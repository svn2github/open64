...
static const char USMID[] = "@(#) libu/util/i3e/ieee_next_after_h_d.c	92.0	10/08/98 14:57:41";
...
extern float _IEEE_NEXT_AFTER_H_D(float x, long double y);
 ...
 *
 */
#pragma _CRI duplicate _IEEE_NEXT_AFTER_H_D as _IEEE_NEXT_AFTER_4_16
float
