...
#pragma ident "@(#) libfi/matrix/matmul_js@.c	92.1	07/09/99 15:18:08"
...
#if defined(_UNICOS)
#pragma _CRI duplicate _MATMUL_JS as MATMUL_JS@
#endif
void
