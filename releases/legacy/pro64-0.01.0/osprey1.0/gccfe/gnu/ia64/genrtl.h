...
extern rtx gen_rtx_fmt_w	PARAMS ((RTX_CODE, enum machine_mode mode,
				       HOST_WIDE_INT arg0));
extern rtx gen_rtx_fmt_e0ww	PARAMS ((RTX_CODE, enum machine_mode mode,
				       rtx arg0, HOST_WIDE_INT arg1,
				       HOST_WIDE_INT arg2));
...
#define gen_rtx_raw_CONST_DOUBLE(MODE, ARG0, ARG1, ARG2) \
  gen_rtx_fmt_e0ww (CONST_DOUBLE, (MODE), (ARG0), (ARG1), (ARG2))
...
#define gen_rtx_SUBREG(MODE, ARG0, ARG1) \
