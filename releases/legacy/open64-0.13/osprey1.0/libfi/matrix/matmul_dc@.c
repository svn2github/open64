...
#pragma ident "@(#) libfi/matrix/matmul_dc@.c	92.1	07/09/99 15:18:08"
...
#if defined(_UNICOS)
#pragma _CRI duplicate _MATMUL_DC as MATMUL_DC@
#endif
void
	...
	DopeVectorType *MATRIX_B)
{
    ...
    _f_real8	*Br, *Bi;	/* pointers to real and imaginary part of B */
