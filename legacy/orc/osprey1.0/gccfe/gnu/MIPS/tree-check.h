...
#define GRANT_TYPE_CHECK(t)	TREE_CHECK (t, GRANT_TYPE)
#define SEIZE_TYPE_CHECK(t)	TREE_CHECK (t, SEIZE_TYPE)
...
#define ALIAS_DECL_CHECK(t)	TREE_CHECK (t, ALIAS_DECL)
#define BASED_DECL_CHECK(t)	TREE_CHECK (t, BASED_DECL)
#define WITH_DECL_CHECK(t)	TREE_CHECK (t, WITH_DECL)
#define CONCAT_EXPR_CHECK(t)	TREE_CHECK (t, CONCAT_EXPR)
#define SLICE_EXPR_CHECK(t)	TREE_CHECK (t, SLICE_EXPR)
#define SET_IN_EXPR_CHECK(t)	TREE_CHECK (t, SET_IN_EXPR)
#define CASE_EXPR_CHECK(t)	TREE_CHECK (t, CASE_EXPR)
#define SET_NOT_EXPR_CHECK(t)	TREE_CHECK (t, SET_NOT_EXPR)
#define SET_IOR_EXPR_CHECK(t)	TREE_CHECK (t, SET_IOR_EXPR)
#define SET_XOR_EXPR_CHECK(t)	TREE_CHECK (t, SET_XOR_EXPR)
#define SET_AND_EXPR_CHECK(t)	TREE_CHECK (t, SET_AND_EXPR)
#define SET_DIFF_EXPR_CHECK(t)	TREE_CHECK (t, SET_DIFF_EXPR)
#define PAREN_EXPR_CHECK(t)	TREE_CHECK (t, PAREN_EXPR)
#define STRING_EQ_EXPR_CHECK(t)	TREE_CHECK (t, STRING_EQ_EXPR)
#define STRING_LT_EXPR_CHECK(t)	TREE_CHECK (t, STRING_LT_EXPR)
#define REPLICATE_EXPR_CHECK(t)	TREE_CHECK (t, REPLICATE_EXPR)
#define UNDEFINED_EXPR_CHECK(t)	TREE_CHECK (t, UNDEFINED_EXPR)
#define INSTANCE_TYPE_CHECK(t)	TREE_CHECK (t, INSTANCE_TYPE)
#define PACKED_ARRAY_REF_CHECK(t)	TREE_CHECK (t, PACKED_ARRAY_REF)
...
#define FUNCTION_NAME_CHECK(t)	TREE_CHECK (t, FUNCTION_NAME)
...
#define START_CATCH_STMT_CHECK(t)	TREE_CHECK (t, START_CATCH_STMT)
...
#define INSTANCE_INITIALIZERS_EXPR_CHECK(t)	TREE_CHECK (t, INSTANCE_INITIALIZERS_EXPR)
