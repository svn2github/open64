...
typedef enum {
  ...
  OPERATOR_MAPCAT_ICALL  = 8
} OPERATOR_MAPCAT;

#define WN_MAP_CATEGORIES 9
...
typedef enum {
  ...
  OPC_I4MPYU2            = OPR_MPYU2 + RTYPE(MTYPE_I4) + DESC(MTYPE_V),
  OPC_U4MPYU2            = OPR_MPYU2 + RTYPE(MTYPE_U4) + DESC(MTYPE_V),
  OPC_I4MPYI2            = OPR_MPYI2 + RTYPE(MTYPE_I4) + DESC(MTYPE_V),
  OPC_U4MPYI2            = OPR_MPYI2 + RTYPE(MTYPE_U4) + DESC(MTYPE_V),
  OPCODE_LAST            = 0x3FFFF
} OPCODE;
