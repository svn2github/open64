/* Generated automatically by the program `gengenrtl'
...
static rtx obstack_alloc_rtx PARAMS ((int length));
     ...
     rtx arg1;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 1 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XEXP (rt, 0) = arg0;
  XEXP (rt, 1) = arg1;
     ...
     const char *arg2;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 2 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XINT (rt, 0) = arg0;
  XSTR (rt, 1) = arg1;
     ...
     int arg0;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 0 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XINT (rt, 0) = arg0;
     ...
     const char *arg3;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 3 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XSTR (rt, 0) = arg0;
  XVEC (rt, 1) = arg1;
     ...
     rtx arg6;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 6 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XINT (rt, 0) = arg0;
  XEXP (rt, 1) = arg1;
     ...
     rtx arg6;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 7 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XINT (rt, 0) = arg0;
  XEXP (rt, 1) = arg1;
     ...
     rtx arg3;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 4 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XEXP (rt, 0) = arg0;
  XVEC (rt, 1) = arg1;
     ...
     int arg12;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 12 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XEXP (rt, 0) = arg0;
  XEXP (rt, 1) = arg1;
     ...
     union tree_node *arg9;
{
  ...
  if (ggc_p)
    ...
    rt = obstack_alloc_rtx (sizeof (struct rtx_def) + 9 * sizeof (rtunion));
  PUT_CODE (rt, code);
  PUT_MODE (rt, mode);
  XINT (rt, 0) = arg0;
  XINT (rt, 1) = arg1;
