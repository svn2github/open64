//OBJ
//TAG:kernel
# 1 "fs/reiserfs/fix_node.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "./include/linux/autoconf.h" 1
# 1 "<command-line>" 2
# 1 "fs/reiserfs/fix_node.c"
# 37 "fs/reiserfs/fix_node.c"
...
# 38 "fs/reiserfs/fix_node.c" 2

# 1 "include/linux/reiserfs_fs.h" 1
# 15 "include/linux/reiserfs_fs.h"
# 1 "include/linux/magic.h" 1
# 16 "include/linux/reiserfs_fs.h" 2
...
# 19 "include/linux/reiserfs_fs.h" 2
...
# 20 "/fc/home/yug/kernel/opencc-build/arch/x86/include/asm/hw_irq.h"
...
# 21 "/fc/home/yug/kernel/opencc-build/arch/x86/include/asm/hw_irq.h" 2
...
extern __attribute__((section(".discard"), unused)) char __pcpu_scope_softirq_work_list; extern __attribute__((section(".data.percpu" ""))) __typeof__(struct list_head [NR_SOFTIRQS]) per_cpu__softirq_work_list;
...
# 20 "include/linux/reiserfs_fs.h" 2
...
# 21 "include/linux/reiserfs_fs.h" 2

# 1 "/fc/home/yug/kernel/opencc-build/arch/x86/include/asm/unaligned.h" 1
...
# 9 "/fc/home/yug/kernel/opencc-build/arch/x86/include/asm/unaligned.h" 2
...
# 10 "/fc/home/yug/kernel/opencc-build/arch/x86/include/asm/unaligned.h" 2
...
# 25 "include/linux/reiserfs_fs.h" 2
...
# 26 "include/linux/reiserfs_fs.h" 2
...
# 27 "include/linux/reiserfs_fs.h" 2
# 1 "include/linux/reiserfs_fs_i.h" 1
...
# 28 "include/linux/reiserfs_fs.h" 2
# 1 "include/linux/reiserfs_fs_sb.h" 1
# 12 "include/linux/reiserfs_fs_sb.h"
typedef enum {
 reiserfs_attrs_cleared = 0x00000001,
} reiserfs_super_block_flags;
# 122 "include/linux/reiserfs_fs_sb.h"
...
struct proc_dir_entry;
# 344 "include/linux/reiserfs_fs_sb.h"
...
enum reiserfs_mount_options {
 ...
 REPLAYONLY,
 REISERFS_CONVERT,
# 437 "include/linux/reiserfs_fs_sb.h"
 FORCE_TEA_HASH,
 FORCE_RUPASOV_HASH,
 FORCE_R5_HASH,
 FORCE_HASH_DETECT,
...
# 502 "include/linux/reiserfs_fs_sb.h"
void reiserfs_file_buffer(struct buffer_head *bh, int list);
extern struct file_system_type reiserfs_fs_type;
int reiserfs_resize(struct super_block *, unsigned long);
# 520 "include/linux/reiserfs_fs_sb.h"
static inline char *reiserfs_bdevname(struct super_block *s)
{
 return (s == ((void *)0)) ? "Null superblock" : s->s_id;
}
...
static inline int __reiserfs_is_journal_aborted(struct reiserfs_journal
      *journal)
{
 return (__builtin_constant_p((J_ABORTED)) ? constant_test_bit((J_ABORTED), (&journal->j_state)) : variable_test_bit((J_ABORTED), (&journal->j_state)));
}
# 29 "include/linux/reiserfs_fs.h" 2
# 61 "include/linux/reiserfs_fs.h"
struct fid;
# 105 "include/linux/reiserfs_fs.h"
void __reiserfs_warning(struct super_block *s, const char *id,
    const char *func, const char *fmt, ...);
# 149 "include/linux/reiserfs_fs.h"
...
# 269 "include/linux/reiserfs_fs.h"
int is_reiserfs_3_5(struct reiserfs_super_block *rs);
int is_reiserfs_3_6(struct reiserfs_super_block *rs);
int is_reiserfs_jr(struct reiserfs_super_block *rs);
# 294 "include/linux/reiserfs_fs.h"
...
# 311 "include/linux/reiserfs_fs.h"
static inline struct reiserfs_inode_info *REISERFS_I(const struct inode *inode)
{
 return ({ const typeof( ((struct reiserfs_inode_info *)0)->vfs_inode ) *__mptr = (inode); (struct reiserfs_inode_info *)( (char *)__mptr - __builtin_offsetof(struct reiserfs_inode_info,vfs_inode) );});
}
...
{
 return ((( __u32)(__le32)(((&((REISERFS_SB(sb)->s_rs)->s_v1))->s_block_count))) - 1) / (sb->s_blocksize * 8) + 1;
}
...
# 410 "include/linux/reiserfs_fs.h"
struct offset_v1 {
 __le32 k_offset;
 __le32 k_uniqueness;
} __attribute__ ((__packed__));
...
{
 __u8 type = (( __u64)(__le64)(v2->v)) >> 60;
...
{
 v2->v =
     (v2->v & (( __le64)(__u64)(~0ULL >> 4))) | (( __le64)(__u64)((__u64) type << 60));
}

static inline loff_t offset_v2_k_offset(const struct offset_v2 *v2)
{
 return (( __u64)(__le64)(v2->v)) & (~0ULL >> 4);
}

static inline void set_offset_v2_k_offset(struct offset_v2 *v2, loff_t offset)
{
 offset &= (~0ULL >> 4);
 v2->v = (v2->v & (( __le64)(__u64)(15ULL << 60))) | (( __le64)(__u64)(offset));
}
...
# 512 "include/linux/reiserfs_fs.h"
struct item_head {
...
# 577 "include/linux/reiserfs_fs.h"
static inline int uniqueness2type(__u32 uniqueness) __attribute__((__const__));
...
static inline __u32 type2uniqueness(int type) __attribute__((__const__));
...
{
 return (version == 0) ?
     (( __u32)(__le32)(key->u.k_offset_v1.k_offset)) :
     offset_v2_k_offset(&(key->u.k_offset_v2));
}

static inline loff_t le_ih_k_offset(const struct item_head *ih)
{
 return le_key_k_offset((( __u16)(__le16)((ih)->ih_version)), &(ih->ih_key));
}

static inline loff_t le_key_k_type(int version, const struct reiserfs_key *key)
{
 return (version == 0) ?
     uniqueness2type((( __u32)(__le32)(key->u.k_offset_v1.k_uniqueness))) :
     offset_v2_k_type(&(key->u.k_offset_v2));
}

static inline loff_t le_ih_k_type(const struct item_head *ih)
{
 return le_key_k_type((( __u16)(__le16)((ih)->ih_version)), &(ih->ih_key));
}

static inline void set_le_key_k_offset(int version, struct reiserfs_key *key,
           loff_t offset)
{
 (version == 0) ? (void)(key->u.k_offset_v1.k_offset = (( __le32)(__u32)(offset))) :
     (void)(set_offset_v2_k_offset(&(key->u.k_offset_v2), offset));
}

static inline void set_le_ih_k_offset(struct item_head *ih, loff_t offset)
{
 set_le_key_k_offset((( __u16)(__le16)((ih)->ih_version)), &(ih->ih_key), offset);
}
         ...
         int type)
{
 (version == 0) ?
     ...
     (( __le32)(__u32)(type2uniqueness(type))))
     : (void)(set_offset_v2_k_type(&(key->u.k_offset_v2), type));
}

static inline void set_le_ih_k_type(struct item_head *ih, int type)
{
 set_le_key_k_type((( __u16)(__le16)((ih)->ih_version)), &(ih->ih_key), type);
}

static inline int is_direntry_le_key(int version, struct reiserfs_key *key)
{
 return le_key_k_type(version, key) == 3;
}

static inline int is_direct_le_key(int version, struct reiserfs_key *key)
{
 return le_key_k_type(version, key) == 2;
}

static inline int is_indirect_le_key(int version, struct reiserfs_key *key)
{
 return le_key_k_type(version, key) == 1;
}

static inline int is_statdata_le_key(int version, struct reiserfs_key *key)
{
 return le_key_k_type(version, key) == 0;
}
...
{
 return is_direntry_le_key((( __u16)(__le16)((ih)->ih_version)), &ih->ih_key);
}

static inline int is_direct_le_ih(struct item_head *ih)
{
 return is_direct_le_key((( __u16)(__le16)((ih)->ih_version)), &ih->ih_key);
}

static inline int is_indirect_le_ih(struct item_head *ih)
{
 return is_indirect_le_key((( __u16)(__le16)((ih)->ih_version)), &ih->ih_key);
}

static inline int is_statdata_le_ih(struct item_head *ih)
{
 return is_statdata_le_key((( __u16)(__le16)((ih)->ih_version)), &ih->ih_key);
}
...
# 763 "include/linux/reiserfs_fs.h"
extern struct reiserfs_key root_key;
# 776 "include/linux/reiserfs_fs.h"
struct block_head {
 __le16 blk_level;
 __le16 blk_nr_item;
...
# 837 "include/linux/reiserfs_fs.h"
struct stat_data_v1 {
 __le16 sd_mode;
 __le16 sd_nlink;
 __le16 sd_uid;
...
# 859 "include/linux/reiserfs_fs.h"
} __attribute__ ((__packed__));
# 913 "include/linux/reiserfs_fs.h"
struct stat_data {
 __le16 sd_mode;
 __le16 sd_attrs;
 __le32 sd_nlink;
...
# 936 "include/linux/reiserfs_fs.h"
 } __attribute__ ((__packed__)) u;
} __attribute__ ((__packed__));
# 1005 "include/linux/reiserfs_fs.h"
...
# 1071 "include/linux/reiserfs_fs.h"
extern void make_empty_dir_item_v1(char *body, __le32 dirid, __le32 objid,
       __le32 par_dirid, __le32 par_objid);
extern void make_empty_dir_item(char *body, __le32 dirid, __le32 objid,
    __le32 par_dirid, __le32 par_objid);
# 1091 "include/linux/reiserfs_fs.h"
static inline int entry_length(const struct buffer_head *bh,
          const struct item_head *ih, int pos_in_item)
{
 struct reiserfs_de_head *deh;

 deh = ((struct reiserfs_de_head *)(( (bh)->b_data + (( __u16)(__le16)((ih)->ih_item_location)) ))) + pos_in_item;
 if (pos_in_item)
  return ((( __u16)(__le16)((deh - 1)->deh_location))) - ((( __u16)(__le16)((deh)->deh_location)));

 return (( __u16)(__le16)((ih)->ih_item_len)) - ((( __u16)(__le16)((deh)->deh_location)));
}
# 1116 "include/linux/reiserfs_fs.h"
...
# 1164 "include/linux/reiserfs_fs.h"
struct disk_child {
 __le32 dc_block_number;
 __le16 dc_size;
 __le16 dc_reserved;
};
# 1208 "include/linux/reiserfs_fs.h"
struct path_element {
 struct buffer_head *pe_buffer;
 int pe_position;

};
# 1241 "include/linux/reiserfs_fs.h"
struct treepath {
 int path_length;
 int reada;
 struct path_element path_elements[7];
 int pos_in_item;
};
# 1307 "include/linux/reiserfs_fs.h"
static inline loff_t max_reiserfs_offset(struct inode *inode)
{
 if (((REISERFS_I(inode)->i_flags & i_item_key_version_mask) ? 1 : 0) == 0)
  return (loff_t) (~(__u32)0);

 return (loff_t) ((~(__u64) 0) >> 4);
}
# 1354 "include/linux/reiserfs_fs.h"
struct virtual_item {
 int vi_index;
...
# 1404 "include/linux/reiserfs_fs.h"
struct tree_balance {
 int tb_mode;
 ...
 struct buffer_head *L[5];
 struct buffer_head *R[5];
 struct buffer_head *FL[5];
 struct buffer_head *FR[5];
 struct buffer_head *CFL[5];
 struct buffer_head *CFR[5];

 struct buffer_head *FEB[6];

 struct buffer_head *used[6];
 struct buffer_head *thrown[6];
 int lnum[5];
# 1430 "include/linux/reiserfs_fs.h"
 int rnum[5];
 int lkey[5];
 ...
 int s2bytes;
 struct buffer_head *buf_to_free[7];
 char *vn_buf;
...
# 1503 "include/linux/reiserfs_fs.h"
struct buffer_info {
...
# 1536 "include/linux/reiserfs_fs.h"
...
extern struct item_operations *item_ops[15 + 1];
# 1607 "include/linux/reiserfs_fs.h"
struct reiserfs_iget_args {
 __u32 objectid;
 __u32 dirid;
};
# 1624 "include/linux/reiserfs_fs.h"
...
# 1640 "include/linux/reiserfs_fs.h"
struct reiserfs_journal_commit {
 __le32 j_trans_id;
 __le32 j_len;
 __le32 j_realblock[1];
};
# 1657 "include/linux/reiserfs_fs.h"
...
# 1714 "include/linux/reiserfs_fs.h"
...
static inline void set_buffer_journaled(struct buffer_head *bh) { set_bit(BH_JDirty, &(bh)->b_state); } static inline void clear_buffer_journaled(struct buffer_head *bh) { clear_bit(BH_JDirty, &(bh)->b_state); } static inline int buffer_journaled(const struct buffer_head *bh) { return (__builtin_constant_p((BH_JDirty)) ? constant_test_bit((BH_JDirty), (&(bh)->b_state)) : variable_test_bit((BH_JDirty), (&(bh)->b_state))); };
static inline int test_set_buffer_journaled(struct buffer_head *bh) { return test_and_set_bit(BH_JDirty, &(bh)->b_state); } static inline int test_clear_buffer_journaled(struct buffer_head *bh) { return test_and_clear_bit(BH_JDirty, &(bh)->b_state); };
static inline void set_buffer_journal_dirty(struct buffer_head *bh) { set_bit(BH_JDirty_wait, &(bh)->b_state); } static inline void clear_buffer_journal_dirty(struct buffer_head *bh) { clear_bit(BH_JDirty_wait, &(bh)->b_state); } static inline int buffer_journal_dirty(const struct buffer_head *bh) { return (__builtin_constant_p((BH_JDirty_wait)) ? constant_test_bit((BH_JDirty_wait), (&(bh)->b_state)) : variable_test_bit((BH_JDirty_wait), (&(bh)->b_state))); };
static inline int test_set_buffer_journal_dirty(struct buffer_head *bh) { return test_and_set_bit(BH_JDirty_wait, &(bh)->b_state); } static inline int test_clear_buffer_journal_dirty(struct buffer_head *bh) { return test_and_clear_bit(BH_JDirty_wait, &(bh)->b_state); };
static inline void set_buffer_journal_new(struct buffer_head *bh) { set_bit(BH_JNew, &(bh)->b_state); } static inline void clear_buffer_journal_new(struct buffer_head *bh) { clear_bit(BH_JNew, &(bh)->b_state); } static inline int buffer_journal_new(const struct buffer_head *bh) { return (__builtin_constant_p((BH_JNew)) ? constant_test_bit((BH_JNew), (&(bh)->b_state)) : variable_test_bit((BH_JNew), (&(bh)->b_state))); };
static inline int test_set_buffer_journal_new(struct buffer_head *bh) { return test_and_set_bit(BH_JNew, &(bh)->b_state); } static inline int test_clear_buffer_journal_new(struct buffer_head *bh) { return test_and_clear_bit(BH_JNew, &(bh)->b_state); };
static inline void set_buffer_journal_prepared(struct buffer_head *bh) { set_bit(BH_JPrepared, &(bh)->b_state); } static inline void clear_buffer_journal_prepared(struct buffer_head *bh) { clear_bit(BH_JPrepared, &(bh)->b_state); } static inline int buffer_journal_prepared(const struct buffer_head *bh) { return (__builtin_constant_p((BH_JPrepared)) ? constant_test_bit((BH_JPrepared), (&(bh)->b_state)) : variable_test_bit((BH_JPrepared), (&(bh)->b_state))); };
static inline int test_set_buffer_journal_prepared(struct buffer_head *bh) { return test_and_set_bit(BH_JPrepared, &(bh)->b_state); } static inline int test_clear_buffer_journal_prepared(struct buffer_head *bh) { return test_and_clear_bit(BH_JPrepared, &(bh)->b_state); };
static inline void set_buffer_journal_restore_dirty(struct buffer_head *bh) { set_bit(BH_JRestore_dirty, &(bh)->b_state); } static inline void clear_buffer_journal_restore_dirty(struct buffer_head *bh) { clear_bit(BH_JRestore_dirty, &(bh)->b_state); } static inline int buffer_journal_restore_dirty(const struct buffer_head *bh) { return (__builtin_constant_p((BH_JRestore_dirty)) ? constant_test_bit((BH_JRestore_dirty), (&(bh)->b_state)) : variable_test_bit((BH_JRestore_dirty), (&(bh)->b_state))); };
static inline int test_set_buffer_journal_restore_dirty(struct buffer_head *bh) { return test_and_set_bit(BH_JRestore_dirty, &(bh)->b_state); } static inline int test_clear_buffer_journal_restore_dirty(struct buffer_head *bh) { return test_and_clear_bit(BH_JRestore_dirty, &(bh)->b_state); };
static inline void set_buffer_journal_test(struct buffer_head *bh) { set_bit(BH_JTest, &(bh)->b_state); } static inline void clear_buffer_journal_test(struct buffer_head *bh) { clear_bit(BH_JTest, &(bh)->b_state); } static inline int buffer_journal_test(const struct buffer_head *bh) { return (__builtin_constant_p((BH_JTest)) ? constant_test_bit((BH_JTest), (&(bh)->b_state)) : variable_test_bit((BH_JTest), (&(bh)->b_state))); };
static inline int test_set_buffer_journal_test(struct buffer_head *bh) { return test_and_set_bit(BH_JTest, &(bh)->b_state); } static inline int test_clear_buffer_journal_test(struct buffer_head *bh) { return test_and_clear_bit(BH_JTest, &(bh)->b_state); };
...
{
 if ((REISERFS_SB(inode->i_sb)->s_mount_opt & (1 << REISERFS_DATA_LOG)) ||
...
{
 struct reiserfs_transaction_handle *th = get_current()->journal_info;
 if (th && th->t_super == s)
  return 1;
 if (th && th->t_super == ((void *)0))
  do { asm volatile("1:\tud2\n" ".pushsection __bug_table,\"a\"\n" "2:\t.long 1b - 2b, %c0 - 2b\n" "\t.word %c1, 0\n" "\t.org 2b+%c2\n" ".popsection" : : "i" ("include/linux/reiserfs_fs.h"), "i" (1787), "i" (sizeof(struct bug_entry))); for (;;) ; } while (0);
 return 0;
}
...
{
 ({ size_t __len = ((sizeof(struct reiserfs_key))); void *__ret; if (__builtin_constant_p((sizeof(struct reiserfs_key))) && __len >= 64) __ret = __memcpy((to), (from), __len); else __ret = __builtin_memcpy((to), (from), __len); __ret; });
}
...
# 1939 "include/linux/reiserfs_fs.h"
void padd_item(char *item, int total_length, int length);
# 1950 "include/linux/reiserfs_fs.h"
...
# 2006 "include/linux/reiserfs_fs.h"
...
int reiserfs_global_version_in_proc(char *buffer, char **start, off_t offset,
        int count, int *eof, void *data);
# 2040 "include/linux/reiserfs_fs.h"
...
# 2261 "include/linux/reiserfs_fs.h"
int reiserfs_ioctl(struct inode *inode, struct file *filp,
     unsigned int cmd, unsigned long arg);
long reiserfs_compat_ioctl(struct file *filp,
     unsigned int cmd, unsigned long arg);
int reiserfs_unpack(struct inode *inode, struct file *filp);
# 40 "fs/reiserfs/fix_node.c" 2
# 57 "fs/reiserfs/fix_node.c"
static inline int old_item_num(int new_num, int affected_item_num, int mode)
{
 if (mode == 'p' || mode == 'c' || new_num < affected_item_num)
  return new_num;
...
static void create_virtual_node(struct tree_balance *tb, int h)
{
 ...
 Sh = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h)))->pe_buffer);


 vn->vn_size =
     ((int)( (Sh)->b_size - (sizeof(struct block_head)) )) - (((( __u16)(__le16)((((struct block_head *)((Sh)->b_data)))->blk_free_space)))) + tb->insert_size[h];


 if (h) {
  vn->vn_nr_item = (vn->vn_size - (sizeof(struct disk_child))) / ((sizeof(struct disk_child)) + (sizeof(struct reiserfs_key)));
  return;
 }


 vn->vn_nr_item =
     (((( __u16)(__le16)((((struct block_head *)((Sh)->b_data)))->blk_nr_item)))) + ((vn->vn_mode == 'i') ? 1 : 0) -
     ((vn->vn_mode == 'd') ? 1 : 0);
 ...
 ih = ( (struct item_head * )((Sh)->b_data + (sizeof(struct block_head))) + (0) );


 if (item_ops[le_key_k_type (le_key_version (&(ih->ih_key)), &(ih->ih_key))]->is_left_mergeable (&(ih->ih_key), Sh->b_size)
     && (vn->vn_mode != 'd' || vn->vn_affected_item_num))
  vn->vn_vi[0].vi_type |= 1;
 ...
 for (new_num = 0; new_num < vn->vn_nr_item; new_num++) {
  ...
  vi->vi_item_len += (( __u16)(__le16)((ih + j)->ih_item_len)) + (sizeof(struct item_head));
  vi->vi_ih = ih + j;
  vi->vi_item = ( (Sh)->b_data + (( __u16)(__le16)((ih + j)->ih_item_location)) );
  vi->vi_uarea = vn->vn_free_ptr;



  vn->vn_free_ptr +=
      item_ops[le_ih_k_type ((vi)->vi_ih)]->create_vi (vn,vi,is_affected,tb->insert_size[0]);
  if (tb->vn_buf + tb->vn_buf_size < vn->vn_free_ptr)
   __reiserfs_panic(tb->tb_sb, "vs-8030", __func__, "virtual node space consumed");
 ...
 if (vn->vn_mode == 'i') {
  ...
  item_ops[le_ih_k_type ((vi)->vi_ih)]->create_vi (vn,vi,0,tb->insert_size[0]);
 ...
 if (tb->CFR[0]) {
  ...
  key = ( (struct reiserfs_key * )((tb->CFR[0])->b_data + (sizeof(struct block_head))) + (tb->rkey[0]) );
  if (item_ops[le_key_k_type (le_key_version (key), key)]->is_left_mergeable (key, Sh->b_size)
      && (vn->vn_mode != 'd'
   || vn->vn_affected_item_num != (((( __u16)(__le16)((((struct block_head *)((Sh)->b_data)))->blk_nr_item)))) - 1))
   vn->vn_vi[vn->vn_nr_item - 1].vi_type |=
       2;
# 197 "fs/reiserfs/fix_node.c"
 }
}
...
static void check_left(struct tree_balance *tb, int h, int cur_free)
{
 ...
 if (h > 0) {
  tb->lnum[h] = cur_free / ((sizeof(struct disk_child)) + (sizeof(struct reiserfs_key)));
  return;
 }
 ...
 if ((unsigned int)cur_free >=
     (vn->vn_size -
      ((vi->vi_type & 1) ? (sizeof(struct item_head)) : 0))) {
 ...
 d_size = 0, ih_size = (sizeof(struct item_head));


 if (vi->vi_type & 1)
  d_size = -((int)(sizeof(struct item_head))), ih_size = 0;

 tb->lnum[0] = 0;
 for (i = 0; i < vn->vn_nr_item;
      i++, ih_size = (sizeof(struct item_head)), d_size = 0, vi++) {
  ...
  tb->lbytes = item_ops[(vi)->vi_index]->check_left (vi, cur_free, 0, 0);
  if (tb->lbytes != -1)
...
static void check_right(struct tree_balance *tb, int h, int cur_free)
{
 ...
 if (h > 0) {
  tb->rnum[h] = cur_free / ((sizeof(struct disk_child)) + (sizeof(struct reiserfs_key)));
  return;
 }
 ...
 if ((unsigned int)cur_free >=
     (vn->vn_size -
      ((vi->vi_type & 2) ? (sizeof(struct item_head)) : 0))) {
 ...
 for (i = vn->vn_nr_item - 1; i >= 0;
      i--, d_size = 0, ih_size = (sizeof(struct item_head)), vi--) {
  d_size += vi->vi_item_len;
  if (cur_free >= d_size) {
  ...
  tb->rbytes = item_ops[(vi)->vi_index]->check_right (vi, cur_free);
  if (tb->rbytes != -1)
         ...
         int to, int to_bytes, short *snum012, int flow)
{
 ...
 max_node_size = ((int)( ((((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h)))->pe_buffer))->b_size - (sizeof(struct block_head)) ));
 ...
 if (h > 0) {
  i = ((to - from) * ((sizeof(struct reiserfs_key)) + (sizeof(struct disk_child))) + (sizeof(struct disk_child)));
  if (i == max_node_size)
   return 1;
 ...
 for (i = start_item; i <= end_item; i++) {
  ...
  current_item_size -=
      item_ops[(vi)->vi_index]->part_size (vi, 0, start_bytes);


  current_item_size -=
      item_ops[(vi)->vi_index]->part_size (vi, 1, skip_from_end);
...

  {
   ...
   free_space = max_node_size - total_node_size - (sizeof(struct item_head));
   units =
       item_ops[(vi)->vi_index]->check_left (vi, free_space, start_bytes, skip_from_end);
  ...
  if (needed_nodes > 2)
   __reiserfs_warning(tb->tb_sb, "vs-8111", __func__, "split_item_position is out of range");
 ...
 if (snum012[4] > 0) {
  ...
  snum012[4] =
      item_ops[(&vn->vn_vi[split_item_num])->vi_index]->unit_num (&vn->vn_vi[split_item_num]) - snum012[4] -
      bytes_to_r - bytes_to_l - bytes_to_S1new;

  if (vn->vn_vi[split_item_num].vi_index != 3 &&
      vn->vn_vi[split_item_num].vi_index != 1)
   __reiserfs_warning(tb->tb_sb, "vs-8115", __func__, "not directory or indirect item");
 ...
 if (snum012[3] > 0) {
  ...
  snum012[3] =
      item_ops[(&vn->vn_vi[split_item_num])->vi_index]->unit_num (&vn->vn_vi[split_item_num]) - snum012[3] -
      bytes_to_r - bytes_to_l - bytes_to_S2new;
 }

 return needed_nodes;
}
# 587 "fs/reiserfs/fix_node.c"
...
static int is_leaf_removable(struct tree_balance *tb)
{
 ...
 size = item_ops[(&(vn->vn_vi[to_left]))->vi_index]->unit_num (&(vn->vn_vi[to_left]));
...
static int are_leaves_removable(struct tree_balance *tb, int lfree, int rfree)
{
 ...
 S0 = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (0)))->pe_buffer);

 ih_size = 0;
 if (vn->vn_nr_item) {
  if (vn->vn_vi[0].vi_type & 1)
   ih_size += (sizeof(struct item_head));
  ...
  ih = ( (struct item_head * )((S0)->b_data + (sizeof(struct block_head))) + (0) );
  if (tb->CFR[0]
      && !comp_short_le_keys(&(ih->ih_key),
        ( (struct reiserfs_key * )((tb->CFR[0])->b_data + (sizeof(struct block_head))) + (tb->rkey[0]) )))
 ...
 if (((int)( (S0)->b_size - (sizeof(struct block_head)) )) + vn->vn_size <= rfree + lfree + ih_size) {
...
static int get_empty_nodes(struct tree_balance *tb, int h)
{
 struct buffer_head *new_bh,
     *Sh = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h)))->pe_buffer);
 b_blocknr_t *blocknr, blocknrs[2] = { 0, };
 int counter, number_of_freeblk, amount_needed,
  retval = 0;
 struct super_block *sb = tb->tb_sb;
# 806 "fs/reiserfs/fix_node.c"
 ...
 if (retval == 0 && (atomic_read (&(REISERFS_SB((tb)->tb_sb)->s_generation_counter)) != (tb)->fs_gen))
  retval = -1;
...
static int get_lfree(struct tree_balance *tb, int h)
{
 ...
 if ((f = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - ((h) + 1)))->pe_buffer)) == ((void *)0) ||
     (l = tb->FL[h]) == ((void *)0))
  return 0;

 if (f == l)
  order = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h + 1)))->pe_position) - 1;
 else {
  order = (((( __u16)(__le16)((((struct block_head *)((l)->b_data)))->blk_nr_item))));
  f = l;
 }

 return (((int)( (f)->b_size - (sizeof(struct block_head)) )) - ((( __u16)(__le16)((((struct disk_child *)((f)->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((f)->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (order))))->dc_size))));
}
...
static int is_left_neighbor_in_cache(struct tree_balance *tb, int h)
{
 ...
 father = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h + 1)))->pe_buffer);

 do {;} while( 0 );
# 922 "fs/reiserfs/fix_node.c"
 left_neighbor_position = (father == tb->FL[h]) ?
     tb->lkey[h] : (((( __u16)(__le16)((((struct block_head *)((tb->FL[h])->b_data)))->blk_nr_item))));

 left_neighbor_blocknr =
     (((( __u32)(__le32)((((struct disk_child *)((tb->FL[h])->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((tb->FL[h])->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (left_neighbor_position))))->dc_block_number))));
     ...
     struct buffer_head **pcom_father, char c_lr_par)
{
 ...
 struct treepath s_path_to_neighbor_father = {.path_length = 1, .reada = 0,};
 struct treepath *path = tb->tb_path;
 struct cpu_key s_lr_father_key;
 int counter,
     position = ((int)(~0U>>1)),
     first_last_position = 0,
     path_offset = ((path)->path_length - (h));
 ...
 for (; counter > 2; counter--) {
  ...
  if (!B_IS_IN_TREE
      (parent = (((path)->path_elements + (counter - 1))->pe_buffer)))
   return -1;

  if ((position =
       (((path)->path_elements + (counter - 1))->pe_position)) >

      (((( __u16)(__le16)((((struct block_head *)((parent)->b_data)))->blk_nr_item)))))
   return -1;

  if ((((( __u32)(__le32)((((struct disk_child *)((parent)->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((parent)->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (position))))->dc_block_number)))) !=
      (((path)->path_elements + (counter))->pe_buffer)->b_blocknr)
   return -1;

  if (c_lr_par == 'r')
   first_last_position = (((( __u16)(__le16)((((struct block_head *)((parent)->b_data)))->blk_nr_item))));
 ...
 if (counter == 2) {
  ...
  if ((((tb->tb_path)->path_elements + (2))->pe_buffer)->b_blocknr ==


      (( __u32)(__le32)(((&((REISERFS_SB(tb->tb_sb)->s_rs)->s_v1))->s_root_block)))) {
 ...
 if (buffer_locked(*pcom_father)) {
  ...
  if ((atomic_read (&(REISERFS_SB((tb)->tb_sb)->s_generation_counter)) != (tb)->fs_gen)) {
   brelse(*pcom_father);
   return -1;
  }
 }
 ...
 le_key2cpu_key(&s_lr_father_key,
         ( (struct reiserfs_key * )((*pcom_father)->b_data + (sizeof(struct block_head))) + ((c_lr_par == 'l') ? (tb->lkey[h - 1] = position - 1) : (tb->rkey[h - 1] = position)) ));
 ...
 *pfather = (((((&s_path_to_neighbor_father))->path_elements + ((&s_path_to_neighbor_father)->path_length))->pe_buffer));
...
# 1079 "fs/reiserfs/fix_node.c"
static int get_parents(struct tree_balance *tb, int h)
{
 struct treepath *path = tb->tb_path;
 int position,
     ret,
     path_offset = ((tb->tb_path)->path_length - (h));
 ...
 position = (((path)->path_elements + (path_offset - 1))->pe_position);
 if (position) {

  curf = (((path)->path_elements + (path_offset - 1))->pe_buffer);
  curcf = (((path)->path_elements + (path_offset - 1))->pe_buffer);
  get_bh(curf);
  get_bh(curf);
 ...
 if (position == (((( __u16)(__le16)((((struct block_head *)(((((path)->path_elements + (path->path_length - (h + 1)))->pe_buffer))->b_data)))->blk_nr_item))))) {
...
{
 struct buffer_head *Sh = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h)))->pe_buffer);
 int levbytes = tb->insert_size[h];
 struct item_head *ih;
 struct reiserfs_key *r_key = ((void *)0);

 ih = ( (struct item_head * )((Sh)->b_data + (sizeof(struct block_head))) + (0) );
 if (tb->CFR[h])
  r_key = ( (struct reiserfs_key * )((tb->CFR[h])->b_data + (sizeof(struct block_head))) + (tb->rkey[h]) );

 if (lfree + rfree + sfree < ((int)( (Sh)->b_size - (sizeof(struct block_head)) )) + levbytes

     -
     ((!h
       && item_ops[le_key_k_type (le_key_version (&(ih->ih_key)), &(ih->ih_key))]->is_left_mergeable (&(ih->ih_key), Sh->b_size)) ? (sizeof(struct item_head)) : 0)
     -
     ((!h && r_key
       && item_ops[le_key_k_type (le_key_version (r_key), r_key)]->is_left_mergeable (r_key, Sh->b_size)) ? (sizeof(struct item_head)) : 0)
     + ((h) ? (sizeof(struct reiserfs_key)) : 0)) {

  if (sfree >= levbytes) {
   if (!h)
    tb->s0num =
        (((( __u16)(__le16)((((struct block_head *)((Sh)->b_data)))->blk_nr_item)))) +
        ((mode == 'i') ? 1 : 0);
...
# 1236 "fs/reiserfs/fix_node.c"
 int nver, lnver, rnver, lrnver;
# 1246 "fs/reiserfs/fix_node.c"
 short snum012[40] = { 0, };
# 1255 "fs/reiserfs/fix_node.c"
 struct buffer_head *Sh;
 ...
 if (!Sh) {
  if (!h)
   __reiserfs_panic(tb->tb_sb, "vs-8210", __func__, "S[0] can not be 0");
  ...
  case -1:
   return ret;
  default:
   __reiserfs_panic(tb->tb_sb, "vs-8215", __func__, "incorrect " "return value of get_empty_nodes");

  }
 }

 if ((ret = get_parents(tb, h)) != 0)
  return ret;

 sfree = (((( __u16)(__le16)((((struct block_head *)((Sh)->b_data)))->blk_free_space))));
 ...
 if (h && (tb->rnum[h] + tb->lnum[h] >= vn->vn_nr_item + 1)) {
  ...
  to_r =
      ((( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) ) << 1) + 2 - tb->lnum[h] - tb->rnum[h] +
       vn->vn_nr_item + 1) / 2 - (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) ) + 1 -
      tb->rnum[h]);
...
# 1377 "fs/reiserfs/fix_node.c"
  ...
  if (lnver < rnver) {
   if (h){ int to_l; to_l = (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) )+1 - lpar + vn->vn_nr_item + 1) / 2 - (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) ) + 1 - lpar); set_parameters (tb, h, to_l, 0, lnver, ((void *)0), -1, -1);}else { if (lset==15) set_parameters (tb, h, lpar, 0, lnver, snum012+lset, tb->lbytes, -1); else set_parameters (tb, h, lpar - (tb->lbytes!=-1), 0, lnver, snum012+lset, -1, -1);};
   return 0;
  }


  if (lnver > rnver) {
   if (h){ int to_r; to_r = (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) )+1 - rpar + vn->vn_nr_item + 1) / 2 - (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) ) + 1 - rpar); set_parameters (tb, h, 0, to_r, rnver, ((void *)0), -1, -1);}else { if (rset==25) set_parameters (tb, h, 0, rpar, rnver, snum012+rset, -1, tb->rbytes); else set_parameters (tb, h, 0, rpar - (tb->rbytes!=-1), rnver, snum012+rset, -1, -1);};
   return 0;
  }
...
static int dc_check_balance_internal(struct tree_balance *tb, int h)
{
 ...
 Sh = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h)))->pe_buffer);
 Fh = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - ((h) + 1)))->pe_buffer);

 maxsize = ((int)( (Sh)->b_size - (sizeof(struct block_head)) ));
 ...
 if (vn->vn_nr_item >= (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) )/2)) {
  ...
  if (vn->vn_nr_item == (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) )/2)) {
   ...
   if (tb->lnum[h] >= vn->vn_nr_item + 1) {
    ...
    order_L =
        ((n =
          (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h + 1)))->pe_position)) ==

         0) ? (((( __u16)(__le16)((((struct block_head *)((tb->FL[h])->b_data)))->blk_nr_item)))) : n - 1;
    n = ((( __u16)(__le16)((((struct disk_child *)((tb->FL[h])->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((tb->FL[h])->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (order_L))))->dc_size))) /
        ((sizeof(struct disk_child)) + (sizeof(struct reiserfs_key)));
   ...
   if (tb->rnum[h] >= vn->vn_nr_item + 1) {
    ...
    order_R =
        ((n =
         ...
         (((( __u16)(__le16)((((struct block_head *)((Fh)->b_data)))->blk_nr_item))))) ? 0 : n + 1;
    n = ((( __u16)(__le16)((((struct disk_child *)((tb->FR[h])->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((tb->FR[h])->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (order_R))))->dc_size))) /
        ((sizeof(struct disk_child)) + (sizeof(struct reiserfs_key)));
  ...
  if (tb->rnum[h] + tb->lnum[h] >= vn->vn_nr_item + 1) {
   ...
   to_r =
       ((( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) ) << 1) + 2 - tb->lnum[h] -
        tb->rnum[h] + vn->vn_nr_item + 1) / 2 -
       (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) ) + 1 - tb->rnum[h]);
  ...
  if (is_left_neighbor_in_cache(tb, h)
   ...
   order_L =
       ((n =
        ...
        0) ? (((( __u16)(__le16)((((struct block_head *)((tb->FL[h])->b_data)))->blk_nr_item)))) : n - 1;
   n = ((( __u16)(__le16)((((struct disk_child *)((tb->FL[h])->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((tb->FL[h])->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (order_L))))->dc_size))) / ((sizeof(struct disk_child)) +
 ...
 if (tb->rnum[h] >= vn->vn_nr_item + 1) {
  ...
  order_R =
      ((n =
        (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h + 1)))->pe_position)) == (((( __u16)(__le16)((((struct block_head *)((Fh)->b_data)))->blk_nr_item))))) ? 0 : (n + 1);

  n = ((( __u16)(__le16)((((struct disk_child *)((tb->FR[h])->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((tb->FR[h])->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (order_R))))->dc_size))) / ((sizeof(struct disk_child)) +
             (sizeof(struct reiserfs_key)));
 ...
 if (is_left_neighbor_in_cache(tb, h) || !tb->FR[h]) {
  ...
  from_l =
      (( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) ) + 1 - tb->lnum[h] + vn->vn_nr_item +
       1) / 2 - (vn->vn_nr_item + 1);
 ...
 set_parameters(tb, h, 0,
         -((( (((int)( (Sh)->b_size - (sizeof(struct block_head)) ))-(sizeof(struct disk_child)))/((sizeof(struct reiserfs_key))+(sizeof(struct disk_child))) ) + 1 - tb->rnum[h] + vn->vn_nr_item +
     1) / 2 - (vn->vn_nr_item + 1)), 1, ((void *)0), -1, -1);
 return 0;
}
# 1740 "fs/reiserfs/fix_node.c"
static int dc_check_balance_leaf(struct tree_balance *tb, int h)
{
 ...
 S0 = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - (0)))->pe_buffer);
 F0 = (((tb->tb_path)->path_elements + (tb->tb_path->path_length - ((0) + 1)))->pe_buffer);

 levbytes = tb->insert_size[h];

 maxsize = ((int)( (S0)->b_size - (sizeof(struct block_head)) ));
...
static int get_direct_parent(struct tree_balance *tb, int h)
{
 ...
 if (path_offset <= 2) {
  ...
  if ((((path)->path_elements + (2))->pe_buffer)->
      b_blocknr == (( __u32)(__le32)(((&((REISERFS_SB(tb->tb_sb)->s_rs)->s_v1))->s_root_block)))) {

   (((path)->path_elements + (path_offset - 1))->pe_buffer) = ((void *)0);
   (((path)->path_elements + (path_offset - 1))->pe_position) = 0;
   return 0;
  }
  return -1;
 }
 ...
 if (!B_IS_IN_TREE
     (bh = (((path)->path_elements + (path_offset - 1))->pe_buffer)))
  return -1;

 if ((position =
      (((path)->path_elements + (path_offset - 1))->pe_position)) > (((( __u16)(__le16)((((struct block_head *)((bh)->b_data)))->blk_nr_item)))))

  return -1;

 if ((((( __u32)(__le32)((((struct disk_child *)((bh)->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((bh)->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (position))))->dc_block_number)))) !=
     (((path)->path_elements + (path_offset))->pe_buffer)->b_blocknr)
...
{
 int child_position,
     path_offset = ((tb->tb_path)->path_length - (h + 1));
 ...
 if (tb->lnum[h]) {
  ...
  ( ( void ) 0 );
  bh = (((tb->tb_path)->path_elements + (path_offset))->pe_buffer);
  ...
  child_position =
      (bh ==
       tb->FL[h]) ? tb->lkey[h] : (((( __u16)(__le16)((((struct block_head *)((tb-> FL[h])->b_data)))->blk_nr_item))));

  son_number = (((( __u32)(__le32)((((struct disk_child *)((tb->FL[h])->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((tb->FL[h])->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (child_position))))->dc_block_number))));
 ...
 if (tb->rnum[h]) {
  ...
  son_number = (((( __u32)(__le32)((((struct disk_child *)((tb->FR[h])->b_data + (sizeof(struct block_head)) + (((( __u16)(__le16)((((struct block_head *)((tb->FR[h])->b_data)))->blk_nr_item)))) * (sizeof(struct reiserfs_key)) + (sizeof(struct disk_child)) * (child_position))))->dc_block_number))));
  bh = sb_bread(sb, son_number);
  if (!bh)
   return -2;
  if ((atomic_read (&(REISERFS_SB((tb)->tb_sb)->s_generation_counter)) != (tb)->fs_gen)) {
...
static int get_virtual_node_size(struct super_block *sb, struct buffer_head *bh)
{
 ...
 max_num_of_items = (blocksize - (sizeof(struct block_head))) / ((sizeof(struct item_head)) + 1);
 max_num_of_entries = (blocksize - (sizeof(struct block_head)) - (sizeof(struct item_head))) /
     (sizeof(struct reiserfs_de_head) + 1);

 return sizeof(struct virtual_node) +
     ({ typeof(max_num_of_items * sizeof(struct virtual_item)) _max1 = (max_num_of_items * sizeof(struct virtual_item)); typeof(sizeof(struct virtual_item) + sizeof(struct direntry_uarea) + (max_num_of_entries - 1) * sizeof(__u16)) _max2 = (sizeof(struct virtual_item) + sizeof(struct direntry_uarea) + (max_num_of_entries - 1) * sizeof(__u16)); (void) (&_max1 == &_max2); _max1 > _max2 ? _max1 : _max2; });
...
static int get_mem_for_virtual_node(struct tree_balance *tb)
{
 ...
 size = get_virtual_node_size(tb->tb_sb, (((((tb->tb_path))->path_elements + ((tb->tb_path)->path_length))->pe_buffer)));
 ...
 if (size > tb->vn_buf_size) {
  ...
  buf = kmalloc(size, ((( gfp_t)0x20u)) | (( gfp_t)0x200u));
  if (!buf) {
   ...
   buf = kmalloc(size, ((( gfp_t)0x10u) | (( gfp_t)0x40u)));
   if (!buf) {
    tb->vn_buf_size = 0;
   }
   tb->vn_buf = buf;
 ...
 if (check_fs && (atomic_read (&(REISERFS_SB((tb)->tb_sb)->s_generation_counter)) != (tb)->fs_gen))
  return -1;

 return 0;
}
# 2135 "fs/reiserfs/fix_node.c"
...
static int wait_tb_buffers_until_unlocked(struct tree_balance *tb)
{
 ...
 do {
  ...
  for (i = tb->tb_path->path_length;
       !locked && i > 1; i--) {
   if ((((tb->tb_path)->path_elements + (i))->pe_buffer)) {
# 2175 "fs/reiserfs/fix_node.c"
    if (!clear_all_dirty_bits(tb->tb_sb,
         (((tb->tb_path)->path_elements + (i))->pe_buffer))) {
  ...
  for (i = 0; !locked && i < 5 && tb->insert_size[i];
       i++) {
...
# 2258 "fs/reiserfs/fix_node.c"
  for (i = 0; !locked && i < 6; i++) {
   if (tb->FEB[i]) {
    if (!clear_all_dirty_bits
        (tb->tb_sb, tb->FEB[i]))
     locked = tb->FEB[i];
...
# 2320 "fs/reiserfs/fix_node.c"
int fix_nodes(int op_mode, struct tree_balance *tb,
       struct item_head *ins_ih, const void *data)
{
 int ret, h, item_num = (((((tb->tb_path))->path_elements + ((tb->tb_path)->path_length))->pe_position));
 int pos_in_item;
 ...
 struct buffer_head *tbS0 = (((((tb->tb_path))->path_elements + ((tb->tb_path)->path_length))->pe_buffer));

 ++REISERFS_SB(tb->tb_sb)->s_fix_nodes;

 pos_in_item = tb->tb_path->pos_in_item;

 tb->fs_gen = atomic_read (&(REISERFS_SB(tb->tb_sb)->s_generation_counter));
...
# 2396 "fs/reiserfs/fix_node.c"
 if (get_mem_for_virtual_node(tb) == -1)

  return -1;


 for (h = 0; h < 5 && tb->insert_size[h]; h++) {
  ...
  if (!(((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h)))->pe_buffer)) {
   ...
   if (h < 5 - 1)
    tb->insert_size[h + 1] = 0;
  } else if (!(((tb->tb_path)->path_elements + (tb->tb_path->path_length - (h + 1)))->pe_buffer)) {
   if (tb->blknum[h] > 1) {
    ...
    tb->insert_size[h + 1] =
        ((sizeof(struct disk_child)) +
         (sizeof(struct reiserfs_key))) * (tb->blknum[h] - 1) +
        (sizeof(struct disk_child));
   } else if (h < 5 - 1)
    tb->insert_size[h + 1] = 0;
  } else
   tb->insert_size[h + 1] =
       ((sizeof(struct disk_child)) + (sizeof(struct reiserfs_key))) * (tb->blknum[h] - 1);
 }
