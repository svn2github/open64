...
# 1 "/export/proj/linux_test/o64guru/base/trunk/objdir/binroot/open64-gcc-4.2.0/lib/gcc/x86_64-redhat-linux/4.2.0/include/stddef.h" 1 3 4
# 214 "/export/proj/linux_test/o64guru/base/trunk/objdir/binroot/open64-gcc-4.2.0/lib/gcc/x86_64-redhat-linux/4.2.0/include/stddef.h" 3 4
...
# 1 "/export/proj/linux_test/o64guru/base/trunk/objdir/binroot/open64-gcc-4.2.0/lib/gcc/x86_64-redhat-linux/4.2.0/include/stddef.h" 1 3 4
# 326 "/export/proj/linux_test/o64guru/base/trunk/objdir/binroot/open64-gcc-4.2.0/lib/gcc/x86_64-redhat-linux/4.2.0/include/stddef.h" 3 4
typedef int wchar_t;
...
# 1 "/export/proj/linux_test/o64guru/base/trunk/objdir/binroot/open64-gcc-4.2.0/lib/gcc/x86_64-redhat-linux/4.2.0/include/stddef.h" 1 3 4
# 355 "/export/proj/linux_test/o64guru/base/trunk/objdir/binroot/open64-gcc-4.2.0/lib/gcc/x86_64-redhat-linux/4.2.0/include/stddef.h" 3 4
...
# 1 "/export/proj/linux_test/o64guru/base/trunk/objdir/binroot/open64-gcc-4.2.0/lib/gcc/x86_64-redhat-linux/4.2.0/include/stdarg.h" 1 3 4
# 43 "/export/proj/linux_test/o64guru/base/trunk/objdir/binroot/open64-gcc-4.2.0/lib/gcc/x86_64-redhat-linux/4.2.0/include/stdarg.h" 3 4
...
# 10 "/usr/include/linux/random.h" 3 4
# 1 "/usr/include/linux/ioctl.h" 1 3 4
# 11 "/usr/include/linux/random.h" 2 3 4
# 35 "/usr/include/linux/random.h" 3 4
...
# 53 "fips.h"
extern const char *fips_test_names[5];
extern const unsigned int fips_test_mask[5];
# 70 "fips.h"
...
{
 random_fd = open(randomdev, 02);
 if (random_fd == -1) {
  do { if (am_daemon) { syslog(((3<<3)|3), "can't open %s: %s", randomdev, strerror((*__errno_location ()))); } else { fprintf(stderr, "can't open %s: %s", randomdev, strerror((*__errno_location ()))); fprintf(stderr, "\n"); } } while (0);
...
void random_add_entropy(void *buf, size_t size)
{
 ...
 if (ioctl(random_fd, (((1U) << (((0 +8)+8)+14)) | ((('R')) << (0 +8)) | (((0x03)) << 0) | ((((sizeof(int [2])))) << ((0 +8)+8))), &entropy) != 0) {
  do { if (am_daemon) { syslog(((3<<3)|3), "RNDADDENTROPY failed: %s\n", strerror((*__errno_location ()))); } else { fprintf(stderr, "RNDADDENTROPY failed: %s\n", strerror((*__errno_location ()))); fprintf(stderr, "\n"); } } while (0);
...
void random_sleep(double poll_timeout)
{
 ...
 if (ioctl(random_fd, (((2U) << (((0 +8)+8)+14)) | ((('R')) << (0 +8)) | (((0x00)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))), &ent_count) == 0 &&
