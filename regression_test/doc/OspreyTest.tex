...
\begin{document}
    ...
    \section{the Directory Hierarchy of the Test Cases}
        ...
        \subsection{the Configuration File for Test Groups}
            ...
            It seems that only the override for \verb\VALIDATION_ONLY\, \verb\WHOLE_COPY\, \verb\EVALUATOR\, \verb\PLATFORMS\ and
        ...
        \subsection{Building Process for Test Cases with Single Source File}
            ...
            \begin{itemize}
                ...
                \item \verb|//PLATFORM:|$<$\emph{architecture name}$>$

                    The available architectures for the current test case.
                    If more than one architectures are available, separate them by comma.
                    If the CURRENT\_PLATFORM value is not among those architecture names, the test case will be skipped.
        ...
        \subsection{Building Process for Test Cases with Multiple Files}
            ...
            Like the single source test cases, you can specify some test instructions in a Makefile.
            An test instruction should be written in a separated line and start with `\#'.
            There're two kinds of available test instructions for test cases with multiple source files,
            i.e. NOEXEC and PLATFORM. Their usage is the same with the single file test cases.
