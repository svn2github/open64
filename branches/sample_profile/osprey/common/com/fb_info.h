...
enum FB_EDGE_TYPE {
  ...
  FB_EDGE_BRANCH_ENTRY     =  4,
  FB_EDGE_BRANCH_TAKEN     =  5,
  FB_EDGE_BRANCH_NOT_TAKEN =  6,
  FB_EDGE_BRANCH_JOIN      =  7,
  FB_EDGE_LOOP_ENTRY       =  8,
  FB_EDGE_LOOP_ZERO        =  9,
  FB_EDGE_LOOP_POSITIVE    = 10,
  FB_EDGE_LOOP_OUT         = 11,
  FB_EDGE_LOOP_BACK        = 12,
  FB_EDGE_LOOP_EXIT        = 13,  // EXIT    == ZERO     + OUT
  FB_EDGE_LOOP_ITERATE     = 14,  // ITERATE == POSITIVE + BACK
  FB_EDGE_CIRCUIT_LEFT     = 15,
  FB_EDGE_CIRCUIT_RIGHT    = 16,
  FB_EDGE_CIRCUIT_NEITHER  = 17,
  FB_EDGE_CALL_INCOMING    = 18,
  FB_EDGE_CALL_OUTGOING    = 19,
  FB_EDGE_CALL_INOUTSAME   = 20,
  FB_EDGE_IO_OUTGOING      = 21,
  FB_EDGE_IO_ESCAPE_BASE   = 22,
  FB_EDGE_SWITCH_DEFAULT   = 23,  // 19 + FB_IO_ESCAPE_EDGES_MAX
  FB_EDGE_SWITCH_BASE      = 24   // must be last
};
