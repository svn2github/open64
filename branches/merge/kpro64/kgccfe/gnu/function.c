...
#ifdef KEY
// Bug 1023
#include "wfe_stmt.h"         // for WFE_Emit_Side_Effects_Pending
#include "tree-inline.h"      // for walk_tree_without_duplicates
#endif
...
#ifdef KEY
  // Bug 1023
  if (pending_sizes && TREE_CODE(TREE_VALUE(pending_sizes)) == SAVE_EXPR)
