...
#define LAST_COMMON_ID 787
  ...
  INTRN_VEC_INIT_V2SI	= LAST_COMMON_ID+159,
  INTRN_VEC_EXT_V2SI	= LAST_COMMON_ID+160,
  INTRN_PMADDWD		= LAST_COMMON_ID+161,
  INTRN_PSLLW_MMX       = LAST_COMMON_ID+162,
  INTRN_PSLLD_MMX       = LAST_COMMON_ID+163,
  INTRN_PSRLW_MMX       = LAST_COMMON_ID+164,
  INTRN_PSRLD_MMX       = LAST_COMMON_ID+165,
  INTRN_PSRAW_MMX       = LAST_COMMON_ID+166,
  INTRN_PSRAD_MMX       = LAST_COMMON_ID+167,
  INTRN_PAND_MMX        = LAST_COMMON_ID+168,
  INTRN_PANDN_MMX       = LAST_COMMON_ID+169,
  INTRN_POR_MMX         = LAST_COMMON_ID+170,
  INTRN_PXOR_MMX        = LAST_COMMON_ID+171,
  INTRN_COMILTSS	= LAST_COMMON_ID+172,
  INTRN_COMILESS	= LAST_COMMON_ID+173,
  INTRN_COMIGTSS	= LAST_COMMON_ID+174,
  INTRN_COMIGESS	= LAST_COMMON_ID+175,
  INTRN_COMINEQSS	= LAST_COMMON_ID+176,
  INTRN_COMIEQSD	= LAST_COMMON_ID+177,
  INTRN_COMILTSD	= LAST_COMMON_ID+178,
  INTRN_COMILESD	= LAST_COMMON_ID+179,
  INTRN_COMIGTSD	= LAST_COMMON_ID+180,
  INTRN_COMIGESD	= LAST_COMMON_ID+181,
  INTRN_COMINEQSD	= LAST_COMMON_ID+182,
  INTRN_CVTPI2PS	= LAST_COMMON_ID+183,
  INTRN_CVTPS2PI	= LAST_COMMON_ID+184,
  INTRN_CVTTPS2PI	= LAST_COMMON_ID+185,
  INTRN_CVTPI2PD	= LAST_COMMON_ID+186,
  INTRN_CVTPD2PI	= LAST_COMMON_ID+187,
  INTRN_CVTTPD2PI	= LAST_COMMON_ID+188,
  INTRN_CVTSI2SS	= LAST_COMMON_ID+189,
  INTRN_CVTSI642SS	= LAST_COMMON_ID+190,
  INTRN_CVTSS2SI	= LAST_COMMON_ID+191,
  INTRN_CVTSS2SI64	= LAST_COMMON_ID+192,
  INTRN_CVTTSS2SI	= LAST_COMMON_ID+193,
  INTRN_CVTTSS2SI64	= LAST_COMMON_ID+194,
  INTRN_CVTSI2SD	= LAST_COMMON_ID+195,
  INTRN_CVTSI642SD	= LAST_COMMON_ID+196,
  INTRN_CVTSD2SI	= LAST_COMMON_ID+197,
  INTRN_CVTSD2SI64	= LAST_COMMON_ID+198,
  INTRN_CVTTSD2SI	= LAST_COMMON_ID+199,
  INTRN_CVTTSD2SI64	= LAST_COMMON_ID+200,
  INTRN_CVTDQ2PS	= LAST_COMMON_ID+201,
  INTRN_CVTPS2DQ	= LAST_COMMON_ID+202,
  INTRN_CVTTPS2DQ	= LAST_COMMON_ID+203,
  INTRN_CVTDQ2PD	= LAST_COMMON_ID+204,
  INTRN_CVTPD2DQ	= LAST_COMMON_ID+205,
  INTRN_CVTTPD2DQ	= LAST_COMMON_ID+206,
  INTRN_CVTPD2PS	= LAST_COMMON_ID+207,
  INTRN_CVTPS2PD	= LAST_COMMON_ID+208,
  INTRN_CVTSD2SS	= LAST_COMMON_ID+209,
  INTRN_CVTSS2SD	= LAST_COMMON_ID+210,
  INTRN_LOADUPS		= LAST_COMMON_ID+211,
  INTRN_STOREUPS	= LAST_COMMON_ID+212,
  INTRN_LOADUPD		= LAST_COMMON_ID+213,
  INTRN_STOREUPD	= LAST_COMMON_ID+214,
  INTRN_LOADHPS		= LAST_COMMON_ID+215,
  INTRN_STOREHPS	= LAST_COMMON_ID+216,
  INTRN_LOADLPS		= LAST_COMMON_ID+217,
  INTRN_STORELPS	= LAST_COMMON_ID+218,
  INTRN_MOVMSKPS	= LAST_COMMON_ID+219,
  INTRN_MOVMSKPD	= LAST_COMMON_ID+220,
  INTRN_MASKMOVDQU	= LAST_COMMON_ID+221,
  INTRN_MASKMOVQ	= LAST_COMMON_ID+222,
  INTRN_MOVNTPD		= LAST_COMMON_ID+223,
  INTRN_MOVNTI		= LAST_COMMON_ID+224,
  INTRN_STMXCSR		= LAST_COMMON_ID+225,
  INTRN_LDMXCSR		= LAST_COMMON_ID+226,
  INTRN_MOVSD           = LAST_COMMON_ID+227,
  INTRN_PSHUFLW         = LAST_COMMON_ID+228,
  INTRN_PSHUFHW         = LAST_COMMON_ID+229,
  INTRN_F8F8I4EXPEXPR   = LAST_COMMON_ID+230,
