 ...
 * $Author: marcel $
 * $Source: /kpro64/common/com/MIPS/config_asm.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *config_asm_rcs_id = "$Source: /kpro64/common/com/MIPS/config_asm.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
...
#define AS_DWORD	".long"
#define AS_DWORD_UNALIGNED ".long"
...
#define AS_ASCII	".ascii" // by ZHOU Xing for ppc32
#define AS_TEXT 	".text"
#define AS_TYPE         ".type"
