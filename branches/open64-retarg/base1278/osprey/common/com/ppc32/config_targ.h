...
#define Is_Target_PowerPC()	(Target==TARGET_POWERPC)
#define Is_Target_32bit() 	(TRUE)
...
#define Is_Target_ISA_P5()	(Target_ISA==TARGET_ISA_P5)

#define Is_Target_ISA_I5Plus()	(Target_ISA >= TARGET_ISA_I5)
