...
//  $Author: weitang $
//  $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/targ_info/isa/MIPS/isa_subset.cxx,v $
...
main()
{
  ...
  ISA_Subset_Begin("PPC32");
  ppc5 = ISA_Subset_Create(NULL,"POWERPC5");

  Instruction_Group(ppc5,
      TOP_lbz,
      TOP_lbzu,
      TOP_lhz,
      TOP_lhzu,
