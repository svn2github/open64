...
enum gt_types_enum {
 ...
 gt_ggc_e_8cp_lexer, 
 gt_ggc_e_26VEC_cp_token_position_heap, 
 gt_ggc_e_8cp_token, 
...
#define gt_ggc_m_26VEC_cp_token_position_heap(X) do { \
  if (X != NULL) gt_ggc_mx_VEC_cp_token_position_heap (X);\
  } while (0)
extern void gt_ggc_mx_VEC_cp_token_position_heap (void *);
#define gt_ggc_m_8cp_token(X) do { \
  if (X != NULL) gt_ggc_mx_cp_token (X);\
  } while (0)
...
#define gt_ggc_m_12nesting_info(X) do { \
  if (X != NULL) gt_ggc_mx_nesting_info (X);\
  } while (0)
extern void gt_ggc_mx_nesting_info (void *);
#define gt_ggc_m_11var_map_elt(X) do { \
  if (X != NULL) gt_ggc_mx_var_map_elt (X);\
  } while (0)
...
#define gt_ggc_m_12int_tree_map(X) do { \
  if (X != NULL) gt_ggc_mx_int_tree_map (X);\
  } while (0)
extern void gt_ggc_mx_int_tree_map (void *);
#define gt_ggc_m_6subvar(X) do { \
  if (X != NULL) gt_ggc_mx_subvar (X);\
  } while (0)
...
#define gt_ggc_m_10c_arg_info(X) do { \
  if (X != NULL) gt_ggc_mx_c_arg_info (X);\
  } while (0)
...
#define gt_ggc_m_25ipa_reference_vars_info_d(X) do { \
  if (X != NULL) gt_ggc_mx_ipa_reference_vars_info_d (X);\
  } while (0)
...
#define gt_ggc_m_17ssa_use_operand_d(X) do { \
  if (X != NULL) gt_ggc_mx_ssa_use_operand_d (X);\
  } while (0)
...
#define gt_pch_n_26VEC_cp_token_position_heap(X) do { \
  if (X != NULL) gt_pch_nx_VEC_cp_token_position_heap (X);\
  } while (0)
extern void gt_pch_nx_VEC_cp_token_position_heap (void *);
#define gt_pch_n_8cp_token(X) do { \
  if (X != NULL) gt_pch_nx_cp_token (X);\
  } while (0)
...
#define gt_pch_n_12nesting_info(X) do { \
  if (X != NULL) gt_pch_nx_nesting_info (X);\
  } while (0)
extern void gt_pch_nx_nesting_info (void *);
#define gt_pch_n_11var_map_elt(X) do { \
  if (X != NULL) gt_pch_nx_var_map_elt (X);\
  } while (0)
...
#define gt_pch_n_12int_tree_map(X) do { \
  if (X != NULL) gt_pch_nx_int_tree_map (X);\
  } while (0)
extern void gt_pch_nx_int_tree_map (void *);
#define gt_pch_n_6subvar(X) do { \
  if (X != NULL) gt_pch_nx_subvar (X);\
  } while (0)
...
#define gt_pch_n_10c_arg_info(X) do { \
  if (X != NULL) gt_pch_nx_c_arg_info (X);\
  } while (0)
...
#define gt_pch_n_25ipa_reference_vars_info_d(X) do { \
  if (X != NULL) gt_pch_nx_ipa_reference_vars_info_d (X);\
  } while (0)
...
#define gt_pch_n_17ssa_use_operand_d(X) do { \
  if (X != NULL) gt_pch_nx_ssa_use_operand_d (X);\
  } while (0)
...
extern void gt_pch_p_8cp_lexer
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_8cp_token
    (void *, void *, gt_pointer_operator, void *);
