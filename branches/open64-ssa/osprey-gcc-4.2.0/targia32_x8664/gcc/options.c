...
/* Set by -fi386-host.
   Internal flag indicating compilation host is i386  */
int key_i386_host;
...
int ix86_force_align_arg_pointer;
...
const struct cl_option cl_options[] =
{
  ...
  { "-fcxx-openmp",
    ...
    N_OPTS, 11, 191,
    CL_COMMON | CL_REPORT,
    &open64_cxx_openmp, CLVC_BOOLEAN, 0 },
  { "-fdata-sections",
    "Place data items into their own section",
    N_OPTS, 14, 192,
    CL_COMMON | CL_REPORT,
  ...
  { "-fhonor-shift",
    ...
    N_OPTS, 12, 238,
    CL_COMMON | CL_REPORT,
    &flag_honor_shift, CLVC_BOOLEAN, 0 },
  { "-fhonor-std",
    0,
    N_OPTS, 10, 239,
    CL_CXX | CL_ObjCXX,
  ...
  { "-mfma4",
    ...
    N_OPTS, 5, 480,
    CL_TARGET | CL_REPORT,
    &ix86_isa_flags, CLVC_BIT_SET, OPTION_MASK_ISA_FMA4 },
  { "-mfp-ret-in-387",
  ...
  { "-mno-avx",
    ...
    N_OPTS, 7, 0,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_REPORT,
    &ix86_isa_flags, CLVC_BIT_CLEAR, OPTION_MASK_ISA_AVX },
  { "-mno-fancy-math-387",
    0,
    N_OPTS, 18, -1,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_UNDOCUMENTED | CL_REPORT,
  ...
  { "-mno-fma4",
    ...
    N_OPTS, 8, 0,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_REPORT,
    &ix86_isa_flags, CLVC_BIT_CLEAR, OPTION_MASK_ISA_FMA4 },
  { "-mno-push-args",
    0,
    N_OPTS, 13, -1,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_UNDOCUMENTED | CL_REPORT,
  ...
  { "-mno-xfc",
    ...
    N_OPTS, 7, 0,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_REPORT,
    &ix86_isa_flags, CLVC_BIT_CLEAR, OPTION_MASK_ISA_XFC },
  { "-mno-xop",
    "Not support AMD XOP built-in functions and code generation",
    N_OPTS, 7, 0,
    CL_TARGET | CL_REJECT_NEGATIVE | CL_REPORT,
    &ix86_isa_flags, CLVC_BIT_CLEAR, OPTION_MASK_ISA_XOP },
  ...
  { "-msoft-float",
    ...
    N_OPTS, 11, 509,
    CL_C | CL_CXX | CL_ObjC | CL_ObjCXX | CL_TARGET,
  ...
  { "-msse4a",
    ...
    N_OPTS, 6, 516,
    CL_TARGET | CL_REPORT,
    &target_flags, CLVC_BIT_SET, MASK_SSE4A },
  { "-msseregparm",
  ...
  { "-mxfc",
    ...
    N_OPTS, 4, 526,
    CL_TARGET | CL_REPORT,
    &ix86_isa_flags, CLVC_BIT_SET, OPTION_MASK_ISA_XFC },
  { "-mxop",
    "Support AMD XOP built-in functions and code generation",
    N_OPTS, 4, 527,
    CL_TARGET | CL_REPORT,
    &ix86_isa_flags, CLVC_BIT_SET, OPTION_MASK_ISA_XOP },
  { "-nostdinc",
  ...
  { "-remap",
    ...
    0, CLVC_BOOLEAN, 0 },
  { "-spinfile",
    "-spinfile <file>        Place binary spin IR into <file>",
    N_OPTS, 8, -1,
    CL_C | CL_CXX | CL_COMMON | CL_SEPARATE,
    0, CLVC_BOOLEAN, 0 },
  { "-std=c++98",
