...
rtx
gen_rtx_fmt_uei (RTX_CODE code, enum machine_mode mode,
	rtx arg0,
	rtx arg1,
	int arg2)
{
...
rtx
gen_rtx_fmt_u (RTX_CODE code, enum machine_mode mode,
	rtx arg0)
{
  rtx rt;
  rt = rtx_alloc (code);
...
rtx
gen_rtx_fmt_ses (RTX_CODE code, enum machine_mode mode,
	const char *arg0,
	rtx arg1,
	const char *arg2)
{
...
rtx
gen_rtx_fmt_sss (RTX_CODE code, enum machine_mode mode,
	const char *arg0,
	const char *arg1,
	const char *arg2)
{
