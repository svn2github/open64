  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9lang_decl, gt_ggc_e_9lang_decl))
    {
      ...
      switch (((*x)).decl_flags.can_be_full)
        ...
        case 1:
          ...
          gt_pch_n_9tree_node ((*x).u.f.named_return_object);
          break;
        default:
          break;
        }
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9lang_type, gt_ggc_e_9lang_type))
    {
      switch (((*x).u).h.is_lang_type_class)
        ...
        case 1:
          ...
          gt_pch_n_9tree_node ((*x).u.c.copy_constructor);
          break;
        case 0:
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch (((*x)).decl_flags.can_be_full)
    ...
    case 1:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).u.f.named_return_object), cookie);
      break;
    default:
      break;
    }
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch (((*x).u).h.is_lang_type_class)
    ...
    case 1:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).u.c.copy_constructor), cookie);
      break;
    case 0:
      if ((void *)(x) == this_obj)
