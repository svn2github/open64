...
#define STRUCT_FIELD_TAG_CHECK(t)	TREE_CHECK (t, STRUCT_FIELD_TAG)
...
#define OMP_RETURN_CHECK(t)	TREE_CHECK (t, OMP_RETURN)
#define OMP_CONTINUE_CHECK(t)	TREE_CHECK (t, OMP_CONTINUE)
...
#define FREQ_HINT_STMT_CHECK(t)	TREE_CHECK (t, FREQ_HINT_STMT)
...
#define TINST_LEVEL_CHECK(t)	TREE_CHECK (t, TINST_LEVEL)
