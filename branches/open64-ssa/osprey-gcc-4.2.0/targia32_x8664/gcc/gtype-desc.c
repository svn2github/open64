...
void
gt_ggc_mx_int_tree_map (void *x_p)
{
  struct int_tree_map * const x = (struct int_tree_map *)x_p;
...
void
gt_ggc_mx_subvar (void *x_p)
{
  struct subvar * const x = (struct subvar *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_9tree_node ((*x).var);
      gt_ggc_m_6subvar ((*x).next);
    }
}
  ...
  while (x != xlimit)
    {
      ...
      gt_ggc_m_9tree_node ((*x).call_stmt);
      x = ((*x).next_caller);
    }
}
...
gt_ggc_mx_edge_prediction (void *x_p)
{
  ...
  while (ggc_test_and_set_mark (xlimit))
   xlimit = ((*xlimit).ep_next);
  while (x != xlimit)
    {
      gt_ggc_m_15edge_prediction ((*x).ep_next);
      gt_ggc_m_8edge_def ((*x).ep_edge);
      x = ((*x).ep_next);
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_7rtx_def ((*x).x_stack_check_probe_note);
      ...
      gt_ggc_m_18VEC_temp_slot_p_gc ((*x).x_used_temp_slots);
      ...
      gt_ggc_m_11VEC_tree_gc ((*x).ib_boundaries_block);
      gt_ggc_m_9tree_node ((*x).unexpanded_var_list);
      gt_ggc_m_9tree_node ((*x).stack_protect_guard);
    }
}
...
void
gt_ggc_mx_ssa_use_operand_d (void *x_p)
{
  struct ssa_use_operand_d * const x = (struct ssa_use_operand_d *)x_p;
  if (ggc_test_and_set_mark (x))
    {
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      switch (ann_type ((tree_ann_t)&((*x))))
        ...
        case VAR_ANN:
          ...
          gt_ggc_m_11VEC_tree_gc ((*x).vdecl.may_aliases);
          gt_ggc_m_9tree_node ((*x).vdecl.current_def);
          gt_ggc_m_6subvar ((*x).vdecl.subvars);
          break;
        case FUNCTION_ANN:
          break;
        case STMT_ANN:
          gt_ggc_m_15basic_block_def ((*x).stmt.bb);
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_7rtx_def ((*x).force_align_arg_pointer);
    }
}
...
void
gt_ggc_m_P12int_tree_map4htab (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      if ((*x).entries != NULL) {
        ...
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
          gt_ggc_m_12int_tree_map ((*x).entries[i0]);
        }
        ggc_mark ((*x).entries);
      }
    }
...
void
gt_pch_nx_int_tree_map (void *x_p)
{
  struct int_tree_map * const x = (struct int_tree_map *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_12int_tree_map, gt_ggc_e_12int_tree_map))
    {
...
void
gt_pch_nx_subvar (void *x_p)
{
  struct subvar * const x = (struct subvar *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_6subvar, gt_ggc_e_6subvar))
    {
      gt_pch_n_9tree_node ((*x).var);
      gt_pch_n_6subvar ((*x).next);
    }
}
...
{
  struct cgraph_varpool_node * const x = (struct cgraph_varpool_node *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_19cgraph_varpool_node, gt_ggc_e_19cgraph_varpool_node))
    {
  ...
  while (x != xlimit)
    {
      ...
      gt_pch_n_9tree_node ((*x).call_stmt);
...
gt_pch_nx_edge_prediction (void *x_p)
{
  struct edge_prediction * x = (struct edge_prediction *)x_p;
  struct edge_prediction * xlimit = x;
  while (gt_pch_note_object (xlimit, xlimit, gt_pch_p_15edge_prediction, gt_ggc_e_15edge_prediction))
   xlimit = ((*xlimit).ep_next);
  while (x != xlimit)
    {
      gt_pch_n_15edge_prediction ((*x).ep_next);
      gt_pch_n_8edge_def ((*x).ep_edge);
      x = ((*x).ep_next);
    }
}
...
{
  struct expr_status * const x = (struct expr_status *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_11expr_status, gt_ggc_e_11expr_status))
    {
...
{
  struct emit_status * const x = (struct emit_status *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_11emit_status, gt_ggc_e_11emit_status))
    {
      ...
      if ((*x).regno_pointer_align != NULL) {
        ...
        gt_pch_note_object ((*x).regno_pointer_align, x, gt_pch_p_11emit_status, gt_types_enum_last);
      }
      if ((*x).x_regno_reg_rtx != NULL) {
        size_t i1;
        for (i1 = 0; i1 != (size_t)(((*x)).x_reg_rtx_no); i1++) {
        ...
        gt_pch_note_object ((*x).x_regno_reg_rtx, x, gt_pch_p_11emit_status, gt_types_enum_last);
      }
    }
}
...
{
  struct var_refs_queue * const x = (struct var_refs_queue *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_14var_refs_queue, gt_ggc_e_14var_refs_queue))
    {
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_8function, gt_ggc_e_8function))
    {
      ...
      gt_pch_n_7rtx_def ((*x).x_stack_check_probe_note);
      ...
      gt_pch_n_18VEC_temp_slot_p_gc ((*x).x_used_temp_slots);
      ...
      gt_pch_n_11VEC_tree_gc ((*x).ib_boundaries_block);
      gt_pch_n_9tree_node ((*x).unexpanded_var_list);
      gt_pch_n_S ((*x).hot_section_label);
      gt_pch_n_S ((*x).cold_section_label);
      gt_pch_n_S ((*x).hot_section_end_label);
      gt_pch_n_S ((*x).cold_section_end_label);
      gt_pch_n_S ((*x).unlikely_text_section_name);
      gt_pch_n_9tree_node ((*x).stack_protect_guard);
    }
}
...
void
gt_pch_nx_ssa_use_operand_d (void *x_p)
{
  struct ssa_use_operand_d * const x = (struct ssa_use_operand_d *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_17ssa_use_operand_d, gt_ggc_e_17ssa_use_operand_d))
    {
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_10tree_ann_d, gt_ggc_e_10tree_ann_d))
    {
      switch (ann_type ((tree_ann_t)&((*x))))
        ...
        case VAR_ANN:
          ...
          gt_pch_n_11VEC_tree_gc ((*x).vdecl.may_aliases);
          gt_pch_n_9tree_node ((*x).vdecl.current_def);
          gt_pch_n_6subvar ((*x).vdecl.subvars);
          break;
        case FUNCTION_ANN:
          break;
        case STMT_ANN:
          gt_pch_n_15basic_block_def ((*x).stmt.bb);
...
{
  struct convert_optab * const x = (struct convert_optab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_13convert_optab, gt_ggc_e_13convert_optab))
    {
      {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(NUM_MACHINE_MODES); i0++) {
...
{
  struct optab * const x = (struct optab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_5optab, gt_ggc_e_5optab))
    {
      {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(NUM_MACHINE_MODES); i0++) {
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_16machine_function, gt_ggc_e_16machine_function))
    {
      ...
      gt_pch_n_7rtx_def ((*x).force_align_arg_pointer);
    }
}
...
{
  struct location_s * const x = (struct location_s *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_10location_s, gt_ggc_e_10location_s))
    {
      gt_pch_n_S ((*x).file);
    }
}
...
void
gt_pch_n_P12int_tree_map4htab (void *x_p)
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P12int_tree_map4htab, gt_e_P12int_tree_map4htab))
    {
      if ((*x).entries != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
          gt_pch_n_12int_tree_map ((*x).entries[i0]);
        }
        gt_pch_note_object ((*x).entries, x, gt_pch_p_P12int_tree_map4htab, gt_types_enum_last);
      }
    }
}
...
{
  struct htab * const x = (struct htab *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_P19cgraph_varpool_node4htab, gt_e_P19cgraph_varpool_node4htab))
    {
      if ((*x).entries != NULL) {
        size_t i0;
        for (i0 = 0; i0 != (size_t)(((*x)).size); i0++) {
        ...
        gt_pch_note_object ((*x).entries, x, gt_pch_p_P19cgraph_varpool_node4htab, gt_types_enum_last);
      }
    }
}
...
void
gt_pch_p_12int_tree_map (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct int_tree_map * const x ATTRIBUTE_UNUSED = (struct int_tree_map *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).to), cookie);
}

void
gt_pch_p_6subvar (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct subvar * const x ATTRIBUTE_UNUSED = (struct subvar *)x_p;
  if ((void *)(x) == this_obj)
    op (&((*x).var), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).next), cookie);
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_stack_check_probe_note), cookie);
  if ((void *)(x) == this_obj)
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).hot_section_label), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).cold_section_label), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).hot_section_end_label), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).cold_section_end_label), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).unlikely_text_section_name), cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).stack_protect_guard), cookie);
}
...
void
gt_pch_p_17ssa_use_operand_d (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ssa_use_operand_d * const x ATTRIBUTE_UNUSED = (struct ssa_use_operand_d *)x_p;
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch (ann_type ((tree_ann_t)&((*x))))
    ...
    case VAR_ANN:
      ...
      if ((void *)(x) == this_obj)
        op (&((*x).vdecl.may_aliases), cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).vdecl.current_def), cookie);
      if ((void *)(x) == this_obj)
        op (&((*x).vdecl.subvars), cookie);
      break;
    case FUNCTION_ANN:
      break;
    case STMT_ANN:
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).force_align_arg_pointer), cookie);
}
...
void
gt_pch_p_P12int_tree_map4htab (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
...
const struct ggc_root_tab gt_ggc_r_gtype_desc_c[] = {
  ...
  },
  {
    ...
    1,
    sizeof (default_defs),
    &gt_ggc_m_P12int_tree_map4htab,
    &gt_pch_n_P12int_tree_map4htab
  },
  {
    &referenced_vars,
    1,
  ...
  },
  {
    ...
    1,
    sizeof (cgraph_varpool_last_needed_node),
    &gt_ggc_mx_cgraph_varpool_node,
    &gt_pch_nx_cgraph_varpool_node
  },
  {
    ...
    1,
    sizeof (cgraph_varpool_first_unanalyzed_node),
    &gt_ggc_mx_cgraph_varpool_node,
    &gt_pch_nx_cgraph_varpool_node
  },
  {
