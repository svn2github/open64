...
extern rtx gen_rtx_fmt_ue	 (RTX_CODE, enum machine_mode mode,
				       rtx arg0, rtx arg1);
extern rtx gen_rtx_fmt_uei	 (RTX_CODE, enum machine_mode mode,
				       rtx arg0, rtx arg1, int arg2);
...
extern rtx gen_rtx_fmt_e0	 (RTX_CODE, enum machine_mode mode,
				       rtx arg0);
extern rtx gen_rtx_fmt_u	 (RTX_CODE, enum machine_mode mode,
				       rtx arg0);
...
extern rtx gen_rtx_fmt_ses	 (RTX_CODE, enum machine_mode mode,
				       ...
				       const char *arg2);
extern rtx gen_rtx_fmt_sss	 (RTX_CODE, enum machine_mode mode,
				       const char *arg0, const char *arg1,
				       const char *arg2);
...
#define gen_rtx_DEPS_LIST(MODE, ARG0, ARG1, ARG2) \
  gen_rtx_fmt_uei (DEPS_LIST, (MODE), (ARG0), (ARG1), (ARG2))
