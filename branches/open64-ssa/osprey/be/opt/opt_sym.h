...
private:
  ...
  WSSA::WSSA_ST_IDX   wssa_st_idx;          // wssa_st_idx.used in wssa
  ...
  void     Set_aux_id_list(AUX_ID_LIST *a) 
    { _aux_id_list = a; }
  void     Set_wssa_st_idx(WSSA::WSSA_ST_IDX idx) {wssa_st_idx = idx;}
  WSSA::WSSA_ST_IDX    Get_wssa_st_idx()          {return wssa_st_idx;}
