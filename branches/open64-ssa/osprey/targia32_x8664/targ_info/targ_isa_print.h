...
#define ISA_PRINT_BEGIN_BUNDLE          ("")
#define ISA_PRINT_END_BUNDLE            (";")

typedef enum {
  ISA_PRINT_COMP_end    = 0,  /* End of list marker */
  ISA_PRINT_COMP_name   = 1,  /* Instruction name */
  ISA_PRINT_COMP_segment = 2,  /* Address segment prefix */
  ISA_PRINT_COMP_opnd   = 3,  /* OPND+n => operand n */
  ISA_PRINT_COMP_result = 11,  /* RESULT+n => result n */
  ISA_PRINT_COMP_MAX    = 12   /* Last component */
} ISA_PRINT_COMP;
...
extern const ISA_PRINT_INFO ISA_PRINT_info[117];

extern const unsigned char ISA_PRINT_info_index[3311];
