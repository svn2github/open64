...
#define ISA_EXEC_PROPERTY_Fetch_Unit      (0x1)
...
#define ISA_MAX_BUNDLES 1

extern const ISA_EXEC_UNIT_PROPERTY ISA_EXEC_unit_prop[];

#define EXEC_PROPERTY_is_Fetch_Unit(t)	 (ISA_EXEC_unit_prop[(INT)t] & ISA_EXEC_PROPERTY_Fetch_Unit)
...
typedef enum {
  ...
  ISA_BUNDLE_PACK_COMP_template  = 1,  /* Template */
  ISA_BUNDLE_PACK_COMP_slot      = 2,  /* SLOT+n => slot n */
  ISA_BUNDLE_PACK_COMP_MAX       = 2   /* Last component */
