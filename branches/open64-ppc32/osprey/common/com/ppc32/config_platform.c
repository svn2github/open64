 ...
 * $Author: marcel $
 * $Source: /kpro64/common/com/ppc32/config_platform.c,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/ppc32/config_platform.c,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
...
static PLATFORM_OPTIONS PF_Opts[] =
{
   ...
   */
  { IP0, "ip??", "powerpc", PROC_POWERPC, "PowerPC" },
