 ...
 * Module: config_asm.h
 * $Revision: 1.2 $
 * $Date: 03/04/03 23:37:43-00:00 $
 * $Author: jliu@keyresearch.com $
 * $Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/com/x8664/SCCS/s.config_asm.h $
 *
 * Revision history:
 *
 * Description:
...
#ifdef _KEEP_RCS_ID
static char *config_asm_rcs_id = "$Source: /scratch/mee/Patch0002-taketwo/kpro64-pending/common/com/x8664/SCCS/s.config_asm.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
...
#define C_Global_Static_Format	"GS_%s"	   /* statics in global scope */
#define C_Local_Static_Format	"LS_%1d.%s"/* statics in local scope  */
#define Deferred_Ref_Format	"%s"	   /* eg: "name"              */
#define Deferred_Ref_Ofst_Format "%s%c%d"  /* eg: "name" '-' offset   */
#define Local_Ret_Buf_Format	"%s_RBUF"  /* eg: "func.RBUF"         */
