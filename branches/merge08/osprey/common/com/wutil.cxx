...
#include "wutil90.h"
  ...
  INTRN_SBUF_OFFSET,            "INTRN_SBUF_OFFSET",

  INTRN_C2_MVGR_R2G,    "C2_MVGR_R2G",
  INTRN_C2_MVGR_G2R,    "C2_MVGR_G2R",
  INTRN_C2_MVGR_G2S,    "C2_MVGR_G2S",
  INTRN_C2_MVGR_S2G,    "C2_MVGR_S2G",
  INTRN_C2_MVGC_C2G,    "C2_MVGC_C2G",
  INTRN_C2_MVGC_G2C,    "C2_MVGC_G2C",
  INTRN_C2_LD_V,    "C2_LD_V",
  INTRN_C2_LD_G,    "C2_LD_G",
  INTRN_C2_LD_S,    "C2_LD_S",
  INTRN_C2_ST_V,    "C2_ST_V",
  INTRN_C2_ST_G,    "C2_ST_G",
  INTRN_C2_LD_G_IMM,    "C2_LD_G_IMM",
  INTRN_C2_LD_C_IMM,    "C2_LD_C_IMM",
  INTRN_C2_LD_V_IMM,    "C2_LD_V_IMM",
  INTRN_C2_ST_V_IMM,    "C2_ST_V_IMM",
  INTRN_C2_ST_C_IMM,    "C2_ST_C_IMM",
  INTRN_C2_ST_G_IMM,    "C2_ST_G_IMM",
  INTRN_C2_VADDS,    "C2_VADDS",
  INTRN_C2_VSUBS,    "C2_VSUBS",
  INTRN_C2_VMUL,    "C2_VMUL",
  INTRN_C2_VNEG,    "C2_VNEG",
  INTRN_C2_VMACS,    "C2_VMACS",
  INTRN_C2_VSHFT,    "C2_VSHFT",
  INTRN_C2_VCLP,    "C2_VCLP",
  INTRN_C2_VCLG,    "C2_VCLG",
  INTRN_C2_VCMOV,    "C2_VCMOV",
  INTRN_C2_LCZERO,    "C2_LCZERO",
  INTRN_C2_VRND,    "C2_VRND",
  INTRN_C2_VSPAS,    "C2_VSPAS",
  INTRN_C2_VSPEL,    "C2_VSPEL",
  INTRN_C2_MMUL_S123,    "C2_MMUL_S123",
  INTRN_C2_MMUL,    "C2_MMUL_S4",
  INTRN_C2_VMOV,    "C2_VMOV",
  INTRN_C2_VCOPY,   " C2_VCOPY", 
  INTRN_C2_VCMPR,    "C2_VCMPR",
  INTRN_C2_SAD,    "C2_SAD",
  INTRN_C2_SATD,    "C2_SATD",
  INTRN_C2_INTRA,    "C2_INTRA",
  INTRN_C2_MVSEL,    "C2_MVSEL",
  INTRN_C2_BCST,    "C2_BCST",
  INTRN_C2_VLCS,    "C2_VLCS",
  INTRN_C2_VLCS_R,    "C2_VLCS_R",
  INTRN_C2_ADDS,    "C2_ADDS",
  INTRN_C2_ADDS_R,    "C2_ADDS_R",
  INTRN_C2_SUBS,    "C2_SUBS",
  INTRN_C2_SUBS_R,    "C2_SUBS_R",
  INTRN_C2_MULS,    "C2_MULS",
  INTRN_C2_MULS_R,    "C2_MULS_R",
  INTRN_C2_MADS,    "C2_MADS",
  INTRN_C2_SMADS,    "C2_SMADS",
  INTRN_C2_MINMAX,    "C2_MINMAX",
  INTRN_C2_CMOV,    "C2_CMOV",
  INTRN_C2_MOV,    "C2_MOV",
  INTRN_C2_MOV_R,    "C2_MOV_R",
  INTRN_C2_CLP,    "C2_CLP",
  INTRN_C2_CHKRNG,    "C2_CHKRNG",
  INTRN_C2_SCOND,    "C2_SCOND",
  INTRN_C2_SCOND_R, "C2_SCOND_R",
  INTRN_C2_BOP,    "C2_BOP",
  INTRN_C2_BDEP,    "C2_BDEP",
  INTRN_C2_BXTR,    "C2_BXTR",
  INTRN_C2_BXTRR48,    "C2_BXTRR48",
  INTRN_C2_SUM4,    "C2_SUM4",
  INTRN_C2_SUM4_R,    "C2_SUM4_R",
  INTRN_C2_MED,      "C2_MED",
  INTRN_C2_FORK,    "C2_FORK",
  INTRN_C2_JOINT,    "C2_JOINT",
  INTRN_C2_LD_V2G,  "C2_LD_V2G",
  INTRN_C2_ST_G2V,  "C2_ST_G2V", 
  INTRN_C2_LD_V2G_IMM, "C2_LD_V2G_IMM",
  INTRN_C2_ST_G2V_IMM,  "C2_ST_G2V_IMM", 
  INTRN_C2_MVGR_R2S,   "C2_MVGR_R2S", 
  INTRN_C2_GSUMS,      "C2_GSUMS",
  INTRN_C2_WRAP,      "C2_WRAP",
  INTRN_C2_CLZOB,      "C2_CLZOB",
  INTRN_C2_THCTRL,      "C2_THCTRL",
  INTRN_C2_SCOND_R_WB, "C2_SCOND_R_WB",
  INTRN_C2_VSPEL_MAC,    "C2_VSPEL_MAC",
  INTRN_C2_SUM3_SADDR,   "C2_SUM3_SADDR",
  INTRN_PERIPHERAL_RW_BEGIN,  "PERIPHERAL_RW_BEGIN", 
  INTRN_PERIPHERAL_RW_END,     "PERIPHERAL_RW_END", 
  INTRN_VBUF_ABSOLUTE,       "INTRN_VBUF_ABSOLUTE",
  INTRN_MUL_SHIFT_HI, "INTRN_MUL_SHIFT_HI",
  INTRN_MUL_SHIFT, "INTRN_MUL_SHIFT",
  INTRN_C3_LEAD, "INTRN_C3_LEAD",
  INTRN_C3_MAC, "INTRN_C3_MAC",
  INTRN_C3_MACN, "INTRN_C3_MACN",
  INTRN_C3_ROUND, "INTRN_C3_ROUND",
  INTRN_C3_SAADDS, "INTRN_C3_SAADDS",
  INTRN_C3_SASUBS, "INTRN_C3_SASUBS",
  INTRN_C3_MULA, "INTRN_C3_MULA",
  INTRN_C3_INIT_ACC, "INTRN_C3_INIT_ACC",
  INTRN_C3_SAVE_ACC, "INTRN_C3_SAVE_ACC",
  INTRN_C3_TRBACK, "INTRN_C3_TRBACK",
  INTRN_MPY_32_16, "INTRN_MPY_32_16",
  INTRN_C3_MACD, "INTRN_C3_MACD",
  INTRN_C3_SAADDSH, "INTRN_C3_SAADDSH",
  INTRN_C3_SASUBSH, "INTRN_C3_SASUBSH",
  INTRN_C3_MVFS, "INTRN_C3_MVFS",
  INTRN_C3_INIT_ADDR, "INTRN_C3_INIT_ADDR",
  INTRN_C3_SAVE_ADDR, "INTRN_C3_SAVE_ADDR",
  INTRN_C3_MAC_A, "INTRN_C3_MAC_A",
  INTRN_C3_MACN_A, "INTRN_C3_MACN_A",
  INTRN_C3_DMAC_A, "INTRN_C3_DMAC_A",
  INTRN_C3_DMACN_A, "INTRN_C3_DMACN_A",
  INTRN_C3_INIT_DACC, "INTRN_C3_INIT_DACC",
  INTRN_C3_SAVE_DACC, "INTRN_C3_SAVE_DACC",
  INTRN_C3_SAADDH_A, "INTRN_C3_SAADDH_A",
  INTRN_C3_SASUBH_A,  "INTRN_C3_SASUBH_A",
  INTRN_C3_SAMULSH, "INTRN_C3_SAMULSH",
  INTRN_C3_MULA_A, "INTRN_C3_MULA_A",
  INTRN_C3_SAMULH_A, "INTRN_C3_SAMULH_A",
  INTRN_C3_PTR, "INTRN_C3_PTR",
  INTRN_C3_MAC_AR, "INTRN_C3_MAC_AR",
  INTRN_C3_MACN_AR, "INTRN_C3_MACN_AR",
  INTRN_C3_MULA_AR, "INTRN_C3_MULA_AR",
  INTRN_C3_INIT_PTR, "INTRN_C3_INIT_PTR",
  INTRN_C3_VITERBI, "INTRN_C3_VITERBI",
  INTRN_C3_DMULT, "INTRN_C3_DMULT",
  INTRN_C3_DMULT_A, "INTRN_C3_DMULT_A",
  INTRN_C3_DMULTN, "INTRN_C3_DMULTN",
  INTRN_C3_DMULTN_A, "INTRN_C3_DMULTN_A",
  INTRN_SET_CIRCBUF, "INTRN_SET_CIRCBUF",
  INTRN_RESET_CIRCBUF, "INTRN_RESET_CIRCBUF",
  INTRN_C3_DADD, "INTRN_C3_DADD",
  INTRN_C3_DSUB, "INTRN_C3_DSUB",
  INTRN_C3_FFT,  "INTRN_C3_FFT",
  INTRN_C3_FFTLD,  "INTRN_C3_FFTLD",
  INTRN_C3_FFTST,  "INTRN_C3_FFTST",
  INTRN_DEPOSIT,  "INTRN_DEPOSIT",
  INTRN_EXTRACT,  "INTRN_EXTRACT",
  INTRN_C3_BITR, "INTRN_C3_BITR",
  INTRN_C3_DMAC, "INTRN_C3_DMAC",
  INTRN_C3_DMACN, "INTRN_C3_DMACN",
  INTRN_C3_LOAD, "INTRN_C3_LOAD",
  INTRN_C3_STORE, "INTRN_C3_STORE",
  INTRN_C3_REVB, "INTRN_C3_REVB",
  INTRN_C3_DSHL_I, "INTRN_C3_DSHL_I",
  INTRN_C3_DSHR_I, "INTRN_C3_DSHR_I",
  INTRN_C3_MAC_I, "INTRN_C3_MAC_I",
  INTRN_C3_MACN_I, "INTRN_C3_MACN_I",
  INTRN_C3_MULA_I, "INTRN_C3_MULA_I",
  INTRN_C3_SAADD_A, "INTRN_C3_SAADD_A",
  INTRN_C3_SADDHA, "INTRN_C3_SADDHA",
  INTRN_C3_SAADDHA_A, "INTRN_C3_SAADDHA_A",
  INTRN_C3_SASUB_A, "INTRN_C3_SASUB_A",
  INTRN_C3_COPY_ADDR, "INTRN_C3_COPY_ADDR",
  INTRN_C3_SET_ADDR, "INTRN_C3_SET_ADDR",
  INTRN_CVT64_HIGH,   "INTRN_CVT64_HIGH", 
  INTRN_CVT64_LOW,    "INTRN_CVT64_LOW", 
  INTRN_CVT32,    "INTRN_CVT32",
  INTRN_LONGLONG_CVT64_HIGH,   "INTRN_LONGLONG_CVT64_HIGH", 
  INTRN_LONGLONG_CVT64_LOW,    "INTRN_LONGLONG_CVT64_LOW", 
  INTRN_MUL_SHIFT_HI_U, "INTRN_MUL_SHIFT_HI_U",
  INTRN_EXTRACTU, "INTRN_EXTRACTU", 
  INTRN_MUL_SHIFT_U, "INTRN_MUL_SHIFT_U",
  // new c3 
  INTRN_C3AADDA, "INTRN_C3AADDA",
  INTRN_C3BITR,"INTRN_C3BITR",
  INTRN_C3CS, "INTRN_C3CS",
  INTRN_C3DADD, "INTRN_C3DADD",
  INTRN_C3DMAC, "INTRN_C3DMAC",
  INTRN_C3DMAC_A, "INTRN_C3DMAC_A",
  INTRN_C3DMULA, "INTRN_C3DMULA",
  INTRN_C3DMULA_A, "INTRN_C3DMULA_A",
  INTRN_C3DSHLL_I, "INTRN_C3DSHLL_I",
  INTRN_C3FFE, "INTRN_C3FFE",
  INTRN_C3LD, "INTRN_C3LD",
  INTRN_C3ST, "INTRN_C3ST",
  INTRN_C3LEAD, "INTRN_C3LEAD",
  INTRN_C3MAC, "INTRN_C3MAC",
  INTRN_C3MAC_A, "INTRN_C3MAC_A",
  INTRN_C3MAC_AR, "INTRN_C3MAC_AR",
  INTRN_C3MAC_I, "INTRN_C3MAC_I",
  INTRN_C3MULA, "INTRN_C3MULA",
  INTRN_C3MULA_A, "INTRN_C3MULA_A",
  INTRN_C3MULA_AR, "INTRN_C3MULA_AR",
  INTRN_C3MULA_I, "INTRN_C3MULA_I",
  INTRN_C3MULS, "INTRN_C3MULS",
  INTRN_C3MULUS, "INTRN_C3MULUS",
  INTRN_C3REVB, "INTRN_C3REVB",
  INTRN_C3ROUND, "INTRN_C3ROUND",
  INTRN_C3SAADD_A, "INTRN_C3SAADD_A",
  INTRN_C3SAADDH_A, "INTRN_C3SAADDH_A",
  INTRN_C3SAADDS, "INTRN_C3SAADDS",
  INTRN_C3SAADDSH, "INTRN_C3SAADDSH",
  INTRN_C3SADDA, "INTRN_C3SADDA",
  INTRN_C3SADDA_A, "INTRN_C3SADDA_A",
  INTRN_C3SAMULH_A, "INTRN_C3SAMULH_A",
  INTRN_C3SAMULSH, "INTRN_C3SAMULSH",
  INTRN_C3SHAV, "INTRN_C3SHAV",
  INTRN_C3SHLAFA_I, "INTRN_C3SHLAFA_I",
  INTRN_C3SHLATA_I, "INTRN_C3SHLATA_I",
  INTRN_C3SHLA_I, "INTRN_C3SHLA_I",
  INTRN_C3SUBC, "INTRN_C3SUBC",
  INTRN_C3NEGA, "INTRN_C3NEGA",
  INTRN_INIT_HI, "INTRN_INIT_HI",
  INTRN_COPY_HI, "INTRN_COPY_HI",
  // end 
#endif // TARG_SL
  INTRN_EXPECT, "INTRN_EXPECT",
