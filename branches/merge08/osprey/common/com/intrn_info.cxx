...
const intrn_info_t intrn_info[INTRINSIC_LAST+1] = {
  ...
  { /* U8READFRAMEPOINTER */
    ...
    { /* APPLY_ARGS */
	BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC,
...
//	IRETURN_F8, NULL, "DTAN", "tan"},
  ...
  { /* C2_SCOND_OP */
	NOT_BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
	IRETURN_I4, "c2_operator_scond", "C2_OPERATOR_SCOND", NULL},		
  { /* C2_SCOND_OP_R */
	NOT_BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
	IRETURN_I4, "c2_operator_scond_r", "C2_OPERATOR_SCOND_R", NULL},		
  { /* C2_BR_F */
	NOT_BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
	IRETURN_V, "c2_br_f", "C2_BR_F", NULL},	
  { /* C2_BR_T */
	NOT_BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
	IRETURN_V, "c2_br_t", "C2_BR_T", NULL},	
  { /* C2_FORK */
	NOT_BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
  ...
  { /* C2_THCTRL*/
	NOT_BYVAL, PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
...
{ /* C2_THREAD_MAJOR */
	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
	IRETURN_I4, "c2_thread_major", "c2_thread_major", NULL},
{ /* C2_THREAD_MINOR */
	BYVAL, NOT_PURE, SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
	IRETURN_I4, "c2_thread_minor", "c2_thread_minor", NULL},
{ /* PERIPHERAL_RW_BEGIN */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
...
{ /*C3_MULAD*/
       BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
       IRETURN_I4, "c3_mulad", "C3_MULAD", NULL},     
{ /*C3_SAADDSH*/
       BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, 
...
{ /*SET_CIRCBUF*/
       BYVAL, PURE, SIDEEFFECTS, NEVER_RETURN, NOT_ACTUAL, CGINTRINSIC, 
...
{ /*C3_FFTST*/
       BYVAL, PURE, NO_SIDEEFFECTS, NEVER_RETURN, NOT_ACTUAL, CGINTRINSIC, 
...
{ /*UNSIGNED MULTIPLY AND SHIFT*/
  ...
  { /* TRAP */
	NOT_BYVAL, NOT_PURE, SIDEEFFECTS, NEVER_RETURN, NOT_ACTUAL, CGINTRINSIC,
  ...
  { /* GETSHAREDMEM */
	BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, ACTUAL, NOT_CGINTRINSIC,
