...
/* Super Computing ABI Intrinsics */
  ...
  INTRN_SL2_BEGIN = INTRN_VBUF_OFFSET,
  INTRN_SBUF_OFFSET   ,
  INTRN_C2_MVGR_R2G ,
  INTRN_C2_MVGR_G2R ,
  INTRN_C2_MVGR_G2S ,
  ...
  INTRN_C2_SUM4_R, 
  INTRN_C2_MED ,
  INTRN_OP_C2_SCOND_BR ,
  INTRN_OP_C2_SCOND_BR_R ,
  INTRN_C2_BR_F ,
  INTRN_C2_BR_T ,
  INTRN_C2_FORK ,
  INTRN_C2_JOINT ,
  ...
  INTRN_C2_VSPEL_MAC ,
  INTRN_C2_SUM3_SADDR ,
  INTRN_C2_THREAD_MAJOR, 
  INTRN_C2_THREAD_MINOR ,
  ...
  INTRN_EXTRACTU ,
  INTRN_MUL_SHIFT_U ,
  INTRN_C3_INTRINSIC_END = INTRN_MUL_SHIFT_U ,
#endif // TARG_X8664
