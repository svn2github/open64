...
static const char rcs_id[] = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/targ_info/access/ti_res_res.c,v $ $Revision: 1.1 $";
...
#if defined(TARG_SL2)
void TI_RES_RES_Reserve_Alternative_Resources(
  TI_RES_RES  *res,
  TOP          opcode,
  INT          cycle
)
