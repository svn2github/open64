...
#ifdef TARG_MIPS
//bug, it doesn't work now.
BOOL 
CGTARG_Can_Fit_Displacement_In_Branch_Instruction (INT64 disp){
 return true;
}
#endif
...
//     
  ...
  if(operand && TN_is_register(operand) && TN_register_class(operand) == ISA_REGISTER_CLASS_cop_vreg)
  {
    *latency = 2;
  } 
#endif
