 ...
 *  $Source: /scratch/mee/2.4-65/kpro64-pending/be/cg/SCCS/s.ebo.cxx $
 *
 *  Revision comments:
 *
...
/* ===================================================================== */
#if defined(TARG_SL)
/* set ebo default level to 0 for walkaround deposit bug */
