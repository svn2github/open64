...
extern void lang_check_failed (const char* file, int line, const char* function);
...
gcc2gs (int code)
{
 ...
 // GCC Specific tree codes: return ;
   ...
   case CHAR_TYPE: return GS_CHAR_TYPE;
   ...
   case FILE_TYPE: return GS_FILE_TYPE;
...
ix86_builtins2gsbi_ts (enum ix86_builtins code) 
{
  switch (code) {
    ...
    case IX86_BUILTIN_CMPNEPS: return GSBI_IX86_BUILTIN_CMPNEPS;
    ...
    case IX86_BUILTIN_CMPNESS: return GSBI_IX86_BUILTIN_CMPNESS;
...
gs_x_1 (tree t, HOST_WIDE_INT seq_num)
{
  ...
  if ((gs_t) GS_NODE (t) != (gs_t) NULL) {
	...
	(tcode == BOOLEAN_TYPE || tcode == CHAR_TYPE ||
  ...
  switch (TREE_CODE_CLASS (TREE_CODE (t)))
	...
	case PARM_DECL:
	  ...
	  gs_set_operand((gs_t) GS_NODE(t), GS_DECL_ARG_TYPE_AS_WRITTEN,
		      gs_x_1(DECL_ARG_TYPE_AS_WRITTEN(t), seq_num));
	  gs_set_operand((gs_t) GS_NODE(t), GS_DECL_VALUE_EXPR,
		     gs_x_1(DECL_VALUE_EXPR(t), seq_num));
	  _gs_bv (flags, GS_DECL_TRANSPARENT_UNION, DECL_TRANSPARENT_UNION (t));
	  break;
	...
	if (gs_operand((gs_t) GS_NODE(t), GS_CP_DECL_FLAGS) == NULL) {
	  ...
	  gs_set_operand ((gs_t) GS_NODE (t), GS_CP_DECL_FLAGS, cp_decl_flags);
        ...
        // if (TREE_CODE (t) == FUNCTION_DECL || TREE_CODE (t) == VAR_DECL)
	//   gs_set_operand ((gs_t) GS_NODE (t), GS_DECL_TEMPLATE_INFO, gs_x (DECL_TEMPLATE_INFO (t)));
