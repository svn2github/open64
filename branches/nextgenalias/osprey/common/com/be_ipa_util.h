...
private:
...
#if 0
  // Constraint graph summary for Nystrom Alias Analyzer 
  // TODO: Do we really need the entry size info?  Isn't that what the
  //       version info is for?
  //  mUINT32 mod_ref_info_entsize;
  ...
  mUINT32 _constraint_graph_nodeids_entry_size;
...
#if 0
  void SetCGNodesEntrySize(mINT32 s) 
  { _constraint_graph_nodes_entry_size = s; }
  void SetCGStInfosEntrySize(mINT32 s) 
  { _constraint_graph_stinfos_entry_size = s; }
  void SetCGCallsitesEntrySize(mINT32 s) 
  { _constraint_graph_callsites_entry_size = s; }
  void SetCGNodeIdsEntrySize(mINT32 s) 
  { _constraint_graph_nodeids_entry_size = s; }
  void SetCGModRangesEntrySize(mINT32 s) 
  { _constraint_graph_modranges_entry_size = s; }
#endif
...
#if 0
  mINT32 GetCGNodesEntrySize() 
  { return _constraint_graph_nodes_entry_size; }
  mINT32 GetCGStInfosEntrySize() 
  { return _constraint_graph_stinfos_entry_size; }
  mINT32 GetCGCallsitesEntrySize() 
  { return _constraint_graph_callsites_entry_size; }
  mINT32 GetCGNodeIdsEntrySize() 
  { return _constraint_graph_nodeids_entry_size; }
  mINT32 GetCGModRangesEntrySize() 
