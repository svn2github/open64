...
#pragma ident "@(#) libu/util/i3e/ieee_expon_d_r.c	92.1	07/07/99 14:37:09"
#include <fenv.h>
#include <fp.h>
#include "i3eintrin.h"

#ifndef _LD64
extern long double _IEEE_EXPONENT_D_R(double x);
/* _IEEE_EXPONENT_D_R - IEEE EXPONENT returns the exponent part of the
 *                       64-bit argument in 128-bit long double result.
 *
 * IEEE_EXPONENT(X,Y_R16) returns real(kind=8)result
 */
#pragma _CRI duplicate _IEEE_EXPONENT_D_R as _IEEE_LOGB_D_R
long double
_IEEE_EXPONENT_D_R(double x)
{
