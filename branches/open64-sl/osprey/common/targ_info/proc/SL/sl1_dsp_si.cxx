...
{
  Machine("sl1_dsp", ISA_SUBSET_MIPS4, argc, argv);

  res_issue = RESOURCE_Create("issue", 3);
  res_memory = RESOURCE_Create("memory", 1);
  res_integer = RESOURCE_Create("integer", 1);
  res_float = RESOURCE_Create("float", 1);
 ...
 Instruction_Group("sl2_vsad", 
      TOP_UNDEFINED);
 Any_Operand_Access_Time(0);
 Any_Result_Available_Time(14);
 Resource_Requirement(res_issue, 0);
 Resource_Requirement(res_sl2_vadd, 0);
 Resource_Requirement(res_sl2_mem, 5);
 ...
 Resource_Requirement(res_issue, 0);
 Resource_Requirement(res_sl2_vadd, 0);
 Resource_Requirement(res_sl2_sum, 1);
 ...
 Resource_Requirement(res_issue, 0);
 Resource_Requirement(res_sl2_vadd, 0);
 Resource_Requirement(res_sl2_vmult, 10);
 ...
 Resource_Requirement(res_issue, 0);
 Resource_Requirement(res_sl2_add, 0);
 Resource_Requirement(res_sl2_sum, 4);
 ...
 Resource_Requirement(res_issue, 0);
 Resource_Requirement(res_sl2_add, 0);
 Resource_Requirement(res_sl2_sum, 5);
 ...
 Resource_Requirement(res_issue, 0);
 Resource_Requirement(res_sl2_add, 0);
 Resource_Requirement(res_sl2_sum, 3);
