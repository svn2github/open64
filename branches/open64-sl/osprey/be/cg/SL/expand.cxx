    ...
    case OPR_MPY: 
      {
        ...
        FmtAssert(Is_Target_Sl1_pcore() || Is_Target_Sl1_dsp(),
          ("Expand_64Bit_ALU_OP: No Implementation of 64-bit multiple operation for %s processer", Processor_Name));
    ...
    OPS* ops )
{
  ...
  Build_MC_OP(op2, dest_tn, cond_tn, false_tn, flag_tn, type, ops);
  return;
}
