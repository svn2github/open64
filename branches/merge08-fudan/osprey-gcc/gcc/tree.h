...
#ifdef KEY
#define DECL_ASMREG(NODE) (DECL_CHECK (NODE)->decl.asmreg)
#endif
...
#define DECL_EMITTED_BY_GXX(DECL) \
  DECL_CHECK (DECL)->decl.decl_emitted_by_gxx
#define DECL_ADDED_TO_WEAK_DECLS(DECL) \
  DECL_CHECK (DECL)->decl.added_to_weak_decls
#endif
...
struct tree_decl GTY(())
{
  ...
  /* KEY: 10 unused bits.  (12 unused bits originally in GCC.) */
