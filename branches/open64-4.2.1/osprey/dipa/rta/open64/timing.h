...
/* \todo This table will be modified later. */
typedef enum {
...
/* Below will be changed later. */
extern RSTATE * Get_Rstate(INT ID);
extern void Alloc_Phase(INT curId, const char *name, INT parentId);
