 ...
 * Module: log1pf.c
 * $Revision: 1.1 $
 * $Date: 2005/07/27 02:29:00 $
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/libm/mips/log1pf.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/libm/mips/log1pf.c,v $ $Revision: 1.1 $";
