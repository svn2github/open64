 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/libm/mips/atan2f.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/libm/mips/atan2f.c,v $ $Revision: 1.1 $";
