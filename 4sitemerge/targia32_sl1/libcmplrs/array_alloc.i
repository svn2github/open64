...
# 51 "../../libcmplrs/array_alloc.c" 2
# 1 "../../include/cmplrs/array_alloc.h" 1
# 70 "../../include/cmplrs/array_alloc.h"
...
# 52 "../../libcmplrs/array_alloc.c" 2
# 67 "../../libcmplrs/array_alloc.c"
static char *aa_error[] = {
 "array_alloc no error.",
       "array_alloc Cannot malloc a struct fore aa_handle to point to",
       "array_alloc Initial allocation amount is not usable (<= 1)",
       "array_alloc Initial element size is not usable ( < 1 )",
       "array_alloc Initial numerator is not usable ( < 2)",
       "array_alloc Initial denominator is not usable (< 1 )",
       "array_alloc consistency checks fail in freeing memory",
       "array_alloc initial word of aa structure destroyed",
       "array_alloc middle word of aa structure destroyed",
       "array_alloc final word of aa structure destroyed",
        "array_alloc elements-to-alloc given <= 0",
        "array_alloc malloc failure",
        "array_alloc realloc failure",
         "array_alloc: null pointer passed to aa_alloc",
};
