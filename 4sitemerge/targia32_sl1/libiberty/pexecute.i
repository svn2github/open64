...
# 50 "../../libiberty/pexecute.c" 2
# 63 "../../libiberty/pexecute.c"
static char *install_error_msg = "installation problem, cannot exec `%s'";
# 667 "../../libiberty/pexecute.c"
extern int execv ();
extern int execvp ();
