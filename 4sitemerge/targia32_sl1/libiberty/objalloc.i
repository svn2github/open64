# 1 "../../libiberty/objalloc.c"
# 1 "/usa/handong/simplnano/cmplr-open64-merge/targia32_sl1/libiberty//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libiberty/objalloc.c"
# 20 "../../libiberty/objalloc.c"
# 1 "../../include/gnu/ansidecl.h" 1
# 21 "../../libiberty/objalloc.c" 2
# 1 "../../libiberty/config.h" 1
# 22 "../../libiberty/objalloc.c" 2

# 1 "../../include/gnu/objalloc.h" 1
# 23 "../../include/gnu/objalloc.h"
# 1 "../../include/gnu/ansidecl.h" 1
# 24 "../../include/gnu/objalloc.h" 2
# 44 "../../include/gnu/objalloc.h"
struct objalloc
{
  char *current_ptr;
...
typedef int wchar_t;
# 58 "../../include/gnu/objalloc.h" 2
# 67 "../../include/gnu/objalloc.h"
...
# 27 "../../libiberty/objalloc.c" 2
# 35 "../../libiberty/objalloc.c"
# 1 "/usr/lib/gcc/i486-linux-gnu/4.1.2/include/stddef.h" 1 3 4
# 36 "../../libiberty/objalloc.c" 2
...
# 40 "../../libiberty/objalloc.c" 2
# 60 "../../libiberty/objalloc.c"
...
objalloc_create ()
{
  ...
  ret->current_ptr = (char *) chunk + ((sizeof (struct objalloc_chunk) + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1));
  ret->current_space = (4096 - 32) - ((sizeof (struct objalloc_chunk) + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1));
     ...
     unsigned long len;
{
  ...
  len = (len + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1);
  ...
  if (len >= (512))
    {
      ...
      ret = (char *) malloc (((sizeof (struct objalloc_chunk) + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1)) + len);
      if (ret == ((void *)0))
 return ((void *)0);
      ...
      return (void *) (ret + ((sizeof (struct objalloc_chunk) + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1)));
    }
  else
    {
      struct objalloc_chunk *chunk;
 ...
 return ((void *)0);
      ...
      o->current_ptr = (char *) chunk + ((sizeof (struct objalloc_chunk) + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1));
      o->current_space = (4096 - 32) - ((sizeof (struct objalloc_chunk) + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1));

      o->chunks = (void *) chunk;

      return __extension__ ({ struct objalloc *__o = (o); unsigned long __len = (len); if (__len == 0) __len = 1; __len = (__len + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1); (__len <= __o->current_space ? (__o->current_ptr += __len, __o->current_space -= __len, (void *) (__o->current_ptr - __len)) : _objalloc_alloc (__o, __len)); });
    }
}
     ...
     void * block;
{
 ...
 {
   if (b == (char *) p + ((sizeof (struct objalloc_chunk) + __builtin_offsetof (struct objalloc_align, d) - 1) &~ (__builtin_offsetof (struct objalloc_align, d) - 1)))
     break;
 }
    }
