...
# 53 "../../libiberty/concat.c" 2
# 61 "../../libiberty/concat.c"
...
# 70 "../../libiberty/concat.c" 2


static __inline__ unsigned long vconcat_length (const char *, va_list);
     ...
     va_list args;
{
  ...
  for (arg = first; arg ; arg = __builtin_va_arg(args,const char *))
    length += strlen (arg);

  return length;
}

static __inline__ char *vconcat_copy (char *, const char *, va_list);
