...
clear_edges ()
{
      ...
      while (e)
 {
  ...
  if (n_edges)
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 218, __FUNCTION__);
}
...
compact_blocks ()
{
  ...
  if (i != n_basic_blocks)
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 278, __FUNCTION__);
     ...
     edge e;
{
  ...
  if (!tmp)
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 426, __FUNCTION__);
  if (last_succ)
  ...
  if (!tmp)
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 436, __FUNCTION__);
  if (last_pred)
     ...
     int size;
{
  ...
  if (bb->aux || !first_block_aux_obj)
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 722, __FUNCTION__);
     ...
     int size;
{
  ...
  if (!initialized)
    ...
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 744, __FUNCTION__);
...
free_aux_for_blocks ()
{
  if (!first_block_aux_obj)
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 773, __FUNCTION__);
     ...
     int size;
{
  ...
  if (e->aux || !first_edge_aux_obj)
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 790, __FUNCTION__);
     ...
     int size;
{
  ...
  if (!initialized)
    ...
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 812, __FUNCTION__);
...
free_aux_for_edges ()
{
  if (!first_edge_aux_obj)
    fancy_abort ("../../../kg++fe/gnu/cfg.c", 851, __FUNCTION__);
