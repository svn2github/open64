...
# 79 "../../../kg++fe/gnu/profile.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 80 "../../../kg++fe/gnu/profile.c" 2
...
# 86 "../../../kg++fe/gnu/profile.c" 2


# 1 "../../../kg++fe/gnu/gcov-io.h" 1
# 35 "../../../kg++fe/gnu/gcov-io.h"
...
# 93 "../../../kg++fe/gnu/profile.c" 2


# 1 "../../../kg++fe/gnu/defaults.h" 1
# 96 "../../../kg++fe/gnu/profile.c" 2
     ...
     struct edge_list *el;
{
      ...
      while (e)
 {
   ...
   if (!inf->ignore && !inf->on_tree)
     {
       if (e->flags & 2)
  fancy_abort ("../../../kg++fe/gnu/profile.c", 200, __FUNCTION__);
       if (rtl_dump_file)
...
# 512 "../../../kg++fe/gnu/profile.c"
      ...
      for (bb = (&entry_exit_blocks[1]); bb != ((void *)0); bb = bb->prev_bb)
 {
       ...
       if (bi->succ_count == 1)
  {
    ...
    if (! e)
      fancy_abort ("../../../kg++fe/gnu/profile.c", 567, __FUNCTION__);
    ((struct edge_info *) (e)->aux)->count_valid = 1;
    e->count = total;
    bi->succ_count--;
       ...
       if (bi->pred_count == 1)
  {
    ...
    if (! e)
      fancy_abort ("../../../kg++fe/gnu/profile.c", 594, __FUNCTION__);
    ((struct edge_info *) (e)->aux)->count_valid = 1;
    e->count = total;
    bi->pred_count--;
 ...
 fancy_abort ("../../../kg++fe/gnu/profile.c", 617, __FUNCTION__);
    }
    ...
    insn = (((insn)->fld[2]).rtx))
 {
       ...
       else
  {
    ...
    if (bb == (&entry_exit_blocks[0]))
      fancy_abort ("../../../kg++fe/gnu/profile.c", 841, __FUNCTION__);
     ...
     basic_block bb1, bb2;
{
  ...
  if (bb1g == bb2g)
    fancy_abort ("../../../kg++fe/gnu/profile.c", 1112, __FUNCTION__);

  bb1g->aux = bb2g;
}
# 1124 "../../../kg++fe/gnu/profile.c"
static void
find_spanning_tree (el)
     struct edge_list *el;
{
...
# 1 "../../../kg++fe/gnu/MIPS/gt-profile.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-profile.h"
