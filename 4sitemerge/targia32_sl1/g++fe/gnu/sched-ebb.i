...
# 34 "../../../kg++fe/gnu/sched-ebb.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 35 "../../../kg++fe/gnu/sched-ebb.c" 2
     ...
     rtx head, tail;
{
 ...
 if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_SAVE_NOTE)
  ...
  if (sched_n_insns != n_insns)
    fancy_abort ("../../../kg++fe/gnu/sched-ebb.c", 412, __FUNCTION__);
