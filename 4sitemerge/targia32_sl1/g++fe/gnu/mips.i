...
# 37 "../../../kg++fe/gnu/mips.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 38 "../../../kg++fe/gnu/mips.c" 2
# 1 "../../../kg++fe/gnu/conditions.h" 1
# 39 "../../../kg++fe/gnu/mips.c" 2
...
# 55 "../../../kg++fe/gnu/mips.c" 2
# 1 "../../../kg++fe/gnu/target-def.h" 1
# 288 "../../../kg++fe/gnu/target-def.h"
# 1 "../../../kg++fe/gnu/hooks.h" 1
# 34 "../../../kg++fe/gnu/hooks.h"
...
_Bool default_can_output_mi_thunk_no_vcall
  (tree, long long, long long, tree);
# 288 "../../../kg++fe/gnu/target-def.h" 2
# 56 "../../../kg++fe/gnu/mips.c" 2
     ...
     enum machine_mode mode;
{
 ...
 return 0;
# 981 "../../../kg++fe/gnu/mips.c"
    case SYMBOL_REF:
# 992 "../../../kg++fe/gnu/mips.c"
      if ((target_flags & 0x00100000)
   && (((addr))->unchanging)
     ...
     int unsignedp;
{
      ...
      else if (code1 == MEM)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/mips.c", 2241, __FUNCTION__);
      ...
      if (ret != 0 && (((op0))->volatil))
 {
   ...
   if (i > sizeof (volatile_buffer) - sizeof ("%{%}"))
     fancy_abort ("../../../kg++fe/gnu/mips.c", 2437, __FUNCTION__);
...
# 2853 "../../../kg++fe/gnu/mips.c"
   ...
   if (ret != 0 && (((op1))->volatil))
     {
       ...
       if (i > sizeof (volatile_buffer) - sizeof ("%{%}"))
  fancy_abort ("../../../kg++fe/gnu/mips.c", 2866, __FUNCTION__);
      ...
      if (ret != 0 && (((op0))->volatil))
 {
   ...
   if (i > sizeof (volatile_buffer) - sizeof ("%{%}"))
     fancy_abort ("../../../kg++fe/gnu/mips.c", 2978, __FUNCTION__);
...

{
  ...
  if (test == ITEST_MAX)
    fancy_abort ("../../../kg++fe/gnu/mips.c", 3177, __FUNCTION__);
     ...
     rtx *operands;
{
 ...
 case LEU:
   ...
   break;
 default:
   fancy_abort ("../../../kg++fe/gnu/mips.c", 3495, __FUNCTION__);
 }
    }
  else
  ...
  if (mode == SImode || mode == DImode)
    ...
    fancy_abort ("../../../kg++fe/gnu/mips.c", 3506, __FUNCTION__);
     ...
     rtx address, scratch;
{
  ...
  if (((cfun->machine->frame.mask >> 31) & 1) == 0)
    fancy_abort ("../../../kg++fe/gnu/mips.c", 3617, __FUNCTION__);
     ...
     rtx orig_src;
{
  ...
  if (bytes < (unsigned)2 * (4 * ((target_flags & 0x00002000) ? 8 : 4)))
    fancy_abort ("../../../kg++fe/gnu/mips.c", 3679, __FUNCTION__);
...
# 3933 "../../../kg++fe/gnu/mips.c"
      ...
      if (++num == num_regs || bytes == 0)
 {
       ...
       for (i = 0; i < num; i++)
  {
    ...
    if (!operands[i + 4])
      fancy_abort ("../../../kg++fe/gnu/mips.c", 4154, __FUNCTION__);
     ...
     const char *reason;
{
  error (reason);
  debug_rtx (insn);
  fancy_abort ("../../../kg++fe/gnu/mips.c", 5053, __FUNCTION__);
}
     ...
     int letter;
{
 ...
 abort_with_insn (op, "PRINT_OPERAND, invalid insn for %%W");
  ...
  else if (letter == 'Z')
    {
      ...
      if (code != REG)
 fancy_abort ("../../../kg++fe/gnu/mips.c", 5918, __FUNCTION__);

      regnum = (((op)->fld[0]).rtuint);
      if (! ((unsigned int) ((int) (regnum) - 67) < (74 - 67 + 1)))
 fancy_abort ("../../../kg++fe/gnu/mips.c", 5922, __FUNCTION__);
...
# 6177 "../../../kg++fe/gnu/mips.c"
  return 0;
}
# 6202 "../../../kg++fe/gnu/mips.c"
void
...
# 6445 "../../../kg++fe/gnu/mips.c"
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/mips.c", 6456, __FUNCTION__);
 }
     ...
     int from, to;
{
 ...
 offset += ((target_flags & 0x00002000) ? 8 : 4) - (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32) / 8);
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/mips.c", 6911, __FUNCTION__);
    }
     ...
     long large_offset;
{
  ...
  if (frame_pointer_needed
    ...
    fancy_abort ("../../../kg++fe/gnu/mips.c", 7029, __FUNCTION__);
...
# 7481 "../../../kg++fe/gnu/mips.c"
   ...
   && tsize > 32767)
 {
   ...
   if (!frame_pointer_needed)
     fancy_abort ("../../../kg++fe/gnu/mips.c", 7711, __FUNCTION__);
...
mips_expand_epilogue ()
{
 ...
 emit_insn (gen_blockage ());
      ...
      if (tsize > 32767 && (target_flags & 0x00100000))
 fancy_abort ("../../../kg++fe/gnu/mips.c", 7973, __FUNCTION__);
     ...
     rtx sym;
{
  ...
  if (((enum rtx_code) (sym)->code) != SYMBOL_REF
      || ! (((sym))->volatil))
    fancy_abort ("../../../kg++fe/gnu/mips.c", 8760, __FUNCTION__);
     ...
     int from_fp_p;
{
  ...
  if (mips_abi != 0 && mips_abi != 4)
    fancy_abort ("../../../kg++fe/gnu/mips.c", 8965, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/mips.c", 9004, __FUNCTION__);
     ...
     int fp_code;
{
  ...
  if (((enum rtx_code) (fnmem)->code) != MEM)
    fancy_abort ("../../../kg++fe/gnu/mips.c", 9157, __FUNCTION__);
  fn = (((fnmem)->fld[0]).rtx);
  ...
  if (mips_abi != 0 && mips_abi != 4)
    fancy_abort ("../../../kg++fe/gnu/mips.c", 9169, __FUNCTION__);



  if (fpret && ((enum machine_mode) (retval)->mode) != SFmode && ((enum machine_mode) (retval)->mode) != DFmode)
    fancy_abort ("../../../kg++fe/gnu/mips.c", 9174, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/mips.c", 9213, __FUNCTION__);
      (((insn)->fld[9]).rtx) =
...
# 9392 "../../../kg++fe/gnu/mips.c"
 ...
 insn = gen_call_value_internal0 (retval, fnmem, arg_size,
      ...
      if (((enum rtx_code) (insn)->code) != CALL_INSN)
 fancy_abort ("../../../kg++fe/gnu/mips.c", 9416, __FUNCTION__);
      ...
      for (insn = first; insn != (rtx) 0; insn = next)
 {
   ...
   if (((enum rtx_code) ((((set1)->fld[0]).rtx))->code) == REG
       ...
       && ((enum rtx_code) ((((((((((set2)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx))->code) == MINUS)
     {
       ...
       if (((enum rtx_code) (sym)->code) != SYMBOL_REF)
  fancy_abort ("../../../kg++fe/gnu/mips.c", 9593, __FUNCTION__);
     ...
     rtx insn;
{
 ...
 case DFmode:
   ...
   break;
 default:
   fancy_abort ("../../../kg++fe/gnu/mips.c", 9749, __FUNCTION__);
 }
...
# 10447 "../../../kg++fe/gnu/mips.c"
    default:
      fancy_abort ("../../../kg++fe/gnu/mips.c", 10448, __FUNCTION__);
    }
...
mips_issue_rate ()
{
  ...
  fancy_abort ("../../../kg++fe/gnu/mips.c", 10700, __FUNCTION__);
...
# 10915 "../../../kg++fe/gnu/mips.c"
# 1 "../../../kg++fe/gnu/MIPS/gt-mips.h" 1
# 23 "../../../kg++fe/gnu/MIPS/gt-mips.h"
void
