...
# 31 "../../../kg++fe/gnu/cselib.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 32 "../../../kg++fe/gnu/cselib.c" 2
     ...
     const void *entry, *x_arg;
{
  ...
  if (((enum rtx_code) (x)->code) == CONST_INT
    ...
    fancy_abort ("../../../kg++fe/gnu/cselib.c", 256, __FUNCTION__);
...
remove_useless_values ()
{
  ...
  if (n_useless_values != 0)
    fancy_abort ("../../../kg++fe/gnu/cselib.c", 385, __FUNCTION__);
}
     ...
     rtx x, y;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/cselib.c", 521, __FUNCTION__);
 }
    }
  return 1;
}
     ...
     rtx x;
{
  if (((enum rtx_code) (x)->code) != CONST_INT
    ...
    return x;
  if (mode == VOIDmode)
    fancy_abort ("../../../kg++fe/gnu/cselib.c", 539, __FUNCTION__);
  return gen_rtx_fmt_e (CONST, (mode), (x));
}
# 552 "../../../kg++fe/gnu/cselib.c"
static unsigned int
     ...
     int create;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/cselib.c", 678, __FUNCTION__);
    }
     ...
     enum machine_mode mode;
{
  ...
  if (value == 0)
    fancy_abort ("../../../kg++fe/gnu/cselib.c", 700, __FUNCTION__);
     ...
     rtx x;
{
 ...
 if (((enum machine_mode) (l->elt->u.val_rtx)->mode) == ((enum machine_mode) (x)->mode))
   return l->elt->u.val_rtx;
      ...
      fancy_abort ("../../../kg++fe/gnu/cselib.c", 796, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  if (reload_completed && regno >= 176
    ...
    fancy_abort ("../../../kg++fe/gnu/cselib.c", 958, __FUNCTION__);
  ...
  if (regno < 176)
    {
      if (mode == VOIDmode)
 fancy_abort ("../../../kg++fe/gnu/cselib.c", 967, __FUNCTION__);
...
# 1 "../../../kg++fe/gnu/MIPS/gt-cselib.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-cselib.h"
