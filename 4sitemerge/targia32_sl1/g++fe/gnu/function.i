...
# 55 "../../../kg++fe/gnu/function.c" 2

# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 57 "../../../kg++fe/gnu/function.c" 2
...
# 1 "../../../kg++fe/gnu/defaults.h" 1
# 72 "../../../kg++fe/gnu/function.c" 2
# 113 "../../../kg++fe/gnu/function.c"
     ...
     tree decl;
{
  ...
  fancy_abort ("../../../kg++fe/gnu/function.c", 324, __FUNCTION__);
}
     ...
     tree type;
{
  ...
  if (size == -1)
    fancy_abort ("../../../kg++fe/gnu/function.c", 663, __FUNCTION__);
  ...
  if (p == 0)
    {
      ...
      p = (struct temp_slot *) ggc_alloc (sizeof (struct temp_slot));
# 747 "../../../kg++fe/gnu/function.c"
      if (mode == BLKmode && align < (mips_abi == 1 || mips_abi == 2 ? 128 : 64))
 fancy_abort ("../../../kg++fe/gnu/function.c", 748, __FUNCTION__);
     ...
     rtx may_share;
{
  ...
  if (ht)
    {
      if (stack != 0)
 fancy_abort ("../../../kg++fe/gnu/function.c", 1587, __FUNCTION__);
     ...
     rtx no_share;
{
      ...
      if ((((x)->fld[0]).rtx) == var)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/function.c", 1959, __FUNCTION__);
...
# 2408 "../../../kg++fe/gnu/function.c"
  ...
  if ((((last)->fld[8]).rtx) && (((insn)->fld[8]).rtx))
    fancy_abort ("../../../kg++fe/gnu/function.c", 2419, __FUNCTION__);
  if ((((last)->fld[8]).rtx))
 ...
 if (((((x)->fld[0]).rtx) == var
  ...
  if ((((last)->fld[8]).rtx) && (((insn)->fld[8]).rtx))
    fancy_abort ("../../../kg++fe/gnu/function.c", 2463, __FUNCTION__);
  if ((((last)->fld[8]).rtx))
    (((insn)->fld[8]).rtx) = (((last)->fld[8]).rtx);
  (((insn)->fld[5]).rtx) = (((last)->fld[5]).rtx);
     ...
     int uncritical;
{
  ...
  if ((mode_size[(int) (mode)]) > (mode_size[(int) (((enum machine_mode) (mem)->mode))]) && ! uncritical)
    fancy_abort ("../../../kg++fe/gnu/function.c", 2566, __FUNCTION__);
...
optimize_bit_field (body, insn, equiv_mem)
     ...
     rtx *equiv_mem;
{
# 2859 "../../../kg++fe/gnu/function.c"
}
# 2868 "../../../kg++fe/gnu/function.c"
static int in_arg_offset;
static int var_offset;
static int dynamic_offset;
static int out_arg_offset;
static int cfa_offset;
# 2922 "../../../kg++fe/gnu/function.c"
rtx
gen_mem_addressof (reg, decl, rescan)
     rtx reg;
     tree decl;
     ...
     htab_t ht;
{
  ...
  if (((enum rtx_code) (reg)->code) != REG)
    fancy_abort ("../../../kg++fe/gnu/function.c", 3001, __FUNCTION__);
     ...
     htab_t ht;
{
 ...
 return 1;
      ...
      if (! validate_change (insn, loc, sub, 0)
   && ! validate_replace_rtx (x, sub, insn))
 fancy_abort ("../../../kg++fe/gnu/function.c", 3089, __FUNCTION__);
  ...
  if (rtx_equal_p ((((x)->fld[0]).rtx), (((tem)->fld[0]).rtx)))
   ...
   || (((enum rtx_code) (((((((tem)->fld[1]).rtx))->fld[0]).rtx))->code) != REG
       && ((enum rtx_code) (((((((tem)->fld[1]).rtx))->fld[0]).rtx))->code) != SUBREG))
        fancy_abort ("../../../kg++fe/gnu/function.c", 3137, __FUNCTION__);
...
# 3440 "../../../kg++fe/gnu/function.c"
 ...
 if (! purge_addressof_1 (&(((insn)->fld[5]).rtx), insn,
   ...
   fancy_abort ("../../../kg++fe/gnu/function.c", 3451, __FUNCTION__);
 ...
 if (! purge_addressof_1 (&(((insn)->fld[8]).rtx), (rtx) 0, 0, 0, ht))
  ...
  if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_RETVAL)
    fancy_abort ("../../../kg++fe/gnu/function.c", 3466, __FUNCTION__);
     ...
     rtx insn;
{
  if (asm_noperands ((((insn)->fld[5]).rtx)) >= 0)
    ...
    fancy_abort ("../../../kg++fe/gnu/function.c", 3790, __FUNCTION__);
}
# 3806 "../../../kg++fe/gnu/function.c"
static int
...
get_first_block_beg ()
{
 ...
 && (((searcher)->fld[5]).rtint) == NOTE_INSN_BLOCK_BEG)
  ...
  fancy_abort ("../../../kg++fe/gnu/function.c", 4279, __FUNCTION__);
  return (rtx) 0;
}
...
# 4554 "../../../kg++fe/gnu/function.c"
      pretend_named = named_arg || 1;
      locate_and_pad_parm (promoted_mode, passed_type,
# 4564 "../../../kg++fe/gnu/function.c"
...
# 4748 "../../../kg++fe/gnu/function.c"
  ...
  fancy_abort ("../../../kg++fe/gnu/function.c", 4757, __FUNCTION__);
     ...
     tree decl;
{
  ...
  fancy_abort ("../../../kg++fe/gnu/function.c", 5654, __FUNCTION__);
}
     ...
     tree var;
{
  ...
  if (((enum rtx_code) (addr)->code) == REG)
    ...
    fancy_abort ("../../../kg++fe/gnu/function.c", 5687, __FUNCTION__);



  if (basereg == fp->internal_arg_pointer)
    {
# 5703 "../../../kg++fe/gnu/function.c"
      rtx addr;
 ...
 if (((link)->list.purpose) == context)
  ...
  if (base == 0)
    fancy_abort ("../../../kg++fe/gnu/function.c", 5733, __FUNCTION__);
...
identify_blocks ()
{
  ...
  if (0 && last_block_vector != block_vector + n_blocks)
    fancy_abort ("../../../kg++fe/gnu/function.c", 5880, __FUNCTION__);
     ...
     tree *orig_block_stack;
{
      ...
      if (((enum rtx_code) (insn)->code) == NOTE)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/function.c", 5913, __FUNCTION__);
  ...
  fancy_abort ("../../../kg++fe/gnu/function.c", 5924, __FUNCTION__);
        ...
        && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == CALL_PLACEHOLDER)
 {
  ...
  if (block_stack != orig_block_stack)
    fancy_abort ("../../../kg++fe/gnu/function.c", 5948, __FUNCTION__);
...
# 6460 "../../../kg++fe/gnu/function.c"
void
expand_main_function ()
{
# 6503 "../../../kg++fe/gnu/function.c"
}
...
# 6600 "../../../kg++fe/gnu/function.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/function.c", 6639, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/function.c", 6720, __FUNCTION__);
...
# 6995 "../../../kg++fe/gnu/function.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/function.c", 7015, __FUNCTION__);
   ...
   : ((decl_result)->decl.regdecl_flag))
 {
   ...
   if (! (((real_decl_rtl))->integrated))
     fancy_abort ("../../../kg++fe/gnu/function.c", 7059, __FUNCTION__);
     ...
     rtx insns;
{
       ...
       && ((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->code) == RETURN))
 {
   ...
   if (((enum rtx_code) (retaddr)->code) == REG)
     ...
     fancy_abort ("../../../kg++fe/gnu/function.c", 7431, __FUNCTION__);
  ...
  if (mips_hard_regno_mode_ok[ (int)((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)) ][ (regno) ]
    ...
    break;
       ...
       if (regno == 176)
  fancy_abort ("../../../kg++fe/gnu/function.c", 7466, __FUNCTION__);
   ...
   if (jump_set == 0)
     fancy_abort ("../../../kg++fe/gnu/function.c", 7479, __FUNCTION__);
   else
     (((jump_set))->jump) = 1;
 }
     ...
     || !reg_set_p (info.sp_equiv_reg, insn)))
 {
   if (! validate_replace_rtx ((global_rtl[GR_STACK_POINTER]),
          ...
          insn))
     fancy_abort ("../../../kg++fe/gnu/function.c", 7500, __FUNCTION__);
     ...
     struct epi_info *p;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/function.c", 7541, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/function.c", 7560, __FUNCTION__);
   ...
   || p->equiv_reg_src != 0)
 fancy_abort ("../../../kg++fe/gnu/function.c", 7575, __FUNCTION__);
      else
 p->equiv_reg_src
     ...
     rtx f __attribute__ ((__unused__));
{
 ...
 fancy_abort ("../../../kg++fe/gnu/function.c", 7648, __FUNCTION__);
...
# 7832 "../../../kg++fe/gnu/function.c"
  if (prologue_end)
    {
      rtx insn, prev;
# 7849 "../../../kg++fe/gnu/function.c"
...
# 1 "../../../kg++fe/gnu/MIPS/gt-function.h" 1
# 23 "../../../kg++fe/gnu/MIPS/gt-function.h"
void
