...
# 34 "../../../kg++fe/gnu/cp/cvt.c" 2
# 1 "../../../kg++fe/gnu/convert.h" 1
# 21 "../../../kg++fe/gnu/convert.h"
extern tree convert_to_integer (tree, tree);
extern tree convert_to_pointer (tree, tree);
extern tree convert_to_real (tree, tree);
extern tree convert_to_complex (tree, tree);
extern tree convert_to_vector (tree, tree);
# 35 "../../../kg++fe/gnu/cp/cvt.c" 2
...
# 37 "../../../kg++fe/gnu/cp/cvt.c" 2

static tree cp_convert_to_pointer (tree, tree, int);
static tree convert_to_pointer_force (tree, tree);
static tree build_up_reference (tree, tree, int, tree);
static void warn_ref_binding (tree, tree, tree);
# 74 "../../../kg++fe/gnu/cp/cvt.c"
static tree
cp_convert_to_pointer (type, expr, force)
     tree type, expr;
     int force;
{
  register tree intype = ((expr)->common.type);
  register enum tree_code form;
  tree rval;

  if ((((enum tree_code) (intype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (intype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (intype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (intype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((intype)->type.lang_flag_5)))
    {
      intype = complete_type (intype);
      if (!(((intype)->type.size) != (tree) ((void *)0)))
 {
   ...
   || (((enum tree_code) (((type)->common.type))->common.code) == VOID_TYPE)))
    {
      ...
      if ((((enum tree_code) (intype)->common.code) == RECORD_TYPE && ((intype)->type.lang_specific) && ((&((intype)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
 {
   tree fntype = (((((((intype)->type.values))->common.type)))->common.type);
   tree decl = maybe_dummy_object (((fntype)->type.maxval), 0);
   expr = build (OFFSET_REF, fntype, decl, expr);
 }

      if (((enum tree_code) (expr)->common.code) == OFFSET_REF
   && ((enum tree_code) (((expr)->common.type))->common.code) == METHOD_TYPE)
 expr = resolve_offset_ref (expr);
      if (((enum tree_code) (((expr)->common.type))->common.code) == METHOD_TYPE)
 expr = build_addr_func (expr);
      if (((enum tree_code) (((expr)->common.type))->common.code) == POINTER_TYPE)
 {
   if (((enum tree_code) (((((expr)->common.type))->common.type))->common.code) == METHOD_TYPE)
     if (pedantic || warn_pmf2ptr)
       pedwarn ("converting from `%T' to `%T'", ((expr)->common.type),
     type);
  ...
  form = ((enum tree_code) (intype)->common.code);

  if ((((enum tree_code) (intype)->common.code) == POINTER_TYPE || ((enum tree_code) (intype)->common.code) == REFERENCE_TYPE))
    {
      intype = ((intype)->type.main_variant);

      if (((type)->type.main_variant) != intype
   && ((enum tree_code) (type)->common.code) == POINTER_TYPE
   && ((enum tree_code) (((type)->common.type))->common.code) == RECORD_TYPE
   && (((enum tree_code) (((type)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((type)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((type)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((type)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((type)->common.type))->type.lang_flag_5))
   && (((enum tree_code) (((intype)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((intype)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((intype)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((intype)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((intype)->common.type))->type.lang_flag_5))
   && ((enum tree_code) (((intype)->common.type))->common.code) == RECORD_TYPE)
 {
   ...
   intype_class = ((intype)->common.type);
   type_class = ((type)->common.type);

   same_p = comptypes ((((intype_class)->type.main_variant)), (((type_class)->type.main_variant)), 0);
      ...
      if ((((enum tree_code) (type)->common.code) == POINTER_TYPE && ((enum tree_code) (((type)->common.type))->common.code) == OFFSET_TYPE) && (((enum tree_code) (intype)->common.code) == POINTER_TYPE && ((enum tree_code) (((intype)->common.type))->common.code) == OFFSET_TYPE))
 {
   ...
   b1 = ((((type)->common.type))->type.maxval);
   b2 = ((((intype)->common.type))->type.maxval);
          ...
          if (bk == bk_via_virtual)
     {
       if (force)
         warning ("pointer to member cast from `%T' to `%T' is via virtual base",
                     ((intype)->common.type), ((type)->common.type));
              else
                {
   ...
   if (binfo)
     expr = size_binop (code, convert (sizetype_tab[(int) SIZETYPE], expr),
          (((binfo))->vec.a[1]));
 }
      else if ((((enum tree_code) (type)->common.code) == RECORD_TYPE && ((type)->type.lang_specific) && ((&((type)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
 {
  ...
  else if ((((enum tree_code) (type)->common.code) == RECORD_TYPE && ((type)->type.lang_specific) && ((&((type)->type.lang_specific)->u.c)->ptrmemfunc_flag)) && (((enum tree_code) (intype)->common.code) == RECORD_TYPE && ((intype)->type.lang_specific) && ((&((intype)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    return build_ptrmemfunc ((((((type)->type.values))->common.type)), expr, 0);
  else if ((((enum tree_code) (intype)->common.code) == RECORD_TYPE && ((intype)->type.lang_specific) && ((&((intype)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    {
      error ("cannot convert `%E' from type `%T' to type `%T'",
  expr, intype, type);
      return global_trees[TI_ERROR_MARK];
  ...
  (void) (((form != OFFSET_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/cvt.c", 241, __FUNCTION__), 0) : 0);
 ...
 expr = build_int_2_wide ((unsigned long long) (-1), (long long) (-1));
      else
 expr = build_int_2_wide ((unsigned long long) (0), (long long) (0));
    ...
    && ((form) == INTEGER_TYPE || (form) == ENUMERAL_TYPE || (form) == BOOLEAN_TYPE))
    {
      error ("invalid conversion from '%T' to '%T'", intype, type);
      return global_trees[TI_ERROR_MARK];
    }

  if (((form) == INTEGER_TYPE || (form) == ENUMERAL_TYPE || (form) == BOOLEAN_TYPE))
    {
      if (((intype)->type.precision) == ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32))
 return build1 (CONVERT_EXPR, type, expr);
      expr = cp_convert (c_common_type_for_size (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32), 0), expr);

      if ((mode_size[(int) (((((expr)->common.type))->type.mode))])
   != (mode_size[(int) (((type)->type.mode))]))


 fancy_abort ("../../../kg++fe/gnu/cp/cvt.c", 276, __FUNCTION__);
...
{
  register tree intype = ((expr)->common.type);
  register enum tree_code form = ((enum tree_code) (intype)->common.code);
   ...
   && ((enum tree_code) (((intype)->common.type))->common.code) == RECORD_TYPE)
 {
   ...
   binfo = lookup_base (((intype)->common.type), ((type)->common.type),
          ba_ignore, ((void *)0));
   if (!binfo)
     {
       binfo = lookup_base (((type)->common.type), ((intype)->common.type),
       ba_ignore, ((void *)0));
       code = MINUS_EXPR;
     }
   if (binfo == global_trees[TI_ERROR_MARK])
   ...
   if (binfo)
     {
       ...
       if (!comptypes ((((((expr)->common.type))->common.type)), (((type)->common.type)), 0))
     ...
     int flags;
{
  ...
  (void) (((((enum tree_code) (type)->common.code) == REFERENCE_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/cvt.c", 356, __FUNCTION__), 0) : 0);

  if ((flags & (256)) && ! real_lvalue_p (arg))
    {


      tree targ = arg;

      arg = make_temporary_var_for_ref_to_temp (decl, ((arg)->common.type));


      ((arg)->decl.initial) = targ;
      cp_finish_decl (arg, targ, (tree) ((void *)0),
        (128)|(256));
    }
  else if (!(flags & (256)) && ! lvalue_p (arg))
  ...
  if ((flags & (1))
      && ((argtype)->type.main_variant) != ((target_type)->type.main_variant)
      && (((enum tree_code) (argtype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (argtype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (argtype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (argtype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((argtype)->type.lang_flag_5))
      && (((enum tree_code) (target_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (target_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (target_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (target_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((target_type)->type.lang_flag_5)))
    {

      tree binfo = lookup_base (argtype, target_type, ba_check, ((void *)0));
      if (binfo == global_trees[TI_ERROR_MARK])
 return global_trees[TI_ERROR_MARK];
      if (binfo == (tree) ((void *)0))
...
# 408 "../../../kg++fe/gnu/cp/cvt.c"
static void
warn_ref_binding (reftype, intype, decl)
     tree reftype, intype, decl;
{
  tree ttl = ((reftype)->common.type);

  if (!((cp_type_quals (ttl) & (0x1 | 0x2)) == 0x1))
    {
      const char *msg;

      if (((cp_type_quals (ttl) & 0x2) != 0) && decl)
   msg = "initialization of volatile reference type `%#T' from rvalue of type `%T'";
      else if (((cp_type_quals (ttl) & 0x2) != 0))
...
convert_to_reference (reftype, expr, convtype, flags, decl)
     ...
     tree decl;
{
  register tree type = ((((reftype)->common.type))->type.main_variant);
  register tree intype;
  tree rval = (tree) ((void *)0);
  tree rval_as_conversion = (tree) ((void *)0);
  int i;

  if (((enum tree_code) (type)->common.code) == FUNCTION_TYPE
      && ((expr)->common.type) == cp_global_trees[CPTI_UNKNOWN_TYPE])
    {
 ...
 return global_trees[TI_ERROR_MARK];
  ...
  (void) (((((enum tree_code) (intype)->common.code) != REFERENCE_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/cvt.c", 467, __FUNCTION__), 0) : 0);

  intype = ((intype)->type.main_variant);

  i = comp_target_types (type, intype, 0);

  if (i <= 0 && (convtype & 1) && (((enum tree_code) (intype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (intype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (intype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (intype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((intype)->type.lang_flag_5))
      && ! (flags & (512)))
    {
 ...
 = build_type_conversion (reftype, expr);
      ...
      if (rval_as_conversion && rval_as_conversion != global_trees[TI_ERROR_MARK]
   && real_lvalue_p (rval_as_conversion))
 {
   expr = rval_as_conversion;
   rval_as_conversion = (tree) ((void *)0);
   intype = type;
   i = 1;
 }
    }
      ...
      if (flags & (2))
 {
  ...
  else if ((convtype & 8) && lvalue_p (expr))
    {
   ...
   && (comptypes (((intype)->common.type), type,
    1 | 2 )))
 warning ("casting `%T' to `%T' does not dereference pointer",
      ...
      if (rval != global_trees[TI_ERROR_MARK])
 rval = convert_force (build_pointer_type (((reftype)->common.type)),
         rval, 0);
      if (rval != global_trees[TI_ERROR_MARK])
 rval = build1 (NOP_EXPR, reftype, rval);
    ...
    {
      rval = convert_for_initialization ((tree) ((void *)0), type, expr, flags,
      "converting", 0, 0);
      if (rval == (tree) ((void *)0) || rval == global_trees[TI_ERROR_MARK])
 return rval;
      warn_ref_binding (reftype, intype, decl);
  ...
  (void) (((((enum tree_code) (intype)->common.code) != OFFSET_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/cvt.c", 548, __FUNCTION__), 0) : 0);
     ...
     tree val;
{
  ...
  if (((enum tree_code) (type)->common.code) == REFERENCE_TYPE)
    return build_indirect_ref (val, ((void *)0));
  return val;
}
...
convert_lvalue (totype, expr)
     tree totype, expr;
{
  totype = cp_build_qualified_type_real ((totype), (((((((expr)->common.type))->common.readonly_flag) * 0x1) | (((((expr)->common.type))->common.volatile_flag) * 0x2) | (((((expr)->common.type))->type.restrict_flag) * 0x4) | ((((enum tree_code) (((expr)->common.type))->common.code) == RECORD_TYPE && ((((expr)->common.type))->common.type)) * 0x8))), tf_error | tf_warning);
  totype = build_reference_type (totype);
  expr = convert_to_reference (totype, expr, 1, (3),
          (tree) ((void *)0));
...
{
  if ((((enum tree_code) (((expr)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((expr)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((expr)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((expr)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((expr)->common.type))->type.lang_flag_5)) && ((enum tree_code) (expr)->common.code) != TARGET_EXPR)
    expr = ocp_convert (((expr)->common.type), expr,
   1|64, (3));
  else
...
cp_convert (type, expr)
     tree type, expr;
{
  return ocp_convert (type, expr, (1 | 2 | 4 | 8), (3));
}
     ...
     int convtype, flags;
{
  ...
  register enum tree_code code = ((enum tree_code) (type)->common.code);

  if (e == global_trees[TI_ERROR_MARK]
      || ((e)->common.type) == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];

  complete_type (type);
  complete_type (((expr)->common.type));

  e = decl_constant_value (e);

  if ((((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)) && (convtype & 64)



      && (((type)->type.lang_flag_1)))
                                                             ;
  else if (((type)->type.main_variant) == ((((e)->common.type))->type.main_variant))
    {
      if (comptypes ((type), (((e)->common.type)), 0))
 ...
 return fold (build1 (NOP_EXPR, type, e));
  ...
  if (code == VOID_TYPE && (convtype & 2))
    {
      e = convert_to_void (e, ((void *)0));
      return e;
    }
  ...
  if (((enum tree_code) (e)->common.code) == OFFSET_REF)
    e = resolve_offset_ref (e);

  if (((code) == INTEGER_TYPE || (code) == ENUMERAL_TYPE || (code) == BOOLEAN_TYPE))
    {
      tree intype = ((e)->common.type);


      if (((enum tree_code) (type)->common.code) == ENUMERAL_TYPE
   && ((((((enum tree_code) (intype)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (intype)->common.code) == INTEGER_TYPE) || ((enum tree_code) (intype)->common.code) == REAL_TYPE) && ! (convtype & 2))
      ...
      if (code == BOOLEAN_TYPE)
 {
   ...
   if (((enum tree_code) (expr)->common.code) == FUNCTION_DECL)
     ...
     && ((enum tree_code) (((expr)->exp.operands[0]))->common.code) == FUNCTION_DECL)
     fn = ((expr)->exp.operands[0]);
   if (fn && !((fn)->decl.weak_flag))
  ...
  if (code == POINTER_TYPE || code == REFERENCE_TYPE
      || (((enum tree_code) (type)->common.code) == RECORD_TYPE && ((type)->type.lang_specific) && ((&((type)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    return fold (cp_convert_to_pointer (type, e, 0));
  if (code == VECTOR_TYPE)
    return fold (convert_to_vector (type, e));
  if (code == REAL_TYPE || code == COMPLEX_TYPE)
    {
      if ((((enum tree_code) (((e)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((e)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((e)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((e)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((e)->common.type))->type.lang_flag_5)))
 {
   tree rval;
   rval = build_type_conversion (type, e);
   if (rval)
 ...
 return fold (convert_to_complex (type, e));
  ...
  if (((code) == RECORD_TYPE || (code) == UNION_TYPE))
    {
      tree dtype = ((e)->common.type);
      tree ctor = (tree) ((void *)0);

      dtype = ((dtype)->type.main_variant);
# 758 "../../../kg++fe/gnu/cp/cvt.c"
      ctor = e;

      if (abstract_virtuals_error ((tree) ((void *)0), type))
 return global_trees[TI_ERROR_MARK];

      if ((flags & (128))
   && ! ((((enum tree_code) (dtype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (dtype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (dtype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (dtype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((dtype)->type.lang_flag_5)) && (lookup_base ((dtype), type, ba_any, ((void *)0)) != (tree) ((void *)0))))



 ctor = build_user_type_conversion (type, ctor, flags);
      else
 ctor = build_special_member_call ((tree) ((void *)0),
       cp_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER],
       build_tree_list ((tree) ((void *)0), ctor),
       ((type)->type.binfo), flags);
      if (ctor)
...
{
  if (expr == global_trees[TI_ERROR_MARK]
      || ((expr)->common.type) == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];
  if (!((expr)->common.type))
    return expr;
    ...
    case COND_EXPR:
      {
        ...
        tree op2 = ((expr)->exp.operands[2]);
        tree new_op1 = convert_to_void (op1, implicit);
        tree new_op2 = convert_to_void (op2, implicit);

 expr = build (COND_EXPR, ((new_op1)->common.type),
        ((expr)->exp.operands[0]), new_op1, new_op2);
        break;
      }
    ...
    case COMPOUND_EXPR:
      {
        ...
        if (new_op1 != op1)
   {
     tree t = build (COMPOUND_EXPR, ((new_op1)->common.type),
       ((expr)->exp.operands[0]), new_op1);
    ...
    case INDIRECT_REF:
      {
        ...
        int is_reference = ((enum tree_code) (((((expr)->exp.operands[0]))->common.type))->common.code)
                           == REFERENCE_TYPE;
        int is_volatile = ((type)->common.volatile_flag);
        int is_complete = (((complete_type (type))->type.size) != (tree) ((void *)0));
    ...
    case VAR_DECL:
      {
        ...
        if (((type)->common.volatile_flag) && !is_complete)
    ...
    }
  {
    ...
    if (((enum tree_code) (probe)->common.code) == ADDR_EXPR)
      probe = ((expr)->exp.operands[0]);
 ...
 pedwarn ("%s cannot resolve address of overloaded function",
  ...
  if (expr != global_trees[TI_ERROR_MARK] && !(((enum tree_code) (((expr)->common.type))->common.code) == VOID_TYPE))
    {
      ...
      if (!implicit)
        expr = build1 (CONVERT_EXPR, global_trees[TI_VOID_TYPE], expr);
    }
  return expr;
}
# 943 "../../../kg++fe/gnu/cp/cvt.c"
tree
convert (type, expr)
     tree type, expr;
{
  ...
  if ((((enum tree_code) (type)->common.code) == POINTER_TYPE || ((enum tree_code) (type)->common.code) == REFERENCE_TYPE) && (((enum tree_code) (intype)->common.code) == POINTER_TYPE || ((enum tree_code) (intype)->common.code) == REFERENCE_TYPE))
    {
      expr = decl_constant_value (expr);
      return fold (build1 (NOP_EXPR, type, expr));
    }

  return ocp_convert (type, expr, (1 | 2 | 4 | 8),
        (3)|(512));
}
     ...
     int convtype;
{
  ...
  if (code == REFERENCE_TYPE)
    return fold (convert_to_reference (type, e, (1 | 2 | 4 | 8 | 16 | 64), (2),
           (tree) ((void *)0)));
  else if (((enum tree_code) (((e)->common.type))->common.code) == REFERENCE_TYPE)
  ...
  if (((((enum tree_code) (((e)->common.type))->common.code) == POINTER_TYPE && ((enum tree_code) (e)->common.code) == ADDR_EXPR
 && ((enum tree_code) (((e)->common.type))->common.code) == POINTER_TYPE
 && ((enum tree_code) (((((e)->common.type))->common.type))->common.code) == METHOD_TYPE)
       || integer_zerop (e)
       || (((enum tree_code) (((e)->common.type))->common.code) == RECORD_TYPE && ((((e)->common.type))->type.lang_specific) && ((&((((e)->common.type))->type.lang_specific)->u.c)->ptrmemfunc_flag)))
      && (((enum tree_code) (type)->common.code) == RECORD_TYPE && ((type)->type.lang_specific) && ((&((type)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    {

      return build_ptrmemfunc ((((((type)->type.values))->common.type)), e, 1);
    }

  return ocp_convert (type, e, (1 | 2 | 4 | 8 | 16 | 64)|convtype, (3));
}
# 1012 "../../../kg++fe/gnu/cp/cvt.c"
tree
     ...
     tree xtype, expr;
{
  ...
  return build_user_type_conversion (xtype, expr, (3));
}
...
build_expr_type_conversion (desires, expr, complain)
     ...
     int complain;
{
  tree basetype = ((expr)->common.type);
  tree conv = (tree) ((void *)0);
  tree winner = (tree) ((void *)0);

  if (expr == cp_global_trees[CPTI_NULL]
      && (desires & 1)
      && !(desires & 16))
  ...
  if (((enum tree_code) (expr)->common.code) == OFFSET_REF)
    expr = resolve_offset_ref (expr);
  expr = convert_from_reference (expr);
  basetype = ((expr)->common.type);

  if (basetype == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];
  ...
  if (! (((enum tree_code) (basetype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (basetype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (basetype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (basetype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((basetype)->type.lang_flag_5)))
    switch (((enum tree_code) (basetype)->common.code))
      {
      case INTEGER_TYPE:
 if ((desires & 16) && null_ptr_cst_p (expr))
   return expr;


      case BOOLEAN_TYPE:
 return (desires & 1) ? expr : (tree) ((void *)0);
      case ENUMERAL_TYPE:
 return (desires & 4) ? expr : (tree) ((void *)0);
      case REAL_TYPE:
 return (desires & 2) ? expr : (tree) ((void *)0);
      case POINTER_TYPE:
 return (desires & 8) ? expr : (tree) ((void *)0);

      case FUNCTION_TYPE:
      case ARRAY_TYPE:
 return (desires & 8) ? default_conversion (expr)
                                      : (tree) ((void *)0);
      default:
 return (tree) ((void *)0);
      }
  ...
  if (! ((&((basetype)->type.lang_specific)->u.c)->h.has_type_conversion))
    return (tree) ((void *)0);

  for (conv = lookup_conversions (basetype); conv; conv = ((conv)->common.chain))
    {
      int win = 0;
      tree candidate;
      tree cand = ((conv)->list.value);

      if (winner && winner == cand)
 continue;

      candidate = ((((cand)->common.type))->common.type);
      if (((enum tree_code) (candidate)->common.code) == REFERENCE_TYPE)
 candidate = ((candidate)->common.type);

      switch (((enum tree_code) (candidate)->common.code))
 {
 case BOOLEAN_TYPE:
 case INTEGER_TYPE:
   win = (desires & 1); break;
      ...
      if (win)
 {
  ...
  if (winner)
    {
      tree type = ((((winner)->common.type))->common.type);
      if (((enum tree_code) (type)->common.code) == REFERENCE_TYPE)
 type = ((type)->common.type);
      return build_user_type_conversion (type, expr, (3));
    }
     ...
     tree type;
{
  ...
  if (type == c_global_trees[CTI_BOOLEAN_TYPE])
    ...
    {
      int precision = ((((type)->type.precision)) > (((integer_types[itk_int])->type.precision)) ? (((type)->type.precision)) : (((integer_types[itk_int])->type.precision)));

      tree totype = c_common_type_for_size (precision, 0);
      if (((type)->common.unsigned_flag)
   && ! int_fits_type_p (((type)->type.maxval), totype))
 ...
 type = integer_types[itk_int];
  ...
  return cp_build_qualified_type_real ((type), (type_quals), tf_error | tf_warning);
}
# 1195 "../../../kg++fe/gnu/cp/cvt.c"
tree
...
{
  if (((enum tree_code) (type)->common.code) == POINTER_TYPE
      && ((enum tree_code) (((expr)->common.type))->common.code) == POINTER_TYPE
      && comp_ptr_ttypes (((type)->common.type), ((((expr)->common.type))->common.type)))
    return build1 (NOP_EXPR, type, expr);
  else
    return global_trees[TI_ERROR_MARK];
}
