...
.Ltext0:
	.section	.rodata
	.type	__FUNCTION__.10605, @object
	.size	__FUNCTION__.10605, 17
__FUNCTION__.10605:
	.string	"init_caller_save"
	.align 4
.LC0:
	.string	"../../../kg++fe/gnu/caller-save.c"
	.text
.globl init_caller_save
	.type	init_caller_save, @function
init_caller_save:
.LFB15:
	.file 1 "../../../kg++fe/gnu/caller-save.c"
	.loc 1 120 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.L26:
	...
	jne	.L28
	.loc 1 171 0
	leal	__FUNCTION__.10605@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$171, 4(%esp)
...
.LFE17:
	...
	.section	.rodata
	.type	__FUNCTION__.11011, @object
	.size	__FUNCTION__.11011, 25
__FUNCTION__.11011:
...
.LBB7:
	...
	je	.L168
	.loc 1 392 0
	leal	__FUNCTION__.11011@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$392, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE21:
	...
	.section	.rodata
	.type	__FUNCTION__.11597, @object
	.size	__FUNCTION__.11597, 15
__FUNCTION__.11597:
...
.LCFI44:
	...
	jne	.L323
	.loc 1 670 0
	leal	__FUNCTION__.11597@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$670, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LCFI50:
	...
	jne	.L347
	.loc 1 747 0
	leal	__FUNCTION__.11703@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$747, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE23:
	...
	.section	.rodata
	.type	__FUNCTION__.11822, @object
	.size	__FUNCTION__.11822, 16
__FUNCTION__.11822:
...
.LBB32:
	...
	je	.L386
	.loc 1 847 0
	leal	__FUNCTION__.11822@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$847, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
