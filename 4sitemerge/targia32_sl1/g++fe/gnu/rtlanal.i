...
# 28 "../../../kg++fe/gnu/rtlanal.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 29 "../../../kg++fe/gnu/rtlanal.c" 2
     ...
     rtx x, y;
{
  ...
  if (! ((rtx_class[(int) (((enum rtx_code) (x)->code))]) == 'i') || ! ((rtx_class[(int) (((enum rtx_code) (y)->code))]) == 'i'))
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 1072, __FUNCTION__);
     ...
     rtx x, in;
{
 ...
 return 0;
  ...
  fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 1545, __FUNCTION__);
}
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) != REG)
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 1764, __FUNCTION__);
     ...
     rtx datum;
{
  ...
  if (! datum)
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 1948, __FUNCTION__);
     ...
     rtx note;
{
 ...
 return;
  ...
  fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 2066, __FUNCTION__);
}
     ...
     rtx x, from, to;
{
      ...
      if (((enum rtx_code) (new)->code) == CONST_INT)
 {
   x = simplify_subreg (((enum machine_mode) (x)->mode), new,
          ...
          (((x)->fld[1]).rtuint));
   if (! x)
     fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 2558, __FUNCTION__);
 }
      else
 (((x)->fld[0]).rtx) = new;
      ...
      if (((enum rtx_code) (new)->code) == CONST_INT)
 {
   ...
   if (! x)
     fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 2574, __FUNCTION__);
 }
      else
 (((x)->fld[0]).rtx) = new;
     ...
     rtx x;
{
 ...
 && ((((x)->fld[1]).rtuint) % ((target_flags & 0x00002000) ? 8 : 4)
     || (mode_size[(int) (mode)]) % ((target_flags & 0x00002000) ? 8 : 4)))
 fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3102, __FUNCTION__);
     ...
     enum machine_mode ymode;
{
  ...
  if (xregno >= 176)
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3139, __FUNCTION__);
  ...
  if (mode_multiple == 0)
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3159, __FUNCTION__);

  y_offset = offset / (mode_size[(int) (ymode)]);
  nregs_multiple = nregs_xmode / nregs_ymode;
  return (y_offset / (mode_multiple / nregs_multiple)) * nregs_ymode;
}
# 3173 "../../../kg++fe/gnu/rtlanal.c"
_Bool
     ...
     enum machine_mode ymode;
{
  ...
  if (xregno >= 176)
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3185, __FUNCTION__);
...
# 3214 "../../../kg++fe/gnu/rtlanal.c"
  ...
  mode_multiple = (mode_size[(int) (xmode)]) / (mode_size[(int) (ymode)]);
  if (mode_multiple == 0)
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3222, __FUNCTION__);
     ...
     rtx call_insn, boundary;
{
 ...
 if ((((((((((p)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint) >= 176)
   fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3290, __FUNCTION__);
 ...
 {
   if (before != boundary)
     fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3319, __FUNCTION__);
   break;
 }
      ...
      for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
 {
  ...
  return 0;
     ...
     default:
      ...
      break;
    default:
      fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3485, __FUNCTION__);
    }
  return 1;
}
     ...
     rtx insn, *xp, val, new;
{
  ...
  if (!(((enum rtx_code) (x)->code) == REG))
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3519, __FUNCTION__);
      ...
      for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
 {
   ...
   switch (((enum rtx_code) (x)->code))
     ...
     default:
      ...
      break;
    default:
      fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3589, __FUNCTION__);
    }
  if (!apply_change_group ())
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3592, __FUNCTION__);
     ...
     edge e;
{
  ...
  if ((e->flags & 2) && ((e)->src->succ->succ_next && (e)->dest->pred->pred_next))
    fancy_abort ("../../../kg++fe/gnu/rtlanal.c", 3607, __FUNCTION__);
