...
# 44 "../../../kg++fe/gnu/dwarf2asm.c" 2
# 55 "../../../kg++fe/gnu/dwarf2asm.c"
void
     ...
     int encoding;
{
  ...
  fancy_abort ("../../../kg++fe/gnu/dwarf2asm.c", 353, __FUNCTION__);
}
     ...
     int format;
{
  ...
  if (format < 0 || format > 0xff || format_names[format] == ((void *)0))
    fancy_abort ("../../../kg++fe/gnu/dwarf2asm.c", 507, __FUNCTION__);
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) != SYMBOL_REF)
    fancy_abort ("../../../kg++fe/gnu/dwarf2asm.c", 753, __FUNCTION__);
...
# 870 "../../../kg++fe/gnu/dwarf2asm.c"
 ...
 case 0x10:
   if (((enum rtx_code) (addr)->code) != SYMBOL_REF)
     fancy_abort ("../../../kg++fe/gnu/dwarf2asm.c", 890, __FUNCTION__);
 ...
 default:
   ...
   fancy_abort ("../../../kg++fe/gnu/dwarf2asm.c", 901, __FUNCTION__);
 }
