...
# 33 "../../../kg++fe/gnu/cp/repo.c" 2
# 1 "../../../include/gnu/obstack.h" 1
# 34 "../../../kg++fe/gnu/cp/repo.c" 2
  ...
  if ((tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 't'))
    {
      ...
      if (!(((t)->type.size) != (tree) ((void *)0)) || ((&((t)->type.lang_specific)->u.c)->being_defined))
 fancy_abort ("../../../kg++fe/gnu/cp/repo.c", 105, __FUNCTION__);

      vtable = get_vtbl_decl_for_binfo (((t)->type.binfo));
     ...
     tree t;
{
 ...
 mark_decl_instantiated (((((enum tree_code) (t)->common.code) == FUNCTION_DECL || ((enum tree_code) (t)->common.code) == TEMPLATE_DECL) && ((t)->decl.lang_specific) && (((t)->decl.lang_specific)->u.f.cloned_function) != (tree) ((void *)0))
    ? (((t)->decl.lang_specific)->u.f.cloned_function) : t,
    0);
    }
  else
    fancy_abort ("../../../kg++fe/gnu/cp/repo.c", 149, __FUNCTION__);

  if (! (((id)->common.lang_flag_3)))
    {
      (((id)->common.lang_flag_3)) = 1;
      pending_repo = tree_cons ((tree) ((void *)0), id, pending_repo);
    }
}
# 202 "../../../kg++fe/gnu/cp/repo.c"
void
     ...
     char **pp;
{
 ...
 break;
      ++p;
      if (backquote)
 __extension__ ({ struct obstack *__o = (&temporary_obstack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (c); (void) 0; });
      else if (! inside && c == ' ')
 break;
      else if (! inside && c == '\\')
 backquote = 1;
...
{
  int c;
  while ((c = _IO_getc (stream)) != (-1) && c != '\n')
    __extension__ ({ struct obstack *__o = (&temporary_obstack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (c); (void) 0; });
  if (__extension__ ({ struct obstack *__o = (&temporary_obstack); (unsigned) (__o->next_free - __o->object_base); }) == 0)
    return ((void *)0);
  __extension__ ({ struct obstack *__o = (&temporary_obstack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('\0'); (void) 0; });
  return __extension__ ({ struct obstack *__o1 = (&temporary_obstack); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; });
}
     ...
     const char *filename;
{
 ...
 {
 case 'A':
   old_args = ggc_alloc_string((buf + 2), -1);
   break;
 case 'D':
   old_dir = ggc_alloc_string((buf + 2), -1);
   break;
 case 'M':
   old_main = ggc_alloc_string((buf + 2), -1);
   break;
 case 'C':
 case 'O':
   {
     tree id = (__builtin_constant_p (buf + 2) ? get_identifier_with_length ((buf + 2), (unsigned) strlen (buf + 2)) : (get_identifier) (buf + 2));
     tree orig;

     if (buf[0] == 'C')
       {
  (((id)->common.lang_flag_4)) = 1;
  orig = global_trees[TI_INTEGER_ONE];
       }
     else
       orig = (tree) ((void *)0);
 ...
 default:
   error ("mysterious repository information in %s", repo_name);
      ...
      __extension__ ({ struct obstack *__o = (&temporary_obstack); void *__obj = (buf); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
    }
}
...
finish_repo ()
{
  ...
  for (t = original_repo; t; t = ((t)->common.chain))
    {
      if (! (((((t)->list.value))->common.lang_flag_3))
   || (! ((t)->list.purpose) && (((((t)->list.value))->common.lang_flag_4))))
 {
   repo_changed = 1;
   break;
 }
      (((((t)->list.value))->common.lang_flag_3)) = 0;
    }



  if (! repo_changed)
    for (t = pending_repo; t; t = ((t)->common.chain))
      {
 if ((((((t)->list.value))->common.lang_flag_3)))
   {
     repo_changed = 1;
 ...
 || (args == ((void *)0)) != (old_args == ((void *)0))
 || (args && strcmp (old_args, args) != 0))
      repo_changed = 1;

  if (! repo_changed || (global_dc)->diagnostic_count[(int) (DK_ERROR)] || (global_dc)->diagnostic_count[(int) (DK_SORRY)])
    goto out;
  ...
  for (t = pending_repo; t; t = ((t)->common.chain))
    {
      tree val = ((t)->list.value);
      char type = (((val)->common.lang_flag_4)) ? 'C' : 'O';

      fprintf (repo_file, "%c %s\n", type, ((char *)(val)->identifier.id.str));
    }
...
# 1 "../../../kg++fe/gnu/MIPS/gt-cp-repo.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-cp-repo.h"
const struct ggc_root_tab gt_ggc_r_gt_cp_repo_h[] = {
  {
    &original_repo,
    1,
    sizeof (original_repo),
