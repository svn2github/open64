...
# 36 "../../../kg++fe/gnu/cp/tree.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 37 "../../../kg++fe/gnu/cp/tree.c" 2
...
# 40 "../../../kg++fe/gnu/cp/tree.c" 2

# 1 "../../../kg++fe/gnu/defaults.h" 1
# 42 "../../../kg++fe/gnu/cp/tree.c" 2
...
static tree build_srcloc (const char *, int);
...
extern int cp_statement_code_p (enum tree_code);

static tree handle_java_interface_attribute (tree *, tree, tree, int, _Bool *);
static tree handle_com_interface_attribute (tree *, tree, tree, int, _Bool *);
static tree handle_init_priority_attribute (tree *, tree, tree, int, _Bool *);
     ...
     int allow_cast_as_lvalue;
{
  ...
  if (ref == (cfun ? (cfun->language)->x_current_class_ptr : (tree) ((void *)0)))
    return clk_none;

  switch (((enum tree_code) (ref)->common.code))
    {
    ...
    case REALPART_EXPR:
    case IMAGPART_EXPR:
      return lvalue_p_1 (((ref)->exp.operands[0]),
   ...
   comptypes ((((((ref)->common.type))->type.main_variant)), (((((((ref)->exp.operands[0]))->common.type))->type.main_variant)), 0))
 ...
 return clk_none;
    ...
    case COMPONENT_REF:
      op1_lvalue_kind = lvalue_p_1 (((ref)->exp.operands[0]),
        treat_class_rvalues_as_lvalues,
        allow_cast_as_lvalue);
      if (op1_lvalue_kind


   && ((enum tree_code) (((ref)->exp.operands[1]))->common.code) == FIELD_DECL
   && ((((((ref)->exp.operands[1])))->decl.lang_flag_4) == 1))
 {
   ...
   op1_lvalue_kind |= clk_bitfield;
    ...
    case VAR_DECL:
      if (((ref)->common.readonly_flag) && ! ((ref)->common.static_flag)
   && ((ref)->decl.lang_specific)
   && (((ref)->decl.lang_flag_3)))
 return clk_none;
    case INDIRECT_REF:
    case ARRAY_REF:
    case PARM_DECL:
    case RESULT_DECL:
      if (((enum tree_code) (((ref)->common.type))->common.code) != METHOD_TYPE)
 return clk_ordinary;
      break;


    case SCOPE_REF:
      fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 150, __FUNCTION__);
    case OFFSET_REF:
      if (((enum tree_code) (((ref)->exp.operands[1]))->common.code) == FUNCTION_DECL)
 return clk_ordinary;
    ...
    case MIN_EXPR:
      op1_lvalue_kind = lvalue_p_1 (((ref)->exp.operands[0]),
        treat_class_rvalues_as_lvalues,
        allow_cast_as_lvalue);
      op2_lvalue_kind = lvalue_p_1 (((ref)->exp.operands[1]),
        treat_class_rvalues_as_lvalues,
        allow_cast_as_lvalue);
      break;

    case COND_EXPR:
      op1_lvalue_kind = lvalue_p_1 (((ref)->exp.operands[1]),
        treat_class_rvalues_as_lvalues,
        allow_cast_as_lvalue);
      op2_lvalue_kind = lvalue_p_1 (((ref)->exp.operands[2]),
        treat_class_rvalues_as_lvalues,
        allow_cast_as_lvalue);
      break;
    ...
    case COMPOUND_EXPR:
      return lvalue_p_1 (((ref)->exp.operands[1]),
    treat_class_rvalues_as_lvalues,
    allow_cast_as_lvalue);
    ...
    case VA_ARG_EXPR:
      return ((treat_class_rvalues_as_lvalues
        && (((enum tree_code) (((ref)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((ref)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((ref)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((ref)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((ref)->common.type))->type.lang_flag_5)))
       ? clk_class : clk_none);

    case FUNCTION_DECL:


      return ((((enum tree_code) (((ref)->common.type))->common.code) == METHOD_TYPE)
     ...
     tree value;
{
  ...
  t = build (TARGET_EXPR, ((decl)->common.type), decl, value,
      cxx_maybe_build_cleanup (decl), (tree) ((void *)0));
     ...
     tree init;
{
  ...
  abstract_virtuals_error ((tree) ((void *)0), type);

  if (((enum tree_code) (init)->common.code) != CALL_EXPR && ((enum tree_code) (init)->common.code) != AGGR_INIT_EXPR)
    return convert (type, init);

  slot = build (VAR_DECL, type);
  ((slot)->decl.artificial_flag) = 1;
  ((slot)->decl.context) = current_function_decl;
  layout_decl (slot, 0);
# 342 "../../../kg++fe/gnu/cp/tree.c"
  fn = ((init)->exp.operands[0]);
  rval = build (AGGR_INIT_EXPR, type, fn, ((init)->exp.operands[1]), slot);
  ((rval)->common.side_effects_flag) = 1;
  (((rval))->common.lang_flag_0)
    = (((enum tree_code) (fn)->common.code) == ADDR_EXPR
       && ((enum tree_code) (((fn)->exp.operands[0]))->common.code) == FUNCTION_DECL
       && (((((fn)->exp.operands[0]))->decl.lang_specific)->decl_flags.constructor_attr));
     ...
     tree type;
{
  ...
  if (((enum tree_code) (init)->common.code) == TARGET_EXPR)
    return init;
...
get_target_expr (init)
     tree init;
{
  return build_target_expr_with_type (init, ((init)->common.type));
}
...
break_out_calls (exp)
     tree exp;
{
  register tree t1, t2 = (tree) ((void *)0);
  ...
  switch (tree_code_type[(int) (code)])
    {
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 414, __FUNCTION__);
...
# 431 "../../../kg++fe/gnu/cp/tree.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 438, __FUNCTION__);
      }
      return exp;
 ...
 {
   t1 = break_out_calls (((exp)->exp.operands[i]));
   if (t1 != ((exp)->exp.operands[i]))
     {
       exp = copy_node (exp);
       ((exp)->exp.operands[i]) = t1;
     }
 }
      return exp;
    ...
    case '<':
    case '2':
      t2 = break_out_calls (((exp)->exp.operands[1]));
      if (t2 != ((exp)->exp.operands[1]))
 changed = 1;
    case '1':
      t1 = break_out_calls (((exp)->exp.operands[0]));
      if (t1 != ((exp)->exp.operands[0]))
 changed = 1;
      if (changed)
 {
   if (tree_code_length[(int) (code)] == 1)
     return build1 (code, ((exp)->common.type), t1);
   else
     return build (code, ((exp)->common.type), t1, t2);
 }
      return exp;
    }
     ...
     tree basetype, rettype, argtypes;
{
  ...
  argtypes = tree_cons ((tree) ((void *)0), ptype, argtypes);
  ((t)->type.values) = argtypes;
  ((argtypes)->common.side_effects_flag) = 1;



  hashcode = ((size_t) (basetype) & 0777777) + ((size_t) (rettype) & 0777777) +
     ...
     tree index_type;
{
  ...
  if (elt_type == global_trees[TI_ERROR_MARK] || index_type == global_trees[TI_ERROR_MARK])
  ...
  if ((scope_chain->x_processing_template_decl
       && index_type && ((index_type)->type.maxval)
       && ((enum tree_code) (((index_type)->type.maxval))->common.code) != INTEGER_CST)
  ...
  ((t)->type.needs_constructing_flag)
    = ((((elt_type)->type.main_variant))->type.needs_constructing_flag);
  (((t)->type.lang_flag_4))
    = (((((elt_type)->type.main_variant))->type.lang_flag_4));
  return t;
}
     ...
     tree index_type;
{
  ...
  int cv_quals = type_quals & (0x1|0x2);
  int other_quals = type_quals & ~(0x1|0x2);

  if (cv_quals)
    elt_type = cp_build_qualified_type_real ((elt_type), (other_quals), tf_error | tf_warning);

  t = build_cplus_array_type_1 (elt_type, index_type);

  if (cv_quals)
    t = cp_build_qualified_type_real ((t), (cv_quals), tf_error | tf_warning);

  return t;
}
# 591 "../../../kg++fe/gnu/cp/tree.c"
tree
     ...
     tsubst_flags_t complain;
{
  ...
  if (type_quals & (0x1 | 0x2)
   ...
   || ((enum tree_code) (type)->common.code) == METHOD_TYPE))
    {
      bad_quals |= type_quals & (0x1 | 0x2);
      if (((enum tree_code) (type)->common.code) != REFERENCE_TYPE)
 bad_func_quals |= type_quals & (0x1 | 0x2);
      type_quals &= ~(0x1 | 0x2);
    }
  ...
  bad_quals &= ~0x1;
      ...
      if (bad_quals)
  {
    tree bad_type = build_qualified_type (global_trees[TI_PTR_TYPE], bad_quals);
  ...
  if (((enum tree_code) (type)->common.code) == ARRAY_TYPE)
    {
      ...
      tree t;
      tree element_type
 = cp_build_qualified_type_real (((type)->common.type),
     type_quals,
     complain);

      if (element_type == global_trees[TI_ERROR_MARK])
 return global_trees[TI_ERROR_MARK];


      for (t = ((type)->type.main_variant); t; t = ((t)->type.next_variant))
 if (cp_type_quals (t) == type_quals
     && ((t)->type.name) == ((type)->type.name)
     && ((t)->type.context) == ((type)->type.context))
   break;
      ...
      if (!t)
 {
   ...
   ((t)->common.type) = element_type;
 }
# 694 "../../../kg++fe/gnu/cp/tree.c"
      ((t)->type.needs_constructing_flag)
 = ((((element_type)->type.main_variant))->type.needs_constructing_flag);
      (((t)->type.lang_flag_4))
 = (((((element_type)->type.main_variant))->type.lang_flag_4));
      return t;
    }
  else if ((((enum tree_code) (type)->common.code) == RECORD_TYPE && ((type)->type.lang_specific) && ((&((type)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    {
      ...
      t = (((((type)->type.values))->common.type));
  ...
  if (result != type
      ...
      && ((enum tree_code) (((type)->common.type))->common.code) == METHOD_TYPE)
    ((result)->type.lang_specific) = ((void *)0);
...
canonical_type_variant (t)
     tree t;
{
  return cp_build_qualified_type_real ((((t)->type.main_variant)), (cp_type_quals (t)), tf_error | tf_warning);
}
     ...
     tree binfo;
{
  ...
  if (binfos == (tree) ((void *)0))
    return;


  for (j = ((binfos)->vec.length)-1;
       j >= 0; j--)
    {
      tree base_binfo = ((binfos)->vec.a[j]);
      new_binfo = ((binfos)->vec.a[j])
 = make_binfo ((((base_binfo))->vec.a[1]),
        base_binfo,
        (((base_binfo))->vec.a[2]),
        (((base_binfo))->vec.a[3]));
      ((new_binfo)->common.public_flag) = ((base_binfo)->common.public_flag);
      ((new_binfo)->common.protected_flag) = ((base_binfo)->common.protected_flag);
      ((new_binfo)->common.static_flag) = ((base_binfo)->common.static_flag);
      (((new_binfo))->vec.a[0]) = binfo;
      ((new_binfo)->vec.a[10]) = (tree) ((void *)0);
      unshare_base_binfos (new_binfo);
    }
}
# 783 "../../../kg++fe/gnu/cp/tree.c"
     ...
     const void *data;
{
  ...
  return (((t)->list.value) == proxy->value
   && ((t)->list.purpose) == proxy->purpose
   && ((t)->common.chain) == proxy->chain);
}
     ...
     tree chain;
{
  ...
  if (chain)
    hashcode += ((size_t) (chain) & 0777777);

  if (value)
    hashcode += ((size_t) (value) & 0777777);
  else
    hashcode += 1007;
  if (purpose)
    hashcode += ((size_t) (purpose) & 0777777);
  else
    hashcode += 1009;
  return hashcode;
}
...
{
  tree t = (tree) p;
  return list_hash_pieces (((t)->list.purpose),
      ((t)->list.value),
      ((t)->common.chain));
}
     ...
     tree purpose, value, chain;
{
  ...
  if (!*slot)
    *slot = (void *) tree_cons (purpose, value, chain);
  return *slot;
}
...
hash_tree_chain (value, chain)
     tree value, chain;
{
  return hash_tree_cons ((tree) ((void *)0), value, chain);
}
     ...
     tree list1, list2;
{
  ...
  if (list1 == 0)
    return list2;
  if (((list1)->common.chain) == (tree) ((void *)0))
    return hash_tree_chain (((list1)->list.value), list2);
  return hash_tree_chain (((list1)->list.value),
     hash_chainon (((list1)->common.chain), list2));
}
# 914 "../../../kg++fe/gnu/cp/tree.c"
tree
     ...
     tree vtable, virtuals;
{
  ...
  if (((enum tree_code) (binfo)->common.code) == TREE_VEC)
    type = ((binfo)->common.type);
  else
    {
      type = binfo;
      binfo = (((((enum tree_code) (type)->common.code)) == RECORD_TYPE || (((enum tree_code) (type)->common.code)) == UNION_TYPE) && (((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5))) ? ((binfo)->type.binfo) : (tree) ((void *)0);
    }

  ((new_binfo)->common.type) = ((type)->type.main_variant);
  (((new_binfo))->vec.a[1]) = offset;
  (((new_binfo))->vec.a[2]) = vtable;
  (((new_binfo))->vec.a[3]) = virtuals;

  if (binfo && (((binfo))->vec.a[4]) != (tree) ((void *)0))
    (((new_binfo))->vec.a[4]) = copy_node ((((binfo))->vec.a[4]));
  return new_binfo;
}
     ...
     tree binfo;
{
  ...
  reversed_path = (tree) ((void *)0);
  while (binfo)
    {
      reversed_path = tree_cons ((tree) ((void *)0), binfo, reversed_path);
      binfo = (((binfo))->vec.a[0]);
    }
     ...
     tree elem;
{
  ...
  fprintf (stderr, "type \"%s\", offset = ",
    (((char *)((((((((elem)->common.type))->type.name))->decl.name)))->identifier.id.str)));
  fprintf (stderr, "%lld",
    ((((((elem))->vec.a[1]))->int_cst.int_cst).low));
  fprintf (stderr, "\nvtable type:\n");
  debug_tree (((elem)->common.type));
  if ((((elem))->vec.a[2]))
    fprintf (stderr, "vtable decl \"%s\"\n",
      ((char *)(((get_vtbl_decl_for_binfo (elem))->decl.name))->identifier.id.str));
  else
    fprintf (stderr, "no vtable decl yet\n");
  fprintf (stderr, "virtuals:\n");
  virtuals = (((elem))->vec.a[3]);
  n = 0;

  while (virtuals)
    {
      tree fndecl = ((virtuals)->list.value);
      fprintf (stderr, "%s [%ld =? %ld]\n",
        ((char *)(decl_assembler_name (fndecl))->identifier.id.str),
        (long) n, (long) (((((fndecl)->decl.vindex))->int_cst.int_cst).low));
      ++n;
     ...
     tree t;
{
  ...
  if (((enum tree_code) (t)->common.code) == FUNCTION_DECL)
    ...
    {
      for (i=0; t; t = ((t)->common.chain))
 i++;
      return i;
    }

  fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 1009, __FUNCTION__);
  return 0;
}
     ...
     tree x;
{
  ...
  if (((enum tree_code) (x)->common.code) == OFFSET_REF)
    x = ((x)->exp.operands[1]);
  if ((((enum tree_code) (x)->common.code) == BASELINK))
    x = ((((x))->exp.operands[1]));
  return (((enum tree_code) (x)->common.code) == FUNCTION_DECL
   || ((enum tree_code) (x)->common.code) == TEMPLATE_ID_EXPR
     ...
     tree x;
{
  ...
  return ((((enum tree_code) (x)->common.code) == OVERLOAD && ((x)->common.chain))
   || (((enum tree_code) (((((enum tree_code) (x)->common.code) == OVERLOAD) ? (((struct tree_overload*)(x))->function) : (x)))->common.code) == TEMPLATE_DECL && ((enum tree_code) (((((((enum tree_code) (x)->common.code) == OVERLOAD) ? (((struct tree_overload*)(x))->function) : (x)))->decl.result))->common.code) == FUNCTION_DECL)
   || ((enum tree_code) (x)->common.code) == TEMPLATE_ID_EXPR);
}
...
get_first_fn (from)
     tree from;
{
  (void) (((is_overloaded_fn (from)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 1061, __FUNCTION__), 0) : 0);

  if ((((enum tree_code) (from)->common.code) == BASELINK))
    from = ((((from))->exp.operands[1]));
  return ((((enum tree_code) (from)->common.code) == OVERLOAD) ? (((struct tree_overload*)(from))->function) : (from));
}
...
bound_pmf_p (t)
     tree t;
{
  return (((enum tree_code) (t)->common.code) == OFFSET_REF
   && (((enum tree_code) (((((t)->exp.operands[1]))->common.type))->common.code) == RECORD_TYPE && ((((((t)->exp.operands[1]))->common.type))->type.lang_specific) && ((&((((((t)->exp.operands[1]))->common.type))->type.lang_specific)->u.c)->ptrmemfunc_flag)));
}
     ...
     tree chain;
{
  ...
  ((result)->common.type) = cp_global_trees[CPTI_UNKNOWN_TYPE];
  (((struct tree_overload*)(result))->function) = decl;
  ((result)->common.chain) = chain;
...
build_overload (decl, chain)
     ...
     tree chain;
{
  if (! chain && ((enum tree_code) (decl)->common.code) != TEMPLATE_DECL)
    return decl;
  if (chain && ((enum tree_code) (chain)->common.code) != OVERLOAD)
    chain = ovl_cons (chain, (tree) ((void *)0));
...
cxx_printable_name (decl, v)
     ...
     int v;
{
  static tree decl_ring[4];
  static char *print_ring[4];
 ...
 ring_counter = 0;
      if (decl_ring[ring_counter] == current_function_decl)
 fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 1174, __FUNCTION__);
    }
...
build_exception_variant (type, raises)
     ...
     tree raises;
{
  tree v = ((type)->type.main_variant);
  int type_quals = ((((type)->common.readonly_flag) * 0x1) | (((type)->common.volatile_flag) * 0x2) | (((type)->type.restrict_flag) * 0x4) | ((((enum tree_code) (type)->common.code) == RECORD_TYPE && ((type)->common.type)) * 0x8));

  for (; v; v = ((v)->type.next_variant))
    if (((((v)->common.readonly_flag) * 0x1) | (((v)->common.volatile_flag) * 0x2) | (((v)->type.restrict_flag) * 0x4) | ((((enum tree_code) (v)->common.code) == RECORD_TYPE && ((v)->common.type)) * 0x8)) == type_quals
        && comp_except_specs (raises, ((v)->type.binfo), 1))
      return v;
...
bind_template_template_parm (t, newargs)
     ...
     tree newargs;
{
  tree decl = ((t)->type.name);
  tree t2;

  t2 = make_aggr_type (BOUND_TEMPLATE_TEMPLATE_PARM);
  decl = build_decl (TYPE_DECL, ((decl)->decl.name), (tree) ((void *)0));



  (((t2)->type.values)) = copy_node ((((t)->type.values)));
  (((template_parm_index*)((((t2)->type.values))))->decl) = decl;
  ((&(((t2))->type.lang_specific)->u.c) ->template_info)
    = tree_cons (((((enum tree_code) (t)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM) ? (((((((enum tree_code) (t)->common.code) == ENUMERAL_TYPE ? ((((t))->type.binfo)) : (((enum tree_code) (t)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM ? ((&(((t))->type.lang_specific)->u.c) ->template_info) : (((t)->type.lang_specific) ? ((&(((t))->type.lang_specific)->u.c)->template_info) : (tree) ((void *)0)))))->list.purpose))) : ((t)->type.name)),
   newargs, (tree) ((void *)0));

  ((decl)->common.type) = t2;
  ((t2)->type.name) = decl;
  ((t2)->common.chain) = decl;
  ((t2)->type.size) = 0;
...
count_trees_r (tp, walk_subtrees, data)
     tree *tp __attribute__ ((__unused__));
     ...
     void *data;
{
  ...
  if (htab_find (*statements, t))
    fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 1280, __FUNCTION__);
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  if ((tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 't')
      ...
      && (decl_function_context ((((((t)->type.main_variant))->common.chain)))
     ...
     tree t;
{
  ...
  t = walk_tree_without_duplicates (&t, no_linkage_helper, ((void *)0));
...
array_type_nelts_top (type)
     tree type;
{
  return fold (build (PLUS_EXPR, sizetype_tab[(int) SIZETYPE],
  ...
  while (((enum tree_code) (type)->common.code) == ARRAY_TYPE)
    {
      ...
      sz = fold (build (MULT_EXPR, sizetype_tab[(int) SIZETYPE], sz, n));
      type = ((type)->common.type);
    }
  return sz;
}
     ...
     void *data;
{
  ...
  if (((enum tree_code) (t)->common.code) == TARGET_EXPR)
    {
      tree u;

      if (((enum tree_code) (((t)->exp.operands[1]))->common.code) == AGGR_INIT_EXPR)
 {
   mark_used (((((((t)->exp.operands[1]))->exp.operands[0]))->exp.operands[0]));
   u = build_cplus_new
     (((t)->common.type), break_out_target_exprs (((t)->exp.operands[1])));
 }
      else
 {
   u = build_target_expr_with_type
     (break_out_target_exprs (((t)->exp.operands[1])), ((t)->common.type));
 }


      splay_tree_insert (target_remap,
    (splay_tree_key) ((t)->exp.operands[0]),
    (splay_tree_value) ((u)->exp.operands[0]));
  ...
  else if (((enum tree_code) (t)->common.code) == CALL_EXPR)
    mark_used (((((t)->exp.operands[0]))->exp.operands[0]));
...
build_min_nt (enum tree_code code, ...)
{
  ...
  { va_list p; __builtin_va_start(p,code); { struct Qdmy;
  struct Qdmy;

  t = make_node (code);
  length = tree_code_length[(int) (code)];
  ((t)->exp.complexity) = lineno;

  for (i = 0; i < length; i++)
    {
      tree x = __builtin_va_arg(p,tree);
      ((t)->exp.operands[i]) = x;
    }
...
build_min (enum tree_code code, tree tt, ...)
{
  ...
  { va_list p; __builtin_va_start(p,tt); { struct Qdmy;
  struct Qdmy;
  struct Qdmy;
...
static tree shared_int_cache[256];
...
{
  if (i >= 256)
    return build_int_2_wide ((unsigned long long) (i), (long long) (0));

  if (!shared_int_cache[i])
    shared_int_cache[i] = build_int_2_wide ((unsigned long long) (i), (long long) (0));
     ...
     tree t;
{
  ...
  fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 1605, __FUNCTION__);
     ...
     tree elem, vec;
{
  ...
  if (vec)
    for (i = 0; i < ((vec)->vec.length); ++i)
      if (comptypes ((elem), (((((vec)->vec.a[i]))->common.type)), 0))
 return ((vec)->vec.a[i]);
     ...
     tree decl;
{
 ...
 return decl;
      else if ((tree_code_type[(int) (((enum tree_code) (decl)->common.code))] == 't'))
 decl = ((((((((decl)->type.main_variant))->common.chain)))->decl.context) ? (((((((decl)->type.main_variant))->common.chain)))->decl.context) : global_namespace);
      else
 decl = (((decl)->decl.context) ? ((decl)->decl.context) : global_namespace);
    }
}
     ...
     tree t1, t2;
{
 ...
 return cp_tree_equal (((t1)->exp.operands[0]), ((t2)->exp.operands[0]));
      else
 return cp_tree_equal (((t1)->exp.operands[0]), t2);
    }
  else if (code2 == NOP_EXPR || code2 == CONVERT_EXPR
    || code2 == NON_LVALUE_EXPR)
    return cp_tree_equal (t1, ((t2)->exp.operands[0]));
 ...
 && (((t1)->int_cst.int_cst).high) == (((t2)->int_cst.int_cst).high);
    ...
    case REAL_CST:
      return real_compare (EQ_EXPR, &((*((t1)->real_cst.real_cst_ptr))), &((*((t2)->real_cst.real_cst_ptr))));
 ...
 && !memcmp (((t1)->string.pointer), ((t2)->string.pointer),
    ...
    case CONSTRUCTOR:
      ...
      if (!(comptypes ((((t1)->common.type)), (((t2)->common.type)), 0)

     && ((t1)->exp.operands[0]) == ((t2)->exp.operands[0])))
 return 0;
      return cp_tree_equal (((t1)->exp.operands[1]), ((t2)->exp.operands[1]));

    case TREE_LIST:
      cmp = cp_tree_equal (((t1)->list.purpose), ((t2)->list.purpose));
      if (cmp <= 0)
 return cmp;
      cmp = cp_tree_equal (((t1)->list.value), ((t2)->list.value));
      if (cmp <= 0)
 return cmp;
      return cp_tree_equal (((t1)->common.chain), ((t2)->common.chain));

    case SAVE_EXPR:
      return cp_tree_equal (((t1)->exp.operands[0]), ((t2)->exp.operands[0]));

    case CALL_EXPR:
      cmp = cp_tree_equal (((t1)->exp.operands[0]), ((t2)->exp.operands[0]));
      if (cmp <= 0)
 return cmp;
 ...
 return cmp;
    ...
    case WITH_CLEANUP_EXPR:
      ...
      if (cmp <= 0)
 return cmp;
      return cp_tree_equal (((t1)->exp.operands[1]), ((t1)->exp.operands[1]));
 ...
 return cp_tree_equal (((t1)->exp.operands[0]), ((t2)->exp.operands[0]));
    ...
    case TEMPLATE_PARM_INDEX:
      return ((((template_parm_index*)(t1))->index) == (((template_parm_index*)(t2))->index)
       && (((template_parm_index*)(t1))->level) == (((template_parm_index*)(t2))->level)
       && comptypes (((((((template_parm_index*)(t1))->decl))->common.type)), ((((((template_parm_index*)(t2))->decl))->common.type)), 0));


    case SIZEOF_EXPR:
    case ALIGNOF_EXPR:
      if (((enum tree_code) (((t1)->exp.operands[0]))->common.code) != ((enum tree_code) (((t2)->exp.operands[0]))->common.code))
 return 0;
      if ((tree_code_type[(int) (((enum tree_code) (((t1)->exp.operands[0]))->common.code))] == 't'))
 return comptypes ((((t1)->exp.operands[0])), (((t2)->exp.operands[0])), 0);
      break;

    case PTRMEM_CST:


      return ((((ptrmem_cst_t)(t1))->member) == (((ptrmem_cst_t)(t2))->member)
       && comptypes ((((((enum tree_code) ((((t1))->common.type))->common.code) == POINTER_TYPE && ((enum tree_code) ((((((t1))->common.type))->common.type))->common.code) == OFFSET_TYPE) ? (((((((t1))->common.type))->common.type))->type.maxval) : ((((((((((((t1))->common.type))->type.values))->common.type)))->common.type))->type.maxval))), (((((enum tree_code) ((((t2))->common.type))->common.code) == POINTER_TYPE && ((enum tree_code) ((((((t2))->common.type))->common.type))->common.code) == OFFSET_TYPE) ? (((((((t2))->common.type))->common.type))->type.maxval) : ((((((((((((t2))->common.type))->type.values))->common.type)))->common.type))->type.maxval))), 0));
 ...
 for (i = 0; i < tree_code_length[(int) (code1)]; ++i)
   {
     cmp = cp_tree_equal (((t1)->exp.operands[i]), ((t2)->exp.operands[i]));
     if (cmp <= 0)
       return cmp;
   }
 return cmp;
     ...
     int line;
{
  ...
  t = make_node (SRCLOC);
  (((struct tree_srcloc*)(t))->filename) = file;
  (((struct tree_srcloc*)(t))->linenum) = line;
     ...
     tree arg;
{
  ...
  if (((enum tree_code) (arg)->common.code) == OVERLOAD)
...
varargs_function_p (function)
     tree function;
{
  tree parm = ((((function)->common.type))->type.values);
  for (; parm; parm = ((parm)->common.chain))
    if (((parm)->list.value) == global_trees[TI_VOID_TYPE])
      return 0;
  return 1;
}
...
member_p (decl)
     tree decl;
{
  const tree ctx = ((decl)->decl.context);
  return (ctx && (tree_code_type[(int) (((enum tree_code) (ctx)->common.code))] == 't'));
}
...
build_dummy_object (type)
     tree type;
{
  tree decl = build1 (NOP_EXPR, build_pointer_type (type), c_global_trees[CTI_VOID_ZERO]);
     ...
     tree *binfop;
{
  ...
  if (scope_chain->class_type
      && (binfo = lookup_base (scope_chain->class_type, type,
  ...
  if ((cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)) && context == scope_chain->class_type



      && comptypes (((((((cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)))->common.type))->type.main_variant)), (scope_chain->class_type), 0))

    decl = (cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0));
  else
     ...
     tree ob;
{
  ...
  return (((enum tree_code) (ob)->common.code) == NOP_EXPR
   && ((ob)->exp.operands[0]) == c_global_trees[CTI_VOID_ZERO]);
}
     ...
     tree t;
{
  ...
  if ((((enum tree_code) (t)->common.code) == INTEGER_TYPE || ((enum tree_code) (t)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (t)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (t)->common.code) == CHAR_TYPE))
    return 1;
  if ((((enum tree_code) (t)->common.code) == REAL_TYPE || (((enum tree_code) (t)->common.code) == COMPLEX_TYPE && ((enum tree_code) (((t)->common.type))->common.code) == REAL_TYPE)))
    return 1;
  ...
  if (! (((((enum tree_code) (t)->common.code)) == RECORD_TYPE || (((enum tree_code) (t)->common.code)) == UNION_TYPE) && (((enum tree_code) (t)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t)->type.lang_flag_5))))
    return 0;
  if (((&((t)->type.lang_specific)->u.c)->non_pod_class))
    return 0;
  return 1;
}
...
const struct attribute_spec cxx_attribute_table[] =
{
  ...
  { "java_interface", 0, 0, 0, 0, 0, handle_java_interface_attribute },
  { "com_interface", 0, 0, 0, 0, 0, handle_com_interface_attribute },
  { "init_priority", 1, 1, 1, 0, 0, handle_init_priority_attribute },
     ...
     _Bool *no_add_attrs;
{
  if ((tree_code_type[(int) (((enum tree_code) (*node)->common.code))] == 'd')
      || !(((((enum tree_code) (*node)->common.code)) == RECORD_TYPE || (((enum tree_code) (*node)->common.code)) == UNION_TYPE) && (((enum tree_code) (*node)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (*node)->common.code) == TYPENAME_TYPE || ((enum tree_code) (*node)->common.code) == TYPEOF_TYPE || ((enum tree_code) (*node)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((*node)->type.lang_flag_5)))
      || !((*node)->type.lang_flag_3))
    {
  ...
  ((&((*node)->type.lang_specific)->u.c)->java_interface) = 1;
...
handle_init_priority_attribute (node, name, args, flags, no_add_attrs)
     ...
     _Bool *no_add_attrs;
{
  tree initp_expr = ((args)->list.value);
  tree decl = *node;
  tree type = ((decl)->common.type);
  int pri;

  while ((((enum tree_code) (initp_expr)->common.code) == NOP_EXPR || ((enum tree_code) (initp_expr)->common.code) == CONVERT_EXPR || ((enum tree_code) (initp_expr)->common.code) == NON_LVALUE_EXPR) && ((initp_expr)->exp.operands[0]) != global_trees[TI_ERROR_MARK] && (((((initp_expr)->common.type))->type.mode) == ((((((initp_expr)->exp.operands[0]))->common.type))->type.mode))) (initp_expr) = ((initp_expr)->exp.operands[0]);

  if (!initp_expr || ((enum tree_code) (initp_expr)->common.code) != INTEGER_CST)
    {
  ...
  pri = (((initp_expr)->int_cst.int_cst).low);
     ...
     tree member;
{
  ...
  ((ptrmem_cst)->common.constant_flag) = 1;
  ((ptrmem_cst)->common.type) = type;
  (((ptrmem_cst_t)(ptrmem_cst))->member) = member;
  return ptrmem_cst;
}
...
# 2192 "../../../kg++fe/gnu/cp/tree.c"
  switch (code)
    ...
    case PTRMEM_CST:
      do { result = walk_tree (&(((*tp)->common.type)), func, data, htab); if (result) return result; } while (0);
      *walk_subtrees_p = 0;
      break;

    case TREE_LIST:

      if (!(((enum tree_code) (*tp)->common.code) == BASELINK))
        do { result = walk_tree (&(((*tp)->list.purpose)), func, data, htab); if (result) return result; } while (0);
      break;

    case OVERLOAD:
      do { result = walk_tree (&((((struct tree_overload*)(*tp))->function)), func, data, htab); if (result) return result; } while (0);
      do { result = walk_tree (&(((*tp)->common.chain)), func, data, htab); if (result) return result; } while (0);
      *walk_subtrees_p = 0;
      break;

    case RECORD_TYPE:
      if ((((enum tree_code) (*tp)->common.code) == RECORD_TYPE && ((*tp)->type.lang_specific) && ((&((*tp)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
 do { result = walk_tree (&((((((*tp)->type.values))->common.type))), func, data, htab); if (result) return result; } while (0);
      break;
     ...
     tree *fnp;
{
  ...
  if (((((fn))->decl.lang_specific) ->decl_flags.u.template_info)
      && ((((((fn))->decl.lang_specific) ->decl_flags.u.template_info))->common.lang_flag_1))
    {
      fn = *fnp = instantiate_decl (fn, 0);
      if (((((((fn))->decl.lang_specific) ->decl_flags.u.template_info))->common.lang_flag_1))
 return 1;
    }



  if (!(((fn)->decl.lang_specific)->decl_flags.base.declared_inline) && !(*targetm.binds_local_p) (fn))
    {
  ...
  if (flag_exceptions && ((((fn)->common.type))->type.binfo))
    {
      ((fn)->decl.uninlinable) = 1;
      return 1;
    }
     ...
     tree prev_fn;
{
  ...
  for (s = scope_chain; s; s = s->prev)
    if (s->function_decl && s->function_decl != prev_fn)
      {
 do { if ((*fnsp)->elements_used >= (*fnsp)->num_elements) (((*fnsp)) = varray_grow ((*fnsp), 2 * (*fnsp)->num_elements)); (*fnsp)->data.tree[(*fnsp)->elements_used++] = (s->function_decl); } while (0);
...
cp_is_overload_p (t)
     tree t;
{
  return ((enum tree_code) (t)->common.code) == OVERLOAD;
}
     ...
     void *target_exprs;
{
  ...
  aggregate_return_p = (((enum tree_code) (((result)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((result)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((result)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((result)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((result)->common.type))->type.lang_flag_5));
  *need_decl = ! aggregate_return_p;
# 2365 "../../../kg++fe/gnu/cp/tree.c"
  if (aggregate_return_p)
    {
      if (((*texps)->elements_used) == 0)
 fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 2368, __FUNCTION__);
      var = ((((*texps)->data.tree[(*texps)->elements_used - 1]))->exp.operands[0]);
      if (! comptypes ((((((var)->common.type))->type.main_variant)), (((((result)->common.type))->type.main_variant)), 0))

 fancy_abort ("../../../kg++fe/gnu/cp/tree.c", 2372, __FUNCTION__);
    }

  else
    var = copy_decl_for_inlining (result, fn, caller);

  if (((((fn))->decl.lang_specific) ->u.f.u.saved_language_function))
    {
      tree nrv = ((((fn))->decl.lang_specific) ->u.f.u.saved_language_function)->x_return_value;
      if (nrv)
 {



   ((var)->decl.name) = ((nrv)->decl.name);
   ((var)->decl.locus) = ((nrv)->decl.locus);
   ((var)->decl.abstract_origin) = (((nrv)->decl.abstract_origin) ? ((nrv)->decl.abstract_origin) : (nrv));

   ((var)->decl.initial) = ((nrv)->decl.initial);

   ((var)->common.addressable_flag) = ((nrv)->common.addressable_flag);
...
void
cp_end_inlining (fn)
     tree fn __attribute__ ((__unused__));
{
  if (((((fn)->decl.lang_specific)->decl_flags.use_template) & 1))
    pop_tinst_level ();
}
...
init_tree ()
{
  ...
  list_hash_table = htab_create_alloc (31, list_hash, list_hash_eq, ((void *)0), ggc_calloc, ((void *)0));
}
     ...
     void *data;
{
  ...
  if (((enum tree_code) (t)->common.code) == DECL_STMT
      && nonstatic_local_decl_p ((((t))->exp.operands[0])))
    decl = (((t))->exp.operands[0]);
  else if (((enum tree_code) (t)->common.code) == LABEL_STMT)
    decl = (((t))->exp.operands[0]);
  else if (((enum tree_code) (t)->common.code) == TARGET_EXPR
    && nonstatic_local_decl_p (((t)->exp.operands[0])))
    decl = ((t)->exp.operands[0]);
  else if (((enum tree_code) (t)->common.code) == CASE_LABEL)
    decl = (((t))->exp.operands[2]);
  else
    decl = (tree) ((void *)0);
     ...
     tree tp;
{
  ...
  st = splay_tree_new (splay_tree_compare_pointers, ((void *)0), ((void *)0));


  walk_tree (&tp, mark_local_for_remap_r, st, ((void *)0));


  walk_tree (&tp, cp_unsave_r, st, ((void *)0));
     ...
     tree decl;
{
  ...
  if (((((decl)->decl.lang_specific)->decl_flags.constructor_attr) && copy_fn_p (decl) > 0))
    return sfk_copy_constructor;
  if ((((decl)->decl.lang_specific)->decl_flags.constructor_attr))
    return sfk_constructor;
  if ((((((decl)->decl.name))->common.lang_flag_2) ? ((decl)->decl.lang_specific)->u.f.operator_code : ERROR_MARK) == NOP_EXPR)
    return sfk_assignment_operator;
  if (((((decl)->decl.lang_specific)->decl_flags.destructor_attr) && !((((enum tree_code) (decl)->common.code) == FUNCTION_DECL || ((enum tree_code) (decl)->common.code) == TEMPLATE_DECL) && ((decl)->decl.lang_specific) && (((decl)->decl.lang_specific)->u.f.cloned_function) != (tree) ((void *)0))))
    return sfk_destructor;
  if (((((decl)->decl.lang_specific)->decl_flags.destructor_attr) && ((decl)->decl.name) == cp_global_trees[CPTI_COMPLETE_DTOR_IDENTIFIER]))
    return sfk_complete_destructor;
  if (((((decl)->decl.lang_specific)->decl_flags.destructor_attr) && ((decl)->decl.name) == cp_global_trees[CPTI_BASE_DTOR_IDENTIFIER]))
    return sfk_base_destructor;
  if (((((decl)->decl.lang_specific)->decl_flags.destructor_attr) && ((decl)->decl.name) == cp_global_trees[CPTI_DELETING_DTOR_IDENTIFIER]))
...
name_p (tree node)
{
  if (((enum tree_code) (node)->common.code) == TEMPLATE_ID_EXPR)
    node = ((node)->exp.operands[0]);
  return (
   ((enum tree_code) (node)->common.code) == IDENTIFIER_NODE

   || ((enum tree_code) (node)->common.code) == BIT_NOT_EXPR

   || ((enum tree_code) (node)->common.code) == SCOPE_REF);
}
...
char_type_p (type)
     tree type;
{
  return (comptypes ((type), (integer_types[itk_char]), 0)
   || comptypes ((type), (integer_types[itk_unsigned_char]), 0)
   || comptypes ((type), (integer_types[itk_signed_char]), 0)
   || comptypes ((type), (c_global_trees[CTI_WCHAR_TYPE]), 0));
}
# 2609 "../../../kg++fe/gnu/cp/tree.c"
linkage_kind
decl_linkage (decl)
     tree decl;
{
# 2621 "../../../kg++fe/gnu/cp/tree.c"
  if (!((decl)->decl.name))
    return lk_none;
  ...
  if (((decl)->decl.lang_specific) && ((decl)->decl.comdat_flag))
    return lk_external;
     ...
     tree *initp;
{
  ...
  if (!((exp)->common.side_effects_flag))
    {
      init_expr = c_global_trees[CTI_VOID_ZERO];
    }
  else if (!real_lvalue_p (exp)
    || !((((exp)->common.type))->type.needs_constructing_flag))
    {
      init_expr = get_target_expr (exp);
      exp = (((init_expr))->exp.operands[0]);
    }
  else
    {
...
# 2693 "../../../kg++fe/gnu/cp/tree.c"
# 1 "../../../kg++fe/gnu/MIPS/gt-cp-tree.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-cp-tree.h"
const struct ggc_root_tab gt_ggc_r_gt_cp_tree_h[] = {
  {
    &shared_int_cache[0],
    1 * (256),
    sizeof (shared_int_cache[0]),
