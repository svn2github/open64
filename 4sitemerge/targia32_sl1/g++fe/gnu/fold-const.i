 ...
 if (((unsigned long long) habs_den
  ...
  && (labs_den < ltwice)))
   ...
   return overflow;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/fold-const.c", 837, __FUNCTION__);
    }
     ...
     int notrunc;
{
 ...
 low = int2l, hi = int2h;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/fold-const.c", 1181, __FUNCTION__);
    }
     ...
     int notrunc;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/fold-const.c", 1342, __FUNCTION__);
 }
      return t;
    }
  return 0;
     ...
     tree arg0, arg1;
{
  ...
  if (((enum tree_code) (type)->common.code) != INTEGER_TYPE || ! ((type)->type.no_force_blk_flag)
    ...
    fancy_abort ("../../../kg++fe/gnu/fold-const.c", 1448, __FUNCTION__);
     ...
     tree arg0, arg1;
{
  ...
  if (((enum tree_code) (type)->common.code) != INTEGER_TYPE || ! ((type)->type.no_force_blk_flag)
      || type != ((arg1)->common.type))
    fancy_abort ("../../../kg++fe/gnu/fold-const.c", 1485, __FUNCTION__);
     ...
     enum tree_code code;
{
  switch (code)
    ...
    case LE_EXPR:
      return GT_EXPR;
    default:
      fancy_abort ("../../../kg++fe/gnu/fold-const.c", 1699, __FUNCTION__);
    }
}
     ...
     enum tree_code code;
{
  switch (code)
    ...
    case LE_EXPR:
      return GE_EXPR;
    default:
      fancy_abort ("../../../kg++fe/gnu/fold-const.c", 1724, __FUNCTION__);
    }
}
     ...
     enum tree_code code;
{
  switch (code)
    ...
    case GE_EXPR:
      return 6;
    default:
      fancy_abort ("../../../kg++fe/gnu/fold-const.c", 1752, __FUNCTION__);
    }
}
     ...
     int code;
{
  switch (code)
    ...
    case 6:
      return GE_EXPR;
    default:
      fancy_abort ("../../../kg++fe/gnu/fold-const.c", 1779, __FUNCTION__);
    }
}
     ...
     tree arg;
{
 ...
 break;
  ...
  if (((enum tree_code) (((arg)->common.type))->common.code) != BOOLEAN_TYPE)
    fancy_abort ("../../../kg++fe/gnu/fold-const.c", 2355, __FUNCTION__);
  return build1 (TRUTH_NOT_EXPR, type, arg);
}
# 2368 "../../../kg++fe/gnu/fold-const.c"
static tree
     ...
     int upper0_p, upper1_p;
{
  ...
  switch (code)
    ...
    case GE_EXPR:
      ...
      break;
    default:
      fancy_abort ("../../../kg++fe/gnu/fold-const.c", 2881, __FUNCTION__);
    }
 ...
 case LT_EXPR: case LE_EXPR: case GE_EXPR: case GT_EXPR:
   ...
   switch (code)
     ...
     case LE_EXPR:
       ...
       break;
     default:
       fancy_abort ("../../../kg++fe/gnu/fold-const.c", 2975, __FUNCTION__);
     }
...
# 3514 "../../../kg++fe/gnu/fold-const.c"
static tree
fold_truthop (code, truth_type, lhs, rhs)
     enum tree_code code;
     tree truth_type, lhs, rhs;
{
# 3528 "../../../kg++fe/gnu/fold-const.c"
...
# 4965 "../../../kg++fe/gnu/fold-const.c"
      ...
      if (operand_equal_p (arg0, arg1, 0))
 {
  ...
  break;
     ...
     default:
       fancy_abort ("../../../kg++fe/gnu/fold-const.c", 6609, __FUNCTION__);
     }
 }
# 6626 "../../../kg++fe/gnu/fold-const.c"
  ...
  return pedantic_non_lvalue
    (negate_expr (convert (type,
      fold (build1 (ABS_EXPR,
             ...
             arg1)))));
       default:
  fancy_abort ("../../../kg++fe/gnu/fold-const.c", 6975, __FUNCTION__);
       }
...
# 7017 "../../../kg++fe/gnu/fold-const.c"
  ...
  case GT_EXPR:
    ...
    break;
  default:
    fancy_abort ("../../../kg++fe/gnu/fold-const.c", 7059, __FUNCTION__);
  }
     }
  ...
  break;
       default:
  fancy_abort ("../../../kg++fe/gnu/fold-const.c", 7123, __FUNCTION__);
       }
 }
...
# 1 "../../../kg++fe/gnu/MIPS/gt-fold-const.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-fold-const.h"
