...
# 138 "../../../kg++fe/gnu/flow.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 139 "../../../kg++fe/gnu/flow.c" 2
...
# 152 "../../../kg++fe/gnu/flow.c" 2
# 188 "../../../kg++fe/gnu/flow.c"
int flow2_completed;
     ...
     basic_block block;
{
  ...
  if (!(((enum rtx_code) (insn)->code) == NOTE && (((insn)->fld[5]).rtint) == NOTE_INSN_BASIC_BLOCK))
    fancy_abort ("../../../kg++fe/gnu/flow.c", 412, __FUNCTION__);
     ...
     basic_block bb;
{
 ...
 break;
  ...
  fancy_abort ("../../../kg++fe/gnu/flow.c", 559, __FUNCTION__);
}
     ...
     basic_block bb;
{
      ...
      if (! bitmap_equal_p (new_live_at_start, bb->global_live_at_start))
 {
   ...
   fancy_abort ("../../../kg++fe/gnu/flow.c", 585, __FUNCTION__);
 }
    }
  else
    {
     ...
     int prop_flags;
{
  ...
  if ((prop_flags & 32)
    ...
    fancy_abort ("../../../kg++fe/gnu/flow.c", 654, __FUNCTION__);
     ...
     void *xset;
{
  ...
  if (((enum machine_mode) (reg)->mode) == BLKmode)
    fancy_abort ("../../../kg++fe/gnu/flow.c", 964, __FUNCTION__);
     ...
     rtx insn;
{
 ...
 _fatal_insn ("Attempt to delete prologue/epilogue insn:", insn, "../../../kg++fe/gnu/flow.c", 1652, __FUNCTION__);
 ...
 for (i = (((((x)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
   {
     ...
     switch (code = ((enum rtx_code) (sub)->code))
       ...
       case COND_EXEC:
  if (cond != (rtx) 0)
    fancy_abort ("../../../kg++fe/gnu/flow.c", 2565, __FUNCTION__);
...
# 3747 "../../../kg++fe/gnu/flow.c"
    }
}
# 3757 "../../../kg++fe/gnu/flow.c"
static void
...
# 3964 "../../../kg++fe/gnu/flow.c"
 ...
 break;
    ...
    case COND_EXEC:
      if (cond != (rtx) 0)
 fancy_abort ("../../../kg++fe/gnu/flow.c", 3986, __FUNCTION__);
