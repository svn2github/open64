...
# 33 "../../../kg++fe/gnu/cse.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 34 "../../../kg++fe/gnu/cse.c" 2
     ...
     enum machine_mode mode;
{
  ...
  if (next_qty >= max_qty)
    fancy_abort ("../../../kg++fe/gnu/cse.c", 1055, __FUNCTION__);
     ...
     unsigned int new, old;
{
  ...
  if (! ((((((old) == cached_regno && cached_cse_reg_info) ? cached_cse_reg_info : get_cse_reg_info ((old))))->reg_qty) != (int) (old)))
    fancy_abort ("../../../kg++fe/gnu/cse.c", 1084, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  if (((enum rtx_code) (x)->code) == REG && ! (((((((((x)->fld[0]).rtuint)) == cached_regno && cached_cse_reg_info) ? cached_cse_reg_info : get_cse_reg_info (((((x)->fld[0]).rtuint)))))->reg_qty) != (int) ((((x)->fld[0]).rtuint))))
    fancy_abort ("../../../kg++fe/gnu/cse.c", 1573, __FUNCTION__);
...
# 1876 "../../../kg++fe/gnu/cse.c"
      ...
      for (i = 0; i < (1 << 5); i++)
 {
       ...
       if (p->in_memory)
  {
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/cse.c", 1981, __FUNCTION__);
    }
}
...
# 2284 "../../../kg++fe/gnu/cse.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/cse.c", 2497, __FUNCTION__);
    }
  return hash;
}
     ...
     int equal_values;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/cse.c", 2716, __FUNCTION__);
 }
    }
...
# 5002 "../../../kg++fe/gnu/cse.c"
  apply_change_group ();
# 5011 "../../../kg++fe/gnu/cse.c"
  for (i = 0; i < n_sets; i++)
    {
      rtx src, dest;
      rtx src_folded;
...
# 5904 "../../../kg++fe/gnu/cse.c"
    }
# 5913 "../../../kg++fe/gnu/cse.c"
   ...
   if (nregs != max_reg_num ())
     {
       if (! validate_change (insn, &(((x)->fld[1]).rtx),
         (((set)->fld[1]).rtx), 0))
         fancy_abort ("../../../kg++fe/gnu/cse.c", 6843, __FUNCTION__);
     }
   else
...
# 7286 "../../../kg++fe/gnu/cse.c"
   ...
   && ((enum rtx_code) (to)->code) == CODE_LABEL && --(((to)->fld[4]).rtint) == to_usage)
 {
  ...
  if (next_qty > max_qty)
    fancy_abort ("../../../kg++fe/gnu/cse.c", 7436, __FUNCTION__);
     ...
     int incr;
{
 ...
 count_reg_usage ((((x)->fld[0]).rtx), counts, (rtx) 0, incr);
    ...
    case INSN_LIST:
      fancy_abort ("../../../kg++fe/gnu/cse.c", 7559, __FUNCTION__);
