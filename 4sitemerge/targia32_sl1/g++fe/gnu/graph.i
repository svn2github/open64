     ...
     const char *suffix;
{
  ...
  switch (graph_dump_format)
    ...
    case vcg:
      ...
      break;
    case no_graph:
      fancy_abort ("../../../kg++fe/gnu/graph.c", 428, __FUNCTION__);
    }
     ...
     const char *suffix;
{
 ...
 case vcg:
   ...
   break;
 case no_graph:
   fancy_abort ("../../../kg++fe/gnu/graph.c", 460, __FUNCTION__);
 }
