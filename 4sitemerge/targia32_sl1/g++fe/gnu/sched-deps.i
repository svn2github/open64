...
# 35 "../../../kg++fe/gnu/sched-deps.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 36 "../../../kg++fe/gnu/sched-deps.c" 2
...
# 268 "../../../kg++fe/gnu/sched-deps.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/sched-deps.c", 273, __FUNCTION__);
      ...
      if ((((link)->fld[0]).rtx) == elem)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/sched-deps.c", 308, __FUNCTION__);
     }
     ...
     rtx elem;
{
 ...
 prev = link;
  ...
  if (!found)
    fancy_abort ("../../../kg++fe/gnu/sched-deps.c", 434, __FUNCTION__);
  return;
}
     ...
     rtx insn;
{
      ...
      else if (regno >= deps->max_reg)
 {
   if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != USE
     ...
     fancy_abort ("../../../kg++fe/gnu/sched-deps.c", 621, __FUNCTION__);
 }
      else
 {
   if (code == SET)
...
# 743 "../../../kg++fe/gnu/sched-deps.c"
 ...
 if (regno < 176)
 ...
 else if (regno >= deps->max_reg)
   {
     if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != USE
  && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != CLOBBER)
       fancy_abort ("../../../kg++fe/gnu/sched-deps.c", 759, __FUNCTION__);
   }
 else
   {
...
# 1387 "../../../kg++fe/gnu/sched-deps.c"
      ...
      if (insn == tail)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/sched-deps.c", 1422, __FUNCTION__);
}
