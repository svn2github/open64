...
.LFE26:
	...
	.section	.rodata
	.type	__FUNCTION__.12634, @object
	.size	__FUNCTION__.12634, 22
__FUNCTION__.12634:
...
.L323:
	.loc 1 1814 0
	leal	__FUNCTION__.12634@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1814, 4(%esp)
...
.L386:
	.loc 1 2186 0
	leal	__FUNCTION__.12968@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2186, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE36:
	...
	.section	.rodata
	.type	__FUNCTION__.12992, @object
	.size	__FUNCTION__.12992, 22
__FUNCTION__.12992:
...
.L398:
	.loc 1 2223 0
	leal	__FUNCTION__.12992@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2223, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L428:
	...
	je	.L431
	.loc 1 2422 0
	leal	__FUNCTION__.13145@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2422, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE47:
	...
	.section	.rodata
	.type	__FUNCTION__.13256, @object
	.size	__FUNCTION__.13256, 22
__FUNCTION__.13256:
...
.L494:
	.loc 1 2722 0
	leal	__FUNCTION__.13256@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2722, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE54:
	...
	.section	.rodata
	.type	__FUNCTION__.13413, @object
	.size	__FUNCTION__.13413, 25
__FUNCTION__.13413:
...
.LBB8:
	...
	jne	.L541
	.loc 1 3026 0
	leal	__FUNCTION__.13413@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3026, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE55:
	...
	.section	.rodata
	.type	__FUNCTION__.12903, @object
	.size	__FUNCTION__.12903, 20
__FUNCTION__.12903:
...
.L565:
	.loc 1 2002 0
	leal	__FUNCTION__.12903@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2002, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE32:
	...
	.section	.rodata
	.type	__FUNCTION__.13483, @object
	.size	__FUNCTION__.13483, 20
__FUNCTION__.13483:
...
.L571:
	.loc 1 3114 0
	leal	__FUNCTION__.13483@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3114, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE79:
	...
	.section	.rodata
	.type	__FUNCTION__.13809, @object
	.size	__FUNCTION__.13809, 21
__FUNCTION__.13809:
...
.L635:
	...
	je	.L636
	.loc 1 3655 0
	leal	__FUNCTION__.13809@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3655, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE85:
	...
	.section	.rodata
	.align 32
	.type	__FUNCTION__.13843, @object
	.size	__FUNCTION__.13843, 36
__FUNCTION__.13843:
...
.LCFI189:
	...
	jne	.L666
	.loc 1 3749 0
	leal	__FUNCTION__.13843@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3749, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L670:
	.loc 1 3442 0
	leal	__FUNCTION__.13659@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3442, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE87:
	...
	.section	.rodata
	.type	__FUNCTION__.13864, @object
	.size	__FUNCTION__.13864, 30
__FUNCTION__.13864:
...
.LCFI201:
	...
	jne	.L681
	.loc 1 3779 0
	leal	__FUNCTION__.13864@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3779, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE59:
	...
	.section	.rodata
	.type	__FUNCTION__.13891, @object
	.size	__FUNCTION__.13891, 28
__FUNCTION__.13891:
...
.L692:
	.loc 1 3858 0
	leal	__FUNCTION__.13891@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3858, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LBB14:
	...
	je	.L765
	.loc 1 3978 0
	leal	__FUNCTION__.13990@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3978, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L797:
	.loc 1 3203 0
	leal	__FUNCTION__.13536@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3203, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE58:
	...
	.section	.rodata
	.type	__FUNCTION__.13501, @object
	.size	__FUNCTION__.13501, 21
__FUNCTION__.13501:
...
.L804:
	.loc 1 3157 0
	leal	__FUNCTION__.13501@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3157, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE116:
	...
	.section	.rodata
	.type	__FUNCTION__.14481, @object
	.size	__FUNCTION__.14481, 12
__FUNCTION__.14481:
	.string	"output_type"
	.text
...
.L999:
	...
	call	output_type
	.loc 1 4782 0
	leal	__FUNCTION__.14481@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$4782, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE117:
	...
	.section	.rodata
	.align 32
	.type	__FUNCTION__.14650, @object
	.size	__FUNCTION__.14650, 33
__FUNCTION__.14650:
...
.L1050:
	...
	je	.L1052
	.loc 1 5001 0
	leal	__FUNCTION__.14650@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$5001, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE120:
	...
	.section	.rodata
	.type	__FUNCTION__.14821, @object
	.size	__FUNCTION__.14821, 12
__FUNCTION__.14821:
	.string	"output_decl"
.LC225:
	.string	"*.L_P%u"
...
.L1118:
	.loc 1 5548 0
	leal	__FUNCTION__.14821@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$5548, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE125:
	...
	.section	.rodata
	.type	__FUNCTION__.15054, @object
	.size	__FUNCTION__.15054, 25
__FUNCTION__.15054:
...
.L1243:
	...
	je	.L1269
	.loc 1 5811 0
	leal	__FUNCTION__.15054@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$5811, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE135:
	...
	.data
	.align 4
	.type	prev_file_entry_num.15359, @object
	.size	prev_file_entry_num.15359, 4
prev_file_entry_num.15359:
	.long	-1
	.local	last_line_entry_num.15358
	.comm	last_line_entry_num.15358,4,4
	.section	.rodata
.LC238:
	.string	"*.L_LC%u"
.LC239:
...
.LBB43:
	...
	call	function_section@PLT
	.loc 1 6056 0
	movl	last_line_entry_num.15358@GOTOFF(%ebx), %eax
	addl	$1, %eax
	movl	%eax, last_line_entry_num.15358@GOTOFF(%ebx)
	movl	last_line_entry_num.15358@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
...
.L1330:
	...
	call	fprintf@PLT
	.loc 1 6067 0
	movl	prev_file_entry_num.15359@GOTOFF(%ebx), %eax
	cmpl	%eax, -76(%ebp)
	je	.L1331
.LBB44:
	.loc 1 6071 0
...
.LBE45:
	...
	je	.L1335
	.loc 1 6088 0
	movl	last_line_entry_num.15358@GOTOFF(%ebx), %edx
	movl	-76(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	%edx, (%esp)
...
.L1335:
	.loc 1 6089 0
	movl	-76(%ebp), %eax
	movl	%eax, prev_file_entry_num.15359@GOTOFF(%ebx)
.L1337:
.LBE43:
	.loc 1 6091 0
	movl	-8(%ebp), %eax
...
.LFE141:
	...
	.local	initialized.15487
	.comm	initialized.15487,4,4
...
.LCFI509:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 6168 0
	movl	initialized.15487@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L1375
	.loc 1 6170 0
	...
	call	dwarfout_start_source_file
	.loc 1 6171 0
	movl	$1, initialized.15487@GOTOFF(%ebx)
.L1375:
	.loc 1 6173 0
	movl	8(%ebp), %eax
	movl	$0, %edx
...
.L1394:
	...
	je	.L1402
	.loc 1 6572 0
	leal	__FUNCTION__.15600@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$6572, 4(%esp)
	leal	.LC179@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE260:
	...
	.file 13 "../../../kg++fe/gnu/hard-reg-set.h"
...
.LLST130:
	...
	.byte	0x5
	.byte	0x3
	.long	last_line_entry_num.15358
	.uleb128 0x30
	...
	.byte	0x5
	.byte	0x3
	.long	prev_file_entry_num.15359
	.byte	0x0
	.uleb128 0x35
	.long	0x9e4b
