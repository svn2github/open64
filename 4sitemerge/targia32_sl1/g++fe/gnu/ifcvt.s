...
.LFE19:
	...
	.section	.rodata
	.type	__FUNCTION__.11146, @object
	.size	__FUNCTION__.11146, 24
__FUNCTION__.11146:
	.string	"cond_exec_process_insns"
.LC0:
	.string	"../../../kg++fe/gnu/ifcvt.c"
	.text
...
.L59:
	...
	je	.L62
	.loc 1 248 0
	leal	__FUNCTION__.11146@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$248, 4(%esp)
...
.LFE38:
	...
	.section	.rodata
	.type	__FUNCTION__.13038, @object
	.size	__FUNCTION__.13038, 15
__FUNCTION__.13038:
...
.L766:
	.loc 1 2045 0
	leal	__FUNCTION__.13038@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2045, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
