     ...
     rtx orig;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/rtl.c", 378, __FUNCTION__);
 }
    }
  return copy;
}
     ...
     rtx x, y;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/rtl.c", 519, __FUNCTION__);
 }
    }
  return 1;
}
