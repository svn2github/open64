...
# 31 "../../../kg++fe/gnu/ggc-page.c" 2
# 43 "../../../kg++fe/gnu/ggc-page.c"
...
# 44 "../../../kg++fe/gnu/ggc-page.c" 2
# 171 "../../../kg++fe/gnu/ggc-page.c"
...
# 286 "../../../kg++fe/gnu/ggc-page.c"
typedef page_entry **page_table[((size_t) 1 << (8))];
# 303 "../../../kg++fe/gnu/ggc-page.c"
     ...
     page_entry *entry;
{
      ...
      else
 {
   ...
   fancy_abort ("../../../kg++fe/gnu/ggc-page.c", 896, __FUNCTION__);
 }
    }
  --G.by_depth_in_use;
     ...
     unsigned order;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ggc-page.c", 1230, __FUNCTION__);
...
# 1271 "../../../kg++fe/gnu/ggc-page.c"
 ...
 if ((size_t)p & (G.pagesize - 1))
   fancy_abort ("../../../kg++fe/gnu/ggc-page.c", 1289, __FUNCTION__);
      }
...
ggc_push_context ()
{
  ...
  if (G.context_depth >= (8 * 4))
    fancy_abort ("../../../kg++fe/gnu/ggc-page.c", 1357, __FUNCTION__);
}
     ...
     page_entry *p;
{
 ...
 p->num_free_objects -= (j & 1);
  ...
  if (p->num_free_objects >= num_objects)
    fancy_abort ("../../../kg++fe/gnu/ggc-page.c", 1395, __FUNCTION__);
}
...
# 1474 "../../../kg++fe/gnu/ggc-page.c"
      p->context_depth = depth;
    }

  adjust_depth ();
# 1493 "../../../kg++fe/gnu/ggc-page.c"
}
