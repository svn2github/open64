     ...
     tree value, name;
{
  ...
  if (((enum tree_code) (value)->common.code) == FIELD_DECL)
    {
      if ((cfun ? (cfun->language)->x_current_class_ptr : (tree) ((void *)0)) == (tree) ((void *)0))
 {
   ...
   return global_trees[TI_ERROR_MARK];
      ...
      (((cfun ? (cfun->language)->x_current_class_ptr : (tree) ((void *)0)))->common.used_flag) = 1;
      if (scope_chain->x_processing_template_decl)
 value = build_min_nt (COMPONENT_REF, (cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)), name);
      else
 {
   tree access_type = scope_chain->class_type;

   while (!(lookup_base ((access_type), context_for_name_lookup (value), ba_any, ((void *)0)) != (tree) ((void *)0)))

     {
       access_type = ((access_type)->type.context);
       while ((tree_code_type[(int) (((enum tree_code) (access_type)->common.code))] == 'd'))
  access_type = ((access_type)->decl.context);
     }

   enforce_access (access_type, value);
   value
     = build_class_member_access_expr ((cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)), value,
                           (tree) ((void *)0),
                                  0);
 }
    }
  else if ((((enum tree_code) (value)->common.code) == FUNCTION_DECL
     && ((((enum tree_code) (((value)->common.type))->common.code) == METHOD_TYPE) || (((value)->decl.lang_specific)->decl_flags.static_function)))
    || (((enum tree_code) (value)->common.code) == OVERLOAD
        && ((((enum tree_code) (((((((enum tree_code) (value)->common.code) == OVERLOAD) ? (((struct tree_overload*)(value))->function) : (value)))->common.type))->common.code) == METHOD_TYPE) || (((((((enum tree_code) (value)->common.code) == OVERLOAD) ? (((struct tree_overload*)(value))->function) : (value)))->decl.lang_specific)->decl_flags.static_function))))
    {
      tree decl;

      if (((enum tree_code) (value)->common.code) == OVERLOAD)
 value = ((((enum tree_code) (value)->common.code) == OVERLOAD) ? (((struct tree_overload*)(value))->function) : (value));

      decl = maybe_dummy_object (((value)->decl.context), 0);
      value = finish_class_member_access_expr (decl, name);
    }
  else if (really_overloaded_fn (value))
    ;
  else if (((enum tree_code) (value)->common.code) == OVERLOAD)

    mark_used ((((struct tree_overload*)(value))->function));
  else if (((enum tree_code) (value)->common.code) == TREE_LIST)
    {

      tree t = value;
      while (t && ((enum tree_code) (t)->common.code) == TREE_LIST)
 {
   mark_used (((t)->list.value));
   t = ((t)->common.chain);
 }
    }
  else if (((enum tree_code) (value)->common.code) == NAMESPACE_DECL)
    {
      error ("use of namespace `%D' as expression", value);
      return global_trees[TI_ERROR_MARK];
    }
  else if ((((enum tree_code) (value)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((value)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (value)->common.code) == TEMPLATE_DECL && (((value)->decl.lang_flag_0) && (((enum tree_code) (value)->common.code) == CONST_DECL || ((enum tree_code) (value)->common.code) == PARM_DECL || ((enum tree_code) (value)->common.code) == TYPE_DECL || ((enum tree_code) (value)->common.code) == TEMPLATE_DECL)))))
    {
  ...
  if (((enum tree_code) (value)->common.code) == VAR_DECL || ((enum tree_code) (value)->common.code) == PARM_DECL
      || ((enum tree_code) (value)->common.code) == RESULT_DECL)
    {
      tree context = decl_function_context (value);
      if (context != (tree) ((void *)0) && context != current_function_decl
   && ! ((value)->common.static_flag))
 {
   error ("use of %s from containing function",
        (((enum tree_code) (value)->common.code) == VAR_DECL
  ...
  if ((tree_code_type[(int) (((enum tree_code) (value)->common.code))] == 'd') && ((value)->decl.nonlocal_flag))
    {
      if ((((value)->decl.context) && (tree_code_type[(int) (((enum tree_code) (((value)->decl.context))->common.code))] == 't'))
   && ((value)->decl.context) != scope_chain->class_type)
 {
   tree path;
   path = currently_open_derived_class (((value)->decl.context));
   enforce_access (path, value);
 }
    }
  else if (((enum tree_code) (value)->common.code) == TREE_LIST
    && ((value)->common.type) == global_trees[TI_ERROR_MARK])
    {
      error ("request for member `%D' is ambiguous in multiple inheritance lattice",
     ...
     tree vcall_index;
{
  ...
  (void) (((((enum tree_code) (function)->common.code) == FUNCTION_DECL) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/method.c", 288, __FUNCTION__), 0) : 0);
  ...
  if (vcall_index)
    ...
    vcall_offset = (tree) ((void *)0);

  d = tree_low_cst (delta, 0);


  for (thunk = (((function)->decl.lang_specific)->u.f.context); thunk; thunk = ((thunk)->common.chain))
    if (((thunk)->decl.thunk_delta) == d
 && ((((&((thunk)->decl.lang_specific)->decl_flags.u2)->vcall_offset) != (tree) ((void *)0))
     == (vcall_offset != (tree) ((void *)0)))
 && (((&((thunk)->decl.lang_specific)->decl_flags.u2)->vcall_offset)
     ? tree_int_cst_equal (((&((thunk)->decl.lang_specific)->decl_flags.u2)->vcall_offset),
      vcall_offset)
     : 1))
      return thunk;
  ...
  (void) (((!((function)->common.asm_written_flag)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/method.c", 316, __FUNCTION__), 0) : 0);

  thunk_id = mangle_thunk (function, delta, vcall_offset);
  thunk = build_decl (FUNCTION_DECL, thunk_id, ((function)->common.type));
  ((thunk)->decl.lang_specific) = ((function)->decl.lang_specific);
  cxx_dup_lang_specific_decl (function);
  ((thunk)->decl.assembler_name = (thunk_id));
  ((thunk)->decl.context) = ((function)->decl.context);
  ((thunk)->common.readonly_flag) = ((function)->common.readonly_flag);
  ((thunk)->common.volatile_flag) = ((function)->common.volatile_flag);
  ((thunk)->common.public_flag) = ((function)->common.public_flag);
  if (flag_weak)
    comdat_linkage (thunk);
  (((thunk)->decl.lang_flag_7) = 1, ((thunk)->decl.lang_specific)->u.f.u3sel = 1);
  ((thunk)->decl.initial) = build1 (ADDR_EXPR, cp_global_trees[CPTI_VTABLE_ENTRY_TYPE], function);
  ((thunk)->decl.thunk_delta) = d;
  ((&((thunk)->decl.lang_specific)->decl_flags.u2)->vcall_offset) = vcall_offset;


  ((thunk)->decl.lang_flag_5) = 1;
  (((thunk)->decl.lang_specific)->decl_flags.not_really_extern) = 1;
  ((((thunk))->decl.lang_specific) ->u.f.u.saved_language_function) = ((void *)0);
  (((thunk)->decl.lang_specific)->decl_flags.destructor_attr) = 0;
  (((thunk)->decl.lang_specific)->decl_flags.constructor_attr) = 0;

  (((thunk)->decl.lang_specific)->u.f.cloned_function) = (tree) ((void *)0);
  ((thunk)->decl.external_flag) = 1;
  ((thunk)->decl.artificial_flag) = 1;


  ((thunk)->decl.regdecl_flag) = 1;

  (((thunk)->decl.lang_specific)->u.f.pending_inline_p) = 0;
  ((thunk)->decl.inline_flag) = 0;
  (((thunk)->decl.lang_specific)->decl_flags.base.declared_inline) = 0;

  (((thunk)->decl.lang_specific)->decl_flags.deferred) = 0;

  ((thunk)->common.chain) = (((function)->decl.lang_specific)->u.f.context);
  (((function)->decl.lang_specific)->u.f.context) = thunk;
...
make_alias_for_thunk (tree function)
{
  ...
  sprintf ((buf), "*%s%s%ld", ("$"), ("LTHUNK"), (long)(thunk_labelno));
  thunk_labelno++;
  alias = build_decl (FUNCTION_DECL, (__builtin_constant_p (buf) ? get_identifier_with_length ((buf), (unsigned) strlen (buf)) : (get_identifier) (buf)),
        ((function)->common.type));
  ((alias)->decl.lang_specific) = ((function)->decl.lang_specific);
  cxx_dup_lang_specific_decl (alias);
  ((alias)->decl.context) = ((void *)0);
  ((alias)->common.readonly_flag) = ((function)->common.readonly_flag);
  ((alias)->common.volatile_flag) = ((function)->common.volatile_flag);
  ((alias)->common.public_flag) = 0;
  ((alias)->decl.lang_flag_5) = 1;
  (((alias)->decl.lang_specific)->decl_flags.not_really_extern) = 1;
  (((alias))->decl.lang_flag_6) = 1;
  ((((alias))->decl.lang_specific) ->u.f.u.saved_language_function) = ((void *)0);
  (((alias)->decl.lang_specific)->decl_flags.destructor_attr) = 0;
  (((alias)->decl.lang_specific)->decl_flags.constructor_attr) = 0;
  (((alias)->decl.lang_specific)->u.f.cloned_function) = (tree) ((void *)0);
  ((alias)->decl.external_flag) = 0;
  ((alias)->decl.artificial_flag) = 1;
  ((alias)->decl.regdecl_flag) = 1;
  (((alias)->decl.lang_specific)->u.f.pending_inline_p) = 0;
  ((alias)->decl.inline_flag) = 0;
  (((alias)->decl.lang_specific)->decl_flags.base.declared_inline) = 0;
  (((alias)->decl.lang_specific)->decl_flags.deferred) = 0;
  (((alias)->decl.lang_specific)->decl_flags.use_template) = 0;
  (((alias))->decl.lang_flag_1) = 0;
  ((((alias))->decl.lang_specific) ->decl_flags.u.template_info) = ((void *)0);
  ((alias)->decl.initial) = global_trees[TI_ERROR_MARK];
  ((alias)->common.addressable_flag) = 1;
  ((alias)->common.used_flag) = 1;
  ((alias)->decl.assembler_name = (((alias)->decl.name)));
  ((decl_assembler_name (alias))->common.static_flag) = 1;
  if (!flag_syntax_only)
     ...
     int emit_p;
{
  ...
  tree function, alias;
  tree vcall_offset;
  long long delta, vcall_value;

  if (((thunk_fndecl)->common.asm_written_flag))
    return;

  fnaddr = ((thunk_fndecl)->decl.initial);
  if (((enum tree_code) (((thunk_fndecl)->decl.initial))->common.code) != ADDR_EXPR)


    return;


  ((thunk_fndecl)->common.addressable_flag) = 1;



  function = ((fnaddr)->exp.operands[0]);
  ((function)->common.addressable_flag) = 1;
  mark_used (function);
  ((decl_assembler_name (function))->common.static_flag) = 1;
  if (!emit_p)
    return;
  ...
  delta = ((thunk_fndecl)->decl.thunk_delta);
  vcall_offset = ((&((thunk_fndecl)->decl.lang_specific)->decl_flags.u2)->vcall_offset);
  ...
  if (vcall_offset)
    {
      ...
      if (!vcall_value)
 fancy_abort ("../../../kg++fe/gnu/cp/method.c", 460, __FUNCTION__);
    }
  else
    vcall_value = 0;
  ...
  ((thunk_fndecl)->decl.external_flag) = 0;


  ((thunk_fndecl)->common.public_flag) = ((function)->common.public_flag);

  if (flag_syntax_only)
    {
      ((thunk_fndecl)->common.asm_written_flag) = 1;
      return;
    }
  ...
  if (targetm.have_named_sections)
    {
      ...
      if (((function)->decl.section_name) != ((void *)0) && ((function)->decl.transparent_union))
 {
   resolve_unique_section (thunk_fndecl, 0, flag_function_sections);


   ((thunk_fndecl)->decl.section_name) = ((function)->decl.section_name);
 }
    }
  ...
  ((thunk_fndecl)->decl.initial_2) = ((thunk_fndecl)->decl.initial);
  gxx_emits_decl (thunk_fndecl);




  ((thunk_fndecl)->decl.initial) = make_node (BLOCK);
  ((((thunk_fndecl)->decl.initial))->block.vars)
    = ((thunk_fndecl)->decl.arguments);
  ...
  if (targetm.asm_out.can_output_mi_thunk (thunk_fndecl, delta,
        vcall_value, alias))
    {
      ...
      ((thunk_fndecl)->decl.result)
 = build_decl (RESULT_DECL, 0, integer_types[itk_int]);
      fnname = ((((((((thunk_fndecl)->decl.rtl ? (thunk_fndecl)->decl.rtl : (make_decl_rtl (thunk_fndecl, ((void *)0)), (thunk_fndecl)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtstr);
 ...
 error ("generic thunk code fails for method `%#D' which uses `...'",
      ...
      t = (tree) ((void *)0);
      for (a = ((function)->decl.arguments); a; a = ((a)->common.chain))
 {
   tree x = copy_node (a);
   ((x)->common.chain) = t;
   ((x)->decl.context) = thunk_fndecl;
   t = x;
 }
      a = nreverse (t);
      ((thunk_fndecl)->decl.arguments) = a;
      ((thunk_fndecl)->decl.result) = (tree) ((void *)0);

      start_function ((tree) ((void *)0), thunk_fndecl, (tree) ((void *)0), 1);



      t = size_int_wide ((long long) (delta), SSIZETYPE);
      t = fold (build (PLUS_EXPR, ((a)->common.type), a, t));
      ...
      if (vcall_offset && !integer_zerop (vcall_offset))
 {
   ...
   t = build1 (INDIRECT_REF, ((((t)->common.type))->common.type), t);

   t = build (PLUS_EXPR, ((t)->common.type), t, vcall_offset);

   t = build1 (INDIRECT_REF, ((((t)->common.type))->common.type), t);

   t = fold (build (PLUS_EXPR,
      ((orig_this)->common.type),
      orig_this,
      t));
 }


      t = tree_cons ((tree) ((void *)0), t, (tree) ((void *)0));
      for (a = ((a)->common.chain); a; a = ((a)->common.chain))
 t = tree_cons ((tree) ((void *)0), a, t);
      t = nreverse (t);
      t = build_call (alias, t);
      if ((((enum tree_code) (((t)->common.type))->common.code) == VOID_TYPE))
 finish_expr_stmt (t);
      else
 finish_return_stmt (t);
      ...
      ((decl_assembler_name (thunk_fndecl))->common.static_flag) = 1;


      ((thunk_fndecl)->decl.ignored_flag) = 1;
...
do_build_copy_constructor (fndecl)
     tree fndecl;
{
  tree parm = skip_artificial_parms_for ((fndecl), ((fndecl)->decl.arguments));
  tree t;

  parm = convert_from_reference (parm);

  if ((((&((scope_chain->class_type)->type.lang_specific)->u.c)->h.has_init_ref) && ! ((&((scope_chain->class_type)->type.lang_specific)->u.c)->has_complex_init_ref))
      && is_empty_class (scope_chain->class_type))

                                        ;
  else if ((((&((scope_chain->class_type)->type.lang_specific)->u.c)->h.has_init_ref) && ! ((&((scope_chain->class_type)->type.lang_specific)->u.c)->has_complex_init_ref)))
    {
      t = build (INIT_EXPR, global_trees[TI_VOID_TYPE], (cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)), parm);
      finish_expr_stmt (t);
    }
  else
    {
      tree fields = ((scope_chain->class_type)->type.values);
      int n_bases = (((((((scope_chain->class_type)->type.binfo)))->vec.a[4]) ? (((((((scope_chain->class_type)->type.binfo)))->vec.a[4]))->vec.length) : 0));
      tree binfos = ((((scope_chain->class_type)->type.binfo))->vec.a[4]);
      tree member_init_list = (tree) ((void *)0);
      int cvquals = cp_type_quals (((parm)->common.type));
      int i;
      ...
      for (t = ((&((scope_chain->class_type)->type.lang_specific)->u.c)->vbases); t;
    t = ((t)->common.chain))
 {
   tree binfo = ((t)->list.value);
      ...
      for (; fields; fields = ((fields)->common.chain))
 {
   ...
   if (((field)->decl.name))
     {
       if ((!strncmp (((char *)(((field)->decl.name))->identifier.id.str), "_vptr.", sizeof("_vptr.")-1)))
  continue;


       if ((((struct lang_identifier*)(((field)->decl.name)))->class_value) != field)
  continue;
     }
   else if ((t = ((field)->common.type)) != (tree) ((void *)0)
   ...
   expr_type = ((field)->common.type);
   if (((enum tree_code) (expr_type)->common.code) != REFERENCE_TYPE)
     expr_type = cp_build_qualified_type_real ((expr_type), (cvquals), tf_error | tf_warning);
   init = build (COMPONENT_REF, expr_type, init, field);
   init = build_tree_list ((tree) ((void *)0), init);
     ...
     tree fndecl;
{
  ...
  if ((((&((scope_chain->class_type)->type.lang_specific)->u.c)->has_assign_ref) && ! ((&((scope_chain->class_type)->type.lang_specific)->u.c)->has_complex_assign_ref))
      && is_empty_class (scope_chain->class_type))

                                        ;
  else if ((((&((scope_chain->class_type)->type.lang_specific)->u.c)->has_assign_ref) && ! ((&((scope_chain->class_type)->type.lang_specific)->u.c)->has_complex_assign_ref)))
    {
      tree t = build (MODIFY_EXPR, global_trees[TI_VOID_TYPE], (cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)), parm);
      finish_expr_stmt (t);
    }
  else
    {
      ...
      for (i = 0; i < (((((((scope_chain->class_type)->type.binfo)))->vec.a[4]) ? (((((((scope_chain->class_type)->type.binfo)))->vec.a[4]))->vec.length) : 0)); ++i)
 {
   tree binfo;
   tree converted_parm;

   binfo = (((((((scope_chain->class_type)->type.binfo)))->vec.a[4]))->vec.a[(i)]);


   converted_parm = build_base_path (PLUS_EXPR, parm, binfo, 1);

   finish_expr_stmt
     (build_special_member_call ((cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)),
     (assignment_operator_name_info[(int) (NOP_EXPR)].identifier),
     build_tree_list ((tree) ((void *)0),
        converted_parm),
     binfo,
     (3) | (8)));
      ...
      for (fields = ((scope_chain->class_type)->type.values);
    fields;
    fields = ((fields)->common.chain))
 {
   ...
   if (((cp_type_quals (((field)->common.type)) & 0x1) != 0))
     {
              error ("non-static const member `%#D', can't use default assignment operator", field);
       continue;
     }
   else if (((enum tree_code) (((field)->common.type))->common.code) == REFERENCE_TYPE)
     {
       error ("non-static reference member `%#D', can't use default assignment operator", field);
       continue;
     }

   comp = (cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0));
   init = parm;
  ...
  continue;
   ...
   comp = build (COMPONENT_REF, ((field)->common.type), comp, field);
   init = build (COMPONENT_REF,
                 cp_build_qualified_type_real ((((field)->common.type)), (cvquals), tf_error | tf_warning),
                 init, field);

   if (((field)->decl.name))
     finish_expr_stmt (build_modify_expr (comp, NOP_EXPR, init));
   else
     finish_expr_stmt (build (MODIFY_EXPR, ((comp)->common.type), comp,
         init));
 }
    }
  finish_return_stmt ((cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)));
...
synthesize_method (fndecl)
     tree fndecl;
{
  int nested = (current_function_decl != (tree) ((void *)0));
  ...
  if (((((enum tree_code) (fndecl)->common.code) == FUNCTION_DECL || ((enum tree_code) (fndecl)->common.code) == TEMPLATE_DECL) && ((fndecl)->decl.lang_specific) && (((fndecl)->decl.lang_specific)->u.f.cloned_function) != (tree) ((void *)0)))
    {
      synthesize_method ((((fndecl)->decl.lang_specific)->u.f.cloned_function));
      return;
    }
  ...
  (((fndecl)->decl.locus).line) = lineno;
  (((fndecl)->decl.locus).file) = input_filename;

  interface_unknown = 1;
  start_function ((tree) ((void *)0), fndecl, (tree) ((void *)0), 0 | 1);
  clear_last_expr ();
  stmt = begin_function_body ();

  if ((((((fndecl)->decl.name))->common.lang_flag_2) ? ((fndecl)->decl.lang_specific)->u.f.operator_code : ERROR_MARK) == NOP_EXPR)
    {
      do_build_assign_ref (fndecl);
      need_body = 0;
    }
    ...
    {
      tree arg_chain = skip_artificial_parms_for ((fndecl), ((((fndecl)->common.type))->type.values));
      if (arg_chain != global_trees[TI_VOID_LIST_NODE])
 do_build_copy_constructor (fndecl);
      else if (((scope_chain->class_type)->type.needs_constructing_flag))
...
synthesize_exception_spec (type, extractor, client)
     ...
     void *client;
{
  tree raises = cp_global_trees[CPTI_EMPTY_EXCEPT_SPEC];
  tree fields = ((type)->type.values);
  int i, n_bases = (((((((type)->type.binfo)))->vec.a[4]) ? (((((((type)->type.binfo)))->vec.a[4]))->vec.length) : 0));
  tree binfos = ((((type)->type.binfo))->vec.a[4]);

  for (i = 0; i != n_bases; i++)
    {
      tree base = ((((binfos)->vec.a[i]))->common.type);
      tree fn = (*extractor) (base, client);
      if (fn)
        {
          tree fn_raises = ((((fn)->common.type))->type.binfo);
...
locate_dtor (type, client)
     tree type;
     void *client __attribute__ ((__unused__));
{
  tree fns;

  if (!(((type)->type.lang_flag_2)))
    return (tree) ((void *)0);
  fns = ((((&((type)->type.lang_specific)->u.c)->methods))->vec.a[1]);
     ...
     void *client __attribute__ ((__unused__));
{
  ...
  if (!((&((type)->type.lang_specific)->u.c)->h.has_default_ctor))
    return (tree) ((void *)0);

  fns = ((((&((type)->type.lang_specific)->u.c)->methods))->vec.a[0]);
  ...
  for (; fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
    {
      ...
      tree parms = ((((fn)->common.type))->type.values);

      if (sufficient_parms_p (((parms)->common.chain)))
        return fn;
    }
  return (tree) ((void *)0);
}
     ...
     void *client_;
{
  ...
  if (client->name)
    {
      if (((&((type)->type.lang_specific)->u.c)->has_assign_ref))
        ix = lookup_fnfields_1 (type, client->name);
    }
  else if (((&((type)->type.lang_specific)->u.c)->h.has_init_ref))
    ix = 0;
  if (ix < 0)
    return (tree) ((void *)0);
  fns = ((((&((type)->type.lang_specific)->u.c)->methods))->vec.a[ix]);
  ...
  for (; fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
    {
      ...
      if (!parms)
        continue;
      src_type = ((parms)->list.value);
      if (((enum tree_code) (src_type)->common.code) == REFERENCE_TYPE)
        src_type = ((src_type)->common.type);
      if (!comptypes ((((src_type)->type.main_variant)), (((type)->type.main_variant)), 0))
        continue;
      if (!sufficient_parms_p (((parms)->common.chain)))
        continue;
...
implicitly_declare_fn (kind, type, const_p)
     ...
     int const_p;
{
  tree declspecs = (tree) ((void *)0);
  tree fn, args = (tree) ((void *)0);
  tree raises = cp_global_trees[CPTI_EMPTY_EXCEPT_SPEC];
  int retref = 0;
  int has_parm = 0;
  tree name = constructor_name ((((((type)->type.name))->decl.name)));
  ...
  switch (kind)
    ...
    case sfk_assignment_operator:
    {
      ...
      if (kind == sfk_assignment_operator)
        {
          retref = 1;
          declspecs = build_tree_list ((tree) ((void *)0), type);

          name = (assignment_operator_name_info[(int) (NOP_EXPR)].identifier);
          data.name = name;
        }
      if (const_p)
        {
          data.quals = 0x1;
          argtype = build_qualified_type (argtype, 0x1);
        }

      argtype = build_reference_type (argtype);
      args = build_tree_list (hash_tree_chain (argtype, (tree) ((void *)0)),
         (__builtin_constant_p ("_ctor_arg") ? get_identifier_with_length (("_ctor_arg"), (unsigned) strlen ("_ctor_arg")) : (get_identifier) ("_ctor_arg")));
      args = tree_cons ((tree) ((void *)0), args, global_trees[TI_VOID_LIST_NODE]);

      raises = synthesize_exception_spec (type, &locate_copy, &data);
      break;
    }
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/method.c", 1120, __FUNCTION__);
    }

  (((args)->common.lang_flag_2)) = 1;

  {
    tree declarator = make_call_declarator (name, args, (tree) ((void *)0), raises);

    if (retref)
      declarator = build_nt (ADDR_EXPR, declarator);

    fn = grokfield (declarator, declspecs, (tree) ((void *)0), (tree) ((void *)0), (tree) ((void *)0));
    if (has_parm)
      ((skip_artificial_parms_for ((fn), ((fn)->decl.arguments)))->common.used_flag) = 1;
  }

  (void) (((((enum tree_code) (fn)->common.code) == FUNCTION_DECL) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/method.c", 1136, __FUNCTION__), 0) : 0);

  ((fn)->decl.artificial_flag) = 1;
  (((fn)->decl.lang_specific)->decl_flags.not_really_extern) = 1;
  (((fn)->decl.lang_specific)->decl_flags.base.declared_inline) = 1;
  ((fn)->decl.inline_flag) = 1;
  defer_fn (fn);
