...
# 68 "../../../kg++fe/gnu/cfgrtl.c" 2

# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 70 "../../../kg++fe/gnu/cfgrtl.c" 2
# 80 "../../../kg++fe/gnu/cfgrtl.c"
  ...
  if (really_delete)
    {
      ...
      if ((((insn))->volatil))
 fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 148, __FUNCTION__);
      remove_insn (insn);
      (((insn))->volatil) = 1;
    }
     ...
     basic_block target;
{
      ...
      if (!redirect_jump (insn, block_label (target), 0))
 {
   if (target == (&entry_exit_blocks[1]))
     return 0;
   fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 738, __FUNCTION__);
 }
    }
     ...
     basic_block target;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 915, __FUNCTION__);
      ...
      if (!redirect_jump (insn, block_label (target), 0))
 {
   if (target == (&entry_exit_blocks[1]))
     return 0;
   fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 924, __FUNCTION__);
 }
    }
     ...
     basic_block target;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 965, __FUNCTION__);
  ...
  if (e->flags & 2)
    {
      ...
      if (e->dest != target)
 fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 990, __FUNCTION__);
      abnormal_edge_flags = e->flags & ~(1 | 64);
      e->flags &= 1 | 64;
    }
  else if (!(e->flags & 1))
    fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 995, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 1071, __FUNCTION__);
    }
  else
    {
     ...
     edge edge_in;
{
  ...
  if ((edge_in->flags & 2) != 0)
    fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 1268, __FUNCTION__);
...
# 1302 "../../../kg++fe/gnu/cfgrtl.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 1336, __FUNCTION__);
    }
  else
     ...
     edge e;
{
  ...
  if ((e->flags & 2) && ((e)->src->succ->succ_next && (e)->dest->pred->pred_next))
    fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 1356, __FUNCTION__);
     ...
     int watch_calls;
{
        ...
        && e->src != (&entry_exit_blocks[0]))
 {
   ...
   NOTE_INSN_LOOP_BEG; before = (((before)->fld[1]).rtx))
   ...
   else
     {
       ...
       if ((e->flags & 1) == 0)
  fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 1448, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 1481, __FUNCTION__);
 ...
 delete_insn (before);
    ...
    fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 1490, __FUNCTION__);
...
verify_flow_info ()
{
  ...
  for (insn = (((e->src->end)->fld[2]).rtx); insn != e->dest->head;
    ...
    if (((enum rtx_code) (insn)->code) == BARRIER
        ...
        )
      {
        ...
        e->src->index, e->dest->index);
        _fatal_insn ("wrong insn in the fallthru edge", insn, "../../../kg++fe/gnu/cfgrtl.c", 1938, __FUNCTION__);
        err = 1;
      }
     }
 ...
 for (x = (((x)->fld[2]).rtx); x; x = (((x)->fld[2]).rtx))
  ...
  _fatal_insn ("flow control insn inside a basic block", x, "../../../kg++fe/gnu/cfgrtl.c", 2095, __FUNCTION__);
       }
   }
    }
      ...
      if (!bb_info[(((x)->fld[0]).rtint)])
 {
  ...
  x = (((x)->fld[2]).rtx);
     ...
     default:
       _fatal_insn ("insn outside basic block", x, "../../../kg++fe/gnu/cfgrtl.c", 2154, __FUNCTION__);
     }
 }
   ...
   && ! ((((x)->fld[2]).rtx) && ((enum rtx_code) ((((x)->fld[2]).rtx))->code) == BARRIER))
     _fatal_insn ("return not followed by barrier", x, "../../../kg++fe/gnu/cfgrtl.c", 2162, __FUNCTION__);
    }
     ...
     basic_block bb;
{
      ...
      if (!(e->flags & 1))
 {
  ...
  if (!bb->succ || bb->succ->succ_next)
    fancy_abort ("../../../kg++fe/gnu/cfgrtl.c", 2339, __FUNCTION__);
