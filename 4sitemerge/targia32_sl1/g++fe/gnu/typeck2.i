...
error_not_base_type (basetype, type)
     tree basetype, type;
{
  if (((enum tree_code) (basetype)->common.code) == FUNCTION_DECL)
    basetype = ((basetype)->decl.context);
...
binfo_or_else (base, type)
     tree base, type;
{
  tree binfo = lookup_base (type, base, ba_ignore, ((void *)0));
     ...
     int soft;
{
  ...
  if (((enum tree_code) (arg)->common.code) == COMPONENT_REF)
    {
      ...
      (*fn) (fmt, string, ((arg)->exp.operands[1]));
    }
  else if (((enum tree_code) (arg)->common.code) == VAR_DECL)
    {
      if (((arg)->decl.lang_specific)
   && (((arg)->decl.lang_flag_3))
 ...
 fmt = "%s of read-only variable `%D'";
  ...
  else if (((enum tree_code) (arg)->common.code) == PARM_DECL)
    (*fn) ("%s of read-only parameter `%D'", string, arg);
  else if (((enum tree_code) (arg)->common.code) == INDIRECT_REF
           && ((enum tree_code) (((((arg)->exp.operands[0]))->common.type))->common.code) == REFERENCE_TYPE
           && (((enum tree_code) (((arg)->exp.operands[0]))->common.code) == VAR_DECL
               || ((enum tree_code) (((arg)->exp.operands[0]))->common.code) == PARM_DECL))
    (*fn) ("%s of read-only reference `%D'", string, ((arg)->exp.operands[0]));
  else if (((enum tree_code) (arg)->common.code) == RESULT_DECL)
    (*fn) ("%s of read-only named return value `%D'", string, arg);
  else if (((enum tree_code) (arg)->common.code) == FUNCTION_DECL)
     ...
     tree type;
{
  ...
  u = ((&((type)->type.lang_specific)->u.c)->pure_virtuals);
  if (decl)
    {
      if (((enum tree_code) (decl)->common.code) == RESULT_DECL)
 return 0;
 ...
 error ("invalid return type for function `%#D'", decl);
  ...
  if (((u)->list.purpose) == (tree) ((void *)0))
    {
      ((u)->list.purpose) = global_trees[TI_ERROR_MARK];

      error ("  because the following virtual functions are abstract:");
      for (tu = u; tu; tu = ((tu)->common.chain))
 cp_error_at ("\t%#D", ((tu)->list.value));
    }
  else
     ...
     int diag_type;
{
  ...
  if (value != 0 && (((enum tree_code) (value)->common.code) == VAR_DECL
       ...
       || ((enum tree_code) (value)->common.code) == FIELD_DECL))
    {
...
retry:
 ...
 (*p_msg_at) ("declaration of `%#T'", type);
    ...
    case LANG_TYPE:
      if (value && ((enum tree_code) (value)->common.code) == COMPONENT_REF)
        goto bad_member;
      else if (value && ((enum tree_code) (value)->common.code) == ADDR_EXPR)
        (*p_msg) ("address of overloaded function with no contextual type information");
      else if (value && ((enum tree_code) (value)->common.code) == OVERLOAD)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/typeck2.c", 282, __FUNCTION__);
    }
}
     ...
     tree decl, init;
{
  ...
  if ((((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)))
    {
      if (! (((&((type)->type.lang_specific)->u.c)->h.has_init_ref) && ! ((&((type)->type.lang_specific)->u.c)->has_complex_init_ref))
   && ((enum tree_code) (init)->common.code) != CONSTRUCTOR)
 fancy_abort ("../../../kg++fe/gnu/cp/typeck2.c", 333, __FUNCTION__);

      if (((enum tree_code) (init)->common.code) == TREE_LIST)
 {
   error ("constructor syntax used, but no constructor declared for type `%T'", type);
   init = build_nt (CONSTRUCTOR, (tree) ((void *)0), nreverse (init));
 }
    }
  else if (((enum tree_code) (init)->common.code) == TREE_LIST
    && ((init)->common.type) != cp_global_trees[CPTI_UNKNOWN_TYPE])
    {
      if (((enum tree_code) (decl)->common.code) == RESULT_DECL)
 {
      ...
      else
 {
  ...
  if (((enum tree_code) (value)->common.code) == ERROR_MARK)
    ;
    ...
    && (! ((value)->common.constant_flag)
        || ! initializer_constant_valid_p (value, ((value)->common.type))))
    return value;
...
# 410 "../../../kg++fe/gnu/cp/typeck2.c"
tree
digest_init (type, init, tail)
     tree type, init, *tail;
{
  enum tree_code code = ((enum tree_code) (type)->common.code);
  tree element = (tree) ((void *)0);
  tree old_tail_contents = (tree) ((void *)0);
  ...
  if (init == global_trees[TI_ERROR_MARK] || (((enum tree_code) (init)->common.code) == TREE_LIST
      && ((init)->list.value) == global_trees[TI_ERROR_MARK]))
    return global_trees[TI_ERROR_MARK];

  if (((enum tree_code) (init)->common.code) == ERROR_MARK)
  ...
  if (!(complete_type_or_diagnostic ((((enum tree_code) (type)->common.code) == ARRAY_TYPE ? ((type)->common.type) : type), ((tree) ((void *)0)), 0)))
  ...
  raw_constructor = (((enum tree_code) (init)->common.code) == CONSTRUCTOR
       && (((init)->common.lang_flag_4)));

  if (raw_constructor
      && (((init))->exp.operands[1]) != 0
      && (((((init))->exp.operands[1]))->common.chain) == 0)
    {
      element = (((((init))->exp.operands[1]))->list.value);

      if (element && ((enum tree_code) (element)->common.code) == NON_LVALUE_EXPR)
 element = ((element)->exp.operands[0]);
      if (element == global_trees[TI_ERROR_MARK])
 return element;
    }
      ...
      if (((enum tree_code) (init)->common.code) == TREE_LIST)
 {
   ...
   return global_trees[TI_ERROR_MARK];
      ...
      typ1 = ((((type)->common.type))->type.main_variant);
      if (char_type_p (typ1)
   && ((init && ((enum tree_code) (init)->common.code) == STRING_CST)
       || (element && ((enum tree_code) (element)->common.code) == STRING_CST)))
 {
   tree string = element ? element : init;

   if ((((((((string)->common.type))->common.type))->type.main_variant)
        != integer_types[itk_char])
       && ((typ1)->type.precision) == 8)
     {
   ...
   if (((type)->type.values) != 0
     ...
     {
       register int size
  = (((((type)->type.size))->int_cst.int_cst).low);
       size = (size + 8 - 1) / 8;




       if (size < ((string)->string.length))
      ...
      if (raw_constructor)
 {
   ...
   init = element;
      ...
      while (((enum tree_code) (init)->common.code) == CONSTRUCTOR && (((init)->common.lang_flag_4)))
 {
   pedwarn ("braces around scalar initializer for `%T'", type);
   init = (((init))->exp.operands[1]);
   if (((init)->common.chain))
     pedwarn ("ignoring extra initializers for `%T'", type);
   init = ((init)->list.value);
 }

      return convert_for_initialization (0, type, init, (3),
      "initialization", (tree) ((void *)0), 0);
    }



  if ((((type)->type.size) != (tree) ((void *)0)) && ! ((((type)->type.size))->common.constant_flag))
    {
  ...
  if (code == ARRAY_TYPE || code == VECTOR_TYPE || ((code) == RECORD_TYPE || (code) == UNION_TYPE))
    {
      if (raw_constructor && ((((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)) && ((&((type)->type.lang_specific)->u.c)->non_aggregate))
   && (((init)->common.lang_flag_4)))
 {
 ...
 return process_init_constructor (type, init, (tree *)0);
      else if (can_convert_arg (type, ((init)->common.type), init)
        || ((((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)) && ((&((type)->type.lang_specific)->u.c)->non_aggregate)))
                                                                       ;
      else if (tail != 0)
 {
      ...
      if (code != ARRAY_TYPE)
 {
   ...
   return convert_for_initialization ((tree) ((void *)0), type, init, flags,
          "initialization", (tree) ((void *)0), 0);
 }
    }
     ...
     tree type, init, *elts;
{
 ...
 warning ("aggregate has a partly bracketed initializer");
    ...
    tail = (((init))->exp.operands[1]);





  if (((enum tree_code) (type)->common.code) == ARRAY_TYPE || ((enum tree_code) (type)->common.code) == VECTOR_TYPE)
    {
      register long len;
      register int i;
      ...
      if (((enum tree_code) (type)->common.code) == ARRAY_TYPE)
 {
   ...
   if (domain)
     len = ((((((domain)->type.maxval))->int_cst.int_cst).low)
     - (((((domain)->type.minval))->int_cst.int_cst).low)
     + 1);
   else
     len = -1;
 }
      else
 {
   ...
   len = (((mode_unit_size[(int) ((type->type.mode))]) == 0) ? 0 : ((mode_size[(int) ((type->type.mode))]) / (mode_unit_size[(int) ((type->type.mode))])));
 }
      ...
      for (i = 0; len < 0 || i < len; i++)
 {
   if (tail)
     {
       if (((tail)->list.purpose)
    && (((enum tree_code) (((tail)->list.purpose))->common.code) != INTEGER_CST
        || compare_tree_int (((tail)->list.purpose), i) != 0))
  sorry ("non-trivial labeled initializers");

       if (((tail)->list.value) != 0)
  {
    tree tail1 = tail;
    next1 = digest_init (((type)->common.type),
           ((tail)->list.value), &tail1);
    if (next1 == global_trees[TI_ERROR_MARK])
      return next1;
    (void) (((comptypes ((((((type)->common.type))->type.main_variant)), (((((next1)->common.type))->type.main_variant)), 0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/typeck2.c", 676, __FUNCTION__), 0) : 0);



    (void) (((tail1 == 0 || ((enum tree_code) (tail1)->common.code) == TREE_LIST) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/typeck2.c", 678, __FUNCTION__), 0) : 0);
  ...
  {
    next1 = global_trees[TI_ERROR_MARK];
    tail = ((tail)->common.chain);
  }
     }
   else if (len < 0)
     ...
     break;
   else if (((((type)->common.type))->type.needs_constructing_flag))
     {
  ...
  next1 = build_functional_cast (((type)->common.type), (tree) ((void *)0));
       else
  next1 = build (CONSTRUCTOR, (tree) ((void *)0), (tree) ((void *)0), (tree) ((void *)0));
       next1 = digest_init (((type)->common.type), next1, 0);
     }
   else if (! zero_init_p (((type)->common.type)))
     next1 = build_zero_init (((type)->common.type),
                   (tree) ((void *)0),
                              0);
   else
   ...
   if (next1 == global_trees[TI_ERROR_MARK])
     erroneous = 1;
   else if (!((next1)->common.constant_flag))
     allconstant = 0;
   else if (! initializer_constant_valid_p (next1, ((next1)->common.type)))
     allsimple = 0;
   members = tree_cons (size_int_wide ((long long) (i), SIZETYPE), next1, members);
 }
    }
   ...
   if ((((type)->common.lang_flag_2)))
     {
      ...
      for (field = ((type)->type.values); field;
    field = ((field)->common.chain))
 {
   if (! ((field)->decl.name) && ((((field))->decl.lang_flag_4) == 1))
     {
       members = tree_cons (field, global_trees[TI_INTEGER_ZERO], members);
       continue;
     }
   ...
   if (tail)
     {
       if (((tail)->list.purpose)
    && ((tail)->list.purpose) != field
    && ((tail)->list.purpose) != ((field)->decl.name))
  sorry ("non-trivial labeled initializers");
       ...
       if (((tail)->list.value) != 0)
  {
    ...
    next1 = digest_init (((field)->common.type),
           ((tail)->list.value), &tail1);
    (void) (((tail1 == 0 || ((enum tree_code) (tail1)->common.code) == TREE_LIST) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/typeck2.c", 778, __FUNCTION__), 0) : 0);
       ...
       else
  {
   ...
   else if (((((field)->common.type))->type.needs_constructing_flag))
     {
       ...
       if ((((enum tree_code) (((field)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((field)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((field)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((field)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((field)->common.type))->type.lang_flag_5)))
  next1 = build_functional_cast (((field)->common.type),
            (tree) ((void *)0));
       else
         {
    next1 = build (CONSTRUCTOR, (tree) ((void *)0), (tree) ((void *)0),
            (tree) ((void *)0));
                  if (init)
                    (((next1)->common.lang_flag_4))
                       = (((init)->common.lang_flag_4));
                }
       next1 = digest_init (((field)->common.type), next1, 0);


       if (extra_warnings
           && (!init || (((init)->common.lang_flag_4))))
  ...
  error ("uninitialized const member `%D'", field);
       else if ((((((field)->common.type))->type.lang_specific) ? (&((((field)->common.type))->type.lang_specific)->u.c)->h.const_needs_init : 0))
  ...
  warning ("missing initializer for member `%D'", field);
       ...
       if (! zero_init_p (((field)->common.type)))
  next1 = build_zero_init (((field)->common.type),
                (tree) ((void *)0),
                           0);
       else
  ...
  continue;
   ...
   members = tree_cons (field, next1, members);
    ...
    && tail)
    {
      register tree field = ((type)->type.values);



      while (field && (!((field)->decl.name) || ((enum tree_code) (field)->common.code) != FIELD_DECL))
 field = ((field)->common.chain);


      if (((tail)->list.purpose) != (tree) ((void *)0))
 {
   int win = 0;

   if (((enum tree_code) (((tail)->list.purpose))->common.code) == FIELD_DECL)

     field = ((tail)->list.purpose), win = 1;
   else if (((enum tree_code) (((tail)->list.purpose))->common.code) != IDENTIFIER_NODE)
     error ("index value instead of field name in union initializer");
   else
     {
       tree temp;
       for (temp = ((type)->type.values);
     temp;
     temp = ((temp)->common.chain))
  if (((temp)->decl.name) == ((tail)->list.purpose))
    break;
       if (temp)
  field = temp, win = 1;
       else
  error ("no field `%D' in union being initialized",
   ...
   if (!win)
     ((tail)->list.value) = global_trees[TI_ERROR_MARK];
 }
      else if (field == 0)
 {
      ...
      if (((tail)->list.value) != 0)
 {
   ...
   next1 = digest_init (((field)->common.type),
          ((tail)->list.value), &tail1);
   if (tail1 != 0 && ((enum tree_code) (tail1)->common.code) != TREE_LIST)
     fancy_abort ("../../../kg++fe/gnu/cp/typeck2.c", 899, __FUNCTION__);
   tail = tail1;
 }
      else
 {
 ...
 allconstant = 0;
      else if (initializer_constant_valid_p (next1, ((next1)->common.type)) == 0)
 allsimple = 0;
      members = tree_cons (field, next1, members);
    }
  ...
  result = build (CONSTRUCTOR, type, (tree) ((void *)0), nreverse (members));
  if (((enum tree_code) (type)->common.code) == ARRAY_TYPE && ((type)->type.values) == (tree) ((void *)0))
    complete_array_type (type, result, 0);
  if (init)
    (((result)->common.lang_flag_4)) = (((init)->common.lang_flag_4));
  if (allconstant) ((result)->common.constant_flag) = 1;
  if (allconstant && allsimple) ((result)->common.static_flag) = 1;
  return result;
}
# 966 "../../../kg++fe/gnu/cp/typeck2.c"
tree
     ...
     tree *binfo_p;
{
  ...
  if (*binfo_p)
    ...
    binfo = lookup_base (((datum)->common.type), basetype, ba_check, ((void *)0));

  if (!binfo || binfo == global_trees[TI_ERROR_MARK])
    {
      *binfo_p = (tree) ((void *)0);
      if (!binfo)
 error_not_base_type (basetype, ((datum)->common.type));
      return global_trees[TI_ERROR_MARK];
    }
...
# 1000 "../../../kg++fe/gnu/cp/typeck2.c"
tree
build_x_arrow (datum)
     tree datum;
{
  tree types_memoized = (tree) ((void *)0);
  register tree rval = datum;
  tree type = ((rval)->common.type);
  tree last_rval = (tree) ((void *)0);
  ...
  if (((enum tree_code) (rval)->common.code) == OFFSET_REF)
    {
      rval = resolve_offset_ref (datum);
      type = ((rval)->common.type);
    }
  ...
  if ((((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)))
    {
      while ((rval = build_opfncall (COMPONENT_REF, (3), rval,
         (tree) ((void *)0), (tree) ((void *)0))))
 {
   if (rval == global_trees[TI_ERROR_MARK])
     return global_trees[TI_ERROR_MARK];

   if (value_member (((rval)->common.type), types_memoized))
     {
     ...
     {
       types_memoized = tree_cons ((tree) ((void *)0), ((rval)->common.type),
       types_memoized);
     }
   last_rval = rval;
 }

      if (last_rval == (tree) ((void *)0))
 {
   error ("base operand of `->' has non-pointer type `%T'", type);
   return global_trees[TI_ERROR_MARK];
 }

      if (((enum tree_code) (((last_rval)->common.type))->common.code) == REFERENCE_TYPE)
 last_rval = convert_from_reference (last_rval);
    }
  else
    last_rval = default_conversion (rval);

  if (((enum tree_code) (((last_rval)->common.type))->common.code) == POINTER_TYPE)
    return build_indirect_ref (last_rval, ((void *)0));
     ...
     tree datum, component;
{
  ...
  if (datum == global_trees[TI_ERROR_MARK] || component == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];

  objtype = ((((datum)->common.type))->type.main_variant);

  if ((((enum tree_code) (((component)->common.type))->common.code) == RECORD_TYPE && ((((component)->common.type))->type.lang_specific) && ((&((((component)->common.type))->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    {
      type = (((((((((component)->common.type))->type.values))->common.type)))->common.type);
      field_type = type;
    }
  else if ((((enum tree_code) (((component)->common.type))->common.code) == POINTER_TYPE && ((enum tree_code) (((((component)->common.type))->common.type))->common.code) == OFFSET_TYPE))
    {
      type = ((((component)->common.type))->common.type);
      field_type = ((type)->common.type);


      type_quals = 0x0;
      if (((enum tree_code) (field_type)->common.code) == REFERENCE_TYPE)
      ...
      else
 {
   ...
   | cp_type_quals (((datum)->common.type)));




   field_type = cp_build_qualified_type_real ((field_type), (type_quals), tf_error | tf_warning);
 }
    }
  else
    {
      error ("`%E' cannot be used as a member pointer, since it is of type `%T'",
  component, ((component)->common.type));
      return global_trees[TI_ERROR_MARK];
    }

  if (! (((enum tree_code) (objtype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (objtype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (objtype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (objtype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((objtype)->type.lang_flag_5)))
    {
  ...
  binfo = lookup_base (objtype, ((type)->type.maxval),
         ba_check, ((void *)0));
  if (!binfo)
    {
      error ("member type `%T::' incompatible with object type `%T'",
  ((type)->type.maxval), objtype);
      return global_trees[TI_ERROR_MARK];
    }
  else if (binfo == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];
     ...
     tree parms;
{
  ...
  if (exp == global_trees[TI_ERROR_MARK] || parms == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];

  if (((enum tree_code) (exp)->common.code) == IDENTIFIER_NODE)
    {
      if ((identifier_type_value (exp) ? 1 : 0))
      ...
      else
 {
  ...
  else if (((enum tree_code) (exp)->common.code) == TYPE_DECL)
  ...
  if (! (((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)))
    {
      ...
      if (parms == (tree) ((void *)0))
 parms = global_trees[TI_INTEGER_ZERO];
      else
 {
   if (((parms)->common.chain) != (tree) ((void *)0))
     pedwarn ("initializer list being treated as compound expression");
...
# 1221 "../../../kg++fe/gnu/cp/typeck2.c"
  if (!(complete_type_or_diagnostic ((type), ((tree) ((void *)0)), 0)))
    return global_trees[TI_ERROR_MARK];
  if (abstract_virtuals_error ((tree) ((void *)0), type))
    return global_trees[TI_ERROR_MARK];

  if (parms && ((parms)->common.chain) == (tree) ((void *)0))
    return build_c_cast (type, ((parms)->list.value));



  if (parms == (tree) ((void *)0) && !((type)->type.needs_constructing_flag)
      && ((&((type)->type.lang_specific)->u.c)->h.has_default_ctor))
    {
      exp = build (CONSTRUCTOR, type, (tree) ((void *)0), (tree) ((void *)0));
      return get_target_expr (exp);
    }

  exp = build_special_member_call ((tree) ((void *)0), cp_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER], parms,
       ((type)->type.binfo), (3));
     ...
     int complain;
{
  ...
  (void) (((spec && (!list || ((list)->list.value))) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/typeck2.c", 1279, __FUNCTION__), 0) : 0);




  is_ptr = ((enum tree_code) (core)->common.code) == POINTER_TYPE;
  if (is_ptr || ((enum tree_code) (core)->common.code) == REFERENCE_TYPE)
    core = ((core)->common.type);
  if (complain < 0)
    ok = 1;
  else if ((((enum tree_code) (core)->common.code) == VOID_TYPE))
    ok = is_ptr;
  else if (((enum tree_code) (core)->common.code) == TEMPLATE_TYPE_PARM)
    ok = 1;
  ...
  else
    {
      ...
      if (!(((complete_type (core))->type.size) != (tree) ((void *)0)))
 diag_type = 2;
    }
  ...
  if (ok)
    {
      ...
      for (probe = list; probe; probe = ((probe)->common.chain))
        if (comptypes ((((probe)->list.value)), (spec), 0))
          break;
      if (!probe)
 list = tree_cons ((tree) ((void *)0), spec, list);
    }
  else
    diag_type = 0;

  if (diag_type >= 0 && complain)
    cxx_incomplete_type_diagnostic ((tree) ((void *)0), core, diag_type);
     ...
     tree list, add;
{
  if (!list || !add)
    ...
    return add;
  else if (!((add)->list.value))
    return list;
  else
    {
      tree orig_list = list;

      for (; add; add = ((add)->common.chain))
        {
          tree spec = ((add)->list.value);
          tree probe;

          for (probe = orig_list; probe; probe = ((probe)->common.chain))
            if (comptypes ((((probe)->list.value)), (spec), 0))
              break;
          if (!probe)
            {
              spec = build_tree_list ((tree) ((void *)0), spec);
              ((spec)->common.chain) = list;
              list = spec;
            }
        }
    }
     ...
     tree fntype, decl;
{
  ...
  if (decl && ((decl)->decl.artificial_flag))
    return;
  for (raises = ((fntype)->type.binfo); raises;
       raises = ((raises)->common.chain))
    {
      tree type = ((raises)->list.value);
      if (type && !(((type)->type.size) != (tree) ((void *)0)))
 {
   if (decl)
     error
