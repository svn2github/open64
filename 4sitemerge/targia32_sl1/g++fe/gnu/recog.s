...
.LFE18:
	...
	.section	.rodata
	.type	__FUNCTION__.11324, @object
	.size	__FUNCTION__.11324, 16
__FUNCTION__.11324:
	.string	"validate_change"
.LC0:
	.string	"../../../kg++fe/gnu/recog.c"
	.text
...
.L32:
	...
	je	.L34
	.loc 1 226 0
	leal	__FUNCTION__.11324@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$226, 4(%esp)
...
.LFE51:
	...
	.section	.rodata
	.type	__FUNCTION__.13292, @object
	.size	__FUNCTION__.13292, 15
__FUNCTION__.13292:
...
.LCFI151:
	...
	je	.L846
	.loc 1 1688 0
	leal	__FUNCTION__.13292@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1688, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LCFI181:
	...
	jne	.L946
	.loc 1 2100 0
	leal	__FUNCTION__.13812@GOTOFF(%ebx), %eax
	movl	%eax, 12(%esp)
	movl	$2100, 8(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, 4(%esp)
...
.LFE61:
	...
	.section	.rodata
	.type	__FUNCTION__.13846, @object
	.size	__FUNCTION__.13846, 13
__FUNCTION__.13846:
	.string	"extract_insn"
	.text
.globl extract_insn
...
.L956:
	...
	jle	.L964
	.loc 1 2160 0
	leal	__FUNCTION__.13846@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2160, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE68:
	...
	.section	.rodata
	.type	__FUNCTION__.14939, @object
	.size	__FUNCTION__.14939, 20
__FUNCTION__.14939:
...
.L1356:
	...
	jne	.L1357
	.loc 1 3390 0
	leal	__FUNCTION__.14939@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3390, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE69:
	...
	.section	.rodata
	.type	__FUNCTION__.15016, @object
	.size	__FUNCTION__.15016, 17
__FUNCTION__.15016:
...
.L1394:
	.loc 1 3444 0
	leal	__FUNCTION__.15016@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3444, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
