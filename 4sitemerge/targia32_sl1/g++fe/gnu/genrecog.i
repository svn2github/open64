# 1 "../../../kg++fe/gnu/genrecog.c"
# 1 "/usa/handong/simplnano/cmplr-open64-merge/targia32_sl1/g++fe/gnu//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../../kg++fe/gnu/genrecog.c"
# 57 "../../../kg++fe/gnu/genrecog.c"
# 1 "../../../kg++fe/gnu/MIPS/hconfig.h" 1




# 1 "../../../kg++fe/gnu/MIPS/auto-host.h" 1
# 6 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
...
# 21 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kg++fe/gnu/config/dbxelf.h" 1
# 22 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kg++fe/gnu/config/elfos.h" 1
# 23 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kg++fe/gnu/config/svr4.h" 1
# 24 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kg++fe/gnu/MIPS/linux.h" 1
# 25 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
...
# 26 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kg++fe/gnu/MIPS/linux.h" 1
# 27 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kg++fe/gnu/defaults.h" 1
# 28 "../../../kg++fe/gnu/MIPS/hconfig.h" 2
# 58 "../../../kg++fe/gnu/genrecog.c" 2
...
# 61 "../../../kg++fe/gnu/genrecog.c" 2
# 1 "../../../kg++fe/gnu/gensupport.h" 1
# 24 "../../../kg++fe/gnu/gensupport.h"
struct obstack;
     ...
     int n;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/genrecog.c", 405, __FUNCTION__);
 }
    }
     ...
     int n;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/genrecog.c", 458, __FUNCTION__);
 }
    }
...
# 622 "../../../kg++fe/gnu/genrecog.c"
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/genrecog.c", 754, __FUNCTION__);
 }
    }
}
# 771 "../../../kg++fe/gnu/genrecog.c"
static struct decision *
...
# 879 "../../../kg++fe/gnu/genrecog.c"
      ...
      if (fmt[i] == 'i')
 {
   if (i == 0)
     ...
     fancy_abort ("../../../kg++fe/gnu/genrecog.c", 977, __FUNCTION__);
 }
      else if (fmt[i] == 'w')
 {
   ...
   if (i != 0)
     fancy_abort ("../../../kg++fe/gnu/genrecog.c", 988, __FUNCTION__);
 ...
 {
   if (i != 0)
     fancy_abort ("../../../kg++fe/gnu/genrecog.c", 996, __FUNCTION__);
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/genrecog.c", 1033, __FUNCTION__);
 }
    }
 ...
 fini:
  ...
  if (this->tests == ((void *)0))
    fancy_abort ("../../../kg++fe/gnu/genrecog.c", 1056, __FUNCTION__);
     ...
     int toplevel;
{
  ...
  int cmp;
# 1238 "../../../kg++fe/gnu/genrecog.c"
  cmp = strcmp (d1->position, d2->position);
  if (cmp != 0)
    {
      if (toplevel)
 fancy_abort ("../../../kg++fe/gnu/genrecog.c", 1242, __FUNCTION__);
     ...
     struct decision_test *d1, *d2;
{
  switch (d1->type)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/genrecog.c", 1321, __FUNCTION__);
    }
}
     ...
     struct decision_head *oldh, *addh;
{
  ...
  if (strcmp (oldh->first->position, addh->first->position))
    fancy_abort ("../../../kg++fe/gnu/genrecog.c", 1427, __FUNCTION__);
...
# 1840 "../../../kg++fe/gnu/genrecog.c"
 ...
 case DT_elt_zero_wide_safe:
   ...
   break;
 default:
   fancy_abort ("../../../kg++fe/gnu/genrecog.c", 1923, __FUNCTION__);
 }
      printf (")\n%s    {\n", indent);
      ...
      do
 {
   ...
   switch (type)
     ...
     case DT_elt_zero_wide_safe:
       ...
       break;
     default:
       fancy_abort ("../../../kg++fe/gnu/genrecog.c", 1956, __FUNCTION__);
     }
     ...
     enum routine_type subroutine_type;
{
 ...
 case RECOG:
   if (p->u.insn.num_clobbers_to_add == 0)
     fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2037, __FUNCTION__);
   printf ("pnum_clobbers != NULL");
   break;

 default:
   fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2042, __FUNCTION__);
 }
      break;

    default:
      fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2047, __FUNCTION__);
    }
}
     ...
     enum routine_type subroutine_type;
{
      ...
      if (test->next)
 {
   ...
   if (test->type != DT_accept_insn)
     fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2086, __FUNCTION__);
 }
    }


  if (test->next)
    fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2092, __FUNCTION__);
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2128, __FUNCTION__);
 }
    }
  else
    {
     ...
     enum routine_type subroutine_type;
{
 ...
 case PEEPHOLE2:
   return -1;
 default:
   fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2165, __FUNCTION__);
 }
    }
     ...
     enum routine_type type;
{
  ...
  if (truth == 0)
    fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2469, __FUNCTION__);
     ...
     struct decision_test *test;
{
 ...
 fprintf (stderr, "c_test=\"%s\"", sub);
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/genrecog.c", 2823, __FUNCTION__);
    }
}
