...
.LFE17:
	...
	.section	.rodata
	.type	__FUNCTION__.13777, @object
	.size	__FUNCTION__.13777, 12
__FUNCTION__.13777:
	.string	"emit_call_1"
.LC0:
	.string	"../../../kg++fe/gnu/calls.c"
	.text
...
.L107:
	...
	jne	.L109
	.loc 1 598 0
	leal	__FUNCTION__.13777@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$598, 4(%esp)
...
.LFE27:
	...
	.section	.rodata
	.type	__FUNCTION__.15426, @object
	.size	__FUNCTION__.15426, 28
__FUNCTION__.15426:
...
.L549:
	...
	je	.L552
	.loc 1 1467 0
	leal	__FUNCTION__.15426@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1467, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE28:
	...
	.section	.rodata
	.type	__FUNCTION__.15514, @object
	.size	__FUNCTION__.15514, 21
__FUNCTION__.15514:
...
.LBB13:
	...
	je	.L568
	.loc 1 1554 0
	leal	__FUNCTION__.15514@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1554, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE38:
	...
	.section	.rodata
	.type	__FUNCTION__.16475, @object
	.size	__FUNCTION__.16475, 12
__FUNCTION__.16475:
	.string	"expand_call"
	.local	currently_expanding_call.16427
	.comm	currently_expanding_call.16427,4,4
.LC18:
...
.L853:
	...
	je	.L854
	.loc 1 2377 0
	leal	__FUNCTION__.16475@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2377, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L881:
	.loc 1 2503 0
	movl	currently_expanding_call.16427@GOTOFF(%ebx), %eax
	addl	$1, %eax
	movl	%eax, currently_expanding_call.16427@GOTOFF(%ebx)
	movl	currently_expanding_call.16427@GOTOFF(%ebx), %eax
	cmpl	$1, %eax
	jne	.L886
...
.LFE39:
	...
	.section	.rodata
	.type	__FUNCTION__.17699, @object
	.size	__FUNCTION__.17699, 26
__FUNCTION__.17699:
...
.L1250:
	...
	je	.L1251
	.loc 1 3686 0
	leal	__FUNCTION__.17699@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3686, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE42:
	...
	.section	.rodata
	.type	__FUNCTION__.18804, @object
	.size	__FUNCTION__.18804, 14
__FUNCTION__.18804:
...
.L1541:
	...
	jne	.L1546
	.loc 1 4514 0
	leal	__FUNCTION__.18804@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$4514, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LLST28:
	...
	.byte	0x5
	.byte	0x3
	.long	currently_expanding_call.16427
	.uleb128 0x34
	.long	.LASF53
	.long	0x9582
	.byte	0x1
