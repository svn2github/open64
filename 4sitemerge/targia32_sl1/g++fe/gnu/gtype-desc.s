...
.LFB15:
	.file 1 "../../../kg++fe/gnu/MIPS/gtype-desc.c"
	.loc 1 46 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LFE16:
	...
	.section	.rodata
	.type	__FUNCTION__.13071, @object
	.size	__FUNCTION__.13071, 26
__FUNCTION__.13071:
	.string	"gt_ggc_mx_varray_head_tag"
	.align 4
.LC0:
	.string	"../../../kg++fe/gnu/MIPS/gtype-desc.c"
	.text
...
.LBB2:
	...
	jae	.L68
	.loc 1 90 0
	leal	__FUNCTION__.13071@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$90, 4(%esp)
...
.LEFDE38:
	...
	.file 20 "../../../kg++fe/gnu/insn-addr.h"
	.file 21 "../../../kg++fe/gnu/ssa.h"
