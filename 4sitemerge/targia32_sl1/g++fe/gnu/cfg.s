...
entry_exit_blocks:
	...
	.long	0
	.long	0
	.local	initialized.12292
	.comm	initialized.12292,4,4
	.text
.globl init_flow
	.type	init_flow, @function
init_flow:
.LFB15:
	.file 1 "../../../kg++fe/gnu/cfg.c"
	.loc 1 148 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LCFI4:
	...
	movl	$0, (%eax)
	.loc 1 155 0
	movl	initialized.12292@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L2
	.loc 1 157 0
...
.LBE2:
	...
	.loc 1 159 0
	movl	$1, initialized.12292@GOTOFF(%ebx)
	jmp	.L21
.L2:
.LBB5:
	.loc 1 163 0
...
.LFE16:
	...
	.section	.rodata
	.type	__FUNCTION__.12417, @object
	.size	__FUNCTION__.12417, 12
__FUNCTION__.12417:
	.string	"clear_edges"
.LC0:
	.string	"../../../kg++fe/gnu/cfg.c"
	.text
.globl clear_edges
...
.LBE11:
	...
	je	.L36
	.loc 1 218 0
	leal	__FUNCTION__.12417@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$218, 4(%esp)
...
.LFE20:
	...
	.section	.rodata
	.type	__FUNCTION__.12500, @object
	.size	__FUNCTION__.12500, 15
__FUNCTION__.12500:
...
.L53:
	...
	je	.L56
	.loc 1 278 0
	leal	__FUNCTION__.12500@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$278, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LC25:
	...
	.align 32
	.type	reg_class_names.12770, @object
	.size	reg_class_names.12770, 100
reg_class_names.12770:
	.long	.LC1
	.long	.LC2
	.long	.LC3
	.long	.LC4
...
.L174:
	.loc 1 564 0
	movl	-32(%ebp), %eax
	movl	reg_class_names.12770@GOTOFF(%ebx,%eax,4), %eax
	movl	%eax, 8(%esp)
...
.L177:
	.loc 1 568 0
	movl	-28(%ebp), %eax
	movl	reg_class_names.12770@GOTOFF(%ebx,%eax,4), %edx
	movl	-32(%ebp), %eax
	movl	reg_class_names.12770@GOTOFF(%ebx,%eax,4), %eax
	movl	%edx, 12(%esp)
	movl	%eax, 8(%esp)
...
.LC65:
	...
	.align 4
	.type	bitnames.13056, @object
	.size	bitnames.13056, 28
bitnames.13056:
	.long	.LC59
	.long	.LC60
	.long	.LC61
...
.L246:
	...
	.loc 1 695 0
	movl	-12(%ebp), %eax
	movl	bitnames.13056@GOTOFF(%ebx,%eax,4), %edx
	movl	8(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	%edx, (%esp)
...
.LFE34:
	...
	.section	.rodata
	.type	__FUNCTION__.13111, @object
	.size	__FUNCTION__.13111, 20
__FUNCTION__.13111:
...
.L254:
	.loc 1 722 0
	leal	__FUNCTION__.13111@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$722, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE35:
	...
	.section	.rodata
	.type	__FUNCTION__.13166, @object
	.size	__FUNCTION__.13166, 21
__FUNCTION__.13166:
	.string	"alloc_aux_for_blocks"
	.local	initialized.13165
	.comm	initialized.13165,4,4
	.text
...
.LCFI93:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 736 0
	movl	initialized.13165@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L265
	.loc 1 738 0
	leal	block_aux_obstack@GOTOFF(%ebx), %eax
	...
	call	gcc_obstack_init@PLT
	.loc 1 739 0
	movl	$1, initialized.13165@GOTOFF(%ebx)
	jmp	.L267
.L265:
	.loc 1 743 0
	movl	first_block_aux_obj@GOTOFF(%ebx), %eax
	...
	je	.L267
	.loc 1 744 0
	leal	__FUNCTION__.13166@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$744, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE37:
	...
	.section	.rodata
	.type	__FUNCTION__.13231, @object
	.size	__FUNCTION__.13231, 20
__FUNCTION__.13231:
...
.LCFI100:
	...
	jne	.L286
	.loc 1 773 0
	leal	__FUNCTION__.13231@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$773, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE38:
	...
	.section	.rodata
	.type	__FUNCTION__.13249, @object
	.size	__FUNCTION__.13249, 19
__FUNCTION__.13249:
...
.L294:
	.loc 1 790 0
	leal	__FUNCTION__.13249@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$790, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE39:
	...
	.section	.rodata
	.type	__FUNCTION__.13304, @object
	.size	__FUNCTION__.13304, 20
__FUNCTION__.13304:
	.string	"alloc_aux_for_edges"
	.local	initialized.13303
	.comm	initialized.13303,4,4
	.text
...
.LCFI111:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 804 0
	movl	initialized.13303@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L305
	.loc 1 806 0
	leal	edge_aux_obstack@GOTOFF(%ebx), %eax
	...
	call	gcc_obstack_init@PLT
	.loc 1 807 0
	movl	$1, initialized.13303@GOTOFF(%ebx)
	jmp	.L307
.L305:
	.loc 1 811 0
	movl	first_edge_aux_obj@GOTOFF(%ebx), %eax
	...
	je	.L307
	.loc 1 812 0
	leal	__FUNCTION__.13304@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$812, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE41:
	...
	.section	.rodata
	.type	__FUNCTION__.13379, @object
	.size	__FUNCTION__.13379, 19
__FUNCTION__.13379:
...
.LCFI118:
	...
	jne	.L332
	.loc 1 851 0
	leal	__FUNCTION__.13379@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$851, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
