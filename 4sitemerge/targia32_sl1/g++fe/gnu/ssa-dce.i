...
# 77 "../../../kg++fe/gnu/ssa-dce.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 78 "../../../kg++fe/gnu/ssa-dce.c" 2
     ...
     int edge_index;
{
  if (bb->index - ((-3)+1) >= c->length)
    fancy_abort ("../../../kg++fe/gnu/ssa-dce.c", 185, __FUNCTION__);

  bitmap_set_bit (c->data[bb->index - ((-3)+1)],
    edge_index);
}
# 203 "../../../kg++fe/gnu/ssa-dce.c"
static void
   ...
   control_dependent_block_to_edge_map cdbte;
{
  ...
  if (((el)->index_to_edge[(edge_index)]->src) == (&entry_exit_blocks[1]))
    fancy_abort ("../../../kg++fe/gnu/ssa-dce.c", 247, __FUNCTION__);
  ending_block =
...
{
  if (!block)
    fancy_abort ("../../../kg++fe/gnu/ssa-dce.c", 273, __FUNCTION__);
  if (block->index == (-3))
    fancy_abort ("../../../kg++fe/gnu/ssa-dce.c", 275, __FUNCTION__);
     ...
     rtx x;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ssa-dce.c", 404, __FUNCTION__);
 break;
      }
}
...
{
  if (!insn)
    fancy_abort ("../../../kg++fe/gnu/ssa-dce.c", 478, __FUNCTION__);
...
# 710 "../../../kg++fe/gnu/ssa-dce.c"
      ...
      if (bb->succ == ((void *)0))
 {
  ...
  if (((unprocessed_instructions)->elements_used) != 0)
    fancy_abort ("../../../kg++fe/gnu/ssa-dce.c", 729, __FUNCTION__);
