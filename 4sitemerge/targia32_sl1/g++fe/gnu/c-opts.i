     ...
     const char *arg;
{
 ...
 xmalloc (deferred_size * sizeof (struct deferred_opt));
  ...
  if (deferred_count == deferred_size)
    fancy_abort ("../../../kg++fe/gnu/c-opts.c", 484, __FUNCTION__);
...
handle_deferred_opts ()
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/c-opts.c", 1559, __FUNCTION__);
 }
    }
