...
# 36 "../../../kg++fe/gnu/tree-inline.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 37 "../../../kg++fe/gnu/tree-inline.c" 2
...
# 42 "../../../kg++fe/gnu/tree-inline.c" 2




# 1 "../../../kg++fe/gnu/c-common.h" 1
# 30 "../../../kg++fe/gnu/c-common.h"
...
# 47 "../../../kg++fe/gnu/tree-inline.c" 2
# 57 "../../../kg++fe/gnu/tree-inline.c"
int flag_inline_trees = 0;
# 73 "../../../kg++fe/gnu/tree-inline.c"
   ...
   && (*lang_hooks.tree_inlining.anon_aggr_type_p) (((t)->common.type)))
 {
   ...
   for (src = (((t))->decl.arguments); src;
        src = ((src)->common.chain))
     {
       ...
       if (((src)->list.purpose))
  fancy_abort ("../../../kg++fe/gnu/tree-inline.c", 199, __FUNCTION__);
      ...
      else
 {
   ...
   *first_block = new_block;
  ...
  else if ((!(((((scope_stmt)))->common.lang_flag_0))) && ((((scope_stmt))->exp.operands[0])))
    {
      ...
      if (! n)
 fancy_abort ("../../../kg++fe/gnu/tree-inline.c", 324, __FUNCTION__);
      ((((scope_stmt))->exp.operands[0])) = (tree) n->value;
    }
# 390 "../../../kg++fe/gnu/tree-inline.c"
}
 ...
 *tp = goto_stmt;
  ...
  else if ((*lang_hooks.tree_inlining.auto_var_in_fn_p) (*tp, fn))
    {
      ...
      if (! new_decl)
 fancy_abort ("../../../kg++fe/gnu/tree-inline.c", 504, __FUNCTION__);
    ...
    fancy_abort ("../../../kg++fe/gnu/tree-inline.c", 519, __FUNCTION__);



  else if (((enum tree_code) (*tp)->common.code) == SCOPE_STMT && !id->in_target_cleanup_p)
    copy_scope_stmt (tp, walk_subtrees, id);
# 551 "../../../kg++fe/gnu/tree-inline.c"
  else
    {
      copy_tree_r (tp, walk_subtrees, ((void *)0));
...
# 1254 "../../../kg++fe/gnu/tree-inline.c"
 ...
 do { if ((id->inlined_fns)->elements_used >= (id->inlined_fns)->num_elements) (((id->inlined_fns)) = varray_grow ((id->inlined_fns), 2 * (id->inlined_fns)->num_elements)); (id->inlined_fns)->data.tree[(id->inlined_fns)->elements_used++] = (fn); } while (0);
  ...
  if (! ((fn)->decl.initial)
    ...
    fancy_abort ("../../../kg++fe/gnu/tree-inline.c", 1276, __FUNCTION__);
  ...
  (((stmt))->exp.operands[0])
    = chainon ((((stmt))->exp.operands[0]),
        declare_return_variable (id, &use_stmt));
# 1315 "../../../kg++fe/gnu/tree-inline.c"
  inlined_body = &(((stmt))->exp.operands[0]);
  while (*inlined_body)
    inlined_body = &((*inlined_body)->common.chain);
  *inlined_body = copy_body (id);
# 1336 "../../../kg++fe/gnu/tree-inline.c"
  (((stmt))->exp.operands[0])
    = chainon ((((stmt))->exp.operands[0]),
        build_stmt (LABEL_STMT, id->ret_label));
# 1351 "../../../kg++fe/gnu/tree-inline.c"
...
# 1563 "../../../kg++fe/gnu/tree-inline.c"
 ...
 do { result = walk_tree (&(((*tp)->exp.operands[i])), func, data, htab); if (result) return result; } while (0);
      ...
      if (((*tp)->common.type) && ((*tp)->common.type) != ERROR_MARK
          && code == NOP_EXPR)
   ...
   do { tp = & (((*tp)->common.chain)); goto tail_recurse; } while (0);
  ...
  else if (tree_code_type[(int) (code)] == 't')
    {
      ...
      if ((code == POINTER_TYPE || code == REFERENCE_TYPE
           || code == ARRAY_TYPE)
          && variably_modified_type_p (((*tp)->common.type)))
        do { result = walk_tree (&(((*tp)->common.type)), func, data, htab); if (result) return result; } while (0);
      if (code == ARRAY_TYPE
          && ((*tp)->type.values))
        do { result = walk_tree (&(((((*tp)->type.values))->type.maxval)), func, data, htab); if (result) return result; } while (0);
 ...
 for (; arg; arg = ((arg)->common.chain))
   do { result = walk_tree (&(((arg)->list.value)), func, data, htab); if (result) return result; } while (0);
    ...
    case OFFSET_TYPE:
      do { result = walk_tree (&(((*tp)->common.type)), func, data, htab); if (result) return result; } while (0);
      do { tp = & (((*tp)->type.maxval)); goto tail_recurse; } while (0);
# 1787 "../../../kg++fe/gnu/tree-inline.c"
    default:
      fancy_abort ("../../../kg++fe/gnu/tree-inline.c", 1788, __FUNCTION__);
    }
