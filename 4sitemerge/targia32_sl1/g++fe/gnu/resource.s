...
.LBB3:
	...
	jbe	.L80
	.loc 1 244 0
	leal	__FUNCTION__.10489@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$244, 4(%esp)
...
.LBB27:
	...
	jbe	.L243
	.loc 1 792 0
	leal	__FUNCTION__.11102@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$792, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
