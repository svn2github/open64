...
{
  if (pending_sizes)
    fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 151, __FUNCTION__);
     ...
     enum mode_class class;
{
  ...
  fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 274, __FUNCTION__);
}
     ...
     enum machine_mode mode;
{
 ...
 break;
    ...
    case MODE_CC:
    default:
      fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 305, __FUNCTION__);
    }
     ...
     unsigned int known_align;
{
  ...
  if (code == CONST_DECL)
    ...
    fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 385, __FUNCTION__);
...
# 1591 "../../../kg++fe/gnu/stor-layout.c"
void
layout_type (type)
     tree type;
{
  if (type == 0)
    fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 1596, __FUNCTION__);
  ...
  switch (((enum tree_code) (type)->common.code))
    ...
    case LANG_TYPE:
      ...
      fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 1607, __FUNCTION__);
...
# 1776 "../../../kg++fe/gnu/stor-layout.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 1843, __FUNCTION__);
      else
 {
   ...
   ((type)->type.precision) = size_in_bits;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 1879, __FUNCTION__);
    }
     ...
     tree type;
{
  ...
  if (sizetype_set)
    fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 1983, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/stor-layout.c", 2033, __FUNCTION__);
...
# 1 "../../../kg++fe/gnu/MIPS/gt-stor-layout.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-stor-layout.h"
...
# 2183 "../../../kg++fe/gnu/stor-layout.c" 2
