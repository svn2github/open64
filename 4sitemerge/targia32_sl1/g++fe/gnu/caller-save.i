...
# 29 "../../../kg++fe/gnu/caller-save.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 30 "../../../kg++fe/gnu/caller-save.c" 2
...
# 40 "../../../kg++fe/gnu/caller-save.c" 2


# 1 "../../../kg++fe/gnu/defaults.h" 1
# 43 "../../../kg++fe/gnu/caller-save.c" 2
# 60 "../../../kg++fe/gnu/caller-save.c"
...
# 164 "../../../kg++fe/gnu/caller-save.c"
  ...
  if (i == 176)
    fancy_abort ("../../../kg++fe/gnu/caller-save.c", 171, __FUNCTION__);
...
save_call_clobbered_regs ()
{
 ...
 fancy_abort ("../../../kg++fe/gnu/caller-save.c", 392, __FUNCTION__);
     ...
     enum machine_mode *save_mode;
{
  ...
  rtx mem;
# 669 "../../../kg++fe/gnu/caller-save.c"
  if (regno_save_mem[regno][1] == 0)
    fancy_abort ("../../../kg++fe/gnu/caller-save.c", 670, __FUNCTION__);
     ...
     enum machine_mode *save_mode;
{
  ...
  struct insn_chain *new;
  rtx mem;
# 746 "../../../kg++fe/gnu/caller-save.c"
  if (regno_save_mem[regno][1] == 0)
    fancy_abort ("../../../kg++fe/gnu/caller-save.c", 747, __FUNCTION__);
...
# 821 "../../../kg++fe/gnu/caller-save.c"
      ...
      for (link = (((chain->insn)->fld[8]).rtx); link; link = (((link)->fld[1]).rtx))
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/caller-save.c", 847, __FUNCTION__);
