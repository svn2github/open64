     ...
     rtx insn;
{
  switch (((enum rtx_code) (insn)->code))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/cfgbuild.c", 100, __FUNCTION__);
    }
}
     ...
     rtx insn;
{
  ...
  switch (((enum rtx_code) (insn)->code))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/cfgbuild.c", 143, __FUNCTION__);
    }
}
     ...
     int flags;
{
  if (((enum rtx_code) (label)->code) != CODE_LABEL)
    fancy_abort ("../../../kg++fe/gnu/cfgbuild.c", 248, __FUNCTION__);
     ...
     int update_p;
{
      ...
      if (code == JUMP_INSN)
 {
  ...
  make_label_edge (edge_cache, bb, (((x)->fld[0]).rtx), 2);
     ...
     {
       if (! (((insn)->fld[9]).rtx))
  fancy_abort ("../../../kg++fe/gnu/cfgbuild.c", 412, __FUNCTION__);
     ...
     rtx f;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/cfgbuild.c", 563, __FUNCTION__);
 }

      if (((enum rtx_code) (insn)->code) == INSN || ((enum rtx_code) (insn)->code) == CALL_INSN)
 {
   rtx note;
# 578 "../../../kg++fe/gnu/cfgbuild.c"
   for (note = (((insn)->fld[8]).rtx); note; note = (((note)->fld[1]).rtx))
     if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_LABEL)
       {
  rtx lab = (((note)->fld[0]).rtx), next;
  ...
  if (last_basic_block != n_basic_blocks)
    fancy_abort ("../../../kg++fe/gnu/cfgbuild.c", 605, __FUNCTION__);
