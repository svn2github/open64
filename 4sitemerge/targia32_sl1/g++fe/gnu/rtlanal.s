...
.LFE35:
	...
	.size	__FUNCTION__.11084, 17
__FUNCTION__.11084:
	.string	"insn_dependent_p"
.LC0:
	.string	"../../../kg++fe/gnu/rtlanal.c"
	.text
...
.L517:
	.loc 1 1072 0
	leal	__FUNCTION__.11084@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1072, 4(%esp)
...
.LFE49:
	...
	.section	.rodata
	.type	__FUNCTION__.11881, @object
	.size	__FUNCTION__.11881, 14
__FUNCTION__.11881:
...
.L859:
	...
	je	.L862
	.loc 1 1764 0
	leal	__FUNCTION__.11881@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1764, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE54:
	...
	.section	.rodata
	.type	__FUNCTION__.12173, @object
	.size	__FUNCTION__.12173, 16
__FUNCTION__.12173:
...
.L981:
	...
	jne	.L984
	.loc 1 1948 0
	leal	__FUNCTION__.12173@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1948, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE57:
	...
	.section	.rodata
	.type	__FUNCTION__.12286, @object
	.size	__FUNCTION__.12286, 12
__FUNCTION__.12286:
	.string	"remove_note"
	.text
.globl remove_note
...
.L1034:
	...
	jne	.L1035
	.loc 1 2066 0
	leal	__FUNCTION__.12286@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2066, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE65:
	...
	.section	.rodata
	.type	__FUNCTION__.12915, @object
	.size	__FUNCTION__.12915, 12
__FUNCTION__.12915:
	.string	"replace_rtx"
	.text
.globl replace_rtx
...
.LBB36:
	...
	jne	.L1251
	.loc 1 2558 0
	leal	__FUNCTION__.12915@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2558, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE78:
	...
	.section	.rodata
	.type	__FUNCTION__.13782, @object
	.size	__FUNCTION__.13782, 30
__FUNCTION__.13782:
...
.LCFI257:
	...
	jbe	.L1519
	.loc 1 3185 0
	leal	__FUNCTION__.13782@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3185, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE84:
	...
	.section	.rodata
	.type	__FUNCTION__.14178, @object
	.size	__FUNCTION__.14178, 17
__FUNCTION__.14178:
...
.L1661:
	.loc 1 3485 0
	leal	__FUNCTION__.14178@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3485, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE85:
	...
	.section	.rodata
	.type	__FUNCTION__.14241, @object
	.size	__FUNCTION__.14241, 19
__FUNCTION__.14241:
...
.L1691:
	...
	je	.L1693
	.loc 1 3519 0
	leal	__FUNCTION__.14241@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3519, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L1711:
	.loc 1 3589 0
	leal	__FUNCTION__.14311@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3589, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
