...
# 156 "../../../kg++fe/gnu/gcse.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 157 "../../../kg++fe/gnu/gcse.c" 2
...
# 168 "../../../kg++fe/gnu/gcse.c" 2
# 279 "../../../kg++fe/gnu/gcse.c"
static FILE *gcse_file;
# 288 "../../../kg++fe/gnu/gcse.c"
     ...
     int *do_not_record_p;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 1768, __FUNCTION__);
    }

  return hash;
}
# 1781 "../../../kg++fe/gnu/gcse.c"
static unsigned int
     ...
     rtx x, y;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/gcse.c", 1928, __FUNCTION__);
 }
    }

  return 1;
}
# 1945 "../../../kg++fe/gnu/gcse.c"
static void
     ...
     struct hash_table *table;
{
  ...
  if (((enum rtx_code) (x)->code) != SET
    ...
    fancy_abort ("../../../kg++fe/gnu/gcse.c", 2087, __FUNCTION__);
     ...
     rtx insn;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 3317, __FUNCTION__);
     ...
     rtx insn, def_insn;
{
      ...
      if ((uid_cuid[(((def_insn)->fld[0]).rtint)]) < (uid_cuid[(((insn)->fld[0]).rtint)]))
 {
   if (((enum rtx_code) ((((def_insn)->fld[5]).rtx))->code) == PARALLEL)
     ...
     fancy_abort ("../../../kg++fe/gnu/gcse.c", 3346, __FUNCTION__);
     ...
     struct expr *expr;
{
  ...
  if (!expr_set)
    fancy_abort ("../../../kg++fe/gnu/gcse.c", 3429, __FUNCTION__);
 ...
 = ((((((expr_set)->fld[0]).rtx))->fld[0]).rtuint);
      ...
      if (regnum_for_replacing >= max_gcse_regno)
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 3465, __FUNCTION__);
...
# 3860 "../../../kg++fe/gnu/gcse.c"
static struct reg_use reg_use_table[8];


static int reg_use_count;
# 3872 "../../../kg++fe/gnu/gcse.c"
static void
...
# 4002 "../../../kg++fe/gnu/gcse.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 4022, __FUNCTION__);

      src = (((set->expr)->fld[1]).rtx);
# 4033 "../../../kg++fe/gnu/gcse.c"
     ...
     int alter_jumps;
{
 ...
 continue;
      ...
      if (((enum rtx_code) (pat)->code) != SET)
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 4220, __FUNCTION__);
     ...
     rtx *libcall_sp;
{
      ...
      if (newcnst && constprop_register (insn, x, newcnst, alter_jumps))
 {
   ...
   if (!adjust_libcall_notes (x, newcnst, insn, libcall_sp))
     fancy_abort ("../../../kg++fe/gnu/gcse.c", 4366, __FUNCTION__);
   if (gcse_file != ((void *)0))
     {
     ...
     int alter_jumps;
{
      ...
      if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/gcse.c", 4458, __FUNCTION__);
     ...
     int bb;
{
 ...
 break;
      ...
      if (((enum rtx_code) (set->expr)->code) != SET)
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 4618, __FUNCTION__);
     ...
     struct expr *expr;
{
  ...
  if (general_operand (exp, ((enum machine_mode) (reg)->mode)))
    ...
    fancy_abort ("../../../kg++fe/gnu/gcse.c", 5077, __FUNCTION__);
     ...
     int pre;
{
  ...
  if (pat == (rtx) 0 || ! ((rtx_class[(int) (((enum rtx_code) (pat)->code))]) == 'i'))
    fancy_abort ("../../../kg++fe/gnu/gcse.c", 5107, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 5130, __FUNCTION__);
...
# 5155 "../../../kg++fe/gnu/gcse.c"
    ...
    && (bb->succ->succ_next || (bb->succ->flags & 2)))
    {
# 5172 "../../../kg++fe/gnu/gcse.c"
      if (pre
   && !((antloc[bb->index])->elms [(expr->bitmap_index) / ((unsigned) (8 * 8))] >> (expr->bitmap_index) % ((unsigned) (8 * 8)) & 1)
   && !((transp[bb->index])->elms [(expr->bitmap_index) / ((unsigned) (8 * 8))] >> (expr->bitmap_index) % ((unsigned) (8 * 8)) & 1))
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 5175, __FUNCTION__);




      insn = find_first_parameter_load (insn, bb->head);
# 5190 "../../../kg++fe/gnu/gcse.c"
     ...
     rtx insn;
{
  ...
  if (!set)
    fancy_abort ("../../../kg++fe/gnu/gcse.c", 5321, __FUNCTION__);
...
pre_delete ()
{
 ...
 for (occr = expr->antic_occr; occr != ((void *)0); occr = occr->next)
  ...
  if (! set)
    fancy_abort ("../../../kg++fe/gnu/gcse.c", 5461, __FUNCTION__);
      ...
      for (i = 0; i < hoist_exprs[bb->index]->n_bits; i++)
 {
       ...
       for (j = 0; j < domby_len; j++)
  {
   ...
   occr = occr->next;
        ...
        if (!occr)
   fancy_abort ("../../../kg++fe/gnu/gcse.c", 6295, __FUNCTION__);

        insn = occr->insn;

        set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0);
        if (! set)
   fancy_abort ("../../../kg++fe/gnu/gcse.c", 6301, __FUNCTION__);
  ...
  for (tmp = e->dest->pred; tmp ; tmp = tmp->pred_next)
    {
      ...
      if (index == -1)
 fancy_abort ("../../../kg++fe/gnu/gcse.c", 7297, __FUNCTION__);
...
# 1 "../../../kg++fe/gnu/MIPS/gt-gcse.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-gcse.h"
