...
# 25 "../../../kg++fe/gnu/ra-build.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 26 "../../../kg++fe/gnu/ra-build.c" 2
...
# 36 "../../../kg++fe/gnu/ra-build.c" 2
# 67 "../../../kg++fe/gnu/ra-build.c"
struct curr_use;
     ...
     rtx *target;
{
  ...
  if (!((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 236, __FUNCTION__);
     ...
     rtx insn;
{
      ...
      if (copy_insn_p (insn, &s, &d))
 {
   ...
   if (!link || !link->ref || !slink || !slink->ref)
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 570, __FUNCTION__);
   ...
   if (link->next
     ...
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 577, __FUNCTION__);
 }
      else
 fancy_abort ("../../../kg++fe/gnu/ra-build.c", 580, __FUNCTION__);
     ...
     struct curr_use *use;
{
...

 {
   ...
   return (old_u != use->undefined) ? 4 : -1;
      ...
      default:
        fancy_abort ("../../../kg++fe/gnu/ra-build.c", 693, __FUNCTION__);
    }
}
# 712 "../../../kg++fe/gnu/ra-build.c"
static int
...
# 818 "../../../kg++fe/gnu/ra-build.c"
  {
    undef &= ~ rtx_to_undefined (s);
  }
       if (undef)
  {
# 835 "../../../kg++fe/gnu/ra-build.c"
    do
      bitmap_set_bit (undef_to_bitmap (wp, &undef),
        ((ref)->id));
    while (undef);
      ...
      else
 {
   ...
   if (uid >= death_insns_max_uid)
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 849, __FUNCTION__);
     ...
     rtx reg;
{
  if (((enum rtx_code) (reg)->code) != REG)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1250, __FUNCTION__);
...
# 1273 "../../../kg++fe/gnu/ra-build.c"
 ...
 mips_class_max_nregs (web->regclass, ((enum machine_mode) ((cfun->emit->x_regno_reg_rtx)[web->regno])->mode)) - 1;
      ...
      if (!web->num_freedom)
 fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1317, __FUNCTION__);
    }
     ...
     rtx reg;
{
  ...
  web->alias = ((void *)0);
  if (web->moves)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1372, __FUNCTION__);
  if (!web->useless_conflicts)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1374, __FUNCTION__);
}
     ...
     rtx reg;
{
  ...
  if (((enum rtx_code) (reg)->code) != SUBREG)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1387, __FUNCTION__);
...
# 1421 "../../../kg++fe/gnu/ra-build.c"
  ...
  if (mode == BLKmode)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1428, __FUNCTION__);
     ...
     struct df *df;
{
      ...
      if (df->defs[no])
 {
   if (no < last_def_id && web_parts[no].ref != df->defs[no])
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1449, __FUNCTION__);
      ...
      if (df->uses[no])
 {
   if (no < last_use_id
     ...
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1468, __FUNCTION__);
   web_parts[no + df->def_id].ref = df->uses[no];
     ...
     struct web *web;
{
  ...
  if (web->orig_conflict_list || web->have_orig_conflicts)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1518, __FUNCTION__);
     ...
     struct web *web1, *web2;
{
  ...
  if (web1 == web2 || ((igraph)->elms [(index) / ((unsigned) (8 * 8))] >> (index) % ((unsigned) (8 * 8)) & 1))
    return;
  if (id1 == id2)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1628, __FUNCTION__);
     ...
     struct web_link **link;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1734, __FUNCTION__);
      if (web1->type != PRECOLORED)
 {
   unsigned int i;
   for (i = 0; i < web1->num_defs; i++)
     if (web1->defs[i] != web2->defs[i])
       fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1740, __FUNCTION__);
   for (i = 0; i < web1->num_uses; i++)
     if (web1->uses[i] != web2->uses[i])
       fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1743, __FUNCTION__);
 }
      if (web1->type == PRECOLORED)
 {
   if (web1->defs)
...
init_webs_defs_uses ()
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1791, __FUNCTION__);
    }
}
     ...
     struct df_link *all_refs;
{
      ...
      if (! wp->uplink)
 {
  ...
  init_one_web (web, ((enum rtx_code) (reg)->code) == SUBREG
   ...
   if (web->regno < 176 && !hardreg2web[web->regno])
     ...
     && hardreg2web[web->regno] != web)
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1897, __FUNCTION__);
 }
      ...
      if (def2web[i] != ((void *)0))
 {
   ...
   if (!web->old_web || web->type == PRECOLORED)
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1918, __FUNCTION__);
   continue;
 }
      ...
      if (wp->uplink)
 {
   ...
   web = (((web)->parent_web) ? find_web_for_subweb_1 ((web)->parent_web) : (web));
      ...
      if (web->old_web && web->type != PRECOLORED)
 fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1941, __FUNCTION__);
   ...
   if (!subweb)
     {
       ...
       if (web->old_web)
  fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1951, __FUNCTION__);
     }
 }
      else
 subweb = web;
      ...
      if (i < def_id)
 {
       ...
       if (i < last_def_id)
  {
    if (web->old_web && compare != subweb)
      fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1972, __FUNCTION__);
  }
       if (!web->old_web && compare)
  fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1975, __FUNCTION__);
       if (compare && compare != subweb)
  fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1977, __FUNCTION__);
     }
   def2web[i] = subweb;
   web->num_defs++;
 }
      else
 {
  ...
  {
    if (web->old_web && compare != subweb)
      fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1990, __FUNCTION__);
  }
       if (!web->old_web && compare)
  fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1993, __FUNCTION__);
       if (compare && compare != subweb)
  fancy_abort ("../../../kg++fe/gnu/ra-build.c", 1995, __FUNCTION__);
     }
  ...
  if (webnum != num_webs)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 2006, __FUNCTION__);
...
# 2049 "../../../kg++fe/gnu/ra-build.c"
 ...
 {
   if (wp->sub_conflicts)
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 2057, __FUNCTION__);
   continue;
 }
      web = def2web[i];
      web = (((web)->parent_web) ? find_web_for_subweb_1 ((web)->parent_web) : (web));
...
reset_conflicts ()
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ra-build.c", 2143, __FUNCTION__);
      ...
      if (web->type != PRECOLORED && !web->old_web)
 {
   *pcl = ((void *)0);
   ...
   if (bitmap_first_set_bit (web->useless_conflicts) >= 0)
     fancy_abort ("../../../kg++fe/gnu/ra-build.c", 2153, __FUNCTION__);
 }
      else
 {
...
# 2352 "../../../kg++fe/gnu/ra-build.c"
  ...
  web->num_freedom = hard_regs_count (web->usable_regs);
  if (!web->num_freedom)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 2371, __FUNCTION__);
  do { HARD_REG_ELT_TYPE *scan_tp_ = (web->orig_usable_regs), *scan_fp_ = (web->usable_regs); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);
      ...
      if (found_size < size)
 {
  ...
  web->num_freedom -= web->add_hardregs;
  if (!web->num_freedom)
    fancy_abort ("../../../kg++fe/gnu/ra-build.c", 2400, __FUNCTION__);
  adjust -= 0 * web->add_hardregs;
   ...
   if (!link || !link->ref)
     {
       if (in_output)
         ...
         fancy_abort ("../../../kg++fe/gnu/ra-build.c", 2919, __FUNCTION__);
     }
   else
     break;
 }
  ...
  for (i = 0; i < num_webs; i++)
    {
      struct web *web = id2web[i];
      if (!web)
 fancy_abort ("../../../kg++fe/gnu/ra-build.c", 3192, __FUNCTION__);
      if (i >= num_webs - num_subwebs
   && (web->conflict_list || web->orig_conflict_list))
 fancy_abort ("../../../kg++fe/gnu/ra-build.c", 3195, __FUNCTION__);
      web->moves = ((void *)0);
    }
...
# 1 "../../../kg++fe/gnu/MIPS/gt-ra-build.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-ra-build.h"
