...
# 35 "../../../kg++fe/gnu/cp/lex.c" 2
# 1 "../../../kg++fe/gnu/cpplib.h" 1
# 36 "../../../kg++fe/gnu/cp/lex.c" 2
...
_Bool pragma_implementation_seen = 0, pragma_interface_seen = 0;
# 138 "../../../kg++fe/gnu/cp/lex.c"
tree
make_pointer_declarator (cv_qualifiers, target)
     tree cv_qualifiers, target;
{
  if (target && ((enum tree_code) (target)->common.code) == IDENTIFIER_NODE
      && (((char *)(target)->identifier.id.str)[0] == '.' && ((char *)(target)->identifier.id.str)[1] == '_'))
    error ("type name expected before `*'");
  target = build_nt (INDIRECT_REF, target);
  ((target)->common.type) = cv_qualifiers;
  return target;
}
# 158 "../../../kg++fe/gnu/cp/lex.c"
tree
     ...
     tree cv_qualifiers, target;
{
  if (target)
    {
      if (((enum tree_code) (target)->common.code) == ADDR_EXPR)
 {
   error ("cannot declare references to references");
   return target;
 }
      if (((enum tree_code) (target)->common.code) == INDIRECT_REF)
 {
   error ("cannot declare pointers to references");
   return target;
 }
      if (((enum tree_code) (target)->common.code) == IDENTIFIER_NODE && (((char *)(target)->identifier.id.str)[0] == '.' && ((char *)(target)->identifier.id.str)[1] == '_'))
   error ("type name expected before `&'");
    }
     ...
     tree target, parms, cv_qualifiers, exception_specification;
{
  target = build_nt (CALL_EXPR, target,
       tree_cons (parms, cv_qualifiers, (tree) ((void *)0)),


       (tree) ((void *)0));
  (((target)->common.type)) = exception_specification;
  return target;
}
...
{
  (((((call_declarator)->exp.operands[1]))->list.value)) = cv_qualifiers;
  (((call_declarator)->common.type)) = exception_specification;
}
...
cxx_init_options ()
{
  ...
  (&(global_dc)->buffer)->state.ideal_maximum_length = 80;
...
extern int constraint_NEW_EXPR [(sizeof "operator " + sizeof "new" <= 256) ? 1 : -1];
extern int constraint_VEC_NEW_EXPR [(sizeof "operator " + sizeof "new []" <= 256) ? 1 : -1];
extern int constraint_DELETE_EXPR [(sizeof "operator " + sizeof "delete" <= 256) ? 1 : -1];
extern int constraint_VEC_DELETE_EXPR [(sizeof "operator " + sizeof "delete []" <= 256) ? 1 : -1];


extern int constraint_CONVERT_EXPR [(sizeof "operator " + sizeof "+" <= 256) ? 1 : -1];
extern int constraint_NEGATE_EXPR [(sizeof "operator " + sizeof "-" <= 256) ? 1 : -1];
extern int constraint_ADDR_EXPR [(sizeof "operator " + sizeof "&" <= 256) ? 1 : -1];
extern int constraint_INDIRECT_REF [(sizeof "operator " + sizeof "*" <= 256) ? 1 : -1];
extern int constraint_BIT_NOT_EXPR [(sizeof "operator " + sizeof "~" <= 256) ? 1 : -1];
extern int constraint_TRUTH_NOT_EXPR [(sizeof "operator " + sizeof "!" <= 256) ? 1 : -1];
extern int constraint_PREINCREMENT_EXPR [(sizeof "operator " + sizeof "++" <= 256) ? 1 : -1];
extern int constraint_PREDECREMENT_EXPR [(sizeof "operator " + sizeof "--" <= 256) ? 1 : -1];
extern int constraint_SIZEOF_EXPR [(sizeof "operator " + sizeof "sizeof" <= 256) ? 1 : -1];

extern int constraint_ALIGNOF_EXPR [(sizeof "operator " + sizeof "alignof" <= 256) ? 1 : -1];


extern int constraint_TYPE_EXPR [(sizeof "operator " + sizeof "" <= 256) ? 1 : -1];
extern int constraint_CAST_EXPR [(sizeof "operator " + sizeof "" <= 256) ? 1 : -1];
extern int constraint_CONST_CAST_EXPR [(sizeof "operator " + sizeof "" <= 256) ? 1 : -1];
extern int constraint_STATIC_CAST_EXPR [(sizeof "operator " + sizeof "" <= 256) ? 1 : -1];


extern int constraint_PLUS_EXPR [(sizeof "operator " + sizeof "+" <= 256) ? 1 : -1];
extern int constraint_MINUS_EXPR [(sizeof "operator " + sizeof "-" <= 256) ? 1 : -1];
extern int constraint_MULT_EXPR [(sizeof "operator " + sizeof "*" <= 256) ? 1 : -1];
extern int constraint_TRUNC_DIV_EXPR [(sizeof "operator " + sizeof "/" <= 256) ? 1 : -1];
extern int constraint_TRUNC_MOD_EXPR [(sizeof "operator " + sizeof "%" <= 256) ? 1 : -1];
extern int constraint_BIT_AND_EXPR [(sizeof "operator " + sizeof "&" <= 256) ? 1 : -1];
extern int constraint_BIT_IOR_EXPR [(sizeof "operator " + sizeof "|" <= 256) ? 1 : -1];
extern int constraint_BIT_XOR_EXPR [(sizeof "operator " + sizeof "^" <= 256) ? 1 : -1];
extern int constraint_LSHIFT_EXPR [(sizeof "operator " + sizeof "<<" <= 256) ? 1 : -1];
extern int constraint_RSHIFT_EXPR [(sizeof "operator " + sizeof ">>" <= 256) ? 1 : -1];
extern int constraint_EQ_EXPR [(sizeof "operator " + sizeof "==" <= 256) ? 1 : -1];
extern int constraint_NE_EXPR [(sizeof "operator " + sizeof "!=" <= 256) ? 1 : -1];
extern int constraint_LT_EXPR [(sizeof "operator " + sizeof "<" <= 256) ? 1 : -1];
extern int constraint_GT_EXPR [(sizeof "operator " + sizeof ">" <= 256) ? 1 : -1];
extern int constraint_LE_EXPR [(sizeof "operator " + sizeof "<=" <= 256) ? 1 : -1];
extern int constraint_GE_EXPR [(sizeof "operator " + sizeof ">=" <= 256) ? 1 : -1];
extern int constraint_TRUTH_ANDIF_EXPR [(sizeof "operator " + sizeof "&&" <= 256) ? 1 : -1];
extern int constraint_TRUTH_ORIF_EXPR [(sizeof "operator " + sizeof "||" <= 256) ? 1 : -1];
extern int constraint_COMPOUND_EXPR [(sizeof "operator " + sizeof "," <= 256) ? 1 : -1];
extern int constraint_MEMBER_REF [(sizeof "operator " + sizeof "->*" <= 256) ? 1 : -1];
extern int constraint_COMPONENT_REF [(sizeof "operator " + sizeof "->" <= 256) ? 1 : -1];
extern int constraint_ARRAY_REF [(sizeof "operator " + sizeof "[]" <= 256) ? 1 : -1];
extern int constraint_POSTINCREMENT_EXPR [(sizeof "operator " + sizeof "++" <= 256) ? 1 : -1];
extern int constraint_POSTDECREMENT_EXPR [(sizeof "operator " + sizeof "--" <= 256) ? 1 : -1];

extern int constraint_MIN_EXPR [(sizeof "operator " + sizeof "<?" <= 256) ? 1 : -1];
extern int constraint_MAX_EXPR [(sizeof "operator " + sizeof ">?" <= 256) ? 1 : -1];

extern int constraint_SCOPE_REF [(sizeof "operator " + sizeof "::" <= 256) ? 1 : -1];;


extern int constraint_NOP_EXPR [(sizeof "operator " + sizeof "=" <= 256) ? 1 : -1];
extern int constraint_PLUS_EXPR [(sizeof "operator " + sizeof "+=" <= 256) ? 1 : -1];
extern int constraint_MINUS_EXPR [(sizeof "operator " + sizeof "-=" <= 256) ? 1 : -1];
extern int constraint_MULT_EXPR [(sizeof "operator " + sizeof "*=" <= 256) ? 1 : -1];
extern int constraint_TRUNC_DIV_EXPR [(sizeof "operator " + sizeof "/=" <= 256) ? 1 : -1];
...
extern int constraint_COND_EXPR [(sizeof "operator " + sizeof "?:" <= 256) ? 1 : -1];


extern int constraint_CALL_EXPR [(sizeof "operator " + sizeof "()" <= 256) ? 1 : -1];
# 259 "../../../kg++fe/gnu/cp/lex.c" 2
...
# 281 "../../../kg++fe/gnu/cp/lex.c"
# 1 "../../../kg++fe/gnu/cp/operators.def" 1
# 81 "../../../kg++fe/gnu/cp/operators.def"
sprintf (buffer, (_sch_istable[("new"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "new"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) NEW_EXPR] : &operator_name_info[(int) NEW_EXPR]); oni->identifier = identifier; oni->name = "new"; oni->mangled_name = "nw"; oni->arity = -1;
sprintf (buffer, (_sch_istable[("new []"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "new []"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) VEC_NEW_EXPR] : &operator_name_info[(int) VEC_NEW_EXPR]); oni->identifier = identifier; oni->name = "new []"; oni->mangled_name = "na"; oni->arity = -1;
sprintf (buffer, (_sch_istable[("delete"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "delete"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) DELETE_EXPR] : &operator_name_info[(int) DELETE_EXPR]); oni->identifier = identifier; oni->name = "delete"; oni->mangled_name = "dl"; oni->arity = -1;
sprintf (buffer, (_sch_istable[("delete []"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "delete []"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) VEC_DELETE_EXPR] : &operator_name_info[(int) VEC_DELETE_EXPR]); oni->identifier = identifier; oni->name = "delete []"; oni->mangled_name = "da"; oni->arity = -1;


sprintf (buffer, (_sch_istable[("+"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "+"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) CONVERT_EXPR] : &operator_name_info[(int) CONVERT_EXPR]); oni->identifier = identifier; oni->name = "+"; oni->mangled_name = "ps"; oni->arity = 1;
sprintf (buffer, (_sch_istable[("-"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "-"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) NEGATE_EXPR] : &operator_name_info[(int) NEGATE_EXPR]); oni->identifier = identifier; oni->name = "-"; oni->mangled_name = "ng"; oni->arity = 1;
sprintf (buffer, (_sch_istable[("&"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "&"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) ADDR_EXPR] : &operator_name_info[(int) ADDR_EXPR]); oni->identifier = identifier; oni->name = "&"; oni->mangled_name = "ad"; oni->arity = 1;
sprintf (buffer, (_sch_istable[("*"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "*"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) INDIRECT_REF] : &operator_name_info[(int) INDIRECT_REF]); oni->identifier = identifier; oni->name = "*"; oni->mangled_name = "de"; oni->arity = 1;
sprintf (buffer, (_sch_istable[("~"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "~"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) BIT_NOT_EXPR] : &operator_name_info[(int) BIT_NOT_EXPR]); oni->identifier = identifier; oni->name = "~"; oni->mangled_name = "co"; oni->arity = 1;
sprintf (buffer, (_sch_istable[("!"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "!"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) TRUTH_NOT_EXPR] : &operator_name_info[(int) TRUTH_NOT_EXPR]); oni->identifier = identifier; oni->name = "!"; oni->mangled_name = "nt"; oni->arity = 1;
sprintf (buffer, (_sch_istable[("++"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "++"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) PREINCREMENT_EXPR] : &operator_name_info[(int) PREINCREMENT_EXPR]); oni->identifier = identifier; oni->name = "++"; oni->mangled_name = "pp"; oni->arity = 1;
sprintf (buffer, (_sch_istable[("--"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "--"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) PREDECREMENT_EXPR] : &operator_name_info[(int) PREDECREMENT_EXPR]); oni->identifier = identifier; oni->name = "--"; oni->mangled_name = "mm"; oni->arity = 1;
sprintf (buffer, (_sch_istable[("sizeof"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "sizeof"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) SIZEOF_EXPR] : &operator_name_info[(int) SIZEOF_EXPR]); oni->identifier = identifier; oni->name = "sizeof"; oni->mangled_name = "sz"; oni->arity = 1;

sprintf (buffer, (_sch_istable[("alignof"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "alignof"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) ALIGNOF_EXPR] : &operator_name_info[(int) ALIGNOF_EXPR]); oni->identifier = identifier; oni->name = "alignof"; oni->mangled_name = "v17alignof"; oni->arity = 1;


sprintf (buffer, (_sch_istable[(""[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ""); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) TYPE_EXPR] : &operator_name_info[(int) TYPE_EXPR]); oni->identifier = identifier; oni->name = ""; oni->mangled_name = "cv"; oni->arity = 1;
sprintf (buffer, (_sch_istable[(""[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ""); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) CAST_EXPR] : &operator_name_info[(int) CAST_EXPR]); oni->identifier = identifier; oni->name = ""; oni->mangled_name = "cv"; oni->arity = 1;
sprintf (buffer, (_sch_istable[(""[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ""); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) CONST_CAST_EXPR] : &operator_name_info[(int) CONST_CAST_EXPR]); oni->identifier = identifier; oni->name = ""; oni->mangled_name = "cv"; oni->arity = 1;
sprintf (buffer, (_sch_istable[(""[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ""); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) STATIC_CAST_EXPR] : &operator_name_info[(int) STATIC_CAST_EXPR]); oni->identifier = identifier; oni->name = ""; oni->mangled_name = "cv"; oni->arity = 1;


sprintf (buffer, (_sch_istable[("+"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "+"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) PLUS_EXPR] : &operator_name_info[(int) PLUS_EXPR]); oni->identifier = identifier; oni->name = "+"; oni->mangled_name = "pl"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("-"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "-"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) MINUS_EXPR] : &operator_name_info[(int) MINUS_EXPR]); oni->identifier = identifier; oni->name = "-"; oni->mangled_name = "mi"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("*"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "*"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) MULT_EXPR] : &operator_name_info[(int) MULT_EXPR]); oni->identifier = identifier; oni->name = "*"; oni->mangled_name = "ml"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("/"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "/"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) TRUNC_DIV_EXPR] : &operator_name_info[(int) TRUNC_DIV_EXPR]); oni->identifier = identifier; oni->name = "/"; oni->mangled_name = "dv"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("%"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "%"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) TRUNC_MOD_EXPR] : &operator_name_info[(int) TRUNC_MOD_EXPR]); oni->identifier = identifier; oni->name = "%"; oni->mangled_name = "rm"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("&"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "&"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) BIT_AND_EXPR] : &operator_name_info[(int) BIT_AND_EXPR]); oni->identifier = identifier; oni->name = "&"; oni->mangled_name = "an"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("|"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "|"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) BIT_IOR_EXPR] : &operator_name_info[(int) BIT_IOR_EXPR]); oni->identifier = identifier; oni->name = "|"; oni->mangled_name = "or"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("^"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "^"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) BIT_XOR_EXPR] : &operator_name_info[(int) BIT_XOR_EXPR]); oni->identifier = identifier; oni->name = "^"; oni->mangled_name = "eo"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("<<"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "<<"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) LSHIFT_EXPR] : &operator_name_info[(int) LSHIFT_EXPR]); oni->identifier = identifier; oni->name = "<<"; oni->mangled_name = "ls"; oni->arity = 2;
sprintf (buffer, (_sch_istable[(">>"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ">>"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) RSHIFT_EXPR] : &operator_name_info[(int) RSHIFT_EXPR]); oni->identifier = identifier; oni->name = ">>"; oni->mangled_name = "rs"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("=="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "=="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) EQ_EXPR] : &operator_name_info[(int) EQ_EXPR]); oni->identifier = identifier; oni->name = "=="; oni->mangled_name = "eq"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("!="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "!="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) NE_EXPR] : &operator_name_info[(int) NE_EXPR]); oni->identifier = identifier; oni->name = "!="; oni->mangled_name = "ne"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("<"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "<"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) LT_EXPR] : &operator_name_info[(int) LT_EXPR]); oni->identifier = identifier; oni->name = "<"; oni->mangled_name = "lt"; oni->arity = 2;
sprintf (buffer, (_sch_istable[(">"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ">"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) GT_EXPR] : &operator_name_info[(int) GT_EXPR]); oni->identifier = identifier; oni->name = ">"; oni->mangled_name = "gt"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("<="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "<="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) LE_EXPR] : &operator_name_info[(int) LE_EXPR]); oni->identifier = identifier; oni->name = "<="; oni->mangled_name = "le"; oni->arity = 2;
sprintf (buffer, (_sch_istable[(">="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ">="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) GE_EXPR] : &operator_name_info[(int) GE_EXPR]); oni->identifier = identifier; oni->name = ">="; oni->mangled_name = "ge"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("&&"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "&&"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) TRUTH_ANDIF_EXPR] : &operator_name_info[(int) TRUTH_ANDIF_EXPR]); oni->identifier = identifier; oni->name = "&&"; oni->mangled_name = "aa"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("||"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "||"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) TRUTH_ORIF_EXPR] : &operator_name_info[(int) TRUTH_ORIF_EXPR]); oni->identifier = identifier; oni->name = "||"; oni->mangled_name = "oo"; oni->arity = 2;
sprintf (buffer, (_sch_istable[(","[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ","); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) COMPOUND_EXPR] : &operator_name_info[(int) COMPOUND_EXPR]); oni->identifier = identifier; oni->name = ","; oni->mangled_name = "cm"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("->*"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "->*"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) MEMBER_REF] : &operator_name_info[(int) MEMBER_REF]); oni->identifier = identifier; oni->name = "->*"; oni->mangled_name = "pm"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("->"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "->"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) COMPONENT_REF] : &operator_name_info[(int) COMPONENT_REF]); oni->identifier = identifier; oni->name = "->"; oni->mangled_name = "pt"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("[]"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "[]"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) ARRAY_REF] : &operator_name_info[(int) ARRAY_REF]); oni->identifier = identifier; oni->name = "[]"; oni->mangled_name = "ix"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("++"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "++"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) POSTINCREMENT_EXPR] : &operator_name_info[(int) POSTINCREMENT_EXPR]); oni->identifier = identifier; oni->name = "++"; oni->mangled_name = "pp"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("--"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "--"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) POSTDECREMENT_EXPR] : &operator_name_info[(int) POSTDECREMENT_EXPR]); oni->identifier = identifier; oni->name = "--"; oni->mangled_name = "mm"; oni->arity = 2;

sprintf (buffer, (_sch_istable[("<?"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "<?"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) MIN_EXPR] : &operator_name_info[(int) MIN_EXPR]); oni->identifier = identifier; oni->name = "<?"; oni->mangled_name = "v23min"; oni->arity = 2;
sprintf (buffer, (_sch_istable[(">?"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", ">?"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) MAX_EXPR] : &operator_name_info[(int) MAX_EXPR]); oni->identifier = identifier; oni->name = ">?"; oni->mangled_name = "v23max"; oni->arity = 2;

sprintf (buffer, (_sch_istable[("::"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "::"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) SCOPE_REF] : &operator_name_info[(int) SCOPE_REF]); oni->identifier = identifier; oni->name = "::"; oni->mangled_name = "sr"; oni->arity = 2;;


sprintf (buffer, (_sch_istable[("="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (1 ? &assignment_operator_name_info[(int) NOP_EXPR] : &operator_name_info[(int) NOP_EXPR]); oni->identifier = identifier; oni->name = "="; oni->mangled_name = "aS"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("+="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "+="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (1 ? &assignment_operator_name_info[(int) PLUS_EXPR] : &operator_name_info[(int) PLUS_EXPR]); oni->identifier = identifier; oni->name = "+="; oni->mangled_name = "pL"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("-="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "-="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (1 ? &assignment_operator_name_info[(int) MINUS_EXPR] : &operator_name_info[(int) MINUS_EXPR]); oni->identifier = identifier; oni->name = "-="; oni->mangled_name = "mI"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("*="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "*="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (1 ? &assignment_operator_name_info[(int) MULT_EXPR] : &operator_name_info[(int) MULT_EXPR]); oni->identifier = identifier; oni->name = "*="; oni->mangled_name = "mL"; oni->arity = 2;
sprintf (buffer, (_sch_istable[("/="[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "/="); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (1 ? &assignment_operator_name_info[(int) TRUNC_DIV_EXPR] : &operator_name_info[(int) TRUNC_DIV_EXPR]); oni->identifier = identifier; oni->name = "/="; oni->mangled_name = "dV"; oni->arity = 2;
...
sprintf (buffer, (_sch_istable[("?:"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "?:"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) COND_EXPR] : &operator_name_info[(int) COND_EXPR]); oni->identifier = identifier; oni->name = "?:"; oni->mangled_name = "qu"; oni->arity = 3;


sprintf (buffer, (_sch_istable[("()"[0]) & 0xff] & (unsigned short)(_sch_isalpha)) ? "operator %s" : "operator%s", "()"); identifier = (__builtin_constant_p (buffer) ? get_identifier_with_length ((buffer), (unsigned) strlen (buffer)) : (get_identifier) (buffer)); ((identifier)->common.lang_flag_2) = 1; oni = (0 ? &assignment_operator_name_info[(int) CALL_EXPR] : &operator_name_info[(int) CALL_EXPR]); oni->identifier = identifier; oni->name = "()"; oni->mangled_name = "cl"; oni->arity = -1;
# 282 "../../../kg++fe/gnu/cp/lex.c" 2


  operator_name_info[(int) ERROR_MARK].identifier
    = (__builtin_constant_p ("<invalid operator>") ? get_identifier_with_length (("<invalid operator>"), (unsigned) strlen ("<invalid operator>")) : (get_identifier) ("<invalid operator>"));
...
struct resword
{
  ...
  const enum rid rid : 16;
  const unsigned int disable : 16;
};
# 343 "../../../kg++fe/gnu/cp/lex.c"
extern int constraint_ridbits_fit [(RID_LAST_MODIFIER < sizeof(unsigned long long) * 8) ? 1 : -1];
...
init_reswords ()
{
  unsigned int i;
  tree id;
  int mask = ((flag_no_asm ? 0x02 : 0)
       | (flag_no_gnu_keywords ? 0x01 : 0));
     ...
     const char *filename;
{
  ...
  cp_global_trees[CPTI_CLASS_TYPE] = build_int_2_wide ((unsigned long long) (class_type), (long long) (0));
  ((cp_global_trees[CPTI_CLASS_TYPE])->common.type) = cp_global_trees[CPTI_CLASS_TYPE];
  ridpointers[(int) RID_CLASS] = cp_global_trees[CPTI_CLASS_TYPE];

  cp_global_trees[CPTI_RECORD_TYPE] = build_int_2_wide ((unsigned long long) (record_type), (long long) (0));
  ((cp_global_trees[CPTI_RECORD_TYPE])->common.type) = cp_global_trees[CPTI_RECORD_TYPE];
  ridpointers[(int) RID_STRUCT] = cp_global_trees[CPTI_RECORD_TYPE];

  cp_global_trees[CPTI_UNION_TYPE] = build_int_2_wide ((unsigned long long) (union_type), (long long) (0));
  ((cp_global_trees[CPTI_UNION_TYPE])->common.type) = cp_global_trees[CPTI_UNION_TYPE];
  ridpointers[(int) RID_UNION] = cp_global_trees[CPTI_UNION_TYPE];

  cp_global_trees[CPTI_ENUM_TYPE] = build_int_2_wide ((unsigned long long) (enum_type), (long long) (0));
  ((cp_global_trees[CPTI_ENUM_TYPE])->common.type) = cp_global_trees[CPTI_ENUM_TYPE];
  ridpointers[(int) RID_ENUM] = cp_global_trees[CPTI_ENUM_TYPE];

  cxx_init_decl_processing ();


  cp_global_trees[CPTI_NULL] = build_int_2_wide ((unsigned long long) (0), (long long) (0));
  ((cp_global_trees[CPTI_NULL])->common.type) = c_common_type_for_size (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32), 0);
  ridpointers[RID_NULL] = cp_global_trees[CPTI_NULL];
     ...
     YYSTYPE yylval;
{
  ...
  switch (yychar)
    ...
    case 370:
      t = yylval.ttype;
      if (((enum tree_code) (t)->common.code) == TYPE_DECL || ((enum tree_code) (t)->common.code) == TEMPLATE_DECL)
 {
   fprintf (file, " `%s'", ((char *)(((t)->decl.name))->identifier.id.str));
   break;
 }
      (void) (((((enum tree_code) (t)->common.code) == IDENTIFIER_NODE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/lex.c", 710, __FUNCTION__), 0) : 0);
      if (((char *)(t)->identifier.id.str))
   fprintf (file, " `%s'", ((char *)(t)->identifier.id.str));
      break;

    case 326:
      if (yylval.ttype == cp_global_trees[CPTI_CLASS_TYPE])
 fprintf (file, " `class'");
      else if (yylval.ttype == cp_global_trees[CPTI_RECORD_TYPE])
 fprintf (file, " `struct'");
      else if (yylval.ttype == cp_global_trees[CPTI_UNION_TYPE])
 fprintf (file, " `union'");
      else if (yylval.ttype == cp_global_trees[CPTI_ENUM_TYPE])
 fprintf (file, " `enum'");
      else
 fancy_abort ("../../../kg++fe/gnu/cp/lex.c", 725, __FUNCTION__);
      break;
...
int *token_count;
# 790 "../../../kg++fe/gnu/cp/lex.c"
void
print_parse_statistics ()
{
# 838 "../../../kg++fe/gnu/cp/lex.c"
}
  ...
  if (flag_alt_external_templates)
    {
      ...
      if (til)
 finfo = get_fileinfo (((char *)((((til))->exp.operands[1]))->identifier.id.str));
    }
  if (!finfo)
     ...
     tree type;
{
 ...
 error ("semicolon missing after %s declaration",
        ((enum tree_code) (type)->common.code) == ENUMERAL_TYPE ? "enum" : "struct");
      else
     ...
     tree type;
{
  if (!(tree_code_type[(int) (((enum tree_code) (type)->common.code))] == 't'))
    fancy_abort ("../../../kg++fe/gnu/cp/lex.c", 938, __FUNCTION__);
  if ((((((enum tree_code) (type)->common.code)) == RECORD_TYPE || (((enum tree_code) (type)->common.code)) == UNION_TYPE) && (((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5))))
     ...
     tree declspecs;
{
  ...
  for (link = declspecs; link; link = ((link)->common.chain))
    {
      tree type = ((link)->list.value);
      if (type && (tree_code_type[(int) (((enum tree_code) (type)->common.code))] == 't'))
 note_got_semicolon (type);
    }
  clear_anon_tags ();
}
...
handle_pragma_vtable (dfile)
     cpp_reader *dfile __attribute__ ((__unused__));
{
     ...
     cpp_reader *dfile __attribute__ ((__unused__));
{
  ...
  if (fname == (tree)-1)
    ...
    main_filename = ((fname)->string.pointer);
 ...
 main_input_filename = input_filename;
  ...
  pragma_interface_seen = 1;

}
# 1048 "../../../kg++fe/gnu/cp/lex.c"
static void
...
{
  while (1)
    switch (((enum tree_code) (d)->common.code))
      {
      case ERROR_MARK:
 return 1;

      case OVERLOAD: d = (((struct tree_overload*)(d))->function); continue;
      case TREE_LIST: d = ((d)->list.value); continue;
      default:
        (void) ((((tree_code_type[(int) (((enum tree_code) (d)->common.code))] == 'd')) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/lex.c", 1129, __FUNCTION__), 0) : 0);

 return (!(((d)->decl.lang_flag_0) && (((enum tree_code) (d)->common.code) == CONST_DECL || ((enum tree_code) (d)->common.code) == PARM_DECL || ((enum tree_code) (d)->common.code) == TYPE_DECL || ((enum tree_code) (d)->common.code) == TEMPLATE_DECL)) && ((enum tree_code) ((((d)->decl.context) ? ((d)->decl.context) : global_namespace))->common.code) == NAMESPACE_DECL);
      }
}
...
{
  if (((name)->common.lang_flag_2))
    {
      if (name != (operator_name_info[(int) (ERROR_MARK)].identifier))
 error ("`%D' not defined", name);
    ...
    {
      if (namespace_binding ((name), scope_chain->old_namespace) != global_trees[TI_ERROR_MARK]
   || (((struct lang_identifier*)(name))->x ? ((struct lang_identifier*)(name))->x->error_locus : 0) != current_function_decl)
 {
   ...
   if (! undeclared_variable_notice)
     {
      ...
      set_namespace_binding ((name), scope_chain->old_namespace, (global_trees[TI_ERROR_MARK]));
      (((struct lang_identifier*)(name))->x == 0 ? ((struct lang_identifier*)(name))->x = (struct lang_id2 *)ggc_alloc_cleared (sizeof (struct lang_id2)) : 0, ((struct lang_identifier*)(name))->x->error_locus = (current_function_decl));
    }
}
     ...
     tree args;
{
  ...
  if (lexing && id && ((id)->common.deprecated_flag))
    warn_deprecated_use (id);
# 1194 "../../../kg++fe/gnu/cp/lex.c"
  if (args && !scope_chain->template_parms && (!id || is_global (id)))
  ...
  if (!id || (((enum tree_code) (id)->common.code) == FUNCTION_DECL
       && ((((id))->decl.lang_specific)->decl_flags.anticipated_p)))
    {
      if (scope_chain->template_parms)
 return (timevar_pop (TV_NAME_LOOKUP), (build_min_nt (LOOKUP_EXPR, token)));

      else if (((token)->common.lang_flag_4))

        return (timevar_pop (TV_NAME_LOOKUP), (token));
      else
 {
  ...
  if (((enum tree_code) (id)->common.code) == CONST_DECL)
    {

      if ((((struct lang_identifier*)(token))->class_value) == id)
 enforce_access ((((id)->decl.context) ? ((id)->decl.context) : global_namespace), id);
      if (!scope_chain->x_processing_template_decl || (((id)->decl.lang_flag_0) && (((enum tree_code) (id)->common.code) == CONST_DECL || ((enum tree_code) (id)->common.code) == PARM_DECL || ((enum tree_code) (id)->common.code) == TYPE_DECL || ((enum tree_code) (id)->common.code) == TEMPLATE_DECL)))
 id = ((id)->decl.initial);
    }
  else
    id = hack_identifier (id, token);
# 1250 "../../../kg++fe/gnu/cp/lex.c"
  if (scope_chain->template_parms
      && (is_overloaded_fn (id)
   || (((enum tree_code) (id)->common.code) == VAR_DECL
       && (((id)->decl.context) ? ((id)->decl.context) : global_namespace)
       && ((enum tree_code) ((((id)->decl.context) ? ((id)->decl.context) : global_namespace))->common.code) == FUNCTION_DECL)
   || ((enum tree_code) (id)->common.code) == PARM_DECL
   || ((enum tree_code) (id)->common.code) == RESULT_DECL
   || ((enum tree_code) (id)->common.code) == USING_DECL))
    id = build_min_nt (LOOKUP_EXPR, token);

  return (timevar_pop (TV_NAME_LOOKUP), (id));
}
     ...
     tree id;
{
      ...
      if (scope_chain->x_processing_template_decl)
 {
   ...
   return (timevar_pop (TV_NAME_LOOKUP), (id));
      ...
      if (namespace_binding ((token), scope_chain->old_namespace) != global_trees[TI_ERROR_MARK])
        error ("`::%D' undeclared (first use here)", token);
      id = global_trees[TI_ERROR_MARK];

      set_namespace_binding ((token), scope_chain->old_namespace, (global_trees[TI_ERROR_MARK]));
    }
  else
    {
      if (((enum tree_code) (id)->common.code) == ADDR_EXPR)
 mark_used (((id)->exp.operands[0]));
      else if (((enum tree_code) (id)->common.code) != OVERLOAD)
 mark_used (id);
    }
  if (((enum tree_code) (id)->common.code) == CONST_DECL && ! scope_chain->x_processing_template_decl)
    {

      id = ((id)->decl.initial);


      id = build1 (NOP_EXPR, ((id)->common.type), id);
      ((id)->common.constant_flag) = 1;
    }
      ...
      if (is_overloaded_fn (id))
 {
  ...
  return (timevar_pop (TV_NAME_LOOKUP), (convert_from_reference (id)));
}
     ...
     tree node;
{
  ...
  if ((((struct lang_identifier*)(node))->bindings))
    {
      t = ((((struct lang_identifier*)(node))->bindings) ? (((((struct lang_identifier*)(node))->bindings))->value) : 0);
      if (t && ((enum tree_code) (t)->common.code) == TYPE_DECL && ((t)->common.type) == type)
 return t;
    }
  if (namespace_binding ((node), scope_chain->old_namespace))
    {
      t = namespace_binding ((node), scope_chain->old_namespace);
      if (t && ((enum tree_code) (t)->common.code) == TYPE_DECL && ((t)->common.type) == type)
 return t;
    }


  if ((((((type)->type.main_variant))->common.chain)))
    return (((((type)->type.main_variant))->common.chain));



  return (tree) ((void *)0);
}
# 1374 "../../../kg++fe/gnu/cp/lex.c"
tree
     ...
     tree t;
{
  ...
  if ((!(((enum tree_code) (t)->common.code) == VAR_DECL || ((enum tree_code) (t)->common.code) == CONST_DECL || ((enum tree_code) (t)->common.code) == FIELD_DECL || ((enum tree_code) (t)->common.code) == USING_DECL)))
  ...
  ld->decl_flags.can_be_full = (!(((enum tree_code) (t)->common.code) == VAR_DECL || ((enum tree_code) (t)->common.code) == CONST_DECL || ((enum tree_code) (t)->common.code) == FIELD_DECL || ((enum tree_code) (t)->common.code) == USING_DECL)) ? 1 : 0;
  ld->decl_flags.u1sel = ((enum tree_code) (t)->common.code) == NAMESPACE_DECL ? 1 : 0;
  ld->decl_flags.u2sel = 0;
  if (ld->decl_flags.can_be_full)
    ld->u.f.u3sel = ((enum tree_code) (t)->common.code) == FUNCTION_DECL ? 1 : 0;

  ((t)->decl.lang_specific) = ld;
  if (scope_chain->lang_name == cp_global_trees[CPTI_LANG_NAME_CPLUSPLUS])
    (((t)->decl.lang_specific)->decl_flags.language = (lang_cplusplus));
  else if (scope_chain->lang_name == cp_global_trees[CPTI_LANG_NAME_C])
    (((t)->decl.lang_specific)->decl_flags.language = (lang_c));
  else if (scope_chain->lang_name == cp_global_trees[CPTI_LANG_NAME_JAVA])
    (((t)->decl.lang_specific)->decl_flags.language = (lang_java));
  else fancy_abort ("../../../kg++fe/gnu/cp/lex.c", 1418, __FUNCTION__);
     ...
     tree node;
{
  ...
  if (! ((node)->decl.lang_specific))
    return;

  if (!(!(((enum tree_code) (node)->common.code) == VAR_DECL || ((enum tree_code) (node)->common.code) == CONST_DECL || ((enum tree_code) (node)->common.code) == FIELD_DECL || ((enum tree_code) (node)->common.code) == USING_DECL)))
    size = sizeof (struct lang_decl_flags);
  else
    size = sizeof (struct lang_decl);
  ld = (struct lang_decl *) ggc_alloc (size);
  memcpy (ld, ((node)->decl.lang_specific), size);
  ((node)->decl.lang_specific) = ld;
     ...
     tree node;
{
  ...
  if (! ((node)->type.lang_specific))
    return;

  if (((node)->type.lang_specific)->u.h.is_lang_type_class)
    size = sizeof (struct lang_type);
  else
    size = sizeof (struct lang_type_ptrmem);
  lt = (struct lang_type *) ggc_alloc (size);
  memcpy (lt, ((node)->type.lang_specific), size);
  ((node)->type.lang_specific) = lt;
     ...
     enum tree_code code;
{
  ...
  if (((code) == RECORD_TYPE || (code) == UNION_TYPE) || code == TEMPLATE_TYPE_PARM
      || code == BOUND_TEMPLATE_TEMPLATE_PARM
      || code == TYPENAME_TYPE)
    ((t)->type.binfo) = make_binfo (global_trees[TI_SIZE_ZERO], t, (tree) ((void *)0), (tree) ((void *)0));
     ...
     tree rid;
{
  ...
  fancy_abort ("../../../kg++fe/gnu/cp/lex.c", 1581, __FUNCTION__);
  return 0x0;
}
