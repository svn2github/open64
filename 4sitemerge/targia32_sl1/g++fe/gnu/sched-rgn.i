...
# 58 "../../../kg++fe/gnu/sched-rgn.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 59 "../../../kg++fe/gnu/sched-rgn.c" 2
...
# 64 "../../../kg++fe/gnu/sched-rgn.c" 2
# 1 "../../../kg++fe/gnu/sched-int.h" 1
# 24 "../../../kg++fe/gnu/sched-int.h"
...
# 261 "../../../kg++fe/gnu/sched-int.h"
extern FILE *sched_dump;
extern int sched_verbose;
# 325 "../../../kg++fe/gnu/sched-int.h"
enum INSN_TRAP_CLASS
{
  TRAP_FREE = 0, IFREE = 1, PFREE_CANDIDATE = 2,
  PRISKY_CANDIDATE = 3, IRISKY = 4, TRAP_RISKY = 5
};
# 343 "../../../kg++fe/gnu/sched-int.h"
...
# 66 "../../../kg++fe/gnu/sched-rgn.c" 2
# 88 "../../../kg++fe/gnu/sched-rgn.c"
...
static sbitmap *dom;
# 238 "../../../kg++fe/gnu/sched-rgn.c"
static float *prob;
# 247 "../../../kg++fe/gnu/sched-rgn.c"
...
debug_regions ()
{
      ...
      for (bb = 0; bb < rgn_table[rgn].rgn_nr_blocks; bb++)
 {
   ...
   if (bb != (block_to_bb[(rgn_bb_table[current_blocks + (bb)])]))
     fancy_abort ("../../../kg++fe/gnu/sched-rgn.c", 525, __FUNCTION__);
...
# 760 "../../../kg++fe/gnu/sched-rgn.c"
      if (current_edge == 0)
 dfs_nr[child] = ++count;
    }
# 771 "../../../kg++fe/gnu/sched-rgn.c"
  unreachable = 0;
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
      ...
      if (sp->is_valid)
 {
       ...
       do
  {
   ...
   if (bblst_last > bblst_size)
     fancy_abort ("../../../kg++fe/gnu/sched-rgn.c", 1227, __FUNCTION__);
 }
      else
 {
     ...
     int rgn;
{
      ...
      if (current_nr_blocks > 1)
 {
  ...
  if (sched_rgn_n_insns != rgn_n_insns)
    fancy_abort ("../../../kg++fe/gnu/sched-rgn.c", 2615, __FUNCTION__);
...
# 2784 "../../../kg++fe/gnu/sched-rgn.c"
 ...
 if ((rgn_table[rgn].rgn_nr_blocks) == 1)
  ...
  != count_or_remove_death_notes (blocks, 0))
       fancy_abort ("../../../kg++fe/gnu/sched-rgn.c", 2832, __FUNCTION__);
   }
 ...
 {
   if (nr_inter > 0)
     fancy_abort ("../../../kg++fe/gnu/sched-rgn.c", 2857, __FUNCTION__);
 }
      fprintf (sched_dump, "\n\n");
    }
