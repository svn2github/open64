 ...
 case '.':
   {
     ...
     if (*++text->format_spec != '*')
       fancy_abort ("../../../kg++fe/gnu/diagnostic.c", 618, __FUNCTION__);
     else if (*++text->format_spec != 's')
       fancy_abort ("../../../kg++fe/gnu/diagnostic.c", 620, __FUNCTION__);
 ...
 default:
   if (!buffer->format_decoder
              || !(*buffer->format_decoder) (buffer, text))
     {
       ...
       fancy_abort ("../../../kg++fe/gnu/diagnostic.c", 633, __FUNCTION__);
     }
 }
    }
}
     ...
     tree decl;
{
      ...
      if (*p == '%')
 {
   if (*(p + 1) == '%')
     ...
     fancy_abort ("../../../kg++fe/gnu/diagnostic.c", 709, __FUNCTION__);
   else
     break;
 }
    }
...
("note: "),
("debug: "),
# 859 "../../../kg++fe/gnu/diagnostic.c" 2

    "must-not-happen"
  };
   if (diagnostic->kind >= DK_LAST_DIAGNOSTIC_KIND)
     fancy_abort ("../../../kg++fe/gnu/diagnostic.c", 863, __FUNCTION__);
    ...
    diagnostic_t kind;
{
  switch (kind)
    {
    default:
      fancy_abort ("../../../kg++fe/gnu/diagnostic.c", 914, __FUNCTION__);
      break;
...
trim_filename (name)
     const char *name;
{
  static const char this_file[] = "../../../kg++fe/gnu/diagnostic.c";
