...
# 28 "../../../kg++fe/gnu/cfganal.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 29 "../../../kg++fe/gnu/cfganal.c" 2
     ...
     int *rc_order;
{
      ...
      else
 {
  ...
  if (dfsnum > n_basic_blocks)
    fancy_abort ("../../../kg++fe/gnu/cfganal.c", 895, __FUNCTION__);


  if (dfsnum < n_basic_blocks)
    fancy_abort ("../../../kg++fe/gnu/cfganal.c", 899, __FUNCTION__);
  ...
  while (sp)
    {
     ...
     if (!(e->src->flags & 8) && predicate (e->src, data))
       {
         if (tv == rslt_max)
           fancy_abort ("../../../kg++fe/gnu/cfganal.c", 1163, __FUNCTION__);
         rslt[tv++] = st[sp++] = e->src;
         e->src->flags |= 8;
       }
        }
     ...
     if (!(e->dest->flags & 8) && predicate (e->dest, data))
       {
         if (tv == rslt_max)
           fancy_abort ("../../../kg++fe/gnu/cfganal.c", 1174, __FUNCTION__);
