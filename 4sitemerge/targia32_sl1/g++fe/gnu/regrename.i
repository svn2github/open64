...
# 31 "../../../kg++fe/gnu/regrename.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 32 "../../../kg++fe/gnu/regrename.c" 2
...
# 42 "../../../kg++fe/gnu/regrename.c" 2


# 1 "../../../kg++fe/gnu/defaults.h" 1
# 45 "../../../kg++fe/gnu/regrename.c" 2
     ...
     void *data;
{
  ...
  if (regno + nregs > 176)
    fancy_abort ("../../../kg++fe/gnu/regrename.c", 120, __FUNCTION__);
     ...
     rtx notes;
{
 ...
 if (regno + nregs > 176)
   fancy_abort ("../../../kg++fe/gnu/regrename.c", 145, __FUNCTION__);
...
# 445 "../../../kg++fe/gnu/regrename.c"
      ...
      else
 {
   ...
   if (action == mark_read)
     {
       if (! exact_match)
  fancy_abort ("../../../kg++fe/gnu/regrename.c", 463, __FUNCTION__);
     ...
     int earlyclobber;
{
  ...
  type == OP_IN ? OP_IN : OP_INOUT, earlyclobber);
    ...
    case PRE_MODIFY:
      ...
      fancy_abort ("../../../kg++fe/gnu/regrename.c", 722, __FUNCTION__);
     ...
     basic_block bb;
{
      ...
      if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
 {
   ...
   int alt;
   int predicated;
# 787 "../../../kg++fe/gnu/regrename.c"
   icode = ((((insn)->fld[6]).rtint) >= 0 ? (((insn)->fld[6]).rtint) : recog_memoized_1 (insn));
   extract_insn (insn);
   if (! constrain_operands (1))
     _fatal_insn_not_found (insn, "../../../kg++fe/gnu/regrename.c", 790, __FUNCTION__);
      ...
      if (! ((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
 {
   if (insn == bb->end)
     ...
     continue;
      ...
      extract_insn (insn);
      if (! constrain_operands (1))
 _fatal_insn_not_found (insn, "../../../kg++fe/gnu/regrename.c", 1609, __FUNCTION__);
      preprocess_constraints ();
      alt = which_alternative;
      n_ops = recog_data.n_operands;
