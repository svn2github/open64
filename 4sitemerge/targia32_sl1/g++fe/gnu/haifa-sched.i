...
# 145 "../../../kg++fe/gnu/haifa-sched.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 146 "../../../kg++fe/gnu/haifa-sched.c" 2
...
# 552 "../../../kg++fe/gnu/haifa-sched.c"
static rtx last_scheduled_insn;
# 561 "../../../kg++fe/gnu/haifa-sched.c"
__inline int
insn_unit (insn)
     rtx insn;
{
...
# 637 "../../../kg++fe/gnu/haifa-sched.c"
static int unit_tick[5 * 1];
# 646 "../../../kg++fe/gnu/haifa-sched.c"
static int unit_n_insns[5];
# 655 "../../../kg++fe/gnu/haifa-sched.c"
rtx
...
{
  if (ready->n_ready == 0)
    fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1128, __FUNCTION__);
     ...
     struct ready_list *ready;
{
  rtx t;
  if (ready->n_ready == 0)
    fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1160, __FUNCTION__);
     ...
     int index;
{
  if (ready->n_ready == 0 || index >= ready->n_ready)
    fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1183, __FUNCTION__);
     ...
     int index;
{
  ...
  if (ready->n_ready == 0 || index >= ready->n_ready)
    fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1202, __FUNCTION__);
     ...
     rtx head, tail;
{
      ...
      if (((enum rtx_code) (insn)->code) == NOTE)
 {
   ...
   if (prev == tail)
     fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1510, __FUNCTION__);
   if (prev == head)
     fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1512, __FUNCTION__);
   if (insn == next_tail)
     fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1514, __FUNCTION__);
 }
    }
}
     ...
     rtx tail;
{
      ...
      if (((enum rtx_code) (insn)->code) == NOTE)
 {
   ...
   if (prev == tail)
     fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1690, __FUNCTION__);
   if (prev == head)
     fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1692, __FUNCTION__);
   if (insn == next_tail)
     fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 1694, __FUNCTION__);
 }
    }
}
...
# 2145 "../../../kg++fe/gnu/haifa-sched.c"
  if (head == tail && (! ((rtx_class[(int) (((enum rtx_code) (head)->code))]) == 'i')))
    fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 2146, __FUNCTION__);
  ...
  while ((*current_sched_info->schedule_more_p) ())
    {
      ...
      if (ready.n_ready == 0)
 fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 2229, __FUNCTION__);
 ...
 print_block_visualization ("");
  ...
  if (current_sched_info->queue_must_finish_empty && q_size != 0)
      fancy_abort ("../../../kg++fe/gnu/haifa-sched.c", 2443, __FUNCTION__);
