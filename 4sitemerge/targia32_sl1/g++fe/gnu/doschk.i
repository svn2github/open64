...
char *path;
{
 ...
 default:
  ...
  break;
   ...
   if (((*__ctype_b_loc ())[(int) ((*cp))] & (unsigned short int) _ISlower))
     *dp++ = toupper (*cp);
   else
     *dp++ = *cp;
   chars_seen++;
