...
# 46 "../../../kg++fe/gnu/ssa.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 47 "../../../kg++fe/gnu/ssa.c" 2
     ...
     rtx *reg_loc;
{
  ...
  if (((enum rtx_code) (*reg_loc)->code) != REG
    ...
    fancy_abort ("../../../kg++fe/gnu/ssa.c", 749, __FUNCTION__);
       ...
       struct rename_context *c;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ssa.c", 785, __FUNCTION__);
...
# 869 "../../../kg++fe/gnu/ssa.c"
   ...
   && (((x)->fld[0]).rtuint) < ssa_max_reg_num)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/ssa.c", 930, __FUNCTION__);
       *ptr = new_reg;
     }
   else
     {
     ...
     dominance_info idom;
{
      ...
      while (((insn) && ((enum rtx_code) (insn)->code) == INSN && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET && ((enum rtx_code) (((((((insn)->fld[5]).rtx))->fld[1]).rtx))->code) == PHI))
 {
   ...
   if (reg == (rtx) 0)
     fancy_abort ("../../../kg++fe/gnu/ssa.c", 1080, __FUNCTION__);
  ...
  fancy_abort ("../../../kg++fe/gnu/ssa.c", 1089, __FUNCTION__);
     }
   else
     {
  ...
  fancy_abort ("../../../kg++fe/gnu/ssa.c", 1099, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/ssa.c", 1124, __FUNCTION__);
...
convert_to_ssa ()
{
  ...
  if (in_ssa_form)
    fancy_abort ("../../../kg++fe/gnu/ssa.c", 1177, __FUNCTION__);
     ...
     partition reg_partition;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ssa.c", 1429, __FUNCTION__);
     ...
     partition reg_partition;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ssa.c", 1527, __FUNCTION__);
 ...
 if ((e->flags & 2) && ((e)->src->succ->succ_next && (e)->dest->pred->pred_next))
  ...
  || !((!(((((*alt)->fld[0]).rtuint)) < 176)) || ((0))))
       fancy_abort ("../../../kg++fe/gnu/ssa.c", 1545, __FUNCTION__);
  ...
  if (conflicting_hard_regs_p (tgt_regno, alt_regno))
    ...
    fancy_abort ("../../../kg++fe/gnu/ssa.c", 1557, __FUNCTION__);
     ...
     partition reg_partition;
{
    ...
    phi2 = next_nonnote_insn (phi2))
 {
       ...
       for (e = b->pred; e; e = e->pred_next)
  {
    ...
    if (((enum rtx_code) (*alt)->code) != REG
        || !((!(((((*alt)->fld[0]).rtuint)) < 176)) || ((0))))
      fancy_abort ("../../../kg++fe/gnu/ssa.c", 1629, __FUNCTION__);
    if (((enum rtx_code) (*alt2)->code) != REG
        || !((!(((((*alt2)->fld[0]).rtuint)) < 176)) || ((0))))
      fancy_abort ("../../../kg++fe/gnu/ssa.c", 1632, __FUNCTION__);
   ...
   fancy_abort ("../../../kg++fe/gnu/ssa.c", 1643, __FUNCTION__);
     ...
     void *data;
{
  ...
  switch (((enum rtx_code) (expr)->code))
    ...
    case PHI:
      return 0;
    default:
      fancy_abort ("../../../kg++fe/gnu/ssa.c", 1954, __FUNCTION__);
    }
}
     ...
     void* data;
{
  ...
  *ptr = canonical_element_rtx;
   ...
   else if (regno != new_regno)
     {
       ...
       if (((enum machine_mode) (x)->mode) != ((enum machine_mode) (new_reg)->mode))
  fancy_abort ("../../../kg++fe/gnu/ssa.c", 2038, __FUNCTION__);
       *ptr = new_reg;
     }
 }
      return -1;
     ...
     partition reg_partition;
{
      ...
      do
 {
       ...
       if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SEQUENCE)
  {
    ...
    if (slen <= 1)
      fancy_abort ("../../../kg++fe/gnu/ssa.c", 2154, __FUNCTION__);
...
convert_from_ssa ()
{
  ...
  if (!check_hard_regs_in_partition (reg_partition))
    ...
    fancy_abort ("../../../kg++fe/gnu/ssa.c", 2194, __FUNCTION__);
