...
.LFE23:
	...
	.section	.rodata
	.type	__FUNCTION__.12196, @object
	.size	__FUNCTION__.12196, 13
__FUNCTION__.12196:
	.string	"make_new_qty"
.LC2:
	.string	"../../../kg++fe/gnu/cse.c"
	.text
...
.LCFI37:
	...
	jl	.L363
	.loc 1 1055 0
	leal	__FUNCTION__.12196@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1055, 4(%esp)
...
.LFE32:
	...
	.section	.rodata
	.type	__FUNCTION__.13078, @object
	.size	__FUNCTION__.13078, 7
__FUNCTION__.13078:
	.string	"insert"
	.text
...
.L691:
	...
	jne	.L686
	.loc 1 1573 0
	leal	__FUNCTION__.13078@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1573, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LBE41:
	...
	je	.L1160
	.loc 1 2497 0
	leal	__FUNCTION__.14093@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2497, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE45:
	...
	.section	.rodata
	.type	__FUNCTION__.14495, @object
	.size	__FUNCTION__.14495, 12
__FUNCTION__.14495:
	.string	"exp_equiv_p"
	.text
...
.L1309:
	.loc 1 2716 0
	leal	__FUNCTION__.14495@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2716, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE67:
	...
	.section	.rodata
	.type	__FUNCTION__.22086, @object
	.size	__FUNCTION__.22086, 16
__FUNCTION__.22086:
...
.L3814:
	...
	jle	.L3829
	.loc 1 7436 0
	leal	__FUNCTION__.22086@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$7436, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE118:
	...
	.file 17 "../../../kg++fe/gnu/recog.h"
	.file 18 "../../../kg++fe/gnu/function.h"
	.file 19 "../../../kg++fe/gnu/output.h"
	.text
.Letext0:
