...
# 30 "../../../kg++fe/gnu/cp/search.c" 2
# 1 "../../../include/gnu/obstack.h" 1
# 31 "../../../kg++fe/gnu/cp/search.c" 2
...
# 36 "../../../kg++fe/gnu/cp/search.c" 2
# 1 "../../../kg++fe/gnu/stack.h" 1
# 25 "../../../kg++fe/gnu/stack.h"
struct stack_level
{
     ...
     int size;
{
  ...
  __extension__ ({ struct obstack *__o = (obstack); int __len = (size); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((tp)), (__len)); __o->next_free += __len; (void) 0; });
  stack = (struct stack_level *) ((char*)((obstack)->next_free) - size);
  ...
  stack->first = (tree *) ((obstack)->object_base);
  stack->limit = __extension__ ({ struct obstack *__o = (obstack); (unsigned) (__o->chunk_limit - __o->next_free); }) / sizeof (tree *);
  return stack;
}
     ...
     struct stack_level *stack;
{
  ...
  stack = tem->prev;
  __extension__ ({ struct obstack *__o = (obstack); void *__obj = (tem); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
  return stack;
}


static struct stack_level *search_stack;
...
static base_kind lookup_base_r
 (tree, tree, base_access, int, tree *);
static int dynamic_cast_base_recurse (tree, tree, int, tree *);
...
static struct stack_level *push_search_level
 (struct stack_level *, struct obstack *);
static struct stack_level *pop_search_level
 (struct stack_level *);
static tree bfs_walk
 (tree, tree (*) (tree, void *), tree (*) (tree, void *), void *);
...
{
  register struct stack_level *stack = pop_stack_level (obstack);

  return stack;
}
# 177 "../../../kg++fe/gnu/cp/search.c"
static base_kind
     ...
     tree *binfo_ptr;
{
  ...
  if (comptypes ((((binfo)->common.type)), (base), 0))
    {
 ...
 found = bk_via_virtual;
      ...
      if (!*binfo_ptr)
 *binfo_ptr = binfo;
      else if (!is_virtual || !tree_int_cst_equal ((((binfo))->vec.a[1]),
         (((*binfo_ptr))->vec.a[1])))
 {
   if (access != ba_any)
     *binfo_ptr = ((void *)0);
  ...
  for (i = ((bases)->vec.length); i--;)
    {
      tree base_binfo = ((bases)->vec.a[i]);
      base_kind bk;

      bk = lookup_base_r (base_binfo, base,
         access,
     is_virtual || ((base_binfo)->common.static_flag),
     binfo_ptr);
 ...
 case bk_proper_base:
   (void) (((found == bk_not_base) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 238, __FUNCTION__), 0) : 0);
   found = bk;
   break;
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/cp/search.c", 251, __FUNCTION__);
 }
    }
  return found;
}
...
accessible_base_p (tree t, tree base)
{
  ...
  decl = ((base)->type.values);
  while (!(((enum tree_code) (decl)->common.code) == TYPE_DECL && ((decl)->decl.lang_flag_4)))
    decl = ((decl)->common.chain);
  while (((((((enum tree_code) (t)->common.code)) == RECORD_TYPE || (((enum tree_code) (t)->common.code)) == UNION_TYPE) && (((enum tree_code) (t)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t)->type.lang_flag_5))) && (&((t)->type.lang_specific)->u.c)->anon_aggr))
    t = ((t)->type.context);
  return accessible_p (t, decl);
}
# 289 "../../../kg++fe/gnu/cp/search.c"
tree
     ...
     base_kind *kind_ptr;
{
  ...
  if (t == global_trees[TI_ERROR_MARK] || base == global_trees[TI_ERROR_MARK])
    {
      if (kind_ptr)
 *kind_ptr = bk_not_base;
      return global_trees[TI_ERROR_MARK];
    }
  (void) ((((tree_code_type[(int) (((enum tree_code) (base)->common.code))] == 't')) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 305, __FUNCTION__), 0) : 0);
  ...
  if (!(tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 't'))
    ...
    t_binfo = ((t)->type.binfo);


  t = complete_type (((t)->type.main_variant));
  base = complete_type (((base)->type.main_variant));
 ...
 if (!(access & ba_quiet))
   {
     ...
     binfo = global_trees[TI_ERROR_MARK];
   }
 break;
     ...
     tree *offset_ptr;
{
  ...
  if (((binfo)->common.type) == subtype)
    {
      if (via_virtual)
        return -1;
      else
        {
          *offset_ptr = (((binfo))->vec.a[1]);
          return 0;
        }
    }

  binfos = (((binfo))->vec.a[4]);
  ...
  for (i = 0; i < n_baselinks; i++)
    {
      ...
      if (!((base_binfo)->common.public_flag))
        continue;
      rval = dynamic_cast_base_recurse
             (subtype, base_binfo,
              via_virtual || ((base_binfo)->common.static_flag), offset_ptr);
      if (worst == -2)
        worst = rval;
      else if (rval >= 0)
     ...
     tree target;
{
  ...
  int boff = dynamic_cast_base_recurse (subtype, ((target)->type.binfo),
                                        0, &offset);

  if (!boff)
    return offset;
  offset = build_int_2_wide ((unsigned long long) (boff), (long long) (-1));
  ((offset)->common.type) = sizetype_tab[(int) SSIZETYPE];
  return offset;
}
# 450 "../../../kg++fe/gnu/cp/search.c"
tree
lookup_field_1 (tree type, tree name, _Bool want_type)
{
  register tree field;
  ...
  if (((type)->type.name)
      && ((((type)->type.name))->decl.lang_specific)
      && ((((((type)->type.name)))->decl.lang_specific)->u.f.u.sorted_fields))
    {
      tree *fields = &((((((((type)->type.name)))->decl.lang_specific)->u.f.u.sorted_fields))->vec.a[0]);
      int lo = 0, hi = ((((((((type)->type.name)))->decl.lang_specific)->u.f.u.sorted_fields))->vec.length);
      int i;
      ...
      while (lo < hi)
 {
   ...
   if (((fields[i])->decl.name) > name)
     hi = i;
   else if (((fields[i])->decl.name) < name)
     lo = i + 1;
   else
     {
       field = (tree) ((void *)0);
       ...
       if (want_type)
  {
    do
      field = fields[i--];
    while (i >= lo && ((fields[i])->decl.name) == name);
    if (((enum tree_code) (field)->common.code) != TYPE_DECL
        && !(((enum tree_code) (field)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((field)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (field)->common.code) == TEMPLATE_DECL && (((field)->decl.lang_flag_0) && (((enum tree_code) (field)->common.code) == CONST_DECL || ((enum tree_code) (field)->common.code) == PARM_DECL || ((enum tree_code) (field)->common.code) == TYPE_DECL || ((enum tree_code) (field)->common.code) == TEMPLATE_DECL)))))
      field = (tree) ((void *)0);
  }
       else
  {
    do
      field = fields[i++];
    while (i < hi && ((fields[i])->decl.name) == name);
  }
       return field;
     }
 }
  ...
  for (field = ((type)->type.values); field; field = ((field)->common.chain))
    {
      ...
      (void) ((((tree_code_type[(int) (((enum tree_code) (field)->common.code))] == 'd')) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 525, __FUNCTION__), 0) : 0);
 ...
 {
   tree temp = lookup_field_1 (((field)->common.type), name, want_type);
   if (temp)
     return temp;
 }
      if (((enum tree_code) (field)->common.code) == USING_DECL)
 ...
 continue;
   ...
   && (!want_type
       || ((enum tree_code) (field)->common.code) == TYPE_DECL
       || (((enum tree_code) (field)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((field)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (field)->common.code) == TEMPLATE_DECL && (((field)->decl.lang_flag_0) && (((enum tree_code) (field)->common.code) == CONST_DECL || ((enum tree_code) (field)->common.code) == PARM_DECL || ((enum tree_code) (field)->common.code) == TYPE_DECL || ((enum tree_code) (field)->common.code) == TEMPLATE_DECL))))))
 return field;
    }

  if (name == cp_global_trees[CPTI_VPTR_IDENTIFIER])
    {

      if ((((type)->common.lang_flag_2)))
 return ((type)->type.minval);
    }
  return (tree) ((void *)0);
}
# 573 "../../../kg++fe/gnu/cp/search.c"
tree
current_scope ()
{
  ...
  if ((((((enum tree_code) (((current_function_decl)->common.type))->common.code) == METHOD_TYPE) || (((current_function_decl)->decl.lang_specific)->decl_flags.static_function))
       && comptypes ((((current_function_decl)->decl.context)), (scope_chain->class_type), 0))

      || ((((((current_function_decl)->decl.lang_specific)->decl_flags.friend_attr) && !((((enum tree_code) (((current_function_decl)->common.type))->common.code) == METHOD_TYPE) || (((current_function_decl)->decl.lang_specific)->decl_flags.static_function))) ? ((current_function_decl)->decl.lang_specific)->u.f.context : (tree) ((void *)0))
   && comptypes (((((((current_function_decl)->decl.lang_specific)->decl_flags.friend_attr) && !((((enum tree_code) (((current_function_decl)->common.type))->common.code) == METHOD_TYPE) || (((current_function_decl)->decl.lang_specific)->decl_flags.static_function))) ? ((current_function_decl)->decl.lang_specific)->u.f.context : (tree) ((void *)0))), (scope_chain->class_type), 0)))
...
at_function_scope_p ()
{
  ...
  return cs && ((enum tree_code) (cs)->common.code) == FUNCTION_DECL;
}
...
{
  tree cs = current_scope ();
  return cs && (tree_code_type[(int) (((enum tree_code) (cs)->common.code))] == 't');
}
     ...
     tree decl;
{
  ...
  while (context && (tree_code_type[(int) (((enum tree_code) (context)->common.code))] == 't') && ((((((enum tree_code) (context)->common.code)) == RECORD_TYPE || (((enum tree_code) (context)->common.code)) == UNION_TYPE) && (((enum tree_code) (context)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (context)->common.code) == TYPENAME_TYPE || ((enum tree_code) (context)->common.code) == TYPEOF_TYPE || ((enum tree_code) (context)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((context)->type.lang_flag_5))) && (&((context)->type.lang_specific)->u.c)->anon_aggr))
...
canonical_binfo (binfo)
     tree binfo;
{
  return (((binfo)->common.static_flag)
   ? ((((binfo)->common.type))->type.binfo) : binfo);
}
...
dfs_assert_unmarked_p (binfo, data)
     ...
     void *data __attribute__ ((__unused__));
{
  (void) (((!(((binfo)->common.static_flag) ? ((((((((enum tree_code) (((binfo)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((binfo)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((binfo)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((binfo)->common.type))->type.lang_flag_5))) ? (&((((binfo)->common.type))->type.lang_specific)->u.c)->marks : ((unsigned) ((((binfo)->common.type))->type.alias_set))) & (1 << (0))) != 0) : ((binfo)->common.lang_flag_0))) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 662, __FUNCTION__), 0) : 0);
  return (tree) ((void *)0);
}
     ...
     void *data;
{
 ...
 access = ak_public;
  ...
  else
    {
      ...
      if (((decl)->decl.lang_specific) && !(((enum tree_code) (decl)->common.code) == VAR_DECL && (((decl)->decl.context) && ((enum tree_code) (((decl)->decl.context))->common.code) == FUNCTION_DECL)))
 {
   tree decl_access = purpose_member (type, ((&((decl)->decl.lang_specific)->decl_flags.u2)->access));
   if (decl_access)
     access = ((access_kind)
        (((((decl_access)->list.value))->int_cst.int_cst).low));
 }
      ...
      if (!access)
 {
  ...
  = ((access_kind) ((((canonical_binfo (base_binfo))->common.lang_flag_1) << 1) | ((canonical_binfo (base_binfo))->common.lang_flag_6)));
  ...
  base_access = ak_none;
       else if (((base_binfo)->common.protected_flag))


  base_access = ak_protected;
       else if (!((base_binfo)->common.public_flag))
  ...
  ((((binfo)->common.lang_flag_1) = ((access) & 2) != 0), (((binfo)->common.lang_flag_6) = ((access) & 1) != 0));
     ...
     void *data;
{
  ...
  (((binfo)->common.static_flag) ? ((((((enum tree_code) (((binfo)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((binfo)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((binfo)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((binfo)->common.type))->type.lang_flag_5))) ? (void) ((&((((binfo)->common.type))->type.lang_specific)->u.c)->marks |= (1 << (0))) : (void) (((((binfo)->common.type))->type.alias_set) |= (1 << (0)))) : (void)(((binfo)->common.lang_flag_0) = 1));
  access = ((access_kind) ((((binfo)->common.lang_flag_1) << 1) | ((binfo)->common.lang_flag_6)));
  if (access == ak_public || (access == ak_protected && protected_ok))
    return binfo;
  else if (access != ak_none
    && is_friend (((binfo)->common.type), current_scope ()))
    return binfo;
...
{
  access_kind access;
# 904 "../../../kg++fe/gnu/cp/search.c"
  if (!(lookup_base ((derived), context_for_name_lookup (decl), ba_any, ((void *)0)) != (tree) ((void *)0)))
    return 0;
  ...
  if (access == ak_none)
    return 0;
# 924 "../../../kg++fe/gnu/cp/search.c"
  if (((((enum tree_code) (decl)->common.code) == FUNCTION_DECL && (((enum tree_code) (((decl)->common.type))->common.code) == METHOD_TYPE)) || ((enum tree_code) (decl)->common.code) == FIELD_DECL))
    {
 ...
 t = (((t))->vec.a[0]);
      ...
      if (!(lookup_base ((((t)->common.type)), derived, ba_any, ((void *)0)) != (tree) ((void *)0)))
 return 0;
    }
     ...
     tree binfo;
{
  ...
  if (((enum tree_code) (scope)->common.code) == FUNCTION_DECL
      || (((enum tree_code) (scope)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((scope)->decl.result))->common.code) == FUNCTION_DECL))
    befriending_classes = (((scope)->decl.lang_specific)->u.f.befriending_classes);
  else if ((tree_code_type[(int) (((enum tree_code) (scope)->common.code))] == 't'))
    befriending_classes = ((&((scope)->type.lang_specific)->u.c)->befriending_classes);
  else
    return 0;

  for (t = befriending_classes; t; t = ((t)->common.chain))
    if (protected_accessible_p (decl, ((t)->list.value), binfo))
      return 1;



  if ((tree_code_type[(int) (((enum tree_code) (scope)->common.code))] == 't'))
    for (t = ((scope)->type.context); t && (tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 't'); t = ((t)->type.context))
 ...
 return 1;
  ...
  if (((enum tree_code) (scope)->common.code) == FUNCTION_DECL
   ...
   && friend_accessible_p (((scope)->decl.context), decl, binfo))
 return 1;


      if (((((scope))->decl.lang_specific) ->decl_flags.u.template_info))
 return friend_accessible_p ((((((((scope))->decl.lang_specific) ->decl_flags.u.template_info))->list.purpose)), decl, binfo);
    }
  else if (((&(((scope))->type.lang_specific)->u.c)->template_info))
    return friend_accessible_p ((((((&(((scope))->type.lang_specific)->u.c)->template_info))->list.purpose)), decl, binfo);

  return 0;
}
# 1012 "../../../kg++fe/gnu/cp/search.c"
void
type_access_control (type, val)
     tree type, val;
{
  if (val == (tree) ((void *)0)
      || (((enum tree_code) (val)->common.code) != TEMPLATE_DECL && ((enum tree_code) (val)->common.code) != TYPE_DECL)
      || ! (((val)->decl.context) && (tree_code_type[(int) (((enum tree_code) (((val)->decl.context))->common.code))] == 't')))
    return;

  if (scope_chain->lookups == global_trees[TI_ERROR_MARK])
    enforce_access (type, val);
  else if (! accessible_p (type, val))
    scope_chain->lookups = tree_cons (type, val, scope_chain->lookups);
}
...

{
  ...
  if (!(tree_code_type[(int) (((enum tree_code) (context_for_name_lookup (decl))->common.code))] == 't'))
    return 1;
  ...
  if (!(tree_code_type[(int) (((enum tree_code) (type)->common.code))] == 't'))
    ...
    binfo = ((type)->type.binfo);
# 1085 "../../../kg++fe/gnu/cp/search.c"
  if (scope_chain->class_type)
    protected_ok = protected_accessible_p (decl, scope_chain->class_type, binfo);
     ...
     tree parent, binfo, most_derived;
{
  ...
  for (i = 0; i < n_baselinks; i++)
    {
      ...
      base_type = ((base_binfo)->common.type);
      if (!(((((enum tree_code) (base_type)->common.code)) == RECORD_TYPE || (((enum tree_code) (base_type)->common.code)) == UNION_TYPE) && (((enum tree_code) (base_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (base_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (base_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (base_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((base_type)->type.lang_flag_5))))
 ...
 {
   if (((((((((enum tree_code) (base_type)->common.code)) == RECORD_TYPE || (((enum tree_code) (base_type)->common.code)) == UNION_TYPE) && (((enum tree_code) (base_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (base_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (base_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (base_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((base_type)->type.lang_flag_5))) ? (&((base_type)->type.lang_specific)->u.c)->marks : ((unsigned) ((base_type)->type.alias_set))) & (1 << (3))) != 0))
     continue;
   ((((((enum tree_code) (base_type)->common.code)) == RECORD_TYPE || (((enum tree_code) (base_type)->common.code)) == UNION_TYPE) && (((enum tree_code) (base_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (base_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (base_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (base_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((base_type)->type.lang_flag_5))) ? (void) ((&((base_type)->type.lang_specific)->u.c)->marks |= (1 << (3))) : (void) (((base_type)->type.alias_set) |= (1 << (3))));
     ...
     void *data;
{
  ...
  if (((lfi->name)->common.lang_flag_3))
    return (tree) ((void *)0);



  binfo = (((binfo)->common.static_flag) ? binfo_for_vbase (((binfo)->common.type), lfi->type) : (binfo));
...
# 1231 "../../../kg++fe/gnu/cp/search.c"
static int
template_self_reference_p (type, decl)
     tree type;
     tree decl;
{
  return (((&((type)->type.lang_specific)->u.c)->use_template)
    ...
    && ((decl)->decl.name) == constructor_name (type));
}
# 1254 "../../../kg++fe/gnu/cp/search.c"
static int
shared_member_p (t)
     tree t;
{
  if (((enum tree_code) (t)->common.code) == VAR_DECL || ((enum tree_code) (t)->common.code) == TYPE_DECL || ((enum tree_code) (t)->common.code) == CONST_DECL)

    return 1;
  if (is_overloaded_fn (t))
    {
      for (; t; t = ((((enum tree_code) (t)->common.code) == OVERLOAD) ? ((t)->common.chain) : (tree) ((void *)0)))
 {
   tree fn = ((((enum tree_code) (t)->common.code) == OVERLOAD) ? (((struct tree_overload*)(t))->function) : (t));
  ...
  if (!lfi->want_type)
    {
      ...
      if (idx >= 0)
 nval = ((((&((type)->type.lang_specific)->u.c)->methods))->vec.a[idx]);
    }
  ...
  if (lfi->want_type && ((enum tree_code) (nval)->common.code) != TYPE_DECL
      && !(((enum tree_code) (nval)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((nval)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (nval)->common.code) == TEMPLATE_DECL && (((nval)->decl.lang_flag_0) && (((enum tree_code) (nval)->common.code) == CONST_DECL || ((enum tree_code) (nval)->common.code) == PARM_DECL || ((enum tree_code) (nval)->common.code) == TYPE_DECL || ((enum tree_code) (nval)->common.code) == TEMPLATE_DECL)))))
    {
      if (lfi->name == (((((type)->type.name))->decl.name)))
 {




   for (nval = ((nval)->common.chain); nval; nval = ((nval)->common.chain))
     if (((nval)->decl.name) == lfi->name
  && ((enum tree_code) (nval)->common.code) == TYPE_DECL)
       break;
 }
      else
 nval = (tree) ((void *)0);
      if (!nval && ((&((type)->type.lang_specific)->u.c)->nested_udts) != ((void *)0))
 {
          binding_entry e = binding_table_find (((&((type)->type.lang_specific)->u.c)->nested_udts),
                                                lfi->name);
   if (e != ((void *)0))
     nval = (((((e->type)->type.main_variant))->common.chain));
   else
     return (tree) ((void *)0);
 }
    }
  ...
  if (lfi->from_dep_base_p && !from_dep_base_p)
    {
# 1357 "../../../kg++fe/gnu/cp/search.c"
      lfi->from_dep_base_p = 0;
      lfi->rval = (tree) ((void *)0);
      lfi->rval_binfo = (tree) ((void *)0);
      lfi->ambiguous = (tree) ((void *)0);
      lfi->errstr = 0;
    }
      ...
      else
 {
   ...
   if (!lfi->ambiguous && lfi->rval)
     {
       ...
       lfi->ambiguous = tree_cons ((tree) ((void *)0), lfi->rval, (tree) ((void *)0));
       ((lfi->ambiguous)->common.type) = global_trees[TI_ERROR_MARK];
     }


   lfi->ambiguous = tree_cons ((tree) ((void *)0), nval, lfi->ambiguous);
   ((lfi->ambiguous)->common.type) = global_trees[TI_ERROR_MARK];
   lfi->errstr = "request for member `%D' is ambiguous";
    ...
    {
      if (from_dep_base_p && ((enum tree_code) (nval)->common.code) != TYPE_DECL
...
build_baselink (tree binfo, tree access_binfo, tree functions, tree optype)
{
  ...
  (void) (((((enum tree_code) (functions)->common.code) == FUNCTION_DECL || ((enum tree_code) (functions)->common.code) == TEMPLATE_DECL || ((enum tree_code) (functions)->common.code) == TEMPLATE_ID_EXPR || ((enum tree_code) (functions)->common.code) == OVERLOAD) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 1430, __FUNCTION__), 0) : 0);




  (void) (((!optype || (tree_code_type[(int) (((enum tree_code) (optype)->common.code))] == 't')) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 1431, __FUNCTION__), 0) : 0);
  (void) (((((functions)->common.type)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 1432, __FUNCTION__), 0) : 0);

  baselink = build (BASELINK, ((functions)->common.type), (tree) ((void *)0),
      (tree) ((void *)0), (tree) ((void *)0));
  ((((baselink))->exp.operands[0])) = binfo;
  ((((baselink))->exp.operands[2])) = access_binfo;
  ((((baselink))->exp.operands[1])) = functions;
  ((((baselink))->common.chain)) = optype;

  return baselink;
}
# 1456 "../../../kg++fe/gnu/cp/search.c"
tree
lookup_member (xbasetype, name, protect, want_type)
     register tree xbasetype, name;
     int protect, want_type;
{
  tree rval, rval_binfo = (tree) ((void *)0);
  tree type = (tree) ((void *)0), basetype_path = (tree) ((void *)0);
  struct lookup_field_info lfi;
# 1472 "../../../kg++fe/gnu/cp/search.c"
  const char *errstr = 0;

  if (xbasetype == scope_chain->class_type && ((&((xbasetype)->type.lang_specific)->u.c)->being_defined)
      && (((struct lang_identifier*)(name))->class_value))
    {
      tree field = (((struct lang_identifier*)(name))->class_value);
      if (! is_overloaded_fn (field)
   && ! (want_type && ((enum tree_code) (field)->common.code) != TYPE_DECL))


 return field;
    }

  if (((enum tree_code) (xbasetype)->common.code) == TREE_VEC)
    {
      type = ((xbasetype)->common.type);
      basetype_path = xbasetype;
    }
  else if (((((enum tree_code) (xbasetype)->common.code)) == RECORD_TYPE || (((enum tree_code) (xbasetype)->common.code)) == UNION_TYPE))
    {
      type = xbasetype;
      basetype_path = ((type)->type.binfo);
      (void) ((((((basetype_path))->vec.a[0]) == (tree) ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 1495, __FUNCTION__), 0) : 0);

    }
  else
    fancy_abort ("../../../kg++fe/gnu/cp/search.c", 1498, __FUNCTION__);
  ...
  if (errstr && protect)
    {
      ...
      rval = global_trees[TI_ERROR_MARK];
    }



  if (rval && lfi.from_dep_base_p && !(((enum tree_code) (rval)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((rval)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (rval)->common.code) == TEMPLATE_DECL && (((rval)->decl.lang_flag_0) && (((enum tree_code) (rval)->common.code) == CONST_DECL || ((enum tree_code) (rval)->common.code) == PARM_DECL || ((enum tree_code) (rval)->common.code) == TYPE_DECL || ((enum tree_code) (rval)->common.code) == TEMPLATE_DECL)))))
    rval = ((build_typename_type (((basetype_path)->common.type), name, name, ((rval)->common.type)))->common.chain);



  if (rval && is_overloaded_fn (rval))
    rval = build_baselink (rval_binfo, basetype_path, rval,
      (((name)->common.lang_flag_4)
      ? ((name)->common.type): (tree) ((void *)0)));
  return rval;
}
     ...
     int protect, want_type;
{
  ...
  if (rval && (((enum tree_code) (rval)->common.code) == BASELINK))
    return (tree) ((void *)0);
     ...
     int complain;
{
  ...
  tree id = (tree) ((void *)0);
  if ((((((scope_chain->class_type)->type.main_variant))->common.chain)))
    {



      for (t = (((((scope_chain->class_type)->type.main_variant))->common.chain));
    t && ((t)->decl.context);
    t = (((((((t)->decl.context))->type.main_variant))->common.chain)))
 {
   if (((enum tree_code) (((t)->decl.context))->common.code) != RECORD_TYPE)
     break;


   id = lookup_field (((t)->decl.context), name, complain, 0);
   ...
   if (id != (tree) ((void *)0))
     {
       if (((enum tree_code) (id)->common.code) == FIELD_DECL
    && ! ((id)->common.static_flag)
    && ((id)->common.type) != global_trees[TI_ERROR_MARK])
  {
    if (complain)
      {
...
lookup_conversion_operator (tree class_type, tree type)
{
  ...
  tree methods = ((&((class_type)->type.lang_specific)->u.c)->methods);

  for (pass = 0; pass < 2; ++pass)
    for (i = 2;
  i < ((methods)->vec.length);
  ++i)
      {
 tree fn = ((methods)->vec.a[i]);
 ...
 if (!(((((fn)->decl.name))->common.lang_flag_4)))
   break;
 ...
 if (pass == 0)
  ...
  && comptypes ((((((((fn)->decl.name))->common.lang_flag_4)) ? ((((fn)->decl.name))->common.type) : (tree) ((void *)0))), (type), 0))
       return i;
   }
 else
   {
...
lookup_fnfields_1 (tree type, tree name)
{
  ...
  if (name == cp_global_trees[CPTI_CTOR_IDENTIFIER])
    return (methods[0]
     ? 0 : -1);

  if (name == cp_global_trees[CPTI_DTOR_IDENTIFIER])
    return (methods[1]
     ? 1 : -1);
  if (((name)->common.lang_flag_4))
    return lookup_conversion_operator (type, ((name)->common.type));


  i = 2;
  while (i < len && methods[i] && (((((((((enum tree_code) (methods[i])->common.code) == OVERLOAD) ? (((struct tree_overload*)(methods[i]))->function) : (methods[i])))->decl.name))->common.lang_flag_4)))
    i++;
      ...
      while (lo < hi)
 {
   ...
   if (tmp)
     tmp = ((((((enum tree_code) (tmp)->common.code) == OVERLOAD) ? (((struct tree_overload*)(tmp))->function) : (tmp)))->decl.name);
   if (!tmp || tmp > name)
     hi = i;
   else if (tmp < name)
     lo = i + 1;
 ...
 tmp = ((((enum tree_code) (methods[i])->common.code) == OVERLOAD) ? (((struct tree_overload*)(methods[i]))->function) : (methods[i]));
 if (((tmp)->decl.name) == name)
   return i;
      }

  return -1;
}
# 1811 "../../../kg++fe/gnu/cp/search.c"
tree
adjust_result_of_qualified_name_lookup (tree decl,
     tree qualifying_class,
     tree context_class)
{
  (void) ((((((((enum tree_code) (qualifying_class)->common.code)) == RECORD_TYPE || (((enum tree_code) (qualifying_class)->common.code)) == UNION_TYPE) && (((enum tree_code) (qualifying_class)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (qualifying_class)->common.code) == TYPENAME_TYPE || ((enum tree_code) (qualifying_class)->common.code) == TYPEOF_TYPE || ((enum tree_code) (qualifying_class)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((qualifying_class)->type.lang_flag_5)))) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 1816, __FUNCTION__), 0) : 0);
  (void) ((((((((enum tree_code) (context_class)->common.code)) == RECORD_TYPE || (((enum tree_code) (context_class)->common.code)) == UNION_TYPE) && (((enum tree_code) (context_class)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (context_class)->common.code) == TYPENAME_TYPE || ((enum tree_code) (context_class)->common.code) == TYPEOF_TYPE || ((enum tree_code) (context_class)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((context_class)->type.lang_flag_5)))) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/search.c", 1817, __FUNCTION__), 0) : 0);

  if ((((enum tree_code) (decl)->common.code) == BASELINK)
      && (lookup_base ((context_class), qualifying_class, ba_any, ((void *)0)) != (tree) ((void *)0)))
    {
      tree base;
     ...
     ba_ignore | ba_quiet, ((void *)0));
      if (base)
 {
   ((((decl))->exp.operands[2])) = base;
   ((((decl))->exp.operands[0]))
     = lookup_base (base, ((((((decl))->exp.operands[0])))->common.type),
      ba_ignore | ba_quiet,
      ((void *)0));
 }
    }
     ...
     void *data;
{
  ...
  bfs_bases = varray_init (10, VARRAY_DATA_TREE, "search_stack");


  ((bfs_bases)->data.tree[0]) = binfo;
  tail = 1;
  ...
  for (head = 0; head < tail; ++head)
    {
      ...
      binfo = ((bfs_bases)->data.tree[head]);
      ...
      for (i = 0; i < n_baselinks; i++)
 {
   ...
   if (base_binfo)
     {
       if (tail == ((bfs_bases)->num_elements))
  ((bfs_bases) = varray_grow (bfs_bases, 2 * ((bfs_bases)->num_elements)));
       ((bfs_bases)->data.tree[tail]) = base_binfo;
       ++tail;
     }
 }
    }
     ...
     void *data;
{
 ...
 return rval;
  ...
  binfos = (((binfo))->vec.a[4]);
  n_baselinks = ((((binfo))->vec.a[4]) ? (((((binfo))->vec.a[4]))->vec.length) : 0);
  for (i = 0; i < n_baselinks; i++)
    {
      tree base_binfo = ((binfos)->vec.a[i]);
     ...
     tree brettype, drettype;
{
  ...
  if (((enum tree_code) (brettype)->common.code) == FUNCTION_DECL)
    {
      brettype = ((((brettype)->common.type))->common.type);
      drettype = ((((drettype)->common.type))->common.type);
    }
  else if (((enum tree_code) (brettype)->common.code) == METHOD_TYPE)
    {
      brettype = ((brettype)->common.type);
      drettype = ((drettype)->common.type);
    }

  if (comptypes ((brettype), (drettype), 0))
    return 0;

  if (! (((enum tree_code) (brettype)->common.code) == ((enum tree_code) (drettype)->common.code)
  && (((enum tree_code) (brettype)->common.code) == POINTER_TYPE
      || ((enum tree_code) (brettype)->common.code) == REFERENCE_TYPE)
  && ((((brettype)->common.readonly_flag) * 0x1) | (((brettype)->common.volatile_flag) * 0x2) | (((brettype)->type.restrict_flag) * 0x4) | ((((enum tree_code) (brettype)->common.code) == RECORD_TYPE && ((brettype)->common.type)) * 0x8)) == ((((drettype)->common.readonly_flag) * 0x1) | (((drettype)->common.volatile_flag) * 0x2) | (((drettype)->type.restrict_flag) * 0x4) | ((((enum tree_code) (drettype)->common.code) == RECORD_TYPE && ((drettype)->common.type)) * 0x8))))
    return 0;
  ...
  if (! (((enum tree_code) (drettype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (drettype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (drettype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (drettype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((drettype)->type.lang_flag_5)) || ! (((enum tree_code) (brettype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (brettype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (brettype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (brettype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((brettype)->type.lang_flag_5)))
    return -1;
  ...
  if (!binfo)
    return 0;
  if ((integer_zerop ((((binfo))->vec.a[1]))) && kind != bk_via_virtual)
    return 1;
  return 2;
}
...
{
  tree over_type = ((overrider)->common.type);
  tree base_type = ((basefn)->common.type);
  tree over_return = ((over_type)->common.type);
  tree base_return = ((base_type)->common.type);
  tree over_throw = ((over_type)->type.binfo);
  tree base_throw = ((base_type)->type.binfo);
  int i;

  if (comptypes ((base_return), (over_return), 0))
            ;
      ...
      if (pedantic && i == -1)
 {
  ...
  else if ((((enum tree_code) (base_return)->common.code) == ((enum tree_code) (over_return)->common.code) && (((enum tree_code) (base_return)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (base_return)->common.code) == TYPENAME_TYPE || ((enum tree_code) (base_return)->common.code) == TYPEOF_TYPE || ((enum tree_code) (base_return)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((base_return)->type.lang_flag_5)) && (((enum tree_code) (over_return)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (over_return)->common.code) == TYPENAME_TYPE || ((enum tree_code) (over_return)->common.code) == TYPEOF_TYPE || ((enum tree_code) (over_return)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((over_return)->type.lang_flag_5)))
    && comptypes ((base_return), (over_return), 1))
    {
      cp_error_at ("invalid covariant return type for `%#D'", overrider);
      cp_error_at ("  overriding `%#D' (must use pointer or reference)", basefn);
      return 0;
    }
  else if ((((struct lang_identifier*)(decl_assembler_name (overrider)))->x ? ((struct lang_identifier*)(decl_assembler_name (overrider)))->x->error_locus : 0) == (tree) ((void *)0))
    {
      cp_error_at ("conflicting return type specified for `%#D'", overrider);
      cp_error_at ("  overriding `%#D'", basefn);
      (((struct lang_identifier*)(decl_assembler_name (overrider)))->x == 0 ? ((struct lang_identifier*)(decl_assembler_name (overrider)))->x = (struct lang_id2 *)ggc_alloc_cleared (sizeof (struct lang_id2)) : 0, ((struct lang_identifier*)(decl_assembler_name (overrider)))->x->error_locus = (((overrider)->decl.context)));
...
# 2094 "../../../kg++fe/gnu/cp/search.c"
int
look_for_overrides (type, fndecl)
     tree type, fndecl;
{
  tree binfo = ((type)->type.binfo);
  tree basebinfos = (((binfo))->vec.a[4]);
  int nbasebinfos = basebinfos ? ((basebinfos)->vec.length) : 0;
  int ix;
  int found = 0;

  for (ix = 0; ix != nbasebinfos; ix++)
    {
      tree basetype = ((((basebinfos)->vec.a[ix]))->common.type);

      if ((((basetype)->common.lang_flag_2)))
     ...
     tree type, fndecl;
{
  ...
  if (((((fndecl)->decl.lang_specific)->decl_flags.destructor_attr) && !((((enum tree_code) (fndecl)->common.code) == FUNCTION_DECL || ((enum tree_code) (fndecl)->common.code) == TEMPLATE_DECL) && ((fndecl)->decl.lang_specific) && (((fndecl)->decl.lang_specific)->u.f.cloned_function) != (tree) ((void *)0))))
    ix = 1;
  else
    ix = lookup_fnfields_1 (type, ((fndecl)->decl.name));
  if (ix >= 0)
    {
      tree fns = ((((&((type)->type.lang_specific)->u.c)->methods))->vec.a[ix]);
      ...
      for (; fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
        {
          ...
          if (!((fn)->decl.virtual_flag))
                                 ;
          else if (((fn)->decl.context) != type)
                                                       ;
   else if ((((fndecl)->decl.lang_specific)->decl_flags.static_function))
     {
       tree btypes = ((((fn)->common.type))->type.values);
       tree dtypes = ((((fndecl)->common.type))->type.values);
         if (compparms (((btypes)->common.chain), dtypes))
  return fn;
            }
  ...
  if (((binfo)->common.static_flag))
    {
      ...
      if (((enum tree_code) (type)->common.code) == TREE_LIST)
 type = ((type)->list.purpose);
      binfo = binfo_for_vbase (((binfo)->common.type), type);
    }
  return unmarkedp (binfo, ((void *)0));
}
     ...
     void *data;
{
 ...
 if (((((((virtuals)->list.value)))->decl.lang_specific)->decl_flags.pure_virtual))
   ((&((type)->type.lang_specific)->u.c)->pure_virtuals)
     = tree_cons ((tree) ((void *)0), (((virtuals)->list.value)),
    ((&((type)->type.lang_specific)->u.c)->pure_virtuals));
    }
     ...
     tree type;
{
  ...
  dfs_walk (((type)->type.binfo), dfs_get_pure_virtuals,
     dfs_unmarked_real_bases_queue_p, type);
  dfs_walk (((type)->type.binfo), dfs_unmark,
     dfs_marked_real_bases_queue_p, type);


  ((&((type)->type.lang_specific)->u.c)->pure_virtuals) = nreverse (((&((type)->type.lang_specific)->u.c)->pure_virtuals));

  for (vbases = ((&((type)->type.lang_specific)->u.c)->vbases);
       vbases;
       vbases = ((vbases)->common.chain))
    {
      tree virtuals;

      for (virtuals = (((((vbases)->list.value)))->vec.a[3]);
    virtuals;
    virtuals = ((virtuals)->common.chain))
 {
   tree base_fndecl = (((virtuals)->list.value));
   if ((((base_fndecl)->decl.lang_specific)->decl_flags.needs_final_overrider))
...
markedp (binfo, data)
     ...
     void *data __attribute__ ((__unused__));
{
  return (((binfo)->common.static_flag) ? ((((((((enum tree_code) (((binfo)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((binfo)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((binfo)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((binfo)->common.type))->type.lang_flag_5))) ? (&((((binfo)->common.type))->type.lang_specific)->u.c)->marks : ((unsigned) ((((binfo)->common.type))->type.alias_set))) & (1 << (0))) != 0) : ((binfo)->common.lang_flag_0)) ? binfo : (tree) ((void *)0);
}
...
marked_vtable_pathp (binfo, data)
     ...
     void *data __attribute__ ((__unused__));
{
  return (((binfo)->common.static_flag) ? ((((((((enum tree_code) (((binfo)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((binfo)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((binfo)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((binfo)->common.type))->type.lang_flag_5))) ? (&((((binfo)->common.type))->type.lang_specific)->u.c)->marks : ((unsigned) ((((binfo)->common.type))->type.alias_set))) & (1 << (2))) != 0) : ((binfo)->common.lang_flag_3)) ? binfo : (tree) ((void *)0);
}
...
marked_pushdecls_p (binfo, data)
     ...
     void *data __attribute__ ((__unused__));
{
  return ((((((enum tree_code) (((binfo)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((binfo)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((binfo)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((binfo)->common.type))->type.lang_flag_5)))
   && (((binfo)->common.static_flag) ? ((((((((enum tree_code) (((binfo)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((binfo)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((binfo)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((binfo)->common.type))->type.lang_flag_5))) ? (&((((binfo)->common.type))->type.lang_specific)->u.c)->marks : ((unsigned) ((((binfo)->common.type))->type.alias_set))) & (1 << (2))) != 0) : ((binfo)->common.lang_flag_3))) ? binfo : (tree) ((void *)0);
}
     ...
     tree type;
{
  ...
  ((&((type)->type.lang_specific)->u.c)->vbases) = (tree) ((void *)0);
  dfs_walk (((type)->type.binfo), dfs_get_vbase_types, unmarkedp, type);


  ((&((type)->type.lang_specific)->u.c)->vbases) = nreverse (((&((type)->type.lang_specific)->u.c)->vbases));
  dfs_walk (((type)->type.binfo), dfs_unmark, markedp, 0);

  last_binfo = ((void *)0);
  dfs_walk_real (((type)->type.binfo),
   dfs_build_inheritance_graph_order,
   ((void *)0),
   unmarkedp,
   &last_binfo);
  dfs_walk (((type)->type.binfo), dfs_unmark, markedp, ((void *)0));
}
...
dfs_find_vbase_instance (binfo, data)
     ...
     void *data;
{
  tree base = (((tree) data)->list.value);

  if ((((binfo)->vec.a[10]) != (tree) ((void *)0))
      && comptypes ((((binfo)->common.type)), (base), 0))
    return binfo;
     ...
     tree type;
{
  ...
  if (!(((instance)->vec.a[10]) != (tree) ((void *)0)))
    return instance;

  return dfs_walk (((type)->type.binfo),
     dfs_find_vbase_instance,
     ((void *)0),
     build_tree_list (type, base));
}
# 2484 "../../../kg++fe/gnu/cp/search.c"
void
maybe_suppress_debug_info (t)
     tree t;
{
# 2496 "../../../kg++fe/gnu/cp/search.c"
  if (write_symbols == DWARF_DEBUG || write_symbols == NO_DEBUG)
    return;


  (((((((t)->type.main_variant))->common.chain)))->decl.external_flag) = 0;



  if (((&((t)->type.lang_specific)->u.c)->interface_unknown == 0))
    {
      if (((&((t)->type.lang_specific)->u.c)->interface_only))
 (((((((t)->type.main_variant))->common.chain)))->decl.external_flag) = 1;

    }


  else if (((((t)->common.lang_flag_2)) || (((t)->common.lang_flag_3))))
    (((((((t)->type.main_variant))->common.chain)))->decl.external_flag) = 1;


}
# 2527 "../../../kg++fe/gnu/cp/search.c"
static tree
dfs_debug_mark (binfo, data)
     tree binfo;
     void *data __attribute__ ((__unused__));
{
  tree t = ((binfo)->common.type);
...
dfs_debug_unmarkedp (binfo, data)
     ...
     void *data __attribute__ ((__unused__));
{
  return (!((&((((binfo)->common.type))->type.lang_specific)->u.c)->debug_requested)
   ? binfo : (tree) ((void *)0));
}
# 2558 "../../../kg++fe/gnu/cp/search.c"
void
note_debug_info_needed (type)
     tree type;
{
  if (((((type)->type.name))->decl.external_flag))
    {
      ((((type)->type.name))->decl.external_flag) = 0;
      rest_of_type_compilation (type, toplevel_bindings_p ());
    }

  dfs_walk (((type)->type.binfo), dfs_debug_mark, dfs_debug_unmarkedp, 0);
}
...
dependent_base_p (binfo)
     tree binfo;
{
  for (; binfo; binfo = (((binfo))->vec.a[0]))
    {
      if (currently_open_class (((binfo)->common.type)))
 break;
      if (uses_template_parms (((binfo)->common.type)))
 return 1;
    }
  return 0;
}
     ...
     int type_binding_p;
{
  ...
  if (type_binding_p)
    {
      type_binding = lookup_member (scope_chain->class_type, name,
                    2,
                      1);
      if (((enum tree_code) (type_binding)->common.code) == TREE_LIST
   && ((type_binding)->common.type) == global_trees[TI_ERROR_MARK])
 ...
 pushdecl_class_level (type_binding);
  ...
  value_binding = lookup_member (scope_chain->class_type, name,
                 2,
                   0);

  if (type_binding_p
      && (((enum tree_code) (value_binding)->common.code) == TYPE_DECL
   || (((enum tree_code) (value_binding)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((value_binding)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (value_binding)->common.code) == TEMPLATE_DECL && (((value_binding)->decl.lang_flag_0) && (((enum tree_code) (value_binding)->common.code) == CONST_DECL || ((enum tree_code) (value_binding)->common.code) == PARM_DECL || ((enum tree_code) (value_binding)->common.code) == TYPE_DECL || ((enum tree_code) (value_binding)->common.code) == TEMPLATE_DECL))))
   || (((enum tree_code) (value_binding)->common.code) == TREE_LIST
       && ((value_binding)->common.type) == global_trees[TI_ERROR_MARK]
       && (((enum tree_code) (((value_binding)->list.value))->common.code)
    == TYPE_DECL))))
    ...
    {
      if (((enum tree_code) (value_binding)->common.code) == TREE_LIST
   && ((value_binding)->common.type) == global_trees[TI_ERROR_MARK])

 push_class_level_binding (name, value_binding);
      else
 {
   if ((((enum tree_code) (value_binding)->common.code) == BASELINK))

     value_binding = ((((value_binding))->exp.operands[1]));
   ...
   if (((name)->common.lang_flag_4)
     ...
     {
       tree fns;
       for (fns = value_binding; fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
  if ((((struct lang_identifier*)(((((((enum tree_code) (fns)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fns))->function) : (fns)))->decl.name)))->class_value))
    return;
     }
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  for (fields = ((type)->type.values); fields; fields = ((fields)->common.chain))
    if (((fields)->decl.name) && ((enum tree_code) (fields)->common.code) == TYPE_DECL
 && !(!comptypes ((type), (scope_chain->class_type), 0)
      && template_self_reference_p (type, fields)))
      setup_class_bindings (((fields)->decl.name), 1);



  (((binfo)->common.static_flag) ? ((((((enum tree_code) (((binfo)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((binfo)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((binfo)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((binfo)->common.type))->type.lang_flag_5))) ? (void) ((&((((binfo)->common.type))->type.lang_specific)->u.c)->marks |= (1 << (2))) : (void) (((((binfo)->common.type))->type.alias_set) |= (1 << (2)))) : (((binfo)->common.lang_flag_3) = 1));
     ...
     void *data;
{
  ...
  type = ((binfo)->common.type);
  dep_base_p = (scope_chain->x_processing_template_decl && type != scope_chain->class_type
  && dependent_base_p (binfo));
  if (!dep_base_p)
    {
      tree fields;
      for (fields = ((type)->type.values); fields; fields = ((fields)->common.chain))
 if (((fields)->decl.name)
     && ((enum tree_code) (fields)->common.code) != TYPE_DECL
     && ((enum tree_code) (fields)->common.code) != USING_DECL
     && !((fields)->decl.artificial_flag))
   setup_class_bindings (((fields)->decl.name), 0);
 else if (((enum tree_code) (fields)->common.code) == FIELD_DECL
   && ((((((enum tree_code) (((fields)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((fields)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((fields)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((fields)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((fields)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((fields)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((fields)->common.type))->type.lang_flag_5))) && (&((((fields)->common.type))->type.lang_specific)->u.c)->anon_aggr))
   dfs_push_decls (((((fields)->common.type))->type.binfo), data);

      method_vec = ((((((enum tree_code) (type)->common.code)) == RECORD_TYPE || (((enum tree_code) (type)->common.code)) == UNION_TYPE) && (((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)))
      ? ((&((type)->type.lang_specific)->u.c)->methods) : (tree) ((void *)0));

      if (method_vec && ((method_vec)->vec.length) >= 3)
 {
   tree *methods;
   tree *end;


   end = ((void) (method_vec), &((method_vec)->vec.a[(method_vec)->vec.length]));

   for (methods = &((method_vec)->vec.a[2]);
        methods < end && *methods;
        methods++)
     setup_class_bindings (((((((enum tree_code) (*methods)->common.code) == OVERLOAD) ? (((struct tree_overload*)(*methods))->function) : (*methods)))->decl.name),
                         0);
 }
    }

  (((binfo)->common.static_flag) ? ((((((enum tree_code) (((binfo)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((binfo)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((binfo)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((binfo)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((binfo)->common.type))->type.lang_flag_5))) ? (void) ((&((((binfo)->common.type))->type.lang_specific)->u.c)->marks &= ~(1 << (2))) : (void) (((((binfo)->common.type))->type.alias_set) &= ~(1 << (2)))) : (((binfo)->common.lang_flag_3) = 0));

  return (tree) ((void *)0);
}
# 2746 "../../../kg++fe/gnu/cp/search.c"
void
     ...
     tree type;
{
  ...
  dfs_walk (((type)->type.binfo), dfs_push_type_decls, unmarked_pushdecls_p, 0);


  dfs_walk (((type)->type.binfo), dfs_push_decls, marked_pushdecls_p, 0);
}
     ...
     void *data __attribute__ ((__unused__));
{
 ...
 continue;
      ...
      ((fields)->common.used_flag) = 0;
      if (((fields)->decl.name) == (tree) ((void *)0)
   && ((((((enum tree_code) (((fields)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((fields)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((fields)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((fields)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((fields)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((fields)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((fields)->common.type))->type.lang_flag_5))) && (&((((fields)->common.type))->type.lang_specific)->u.c)->anon_aggr))
 unuse_fields (((fields)->common.type));
    }
...
unuse_fields (type)
     tree type;
{
  dfs_walk (((type)->type.binfo), dfs_unuse_fields, unmarkedp, 0);
}
...
{
  int i;
  tree method_vec = ((&((((binfo)->common.type))->type.lang_specific)->u.c)->methods);
  ...
  for (i = 2; i < ((method_vec)->vec.length); ++i)
    {
      tree tmp = ((method_vec)->vec.a[i]);
      tree name;

      if (!tmp || ! (((((((((enum tree_code) (tmp)->common.code) == OVERLOAD) ? (((struct tree_overload*)(tmp))->function) : (tmp)))->decl.name))->common.lang_flag_4)))
 break;

      name = ((((((enum tree_code) (tmp)->common.code) == OVERLOAD) ? (((struct tree_overload*)(tmp))->function) : (tmp)))->decl.name);


      if (! ((name)->common.lang_flag_0))
 {
   tree t;
   ...
   for (t = *conversions; t; t = ((t)->common.chain))
     {
       tree fn;
       for (fn = ((t)->list.value); fn; fn = ((((enum tree_code) (fn)->common.code) == OVERLOAD) ? ((fn)->common.chain) : (tree) ((void *)0)))
  if (comptypes ((((name)->common.type)), (((((((((((enum tree_code) (fn)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fn))->function) : (fn)))->decl.name))->common.lang_flag_4)) ? ((((((((enum tree_code) (fn)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fn))->function) : (fn)))->decl.name))->common.type) : (tree) ((void *)0))), 0))
...
{
  tree t;
  tree conversions = (tree) ((void *)0);

  complete_type (type);
  bfs_walk (((type)->type.binfo), add_conversions, 0, &conversions);

  for (t = conversions; t; t = ((t)->common.chain))
    ((((((((enum tree_code) (((t)->list.value))->common.code) == OVERLOAD) ? (((struct tree_overload*)(((t)->list.value)))->function) : (((t)->list.value))))->decl.name))->common.lang_flag_0) = 0;
     ...
     void *data;
{
  ...
  tree binfo;
  for (binfo = ((oi->compare_type)->type.binfo);
       ;
       binfo = (((((binfo))->vec.a[4]))->vec.a[(0)]))
    {
      if (((binfo)->common.type) == ((empty_binfo)->common.type))
 {
   oi->found_overlap = 1;
   break;
 }
      else if ((((binfo))->vec.a[4]) == (tree) ((void *)0))
 break;
    }
...
{
  struct overlap_info *oi = (struct overlap_info *) data;
  return !oi->found_overlap ? binfo : (tree) ((void *)0);
}
     ...
     tree empty_type, next_type;
{
  ...
  if (! (((enum tree_code) (next_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (next_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (next_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (next_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((next_type)->type.lang_flag_5)))
    return 0;
  oi.compare_type = next_type;
  oi.found_overlap = 0;
  dfs_walk (((empty_type)->type.binfo), dfs_check_overlap,
...
binfo_for_vtable (var)
     tree var;
{
  tree main_binfo = ((((var)->decl.context))->type.binfo);
  tree binfos = ((((((main_binfo)->common.type))->type.binfo))->vec.a[4]);
  int n_baseclasses = (((((((((main_binfo)->common.type))->type.binfo)))->vec.a[4]) ? (((((((((main_binfo)->common.type))->type.binfo)))->vec.a[4]))->vec.length) : 0));
  int i;

  for (i = 0; i < n_baseclasses; i++)
    {
      tree base_binfo = ((binfos)->vec.a[i]);
      if (base_binfo != (tree) ((void *)0) && (((base_binfo))->vec.a[2]) == var)
 return base_binfo;
    }



  if ((((&((((main_binfo)->common.type))->type.lang_specific)->u.c)->primary_base) != (tree) ((void *)0)))
...
binfo_via_virtual (binfo, limit)
     ...
     tree limit;
{
  for (; binfo && (!limit || !comptypes ((((binfo)->common.type)), (limit), 0));
       binfo = (((binfo))->vec.a[0]))
    {
      if (((binfo)->common.static_flag))
 return binfo;
     ...
     tree classtype;
{
  ...
  binfo = purpose_member (basetype, ((&((classtype)->type.lang_specific)->u.c)->vbases));
  return binfo ? ((binfo)->list.value) : (tree) ((void *)0);
}
