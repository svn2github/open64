...
# 41 "../../../kg++fe/gnu/alias.c" 2
# 72 "../../../kg++fe/gnu/alias.c"
typedef struct alias_set_entry
{

  long long alias_set;
# 84 "../../../kg++fe/gnu/alias.c"
  splay_tree children;
     ...
     long long subset;
{
  ...
  if (superset == 0)
    fancy_abort ("../../../kg++fe/gnu/alias.c", 639, __FUNCTION__);
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  if (regno >= reg_base_value_size)
    fancy_abort ("../../../kg++fe/gnu/alias.c", 944, __FUNCTION__);
     ...
     rtx x, y;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/alias.c", 1225, __FUNCTION__);
 }
    }
  return 1;
}
...
# 1 "../../../kg++fe/gnu/MIPS/gt-alias.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-alias.h"
