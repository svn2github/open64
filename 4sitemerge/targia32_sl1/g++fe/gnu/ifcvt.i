...
# 28 "../../../kg++fe/gnu/ifcvt.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 29 "../../../kg++fe/gnu/ifcvt.c" 2
...
# 38 "../../../kg++fe/gnu/ifcvt.c" 2
# 67 "../../../kg++fe/gnu/ifcvt.c"
     ...
     int mod_ok;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/ifcvt.c", 248, __FUNCTION__);
     ...
     struct ce_if_block * ce_info;
{
      ...
      if (combo_bb->succ == ((struct edge_def *)((void *)0)))
 {
   if (find_reg_note (last, REG_NORETURN, ((void *)0)))
     ...
     fancy_abort ("../../../kg++fe/gnu/ifcvt.c", 2045, __FUNCTION__);
 }
 ...
 fancy_abort ("../../../kg++fe/gnu/ifcvt.c", 2060, __FUNCTION__);
    }
 ...
 fancy_abort ("../../../kg++fe/gnu/ifcvt.c", 2091, __FUNCTION__);
