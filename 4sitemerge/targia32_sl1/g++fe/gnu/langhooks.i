...
# 29 "../../../kg++fe/gnu/langhooks.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 30 "../../../kg++fe/gnu/langhooks.c" 2
...
void
lhd_do_nothing_f (f)
     struct function *f __attribute__ ((__unused__));
{
}
...
lhd_print_tree_nothing (file, node, indent)
     ...
     int indent __attribute__ ((__unused__));
{
}
     ...
     tree decl;
{
  ...
  if (((enum tree_code) (decl)->common.code) == FUNCTION_DECL
   ...
   && (((decl)->common.static_flag)
    ...
    fancy_abort ("../../../kg++fe/gnu/langhooks.c", 175, __FUNCTION__);
}
...
{
  fancy_abort ("../../../kg++fe/gnu/langhooks.c", 199, __FUNCTION__);
}


void
lhd_incomplete_type_error (value, type)
     tree value __attribute__ ((__unused__)), type;
{
  if (((enum tree_code) (type)->common.code) == ERROR_MARK)
    return;

  fancy_abort ("../../../kg++fe/gnu/langhooks.c", 210, __FUNCTION__);
}
...
lhd_expand_expr (t, r, mm, em)
     tree t __attribute__ ((__unused__));
     rtx r __attribute__ ((__unused__));
     enum machine_mode mm __attribute__ ((__unused__));
     int em __attribute__ ((__unused__));
{
  fancy_abort ("../../../kg++fe/gnu/langhooks.c", 242, __FUNCTION__);
}
...
lhd_decl_printable_name (decl, verbosity)
     tree decl;
     int verbosity __attribute__ ((__unused__));
{
  return ((char *)(((decl)->decl.name))->identifier.id.str);
}
# 266 "../../../kg++fe/gnu/langhooks.c"
tree
lhd_tree_inlining_walk_subtrees (tp,subtrees,func,data,htab)
     tree *tp __attribute__ ((__unused__));
     int *subtrees __attribute__ ((__unused__));
     walk_tree_fn func __attribute__ ((__unused__));
     void *data __attribute__ ((__unused__));
     void *htab __attribute__ ((__unused__));
{
  return (tree) ((void *)0);
}
...
# 313 "../../../kg++fe/gnu/langhooks.c"
tree
lhd_tree_inlining_add_pending_fn_decls (vafnp, pfn)
     void *vafnp __attribute__ ((__unused__));
     tree pfn;
{
  return pfn;
}
...
# 355 "../../../kg++fe/gnu/langhooks.c"
tree
lhd_tree_inlining_copy_res_decl_for_inlining (res, fn, caller,
           dm, ndp, texps)
     tree res, fn, caller;
     void *dm __attribute__ ((__unused__));
     int *ndp __attribute__ ((__unused__));
     void *texps __attribute__ ((__unused__));
{
...
lhd_tree_inlining_convert_parm_for_inlining (parm, value, fndecl)
     tree parm __attribute__ ((__unused__));
     tree value;
...
lhd_tree_dump_dump_tree (di, t)
     void *di __attribute__ ((__unused__));
     tree t __attribute__ ((__unused__));
{
  return 0;
}
...
lhd_tree_dump_type_quals (t)
     tree t;
{
  return ((((t)->common.readonly_flag) * 0x1) | (((t)->common.volatile_flag) * 0x2) | (((t)->type.restrict_flag) * 0x4) | ((((enum tree_code) (t)->common.code) == RECORD_TYPE && ((t)->common.type)) * 0x8));
}
