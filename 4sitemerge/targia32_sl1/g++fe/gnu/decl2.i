...
extern long get_run_time (void);
extern void print_time (const char *, long);
# 49 "../../../kg++fe/gnu/cp/decl2.c" 2
# 1 "../../../kg++fe/gnu/cpplib.h" 1
# 50 "../../../kg++fe/gnu/cp/decl2.c" 2
...
# 51 "../../../kg++fe/gnu/cp/decl2.c" 2



# 1 "../../../kg++fe/gnu/defaults.h" 1
# 55 "../../../kg++fe/gnu/cp/decl2.c" 2
...
static int acceptable_java_type (tree);
...
static void generate_ctor_or_dtor_function (int, int);
...
{
  tree fntype = ((function)->common.type);
  tree raises = ((fntype)->type.binfo);
  int type_quals = 0x0;
  int dup_quals = 0x0;
  int this_quals = 0x0;
  ...
  do
    {
      int tq = cp_type_qual_from_rid (((quals)->list.value));
 ...
 type_quals |= tq;
      quals = ((quals)->common.chain);
    }
  while (quals);

  if (dup_quals != 0x0)
    error ("duplicate type qualifiers in %s declaration",
       ((enum tree_code) (function)->common.code) == FUNCTION_DECL
       ? "member function" : "type");

  ctype = cp_build_qualified_type_real ((ctype), (type_quals), tf_error | tf_warning);
  fntype = build_cplus_method_type (ctype, ((fntype)->common.type),
        (((enum tree_code) (fntype)->common.code) == METHOD_TYPE
         ? ((((fntype)->type.values))->common.chain)
         : ((fntype)->type.values)));
  if (raises)
    fntype = build_exception_variant (fntype, raises);

  ((function)->common.type) = fntype;
  return this_quals;
}
  ...
  if (flag_alt_external_templates)
    {
      ...
      if (til)
 {
   lineno = (((til)->exp.complexity) >> 12);
   input_filename = ((char *)((((til))->exp.operands[1]))->identifier.id.str);
 }
     ...
     tree specs;
{
  ...
  t = groktypename (build_tree_list (specs, (tree) ((void *)0)));



  if (t == (tree) ((void *)0) || !((((((enum tree_code) (t)->common.code)) == RECORD_TYPE || (((enum tree_code) (t)->common.code)) == UNION_TYPE) && (((enum tree_code) (t)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t)->type.lang_flag_5))) && (&((t)->type.lang_specific)->u.c)->anon_aggr))
    return;

  fixup_anonymous_aggr (t);
  finish_member_declaration (build_decl (FIELD_DECL, (tree) ((void *)0), t));
}
     ...
     tree type;
{
  ...
  ((parm)->decl.initial) = type_passed_as (type);
  return parm;
}
     ...
     tree type;
{
  ...
  ((parm)->decl.artificial_flag) = 1;


  ((parm)->common.readonly_flag) = 1;
  return parm;
}
# 285 "../../../kg++fe/gnu/cp/decl2.c"
void
     ...
     tree fn;
{
  ...
  if ((((fn)->decl.lang_specific)->decl_flags.constructor_attr)
      && !(((((fn)->decl.context))->common.lang_flag_3)))
    return;

  arg_types = ((((fn)->common.type))->type.values);
  basetype = ((((arg_types)->list.value))->common.type);
  arg_types = ((arg_types)->common.chain);

  parms = ((((fn)->decl.arguments))->common.chain);



  if ((((((fn)->decl.context))->common.lang_flag_3)))
    {
      parm = build_artificial_parm (cp_global_trees[CPTI_VTT_PARM_IDENTIFIER], cp_global_trees[CPTI_VTT_PARM_TYPE]);


      ((parm)->common.chain) = parms;
      parms = parm;


      arg_types = hash_tree_chain (cp_global_trees[CPTI_VTT_PARM_TYPE], arg_types);

      (((fn)->decl.lang_specific)->decl_flags.has_vtt_parm_p) = 1;
    }


  parm = build_artificial_parm (cp_global_trees[CPTI_IN_CHARGE_IDENTIFIER], integer_types[itk_int]);
  ((parm)->common.chain) = parms;
  parms = parm;
  arg_types = hash_tree_chain (integer_types[itk_int], arg_types);


  ((((fn)->decl.arguments))->common.chain) = parms;


  fntype = build_cplus_method_type (basetype, ((((fn)->common.type))->common.type),
        arg_types);
  if (((((fn)->common.type))->type.binfo))
    fntype = build_exception_variant (fntype,
          ((((fn)->common.type))->type.binfo));
  ((fn)->common.type) = fntype;


  (((fn)->decl.lang_specific)->decl_flags.has_in_charge_parm_p) = 1;
}
# 369 "../../../kg++fe/gnu/cp/decl2.c"
void
grokclassfn (ctype, function, flags, quals)
     ...
     tree quals;
{
  tree fn_name = ((function)->decl.name);
  int this_quals = 0x0;



  (((function)->decl.lang_specific)->decl_flags.language = (lang_cplusplus));

  if (fn_name == (tree) ((void *)0))
    {
      error ("name missing for member function");
      fn_name = (__builtin_constant_p ("<anonymous>") ? get_identifier_with_length (("<anonymous>"), (unsigned) strlen ("<anonymous>")) : (get_identifier) ("<anonymous>"));
      ((function)->decl.name) = fn_name;
    }

  if (quals)
    this_quals = grok_method_quals (ctype, function, quals);

  if (((enum tree_code) (((function)->common.type))->common.code) == METHOD_TYPE)
    {



      tree type = ((((((function)->common.type))->type.values))->list.value);
      tree qual_type;
      tree parm;
      ...
      this_quals |= 0x1;
      qual_type = cp_build_qualified_type_real ((type), (this_quals), tf_error | tf_warning);
      parm = build_artificial_parm (cp_global_trees[CPTI_THIS_IDENTIFIER], qual_type);
      c_apply_type_quals_to_decl (this_quals, parm);
      ((parm)->common.chain) = last_function_parms;
      last_function_parms = parm;
    }

  ((function)->decl.arguments) = last_function_parms;
  ((function)->decl.context) = ctype;

  if (flags == DTOR_FLAG)
    (((function)->decl.lang_specific)->decl_flags.destructor_attr) = 1;

  if (flags == DTOR_FLAG || (((function)->decl.lang_specific)->decl_flags.constructor_attr))
    maybe_retrofit_in_chrg (function);

  if (flags == DTOR_FLAG)
    {
      (((function)->decl.lang_specific)->decl_flags.destructor_attr) = 1;
      (((ctype)->type.lang_flag_2)) = 1;
    }
}
...
{
  tree type = ((array_expr)->common.type);
  tree p1, p2, i1, i2;

  if (type == global_trees[TI_ERROR_MARK] || index_exp == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];
  if (scope_chain->x_processing_template_decl)
    return build_min (ARRAY_REF, type ? ((type)->common.type) : (tree) ((void *)0),
  ...
  if ((((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)) || (((enum tree_code) (((index_exp)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((index_exp)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((index_exp)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((index_exp)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((index_exp)->common.type))->type.lang_flag_5)))
    return build_opfncall (ARRAY_REF, (3),
      array_expr, index_exp, (tree) ((void *)0));
  ...
  if (((enum tree_code) (type)->common.code) == ARRAY_TYPE)
    ...
    p1 = build_expr_type_conversion (8, array_expr, 0);

  if (((enum tree_code) (((index_exp)->common.type))->common.code) == ARRAY_TYPE)
    p2 = index_exp;
  else
    p2 = build_expr_type_conversion (8, index_exp, 0);

  i1 = build_expr_type_conversion (1 | 4, array_expr, 0);
  i2 = build_expr_type_conversion (1 | 4, index_exp, 0);
  ...
  type, ((index_exp)->common.type));
      return global_trees[TI_ERROR_MARK];
    }

  if (array_expr == global_trees[TI_ERROR_MARK] || index_exp == global_trees[TI_ERROR_MARK])
    error ("ambiguous conversion for array subscript");

  return build_array_ref (array_expr, index_exp);
}
# 505 "../../../kg++fe/gnu/cp/decl2.c"
tree
     ...
     int doing_vec, use_global_delete;
{
  ...
  if (scope_chain->x_processing_template_decl)
    {
      t = build_min (DELETE_EXPR, global_trees[TI_VOID_TYPE], exp, size);
      ((t)->common.lang_flag_0) = use_global_delete;
      ((t)->common.lang_flag_1) = doing_vec;
      return t;
    }
  ...
  t = build_expr_type_conversion (8, t, 1);
  ...
  if (doing_vec == 2)
    {
      maxindex = build_binary_op(MINUS_EXPR, size, global_trees[TI_INTEGER_ONE], 1);
  ...
  if (((enum tree_code) (((type)->common.type))->common.code) == FUNCTION_TYPE)
    {
  ...
  if (((enum tree_code) (t)->common.code) == ADDR_EXPR
      && ((enum tree_code) (((t)->exp.operands[0]))->common.code) == VAR_DECL
      && ((enum tree_code) (((((t)->exp.operands[0]))->common.type))->common.code) == ARRAY_TYPE)
    warning ("deleting array `%#D'", ((t)->exp.operands[0]));


  if (integer_zerop (t))
    return build1 (NOP_EXPR, global_trees[TI_VOID_TYPE], t);
     ...
     tree tmpl;
{
  ...
  (void) (((((enum tree_code) (tmpl)->common.code) == TEMPLATE_DECL) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 590, __FUNCTION__), 0) : 0);
  decl = ((tmpl)->decl.result);

  if (((enum tree_code) (decl)->common.code) == FUNCTION_DECL
      || (((enum tree_code) (decl)->common.code) == TYPE_DECL
   && (((enum tree_code) (((decl)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((decl)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((decl)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((decl)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((decl)->common.type))->type.lang_flag_5))))
    {
 ...
 error ("invalid declaration of member template `%#D' in local class",
    decl);
      ...
      if (((enum tree_code) (decl)->common.code) == FUNCTION_DECL && ((decl)->decl.virtual_flag))
 {
   ...
   error
     ("invalid use of `virtual' in template declaration of `%#D'",
      decl);
   ((decl)->decl.virtual_flag) = 0;
 }



      ((tmpl)->decl.ignored_flag) = 1;
    }
  else
...
acceptable_java_type (type)
     tree type;
{
  if (((enum tree_code) (type)->common.code) == VOID_TYPE || ((type)->type.lang_flag_3))
    return 1;
...
{
  int jerr = 0;
  tree arg_types = ((((method)->common.type))->type.values);
  tree ret_type = ((((method)->common.type))->common.type);
  ...
  for (; arg_types != (tree) ((void *)0); arg_types = ((arg_types)->common.chain))
    {
      tree type = ((arg_types)->list.value);
     ...
     tree ctype, function;
{
  ...
  if ((((function)->decl.lang_specific)->decl_flags.use_template)
      && !(((enum tree_code) (function)->common.code) == TEMPLATE_DECL
    && ((((function)->decl.lang_specific)->decl_flags.use_template) == 2))
      && is_member_template ((((((((function))->decl.lang_specific) ->decl_flags.u.template_info))->list.purpose))))
# 712 "../../../kg++fe/gnu/cp/decl2.c"
    return (tree) ((void *)0);


  is_template = (((enum tree_code) (function)->common.code) == TEMPLATE_DECL
   || (scope_chain->x_processing_template_decl - template_class_depth (ctype)));

  ix = lookup_fnfields_1 (complete_type (ctype),
     (((function)->decl.lang_specific)->decl_flags.constructor_attr) ? cp_global_trees[CPTI_CTOR_IDENTIFIER] :
     (((function)->decl.lang_specific)->decl_flags.destructor_attr) ? cp_global_trees[CPTI_DTOR_IDENTIFIER] :
     ((function)->decl.name));

  if (ix >= 0)
    {
      tree methods = ((&((ctype)->type.lang_specific)->u.c)->methods);
      tree fndecls, fndecl = 0;
      _Bool is_conv_op;
      const char *format = ((void *)0);

      for (fndecls = ((methods)->vec.a[ix]);
    fndecls; fndecls = ((((enum tree_code) (fndecls)->common.code) == OVERLOAD) ? ((fndecls)->common.chain) : (tree) ((void *)0)))
 {
   tree p1, p2;

   fndecl = ((((enum tree_code) (fndecls)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fndecls))->function) : (fndecls));
   p1 = ((((function)->common.type))->type.values);
   p2 = ((((fndecl)->common.type))->type.values);
# 746 "../../../kg++fe/gnu/cp/decl2.c"
   if ((((fndecl)->decl.lang_specific)->decl_flags.static_function)
       && ((enum tree_code) (((function)->common.type))->common.code) == METHOD_TYPE)
     p1 = ((p1)->common.chain);



   if (is_template != (((enum tree_code) (fndecl)->common.code) == TEMPLATE_DECL))
     continue;

   if (comptypes ((((((function)->common.type))->common.type)), (((((fndecl)->common.type))->common.type)), 0)

       && compparms (p1, p2)
       && (((((function)->decl.lang_specific)->decl_flags.use_template) == 2)
    == ((((fndecl)->decl.lang_specific)->decl_flags.use_template) == 2))
       && (!((((function)->decl.lang_specific)->decl_flags.use_template) == 2)
    || ((((((((function))->decl.lang_specific) ->decl_flags.u.template_info))->list.purpose))
        == (((((((fndecl))->decl.lang_specific) ->decl_flags.u.template_info))->list.purpose)))))
     return fndecl;
 }
      error ("prototype for `%#D' does not match any in class `%T'",
      function, ctype);
      is_conv_op = (((((fndecl)->decl.name))->common.lang_flag_4));

      if (is_conv_op)
 ix = 2;
      fndecls = ((methods)->vec.a[ix]);
      while (fndecls)
 {
   fndecl = ((((enum tree_code) (fndecls)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fndecls))->function) : (fndecls));
   fndecls = ((((enum tree_code) (fndecls)->common.code) == OVERLOAD) ? ((fndecls)->common.chain) : (tree) ((void *)0));

   if (!fndecls && is_conv_op)
     {
       if (((methods)->vec.length) > ix)
  {
    ix++;
    fndecls = ((methods)->vec.a[ix]);
    if (!(((((((((enum tree_code) (fndecls)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fndecls))->function) : (fndecls)))->decl.name))->common.lang_flag_4)))
      {
        fndecls = (tree) ((void *)0);
        is_conv_op = 0;
      }
  ...
  else if (!(((ctype)->type.size) != (tree) ((void *)0)))
    (cxx_incomplete_type_diagnostic ((function), (ctype), 0));
  else
  ...
  if ((((ctype)->type.size) != (tree) ((void *)0)))
...
finish_static_data_member_decl (decl, init, asmspec_tree, flags)
     ...
     int flags;
{
  (void) (((((decl)->common.public_flag)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 828, __FUNCTION__), 0) : 0);

  ((decl)->decl.context) = scope_chain->class_type;





  if (!asmspec_tree && scope_chain->class_type)
    ((decl)->decl.initial) = global_trees[TI_ERROR_MARK];

  if (! scope_chain->x_processing_template_decl)
    {
      if (!pending_statics)
 pending_statics = varray_init (32, VARRAY_DATA_TREE, "pending_statics");
      do { if ((pending_statics)->elements_used >= (pending_statics)->num_elements) (((pending_statics)) = varray_grow ((pending_statics), 2 * (pending_statics)->num_elements)); (pending_statics)->data.tree[(pending_statics)->elements_used++] = (decl); } while (0);
    }

  if ((decl_function_context ((((((scope_chain->class_type)->type.main_variant))->common.chain))) != (tree) ((void *)0)))
    pedwarn ("local class `%#T' shall not have static data member `%#D'",
      scope_chain->class_type, decl);


  if (init != (tree) ((void *)0) && ((((decl)->common.type))->type.needs_constructing_flag))
    {
  ...
  if (((cp_type_quals (((decl)->common.type)) & 0x1) != 0) && init == 0)
     ...
     tree declarator, declspecs, init, asmspec_tree, attrlist;
{
  ...
  if (init == (tree) ((void *)0) && declarator != (tree) ((void *)0)
      && ((enum tree_code) (declarator)->common.code) == CALL_EXPR
      && ((declarator)->exp.operands[0])
      && (((enum tree_code) (((declarator)->exp.operands[0]))->common.code) == IDENTIFIER_NODE
   || ((enum tree_code) (((declarator)->exp.operands[0]))->common.code) == SCOPE_REF)
      && parmlist_is_exprlist ((((((declarator)->exp.operands[1]))->list.purpose))))
    {
# 915 "../../../kg++fe/gnu/cp/decl2.c"
      ...
      if (!explained)
 {
  ...
  if (declspecs == (tree) ((void *)0)
      && ((enum tree_code) (declarator)->common.code) == SCOPE_REF
      && ((enum tree_code) (((declarator)->exp.operands[1]))->common.code) == IDENTIFIER_NODE)
    {

      if (! ((((enum tree_code) (((declarator)->exp.operands[0]))->common.code)) == RECORD_TYPE || (((enum tree_code) (((declarator)->exp.operands[0]))->common.code)) == UNION_TYPE))
 ;
 ...
 pop_nested_class ();
  ...
  if (init
      && ((enum tree_code) (init)->common.code) == TREE_LIST
      && ((init)->list.value) == global_trees[TI_ERROR_MARK]
      && ((init)->common.chain) == (tree) ((void *)0))
    init = (tree) ((void *)0);

  value = grokdeclarator (declarator, declspecs, FIELD, init != 0, &attrlist);
  if (! value || value == global_trees[TI_ERROR_MARK])

    return value;
  if (((value)->common.type) == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];

  if (((enum tree_code) (value)->common.code) == TYPE_DECL && init)
    {
  ...
  if (((enum tree_code) (value)->common.code) == VOID_TYPE)
    return global_trees[TI_VOID_TYPE];

  if (((value)->decl.name) != (tree) ((void *)0)
      && ((char *)(((value)->decl.name))->identifier.id.str)[0] == '_'
      && ! strcmp (((char *)(((value)->decl.name))->identifier.id.str), "_vptr"))
    error ("member `%D' conflicts with virtual function table field name",
       value);


  if (((enum tree_code) (value)->common.code) == TYPE_DECL)
    {
      ((value)->decl.nonlocal_flag) = 1;
      ((value)->decl.context) = scope_chain->class_type;

      if ((((((enum tree_code) (((value)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((value)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((value)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((value)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((value)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((value)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((value)->common.type))->type.lang_flag_5))))
        ((&((((value)->common.type))->type.lang_specific)->u.c)->got_semicolon) = 1;
 ...
 value = push_template_decl (value);
  ...
  if (init)
    {
      if (((enum tree_code) (value)->common.code) == FUNCTION_DECL)
 {
   grok_function_init (value, init);
   init = (tree) ((void *)0);
 }
      else if (pedantic && ((enum tree_code) (value)->common.code) != VAR_DECL)
      ...
      else
 {
  ...
  init = digest_init (((value)->common.type), init, (tree *)0);
     }

   if (!scope_chain->x_processing_template_decl)
     {
       if (((enum tree_code) (init)->common.code) == CONST_DECL)
  init = ((init)->decl.initial);
  ...
  init = digest_init (((value)->common.type), init, (tree *)0);
       if (init != global_trees[TI_ERROR_MARK] && ! ((init)->common.constant_flag))
  {



    if (((enum tree_code) (((value)->common.type))->common.code) != REFERENCE_TYPE
        || (((init)->common.static_flag) == 0
     && (!(tree_code_type[(int) (((enum tree_code) (init)->common.code))] == 'd') || ((init)->decl.external_flag) == 0)))
      {
  ...
  if (scope_chain->x_processing_template_decl
      && (((enum tree_code) (value)->common.code) == VAR_DECL || ((enum tree_code) (value)->common.code) == FUNCTION_DECL))
    value = push_template_decl (value);

  if (attrlist)
    cplus_decl_attributes (&value, attrlist, 0);

  if (((enum tree_code) (value)->common.code) == VAR_DECL)
    {
      finish_static_data_member_decl (value, init, asmspec_tree,
          flags);
      return value;
    }
  if (((enum tree_code) (value)->common.code) == FIELD_DECL)
    {
      if (asmspec)
 error ("`asm' specifiers are not permitted on non-static data members");
      if (((value)->decl.initial) == global_trees[TI_ERROR_MARK])
 init = global_trees[TI_ERROR_MARK];
      cp_finish_decl (value, init, (tree) ((void *)0), flags);
      ((value)->decl.initial) = init;
      (((value)->decl.lang_flag_3)) = 1;
      return value;
    }
  if (((enum tree_code) (value)->common.code) == FUNCTION_DECL)
    {
      if (asmspec)
 {
   ...
   ((value)->decl.rtl = ((rtx) 0));
   ((value)->decl.assembler_name = ((__builtin_constant_p (asmspec) ? get_identifier_with_length ((asmspec), (unsigned) strlen (asmspec)) : (get_identifier) (asmspec))));
 }
      if (!(((value)->decl.lang_specific)->decl_flags.friend_attr))
 ...
 return global_trees[TI_VOID_TYPE];
  ...
  fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 1086, __FUNCTION__);
     ...
     tree declarator, declspecs, width;
{
  ...
  if (((value)->common.static_flag))
    {
      error ("static member `%D' cannot be a bit-field", value);
      return (tree) ((void *)0);
    }
  cp_finish_decl (value, (tree) ((void *)0), (tree) ((void *)0), 0);

  if (width != global_trees[TI_ERROR_MARK])
    {
...
grokoptypename (declspecs, declarator, scope)
     ...
     tree scope;
{
  tree t = grokdeclarator (declarator, declspecs, TYPENAME, 0, ((void *)0));



  if (scope && scope_chain->template_parms
      ...
      && uses_template_parms (scope))
    {
      ...
      push_scope (scope);
      t = tsubst (t, args, tf_error | tf_warning, (tree) ((void *)0));
      pop_scope (scope);
    }

  return mangle_conv_op_name_for_type (t);
}
# 1210 "../../../kg++fe/gnu/cp/decl2.c"
static void
     ...
     tree init;
{
  ...
  if (((enum tree_code) (type)->common.code) == FUNCTION_TYPE)
    ...
    (((decl)->decl.lang_specific)->decl_flags.pure_virtual) = 1;
  else
     ...
     int flags;
{
  ...
  if (((enum tree_code) (*decl)->common.code) == TYPE_DECL)
    (((((*decl)->decl.name))->common.type) = (((*decl)->common.type)));
}
...
constructor_name_full (thing)
     tree thing;
{
  if (((enum tree_code) (thing)->common.code) == TEMPLATE_TYPE_PARM
      || ((enum tree_code) (thing)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM
      || ((enum tree_code) (thing)->common.code) == TYPENAME_TYPE)
    thing = ((thing)->type.name);
  else if (((((enum tree_code) (thing)->common.code)) == RECORD_TYPE || (((enum tree_code) (thing)->common.code)) == UNION_TYPE))
    {
      if (((&((thing)->type.lang_specific)->u.c)->was_anonymous) && (((thing)->type.lang_flag_1)))
 thing = ((((((enum tree_code) (((((&((thing)->type.lang_specific)->u.c)->methods))->vec.a[0]))->common.code) == OVERLOAD) ? (((struct tree_overload*)(((((&((thing)->type.lang_specific)->u.c)->methods))->vec.a[0])))->function) : (((((&((thing)->type.lang_specific)->u.c)->methods))->vec.a[0]))))->decl.name);
      else
 thing = ((thing)->type.name);
    }
  if (((enum tree_code) (thing)->common.code) == TYPE_DECL
      || (((enum tree_code) (thing)->common.code) == TEMPLATE_DECL
   && ((enum tree_code) (((thing)->decl.result))->common.code) == TYPE_DECL))
    thing = ((thing)->decl.name);
  (void) (((((enum tree_code) (thing)->common.code) == IDENTIFIER_NODE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 1269, __FUNCTION__), 0) : 0);
  return thing;
}
     ...
     tree thing;
{
  ...
  t = (((struct lang_identifier*)(thing))->class_template_info);
  if (!t)
    return thing;
  return t;
}
...
defer_fn (fn)
     tree fn;
{
  if ((((fn)->decl.lang_specific)->decl_flags.deferred))
    return;
  (((fn)->decl.lang_specific)->decl_flags.deferred) = 1;
  if (!deferred_fns)
    deferred_fns = varray_init (32, VARRAY_DATA_TREE, "deferred_fns");

  do { if ((deferred_fns)->elements_used >= (deferred_fns)->num_elements) (((deferred_fns)) = varray_grow ((deferred_fns), 2 * (deferred_fns)->num_elements)); (deferred_fns)->data.tree[(deferred_fns)->elements_used++] = (fn); } while (0);
}
# 1324 "../../../kg++fe/gnu/cp/decl2.c"
static tree
build_anon_union_vars (anon_decl, elems, static_p, external_p)
     ...
     int external_p;
{
  tree type = ((anon_decl)->common.type);
  tree main_decl = (tree) ((void *)0);
  tree field;
  ...
  for (field = ((type)->type.values);
       field != (tree) ((void *)0);
       field = ((field)->common.chain))
    {
      tree decl;

      if (((field)->decl.artificial_flag))
 continue;
      if (((enum tree_code) (field)->common.code) != FIELD_DECL)
 {
   ...
   continue;
      ...
      if (((field)->common.private_flag))
 cp_pedwarn_at ("private member `%#D' in anonymous union", field);
      else if (((field)->common.protected_flag))
   ...
   && ((((((enum tree_code) (((field)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((field)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((field)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((field)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((field)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((field)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((field)->common.type))->type.lang_flag_5))) && (&((((field)->common.type))->type.lang_specific)->u.c)->anon_aggr))
 {
   ...
   if (!decl)
     continue;
      ...
      else if (((field)->decl.name) == (tree) ((void *)0))
 continue;
      else
 {
   decl = build_decl (VAR_DECL, ((field)->decl.name), ((field)->common.type));

   ((decl)->decl.initial) = global_trees[TI_ERROR_MARK];
   ((decl)->common.public_flag) = 0;
   ((decl)->common.static_flag) = static_p;
   ((decl)->decl.external_flag) = external_p;
   decl = pushdecl (decl);
   ((decl)->decl.initial) = (tree) ((void *)0);
      ...
      if (main_decl == (tree) ((void *)0)
   || tree_int_cst_lt (((main_decl)->decl.size), ((decl)->decl.size)))
 {
   if (main_decl)
     ((main_decl)->common.asm_written_flag) = 1;
   main_decl = decl;
 }
      else
 ...
 continue;
      ...
      *elems = tree_cons ((tree) ((void *)0), decl, *elems);
      ((*elems)->common.type) = type;
    }
...
{
  tree type = ((anon_union_decl)->common.type);
  tree main_decl;
  int public_p = ((anon_union_decl)->common.public_flag);
  int static_p = ((anon_union_decl)->common.static_flag);
  int external_p = ((anon_union_decl)->decl.external_flag);


  ((anon_union_decl)->decl.context) = ((((type)->type.name))->decl.context);
 ...
 = build_anon_union_vars (anon_union_decl,
     &(((anon_union_decl))->decl.arguments),
     static_p, external_p);
      ...
      if (static_p)
 {
   ...
   ((anon_union_decl)->decl.rtl = (main_decl)->decl.rtl);
     ...
     tree align_type;
{
  ...
  ((type)->type.values) = fields[0];
  for (i = 0; i < len; i++)
    {
      layout_type (((fields[i])->common.type));
      ((fields[i])->decl.context) = type;
      ((fields[i])->common.chain) = fields[i+1];
    }
  ((fields[i])->decl.context) = type;
  ...
  ((type)->type.name) = build_decl (TYPE_DECL, (__builtin_constant_p (name) ? get_identifier_with_length ((name), (unsigned) strlen (name)) : (get_identifier) (name)), type);
     ...
     tree type;
{
  ...
  (void) (((((enum tree_code) (type)->common.code) == FUNCTION_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 1513, __FUNCTION__), 0) : 0);

  if (!comptypes ((((type)->common.type)), (global_trees[TI_PTR_TYPE]), 0))
    e = 1, error ("`operator new' must return type `%T'", global_trees[TI_PTR_TYPE]);

  if (!args || args == global_trees[TI_VOID_LIST_NODE]
      || !comptypes ((((args)->list.value)), (global_trees[TI_SIZE_TYPE]), 0))
    {
      e = 2;
      if (args && args != global_trees[TI_VOID_LIST_NODE])
        args = ((args)->common.chain);
      pedwarn ("`operator new' takes type `size_t' (`%T') as first parameter", global_trees[TI_SIZE_TYPE]);
    }
  switch (e)
  {
    case 2:
      args = tree_cons ((tree) ((void *)0), global_trees[TI_SIZE_TYPE], args);

    case 1:
      type = build_exception_variant
              (build_function_type (global_trees[TI_PTR_TYPE], args),
               ((type)->type.binfo));
     ...
     tree type;
{
  ...
  (void) (((((enum tree_code) (type)->common.code) == FUNCTION_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 1548, __FUNCTION__), 0) : 0);

  if (!comptypes ((((type)->common.type)), (global_trees[TI_VOID_TYPE]), 0))
    e = 1, error ("`operator delete' must return type `%T'", global_trees[TI_VOID_TYPE]);

  if (!args || args == global_trees[TI_VOID_LIST_NODE]
      || !comptypes ((((args)->list.value)), (global_trees[TI_PTR_TYPE]), 0))
    {
      e = 2;
      if (args && args != global_trees[TI_VOID_LIST_NODE])
        args = ((args)->common.chain);
      error ("`operator delete' takes type `%T' as first parameter", global_trees[TI_PTR_TYPE]);
    }
  switch (e)
  {
    case 2:
      args = tree_cons ((tree) ((void *)0), global_trees[TI_PTR_TYPE], args);

    case 1:
      type = build_exception_variant
              (build_function_type (global_trees[TI_VOID_TYPE], args),
               ((type)->type.binfo));
...
mark_vtable_entries (decl)
     tree decl;
{
  tree entries = (((((decl)->decl.initial)))->exp.operands[1]);

  for (; entries; entries = ((entries)->common.chain))
    {
      tree fnaddr = ((entries)->list.value);
      tree fn;

      if (((enum tree_code) (fnaddr)->common.code) != ADDR_EXPR
   && ((enum tree_code) (fnaddr)->common.code) != FDESC_EXPR)


 continue;

      fn = ((fnaddr)->exp.operands[0]);
      ((fn)->common.addressable_flag) = 1;




      if ((((enum tree_code) (fn)->common.code) == FUNCTION_DECL && ((fn)->decl.lang_flag_7)))
 use_thunk (fn, 0);
      mark_used (fn);
    }
}
     ...
     tree decl;
{
  if (flag_weak)
    ...
    || (((enum tree_code) (decl)->common.code) == VAR_DECL && ((decl)->decl.artificial_flag)))
# 1633 "../../../kg++fe/gnu/cp/decl2.c"
    ((decl)->common.public_flag) = 0;
  else
    {
 ...
 ((decl)->decl.common_flag) = 1;
      else if ((((enum tree_code) (((decl)->decl.initial))->common.code) == CONSTRUCTOR && (((((decl)->decl.initial)))->exp.operands[1]) == (tree) ((void *)0) && ! (((((decl)->decl.initial))->common.lang_flag_4))))
 {
   ((decl)->decl.common_flag) = 1;
   ((decl)->decl.initial) = global_trees[TI_ERROR_MARK];
 }
      else if (!((((decl)->decl.lang_specific)->decl_flags.use_template) == 3))
 {


   ((decl)->decl.external_flag) = 1;
   (((decl)->decl.lang_specific)->decl_flags.not_really_extern) = 0;
 }
    }
  ...
  if (((enum tree_code) (decl)->common.code) == VAR_DECL)
    {
      ...
      ((decl_assembler_name (decl))->common.static_flag) = 1;
    }
}
# 1698 "../../../kg++fe/gnu/cp/decl2.c"
void
import_export_vtable (decl, type, final)
     tree decl, type;
     int final;
{
  if (((decl)->decl.lang_flag_5))
    return;
  ...
  else if (((&((type)->type.lang_specific)->u.c)->interface_unknown == 0))
    {
      ((decl)->common.public_flag) = 1;
      ((decl)->decl.external_flag) = ((&((type)->type.lang_specific)->u.c)->interface_only);
      ((decl)->decl.lang_flag_5) = 1;
    }
  else
    {
      ...
      int found = ((((&((type)->type.lang_specific)->u.c)->use_template) & 1)
     || ((&((type)->type.lang_specific)->u.c)->key_method) != (tree) ((void *)0));
     ...
     tree ctype;
{
  ...
  (void) (((at_eof) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 1754, __FUNCTION__), 0) : 0);

  if (((&((ctype)->type.lang_specific)->u.c)->interface_unknown == 0))
    return;
  ...
  if (((&((ctype)->type.lang_specific)->u.c)->interface_only))
    return;

  if (lookup_attribute ("dllimport", ((ctype)->type.attributes)))
    import_export = -1;
  else if (lookup_attribute ("dllexport", ((ctype)->type.attributes)))
    import_export = 1;
  ...
  if (import_export == 0
      && (((ctype)->common.lang_flag_2)))
    {
      tree method = ((&((ctype)->type.lang_specific)->u.c)->key_method);
      if (method)
 import_export = ((((method)->decl.external_flag) && ! (((method)->decl.lang_specific)->decl_flags.not_really_extern)) ? -1 : 1);
    }
  ...
  if (import_export)
    {
      ((&((ctype)->type.lang_specific)->u.c)->interface_unknown = 0);
      ((&((ctype)->type.lang_specific)->u.c)->interface_only) = (import_export < 0);
    }
}
     ...
     tree vars;
{
  ...
  child_rtx = (((((vars)->decl.rtl ? (vars)->decl.rtl : (make_decl_rtl (vars, ((void *)0)), (vars)->decl.rtl)))->fld[0]).rtx);

  parent = binfo_for_vtable (vars);

  if (parent == ((((vars)->decl.context))->type.binfo))
    parent_rtx = (const_int_rtx[64]);
  else if (parent)
    {
      parent = get_vtbl_decl_for_binfo (((((parent)->common.type))->type.binfo));
      parent_rtx = (((((parent)->decl.rtl ? (parent)->decl.rtl : (make_decl_rtl (parent, ((void *)0)), (parent)->decl.rtl)))->fld[0]).rtx);
    }
  else
    fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 1823, __FUNCTION__);
...
maybe_emit_vtables (tree ctype)
{
  ...
  primary_vtbl = ((&((ctype)->type.lang_specific)->u.c)->vtables);
  if (((primary_vtbl)->common.asm_written_flag))
    return 0;

  if (((primary_vtbl)->common.type) == global_trees[TI_VOID_TYPE])
    return 0;
  ...
  for (vtbl = ((&((ctype)->type.lang_specific)->u.c)->vtables); vtbl; vtbl = ((vtbl)->common.chain))
    if (!((vtbl)->decl.external_flag) && ((at_eof && ((vtbl)->common.public_flag) && !((vtbl)->decl.comdat_flag)) || (((vtbl)->decl.assembler_name != (tree) ((void *)0)) && ((decl_assembler_name (vtbl))->common.static_flag)) || (flag_syntax_only && ((vtbl)->common.used_flag))))
      break;
  ...
  if (!vtbl)
    {
      ...
      if (((primary_vtbl)->decl.comdat_flag)
   && ((&((ctype)->type.lang_specific)->u.c)->debug_requested))
  ...
  for (vtbl = ((&((ctype)->type.lang_specific)->u.c)->vtables); vtbl; vtbl = ((vtbl)->common.chain))
    {
      ...
      if (((((vtbl)->decl.initial))->common.type) == 0)
 store_init_value (vtbl, ((vtbl)->decl.initial));

      if (write_symbols == DWARF_DEBUG || write_symbols == DWARF2_DEBUG)
 {
# 1898 "../../../kg++fe/gnu/cp/decl2.c"
   ((vtbl)->decl.ignored_flag) = 1;
 }
 ...
 comdat_linkage (vtbl);
      ...
      rest_of_decl_compilation (vtbl, ((void *)0), 1, 1);
 ...
 output_vtable_inherit (vtbl);
      ...
      if (flag_syntax_only)
 ((vtbl)->common.asm_written_flag) = 1;
    }
     ...
     tree decl;
{
  ...
  if (((((decl)->decl.lang_specific)->decl_flags.use_template) & 1)
      || (((((decl))->decl.lang_specific) ->decl_flags.u.template_info) && !(((decl)->decl.lang_specific)->decl_flags.use_template)))
    {
      ...
      else
 {
  ...
  else if (((((enum tree_code) (((decl)->common.type))->common.code) == METHOD_TYPE) || (((decl)->decl.lang_specific)->decl_flags.static_function)))
    {
      if (!(((decl)->decl.lang_specific)->decl_flags.base.declared_inline))
 {
   tree ctype = ((decl)->decl.context);
   import_export_class (ctype);
   if (((&((ctype)->type.lang_specific)->u.c)->interface_unknown == 0))
     {
       (((decl)->decl.lang_specific)->decl_flags.not_really_extern)
  = ! (((&((ctype)->type.lang_specific)->u.c)->interface_only)
       || ((((decl)->decl.lang_specific)->decl_flags.base.declared_inline)
    && ! flag_implement_inlines
    && !((decl)->decl.vindex)));

       if (!(((decl)->decl.lang_specific)->decl_flags.not_really_extern))
  ((decl)->decl.external_flag) = 1;


       if (((decl)->decl.artificial_flag) && flag_weak)
  comdat_linkage (decl);
       else
  maybe_make_one_only (decl);
     }
     ...
     int is_in_library;
{
  ...
  if ((((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)) && ((&((type)->type.lang_specific)->u.c)->interface_unknown == 0)
      && (((type)->common.lang_flag_2))



      && flag_rtti)
    {
      (((decl)->decl.lang_specific)->decl_flags.not_really_extern) = !((&((type)->type.lang_specific)->u.c)->interface_only);
      ((decl)->decl.comdat_flag) = 0;
    }
  else
    {
      (((decl)->decl.lang_specific)->decl_flags.not_really_extern) = 1;
     ...
     tree decl;
{
  ...
  (void) (((!(!(((type)->type.lang_flag_4)))) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 2043, __FUNCTION__), 0) : 0);
  ...
  temp = build_delete (((temp)->common.type), temp,
         sfk_complete_destructor,
         (3)|(8)|(512), 0);
  return temp;
}
     ...
     tree decl;
{
  ...
  guard = namespace_binding ((sname), global_namespace);
  if (! guard)
    {
      tree guard_type;
      ...
      guard_type = integer_types[itk_long_long];
      guard = build_decl (VAR_DECL, sname, guard_type);


      ((guard)->common.public_flag) = ((decl)->common.public_flag);
      ((guard)->common.static_flag) = ((decl)->common.static_flag);
      ((guard)->decl.common_flag) = ((decl)->decl.common_flag);
      ((guard)->decl.transparent_union) = ((decl)->decl.transparent_union);
      if (((decl)->common.public_flag))
        ((guard)->decl.weak_flag) = ((decl)->decl.weak_flag);

      ((guard)->decl.artificial_flag) = 1;
      ((guard)->common.used_flag) = 1;
      pushdecl_top_level_and_finish (guard, (tree) ((void *)0));
    }
  return guard;
}
     ...
     tree guard;
{
  ...
  guard = build1 (ADDR_EXPR,
    build_pointer_type (((guard)->common.type)),
    guard);
  guard = build1 (NOP_EXPR,
    build_pointer_type (integer_types[itk_char]),
    guard);
  guard = build1 (INDIRECT_REF, integer_types[itk_char], guard);
     ...
     tree guard;
{
  ...
  guard_value = global_trees[TI_INTEGER_ZERO];
  if (!comptypes ((((guard_value)->common.type)), (((guard)->common.type)), 0))
    guard_value = convert (((guard)->common.type), guard_value);
  return build_binary_op(EQ_EXPR, guard, guard_value, 1);
}
     ...
     tree guard;
{
  ...
  guard = get_guard_bits (guard);
  guard_init = global_trees[TI_INTEGER_ONE];
  if (!comptypes ((((guard_init)->common.type)), (((guard)->common.type)), 0))
    guard_init = convert (((guard)->common.type), guard_init);
     ...
     int method_type, initp;
{
  ...
  start_function (global_trees[TI_VOID_LIST_NODE],
    make_call_declarator (fnname, global_trees[TI_VOID_LIST_NODE], (tree) ((void *)0),
     (tree) ((void *)0)),
    (tree) ((void *)0), 0);



  ((current_function_decl)->common.public_flag) = ! targetm.have_ctors_dtors;


  ((current_function_decl)->common.used_flag) = 1;


  if (method_type == 'I')
    (((current_function_decl)->decl.lang_specific)->decl_flags.global_ctor_p) = 1;
  else
    (((current_function_decl)->decl.lang_specific)->decl_flags.global_dtor_p) = 1;
  ((current_function_decl)->decl.lang_specific)->decl_flags.u2sel = 1;
     ...
     tree body;
{
  ...
  if (targetm.have_ctors_dtors)
    {
      rtx fnsym = (((((fn)->decl.rtl ? (fn)->decl.rtl : (make_decl_rtl (fn, ((void *)0)), (fn)->decl.rtl)))->fld[0]).rtx);
      if (method_type == 'I')
...
start_static_storage_duration_function ()
{
  ...
  tree type;
  tree body;
  char id[sizeof ("__static_initialization_and_destruction") + 1 + 32];



  sprintf (id, "%s_%u", "__static_initialization_and_destruction", ssdf_number++);
  if (ssdf_number == 0)
    {


      sorry ("too many initialization functions required");
      fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 2304, __FUNCTION__);
    }


  parm_types = global_trees[TI_VOID_LIST_NODE];
  parm_types = tree_cons ((tree) ((void *)0), integer_types[itk_int], parm_types);
  parm_types = tree_cons ((tree) ((void *)0), integer_types[itk_int], parm_types);
  type = build_function_type (global_trees[TI_VOID_TYPE], parm_types);


  ssdf_decl = build_lang_decl (FUNCTION_DECL,
          (__builtin_constant_p (id) ? get_identifier_with_length ((id), (unsigned) strlen (id)) : (get_identifier) (id)),
          type);
  ((ssdf_decl)->common.public_flag) = 0;
  ((ssdf_decl)->decl.artificial_flag) = 1;



  if (!ssdf_decls)
    {
      ssdf_decls = varray_init (32, VARRAY_DATA_TREE, "ssdf_decls");
      ...
      get_priority_info (65535);
    }

  do { if ((ssdf_decls)->elements_used >= (ssdf_decls)->num_elements) (((ssdf_decls)) = varray_grow ((ssdf_decls), 2 * (ssdf_decls)->num_elements)); (ssdf_decls)->data.tree[(ssdf_decls)->elements_used++] = (ssdf_decl); } while (0);


  initialize_p_decl = cp_build_parm_decl
    ((__builtin_constant_p ("__initialize_p") ? get_identifier_with_length (("__initialize_p"), (unsigned) strlen ("__initialize_p")) : (get_identifier) ("__initialize_p")), integer_types[itk_int]);
  ((initialize_p_decl)->decl.context) = ssdf_decl;
  ((initialize_p_decl)->common.used_flag) = 1;
  priority_decl = cp_build_parm_decl
    ((__builtin_constant_p ("__priority") ? get_identifier_with_length (("__priority"), (unsigned) strlen ("__priority")) : (get_identifier) ("__priority")), integer_types[itk_int]);
  ((priority_decl)->decl.context) = ssdf_decl;
  ((priority_decl)->common.used_flag) = 1;

  ((initialize_p_decl)->common.chain) = priority_decl;
  ((ssdf_decl)->decl.arguments) = initialize_p_decl;


  pushdecl (ssdf_decl);
# 2365 "../../../kg++fe/gnu/cp/decl2.c"
  start_function ( (tree) ((void *)0),
    ssdf_decl,
              (tree) ((void *)0),
    1);
...
start_static_initialization_or_destruction (decl, initp)
     ...
     int initp;
{
  tree guard_if_stmt = (tree) ((void *)0);
  int priority;
  tree cond;
  tree guard;
  tree init_cond;
...
# 2472 "../../../kg++fe/gnu/cp/decl2.c"
  if (member_p (decl))
    {
      ((current_function_decl)->decl.context) = ((decl)->decl.context);
      (((current_function_decl)->decl.lang_specific)->decl_flags.static_function) = 1;
    }



  guard_if_stmt = begin_if_stmt ();
  cond = build_binary_op(EQ_EXPR, priority_decl, build_int_2_wide ((unsigned long long) (priority), (long long) (0)), 1);


  init_cond = initp ? global_trees[TI_INTEGER_ONE] : global_trees[TI_INTEGER_ZERO];
  init_cond = build_binary_op(EQ_EXPR, initialize_p_decl, init_cond, 1);


  cond = build_binary_op(TRUTH_ANDIF_EXPR, cond, init_cond, 1);
  ...
  if (((decl)->common.public_flag) && (((decl)->decl.common_flag)
      ...
      if (flag_use_cxa_atexit)
 {
   ...
   (void) (((initp) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 2510, __FUNCTION__), 0) : 0);
 ...
 guard_cond
   = build_binary_op(EQ_EXPR, build_unary_op (PREINCREMENT_EXPR, guard, 1), global_trees[TI_INTEGER_ONE], 1);
 ...
 guard_cond
   = build_binary_op(EQ_EXPR, build_unary_op (PREDECREMENT_EXPR, guard, 1), global_trees[TI_INTEGER_ZERO], 1);





      cond = build_binary_op(TRUTH_ANDIF_EXPR, cond, guard_cond, 1);
    }
     ...
     tree guard_if_stmt;
{
  ...
  ((current_function_decl)->decl.context) = (tree) ((void *)0);
  (((current_function_decl)->decl.lang_specific)->decl_flags.static_function) = 0;
}
     ...
     tree decl;
{
  ...
  (void) (((!flag_use_cxa_atexit) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 2606, __FUNCTION__), 0) : 0);
     ...
     tree *vars;
{
  ...
  while (*var)
    {
      tree t = *var;
      tree decl = ((t)->list.value);
      tree init = ((t)->list.purpose);
      ...
      if (decl == global_trees[TI_ERROR_MARK])
 {
   ...
   continue;
      ...
      (void) (((((enum tree_code) (decl)->common.code) == VAR_DECL) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 2648, __FUNCTION__), 0) : 0);
      ...
      if (((decl)->decl.external_flag))
 {
   ...
   && value_member (global_trees[TI_ERROR_MARK], init))
 {
   var = &((t)->common.chain);
   continue;
 }
     ...
     tree vars;
{
  ...
  for (v = vars; v; v = ((v)->common.chain))
    if (! ((((v)->list.value))->common.asm_written_flag))
      rest_of_decl_compilation (((v)->list.value), 0, 1, 1);
}
     ...
     int priority;
{
  ...
  if (ssdf_decls)
    for (i = 0; i < ssdf_decls->elements_used; ++i)
      {
 arguments = tree_cons ((tree) ((void *)0), build_int_2_wide ((unsigned long long) (priority), (long long) (0)),
          (tree) ((void *)0));
 arguments = tree_cons ((tree) ((void *)0), build_int_2_wide ((unsigned long long) (constructor_p), (long long) (0)),
          arguments);
 finish_expr_stmt (build_function_call (((ssdf_decls)->data.tree[i]),
            arguments));
      }
  ...
  if (priority == 65535)
    ...
    fns;
    fns = ((fns)->common.chain))
 finish_expr_stmt (build_function_call (((fns)->list.value), (tree) ((void *)0)));
    }
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  if (pi->initializations_p
      || (priority == 65535 && static_ctors))
    generate_ctor_or_dtor_function ( 1,
        priority);
  if (pi->destructions_p
      || (priority == 65535 && static_dtors))
...
finish_file ()
{
  ...
  if (! global_bindings_p () || scope_chain->class_type || scope_chain->decl_ns_list)
    return;
  ...
  do
    {
      ...
      while (cp_global_trees[CPTI_KEYED_CLASSES] != (tree) ((void *)0)
         && maybe_emit_vtables (((cp_global_trees[CPTI_KEYED_CLASSES])->list.value)))
    {
       reconsider = 1;
      cp_global_trees[CPTI_KEYED_CLASSES] = ((cp_global_trees[CPTI_KEYED_CLASSES])->common.chain);
    }

      t = cp_global_trees[CPTI_KEYED_CLASSES];
      if (t != (tree) ((void *)0))
    {
      tree next = ((t)->common.chain);

      while (next)
        {
          if (maybe_emit_vtables (((next)->list.value)))
     {
       reconsider = 1;
       ((t)->common.chain) = ((next)->common.chain);
     }
          else
     t = next;
      ...
      if (walk_globals (unemitted_tinfo_decl_p, emit_tinfo_decl, 0))
 reconsider = 1;
...
# 2881 "../../../kg++fe/gnu/cp/decl2.c"
   ...
   for (v = vars; v; v = ((v)->common.chain))
     do_static_initialization (((v)->list.value),
          ((v)->list.purpose));
   ...
   if (!flag_use_cxa_atexit)
     {
       vars = nreverse (vars);
       for (v = vars; v; v = ((v)->common.chain))
  do_static_destruction (((v)->list.value));
     }
   else
     vars = (tree) ((void *)0);
   ...
   reconsider = 1;
      ...
      for (i = 0; i < (deferred_fns ? deferred_fns->elements_used : 0); ++i)
 {
   tree decl = ((deferred_fns)->data.tree[i]);


   if (((decl)->decl.artificial_flag) && ! ((decl)->decl.initial)
       && ((decl)->common.used_flag)
       && (! (((decl)->decl.external_flag) && ! (((decl)->decl.lang_specific)->decl_flags.not_really_extern)) || ((decl)->decl.inline_flag)))
     {
   ...
   import_export_decl (decl);
# 2957 "../../../kg++fe/gnu/cp/decl2.c"
   if ((((decl)->decl.lang_specific)->decl_flags.not_really_extern)
       && ((decl)->decl.initial)
       && ((at_eof && ((decl)->common.public_flag) && !((decl)->decl.comdat_flag)) || (((decl)->decl.assembler_name != (tree) ((void *)0)) && ((decl_assembler_name (decl))->common.static_flag)) || (flag_syntax_only && ((decl)->common.used_flag))))
     ((decl)->decl.external_flag) = 0;
   ...
   if (!((decl)->decl.external_flag)
       ...
       && !((decl)->common.asm_written_flag))
     {
       ...
       saved_not_really_extern = (((decl)->decl.lang_specific)->decl_flags.not_really_extern);


       expand_body (decl);

       ((decl)->decl.external_flag) = 0;
       (((decl)->decl.lang_specific)->decl_flags.not_really_extern) = saved_not_really_extern;
  ...
  ((decl)->common.asm_written_flag) = 1;
      ...
      if ((deferred_fns ? deferred_fns->elements_used : 0)
   && wrapup_global_declarations (&((deferred_fns)->data.tree[0]),
 ...
 reconsider = 1;
      ...
      for (i = 0; i < (pending_statics ? pending_statics->elements_used : 0); ++i)
 {
   tree decl = ((pending_statics)->data.tree[i]);
   if (((decl)->common.asm_written_flag))
     continue;
   import_export_decl (decl);
   if ((((decl)->decl.lang_specific)->decl_flags.not_really_extern) && ! (((decl)->decl.lang_flag_3)))
     ((decl)->decl.external_flag) = 0;
 }
      if (pending_statics
   && wrapup_global_declarations (&((pending_statics)->data.tree[0]),
  ...
  for (i = 0; i < (deferred_fns ? deferred_fns->elements_used : 0); ++i)
    {
      ...
      if (((decl)->common.used_flag) && (((decl)->decl.lang_specific)->decl_flags.base.declared_inline)
   && !(((decl)->common.asm_written_flag) || ((decl)->decl.saved_tree)



        || ((((decl)->decl.lang_specific)->decl_flags.use_template) == 3)))
 ...
 generate_ctor_or_dtor_function ( 0,
  ...
  if (pending_statics)
    check_global_declarations (&((pending_statics)->data.tree[0]),
          (pending_statics ? pending_statics->elements_used : 0));
...

  {
    ...
    if (stream)
      {
 dump_node (global_namespace, flags & ~(1 << 1), stream);
...
# 3111 "../../../kg++fe/gnu/cp/decl2.c"
tree
reparse_absdcl_as_expr (type, decl)
     tree type, decl;
{

  if (((decl)->exp.operands[0]) == (tree) ((void *)0))
    return build_functional_cast (type, (tree) ((void *)0));


  decl = reparse_absdcl_as_expr (type, ((decl)->exp.operands[0]));

  return finish_call_expr (decl, (tree) ((void *)0), 0);
}
# 3133 "../../../kg++fe/gnu/cp/decl2.c"
tree
     ...
     tree decl, expr;
{
  ...
  if (((enum tree_code) (expr)->common.code) == CONSTRUCTOR
      && ((expr)->common.type) == 0)
    {
      type = groktypename ((((((((decl)->exp.operands[1]))->list.purpose)))->list.value));
   ...
   if (((enum tree_code) (type)->common.code) == ARRAY_TYPE && !(((type)->type.size) != (tree) ((void *)0)))
     {
       ...
       (void) (((!failure) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3154, __FUNCTION__), 0) : 0);
     }
 }
    }
 ...
 non_void_p = 1;
  ...
  if (warn_old_style_cast && ! in_system_header
      && non_void_p && scope_chain->lang_name != cp_global_trees[CPTI_LANG_NAME_C])
     ...
     tree t;
{
  ...
  switch (((enum tree_code) (t)->common.code))
    ...
    case IDENTIFIER_NODE:
      return do_identifier (t, 0, (tree) ((void *)0));

    case LOOKUP_EXPR:
      if (((t)->common.lang_flag_0))
 {
   tree token = ((t)->exp.operands[0]);
   return do_scoped_id (token, namespace_binding ((token), global_namespace));
 }
      else
 return do_identifier (((t)->exp.operands[0]), 0, (tree) ((void *)0));
 ...
 template = build_expr_from_tree (((t)->exp.operands[0]));
 args = build_expr_from_tree (((t)->exp.operands[1]));

 if (((enum tree_code) (template)->common.code) == COMPONENT_REF)
   {
     object = ((template)->exp.operands[0]);
     template = ((template)->exp.operands[1]);
   }
 else
   object = (tree) ((void *)0);
 ...
 if (object)
   return build (COMPONENT_REF, ((template)->common.type),
   object, template);
 else
   return template;
      }
 ...
 (build_expr_from_tree (((t)->exp.operands[0])), "unary *");

    case CAST_EXPR:
      return build_functional_cast
 (((t)->common.type), build_expr_from_tree (((t)->exp.operands[0])));
 ...
 (((t)->common.type), build_expr_from_tree (((t)->exp.operands[0])));
    ...
    case IMAGPART_EXPR:
      if (((t)->common.type))
 return t;
      return build_x_unary_op (((enum tree_code) (t)->common.code),
          build_expr_from_tree (((t)->exp.operands[0])));
 ...
 (((enum tree_code) (t)->common.code),
  build_expr_from_tree (((t)->exp.operands[0])),
  build_expr_from_tree (((t)->exp.operands[1])));
 ...
 (build_expr_from_tree (((t)->exp.operands[0])),
  build_expr_from_tree (((t)->exp.operands[1])));
    ...
    case SCOPE_REF:
      return build_offset_ref (((t)->exp.operands[0]), ((t)->exp.operands[1]));

    case ARRAY_REF:
      if (((t)->exp.operands[0]) == (tree) ((void *)0))

 return build_nt (ARRAY_REF, (tree) ((void *)0),
    build_expr_from_tree (((t)->exp.operands[1])));
      return grok_array_decl (build_expr_from_tree (((t)->exp.operands[0])),
         build_expr_from_tree (((t)->exp.operands[1])));

    case SIZEOF_EXPR:
    case ALIGNOF_EXPR:
      {
 tree r = build_expr_from_tree (((t)->exp.operands[0]));
 if (!(tree_code_type[(int) (((enum tree_code) (r)->common.code))] == 't'))
   return ((enum tree_code) (t)->common.code) == SIZEOF_EXPR ? expr_sizeof (r) : c_alignof_expr (r);
 else
   return cxx_sizeof_or_alignof_type (r, ((enum tree_code) (t)->common.code), 1);
      }

    case MODOP_EXPR:
      return build_x_modify_expr
 (build_expr_from_tree (((t)->exp.operands[0])),
  ((enum tree_code) (((t)->exp.operands[1]))->common.code),
  build_expr_from_tree (((t)->exp.operands[2])));
 ...
 (build_expr_from_tree (((t)->exp.operands[0])),
  build_expr_from_tree (((t)->exp.operands[1])),
  build_expr_from_tree (((t)->exp.operands[2])),
  ((t)->common.lang_flag_0));

    case DELETE_EXPR:
      return delete_sanity
 (build_expr_from_tree (((t)->exp.operands[0])),
  build_expr_from_tree (((t)->exp.operands[1])),
  ((t)->common.lang_flag_1), ((t)->common.lang_flag_0));

    case COMPOUND_EXPR:
      if (((t)->exp.operands[1]) == (tree) ((void *)0))
 return build_x_compound_expr
   (build_expr_from_tree (((t)->exp.operands[0])));
      else
 fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3355, __FUNCTION__);

    case METHOD_CALL_EXPR:
      if (((enum tree_code) (((t)->exp.operands[0]))->common.code) == SCOPE_REF)
 {
   tree ref = ((t)->exp.operands[0]);
   tree name = ((ref)->exp.operands[1]);

   if (((enum tree_code) (name)->common.code) == TEMPLATE_ID_EXPR)
     name = build_nt (TEMPLATE_ID_EXPR,
                      ((name)->exp.operands[0]),
                      build_expr_from_tree (((name)->exp.operands[1])));

   return build_scoped_method_call
     (build_expr_from_tree (((t)->exp.operands[1])),
      build_expr_from_tree (((ref)->exp.operands[0])),
      name,
      build_expr_from_tree (((t)->exp.operands[2])));
 }
      else
...
# 3387 "../../../kg++fe/gnu/cp/decl2.c"
      ...
      if (((enum tree_code) (((t)->exp.operands[0]))->common.code) == SCOPE_REF)
 {
   ...
   scope = build_expr_from_tree (((ref)->exp.operands[0]));
   args = build_expr_from_tree (((t)->exp.operands[1]));
      ...
      else
 {
   tree name = ((t)->exp.operands[0]);
          tree id;
          tree args = build_expr_from_tree (((t)->exp.operands[1]));
          if (args != (tree) ((void *)0) && ((enum tree_code) (name)->common.code) == LOOKUP_EXPR
              && !((name)->common.lang_flag_0)
              && ((enum tree_code) ((id = ((name)->exp.operands[0])))->common.code) == IDENTIFIER_NODE
              && (!scope_chain->class_type
                  || !lookup_member (scope_chain->class_type, id, 0, 0)))
            {

              name = do_identifier (id, 0, args);
            }
          else if (((enum tree_code) (name)->common.code) == TEMPLATE_ID_EXPR
     || ! really_overloaded_fn (name))
     name = build_expr_from_tree (name);

   if (((enum tree_code) (name)->common.code) == OFFSET_REF)
     return build_offset_ref_call_from_tree (name, args);
   if (((enum tree_code) (name)->common.code) == COMPONENT_REF)
     return finish_object_call_expr (((name)->exp.operands[1]),
         ((name)->exp.operands[0]),
         args);
 ...
 return tree_cons (purpose, value, chain);
    ...
    case COMPONENT_REF:
      {
 tree object = build_expr_from_tree (((t)->exp.operands[0]));
 return finish_class_member_access_expr (object,
      ((t)->exp.operands[1]));
      }

    case THROW_EXPR:
      return build_throw (build_expr_from_tree (((t)->exp.operands[0])));
 ...
 if (type && (((enum tree_code) (type)->common.code) == RECORD_TYPE && ((type)->type.lang_specific) && ((&((type)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
   return t;
 ...
 purpose_p = !(type && (((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)));
 for (elts = (((t))->exp.operands[1]); elts; elts = ((elts)->common.chain))
   {
     tree purpose = ((elts)->list.purpose);
     tree value = ((elts)->list.value);
 ...
 r = build_nt (CONSTRUCTOR, (tree) ((void *)0), nreverse (r));
 ...
 return r;
    ...
    case TYPEID_EXPR:
      if ((tree_code_type[(int) (((enum tree_code) (((t)->exp.operands[0]))->common.code))] == 't'))
 return get_typeid (((t)->exp.operands[0]));
      return build_typeid (build_expr_from_tree (((t)->exp.operands[0])));

    case VAR_DECL:
      return convert_from_reference (t);

    case VA_ARG_EXPR:
      return build_va_arg (build_expr_from_tree (((t)->exp.operands[0])),
      ((t)->common.type));
...
build_offset_ref_call_from_tree (tree fn, tree args)
{
  ...
  (void) (((((enum tree_code) (fn)->common.code) == OFFSET_REF) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3549, __FUNCTION__), 0) : 0);
# 3567 "../../../kg++fe/gnu/cp/decl2.c"
  if (((enum tree_code) (((fn)->exp.operands[1]))->common.code) == FIELD_DECL)
    fn = resolve_offset_ref (fn);
  else
    {
      object_addr = build_unary_op (ADDR_EXPR, ((fn)->exp.operands[0]), 0);
      fn = ((fn)->exp.operands[1]);
      fn = get_member_function_from_ptrfunc (&object_addr, fn);
      args = tree_cons ((tree) ((void *)0), object_addr, args);
    }
...
tree
build_call_from_tree (tree fn, tree args, _Bool disallow_virtual)
{
  tree template_args;
  tree template_id;
  tree f;
  ...
  (void) (((((enum tree_code) (fn)->common.code) != OFFSET_REF) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3593, __FUNCTION__), 0) : 0);
  (void) (((((enum tree_code) (fn)->common.code) != SCOPE_REF) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3594, __FUNCTION__), 0) : 0);
  ...
  if (((enum tree_code) (fn)->common.code) == TEMPLATE_ID_EXPR)
    {
      template_id = fn;
      template_args = ((fn)->exp.operands[1]);
      fn = ((fn)->exp.operands[0]);
    }
  else
    {
      template_id = (tree) ((void *)0);
      template_args = (tree) ((void *)0);
    }

  f = (((enum tree_code) (fn)->common.code) == OVERLOAD) ? get_first_fn (fn) : fn;


  if (scope_chain->class_type
      && ((((enum tree_code) (f)->common.code) == FUNCTION_DECL
    && ((((enum tree_code) (((f)->common.type))->common.code) == METHOD_TYPE) || (((f)->decl.lang_specific)->decl_flags.static_function)))
   || ((((enum tree_code) (f)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((f)->decl.result))->common.code) == FUNCTION_DECL)
       && ((((enum tree_code) (((f)->common.type))->common.code) == METHOD_TYPE) || (((f)->decl.lang_specific)->decl_flags.static_function)))))
    {
      f = lookup_member (scope_chain->class_type, ((f)->decl.name),
                1, 0);
      if (f)
 fn = f;
    }
  ...
  if (template_id)
   ...
   ((((fn))->exp.operands[1])) = build_nt (TEMPLATE_ID_EXPR,
           ((((fn))->exp.operands[1])),
           template_args);
      else
 fn = template_id;
     ...
     tree type, decl;
{
  ...
  if (type)
    return build_functional_cast (type, build_tree_list ((tree) ((void *)0), decl));
  else
    return decl;
}
     ...
     tree decl;
{
 ...
 ((tree) ((void *)0), finish_decl_parsing (((decl)->exp.operands[0])));
    case ADDR_EXPR:
      return make_reference_declarator
 ((tree) ((void *)0), finish_decl_parsing (((decl)->exp.operands[0])));
    case BIT_NOT_EXPR:
      ((decl)->exp.operands[0]) = finish_decl_parsing (((decl)->exp.operands[0]));
      return decl;
    case SCOPE_REF:
      push_nested_class (((((decl)->exp.operands[0]))->common.type), 3);
      ((decl)->exp.complexity) = current_class_depth;
      return decl;
    case ARRAY_REF:
      ((decl)->exp.operands[0]) = finish_decl_parsing (((decl)->exp.operands[0]));
      return decl;
    case TREE_LIST:
      ...
      ((decl)->list.value) = finish_decl_parsing (((decl)->list.value));
      return decl;
    case TEMPLATE_ID_EXPR:
      return decl;
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3694, __FUNCTION__);
      return (tree) ((void *)0);
    }
}
...
{
  (void) ((((((enum tree_code) (root)->common.code) == NAMESPACE_DECL || ((enum tree_code) (root)->common.code) == FUNCTION_DECL || (((((enum tree_code) (root)->common.code)) == RECORD_TYPE || (((enum tree_code) (root)->common.code)) == UNION_TYPE) && (((enum tree_code) (root)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (root)->common.code) == TYPENAME_TYPE || ((enum tree_code) (root)->common.code) == TYPEOF_TYPE || ((enum tree_code) (root)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((root)->type.lang_flag_5))))) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3707, __FUNCTION__), 0) : 0);


  (void) ((((((enum tree_code) (child)->common.code) == NAMESPACE_DECL || ((enum tree_code) (root)->common.code) == FUNCTION_DECL || (((((enum tree_code) (child)->common.code)) == RECORD_TYPE || (((enum tree_code) (child)->common.code)) == UNION_TYPE) && (((enum tree_code) (child)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (child)->common.code) == TYPENAME_TYPE || ((enum tree_code) (child)->common.code) == TYPEOF_TYPE || ((enum tree_code) (child)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((child)->type.lang_flag_5))))) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3711, __FUNCTION__), 0) : 0);
 ...
 return 1;
      ...
      if ((tree_code_type[(int) (((enum tree_code) (child)->common.code))] == 't'))
 child = ((child)->type.name);
      child = ((child)->decl.context);
    }
}
     ...
     tree ns1, ns2;
{
  ...
  if (is_ancestor (ns1, ns2))
    return (timevar_pop (TV_NAME_LOOKUP), (ns1));
  return (timevar_pop (TV_NAME_LOOKUP), (namespace_ancestor ((((ns1)->decl.context) ? ((ns1)->decl.context) : global_namespace), ns2)));
     ...
     int indirect;
{
  ...
  (void) (((((enum tree_code) (user)->common.code) == NAMESPACE_DECL) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3760, __FUNCTION__), 0) : 0);
  (void) (((((enum tree_code) (used)->common.code) == NAMESPACE_DECL) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3761, __FUNCTION__), 0) : 0);

  t = purpose_member (used, (((user))->decl.vindex));
  if (t != (tree) ((void *)0))
    {
      if (!indirect)

 ((t)->common.lang_flag_0) = 0;
      return (timevar_pop (TV_NAME_LOOKUP), ((void)0));
    }
  ...
  (((((user))->decl.vindex))->common.lang_flag_0) = indirect;


  (((used))->decl.initial)
    = tree_cons (user, 0, (((used))->decl.initial));


  for (t = (((used))->decl.vindex); t; t = ((t)->common.chain))

    add_using_namespace (user, ((t)->list.purpose), 1);


  for (t = (((user))->decl.initial); t; t = ((t)->common.chain))
    add_using_namespace (((t)->list.purpose), used, 1);
  timevar_pop (TV_NAME_LOOKUP);
}
# 3801 "../../../kg++fe/gnu/cp/decl2.c"
static tree
merge_functions (s1, s2)
     tree s1;
     tree s2;
{
  for (; s2; s2 = ((((enum tree_code) (s2)->common.code) == OVERLOAD) ? ((s2)->common.chain) : (tree) ((void *)0)))
    {
      tree fn2 = ((((enum tree_code) (s2)->common.code) == OVERLOAD) ? (((struct tree_overload*)(s2))->function) : (s2));
      tree fns1;

      for (fns1 = s1; fns1; fns1 = ((((enum tree_code) (fns1)->common.code) == OVERLOAD) ? ((fns1)->common.chain) : (tree) ((void *)0)))
 {
   tree fn1 = ((((enum tree_code) (fns1)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fns1))->function) : (fns1));
   ...
   if (fn1 == fn2
       || (((((fn1)->decl.lang_specific) ? ((fn1)->decl.lang_specific)->decl_flags.language : (((enum tree_code) (fn1)->common.code) == FUNCTION_DECL ? lang_c : lang_cplusplus)) == lang_c) && ((((fn2)->decl.lang_specific) ? ((fn2)->decl.lang_specific)->decl_flags.language : (((enum tree_code) (fn2)->common.code) == FUNCTION_DECL ? lang_c : lang_cplusplus)) == lang_c)
    && ((fn1)->decl.name) == ((fn2)->decl.name)))
     break;
 }
...
# 3840 "../../../kg++fe/gnu/cp/decl2.c"
static cxx_binding *
ambiguous_decl (tree name, cxx_binding *old, cxx_binding *new, int flags)
{
  tree val, type;
  (void) (((old != ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 3844, __FUNCTION__), 0) : 0);

  val = ((new)->value);
  if (val)
    switch (((enum tree_code) (val)->common.code))
      {
      case TEMPLATE_DECL:
      ...
      case FUNCTION_DECL:
        ...
        if (((flags) & (6144)) || ((((val))->decl.lang_specific)->decl_flags.anticipated_p))
          val = (tree) ((void *)0);
        break;
      default:
        if (((flags) & (6144)))
  ...
  if (!((old)->value))
    ...
    {
      if (is_overloaded_fn (((old)->value))
   && is_overloaded_fn (val))
 {
   ((old)->value) = merge_functions (((old)->value),
       val);
 }
      else
 {
       ...
       if (((old)->value) != global_trees[TI_ERROR_MARK])
  {
   ...
   ((old)->value) = global_trees[TI_ERROR_MARK];
 }
    }
      ...
      if (flags & (2))
        {
          ...
          cp_error_at ("  first type here", ((old)->type));
          cp_error_at ("  other type here", type);
        }
    }
  return old;
}
# 3929 "../../../kg++fe/gnu/cp/decl2.c"
_Bool
                        ...
                        tree scope, int flags, tree *spacesp)
{
  ...
  for (iter = usings; iter; iter = ((iter)->common.chain))
    if (((iter)->list.value) == scope)
      {
 if (spacesp)
   *spacesp = tree_cons (((iter)->list.purpose), (tree) ((void *)0),
    *spacesp);
 val1 = cxx_scope_find_binding_for_name (((iter)->list.purpose), name);

        if (val1)
          val = ambiguous_decl (name, val, val1, flags);
      }
  return (timevar_pop (TV_NAME_LOOKUP), (((val)->value) != global_trees[TI_ERROR_MARK]));
                                  ...
                                  int flags)
{
  ...
  tree seen = (tree) ((void *)0);

  tree todo = (tree) ((void *)0);
  tree usings;
  timevar_push (TV_NAME_LOOKUP);

  scope = ((((scope))->decl.abstract_origin) ? (((scope))->decl.abstract_origin) : (scope));
  while (scope && result->value != global_trees[TI_ERROR_MARK])
    {
      ...
      if (b)
        {
          seen = tree_cons (scope, (tree) ((void *)0), seen);
          result = ambiguous_decl (name, result, b, flags);
        }
      if (!((result)->value) && !((result)->type))

 for (usings = (((scope))->decl.vindex); usings;
      usings = ((usings)->common.chain))

   if (!((usings)->common.lang_flag_0)
       && !purpose_member (((usings)->list.purpose), seen))
     todo = tree_cons (((usings)->list.purpose), (tree) ((void *)0), todo);
      if (todo)
 {
   scope = ((todo)->list.purpose);
   todo = ((todo)->common.chain);
 }
      else
 scope = (tree) ((void *)0);
    }
  return (timevar_pop (TV_NAME_LOOKUP), (result->value != global_trees[TI_ERROR_MARK]));
}
     ...
     int friendp;
{
  ...
  if (!friendp && !is_ancestor (scope_chain->old_namespace, scope))
    error ("declaration of `%D' not in a namespace surrounding `%D'",
       decl, scope);
  ((decl)->decl.context) = ((scope) == global_namespace ? (tree) ((void *)0) : (scope));
  if (scope != scope_chain->old_namespace)
    {

      old = namespace_binding (((decl)->decl.name), scope);
      if (!old)
 ...
 goto complain;
      if (scope_chain->x_processing_template_decl || scope_chain->x_processing_specialization)




 return;
      for (; old; old = ((((enum tree_code) (old)->common.code) == OVERLOAD) ? ((old)->common.chain) : (tree) ((void *)0)))
 if (decls_match (decl, ((((enum tree_code) (old)->common.code) == OVERLOAD) ? (((struct tree_overload*)(old))->function) : (old))))
   return;
    }
  else
    return;
     ...
     tree decl;
{
  ...
  while (((decl)->decl.context))
    {
      decl = ((decl)->decl.context);
      if (((enum tree_code) (decl)->common.code) == NAMESPACE_DECL)
 return (timevar_pop (TV_NAME_LOOKUP), (decl));
      if ((tree_code_type[(int) (((enum tree_code) (decl)->common.code))] == 't'))
 decl = ((decl)->common.chain);
      (void) ((((tree_code_type[(int) (((enum tree_code) (decl)->common.code))] == 'd')) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 4071, __FUNCTION__), 0) : 0);
    }

  return (timevar_pop (TV_NAME_LOOKUP), (global_namespace));
}
...
current_decl_namespace ()
{
  ...
  if (scope_chain->decl_ns_list)
    return ((scope_chain->decl_ns_list)->list.purpose);

  if (scope_chain->class_type)
    result = decl_namespace (((scope_chain->class_type)->common.chain));
  else if (current_function_decl)
    result = decl_namespace (current_function_decl);
  else
    result = scope_chain->old_namespace;
  return result;
}
     ...
     tree decl;
{
  ...
  scope_chain->decl_ns_list = tree_cons (((((decl))->decl.abstract_origin) ? (((decl))->decl.abstract_origin) : (decl)),
                                   (tree) ((void *)0), scope_chain->decl_ns_list);
}

void
pop_decl_namespace ()
{
  scope_chain->decl_ns_list = ((scope_chain->decl_ns_list)->common.chain);
}
...
push_scope (t)
     tree t;
{
  if (((enum tree_code) (t)->common.code) == NAMESPACE_DECL)
    push_decl_namespace (t);
  else if ((((((enum tree_code) (t)->common.code)) == RECORD_TYPE || (((enum tree_code) (t)->common.code)) == UNION_TYPE) && (((enum tree_code) (t)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t)->type.lang_flag_5))))
    pushclass (t, 2);
}
...
static int add_function (struct arg_lookup *, tree);
static int arg_assoc_namespace (struct arg_lookup *, tree);
static int arg_assoc_class (struct arg_lookup *, tree);
static int arg_assoc_template_arg (struct arg_lookup*, tree);
...
# 4173 "../../../kg++fe/gnu/cp/decl2.c"
  if (!k->functions)
    ...
    {
      tree f1 = ((((enum tree_code) (k->functions)->common.code) == OVERLOAD) ? (((struct tree_overload*)(k->functions))->function) : (k->functions));
      tree f2 = fn;
     ...
     tree scope;
{
  ...
  if (purpose_member (scope, k->namespaces))
    return 0;
  k->namespaces = tree_cons (scope, (tree) ((void *)0), k->namespaces);

  value = namespace_binding (k->name, scope);
  if (!value)
    return 0;

  for (; value; value = ((((enum tree_code) (value)->common.code) == OVERLOAD) ? ((value)->common.chain) : (tree) ((void *)0)))
    if (add_function (k, ((((enum tree_code) (value)->common.code) == OVERLOAD) ? (((struct tree_overload*)(value))->function) : (value))))
      return 1;
...
arg_assoc_template_arg (k, arg)
     ...
     tree arg;
{
# 4241 "../../../kg++fe/gnu/cp/decl2.c"
  if (((enum tree_code) (arg)->common.code) == TEMPLATE_TEMPLATE_PARM
      || ((enum tree_code) (arg)->common.code) == UNBOUND_CLASS_TEMPLATE)
    return 0;
  else if (((enum tree_code) (arg)->common.code) == TEMPLATE_DECL)
    {
      tree ctx = (((arg)->decl.context) ? ((arg)->decl.context) : global_namespace);


      if (((enum tree_code) (ctx)->common.code) == NAMESPACE_DECL)
  ...
  else if ((tree_code_type[(int) (((enum tree_code) (arg)->common.code))] == 't'))
     ...
     tree type;
{
  ...
  if (purpose_member (type, k->classes))
    return 0;
  k->classes = tree_cons (type, (tree) ((void *)0), k->classes);

  context = decl_namespace ((((((type)->type.main_variant))->common.chain)));
  if (arg_assoc_namespace (k, context))
    return 1;


  for (i = 0; i < (((((((type)->type.binfo)))->vec.a[4]) ? (((((((type)->type.binfo)))->vec.a[4]))->vec.length) : 0)); i++)
    if (arg_assoc_class (k, (((((((((type)->type.binfo)))->vec.a[4]))->vec.a[(i)]))->common.type)))
      return 1;


  for (list = ((((((((type)->type.main_variant))->common.chain)))->decl.initial)); list;
       list = ((list)->common.chain))
    if (k->name == ((list)->list.purpose))
      for (friends = ((list)->list.value); friends;
    friends = ((friends)->common.chain))


 if (((friends)->list.purpose) == global_trees[TI_ERROR_MARK] && ((friends)->list.value)
     && (((((friends)->list.value))->decl.context) ? ((((friends)->list.value))->decl.context) : global_namespace) == context)
   if (add_function (k, ((friends)->list.value)))
     return 1;


  if (((&(((type))->type.lang_specific)->u.c)->template_info))
    {
      list = (get_innermost_template_args (((((((&(((type))->type.lang_specific)->u.c)->template_info))->list.value))), 1));
      for (i = 0; i < ((list)->vec.length); ++i)
        arg_assoc_template_arg (k, ((list)->vec.a[i]));
    }
     ...
     tree type;
{
 ...
 return arg_assoc_type (k, (((((type)->type.values))->common.type)));
      return arg_assoc_class (k, type);
    case POINTER_TYPE:
    case REFERENCE_TYPE:
    case ARRAY_TYPE:
      return arg_assoc_type (k, ((type)->common.type));
    case UNION_TYPE:
    case ENUMERAL_TYPE:
      return arg_assoc_namespace (k, decl_namespace ((((((type)->type.main_variant))->common.chain))));
    case OFFSET_TYPE:

      if (arg_assoc_type (k, ((type)->type.maxval)))
 return 1;
      return arg_assoc_type (k, ((type)->common.type));
    case METHOD_TYPE:
    ...
    case FUNCTION_TYPE:
      ...
      if (arg_assoc_args (k, ((type)->type.values)))
 return 1;
 ...
 return 0;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 4370, __FUNCTION__);
    }
  return 0;
}
     ...
     tree args;
{
  for (; args; args = ((args)->common.chain))
    if (arg_assoc (k, ((args)->list.value)))
      return 1;
  return 0;
}
...
arg_assoc (k, n)
     ...
     tree n;
{
  if (n == global_trees[TI_ERROR_MARK])
    return 0;

  if ((tree_code_type[(int) (((enum tree_code) (n)->common.code))] == 't'))
    return arg_assoc_type (k, n);

  if (! type_unknown_p (n))
    return arg_assoc_type (k, ((n)->common.type));

  if (((enum tree_code) (n)->common.code) == ADDR_EXPR)
    n = ((n)->exp.operands[0]);
  if (((enum tree_code) (n)->common.code) == COMPONENT_REF)
    n = ((n)->exp.operands[1]);
  if (((enum tree_code) (n)->common.code) == OFFSET_REF)
    n = ((n)->exp.operands[1]);
  while (((enum tree_code) (n)->common.code) == TREE_LIST)
    n = ((n)->list.value);
  if (((enum tree_code) (n)->common.code) == BASELINK)
    n = ((((n))->exp.operands[1]));

  if (((enum tree_code) (n)->common.code) == FUNCTION_DECL)
    return arg_assoc_type (k, ((n)->common.type));
  if (((enum tree_code) (n)->common.code) == TEMPLATE_ID_EXPR)
    {
      ...
      tree template = ((n)->exp.operands[0]);
      tree args = ((n)->exp.operands[1]);
      tree ctx;
      tree arg;
      ...
      template = ((((enum tree_code) (template)->common.code) == OVERLOAD) ? (((struct tree_overload*)(template))->function) : (template));

      ctx = (((template)->decl.context) ? ((template)->decl.context) : global_namespace);
 ...
 return 1;
      ...
      for (arg = args; arg != (tree) ((void *)0); arg = ((arg)->common.chain))
 if (arg_assoc_template_arg (k, ((arg)->list.value)) == 1)
   return 1;
    }
  else
    {
      (void) (((((enum tree_code) (n)->common.code) == OVERLOAD) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 4456, __FUNCTION__), 0) : 0);

      for (; n; n = ((n)->common.chain))
 if (arg_assoc_type (k, (((((struct tree_overload*)(n))->function))->common.type)))
   return 1;
    }
     ...
     tree args;
{
  ...
  k.name = name;
  k.functions = fns;
  k.classes = (tree) ((void *)0);



  if (fns)
    fn = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fns))->function) : (fns));
  if (fn && ((enum tree_code) (fn)->common.code) == FUNCTION_DECL && (((fn))->decl.lang_flag_0))
    k.namespaces = (tree) ((void *)0);
  else
    unqualified_namespace_lookup (name, 0, &k.namespaces);

  arg_assoc_args (&k, args);
  return (timevar_pop (TV_NAME_LOOKUP), (k.functions));
}
...
{
  if (((enum tree_code) (namespace)->common.code) != NAMESPACE_DECL)
    {
  ...
  alias = build_lang_decl (NAMESPACE_DECL, alias, global_trees[TI_VOID_TYPE]);
  (((alias))->decl.abstract_origin) = namespace;
  pushdecl (alias);
}
     ...
     tree *name;
{
  if (((enum tree_code) (decl)->common.code) == SCOPE_REF)
    {
      *scope = ((decl)->exp.operands[0]);
      *name = ((decl)->exp.operands[1]);
      ...
      if (!scope_chain->x_processing_template_decl)
        {
          ...
          if(((enum tree_code) (*scope)->common.code) != NAMESPACE_DECL)
            {
              if ((tree_code_type[(int) (((enum tree_code) (*scope)->common.code))] == 't'))
  ...
  else if (((enum tree_code) (decl)->common.code) == NAMESPACE_DECL)
    {
      error ("namespace `%D' not allowed in using-declaration", decl);
      return (tree) ((void *)0);
    }
  else
    fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 4571, __FUNCTION__);
     ...
     tree *newval, *newtype;
{
  ...
  *newval = *newtype = (tree) ((void *)0);
  memset ((&decls), 0, sizeof (cxx_binding));
 ...
 {
   if (!(((enum tree_code) (oldval)->common.code) == TYPE_DECL && ((oldval)->decl.lang_flag_2)))
     error ("`%D' is already declared in this scope", name);
   oldval = (tree) ((void *)0);
 }

      *newval = oldval;
      for (tmp = decls.value; tmp; tmp = ((((enum tree_code) (tmp)->common.code) == OVERLOAD) ? ((tmp)->common.chain) : (tree) ((void *)0)))
 {
   tree new_fn = ((((enum tree_code) (tmp)->common.code) == OVERLOAD) ? (((struct tree_overload*)(tmp))->function) : (tmp));
   ...
   for (tmp1 = oldval; tmp1; tmp1 = ((((enum tree_code) (tmp1)->common.code) == OVERLOAD) ? ((tmp1)->common.chain) : (tree) ((void *)0)))
     {
       tree old_fn = ((((enum tree_code) (tmp1)->common.code) == OVERLOAD) ? (((struct tree_overload*)(tmp1))->function) : (tmp1));

              if (new_fn == old_fn)

                break;
       else if (((tmp1)->common.used_flag))
         continue;
       else if (compparms (((((new_fn)->common.type))->type.values),
        ((((old_fn)->common.type))->type.values)))
  {
                  ...
                  if (decls_match (new_fn, old_fn))
      {
        ...
        if (((((old_fn))->decl.lang_specific)->decl_flags.anticipated_p))
   ((((old_fn))->decl.lang_specific)->decl_flags.anticipated_p) = 0;
        break;
      }
    else if (!((((old_fn))->decl.lang_specific)->decl_flags.anticipated_p))
      {
   ...
   *newval = build_overload (((((enum tree_code) (tmp)->common.code) == OVERLOAD) ? (((struct tree_overload*)(tmp))->function) : (tmp)), *newval);
   if (((enum tree_code) (*newval)->common.code) != OVERLOAD)
     *newval = ovl_cons (*newval, (tree) ((void *)0));
   ((*newval)->common.used_flag) = 1;
 }
    }
  else
    {
  ...
  *newtype = decls.type;
  if (oldtype && *newtype && !comptypes ((oldtype), (*newtype), 0))
    {
     ...
     tree decl;
{
  ...
  binding = binding_for_name (name, scope_chain->old_namespace);
     ...
     tree decl;
{
      ...
      if (is_overloaded_fn (newval))
 {
   ...
   if (oldval && ((enum tree_code) (oldval)->common.code) == OVERLOAD)
     term = (((struct tree_overload*)(oldval))->function);
   else
     term = oldval;
   for (fn = newval; fn && ((((enum tree_code) (fn)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fn))->function) : (fn)) != term;
        fn = ((((enum tree_code) (fn)->common.code) == OVERLOAD) ? ((fn)->common.chain) : (tree) ((void *)0)))
     push_overloaded_decl (((((enum tree_code) (fn)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fn))->function) : (fn)),
      1 | 2);
 }
      else
 push_local_binding (name, newval, 2);
    }
  if (newtype)
     ...
     tree decl;
{
  ...
  if (((enum tree_code) (decl)->common.code) != SCOPE_REF
      || !(tree_code_type[(int) (((enum tree_code) (((decl)->exp.operands[0]))->common.code))] == 't'))
    {
  ...
  if (((enum tree_code) (name)->common.code) == BIT_NOT_EXPR)
    ...
    {
      name = ((name)->exp.operands[0]);
      error ("a using-declaration cannot specify a template-id.  Try  `using %T::%D'", ((decl)->exp.operands[0]), name);
      return (tree) ((void *)0);
    }
  if (((enum tree_code) (name)->common.code) == TYPE_DECL || ((enum tree_code) (name)->common.code) == TEMPLATE_DECL)
    name = ((name)->decl.name);
  else if ((((enum tree_code) (name)->common.code) == BASELINK))
    {
 ...
 name = ((name)->exp.operands[0]);
  ...
  (void) (((((enum tree_code) (name)->common.code) == IDENTIFIER_NODE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/decl2.c", 4800, __FUNCTION__), 0) : 0);

  value = build_lang_decl (USING_DECL, name, global_trees[TI_VOID_TYPE]);
  ((value)->decl.initial) = ((decl)->exp.operands[0]);
  return value;
}
     ...
     tree namespace;
{
  ...
  if (((enum tree_code) (namespace)->common.code) == SCOPE_REF)
      namespace = ((namespace)->exp.operands[1]);
  if (((enum tree_code) (namespace)->common.code) == IDENTIFIER_NODE)
    {
 ...
 error ("`%T' is not a namespace", namespace);
  ...
  if (!toplevel_bindings_p ())
    ...
    add_using_namespace (scope_chain->old_namespace, namespace, 0);
}
...
check_default_args (x)
     tree x;
{
  tree arg = ((((x)->common.type))->type.values);
  int saw_def = 0, i = 0 - (((enum tree_code) (((x)->common.type))->common.code) == METHOD_TYPE);
  for (; arg && arg != global_trees[TI_VOID_LIST_NODE]; arg = ((arg)->common.chain), ++i)
    {
      if (((arg)->list.purpose))
 saw_def = 1;
      else if (saw_def)
...
{
  ((decl)->common.used_flag) = 1;
  if (scope_chain->x_processing_template_decl || skip_evaluation)
    return;

  if (((enum tree_code) (decl)->common.code) == FUNCTION_DECL && (((decl)->decl.lang_specific)->decl_flags.base.declared_inline)
      && !((decl)->common.asm_written_flag))
  ...
  if (((((enum tree_code) (decl)->common.code) == FUNCTION_DECL && !(((enum tree_code) (decl)->common.code) == FUNCTION_DECL && ((decl)->decl.lang_flag_7))) || ((enum tree_code) (decl)->common.code) == VAR_DECL)
      && ((decl)->decl.lang_specific) && ((((decl))->decl.lang_specific) ->decl_flags.u.template_info)
      && (!((((decl)->decl.lang_specific)->decl_flags.use_template) == 3)
   || (((enum tree_code) (decl)->common.code) == FUNCTION_DECL && ((decl)->decl.inline_flag))))
    {
      _Bool defer;
# 4907 "../../../kg++fe/gnu/cp/decl2.c"
      defer = (!flag_exceptions
        || ((enum tree_code) (decl)->common.code) != FUNCTION_DECL


        || ((decl)->common.nothrow_flag)
        || !cfun


        || ((current_function_decl)->common.nothrow_flag)
     ...
     int *new_type_p;
{
  ...
  if (current == (tree) ((void *)0))
    current = scope_chain->old_namespace;

  *new_type_p = 0;

  if (scope)
    {
      if (((enum tree_code) (id)->common.code) == TYPE_DECL)


 decl = (((((((id)->common.type))->type.main_variant))->common.chain));
      else if ((((enum tree_code) (id)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((id)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (id)->common.code) == TEMPLATE_DECL && (((id)->decl.lang_flag_0) && (((enum tree_code) (id)->common.code) == CONST_DECL || ((enum tree_code) (id)->common.code) == PARM_DECL || ((enum tree_code) (id)->common.code) == TYPE_DECL || ((enum tree_code) (id)->common.code) == TEMPLATE_DECL)))))
 decl = ((id)->decl.result);
      else
 {
   if ((tree_code_type[(int) (((enum tree_code) (scope)->common.code))] == 't'))
     {
       ...
       if (decl != global_trees[TI_ERROR_MARK])
  decl = (((((decl)->type.main_variant))->common.chain));
       else
  decl = (tree) ((void *)0);
     }
 ...
 return global_trees[TI_ERROR_MARK];
  ...
  if (((enum tree_code) (type)->common.code) == RECORD_TYPE
      && (((&(((type))->type.lang_specific)->u.c)->template_info) && !((&((type)->type.lang_specific)->u.c)->use_template) && (((((((((((((&(((type))->type.lang_specific)->u.c)->template_info))->list.purpose)))->decl.arguments))->list.value))->common.type)) == ((((((&(((type))->type.lang_specific)->u.c)->template_info))->list.purpose)))))
      && scope_chain->x_processing_template_decl <= template_class_depth (current)
      && ! is_base_of_enclosing_class (type, scope_chain->class_type))
    {
  ...
  if (defn_p)
    {
      ...
      if ((((enum tree_code) (context)->common.code) == TYPENAME_TYPE && ((context)->common.type)))
 context = ((context)->common.type);
      ...
      if (current && !is_ancestor (current, context))
 {
   ...
   "enclose `%D'", decl, current, (((decl)->decl.context) ? ((decl)->decl.context) : global_namespace));
   return (tree) ((void *)0);
 }

      *new_type_p = (current != context
       && ((enum tree_code) (context)->common.code) != TEMPLATE_TYPE_PARM
       && ((enum tree_code) (context)->common.code) != BOUND_TEMPLATE_TEMPLATE_PARM);
      if (*new_type_p)
 push_scope (context);

      if (((enum tree_code) (((decl)->common.type))->common.code) == RECORD_TYPE)


 ((&((((decl)->common.type))->type.lang_specific)->u.c)->declared_class)
   = (tag_kind == class_type);

      if (!xrefd_p && (scope_chain->x_processing_template_decl > template_class_depth (current_scope ())))
 decl = push_template_decl (decl);
    }
  else
    {
# 5060 "../../../kg++fe/gnu/cp/decl2.c"
      if ((((enum tree_code) (type)->common.code) == TYPENAME_TYPE && ((type)->common.type)))
 decl = ((build_typename_type (((type)->type.context), (((((type)->type.name))->decl.name)), (((type)->type.values)), (tree) ((void *)0)))->common.chain);
    ...
    int *new_type_p;
{
  ...
  *new_type_p = 0;
  ...
  context = (((decl)->decl.context) ? ((decl)->decl.context) : global_namespace);
  ...
  *new_type_p = (current != context
  ...
  if (((enum tree_code) (((decl)->common.type))->common.code) == RECORD_TYPE)
    ...
    ((&((((decl)->common.type))->type.lang_specific)->u.c)->declared_class)
      = (cp_global_trees[CPTI_AGGR_TAG] == cp_global_trees[CPTI_CLASS_TYPE]);

  return decl;
}

# 1 "../../../kg++fe/gnu/MIPS/gt-cp-decl2.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-cp-decl2.h"
