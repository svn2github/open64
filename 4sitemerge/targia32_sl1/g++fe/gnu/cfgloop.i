  ...
  if (loops->parray)
    {
      ...
      if (! loops->num)
 fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 210, __FUNCTION__);
     ...
     struct loop *loop;
{
 ...
 num_entries++;
  ...
  if (! num_entries)
    fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 254, __FUNCTION__);
     ...
     int flags;
{
  ...
  if (! (flags & 1))
    fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 777, __FUNCTION__);
   ...
   if (latch != (&entry_exit_blocks[0]) && dominated_by_p (dom, latch, header))
     {
       ...
       if (more_latches)
  fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 830, __FUNCTION__);
       more_latches = 1;
       ((headers)->elms [(header->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (header->index) % ((unsigned) (8 * 8)));
       num_loops++;
     }
     ...
     edge e;
{
  if (e->dest != loop->header)
    fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 975, __FUNCTION__);
     ...
     const struct loop *loop;
{
  ...
  if (!loop->num_nodes)
    fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 997, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 1006, __FUNCTION__);
      for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
 tovisit[tv++] = bb;
  ...
  if (tv != loop->num_nodes)
    fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 1019, __FUNCTION__);
  return tovisit;
}
     ...
     int flags;
{
      ...
      if (loop->header->loop_father != loop)
 {
  ...
  if (err)
    fancy_abort ("../../../kg++fe/gnu/cfgloop.c", 1173, __FUNCTION__);
}
