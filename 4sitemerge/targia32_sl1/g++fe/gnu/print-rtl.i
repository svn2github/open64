...
# 35 "../../../kg++fe/gnu/print-rtl.c" 2
# 47 "../../../kg++fe/gnu/print-rtl.c"
     ...
     rtx in_rtx;
{
 ...
 fprintf (stderr,
   ...
   format_ptr[-1]);
 fancy_abort ("../../../kg++fe/gnu/print-rtl.c", 489, __FUNCTION__);
      }
      ...
      switch (((enum label_kind) (((in_rtx)->jump << 1) | (in_rtx)->call)))
 {
   ...
   default: fancy_abort ("../../../kg++fe/gnu/print-rtl.c", 546, __FUNCTION__);
 }
      break;
