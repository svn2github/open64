...
scan_actions_name:
	...
	.long	.LC30
	.section	.rodata
	.type	__FUNCTION__.10544, @object
	.size	__FUNCTION__.10544, 10
__FUNCTION__.10544:
	.string	"note_sets"
	.align 4
.LC31:
	.string	"../../../kg++fe/gnu/regrename.c"
	.text
	.type	note_sets, @function
note_sets:
.LFB15:
	.file 1 "../../../kg++fe/gnu/regrename.c"
	.loc 1 109 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LCFI5:
	...
	jbe	.L6
	.loc 1 120 0
	leal	__FUNCTION__.10544@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$120, 4(%esp)
...
.LFE15:
	...
	.section	.rodata
	.type	__FUNCTION__.10581, @object
	.size	__FUNCTION__.10581, 16
__FUNCTION__.10581:
...
.LBB2:
	...
	jbe	.L18
	.loc 1 145 0
	leal	__FUNCTION__.10581@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$145, 4(%esp)
	leal	.LC31@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE19:
	...
	.section	.rodata
	.type	__FUNCTION__.11096, @object
	.size	__FUNCTION__.11096, 13
__FUNCTION__.11096:
	.string	"scan_rtx_reg"
	.align 4
.LC37:
...
.L168:
	...
	jne	.L171
	.loc 1 463 0
	leal	__FUNCTION__.11096@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$463, 4(%esp)
	leal	.LC31@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L271:
	.loc 1 722 0
	leal	__FUNCTION__.11442@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$722, 4(%esp)
	leal	.LC31@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE22:
	...
	.section	.rodata
	.type	__FUNCTION__.11522, @object
	.size	__FUNCTION__.11522, 14
__FUNCTION__.11522:
...
.L298:
	...
	jne	.L299
	.loc 1 790 0
	leal	__FUNCTION__.11522@GOTOFF(%ebx), %eax
	movl	%eax, 12(%esp)
	movl	$790, 8(%esp)
	leal	.LC31@GOTOFF(%ebx), %eax
	movl	%eax, 4(%esp)
...
.LFE38:
	...
	.section	.rodata
	.type	__FUNCTION__.12498, @object
	.size	__FUNCTION__.12498, 27
__FUNCTION__.12498:
...
.L620:
	...
	jne	.L621
	.loc 1 1609 0
	leal	__FUNCTION__.12498@GOTOFF(%ebx), %eax
	movl	%eax, 12(%esp)
	movl	$1609, 8(%esp)
	leal	.LC31@GOTOFF(%ebx), %eax
	movl	%eax, 4(%esp)
