...
# 27 "../../../kg++fe/gnu/cp/optimize.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 28 "../../../kg++fe/gnu/cp/optimize.c" 2
...
# 61 "../../../kg++fe/gnu/cp/optimize.c"
  ...
  if (flag_inline_trees
      ...
      && !(((enum tree_code) (fn)->common.code) == FUNCTION_DECL && ((fn)->decl.lang_flag_7)))
    {
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  if (((enum tree_code) (*tp)->common.code) != FUNCTION_DECL)
    return (tree) ((void *)0);

  return setjmp_call_p (*tp) ? *tp : (tree) ((void *)0);
}
...
calls_setjmp_p (fn)
     tree fn;
{
  return walk_tree_without_duplicates (&((fn)->decl.saved_tree),
           calls_setjmp_r,
           ((void *)0)) != (tree) ((void *)0);
}
...
update_cloned_parm (parm, cloned_parm)
     ...
     tree cloned_parm;
{
  ((cloned_parm)->decl.abstract_origin) = parm;


  ((cloned_parm)->common.addressable_flag) = ((parm)->common.addressable_flag);


  ((cloned_parm)->common.readonly_flag) = ((parm)->common.readonly_flag);

  ((cloned_parm)->common.used_flag) = ((parm)->common.used_flag);


  ((cloned_parm)->decl.name) = ((parm)->decl.name);
  ((cloned_parm)->decl.locus) = ((parm)->decl.locus);
}
     ...
     tree fn;
{
  ...
  if (!((((fn)->decl.lang_specific)->decl_flags.constructor_attr) && !((((enum tree_code) (fn)->common.code) == FUNCTION_DECL || ((enum tree_code) (fn)->common.code) == TEMPLATE_DECL) && ((fn)->decl.lang_specific) && (((fn)->decl.lang_specific)->u.f.cloned_function) != (tree) ((void *)0)))
      && !((((fn)->decl.lang_specific)->decl_flags.destructor_attr) && !((((enum tree_code) (fn)->common.code) == FUNCTION_DECL || ((enum tree_code) (fn)->common.code) == TEMPLATE_DECL) && ((fn)->decl.lang_specific) && (((fn)->decl.lang_specific)->u.f.cloned_function) != (tree) ((void *)0))))
    return 0;
  ...
  for (clone = ((fn)->common.chain);
       ...
       clone = ((clone)->common.chain), first = 0)
    {
      tree parm;
      tree clone_parm;
      int parmno;
      ...
      ((clone)->decl.locus) = ((fn)->decl.locus);
      ((clone)->decl.inline_flag) = ((fn)->decl.inline_flag);
      ((clone)->decl.inlined_function_flag) = ((fn)->decl.inlined_function_flag);
      (((clone)->decl.lang_specific)->decl_flags.base.declared_inline) = (((fn)->decl.lang_specific)->decl_flags.base.declared_inline);
      ((clone)->decl.comdat_flag) = ((fn)->decl.comdat_flag);
      ((clone)->decl.weak_flag) = ((fn)->decl.weak_flag);
      ((clone)->decl.transparent_union) = ((fn)->decl.transparent_union);
      ((clone)->decl.section_name) = ((fn)->decl.section_name);
      (((clone)->decl.lang_specific)->decl_flags.use_template) = (((fn)->decl.lang_specific)->decl_flags.use_template);
      ((clone)->decl.external_flag) = ((fn)->decl.external_flag);
      ((clone)->decl.lang_flag_5) = ((fn)->decl.lang_flag_5);
      (((clone)->decl.lang_specific)->decl_flags.not_really_extern) = (((fn)->decl.lang_specific)->decl_flags.not_really_extern);
      ((clone)->common.public_flag) = ((fn)->common.public_flag);


      parm = ((fn)->decl.arguments);
      clone_parm = ((clone)->decl.arguments);

      update_cloned_parm (parm, clone_parm);
      parm = ((parm)->common.chain);
      clone_parm = ((clone_parm)->common.chain);
 ...
 clone_parm = ((clone_parm)->common.chain);
      for (; parm;
    parm = ((parm)->common.chain), clone_parm = ((clone_parm)->common.chain))
 {

   update_cloned_parm (parm, clone_parm);

   if (!first)
     ((clone_parm)->common.used_flag) = 1;
 }


      push_to_top_level ();
      start_function ((tree) ((void *)0), clone, (tree) ((void *)0), 1);


      decl_map = splay_tree_new (splay_tree_compare_pointers, ((void *)0), ((void *)0));
      for (parmno = 0,
      parm = ((fn)->decl.arguments),
      clone_parm = ((clone)->decl.arguments);
    parm;
      ...
      parm = ((parm)->common.chain))
 {
   ...
   if ((((fn)->decl.lang_specific)->decl_flags.has_in_charge_parm_p) && parmno == 1)
     {
       tree in_charge;
       in_charge = in_charge_arg_for_name (((clone)->decl.name));
       splay_tree_insert (decl_map,
     (splay_tree_key) parm,
     (splay_tree_value) in_charge);
     }
   else if (((parm)->decl.artificial_flag)
     && ((parm)->decl.name) == cp_global_trees[CPTI_VTT_PARM_IDENTIFIER])
     {
       ...
       if ((((clone)->decl.lang_specific)->decl_flags.has_vtt_parm_p))
  {
    ((clone_parm)->decl.abstract_origin) = parm;
    splay_tree_insert (decl_map,
         (splay_tree_key) parm,
       ...
       else
  {
    splay_tree_insert (decl_map,
         (splay_tree_key) parm,
         (splay_tree_value) global_trees[TI_NULL_POINTER]);
  }
     }
     ...
     (splay_tree_value) clone_parm);
      ...
      ((clone)->decl.u1.i) = ((fn)->decl.u1.i);


      splay_tree_delete (decl_map);


      (cfun->language)->can_throw = !((fn)->common.nothrow_flag);


      finish_function (0);
      ((((clone)->decl.initial))->block.abstract_origin) = ((fn)->decl.initial);
      expand_body (clone);
      pop_from_top_level ();
    }
