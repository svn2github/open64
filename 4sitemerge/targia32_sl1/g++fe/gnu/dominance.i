...
# 42 "../../../kg++fe/gnu/dominance.c" 2
# 1 "../../../kg++fe/gnu/et-forest.h" 1
# 51 "../../../kg++fe/gnu/et-forest.h"
# 1 "../../../include/gnu/ansidecl.h" 1
# 52 "../../../kg++fe/gnu/et-forest.h" 2
# 1 "/usr/lib/gcc/i486-linux-gnu/4.1.2/include/stddef.h" 1 3 4
# 53 "../../../kg++fe/gnu/et-forest.h" 2
...
extern int et_forest_add_edge (et_forest_t, et_forest_node_t, et_forest_node_t);

extern void et_forest_remove_node (et_forest_t, et_forest_node_t);
extern int et_forest_remove_edge (et_forest_t, et_forest_node_t, et_forest_node_t);

extern et_forest_node_t et_forest_parent (et_forest_t, et_forest_node_t);
extern et_forest_node_t et_forest_common_ancestor (et_forest_t, et_forest_node_t, et_forest_node_t);


extern void * et_forest_node_value (et_forest_t, et_forest_node_t);
extern int et_forest_enumerate_sons (et_forest_t, et_forest_node_t, et_forest_node_t *);
# 43 "../../../kg++fe/gnu/dominance.c" 2
     ...
     struct dom_info *di;
{
  ...
  do { unsigned int i = 1; if (! (0)) (di->dfs_parent) = (TBB *) xcalloc ((num), sizeof (TBB)); else { (di->dfs_parent) = (TBB *) xmalloc ((num) * sizeof (TBB)); for (i = 0; i < num; i++) (di->dfs_parent)[i] = (0); } } while (0);
  do { unsigned int i = 1; if (! (i)) (di->path_min) = (TBB *) xcalloc ((num), sizeof (TBB)); else { (di->path_min) = (TBB *) xmalloc ((num) * sizeof (TBB)); for (i = 0; i < num; i++) (di->path_min)[i] = (i); } } while (0);
  do { unsigned int i = 1; if (! (i)) (di->key) = (TBB *) xcalloc ((num), sizeof (TBB)); else { (di->key) = (TBB *) xmalloc ((num) * sizeof (TBB)); for (i = 0; i < num; i++) (di->key)[i] = (i); } } while (0);
  do { unsigned int i = 1; if (! (0)) (di->dom) = (TBB *) xcalloc ((num), sizeof (TBB)); else { (di->dom) = (TBB *) xmalloc ((num) * sizeof (TBB)); for (i = 0; i < num; i++) (di->dom)[i] = (0); } } while (0);

  do { unsigned int i = 1; if (! (0)) (di->bucket) = (TBB *) xcalloc ((num), sizeof (TBB)); else { (di->bucket) = (TBB *) xmalloc ((num) * sizeof (TBB)); for (i = 0; i < num; i++) (di->bucket)[i] = (0); } } while (0);
  do { unsigned int i = 1; if (! (0)) (di->next_bucket) = (TBB *) xcalloc ((num), sizeof (TBB)); else { (di->next_bucket) = (TBB *) xmalloc ((num) * sizeof (TBB)); for (i = 0; i < num; i++) (di->next_bucket)[i] = (0); } } while (0);

  do { unsigned int i = 1; if (! (0)) (di->set_chain) = (TBB *) xcalloc ((num), sizeof (TBB)); else { (di->set_chain) = (TBB *) xmalloc ((num) * sizeof (TBB)); for (i = 0; i < num; i++) (di->set_chain)[i] = (0); } } while (0);
  do { unsigned int i = 1; if (! (1)) (di->set_size) = (unsigned int *) xcalloc ((num), sizeof (unsigned int)); else { (di->set_size) = (unsigned int *) xmalloc ((num) * sizeof (unsigned int)); for (i = 0; i < num; i++) (di->set_size)[i] = (1); } } while (0);
  do { unsigned int i = 1; if (! (0)) (di->set_child) = (TBB *) xcalloc ((num), sizeof (TBB)); else { (di->set_child) = (TBB *) xmalloc ((num) * sizeof (TBB)); for (i = 0; i < num; i++) (di->set_child)[i] = (0); } } while (0);

  do { unsigned int i = 1; if (! (0)) (di->dfs_order) = (TBB *) xcalloc (((unsigned int) last_basic_block + 1), sizeof (TBB)); else { (di->dfs_order) = (TBB *) xmalloc (((unsigned int) last_basic_block + 1) * sizeof (TBB)); for (i = 0; i < (unsigned int) last_basic_block + 1; i++) (di->dfs_order)[i] = (0); } } while (0);
  do { unsigned int i = 1; if (! (0)) (di->dfs_to_bb) = (basic_block *) xcalloc ((num), sizeof (basic_block)); else { (di->dfs_to_bb) = (basic_block *) xmalloc ((num) * sizeof (basic_block)); for (i = 0; i < num; i++) (di->dfs_to_bb)[i] = (0); } } while (0);
     ...
     enum cdi_direction reverse;
{
  ...
  if (reverse)
    {
      e = bb->pred;
      en_block = (&entry_exit_blocks[1]);
      ex_block = (&entry_exit_blocks[0]);
    }
  else
    {
      e = bb->succ;
      en_block = (&entry_exit_blocks[0]);
      ex_block = (&entry_exit_blocks[1]);
    }
      ...
      while (e)
 {
       ...
       if (bn == ex_block || di->dfs_order[bn->index])
  {
   ...
   if (bn == en_block)
     fancy_abort ("../../../kg++fe/gnu/dominance.c", 279, __FUNCTION__);
     ...
     enum cdi_direction reverse;
{
  ...
  basic_block begin = reverse ? (&entry_exit_blocks[1]) : (&entry_exit_blocks[0]);
      ...
      for (b = (&entry_exit_blocks[1])->prev_bb; b != (&entry_exit_blocks[0]); b = b->prev_bb)
 {
  ...
  if (di->nodes != (unsigned int) n_basic_blocks + 1)
    fancy_abort ("../../../kg++fe/gnu/dominance.c", 356, __FUNCTION__);
}
     ...
     enum cdi_direction reverse;
{
  ...
  info->varray = varray_init (last_basic_block + 3, VARRAY_DATA_GENERIC, "dominance info");


  ((((info)->varray)->data.generic[((&entry_exit_blocks[0]))->index + 2]) = (et_forest_add_node (info->forest, (&entry_exit_blocks[0]))));

  ((((info)->varray)->data.generic[((&entry_exit_blocks[1]))->index + 2]) = (et_forest_add_node (info->forest, (&entry_exit_blocks[1]))));

  for (b = (&entry_exit_blocks[0])->next_bb; b != (&entry_exit_blocks[1]); b = b->next_bb)
    ((((info)->varray)->data.generic[(b)->index + 2]) = (et_forest_add_node (info->forest, b)));
  ...
  for (b = (&entry_exit_blocks[0])->next_bb; b != (&entry_exit_blocks[1]); b = b->next_bb)
    {
      ...
      if (di.dfs_to_bb[d])
        et_forest_add_edge (info->forest, ((et_forest_node_t)(((info)->varray)->data.generic[(di.dfs_to_bb[d])->index + 2])), ((et_forest_node_t)(((info)->varray)->data.generic[(b)->index + 2])));
    }
     ...
     dominance_info info;
{
 ...
 && ((et_forest_node_t)(((info)->varray)->data.generic[(bb)->index + 2])))
      delete_from_dominance_info (info, bb);
  delete_from_dominance_info (info, (&entry_exit_blocks[0]));
  delete_from_dominance_info (info, (&entry_exit_blocks[1]));
  et_forest_delete (info->forest);
  ((info->varray) = varray_grow (info->varray, 0));
  free (info);
}
     ...
     basic_block bb;
{
  return et_forest_node_value (dom->forest,
       ...
       ((et_forest_node_t)(((dom)->varray)->data.generic[(bb)->index + 2]))));
}
...
{
  void *aux_bb_node;
  et_forest_node_t bb_node = ((et_forest_node_t)(((dom)->varray)->data.generic[(bb)->index + 2]));

  aux_bb_node = et_forest_parent (dom->forest, bb_node);
  if (aux_bb_node)
    et_forest_remove_edge (dom->forest, aux_bb_node, bb_node);
  if (dominated_by != ((void *)0))
    {
      if (bb == dominated_by)
 fancy_abort ("../../../kg++fe/gnu/dominance.c", 642, __FUNCTION__);
      if (!et_forest_add_edge (dom->forest, ((et_forest_node_t)(((dom)->varray)->data.generic[(dominated_by)->index + 2])), bb_node))
 fancy_abort ("../../../kg++fe/gnu/dominance.c", 644, __FUNCTION__);
    }
}
     ...
     basic_block **bbs;
{
  ...
  *bbs = xmalloc (n_basic_blocks * sizeof (basic_block));
  n = et_forest_enumerate_sons (dom->forest, ((et_forest_node_t)(((dom)->varray)->data.generic[(bb)->index + 2])), (et_forest_node_t *)*bbs);
  for (i = 0; i < n; i++)
     ...
     basic_block to;
{
  ...
  et_forest_node_t node = ((et_forest_node_t)(((dom)->varray)->data.generic[(bb)->index + 2]));
  et_forest_node_t node2 = ((et_forest_node_t)(((dom)->varray)->data.generic[(to)->index + 2]));
     ...
     basic_block bb2;
{
  ...
  return et_forest_node_value (dom->forest,
         ...
         ((et_forest_node_t)(((dom)->varray)->data.generic[(bb1)->index + 2])),
         ((et_forest_node_t)(((dom)->varray)->data.generic[(bb2)->index + 2]))));
     ...
     dominance_info dom;
{
      ...
      if (dom_bb != get_immediate_dominator (dom, bb))
 {
  ...
  if (err)
    fancy_abort ("../../../kg++fe/gnu/dominance.c", 734, __FUNCTION__);
}
...
add_to_dominance_info (dom, bb)
     ...
     basic_block bb;
{
  ((dom->varray) = varray_grow (dom->varray, last_basic_block + 3));




  ((((dom)->varray)->data.generic[(bb)->index + 2]) = (et_forest_add_node (dom->forest, bb)));
}
...
delete_from_dominance_info (dom, bb)
     ...
     basic_block bb;
{
  et_forest_remove_node (dom->forest, ((et_forest_node_t)(((dom)->varray)->data.generic[(bb)->index + 2])));
  ((((dom)->varray)->data.generic[(bb)->index + 2]) = (((void *)0)));
}
