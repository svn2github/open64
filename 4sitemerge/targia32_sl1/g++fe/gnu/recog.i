...
# 33 "../../../kg++fe/gnu/recog.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 34 "../../../kg++fe/gnu/recog.c" 2
    ...
    int in_group;
{
  ...
  if (in_group == 0 && num_changes != 0)
    fancy_abort ("../../../kg++fe/gnu/recog.c", 226, __FUNCTION__);
     ...
     const char *constraint;
{
  ...
  if (reload_completed)
    fancy_abort ("../../../kg++fe/gnu/recog.c", 1688, __FUNCTION__);
     ...
     rtx insn;
{
  ...
  if (which_alternative == -1
    ...
    _fatal_insn_not_found (insn, "../../../kg++fe/gnu/recog.c", 2100, __FUNCTION__);
}
     ...
     rtx insn;
{
      ...
      if (noperands >= 0)
 {
   ...
   if (noperands > 30)
     fancy_abort ("../../../kg++fe/gnu/recog.c", 2160, __FUNCTION__);
  ...
  recog_data.n_alternatives += (*p++ == ',');
   ...
   break;
      ...
      _fatal_insn_not_found (insn, "../../../kg++fe/gnu/recog.c", 2176, __FUNCTION__);
    ...
    normal_insn:
      ...
      if (icode < 0)
 _fatal_insn_not_found (insn, "../../../kg++fe/gnu/recog.c", 2185, __FUNCTION__);
      ...
      for (i = 0; i < noperands; i++)
 {
  ...
  if (recog_data.n_alternatives > 30)
    fancy_abort ("../../../kg++fe/gnu/recog.c", 2209, __FUNCTION__);
}
     ...
     rtx out_insn, in_insn;
{
  ...
  if (! in_set)
    fancy_abort ("../../../kg++fe/gnu/recog.c", 3390, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/recog.c", 3408, __FUNCTION__);
      ...
      for (i = 0; i < (((((out_pat)->fld[0]).rtvec))->num_elem); i++)
 {
   ...
   if (((enum rtx_code) (exp)->code) != SET)
     fancy_abort ("../../../kg++fe/gnu/recog.c", 3418, __FUNCTION__);
     ...
     rtx out_insn, in_insn;
{
 ...
 return 0;
      fancy_abort ("../../../kg++fe/gnu/recog.c", 3444, __FUNCTION__);
    }
 ...
 return 0;
  ...
  else
    {
      ...
      out_pat = (((out_insn)->fld[5]).rtx);
      if (((enum rtx_code) (out_pat)->code) != PARALLEL)
 fancy_abort ("../../../kg++fe/gnu/recog.c", 3465, __FUNCTION__);
      ...
      for (i = 0; i < (((((out_pat)->fld[0]).rtvec))->num_elem); i++)
 {
   ...
   if (((enum rtx_code) (exp)->code) != SET)
     fancy_abort ("../../../kg++fe/gnu/recog.c", 3475, __FUNCTION__);
