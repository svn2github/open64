...
# 37 "../../../kg++fe/gnu/builtins.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 38 "../../../kg++fe/gnu/builtins.c" 2
...
# 43 "../../../kg++fe/gnu/builtins.c" 2
# 1 "../../../kg++fe/gnu/typeclass.h" 1
...
# 49 "../../../kg++fe/gnu/builtins.c" 2
# 66 "../../../kg++fe/gnu/builtins.c"
     ...
     enum machine_mode mode;
{
  ...
  if ((mode_class[(int) (mode)]) != MODE_INT)
    fancy_abort ("../../../kg++fe/gnu/builtins.c", 370, __FUNCTION__);
  c[0] = 0;
  c[1] = 0;
  ch = 1;
 ...
 j = j + ((target_flags & 0x00002000) ? 8 : 4) - 2 * (j % ((target_flags & 0x00002000) ? 8 : 4)) - 1;
      j *= 8;
      if (j > 2 * (8 * 8))
 fancy_abort ("../../../kg++fe/gnu/builtins.c", 384, __FUNCTION__);
      if (ch)
     ...
     rtx buf_addr, value;
{
  ...
  if (value != (const_int_rtx[64 +1]))
    fancy_abort ("../../../kg++fe/gnu/builtins.c", 701, __FUNCTION__);
...
# 732 "../../../kg++fe/gnu/builtins.c"
 {
  ...
  for (insn = get_last_insn (); insn; insn = (((insn)->fld[1]).rtx))
    {
      if (insn == last)
 fancy_abort ("../../../kg++fe/gnu/builtins.c", 752, __FUNCTION__);
 ...
 if (((((unsigned long long) (((regno)) - ((0 + 4))) <= ((((0 + 4) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((0 + 4)))) || (((unsigned long long) (((regno)) - ((32 + 12))) <= ((((32 + 12) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((32 + 12)))) && ((regno) % ((target_flags & 0x00000200) || (target_flags & 0x00020000) ? 1 : 2) == 0) && mips_abi != 4)) && !fixed_regs[regno]))
  ...
  if (mips_hard_regno_mode_ok[ (int)(mode) ][ (regno) ]
    ...
    best_mode = mode;
     ...
     mode = best_mode;
     if (mode == VOIDmode)
       fancy_abort ("../../../kg++fe/gnu/builtins.c", 994, __FUNCTION__);
 ...
 if (((regno) == (0 + 2) || (regno) == (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) || ((mips_abi == 1 || mips_abi == 2 ? 128 : 64) == 128 && (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) != (0 + 2) && (regno) == (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) + 2)))
  ...
  if (mips_hard_regno_mode_ok[ (int)(mode) ][ (regno) ]
    ...
    best_mode = mode;
     ...
     mode = best_mode;
     if (mode == VOIDmode)
       fancy_abort ("../../../kg++fe/gnu/builtins.c", 1066, __FUNCTION__);
     ...
     rtx function, arguments, argsize;
{
 ...
 if ((mode = apply_result_mode[regno]) != VOIDmode)
   {
     if (valreg)
       fancy_abort ("../../../kg++fe/gnu/builtins.c", 1335, __FUNCTION__);
    ...
    fancy_abort ("../../../kg++fe/gnu/builtins.c", 1347, __FUNCTION__);
  ...
  if (! call_insn)
    fancy_abort ("../../../kg++fe/gnu/builtins.c", 1356, __FUNCTION__);
     ...
     rtx target, subtarget;
{
  ...
  switch (((fndecl)->decl.u1.f))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/builtins.c", 1582, __FUNCTION__);
    }
     ...
     enum machine_mode mode;
{
  ...
  if (offset < 0
   ...
   > strlen (str) + 1))
    fancy_abort ("../../../kg++fe/gnu/builtins.c", 2000, __FUNCTION__);
     ...
     tree exp;
{
  ...
  if (sizeof (CUMULATIVE_ARGS) % sizeof (int) != 0)
    fancy_abort ("../../../kg++fe/gnu/builtins.c", 3320, __FUNCTION__);
     ...
     rtx target, subtarget;
{
  ...
  if (target == 0)
    fancy_abort ("../../../kg++fe/gnu/builtins.c", 3831, __FUNCTION__);
  return target;
}
# 3924 "../../../kg++fe/gnu/builtins.c"
static rtx
...
# 4287 "../../../kg++fe/gnu/builtins.c"
      case BUILT_IN_STRCMP:
      case BUILT_IN_FFS:
# 4297 "../../../kg++fe/gnu/builtins.c"
      ...
      if (! volatilep)
 {
  ...
  switch (fcode)
    ...
    case BUILT_IN_FABSL:
      ...
      fancy_abort ("../../../kg++fe/gnu/builtins.c", 4349, __FUNCTION__);
    ...
    case BUILT_IN_CIMAGL:
      ...
      fancy_abort ("../../../kg++fe/gnu/builtins.c", 4362, __FUNCTION__);
...
# 4408 "../../../kg++fe/gnu/builtins.c"
 ...
 return target;
      break;
# 4497 "../../../kg++fe/gnu/builtins.c"
    case BUILT_IN_STPCPY:
      target = expand_builtin_stpcpy (arglist, target, mode);
      if (target)
 return target;
      break;
# 4555 "../../../kg++fe/gnu/builtins.c"
    case BUILT_IN_MEMCPY:
...
# 4605 "../../../kg++fe/gnu/builtins.c"
 ...
 return target;
      break;
# 4623 "../../../kg++fe/gnu/builtins.c"
    case BUILT_IN_LONGJMP:
      if (!validate_arglist (arglist, POINTER_TYPE, INTEGER_TYPE, VOID_TYPE))
 break;
      else
 {
# 4642 "../../../kg++fe/gnu/builtins.c"
   return (const_int_rtx[64]);
 }
