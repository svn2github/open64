...
.LFE24:
	...
	.section	.rodata
	.type	__FUNCTION__.10576, @object
	.size	__FUNCTION__.10576, 13
__FUNCTION__.10576:
	.string	"schedule_ebb"
	.align 4
.LC1:
	.string	"../../../kg++fe/gnu/sched-ebb.c"
	.text
...
.LBE6:
	...
	je	.L82
	.loc 1 412 0
	leal	__FUNCTION__.10576@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$412, 4(%esp)
