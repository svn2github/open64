...
# 35 "../../../kg++fe/gnu/conflict.c" 2
# 64 "../../../kg++fe/gnu/conflict.c"
     ...
     int reg2;
{
  ...
  if (reg1 == reg2)
    fancy_abort ("../../../kg++fe/gnu/conflict.c", 203, __FUNCTION__);
     ...
     void *contextp;
{
  ...
  if (reg1 == context->reg)
    ...
    fancy_abort ("../../../kg++fe/gnu/conflict.c", 352, __FUNCTION__);
