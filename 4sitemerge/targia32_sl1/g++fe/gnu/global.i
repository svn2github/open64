...
# 34 "../../../kg++fe/gnu/global.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 35 "../../../kg++fe/gnu/global.c" 2
...
# 38 "../../../kg++fe/gnu/global.c" 2
# 80 "../../../kg++fe/gnu/global.c"
...
# 242 "../../../kg++fe/gnu/global.c"
static long long *allocnos_live;
# 283 "../../../kg++fe/gnu/global.c"
static rtx *regs_set;
...
# 389 "../../../kg++fe/gnu/global.c"
 ...
 if ((((reg_n_info)->data.reg[i])->live_length) == 0)
   fancy_abort ("../../../kg++fe/gnu/global.c", 434, __FUNCTION__);
      }
    else
      reg_allocno[i] = -1;
...
# 702 "../../../kg++fe/gnu/global.c"
 record_conflicts (block_start_allocnos, ax);
# 724 "../../../kg++fe/gnu/global.c"
      }
     ...
     rtx first;
{
      ...
      if (b == (&entry_exit_blocks[1]))
 {
  ...
  && ! ((((enum rtx_code) ((((first)->fld[5]).rtx))->code) == ADDR_VEC
       ...
       fancy_abort ("../../../kg++fe/gnu/global.c", 1888, __FUNCTION__);
   break;
 }
    }
