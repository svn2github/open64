...
dump_stmt (di, t)
     ...
     tree t;
{
  dump_int (di, "line", ((((t))->exp.complexity)));
}
...
dump_next_stmt (di, t)
     ...
     tree t;
{
  queue_and_dump_index (di, "next", ((t)->common.chain), 0);
}
     ...
     tree t;
{
 ...
 dump_string (di, "volatile");
      queue_and_dump_index (di, "strg", (((t))->exp.operands[1]), 0);
      queue_and_dump_index (di, "outs", (((t))->exp.operands[2]), 0);
      queue_and_dump_index (di, "ins", (((t))->exp.operands[3]), 0);
      queue_and_dump_index (di, "clbr", (((t))->exp.operands[4]), 0);
      dump_next_stmt (di, t);
      break;
    ...
    case CASE_LABEL:
      ...
      queue_and_dump_index (di, "low", (((t))->exp.operands[0]), 0);
      queue_and_dump_index (di, "high", (((t))->exp.operands[1]), 0);
      dump_next_stmt (di, t);
      break;
    ...
    case CLEANUP_STMT:
      ...
      queue_and_dump_index (di, "expr", (((t))->exp.operands[1]), 0);
      dump_next_stmt (di, t);
      break;
    ...
    case GOTO_STMT:
      dump_stmt (di, t);
      queue_and_dump_index (di, "dest", (((t))->exp.operands[0]), 0);
      dump_next_stmt (di, t);
      break;
    ...
    case IF_STMT:
      dump_stmt (di, t);
      queue_and_dump_index (di, "cond", (((t))->exp.operands[0]), 0);
      queue_and_dump_index (di, "then", (((t))->exp.operands[1]), 0);
      queue_and_dump_index (di, "else", (((t))->exp.operands[2]), 0);
      dump_next_stmt (di, t);
      break;

    case LABEL_STMT:
      dump_stmt (di, t);
      queue_and_dump_index (di, "labl", (((t))->exp.operands[0]), 0);
      dump_next_stmt (di, t);
      break;
