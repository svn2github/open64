...
# 30 "../../../kg++fe/gnu/reload1.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 31 "../../../kg++fe/gnu/reload1.c" 2
...
extern void fancy_abort (const char *, int, const char *)
    __attribute__ ((__noreturn__));
# 45 "../../../kg++fe/gnu/reload1.c" 2
# 90 "../../../kg++fe/gnu/reload1.c"
 ...
 *loc = (cfun->emit->x_regno_reg_rtx)[regno];
 ...
 fancy_abort ("../../../kg++fe/gnu/reload1.c", 625, __FUNCTION__);
...
# 1067 "../../../kg++fe/gnu/reload1.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/reload1.c", 1108, __FUNCTION__);
...
# 1304 "../../../kg++fe/gnu/reload1.c"
static void
maybe_fix_stack_asms ()
{
# 1411 "../../../kg++fe/gnu/reload1.c"
}
     ...
     int reg;
{
  ...
  if (r < 0)
    fancy_abort ("../../../kg++fe/gnu/reload1.c", 1605, __FUNCTION__);
     ...
     int order;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/reload1.c", 1784, __FUNCTION__);
     ...
     enum reg_class class;
{
  ...
  if (asm_noperands ((((insn)->fld[5]).rtx)) >= 0)
  ...
  else
    {
      ...
      reg_class_names[class]);
      _fatal_insn ("this is the insn:", insn, "../../../kg++fe/gnu/reload1.c", 1915, __FUNCTION__);
    }
}
...
# 2576 "../../../kg++fe/gnu/reload1.c"
 ...
 return gen_rtx_fmt_e (USE, (((enum machine_mode) (x)->mode)), (new));
    ...
    case ASM_OPERANDS:
    case SET:
      fancy_abort ("../../../kg++fe/gnu/reload1.c", 2614, __FUNCTION__);
...

{
  ...
  switch (code)
    ...
    case ADDRESSOF:
      fancy_abort ("../../../kg++fe/gnu/reload1.c", 2703, __FUNCTION__);
...
# 2820 "../../../kg++fe/gnu/reload1.c"
  ...
  if (((enum rtx_code) (src)->code) == PLUS
    ...
    case MEM:
      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == ADDRESSOF)
 fancy_abort ("../../../kg++fe/gnu/reload1.c", 2844, __FUNCTION__);
     ...
     int replace;
{
 ...
 return 0;
      fancy_abort ("../../../kg++fe/gnu/reload1.c", 2944, __FUNCTION__);
    }
...
# 3027 "../../../kg++fe/gnu/reload1.c"
 ...
 if (ep->from_rtx == reg && ep->can_eliminate)
  ...
  if ((((insn)->fld[6]).rtint) < 0)
    fancy_abort ("../../../kg++fe/gnu/reload1.c", 3076, __FUNCTION__);
       }
     else
       {
  new_body = old_body;
...
verify_initial_elim_offsets ()
{
 ...
 fancy_abort ("../../../kg++fe/gnu/reload1.c", 3344, __FUNCTION__);
    }
...
# 3654 "../../../kg++fe/gnu/reload1.c"
      ...
      if (chain->need_reload)
 {
   ...
   fancy_abort ("../../../kg++fe/gnu/reload1.c", 3723, __FUNCTION__);
 ok:;
 }
    }
     ...
     enum machine_mode mode;
{
  ...
  switch (type)
    ...
    case RELOAD_FOR_INSN:
      ...
      break;
    default:
      fancy_abort ("../../../kg++fe/gnu/reload1.c", 4329, __FUNCTION__);
    }
# 4339 "../../../kg++fe/gnu/reload1.c"
  start_regno = regno;
     ...
     enum reload_type type;
{
 ...
 if ((!!((reload_reg_used_in_input[i])[(regno) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8))))))
  ...
  fancy_abort ("../../../kg++fe/gnu/reload1.c", 4528, __FUNCTION__);
}
# 4539 "../../../kg++fe/gnu/reload1.c"
static int
     ...
     enum reload_type type;
{
 ...
 if ((!!((reload_reg_used_in_output_addr[i])[(regno) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8))))))
  ...
  fancy_abort ("../../../kg++fe/gnu/reload1.c", 4664, __FUNCTION__);
}
     ...
     int r1, r2;
{
  ...
  switch (r1_type)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/reload1.c", 4740, __FUNCTION__);
    }
}
     ...
     int r;
{
  if (asm_noperands ((((insn)->fld[5]).rtx)) < 0)
    ...
    _fatal_insn ("could not find a spill register", insn, "../../../kg++fe/gnu/reload1.c", 5052, __FUNCTION__);
...
{
  int i, pass, count;
# 5145 "../../../kg++fe/gnu/reload1.c"
  int force_group = rld[r].nregs > 1 && ! last_reload;
# 5159 "../../../kg++fe/gnu/reload1.c"
...
# 5562 "../../../kg++fe/gnu/reload1.c"
       ...
       if (equiv != 0)
  {
    if (((enum rtx_code) (equiv)->code) == REG)
      ...
      fancy_abort ("../../../kg++fe/gnu/reload1.c", 5669, __FUNCTION__);
  }
...
# 5821 "../../../kg++fe/gnu/reload1.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/reload1.c", 5861, __FUNCTION__);
      ...
      for (i = 0; i < n_reloads; i++)
 {
   ...
   if (chain->rld[i].when_needed != rld[i].when_needed)
     fancy_abort ("../../../kg++fe/gnu/reload1.c", 5868, __FUNCTION__);
   ...
   && rld[r].reg_rtx != 0)
 {
  ...
  ((reg_is_output_reload)[(i + nr) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((i + nr) % ((unsigned) (8 * 8))));
   ...
   if (rld[r].when_needed != RELOAD_OTHER
     ...
     fancy_abort ("../../../kg++fe/gnu/reload1.c", 5984, __FUNCTION__);
 }
    }
}
...
# 6108 "../../../kg++fe/gnu/reload1.c"
        ...
        rld[i].in))
  {
   ...
   fancy_abort ("../../../kg++fe/gnu/reload1.c", 6136, __FUNCTION__);
  }
 }
    }
}
 ...
 oldequiv = 0;
  ...
  switch (rl->when_needed)
    ...
    case RELOAD_FOR_OTHER_ADDRESS:
      ...
      break;
    default:
      fancy_abort ("../../../kg++fe/gnu/reload1.c", 6353, __FUNCTION__);
    }
  ...
  if (rl->out && ! rl->out_reg)
    {
      ...
      if (rl->secondary_in_reload >= 0)
 fancy_abort ("../../../kg++fe/gnu/reload1.c", 6365, __FUNCTION__);
     ...
     int j;
{
 ...
 _fatal_insn ("VOIDmode on an output", insn, "../../../kg++fe/gnu/reload1.c", 6679, __FUNCTION__);
     ...
     int j;
{
 ...
 delete_output_reload (insn, j, last_regno);
  ...
  if (((enum rtx_code) (insn)->code) == JUMP_INSN)
    fancy_abort ("../../../kg++fe/gnu/reload1.c", 6995, __FUNCTION__);
      ...
      if ((((enum rtx_code) (this_rtx)->code) == LABEL_REF || ((enum rtx_code) (this_rtx)->code) == SYMBOL_REF || ((enum rtx_code) (this_rtx)->code) == CONST_INT || ((enum rtx_code) (this_rtx)->code) == CONST_DOUBLE || ((enum rtx_code) (this_rtx)->code) == CONST || ((enum rtx_code) (this_rtx)->code) == HIGH || ((enum rtx_code) (this_rtx)->code) == CONST_VECTOR || ((enum rtx_code) (this_rtx)->code) == CONSTANT_P_RTX) && ! references_value_p (this_rtx, 0))
 {
  ...
  case SIGN_EXTEND:
    ...
    if (this_val == trunc_int_for_mode (this_val, ((enum machine_mode) (src)->mode)))
      break;
  default:
    fancy_abort ("../../../kg++fe/gnu/reload1.c", 8248, __FUNCTION__);
  }
     ...
     rtx testreg;
{
  ...
  if (! constrain_operands (1))
    _fatal_insn_not_found (insn, "../../../kg++fe/gnu/reload1.c", 8345, __FUNCTION__);
...
# 8556 "../../../kg++fe/gnu/reload1.c"
struct reg_use { rtx insn, *usep; };
# 8569 "../../../kg++fe/gnu/reload1.c"
static struct
  {
     ...
     rtx *xp, insn;
{
      ...
      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == REG)
 {
   ...
   if (((((((x)->fld[0]).rtx))->fld[0]).rtuint) >= 176)
     fancy_abort ("../../../kg++fe/gnu/reload1.c", 8969, __FUNCTION__);
   return;
 }
      break;
 ...
 if (regno >= 176)
   fancy_abort ("../../../kg++fe/gnu/reload1.c", 8990, __FUNCTION__);
...
fixup_abnormal_edges ()
{
      ...
      if (e && ((enum rtx_code) (bb->end)->code) != CALL_INSN && !can_throw_internal (bb->end))
 {
   ...
   if (((enum rtx_code) (insn)->code) != CALL_INSN && !can_throw_internal (insn))
     fancy_abort ("../../../kg++fe/gnu/reload1.c", 9501, __FUNCTION__);
   bb->end = insn;
   inserted = 1;
   insn = (((insn)->fld[2]).rtx);
