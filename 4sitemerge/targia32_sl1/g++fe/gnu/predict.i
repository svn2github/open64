...
# 48 "../../../kg++fe/gnu/predict.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 49 "../../../kg++fe/gnu/predict.c" 2
     ...
     enum br_predictor predictor;
{
  if (!any_condjump_p (insn))
    fancy_abort ("../../../kg++fe/gnu/predict.c", 195, __FUNCTION__);
...
# 700 "../../../kg++fe/gnu/predict.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/predict.c", 715, __FUNCTION__);
 ...
 int threshold;
{
  ...
  if (threshold > 10000)
    fancy_abort ("../../../kg++fe/gnu/predict.c", 1123, __FUNCTION__);
