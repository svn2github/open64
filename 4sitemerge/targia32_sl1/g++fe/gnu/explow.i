...
# 38 "../../../kg++fe/gnu/explow.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 39 "../../../kg++fe/gnu/explow.c" 2
# 1 "../../../kg++fe/gnu/ggc.h" 1
# 25 "../../../kg++fe/gnu/ggc.h"
...
# 42 "../../../kg++fe/gnu/explow.c" 2


# 1 "../../../kg++fe/gnu/defaults.h" 1
# 45 "../../../kg++fe/gnu/explow.c" 2
     ...
     enum machine_mode mode;
{
  ...
  if (! ((mode_class[(int) (mode)]) == MODE_INT || (mode_class[(int) (mode)]) == MODE_PARTIAL_INT))
    fancy_abort ("../../../kg++fe/gnu/explow.c", 62, __FUNCTION__);
     ...
     rtx insn;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/explow.c", 290, __FUNCTION__);
    }
  return 0;
}
     ...
     rtx x;
{
  ...
  if (((enum machine_mode) (x)->mode) != mode && ((enum machine_mode) (x)->mode) != VOIDmode)
    fancy_abort ("../../../kg++fe/gnu/explow.c", 748, __FUNCTION__);
  if (x != temp)
    emit_move_insn (temp, x);
  return temp;
}
# 762 "../../../kg++fe/gnu/explow.c"
rtx
force_reg (mode, x)
     enum machine_mode mode;
     rtx x;
...
# 1016 "../../../kg++fe/gnu/explow.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/explow.c", 1036, __FUNCTION__);
    }
...
# 1342 "../../../kg++fe/gnu/explow.c"
  ...
  if ((cfun->expr->x_stack_pointer_delta) % (((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128) / 8))
    fancy_abort ("../../../kg++fe/gnu/explow.c", 1351, __FUNCTION__);
...
# 1557 "../../../kg++fe/gnu/explow.c"
 ...
 test_addr = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), test_addr);
      ...
      if (temp != test_addr)
 fancy_abort ("../../../kg++fe/gnu/explow.c", 1621, __FUNCTION__);
    ...
    tmpmode = ((enum machine_mode)mode_wider_mode[(int) (tmpmode)]))
 {
   ...
   if ((mode_size[(int) (tmpmode)]) >= bytes)
     break;
      ...
      if (tmpmode == VOIDmode)
 fancy_abort ("../../../kg++fe/gnu/explow.c", 1679, __FUNCTION__);
...
# 1 "../../../kg++fe/gnu/MIPS/gt-explow.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-explow.h"
