...
# 160 "../../../kg++fe/gnu/df.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 161 "../../../kg++fe/gnu/df.c" 2
     ...
     struct ref *ref;
{
      ...
      if (! link->next)
 {
   ...
   if (link->ref != ref)
     fancy_abort ("../../../kg++fe/gnu/df.c", 673, __FUNCTION__);
     ...
     enum df_ref_flags ref_flags;
{
  ...
  if (((enum rtx_code) (reg)->code) != REG && ((enum rtx_code) (reg)->code) != SUBREG)
    fancy_abort ("../../../kg++fe/gnu/df.c", 856, __FUNCTION__);
...
# 1077 "../../../kg++fe/gnu/df.c"
 ...
 switch (((enum rtx_code) (dst)->code))
  ...
  fancy_abort ("../../../kg++fe/gnu/df.c", 1119, __FUNCTION__);
       use_flags = DF_REF_READ_WRITE;
     ...
     case SIGN_EXTRACT:
       ...
       break;
     default:
       fancy_abort ("../../../kg++fe/gnu/df.c", 1138, __FUNCTION__);
   }
 return;
      }
     ...
     int flags;
{
  ...
  if (df->n_bbs && df->n_bbs != (unsigned int) last_basic_block)
    fancy_abort ("../../../kg++fe/gnu/df.c", 2336, __FUNCTION__);
      ...
      else
 {
   ...
   if (! df->n_bbs)
     fancy_abort ("../../../kg++fe/gnu/df.c", 2359, __FUNCTION__);
     ...
     rtx insn;
{
  ...
  if (insn == bb->head)
    fancy_abort ("../../../kg++fe/gnu/df.c", 2467, __FUNCTION__);
     ...
     rtx newreg;
{
      ...
      else
 {
   ...
   fancy_abort ("../../../kg++fe/gnu/df.c", 2655, __FUNCTION__);
 }
    }
}
     ...
     rtx newreg;
{
  ...
  if (oldreg && oldreg != ((ref)->reg))
    fancy_abort ("../../../kg++fe/gnu/df.c", 2695, __FUNCTION__);
     ...
     rtx last_insn;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/df.c", 2773, __FUNCTION__);
     ...
     rtx insn;
{
  ...
  if (insn == bb->head)
    fancy_abort ("../../../kg++fe/gnu/df.c", 2801, __FUNCTION__);
     ...
     rtx reg2;
{
  ...
  if (df_regno_bb (df, regno1) != bb
    ...
    fancy_abort ("../../../kg++fe/gnu/df.c", 3112, __FUNCTION__);
     ...
     rtx reg;
{
  ...
  if (! def)
    fancy_abort ("../../../kg++fe/gnu/df.c", 3246, __FUNCTION__);
