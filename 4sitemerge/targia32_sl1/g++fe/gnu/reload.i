...
# 97 "../../../kg++fe/gnu/reload.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 98 "../../../kg++fe/gnu/reload.c" 2
...
# 109 "../../../kg++fe/gnu/reload.c" 2


# 1 "../../../kg++fe/gnu/defaults.h" 1
# 112 "../../../kg++fe/gnu/reload.c" 2
# 128 "../../../kg++fe/gnu/reload.c"
int n_reloads;
     ...
     enum insn_code *picode;
{
      ...
      else
 {
   ...
   insn_class
     ...
     fancy_abort ("../../../kg++fe/gnu/reload.c", 398, __FUNCTION__);
   if (in_p
       && insn_data[(int) icode].operand[!in_p].constraint[0] != '=')
     fancy_abort ("../../../kg++fe/gnu/reload.c", 401, __FUNCTION__);
 }


      if (insn_data[(int) icode].operand[2].constraint[0] != '='
   || insn_data[(int) icode].operand[2].constraint[1] != '&')
 fancy_abort ("../../../kg++fe/gnu/reload.c", 407, __FUNCTION__);
...
# 437 "../../../kg++fe/gnu/reload.c"
  if (in_p && class == reload_class && icode == CODE_FOR_nothing
      && t_icode == CODE_FOR_nothing)
    fancy_abort ("../../../kg++fe/gnu/reload.c", 439, __FUNCTION__);
     ...
     unsigned int dest_regno;
{
   ...
   || best_cost > cost)
 {
  ...
  if (best_size == 0)
    fancy_abort ("../../../kg++fe/gnu/reload.c", 716, __FUNCTION__);

  return best_class;
}
# 729 "../../../kg++fe/gnu/reload.c"
static int
...
# 1228 "../../../kg++fe/gnu/reload.c"
      ...
      if (i == 176)
 {
  ...
  if (class == NO_REGS
    ...
    fancy_abort ("../../../kg++fe/gnu/reload.c", 1269, __FUNCTION__);
     ...
     rtx x, y;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/reload.c", 2238, __FUNCTION__);
 }
    }
  return 1 + success_2;
}
# 2252 "../../../kg++fe/gnu/reload.c"
     ...
     rtx x;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/reload.c", 2345, __FUNCTION__);
 ...
 val.end = val.start + mips_hard_regno_nregs (val.start, ((enum machine_mode) (x)->mode));
    ...
    fancy_abort ("../../../kg++fe/gnu/reload.c", 2384, __FUNCTION__);
  return val;
}
     ...
     struct decomposition ydata;
{
  ...
  if (((enum rtx_code) (y)->code) != MEM)
    fancy_abort ("../../../kg++fe/gnu/reload.c", 2404, __FUNCTION__);
      ...
      while ((c = *p++))
 {
   if (c == '=')
   ...
   else if (c == '%')
     {
       ...
       if (i == noperands - 1)
  fancy_abort ("../../../kg++fe/gnu/reload.c", 2612, __FUNCTION__);
  ...
  = operands_match_p (recog_data.operand[c],
       ...
       if (c == i)
  fancy_abort ("../../../kg++fe/gnu/reload.c", 2626, __FUNCTION__);
 ...
 if (this_alternative_earlyclobber[i]
     && (this_alternative_win[i] || this_alternative_match_win[i]))
   {
     ...
     if (modified[i] == RELOAD_READ)
       fancy_abort ("../../../kg++fe/gnu/reload.c", 3462, __FUNCTION__);
  ...
  if (this_insn_is_asm)
    ...
    fancy_abort ("../../../kg++fe/gnu/reload.c", 3471, __FUNCTION__);
       }
...
# 3585 "../../../kg++fe/gnu/reload.c"
 ...
 _fatal_insn ("unable to generate reloads for:", insn, "../../../kg++fe/gnu/reload.c", 3637, __FUNCTION__);
...
# 3715 "../../../kg++fe/gnu/reload.c"
 ...
 if (goal_alternative_matches[i] >= 0)
  ...
  for (j = 0; j < n_reloads; j++)
   ...
   fancy_abort ("../../../kg++fe/gnu/reload.c", 3849, __FUNCTION__);
 else
   {
     error_for_asm (insn, "inconsistent operand constraints in an `asm'");
...
# 4467 "../../../kg++fe/gnu/reload.c"
   ...
   && reg_equiv_constant[regno] != 0)
 {
   ...
   if (!tem)
     fancy_abort ("../../../kg++fe/gnu/reload.c", 4484, __FUNCTION__);
   return tem;
 }
# 4501 "../../../kg++fe/gnu/reload.c"
      else if (regno >= 176
...
{
# 5173 "../../../kg++fe/gnu/reload.c"
}
# 5199 "../../../kg++fe/gnu/reload.c"
static int
     ...
     rtx insn;
{
 ...
 if (op0 != (((op1)->fld[0]).rtx))
   fancy_abort ("../../../kg++fe/gnu/reload.c", 5354, __FUNCTION__);
 ...
 if ((((enum rtx_code) ((((op1)->fld[0]).rtx))->code) == REG))
   {
     ...
     if (regno >= 176
  && reg_equiv_constant[regno] != 0)
       fancy_abort ("../../../kg++fe/gnu/reload.c", 5373, __FUNCTION__);
  ...
  return 0;
   ...
   fancy_abort ("../../../kg++fe/gnu/reload.c", 5425, __FUNCTION__);
      }
      return 0;
      ...
      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == REG)
 {
   ...
   if (regno >= 176
       && reg_equiv_constant[regno] != 0)
     fancy_abort ("../../../kg++fe/gnu/reload.c", 5442, __FUNCTION__);
...
# 5927 "../../../kg++fe/gnu/reload.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/reload.c", 5970, __FUNCTION__);
    }
}
     ...
     rtx x, y;
{
  ...
  if (((enum rtx_code) (x)->code) == SUBREG)
    fancy_abort ("../../../kg++fe/gnu/reload.c", 5984, __FUNCTION__);
     ...
     rtx *loc;
{
      ...
      if (r >= 176)
 {
   ...
   fancy_abort ("../../../kg++fe/gnu/reload.c", 6164, __FUNCTION__);
 }
     ...
     rtx x, in;
{
      ...
      if (regno >= 176)
 {
   if (reg_equiv_memory_loc[regno])
     ...
     return 0;
   fancy_abort ("../../../kg++fe/gnu/reload.c", 6292, __FUNCTION__);
 }
    }
    ...
    fancy_abort ("../../../kg++fe/gnu/reload.c", 6304, __FUNCTION__);
