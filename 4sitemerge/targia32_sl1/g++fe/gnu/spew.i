...
# 36 "../../../kg++fe/gnu/cp/spew.c" 2
# 1 "../../../kg++fe/gnu/cpplib.h" 1
# 37 "../../../kg++fe/gnu/cp/spew.c" 2
...
# 41 "../../../kg++fe/gnu/cp/spew.c" 2
# 1 "../../../include/gnu/obstack.h" 1
# 42 "../../../kg++fe/gnu/cp/spew.c" 2
...
extern long get_run_time (void);
extern void print_time (const char *, long);
# 46 "../../../kg++fe/gnu/cp/spew.c" 2
# 58 "../../../kg++fe/gnu/cp/spew.c"
struct token
{
...
# 77 "../../../kg++fe/gnu/cp/spew.c"
struct token_chunk
{
  struct token_chunk *next;
  struct token toks[20];
};
...
struct unparsed_text
{
  ...
  struct token_chunk * tokens;

  struct token_chunk *last_chunk;
  short last_pos;


  short cur_pos;
  struct token_chunk *cur_chunk;
};
...
static __inline__ void do_aggr (void);
static __inline__ int identifier_type (tree);
static void scan_tokens (int);
static void feed_defarg (tree);
static void finish_defarg (void);
static void yylexstring (struct token *);
static int read_token (struct token *);

static __inline__ int num_tokens (void);
static __inline__ struct token *nth_token (int);
static __inline__ int next_token (struct token *);
static __inline__ int shift_token (void);
static __inline__ void push_token (struct token *);
static __inline__ void consume_token (void);
static __inline__ int read_process_identifier (YYSTYPE *);

static __inline__ void feed_input (struct unparsed_text *);
static __inline__ struct token * space_for_token
  (struct unparsed_text *t);
static __inline__ struct token * remove_last_token
  (struct unparsed_text *t);
static struct unparsed_text * alloc_unparsed_text
  (const location_t *, tree decl, int interface);

static void snarf_block (struct unparsed_text *t);
static tree snarf_defarg (void);
static void snarf_parenthesized_expression (struct unparsed_text *);
static int frob_id (int, int, tree *);
...
static void begin_parsing_inclass_inline (struct unparsed_text *);
# 164 "../../../kg++fe/gnu/cp/spew.c"
     ...
     YYSTYPE *pyylval;
{
  ...
  if (((id)->common.lang_flag_5))
    {


      if (in_omp_pragma &&
          ((((struct c_common_identifier *) (id))->node.rid_code) == RID_PRIVATE ||
    (((struct c_common_identifier *) (id))->node.rid_code) == RID_STATIC))
        return 258;


      pyylval->ttype = ridpointers[(((struct c_common_identifier *) (id))->node.rid_code)];
      return rid_to_yy[(((struct c_common_identifier *) (id))->node.rid_code)];
    }
# 245 "../../../kg++fe/gnu/cp/spew.c"
  return 258;
}
  ...
  if (next_type == CPP_STRING || next_type == CPP_WSTRING)
    {
      ...
      do { if ((strings)->elements_used >= (strings)->num_elements) (((strings)) = varray_grow ((strings), 2 * (strings)->num_elements)); (strings)->data.tree[(strings)->elements_used++] = (t->yylval.ttype); } while (0);

      do
 {
   do { if ((strings)->elements_used >= (strings)->num_elements) (((strings)) = varray_grow ((strings), 2 * (strings)->num_elements)); (strings)->data.tree[(strings)->elements_used++] = (next); } while (0);
   next_type = c_lex (&next);
 }
     ...
     struct token *t;
{
 retry:
  ...
  switch (last_token)
    ...
    case CPP_EQ: t->yychar = ('='); break;;
    case CPP_NOT: t->yychar = ('!'); break;;
    case CPP_GREATER: t->yylval.code = (GT_EXPR);; t->yychar = ('>'); break;;
    case CPP_LESS: t->yylval.code = (LT_EXPR);; t->yychar = ('<'); break;;
    case CPP_PLUS: t->yylval.code = (PLUS_EXPR);; t->yychar = ('+'); break;;
    case CPP_MINUS: t->yylval.code = (MINUS_EXPR);; t->yychar = ('-'); break;;
    case CPP_MULT: t->yylval.code = (MULT_EXPR);; t->yychar = ('*'); break;;
    case CPP_DIV: t->yylval.code = (TRUNC_DIV_EXPR);; t->yychar = ('/'); break;;
    case CPP_MOD: t->yylval.code = (TRUNC_MOD_EXPR);; t->yychar = ('%'); break;;
    case CPP_AND: t->yylval.code = (BIT_AND_EXPR);; t->yychar = ('&'); break;;
    case CPP_OR: t->yylval.code = (BIT_IOR_EXPR);; t->yychar = ('|'); break;;
    case CPP_XOR: t->yylval.code = (BIT_XOR_EXPR);; t->yychar = ('^'); break;;
    case CPP_RSHIFT: t->yylval.code = (RSHIFT_EXPR);; t->yychar = (357); break;;
    case CPP_LSHIFT: t->yylval.code = (LSHIFT_EXPR);; t->yychar = (358); break;;

    case CPP_COMPL: t->yychar = ('~'); break;;
    case CPP_AND_AND: t->yychar = (353); break;;
    case CPP_OR_OR: t->yychar = (352); break;;
    case CPP_QUERY: t->yychar = ('?'); break;;
    case CPP_COLON: t->yychar = (':'); break;;
    case CPP_COMMA: t->yychar = (','); break;;
    case CPP_OPEN_PAREN: t->yychar = ('('); break;;
    case CPP_CLOSE_PAREN: t->yychar = (')'); break;;
    case CPP_EQ_EQ: t->yylval.code = (EQ_EXPR);; t->yychar = (355); break;;
    case CPP_NOT_EQ: t->yylval.code = (NE_EXPR);; t->yychar = (355); break;;
    case CPP_GREATER_EQ:t->yylval.code = (GE_EXPR);; t->yychar = (356); break;;
    case CPP_LESS_EQ: t->yylval.code = (LE_EXPR);; t->yychar = (356); break;;

    case CPP_PLUS_EQ: t->yylval.code = (PLUS_EXPR);; t->yychar = (351); break;;
    case CPP_MINUS_EQ: t->yylval.code = (MINUS_EXPR);; t->yychar = (351); break;;
    case CPP_MULT_EQ: t->yylval.code = (MULT_EXPR);; t->yychar = (351); break;;
    case CPP_DIV_EQ: t->yylval.code = (TRUNC_DIV_EXPR);; t->yychar = (351); break;;
    case CPP_MOD_EQ: t->yylval.code = (TRUNC_MOD_EXPR);; t->yychar = (351); break;;
    case CPP_AND_EQ: t->yylval.code = (BIT_AND_EXPR);; t->yychar = (351); break;;
    case CPP_OR_EQ: t->yylval.code = (BIT_IOR_EXPR);; t->yychar = (351); break;;
    case CPP_XOR_EQ: t->yylval.code = (BIT_XOR_EXPR);; t->yychar = (351); break;;
    case CPP_RSHIFT_EQ: t->yylval.code = (RSHIFT_EXPR);; t->yychar = (351); break;;
    case CPP_LSHIFT_EQ: t->yylval.code = (LSHIFT_EXPR);; t->yychar = (351); break;;

    case CPP_OPEN_SQUARE: t->yychar = ('['); break;;
    case CPP_CLOSE_SQUARE: t->yychar = (']'); break;;
    case CPP_OPEN_BRACE: t->yychar = ('{'); break;;
    case CPP_CLOSE_BRACE: t->yychar = ('}'); break;;
    case CPP_SEMICOLON: t->yychar = (';'); break;;
    case CPP_ELLIPSIS: t->yychar = (268); break;;

    case CPP_PLUS_PLUS: t->yychar = (362); break;;
    case CPP_MINUS_MINUS: t->yychar = (361); break;;
    case CPP_DEREF: t->yychar = (365); break;;
    case CPP_DOT: t->yychar = ('.'); break;;


    case CPP_SCOPE: t->yychar = (345); break;;
    case CPP_DEREF_STAR: t->yychar = (360); break;;
    case CPP_DOT_STAR: t->yychar = (359); break;;
    case CPP_MIN_EQ: t->yylval.code = (MIN_EXPR);; t->yychar = (351); break;;
    case CPP_MAX_EQ: t->yylval.code = (MAX_EXPR);; t->yychar = (351); break;;
    case CPP_MIN: t->yylval.code = (MIN_EXPR);; t->yychar = (354); break;;
    case CPP_MAX: t->yylval.code = (MAX_EXPR);; t->yychar = (354); break;;
    ...
    case CPP_NAME:
      ...
      if (t->yychar == 258 && in_omp_pragma)
      {
        if (((enum tree_code) (t->yylval.ttype)->common.code) != IDENTIFIER_NODE) fancy_abort ("../../../kg++fe/gnu/cp/spew.c", 468, __FUNCTION__);
 char * omp_name = ((char *)(t->yylval.ttype)->identifier.id.str);
 _Bool valid = 0;
...
end_input ()
{
  ...
  __extension__ ({ struct obstack *__o = (&token_obstack); void *__obj = (0); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
...
num_tokens ()
{
  return (__extension__ ({ struct obstack *__o = (&token_obstack); (unsigned) (__o->next_free - __o->object_base); }) / sizeof (struct token))
    - first_token;
}



static __inline__ struct token*
nth_token (n)
     int n;
{
  ...
  return ((struct token*)((&token_obstack)->object_base)) + n + first_token;
}

static const struct token Teosi = { 383, 0 , {0} };
static const struct token Tpad = { 347, 0 , {0} };
...
shift_token ()
{
  size_t point = __extension__ ({ struct obstack *__o = (&token_obstack); (unsigned) (__o->next_free - __o->object_base); });
  __extension__ ({ struct obstack *__o = (&token_obstack); int __len = (sizeof (struct token)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; });
  return next_token ((struct token *) (((&token_obstack)->object_base) + point));
}
...
consume_token ()
{
  if (num_tokens () == 1)
    {
      __extension__ ({ struct obstack *__o = (&token_obstack); void *__obj = (((&token_obstack)->object_base)); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
      first_token = 0;
    }
  else
    first_token++;
     ...
     struct token *t;
{
  if (first_token == 0)
    {
      size_t active = __extension__ ({ struct obstack *__o = (&token_obstack); (unsigned) (__o->next_free - __o->object_base); });
      __extension__ ({ struct obstack *__o = (&token_obstack); int __len = (sizeof (struct token)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; });
      if (active)
 memmove (((&token_obstack)->object_base) + sizeof (struct token),
   ((&token_obstack)->object_base), active);
      first_token++;
    }
  first_token--;
     ...
     int n;
{
  ...
  i = num;
  while (i > 0 && nth_token (i - 1)->yychar == 347)
    i--;
  if (i < num)
    {
      __extension__ ({ struct obstack *__o = (&token_obstack); int __len = (-((num - i) * sizeof (struct token))); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; });
      num = i;
    }
 ...
 pad_tokens:
  while (num_tokens () <= n)
    __extension__ ({ struct obstack *__o = (&token_obstack); int __len = (sizeof (struct token)); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((&Tpad)), (__len)); __o->next_free += __len; (void) 0; });
}
     ...
     tree decl;
{
  ...
  if (((enum tree_code) (decl)->common.code) == TEMPLATE_DECL)
    {
      if (((enum tree_code) (((decl)->decl.result))->common.code) == TYPE_DECL)
 return 349;
 ...
 decl = ((((decl))->exp.operands[1]));
      ...
      for (t = decl; t != (tree) ((void *)0); t = ((t)->common.chain))
 if ((((enum tree_code) ((((struct tree_overload*)(t))->function))->common.code) == TEMPLATE_DECL && ((enum tree_code) ((((((struct tree_overload*)(t))->function))->decl.result))->common.code) == FUNCTION_DECL))
   return 261;
    }
  ...
  if (((enum tree_code) (decl)->common.code) != TYPE_DECL)
    return 258;
  if (((decl)->decl.artificial_flag) && ((decl)->common.type) == scope_chain->class_type)
    return 260;



  t = got_scope;
  if (t && ((enum tree_code) (t)->common.code) == TYPENAME_TYPE)
    t = ((t)->common.type);
  decl = ((decl)->common.type);
  if (((enum tree_code) (decl)->common.code) == TYPENAME_TYPE)
    decl = ((decl)->common.type);
  if (t && t == decl)
    return 260;
...
do_aggr ()
{
 ...
 return;
  ...
  switch (yc1)
    {
    case 259:
      nth_token (1)->yychar = 374;
      break;
    case 349:
      nth_token (1)->yychar = 376;
      break;
    case 258:
      nth_token (1)->yychar = 375;
      break;
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/spew.c", 790, __FUNCTION__);
    }
}
...
yylex ()
{
 ...
 retry:
# 829 "../../../kg++fe/gnu/cp/spew.c"
  if (do_snarf_defarg)
    {
      do_snarf_defarg = 0;
      yylval.ttype = snarf_defarg ();
      yychar = 371;
      got_object = (tree) ((void *)0);
      timevar_pop (TV_LEX);
      return 371;
    }
 ...
 {
   scan_tokens (1);
   if (nth_token (1)->yychar == 267)
     {
       yychr = 368;
       nth_token (1)->yylval.ttype = (__builtin_constant_p (((nth_token (1)->yylval.ttype)->string.pointer)) ? get_identifier_with_length ((((nth_token (1)->yylval.ttype)->string.pointer)), (unsigned) strlen (((nth_token (1)->yylval.ttype)->string.pointer))) : (get_identifier) (((nth_token (1)->yylval.ttype)->string.pointer)));
      ...
      switch(yyc)
        {
          ...
          case 258:
            ...
            break;
          default:
            fancy_abort ("../../../kg++fe/gnu/cp/spew.c", 1025, __FUNCTION__);
        }
    }
  else
    lastiddecl = (tree) ((void *)0);
     ...
     struct unparsed_text *pi;
{
  ...
  if (cfun)
    (cfun->language)->unparsed_inlines = pi;
  else
  ...
  (((pi->decl)->decl.lang_specific)->u.f.pending_inline_p) = 0;
  (((pi->decl)->decl.lang_specific)->u.f.u.pending_inline_info) = 0;
  ...
  start_function ((tree) ((void *)0), pi->decl, (tree) ((void *)0),
    (0 | 1 | 2));
}
     ...
     struct unparsed_text *i;
{
  ...
  if (i)
    ...
    {
      if (cfun)
 (cfun->language)->unparsed_inlines = 0;
      else
     ...
     struct unparsed_text *t;
{
  ...
  if (t->last_pos == 0)
    fancy_abort ("../../../kg++fe/gnu/cp/spew.c", 1167, __FUNCTION__);
  t->last_pos--;
 ...
 c = c->next;
      c->next = ((void *)0);
      t->last_chunk = c;
      t->last_pos = (sizeof (c->toks) / sizeof ((c->toks)[0]));
    }
  return result;
}
     ...
     struct unparsed_text *t;
{
  ...
  else if (yychar == ':' || yychar == 314 || yychar == 367)
    {
      if (yychar == 367)
 look_for_catch = 1;
      look_for_lbrac = 1;
      ...
      else if (yyc == '}')
 {
  ...
  break;
       ...
       if (next_token (space_for_token (t)) != 366)
  {
     ...
     tree decl;
{
  ...
  if (decl == global_trees[TI_VOID_TYPE]
      || (scope_chain->class_type && ((&((scope_chain->class_type)->type.lang_specific)->u.c)->redefined)))
    return;
  ...
  (((decl)->decl.lang_specific)->u.f.u.pending_inline_info) = meth;
  (((decl)->decl.lang_specific)->u.f.pending_inline_p) = 1;
...
snarf_defarg ()
{
      ...
      else if (yyc == 0)
 {
  ...
  ((arg)->identifier.id.str) = (char *)buf;
     ...
     tree decl;
{
  if (((enum tree_code) (decl)->common.code) == FUNCTION_DECL)
    ((defarg_fns)->list.value) = decl;
  else
    {
      defarg_fns = tree_cons ((tree) ((void *)0), decl, defarg_fns);
      ((defarg_fns)->common.type) = scope_chain->class_type;
    }
}
...
feed_defarg (p)
     tree p;
{
  tree d = ((p)->list.purpose);

  feed_input ((struct unparsed_text *)((d)->identifier.id.str));
  yychar = 372;
  yylval.ttype = p;
}
...
do_pending_defargs ()
{
  ...
  for (; defarg_fns;)
    {
      ...
      tree defarg_fn = ((defarg_fns)->list.value);
      if (defarg_parm == (tree) ((void *)0))
 {
   push_nested_class (((defarg_fns)->common.type), 1);
   pushlevel (0);
   if (((enum tree_code) (defarg_fn)->common.code) == FUNCTION_DECL)
     maybe_begin_member_template_processing (defarg_fn);

   if (((enum tree_code) (defarg_fn)->common.code) == FUNCTION_DECL)
     defarg_parm = ((((defarg_fn)->common.type))->type.values);
   else
     defarg_parm = ((defarg_fn)->type.values);
 }
      else
 defarg_parm = ((defarg_parm)->common.chain);

      for (; defarg_parm; defarg_parm = ((defarg_parm)->common.chain))
 if (!((defarg_parm)->list.purpose)
     || ((enum tree_code) (((defarg_parm)->list.purpose))->common.code) != DEFAULT_ARG)
   ;
 else if (((current)->list.purpose) == global_trees[TI_ERROR_MARK])
   ((((defarg_parm)->list.purpose))->identifier.id.str) = ((void *)0);
 else
   {
      ...
      if (((enum tree_code) (defarg_fn)->common.code) == FUNCTION_DECL)
 {
   ...
   check_default_args (defarg_fn);
      ...
      defarg_fns = ((defarg_fns)->common.chain);
      if (defarg_depfns)
        {
          ...
          for (a = defarg_depfns, b = ((current)->list.purpose); a && b;
               a = ((a)->common.chain), b = ((b)->common.chain))
            if (((a)->list.value) != ((b)->list.value))
              goto different;
          if (a || b)
            {
            different:;
              ((current)->common.chain) = (tree) ((void *)0);
              defarg_fns = chainon (defarg_fns, current);
              ((current)->list.purpose) = defarg_depfns;
            }
          else
            {
              ...
              defarg_fns = current;
              ((current)->list.purpose) = global_trees[TI_ERROR_MARK];
            }
          defarg_depfns = (tree) ((void *)0);
        }
      else if (((current)->list.purpose) == global_trees[TI_ERROR_MARK])
        defarg_fnsdone = tree_cons ((tree) ((void *)0), defarg_fn, defarg_fnsdone);
    }
}
...
{
  for (; defarg_fnsdone; defarg_fnsdone = ((defarg_fnsdone)->common.chain))
    {
      tree fn = ((defarg_fnsdone)->list.value);
      tree parms;

      if (((enum tree_code) (fn)->common.code) == FUNCTION_DECL)
        parms = ((((fn)->common.type))->type.values);
      else
        parms = ((fn)->type.values);
      for (; parms; parms = ((parms)->common.chain))
 if (((parms)->list.purpose)
     && ((enum tree_code) (((parms)->list.purpose))->common.code) == DEFAULT_ARG)
   {
            (void) (((!((((parms)->list.purpose))->identifier.id.str)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/spew.c", 1578, __FUNCTION__), 0) : 0);
...
unprocessed_defarg_fn (fn)
     tree fn;
{
  defarg_depfns = tree_cons ((tree) ((void *)0), fn, defarg_depfns);
}
     ...
     tree arg, init;
{
  if (init == global_trees[TI_ERROR_MARK])
    ((arg)->list.purpose) = global_trees[TI_ERROR_MARK];
  else
    {
      if (! scope_chain->x_processing_template_decl
          && ! can_convert_arg (((arg)->list.value), ((init)->common.type), init))
        pedwarn ("invalid type `%T' for default argument to `%T'",
            ((init)->common.type), ((arg)->list.value));
      if (!defarg_depfns)
        ((arg)->list.purpose) = init;
    }
}
# 1644 "../../../kg++fe/gnu/cp/spew.c"
void
yyerror (msgid)
     const char *msgid;
{
  ...
  if (last_token == CPP_EOF)
    ...
    {
      if (yylval.ttype && ((enum tree_code) (yylval.ttype)->common.code) == INTEGER_CST)
 {
 ...
 error ("%s", string);
    ...
    {
      if (((enum tree_code) (last_token_id)->common.code) == IDENTIFIER_NODE)
        error ("%s before `%s'", string, ((char *)(last_token_id)->identifier.id.str));
      else if ((_sch_istable[(yychar) & 0xff] & (unsigned short)(_sch_isgraph)))
...
# 1 "../../../kg++fe/gnu/MIPS/gt-cp-spew.h" 1
# 23 "../../../kg++fe/gnu/MIPS/gt-cp-spew.h"
void
gt_ggc_mx_feed (x_p)
      void *x_p;
{
  ...
  if (((x) != ((void *)0) && ((void *) (x)) != (void *) 1 && ! ggc_set_mark (x)))
    {
      do { if ((*x).input != ((void *)0)) gt_ggc_mx_unparsed_text ((*x).input); } while (0);
      switch (((*x)).yychar)
        {
        case 348:
          do { if ((*x).yylval.ttype != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).yylval.ttype); } while (0);
          break;
        case 376:
          do { if ((*x).yylval.ttype != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).yylval.ttype); } while (0);
          break;
        ...
        case 375:
          ...
          break;
        case 373:
          do { if ((*x).yylval.pi != ((void *)0)) gt_ggc_mx_unparsed_text ((*x).yylval.pi); } while (0);
          break;
        case 372:
          do { if ((*x).yylval.ttype != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).yylval.ttype); } while (0);
          break;
      ...
      do { if ((*x).next != ((void *)0)) gt_ggc_mx_feed ((*x).next); } while (0);
  }
}
      ...
      void *x_p;
{
  ...
  if (((x) != ((void *)0) && ((void *) (x)) != (void *) 1 && ! ggc_set_mark (x)))
    {
      do { if ((*x).next != ((void *)0)) gt_ggc_mx_token_chunk ((*x).next); } while (0);
      {
        size_t i1_0;
        const size_t ilimit1_0 = (20);
        for (i1_0 = 0; i1_0 < ilimit1_0; i1_0++) {
          switch (((*x).toks[i1_0]).yychar)
            {
            case 348:
              do { if ((*x).toks[i1_0].yylval.ttype != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).toks[i1_0].yylval.ttype); } while (0);
              break;
            case 376:
              do { if ((*x).toks[i1_0].yylval.ttype != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).toks[i1_0].yylval.ttype); } while (0);
              break;
            ...
            case 375:
              ...
              break;
            case 373:
              do { if ((*x).toks[i1_0].yylval.pi != ((void *)0)) gt_ggc_mx_unparsed_text ((*x).toks[i1_0].yylval.pi); } while (0);
              break;
            case 372:
              do { if ((*x).toks[i1_0].yylval.ttype != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).toks[i1_0].yylval.ttype); } while (0);
              break;
      ...
      void *x_p;
{
  ...
  if (((x) != ((void *)0) && ((void *) (x)) != (void *) 1 && ! ggc_set_mark (x)))
    {
      do { if ((*x).next != ((void *)0)) gt_ggc_mx_unparsed_text ((*x).next); } while (0);
      do { if ((*x).decl != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).decl); } while (0);
      do { if ((*x).tokens != ((void *)0)) gt_ggc_mx_token_chunk ((*x).tokens); } while (0);
      do { if ((*x).last_chunk != ((void *)0)) gt_ggc_mx_token_chunk ((*x).last_chunk); } while (0);
      do { if ((*x).cur_chunk != ((void *)0)) gt_ggc_mx_token_chunk ((*x).cur_chunk); } while (0);
  }
}
