...
# 29 "../../../kg++fe/gnu/sibcall.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 30 "../../../kg++fe/gnu/sibcall.c" 2
     ...
     sibcall_use_t use;
{
  if (use == sibcall_use_tail_recursion)
    ...
    fancy_abort ("../../../kg++fe/gnu/sibcall.c", 550, __FUNCTION__);
