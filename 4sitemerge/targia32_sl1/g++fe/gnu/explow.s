...
.Ltext0:
	.section	.rodata
	.type	__FUNCTION__.12880, @object
	.size	__FUNCTION__.12880, 19
__FUNCTION__.12880:
	.string	"trunc_int_for_mode"
.LC0:
	.string	"../../../kg++fe/gnu/explow.c"
	.text
.globl trunc_int_for_mode
	.type	trunc_int_for_mode, @function
trunc_int_for_mode:
.LFB15:
	.file 1 "../../../kg++fe/gnu/explow.c"
	.loc 1 57 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LCFI5:
	...
	je	.L2
	.loc 1 62 0
	leal	__FUNCTION__.12880@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$62, 4(%esp)
...
.LFE17:
	...
	.section	.rodata
	.type	__FUNCTION__.13093, @object
	.size	__FUNCTION__.13093, 14
__FUNCTION__.13093:
...
.L80:
	.loc 1 290 0
	leal	__FUNCTION__.13093@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$290, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE29:
	...
	.section	.rodata
	.type	__FUNCTION__.13806, @object
	.size	__FUNCTION__.13806, 17
__FUNCTION__.13806:
...
.L355:
	...
	je	.L357
	.loc 1 748 0
	leal	__FUNCTION__.13806@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$748, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE37:
	...
	.section	.rodata
	.type	__FUNCTION__.14104, @object
	.size	__FUNCTION__.14104, 16
__FUNCTION__.14104:
...
.L469:
	.loc 1 1036 0
	leal	__FUNCTION__.14104@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1036, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE39:
	...
	.section	.rodata
	.type	__FUNCTION__.14180, @object
	.size	__FUNCTION__.14180, 29
__FUNCTION__.14180:
...
.L542:
	...
	je	.L543
	.loc 1 1351 0
	leal	__FUNCTION__.14180@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1351, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE42:
	...
	.section	.rodata
	.type	__FUNCTION__.14480, @object
	.size	__FUNCTION__.14480, 18
__FUNCTION__.14480:
...
.L671:
	...
	je	.L672
	.loc 1 1621 0
	leal	__FUNCTION__.14480@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1621, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE62:
	...
	.file 17 "../../../kg++fe/gnu/flags.h"
	.file 18 "../../../kg++fe/gnu/optabs.h"
	.file 19 "../../../kg++fe/gnu/MIPS/insn-codes.h"
	.file 20 "../../../kg++fe/gnu/langhooks.h"
	.file 21 "../../../kg++fe/gnu/MIPS/gt-explow.h"
