 ...
 *r = *a;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 633, __FUNCTION__);
    }
     ...
     const struct real_value *a, *b;
{
  ...
  switch (((a->class) << 2 | (b->class)))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 763, __FUNCTION__);
    }
     ...
     const struct real_value *a, *b;
{
  ...
  switch (((a->class) << 2 | (b->class)))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 900, __FUNCTION__);
    }
     ...
     int nan_result;
{
  ...
  switch (((a->class) << 2 | (b->class)))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 970, __FUNCTION__);
    }
     ...
     const struct real_value *a;
{
 ...
 clear_significand_below (r, (128 + (8 * 4)) - r->exp);
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1010, __FUNCTION__);
    }
}
 ...
 *r = *op0;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1076, __FUNCTION__);
    }
}
     ...
     const struct real_value *op0, *op1;
{
  ...
  switch (code)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1129, __FUNCTION__);
    }
}
     ...
     const struct real_value *r;
{
  switch (r->class)
    ...
    case rvc_normal:
      return r->exp;
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1149, __FUNCTION__);
    }
}
     ...
     int exp;
{
 ...
 r->exp = exp;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1180, __FUNCTION__);
    }
}
     ...
     const struct real_value *a, *b;
{
 ...
 if (a->sig[i] != b->sig[i])
   return 0;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1250, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/real.c", 1332, __FUNCTION__);
 ...
 i = -i;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1341, __FUNCTION__);
    }
}
     ...
     const struct real_value *r;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/real.c", 1400, __FUNCTION__);
      ...
      if (r->sign)
 {
   if (low == 0)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1412, __FUNCTION__);
    }
     ...
     int crop_trailing_zeros;
{
  ...
  switch (r.class)
    ...
    case rvc_nan:
      ...
      return;
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1493, __FUNCTION__);
    }
  ...
  if (max_digits > buf_size)
    fancy_abort ("../../../kg++fe/gnu/real.c", 1511, __FUNCTION__);
  ...
  if (digit == 0 && cmp_significand_0 (&r))
    {
      ...
      dec_exp -= 1;
      if (digit == 0)
 fancy_abort ("../../../kg++fe/gnu/real.c", 1654, __FUNCTION__);
    }
 ...
 *p++ = '0';
    ...
    fancy_abort ("../../../kg++fe/gnu/real.c", 1666, __FUNCTION__);
  else
    *p++ = digit + '0';
     ...
     int crop_trailing_zeros;
{
  ...
  switch (r->class)
    ...
    case rvc_nan:
      ...
      return;
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 1762, __FUNCTION__);
    }
  ...
  if (max_digits > buf_size)
    fancy_abort ("../../../kg++fe/gnu/real.c", 1773, __FUNCTION__);
  if (digits > max_digits)
    digits = max_digits;
     ...
     int unsigned_p;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/real.c", 2048, __FUNCTION__);
     ...
     int n;
{
  ...
  if (n < 0 || n >= (32 - 3))
    fancy_abort ("../../../kg++fe/gnu/real.c", 2066, __FUNCTION__);
     ...
     int n;
{
  ...
  if (n < 0 || n >= (32 - 3))
    fancy_abort ("../../../kg++fe/gnu/real.c", 2099, __FUNCTION__);
     ...
     int n;
{
  ...
  if (n < 0 || n > 9)
    fancy_abort ("../../../kg++fe/gnu/real.c", 2116, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  if (fmt == ((void *)0))
    fancy_abort ("../../../kg++fe/gnu/real.c", 2177, __FUNCTION__);
      ...
      while ((d = (_hex_value[(unsigned char) (*str)])) < base)
 {
   ...
   switch (base)
     ...
     case 10:
       ...
       break;
     default:
       fancy_abort ("../../../kg++fe/gnu/real.c", 2228, __FUNCTION__);
     }
     ...
     struct real_value *r;
{
 ...
 r->sig[((128 + (8 * 4)) / (8 * 4))-1] = ((unsigned long)1 << ((8 * 4) - 1)) >> 2;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 2340, __FUNCTION__);
    }
     ...
     const struct real_value *a;
{
  ...
  fmt = real_format_for_mode[mode - QFmode];
  if (fmt == ((void *)0))
    fancy_abort ("../../../kg++fe/gnu/real.c", 2446, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  fmt = real_format_for_mode[mode - QFmode];
  if (fmt == ((void *)0))
    fancy_abort ("../../../kg++fe/gnu/real.c", 2517, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  fmt = real_format_for_mode[mode - QFmode];
  if (fmt == ((void *)0))
    fancy_abort ("../../../kg++fe/gnu/real.c", 2547, __FUNCTION__);
     ...
     const struct real_value *r;
{
 ...
 for (i = 0; i < ((128 + (8 * 4)) / (8 * 4)); ++i)
   h ^= r->sig[i];
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 2603, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
 ...
 exp = 0;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 2665, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
 ...
 exp = r->exp + 1023 - 1;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 2818, __FUNCTION__);
    }
...
# 3026 "../../../kg++fe/gnu/real.c"
 if (denormal)
 ...
 else
   {
     exp += 16383 - 1;
     if (exp < 0)
       fancy_abort ("../../../kg++fe/gnu/real.c", 3032, __FUNCTION__);
   }
 image_hi |= exp;
 ...
 if ((8 * 4) == 32)
 ...
 else
   {
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 3051, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   round_for_format (&ieee_double_format, &v);
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 3305, __FUNCTION__);
    }
}
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   image2 &= 0xffffffff;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 3449, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
  ...
  switch (r->class)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 3652, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   image0 = (image0 >> 8) & 0xffffff;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 3727, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   image0 = (image0 >> 11) & 0xfffff;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 3831, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
  ...
  switch (r->class)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 3980, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   image_hi >>= 8;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 4053, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      if (r->sign)
 {
   ...
   sig |= 0x800000;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 4196, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      if (r->sign)
 {
   ...
   sig |= 0x80000000;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/real.c", 4278, __FUNCTION__);
    }
