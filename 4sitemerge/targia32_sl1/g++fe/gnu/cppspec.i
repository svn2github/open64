...
extern void fatal (const char *, ...)
     __attribute__ ((__format__ (__printf__, 1, 2))) __attribute__ ((__nonnull__ (1))) __attribute__ ((__noreturn__));
extern void error (const char *, ...) __attribute__ ((__format__ (__printf__, 1, 2))) __attribute__ ((__nonnull__ (1)));
extern void pfatal_with_name (const char *) __attribute__ ((__noreturn__));
...
# 24 "../../../kg++fe/gnu/cppspec.c" 2
# 43 "../../../kg++fe/gnu/cppspec.c"
...
lang_specific_driver (in_argc, in_argv, in_added_libraries)
     ...
     int *in_added_libraries __attribute__ ((__unused__));
{
  int argc = *in_argc;
      ...
      if (argv[i][0] == '-')
 {
       ...
       else if (argv[i][1] == 'x')
  {
    ...
    quote = 1;
       ...
       else if ((((argv[i][1]) == 'D' || (argv[i][1]) == 'U' || (argv[i][1]) == 'o' || (argv[i][1]) == 'e' || (argv[i][1]) == 'T' || (argv[i][1]) == 'u' || (argv[i][1]) == 'I' || (argv[i][1]) == 'm' || (argv[i][1]) == 'x' || (argv[i][1]) == 'L' || (argv[i][1]) == 'A' || (argv[i][1]) == 'V' || (argv[i][1]) == 'B' || (argv[i][1]) == 'b') || (argv[i][1]) == 'G'))
  quote = 1;
     }
   else if (argv[i][1] == 'x')
     need_fixups = 0;
     ...
     need_no_gcc = 0;
   else if (((!strcmp (&argv[i][1], "Tdata") || !strcmp (&argv[i][1], "Ttext") || !strcmp (&argv[i][1], "Tbss") || !strcmp (&argv[i][1], "include") || !strcmp (&argv[i][1], "imacros") || !strcmp (&argv[i][1], "aux-info") || !strcmp (&argv[i][1], "idirafter") || !strcmp (&argv[i][1], "iprefix") || !strcmp (&argv[i][1], "iwithprefix") || !strcmp (&argv[i][1], "iwithprefixbefore") || !strcmp (&argv[i][1], "isystem") || !strcmp (&argv[i][1], "-param") || !strcmp (&argv[i][1], "specs") || !strcmp (&argv[i][1], "MF") || !strcmp (&argv[i][1], "MT") || !strcmp (&argv[i][1], "MQ")) && strcmp (&argv[i][1], "Tdata") && strcmp (&argv[i][1], "Ttext") && strcmp (&argv[i][1], "Tbss")))
     quote = 1;
 }
      else
 {
