...
# 35 "../../../kg++fe/gnu/expmed.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 36 "../../../kg++fe/gnu/expmed.c" 2
     ...
     int opno;
{
      ...
      if ((!(target_flags & 0x00100000)))
 {
   ...
   break;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/expmed.c", 262, __FUNCTION__);
    }
...
# 345 "../../../kg++fe/gnu/expmed.c"
      ...
      if (((enum machine_mode) (op0)->mode) != fieldmode)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/expmed.c", 370, __FUNCTION__);
     }
 ...
 if (((enum rtx_code) (op0)->code) == MEM)
   ...
   fancy_abort ("../../../kg++fe/gnu/expmed.c", 394, __FUNCTION__);
      }
  }
      ...
      if (((enum rtx_code) (op0)->code) == SUBREG)
 {
   if (((enum machine_mode) ((((op0)->fld[0]).rtx))->mode) == fieldmode
     ...
     fancy_abort ("../../../kg++fe/gnu/expmed.c", 447, __FUNCTION__);
 }
   ...
   || (mode_size[(int) (((enum machine_mode) (op0)->mode))]) > ((target_flags & 0x00002000) ? 8 : 4))
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/expmed.c", 525, __FUNCTION__);
     }
      ...
      if (((enum machine_mode) (value)->mode) != maxmode)
 {
  ...
  value1 = gen_lowpart (maxmode, value1);
     ...
     fancy_abort ("../../../kg++fe/gnu/expmed.c", 670, __FUNCTION__);
 }
     ...
     rtx value;
{
  ...
  int all_zero = 0;
  int all_one = 0;
# 725 "../../../kg++fe/gnu/expmed.c"
  if (((enum rtx_code) (op0)->code) == REG || ((enum rtx_code) (op0)->code) == SUBREG)
    {
      if (offset != 0)
 fancy_abort ("../../../kg++fe/gnu/expmed.c", 728, __FUNCTION__);
     ...
     long long total_size;
{
 ...
 if (((enum rtx_code) (op0)->code) == MEM)
   ...
   fancy_abort ("../../../kg++fe/gnu/expmed.c", 1077, __FUNCTION__);
      }
  }
      ...
      for (i = 0; i < nwords; i++)
 {
   ...
   if (target_part == 0)
     fancy_abort ("../../../kg++fe/gnu/expmed.c", 1199, __FUNCTION__);
...
# 1240 "../../../kg++fe/gnu/expmed.c"
  int_mode = int_mode_for_mode (tmode);
  if (int_mode == BLKmode)
    int_mode = int_mode_for_mode (mode);
  if (int_mode == BLKmode)
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 1244, __FUNCTION__);
...
# 1973 "../../../kg++fe/gnu/expmed.c"
   ...
   && (! unsignedp || (! left && methods == OPTAB_WIDEN)))
 {
  ...
  if (temp == 0)
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 2043, __FUNCTION__);
  return temp;
}
...
# 2363 "../../../kg++fe/gnu/expmed.c"
      ...
      if (alg.cost < mult_cost)
 {
   ...
   if (alg.op[0] == alg_zero)
     ...
     fancy_abort ("../../../kg++fe/gnu/expmed.c", 2446, __FUNCTION__);
  ...
  default:
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 2524, __FUNCTION__);
  }
       ...
       if (((enum rtx_code) (accum)->code) == SUBREG)
  {
   ...
   if (val != val_so_far)
     fancy_abort ("../../../kg++fe/gnu/expmed.c", 2558, __FUNCTION__);
  ...
  if (op0 == 0)
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 2572, __FUNCTION__);
  return op0;
}
     ...
     int *lgup_ptr;
{
  ...
  if (lgup > n)
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 2622, __FUNCTION__);
  ...
  if (pow == 2 * (8 * 8))
    {
      ...
      fancy_abort ("../../../kg++fe/gnu/expmed.c", 2631, __FUNCTION__);
    }
 ...
 if (pow >= (8 * 8))
  ...
  if (mhigh_hi && nh - d >= d)
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 2657, __FUNCTION__);
  if (mhigh_hi > 1 || mlow_hi > 1)
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 2659, __FUNCTION__);

  if (! (mlow_hi < mhigh_hi || (mlow_hi == mhigh_hi && mlow_lo < mhigh_lo)))
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 2662, __FUNCTION__);
     ...
     int max_cost;
{
  ...
  if (size > (8 * 8))
    fancy_abort ("../../../kg++fe/gnu/expmed.c", 2790, __FUNCTION__);
...
# 3093 "../../../kg++fe/gnu/expmed.c"
   ...
   if (mh != 0 && (d & 1) == 0)
     {
       ...
       mh = choose_multiplier (d >> pre_shift, size,
          ...
          &ml, &post_shift, &dummy);
       if (mh)
         fancy_abort ("../../../kg++fe/gnu/expmed.c", 3200, __FUNCTION__);
     }
   else
     pre_shift = 0;
   ...
   if (remainder)
  ...
  else
    {
      ...
      mh = choose_multiplier (d, size, size - 1,
         &ml, &post_shift, &lgup);
      if (mh)
        fancy_abort ("../../../kg++fe/gnu/expmed.c", 3488, __FUNCTION__);
 ...
 return gen_lowpart (mode, rem_flag ? remainder : quotient);
      ...
      default:
 fancy_abort ("../../../kg++fe/gnu/expmed.c", 3937, __FUNCTION__);
      }
...
# 4474 "../../../kg++fe/gnu/expmed.c"
  ...
  op0 = expand_unop (compare_mode, (optab_table[OTI_neg]), op0, op0, 0);
     ...
     fancy_abort ("../../../kg++fe/gnu/expmed.c", 4520, __FUNCTION__);
     ...
     enum machine_mode mode;
{
 ...
 case EQ:
   if (arg2 != (const_int_rtx[64]) || mode != ((enum machine_mode) (arg1)->mode))
     fancy_abort ("../../../kg++fe/gnu/expmed.c", 4797, __FUNCTION__);
   do_jump_by_parts_equality_rtx (arg1, label2, label);
   break;

 case NE:
   if (arg2 != (const_int_rtx[64]) || mode != ((enum machine_mode) (arg1)->mode))
     fancy_abort ("../../../kg++fe/gnu/expmed.c", 4803, __FUNCTION__);
   do_jump_by_parts_equality_rtx (arg1, label, label2);
   break;

 default:
   fancy_abort ("../../../kg++fe/gnu/expmed.c", 4808, __FUNCTION__);
 }
