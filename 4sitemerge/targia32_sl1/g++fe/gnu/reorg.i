...
# 130 "../../../kg++fe/gnu/reorg.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 131 "../../../kg++fe/gnu/reorg.c" 2
# 1 "../../../kg++fe/gnu/conditions.h" 1
# 132 "../../../kg++fe/gnu/reorg.c" 2
     ...
     int labels_p;
{
  ...
  switch (((enum rtx_code) (insn)->code))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/reorg.c", 260, __FUNCTION__);
    }
}
     ...
     int length;
{
      ...
      for (note = (((tem)->fld[8]).rtx); note; note = next)
 {
  ...
  if (i != length + 1)
    fancy_abort ("../../../kg++fe/gnu/reorg.c", 542, __FUNCTION__);
     ...
     rtx insn, label;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/reorg.c", 867, __FUNCTION__);
 }
    }
  else
    flags |= (0x8 | 0x4);
...
# 2097 "../../../kg++fe/gnu/reorg.c"
      if (slots_to_fill == 0)
 continue;
# 2118 "../../../kg++fe/gnu/reorg.c"
      slots_filled = 0;
      delay_list = 0;
...
# 2256 "../../../kg++fe/gnu/reorg.c"
      if (slots_filled != slots_to_fill
# 2277 "../../../kg++fe/gnu/reorg.c"
...
# 2532 "../../../kg++fe/gnu/reorg.c"
}
# 2558 "../../../kg++fe/gnu/reorg.c"
static rtx
     ...
     rtx delay_list;
{
  ...
  if ((condition == const_true_rtx && ! thread_if_true)
    ...
    fancy_abort ("../../../kg++fe/gnu/reorg.c", 2581, __FUNCTION__);
  ...
  if (new_thread != thread)
    {
      ...
      if (! thread_if_true)
 fancy_abort ("../../../kg++fe/gnu/reorg.c", 2950, __FUNCTION__);
...
# 3252 "../../../kg++fe/gnu/reorg.c"
   ...
   delete_related_insns (insn);
   if (((enum rtx_code) (pat)->code) != SEQUENCE)
     fancy_abort ("../../../kg++fe/gnu/reorg.c", 3258, __FUNCTION__);
   after = trial;
   for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
     {
...
# 3359 "../../../kg++fe/gnu/reorg.c"
   )
 {
   rtx after;
   int i;
# 3375 "../../../kg++fe/gnu/reorg.c"
   for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
     ((((((((pat)->fld[0]).rtvec))->elem[i])))->in_struct) = 0;
   ...
   delete_related_insns (insn);
   if (((enum rtx_code) (pat)->code) != SEQUENCE)
     fancy_abort ("../../../kg++fe/gnu/reorg.c", 3381, __FUNCTION__);
   after = trial;
   for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
     {
       rtx this_insn = (((((pat)->fld[0]).rtvec))->elem[i]);
