     ...
     int real, expect;
{
  ...
  if (real > expect)
    fancy_abort ("../../../kg++fe/gnu/genflags.c", 112, __FUNCTION__);
  if (real == 0)
    fancy_abort ("../../../kg++fe/gnu/genflags.c", 114, __FUNCTION__);
