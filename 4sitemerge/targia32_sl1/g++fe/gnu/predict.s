...
.LFE18:
	...
	.size	__FUNCTION__.13934, 13
__FUNCTION__.13934:
	.string	"predict_insn"
.LC24:
	.string	"../../../kg++fe/gnu/predict.c"
	.text
.globl predict_insn
...
.L235:
	...
	je	.L241
	.loc 1 715 0
	leal	__FUNCTION__.14487@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$715, 4(%esp)
	leal	.LC24@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE35:
	...
	.section	.rodata
	.type	__FUNCTION__.14960, @object
	.size	__FUNCTION__.14960, 21
__FUNCTION__.14960:
...
.LCFI103:
	...
	jle	.L377
	.loc 1 1123 0
	leal	__FUNCTION__.14960@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1123, 4(%esp)
	leal	.LC24@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE48:
	...
	.file 24 "../../../kg++fe/gnu/profile.h"
	.file 25 "../../../kg++fe/gnu/params.h"
