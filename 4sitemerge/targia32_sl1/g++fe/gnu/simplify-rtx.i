...
# 32 "../../../kg++fe/gnu/simplify-rtx.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 33 "../../../kg++fe/gnu/simplify-rtx.c" 2
...
# 39 "../../../kg++fe/gnu/simplify-rtx.c" 2
# 84 "../../../kg++fe/gnu/simplify-rtx.c"
     ...
     enum machine_mode op_mode;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 387, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 391, __FUNCTION__);
      if (((enum machine_mode) (trueop)->mode) != VOIDmode
   && ((mode_class[(int) (((enum machine_mode) (trueop)->mode))]) == MODE_VECTOR_INT || (mode_class[(int) (((enum machine_mode) (trueop)->mode))]) == MODE_VECTOR_FLOAT)
   && inner_mode_array[(int) (mode)] != inner_mode_array[(int) (((enum machine_mode) (trueop)->mode))])
 fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 395, __FUNCTION__);
   ...
   || ((enum rtx_code) (trueop)->code) == CONST_VECTOR)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 414, __FUNCTION__);
       for (i = 0; i < n_elts; i++)
 ...
 case ZERO_EXTEND:
   ...
   if (op_mode == VOIDmode)
     fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 505, __FUNCTION__);
  ...
  fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 512, __FUNCTION__);
       val = arg0;
     }
   ...
   if ((mode_bitsize[(int) (op_mode)]) == (8 * 8))
     {
       ...
       if (width != (mode_bitsize[(int) (op_mode)]))
  fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 530, __FUNCTION__);
       val = arg0;
     }
   else if ((mode_bitsize[(int) (op_mode)]) < (8 * 8))
     {
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 553, __FUNCTION__);
 }
 ...
 case ZERO_EXTEND:
   if (op_mode == VOIDmode)
     fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 609, __FUNCTION__);
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 673, __FUNCTION__);
 }
      return const_double_from_real_value (d, mode);
    }
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 691, __FUNCTION__);
 }
 ...
 case SIGN_EXTEND:
   ...
   if (((enum rtx_code) (op)->code) == TRUNCATE
     ...
     return (((op)->fld[0]).rtx);
# 746 "../../../kg++fe/gnu/simplify-rtx.c"
   break;
# 761 "../../../kg++fe/gnu/simplify-rtx.c"
 default:
   break;
 }
     ...
     rtx op0, op1;
{
  ...
  if ((rtx_class[(int) (code)]) == '<')
    fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 793, __FUNCTION__);
...
# 1078 "../../../kg++fe/gnu/simplify-rtx.c"
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 1447, __FUNCTION__);
 }
 ...
 return 0;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 1623, __FUNCTION__);
    }
     ...
     rtx op0, op1;
{
  ...
  if (mode == VOIDmode
   ...
   || ((enum machine_mode) (op1)->mode) != VOIDmode))
    fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 1925, __FUNCTION__);
 ...
 default:
  ...
  switch (code)
    ...
    case UNORDERED:
      return (const_int_rtx[64]);
    default:
      fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2198, __FUNCTION__);
    }
}
     ...
     rtx op0, op1, op2;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2321, __FUNCTION__);
   ...
   && ((enum rtx_code) (op2)->code) == CONST_INT)
 {
   ...
   return gen_rtx_CONST_VECTOR (mode, v);
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2343, __FUNCTION__);
    }
     ...
     enum machine_mode outermode, innermode;
{
  ...
  if (innermode == VOIDmode || outermode == VOIDmode
    ...
    fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2360, __FUNCTION__);

  if (((enum machine_mode) (op)->mode) != innermode
      && ((enum machine_mode) (op)->mode) != VOIDmode)
    fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2364, __FUNCTION__);

  if (byte % (mode_size[(int) (outermode)])
      || byte >= (mode_size[(int) (innermode)]))
    fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2368, __FUNCTION__);
     ...
     enum machine_mode outermode, innermode;
{
  ...
  if (innermode == VOIDmode || outermode == VOIDmode
      || innermode == BLKmode || outermode == BLKmode)
    fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2744, __FUNCTION__);

  if (((enum machine_mode) (op)->mode) != innermode
      && ((enum machine_mode) (op)->mode) != VOIDmode)
    fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2748, __FUNCTION__);

  if (byte % (mode_size[(int) (outermode)])
      || byte >= (mode_size[(int) (innermode)]))
    fancy_abort ("../../../kg++fe/gnu/simplify-rtx.c", 2752, __FUNCTION__);
