...
# 36 "../../../kg++fe/gnu/sched-vis.c" 2
# 46 "../../../kg++fe/gnu/sched-vis.c"
     ...
     int verbose;
{
 ...
 sprintf (buf, "%s}", t1);
    ...
    case SEQUENCE:
      ...
      fancy_abort ("../../../kg++fe/gnu/sched-vis.c", 701, __FUNCTION__);
      break;
    case ASM_INPUT:
