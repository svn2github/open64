...
.LC172:
	...
	.align 32
	.type	debug_reg_names, @object
	.size	debug_reg_names, 704
debug_reg_names:
	.long	.LC0
	.long	.LC1
	.long	.LC2
...
.LC205:
	.string	"%d %s"
.LC206:
	.string	" %d virtual-incoming-args"
.LC207:
	.string	" %d virtual-stack-vars"
.LC208:
	.string	" %d virtual-stack-dynamic"
.LC209:
	.string	" %d virtual-outgoing-args"
.LC210:
	.string	" %d virtual-cfa"
.LC211:
	.string	" %d virtual-reg-%d"
.LC212:
	.string	" {%s}"
.LC213:
	.string	" [# deleted]"
...
.LC220:
	...
	.align 4
.LC221:
	.string	"switch format wrong in rtl.print_rtx(). format was: %c.\n"
	.align 4
.LC222:
	.string	"../../../kg++fe/gnu/print-rtl.c"
.LC223:
	.string	" S"
.LC224:
	.string	" A%u"
...
.LCFI9:
	...
	movl	$0, -128(%ebp)
	.loc 1 121 0
	movl	sawclose@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	je	.L18
	.loc 1 123 0
	movl	flag_simple@GOT(%ebx), %eax
	movl	(%eax), %eax
	testl	%eax, %eax
	je	.L20
	.loc 1 124 0
	movl	outfile@GOTOFF(%ebx), %eax
	movl	%eax, 4(%esp)
	movl	$32, (%esp)
	call	fputc_unlocked@PLT
	jmp	.L22
.L20:
	.loc 1 126 0
	movl	indent@GOTOFF(%ebx), %eax
	leal	(%eax,%eax), %ecx
	movl	print_rtx_head@GOT(%ebx), %eax
	movl	(%eax), %edx
	movl	outfile@GOTOFF(%ebx), %esi
...
.L55:
	...
	movzbl	2(%eax), %eax
	movzbl	%al, %edx
	movl	reg_note_name@GOT(%ebx), %eax
	movl	(%eax,%edx,4), %eax
	movl	outfile@GOTOFF(%ebx), %edx
	movl	%eax, 8(%esp)
...
.L101:
	.loc 1 248 0
	movl	flag_dump_unnumbered@GOT(%ebx), %eax
	movl	(%eax), %eax
	testl	%eax, %eax
	je	.L106
	.loc 1 249 0
...
.LBB5:
	...
	movl	-132(%ebp), %eax
	movl	4(%eax), %eax
	movl	debug_reg_names@GOTOFF(%ebx,%eax,4), %edx
	movl	-132(%ebp), %eax
	movl	4(%eax), %eax
	movl	outfile@GOTOFF(%ebx), %ecx
	movl	%edx, 12(%esp)
...
.L65:
	...
	call	fprintf@PLT
	.loc 1 489 0
	leal	__FUNCTION__.11418@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$489, 4(%esp)
...
.L208:
	.loc 1 551 0
	movl	debug_call_placeholder_verbose@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	je	.L265
	.loc 1 553 0
	movl	outfile@GOTOFF(%ebx), %eax
...
.globl debug_rtx_count
	.bss
	.align 4
	.type	debug_rtx_count, @object
	.size	debug_rtx_count, 4
debug_rtx_count:
	.zero	4
	.text
...
.L319:
	...
	je	.L321
	.loc 1 707 0
	movl	debug_rtx_count@GOT(%ebx), %eax
	movl	(%eax), %eax
	movl	%eax, 4(%esp)
	movl	8(%ebp), %eax
	movl	%eax, (%esp)
	call	debug_rtx_list@PLT
	.loc 1 708 0
	movl	8(%ebp), %eax
	movl	%eax, -8(%ebp)
	jmp	.L323
...
.LFE24:
	...
	.local	indent
	.comm	indent,4,4
	.local	debug_call_placeholder_verbose
	.comm	debug_call_placeholder_verbose,4,4
...
.LEFDE18:
	...
	.file 10 "../../../kg++fe/gnu/bitmap.h"
	.file 11 "../../../kg++fe/gnu/basic-block.h"
	.file 12 "../../../kg++fe/gnu/sbitmap.h"
	.file 13 "../../../kg++fe/gnu/real.h"
	.file 14 "../../../kg++fe/gnu/hashtable.h"
	.file 15 "../../../kg++fe/gnu/location.h"
...
.LLST9:
	...
	.byte	0x0
	.uleb128 0x24
	.string	"debug_reg_names"
	.byte	0x1
	.byte	0x2f
	.long	0x5cd6
	.byte	0x5
	.byte	0x3
	.long	debug_reg_names
	.uleb128 0xa
	.long	0x5ca9
	.uleb128 0x24
	.string	"outfile"
	...
	.long	indent
	.uleb128 0x24
	.string	"debug_call_placeholder_verbose"
	.byte	0x1
	.byte	0x4e
	.long	0x2e6
	.byte	0x5
	.byte	0x3
	.long	debug_call_placeholder_verbose
	.uleb128 0x2e
	.string	"stderr"
	.byte	0x2
	.byte	0x90
