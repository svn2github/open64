...
# 29 "../../../kg++fe/gnu/cpplex.c" 2
# 1 "../../../kg++fe/gnu/cpplib.h" 1
# 31 "../../../kg++fe/gnu/cpplib.h"
...
# 30 "../../../kg++fe/gnu/cpplex.c" 2
# 1 "../../../kg++fe/gnu/cpphash.h" 1
# 28 "../../../kg++fe/gnu/cpphash.h"
struct directive;
struct pending_option;
struct op;

typedef unsigned char uchar;
# 54 "../../../kg++fe/gnu/cpphash.h"
struct dummy
{
  char c;
  union
...
# 31 "../../../kg++fe/gnu/cpplex.c" 2
# 39 "../../../kg++fe/gnu/cpplex.c"
# 1 "../../../kg++fe/gnu/defaults.h" 1
# 40 "../../../kg++fe/gnu/cpplex.c" 2
...
static const struct token_spelling token_spellings[N_TTYPES] = { { SPELL_OPERATOR, (const uchar *) "=" }, { SPELL_OPERATOR, (const uchar *) "!" }, { SPELL_OPERATOR, (const uchar *) ">" }, { SPELL_OPERATOR, (const uchar *) "<" }, { SPELL_OPERATOR, (const uchar *) "+" }, { SPELL_OPERATOR, (const uchar *) "-" }, { SPELL_OPERATOR, (const uchar *) "*" }, { SPELL_OPERATOR, (const uchar *) "/" }, { SPELL_OPERATOR, (const uchar *) "%" }, { SPELL_OPERATOR, (const uchar *) "&" }, { SPELL_OPERATOR, (const uchar *) "|" }, { SPELL_OPERATOR, (const uchar *) "^" }, { SPELL_OPERATOR, (const uchar *) ">>" }, { SPELL_OPERATOR, (const uchar *) "<<" }, { SPELL_OPERATOR, (const uchar *) "<?" }, { SPELL_OPERATOR, (const uchar *) ">?" }, { SPELL_OPERATOR, (const uchar *) "~" }, { SPELL_OPERATOR, (const uchar *) "&&" }, { SPELL_OPERATOR, (const uchar *) "||" }, { SPELL_OPERATOR, (const uchar *) "?" }, { SPELL_OPERATOR, (const uchar *) ":" }, { SPELL_OPERATOR, (const uchar *) "," }, { SPELL_OPERATOR, (const uchar *) "(" }, { SPELL_OPERATOR, (const uchar *) ")" }, { SPELL_NONE, (const uchar *) "CPP_EOF" }, { SPELL_OPERATOR, (const uchar *) "==" }, { SPELL_OPERATOR, (const uchar *) "!=" }, { SPELL_OPERATOR, (const uchar *) ">=" }, { SPELL_OPERATOR, (const uchar *) "<=" }, { SPELL_OPERATOR, (const uchar *) "+=" }, { SPELL_OPERATOR, (const uchar *) "-=" }, { SPELL_OPERATOR, (const uchar *) "*=" }, { SPELL_OPERATOR, (const uchar *) "/=" }, { SPELL_OPERATOR, (const uchar *) "%=" }, { SPELL_OPERATOR, (const uchar *) "&=" }, { SPELL_OPERATOR, (const uchar *) "|=" }, { SPELL_OPERATOR, (const uchar *) "^=" }, { SPELL_OPERATOR, (const uchar *) ">>=" }, { SPELL_OPERATOR, (const uchar *) "<<=" }, { SPELL_OPERATOR, (const uchar *) "<?=" }, { SPELL_OPERATOR, (const uchar *) ">?=" }, { SPELL_OPERATOR, (const uchar *) "#" }, { SPELL_OPERATOR, (const uchar *) "##" }, { SPELL_OPERATOR, (const uchar *) "[" }, { SPELL_OPERATOR, (const uchar *) "]" }, { SPELL_OPERATOR, (const uchar *) "{" }, { SPELL_OPERATOR, (const uchar *) "}" }, { SPELL_OPERATOR, (const uchar *) ";" }, { SPELL_OPERATOR, (const uchar *) "..." }, { SPELL_OPERATOR, (const uchar *) "++" }, { SPELL_OPERATOR, (const uchar *) "--" }, { SPELL_OPERATOR, (const uchar *) "->" }, { SPELL_OPERATOR, (const uchar *) "." }, { SPELL_OPERATOR, (const uchar *) "::" }, { SPELL_OPERATOR, (const uchar *) "->*" }, { SPELL_OPERATOR, (const uchar *) ".*" }, { SPELL_OPERATOR, (const uchar *) "@" }, { SPELL_IDENT, (const uchar *) "CPP_NAME" }, { SPELL_NUMBER, (const uchar *) "CPP_NUMBER" }, { SPELL_STRING, (const uchar *) "CPP_CHAR" }, { SPELL_STRING, (const uchar *) "CPP_WCHAR" }, { SPELL_CHAR, (const uchar *) "CPP_OTHER" }, { SPELL_STRING, (const uchar *) "CPP_STRING" }, { SPELL_STRING, (const uchar *) "CPP_WSTRING" }, { SPELL_STRING, (const uchar *) "CPP_HEADER_NAME" }, { SPELL_NUMBER, (const uchar *) "CPP_COMMENT" }, { SPELL_NONE, (const uchar *) "CPP_MACRO_ARG" }, { SPELL_NONE, (const uchar *) "CPP_PADDING" }, };
...
static void handle_newline (cpp_reader *);
static cppchar_t skip_escaped_newlines (cpp_reader *);
static cppchar_t get_effective_char (cpp_reader *);

static int skip_block_comment (cpp_reader *);
static int skip_line_comment (cpp_reader *);
static void adjust_column (cpp_reader *);
static int skip_whitespace (cpp_reader *, cppchar_t);
static cpp_hashnode *parse_identifier (cpp_reader *);
static uchar *parse_slow (cpp_reader *, const uchar *, int, unsigned int *);

static void parse_number (cpp_reader *, cpp_string *, int);
static int unescaped_terminator_p (cpp_reader *, const uchar *);
static void parse_string (cpp_reader *, cpp_token *, cppchar_t);
static _Bool trigraph_p (cpp_reader *);
static void save_comment (cpp_reader *, cpp_token *, const uchar *, cppchar_t);

static _Bool continue_after_nul (cpp_reader *);
static int name_p (cpp_reader *, const cpp_string *);
static int maybe_read_ucs (cpp_reader *, const unsigned char **, const unsigned char *, cppchar_t *);
     ...
     const char *string;
{
  ...
  return !ustrcmp (((&(token->val.node)->ident)->str), (const uchar *) string);
}


extern _Bool in_omp_pragma;
_Bool seen_omp_paren = 0;
     ...
     cpp_reader *pfile;
{
  ...
  accept = ((pfile)->opts.trigraphs);


  if (((pfile)->opts.warn_trigraphs) && !pfile->state.lexing_comment)
    {
      if (accept)
 cpp_error_with_line (pfile, 0x00,
        pfile->line, (((buffer)->cur) - (buffer)->line_base + (buffer)->col_adjust) - 1,
     ...
     cpp_reader *pfile;
{
      ...
      do
 {
  ...
  break;
   ...
   do
     next1 = *buffer->cur++;
   while ((_sch_istable[(next1) & 0xff] & (unsigned short)(_sch_isnvsp)) && buffer->cur < buffer->rlimit);

   if (!(_sch_istable[(next1) & 0xff] & (unsigned short)(_sch_isvsp)))
     {
     ...
     cpp_reader *pfile;
{
      ...
      if (c == '/')
 {
   ...
   if (((pfile)->opts.warn_comments)
     ...
     cpp_error_with_line (pfile, 0x00,
     pfile->line, (((buffer)->cur) - (buffer)->line_base + (buffer)->col_adjust),
     "\"/*\" within comment");
 }
      else if ((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isvsp)))
 handle_newline (pfile);
      else if (c == '\t')
 adjust_column (pfile);
    }
  ...
  do
    {
      if (buffer->cur == buffer->rlimit)
 goto at_eof;
# 353 "../../../kg++fe/gnu/cpplex.c"
      c = *buffer->cur++;

      if (c == '?' || c == '\\')
 c = skip_escaped_newlines (pfile);
    }
  while (!(_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isvsp)));
...
{
  cpp_buffer *buffer = pfile->buffer;
  unsigned int col = (((buffer)->cur) - (buffer)->line_base + (buffer)->col_adjust) - 1;



  buffer->col_adjust += (((pfile)->opts.tabstop)
    - col % ((pfile)->opts.tabstop)) - 1;
}
     ...
     cppchar_t c;
{
 ...
 cpp_error_with_line (pfile, 0x02, pfile->line,
        (((buffer)->cur) - (buffer)->line_base + (buffer)->col_adjust),
     ...
     const cpp_string *string;
{
  ...
  for (i = 0; i < string->len; i++)
    if (!((_sch_istable[(string->text[i]) & 0xff] & (unsigned short)(_sch_isidnum)) || ((string->text[i]) == '$' && ((pfile)->opts.dollars_in_ident))))
      return 0;

  return 1;
}
# 451 "../../../kg++fe/gnu/cpplex.c"
static cpp_hashnode *
     ...
     cpp_reader *pfile;
{
 ...
 ht_lookup (pfile->hash_table, base, cur - base, HT_ALLOC);
  ...
  if (__builtin_expect ((result->flags & (1 << 3))
     ...
     unsigned int *plen;
{
  ...
  if (number_p == 2)
    __extension__ ({ struct obstack *__o = (stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('.'); (void) 0; });


  __extension__ ({ struct obstack *__o = (stack); int __len = (cur - base); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((base)), (__len)); __o->next_free += __len; (void) 0; });
 ...
 c = skip_escaped_newlines (pfile);
      ...
      if (!((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isidnum)) || ((c) == '$' && ((pfile)->opts.dollars_in_ident))))
 {
   if (!number_p)
     break;
   if (c != '.' && !(((c) == '+' || (c) == '-') && ((prevc) == 'e' || (prevc) == 'E' || (((prevc) == 'p' || (prevc) == 'P') && ((pfile)->opts.extended_numbers)))))
     break;
 }
 ...
 {
   prevc = c;
   __extension__ ({ struct obstack *__o = (stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (c); (void) 0; });
   ...
   c = *buffer->cur++;
      ...
      while (((_sch_istable[(c) & 0xff] & (unsigned short)(_sch_isidnum)) || ((c) == '$' && ((pfile)->opts.dollars_in_ident))));
    }


  do {buffer->cur = buffer->backup_to;} while (0);




  if (saw_dollar && ((pfile)->opts.pedantic) && ! pfile->state.skipping)
    cpp_error (pfile, 0x02, "'$' character(s) in identifier or number");


  *plen = __extension__ ({ struct obstack *__o = (stack); (unsigned) (__o->next_free - __o->object_base); });
  __extension__ ({ struct obstack *__o = (stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('\0'); (void) 0; });
  return __extension__ ({ struct obstack *__o1 = (stack); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; });
}
...
# 691 "../../../kg++fe/gnu/cpplex.c"
 ...
 unterminated:
   if (((pfile)->opts.lang) != CLK_ASM || terminator == '>')
     cpp_error (pfile, 0x03, "missing terminating %c character",
         (int) terminator);
   buffer->cur--;
   break;
 }
...
# 735 "../../../kg++fe/gnu/cpplex.c"
 *dest++ = c;
    }

  *dest = '\0';

  token->val.str.text = ((pfile->u_buff)->cur);
  token->val.str.len = dest - ((pfile->u_buff)->cur);
...
_Bool last_token_omp_hash = 0;
static cpp_token *
_cpp_omp_token (cpp_reader * pfile)
{
  cpp_buffer * buffer = pfile->buffer;
  cpp_token * result = ((void *)0);
     ...
     cpp_reader *pfile;
{
 ...
 if (in_omp_pragma && *(pfile->buffer->cur-1) == '\n')
   return result;
      ...
      if ((result->flags & (1 << 6)) && result->type == CPP_HASH &&
   ...
   if (buffer->cur != buffer->line_base)
     {
       ...
       if (!buffer->from_stage3)
  cpp_error (pfile, 0x02, "no newline at end of file");
       handle_newline (pfile);
     }
     ...
     cpp_reader *pfile;
{
 ...
 skipped_white:
  c = *buffer->cur++;
  result->col = ((buffer->cur) - (buffer)->line_base + (buffer)->col_adjust);
      ...
      if (result->val.node->flags & (1 << 0))
 {
   result->flags |= (1 << 4);
          ...
          result->type = result->val.node->value.operator_code;
 ...
 do { if (get_effective_char (pfile) == '=') result->type = CPP_LSHIFT_EQ; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_LSHIFT; } } while (0);
      else if (c == '?' && ((pfile)->opts.cplusplus))
 do { if (get_effective_char (pfile) == '=') result->type = CPP_MIN_EQ; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_MIN; } } while (0);
      else if (c == ':' && ((pfile)->opts.digraphs))
 {
 ...
 do { if (get_effective_char (pfile) == '=') result->type = CPP_RSHIFT_EQ; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_RSHIFT; } } while (0);
      else if (c == '?' && ((pfile)->opts.cplusplus))
 do { if (get_effective_char (pfile) == '=') result->type = CPP_MAX_EQ; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_MAX; } } while (0);
      else
 {
   do {buffer->cur = buffer->backup_to;} while (0);
      ...
      else
 {
   ...
   result->type = CPP_COLON;
    ...
    case '*': do { if (get_effective_char (pfile) == '=') result->type = CPP_MULT_EQ; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_MULT; } } while (0); break;
    case '=': do { if (get_effective_char (pfile) == '=') result->type = CPP_EQ_EQ; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_EQ; } } while (0); break;
    case '!': do { if (get_effective_char (pfile) == '=') result->type = CPP_NOT_EQ; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_NOT; } } while (0); break;
    case '^': do { if (get_effective_char (pfile) == '=') result->type = CPP_XOR_EQ; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_XOR; } } while (0); break;
    case '#': do { if (get_effective_char (pfile) == '#') result->type = CPP_PASTE; else { do {buffer->cur = buffer->backup_to;} while (0); result->type = CPP_HASH; } } while (0); break;

    case '~': result->type = CPP_COMPL; break;
    case ',': result->type = CPP_COMMA; break;
    case '(': result->type = CPP_OPEN_PAREN;

              if (in_omp_pragma) seen_omp_paren = 1;
     ...
     unsigned char *buffer;
{
 ...
 switch (token->type)
   ...
   default:
     cpp_error (pfile, 0x04, "unknown string token %s\n",
 ...
 *buffer++ = right;
    ...
    case SPELL_NONE:
      cpp_error (pfile, 0x04, "unspellable token %s", (token_spellings[(token)->type].name));
      break;
    }
     ...
     FILE *fp;
{
 ...
 if (tag) putc_unlocked (tag, fp);
 putc_unlocked (left, fp);
 fwrite_unlocked (token->val.str.text, 1, token->val.str.len, fp);
 putc_unlocked (right, fp);
      }
      break;
     ...
     const cpp_token *token1, *token2;
{
  ...
  switch (a)
    ...
    || c == '.' || c == '+' || c == '-');
    case CPP_OTHER: return (((pfile)->opts.objc)
    && token1->val.c == '@'
...
hex_digit_value (c)
     unsigned int c;
{
  if (((_hex_value[(unsigned char) (c)]) != 99))
    return (_hex_value[(unsigned char) (c)]);
  else
    abort ();
}
# 1839 "../../../kg++fe/gnu/cpplex.c"
static int
     ...
     cppchar_t *pc;
{
  ...
  if ((size_t) (limit - p) < length)
    {
      cpp_error (pfile, 0x03, "incomplete universal-character-name");
      ...
      for (; length; length--, p++)
 {
  ...
  if (code >= 0xa0
    ...
    cpp_error (pfile, 0x03, "universal-character-name out of range");
     ...
     int wide;
{
  ...
  if (wide)
    width = ((pfile)->opts.wchar_precision);
  else
    width = ((pfile)->opts.char_precision);
 ...
 cpp_error (pfile, 0x02,
  ...
  if (c > mask)
    {
      cpp_error (pfile, 0x02, "escape sequence out of range for its type");
      c &= mask;
    }
     ...
     int *unsignedp;
{
  ...
  if (token->type == CPP_CHAR)
    {
      width = ((pfile)->opts.char_precision);
      max_chars = ((pfile)->opts.int_precision) / width;
  ...
  else
    {
      width = ((pfile)->opts.wchar_precision);
      max_chars = 1;
      unsigned_p = ((pfile)->opts.unsigned_wchar);
    }
...
# 2112 "../../../kg++fe/gnu/cpplex.c"
      ...
      if (chars_seen > max_chars)
 {
   ...
   cpp_error (pfile, 0x00,
      ...
      else if (((pfile)->opts.warn_multichar))
     ...
     size_t len;
{
  ...
  if (len < 8000)
    len = 8000;
  len = (((len) + ((__builtin_offsetof (struct dummy, u)) - 1)) & ~((__builtin_offsetof (struct dummy, u)) - 1));
