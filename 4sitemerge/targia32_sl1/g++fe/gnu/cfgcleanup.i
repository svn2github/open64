...
# 41 "../../../kg++fe/gnu/cfgcleanup.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 42 "../../../kg++fe/gnu/cfgcleanup.c" 2
       ...
       if (t)
  {
        ...
        if (i < nthreaded_edges)
   {
    ...
    if (nthreaded_edges >= n_basic_blocks)
      fancy_abort ("../../../kg++fe/gnu/cfgcleanup.c", 508, __FUNCTION__);
      ...
      else
 {
       ...
       if (first->succ->succ_next)
  {
    ...
    if (n >= nthreaded_edges)
      fancy_abort ("../../../kg++fe/gnu/cfgcleanup.c", 614, __FUNCTION__);
    t = threaded_edges [n++];
    if (t->src != first)
      fancy_abort ("../../../kg++fe/gnu/cfgcleanup.c", 617, __FUNCTION__);
    if (first->frequency)
     ...
     basic_block a, b;
{
  ...
  if (((enum rtx_code) (barrier)->code) != BARRIER)
    fancy_abort ("../../../kg++fe/gnu/cfgcleanup.c", 724, __FUNCTION__);
  delete_insn (barrier);
# 734 "../../../kg++fe/gnu/cfgcleanup.c"
  if (squeeze_notes (&a->head, &a->end))
    fancy_abort ("../../../kg++fe/gnu/cfgcleanup.c", 735, __FUNCTION__);
     ...
     basic_block a, b;
{
  ...
  if (barrier && ((enum rtx_code) (barrier)->code) == BARRIER)
    delete_insn (barrier);
# 793 "../../../kg++fe/gnu/cfgcleanup.c"
  if (squeeze_notes (&b->head, &b->end))
    fancy_abort ("../../../kg++fe/gnu/cfgcleanup.c", 794, __FUNCTION__);
