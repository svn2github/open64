...
# 54 "../../../kg++fe/gnu/emit-rtl.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 55 "../../../kg++fe/gnu/emit-rtl.c" 2
     ...
     enum machine_mode mode;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 432, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 447, __FUNCTION__);
# 458 "../../../kg++fe/gnu/emit-rtl.c"
      if (width < (8 * 8)
   && (i0 & ((long long) 1 << (width - 1))))
 i0 |= ((long long) (-1) << width);
# 480 "../../../kg++fe/gnu/emit-rtl.c"
      if (width <= (8 * 8))
     ...
     int offset;
{
  ...
  if ((offset % (mode_size[(int) (mode)])) != 0)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 591, __FUNCTION__);
# 601 "../../../kg++fe/gnu/emit-rtl.c"
...
gen_rtx (enum rtx_code code, enum machine_mode mode, ...)
{
      ...
      for (i = 0; i < (rtx_length[(int) (code)]); i++)
 {
   switch (*fmt++)
     ...
     default:
       fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 724, __FUNCTION__);
     }
 }
      break;
    }
     ...
     enum machine_mode mode;
{
  ...
  if (no_new_pseudos)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 797, __FUNCTION__);
     ...
     rtx reg;
{
  if (((enum rtx_code) (reg)->code) == CONCAT)
    ...
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 862, __FUNCTION__);
}
     ...
     int check_mode;
{
  ...
  if (((enum rtx_code) (x)->code) != SUBREG
    ...
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 926, __FUNCTION__);
  base_regno = (((reg)->fld[0]).rtuint);
  if (base_regno >= 176)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 929, __FUNCTION__);
  if (check_mode && ! mips_hard_regno_mode_ok[ (int)(((enum machine_mode) (reg)->mode)) ][ (base_regno) ])
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 931, __FUNCTION__);
  ...
  if ((byte_offset % (mode_size[(int) (mode)])) != 0)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 940, __FUNCTION__);

  final_regno = subreg_regno (x);

  return final_regno;
}
# 958 "../../../kg++fe/gnu/emit-rtl.c"
rtx
...
# 1048 "../../../kg++fe/gnu/emit-rtl.c"
 ...
 case 128:
   ...
   break;
 default:
   fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1124, __FUNCTION__);
 }
      ...
      if ((8 * 8) != 64)
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1132, __FUNCTION__);
     ...
     rtx x;
{
  ...
  if (result)
  ...
  else if (((enum rtx_code) (x)->code) == REG)
    {
      ...
      if (result == 0)
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1229, __FUNCTION__);
      return result;
    }
     ...
     rtx x;
{
  ...
  if (msize > ((target_flags & 0x00002000) ? 8 : 4)
    ...
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1278, __FUNCTION__);
     ...
     rtx exp;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1313, __FUNCTION__);
     ...
     enum machine_mode outermode, innermode;
{
  ...
  if ((mode_size[(int) (innermode)]) < (mode_size[(int) (outermode)]))
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1351, __FUNCTION__);
...
# 1422 "../../../kg++fe/gnu/emit-rtl.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1446, __FUNCTION__);
    }
 ...
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1475, __FUNCTION__);
    }
     ...
     enum machine_mode mode;
{
  ...
  if (mode == VOIDmode)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1576, __FUNCTION__);
     ...
     enum machine_mode mode;
{
 ...
 op = force_reg (mode, op);
  ...
  if (result == 0)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1638, __FUNCTION__);
     ...
     long long bitpos;
{
  ...
  if ((tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 'd') && ref == (((t)->decl.rtl != ((void *)0)) ? ((t)->decl.rtl ? (t)->decl.rtl : (make_decl_rtl (t, ((void *)0)), (t)->decl.rtl)) : ((void *)0)))
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 1748, __FUNCTION__);
     ...
     int validate;
{
  ...
  if (((enum rtx_code) (memref)->code) != MEM)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 2037, __FUNCTION__);
  if (mode == VOIDmode)
      ...
      if (reload_in_progress || reload_completed)
 {
   if (! memory_address_p (mode, addr))
     fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 2048, __FUNCTION__);
 }
      else
     ...
     rtx may_share;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 2590, __FUNCTION__);
 }
    }
  return copy;
}
...
{
  if ((((insn)->fld[1]).rtx) != 0)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 2833, __FUNCTION__);
...
{
  if ((((insn)->fld[2]).rtx) != 0)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 2852, __FUNCTION__);
      ...
      if (((enum rtx_code) (insn)->code) == JUMP_INSN)
 {
   ...
   if (probability != -1
       ...
       && !find_reg_note (insn, REG_BR_PROB, 0))
     {
       ...
       if (njumps != 1)
  fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3293, __FUNCTION__);
       (((insn)->fld[8]).rtx)
     ...
     rtx insn, after;
{
  ...
  if (optimize && (((after))->volatil))
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3514, __FUNCTION__);
 ...
 if (after == stack->last)
   {
     ...
     break;
      ...
      if (stack == 0)
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3539, __FUNCTION__);
    }
     ...
     rtx insn, before;
{
  ...
  if (optimize && (((before))->volatil))
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3580, __FUNCTION__);
 ...
 if (before == stack->first)
   {
     ...
     break;
      ...
      if (stack == 0)
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3608, __FUNCTION__);
    }
 ...
 bb->flags |= 1;
   ...
   && (((enum rtx_code) (insn)->code) != NOTE
       || (((insn)->fld[5]).rtint) != NOTE_INSN_BASIC_BLOCK))
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3625, __FUNCTION__);
    }
     ...
     rtx insn;
{
 ...
 if (insn == stack->first)
   {
     ...
     break;
      ...
      if (stack == 0)
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3666, __FUNCTION__);
    }
 ...
 if (insn == stack->last)
   {
     ...
     break;
      ...
      if (stack == 0)
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3689, __FUNCTION__);
    }
      ...
      if (bb->head == insn)
 {
   ...
   if (((enum rtx_code) (insn)->code) == NOTE)
     fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3701, __FUNCTION__);
   bb->head = next;
 }
      if (bb->end == insn)
 bb->end = prev;
...
remove_unnecessary_notes ()
{
 ...
 case NOTE_INSN_EH_REGION_END:
   ...
   if (eh_stack == (rtx) 0)
     fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3869, __FUNCTION__);

   if (((((((eh_stack)->fld[0]).rtx))->fld[4]).rtint) != (((insn)->fld[4]).rtint))
     fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3872, __FUNCTION__);
   tmp = eh_stack;
 ...
 case NOTE_INSN_BLOCK_BEG:
   ...
   if ((((insn)->fld[4]).rttree) == (tree) ((void *)0))
     fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3882, __FUNCTION__);
 ...
 case NOTE_INSN_BLOCK_END:
   ...
   if (block_stack == (rtx) 0)
     fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3889, __FUNCTION__);

   if (((((((block_stack)->fld[0]).rtx))->fld[4]).rttree) != (((insn)->fld[4]).rttree))
     fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3892, __FUNCTION__);
   tmp = block_stack;
  ...
  if (block_stack || eh_stack)
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 3942, __FUNCTION__);
}
# 3973 "../../../kg++fe/gnu/emit-rtl.c"
rtx
     ...
     rtx datum;
{
 ...
 {
   if (note)
     fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 4757, __FUNCTION__);
   return (rtx) 0;
 }
     ...
     rtx x;
{
 ...
 return emit_barrier ();
    ...
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 4842, __FUNCTION__);
}


static struct sequence_stack *free_sequence_stack;
# 4856 "../../../kg++fe/gnu/emit-rtl.c"
void
start_sequence ()
{
     ...
     rtx first, last;
{
  ...
  if (last && (((last)->fld[2]).rtx))
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 4922, __FUNCTION__);
}
     ...
     rtx orig;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 5157, __FUNCTION__);
 }
    }
  ...
  if (code == SCRATCH)
    {
      ...
      if (i >= 30)
 fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 5165, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  if (!(const_tiny_rtx[0][(int) (inner)]))
    fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 5290, __FUNCTION__);
     ...
     rtx insn, after;
{
 ...
 (((new)->fld[9]).rtx)
   = copy_insn ((((insn)->fld[9]).rtx));
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/emit-rtl.c", 5567, __FUNCTION__);
    }
...
# 1 "../../../kg++fe/gnu/MIPS/gt-emit-rtl.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-emit-rtl.h"
