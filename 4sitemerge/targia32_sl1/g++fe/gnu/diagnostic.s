...
.LBB14:
	...
	je	.L175
	.loc 1 618 0
	leal	__FUNCTION__.11770@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$618, 4(%esp)
...
.LFE51:
	...
	.section	.rodata
	.type	__FUNCTION__.11937, @object
	.size	__FUNCTION__.11937, 17
__FUNCTION__.11937:
...
.L195:
	...
	je	.L197
	.loc 1 709 0
	leal	__FUNCTION__.11937@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$709, 4(%esp)
	leal	.LC11@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LC22:
	...
	.align 32
	.type	diagnostic_kind_text.12053, @object
	.size	diagnostic_kind_text.12053, 36
diagnostic_kind_text.12053:
	.long	.LC14
	.long	.LC15
	.long	.LC16
	.long	.LC17
...
.L232:
	...
	movl	8(%ebp), %eax
	movl	16(%eax), %eax
	movl	diagnostic_kind_text.12053@GOTOFF(%ebx,%eax,4), %edx
	movl	8(%ebp), %eax
	movl	12(%eax), %ecx
	movl	8(%ebp), %eax
	movl	8(%eax), %eax
...
.LFE61:
	...
	.section	.rodata
	.type	__FUNCTION__.12114, @object
	.size	__FUNCTION__.12114, 28
__FUNCTION__.12114:
...
.L247:
	.loc 1 914 0
	leal	__FUNCTION__.12114@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$914, 4(%esp)
	leal	.LC11@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE82:
	...
	.section	.rodata
	.align 32
	.type	this_file.12450, @object
	.size	this_file.12450, 33
this_file.12450:
	.string	"../../../kg++fe/gnu/diagnostic.c"
	.text
.globl trim_filename
...
.LCFI266:
	...
	movl	8(%ebp), %eax
	movl	%eax, -8(%ebp)
	leal	this_file.12450@GOTOFF(%ecx), %eax
	movl	%eax, -4(%ebp)
	.loc 1 1344 0
	jmp	.L342
.L343:
...
.LLST74:
	...
	.byte	0x5
	.byte	0x3
	.long	diagnostic_kind_text.12053
	.uleb128 0x38
	.long	.LASF38
	.long	0x7f68
	.byte	0x1
