...
# 573 "../../../kg++fe/gnu/dwarfout.c" 2
# 1 "../../../kg++fe/gnu/dwarf.h" 1
# 34 "../../../kg++fe/gnu/dwarf.h"
enum dwarf_tag {
    TAG_padding = 0x0000,
...
# 585 "../../../kg++fe/gnu/dwarfout.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 586 "../../../kg++fe/gnu/dwarfout.c" 2
...
# 593 "../../../kg++fe/gnu/dwarfout.c" 2


# 1 "../../../kg++fe/gnu/defaults.h" 1
# 596 "../../../kg++fe/gnu/dwarfout.c" 2
# 655 "../../../kg++fe/gnu/dwarfout.c"
     ...
     tree type;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 1814, __FUNCTION__);
 ...
 if (((type)->type.precision) == (mips_abi == 1 || mips_abi == 2 ? 128 : 64))
   return FT_ext_prec_float;
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 1855, __FUNCTION__);
 ...
 return FT_boolean;
      ...
      default:
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 1867, __FUNCTION__);
    }
  return 0;
}
# 1882 "../../../kg++fe/gnu/dwarfout.c"
static tree
     ...
     tree type;
{
 ...
 return 0;
      ...
      default:
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 2002, __FUNCTION__);
    }
  return 0;
}
# 2020 "../../../kg++fe/gnu/dwarfout.c"
static void
...
# 2103 "../../../kg++fe/gnu/dwarfout.c"
static void
output_mem_loc_descriptor (rtl)
     rtx rtl;
{
# 2116 "../../../kg++fe/gnu/dwarfout.c"
...
# 2150 "../../../kg++fe/gnu/dwarfout.c"
 ...
 break;
      ...
      default:
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 2186, __FUNCTION__);
    }
}
     ...
     rtx rtl;
{
 ...
 break;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 2223, __FUNCTION__);
    }
}
     ...
     tree decl;
{
  ...
  if (((enum tree_code) (decl)->common.code) != FIELD_DECL)
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 2422, __FUNCTION__);
...
# 2679 "../../../kg++fe/gnu/dwarfout.c"
 ...
 break;
      ...
      case PLUS:
# 2719 "../../../kg++fe/gnu/dwarfout.c"
 break;

      default:
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 2722, __FUNCTION__);
    }

  do { assemble_name ((asm_out_file), (end_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
}
# 2740 "../../../kg++fe/gnu/dwarfout.c"
static void
  ...
  if ((((enum tree_code) (decl)->common.code) != VAR_DECL) && (((enum tree_code) (decl)->common.code) != PARM_DECL))
    {
      ...
      fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 2752, __FUNCTION__);
      return;
    }
# 2830 "../../../kg++fe/gnu/dwarfout.c"
 ...
 if (declared_type == passed_type)
  ...
  switch (((enum rtx_code) (rtl)->code))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 2893, __FUNCTION__);
    }
}
...
# 3007 "../../../kg++fe/gnu/dwarfout.c"
      ...
      if (domain)
 {
   ...
   if (! type_is_fundamental (domain))
     fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3026, __FUNCTION__);
     ...
     tree tree_node;
{
 ...
 break;
      ...
      default:
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3114, __FUNCTION__);
    }
     ...
     tree decl;
{
  ...
  if (!type
    ...
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3157, __FUNCTION__);
    ...
    tree decl;
{
  ...
  if (((enum tree_code) (decl)->common.code) != FIELD_DECL
      || ! ((decl)->decl.result))
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3203, __FUNCTION__);
     ...
     tree origin;
{
  ...
  switch (tree_code_type[(int) (((enum tree_code) (origin)->common.code))])
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3442, __FUNCTION__);

    }
  dw2_asm_output_addr (4, label, ((void *)0));
}
# 3460 "../../../kg++fe/gnu/dwarfout.c"
static __inline__ void
    ...
    tree decl;
{
  ...
  if (((enum rtx_code) (x)->code) != MEM)
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3655, __FUNCTION__);
  x = (((x)->fld[0]).rtx);
  if (((enum rtx_code) (x)->code) != SYMBOL_REF)
        fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3658, __FUNCTION__);
  fnname = (((x)->fld[0]).rtstr);
  return fnname;
}
# 3670 "../../../kg++fe/gnu/dwarfout.c"
static void
     ...
     void *arg;
{
  ...
  if (!((type)->common.asm_written_flag))
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3749, __FUNCTION__);
     ...
     void *arg;
{
  ...
  sibling_attribute ();
  if (!((type)->common.asm_written_flag))
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3764, __FUNCTION__);
  abstract_origin_attribute (type);
}
     ...
     void *arg;
{
  ...
  sibling_attribute ();
  if (!((type)->common.asm_written_flag))
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3779, __FUNCTION__);
  abstract_origin_attribute (type);
}
     ...
     void *arg;
{
 ...
 if (((node)->decl.abstract_flag))
   ...
   location_or_const_value_attribute (node);
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3858, __FUNCTION__);
    }
}
     ...
     void *arg;
{
        ...
        && (((insn)->fld[5]).rtint) == NOTE_INSN_DELETED_LABEL)))
 {
   ...
   if ((((insn))->volatil))
     fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 3978, __FUNCTION__);
...
# 4586 "../../../kg++fe/gnu/dwarfout.c"
static __inline__ int
type_ok_for_scope (type, scope)
    tree type;
    tree scope;
{
# 4602 "../../../kg++fe/gnu/dwarfout.c"
     ...
     tree containing_scope;
{
 ...
 break;
      ...
      case FILE_TYPE:
 output_type (((type)->common.type), containing_scope);
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 4782, __FUNCTION__);
 break;
...
# 4855 "../../../kg++fe/gnu/dwarfout.c"
 ...
 switch (((enum tree_code) (type)->common.code))
   ...
   default:
     fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 4890, __FUNCTION__);
   }
# 4910 "../../../kg++fe/gnu/dwarfout.c"
 if ((((type)->type.size) != (tree) ((void *)0)))
   {
 ...
 break;
      ...
      default:
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 4982, __FUNCTION__);
    }
     ...
     tree type;
{
  ...
  if (type != type_main_variant (type))
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 5001, __FUNCTION__);

  if (!((type)->common.asm_written_flag))
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 5004, __FUNCTION__);
 ...
 break;
      ...
      default:
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 5025, __FUNCTION__);
    }
}
...
# 5349 "../../../kg++fe/gnu/dwarfout.c"
   output_pending_types_for_scope (decl);
# 5360 "../../../kg++fe/gnu/dwarfout.c"
   {
...
# 5443 "../../../kg++fe/gnu/dwarfout.c"
      ...
      if (((decl)->decl.name) != 0)
 {
   ...
   output_die (output_member_die, decl);
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 5548, __FUNCTION__);
    }
}
...
# 5801 "../../../kg++fe/gnu/dwarfout.c"
  ...
  if (! ((decl)->decl.context))
    {
      if (pending_types != 0)
 fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 5811, __FUNCTION__);
    }
...
# 6558 "../../../kg++fe/gnu/dwarfout.c"
  ...
  if (pending_types != 0)
    fancy_abort ("../../../kg++fe/gnu/dwarfout.c", 6572, __FUNCTION__);
}
