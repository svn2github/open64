...
# 33 "../../../kg++fe/gnu/timevar.c" 2
# 113 "../../../kg++fe/gnu/timevar.c"
static float ticks_to_msec;
# 122 "../../../kg++fe/gnu/timevar.c"
...
# 125 "../../../kg++fe/gnu/timevar.c" 2
# 133 "../../../kg++fe/gnu/timevar.c"
struct timevar_def
{
     ...
     timevar_id_t timevar;
{
  ...
  if (tv->standalone)
    fancy_abort ("../../../kg++fe/gnu/timevar.c", 283, __FUNCTION__);
  ...
  if (&timevars[timevar] != stack->timevar)
    {
      ...
      fancy_abort ("../../../kg++fe/gnu/timevar.c", 334, __FUNCTION__);
    }
     ...
     timevar_id_t timevar;
{
  ...
  if (tv->standalone)
    fancy_abort ("../../../kg++fe/gnu/timevar.c", 375, __FUNCTION__);
  tv->standalone = 1;
     ...
     timevar_id_t timevar;
{
  ...
  if (!tv->standalone)
    fancy_abort ("../../../kg++fe/gnu/timevar.c", 396, __FUNCTION__);
