...
# 24 "../../../kg++fe/gnu/ra-debug.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 25 "../../../kg++fe/gnu/ra-debug.c" 2
     ...
     int with_pn;
{
...

 {
   ...
   switch (((enum label_kind) (((x)->jump << 1) | (x)->call)))
     ...
     default: fancy_abort ("../../../kg++fe/gnu/ra-debug.c", 381, __FUNCTION__);
     }
