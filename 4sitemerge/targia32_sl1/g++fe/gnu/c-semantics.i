     ...
     tree destination;
{
  if (((enum tree_code) (destination)->common.code) == IDENTIFIER_NODE)
    fancy_abort ("../../../kg++fe/gnu/c-semantics.c", 315, __FUNCTION__);
     ...
     tree t;
{
 ...
 default:
   if (lang_expand_stmt)
     ...
     fancy_abort ("../../../kg++fe/gnu/c-semantics.c", 897, __FUNCTION__);
   break;
 }
