...
.L141:
	.loc 1 381 0
	leal	__FUNCTION__.10687@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$381, 4(%esp)
...
.LEFDE42:
	...
	.file 13 "../../../kg++fe/gnu/df.h"
	.file 14 "../../../kg++fe/gnu/ra.h"
