...
# 35 "../../../kg++fe/gnu/calls.c" 2


# 1 "../../../kg++fe/gnu/MIPS/insn-flags.h" 1
# 38 "../../../kg++fe/gnu/calls.c" 2
...
# 47 "../../../kg++fe/gnu/calls.c" 2


# 1 "../../../kg++fe/gnu/defaults.h" 1
# 50 "../../../kg++fe/gnu/calls.c" 2
# 85 "../../../kg++fe/gnu/calls.c"
struct arg_data
{
...
# 575 "../../../kg++fe/gnu/calls.c"
 ...
 emit_call_insn (gen_call ((gen_rtx_MEM (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? DImode : SImode), funexp)), (rounded_stack_size_rtx), (next_arg_reg), (struct_value_size_rtx)));
    ...
    fancy_abort ("../../../kg++fe/gnu/calls.c", 589, __FUNCTION__);
  ...
  if (! call_insn)
    fancy_abort ("../../../kg++fe/gnu/calls.c", 598, __FUNCTION__);
     ...
     int preferred_stack_boundary __attribute__ ((__unused__));
{
      ...
      if (preferred_stack_boundary > 1)
 {
   ...
   if ((cfun->expr->x_stack_pointer_delta) & (preferred_stack_boundary - 1))
     fancy_abort ("../../../kg++fe/gnu/calls.c", 1467, __FUNCTION__);
...
# 1509 "../../../kg++fe/gnu/calls.c"
    }
  return unadjusted_args_size;
}
# 1523 "../../../kg++fe/gnu/calls.c"
static void
...
# 1546 "../../../kg++fe/gnu/calls.c"
 ...
 if (((((args[i].tree_value)->common.type))->common.addressable_flag))
   fancy_abort ("../../../kg++fe/gnu/calls.c", 1554, __FUNCTION__);
     ...
     tree t;
{
 ...
 t = var;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/calls.c", 2137, __FUNCTION__);
    }
  return t;
}
...
# 2340 "../../../kg++fe/gnu/calls.c"
 ...
 return temp;
  ...
  if (! (((enum tree_code) (funtype)->common.code) == POINTER_TYPE || ((enum tree_code) (funtype)->common.code) == REFERENCE_TYPE))
    fancy_abort ("../../../kg++fe/gnu/calls.c", 2377, __FUNCTION__);
...
# 3106 "../../../kg++fe/gnu/calls.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/calls.c", 3114, __FUNCTION__);
   ...
   && ! (flags & (2 | 64))
   && old_stack_allocated != (cfun->expr->x_stack_pointer_delta) - (cfun->expr->x_pending_stack_adjust))
 fancy_abort ("../../../kg++fe/gnu/calls.c", 3126, __FUNCTION__);
   ...
   while (((enum rtx_code) (last)->code) != CALL_INSN)
     {
       ...
       if (last == before_call)
  fancy_abort ("../../../kg++fe/gnu/calls.c", 3214, __FUNCTION__);
     }
   ...
   && ((enum machine_mode) (target)->mode) != ((((exp)->common.type))->type.mode))
 {
   ...
   if (((enum machine_mode) (target)->mode)
     ...
     fancy_abort ("../../../kg++fe/gnu/calls.c", 3328, __FUNCTION__);
...
# 3646 "../../../kg++fe/gnu/calls.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/calls.c", 3686, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/calls.c", 3716, __FUNCTION__);
# 3729 "../../../kg++fe/gnu/calls.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/calls.c", 3818, __FUNCTION__);
 ...
 args_size.constant += argvec[count].size.constant;
  ...
  if (1)
    {
# 3870 "../../../kg++fe/gnu/calls.c"
      needed = args_size.constant;
# 3883 "../../../kg++fe/gnu/calls.c"
      highest_outgoing_arg_in_use = ((initial_highest_arg_in_use) > (needed) ? (initial_highest_arg_in_use) : (needed));
...
# 4019 "../../../kg++fe/gnu/calls.c"
 ...
 use_reg (&call_fusage, struct_value_rtx);
  ...
  if ((cfun->expr->x_stack_pointer_delta) & (((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128) / 8 - 1))
    fancy_abort ("../../../kg++fe/gnu/calls.c", 4141, __FUNCTION__);

  before_call = get_last_insn ();
# 4152 "../../../kg++fe/gnu/calls.c"
  emit_call_1 (fun,
      ...
      while (((enum rtx_code) (last)->code) != CALL_INSN)
 {
   ...
   if (last == before_call)
     fancy_abort ("../../../kg++fe/gnu/calls.c", 4177, __FUNCTION__);
 }
...
# 4454 "../../../kg++fe/gnu/calls.c"
 ...
 reg = arg->reg;
  ...
  if (reg != 0 && partial == 0)
    ...
    fancy_abort ("../../../kg++fe/gnu/calls.c", 4514, __FUNCTION__);
...
# 4628 "../../../kg++fe/gnu/calls.c"
      ...
      if ((flags & 256) && ((enum rtx_code) (arg->value)->code) == MEM)
 {
  ...
  fancy_abort ("../../../kg++fe/gnu/calls.c", 4678, __FUNCTION__);
