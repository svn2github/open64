     ...
     int validated_p;
{
  ...
  if (((enum tree_code) (format_type_id)->common.code) != IDENTIFIER_NODE)
    {
      if (validated_p)
 fancy_abort ("../../../kg++fe/gnu/c-format.c", 240, __FUNCTION__);
 ...
 {
   if (validated_p)
     fancy_abort ("../../../kg++fe/gnu/c-format.c", 253, __FUNCTION__);
  ...
  if (((enum tree_code) (format_num_expr)->common.code) != INTEGER_CST
    ...
    {
      if (validated_p)
 fancy_abort ("../../../kg++fe/gnu/c-format.c", 277, __FUNCTION__);
      error ("format string has invalid operand number");
      return 0;
    }
  ...
  if (info->first_arg_num != 0 && info->first_arg_num <= info->format_num)
    {
      if (validated_p)
 fancy_abort ("../../../kg++fe/gnu/c-format.c", 287, __FUNCTION__);
 ...
 *param_ptr = ((*param_ptr)->common.chain);
      ...
      if (*param_ptr == 0)
 {
   ...
   fancy_abort ("../../../kg++fe/gnu/c-format.c", 1201, __FUNCTION__);
 }
    }
  else
    *param_ptr = 0;
     ...
     const char *predicates;
{
 ...
 return &spec[i];
  ...
  if (predicates == ((void *)0))
    fancy_abort ("../../../kg++fe/gnu/c-format.c", 1279, __FUNCTION__);
  else
    return ((void *)0);
}
     ...
     unsigned long long arg_num;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/c-format.c", 1489, __FUNCTION__);
     ...
     format_wanted_type *types;
{
 ...
 continue;
      ...
      if (wanted_type == 0)
 fancy_abort ("../../../kg++fe/gnu/c-format.c", 2204, __FUNCTION__);
      if (wanted_type == global_trees[TI_VOID_TYPE] && types->pointer_count == 0)
 fancy_abort ("../../../kg++fe/gnu/c-format.c", 2206, __FUNCTION__);
