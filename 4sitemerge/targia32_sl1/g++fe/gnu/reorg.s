...
.Ltext0:
	.section	.rodata
	.type	__FUNCTION__.11289, @object
	.size	__FUNCTION__.11289, 14
__FUNCTION__.11289:
	.string	"stop_search_p"
.LC0:
	.string	"../../../kg++fe/gnu/reorg.c"
	.text
	.type	stop_search_p, @function
stop_search_p:
.LFB15:
	.file 1 "../../../kg++fe/gnu/reorg.c"
	.loc 1 235 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.L5:
	.loc 1 260 0
	leal	__FUNCTION__.11289@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$260, 4(%esp)
...
.LFE19:
	...
	.section	.rodata
	.type	__FUNCTION__.11486, @object
	.size	__FUNCTION__.11486, 20
__FUNCTION__.11486:
...
.L103:
	...
	je	.L105
	.loc 1 542 0
	leal	__FUNCTION__.11486@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$542, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE25:
	...
	.section	.rodata
	.type	__FUNCTION__.11773, @object
	.size	__FUNCTION__.11773, 15
__FUNCTION__.11773:
...
.L192:
	.loc 1 867 0
	leal	__FUNCTION__.11773@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$867, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE46:
	...
	.section	.rodata
	.type	__FUNCTION__.13918, @object
	.size	__FUNCTION__.13918, 18
__FUNCTION__.13918:
...
.L1019:
	...
	je	.L1022
	.loc 1 3258 0
	leal	__FUNCTION__.13918@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3258, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE68:
	...
	.file 8 "../../../kg++fe/gnu/resource.h"
	.file 9 "../../../kg++fe/gnu/hard-reg-set.h"
