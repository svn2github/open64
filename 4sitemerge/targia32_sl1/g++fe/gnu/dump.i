...
dump_op (di, t)
     ...
     tree t;
{
  switch ((((((t)->decl.name))->common.lang_flag_2) ? ((t)->decl.lang_specific)->u.f.operator_code : ERROR_MARK)) {
    case NEW_EXPR:
      dump_string (di, "new");
      break;
    case VEC_NEW_EXPR:
    ...
    case PREDECREMENT_EXPR:
      ...
      break;
    case PLUS_EXPR:
      if ((((t)->decl.lang_specific)->decl_flags.assignment_operator_p))
     ...
     tree t;
{
  ...
  if ((tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 'd'))
    {
      if (((t)->decl.lang_specific) && (((t)->decl.lang_specific) ? ((t)->decl.lang_specific)->decl_flags.language : (((enum tree_code) (t)->common.code) == FUNCTION_DECL ? lang_c : lang_cplusplus)) != lang_cplusplus)
 dump_string (di, language_to_string ((((t)->decl.lang_specific) ? ((t)->decl.lang_specific)->decl_flags.language : (((enum tree_code) (t)->common.code) == FUNCTION_DECL ? lang_c : lang_cplusplus)), 0));
    }
      ...
      if (((t)->common.lang_flag_2))
 {
   ...
   return 1;
      ...
      else if (((t)->common.lang_flag_4))
 {
   queue_and_dump_index (di, "tynm", ((t)->common.type), 0);
   return 1;
 }
      ...
      if ((((enum tree_code) (t)->common.code) == POINTER_TYPE && ((enum tree_code) (((t)->common.type))->common.code) == OFFSET_TYPE))
 {
   ...
   queue_and_dump_index (di, "ptd", ((((enum tree_code) (t)->common.code) == POINTER_TYPE && ((enum tree_code) (((t)->common.type))->common.code) == OFFSET_TYPE) ? ((((t)->common.type))->common.type) : (((((((t)->type.values))->common.type)))->common.type)), 0);
   queue_and_dump_index (di, "cls", ((((enum tree_code) (t)->common.code) == POINTER_TYPE && ((enum tree_code) (((t)->common.type))->common.code) == OFFSET_TYPE) ? ((((t)->common.type))->type.maxval) : (((((((((t)->type.values))->common.type)))->common.type))->type.maxval)), 0);
   return 1;
 }
      break;
      ...
      if ((((enum tree_code) (t)->common.code) == RECORD_TYPE && ((t)->type.lang_specific) && ((&((t)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
 {
   ...
   return 1;
      ...
      if (((t)->type.context) && ((enum tree_code) (((t)->type.context))->common.code) == ((enum tree_code) (t)->common.code)
   && ((&((((t)->type.context))->type.lang_specific)->u.c)->as_base) == t)
 {
   queue_and_dump_index (di, "bfld", ((t)->type.context), 0);
   return 1;
 }

      queue_and_dump_index (di, "vfld", ((t)->type.minval), 0);
      if ((((&((t)->type.lang_specific)->u.c)->use_template) == 2))
        dump_string(di, "spec");

      if (!dump_flag (di, (1 << 1), t))
 {
   int i;

   for (i = 0; i < (((((((t)->type.binfo)))->vec.a[4]) ? (((((((t)->type.binfo)))->vec.a[4]))->vec.length) : 0)); ++i)
     {
       tree base_binfo = (((((((t)->type.binfo)))->vec.a[4]))->vec.a[(i)]);
       queue_and_dump_index (di, "base", ((base_binfo)->common.type), 0);
  ...
  dump_string (di, "virtual");
    ...
    case FIELD_DECL:
      dump_access (di, t);
      if ((((t)->decl.lang_flag_0)))
        dump_string(di, "mutable");
      break;

    case VAR_DECL:
      if (((enum tree_code) ((((t)->decl.context) ? ((t)->decl.context) : global_namespace))->common.code) == RECORD_TYPE)
        dump_access (di, t);
      if (((t)->common.static_flag) && !((t)->common.public_flag))
        dump_string (di, "static");
      break;

    case FUNCTION_DECL:
      if (!(((enum tree_code) (t)->common.code) == FUNCTION_DECL && ((t)->decl.lang_flag_7)))
 {
          if ((((((t)->decl.name))->common.lang_flag_2) ? ((t)->decl.lang_specific)->u.f.operator_code : ERROR_MARK)) {
     dump_string (di, "operator");
            dump_op (di, t);
          }
   if (((((enum tree_code) (((t)->common.type))->common.code) == METHOD_TYPE) || (((t)->decl.lang_specific)->decl_flags.static_function)))
     {
       dump_string (di, "member");
       dump_access (di, t);
     }
          if ((((t)->decl.lang_specific)->decl_flags.pure_virtual))
            dump_string (di, "pure");
          if (((t)->decl.virtual_flag))
            dump_string (di, "virtual");
   ...
   if ((((((t)->decl.name))->common.lang_flag_4)))
  ...
  dump_string (di, "global init");
       if ((((t)->decl.lang_specific)->decl_flags.global_dtor_p))
  dump_string (di, "global fini");
     }
   if ((((((t))->decl.lang_specific) ->decl_flags.u.template_info) && !(((t)->decl.lang_specific)->decl_flags.use_template)))
     dump_string (di, "pseudo tmpl");
 }
      else
 {
   dump_string (di, "thunk");
   dump_int (di, "dlta", ((t)->decl.thunk_delta));
   queue_and_dump_index (di, "vcll", ((&((t)->decl.lang_specific)->decl_flags.u2)->vcall_offset), 0);
   queue_and_dump_index (di, "fn", ((t)->decl.initial), 0);
 }
      break;

    case NAMESPACE_DECL:
      if ((((t))->decl.abstract_origin))
 queue_and_dump_index (di, "alis", (((t))->decl.abstract_origin), 0);
      else if (!dump_flag (di, (1 << 1), t))
 queue_and_dump_index (di, "dcls", cp_namespace_decls (t), 0);
      break;

    case TEMPLATE_DECL:
      queue_and_dump_index (di, "rslt", ((t)->decl.result), 0);
      queue_and_dump_index (di, "inst", ((t)->decl.vindex), 0);
      queue_and_dump_index (di, "spcs", ((t)->decl.size), 0);
      queue_and_dump_index (di, "prms", ((t)->decl.arguments), 0);
      break;

    case OVERLOAD:
      queue_and_dump_index (di, "crnt", ((((enum tree_code) (t)->common.code) == OVERLOAD) ? (((struct tree_overload*)(t))->function) : (t)), 0);
 ...
 dump_string (di, "cleanup");
      ...
      queue_and_dump_index (di, "hdlr", (((t))->exp.operands[1]), 0);
      dump_next_stmt (di, t);
      break;
    ...
    case EH_SPEC_BLOCK:
      dump_stmt (di, t);
      queue_and_dump_index (di, "body", (((t))->exp.operands[0]), 0);
      queue_and_dump_index (di, "raises", (((t))->exp.operands[1]), 0);
      dump_next_stmt (di, t);
      break;

    case PTRMEM_CST:
      queue_and_dump_index (di, "clas", ((((enum tree_code) ((((t))->common.type))->common.code) == POINTER_TYPE && ((enum tree_code) ((((((t))->common.type))->common.type))->common.code) == OFFSET_TYPE) ? (((((((t))->common.type))->common.type))->type.maxval) : ((((((((((((t))->common.type))->type.values))->common.type)))->common.type))->type.maxval)), 0);
      queue_and_dump_index (di, "mbr", (((ptrmem_cst_t)(t))->member), 0);
      break;
    ...
    case AGGR_INIT_EXPR:
      dump_int (di, "ctor", (((t))->common.lang_flag_0));
      queue_and_dump_index (di, "fn", ((t)->exp.operands[0]), 0);
      queue_and_dump_index (di, "args", ((t)->exp.operands[1]), 0);
      queue_and_dump_index (di, "decl", ((t)->exp.operands[2]), 0);
      break;

    case HANDLER:
      dump_stmt (di, t);
      queue_and_dump_index (di, "parm", (((t))->exp.operands[0]), 0);
    ...
    case USING_STMT:
      dump_stmt (di, t);
      queue_and_dump_index (di, "nmsp", (((t))->exp.operands[0]), 0);
      dump_next_stmt (di, t);
      break;
