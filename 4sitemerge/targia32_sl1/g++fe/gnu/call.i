...
static tree convert_like_real (tree, tree, tree, int, int, _Bool);
...
static int any_strictly_viable (struct z_candidate *);
static struct z_candidate * add_template_candidate
 (struct z_candidate **, tree, tree, tree, tree, tree, tree, tree, int, unification_kind_t);

static struct z_candidate * add_template_candidate_real
 (struct z_candidate **, tree, tree, tree, tree, tree, tree, tree, int, tree, unification_kind_t);

static struct z_candidate * add_template_conv_candidate
        (struct z_candidate **, tree, tree, tree, tree, tree, tree);
static void add_builtin_candidates
 (struct z_candidate **, enum tree_code, enum tree_code, tree, tree *, int);

static void add_builtin_candidate
 (struct z_candidate **, enum tree_code, enum tree_code, tree, tree, tree, tree *, tree *, int);
...
static int reference_related_p (tree, tree);
static int reference_compatible_p (tree, tree);
static tree convert_class_to_reference (tree, tree, tree);
static tree direct_reference_binding (tree, tree);
static int promoted_arithmetic_type_p (tree);
...
build_vfield_ref (datum, type)
     tree datum, type;
{
  if (datum == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];

  if (((enum tree_code) (((datum)->common.type))->common.code) == REFERENCE_TYPE)
    datum = convert_from_reference (datum);

  if ((((type)->common.lang_flag_1))
      && !comptypes ((((((datum)->common.type))->type.main_variant)), (((type)->type.main_variant)), 0))
    datum = convert_to_base (datum, type, 0);

  return build (COMPONENT_REF, ((((type)->type.minval))->common.type),
  datum, ((type)->type.minval));
}
...
build_field_call (tree instance_ptr, tree decl, tree parms)
{
  ...
  if (decl == global_trees[TI_ERROR_MARK] || decl == (tree) ((void *)0))
    return decl;

  if (((enum tree_code) (decl)->common.code) == FIELD_DECL || ((enum tree_code) (decl)->common.code) == VAR_DECL)
    {


      instance = build_indirect_ref (instance_ptr, ((void *)0));
      instance = build_class_member_access_expr (instance, decl,
                       (tree) ((void *)0),
                              0);

      if (instance == global_trees[TI_ERROR_MARK])
 return global_trees[TI_ERROR_MARK];
 ...
 return build_opfncall (CALL_EXPR, (3),
          instance, parms, (tree) ((void *)0));
      else if (((enum tree_code) (((instance)->common.type))->common.code) == FUNCTION_TYPE
        || (((enum tree_code) (((instance)->common.type))->common.code) == POINTER_TYPE
     && (((enum tree_code) (((((instance)->common.type))->common.type))->common.code)
         == FUNCTION_TYPE)))
     ...
     tree basetype, name;
{
  ...
  if (((enum tree_code) (name)->common.code) == TYPE_DECL)
    ...
    {
      if (((((enum tree_code) (basetype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (basetype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (basetype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (basetype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((basetype)->type.lang_flag_5)) && name == constructor_name (basetype))
   || (((enum tree_code) (basetype)->common.code) == ENUMERAL_TYPE
       && name == (((((basetype)->type.name))->decl.name))))
 name = basetype;
      else
 name = get_type_value (name);
  ...
  else if ((((enum tree_code) (name)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((name)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (name)->common.code) == TEMPLATE_DECL && (((name)->decl.lang_flag_0) && (((enum tree_code) (name)->common.code) == CONST_DECL || ((enum tree_code) (name)->common.code) == PARM_DECL || ((enum tree_code) (name)->common.code) == TYPE_DECL || ((enum tree_code) (name)->common.code) == TEMPLATE_DECL)))))
    return 0;
  else
    fancy_abort ("../../../kg++fe/gnu/cp/call.c", 200, __FUNCTION__);

  if (name && ((basetype)->type.main_variant) == ((name)->type.main_variant))
    return 1;
  return 0;
}
     ...
     tree exp, basetype, name, parms;
{
  ...
  if (type == global_trees[TI_ERROR_MARK]
      || basetype == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];

  if (scope_chain->x_processing_template_decl)
    {
      if (((enum tree_code) (name)->common.code) == BIT_NOT_EXPR
   && ((enum tree_code) (((name)->exp.operands[0]))->common.code) == IDENTIFIER_NODE)
 {
   tree type = get_aggr_from_typedef (((name)->exp.operands[0]), 0);
   if (type)
     name = build_min_nt (BIT_NOT_EXPR, type);
 }
      name = build_min_nt (SCOPE_REF, basetype, name);
      return build_min_nt (METHOD_CALL_EXPR, name, exp, parms, (tree) ((void *)0));
    }

  if (((enum tree_code) (type)->common.code) == REFERENCE_TYPE)
    type = ((type)->common.type);

  if (((enum tree_code) (basetype)->common.code) == TREE_VEC)
    {
      binfo = basetype;
  ...
  if (((enum tree_code) (name)->common.code) == BIT_NOT_EXPR)
    {
      ...
      if (((enum tree_code) (basetype)->common.code) == NAMESPACE_DECL)
 return build_method_call (exp, name, parms, (tree) ((void *)0), (3));

      if (! check_dtor_name (basetype, name))
 error ("qualified type `%T' does not match destructor name `~%T'",
    basetype, ((name)->exp.operands[0]));




      if (! (((enum tree_code) (basetype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (basetype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (basetype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (basetype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((basetype)->type.lang_flag_5)))
 {
   if (((type)->type.main_variant) != ((basetype)->type.main_variant))
     error ("type of `%E' does not match destructor type `%T' (type was `%T')",
        exp, basetype, type);

   return cp_convert (global_trees[TI_VOID_TYPE], exp);
 }
    }
  ...
  if (binfo)
    {
      ...
      if (((enum tree_code) (name)->common.code) == BIT_NOT_EXPR)
 {
   if (! (((((decl)->common.type))->type.lang_flag_2)))
     return cp_convert (global_trees[TI_VOID_TYPE], exp);

   return build_delete (((decl)->common.type), decl,
          sfk_complete_destructor,
          (3)|(8)|(512),
          0);
 }
     ...
     tree function, parms;
{
  ...
  if (((enum tree_code) (function)->common.code) == ADDR_EXPR
    ...
    decl = ((function)->exp.operands[0]);
  else
    decl = (tree) ((void *)0);



  nothrow = ((decl && ((decl)->common.nothrow_flag))
      || (((((((function)->common.type))->common.type))->type.binfo) && ((((((((function)->common.type))->common.type))->type.binfo))->list.value) == (tree) ((void *)0)));
  ...
  if (decl && (((decl)->decl.lang_specific)->decl_flags.constructor_attr))
    is_constructor = 1;
  ...
  if (decl && ! ((decl)->common.used_flag))
   ...
   || !strncmp (((char *)(((decl)->decl.name))->identifier.id.str), "__", 2))
 mark_used (decl);
      else
 fancy_abort ("../../../kg++fe/gnu/cp/call.c", 406, __FUNCTION__);
    }
  ...
  if (! decl || ! (((decl)->decl.built_in_class) != NOT_BUILT_IN))
    for (tmp = parms; tmp; tmp = ((tmp)->common.chain))
      if (is_empty_class (((((tmp)->list.value))->common.type))
   && ! ((((((tmp)->list.value))->common.type))->common.addressable_flag))
 {
   tree t = build (EMPTY_CLASS_EXPR, ((((tmp)->list.value))->common.type));
   ((tmp)->list.value) = build (COMPOUND_EXPR, ((t)->common.type),
        ((tmp)->list.value), t);
 }

  function = build_nt (CALL_EXPR, function, parms, (tree) ((void *)0));
  (((function)->common.lang_flag_4)) = is_constructor;
  ((function)->common.type) = result_type;
  ((function)->common.side_effects_flag) = 1;
  ((function)->common.nothrow_flag) = nothrow;

  return function;
}
# 467 "../../../kg++fe/gnu/cp/call.c"
tree
     ...
     int flags;
{
  ...
  if (instance == global_trees[TI_ERROR_MARK]
      || name == global_trees[TI_ERROR_MARK]
      || parms == global_trees[TI_ERROR_MARK]
      || (instance && ((instance)->common.type) == global_trees[TI_ERROR_MARK]))
    return global_trees[TI_ERROR_MARK];
      ...
      if (((enum tree_code) (name)->common.code) == BIT_NOT_EXPR)
 {
   ...
   if (((enum tree_code) (((name)->exp.operands[0]))->common.code) == IDENTIFIER_NODE)
     type = get_aggr_from_typedef (((name)->exp.operands[0]), 0);
   else if (((enum tree_code) (((name)->exp.operands[0]))->common.code) == TYPE_DECL)
     type = ((((name)->exp.operands[0]))->common.type);

   if (type && ((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM)
     name = build_min_nt (BIT_NOT_EXPR, type);
 }

      return build_min_nt (METHOD_CALL_EXPR, name, instance, parms, (tree) ((void *)0));
    }

  if (((enum tree_code) (instance)->common.code) == OFFSET_REF)
    instance = resolve_offset_ref (instance);
  if (((enum tree_code) (((instance)->common.type))->common.code) == REFERENCE_TYPE)
    instance = convert_from_reference (instance);
  object_type = ((instance)->common.type);
 ...
 error
   ("destructor name `~%T' does not match type `%T' of expression",
    ((name)->exp.operands[0]), object_type);


      object_type = (complete_type_or_diagnostic ((object_type), ((tree) ((void *)0)), 0));
      if (!object_type || object_type == global_trees[TI_ERROR_MARK])
 return global_trees[TI_ERROR_MARK];

      if (! (((object_type)->type.lang_flag_2)))
 return cp_convert (global_trees[TI_VOID_TYPE], instance);
  ...
  if (!(((((enum tree_code) (object_type)->common.code)) == RECORD_TYPE || (((enum tree_code) (object_type)->common.code)) == UNION_TYPE) && (((enum tree_code) (object_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (object_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (object_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (object_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((object_type)->type.lang_flag_5))))
    {
      if ((flags & (2))
   && ((instance)->common.type) != global_trees[TI_ERROR_MARK])
 error ("request for member `%D' in `%E', which is of non-aggregate type `%T'",
  ...
  if (((enum tree_code) (name)->common.code) == OVERLOAD)
    name = ((get_first_fn (name))->decl.name);
  else if (((enum tree_code) (name)->common.code) == LOOKUP_EXPR)
    name = ((name)->exp.operands[0]);
  else if ((tree_code_type[(int) (((enum tree_code) (name)->common.code))] == 'd'))
    name = ((name)->decl.name);
  if (has_template_args)
    fn = lookup_fnfields (object_type, name, 2);
  else
    fn = lookup_member (object_type, name, 2, 0);

  if (fn && ((enum tree_code) (fn)->common.code) == TREE_LIST && !(((enum tree_code) (fn)->common.code) == BASELINK))
    {
  ...
  if ((((enum tree_code) (fn)->common.code) == BASELINK) && has_template_args)
    ((((fn))->exp.operands[1]))
      = build_nt (TEMPLATE_ID_EXPR,
    ((((fn))->exp.operands[1])),
    template_args);
  if ((((enum tree_code) (fn)->common.code) == BASELINK) && basetype_path)
    ((((fn))->exp.operands[2])) = basetype_path;
     ...
     tree t;
{
  ...
  if (t == cp_global_trees[CPTI_NULL]
      || ((((enum tree_code) (((t)->common.type))->common.code) == BOOLEAN_TYPE || ((enum tree_code) (((t)->common.type))->common.code) == INTEGER_TYPE) && integer_zerop (t)))
    return 1;
  return 0;
}
...
sufficient_parms_p (parmlist)
     tree parmlist;
{
  for (; parmlist && parmlist != global_trees[TI_VOID_LIST_NODE];
       parmlist = ((parmlist)->common.chain))
    if (!((parmlist)->list.purpose))
      return 0;
  return 1;
}
     ...
     tree type, from;
{
 ...
 rank = 1;
  ...
  ((t)->exp.complexity) = rank;
  ((t)->common.lang_flag_0) = (code == USER_CONV || ((from)->common.lang_flag_0));
  ((t)->common.lang_flag_3) = ((from)->common.lang_flag_3);
  return t;
}
...
non_reference (t)
     tree t;
{
  if (((enum tree_code) (t)->common.code) == REFERENCE_TYPE)
    t = ((t)->common.type);
  return t;
}
     ...
     tree to, from, expr;
{
  ...
  if (((((enum tree_code) (to)->common.code) == POINTER_TYPE && ((enum tree_code) (((to)->common.type))->common.code) == FUNCTION_TYPE) || (((enum tree_code) (to)->common.code) == RECORD_TYPE && ((to)->type.lang_specific) && ((&((to)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
 ...
 return (tree) ((void *)0);
  ...
  if (tcode == COMPLEX_TYPE && fcode == COMPLEX_TYPE)
    {
      ...
      tree part_conv = standard_conversion
        (((to)->common.type), ((from)->common.type), (tree) ((void *)0));

      if (part_conv)
        {
          conv = build_conv (((enum tree_code) (part_conv)->common.code), to, conv);
          ((conv)->exp.complexity) = ((part_conv)->exp.complexity);
        }
      else
        conv = (tree) ((void *)0);
  ...
  if ((tcode == POINTER_TYPE || (((enum tree_code) (to)->common.code) == RECORD_TYPE && ((to)->type.lang_specific) && ((&((to)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    ...
    {
      enum tree_code ufcode = ((enum tree_code) (((from)->common.type))->common.code);
      enum tree_code utcode = ((enum tree_code) (((to)->common.type))->common.code);

      if (comptypes ((((((from)->common.type))->type.main_variant)), (((((to)->common.type))->type.main_variant)), 0))
        ...
        && ufcode != FUNCTION_TYPE)
 {
   from = build_pointer_type
     (cp_build_qualified_type_real ((global_trees[TI_VOID_TYPE]), (cp_type_quals (((from)->common.type))), tf_error | tf_warning));

   conv = build_conv (PTR_CONV, from, conv);
 }
      else if (ufcode == OFFSET_TYPE && utcode == OFFSET_TYPE)
 {
   tree fbase = ((((from)->common.type))->type.maxval);
   tree tbase = ((((to)->common.type))->type.maxval);

   if ((lookup_base ((tbase), fbase, ba_any, ((void *)0)) != (tree) ((void *)0))
       && (comptypes ((((((((from)->common.type))->common.type))->type.main_variant)), (((((((to)->common.type))->common.type))->type.main_variant)), 0)))


     {
       from = build_ptrmem_type (tbase, ((((from)->common.type))->common.type));
       conv = build_conv (PMEM_CONV, from, conv);
     }
 }
      else if ((((enum tree_code) (((from)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((from)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((from)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((from)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((from)->common.type))->type.lang_flag_5))
        && (((enum tree_code) (((to)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((to)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((to)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((to)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((to)->common.type))->type.lang_flag_5))
# 872 "../../../kg++fe/gnu/cp/call.c"
        && (lookup_base ((((from)->common.type)), ((to)->common.type), ba_any, ((void *)0)) != (tree) ((void *)0)))
 {
   from =
     cp_build_qualified_type_real ((((to)->common.type)), (cp_type_quals (((from)->common.type))), tf_error | tf_warning);
   ...
   conv = build_conv (PTR_CONV, from, conv);
      ...
      if (comptypes ((from), (to), 0))
         ;
      else if (comp_ptr_ttypes (((to)->common.type), ((from)->common.type)))
 conv = build_conv (QUAL_CONV, to, conv);
      else if (expr && string_conv_p (to, expr, 0))

 conv = build_conv (QUAL_CONV, to, conv);
      else if (ptr_reasonably_similar (((to)->common.type), ((from)->common.type)))
 {
 ...
 return 0;
  ...
  else if ((((enum tree_code) (to)->common.code) == RECORD_TYPE && ((to)->type.lang_specific) && ((&((to)->type.lang_specific)->u.c)->ptrmemfunc_flag)) && (((enum tree_code) (from)->common.code) == RECORD_TYPE && ((from)->type.lang_specific) && ((&((from)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    {
      ...
      if (!(lookup_base ((tbase), fbase, ba_any, ((void *)0)) != (tree) ((void *)0))
   || !comptypes ((((fromfn)->common.type)), (((tofn)->common.type)), 0)
   || !compparms (((((fromfn)->type.values))->common.chain),
    ((((tofn)->type.values))->common.chain))
   || cp_type_quals (fbase) != cp_type_quals (tbase))
 return 0;

      from = cp_build_qualified_type_real ((tbase), (cp_type_quals (fbase)), tf_error | tf_warning);
      from = build_cplus_method_type (from, ((fromfn)->common.type),
          ((((fromfn)->type.values))->common.chain));
      from = build_ptrmemfunc_type (build_pointer_type (from));
      conv = build_conv (PMEM_CONV, from, conv);
    }
  else if (tcode == BOOLEAN_TYPE)
    {
      if (! (((fcode) == INTEGER_TYPE || (fcode) == ENUMERAL_TYPE || (fcode) == BOOLEAN_TYPE) || fcode == REAL_TYPE
      || fcode == POINTER_TYPE || (((enum tree_code) (from)->common.code) == RECORD_TYPE && ((from)->type.lang_specific) && ((&((from)->type.lang_specific)->u.c)->ptrmemfunc_flag))))
 return 0;

      conv = build_conv (STD_CONV, to, conv);
      if (fcode == POINTER_TYPE
   || ((((enum tree_code) (from)->common.code) == RECORD_TYPE && ((from)->type.lang_specific) && ((&((from)->type.lang_specific)->u.c)->ptrmemfunc_flag)) && ((conv)->exp.complexity) < 4))
 ((conv)->exp.complexity) = 4;
    }
     ...
     tree t2;
{
  ...
  return (comptypes ((t1), (t2), 0)
   || ((((((enum tree_code) (t1)->common.code)) == RECORD_TYPE || (((enum tree_code) (t1)->common.code)) == UNION_TYPE) && (((enum tree_code) (t1)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t1)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t1)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t1)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t1)->type.lang_flag_5))) && (((((enum tree_code) (t2)->common.code)) == RECORD_TYPE || (((enum tree_code) (t2)->common.code)) == UNION_TYPE) && (((enum tree_code) (t2)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t2)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t2)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t2)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t2)->type.lang_flag_5)))
       && (lookup_base ((t2), t1, ba_any, ((void *)0)) != (tree) ((void *)0))));
}
...
# 1032 "../../../kg++fe/gnu/cp/call.c"
  ...
  arglist = build_int_2_wide ((unsigned long long) (0), (long long) (0));
  ((arglist)->common.type) = build_pointer_type (s);
  arglist = build_tree_list ((tree) ((void *)0), arglist);
      ...
      for (; fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
 {
       ...
       if (cand)
  {
    ...
    if (((enum tree_code) (t2)->common.code) != REFERENCE_TYPE
        || !reference_compatible_p (t, ((t2)->common.type)))
      {
   ...
   else if (((enum tree_code) (t2)->common.code) == REFERENCE_TYPE
     && reference_compatible_p (t, ((t2)->common.type)))
   ...
   (reference_type,
    build1 (IDENTITY_CONV,
     ((((((cand->fn)->common.type))->common.type))->common.type),
     (tree) ((void *)0))));
 }
  ...
  conv = build_conv (USER_CONV,
       ((((cand->fn)->common.type))->common.type),
       build1 (IDENTITY_CONV, ((expr)->common.type), expr));
  ((conv)->exp.operands[1]) = build_zc_wrapper (cand);
     ...
     tree conv;
{
  ...
  (void) (((((enum tree_code) (type)->common.code) == REFERENCE_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 1145, __FUNCTION__), 0) : 0);
  (void) (((((enum tree_code) (((conv)->common.type))->common.code) != REFERENCE_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 1147, __FUNCTION__), 0) : 0);


  t = ((type)->common.type);
# 1167 "../../../kg++fe/gnu/cp/call.c"
  if (!comptypes ((((t)->type.main_variant)), (((((conv)->common.type))->type.main_variant)), 0))
    {
...
reference_binding (tree rto, tree rfrom, tree expr, int flags)
{
 ...
 return (tree) ((void *)0);
  ...
  if (lvalue_p && compatible_p)
    {
# 1229 "../../../kg++fe/gnu/cp/call.c"
      conv = build1 (IDENTITY_CONV, from, expr);
      conv = direct_reference_binding (rto, conv);
      if ((lvalue_p & clk_bitfield) != 0
   && ((cp_type_quals (to) & (0x1 | 0x2)) == 0x1))
# 1244 "../../../kg++fe/gnu/cp/call.c"
 ((conv)->common.lang_flag_4) = 1;
      return conv;
    }
  else if ((((((enum tree_code) (from)->common.code)) == RECORD_TYPE || (((enum tree_code) (from)->common.code)) == UNION_TYPE) && (((enum tree_code) (from)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (from)->common.code) == TYPENAME_TYPE || ((enum tree_code) (from)->common.code) == TYPEOF_TYPE || ((enum tree_code) (from)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((from)->type.lang_flag_5))) && !(flags & (512)))
    {
# 1262 "../../../kg++fe/gnu/cp/call.c"
     ...
     int flags;
{
  ...
  if (expr && ((enum tree_code) (expr)->common.code) == OFFSET_REF)
    {
      expr = resolve_offset_ref (expr);
      from = ((expr)->common.type);
    }

  if (from == global_trees[TI_ERROR_MARK] || to == global_trees[TI_ERROR_MARK]
  ...
  if (conv)
    ;
  else if (expr != (tree) ((void *)0)
    && ((((enum tree_code) (from)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (from)->common.code) == TYPENAME_TYPE || ((enum tree_code) (from)->common.code) == TYPEOF_TYPE || ((enum tree_code) (from)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((from)->type.lang_flag_5))
        || (((enum tree_code) (to)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (to)->common.code) == TYPENAME_TYPE || ((enum tree_code) (to)->common.code) == TYPEOF_TYPE || ((enum tree_code) (to)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((to)->type.lang_flag_5)))
    && (flags & (512)) == 0)
    {
      struct z_candidate *cand;
   ...
   int flags)
{
  ...
  if (((((fn))->decl.lang_specific)->decl_flags.anticipated_p))
    return ((void *)0);



  if ((((fn)->decl.lang_specific)->decl_flags.constructor_attr))
    {
...
# 1448 "../../../kg++fe/gnu/cp/call.c"
 ...
 break;
      ...
      is_this = (i == 0 && (((enum tree_code) (((fn)->common.type))->common.code) == METHOD_TYPE)
   && ! (((fn)->decl.lang_specific)->decl_flags.constructor_attr));

      if (parmnode)
 {
   tree parmtype = ((parmnode)->list.value);
# 1499 "../../../kg++fe/gnu/cp/call.c"
   if (ctype && is_this)
     {
       parmtype
  = build_qualified_type (ctype,
     ((((((parmtype)->common.type))->common.readonly_flag) * 0x1) | (((((parmtype)->common.type))->common.volatile_flag) * 0x2) | (((((parmtype)->common.type))->type.restrict_flag) * 0x4) | ((((enum tree_code) (((parmtype)->common.type))->common.code) == RECORD_TYPE && ((((parmtype)->common.type))->common.type)) * 0x8)));
     ...
     tree conversion_path;
{
  ...
  for (parmlist = totype; ((enum tree_code) (parmlist)->common.code) != FUNCTION_TYPE; )
    parmlist = ((parmlist)->common.type);
 ...
 t = implicit_conversion (totype, argtype, arg, flags);
      else if (parmnode == global_trees[TI_VOID_LIST_NODE])
 break;
      else if (parmnode)
 t = implicit_conversion (((parmnode)->list.value), argtype, arg, flags);
      else
 {
   t = build1 (IDENTITY_CONV, argtype, arg);
   ((t)->common.lang_flag_1) = 1;
...

{
      ...
      if (! t)
 {
   ...
   t = build1 (IDENTITY_CONV, types[i], (tree) ((void *)0));
 }
      else if (((t)->common.lang_flag_3))
 viable = 0;
      ((convs)->vec.a[i]) = t;
    }
  ...
  if (args[2])
    {
      ((convs)->vec.a[2]) = ((convs)->vec.a[1]);
      ((convs)->vec.a[1]) = ((convs)->vec.a[0]);
      t = implicit_conversion (c_global_trees[CTI_BOOLEAN_TYPE], argtypes[2], args[2], flags);
      if (t)
 ((convs)->vec.a[0]) = t;
      else
 viable = 0;
     ...
     tree type;
{
  ...
  return (((((enum tree_code) (type)->common.code) == INTEGER_TYPE || ((enum tree_code) (type)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (type)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type)->common.code) == CHAR_TYPE)
    && comptypes ((type_promotes_to (type)), (type), 0))
   || ((enum tree_code) (type)->common.code) == REAL_TYPE);
}
# 1706 "../../../kg++fe/gnu/cp/call.c"
static void
     ...
     int flags;
{
  switch (code)
    ...
    case POSTDECREMENT_EXPR:
      args[1] = global_trees[TI_INTEGER_ZERO];
...
# 1746 "../../../kg++fe/gnu/cp/call.c"
 ...
 return;
    ...
    case PREINCREMENT_EXPR:
      if (((((enum tree_code) (type1)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type1)->common.code) == INTEGER_TYPE) || ((enum tree_code) (type1)->common.code) == REAL_TYPE) || ((((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != OFFSET_TYPE) && ((enum tree_code) (((type1)->common.type))->common.code) != FUNCTION_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != VOID_TYPE))
 {
   type1 = build_reference_type (type1);
   break;
 }
      return;
# 1768 "../../../kg++fe/gnu/cp/call.c"
    case INDIRECT_REF:
      if (((enum tree_code) (type1)->common.code) == POINTER_TYPE
   && (((((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != OFFSET_TYPE) && ((enum tree_code) (((type1)->common.type))->common.code) != FUNCTION_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != VOID_TYPE)
       || ((enum tree_code) (((type1)->common.type))->common.code) == FUNCTION_TYPE))
 break;
      return;
# 1783 "../../../kg++fe/gnu/cp/call.c"
    case CONVERT_EXPR:
      if (((enum tree_code) (type1)->common.code) == POINTER_TYPE
   && ((enum tree_code) (((type1)->common.type))->common.code) != OFFSET_TYPE)
 break;
    case NEGATE_EXPR:
      if (((((enum tree_code) (type1)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type1)->common.code) == INTEGER_TYPE) || ((enum tree_code) (type1)->common.code) == REAL_TYPE))
 break;
      return;
    ...
    case BIT_NOT_EXPR:
      if ((((enum tree_code) (type1)->common.code) == INTEGER_TYPE || ((enum tree_code) (type1)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (type1)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type1)->common.code) == CHAR_TYPE))
 break;
      return;
# 1808 "../../../kg++fe/gnu/cp/call.c"
    case MEMBER_REF:
      if (((enum tree_code) (type1)->common.code) == POINTER_TYPE
   && ((((enum tree_code) (type2)->common.code) == RECORD_TYPE && ((type2)->type.lang_specific) && ((&((type2)->type.lang_specific)->u.c)->ptrmemfunc_flag)) || (((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) == OFFSET_TYPE)))
 {
   tree c1 = ((type1)->common.type);
   tree c2 = ((((enum tree_code) (type2)->common.code) == RECORD_TYPE && ((type2)->type.lang_specific) && ((&((type2)->type.lang_specific)->u.c)->ptrmemfunc_flag))
       ? (((((((((type2)->type.values))->common.type)))->common.type))->type.maxval)
       : ((((type2)->common.type))->type.maxval));

   if ((((enum tree_code) (c1)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (c1)->common.code) == TYPENAME_TYPE || ((enum tree_code) (c1)->common.code) == TYPEOF_TYPE || ((enum tree_code) (c1)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((c1)->type.lang_flag_5)) && (lookup_base ((c1), c2, ba_any, ((void *)0)) != (tree) ((void *)0))
       && ((((enum tree_code) (type2)->common.code) == RECORD_TYPE && ((type2)->type.lang_specific) && ((&((type2)->type.lang_specific)->u.c)->ptrmemfunc_flag))
    || is_complete (((((type2)->common.type))->common.type))))
     break;
 }
      return;
# 1866 "../../../kg++fe/gnu/cp/call.c"
    case MINUS_EXPR:
      if (((((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != OFFSET_TYPE) && ((enum tree_code) (((type1)->common.type))->common.code) != FUNCTION_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != VOID_TYPE) && ((((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) != OFFSET_TYPE) && ((enum tree_code) (((type2)->common.type))->common.code) != FUNCTION_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) != VOID_TYPE))
 break;
      if (((((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != OFFSET_TYPE) && ((enum tree_code) (((type1)->common.type))->common.code) != FUNCTION_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != VOID_TYPE) && (((enum tree_code) (type2)->common.code) == INTEGER_TYPE || ((enum tree_code) (type2)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (type2)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type2)->common.code) == CHAR_TYPE))
 {
   ...
   break;
    ...
    case MULT_EXPR:
    case TRUNC_DIV_EXPR:
      if (((((enum tree_code) (type1)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type1)->common.code) == INTEGER_TYPE) || ((enum tree_code) (type1)->common.code) == REAL_TYPE) && ((((enum tree_code) (type2)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type2)->common.code) == INTEGER_TYPE) || ((enum tree_code) (type2)->common.code) == REAL_TYPE))
 break;
      return;

    case EQ_EXPR:
    case NE_EXPR:
      if (((((enum tree_code) (type1)->common.code) == RECORD_TYPE && ((type1)->type.lang_specific) && ((&((type1)->type.lang_specific)->u.c)->ptrmemfunc_flag)) && (((enum tree_code) (type2)->common.code) == RECORD_TYPE && ((type2)->type.lang_specific) && ((&((type2)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
   || ((((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) == OFFSET_TYPE) && (((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) == OFFSET_TYPE)))
 break;
      if (((((enum tree_code) (type1)->common.code) == RECORD_TYPE && ((type1)->type.lang_specific) && ((&((type1)->type.lang_specific)->u.c)->ptrmemfunc_flag)) || (((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) == OFFSET_TYPE))
   && null_ptr_cst_p (args[1]))
 {
   type2 = type1;
   break;
 }
      if (((((enum tree_code) (type2)->common.code) == RECORD_TYPE && ((type2)->type.lang_specific) && ((&((type2)->type.lang_specific)->u.c)->ptrmemfunc_flag)) || (((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) == OFFSET_TYPE))
   && null_ptr_cst_p (args[0]))
 {
   ...
   break;
    ...
    case MIN_EXPR:
      if (((((enum tree_code) (type1)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type1)->common.code) == INTEGER_TYPE) || ((enum tree_code) (type1)->common.code) == REAL_TYPE) && ((((enum tree_code) (type2)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type2)->common.code) == INTEGER_TYPE) || ((enum tree_code) (type2)->common.code) == REAL_TYPE))
        break;
      if ((((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != OFFSET_TYPE) && (((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) != OFFSET_TYPE))
 break;
      if (((enum tree_code) (type1)->common.code) == ENUMERAL_TYPE && ((enum tree_code) (type2)->common.code) == ENUMERAL_TYPE)
        break;
      if ((((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) != OFFSET_TYPE) && null_ptr_cst_p (args[1]))
 {
   type2 = type1;
   break;
 }
      if (null_ptr_cst_p (args[0]) && (((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) != OFFSET_TYPE))
 {
   type1 = type2;
   break;
 }
 ...
 break;
    case ARRAY_REF:
      if ((((enum tree_code) (type1)->common.code) == INTEGER_TYPE || ((enum tree_code) (type1)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (type1)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type1)->common.code) == CHAR_TYPE) && ((((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) != OFFSET_TYPE) && ((enum tree_code) (((type2)->common.type))->common.code) != FUNCTION_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) != VOID_TYPE))
 {
...
# 1949 "../../../kg++fe/gnu/cp/call.c"
    ...
    case LSHIFT_EXPR:
    case RSHIFT_EXPR:
      if ((((enum tree_code) (type1)->common.code) == INTEGER_TYPE || ((enum tree_code) (type1)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (type1)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type1)->common.code) == CHAR_TYPE) && (((enum tree_code) (type2)->common.code) == INTEGER_TYPE || ((enum tree_code) (type2)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (type2)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type2)->common.code) == CHAR_TYPE))
 break;
      return;
# 1995 "../../../kg++fe/gnu/cp/call.c"
    case MODIFY_EXPR:
      switch (code2)
 {
 case PLUS_EXPR:
 ...
 case NOP_EXPR:
   ...
   if (((((enum tree_code) (type1)->common.code) == RECORD_TYPE && ((type1)->type.lang_specific) && ((&((type1)->type.lang_specific)->u.c)->ptrmemfunc_flag)) && (((enum tree_code) (type2)->common.code) == RECORD_TYPE && ((type2)->type.lang_specific) && ((&((type2)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
     ...
     || ((enum tree_code) (type1)->common.code) == POINTER_TYPE)
    && null_ptr_cst_p (args[1])))
     {
       type2 = type1;
       break;
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/cp/call.c", 2037, __FUNCTION__);
 }
      type1 = build_reference_type (type1);
      break;

    case COND_EXPR:
# 2057 "../../../kg++fe/gnu/cp/call.c"
 ...
 break;
      ...
      if (!(((enum tree_code) (type1)->common.code) == POINTER_TYPE
     || (((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) == OFFSET_TYPE)
     || (((enum tree_code) (type1)->common.code) == RECORD_TYPE && ((type1)->type.lang_specific) && ((&((type1)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
   || !(((enum tree_code) (type2)->common.code) == POINTER_TYPE
        || (((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) == OFFSET_TYPE)
        || (((enum tree_code) (type2)->common.code) == RECORD_TYPE && ((type2)->type.lang_specific) && ((&((type2)->type.lang_specific)->u.c)->ptrmemfunc_flag))))
 return;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/call.c", 2078, __FUNCTION__);
    }



  if (type2 && !comptypes ((type1), (type2), 0)
      && ((enum tree_code) (type1)->common.code) == ((enum tree_code) (type2)->common.code)
      && (((enum tree_code) (type1)->common.code) == REFERENCE_TYPE
   || (((enum tree_code) (type1)->common.code) == POINTER_TYPE
       && (((enum tree_code) (type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((type1)->common.type))->common.code) == OFFSET_TYPE) == (((enum tree_code) (type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((type2)->common.type))->common.code) == OFFSET_TYPE))
   || (((enum tree_code) (type1)->common.code) == RECORD_TYPE && ((type1)->type.lang_specific) && ((&((type1)->type.lang_specific)->u.c)->ptrmemfunc_flag))
   || (((enum tree_code) (type1)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type1)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type1)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type1)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type1)->type.lang_flag_5))
     ...
     int flags;
{
 ...
 argtypes[i] = (tree) ((void *)0);
  ...
  switch (code)
    ...
    case TRUTH_NOT_EXPR:
      build_builtin_candidate
 (candidates, fnname, c_global_trees[CTI_BOOLEAN_TYPE],
  (tree) ((void *)0), args, argtypes, flags);
      return;
    ...
    case TRUTH_ANDIF_EXPR:
      build_builtin_candidate
 (candidates, fnname, c_global_trees[CTI_BOOLEAN_TYPE],
  c_global_trees[CTI_BOOLEAN_TYPE], args, argtypes, flags);
      return;
  ...
  for (i = 0; i < 2; ++i)
    {
      if (! args[i])
 ;
      else if ((((enum tree_code) (argtypes[i])->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (argtypes[i])->common.code) == TYPENAME_TYPE || ((enum tree_code) (argtypes[i])->common.code) == TYPEOF_TYPE || ((enum tree_code) (argtypes[i])->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((argtypes[i])->type.lang_flag_5)))
 {
   tree convs;
  ...
  types[i] = tree_cons
    ((tree) ((void *)0), build_reference_type (argtypes[i]), types[i]);

       types[i] = tree_cons
  ((tree) ((void *)0), ((argtypes[i])->type.main_variant), types[i]);
     }
   ...
   for (; convs; convs = ((convs)->common.chain))
    ...
    && (((enum tree_code) (type)->common.code) != REFERENCE_TYPE
        || ((cp_type_quals (((type)->common.type)) & 0x1) != 0)))
  continue;

       if (code == COND_EXPR && ((enum tree_code) (type)->common.code) == REFERENCE_TYPE)
  types[i] = tree_cons ((tree) ((void *)0), type, types[i]);
      ...
      else
 {
  ...
  for (; types[0]; types[0] = ((types[0])->common.chain))
    {
      if (types[1])
 for (type = types[1]; type; type = ((type)->common.chain))
   add_builtin_candidate
     (candidates, code, code2, fnname, ((types[0])->list.value),
      ((type)->list.value), args, argtypes, flags);
      else
 add_builtin_candidate
   (candidates, code, code2, fnname, ((types[0])->list.value),
    (tree) ((void *)0), args, argtypes, flags);
...
{
  int ntparms = ((((((tmpl)->decl.arguments))->list.value))->vec.length);
  ...
  if ((((((tmpl)->decl.lang_specific)->decl_flags.constructor_attr) && !((((enum tree_code) (tmpl)->common.code) == FUNCTION_DECL || ((enum tree_code) (tmpl)->common.code) == TEMPLATE_DECL) && ((tmpl)->decl.lang_specific) && (((tmpl)->decl.lang_specific)->u.f.cloned_function) != (tree) ((void *)0)))
       || ((((tmpl)->decl.lang_specific)->decl_flags.constructor_attr) && ((tmpl)->decl.name) == cp_global_trees[CPTI_BASE_CTOR_IDENTIFIER]))
      && (((((tmpl)->decl.context))->common.lang_flag_3)))
    args_without_in_chrg = ((args_without_in_chrg)->common.chain);
  ...
  if (fn == global_trees[TI_ERROR_MARK])
    return ((void *)0);
# 2366 "../../../kg++fe/gnu/cp/call.c"
  if ((((fn)->decl.lang_specific)->decl_flags.constructor_attr) && list_length (arglist) == 2)
    {
 ...
 return ((void *)0);
  ...
  if ((((((((fn))->decl.lang_specific) ->decl_flags.u.template_info))->list.purpose)) != tmpl)
# 2400 "../../../kg++fe/gnu/cp/call.c"
    cand->template = tree_cons (tmpl, targs, (tree) ((void *)0));
  else
    cand->template = ((((fn))->decl.lang_specific) ->decl_flags.u.template_info);
...
{
  return
    add_template_candidate_real (candidates, tmpl, (tree) ((void *)0), (tree) ((void *)0),
     arglist, return_type, access_path,
...
equal_functions (fn1, fn2)
     ...
     tree fn2;
{
  if ((((fn1))->decl.lang_flag_0) || (((fn2))->decl.lang_flag_0)
      || ((((enum tree_code) (fn1)->common.code) == FUNCTION_DECL && !(((enum tree_code) (fn1)->common.code) == FUNCTION_DECL && ((fn1)->decl.lang_flag_7))) && ((((fn1)->decl.lang_specific) ? ((fn1)->decl.lang_specific)->decl_flags.language : (((enum tree_code) (fn1)->common.code) == FUNCTION_DECL ? lang_c : lang_cplusplus)) == lang_c)))
...
print_z_candidates (struct z_candidate *candidates)
{
 ...
 continue;
      ...
      while (*cand2)
 {
   if (((enum tree_code) ((*cand2)->fn)->common.code) == FUNCTION_DECL
  ...
  for (; candidates; candidates = candidates->next)
    {
      if (((enum tree_code) (candidates->fn)->common.code) == IDENTIFIER_NODE)
 {
   if (((candidates->convs)->vec.length) == 3)
     error ("%s %D(%T, %T, %T) <built-in>", str, candidates->fn,
        ((((candidates->convs)->vec.a[0]))->common.type),
        ((((candidates->convs)->vec.a[1]))->common.type),
        ((((candidates->convs)->vec.a[2]))->common.type));
   else if (((candidates->convs)->vec.length) == 2)
     ...
     error ("%s %D(%T) <built-in>", str, candidates->fn,
      ...
      else if ((tree_code_type[(int) (((enum tree_code) (candidates->fn)->common.code))] == 't'))
...
merge_conversion_sequences (tree user_seq, tree std_seq)
{
  ...
  (void) (((((enum tree_code) (user_seq)->common.code) == USER_CONV) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 2570, __FUNCTION__), 0) : 0);



  t = &(std_seq);
  while (((enum tree_code) (*t)->common.code) != IDENTITY_CONV)
    t = &((*t)->exp.operands[0]);
     ...
     int flags;
{
  ...
  if ((((enum tree_code) (totype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (totype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (totype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (totype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((totype)->type.lang_flag_5)))
    ctors = lookup_fnfields (((totype)->type.binfo),
  ...
  if (ctors)
    {
      ...
      ctors = ((((ctors))->exp.operands[1]));

      t = build_int_2_wide ((unsigned long long) (0), (long long) (0));
      ((t)->common.type) = build_pointer_type (totype);
      args = build_tree_list ((tree) ((void *)0), expr);


      (void) (((!(((((((enum tree_code) (ctors)->common.code) == OVERLOAD) ? (((struct tree_overload*)(ctors))->function) : (ctors)))->decl.lang_specific)->decl_flags.has_in_charge_parm_p) && !(((((((enum tree_code) (ctors)->common.code) == OVERLOAD) ? (((struct tree_overload*)(ctors))->function) : (ctors)))->decl.lang_specific)->decl_flags.has_vtt_parm_p)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 2633, __FUNCTION__), 0) : 0);


      args = tree_cons ((tree) ((void *)0), t, args);
    }
 ...
 cand = add_function_candidate (&candidates, ctor, totype,
           args, ((totype)->type.binfo),
           ((totype)->type.binfo),
           flags);

      if (cand)
 cand->second_conv = build1 (IDENTITY_CONV, totype, (tree) ((void *)0));
    }

  if (convs)
    args = build_tree_list ((tree) ((void *)0), build_this (expr));

  for (; convs; convs = ((convs)->common.chain))
    {
      tree fns;
      tree conversion_path = ((convs)->list.purpose);
      int convflags = (512);
 ...
 convflags |= (1024);
      ...
      for (fns = ((convs)->list.value); fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
 {
   tree fn = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fns))->function) : (fns));
# 2686 "../../../kg++fe/gnu/cp/call.c"
   if (((enum tree_code) (fn)->common.code) == TEMPLATE_DECL)
     cand = add_template_candidate (&candidates, fn, fromtype, (tree) ((void *)0),
        args, totype,
        ((fromtype)->type.binfo),
        conversion_path,
        flags,
  ...
  (totype, ((((cand->fn)->common.type))->common.type),
   0, convflags);
       ...
       if (ics == (tree) ((void *)0))
  cand->viable = 0;
       else if (cand->viable == 1 && ((ics)->common.lang_flag_3))
  cand->viable = -1;
     }
 }
    }
      ...
      if (flags & (2))
 {
   ...
   print_z_candidates (candidates);
      ...
      ((cand->second_conv)->common.lang_flag_0) = 1;
      if (!any_strictly_viable (candidates))
 ((cand->second_conv)->common.lang_flag_3) = 1;
  ...
  convs = build_conv
    (USER_CONV,
     ((((cand->fn)->decl.lang_specific)->decl_flags.constructor_attr)
      ? totype : non_reference (((((cand->fn)->common.type))->common.type))),
     build1 (IDENTITY_CONV, ((expr)->common.type), expr));
  ((convs)->exp.operands[1]) = build_zc_wrapper (cand);
     ...
     int flags;
{
  ...
  if (cand)
    {
      if (((enum tree_code) (cand->second_conv)->common.code) == AMBIG_CONV)
 return global_trees[TI_ERROR_MARK];
      return convert_from_reference (convert_like_real ((cand->second_conv), (expr), (tree) ((void *)0), 0, 0, 1));
    }
  return (tree) ((void *)0);
}
...
resolve_scoped_fn_name (tree scope, tree name)
{
  tree fn;
  tree template_args = (tree) ((void *)0);
  _Bool is_template_id = ((enum tree_code) (name)->common.code) == TEMPLATE_ID_EXPR;
  ...
  if (((enum tree_code) (scope)->common.code) == NAMESPACE_DECL)
  ...
  else if (!(((((enum tree_code) (scope)->common.code)) == RECORD_TYPE || (((enum tree_code) (scope)->common.code)) == UNION_TYPE) && (((enum tree_code) (scope)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (scope)->common.code) == TYPENAME_TYPE || ((enum tree_code) (scope)->common.code) == TYPEOF_TYPE || ((enum tree_code) (scope)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((scope)->type.lang_flag_5))))
    {
    ...
    {
      if (!((&((scope)->type.lang_specific)->u.c)->being_defined)
   && !(((complete_type (scope))->type.size) != (tree) ((void *)0)))
 {
 ...
 fn = lookup_member (scope, name, 1, 0);
      if (fn && scope_chain->class_type)
 fn = (adjust_result_of_qualified_name_lookup
       (fn, scope, scope_chain->class_type));


      if (fn && ((enum tree_code) (fn)->common.code) == FIELD_DECL)
     ...
     tree args;
{
 ...
 return global_trees[TI_ERROR_MARK];
      else if ((((enum tree_code) (((arg)->common.type))->common.code) == VOID_TYPE))
 {
   error ("invalid use of void expression");
   return global_trees[TI_ERROR_MARK];
 }
      else if (((enum tree_code) (arg)->common.code) == OFFSET_REF)
     ...
     tree fn, args;
{
  ...
  (void) (((((enum tree_code) (fn)->common.code) == FUNCTION_DECL || ((enum tree_code) (fn)->common.code) == TEMPLATE_DECL || ((enum tree_code) (fn)->common.code) == OVERLOAD || ((enum tree_code) (fn)->common.code) == TEMPLATE_ID_EXPR) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 2892, __FUNCTION__), 0) : 0);




  (void) (((!args || ((enum tree_code) (args)->common.code) == TREE_LIST) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 2894, __FUNCTION__), 0) : 0);
  ...
  if (really_overloaded_fn (fn)
      || ((enum tree_code) (fn)->common.code) == TEMPLATE_DECL)
    {
      tree t1;
 ...
 return global_trees[TI_ERROR_MARK];
      ...
      for (t1 = fn; t1; t1 = ((((enum tree_code) (t1)->common.code) == OVERLOAD) ? ((t1)->common.chain) : (tree) ((void *)0)))
 {
   tree t = ((((enum tree_code) (t1)->common.code) == OVERLOAD) ? (((struct tree_overload*)(t1))->function) : (t1));

   if (((enum tree_code) (t)->common.code) == TEMPLATE_DECL)
     add_template_candidate
       (&candidates, t, (tree) ((void *)0), explicit_targs, args,
        (tree) ((void *)0),
                        (tree) ((void *)0), (tree) ((void *)0),
        (3), DEDUCE_CALL);
   else if (! template_only)
     add_function_candidate
       (&candidates, t, (tree) ((void *)0), args, (tree) ((void *)0),
                            (tree) ((void *)0), (3));
 }
      ...
      if (! any_viable (candidates))
 {
   ...
   error ("no matching function for call to `%D(%A)'",
      ((((((enum tree_code) (fn)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fn))->function) : (fn)))->decl.name), args);
   if (candidates)
     print_z_candidates (candidates);
   return global_trees[TI_ERROR_MARK];
 }
      ...
      if (cand == 0)
 {
   error ("call of overloaded `%D(%A)' is ambiguous",
      (((((struct tree_overload*)(fn))->function))->decl.name), args);
   print_z_candidates (candidates);
   return global_trees[TI_ERROR_MARK];
 }

      return build_over_call (cand, args, (3));
    }
     ...
     tree obj, args;
{
  ...
  if (fns)
    {
      tree base = ((((((fns))->exp.operands[0])))->common.type);
      mem_args = tree_cons ((tree) ((void *)0), build_this (obj), args);

      for (fns = ((((fns))->exp.operands[1])); fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
 {
   tree fn = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fns))->function) : (fns));
   if (((enum tree_code) (fn)->common.code) == TEMPLATE_DECL)
     add_template_candidate (&candidates, fn, base, (tree) ((void *)0),
        mem_args, (tree) ((void *)0),
        ((type)->type.binfo),
        ((type)->type.binfo),
        (3), DEDUCE_CALL);
   else
     add_function_candidate
       (&candidates, fn, base, mem_args, ((type)->type.binfo),
        ((type)->type.binfo), (3));
 }
    }
  ...
  for (; convs; convs = ((convs)->common.chain))
    {
      ...
      if ((((enum tree_code) (totype)->common.code) == POINTER_TYPE
    && ((enum tree_code) (((totype)->common.type))->common.code) == FUNCTION_TYPE)
   || (((enum tree_code) (totype)->common.code) == REFERENCE_TYPE
       && ((enum tree_code) (((totype)->common.type))->common.code) == FUNCTION_TYPE)
   || (((enum tree_code) (totype)->common.code) == REFERENCE_TYPE
       && ((enum tree_code) (((totype)->common.type))->common.code) == POINTER_TYPE
       && ((enum tree_code) (((((totype)->common.type))->common.type))->common.code) == FUNCTION_TYPE))
 for (; fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
   {
     tree fn = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fns))->function) : (fns));
     if (((enum tree_code) (fn)->common.code) == TEMPLATE_DECL)
  ...
  if (((enum tree_code) (cand->fn)->common.code) == FUNCTION_DECL
      && (((((cand->fn)->decl.name))->common.lang_flag_2) ? ((cand->fn)->decl.lang_specific)->u.f.operator_code : ERROR_MARK) == CALL_EXPR)
    return build_over_call (cand, mem_args, (3));

  obj = convert_like_real ((((cand->convs)->vec.a[0])), (obj), (cand->fn), (-1), 0, 1);
...
# 3144 "../../../kg++fe/gnu/cp/call.c"
  if ((((((enum tree_code) (t1)->common.code)) == RECORD_TYPE || (((enum tree_code) (t1)->common.code)) == UNION_TYPE) && (((enum tree_code) (t1)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t1)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t1)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t1)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t1)->type.lang_flag_5))) && (((((enum tree_code) (t2)->common.code)) == RECORD_TYPE || (((enum tree_code) (t2)->common.code)) == UNION_TYPE) && (((enum tree_code) (t2)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t2)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t2)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t2)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t2)->type.lang_flag_5)))
      && ((good_base = (lookup_base ((t1), t2, ba_any, ((void *)0)) != (tree) ((void *)0))) || (lookup_base ((t2), t1, ba_any, ((void *)0)) != (tree) ((void *)0))))
    {
 ...
 return (tree) ((void *)0);
    ...
    return implicit_conversion (t2, t1, e1, (3));
}
     ...
     tree arg3;
{
 ...
 pedwarn ("ISO C++ forbids omitting the middle term of a ?: expression");
  ...
  arg1 = cp_convert (c_global_trees[CTI_BOOLEAN_TYPE], arg1);



  if (arg1 == global_trees[TI_ERROR_MARK]
      || arg2 == global_trees[TI_ERROR_MARK]
      || arg3 == global_trees[TI_ERROR_MARK]
      || ((arg1)->common.type) == global_trees[TI_ERROR_MARK]
      || ((arg2)->common.type) == global_trees[TI_ERROR_MARK]
      || ((arg3)->common.type) == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];
# 3218 "../../../kg++fe/gnu/cp/call.c"
 ...
 arg3 = decay_conversion (arg3);
      arg2_type = ((arg2)->common.type);
      arg3_type = ((arg3)->common.type);
# 3242 "../../../kg++fe/gnu/cp/call.c"
      if ((((enum tree_code) (arg2)->common.code) == THROW_EXPR)
   ^ (((enum tree_code) (arg3)->common.code) == THROW_EXPR))
 result_type = ((((enum tree_code) (arg2)->common.code) == THROW_EXPR)
         ? arg3_type : arg2_type);
      else if ((((enum tree_code) (arg2_type)->common.code) == VOID_TYPE) && (((enum tree_code) (arg3_type)->common.code) == VOID_TYPE))
 result_type = global_trees[TI_VOID_TYPE];
      else
 {
   error ("`%E' has type `void' and is not a throw-expression",
      (((enum tree_code) (arg2_type)->common.code) == VOID_TYPE) ? arg2 : arg3);
   return global_trees[TI_ERROR_MARK];
 }
  ...
  else if (!comptypes ((arg2_type), (arg3_type), 0)
    && ((((((enum tree_code) (arg2_type)->common.code)) == RECORD_TYPE || (((enum tree_code) (arg2_type)->common.code)) == UNION_TYPE) && (((enum tree_code) (arg2_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (arg2_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (arg2_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (arg2_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((arg2_type)->type.lang_flag_5))) || (((((enum tree_code) (arg3_type)->common.code)) == RECORD_TYPE || (((enum tree_code) (arg3_type)->common.code)) == UNION_TYPE) && (((enum tree_code) (arg3_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (arg3_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (arg3_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (arg3_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((arg3_type)->type.lang_flag_5)))))
    {
      tree conv2 = conditional_conversion (arg2, arg3);
      tree conv3 = conditional_conversion (arg3, arg2);
# 3278 "../../../kg++fe/gnu/cp/call.c"
      if ((conv2 && !((conv2)->common.lang_flag_3)
    && conv3 && !((conv3)->common.lang_flag_3))
   || (conv2 && ((enum tree_code) (conv2)->common.code) == AMBIG_CONV)
   || (conv3 && ((enum tree_code) (conv3)->common.code) == AMBIG_CONV))
 {
   error ("operands to ?: have different types");
   return global_trees[TI_ERROR_MARK];
 }
      else if (conv2 && !((conv2)->common.lang_flag_3))
 {
   arg2 = convert_like_real ((conv2), (arg2), (tree) ((void *)0), 0, 0, 1);
   ...
   if (!comptypes ((((arg2)->common.type)), (arg3_type), 0))
     arg2 = build1 (NOP_EXPR, arg3_type, arg2);
   arg2_type = ((arg2)->common.type);
 }
      else if (conv3 && !((conv3)->common.lang_flag_3))
 {
   arg3 = convert_like_real ((conv3), (arg3), (tree) ((void *)0), 0, 0, 1);
   arg3 = convert_from_reference (arg3);
   if (!comptypes ((((arg3)->common.type)), (arg2_type), 0))
  ...
  if (real_lvalue_p (arg2) && real_lvalue_p (arg3) &&
      comptypes ((arg2_type), (arg3_type), 0))
    {
      result_type = arg2_type;
      goto valid_operands;
    }
# 3329 "../../../kg++fe/gnu/cp/call.c"
  lvalue_p = 0;
  if (!comptypes ((arg2_type), (arg3_type), 0)
      && ((((((enum tree_code) (arg2_type)->common.code)) == RECORD_TYPE || (((enum tree_code) (arg2_type)->common.code)) == UNION_TYPE) && (((enum tree_code) (arg2_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (arg2_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (arg2_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (arg2_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((arg2_type)->type.lang_flag_5))) || (((((enum tree_code) (arg3_type)->common.code)) == RECORD_TYPE || (((enum tree_code) (arg3_type)->common.code)) == UNION_TYPE) && (((enum tree_code) (arg3_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (arg3_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (arg3_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (arg3_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((arg3_type)->type.lang_flag_5)))))
    {
      ...
      add_builtin_candidates (&candidates,
         COND_EXPR,
         NOP_EXPR,
         (operator_name_info[(int) (COND_EXPR)].identifier),
         args,
         (3));
      ...
      if (!cand)
 {
   ...
   return global_trees[TI_ERROR_MARK];
      ...
      conv = ((cand->convs)->vec.a[0]);
      arg1 = convert_like_real ((conv), (arg1), (tree) ((void *)0), 0, 0, 1);
      conv = ((cand->convs)->vec.a[1]);
      arg2 = convert_like_real ((conv), (arg2), (tree) ((void *)0), 0, 0, 1);
      conv = ((cand->convs)->vec.a[2]);
      arg3 = convert_like_real ((conv), (arg3), (tree) ((void *)0), 0, 0, 1);
    }
# 3395 "../../../kg++fe/gnu/cp/call.c"
  ...
  else if ((((((enum tree_code) (arg2_type)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (arg2_type)->common.code) == INTEGER_TYPE) || ((enum tree_code) (arg2_type)->common.code) == REAL_TYPE)
     || ((enum tree_code) (arg2_type)->common.code) == ENUMERAL_TYPE)
    && (((((enum tree_code) (arg3_type)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (arg3_type)->common.code) == INTEGER_TYPE) || ((enum tree_code) (arg3_type)->common.code) == REAL_TYPE)
        || ((enum tree_code) (arg3_type)->common.code) == ENUMERAL_TYPE))
    {

      result_type = type_after_usual_arithmetic_conversions (arg2_type,
            arg3_type);

      if (((enum tree_code) (arg2_type)->common.code) == ENUMERAL_TYPE
          && ((enum tree_code) (arg3_type)->common.code) == ENUMERAL_TYPE)
         warning ("enumeral mismatch in conditional expression: `%T' vs `%T'",
                   arg2_type, arg3_type);
      else if (extra_warnings
               && ((((enum tree_code) (arg2_type)->common.code) == ENUMERAL_TYPE
                    && !comptypes ((arg3_type), (type_promotes_to (arg2_type)), 0))
                   || (((enum tree_code) (arg3_type)->common.code) == ENUMERAL_TYPE
                       && !comptypes ((arg2_type), (type_promotes_to (arg3_type)), 0))))
        warning ("enumeral and non-enumeral type in conditional expression");

      arg2 = perform_implicit_conversion (result_type, arg2);
      arg3 = perform_implicit_conversion (result_type, arg3);
    }
# 3456 "../../../kg++fe/gnu/cp/call.c"
  else if ((null_ptr_cst_p (arg2)
     && ((((enum tree_code) (arg3_type)->common.code) == POINTER_TYPE && ((enum tree_code) (((arg3_type)->common.type))->common.code) != OFFSET_TYPE) || (((enum tree_code) (arg3_type)->common.code) == POINTER_TYPE && ((enum tree_code) (((arg3_type)->common.type))->common.code) == OFFSET_TYPE)
  || (((enum tree_code) (arg3_type)->common.code) == RECORD_TYPE && ((arg3_type)->type.lang_specific) && ((&((arg3_type)->type.lang_specific)->u.c)->ptrmemfunc_flag))))
    || (null_ptr_cst_p (arg3)
        && ((((enum tree_code) (arg2_type)->common.code) == POINTER_TYPE && ((enum tree_code) (((arg2_type)->common.type))->common.code) != OFFSET_TYPE) || (((enum tree_code) (arg2_type)->common.code) == POINTER_TYPE && ((enum tree_code) (((arg2_type)->common.type))->common.code) == OFFSET_TYPE)
  || (((enum tree_code) (arg2_type)->common.code) == RECORD_TYPE && ((arg2_type)->type.lang_specific) && ((&((arg2_type)->type.lang_specific)->u.c)->ptrmemfunc_flag))))
    || ((((enum tree_code) (arg2_type)->common.code) == POINTER_TYPE && ((enum tree_code) (((arg2_type)->common.type))->common.code) != OFFSET_TYPE) && (((enum tree_code) (arg3_type)->common.code) == POINTER_TYPE && ((enum tree_code) (((arg3_type)->common.type))->common.code) != OFFSET_TYPE))
    || ((((enum tree_code) (arg2_type)->common.code) == POINTER_TYPE && ((enum tree_code) (((arg2_type)->common.type))->common.code) == OFFSET_TYPE) && (((enum tree_code) (arg3_type)->common.code) == POINTER_TYPE && ((enum tree_code) (((arg3_type)->common.type))->common.code) == OFFSET_TYPE))
    || ((((enum tree_code) (arg2_type)->common.code) == RECORD_TYPE && ((arg2_type)->type.lang_specific) && ((&((arg2_type)->type.lang_specific)->u.c)->ptrmemfunc_flag))
        && (((enum tree_code) (arg3_type)->common.code) == RECORD_TYPE && ((arg3_type)->type.lang_specific) && ((&((arg3_type)->type.lang_specific)->u.c)->ptrmemfunc_flag))))
    {
 ...
 valid_operands:
  ...
  if (!lvalue_p && (((enum tree_code) (result_type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (result_type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (result_type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (result_type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((result_type)->type.lang_flag_5)))
...
{
  struct z_candidate *candidates = 0, *cand;
  tree fns, mem_arglist = (tree) ((void *)0), arglist, fnname;
  enum tree_code code2 = NOP_EXPR;
  tree conv;
  _Bool viable_candidates;
  ...
  if (code == LT_EXPR && ((enum tree_code) (arg1)->common.code) == TEMPLATE_DECL)
    {
  ...
  if (code == MODIFY_EXPR)
    {
      ...
      arg3 = (tree) ((void *)0);
      fnname = (assignment_operator_name_info[(int) (code2)].identifier);
    }
  else
    fnname = (operator_name_info[(int) (code)].identifier);

  if (((enum tree_code) (arg1)->common.code) == OFFSET_REF)
    arg1 = resolve_offset_ref (arg1);
  arg1 = convert_from_reference (arg1);
  if ((((((enum tree_code) (((arg1)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((arg1)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((arg1)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((arg1)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((arg1)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((arg1)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((arg1)->common.type))->type.lang_flag_5)))
      && (((&((((arg1)->common.type))->type.lang_specific)->u.c)->use_template) & 1))

    instantiate_class_template (((((arg1)->common.type))->type.main_variant));
  ...
  switch (code)
    ...
    case DELETE_EXPR:
      ...
      fancy_abort ("../../../kg++fe/gnu/cp/call.c", 3544, __FUNCTION__);
  ...
  if (arg2)
    {
      if (((enum tree_code) (arg2)->common.code) == OFFSET_REF)
 arg2 = resolve_offset_ref (arg2);
      arg2 = convert_from_reference (arg2);
      if ((((((enum tree_code) (((arg2)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((arg2)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((arg2)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((arg2)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((arg2)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((arg2)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((arg2)->common.type))->type.lang_flag_5)))
   && (((&((((arg2)->common.type))->type.lang_specific)->u.c)->use_template) & 1))
 instantiate_class_template (((((arg2)->common.type))->type.main_variant));
    }
  if (arg3)
    {
      if (((enum tree_code) (arg3)->common.code) == OFFSET_REF)
 arg3 = resolve_offset_ref (arg3);
      arg3 = convert_from_reference (arg3);
      if ((((((enum tree_code) (((arg3)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((arg3)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((arg3)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((arg3)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((arg3)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((arg3)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((arg3)->common.type))->type.lang_flag_5)))
   && (((&((((arg3)->common.type))->type.lang_specific)->u.c)->use_template) & 1))
 instantiate_class_template (((((arg3)->common.type))->type.main_variant));
    }

  if (code == COND_EXPR)
    {
      if (arg2 == (tree) ((void *)0)
   || ((enum tree_code) (((arg2)->common.type))->common.code) == VOID_TYPE
   || ((enum tree_code) (((arg3)->common.type))->common.code) == VOID_TYPE
   || (! ((((((enum tree_code) (((arg2)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((arg2)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((arg2)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((arg2)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((arg2)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((arg2)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((arg2)->common.type))->type.lang_flag_5))) || ((enum tree_code) (((arg2)->common.type))->common.code) == ENUMERAL_TYPE)
       && ! ((((((enum tree_code) (((arg3)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((arg3)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((arg3)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((arg3)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((arg3)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((arg3)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((arg3)->common.type))->type.lang_flag_5))) || ((enum tree_code) (((arg3)->common.type))->common.code) == ENUMERAL_TYPE)))
 goto builtin;
    }
  else if (! ((((((enum tree_code) (((arg1)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((arg1)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((arg1)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((arg1)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((arg1)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((arg1)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((arg1)->common.type))->type.lang_flag_5))) || ((enum tree_code) (((arg1)->common.type))->common.code) == ENUMERAL_TYPE)
    && (! arg2 || ! ((((((enum tree_code) (((arg2)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((arg2)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((arg2)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((arg2)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((arg2)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((arg2)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((arg2)->common.type))->type.lang_flag_5))) || ((enum tree_code) (((arg2)->common.type))->common.code) == ENUMERAL_TYPE)))
    goto builtin;
  ...
  arglist = (tree) ((void *)0);
  if (arg3)
    arglist = tree_cons ((tree) ((void *)0), arg3, arglist);
  if (arg2)
    arglist = tree_cons ((tree) ((void *)0), arg2, arglist);
  arglist = tree_cons ((tree) ((void *)0), arg1, arglist);

  fns = lookup_function_nonclass (fnname, arglist);

  if (fns && ((enum tree_code) (fns)->common.code) == TREE_LIST)
    fns = ((fns)->list.value);
  for (; fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
    {
      tree fn = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fns))->function) : (fns));
      if (((enum tree_code) (fn)->common.code) == TEMPLATE_DECL)
 add_template_candidate (&candidates, fn, (tree) ((void *)0), (tree) ((void *)0),
    arglist, ((fnname)->common.type),
                    (tree) ((void *)0),
                        (tree) ((void *)0),
    flags, DEDUCE_CALL);
      else
 add_function_candidate (&candidates, fn, (tree) ((void *)0),
    arglist,
                    (tree) ((void *)0),
                        (tree) ((void *)0),
    flags);
  ...
  if ((((enum tree_code) (((arg1)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((arg1)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((arg1)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((arg1)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((arg1)->common.type))->type.lang_flag_5)))
    {
      fns = lookup_fnfields (((((arg1)->common.type))->type.binfo), fnname, 1);
      if (fns == global_trees[TI_ERROR_MARK])
 return fns;
    }
  else
  ...
  if (fns)
    {
      tree conversion_path = ((((fns))->exp.operands[0]));

      mem_arglist = tree_cons ((tree) ((void *)0), build_this (arg1), ((arglist)->common.chain));
      for (fns = ((((fns))->exp.operands[1])); fns; fns = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? ((fns)->common.chain) : (tree) ((void *)0)))
 {
   tree fn = ((((enum tree_code) (fns)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fns))->function) : (fns));
   tree this_arglist;
   tree access_path = ((((arg1)->common.type))->type.binfo);
   ...
   if (((enum tree_code) (fn)->common.code) == TEMPLATE_DECL)
     ...
     add_template_candidate (&candidates, fn,
        ((conversion_path)->common.type),
        (tree) ((void *)0),
        this_arglist, ((fnname)->common.type),
        access_path, conversion_path,
        flags, DEDUCE_CALL);
   else
     add_function_candidate
       (&candidates, fn, ((conversion_path)->common.type), this_arglist,
 ...
 case POSTDECREMENT_EXPR:
   ...
   return build_new_op (code, flags, arg1, (tree) ((void *)0), (tree) ((void *)0));
  ...
  if (((enum tree_code) (cand->fn)->common.code) == FUNCTION_DECL)
    {
      extern int warn_synth;
      if (warn_synth
   && fnname == (assignment_operator_name_info[(int) (NOP_EXPR)].identifier)
   && ((cand->fn)->decl.artificial_flag)
   && candidates->next
 ...
 (cand,
  ((enum tree_code) (((cand->fn)->common.type))->common.code) == METHOD_TYPE
  ? mem_arglist : arglist,
  (3));
    }
  ...
  switch (code)
    ...
    case EQ_EXPR:
    case NE_EXPR:
      if (((enum tree_code) (((arg1)->common.type))->common.code) == ENUMERAL_TYPE
   && ((enum tree_code) (((arg2)->common.type))->common.code) == ENUMERAL_TYPE
   && (((((arg1)->common.type))->type.main_variant)
       != ((((arg2)->common.type))->type.main_variant)))
 {
   warning ("comparison between `%#T' and `%#T'",
        ((arg1)->common.type), ((arg2)->common.type));
 }
      break;
    default:
      break;
  ...
  conv = ((cand->convs)->vec.a[0]);
  if (((enum tree_code) (conv)->common.code) == REF_BIND)
    conv = ((conv)->exp.operands[0]);
  arg1 = convert_like_real ((conv), (arg1), (tree) ((void *)0), 0, 0, 1);
  if (arg2)
    {
...
builtin:
 ...
 (build_indirect_ref (arg1, ((void *)0)), arg2);
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/call.c", 3872, __FUNCTION__);
      return (tree) ((void *)0);
    }
}
# 3889 "../../../kg++fe/gnu/cp/call.c"
tree
     ...
     int flags;
{
  ...
  if ((((enum tree_code) (type)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (type)->common.code) == TYPENAME_TYPE || ((enum tree_code) (type)->common.code) == TYPEOF_TYPE || ((enum tree_code) (type)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((type)->type.lang_flag_5)) && ! (flags & (16)))
  ...
  if (placement)
    {
      ...
      while (((enum tree_code) (call_expr)->common.code) == COMPOUND_EXPR)
 call_expr = ((call_expr)->exp.operands[1]);

      alloc_fn = get_callee_fndecl (call_expr);
      (void) (((alloc_fn != (tree) ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 3940, __FUNCTION__), 0) : 0);

      argtypes = ((((((alloc_fn)->common.type))->type.values))->common.chain);

      args = ((((call_expr)->exp.operands[1]))->common.chain);
    }
  else
    {
  ...
  for (pass = 0; pass < (placement ? 1 : 2); ++pass)
    {
      if (pass == 0)
 argtypes = tree_cons ((tree) ((void *)0), global_trees[TI_PTR_TYPE], argtypes);
      else


 argtypes = tree_cons ((tree) ((void *)0), global_trees[TI_PTR_TYPE],
         tree_cons ((tree) ((void *)0), sizetype_tab[(int) SIZETYPE],
      global_trees[TI_VOID_LIST_NODE]));
      fntype = build_function_type (global_trees[TI_VOID_TYPE], argtypes);



      for (fn = (((enum tree_code) (fns)->common.code) == BASELINK) ? ((((fns))->exp.operands[1])) : fns;
    fn;
    fn = ((((enum tree_code) (fn)->common.code) == OVERLOAD) ? ((fn)->common.chain) : (tree) ((void *)0)))
 {
   ...
   t = build_exception_variant (((((((enum tree_code) (fn)->common.code) == OVERLOAD) ? (((struct tree_overload*)(fn))->function) : (fn)))->common.type),
           (tree) ((void *)0));


   if (comptypes (t, fntype, 8))
     break;
 }
  ...
  if (fn)
    {
      ...
      if ((((fn)->decl.context) && (tree_code_type[(int) (((enum tree_code) (((fn)->decl.context))->common.code))] == 't')))
 enforce_access (type, fn);

      if (pass == 0)
 args = tree_cons ((tree) ((void *)0), addr, args);
      else
 args = tree_cons ((tree) ((void *)0), addr,
     build_tree_list ((tree) ((void *)0), size));
...
# 4060 "../../../kg++fe/gnu/cp/call.c"
static tree
convert_like_real (tree convs, tree expr, tree fn, int argnum, int inner,
     _Bool issue_conversion_warnings)
{
  int savew, savee;

  tree totype = ((convs)->common.type);

  if (((convs)->common.lang_flag_3)
      && ((enum tree_code) (convs)->common.code) != USER_CONV
      && ((enum tree_code) (convs)->common.code) != AMBIG_CONV
      && ((enum tree_code) (convs)->common.code) != REF_BIND)
    {
      tree t = convs;
      for (; t; t = ((t)->exp.operands[0]))
 {
   if (((enum tree_code) (t)->common.code) == USER_CONV || !((t)->common.lang_flag_3))
     {
       expr = convert_like_real (t, expr, fn, argnum, 1,
                                   0);
       break;
     }
   else if (((enum tree_code) (t)->common.code) == AMBIG_CONV)
     return convert_like_real (t, expr, fn, argnum, 1,
                                        0);
   else if (((enum tree_code) (t)->common.code) == IDENTITY_CONV)
     break;
 }
      pedwarn ("invalid conversion from `%T' to `%T'", ((expr)->common.type), totype);
      if (fn)
 pedwarn ("  initializing argument %P of `%D'", argnum, fn);
  ...
  switch (((enum tree_code) (convs)->common.code))
    ...
    case USER_CONV:
      {
 struct z_candidate *cand = (((struct tree_wrapper*)(((convs)->exp.operands[1])))->z_c);
 tree convfn = cand->fn;
 tree args;

 if ((((convfn)->decl.lang_specific)->decl_flags.constructor_attr))
   {
     tree t = build_int_2_wide ((unsigned long long) (0), (long long) (0));
     ((t)->common.type) = build_pointer_type (((convfn)->decl.context));

     args = build_tree_list ((tree) ((void *)0), expr);
     if ((((convfn)->decl.lang_specific)->decl_flags.has_in_charge_parm_p)
  || (((convfn)->decl.lang_specific)->decl_flags.has_vtt_parm_p))


       fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4115, __FUNCTION__);
     args = tree_cons ((tree) ((void *)0), t, args);
   }
 else
   args = build_this (expr);
 expr = build_over_call (cand, args, (3));



 if ((((convfn)->decl.lang_specific)->decl_flags.constructor_attr))
   expr = build_cplus_new (totype, expr);
# 4135 "../../../kg++fe/gnu/cp/call.c"
 if ((((enum tree_code) (totype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (totype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (totype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (totype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((totype)->type.lang_flag_5))
     && (inner >= 0 || !lvalue_p (expr)))
   {
     savew = (global_dc)->diagnostic_count[(int) (DK_WARNING)], savee = (global_dc)->diagnostic_count[(int) (DK_ERROR)];
     expr = build_special_member_call
       ((tree) ((void *)0), cp_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER],
        build_tree_list ((tree) ((void *)0), expr), ((totype)->type.binfo),
 ...
 (totype, ((convs)->exp.operands[0]), (3));

    default:
      break;
    };

  expr = convert_like_real (((convs)->exp.operands[0]), expr, fn, argnum,
                            ((enum tree_code) (convs)->common.code) == REF_BIND ? -1 : 1,
                                     0);
  if (expr == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];
  ...
  if (((enum tree_code) (convs)->common.code) != REF_BIND
 ...
 return expr;
    ...
    case BASE_CONV:
      if (((enum tree_code) (convs)->common.code) == BASE_CONV && !((convs)->common.lang_flag_4))
 {
   ...
   return expr;
      ...
      savew = (global_dc)->diagnostic_count[(int) (DK_WARNING)], savee = (global_dc)->diagnostic_count[(int) (DK_ERROR)];
      expr = build_special_member_call ((tree) ((void *)0), cp_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER],
     build_tree_list ((tree) ((void *)0), expr),
     ((totype)->type.binfo),
     (3)|(128));
      if (fn)
 {
 ...
 if (((convs)->common.lang_flag_4) || !non_cast_lvalue_p (expr))
   {
     tree type = ((((convs)->exp.operands[0]))->common.type);
 ...
 expr = cp_convert (build_pointer_type (((ref_type)->common.type)),
      expr);
 ...
 return build_nop (ref_type, expr);
  ...
  return ocp_convert (totype, expr, 1,
        (3)|(512));
}
...
call_builtin_trap ()
{
  tree fn = (__builtin_constant_p ("__builtin_trap") ? get_identifier_with_length (("__builtin_trap"), (unsigned) strlen ("__builtin_trap")) : (get_identifier) ("__builtin_trap"));
  if (namespace_binding ((fn), global_namespace))
    fn = namespace_binding ((fn), global_namespace);
  else
    fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4285, __FUNCTION__);

  fn = build_call (fn, (tree) ((void *)0));
  fn = build (COMPOUND_EXPR, integer_types[itk_int], fn, global_trees[TI_INTEGER_ZERO]);
  return fn;
}
...
convert_arg_to_ellipsis (arg)
     tree arg;
{
  if (((enum tree_code) (((arg)->common.type))->common.code) == REAL_TYPE
      && (((((arg)->common.type))->type.precision)
   < ((global_trees[TI_DOUBLE_TYPE])->type.precision)))

    arg = cp_convert (global_trees[TI_DOUBLE_TYPE], arg);
  else
  ...
  if (arg != global_trees[TI_ERROR_MARK] && ! pod_type_p (((arg)->common.type)))
    {
      ...
      warning ("cannot pass objects of non-POD type `%#T' through `...'; call will abort at runtime",
     ...
     tree type;
{
  ...
  type = (complete_type_or_diagnostic ((type), ((tree) ((void *)0)), 0));
     ...
     int parmnum;
{
  if (((enum tree_code) (arg)->common.code) == DEFAULT_ARG)
    {
# 4396 "../../../kg++fe/gnu/cp/call.c"
      unprocessed_defarg_fn (fn);




      return build1 (NOP_EXPR, type, global_trees[TI_INTEGER_ZERO]);
    }

  if (fn && ((((fn))->decl.lang_specific) ->decl_flags.u.template_info))
  ...
  if (((enum tree_code) (arg)->common.code) == CONSTRUCTOR)
    {
      ...
      arg = convert_for_initialization (0, type, arg, (3),
     ...
     int flags;
{
  ...
  if (cand->warnings)
    for (val = cand->warnings; val; val = ((val)->common.chain))
      joust (cand, (((struct tree_wrapper*)(((val)->list.value)))->z_c), 1);

  if (((((enum tree_code) (((fn)->common.type))->common.code) == METHOD_TYPE) || (((fn)->decl.lang_specific)->decl_flags.static_function)))
    enforce_access (cand->access_path, fn);

  if (args && ((enum tree_code) (args)->common.code) != TREE_LIST)
    args = build_tree_list ((tree) ((void *)0), args);
  arg = args;
  ...
  if ((((fn)->decl.lang_specific)->decl_flags.constructor_attr))
    {
      converted_args = tree_cons ((tree) ((void *)0), ((arg)->list.value), converted_args);
      arg = ((arg)->common.chain);
      parm = ((parm)->common.chain);
      if ((((fn)->decl.lang_specific)->decl_flags.has_in_charge_parm_p))

 fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4505, __FUNCTION__);
      if ((((fn)->decl.lang_specific)->decl_flags.has_vtt_parm_p))
 {
   converted_args = tree_cons
     ((tree) ((void *)0), ((arg)->list.value), converted_args);
   arg = ((arg)->common.chain);
   parm = ((parm)->common.chain);
 }
    }

  else if (((enum tree_code) (((fn)->common.type))->common.code) == METHOD_TYPE)
    {
 ...
 pedwarn ("passing `%T' as `this' argument of `%#D' discards qualifiers",
      ...
      (void) (((((enum tree_code) (parmtype)->common.code) == POINTER_TYPE) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4532, __FUNCTION__), 0) : 0);

      (void) (((cand->conversion_path != (tree) ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4534, __FUNCTION__), 0) : 0);
      converted_arg = build_base_path (PLUS_EXPR,
           ((arg)->list.value),
           cand->conversion_path,
           1);

      if (!accessible_base_p (((argtype)->common.type),
         ((cand->conversion_path)->common.type)))
 error ("`%T' is not an accessible base of `%T'",
      ...
      base_binfo = lookup_base (((((converted_arg)->common.type))->common.type),
    ((parmtype)->common.type), ba_ignore, ((void *)0));
      converted_arg = build_base_path (PLUS_EXPR, converted_arg,
           base_binfo, 1);

      converted_args = tree_cons ((tree) ((void *)0), converted_arg, converted_args);
      parm = ((parm)->common.chain);
      arg = ((arg)->common.chain);
      ++i;
      is_method = 1;
  ...
  for (; arg && parm;
       parm = ((parm)->common.chain), arg = ((arg)->common.chain), ++i)
    {
      tree type = ((parm)->list.value);

      conv = ((convs)->vec.a[i]);
      val = convert_like_real ((conv), (((arg)->list.value)), (fn), (i - is_method), 0, 1);


      val = convert_for_arg_passing (type, val);
      converted_args = tree_cons ((tree) ((void *)0), val, converted_args);
    }


  for (; parm && parm != global_trees[TI_VOID_LIST_NODE]; parm = ((parm)->common.chain), i++)
    converted_args
      = tree_cons ((tree) ((void *)0),
     convert_default_arg (((parm)->list.value),
     ((parm)->list.purpose),
     fn, i - is_method),
     converted_args);
  ...
  for (; arg; arg = ((arg)->common.chain))
    converted_args
      = tree_cons ((tree) ((void *)0),
     convert_arg_to_ellipsis (((arg)->list.value)),
     converted_args);

  converted_args = nreverse (converted_args);

  if (warn_format)
    check_function_format (((void *)0), ((((fn)->common.type))->type.attributes),
      converted_args);
  ...
  if (! flag_elide_constructors)
                                  ;
  else if (((convs)->vec.length) == 1
    && ((((fn)->decl.lang_specific)->decl_flags.constructor_attr) && copy_fn_p (fn) > 0))
    {
      tree targ;
      ...
      targ = arg;
      while (((enum tree_code) (targ)->common.code) == NOP_EXPR
      || ((enum tree_code) (targ)->common.code) == NON_LVALUE_EXPR
      || ((enum tree_code) (targ)->common.code) == CONVERT_EXPR)
 ...
 arg = build_indirect_ref (arg, 0);
      ...
      if (((&((((fn)->decl.context))->type.lang_specific)->u.c)->has_complex_init_ref))
 mark_used (fn);
      ...
      if (integer_zerop (((args)->list.value)))
 {
   if (((enum tree_code) (arg)->common.code) == TARGET_EXPR)
     return arg;
   else if ((((&((((fn)->decl.context))->type.lang_specific)->u.c)->h.has_init_ref) && ! ((&((((fn)->decl.context))->type.lang_specific)->u.c)->has_complex_init_ref)))
     return build_target_expr_with_type (arg, ((fn)->decl.context));
 }
      else if (((enum tree_code) (arg)->common.code) == TARGET_EXPR
        || (((&((((fn)->decl.context))->type.lang_specific)->u.c)->h.has_init_ref) && ! ((&((((fn)->decl.context))->type.lang_specific)->u.c)->has_complex_init_ref)))
 {
   tree address;
   tree to = stabilize_reference
     (build_indirect_ref (((args)->list.value), 0));

   val = build (INIT_EXPR, ((fn)->decl.context), to, arg);
   address = build_unary_op (ADDR_EXPR, val, 0);


   ((address)->common.used_flag) = 1;
   return address;
 }
    }
  else if ((((((fn)->decl.name))->common.lang_flag_2) ? ((fn)->decl.lang_specific)->u.f.operator_code : ERROR_MARK) == NOP_EXPR
    && copy_fn_p (fn)
    && (((&((((fn)->decl.context))->type.lang_specific)->u.c)->has_assign_ref) && ! ((&((((fn)->decl.context))->type.lang_specific)->u.c)->has_complex_assign_ref)))
    {
      tree to = stabilize_reference
 (build_indirect_ref (((converted_args)->list.value), 0));

      arg = build_indirect_ref (((((converted_args)->common.chain))->list.value), 0);
      val = build (MODIFY_EXPR, ((to)->common.type), to, arg);
      return val;
    }

  mark_used (fn);

  if (((fn)->decl.vindex) && (flags & (8)) == 0)
    {
      tree t, *p = &((converted_args)->list.value);
      tree binfo = lookup_base (((((*p)->common.type))->common.type),
    ((fn)->decl.context),
    ba_any, ((void *)0));
      (void) (((binfo && binfo != global_trees[TI_ERROR_MARK]) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4680, __FUNCTION__), 0) : 0);

      *p = build_base_path (PLUS_EXPR, *p, binfo, 1);
      if (((*p)->common.side_effects_flag))
 *p = save_expr (*p);
      t = build_pointer_type (((fn)->common.type));
      if (((fn)->decl.context) && ((&((((fn)->decl.context))->type.lang_specific)->u.c)->java_interface))
 fn = build_java_interface_fn_ref (fn, *p);
      else
 fn = build_vfn_ref (build_indirect_ref (*p, 0), ((fn)->decl.vindex));
      ((fn)->common.type) = t;
    }
  else if (((fn)->decl.inline_flag))
...
build_cxx_call(tree fn, tree args, tree converted_args)
{
  ...
  if (((enum tree_code) (fn)->common.code) == ADDR_EXPR
      && ((enum tree_code) (((fn)->exp.operands[0]))->common.code) == FUNCTION_DECL
      && (((((fn)->exp.operands[0]))->decl.built_in_class) != NOT_BUILT_IN))
    {
      tree exp;
      exp = expand_tree_builtin (((fn)->exp.operands[0]), args, converted_args);
      if (exp)
 return exp;
    }
  ...
  if ((!fndecl || !((fndecl)->common.nothrow_flag))
      && at_function_scope_p ()
      && cfun)
  ...
  if (!java_iface_lookup_fn)
    {
      ...
      tree t = tree_cons ((tree) ((void *)0), global_trees[TI_PTR_TYPE],
     tree_cons ((tree) ((void *)0), global_trees[TI_PTR_TYPE],
         tree_cons ((tree) ((void *)0), cp_global_trees[CPTI_JAVA_INT_TYPE],
      endlink)));
      java_iface_lookup_fn
 = builtin_function ("_Jv_LookupInterfaceMethodIdx",
       build_function_type (global_trees[TI_PTR_TYPE], t),
       0, NOT_BUILT_IN, ((void *)0), (tree) ((void *)0));
    }
  ...
  iface = ((fn)->decl.context);
  iface_ref = lookup_field (iface, (__builtin_constant_p ("class$") ? get_identifier_with_length (("class$"), (unsigned) strlen ("class$")) : (get_identifier) ("class$")), 0, 0);
  if (!iface_ref || ((enum tree_code) (iface_ref)->common.code) != VAR_DECL
      || ((iface_ref)->decl.context) != iface)
    {
  ...
  for (method = ((iface)->type.maxval); method; method = ((method)->common.chain))
    {
      if (!((method)->decl.virtual_flag))
        continue;
      if (fn == method)
        break;
      i++;
    }
  idx = build_int_2_wide ((unsigned long long) (i), (long long) (0));

  lookup_args = tree_cons ((tree) ((void *)0), klass_ref,
      tree_cons ((tree) ((void *)0), iface_ref,
          build_tree_list ((tree) ((void *)0), idx)));
  lookup_fn = build1 (ADDR_EXPR,
        build_pointer_type (((java_iface_lookup_fn)->common.type)),
        java_iface_lookup_fn);
  return build (CALL_EXPR, global_trees[TI_PTR_TYPE], lookup_fn, lookup_args, (tree) ((void *)0));
}
...
in_charge_arg_for_name (name)
     tree name;
{
  if (name == cp_global_trees[CPTI_BASE_CTOR_IDENTIFIER]
      || name == cp_global_trees[CPTI_BASE_DTOR_IDENTIFIER])
    return global_trees[TI_INTEGER_ZERO];
  else if (name == cp_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER])
    return global_trees[TI_INTEGER_ONE];
  else if (name == cp_global_trees[CPTI_COMPLETE_DTOR_IDENTIFIER])
    return integer_two_node;
  else if (name == cp_global_trees[CPTI_DELETING_DTOR_IDENTIFIER])
    return integer_three_node;



  fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4832, __FUNCTION__);
  return (tree) ((void *)0);
}
# 4848 "../../../kg++fe/gnu/cp/call.c"
tree
      ...
      tree binfo, int flags)
{
  ...
  (void) (((binfo != (tree) ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4863, __FUNCTION__), 0) : 0);
  ...
  if (name == cp_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER] && !instance)
    {
      instance = build_int_2_wide ((unsigned long long) (0), (long long) (0));
      ((instance)->common.type) = build_pointer_type (class_type);
 ...
 (void) (((args == (tree) ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4879, __FUNCTION__), 0) : 0);
 ...
 instance = convert_to_base_statically (instance, binfo);
  ...
  (void) (((instance != (tree) ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4891, __FUNCTION__), 0) : 0);


  if (!(complete_type_or_diagnostic ((((binfo)->common.type)), ((tree) ((void *)0)), 0)))
    return global_trees[TI_ERROR_MARK];
  ...
  if ((name == cp_global_trees[CPTI_BASE_CTOR_IDENTIFIER]
      ...
      && (((class_type)->common.lang_flag_3)))
    {
      ...
      vtt = build (COND_EXPR, ((vtt)->common.type),
     build (EQ_EXPR, c_global_trees[CTI_BOOLEAN_TYPE],
     (cfun->language)->x_in_charge_parm, global_trees[TI_INTEGER_ZERO]),
     (cfun->language)->x_vtt_parm,
     vtt);
      if (((binfo)->common.static_flag))
 binfo = binfo_for_vbase (class_type, scope_chain->class_type);
      (void) (((((binfo)->vec.a[8])) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4921, __FUNCTION__), 0) : 0);
      sub_vtt = build (PLUS_EXPR, ((vtt)->common.type), vtt,
         ((binfo)->vec.a[8]));

      args = tree_cons ((tree) ((void *)0), sub_vtt, args);
    }

  return build_new_method_call (instance, fns, args,
    ((((binfo)->common.type))->type.binfo),
    flags);
}
         ...
         tree conversion_path, int flags)
{
  ...
  (void) (((instance != (tree) ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4950, __FUNCTION__), 0) : 0);

  if (instance == global_trees[TI_ERROR_MARK] || fns == global_trees[TI_ERROR_MARK]
      || args == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];
 ...
 return call;
  ...
  if (!conversion_path)
    conversion_path = ((((fns))->exp.operands[0]));
  access_binfo = ((((fns))->exp.operands[2]));
  ...
  (void) (((((enum tree_code) (fns)->common.code) == FUNCTION_DECL || ((enum tree_code) (fns)->common.code) == TEMPLATE_DECL || ((enum tree_code) (fns)->common.code) == OVERLOAD) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 4994, __FUNCTION__), 0) : 0);
  ...
  if (! (((enum tree_code) (basetype)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (basetype)->common.code) == TYPENAME_TYPE || ((enum tree_code) (basetype)->common.code) == TYPEOF_TYPE || ((enum tree_code) (basetype)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((basetype)->type.lang_flag_5)))
    {
      if ((flags & (2)) && basetype != global_trees[TI_ERROR_MARK])
 error ("request for member `%D' in `%E', which is of non-aggregate type `%T'",
  ...
  name = ((get_first_fn (fns))->decl.name);

  if (((name)->common.lang_flag_3))
    {


      (void) (((name != cp_global_trees[CPTI_CTOR_IDENTIFIER]) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 5012, __FUNCTION__), 0) : 0);

      (void) (((name != cp_global_trees[CPTI_DTOR_IDENTIFIER]) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 5014, __FUNCTION__), 0) : 0);

      if (name == cp_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER]
   || name == cp_global_trees[CPTI_BASE_CTOR_IDENTIFIER])
 pretty_name = constructor_name (basetype);
      else
 pretty_name = cp_global_trees[CPTI_DTOR_IDENTIFIER];
    }
  else
    pretty_name = name;
  ...
  if (fns)
    ...
    : (tree) ((void *)0));
      ...
      mem_args = tree_cons ((tree) ((void *)0), instance_ptr, args);
      for (fn = fns; fn; fn = ((((enum tree_code) (fn)->common.code) == OVERLOAD) ? ((fn)->common.chain) : (tree) ((void *)0)))
 {
   ...
   if ((flags & (128))
       && (((t)->decl.lang_specific)->decl_flags.nonconverting))
     continue;
 ...
 (cxx_incomplete_type_diagnostic ((instance_ptr), (basetype), 0));
      else
 error ("no matching function for call to `%T::%D(%A)%#V'",
        basetype, pretty_name, user_args,
        ((((instance_ptr)->common.type))->common.type));
      print_z_candidates (candidates);
      return global_trees[TI_ERROR_MARK];
    }
  candidates = splice_viable (candidates);
  ...
  if ((((cand->fn)->decl.lang_specific)->decl_flags.pure_virtual)
      && instance == (cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0))
   ...
   || (((current_function_decl)->decl.lang_specific)->decl_flags.destructor_attr))
      && ! (flags & (8))
      && value_member (cand->fn, ((&((basetype)->type.lang_specific)->u.c)->pure_virtuals)))
    error (((((current_function_decl)->decl.lang_specific)->decl_flags.constructor_attr) ?
        "abstract virtual `%#D' called from constructor"
        : "abstract virtual `%#D' called from destructor"),
       cand->fn);
  if (((enum tree_code) (((cand->fn)->common.type))->common.code) == METHOD_TYPE
  ...
  if (((cand->fn)->decl.vindex) && ! (flags & (8))
  ...
  if (((enum tree_code) (((cand->fn)->common.type))->common.code) == METHOD_TYPE)
  ...
  else
    {
      ...
      if (instance && ((instance)->common.side_effects_flag))
 call = build (COMPOUND_EXPR, ((call)->common.type), instance, call);
    }
     ...
     tree ics1, ics2;
{
  ...
  while (((enum tree_code) (ics1)->common.code) == RVALUE_CONV
  || ((enum tree_code) (ics1)->common.code) == LVALUE_CONV)
    ics1 = ((ics1)->exp.operands[0]);

  while (1)
    {
      while (((enum tree_code) (ics2)->common.code) == RVALUE_CONV
   || ((enum tree_code) (ics2)->common.code) == LVALUE_CONV)
 ics2 = ((ics2)->exp.operands[0]);

      if (((enum tree_code) (ics2)->common.code) == USER_CONV
   || ((enum tree_code) (ics2)->common.code) == AMBIG_CONV
   || ((enum tree_code) (ics2)->common.code) == IDENTITY_CONV)
 ...
 return 0;
      ...
      if (((enum tree_code) (ics2)->common.code) == ((enum tree_code) (ics1)->common.code)
   && comptypes ((((ics2)->common.type)), (((ics1)->common.type)), 0)
   && comptypes ((((((ics2)->exp.operands[0]))->common.type)), (((((ics1)->exp.operands[0]))->common.type)), 0))
...
is_properly_derived_from (derived, base)
     ...
     tree base;
{
  if (!((((enum tree_code) (derived)->common.code)) == RECORD_TYPE || (((enum tree_code) (derived)->common.code)) == UNION_TYPE)
      || !((((enum tree_code) (base)->common.code)) == RECORD_TYPE || (((enum tree_code) (base)->common.code)) == UNION_TYPE))
    return 0;



  return (!comptypes ((((derived)->type.main_variant)), (((base)->type.main_variant)), 0)
   && (lookup_base ((derived), base, ba_any, ((void *)0)) != (tree) ((void *)0)));
}
  ...
  if (((*ics)->common.lang_flag_2))
    {
      ...
      reference_type = ((((*ics)->common.type))->common.type);
      reference_type = build_reference_type (reference_type);

      if (((enum tree_code) (t)->common.code) == QUAL_CONV)
 t = ((t)->exp.operands[0]);
      if (((enum tree_code) (t)->common.code) == PTR_CONV)
 t = ((t)->exp.operands[0]);
      t = build1 (IDENTITY_CONV, ((((t)->common.type))->common.type), (tree) ((void *)0));
...
maybe_handle_ref_bind (ics)
     tree* ics;
{
  if (((enum tree_code) (*ics)->common.code) == REF_BIND)
    {
      tree old_ics = *ics;
      tree type = ((((old_ics)->common.type))->common.type);
      *ics = ((old_ics)->exp.operands[0]);
      ((*ics)->common.lang_flag_0) = ((old_ics)->common.lang_flag_0);
      ((*ics)->common.lang_flag_3) = ((old_ics)->common.lang_flag_3);
      return type;
    }

  return (tree) ((void *)0);
}
# 5252 "../../../kg++fe/gnu/cp/call.c"
static int
...
# 5292 "../../../kg++fe/gnu/cp/call.c"
  rank1 = (((ics1)->common.lang_flag_3) ? 7 : ((ics1)->common.lang_flag_1) ? 6 : ((ics1)->common.lang_flag_0) ? 5 : ((ics1)->exp.complexity));
  rank2 = (((ics2)->common.lang_flag_3) ? 7 : ((ics2)->common.lang_flag_1) ? 6 : ((ics2)->common.lang_flag_0) ? 5 : ((ics2)->exp.complexity));
  ...
  if (rank1 == 7)
    {
      ...
      if (((ics1)->common.lang_flag_0) > ((ics2)->common.lang_flag_0)
   || ((ics1)->exp.complexity) > ((ics2)->exp.complexity))
 return -1;
      else if (((ics1)->common.lang_flag_0) < ((ics2)->common.lang_flag_0)
        || ((ics1)->exp.complexity) < ((ics2)->exp.complexity))
 return 1;
  ...
  if (((ics1)->common.lang_flag_0))
    {
      tree t1, t2;

      for (t1 = ics1; ((enum tree_code) (t1)->common.code) != USER_CONV; t1 = ((t1)->exp.operands[0]))
 if (((enum tree_code) (t1)->common.code) == AMBIG_CONV)
   return 0;
      for (t2 = ics2; ((enum tree_code) (t2)->common.code) != USER_CONV; t2 = ((t2)->exp.operands[0]))
 if (((enum tree_code) (t2)->common.code) == AMBIG_CONV)
   return 0;

      if (((((struct tree_wrapper*)(((t1)->exp.operands[1])))->z_c)->fn) != ((((struct tree_wrapper*)(((t2)->exp.operands[1])))->z_c)->fn))
 return 0;



      from_type1 = ((t1)->common.type);
      from_type2 = ((t2)->common.type);
    }
  else
    {
# 5359 "../../../kg++fe/gnu/cp/call.c"
      from_type1 = ics1;
      while (((enum tree_code) (from_type1)->common.code) != IDENTITY_CONV)
 from_type1 = ((from_type1)->exp.operands[0]);
      from_type1 = ((from_type1)->common.type);

      from_type2 = ics2;
      while (((enum tree_code) (from_type2)->common.code) != IDENTITY_CONV)
 from_type2 = ((from_type2)->exp.operands[0]);
      from_type2 = ((from_type2)->common.type);
    }
...
# 5402 "../../../kg++fe/gnu/cp/call.c"
  if (((ics1)->exp.complexity) < ((ics2)->exp.complexity))
    return 1;
  else if (((ics2)->exp.complexity) < ((ics1)->exp.complexity))
    return -1;

  to_type1 = ((ics1)->common.type);
  to_type2 = ((ics2)->common.type);

  if ((((enum tree_code) (from_type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((from_type1)->common.type))->common.code) != OFFSET_TYPE)
      && (((enum tree_code) (from_type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((from_type2)->common.type))->common.code) != OFFSET_TYPE)
      && (((enum tree_code) (to_type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((to_type1)->common.type))->common.code) != OFFSET_TYPE)
      && (((enum tree_code) (to_type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((to_type2)->common.type))->common.code) != OFFSET_TYPE))
    {
      deref_from_type1 = ((from_type1)->common.type);
      deref_from_type2 = ((from_type2)->common.type);
      deref_to_type1 = ((to_type1)->common.type);
      deref_to_type2 = ((to_type2)->common.type);
    }




  else if ((((enum tree_code) (from_type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((from_type1)->common.type))->common.code) == OFFSET_TYPE)
    && (((enum tree_code) (from_type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((from_type2)->common.type))->common.code) == OFFSET_TYPE)
    && (((enum tree_code) (to_type1)->common.code) == POINTER_TYPE && ((enum tree_code) (((to_type1)->common.type))->common.code) == OFFSET_TYPE)
    && (((enum tree_code) (to_type2)->common.code) == POINTER_TYPE && ((enum tree_code) (((to_type2)->common.type))->common.code) == OFFSET_TYPE))
    {
      deref_to_type1 = ((((from_type1)->common.type))->type.maxval);
      deref_to_type2 = ((((from_type2)->common.type))->type.maxval);
      deref_from_type1 = ((((to_type1)->common.type))->type.maxval);
      deref_from_type2 = ((((to_type2)->common.type))->type.maxval);
    }
  else if ((((enum tree_code) (from_type1)->common.code) == RECORD_TYPE && ((from_type1)->type.lang_specific) && ((&((from_type1)->type.lang_specific)->u.c)->ptrmemfunc_flag))
    && (((enum tree_code) (from_type2)->common.code) == RECORD_TYPE && ((from_type2)->type.lang_specific) && ((&((from_type2)->type.lang_specific)->u.c)->ptrmemfunc_flag))
    && (((enum tree_code) (to_type1)->common.code) == RECORD_TYPE && ((to_type1)->type.lang_specific) && ((&((to_type1)->type.lang_specific)->u.c)->ptrmemfunc_flag))
    && (((enum tree_code) (to_type2)->common.code) == RECORD_TYPE && ((to_type2)->type.lang_specific) && ((&((to_type2)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    {
      deref_to_type1 = (((((((((from_type1)->type.values))->common.type)))->common.type))->type.maxval);
      deref_to_type2 = (((((((((from_type2)->type.values))->common.type)))->common.type))->type.maxval);
      deref_from_type1 = (((((((((to_type1)->type.values))->common.type)))->common.type))->type.maxval);
      deref_from_type2 = (((((((((to_type2)->type.values))->common.type)))->common.type))->type.maxval);
    }

  if (deref_from_type1 != (tree) ((void *)0)
      && ((((enum tree_code) (deref_from_type1)->common.code)) == RECORD_TYPE || (((enum tree_code) (deref_from_type1)->common.code)) == UNION_TYPE)
      && ((((enum tree_code) (deref_from_type2)->common.code)) == RECORD_TYPE || (((enum tree_code) (deref_from_type2)->common.code)) == UNION_TYPE))
    {
# 5457 "../../../kg++fe/gnu/cp/call.c"
      if (((enum tree_code) (deref_to_type1)->common.code) == VOID_TYPE
   && ((enum tree_code) (deref_to_type2)->common.code) == VOID_TYPE)
 {
   if (is_properly_derived_from (deref_from_type1,
     ...
     return 1;
      ...
      else if (((enum tree_code) (deref_to_type1)->common.code) == VOID_TYPE
        || ((enum tree_code) (deref_to_type2)->common.code) == VOID_TYPE)
 {
  ...
  return -1;
      ...
      else if (((((enum tree_code) (deref_to_type1)->common.code)) == RECORD_TYPE || (((enum tree_code) (deref_to_type1)->common.code)) == UNION_TYPE)
        && ((((enum tree_code) (deref_to_type2)->common.code)) == RECORD_TYPE || (((enum tree_code) (deref_to_type2)->common.code)) == UNION_TYPE))
 {
# 5497 "../../../kg++fe/gnu/cp/call.c"
   if (comptypes ((deref_from_type1), (deref_from_type2), 0))
     {
  ...
  return -1;
   ...
   else if (comptypes ((deref_to_type1), (deref_to_type2), 0))
     {
  ...
  else if ((((((enum tree_code) (non_reference (from_type1))->common.code)) == RECORD_TYPE || (((enum tree_code) (non_reference (from_type1))->common.code)) == UNION_TYPE) && (((enum tree_code) (non_reference (from_type1))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (non_reference (from_type1))->common.code) == TYPENAME_TYPE || ((enum tree_code) (non_reference (from_type1))->common.code) == TYPEOF_TYPE || ((enum tree_code) (non_reference (from_type1))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((non_reference (from_type1))->type.lang_flag_5)))
    && comptypes ((from_type1), (from_type2), 0))
    {
      tree from = non_reference (from_type1);
# 5529 "../../../kg++fe/gnu/cp/call.c"
   ...
   && is_properly_derived_from (from, to_type2))
 {
  ...
  else if ((((((enum tree_code) (non_reference (to_type1))->common.code)) == RECORD_TYPE || (((enum tree_code) (non_reference (to_type1))->common.code)) == UNION_TYPE) && (((enum tree_code) (non_reference (to_type1))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (non_reference (to_type1))->common.code) == TYPENAME_TYPE || ((enum tree_code) (non_reference (to_type1))->common.code) == TYPEOF_TYPE || ((enum tree_code) (non_reference (to_type1))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((non_reference (to_type1))->type.lang_flag_5)))
    && comptypes ((to_type1), (to_type2), 0))
    {
      tree to = non_reference (to_type1);
# 5550 "../../../kg++fe/gnu/cp/call.c"
   ...
   && is_properly_derived_from (from_type2, to))
 {
  ...
  if (((enum tree_code) (ics1)->common.code) == QUAL_CONV
      && ((enum tree_code) (ics2)->common.code) == QUAL_CONV
      && comptypes ((from_type1), (from_type2), 0))
    return comp_cv_qual_signature (to_type1, to_type2);
# 5579 "../../../kg++fe/gnu/cp/call.c"
  if (target_type1 && target_type2
      && comptypes ((((to_type1)->type.main_variant)), (((to_type2)->type.main_variant)), 0))
...
source_type (t)
     tree t;
{
  for (;; t = ((t)->exp.operands[0]))
    {
      if (((enum tree_code) (t)->common.code) == USER_CONV
   || ((enum tree_code) (t)->common.code) == AMBIG_CONV
   || ((enum tree_code) (t)->common.code) == IDENTITY_CONV)
 return ((t)->common.type);
    }
  fancy_abort ("../../../kg++fe/gnu/cp/call.c", 5600, __FUNCTION__);
}
...
{
  winner->warnings = tree_cons ((tree) ((void *)0),
    build_zc_wrapper (loser),
    winner->warnings);
}
# 5623 "../../../kg++fe/gnu/cp/call.c"
static int
     ...
     int warn;
{
  ...
  if (cand1->fn == cand2->fn
      && ((tree_code_type[(int) (((enum tree_code) (cand1->fn)->common.code))] == 't') || (tree_code_type[(int) (((enum tree_code) (cand1->fn)->common.code))] == 'd')))
    return 1;
# 5656 "../../../kg++fe/gnu/cp/call.c"
  len = ((cand1->convs)->vec.length);
  if (len != ((cand2->convs)->vec.length))
    {
      if ((((cand1->fn)->decl.lang_specific)->decl_flags.static_function)
   && ! (((cand2->fn)->decl.lang_specific)->decl_flags.static_function))
 off2 = 1;
      else if (! (((cand1->fn)->decl.lang_specific)->decl_flags.static_function)
        && (((cand2->fn)->decl.lang_specific)->decl_flags.static_function))
 {
   off1 = 1;
   --len;
 ...
 fancy_abort ("../../../kg++fe/gnu/cp/call.c", 5669, __FUNCTION__);
    }

  for (i = 0; i < len; ++i)
    {
      tree t1 = ((cand1->convs)->vec.a[i+off1]);
      tree t2 = ((cand2->convs)->vec.a[i+off2]);
      int comp = compare_ics (t1, t2);

      if (comp != 0)
 {
   if (warn_sign_promo
       && (((t1)->common.lang_flag_3) ? 7 : ((t1)->common.lang_flag_1) ? 6 : ((t1)->common.lang_flag_0) ? 5 : ((t1)->exp.complexity)) + (((t2)->common.lang_flag_3) ? 7 : ((t2)->common.lang_flag_1) ? 6 : ((t2)->common.lang_flag_0) ? 5 : ((t2)->exp.complexity)) == 3 + 2
       && ((enum tree_code) (t1)->common.code) == STD_CONV
       && ((enum tree_code) (t2)->common.code) == STD_CONV
       && ((enum tree_code) (((t1)->common.type))->common.code) == INTEGER_TYPE
       && ((enum tree_code) (((t2)->common.type))->common.code) == INTEGER_TYPE
       && (((((t1)->common.type))->type.precision)
    == ((((t2)->common.type))->type.precision))
       && (((((((t1)->exp.operands[0]))->common.type))->common.unsigned_flag)
    || (((enum tree_code) (((((t1)->exp.operands[0]))->common.type))->common.code)
        == ENUMERAL_TYPE)))
     {
       tree type = ((((t1)->exp.operands[0]))->common.type);
       tree type1, type2;
       struct z_candidate *w, *l;
       if (comp > 0)
  type1 = ((t1)->common.type), type2 = ((t2)->common.type),
    w = cand1, l = cand2;
       else
  type1 = ((t2)->common.type), type2 = ((t1)->common.type),
    w = cand2, l = cand1;
  ...
  if (winner && cand1->second_conv
      && (((((cand1->fn)->decl.lang_specific)->decl_flags.constructor_attr)
    != (((cand2->fn)->decl.lang_specific)->decl_flags.constructor_attr))

   || (! (((cand1->fn)->decl.lang_specific)->decl_flags.constructor_attr)
       && ! comptypes ((((((cand1->fn)->common.type))->common.type)), (((((cand2->fn)->common.type))->common.type)), 0))))
      ...
      if (comp != winner)
 {
   ...
   if (winner == 1)
     ...
     w = cand2, l = cand1;
   if (((cand1->fn)->decl.context) == ((cand2->fn)->decl.context)
       && ! (((cand1->fn)->decl.lang_specific)->decl_flags.constructor_attr)
       && ! (((cand2->fn)->decl.lang_specific)->decl_flags.constructor_attr)
       && (convn = standard_conversion
    (((((l->fn)->common.type))->common.type),
     ((((w->fn)->common.type))->common.type), (tree) ((void *)0)))
       && ((enum tree_code) (convn)->common.code) == QUAL_CONV)

                                            ;
   else if (warn && warn_conversion)
     {
       tree source = source_type (((w->convs)->vec.a[0]));
       if (! (((w->fn)->decl.lang_specific)->decl_flags.constructor_attr))
  source = ((source)->common.type);
       warning ("choosing `%D' over `%D'", w->fn, l->fn);
       warning ("  for conversion from `%T' to `%T'",
     source, ((w->second_conv)->common.type));
  ...
  if (cand1->template && cand2->template)
    {
      winner = more_specialized
        ((((cand1->template)->list.purpose)), (((cand2->template)->list.purpose)),
         DEDUCE_ORDER,
# 5795 "../../../kg++fe/gnu/cp/call.c"
         ((cand1->convs)->vec.length)
  - ((((enum tree_code) (((cand1->fn)->common.type))->common.code) == METHOD_TYPE)
     - (((cand1->fn)->decl.lang_specific)->decl_flags.constructor_attr)));

      if (winner)
        return winner;
    }
# 5811 "../../../kg++fe/gnu/cp/call.c"
...
# 5829 "../../../kg++fe/gnu/cp/call.c"
  if (((enum tree_code) (cand1->fn)->common.code) == IDENTIFIER_NODE
      || ((enum tree_code) (cand2->fn)->common.code) == IDENTIFIER_NODE)
    {
      for (i = 0; i < len; ++i)
 if (!comptypes ((((((cand1->convs)->vec.a[i]))->common.type)), (((((cand2->convs)->vec.a[i]))->common.type)), 0))

   break;
      if (i == ((cand1->convs)->vec.length))
 {
   if (cand1->fn == cand2->fn)

     return 1;
   else if (((enum tree_code) (cand1->fn)->common.code) == IDENTIFIER_NODE)
  ...
  if ((tree_code_type[(int) (((enum tree_code) (cand1->fn)->common.code))] == 'd') && (tree_code_type[(int) (((enum tree_code) (cand2->fn)->common.code))] == 'd')
...
tweak:
  ...
  if (!pedantic)
    {
      ...
      for (i = 0; i < len; ++i)
 {
   if ((((((cand1->convs)->vec.a[i+off1]))->common.lang_flag_3) ? 7 : ((((cand1->convs)->vec.a[i+off1]))->common.lang_flag_1) ? 6 : ((((cand1->convs)->vec.a[i+off1]))->common.lang_flag_0) ? 5 : ((((cand1->convs)->vec.a[i+off1]))->exp.complexity)) > rank1)
     rank1 = (((((cand1->convs)->vec.a[i+off1]))->common.lang_flag_3) ? 7 : ((((cand1->convs)->vec.a[i+off1]))->common.lang_flag_1) ? 6 : ((((cand1->convs)->vec.a[i+off1]))->common.lang_flag_0) ? 5 : ((((cand1->convs)->vec.a[i+off1]))->exp.complexity));
   if ((((((cand2->convs)->vec.a[i+off2]))->common.lang_flag_3) ? 7 : ((((cand2->convs)->vec.a[i+off2]))->common.lang_flag_1) ? 6 : ((((cand2->convs)->vec.a[i+off2]))->common.lang_flag_0) ? 5 : ((((cand2->convs)->vec.a[i+off2]))->exp.complexity)) > rank2)
     rank2 = (((((cand2->convs)->vec.a[i+off2]))->common.lang_flag_3) ? 7 : ((((cand2->convs)->vec.a[i+off2]))->common.lang_flag_1) ? 6 : ((((cand2->convs)->vec.a[i+off2]))->common.lang_flag_0) ? 5 : ((((cand2->convs)->vec.a[i+off2]))->exp.complexity));
 }
      if (rank1 < rank2)
 ...
 winner = -1, w = cand2, l = cand1;
      if (winner)
        {
   if (warn)
     pedwarn ("ISO C++ says that `%D' and `%D' are ambiguous even though the worst conversion for the former is better than the worst conversion for the latter", w->fn, l->fn);
  ...
  (void) (((!winner) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 5888, __FUNCTION__), 0) : 0);
  return 0;
}
...
can_convert (to, from)
     tree to, from;
{
  return can_convert_arg (to, from, (tree) ((void *)0));
}
...
can_convert_arg (to, from, arg)
     tree to, from, arg;
{
  tree t = implicit_conversion (to, from, arg, (3));
  return (t && ! ((t)->common.lang_flag_3));
}
     ...
     tree expr;
{
  ...
  if (expr == global_trees[TI_ERROR_MARK])
    return global_trees[TI_ERROR_MARK];
  conv = implicit_conversion (type, ((expr)->common.type), expr,
         (3));
  if (!conv)
    {
  ...
  return convert_like_real ((conv), (expr), (tree) ((void *)0), 0, 0, 1);
}
...
# 6023 "../../../kg++fe/gnu/cp/call.c"
  ...
  conv = implicit_conversion (type, ((expr)->common.type), expr,
         (3));
  if (!conv || ((conv)->common.lang_flag_3))
    return (tree) ((void *)0);
  return convert_like_real (conv, expr, (tree) ((void *)0), 0, 0,
                                     0);
}
...
make_temporary_var_for_ref_to_temp (tree decl, tree type)
{
  ...
  var = build_decl (VAR_DECL, (tree) ((void *)0), type);
  ((var)->decl.artificial_flag) = 1;
  ((var)->common.used_flag) = 1;
  ...
  if (((decl)->common.static_flag))
  ...
  else
    {
      ...
      ((var)->decl.context) = current_function_decl;
    }

  return var;
}
# 6088 "../../../kg++fe/gnu/cp/call.c"
tree
     ...
     tree *cleanup;
{
  ...
  conv = reference_binding (type, ((expr)->common.type), expr, (3));
  if (!conv || ((conv)->common.lang_flag_3))
    {
      if (!(((((((type)->common.type))->common.readonly_flag) * 0x1) | (((((type)->common.type))->common.volatile_flag) * 0x2) | (((((type)->common.type))->type.restrict_flag) * 0x4) | ((((enum tree_code) (((type)->common.type))->common.code) == RECORD_TYPE && ((((type)->common.type))->common.type)) * 0x8)) & 0x1)
          && !real_lvalue_p (expr))
...
# 6147 "../../../kg++fe/gnu/cp/call.c"
  (void) (((((enum tree_code) (conv)->common.code) == REF_BIND) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/call.c", 6147, __FUNCTION__), 0) : 0);
  if (decl)
    {
      tree var;
      tree base_conv_type;
      ...
      if (((enum tree_code) (conv)->common.code) == BASE_CONV && !((conv)->common.lang_flag_4))
 {
   base_conv_type = ((conv)->common.type);
   conv = ((conv)->exp.operands[0]);
 }
      else
 base_conv_type = (tree) ((void *)0);

      expr = convert_like_real ((conv), (expr), (tree) ((void *)0), 0, 0, 1);
   ...
   if (at_function_scope_p ())
     {
       ...
       *cleanup = cxx_maybe_build_cleanup (var);
       if (*cleanup)
# 6201 "../../../kg++fe/gnu/cp/call.c"
  *cleanup = build_stmt (CLEANUP_STMT, var, *cleanup);
     }
   else
     {
       rest_of_decl_compilation (var, ((void *)0), 1, at_eof);
       if ((((type)->type.lang_flag_4)))
  static_aggregates = tree_cons ((tree) ((void *)0), var,
            static_aggregates);
     }

   expr = build_address (var);
   expr = build (COMPOUND_EXPR, ((expr)->common.type), init, expr);
 }
      else
...
# 1 "../../../kg++fe/gnu/MIPS/gt-cp-call.h" 1
# 23 "../../../kg++fe/gnu/MIPS/gt-cp-call.h"
void
      ...
      void *x_p;
{
  ...
  if (((x) != ((void *)0) && ((void *) (x)) != (void *) 1 && ! ggc_set_mark (x)))
    {
      do { if ((*x).fn != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).fn); } while (0);
      do { if ((*x).convs != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).convs); } while (0);
      do { if ((*x).second_conv != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).second_conv); } while (0);
      do { if ((*x).access_path != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).access_path); } while (0);
      do { if ((*x).conversion_path != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).conversion_path); } while (0);
      do { if ((*x).template != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).template); } while (0);
      do { if ((*x).warnings != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).warnings); } while (0);
      do { if ((*x).next != ((void *)0)) gt_ggc_mx_z_candidate ((*x).next); } while (0);
  }
}
