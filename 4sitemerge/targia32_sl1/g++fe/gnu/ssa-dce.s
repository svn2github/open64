...
.LFE15:
	...
	.size	__FUNCTION__.9430, 44
__FUNCTION__.9430:
	.string	"set_control_dependent_block_to_edge_map_bit"
.LC0:
	.string	"../../../kg++fe/gnu/ssa-dce.c"
	.text
...
.LCFI8:
	...
	jl	.L7
	.loc 1 185 0
	leal	__FUNCTION__.9430@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$185, 4(%esp)
...
.LCFI19:
	...
	jne	.L23
	.loc 1 247 0
	leal	__FUNCTION__.9495@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$247, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE19:
	...
	.section	.rodata
	.type	__FUNCTION__.9541, @object
	.size	__FUNCTION__.9541, 10
__FUNCTION__.9541:
	.string	"find_pdom"
	.text
...
.LCFI23:
	...
	jne	.L34
	.loc 1 273 0
	leal	__FUNCTION__.9541@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$273, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LBE3:
	.loc 1 404 0
	leal	__FUNCTION__.9619@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$404, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE27:
	...
	.section	.rodata
	.type	__FUNCTION__.9720, @object
	.size	__FUNCTION__.9720, 15
__FUNCTION__.9720:
...
.LCFI54:
	...
	jne	.L122
	.loc 1 478 0
	leal	__FUNCTION__.9720@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$478, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE28:
	...
	.section	.rodata
	.type	__FUNCTION__.9821, @object
	.size	__FUNCTION__.9821, 24
__FUNCTION__.9821:
...
.L235:
	...
	je	.L238
	.loc 1 729 0
	leal	__FUNCTION__.9821@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$729, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
