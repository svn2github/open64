...
# 47 "../../../kg++fe/gnu/stmt.c" 2
# 1 "../../../kg++fe/gnu/except.h" 1
# 33 "../../../kg++fe/gnu/except.h"
...
# 49 "../../../kg++fe/gnu/stmt.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 50 "../../../kg++fe/gnu/stmt.c" 2
...
# 24 "../../../kg++fe/gnu/loop.h" 2

# 1 "../../../kg++fe/gnu/basic-block.h" 1
# 27 "../../../kg++fe/gnu/basic-block.h"
...
# 55 "../../../kg++fe/gnu/stmt.c" 2
# 1 "../../../kg++fe/gnu/machmode.h" 1
# 56 "../../../kg++fe/gnu/stmt.c" 2
...
# 61 "../../../kg++fe/gnu/stmt.c" 2


# 1 "../../../kg++fe/gnu/defaults.h" 1
# 64 "../../../kg++fe/gnu/stmt.c" 2
# 95 "../../../kg++fe/gnu/stmt.c"
struct case_node
{
     ...
     tree label;
{
  if (((enum tree_code) (label)->common.code) != LABEL_DECL)
    fancy_abort ("../../../kg++fe/gnu/stmt.c", 517, __FUNCTION__);
     ...
     rtx last_insn;
{
  ...
  if (((enum rtx_code) (label)->code) != CODE_LABEL)
    fancy_abort ("../../../kg++fe/gnu/stmt.c", 728, __FUNCTION__);
  ...
  for (i = 0, tail = outputs; tail; tail = ((tail)->common.chain), i++)
    {
      ...
      if (!parse_output_constraint (&constraints[i], i, ninputs,
        ...
        &is_inout))
 fancy_abort ("../../../kg++fe/gnu/stmt.c", 1634, __FUNCTION__);
  ...
  for (i = 0, tail = inputs; tail; tail = ((tail)->common.chain), ++i)
    {
      ...
      if (! parse_input_constraint (&constraint, i, ninputs, noutputs, ninout,
        constraints, &allows_mem, &allows_reg))
 fancy_abort ("../../../kg++fe/gnu/stmt.c", 1715, __FUNCTION__);
     ...
     tree outputs, inputs;
{
 ...
 found:
  ...
  if (p > q)
    fancy_abort ("../../../kg++fe/gnu/stmt.c", 2129, __FUNCTION__);
 ...
 if ((((etc_note)->fld[5]).rtint) == NOTE_INSN_LOOP_END_TOP_COND)
 ...
 else if ((((etc_note)->fld[5]).rtint) == NOTE_INSN_EH_REGION_END)
   {
     if (--eh_regions < 0)
       ...
       fancy_abort ("../../../kg++fe/gnu/stmt.c", 2681, __FUNCTION__);
   }
...
# 3126 "../../../kg++fe/gnu/stmt.c"
 ...
 if ((mode_size[(int) (tmpmode)]) >= bytes)
   break;
      ...
      if (tmpmode == VOIDmode)
 fancy_abort ("../../../kg++fe/gnu/stmt.c", 3206, __FUNCTION__);
     ...
     tree block;
{
  ...
  if (!block_flag && block)
    fancy_abort ("../../../kg++fe/gnu/stmt.c", 3409, __FUNCTION__);
     ...
     tree decl;
{
      ...
      if (((decl)->decl.rtl != ((void *)0)))
 {
   if (((enum rtx_code) (((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->code) != MEM
     ...
     fancy_abort ("../../../kg++fe/gnu/stmt.c", 3984, __FUNCTION__);
     ...
     tree decl, cleanup, decl_elts;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/stmt.c", 4277, __FUNCTION__);
...
# 5304 "../../../kg++fe/gnu/stmt.c"
      ...
      for (n = thiscase->data.case_stmt.case_list; n; n = n->right)
 {
   ...
   if (((enum tree_code) (n->low)->common.code) != INTEGER_CST)
     fancy_abort ("../../../kg++fe/gnu/stmt.c", 5350, __FUNCTION__);
   if (((enum tree_code) (n->high)->common.code) != INTEGER_CST)
     fancy_abort ("../../../kg++fe/gnu/stmt.c", 5352, __FUNCTION__);
      ...
      else
 {
    ...
    && compare_tree_int (minval, 3) < 0)
  {
    ...
    range = maxval;
       ...
       table_label, default_label))
  fancy_abort ("../../../kg++fe/gnu/stmt.c", 5504, __FUNCTION__);
     }
...
# 5554 "../../../kg++fe/gnu/stmt.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/stmt.c", 5561, __FUNCTION__);
...
# 1 "../../../kg++fe/gnu/MIPS/gt-stmt.h" 1
# 23 "../../../kg++fe/gnu/MIPS/gt-stmt.h"
void
