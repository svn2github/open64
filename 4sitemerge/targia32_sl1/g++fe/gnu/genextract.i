...
# 27 "../../../kg++fe/gnu/genextract.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 28 "../../../kg++fe/gnu/genextract.c" 2
...
# 29 "../../../kg++fe/gnu/genextract.c" 2
# 41 "../../../kg++fe/gnu/genextract.c"
struct extraction
{
  int op_count;
  char *oplocs[30];
...
static char *duplocs[2];



static int dupnums[2];
     ...
     const char *path;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/genextract.c", 331, __FUNCTION__);
    }
 ...
 fancy_abort ("../../../kg++fe/gnu/genextract.c", 343, __FUNCTION__);
    }
}
