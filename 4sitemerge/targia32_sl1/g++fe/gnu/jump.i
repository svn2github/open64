...
# 44 "../../../kg++fe/gnu/jump.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 45 "../../../kg++fe/gnu/jump.c" 2
...
# 338 "../../../kg++fe/gnu/jump.c"
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/jump.c", 498, __FUNCTION__);
 }
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/jump.c", 831, __FUNCTION__);
    }
}
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/jump.c", 875, __FUNCTION__);
    }
}
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/jump.c", 922, __FUNCTION__);
    }
}
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/jump.c", 954, __FUNCTION__);
    }
}
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/jump.c", 984, __FUNCTION__);
    }
}
     ...
     int in_mem;
{
 ...
 if (((enum rtx_code) (label)->code) != CODE_LABEL)
   fancy_abort ("../../../kg++fe/gnu/jump.c", 1469, __FUNCTION__);
...
{
  if (((enum rtx_code) (insn)->code) != BARRIER)
    fancy_abort ("../../../kg++fe/gnu/jump.c", 1549, __FUNCTION__);
...
# 1686 "../../../kg++fe/gnu/jump.c"
static void
delete_computation (insn)
     rtx insn;
{
  rtx note, next;
# 1716 "../../../kg++fe/gnu/jump.c"
  for (note = (((insn)->fld[8]).rtx); note; note = next)
    {
      next = (((note)->fld[1]).rtx);
     ...
     rtx insn;
{
  ...
  if (!x)
    fancy_abort ("../../../kg++fe/gnu/jump.c", 2140, __FUNCTION__);
  x = (((x)->fld[1]).rtx);
      ...
      if (reversed_code != UNKNOWN)
 {
   ...
   return;
    ...
    fancy_abort ("../../../kg++fe/gnu/jump.c", 2173, __FUNCTION__);
}
     ...
     int delete_unused;
{
  ...
  if (! invert_exp (jump))
    ...
    fancy_abort ("../../../kg++fe/gnu/jump.c", 2236, __FUNCTION__);

  return 0;
}
# 2255 "../../../kg++fe/gnu/jump.c"
int
     ...
     rtx x, y;
{
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/jump.c", 2434, __FUNCTION__);
 }
    }
  return 1;
}
     ...
     rtx reg;
{
  ...
  fancy_abort ("../../../kg++fe/gnu/jump.c", 2475, __FUNCTION__);
}
