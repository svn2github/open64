...
# 71 "../../../kg++fe/gnu/local-alloc.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 72 "../../../kg++fe/gnu/local-alloc.c" 2
      ...
      for (insn = bb->end; insn != (((bb->head)->fld[1]).rtx); insn = (((insn)->fld[1]).rtx))
 {
    ...
    && reg_mentioned_p ((((link)->fld[0]).rtx), (((insn)->fld[5]).rtx)))
  {
    ...
    if (reg_equiv[regno].init_insns == (rtx) 0
      ...
      fancy_abort ("../../../kg++fe/gnu/local-alloc.c", 1070, __FUNCTION__);
     ...
     int b;
{
 ...
 if (++insn_count > max_uid)
   fancy_abort ("../../../kg++fe/gnu/local-alloc.c", 1232, __FUNCTION__);
     ...
     int born_index, dead_index;
{
  ...
  if (born_index < 0 || born_index > dead_index)
    fancy_abort ("../../../kg++fe/gnu/local-alloc.c", 2182, __FUNCTION__);
