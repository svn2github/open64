...
# 30 "../../../kg++fe/gnu/optabs.c" 2



# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 34 "../../../kg++fe/gnu/optabs.c" 2
# 1 "../../../kg++fe/gnu/rtl.h" 1
# 25 "../../../kg++fe/gnu/rtl.h"
struct function;
...
# 48 "../../../kg++fe/gnu/optabs.c" 2
# 58 "../../../kg++fe/gnu/optabs.c"
     ...
     rtx op0, op1;
{
  ...
  if (! insns
    ...
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 162, __FUNCTION__);
     ...
     enum optab_methods methods;
{
  ...
  if (binop == 0)
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 663, __FUNCTION__);

  return expand_binop (mode, binop, op0, op1, target, unsignedp, methods);
}
# 679 "../../../kg++fe/gnu/optabs.c"
rtx
...
# 1538 "../../../kg++fe/gnu/optabs.c"
  if (class == MODE_COMPLEX_FLOAT || class == MODE_COMPLEX_INT)
    {
      ...
      if (submode == BLKmode)
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 1551, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 1578, __FUNCTION__);
 ...
 case DIV:
  ...
  default:
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 1752, __FUNCTION__);
  }
     }
   break;

 default:
   fancy_abort ("../../../kg++fe/gnu/optabs.c", 1758, __FUNCTION__);
 }
      ...
      for (i = 0; i < elts; ++i)
 {
  ...
  res = expand_divmod (0, TRUNC_DIV_EXPR, submode,
   ...
   if (t)
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/optabs.c", 2012, __FUNCTION__);
    }
     ...
     int unsignedp;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 2275, __FUNCTION__);
     ...
     int unsignedp;
{
  ...
  if (unop == 0)
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 2332, __FUNCTION__);

  return expand_unop (mode, unop, op0, target, unsignedp);
}
# 2348 "../../../kg++fe/gnu/optabs.c"
rtx
      ...
      for (i = 0; i < (mode_bitsize[(int) (mode)]) / (8 * ((target_flags & 0x00002000) ? 8 : 4)); i++)
 {
   ...
   if (target_piece != x)
    ...
    && (class == MODE_COMPLEX_FLOAT || class == MODE_COMPLEX_INT))
    {
      ...
      if (submode == BLKmode)
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 2501, __FUNCTION__);
     ...
     int unsignedp;
{
  ...
  if (submode == BLKmode)
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 2745, __FUNCTION__);
     ...
     rtx equiv;
{
      ...
      else if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL)
 {
  ...
  break;
      ...
      if (set == 0)
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 3042, __FUNCTION__);
...
# 3405 "../../../kg++fe/gnu/optabs.c"
 ...
 = gen_rtx_CONST_INT (VOIDmode, (long long) (((((((x)->fld[1]).rtmem) != 0 ? (((x)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (x)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (x)->mode)) : 8))) < (((((y)->fld[1]).rtmem) != 0 ? (((y)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (y)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (y)->mode)) : 8))) ? (((((x)->fld[1]).rtmem) != 0 ? (((x)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (x)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (x)->mode)) : 8))) : (((((y)->fld[1]).rtmem) != 0 ? (((y)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (y)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (y)->mode)) : 8)))) / 8));
      ...
      if (size == 0)
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 3422, __FUNCTION__);
# 3491 "../../../kg++fe/gnu/optabs.c"
 {
...
# 3509 "../../../kg++fe/gnu/optabs.c"
 ...
 libfunc = (optab_table[OTI_ucmp])->handlers[(int) mode].libfunc;
  ...
  if (class == MODE_FLOAT)
    ...
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 3550, __FUNCTION__);
}
     ...
     rtx label;
{
 ...
 break;
  ...
  fancy_abort ("../../../kg++fe/gnu/optabs.c", 3651, __FUNCTION__);
}
# 3671 "../../../kg++fe/gnu/optabs.c"
void
  ...
  if (swap_commutative_operands_p (x, y))
    {
      ...
      if (! label)
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 3688, __FUNCTION__);

      op0 = y, op1 = x;
      comparison = swap_condition (comparison);
    }
# 3702 "../../../kg++fe/gnu/optabs.c"
  emit_queue ();
  if (unsignedp)
    ...
    wider_mode = ((enum machine_mode)mode_wider_mode[(int) (wider_mode)]))
 {
   if (((optab_table[OTI_cmp])->handlers[(int) wider_mode].insn_code
       ...
       || ((optab_table[OTI_cmp])->handlers[(int) wider_mode].libfunc != 0))
     {
      ...
      fancy_abort ("../../../kg++fe/gnu/optabs.c", 4051, __FUNCTION__);
    }

  if (libfunc == 0)
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 4055, __FUNCTION__);
     ...
     rtx x, y;
{
  ...
  (x, insn_data[icode].operand[0].mode))
    ...
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 4256, __FUNCTION__);
     ...
     rtx x, y;
{
  ...
  if (((enum machine_mode) (x)->mode) == VOIDmode)
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 4288, __FUNCTION__);
     ...
     rtx x, y;
{
  ...
  (x, insn_data[icode].operand[0].mode))
     ...
     (x, insn_data[icode].operand[1].mode))
      || ! ((*insn_data[icode].operand[2].predicate)
     (y, insn_data[icode].operand[2].mode)))
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 4320, __FUNCTION__);
     ...
     rtx x, y;
{
  ...
  if (((enum machine_mode) (x)->mode) == VOIDmode)
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 4352, __FUNCTION__);
 ...
 for (tmode = QImode; tmode != VOIDmode;
   ...
   if ((mode_size[(int) (tmode)]) == (mode_size[(int) (mode)]))
     break;
      ...
      if (tmode == VOIDmode)
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 4405, __FUNCTION__);
# 4414 "../../../kg++fe/gnu/optabs.c"
     ...
     int unsignedp;
{
  ...
  if (((enum machine_mode) (from)->mode) == VOIDmode)
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 4529, __FUNCTION__);
...
# 4689 "../../../kg++fe/gnu/optabs.c"
      ...
      if (((enum machine_mode) (to)->mode) == SFmode)
 {
   if (((enum machine_mode) (from)->mode) == SImode)
     ...
     fancy_abort ("../../../kg++fe/gnu/optabs.c", 4712, __FUNCTION__);
 }
      else if (((enum machine_mode) (to)->mode) == DFmode)
 {
   if (((enum machine_mode) (from)->mode) == SImode)
     ...
     fancy_abort ("../../../kg++fe/gnu/optabs.c", 4723, __FUNCTION__);
 }
      else if (((enum machine_mode) (to)->mode) == XFmode)
 {
   if (((enum machine_mode) (from)->mode) == SImode)
     ...
     fancy_abort ("../../../kg++fe/gnu/optabs.c", 4734, __FUNCTION__);
 }
      else if (((enum machine_mode) (to)->mode) == TFmode)
 {
   if (((enum machine_mode) (from)->mode) == SImode)
     ...
     fancy_abort ("../../../kg++fe/gnu/optabs.c", 4745, __FUNCTION__);
 }
      else
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 4748, __FUNCTION__);
...
# 4845 "../../../kg++fe/gnu/optabs.c"
 ...
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 4935, __FUNCTION__);
    }
 ...
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 4946, __FUNCTION__);
    }
 ...
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 4957, __FUNCTION__);
    }
 ...
 fancy_abort ("../../../kg++fe/gnu/optabs.c", 4968, __FUNCTION__);
    }
  else
    fancy_abort ("../../../kg++fe/gnu/optabs.c", 4971, __FUNCTION__);
...
# 1 "../../../kg++fe/gnu/MIPS/gt-optabs.h" 1
# 25 "../../../kg++fe/gnu/MIPS/gt-optabs.h"
