...
# 41 "../../../kg++fe/gnu/cp/semantics.c" 2
# 1 "../../../kg++fe/gnu/rtl.h" 1
# 42 "../../../kg++fe/gnu/cp/semantics.c" 2
...
# 46 "../../../kg++fe/gnu/cp/semantics.c" 2
# 56 "../../../kg++fe/gnu/cp/semantics.c"
static tree maybe_convert_cond (tree);
static tree simplify_aggr_init_exprs_r (tree *, int *, void *);
static void deferred_type_access_control (void);
static void emit_associated_thunks (tree);
static void genrtl_try_block (tree);
static void genrtl_eh_spec_block (tree);
static void genrtl_handler (tree);
static void genrtl_named_return_value (void);
...
anon_aggr_type_p (node)
     tree node;
{
  return ((((((enum tree_code) (node)->common.code)) == RECORD_TYPE || (((enum tree_code) (node)->common.code)) == UNION_TYPE) && (((enum tree_code) (node)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (node)->common.code) == TYPENAME_TYPE || ((enum tree_code) (node)->common.code) == TYPEOF_TYPE || ((enum tree_code) (node)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((node)->type.lang_flag_5))) && (&((node)->type.lang_specific)->u.c)->anon_aggr);
}
...
finish_goto_stmt (destination)
     tree destination;
{
  if (((enum tree_code) (destination)->common.code) == IDENTIFIER_NODE)
    destination = lookup_label (destination);



  if (((enum tree_code) (destination)->common.code) == LABEL_DECL)
    ((destination)->common.used_flag) = 1;
  ...
  if (((enum tree_code) (destination)->common.code) != LABEL_DECL)
    ...
    ((current_function_decl)->decl.uninlinable) = 1;
     ...
     tree expr;
{
 ...
 expr = convert_to_void (expr, "statement");
  ...
  (current_stmt_tree ()->x_last_expr_type) = expr_type;
     ...
     tree if_stmt;
{
  ...
  do { if ((current_stmt_tree ()->x_last_stmt) != (if_stmt)) { do { (((if_stmt))->exp.operands[0]) = ((if_stmt)->common.chain); ((if_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = if_stmt; } while (0); if (!scope_chain->x_processing_template_decl) { (cond) = build_tree_list ((((if_stmt))->exp.operands[0]), cond); ((((if_stmt))->exp.operands[0])) = (cond); } } else ((((if_stmt))->exp.operands[0])) = (cond); } while (0);
}
     ...
     tree while_stmt;
{
  ...
  if (scope_chain->x_processing_template_decl)
    ...
    do { if ((current_stmt_tree ()->x_last_stmt) != (while_stmt)) { do { (((while_stmt))->exp.operands[0]) = ((while_stmt)->common.chain); ((while_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = while_stmt; } while (0); if (!scope_chain->x_processing_template_decl) { (cond) = build_tree_list ((((while_stmt))->exp.operands[0]), cond); ((((while_stmt))->exp.operands[0])) = (cond); } } else ((((while_stmt))->exp.operands[0])) = (cond); } while (0);
  else if (getdecls () == (tree) ((void *)0))
  ...
  else
    {
      ...
      tree if_stmt;
      (((while_stmt))->exp.operands[0]) = c_global_trees[CTI_BOOLEAN_TRUE];
...
{
  do_poplevel ();
  do { (((while_stmt))->exp.operands[1]) = ((while_stmt)->common.chain); ((while_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = while_stmt; } while (0);
  finish_stmt ();
}
...
begin_do_stmt ()
{
  tree r = build_stmt (DO_STMT, (tree) ((void *)0), (tree) ((void *)0));
  add_stmt (r);
  return r;
}
...
finish_do_body (do_stmt)
     tree do_stmt;
{
  do { (((do_stmt))->exp.operands[1]) = ((do_stmt)->common.chain); ((do_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = do_stmt; } while (0);
}
     ...
     tree expr;
{
      ...
      if ((((current_function_decl)->decl.lang_specific)->decl_flags.destructor_attr))
 {
   ...
   return finish_goto_stmt ((cfun->language)->x_dtor_label);
 }
    }
...
begin_for_stmt ()
{
  ...
  r = build_stmt (FOR_STMT, (tree) ((void *)0), (tree) ((void *)0),
    (tree) ((void *)0), (tree) ((void *)0));
  (((r)->common.lang_flag_0)) = flag_new_for_scope > 0;
  if ((((r)->common.lang_flag_0)))
    {
      do_pushlevel ();
      note_level_for_for ();
    }
...
finish_for_init_stmt (for_stmt)
     tree for_stmt;
{
  if ((current_stmt_tree ()->x_last_stmt) != for_stmt)
    do { (((for_stmt))->exp.operands[0]) = ((for_stmt)->common.chain); ((for_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = for_stmt; } while (0);
  do_pushlevel ();
}
     ...
     tree for_stmt;
{
  ...
  if (scope_chain->x_processing_template_decl)
    ...
    do { if ((current_stmt_tree ()->x_last_stmt) != (for_stmt)) { do { (((for_stmt))->exp.operands[1]) = ((for_stmt)->common.chain); ((for_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = for_stmt; } while (0); if (!scope_chain->x_processing_template_decl) { (cond) = build_tree_list ((((for_stmt))->exp.operands[1]), cond); ((((for_stmt))->exp.operands[1])) = (cond); } } else ((((for_stmt))->exp.operands[1])) = (cond); } while (0);
  else if (getdecls () == (tree) ((void *)0))

    (((for_stmt))->exp.operands[1]) = cond;
  else
    {
      ...
      tree if_stmt;
      (((for_stmt))->exp.operands[1]) = (tree) ((void *)0);
     ...
     tree for_stmt;
{
  ...
  do_poplevel ();
  do { (((for_stmt))->exp.operands[3]) = ((for_stmt)->common.chain); ((for_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = for_stmt; } while (0);
  if ((((for_stmt)->common.lang_flag_0)))
    do_poplevel ();
  finish_stmt ();
}
...
begin_switch_stmt ()
{
  tree r;
  do_pushlevel ();
  r = build_stmt (SWITCH_STMT, (tree) ((void *)0), (tree) ((void *)0), (tree) ((void *)0));
  add_stmt (r);
  return r;
}
...
finish_switch_cond (cond, switch_stmt)
     ...
     tree switch_stmt;
{
  tree orig_type = ((void *)0);
  if (!scope_chain->x_processing_template_decl)
    {
      tree index;


      cond = build_expr_type_conversion (1 | 4, cond, 1);
      if (cond == (tree) ((void *)0))
 {
   error ("switch quantity not an integer");
   cond = global_trees[TI_ERROR_MARK];
 }
      orig_type = ((cond)->common.type);
      if (cond != global_trees[TI_ERROR_MARK])
 {
   cond = default_conversion (cond);
   cond = fold (build1 (CLEANUP_POINT_EXPR, ((cond)->common.type), cond));
 }

      if (cond != global_trees[TI_ERROR_MARK])
 {
   index = get_unwidened (cond, (tree) ((void *)0));




   if (((((cond)->common.type))->common.unsigned_flag)
       == ((((index)->common.type))->common.unsigned_flag))
     cond = index;
 }
    }
  do { if ((current_stmt_tree ()->x_last_stmt) != (switch_stmt)) { do { (((switch_stmt))->exp.operands[0]) = ((switch_stmt)->common.chain); ((switch_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = switch_stmt; } while (0); if (!scope_chain->x_processing_template_decl) { (cond) = build_tree_list ((((switch_stmt))->exp.operands[0]), cond); ((((switch_stmt))->exp.operands[0])) = (cond); } } else ((((switch_stmt))->exp.operands[0])) = (cond); } while (0);
  (((switch_stmt))->exp.operands[2]) = orig_type;
...
finish_switch_stmt (switch_stmt)
     tree switch_stmt;
{
  do { (((switch_stmt))->exp.operands[1]) = ((switch_stmt)->common.chain); ((switch_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = switch_stmt; } while (0);
  pop_switch ();
  finish_stmt ();
  do_poplevel ();
}
     ...
     tree t;
{
  if ((((t))->common.lang_flag_0))
    {
      ...
      expand_stmt ((((t))->exp.operands[0]));
      expand_eh_region_end_cleanup ((((t))->exp.operands[1]));
    }
  else
    {
      ...
      if ((((t))->common.lang_flag_3))
 {
   ...
   (cfun->language)->in_function_try_handler = 1;
   expand_stmt ((((t))->exp.operands[1]));
   (cfun->language)->in_function_try_handler = 0;
     ...
     tree t;
{
  expand_eh_region_start ();
  expand_stmt ((((t))->exp.operands[0]));
  expand_eh_region_end_allowed ((((t))->exp.operands[1]),
    build_call (cp_global_trees[CPTI_CALL_UNEXPECTED],
...
begin_try_block ()
{
  tree r = build_stmt (TRY_BLOCK, (tree) ((void *)0), (tree) ((void *)0));
  add_stmt (r);
  return r;
}
...
finish_try_block (try_block)
     tree try_block;
{
  do { (((try_block))->exp.operands[0]) = ((try_block)->common.chain); ((try_block)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = try_block; } while (0);
}
...
finish_cleanup (cleanup, try_block)
     ...
     tree try_block;
{
  (((try_block))->exp.operands[1]) = cleanup;
  (((try_block))->common.lang_flag_0) = 1;
}
...
finish_function_try_block (try_block)
     tree try_block;
{
  if (((try_block)->common.chain)
      && ((enum tree_code) (((try_block)->common.chain))->common.code) == CTOR_INITIALIZER)
    {

      ((((try_block)->common.chain))->common.chain) = (current_stmt_tree ()->x_last_stmt);
...
finish_handler_sequence (try_block)
     tree try_block;
{
  do { (((try_block))->exp.operands[1]) = ((try_block)->common.chain); ((try_block)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = try_block; } while (0);
  check_handlers ((((try_block))->exp.operands[1]));
}
     ...
     tree t;
{
  genrtl_do_pushlevel ();
  if (!scope_chain->x_processing_template_decl)
    expand_start_catch ((((t))->common.type));
  expand_stmt ((((t))->exp.operands[1]));
  if (!scope_chain->x_processing_template_decl)
    expand_end_catch ();
}
...
{
  tree r;
  r = build_stmt (HANDLER, (tree) ((void *)0), (tree) ((void *)0));
  add_stmt (r);
     ...
     tree handler;
{
      ...
      if (decl)
 {
   ...
   add_decl_stmt (decl);
   do { (((handler))->exp.operands[0]) = ((handler)->common.chain); ((handler)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = handler; } while (0);
     ...
     tree handler;
{
  ...
  do_poplevel ();
  do { (((handler))->exp.operands[1]) = ((handler)->common.chain); ((handler)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = handler; } while (0);
}
     ...
     int has_no_scope;
{
  ...
  r = build_stmt (COMPOUND_STMT, (tree) ((void *)0));

  if ((current_stmt_tree ()->x_last_stmt) && ((enum tree_code) ((current_stmt_tree ()->x_last_stmt))->common.code) == TRY_BLOCK)
    is_try = 1;

  add_stmt (r);
  if (has_no_scope)
    ((r)->common.lang_flag_0) = 1;
     ...
     tree compound_stmt;
{
  ...
  do { (((compound_stmt))->exp.operands[0]) = ((compound_stmt)->common.chain); ((compound_stmt)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = compound_stmt; } while (0);





  t = (current_stmt_tree ()->x_last_expr_type);
  finish_stmt ();
  (current_stmt_tree ()->x_last_expr_type) = t;
  ...
  if (!scope_chain->x_processing_template_decl)
    {
      ...
      for (t = input_operands; t; t = ((t)->common.chain))
 {
   tree converted_operand
     = decay_conversion (((t)->list.value));





   if (((converted_operand)->common.type) == cp_global_trees[CPTI_UNKNOWN_TYPE])
     {
       error ("type of asm operand `%E' could not be determined",
   ((t)->list.value));
       converted_operand = global_trees[TI_ERROR_MARK];
     }
   ((t)->list.value) = converted_operand;
 }

      ninputs = list_length (input_operands);
      noutputs = list_length (output_operands);

      for (i = 0, t = output_operands; t; t = ((t)->common.chain), ++i)
 {
   _Bool allows_mem;
   _Bool allows_reg;
   _Bool is_inout;
   ...
   constraint = ((((((t)->list.purpose))->list.value))->string.pointer);
   operand = ((t)->list.value);
   ...
   if (!parse_output_constraint (&constraint,
     ...
     &is_inout))
     {
       ...
       ((operand)->common.type) = global_trees[TI_ERROR_MARK];
       continue;
     }
   ...
   if (!allows_reg && (tree_code_type[(int) (((enum tree_code) (operand)->common.code))] == 'd'))
...
finish_eh_cleanup (cleanup)
     tree cleanup;
{
  tree r = build_stmt (CLEANUP_STMT, (tree) ((void *)0), cleanup);
  ((r)->common.static_flag) = 1;
  add_stmt (r);
}
  ...
  if (((decl)->decl.regdecl_flag))
    {
      ...
      ((decl)->decl.rtl = (gen_reg_rtx (((enum machine_mode) (((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->mode))));
     ...
     tree return_id, init;
{
  ...
  do { if (warn_deprecated) warning ("%s is deprecated, please see the documentation for details", ("the named return value extension")); } while (0);

  if (return_id != (tree) ((void *)0))
    {
      ...
      if (!scope_chain->x_processing_template_decl)
 {
   ...
   add_stmt (build_stmt (RETURN_INIT, (tree) ((void *)0), (tree) ((void *)0)));
 }
      else
...
finish_parenthesized_expr (expr)
     tree expr;
{
  if (((tree_code_type[(int) (((enum tree_code) (expr)->common.code))]) == '<' || (tree_code_type[(int) (((enum tree_code) (expr)->common.code))]) == '1' || (tree_code_type[(int) (((enum tree_code) (expr)->common.code))]) == '2' || (tree_code_type[(int) (((enum tree_code) (expr)->common.code))]) == 'e'))

    (((expr)->exp.complexity) = (int)(ERROR_MARK));

  if (((enum tree_code) (expr)->common.code) == OFFSET_REF)


    ((expr)->common.lang_flag_0) = 0;
  return expr;
}
...
begin_stmt_expr ()
{
  ...
  if (! cfun && !(current_stmt_tree ()->x_last_stmt))
  ...
  return (current_stmt_tree ()->x_last_stmt);
}
...
begin_global_stmt_expr ()
{
  ...
  return (current_stmt_tree ()->x_last_stmt) ? (current_stmt_tree ()->x_last_stmt) : expand_start_stmt_expr( 1);
}
     ...
     tree stmt_expr;
{
  ...
  if (! cfun
      && ((scope_chain->x_saved_tree)->common.chain) == (tree) ((void *)0))
     ...
     tree rtl_expr;
{
  ...
  result = build_min (STMT_EXPR, (current_stmt_tree ()->x_last_expr_type), (current_stmt_tree ()->x_last_stmt));
  ((result)->common.side_effects_flag) = 1;



  (current_stmt_tree ()->x_last_stmt) = rtl_expr;
...
# 1241 "../../../kg++fe/gnu/cp/semantics.c"
tree
finish_call_expr (tree fn, tree args, _Bool disallow_virtual)
{
  if (fn == global_trees[TI_ERROR_MARK] || args == global_trees[TI_ERROR_MARK])
  ...
  (void) (((!args || ((enum tree_code) (args)->common.code) == TREE_LIST) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/semantics.c", 1252, __FUNCTION__), 0) : 0);


  if ((((enum tree_code) (fn)->common.code) == BASELINK))
    {
      tree object;
# 1276 "../../../kg++fe/gnu/cp/semantics.c"
      if (scope_chain->class_type
   && (lookup_base ((scope_chain->class_type), ((((((fn))->exp.operands[2])))->common.type), ba_any, ((void *)0)) != (tree) ((void *)0))

   && (cfun ? (cfun->language)->x_current_class_ref : (tree) ((void *)0)))
 object = maybe_dummy_object (((((((fn))->exp.operands[2])))->common.type),
         ((void *)0));
      else
 {
   tree representative_fn;

   representative_fn = ((((fn))->exp.operands[1]));
   if (((enum tree_code) (representative_fn)->common.code) == TEMPLATE_ID_EXPR)
     representative_fn = ((representative_fn)->exp.operands[0]);
   representative_fn = get_first_fn (representative_fn);
   object = build_dummy_object (((representative_fn)->decl.context));
 }

      return build_new_method_call (object, fn, args, (tree) ((void *)0),
        (disallow_virtual
         ? (8) : 0));
    }
  ...
  else if ((((((enum tree_code) (((fn)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((fn)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((fn)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((fn)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((fn)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((fn)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((fn)->common.type))->type.lang_flag_5))))
    {


      tree result;
      result = build_opfncall (CALL_EXPR, (3), fn, args, (tree) ((void *)0));
      if (result)
 return result;
    }
...
finish_this_expr ()
{
  ...
  if ((cfun ? (cfun->language)->x_current_class_ptr : (tree) ((void *)0)))
    {
      result = (cfun ? (cfun->language)->x_current_class_ptr : (tree) ((void *)0));
    }
  else if (current_function_decl
    && (((current_function_decl)->decl.lang_specific)->decl_flags.static_function))
    {
...
finish_object_call_expr (fn, object, args)
     ...
     tree args;
{
  if ((((enum tree_code) (fn)->common.code) == TYPE_DECL || (((enum tree_code) (fn)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((fn)->decl.result))->common.code) == TYPE_DECL && !(((enum tree_code) (fn)->common.code) == TEMPLATE_DECL && (((fn)->decl.lang_flag_0) && (((enum tree_code) (fn)->common.code) == CONST_DECL || ((enum tree_code) (fn)->common.code) == PARM_DECL || ((enum tree_code) (fn)->common.code) == TYPE_DECL || ((enum tree_code) (fn)->common.code) == TEMPLATE_DECL))))))
    {
      if (scope_chain->x_processing_template_decl)
# 1382 "../../../kg++fe/gnu/cp/semantics.c"
 fn = ((fn)->decl.name);
      else
 {
  ...
  if (scope_chain->x_processing_template_decl || name_p (fn))
    return build_method_call (object, fn, args, (tree) ((void *)0), (3));
  else
    return build_new_method_call (object, fn, args, (tree) ((void *)0), (3));
}
...
finish_qualified_object_call_expr (fn, object, args)
     ...
     tree args;
{
  return build_scoped_method_call (object, ((fn)->exp.operands[0]),
       ((fn)->exp.operands[1]), args);
}
     ...
     tree destructor;
{
  ...
  if ((scope == (tree) ((void *)0) || namespace_binding ((destructor), global_namespace))
      && (((enum tree_code) (((object)->common.type))->common.code) !=
   ((enum tree_code) (((namespace_binding ((destructor), global_namespace))->common.type))->common.code)))
    error ("`%E' is not of type `%T'", object, destructor);

  return cp_convert (global_trees[TI_VOID_TYPE], object);
}
     ...
     tree expr;
{
  ...
  if (code == NEGATE_EXPR && ((enum tree_code) (expr)->common.code) == INTEGER_CST
      && ((enum tree_code) (result)->common.code) == INTEGER_CST
      && !((((result)->common.type))->common.unsigned_flag)
      && ((((result)->int_cst.int_cst).high) < (((global_trees[TI_INTEGER_ZERO])->int_cst.int_cst).high) || ((((result)->int_cst.int_cst).high) == (((global_trees[TI_INTEGER_ZERO])->int_cst.int_cst).high) && (((result)->int_cst.int_cst).low) < (((global_trees[TI_INTEGER_ZERO])->int_cst.int_cst).low))))
    (((result))->common.lang_flag_0) = 1;
...
finish_id_expr (expr)
     tree expr;
{
  if (((enum tree_code) (expr)->common.code) == IDENTIFIER_NODE)
    expr = do_identifier (expr, 1, (tree) ((void *)0));
...
finish_fname (tree id)
{
  ...
  decl = fname_decl ((((struct c_common_identifier *) (id))->node.rid_code), id);
  if (scope_chain->x_processing_template_decl)
    decl = build_min_nt (LOOKUP_EXPR, ((decl)->decl.name));
  return decl;
}
...
{
  tree lookup = scope_chain->lookups;

  if (lookup == global_trees[TI_ERROR_MARK])
    return;

  for (; lookup; lookup = ((lookup)->common.chain))
    enforce_access (((lookup)->list.purpose), ((lookup)->list.value));
}
     ...
     tree decl;
{
  ...
  scope_chain->lookups = current_type_lookups;
}
...
reset_type_access_control ()
{
  ...
  current_type_lookups = (tree) ((void *)0);
}
...
begin_function_definition (decl_specs, attributes, declarator)
     ...
     tree declarator;
{
  if (!start_function (decl_specs, declarator, attributes, 0))
    return 0;

  deferred_type_access_control ();
  scope_chain->lookups = global_trees[TI_ERROR_MARK];
...
finish_translation_unit ()
{
  ...
  pop_everything ();
  while (scope_chain->old_namespace != global_namespace)
    pop_namespace ();
...
finish_template_type_parm (aggr, identifier)
     ...
     tree identifier;
{
  if (aggr != cp_global_trees[CPTI_CLASS_TYPE])
    {
      pedwarn ("template type parameters must use the keyword `class' or `typename'");
      aggr = cp_global_trees[CPTI_CLASS_TYPE];
    }
...
finish_template_template_parm (aggr, identifier)
     ...
     tree identifier;
{
  tree decl = build_decl (TYPE_DECL, identifier, (tree) ((void *)0));
  tree tmpl = build_lang_decl (TEMPLATE_DECL, identifier, (tree) ((void *)0));
  ((tmpl)->decl.arguments) = scope_chain->template_parms;
  ((tmpl)->decl.result) = decl;
  ((decl)->decl.artificial_flag) = 1;
  end_template_decl ();

  (void) (((((tmpl)->decl.arguments)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/semantics.c", 1639, __FUNCTION__), 0) : 0);
...
{
  if (((enum tree_code) (argument)->common.code) != TEMPLATE_DECL
      && ((enum tree_code) (argument)->common.code) != TEMPLATE_TEMPLATE_PARM
      && ((enum tree_code) (argument)->common.code) != TYPE_DECL
      && ((enum tree_code) (argument)->common.code) != UNBOUND_CLASS_TEMPLATE)
    {
  ...
  if (parms)
    {
      ...
      (((parms)->common.lang_flag_2)) = 1;


      ((parms)->common.lang_flag_0) = ellipsis;
    }
  return parms;
}
     ...
     tree t;
{
  ...
  decl_type_access_control (((t)->type.name));
  reset_type_access_control ();
  ...
  else if (((enum tree_code) (t)->common.code) == TYPENAME_TYPE)
    {
      error ("invalid definition of qualified type `%T'", t);
      t = global_trees[TI_ERROR_MARK];
    }

  if (t == global_trees[TI_ERROR_MARK] || ! (((enum tree_code) (t)->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (t)->common.code) == TYPENAME_TYPE || ((enum tree_code) (t)->common.code) == TYPEOF_TYPE || ((enum tree_code) (t)->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((t)->type.lang_flag_5)))
    {
      t = make_aggr_type (RECORD_TYPE);
      pushtag (make_anon_name (), t, 0);
    }
# 1747 "../../../kg++fe/gnu/cp/semantics.c"
  if (((&((t)->type.lang_specific)->u.c)->is_partial_instantiation))
    {
      if (!pedantic)
 {
# 1759 "../../../kg++fe/gnu/cp/semantics.c"
   ((((t)->type.binfo))->vec.a[4]) = (tree) ((void *)0);
   ((t)->type.values) = (tree) ((void *)0);
   ((t)->type.maxval) = (tree) ((void *)0);
   ((&((t)->type.lang_specific)->u.c)->decl_list) = (tree) ((void *)0);
   ((&((t)->type.lang_specific)->u.c)->nested_udts) = ((void *)0);
   ((&((t)->type.lang_specific)->u.c)->vbases) = (tree) ((void *)0);
   ((t)->type.size) = (tree) ((void *)0);
 }


      ((&((t)->type.lang_specific)->u.c)->is_partial_instantiation) = 0;
    }


  else if ((((t)->type.size) != (tree) ((void *)0)))
    duplicate_tag_error (t);


  (((((t)->type.name))->decl.locus).file) = input_filename;
  (((((t)->type.name))->decl.locus).line) = lineno;

  if (((&((t)->type.lang_specific)->u.c)->being_defined))
    {
      t = make_aggr_type (((enum tree_code) (t)->common.code));
      pushtag ((((((t)->type.name))->decl.name)), t, 0);
    }
  maybe_process_partial_specialization (t);
  pushclass (t, 1);
  ((&((t)->type.lang_specific)->u.c)->being_defined) = 1;
  ((t)->type.packed_flag) = flag_pack_struct;
     ...
     tree decl;
{
  ...
  (void) (((((decl)->common.chain) == (tree) ((void *)0)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/semantics.c", 1821, __FUNCTION__), 0) : 0);


  ((decl)->common.private_flag)
    = (scope_chain->access_specifier == cp_global_trees[CPTI_ACCESS_PRIVATE]);
  ((decl)->common.protected_flag)
    = (scope_chain->access_specifier == cp_global_trees[CPTI_ACCESS_PROTECTED]);
  if (((enum tree_code) (decl)->common.code) == TEMPLATE_DECL)
    {
      ((((decl)->decl.result))->common.private_flag) = ((decl)->common.private_flag);
      ((((decl)->decl.result))->common.protected_flag) = ((decl)->common.protected_flag);
    }
  ...
  if (((decl)->decl.lang_specific) && (((decl)->decl.lang_specific) ? ((decl)->decl.lang_specific)->decl_flags.language : (((enum tree_code) (decl)->common.code) == FUNCTION_DECL ? lang_c : lang_cplusplus)) == lang_c)
    (((decl)->decl.lang_specific)->decl_flags.language = (lang_cplusplus));




  if (((enum tree_code) (decl)->common.code) == FUNCTION_DECL
      || (((enum tree_code) (decl)->common.code) == TEMPLATE_DECL && ((enum tree_code) (((decl)->decl.result))->common.code) == FUNCTION_DECL))
    {


      add_method (scope_chain->class_type, decl, 0);

      ((decl)->common.chain) = ((scope_chain->class_type)->type.maxval);
      ((scope_chain->class_type)->type.maxval) = decl;

      maybe_add_class_template_decl_list (scope_chain->class_type, decl,
                    0);
    }

  else if (((enum tree_code) (decl)->common.code) == USING_DECL || pushdecl_class_level (decl))
    {
# 1880 "../../../kg++fe/gnu/cp/semantics.c"
      if (((enum tree_code) (decl)->common.code) == TYPE_DECL)
 ((scope_chain->class_type)->type.values)
   = chainon (((scope_chain->class_type)->type.values), decl);
      else
 {
   ((decl)->common.chain) = ((scope_chain->class_type)->type.values);
   ((scope_chain->class_type)->type.values) = decl;
 }
     ...
     int pop_scope_p;
{
  ...
  attributes = chainon (((t)->type.attributes), attributes);
 ...
 note_got_semicolon (t);
  ...
  if (pop_scope_p)
    pop_scope (((((((((t)->type.main_variant))->common.chain)))->decl.context) ? (((((((t)->type.main_variant))->common.chain)))->decl.context) : global_namespace));
     ...
     tree types;
{
  ...
  for (t = types; t != (tree) ((void *)0); t = ((t)->common.chain))
    if (((((enum tree_code) (((t)->list.value))->common.code)) == RECORD_TYPE || (((enum tree_code) (((t)->list.value))->common.code)) == UNION_TYPE))
      maybe_process_partial_specialization (((t)->list.value));

  note_list_got_semicolon (types);
  grok_x_components (types);
  if (((((types)->list.value))->type.context) != scope_chain->class_type)
     ...
     tree sr;
{
  ...
  else if (scope != scope_chain->class_type)
    {
      if (((enum tree_code) (scope)->common.code) == TYPENAME_TYPE)
 {


   scope = ((scope)->common.type);
   ((sr)->exp.operands[0]) = scope;
 }
      push_nested_class (scope, 3);
      ((sr)->exp.complexity) = current_class_depth;
    }
}
     ...
     tree base_class;
{
  ...
  if (base_class == global_trees[TI_ERROR_MARK])
    {
      ...
      if (cp_type_quals (base_class) != 0)
        {
          ...
          base_class = ((base_class)->type.main_variant);
        }
     ...
     tree expr;
{
  ...
  if (!type || type == cp_global_trees[CPTI_UNKNOWN_TYPE])
    {
     ...
     tree t;
{
  ...
  return (tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 't') ? cxx_sizeof_or_alignof_type (t, SIZEOF_EXPR, 1) : expr_sizeof (t);
}
     ...
     tree t;
{
  ...
  return (tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 't') ? cxx_sizeof_or_alignof_type (t, ALIGNOF_EXPR, 1) : c_alignof_expr (t);
}
     ...
     tree t;
{
  switch (((enum tree_code) (t)->common.code))
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/cp/semantics.c", 2185, __FUNCTION__);
      break;
    }
}
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  if ((tree_code_type[(int) (((enum tree_code) (aggr_init_expr)->common.code))] == 't'))
    {
      *walk_subtrees = 0;
      return (tree) ((void *)0);
    }

  else if (((enum tree_code) (aggr_init_expr)->common.code) != AGGR_INIT_EXPR)
    return (tree) ((void *)0);


  fn = ((aggr_init_expr)->exp.operands[0]);
  args = ((aggr_init_expr)->exp.operands[1]);
  slot = ((aggr_init_expr)->exp.operands[2]);
  type = ((aggr_init_expr)->common.type);
  if ((((aggr_init_expr))->common.lang_flag_0))
    {
   ...
   build1 (ADDR_EXPR,
    build_pointer_type (((slot)->common.type)),
    slot),
   ((args)->common.chain));
    }
  call_expr = build (CALL_EXPR,
       ((((((fn)->common.type))->common.type))->common.type),
       fn, args, (tree) ((void *)0));
...
# 2263 "../../../kg++fe/gnu/cp/semantics.c"
  if ((((aggr_init_expr))->common.lang_flag_0) || copy_from_buffer_p)
    {
  ...
  ((call_expr)->common.chain) = ((aggr_init_expr)->common.chain);
  *tp = call_expr;
     ...
     tree fn;
{
  ...
  if (((fn)->decl.virtual_flag))
    {
      tree thunk;
      for (thunk = (((fn)->decl.lang_specific)->u.f.context); thunk; thunk = ((thunk)->common.chain))
 use_thunk (thunk, 1);
    }
}
     ...
     tree fn;
{
  ...
  if (scope_chain->x_processing_template_decl
      || (((fn)->decl.lang_specific)
   && ((((fn))->decl.lang_specific) ->decl_flags.u.template_info)
   && uses_template_parms ((((((((fn))->decl.lang_specific) ->decl_flags.u.template_info))->list.value)))))
    {
  ...
  walk_tree_without_duplicates (&((fn)->decl.saved_tree),
  ...
  if (((((fn)->decl.lang_specific)->decl_flags.constructor_attr) && copy_fn_p (fn) > 0) &&
      ((((fn)->decl.lang_specific)->decl_flags.constructor_attr) && ((fn)->decl.name) == cp_global_trees[CPTI_COMPLETE_CTOR_IDENTIFIER]) &&
      ((fn)->decl.assembler_name != (tree) ((void *)0)))
    ((decl_assembler_name (fn))->common.static_flag) = 1;
  ...
  if (
      (((fn)->decl.inline_flag) || ((fn)->decl.comdat_flag))

      && !flag_keep_inline_functions

      && !((at_eof && ((fn)->common.public_flag) && !((fn)->decl.comdat_flag)) || (((fn)->decl.assembler_name != (tree) ((void *)0)) && ((decl_assembler_name (fn))->common.static_flag)) || (flag_syntax_only && ((fn)->common.used_flag))))
    {


      if (!((fn)->decl.external_flag))
 {
   (((fn)->decl.lang_specific)->decl_flags.not_really_extern) = 1;
  ...
  if ((((fn)->decl.lang_specific)->decl_flags.base.declared_inline))
  ...
  lineno = (((fn)->decl.locus).line);
  input_filename = (((fn)->decl.locus).file);
  ...
  (cfun->is_thunk) = (((enum tree_code) (fn)->common.code) == FUNCTION_DECL && ((fn)->decl.lang_flag_7));


  expand_stmt (((fn)->decl.saved_tree));



  (void) (((stmts_are_full_exprs_p ()) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/semantics.c", 2418, __FUNCTION__), 0) : 0);



  lineno = ((((((fn)->decl.saved_tree)))->exp.complexity));
  ...
  if (dump_enabled_p (TDI_all))
    ...
    ;
  else if (((fn)->decl.inline_flag) && flag_inline_trees)
     ...
     void *data;
{
  ...
  if ((tree_code_type[(int) (((enum tree_code) (*tp)->common.code))] == 't'))
    *walk_subtrees = 0;
  else if (((enum tree_code) (*tp)->common.code) == RETURN_STMT)
    (((*tp))->exp.operands[0]) = (tree) ((void *)0);
  else if (((enum tree_code) (*tp)->common.code) == CLEANUP_STMT
    && (((*tp))->exp.operands[0]) == nrv)
    ((*tp)->common.static_flag) = 1;
     ...
     tree fn;
{
  ...
  init_function_start (fn, (((fn)->decl.locus).file), (((fn)->decl.locus).line));


  (cfun->language)->x_expanding_p = 1;
  ...
  (void) (((!(((fn)->decl.lang_specific)->u.f.pending_inline_p)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/semantics.c", 2505, __FUNCTION__), 0) : 0);
  if (((((fn))->decl.lang_specific) ->u.f.u.saved_language_function))
    {


      *(cfun->language) = *((((fn))->decl.lang_specific) ->u.f.u.saved_language_function);
 ...
 (cfun->cannot_inline) = (cfun->language)->cannot_inline;




      if (! ((fn)->decl.inline_flag))
 ((((fn))->decl.lang_specific) ->u.f.u.saved_language_function) = ((void *)0);
    }
  ...
  if ((((((enum tree_code) (fn)->common.code) == FUNCTION_DECL && !(((enum tree_code) (fn)->common.code) == FUNCTION_DECL && ((fn)->decl.lang_flag_7))) && ((((fn)->decl.lang_specific) ? ((fn)->decl.lang_specific)->decl_flags.language : (((enum tree_code) (fn)->common.code) == FUNCTION_DECL ? lang_c : lang_cplusplus)) == lang_c)) && ((fn)->decl.name) != (tree) ((void *)0) && ((((fn)->decl.name)) == global_trees[TI_MAIN_IDENTIFIER])))
    expand_main_function ();


  if (((cfun->language)->x_return_value))
    ((((cfun->language)->x_return_value))->decl.rtl = (((fn)->decl.result))->decl.rtl);
}
...
{
  tree t;
# 2574 "../../../kg++fe/gnu/cp/semantics.c"
  do_pending_stack_adjust ();



  if (((((fn)->decl.result))->decl.name))
    emit_jump ((cfun->x_return_label));
  ...
  if (function_depth > 1)
    ggc_pop_context ();
# 2621 "../../../kg++fe/gnu/cp/semantics.c"
  if (((fn)->decl.static_ctor_flag))
    static_ctors = tree_cons ((tree) ((void *)0), fn, static_ctors);




  if (((fn)->decl.static_dtor_flag))
    static_dtors = tree_cons ((tree) ((void *)0), fn, static_dtors);

  --function_depth;


  (void) (((!((fn)->decl.u2.f)) == 0) ? (fancy_abort ("../../../kg++fe/gnu/cp/semantics.c", 2633, __FUNCTION__), 0) : 0);
  ...
  for (t = ((fn)->decl.arguments); t; t = ((t)->common.chain))
    {
      ((t)->decl.rtl = ((rtx) 0));
      ((t)->decl.u2.r) = (rtx) 0;
    }

  if (!(flag_inline_trees && ((fn)->decl.inline_flag)))


    ((fn)->decl.initial) = global_trees[TI_ERROR_MARK];
