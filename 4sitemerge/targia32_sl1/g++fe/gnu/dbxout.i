...
# 88 "../../../kg++fe/gnu/dbxout.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 89 "../../../kg++fe/gnu/dbxout.c" 2
...
# 99 "../../../kg++fe/gnu/dbxout.c" 2
# 158 "../../../kg++fe/gnu/dbxout.c"
...
# 173 "../../../kg++fe/gnu/dbxout.c"
# 1 "../../../kg++fe/gnu/gstab.h" 1
...
{
# 1 "../../../kg++fe/gnu/stab.def" 1
# 24 "../../../kg++fe/gnu/stab.def"
N_GSYM=0x20,
...
N_LENG=0xfe,
# 9 "../../../kg++fe/gnu/gstab.h" 2
LAST_UNUSED_STAB_CODE
};
# 174 "../../../kg++fe/gnu/dbxout.c" 2
# 197 "../../../kg++fe/gnu/dbxout.c"
static FILE *asmfile;
     ...
     tree type;
{
 ...
 value = '3';
    ...
    fancy_abort ("../../../kg++fe/gnu/dbxout.c", 752, __FUNCTION__);
...
# 1335 "../../../kg++fe/gnu/dbxout.c"
 ...
 have_used_extensions = 1;
    ...
    default:
      fancy_abort ("../../../kg++fe/gnu/dbxout.c", 1791, __FUNCTION__);
    }
}
     ...
     tree type;
{
  tree t;
  if (((type)->type.name) == 0)
    fancy_abort ("../../../kg++fe/gnu/dbxout.c", 1886, __FUNCTION__);
  if (((enum tree_code) (((type)->type.name))->common.code) == IDENTIFIER_NODE)
    ...
    fancy_abort ("../../../kg++fe/gnu/dbxout.c", 1896, __FUNCTION__);
...
# 2022 "../../../kg++fe/gnu/dbxout.c"
 ...
 break;
    ...
    case PARM_DECL:
      ...
      fancy_abort ("../../../kg++fe/gnu/dbxout.c", 2164, __FUNCTION__);
