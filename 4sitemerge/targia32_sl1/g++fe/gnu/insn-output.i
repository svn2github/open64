# 1 "../../../kg++fe/gnu/MIPS/insn-output.c"
...
# 5 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 6 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 7 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
# 1 "../../../kg++fe/gnu/ggc.h" 1
# 25 "../../../kg++fe/gnu/ggc.h"
...
# 8 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
# 1 "../../../kg++fe/gnu/rtl.h" 1
# 25 "../../../kg++fe/gnu/rtl.h"
struct function;
...
# 9 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 10 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 11 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 12 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 13 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 14 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
# 1 "../../../kg++fe/gnu/hard-reg-set.h" 1
# 15 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 16 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 17 "../../../kg++fe/gnu/MIPS/insn-output.c" 2

# 1 "../../../kg++fe/gnu/conditions.h" 1
# 19 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 20 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 22 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 24 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...
# 25 "../../../kg++fe/gnu/MIPS/insn-output.c" 2
...

{
  if ((target_flags & 0x00040000))
    ...
    fancy_abort ("../../../kg++fe/gnu/MIPS/insn-output.c", 552, __FUNCTION__);
...

{
  ...
  if (optimize && find_reg_note (insn, REG_DEAD, operands[1]))
    return "%(move\t%0,%z4\n\tbeq\t%1,%z4,2f\n%~1:\tand\t%2,%1,0x0001\n\taddu\t%0,%0,1\n\tbeq\t%2,%z4,1b\n\tsrl\t%1,%1,1\n%~2:%)";
# 706 "../../../kg++fe/gnu/MIPS/insn-output.c"
  return "%(move\t%0,%z4\n\tmove\t%3,%1\n\tbeq\t%3,%z4,2f\n%~1:\tand\t%2,%3,0x0001\n\taddu\t%0,%0,1\n\tbeq\t%2,%z4,1b\n\tsrl\t%3,%3,1\n%~2:%)";
# 715 "../../../kg++fe/gnu/MIPS/insn-output.c"
}
}
...

{
  ...
  if (optimize && find_reg_note (insn, REG_DEAD, operands[1]))
    return "%(move\t%0,%z4\n\tbeq\t%1,%z4,2f\n%~1:\tand\t%2,%1,0x0001\n\tdaddu\t%0,%0,1\n\tbeq\t%2,%z4,1b\n\tdsrl\t%1,%1,1\n%~2:%)";
# 741 "../../../kg++fe/gnu/MIPS/insn-output.c"
  return "%(move\t%0,%z4\n\tmove\t%3,%1\n\tbeq\t%3,%z4,2f\n%~1:\tand\t%2,%3,0x0001\n\tdaddu\t%0,%0,1\n\tbeq\t%2,%z4,1b\n\tdsrl\t%3,%3,1\n%~2:%)";
# 750 "../../../kg++fe/gnu/MIPS/insn-output.c"
}
}
...

{
  ...
  return "sll\t%3,%2,26\n\tbgez\t%3,1f\n\tsll\t%M0,%L1,%2\n\t%(b\t3f\n\tmove\t%L0,%z4%)\n\n%~1:\n\t%(beq\t%3,%z4,2f\n\tsll\t%M0,%M1,%2%)\n\n\tsubu\t%3,%z4,%2\n\tsrl\t%3,%L1,%3\n\tor\t%M0,%M0,%3\n%~2:\n\tsll\t%L0,%L1,%2\n%~3:";
# 1710 "../../../kg++fe/gnu/MIPS/insn-output.c"
}
}
...

{
  ...
  return "sll\t%3,%2,26\n\tbgez\t%3,1f\n\tsra\t%L0,%M1,%2\n\t%(b\t3f\n\tsra\t%M0,%M1,31%)\n\n%~1:\n\t%(beq\t%3,%z4,2f\n\tsrl\t%L0,%L1,%2%)\n\n\tsubu\t%3,%z4,%2\n\tsll\t%3,%M1,%3\n\tor\t%L0,%L0,%3\n%~2:\n\tsra\t%M0,%M1,%2\n%~3:";
# 1846 "../../../kg++fe/gnu/MIPS/insn-output.c"
}
}
...

{
  ...
  return "sll\t%3,%2,26\n\tbgez\t%3,1f\n\tsrl\t%L0,%M1,%2\n\t%(b\t3f\n\tmove\t%M0,%z4%)\n\n%~1:\n\t%(beq\t%3,%z4,2f\n\tsrl\t%L0,%L1,%2%)\n\n\tsubu\t%3,%z4,%2\n\tsll\t%3,%M1,%3\n\tor\t%L0,%L0,%3\n%~2:\n\tsrl\t%M0,%M1,%2\n%~3:";
# 1977 "../../../kg++fe/gnu/MIPS/insn-output.c"
}
}
...

{
  ...
  if ((((enum rtx_code) (operands[2])->code) == CONST_INT)
    ...
    fancy_abort ("../../../kg++fe/gnu/MIPS/insn-output.c", 2059, __FUNCTION__);
...

{
  ...
  if ((((enum rtx_code) (operands[2])->code) == CONST_INT)
    ...
    fancy_abort ("../../../kg++fe/gnu/MIPS/insn-output.c", 2085, __FUNCTION__);
...

{
  ...
  if (((enum rtx_code) (operands[0])->code) != CONST_DOUBLE)
    fancy_abort ("../../../kg++fe/gnu/MIPS/insn-output.c", 3104, __FUNCTION__);
...

{
  ...
  if (((enum rtx_code) (operands[0])->code) != CONST_DOUBLE)
    fancy_abort ("../../../kg++fe/gnu/MIPS/insn-output.c", 3123, __FUNCTION__);
  memcpy (&(d), &((((operands[0]))->fld[0]).rtwint), sizeof (struct real_value));
