...
# 63 "../../../kg++fe/gnu/final.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 64 "../../../kg++fe/gnu/final.c" 2
...
# 66 "../../../kg++fe/gnu/final.c" 2
# 1 "../../../kg++fe/gnu/conditions.h" 1
# 67 "../../../kg++fe/gnu/final.c" 2
...
# 80 "../../../kg++fe/gnu/final.c" 2
# 1 "../../../kg++fe/gnu/profile.h" 1
# 24 "../../../kg++fe/gnu/profile.h"
struct profile_info
  {
...
# 82 "../../../kg++fe/gnu/final.c" 2

# 1 "../../../kg++fe/gnu/defaults.h" 1
# 84 "../../../kg++fe/gnu/final.c" 2
# 1 "../../../kg++fe/gnu/insn-addr.h" 1
# 85 "../../../kg++fe/gnu/final.c" 2
# 93 "../../../kg++fe/gnu/final.c"
...
# 94 "../../../kg++fe/gnu/final.c" 2
# 123 "../../../kg++fe/gnu/final.c"
...
# 824 "../../../kg++fe/gnu/final.c"
static int min_labelno, max_labelno;
# 834 "../../../kg++fe/gnu/final.c"
int
     ...
     rtx first __attribute__ ((__unused__));
{
 ...
 fancy_abort ("../../../kg++fe/gnu/final.c", 1090, __FUNCTION__);
...
# 1270 "../../../kg++fe/gnu/final.c"
 ...
 _fatal_insn ("negative insn length", insn, "../../../kg++fe/gnu/final.c", 1359, __FUNCTION__);
     ...
     rtx insn;
{
  ...
  switch (insn_data[code].output_format)
    ...
    case 3:
      if (insn == ((void *)0))
 fancy_abort ("../../../kg++fe/gnu/final.c", 1963, __FUNCTION__);
      return (*(insn_output_fn) output) (recog_data.operand, insn);

    default:
      fancy_abort ("../../../kg++fe/gnu/final.c", 1967, __FUNCTION__);
    }
}
     ...
     rtx insn;
{
  ...
  switch (((enum label_kind) (((insn)->jump << 1) | (insn)->call)))
    ...
    case LABEL_NORMAL:
    default:
      fancy_abort ("../../../kg++fe/gnu/final.c", 2000, __FUNCTION__);
    }
}
# 2012 "../../../kg++fe/gnu/final.c"
rtx
 ...
 *xp = new;
 ...
 fancy_abort ("../../../kg++fe/gnu/final.c", 2959, __FUNCTION__);
    }
...
# 3347 "../../../kg++fe/gnu/final.c"
 break;
# 3402 "../../../kg++fe/gnu/final.c"
      case '%':
     ...
     int code __attribute__ ((__unused__));
{
  ...
  if (x && ((enum rtx_code) (x)->code) == REG && (((x)->fld[0]).rtuint) >= 176)
    fancy_abort ("../../../kg++fe/gnu/final.c", 3547, __FUNCTION__);
...
# 3772 "../../../kg++fe/gnu/final.c"
   ...
   case 'U':
     ...
     break;
# 3845 "../../../kg++fe/gnu/final.c"
   default:
     fancy_abort ("../../../kg++fe/gnu/final.c", 3846, __FUNCTION__);
   }
 break;
     ...
     rtx insn;
{
  ...
  if (!uid_shuid)
    fancy_abort ("../../../kg++fe/gnu/final.c", 4051, __FUNCTION__);
  insn_id = (uid_shuid[(((insn)->fld[0]).rtint)]);
  label_id = (uid_shuid[((((((insn)->fld[9]).rtx))->fld[0]).rtint)]);

  if (!insn_id || !label_id)
    fancy_abort ("../../../kg++fe/gnu/final.c", 4056, __FUNCTION__);
  return insn_id < label_id;
}
# 4201 "../../../kg++fe/gnu/final.c"
void
mark_referenced_symbols (rtx x)
{
  ...
  if (((enum rtx_code) (x)->code) == SYMBOL_REF) {
    ...
    if (!name)
      fancy_abort ("../../../kg++fe/gnu/final.c", 4216, __FUNCTION__);
  ...
  } else if (((enum rtx_code) (x)->code) == CALL_PLACEHOLDER) {
    rtx tem;
    for (tem = (((x)->fld[0]).rtx); tem != 0; tem = (((tem)->fld[2]).rtx))
  ...
  for (i = 0; i < (rtx_length[(int) (((enum rtx_code) (x)->code))]); i++)
    {
      if (fmt[i] == 'e')
        mark_referenced_symbols ((((x)->fld[i]).rtx));
      else if (fmt[i] == 'E')
        for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
          mark_referenced_symbols ((((((x)->fld[i]).rtvec))->elem[j]));
    }
}
