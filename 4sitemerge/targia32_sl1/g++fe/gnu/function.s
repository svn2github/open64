...
cfun:
	.zero	4
	.section	.rodata
	.type	__FUNCTION__.14053, @object
	.size	__FUNCTION__.14053, 19
__FUNCTION__.14053:
	.string	"find_function_data"
	.align 4
.LC0:
	.string	"../../../kg++fe/gnu/function.c"
	.text
.globl find_function_data
	.type	find_function_data, @function
find_function_data:
.LFB15:
	.file 1 "../../../kg++fe/gnu/function.c"
	.loc 1 317 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.L2:
	...
	jne	.L3
	.loc 1 324 0
	leal	__FUNCTION__.14053@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$324, 4(%esp)
...
.LFE25:
	...
	.section	.rodata
	.type	__FUNCTION__.14326, @object
	.size	__FUNCTION__.14326, 27
__FUNCTION__.14326:
...
.LCFI48:
	...
	jne	.L107
	.loc 1 663 0
	leal	__FUNCTION__.14326@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$663, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE43:
	...
	.section	.rodata
	.type	__FUNCTION__.15321, @object
	.size	__FUNCTION__.15321, 15
__FUNCTION__.15321:
...
.LCFI118:
	...
	je	.L508
	.loc 1 1587 0
	leal	__FUNCTION__.15321@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1587, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE48:
	...
	.section	.rodata
	.type	__FUNCTION__.15650, @object
	.size	__FUNCTION__.15650, 17
__FUNCTION__.15650:
...
.LBB22:
	...
	jne	.L627
	.loc 1 1959 0
	leal	__FUNCTION__.15650@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1959, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE49:
	...
	.section	.rodata
	.type	__FUNCTION__.16330, @object
	.size	__FUNCTION__.16330, 20
__FUNCTION__.16330:
...
.LCFI147:
	...
	jne	.L831
	.loc 1 2566 0
	leal	__FUNCTION__.16330@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2566, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LCFI174:
	...
	je	.L951
	.loc 1 3001 0
	leal	__FUNCTION__.16702@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3001, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE56:
	...
	.section	.rodata
	.type	__FUNCTION__.16752, @object
	.size	__FUNCTION__.16752, 18
__FUNCTION__.16752:
...
.L979:
	...
	jne	.L980
	.loc 1 3089 0
	leal	__FUNCTION__.16752@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3089, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE62:
	...
	.section	.rodata
	.type	__FUNCTION__.17150, @object
	.size	__FUNCTION__.17150, 16
__FUNCTION__.17150:
...
.L1100:
	...
	je	.L1104
	.loc 1 3451 0
	leal	__FUNCTION__.17150@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3451, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE70:
	...
	.section	.rodata
	.align 32
	.type	__FUNCTION__.17508, @object
	.size	__FUNCTION__.17508, 33
__FUNCTION__.17508:
...
.L1241:
	.loc 1 3790 0
	leal	__FUNCTION__.17508@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3790, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE75:
	...
	.section	.rodata
	.type	__FUNCTION__.18073, @object
	.size	__FUNCTION__.18073, 20
__FUNCTION__.18073:
...
.L1438:
	...
	jne	.L1439
	.loc 1 4279 0
	leal	__FUNCTION__.18073@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$4279, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE77:
	...
	.section	.rodata
	.type	__FUNCTION__.18185, @object
	.size	__FUNCTION__.18185, 13
__FUNCTION__.18185:
	.string	"assign_parms"
	.text
.globl assign_parms
...
.L1741:
	...
	je	.L1731
	.loc 1 4757 0
	leal	__FUNCTION__.18185@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$4757, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE86:
	...
	.section	.rodata
	.type	__FUNCTION__.20336, @object
	.size	__FUNCTION__.20336, 20
__FUNCTION__.20336:
...
.L2350:
	...
	jne	.L2351
	.loc 1 5654 0
	leal	__FUNCTION__.20336@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$5654, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE87:
	...
	.section	.rodata
	.type	__FUNCTION__.20369, @object
	.size	__FUNCTION__.20369, 17
__FUNCTION__.20369:
...
.L2367:
	.loc 1 5687 0
	leal	__FUNCTION__.20369@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$5687, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE92:
	...
	.section	.rodata
	.type	__FUNCTION__.20639, @object
	.size	__FUNCTION__.20639, 18
__FUNCTION__.20639:
...
.LBB90:
	...
	jne	.L2457
	.loc 1 5913 0
	leal	__FUNCTION__.20639@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$5913, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE108:
	...
	.section	.rodata
	.type	__FUNCTION__.21095, @object
	.size	__FUNCTION__.21095, 22
__FUNCTION__.21095:
...
.L2660:
	.loc 1 6639 0
	leal	__FUNCTION__.21095@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$6639, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE115:
	...
	.section	.rodata
	.type	__FUNCTION__.21458, @object
	.size	__FUNCTION__.21458, 20
__FUNCTION__.21458:
...
.LFE122:
	...
	.section	.rodata
	.type	__FUNCTION__.21967, @object
	.size	__FUNCTION__.21967, 21
__FUNCTION__.21967:
...
.L2821:
	.loc 1 7431 0
	leal	__FUNCTION__.21967@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$7431, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE123:
	...
	.section	.rodata
	.type	__FUNCTION__.22232, @object
	.size	__FUNCTION__.22232, 20
__FUNCTION__.22232:
...
.LCFI456:
	...
	je	.L2896
	.loc 1 7541 0
	leal	__FUNCTION__.22232@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$7541, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE125:
	...
	.section	.rodata
	.align 32
	.type	__FUNCTION__.22319, @object
	.size	__FUNCTION__.22319, 35
__FUNCTION__.22319:
...
.L2920:
	.loc 1 7648 0
	leal	__FUNCTION__.22319@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$7648, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
gt_ggc_mx_temp_slot:
.LFB129:
	.file 2 "../../../kg++fe/gnu/MIPS/gt-function.h"
	.loc 2 26 0
	pushl	%ebp
.LCFI473:
	movl	%esp, %ebp
...
.LEFDE228:
	...
	.file 17 "../../../kg++fe/gnu/expr.h"
	.file 18 "../../../kg++fe/gnu/varray.h"
	.file 19 "../../../kg++fe/gnu/except.h"
	.file 20 "../../../kg++fe/gnu/regs.h"
	.file 21 "../../../kg++fe/gnu/hard-reg-set.h"
	.file 22 "../../../kg++fe/gnu/flags.h"
	.file 23 "../../../kg++fe/gnu/libfuncs.h"
	.file 24 "../../../kg++fe/gnu/langhooks.h"
