...
# 138 "../../../kg++fe/gnu/unroll.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 139 "../../../kg++fe/gnu/unroll.c" 2
# 1 "../../../kg++fe/gnu/integrate.h" 1
# 21 "../../../kg++fe/gnu/integrate.h"
...
# 151 "../../../kg++fe/gnu/unroll.c" 2
# 161 "../../../kg++fe/gnu/unroll.c"
...
# 696 "../../../kg++fe/gnu/unroll.c"
 ...
 ((map)->label_map[((((((note)->fld[0]).rtx))->fld[6]).rtint)] = ((((note)->fld[0]).rtx)));
  ...
  map->inline_target = 0;
# 743 "../../../kg++fe/gnu/unroll.c"
  maxregnum = max_reg_num ();


  max_local_regnum = maxregnum;
# 756 "../../../kg++fe/gnu/unroll.c"
  ...
  if ((((copy_end)->fld[0]).rtint) < max_uid_for_loop)
    {
      int copy_start_luid = ((((copy_start)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((copy_start)->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 766, __FUNCTION__), -1));
      int copy_end_luid = ((((copy_end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((copy_end)->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 767, __FUNCTION__), -1));



      if (((enum rtx_code) (copy_end)->code) == JUMP_INSN)
 copy_end_luid--;
# 786 "../../../kg++fe/gnu/unroll.c"
...
# 1013 "../../../kg++fe/gnu/unroll.c"
       ...
       else
  {
   ...
   if (((enum rtx_code) (last_loop_insn)->code) == BARRIER)
     ...
     fancy_abort ("../../../kg++fe/gnu/unroll.c", 1055, __FUNCTION__);
...
# 1282 "../../../kg++fe/gnu/unroll.c"
 ...
 insn = (((insn)->fld[2]).rtx);
  ...
  if ((((safety_label))->volatil))
    fancy_abort ("../../../kg++fe/gnu/unroll.c", 1294, __FUNCTION__);
     ...
     enum machine_mode *mode;
{
 ...
 fprintf (loop_dump_stream,
  ...
  if (uid_luid[(((reg_n_info)->data.reg[(((loop_info->iteration_var)->fld[0]).rtuint)])->first_uid)]
      > ((((loop_start)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop_start)->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 1506, __FUNCTION__), -1)))
    {
      if (loop_dump_stream)
 fprintf (loop_dump_stream,
     ...
     unsigned int regno;
{
  ...
  if (((enum rtx_code) ((((pattern)->fld[1]).rtx))->code) != PLUS)
    {
      ...
      if (((enum rtx_code) ((((pattern)->fld[1]).rtx))->code) != PLUS)
 fancy_abort ("../../../kg++fe/gnu/unroll.c", 1599, __FUNCTION__);
        ...
        || ((enum rtx_code) (increment)->code) == LSHIFTRT)
 {
   ...
   if (((enum rtx_code) (second_part)->code) != CONST_INT
     ...
     fancy_abort ("../../../kg++fe/gnu/unroll.c", 1647, __FUNCTION__);
   ...
   if (code == IOR)
     ...
     increment = gen_rtx_CONST_INT (VOIDmode, (long long) ((unsigned long long) (((increment)->fld[0]).rtwint) >> (((second_part)->fld[0]).rtwint)));
      ...
      if (((enum rtx_code) (increment)->code) != CONST_INT)
 fancy_abort ("../../../kg++fe/gnu/unroll.c", 1660, __FUNCTION__);
      ...
      if (tries == 0)
 {
   ...
   goto retry;
      ...
      fancy_abort ("../../../kg++fe/gnu/unroll.c", 1693, __FUNCTION__);
    }
     ...
     struct inline_remap *map;
{
  ...
  if (((enum rtx_code) (notes)->code) == EXPR_LIST)
    ...
    fancy_abort ("../../../kg++fe/gnu/unroll.c", 1722, __FUNCTION__);
      ...
      if (((enum rtx_code) (note)->code) == INSN_LIST)
 {
       ...
       if (!insn)
  {
    if (((enum reg_note) ((enum machine_mode) (note)->mode)) != REG_LABEL)
      fancy_abort ("../../../kg++fe/gnu/unroll.c", 1760, __FUNCTION__);
  }
       else
         (((note)->fld[0]).rtx) = insn;
     }
...
# 2080 "../../../kg++fe/gnu/unroll.c"
 ...
 case JUMP_INSN:
       ...
       if (!invert_jump (copy, exit_label, 0))
  {
    ...
    if (!redirect_jump (copy, lab, 0))
      fancy_abort ("../../../kg++fe/gnu/unroll.c", 2135, __FUNCTION__);
  }
     }
 ...
 default:
   fancy_abort ("../../../kg++fe/gnu/unroll.c", 2283, __FUNCTION__);
 }
     ...
     enum machine_mode mode;
{
  ...
  if ((((enum machine_mode) (mult1)->mode) != mode && ((enum machine_mode) (mult1)->mode) != VOIDmode)
    ...
    fancy_abort ("../../../kg++fe/gnu/unroll.c", 2425, __FUNCTION__);
     ...
     int unroll_number;
{
 ...
 continue;
# 2545 "../../../kg++fe/gnu/unroll.c"
      biv_splittable = 1;
      biv_final_value = 0;
      if (unroll_type != UNROLL_COMPLETELY
   && (loop->exit_count || unroll_type == UNROLL_NAIVE)
   && (uid_luid[(((reg_n_info)->data.reg[bl->regno])->last_uid)] >= ((((loop->end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->end)->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 2549, __FUNCTION__), -1))
       || ! bl->init_insn
       || (((bl->init_insn)->fld[0]).rtint) >= max_uid_for_loop
       || (uid_luid[(((reg_n_info)->data.reg[bl->regno])->first_uid)]
    < ((((bl->init_insn)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((bl->init_insn)->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 2553, __FUNCTION__), -1)))
...
# 2730 "../../../kg++fe/gnu/unroll.c"
   ...
   && ((((v->dest_reg)->fld[0]).rtuint) >= max_reg_before_loop
    ...
    >= ((((loop->end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->end)->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 2747, __FUNCTION__), -1))))
   && ! (final_value = v->final_value))
 continue;
# 2779 "../../../kg++fe/gnu/unroll.c"
      if (unroll_type == UNROLL_COMPLETELY)
 {
...
# 3099 "../../../kg++fe/gnu/unroll.c"
  if (n_iterations != 0
      && ! loop->exit_count
      && v->always_executed)
    {
# 3114 "../../../kg++fe/gnu/unroll.c"
      increment = biv_total_increment (bl);

      if (increment && loop_invariant_p (loop, increment)
   && loop_invariant_p (loop, bl->initial_value))
 {
# 3130 "../../../kg++fe/gnu/unroll.c"
  ...
  if (v->replaceable)
    fancy_abort ("../../../kg++fe/gnu/unroll.c", 3170, __FUNCTION__);
     ...
     rtx op, reg;
{
 ...
 return (((op)->fld[0]).rtx);
  ...
  fancy_abort ("../../../kg++fe/gnu/unroll.c", 3259, __FUNCTION__);
}
     ...
     struct loop *loop;
{
      ...
      do
 {
       ...
       if ((((temp)->fld[9]).rtx) == 0)
  {
    ...
    && (((((((temp)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((((temp)->fld[9]).rtx))->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 3384, __FUNCTION__), -1)) > ((((loop->top)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->top)->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 3384, __FUNCTION__), -1))
    && (((((((temp)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((((temp)->fld[9]).rtx))->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 3385, __FUNCTION__), -1)) < ((((loop->cont)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->cont)->fld[0]).rtint)] : (fancy_abort ("../../../kg++fe/gnu/unroll.c", 3385, __FUNCTION__), -1)))
  {
    if (loop_dump_stream)
      fprintf
        (loop_dump_stream,
 ...
 fprintf (loop_dump_stream,
  ...
  if ((unsigned) (((iteration_var)->fld[0]).rtuint) >= ivs->n_regs
    ...
    fancy_abort ("../../../kg++fe/gnu/unroll.c", 3434, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/unroll.c", 3479, __FUNCTION__);
 ...
 fancy_abort ("../../../kg++fe/gnu/unroll.c", 3501, __FUNCTION__);
 ...
 fprintf (loop_dump_stream,
  ...
  switch (comparison_code)
    ...
    case NE:
      ...
      break;
    default:
      fancy_abort ("../../../kg++fe/gnu/unroll.c", 3603, __FUNCTION__);
    }
...
# 3877 "../../../kg++fe/gnu/unroll.c"
 ...
 fprintf (loop_dump_stream, "Loop iterations: Not normal loop.\n");
  ...
  if (inc > 0)
    ...
    fancy_abort ("../../../kg++fe/gnu/unroll.c", 3904, __FUNCTION__);
