...
# 30 "../../../kg++fe/gnu/cp/cp-lang.c" 2

static long long cxx_get_alias_set (tree);
static _Bool ok_to_generate_alias_set_for_type (tree);
static _Bool cxx_warn_unused_global_decl (tree);
static tree cp_expr_size (tree);
static _Bool cp_var_mod_type_p (tree);
# 161 "../../../kg++fe/gnu/cp/cp-lang.c"
const struct lang_hooks lang_hooks = { "GNU C++", sizeof (struct lang_identifier), cxx_init_options, c_common_decode_option, c_common_post_options, cxx_init, cxx_finish, c_common_parse_file, pop_everything, cxx_get_alias_set, cplus_expand_constant, cxx_expand_expr, c_common_truthvalue_conversion, cxx_insert_default_attributes, c_safe_from_p, lhd_do_nothing_t, c_common_unsafe_for_reeval, cxx_mark_addressable, lhd_staticp, cxx_dup_lang_specific_decl, cxx_unsave_expr_now, cxx_maybe_build_cleanup, mangle_decl, lhd_can_use_bit_fields_p, 0, cxx_print_statistics, cxx_print_xnode, cxx_print_decl, cxx_print_type, cxx_print_identifier, cxx_printable_name, cxx_print_error_function, cp_expr_size, cxx_attribute_table, c_common_attribute_table, c_common_format_attribute_table, { cxx_push_function_context, cxx_pop_function_context, lhd_do_nothing_f, lhd_do_nothing_f }, { cp_walk_subtrees, cp_cannot_inline_tree_fn, lhd_tree_inlining_disregard_inline_limits, cp_add_pending_fn_decls, cp_is_overload_p, cp_auto_var_in_fn_p, cp_copy_res_decl_for_inlining, anon_aggr_type_p, cp_var_mod_type_p, cp_start_inlining, cp_end_inlining, lhd_tree_inlining_convert_parm_for_inlining }, { cp_dump_tree, cp_type_quals }, { pushlevel, poplevel, global_bindings_p, insert_block, set_block, pushdecl, getdecls, cxx_warn_unused_global_decl, lhd_do_nothing, lhd_decl_ok_for_sibcall, }, { cxx_make_type, c_common_type_for_mode, c_common_type_for_size, c_common_unsigned_type, c_common_signed_type, c_common_signed_or_unsigned_type, cxx_type_promotes_to, cxx_incomplete_type_error } };
...
'e',
'e',
# 173 "../../../kg++fe/gnu/cp/cp-lang.c" 2
};
# 182 "../../../kg++fe/gnu/cp/cp-lang.c"
...
((sizeof (struct lang_identifier) - sizeof (struct tree_common) + sizeof (tree) - 1) / sizeof (tree)),
...
0,
# 156 "../../../kg++fe/gnu/cp/cp-tree.def"
((sizeof (template_parm_index) - sizeof (struct tree_common)) + sizeof (tree) - 1) / sizeof (tree),
# 169 "../../../kg++fe/gnu/cp/cp-tree.def"
0,
# 178 "../../../kg++fe/gnu/cp/cp-tree.def"
0,
     ...
     tree t;
{
  if ((((enum tree_code) (t)->common.code) == RECORD_TYPE && ((t)->type.lang_specific) && ((&((t)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    return 1;
  if ((((enum tree_code) (t)->common.code) == ARRAY_TYPE || ((enum tree_code) (t)->common.code) == RECORD_TYPE || ((enum tree_code) (t)->common.code) == UNION_TYPE || ((enum tree_code) (t)->common.code) == QUAL_UNION_TYPE || ((enum tree_code) (t)->common.code) == SET_TYPE))
    {
      if ((((enum tree_code) (t)->common.code) == RECORD_TYPE) || (((enum tree_code) (t)->common.code) == UNION_TYPE))
 {
   tree fields;
   ...
   if (((t)->type.binfo) != ((void *)0) && ((((t)->type.binfo))->vec.a[4]) != ((void *)0))
     {
       int i;
       for (i = 0; i < ((((((t)->type.binfo))->vec.a[4]))->vec.length); i++)
  {
    tree binfo = ((((((t)->type.binfo))->vec.a[4]))->vec.a[i]);
    if (!ok_to_generate_alias_set_for_type (((binfo)->common.type)))
      return 0;
  }
     }
  ...
  continue;
       if (! ok_to_generate_alias_set_for_type (((fields)->common.type)))
  return 0;
     }
   return 1;
 }
      else if (((enum tree_code) (t)->common.code) == ARRAY_TYPE)
 return ok_to_generate_alias_set_for_type (((t)->common.type));
      else


 fancy_abort ("../../../kg++fe/gnu/cp/cp-lang.c", 253, __FUNCTION__);
    }
  else
    return 1;
}
     ...
     tree t;
{
  if (
      ...
      || (((enum tree_code) (t)->common.code) == RECORD_TYPE && ((t)->type.lang_specific) && ((&((t)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    return 0;
...
cp_expr_size (exp)
     tree exp;
{
  if ((((((enum tree_code) (((exp)->common.type))->common.code)) == RECORD_TYPE || (((enum tree_code) (((exp)->common.type))->common.code)) == UNION_TYPE) && (((enum tree_code) (((exp)->common.type))->common.code) == TEMPLATE_TYPE_PARM || ((enum tree_code) (((exp)->common.type))->common.code) == TYPENAME_TYPE || ((enum tree_code) (((exp)->common.type))->common.code) == TYPEOF_TYPE || ((enum tree_code) (((exp)->common.type))->common.code) == BOUND_TEMPLATE_TEMPLATE_PARM || ((((exp)->common.type))->type.lang_flag_5))))
    {



      if (((&((((exp)->common.type))->type.lang_specific)->u.c)->has_complex_init_ref)
   && ((&((((exp)->common.type))->type.lang_specific)->u.c)->has_complex_assign_ref)

   && ((enum tree_code) (exp)->common.code) != CONSTRUCTOR)
 fancy_abort ("../../../kg++fe/gnu/cp/cp-lang.c", 312, __FUNCTION__);


      return ((((&((((exp)->common.type))->type.lang_specific)->u.c)->as_base))->type.size_unit);
    }
  else
...
cp_var_mod_type_p (tree type)
{
  ...
  if ((((enum tree_code) (type)->common.code) == POINTER_TYPE && ((enum tree_code) (((type)->common.type))->common.code) == OFFSET_TYPE) || (((enum tree_code) (type)->common.code) == RECORD_TYPE && ((type)->type.lang_specific) && ((&((type)->type.lang_specific)->u.c)->ptrmemfunc_flag)))
    return (variably_modified_type_p (((((enum tree_code) (type)->common.code) == POINTER_TYPE && ((enum tree_code) (((type)->common.type))->common.code) == OFFSET_TYPE) ? ((((type)->common.type))->type.maxval) : (((((((((type)->type.values))->common.type)))->common.type))->type.maxval)))
     || variably_modified_type_p (((((enum tree_code) (type)->common.code) == POINTER_TYPE && ((enum tree_code) (((type)->common.type))->common.code) == OFFSET_TYPE) ? ((((type)->common.type))->common.type) : (((((((type)->type.values))->common.type)))->common.type))));
