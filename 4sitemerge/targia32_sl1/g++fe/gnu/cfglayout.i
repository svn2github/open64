...
# 37 "../../../kg++fe/gnu/cfglayout.c" 2
# 1 "../../../kg++fe/gnu/MIPS/insn-config.h" 1
# 38 "../../../kg++fe/gnu/cfglayout.c" 2
     ...
     tree s1, s2;
{
 ...
 fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 305, __FUNCTION__);
...
fixup_reorder_chain ()
{
      ...
      if (((reorder_block_def) (bb)->aux)->footer)
 {
  ...
  if (index != n_basic_blocks)
    fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 427, __FUNCTION__);
        ...
        label_for_bb (e_fall->dest), 0))
  {
    ...
    continue;
   ...
   else
     {
       ...
       if (! e_fall)
  continue;
# 553 "../../../kg++fe/gnu/cfglayout.c"
       fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 553, __FUNCTION__);
...
verify_insn_chain ()
{
  ...
  for (prevx = ((void *)0), insn_cnt1 = 1, x = get_insns ();
    ...
    if ((((x)->fld[1]).rtx) != prevx)
      fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 638, __FUNCTION__);

  if (prevx != get_last_insn ())
    fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 641, __FUNCTION__);

  for (nextx = ((void *)0), insn_cnt2 = 1, x = get_last_insn ();
       x != 0;
       nextx = x, insn_cnt2++, x = (((x)->fld[1]).rtx))
    if ((((x)->fld[2]).rtx) != nextx)
      fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 647, __FUNCTION__);

  if (insn_cnt1 != insn_cnt2)
    fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 650, __FUNCTION__);
}
 ...
 case NOTE:
   switch ((((insn)->fld[5]).rtint))
     ...
     case NOTE_INSN_EH_REGION_END:
       ...
       fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 843, __FUNCTION__);
       break;
  ...
  fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 851, __FUNCTION__);
   ...
   break;
 default:
   fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 858, __FUNCTION__);
 }
    }
  insn = (((last)->fld[2]).rtx);
  delete_insn (last);
     ...
     basic_block dest;
{
   ...
   && (((src->end)->fld[9]).rtx) == e->dest->head)
 {
     ...
     fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 887, __FUNCTION__);
 }
     ...
     edge e;
{
  ...
  if (bb->count < new_count)
    new_count = bb->count;
  if (!bb->pred)
    fancy_abort ("../../../kg++fe/gnu/cfglayout.c", 930, __FUNCTION__);
