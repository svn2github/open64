...
.LFE28:
	...
	.size	__FUNCTION__.9016, 17
__FUNCTION__.9016:
	.string	"bitmap_operation"
.LC0:
	.string	"../../../kg++fe/gnu/bitmap.c"
	.text
...
.L197:
	.loc 1 642 0
	leal	__FUNCTION__.9016@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$642, 4(%esp)
