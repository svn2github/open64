...
.LCFI7:
	.loc 2 140 0
	movl	target_flags, %eax
	andl	$8192, %eax
	testl	%eax, %eax
	je	.L8
	.loc 2 141 0
	movl	$1, Target_Int_Model
.L8:
	.loc 2 142 0
	movl	target_flags, %eax
	andl	$65536, %eax
	...
	je	.L10
	.loc 2 143 0
	movl	$4321, Target_Byte_Sex
	jmp	.L13
.L10:
	.loc 2 144 0
	movl	$1234, Target_Byte_Sex
.L13:
	.loc 2 146 0
	popl	%ebp
	ret
...
.LCFI11:
	.loc 2 156 0
	movl	Target_Int_Model, %eax
	leal	0(,%eax,4), %edx
	leal	0(,%edx,8), %eax
	subl	%edx, %eax
	movl	C_Int_Model+24(%eax), %eax
	.loc 2 157 0
	popl	%ebp
	ret
.LFE9:
...
.LCFI15:
	...
	leal	0(,%edx,8), %eax
	subl	%edx, %eax
	movl	C_Int_Model+24(%eax), %edx
	movl	%edx, %eax
	addl	%eax, %eax
	addl	%edx, %eax
	sall	$3, %eax
	movzwl	Machine_Types+2(%eax), %eax
	cmpw	$32, %ax
	sete	%al
	movzbl	%al, %eax
	movl	%eax, Use_32_Bit_Pointers
	.loc 2 169 0
	popl	%ebp
	ret
.LFE11:
