...
.LC1:
	...
	.align 4
	.type	isa_subset_names, @object
	.size	isa_subset_names, 8
isa_subset_names:
	.long	.LC0
	.long	.LC1
.globl ISA_SUBSET_Value
	.data
	.align 4
	.type	ISA_SUBSET_Value, @object
	.size	ISA_SUBSET_Value, 4
ISA_SUBSET_Value:
	.long	1
	.text
.globl ISA_SUBSET_Name
	.type	ISA_SUBSET_Name, @function
ISA_SUBSET_Name:
.LFB2:
	.file 1 "targ_isa_subset.c"
	.loc 1 9 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
.LCFI1:
	...
	.loc 1 10 0
	movl	8(%ebp), %eax
	movl	isa_subset_names@GOTOFF(%ecx,%eax,4), %eax
	.loc 1 11 0
	popl	%ebp
	ret
.LFE2:
	.size	ISA_SUBSET_Name, .-ISA_SUBSET_Name
	.section	.rodata
	.align 32
	.type	isa_subset_opcode_table, @object
	.size	isa_subset_opcode_table, 192
isa_subset_opcode_table:
	.byte	-1
	.byte	-1
	.byte	-1
	.byte	-1
	...
	.zero	95
	.text
.globl ISA_SUBSET_Member
	.type	ISA_SUBSET_Member, @function
ISA_SUBSET_Member:
.LFB3:
	.loc 1 116 0
	pushl	%ebp
...
.LCFI6:
	...
	movl	8(%ebp), %edx
	movl	-20(%ebp), %esi
	leal	isa_subset_opcode_table@GOTOFF(%ebx), %ecx
	movl	%edx, %eax
	addl	%eax, %eax
	addl	%edx, %eax
	sall	$5, %eax
	...
	ret
.LFE3:
	.size	ISA_SUBSET_Member, .-ISA_SUBSET_Member
...
.LLST1:
	...
	.byte	0x7
	.uleb128 0xd
	.string	"isa_subset_names"
	.byte	0x1
	.byte	0x4
	.long	0x35c2
	.byte	0x5
	.byte	0x3
	.long	isa_subset_names
	.uleb128 0xc
	.long	0x358d
	.uleb128 0xe
	.long	0x35dd
	...
	.byte	0x0
	.uleb128 0xd
	.string	"isa_subset_opcode_table"
	.byte	0x1
	.byte	0xc
	.long	0x3602
	.byte	0x5
	.byte	0x3
	.long	isa_subset_opcode_table
	.uleb128 0xc
	.long	0x35c7
	.uleb128 0x10
