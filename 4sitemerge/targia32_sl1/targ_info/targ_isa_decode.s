...
.Ltext0:
	.section	.rodata
	.align 2
	.type	state_unit_tab, @object
	.size	state_unit_tab, 16
state_unit_tab:
	.value	764
	.value	764
	.value	764
	...
	.value	764
	.text
.globl ISA_Decode_Inst
	.type	ISA_Decode_Inst, @function
ISA_Decode_Inst:
.LFB28:
	.file 1 "targ_isa_decode.c"
	.loc 1 12 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LCFI2:
	...
	.loc 1 16 0
	movl	-4(%ebp), %eax
	movzwl	state_unit_tab@GOTOFF(%ecx,%eax,2), %eax
	movzwl	%ax, %eax
	movl	%eax, -8(%ebp)
	.loc 1 17 0
	movl	-8(%ebp), %eax
	...
	ret
.LFE28:
	.size	ISA_Decode_Inst, .-ISA_Decode_Inst
...
.LEFDE0:
	.file 2 "topcode.h"
	.file 3 "targ_isa_pack.h"
	.file 4 "targ_isa_bundle.h"
