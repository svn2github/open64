...
extern INT ISA_SUBSET_Member( ISA_SUBSET subset,
                              TOP opcode );
# 3 "targ_isa_hazards.c" 2
# 1 "targ_isa_hazards.h" 1
# 84 "targ_isa_hazards.h"
typedef enum {
  ISA_HAZARD_result,
  ISA_HAZARD_operand,
  ISA_HAZARD_errata,
...
# 4 "targ_isa_hazards.c" 2

ISA_HAZARD_INFO ISA_HAZARD_hazard_info[1] = {
  { ISA_HAZARD_UNDEFINED, 0, 0, 0, 0x00, 0 },
};

mUINT8 ISA_HAZARD_hazard_index[764] = {
    0,
    0,
    0,
    0,
