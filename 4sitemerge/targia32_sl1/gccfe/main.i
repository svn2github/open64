...
# 46 "../../kgccfe/main.c" 2
# 1 "../../kgccfe/wfe_misc.h" 1
# 49 "../../kgccfe/wfe_misc.h"
typedef int INT;
...
# 47 "../../kgccfe/main.c" 2
# 1 "../../common/com/glob.h" 1
# 83 "../../common/com/glob.h"
struct bb;
struct symtab;
...
struct st;
# 100 "../../common/com/glob.h"
extern char *Cur_PU_Name;
extern char *Orig_PU_Name;
...
extern char *Output_h_File_Name;
extern FILE *Output_h_File;
...
extern char *Lst_File_Name;
extern char *Err_File_Name;
extern char *Trc_File_Name;
extern char *Tlog_File_Name;
extern char *Irb_File_Name;
extern char *IR_File_Name;
extern char *Ipa_File_Name;
extern char *Asm_File_Name;
extern char *Obj_File_Name;
extern char *call_graph_file_name;
extern char *cord_output_file_name;
extern char *cord_obj_file_name;
extern char *Instrumentation_File_Name;
extern char *Feedback_File_Name;

extern char *Lib_File_Name;

extern char *Lib_Lock_Name;
extern char *DSTdump_File_Name;
extern char *Global_File_Name;

extern char *License_File_Name ;
...
extern FILE *Trc_File;
extern FILE *Tlog_File;
extern FILE *Irb_File;
extern FILE *IR_File;
extern FILE *Ipa_File;
extern FILE *Asm_File;
extern FILE *Obj_File;
extern FILE *Lib_File;
extern FILE *Tim_File;
# 180 "../../common/com/glob.h"
extern INT32 Num_Source_Files;


extern BOOL Assembly;
extern BOOL Object_Code;
extern BOOL Symbol_Table_Out;
extern BOOL Create_Cycle_Output;
  ...
  char **envp)
{
 ...
 WFE_Init (argc, argv, envp);
 WFE_File_Init (argc, argv);

 if (Orig_Src_File_Name == ((void *)0)) {
  exit (0);
 }
