# 1 "../../kgccfe/c_int_model.c"
# 1 "/usa/handong/simplnano/cmplr-open64-merge/targia32_sl1/gccfe//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../kgccfe/c_int_model.c"
# 56 "../../kgccfe/c_int_model.c"
# 1 "../../include/gnu/ansidecl.h" 1
# 57 "../../kgccfe/c_int_model.c" 2
# 1 "../../common/com/defs.h" 1
# 82 "../../common/com/defs.h"
...
# 1 "../../linux/include/stddef.h" 1 3 4
# 205 "../../linux/include/stddef.h" 3 4
...
# 1 "../../linux/include/stddef.h" 1 3 4
# 290 "../../linux/include/stddef.h" 3 4
typedef int wchar_t;
# 315 "../../linux/include/stddef.h" 3 4
...
# 84 "../../common/com/defs.h" 2
# 1 "../../linux/include/stddef.h" 1
# 153 "../../linux/include/stddef.h"
typedef int ptrdiff_t;
# 85 "../../common/com/defs.h" 2
...
# 86 "../../common/com/defs.h" 2
# 1 "../include/bstring.h" 1
# 87 "../../common/com/defs.h" 2
...
# 92 "../../common/com/defs.h" 2
# 230 "../../common/com/defs.h"
...
# 374 "../../common/com/defs.h"
__inline__ INT Max(INT i, INT j)
{
  return ((i>=j)?i:j);
}
__inline__ INT Min(INT i, INT j)
{
  return ((i<=j)?i:j);
}
# 58 "../../kgccfe/c_int_model.c" 2
# 1 "../../kgccfe/c_int_model.h" 1
# 73 "../../kgccfe/c_int_model.h"
# 1 "../../common/com/mtypes.h" 1
# 157 "../../common/com/mtypes.h"
typedef UINT8 TYPE_ID;
typedef mUINT8 mTYPE_ID;
# 178 "../../common/com/mtypes.h"
...
# 251 "../../common/com/mtypes.h"
typedef UINT32 MTYPE_MASK;
# 263 "../../common/com/mtypes.h"
extern MTYPE_MASK Machine_Types_Available;
# 287 "../../common/com/mtypes.h"
...
# 60 "../../kgccfe/c_int_model.c" 2

# 1 "../../kgccfe/gnu_config.h" 1
# 43 "../../kgccfe/gnu_config.h"
...
# 44 "../../kgccfe/gnu_config.h" 2
# 62 "../../kgccfe/c_int_model.c" 2
# 1 "../../common/com/config.h" 1
# 262 "../../common/com/config.h"
# 1 "../../common/com/config_host.h" 1
# 98 "../../common/com/config_host.h"
...
# 263 "../../common/com/config.h" 2
# 1 "../../common/com/MIPS/config_targ.h" 1
# 264 "../../common/com/config.h" 2
...
# 441 "../../common/util/mempool.h"
# 1 "../../common/com/defs.h" 1
# 442 "../../common/util/mempool.h" 2
...
# 270 "../../common/com/config.h" 2
# 1 "../../common/util/flags.h" 1
# 282 "../../common/util/flags.h"
extern char Cmdname[];
...
# 271 "../../common/com/config.h" 2
# 311 "../../common/com/config.h"
# 1 "../../common/com/language.h" 1
# 70 "../../common/com/language.h"
typedef enum {
  LANG_UNKNOWN,
  LANG_F77,
  LANG_F90,
...
void Initialize_C_Int_Model( void ) {
  ...
  if ((target_flags & 0x00010000))
    Target_Byte_Sex = 4321;
  else Target_Byte_Sex = 1234;
...
{
  return (C_Int_Model[Target_Int_Model].mtype_pointer);
}

TYPE_ID FE_int_To_Mtype( void )
{
  return (C_Int_Model[Target_Int_Model].mtype_int);
}
...
{
   Use_32_Bit_Pointers =
     (Machine_Types[(C_Int_Model[Target_Int_Model].mtype_pointer)].bit_size) == 32;
}
