...
# 46 "../../../kgccfe/gnu/dwarf2asm.c" 2
# 57 "../../../kgccfe/gnu/dwarf2asm.c"
void
     ...
     rtx x;
{
 ...
 fprintf (asm_out_file, "0x%llx", (((x)->fld[0]).rtwint));
      else
...
void
dw2_asm_output_data (int size, unsigned long long value, const char *comment, ...)

{
  { va_list ap; __builtin_va_start(ap,comment); { struct Qdmy;
  struct Qdmy;
  struct Qdmy;
  struct Qdmy;

  if (size * 8 < (8 * 8))
    value &= ~(~(unsigned long long) 0 << (size * 8));

  dw2_assemble_integer (size, gen_rtx_CONST_INT (VOIDmode, (long long) (value)));
...
void
dw2_asm_output_delta (int size, const char *lab1, const char *lab2, const char *comment, ...)

{
  ...
  dw2_assemble_integer (size,
   gen_rtx_fmt_ee (MINUS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (lab1))), (gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (lab2)))));
...
void
dw2_asm_output_offset (int size, const char *label, const char *comment, ...)

{
  ...
  dw2_assemble_integer (size, gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (label)));
...
void
dw2_asm_output_pcrel (int size __attribute__ ((__unused__)), const char *label __attribute__ ((__unused__)), const char *comment, ...)
...

{
  ...
  dw2_assemble_integer (size,
   gen_rtx_fmt_ee (MINUS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (label))), ((global_rtl[GR_PC]))));
...
void
dw2_asm_output_addr (int size, const char *label, const char *comment, ...)
...
void
dw2_asm_output_addr_rtx (int size, rtx addr, const char *comment, ...)
...
void
dw2_asm_output_nstring (const char *str, size_t orig_len, const char *comment, ...)

{
 ...
 len += 1;
      mips_output_ascii (asm_out_file, str, len);
      if (orig_len != (size_t) -1)
     ...
     int encoding;
{
  ...
  switch (encoding & 0x07)
    {
    case 0x00:
      return ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32) / 8;
    case 0x02:
      return 2;
    case 0x03:
      return 4;
  ...
  fancy_abort ("../../../kgccfe/gnu/dwarf2asm.c", 355, __FUNCTION__);
}
     ...
     int format;
{
  ...
  [0x00 | 0x10] = "pcrel",
  [0x01 | 0x10] = "pcrel uleb128",
  [0x02 | 0x10] = "pcrel udata2",
  [0x03 | 0x10] = "pcrel udata4",
  [0x04 | 0x10] = "pcrel udata8",
  [0x09 | 0x10] = "pcrel sleb128",
  [0x0A | 0x10] = "pcrel sdata2",
  [0x0B | 0x10] = "pcrel sdata4",
  [0x0C | 0x10] = "pcrel sdata8",

  [0x00 | 0x20] = "textrel",
  [0x01 | 0x20] = "textrel uleb128",
  [0x02 | 0x20] = "textrel udata2",
  [0x03 | 0x20] = "textrel udata4",
  [0x04 | 0x20] = "textrel udata8",
  [0x09 | 0x20] = "textrel sleb128",
  [0x0A | 0x20] = "textrel sdata2",
  [0x0B | 0x20] = "textrel sdata4",
  [0x0C | 0x20] = "textrel sdata8",

  [0x00 | 0x30] = "datarel",
  [0x01 | 0x30] = "datarel uleb128",
  [0x02 | 0x30] = "datarel udata2",
  [0x03 | 0x30] = "datarel udata4",
  [0x04 | 0x30] = "datarel udata8",
  [0x09 | 0x30] = "datarel sleb128",
  [0x0A | 0x30] = "datarel sdata2",
  [0x0B | 0x30] = "datarel sdata4",
  [0x0C | 0x30] = "datarel sdata8",

  [0x00 | 0x40] = "funcrel",
  [0x01 | 0x40] = "funcrel uleb128",
  [0x02 | 0x40] = "funcrel udata2",
  [0x03 | 0x40] = "funcrel udata4",
  [0x04 | 0x40] = "funcrel udata8",
  [0x09 | 0x40] = "funcrel sleb128",
  [0x0A | 0x40] = "funcrel sdata2",
  [0x0B | 0x40] = "funcrel sdata4",
  [0x0C | 0x40] = "funcrel sdata8",

  [0x80 | 0x00 | 0x10] = "indirect pcrel",

  [0x80 | 0x01 | 0x10] = "indirect pcrel uleb128",

  [0x80 | 0x02 | 0x10] = "indirect pcrel udata2",

  [0x80 | 0x03 | 0x10] = "indirect pcrel udata4",

  [0x80 | 0x04 | 0x10] = "indirect pcrel udata8",

  [0x80 | 0x09 | 0x10] = "indirect pcrel sleb128",

  [0x80 | 0x0A | 0x10] = "indirect pcrel sdata2",

  [0x80 | 0x0B | 0x10] = "indirect pcrel sdata4",

  [0x80 | 0x0C | 0x10] = "indirect pcrel sdata8",


  [0x80 | 0x00 | 0x20] = "indirect textrel",

  [0x80 | 0x01 | 0x20] = "indirect textrel uleb128",

  [0x80 | 0x02 | 0x20] = "indirect textrel udata2",

  [0x80 | 0x03 | 0x20] = "indirect textrel udata4",

  [0x80 | 0x04 | 0x20] = "indirect textrel udata8",

  [0x80 | 0x09 | 0x20] = "indirect textrel sleb128",

  [0x80 | 0x0A | 0x20] = "indirect textrel sdata2",

  [0x80 | 0x0B | 0x20] = "indirect textrel sdata4",

  [0x80 | 0x0C | 0x20] = "indirect textrel sdata8",


  [0x80 | 0x00 | 0x30] = "indirect datarel",

  [0x80 | 0x01 | 0x30] = "indirect datarel uleb128",

  [0x80 | 0x02 | 0x30] = "indirect datarel udata2",

  [0x80 | 0x03 | 0x30] = "indirect datarel udata4",

  [0x80 | 0x04 | 0x30] = "indirect datarel udata8",

  [0x80 | 0x09 | 0x30] = "indirect datarel sleb128",

  [0x80 | 0x0A | 0x30] = "indirect datarel sdata2",

  [0x80 | 0x0B | 0x30] = "indirect datarel sdata4",

  [0x80 | 0x0C | 0x30] = "indirect datarel sdata8",


  [0x80 | 0x00 | 0x40] = "indirect funcrel",

  [0x80 | 0x01 | 0x40] = "indirect funcrel uleb128",

  [0x80 | 0x02 | 0x40] = "indirect funcrel udata2",

  [0x80 | 0x03 | 0x40] = "indirect funcrel udata4",

  [0x80 | 0x04 | 0x40] = "indirect funcrel udata8",

  [0x80 | 0x09 | 0x40] = "indirect funcrel sleb128",

  [0x80 | 0x0A | 0x40] = "indirect funcrel sdata2",

  [0x80 | 0x0B | 0x40] = "indirect funcrel sdata4",

  [0x80 | 0x0C | 0x40] = "indirect funcrel sdata8",



  };

  if (format < 0 || format > 0xff || format_names[format] == ((void *)0))
    fancy_abort ("../../../kgccfe/gnu/dwarf2asm.c", 509, __FUNCTION__);
...
void
dw2_asm_output_data_uleb128 (unsigned long long value, const char *comment, ...)

{
  ...
  fprintf (asm_out_file, "0x%llx", value);
...
void
dw2_asm_output_data_sleb128 (long long value, const char *comment, ...)

{
  ...
  fprintf (asm_out_file, "%lld", value);
...
void
dw2_asm_output_delta_uleb128 (const char *lab1 __attribute__ ((__unused__)), const char *lab2 __attribute__ ((__unused__)), const char *comment, ...)
...
void
dw2_asm_output_delta_sleb128 (const char *lab1 __attribute__ ((__unused__)), const char *lab2 __attribute__ ((__unused__)), const char *comment, ...)
...
static int mark_indirect_pool_entry (splay_tree_node, void *);
static void mark_indirect_pool (void * arg);
static rtx dw2_force_const_mem (rtx);
static int dw2_output_indirect_constant_1 (splay_tree_node, void *);

static splay_tree indirect_pool;
# 717 "../../../kgccfe/gnu/dwarf2asm.c"
static int
mark_indirect_pool_entry (node, data)
     splay_tree_node node;
     void* data __attribute__ ((__unused__));
{
  do { if ((tree) node->value != ((void *)0)) gt_ggc_mx_lang_tree_node ((tree) node->value); } while (0);
  return 0;
}
...
{
  splay_tree_foreach (indirect_pool, mark_indirect_pool_entry, ((void *)0));
}
     ...
     rtx x;
{
  ...
  if (! indirect_pool)
    {
      indirect_pool = splay_tree_new (splay_tree_compare_pointers, ((void *)0), ((void *)0));
      ggc_add_root (&indirect_pool, 1, sizeof indirect_pool, mark_indirect_pool);
    }

  if (((enum rtx_code) (x)->code) != SYMBOL_REF)
    fancy_abort ("../../../kgccfe/gnu/dwarf2asm.c", 755, __FUNCTION__);

  str = (* targetm.strip_name_encoding) ((((x)->fld[0]).rtstr));
  ...
  if (node)
  ...
  else
    {
      ...
      if (1)
 {
   char *ref_name = __builtin_alloca(strlen (str) + sizeof "DW.ref.");

   sprintf (ref_name, "DW.ref.%s", str);
   id = (__builtin_constant_p (ref_name) ? get_identifier_with_length ((ref_name), (unsigned) strlen (ref_name)) : (get_identifier) (ref_name));
   decl = build_decl (VAR_DECL, id, global_trees[TI_PTR_TYPE]);
      ...
      else
 {
   ...
   ++const_labelno;
   id = (__builtin_constant_p (label) ? get_identifier_with_length ((label), (unsigned) strlen (label)) : (get_identifier) (label));
   decl = build_decl (VAR_DECL, id, global_trees[TI_PTR_TYPE]);
   ((decl)->decl.artificial_flag) = 1;
     ...
     void* data __attribute__ ((__unused__));
{
  ...
  sym_ref = gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (sym));
  if (1)
    fprintf (asm_out_file, "\t.hidden DW.ref.%s\n", sym);
  assemble_variable ((tree) node->value, 1, 1, 1);
  assemble_integer (sym_ref, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32) / 8, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32), 1);
...
void
dw2_asm_output_encoded_addr_rtx (int encoding, rtx addr, const char *comment, ...)
  ...
  if (encoding == 0x50)
    {
      ...
      assemble_integer (addr, size, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32), 1);
      return;
    }
...
# 872 "../../../kgccfe/gnu/dwarf2asm.c"
 ...
 case 0x10:
   if (((enum rtx_code) (addr)->code) != SYMBOL_REF)
     fancy_abort ("../../../kgccfe/gnu/dwarf2asm.c", 892, __FUNCTION__);



   dw2_assemble_integer (size, gen_rtx_fmt_ee (MINUS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (addr), ((global_rtl[GR_PC]))));
 ...
 default:
   ...
   fancy_abort ("../../../kgccfe/gnu/dwarf2asm.c", 903, __FUNCTION__);
 }
