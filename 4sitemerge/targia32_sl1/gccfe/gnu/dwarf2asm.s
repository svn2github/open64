...
.LFE24:
	...
	.size	__FUNCTION__.12291, 22
__FUNCTION__.12291:
	.string	"size_of_encoded_value"
	.align 4
.LC6:
	.string	"../../../kgccfe/gnu/dwarf2asm.c"
	.text
...
.LFE25:
	...
	.section	.rodata
	.type	__FUNCTION__.12312, @object
	.size	__FUNCTION__.12312, 20
__FUNCTION__.12312:
...
.LC89:
	...
	.align 32
	.type	format_names.12311, @object
	.size	format_names.12311, 1024
format_names.12311:
	.long	.LC7
	.long	.LC8
	.long	.LC9
...
.LCFI49:
	...
	jg	.L118
	movl	8(%ebp), %eax
	movl	format_names.12311@GOTOFF(%ebx,%eax,4), %eax
	testl	%eax, %eax
	jne	.L121
.L118:
	.loc 1 509 0
	leal	__FUNCTION__.12312@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$509, 4(%esp)
	leal	.LC6@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L150:
	...
	je	.L152
	.loc 1 755 0
	leal	__FUNCTION__.12433@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$755, 4(%esp)
	leal	.LC6@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE35:
	...
	.section	.rodata
	.align 32
	.type	__FUNCTION__.12544, @object
	.size	__FUNCTION__.12544, 32
__FUNCTION__.12544:
...
.L202:
	...
	je	.L203
	.loc 1 892 0
	leal	__FUNCTION__.12544@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$892, 4(%esp)
	leal	.LC6@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
