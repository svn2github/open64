...
# 34 "../../../kgccfe/gnu/ra-rewrite.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 35 "../../../kgccfe/gnu/ra-rewrite.c" 2
 ...
 if ((((spilled)->elms [(s->id) / ((unsigned) (8 * 8))] >> (s->id) % ((unsigned) (8 * 8)) & 1) && ((coalesce)->elms [(t->id) / ((unsigned) (8 * 8))] >> (t->id) % ((unsigned) (8 * 8)) & 1))
  ...
  || s->pattern || t->pattern)
     ...
     if (s == t)
       ...
       continue;
# 122 "../../../kgccfe/gnu/ra-rewrite.c"
     if (t->type != SPILLED || s->type != SPILLED)
       fancy_abort ("../../../kgccfe/gnu/ra-rewrite.c", 123, __FUNCTION__);
     ...
     rtx s1, s2;
{
 ...
 return 0;
  ...
  if (((enum rtx_code) (s1)->code) != MEM || ((enum rtx_code) (s2)->code) != MEM)
    fancy_abort ("../../../kgccfe/gnu/ra-rewrite.c", 585, __FUNCTION__);
  s1 = (((s1)->fld[0]).rtx);
  s2 = (((s2)->fld[0]).rtx);
     ...
     rtx last_block_insn;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/ra-rewrite.c", 904, __FUNCTION__);
      ...
      if (supweb->pattern)
 {
   ...
   if (aweb != supweb)
     fancy_abort ("../../../kgccfe/gnu/ra-rewrite.c", 931, __FUNCTION__);
   slot = copy_rtx (supweb->pattern);
   reg = copy_rtx (supweb->orig_x);


   if (reg != supweb->orig_x)
     fancy_abort ("../../../kgccfe/gnu/ra-rewrite.c", 937, __FUNCTION__);
 }
      else
 {
   allocate_spill_web (aweb);
...
# 1422 "../../../kgccfe/gnu/ra-rewrite.c"
   bitmap_operation (ri.need_reload, ri.need_reload, ri.scratch,
      ...
      emit_loads (&ri, nl_first_reload, last_block_insn);
      if (ri.nl_size != 0 )
 fancy_abort ("../../../kgccfe/gnu/ra-rewrite.c", 1429, __FUNCTION__);
      if (!insn)
 break;
    }
     ...
     struct df *df;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/ra-rewrite.c", 1713, __FUNCTION__);
