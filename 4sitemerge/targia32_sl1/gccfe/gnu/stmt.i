...
# 51 "../../../kgccfe/gnu/stmt.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 52 "../../../kgccfe/gnu/stmt.c" 2
...
# 55 "../../../kgccfe/gnu/stmt.c" 2
# 1 "../../../kgccfe/gnu/loop.h" 1
# 22 "../../../kgccfe/gnu/loop.h"
...
# 24 "../../../kgccfe/gnu/loop.h" 2

# 1 "../../../kgccfe/gnu/basic-block.h" 1
# 27 "../../../kgccfe/gnu/basic-block.h"
...
# 26 "../../../kgccfe/gnu/loop.h" 2
# 66 "../../../kgccfe/gnu/loop.h"
enum g_types
{
  DEST_ADDR,
  DEST_REG
...
# 57 "../../../kgccfe/gnu/stmt.c" 2
# 1 "../../../kgccfe/gnu/machmode.h" 1
# 58 "../../../kgccfe/gnu/stmt.c" 2
...
# 62 "../../../kgccfe/gnu/stmt.c" 2
# 1 "../../../kgccfe/gnu/predict.h" 1
# 23 "../../../kgccfe/gnu/predict.h"
enum br_predictor
{
# 1 "../../../kgccfe/gnu/predict.def" 1
# 40 "../../../kgccfe/gnu/predict.def"
PRED_COMBINED,
...
# 63 "../../../kgccfe/gnu/stmt.c" 2



# 1 "../../../kgccfe/gnu/defaults.h" 1
# 67 "../../../kgccfe/gnu/stmt.c" 2
...
# 69 "../../../kgccfe/gnu/stmt.c" 2
# 1 "../../../kgccfe/wfe_expr.h" 1
# 59 "../../../kgccfe/wfe_expr.h"
...
static _Bool parse_input_constraint (const char **, int, int, int, int, const char * const *, _Bool *, _Bool *);


static _Bool decl_conflicts_with_clobbers_p (tree, const HARD_REG_SET);
...
static _Bool check_operand_nalternatives (tree, tree);
static _Bool check_unique_operand_names (tree, tree);
static tree resolve_operand_names (tree, tree, tree, const char **);
...
init_stmt_for_function ()
{
  ...
  (cfun->stmt->x_block_stack) = 0;
  (cfun->stmt->x_stack_block_stack) = 0;
  (cfun->stmt->x_loop_stack) = 0;
  (cfun->stmt->x_case_stack) = 0;
  (cfun->stmt->x_cond_stack) = 0;
  (cfun->stmt->x_nesting_stack) = 0;
  (cfun->stmt->x_nesting_depth) = 0;

  (cfun->stmt->x_block_start_count) = 0;


  (cfun->stmt->x_goto_fixup_chain) = 0;


  (cfun->stmt->x_expr_stmts_for_value) = 0;
  clear_last_expr ();
}
...
in_control_zone_p ()
{
  return (cfun->stmt->x_cond_stack) || (cfun->stmt->x_loop_stack) || (cfun->stmt->x_case_stack);
}
     ...
     int line;
{
  ...
  if (cfun->stmt)
    {
      (cfun->stmt->x_emit_filename) = file;
      (cfun->stmt->x_emit_lineno) = line;
    }
}
     ...
     tree label;
{
  if (((enum tree_code) (label)->common.code) != LABEL_DECL)
    fancy_abort ("../../../kgccfe/gnu/stmt.c", 599, __FUNCTION__);

  if (!((label)->decl.rtl != ((void *)0)))
    ((label)->decl.rtl = (gen_label_rtx ()));
     ...
     tree exp;
{
  ...
  if (! cfun->computed_goto_common_label)
    {
      cfun->computed_goto_common_reg = copy_to_mode_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), x);
     ...
     tree label;
{
  ...
  if (((label)->decl.name))
    (((((label)->decl.rtl ? (label)->decl.rtl : (make_decl_rtl (label, ((void *)0)), (label)->decl.rtl)))->fld[7]).rtstr) = ((char *)(((label)->decl.name))->identifier.id.str);
...
declare_nonlocal_label (label)
     tree label;
{
  rtx slot = assign_stack_local ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]), 0);

  (cfun->x_nonlocal_labels) = tree_cons ((tree) ((void *)0), label, (cfun->x_nonlocal_labels));
  (((label_rtx (label)))->in_struct) = 1;
  if ((cfun->x_nonlocal_goto_handler_slots) == 0)
    {
      emit_stack_save (SAVE_NONLOCAL,
         &(cfun->x_nonlocal_goto_stack_level),
         ((((cfun->x_tail_recursion_reentry))->fld[1]).rtx));
    }
  (cfun->x_nonlocal_goto_handler_slots)
    = gen_rtx_fmt_ee (EXPR_LIST, (VOIDmode), (slot), ((cfun->x_nonlocal_goto_handler_slots)));
     ...
     tree label;
{
  ...
  if (context != 0 && context != current_function_decl)
    {
      ...
      rtx label_ref = gen_rtx_fmt_u00 (LABEL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (label_rtx (label)));
      rtx handler_slot, static_chain, save_area, insn;
      tree link;


      handler_slot = p->x_nonlocal_goto_handler_slots;
      for (link = p->x_nonlocal_labels; ((link)->list.value) != label;
    link = ((link)->common.chain))
 handler_slot = (((handler_slot)->fld[1]).rtx);
      handler_slot = (((handler_slot)->fld[0]).rtx);
 ...
 save_area = replace_rtx (copy_rtx (save_area),
     (global_rtl[GR_VIRTUAL_STACK_ARGS]), static_chain);
...

 {
   ...
   emit_move_insn ((global_rtl[GR_HARD_FRAME_POINTER]), static_chain);
   emit_stack_restore (SAVE_NONLOCAL, save_area, (rtx) 0);
      ...
      for (insn = get_last_insn (); insn; insn = (((insn)->fld[1]).rtx))
 {
   if (((enum rtx_code) (insn)->code) == JUMP_INSN)
     {
       (((insn)->fld[8]).rtx) = alloc_EXPR_LIST (REG_NON_LOCAL_GOTO,
        (const_int_rtx[64]), (((insn)->fld[8]).rtx));
       break;
     }
     ...
     rtx last_insn;
{
  ...
  if (((enum rtx_code) (label)->code) != CODE_LABEL)
    fancy_abort ("../../../kgccfe/gnu/stmt.c", 827, __FUNCTION__);
      ...
      for (block = (cfun->stmt->x_block_stack); block; block = block->next)
 {
   ...
   if (block->data.block.cleanups != 0)
     {
       expand_cleanups (block->data.block.cleanups, (tree) ((void *)0), 1, 1);
       do_pending_stack_adjust ();
     }
 }
 ...
 error ("jump to `%s' invalidly jumps into binding contour",
        ((char *)(((body)->decl.name))->identifier.id.str));
    }
     ...
     rtx last_insn;
{
  ...
  else if ((cfun->stmt->x_loop_stack)
      && (rtl_label == (cfun->stmt->x_loop_stack)->data.loop.start_label
   || rtl_label == (cfun->stmt->x_loop_stack)->data.loop.end_label
   || rtl_label == (cfun->stmt->x_loop_stack)->data.loop.continue_label))
    end_block = (cfun->stmt->x_loop_stack);
  else
    end_block = 0;
...
# 992 "../../../kgccfe/gnu/stmt.c"
 ...
 start_sequence ();
 start = emit_note (((void *)0), NOTE_INSN_BLOCK_BEG);
 if (cfun->x_whole_function_mode_p)
   (((start)->fld[4]).rttree) = block;
 fixup->before_jump = emit_note (((void *)0), NOTE_INSN_DELETED);
 end = emit_note (((void *)0), NOTE_INSN_BLOCK_END);
 if (cfun->x_whole_function_mode_p)
   (((end)->fld[4]).rttree) = block;
 fixup->context = block;
 end_sequence ();
 ...
 = ((block->data.block.outer_cleanups
    ...
    ? tree_cons ((tree) ((void *)0), block->data.block.cleanups,
   block->data.block.outer_cleanups)
    : 0);
     ...
     int dont_jump_in;
{
 ...
 {
   rtx cleanup_insns;
# 1102 "../../../kgccfe/gnu/stmt.c"
   if (f->target != 0
       && (dont_jump_in || stack_level || cleanup_list)
       && (((first_insn)->fld[0]).rtint) < (((f->target_rtl)->fld[0]).rtint)
  ...
  if (((lists)->common.addressable_flag)
      && ((lists)->list.value) != 0)
    {
      expand_cleanups (((lists)->list.value), (tree) ((void *)0), 1, 1);
     ...
     int vol;
{
  ...
  if (((enum tree_code) (string)->common.code) == ADDR_EXPR)
    string = ((string)->exp.operands[0]);

  body = gen_rtx_fmt_s (ASM_INPUT, (VOIDmode), (((string)->string.pointer)));


  Wfe_Expand_Asm_Operands(string, ((void *)0), ((void *)0), ((void *)0), 1, input_filename, lineno);
 ...
 *allows_reg = 1;
 ...
 if (!(_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isalpha)))
   break;
 if (mips_char_to_class[(unsigned char)(*p)] != NO_REGS)
   *allows_reg = 1;
 ...
 *allows_mem = 1;
 ...
 if (mips_char_to_class[(unsigned char)(constraint[j])] != NO_REGS)
   *allows_reg = 1;
     ...
     const HARD_REG_SET clobbered_regs;
{
  ...
  if ((((enum tree_code) (decl)->common.code) == VAR_DECL || ((enum tree_code) (decl)->common.code) == PARM_DECL)
      ...
      && (((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[0]).rtuint) < 176)
    {
      rtx reg = ((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl));
      unsigned int regno;

      for (regno = (((reg)->fld[0]).rtuint);
    regno < ((((reg)->fld[0]).rtuint)
      + mips_hard_regno_nregs ((((reg)->fld[0]).rtuint), ((enum machine_mode) (reg)->mode)));
    regno++)
 if ((!!((clobbered_regs)[(regno) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8)))))))
   {
     ...
     int line;
{
  ...
  int *inout_opnum = (int *) __builtin_alloca(noutputs * sizeof (int));
  rtx *real_output_rtx = (rtx *) __builtin_alloca(noutputs * sizeof (rtx));
  enum machine_mode *inout_mode
    = (enum machine_mode *) __builtin_alloca(noutputs * sizeof (enum machine_mode));
  const char **constraints
    = (const char **) __builtin_alloca((noutputs + ninputs) * sizeof (const char *));
  ...
  Wfe_Expand_Asm_Operands (string, outputs, inputs, clobbers, vol,
                           filename, line);
# 1650 "../../../kgccfe/gnu/stmt.c"
  nclobbers = 0;
  do { HARD_REG_ELT_TYPE *scan_tp_ = (clobbered_regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
  for (tail = clobbers; tail; tail = ((tail)->common.chain))
    {
      const char *regname = ((((tail)->list.value))->string.pointer);
 ...
 error ("unknown register name `%s' in `asm'", regname);
      ...
      if (i >= 0)
 ((clobbered_regs)[(i) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))));
    }
 ...
 ninout++;
  ...
  for (i = 0, tail = inputs; tail; i++, tail = ((tail)->common.chain))
    {
      _Bool allows_reg, allows_mem;
      const char *constraint;



      if (((((tail)->list.value))->common.type) == global_trees[TI_ERROR_MARK])
 return;
 ...
 (*lang_hooks.mark_addressable) (((tail)->list.value));
    }
  ...
  for (i = 0, tail = outputs; tail; tail = ((tail)->common.chain), i++)
    {
      ...
      if (!parse_output_constraint (&constraints[i], i, ninputs,
        ...
        &is_inout))
 fancy_abort ("../../../kgccfe/gnu/stmt.c", 1746, __FUNCTION__);
      ...
      else
 {
   ...
   op = validize_mem (op);
   ((tail)->list.value) = make_tree (type, op);
 }
      output_rtx[i] = op;
 ...
 clobber_conflict_found = 1;
  ...
  body = gen_rtx_fmt_ssiEEsi (ASM_OPERANDS, ((noutputs == 0 ? VOIDmode : ((enum machine_mode) (output_rtx[0])->mode))), (((string)->string.pointer)), (empty_string), (0), (argvec), (constraintvec), (filename), (line));
  ...
  for (i = 0, tail = inputs; tail; tail = ((tail)->common.chain), ++i)
    {
      ...
      if (! parse_input_constraint (&constraint, i, ninputs, noutputs, ninout,
        constraints, &allows_mem, &allows_reg))
 fancy_abort ("../../../kgccfe/gnu/stmt.c", 1827, __FUNCTION__);
      ...
      if (asm_operand_ok (op, constraint) <= 0)
 {
   if (allows_reg)
   ...
   else
     {
       ...
       if ((((enum rtx_code) (op)->code) == LABEL_REF || ((enum rtx_code) (op)->code) == SYMBOL_REF || ((enum rtx_code) (op)->code) == CONST_INT || ((enum rtx_code) (op)->code) == CONST_DOUBLE || ((enum rtx_code) (op)->code) == CONST || ((enum rtx_code) (op)->code) == HIGH || ((enum rtx_code) (op)->code) == CONST_VECTOR || ((enum rtx_code) (op)->code) == CONSTANT_P_RTX))
  {
    op = force_const_mem (((type)->type.mode), op);
    op = validize_mem (op);
  }
       else if (((enum rtx_code) (op)->code) == REG
         || ((enum rtx_code) (op)->code) == SUBREG
         || ((enum rtx_code) (op)->code) == ADDRESSOF
         || ((enum rtx_code) (op)->code) == CONCAT)
  {
    ...
    op = memloc;
      ...
      generating_concat_p = old_generating_concat_p;
      (((((body)->fld[3]).rtvec))->elem[i]) = op;

      (((((body)->fld[4]).rtvec))->elem[i])
 ...
 clobber_conflict_found = 1;
  ...
  for (i = 0; i < ninputs - ninout; i++)
    (((((body)->fld[3]).rtvec))->elem[i])
      = protect_from_queue ((((((body)->fld[3]).rtvec))->elem[i]), 0);
  ...
  for (i = 0; i < ninout; i++)
    {
      ...
      (((((body)->fld[3]).rtvec))->elem[ninputs - ninout + i])
 = output_rtx[j];

      sprintf (buffer, "%d", j);
      (((((body)->fld[4]).rtvec))->elem[ninputs - ninout + i])
 = gen_rtx_fmt_s (ASM_INPUT, (inout_mode[i]), (ggc_alloc_string (buffer, -1)));
  ...
  if (noutputs == 1 && nclobbers == 0)
    {
      (((body)->fld[1]).rtstr) = constraints[0];
      insn = emit_insn (gen_rtx_fmt_ee (SET, (VOIDmode), (output_rtx[0]), (body)));
    }
 ...
 num = 1;
      ...
      for (i = 0, tail = outputs; tail; tail = ((tail)->common.chain), i++)
 {
   (((((body)->fld[0]).rtvec))->elem[i])
     = gen_rtx_fmt_ee (SET, (VOIDmode), (output_rtx[i]), (gen_rtx_fmt_ssiEEsi (ASM_OPERANDS, (((enum machine_mode) (output_rtx[i])->mode)), (((string)->string.pointer)), (constraints[i]), (i), (argvec), (constraintvec), (filename), (line))));
   ...
   (((((((((((body)->fld[0]).rtvec))->elem[i]))->fld[1]).rtx)))->volatil) = vol;
 }
     ...
     tree outputs, inputs;
{
  if (outputs || inputs)
    {
      ...
      int nalternatives
 = n_occurrences (',', ((((tmp)->list.value))->string.pointer));
      tree next = inputs;
 ...
 {
   const char *constraint
     = ((((((tmp)->list.purpose))->list.value))->string.pointer);
     ...
     tree outputs, inputs;
{
 ...
 failure:
  ...
  ((((((i)->list.purpose))->list.purpose))->string.pointer));
  return 0;
}
...
{
  char *buffer = xstrdup (((string)->string.pointer));
  char *p;
  tree t;
      ...
      else
 {
  ...
  for (t = outputs; t ; t = ((t)->common.chain), pconstraints++)
    *pconstraints = ((((((t)->list.purpose))->list.value))->string.pointer);


  for (t = inputs; t ; t = ((t)->common.chain), pconstraints++)
    {
      const char *c = ((((((t)->list.purpose))->list.value))->string.pointer);
      if (strchr (c, '[') == ((void *)0))
 *pconstraints = c;
      else
 {
     ...
     tree outputs, inputs;
{
  ...
  for (op = 0, t = outputs; t ; t = ((t)->common.chain), op++)
    {
      ...
      if (name)
 {
   const char *c = ((name)->string.pointer);
 ...
 found:
  ...
  if (p > q)
    fancy_abort ("../../../kgccfe/gnu/stmt.c", 2241, __FUNCTION__);
     ...
     int want_value, maybe_last;
{
  ...
  if (want_value == -1)
    want_value = (cfun->stmt->x_expr_stmts_for_value) != 0;




  if (! want_value
      && ((cfun->stmt->x_expr_stmts_for_value) == 0 || ! maybe_last)
      && exp != global_trees[TI_ERROR_MARK])
    {
      if (! ((exp)->common.side_effects_flag))
 {
   if ((extra_warnings || warn_unused_value)
       && !(((enum tree_code) (exp)->common.code) == CONVERT_EXPR
     && (((enum tree_code) (((exp)->common.type))->common.code) == VOID_TYPE)))
     warning_with_file_and_line ((cfun->stmt->x_emit_filename), (cfun->stmt->x_emit_lineno),
 ...
 warn_if_unused_value (exp);
  ...
  if (want_value && ((enum tree_code) (((exp)->common.type))->common.code) == FUNCTION_TYPE)
    exp = build1 (ADDR_EXPR, build_pointer_type (((exp)->common.type)), exp);




  value = expand_expr (exp, want_value ? (rtx) 0 : (const_int_rtx[64]),
         VOIDmode, 0);
  type = ((exp)->common.type);



  if (value && ((enum rtx_code) (value)->code) == MEM && ((exp)->common.volatile_flag))
    {
      ...
      else
 {
  ...
  if (want_value)
    {
      (cfun->stmt->x_last_expr_value) = value;
      (cfun->stmt->x_last_expr_type) = type;
    }
     ...
     tree exp;
{
  ...
  switch (((enum tree_code) (exp)->common.code))
    ...
    case BIND_EXPR:
      ...
      return warn_if_unused_value (((exp)->exp.operands[1]));
 ...
 return 0;
      if (warn_if_unused_value (((exp)->exp.operands[0])))
 return 1;
 ...
 return warn_if_unused_value (((exp)->exp.operands[0]));
...
clear_last_expr ()
{
  (cfun->stmt->x_last_expr_type) = (tree) ((void *)0);
  (cfun->stmt->x_last_expr_value) = (rtx) 0;
}
# 2484 "../../../kgccfe/gnu/stmt.c"
tree
     ...
     int has_scope;
{
  ...
  (cfun->stmt->x_expr_stmts_for_value)++;

  WFE_Expand_Start_Stmt_Expr (t);

  return t;
}
# 2518 "../../../kgccfe/gnu/stmt.c"
tree
     ...
     tree t;
{
  ...
  if (! (cfun->stmt->x_last_expr_value) || ! (cfun->stmt->x_last_expr_type))
    {
      (cfun->stmt->x_last_expr_value) = (const_int_rtx[64]);
      (cfun->stmt->x_last_expr_type) = global_trees[TI_VOID_TYPE];
    }
  else if (((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) != REG && ! (((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) == LABEL_REF || ((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) == SYMBOL_REF || ((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) == CONST_INT || ((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) == CONST_DOUBLE || ((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) == CONST || ((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) == HIGH || ((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) == CONST_VECTOR || ((enum rtx_code) ((cfun->stmt->x_last_expr_value))->code) == CONSTANT_P_RTX))

    (cfun->stmt->x_last_expr_value) = protect_from_queue ((cfun->stmt->x_last_expr_value), 0);

  emit_queue ();

  ((t)->common.type) = (cfun->stmt->x_last_expr_type);
  (*(rtx *) &(t)->exp.operands[1]) = (cfun->stmt->x_last_expr_value);
  (*(rtx *) &(t)->exp.operands[0]) = get_insns ();

  (cfun->x_rtl_expr_chain) = tree_cons ((tree) ((void *)0), t, (cfun->x_rtl_expr_chain));
  ...
  ((t)->common.volatile_flag) = volatile_refs_p ((cfun->stmt->x_last_expr_value));
...
expand_start_cond (cond, exitflag)
     ...
     int exitflag;
{
  struct nesting *thiscond = (struct nesting *) ggc_alloc (sizeof (struct nesting));
...
# 2675 "../../../kgccfe/gnu/stmt.c"
struct nesting *
expand_start_loop (exit_flag)
     int exit_flag;
{
  struct nesting *thisloop = (struct nesting *) ggc_alloc (sizeof (struct nesting));


  dump_parse_tree ("start_loop", ((void *)0));




  thisloop->desc = LOOP_NESTING;
  thisloop->next = (cfun->stmt->x_loop_stack);
  thisloop->all = (cfun->stmt->x_nesting_stack);
  thisloop->depth = ++(cfun->stmt->x_nesting_depth);
  ...
  (cfun->stmt->x_loop_stack) = thisloop;
  (cfun->stmt->x_nesting_stack) = thisloop;
     ...
     int exit_flag;
{
  ...
  (cfun->stmt->x_loop_stack)->data.loop.continue_label = gen_label_rtx ();
...
expand_start_null_loop ()
{
  ...
  thisloop->all = (cfun->stmt->x_nesting_stack);
  thisloop->depth = ++(cfun->stmt->x_nesting_depth);
  thisloop->data.loop.start_label = emit_note (((void *)0), NOTE_INSN_DELETED);
  thisloop->data.loop.end_label = gen_label_rtx ();
  thisloop->data.loop.alt_end_label = (rtx) 0;
...
expand_loop_continue_here ()
{
  ...
  emit_label ((cfun->stmt->x_loop_stack)->data.loop.continue_label);
...
expand_end_loop ()
{
  rtx start_label = (cfun->stmt->x_loop_stack)->data.loop.start_label;
  rtx etc_note;
  int eh_regions, debug_blocks;


  dump_parse_tree ("end_loop", ((void *)0));
  ...
  do_pending_stack_adjust ();
# 2831 "../../../kgccfe/gnu/stmt.c"
  eh_regions = debug_blocks = 0;
  for (etc_note = start_label; etc_note ; etc_note = (((etc_note)->fld[2]).rtx))
    if (((enum rtx_code) (etc_note)->code) == NOTE)
      {
 if ((((etc_note)->fld[5]).rtint) == NOTE_INSN_LOOP_END_TOP_COND)
   break;


 else if ((((etc_note)->fld[5]).rtint) == NOTE_INSN_LOOP_BEG)
   {
     etc_note = (rtx) 0;
     break;
   }
 ...
 else if ((((etc_note)->fld[5]).rtint) == NOTE_INSN_EH_REGION_BEG)
   eh_regions++;
 else if ((((etc_note)->fld[5]).rtint) == NOTE_INSN_EH_REGION_END)
   {
     if (--eh_regions < 0)
       ...
       fancy_abort ("../../../kgccfe/gnu/stmt.c", 2859, __FUNCTION__);
   }
 ...
 else if ((((etc_note)->fld[5]).rtint) == NOTE_INSN_BLOCK_BEG)
   debug_blocks++;
 else if ((((etc_note)->fld[5]).rtint) == NOTE_INSN_BLOCK_END)
   debug_blocks--;
      }
  ...
  if (etc_note
      ...
      && ! any_condjump_p (get_last_insn ()))
    {
      ...
      if (((enum rtx_code) ((((start_move)->fld[1]).rtx))->code) == NOTE
   && ((((((start_move)->fld[1]).rtx))->fld[5]).rtint) == NOTE_INSN_LOOP_CONT)
 start_move = (((start_move)->fld[1]).rtx);
      ...
      else
 {
   ...
   for (insn = start_move; insn; insn = next_insn)
     {
       ...
       next_insn = (insn == etc_note ? ((void *)0) : (((insn)->fld[2]).rtx));

       if (((enum rtx_code) (insn)->code) == NOTE
    && ((((insn)->fld[5]).rtint) == NOTE_INSN_BLOCK_BEG
        || (((insn)->fld[5]).rtint) == NOTE_INSN_BLOCK_END))
  continue;
  ...
  emit_label ((cfun->stmt->x_loop_stack)->data.loop.end_label);

  do { struct nesting *target = (cfun->stmt->x_loop_stack); struct nesting *this; do { this = (cfun->stmt->x_nesting_stack); if ((cfun->stmt->x_loop_stack) == this) (cfun->stmt->x_loop_stack) = (cfun->stmt->x_loop_stack)->next; if ((cfun->stmt->x_cond_stack) == this) (cfun->stmt->x_cond_stack) = (cfun->stmt->x_cond_stack)->next; if ((cfun->stmt->x_block_stack) == this) (cfun->stmt->x_block_stack) = (cfun->stmt->x_block_stack)->next; if ((cfun->stmt->x_stack_block_stack) == this) (cfun->stmt->x_stack_block_stack) = (cfun->stmt->x_stack_block_stack)->next; if ((cfun->stmt->x_case_stack) == this) (cfun->stmt->x_case_stack) = (cfun->stmt->x_case_stack)->next; (cfun->stmt->x_nesting_depth) = (cfun->stmt->x_nesting_stack)->depth - 1; (cfun->stmt->x_nesting_stack) = this->all; } while (this != target); } while (0);
     ...
     struct nesting *whichloop;
{
  ...
  if (flag_guess_branch_prob)
    {
      note = emit_note (((void *)0), NOTE_INSN_PREDICTION);
      (((note)->fld[4]).rtint) = ((PRED_CONTINUE<<8)+(1));
    }
  clear_last_expr ();
  if (whichloop == 0)
    whichloop = (cfun->stmt->x_loop_stack);
  if (whichloop == 0)
    return 0;
  expand_goto_internal ((tree) ((void *)0), whichloop->data.loop.continue_label,
   (rtx) 0);
     ...
     struct nesting *whichloop;
{
  ...
  if (whichloop == 0)
    return 0;
  expand_goto_internal ((tree) ((void *)0), whichloop->data.loop.end_label, (rtx) 0);
     ...
     tree cond;
{
  ...
  do_jump (cond, (rtx) 0, label);
  last_insn = get_last_insn ();
  if (((enum rtx_code) (last_insn)->code) == CODE_LABEL)
    whichloop->data.loop.alt_end_label = last_insn;
  expand_goto_internal ((tree) ((void *)0), whichloop->data.loop.end_label,
   (rtx) 0);
  emit_label (label);
     ...
     tree cond;
{
  ...
  emit_note (((void *)0), NOTE_INSN_LOOP_END_TOP_COND);
  return 1;
}
...
stmt_loop_nest_empty ()
{
  ...
  return (cfun->stmt == ((void *)0) || (cfun->stmt->x_loop_stack) == ((void *)0));
}
# 3074 "../../../kgccfe/gnu/stmt.c"
int
preserve_subexpressions_p ()
{
  ...
  if (optimize == 0 || cfun == 0 || cfun->stmt == 0 || (cfun->stmt->x_loop_stack) == 0)
    return 0;

  insn = get_last_insn_anywhere ();

  return (insn
   && ((((insn)->fld[0]).rtint) - ((((cfun->stmt->x_loop_stack)->data.loop.start_label)->fld[0]).rtint)
       < n_non_fixed_regs * 3));

}
# 3102 "../../../kgccfe/gnu/stmt.c"
int
expand_exit_something ()
{
  struct nesting *n;
  clear_last_expr ();
  for (n = (cfun->stmt->x_nesting_stack); n; n = n->all)
    if (n->exit_label != 0)
      {

        WFE_Expand_Exit_Something (n, (cfun->stmt->x_cond_stack), (cfun->stmt->x_loop_stack), (cfun->stmt->x_case_stack),
                                   &n->exit_label_idx);

 expand_goto_internal ((tree) ((void *)0), n->exit_label, (rtx) 0);
 return 1;
      }
     ...
     rtx val;
{
 ...
 return PRED_NEGATIVE_RETURN;
      ...
      if ((((enum rtx_code) (val)->code) == LABEL_REF || ((enum rtx_code) (val)->code) == SYMBOL_REF || ((enum rtx_code) (val)->code) == CONST_INT || ((enum rtx_code) (val)->code) == CONST_DOUBLE || ((enum rtx_code) (val)->code) == CONST || ((enum rtx_code) (val)->code) == HIGH || ((enum rtx_code) (val)->code) == CONST_VECTOR || ((enum rtx_code) (val)->code) == CONSTANT_P_RTX)
     ...
     rtx val;
{
  ...
  if (flag_guess_branch_prob
      && (pred = return_prediction (val)) != PRED_NO_PREDICTION)
    {
      ...
      (((note)->fld[4]).rtint) = ((pred<<8)+(NOT_TAKEN));
...
expand_null_return_1 (last_insn)
     rtx last_insn;
{
  rtx end_label = (cfun->x_cleanup_label) ? (cfun->x_cleanup_label) : (cfun->x_return_label);
...
# 3254 "../../../kgccfe/gnu/stmt.c"
  ...
  else if ((((enum tree_code) (((retval)->common.type))->common.code) == VOID_TYPE))

    retval_rhs = retval;
  else
    retval_rhs = (tree) ((void *)0);

  last_insn = get_last_insn ();
# 3327 "../../../kgccfe/gnu/stmt.c"
...
# 3337 "../../../kgccfe/gnu/stmt.c"
  if (retval_rhs != 0
      && ((((retval_rhs)->common.type))->type.mode) == BLKmode
      && ((enum rtx_code) (result_rtl)->code) == REG)
    {
      int i;
      unsigned long long bitpos, xbitpos;
      unsigned long long big_endian_correction = 0;
      unsigned long long bytes
 = int_size_in_bytes (((retval_rhs)->common.type));
      int n_regs = (bytes + ((target_flags & 0x00002000) ? 8 : 4) - 1) / ((target_flags & 0x00002000) ? 8 : 4);
      unsigned int bitsize
 = ((((((retval_rhs)->common.type))->type.align)) < ((8 * ((target_flags & 0x00002000) ? 8 : 4))) ? (((((retval_rhs)->common.type))->type.align)) : ((8 * ((target_flags & 0x00002000) ? 8 : 4))));
      rtx *result_pseudos = (rtx *) __builtin_alloca(sizeof (rtx) * n_regs);
 ...
 big_endian_correction = ((8 * ((target_flags & 0x00002000) ? 8 : 4)) - ((bytes % ((target_flags & 0x00002000) ? 8 : 4))
        * 8));
    ...
    bitpos += bitsize, xbitpos += bitsize)
 {
   ...
   if (xbitpos % (8 * ((target_flags & 0x00002000) ? 8 : 4)) == 0
       || xbitpos == big_endian_correction)
     {
       ...
       result_pseudos[xbitpos / (8 * ((target_flags & 0x00002000) ? 8 : 4))] = dst;
   ...
   store_bit_field (dst, bitsize, xbitpos % (8 * ((target_flags & 0x00002000) ? 8 : 4)), word_mode,
      extract_bit_field (src, bitsize,
           bitpos % (8 * ((target_flags & 0x00002000) ? 8 : 4)), 1,
      ...
      for (tmpmode = class_narrowest_mode[(int) (MODE_INT)];
    tmpmode != VOIDmode;
    tmpmode = ((enum machine_mode)mode_wider_mode[(int) (tmpmode)]))

 if ((mode_size[(int) (tmpmode)]) >= bytes)
   break;


      if (tmpmode == VOIDmode)
 fancy_abort ("../../../kgccfe/gnu/stmt.c", 3417, __FUNCTION__);

      ((result_rtl)->mode = (enum machine_mode) (tmpmode));

      if ((mode_size[(int) (tmpmode)]) < (mode_size[(int) (word_mode)]))
 ...
 result_reg = gen_lowpart (tmpmode, result_reg);
        ...
        || (((enum rtx_code) (result_rtl)->code) == PARALLEL)))
    {
      ...
      tree nt = build_qualified_type (ot, ((((ot)->common.readonly_flag) * 0x1) | (((ot)->common.volatile_flag) * 0x2) | (((ot)->type.restrict_flag) * 0x4) | ((((enum tree_code) (ot)->common.code) == RECORD_TYPE && ((ot)->common.type)) * 0x8)) | 0x1);
...
drop_through_at_end_p ()
{
  ...
  while (insn && ((enum rtx_code) (insn)->code) == NOTE)
    insn = (((insn)->fld[1]).rtx);
  return insn && ((enum rtx_code) (insn)->code) != BARRIER;
}
     ...
     rtx last_insn;
{
  ...
  if (tail_recursion_args (arguments, ((current_function_decl)->decl.arguments)))
    {
      if ((cfun->x_tail_recursion_label) == 0)
 {
   (cfun->x_tail_recursion_label) = gen_label_rtx ();
   emit_label_after ((cfun->x_tail_recursion_label),
       (cfun->x_tail_recursion_reentry));
 }
      emit_queue ();
      expand_goto_internal ((tree) ((void *)0), (cfun->x_tail_recursion_label), last_insn);
      emit_barrier ();
      return 1;
    }
  return 0;
     ...
     tree actuals, formals;
{
  ...
  int i;
  rtx *argvec;
# 3526 "../../../kgccfe/gnu/stmt.c"
  for (a = actuals, f = formals, i = 0; a && f; a = ((a)->common.chain), f = ((f)->common.chain), i++)
    {
      if (((((((a)->list.value))->common.type))->type.main_variant)
   != ((((f)->common.type))->type.main_variant))
 return 0;
      if (((enum rtx_code) (((f)->decl.rtl ? (f)->decl.rtl : (make_decl_rtl (f, ((void *)0)), (f)->decl.rtl)))->code) != REG || ((f)->decl.mode) == BLKmode)
 return 0;
    }
  if (a != 0 || f != 0)
    return 0;
  ...
  for (a = actuals, i = 0; a; a = ((a)->common.chain), i++)
    argvec[i] = expand_expr (((a)->list.value), (rtx) 0, VOIDmode, 0);
 ...
 if (reg_mentioned_p (((f)->decl.rtl ? (f)->decl.rtl : (make_decl_rtl (f, ((void *)0)), (f)->decl.rtl)), argvec[i]))
   {
     copy = 1;
     break;
   }
 ...
 argvec[i] = copy_to_reg (argvec[i]);
  ...
  for (f = formals, a = actuals, i = 0; f;
    ...
    {
      if (((enum machine_mode) (((f)->decl.rtl ? (f)->decl.rtl : (make_decl_rtl (f, ((void *)0)), (f)->decl.rtl)))->mode) == ((enum machine_mode) (argvec[i])->mode))
 emit_move_insn (((f)->decl.rtl ? (f)->decl.rtl : (make_decl_rtl (f, ((void *)0)), (f)->decl.rtl)), argvec[i]);
      else
 {
   rtx tmp = argvec[i];
   int unsignedp = ((((((a)->list.value))->common.type))->common.unsigned_flag);
   promote_mode(((((a)->list.value))->common.type), ((enum machine_mode) (tmp)->mode),
         &unsignedp, 0);
   if (((f)->decl.mode) != ((enum machine_mode) (((f)->decl.rtl ? (f)->decl.rtl : (make_decl_rtl (f, ((void *)0)), (f)->decl.rtl)))->mode))
     {
       tmp = gen_reg_rtx (((f)->decl.mode));
       convert_move (tmp, argvec[i], unsignedp);
     }
   convert_move (((f)->decl.rtl ? (f)->decl.rtl : (make_decl_rtl (f, ((void *)0)), (f)->decl.rtl)), tmp, unsignedp);
 }
    }
...
# 3607 "../../../kgccfe/gnu/stmt.c"
void
expand_start_bindings_and_block (flags, block)
     int flags;
     tree block;
{
  struct nesting *thisblock = (struct nesting *) ggc_alloc (sizeof (struct nesting));
  rtx note;
  ...
  if (!block_flag && block)
    fancy_abort ("../../../kgccfe/gnu/stmt.c", 3620, __FUNCTION__);


  if (block_flag)
    {
      note = emit_note (((void *)0), NOTE_INSN_BLOCK_BEG);
      (((note)->fld[4]).rttree) = block;
    }
  else
    note = emit_note (((void *)0), NOTE_INSN_DELETED);
  ...
  if ((cfun->stmt->x_block_stack)
    ...
    thisblock->data.block.outer_cleanups
      = tree_cons ((tree) ((void *)0), (cfun->stmt->x_block_stack)->data.block.cleanups,
     (cfun->stmt->x_block_stack)->data.block.outer_cleanups);
  else
     ...
     rtx slot, before_insn;
{
  ...
  (((handler_label))->in_struct) = 1;

  start_sequence ();
  emit_move_insn (slot, gen_rtx_fmt_u00 (LABEL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (handler_label)));
  insns = get_insns ();
  end_sequence ();
  ...
  if (fixed_regs[0])
    {
      ...
      static const struct elims {const int from, to;} elim_regs[] = {{ 0, (0 + 29)}, { 0, 0 + 30}, { 0, 0 + 17}, { 75, (0 + 29)}, { 75, 0 + 30}, { 75, 0 + 17}, { (0 + 1), (0 + 29)}, { (0 + 1), 0 + 30}, { (0 + 1), 0 + 17}};
      size_t i;

      for (i = 0; i < (sizeof (elim_regs) / sizeof ((elim_regs)[0])); i++)
 if (elim_regs[i].from == 0
     && elim_regs[i].to == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30))
   break;
     ...
     struct nesting *thisblock;
{
  ...
  if (thisblock->next != 0)
    for (slot = (cfun->x_nonlocal_goto_handler_slots); slot; slot = (((slot)->fld[1]).rtx))
      {
 rtx save_receiver = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode));
 emit_move_insn ((((slot)->fld[0]).rtx), save_receiver);

 start_sequence ();
 emit_move_insn (save_receiver, (((slot)->fld[0]).rtx));
 insns = get_insns ();
 end_sequence ();
 emit_insn_before (insns, thisblock->data.block.first_insn);
  ...
  link = (cfun->x_nonlocal_labels);
  slot = (cfun->x_nonlocal_goto_handler_slots);
  label_list = (rtx) 0;
  for (; link; link = ((link)->common.chain), slot = (((slot)->fld[1]).rtx))



    if (! ((((link)->list.value))->decl.bit_field_flag))
      {
 rtx lab;
 lab = expand_nl_handler_label ((((slot)->fld[0]).rtx),
           thisblock->data.block.first_insn);
 label_list = gen_rtx_fmt_ee (EXPR_LIST, (VOIDmode), (lab), (label_list));

 expand_nl_goto_receiver ();


 expand_goto (((link)->list.value));
      }
 ...
 any_invalid = 1;
  ...
  (cfun->x_nonlocal_goto_handler_labels) = label_list;
     ...
     int dont_jump_in;
{
  ...
  if ((cfun->x_function_call_count) != thisblock->data.block.n_function_calls
      && (cfun->x_nonlocal_labels)


      && (thisblock->next == 0 ? (cfun->has_nonlocal_label)
      ...
      for (chain = thisblock->data.block.label_chain; chain; chain = chain->next)
 {
  ...
  if (thisblock->data.block.stack_level != 0
      || thisblock->data.block.cleanups != 0)
    {
      ...
      int old_expr_stmts_for_value = (cfun->stmt->x_expr_stmts_for_value);
      rtx old_last_expr_value = (cfun->stmt->x_last_expr_value);
      tree old_last_expr_type = (cfun->stmt->x_last_expr_type);
      (cfun->stmt->x_expr_stmts_for_value) = 0;
 ...
 insn = prev_nonnote_insn (insn);
      ...
      expand_cleanups (thisblock->data.block.cleanups, (tree) ((void *)0), 0, reachable);
      if (reachable)
 do_pending_stack_adjust ();

      (cfun->stmt->x_expr_stmts_for_value) = old_expr_stmts_for_value;
      (cfun->stmt->x_last_expr_value) = old_last_expr_value;
      (cfun->stmt->x_last_expr_type) = old_last_expr_type;
      ...
      if (reachable && thisblock->data.block.stack_level != 0)
 {
   ...
   if ((cfun->x_nonlocal_goto_handler_slots) != 0)
     emit_stack_save (SAVE_NONLOCAL, &(cfun->x_nonlocal_goto_stack_level),
        (rtx) 0);
 }
  ...
  if (mark_ends)
    {
      rtx note = emit_note (((void *)0), NOTE_INSN_BLOCK_END);
      (((note)->fld[4]).rttree) = (((thisblock->data.block.first_insn)->fld[4]).rttree);
    }
  else

    (((thisblock->data.block.first_insn)->fld[5]).rtint) = NOTE_INSN_DELETED;
     ...
     tree decl;
{
  ...
  if (type == global_trees[TI_ERROR_MARK])
    ((decl)->decl.rtl = (gen_rtx_MEM (BLKmode, (const_int_rtx[64]))));
 ...
 x = gen_rtx_MEM (BLKmode, gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)));
  ...
  && ((enum tree_code) (type)->common.code) == REAL_TYPE)
    ...
    && ! ((decl)->decl.nonlocal_flag)
    && (((decl)->decl.regdecl_flag) || optimize))
    {
 ...
 = promote_mode (type, ((decl)->decl.mode), &unsignedp, 0);
      ...
      ((decl)->decl.rtl = (gen_reg_rtx (reg_mode)));

      if (((enum rtx_code) (((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->code) == REG)
 (cfun->emit->regno_decl[(((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[0]).rtuint)]) = decl;
      else if (((enum rtx_code) (((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->code) == CONCAT)
 {
   (cfun->emit->regno_decl[((((((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtuint)]) = decl;
   (cfun->emit->regno_decl[((((((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[1]).rtx))->fld[0]).rtuint)]) = decl;
 }
      ...
      if (((decl)->decl.rtl != ((void *)0)))
 {
   if (((enum rtx_code) (((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->code) != MEM
       || ((enum rtx_code) ((((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[0]).rtx))->code) != REG)
     fancy_abort ("../../../kgccfe/gnu/stmt.c", 4201, __FUNCTION__);
   oldaddr = (((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[0]).rtx);
 }


      ((decl)->decl.u1.a.align) = (((decl)->decl.mode) == BLKmode ? (mips_abi == 1 || mips_abi == 2 ? 128 : 64)
      : (mode_bitsize[(int) (((decl)->decl.mode))]));
      ...
      if (oldaddr)
 {
   addr = force_operand ((((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[0]).rtx), oldaddr);
   if (addr != oldaddr)
 ...
 expand_expr (((((type)->type.values))->type.maxval),
       (const_int_rtx[64]), VOIDmode, 0);
      ...
      ((decl)->decl.u1.a.align) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
     ...
     tree decl;
{
 ...
 expand_assignment (decl, convert (((decl)->common.type), global_trees[TI_INTEGER_ZERO]),
    ...
    {
      emit_line_note ((((decl)->decl.locus).file), (((decl)->decl.locus).line));
     ...
     tree decl, cleanup;
{
      ...
      if (cond_context)
 {
   ...
   cond = build_decl (VAR_DECL, (tree) ((void *)0),
     ...
     tree decl, cleanup, decl_elts;
{
  ...
  for (t = decl_elts; t; t = ((t)->common.chain))
    if (((((t)->list.value))->common.addressable_flag))
      {
      ...
      if (((enum rtx_code) (x)->code) == MEM)
 {
   if (mode == ((enum machine_mode) (x)->mode))
     ...
     ((decl_elt)->decl.rtl = (adjust_address_1 (x, mode, 0, 0, 1)));
 }
      else if (((enum rtx_code) (x)->code) == REG)
 {
   if (mode == ((enum machine_mode) (x)->mode))
     ...
     ((decl_elt)->decl.rtl = (gen_lowpart_SUBREG (mode, x)));
 }
      else
 fancy_abort ("../../../kgccfe/gnu/stmt.c", 4512, __FUNCTION__);
     ...
     int reachable;
{
 ...
 if (((enum tree_code) (((tail)->list.value))->common.code) == TREE_LIST)
   expand_cleanups (((tail)->list.value), dont_do, in_fixup, reachable);
 else
   {
     if (! in_fixup && using_eh_for_cleanups_p)
       expand_eh_region_end_cleanup (((tail)->list.value));

     if (reachable && !((tail)->common.static_flag))
       {
# 4567 "../../../kgccfe/gnu/stmt.c"
  if (in_fixup && using_eh_for_cleanups_p)
    {
      expand_eh_region_start ();

      expand_expr (((tail)->list.value), (const_int_rtx[64]), VOIDmode, 0);

      expand_eh_region_end_fixup (((tail)->list.value));
    }
  else
    expand_expr (((tail)->list.value), (const_int_rtx[64]), VOIDmode, 0);


                WFE_One_Stmt(((tail)->list.value));
...
move_cleanups_up ()
{
  struct nesting *block = (cfun->stmt->x_block_stack);
     ...
     int this_contour;
{
  ...
  if (this_contour && (cfun->stmt->x_block_stack)->data.block.cleanups != ((void *)0))
    return 1;
  if ((cfun->stmt->x_block_stack)->data.block.cleanups == 0
      && (cfun->stmt->x_block_stack)->data.block.outer_cleanups == 0)
    return 0;
...
expand_start_case (exit_flag, expr, type, printname)
     ...
     const char *printname;
{
  struct nesting *thiscase = (struct nesting *) ggc_alloc (sizeof (struct nesting));
...
{
  if ((cfun->stmt->x_case_stack))
    return (((cfun->stmt->x_case_stack)->data.case_stmt.index_expr)->common.type);
  return 0;
}
...
check_seenlabel ()
{
  ...
  if ((cfun->stmt->x_case_stack)->data.case_stmt.line_number_status >= 0)
    {
      rtx insn;

      restore_line_number_status
 ((cfun->stmt->x_case_stack)->data.case_stmt.line_number_status);
      (cfun->stmt->x_case_stack)->data.case_stmt.line_number_status = -1;

      for (insn = (cfun->stmt->x_case_stack)->data.case_stmt.start;
    insn;
    insn = (((insn)->fld[2]).rtx))
 {
   ...
   if (((enum rtx_code) (insn)->code) != NOTE
       && (((enum rtx_code) (insn)->code) != INSN || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != USE))
     {
       do
  insn = (((insn)->fld[1]).rtx);
       while (insn && (((enum rtx_code) (insn)->code) != NOTE || (((insn)->fld[5]).rtint) < 0));


       if (insn)
  warning_with_file_and_line ((((insn)->fld[4]).rtstr),
         (((insn)->fld[5]).rtint),
         "unreachable code at beginning of %s",
         (cfun->stmt->x_case_stack)->data.case_stmt.printname);
       break;
     }
 }
    }
}
# 4836 "../../../kgccfe/gnu/stmt.c"
int
...
{
  tree t;
  long long count, minval, lastval;
  ...
  *sparseness = 0;
  ...
  switch (((enum tree_code) (type)->common.code))
   ...
   && 0 != (t = fold (build (MINUS_EXPR, type, ((type)->type.maxval),
        ((type)->type.minval))))
 ...
 return -1;
    ...
    case ENUMERAL_TYPE:
      ...
      if (! host_integerp (((type)->type.minval), 0)
   || ((type)->type.maxval) == 0
   || ! host_integerp (((type)->type.maxval), 0))
 return -1;

      lastval = minval = tree_low_cst (((type)->type.minval), 0);
      count = 0;

      for (t = ((type)->type.values); t != (tree) ((void *)0); t = ((t)->common.chain))
 {
   long long thisval = tree_low_cst (((t)->list.value), 0);
...
mark_seen_cases (type, cases_seen, count, sparseness)
     ...
     int sparseness;
{
  tree next_node_to_try = (tree) ((void *)0);
  long long next_node_offset = 0;

  struct case_node *n, *root = (cfun->stmt->x_case_stack)->data.case_stmt.case_list;
  tree val = make_node (INTEGER_CST);

  ((val)->common.type) = type;
  if (! root)
  ...
  else if (sparseness == 2)
    {
      ...
      ((val)->common.type) = ((root->low)->common.type);
      for (t = ((type)->type.values), xlo = 0; t != (tree) ((void *)0);
    t = ((t)->common.chain), xlo++)
 {
   (((val)->int_cst.int_cst).low) = (((((t)->list.value))->int_cst.int_cst).low);
   (((val)->int_cst.int_cst).high) = (((((t)->list.value))->int_cst.int_cst).high);
   n = root;
   do
     {
       ...
       else
  {
    ...
    ((cases_seen)[(unsigned) (xlo) / 8] |= 1 << ((unsigned) (xlo) % 8));
    break;
  }
     }
   while (n);
    ...
    {
      if (root->left)
 (cfun->stmt->x_case_stack)->data.case_stmt.case_list = root = case_tree2list (root, 0);

      for (n = root; n; n = n->right)
 {
   (((val)->int_cst.int_cst).low) = (((n->low)->int_cst.int_cst).low);
   (((val)->int_cst.int_cst).high) = (((n->low)->int_cst.int_cst).high);
   while (! tree_int_cst_lt (n->high, val))
     {
       ...
       if (sparseness && ((type)->type.values) != (tree) ((void *)0))
  {
        ...
        if (t == (tree) ((void *)0))
   {
     ...
     xlo = 0;
        ...
        if (tree_int_cst_equal (val, ((t)->list.value)))
   {
     next_node_to_try = ((t)->common.chain);
       ...
       else
  {
    t = ((type)->type.minval);
    if (t)
      neg_double ((((t)->int_cst.int_cst).low), (((t)->int_cst.int_cst).high),
    &xlo, &xhi);
    else
      xlo = xhi = 0;
    add_double (xlo, xhi,
         (((val)->int_cst.int_cst).low), (((val)->int_cst.int_cst).high),
         &xlo, &xhi);
  }

       if (xhi == 0 && xlo < (unsigned long long) count)
  ((cases_seen)[(unsigned) (xlo) / 8] |= 1 << ((unsigned) (xlo) % 8));

       add_double ((((val)->int_cst.int_cst).low), (((val)->int_cst.int_cst).high),
     1, 0,
     &(((val)->int_cst.int_cst).low), &(((val)->int_cst.int_cst).high));
     }
 }
     ...
     tree type;
{
  ...
  if (size > 0 && size < 600000
      ...
      && (cases_seen =
   (unsigned char *) calloc (bytes_needed, 1)) != ((void *)0))
    {
      long long i;
      tree v = ((type)->type.values);
      ...
      for (i = 0; v != (tree) ((void *)0) && i < size; i++, v = ((v)->common.chain))
 if (((cases_seen)[(unsigned) (i) / 8] & (1 << ((unsigned) (i) % 8))) == 0)
   warning ("enumeration value `%s' not handled in switch",
     ((char *)(((v)->list.purpose))->identifier.id.str));
  ...
  if ((cfun->stmt->x_case_stack)->data.case_stmt.case_list
      && (cfun->stmt->x_case_stack)->data.case_stmt.case_list->left)
    (cfun->stmt->x_case_stack)->data.case_stmt.case_list
      = case_tree2list ((cfun->stmt->x_case_stack)->data.case_stmt.case_list, 0);
  for (n = (cfun->stmt->x_case_stack)->data.case_stmt.case_list; n; n = n->right)
    {
      for (chain = ((type)->type.values);
      ...
      if (!chain)
 {
   if (((type)->type.name) == 0)
     warning ("case value `%ld' not in enumerated type",
       (long) (((n->low)->int_cst.int_cst).low));
   else
     warning ("case value `%ld' not in enumerated type `%s'",
       (long) (((n->low)->int_cst.int_cst).low),
       ((char *)((((enum tree_code) (((type)->type.name))->common.code) == IDENTIFIER_NODE) ? ((type)->type.name) : ((((type)->type.name))->decl.name))->identifier.id.str));
 ...
 {
   for (chain = ((type)->type.values);
        chain && !tree_int_cst_equal (n->high, ((chain)->list.value));
        chain = ((chain)->common.chain))
     ;
   ...
   if (!chain)
     {
       if (((type)->type.name) == 0)
  warning ("case value `%ld' not in enumerated type",
    (long) (((n->high)->int_cst.int_cst).low));
       else
  warning ("case value `%ld' not in enumerated type `%s'",
    (long) (((n->high)->int_cst.int_cst).low),
    ((char *)((((enum tree_code) (((type)->type.name))->common.code) == IDENTIFIER_NODE) ? ((type)->type.name) : ((((type)->type.name))->decl.name))->identifier.id.str));
...
# 5574 "../../../kgccfe/gnu/stmt.c"
      ...
      if (thiscase->data.case_stmt.default_label == 0)
 {
   thiscase->data.case_stmt.default_label
     = build_decl (LABEL_DECL, (tree) ((void *)0), (tree) ((void *)0));
      ...
      for (n = thiscase->data.case_stmt.case_list; n; n = n->right)
 {
   ...
   if (((enum tree_code) (n->low)->common.code) != INTEGER_CST)
     fancy_abort ("../../../kgccfe/gnu/stmt.c", 5620, __FUNCTION__);
   if (((enum tree_code) (n->high)->common.code) != INTEGER_CST)
     fancy_abort ("../../../kgccfe/gnu/stmt.c", 5622, __FUNCTION__);
      ...
      if (count == 0)
 {
   ...
   emit_jump (default_label);
        ...
        || ((enum tree_code) (index_expr)->common.code) == INTEGER_CST
        || (((enum tree_code) (index_expr)->common.code) == COMPOUND_EXPR
     && ((enum tree_code) (((index_expr)->exp.operands[1]))->common.code) == INTEGER_CST))
 {
   ...
   if ((mode_class[(int) (((enum machine_mode) (index)->mode))]) == MODE_INT
  ...
  {
    index_expr
      = build_int_2_wide ((unsigned long long) ((((index)->fld[0]).rtwint)), (long long) (unsignedp || (((index)->fld[0]).rtwint) >= 0 ? 0 : -1));
      ...
      else
 {
    ...
    && compare_tree_int (minval, 3) < 0)
  {
    ...
    range = maxval;
       ...
       table_label, default_label))
  fancy_abort ("../../../kgccfe/gnu/stmt.c", 5774, __FUNCTION__);
     }
  ...
  labelvec[i]
    = gen_rtx_fmt_u00 (LABEL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (label_rtx (n->code_label)));
     }


   for (i = 0; i < ncases; i++)
     if (labelvec[i] == 0)
       labelvec[i] = gen_rtx_fmt_u00 (LABEL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (default_label));


   emit_label (table_label);

   if (((target_flags & 0x00100000)) || flag_pic)
     emit_jump_insn (gen_rtx_fmt_eEee0 (ADDR_DIFF_VEC, (((target_flags & 0x00100000) ? HImode : (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? DImode : SImode)), (gen_rtx_fmt_u00 (LABEL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (table_label))), (gen_rtvec_v (ncases, labelvec)), ((const_int_rtx[64])), ((const_int_rtx[64]))));



   else
     emit_jump_insn (gen_rtx_fmt_E (ADDR_VEC, (((target_flags & 0x00100000) ? HImode : (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? DImode : SImode)), (gen_rtvec_v (ncases, labelvec))));
# 5824 "../../../kgccfe/gnu/stmt.c"
   emit_barrier ();

 }

      before_case = (((before_case)->fld[2]).rtx);
      end = get_last_insn ();
      if (squeeze_notes (&before_case, &end))
 fancy_abort ("../../../kgccfe/gnu/stmt.c", 5831, __FUNCTION__);
     ...
     int unsignedp;
{
  if (((enum rtx_code) (op1)->code) == CONST_INT && ((enum rtx_code) (op2)->code) == CONST_INT)
    {
      if ((((op1)->fld[0]).rtwint) == (((op2)->fld[0]).rtwint))
 emit_jump (label);
    }
  else
...
# 5911 "../../../kgccfe/gnu/stmt.c"
static int
estimate_case_costs (node)
     case_node_ptr node;
{
  tree min_ascii = global_trees[TI_INTEGER_MINUS_ONE];
  tree max_ascii = convert (((node->high)->common.type), build_int_2_wide ((unsigned long long) (127), (long long) (0)));
  case_node_ptr n;
  int i;
      ...
      for (i = 0; i < 128; i++)
 {
   if ((_sch_istable[(i) & 0xff] & (unsigned short)(_sch_isalnum)))
     cost_table_[(unsigned long long) ((i) + 1)] = 16;
   else if ((_sch_istable[(i) & 0xff] & (unsigned short)(_sch_ispunct)))
     cost_table_[(unsigned long long) ((i) + 1)] = 8;
   else if ((_sch_istable[(i) & 0xff] & (unsigned short)(_sch_iscntrl)))
     cost_table_[(unsigned long long) ((i) + 1)] = -1;
 }

      cost_table_[(unsigned long long) ((' ') + 1)] = 8;
      cost_table_[(unsigned long long) (('\t') + 1)] = 4;
      cost_table_[(unsigned long long) (('\0') + 1)] = 4;
      cost_table_[(unsigned long long) (('\n') + 1)] = 2;
      cost_table_[(unsigned long long) (('\f') + 1)] = 1;
      cost_table_[(unsigned long long) (('\v') + 1)] = 1;
      cost_table_[(unsigned long long) (('\b') + 1)] = 1;
    }
 ...
 return 0;
      ...
      for (i = (long long) (((n->low)->int_cst.int_cst).low);
    i <= (long long) (((n->high)->int_cst.int_cst).low); i++)
 if (cost_table_[(unsigned long long) ((i) + 1)] < 0)
   return 0;
    }
     ...
     case_node_ptr head;
{
  ...
  while (node)
   ...
   || (lb != 0 && lb2 != 0
       && simplejump_p (lb)
       && simplejump_p (lb2)
       && rtx_equal_p (((((((lb)->fld[5]).rtx))->fld[1]).rtx),
         ((((((lb2)->fld[5]).rtx))->fld[1]).rtx))))
   ...
   if (!tree_int_cst_equal (np->low, np->high))
     {
       ranges++;
       if (use_cost_table)
  cost += cost_table_[(unsigned long long) (((((np->high)->int_cst.int_cst).low)) + 1)];
     }

   if (use_cost_table)
     cost += cost_table_[(unsigned long long) (((((np->low)->int_cst.int_cst).low)) + 1)];
      ...
      if (i > 2)
 {
       ...
       while (1)
  {
    ...
    if (!tree_int_cst_equal ((*npp)->low, (*npp)->high))
      i -= cost_table_[(unsigned long long) ((((((*npp)->high)->int_cst.int_cst).low)) + 1)];
    i -= cost_table_[(unsigned long long) ((((((*npp)->low)->int_cst.int_cst).low)) + 1)];
    if (i <= 0)
      break;
    npp = &(*npp)->right;
    n_moved += 1;
      ...
      if (node->right != 0 && node->left != 0)
 {
   ...
   if (node_is_bounded (node->right, index_type))
   ...
   else
     {
       ...
       tree test_label = build_decl (LABEL_DECL, (tree) ((void *)0), (tree) ((void *)0));
      ...
      if (node->right != 0 && node->left != 0)
 {
   ...
   if (node_is_bounded (node->right, index_type))
   ...
   else
     {
       ...
       test_label = build_decl (LABEL_DECL, (tree) ((void *)0), (tree) ((void *)0));
       emit_cmp_and_jump_insns (index,
           convert_modes
           (mode, imode,
     expand_expr (node->high, (rtx) 0,
...
{
  return (cfun->stmt->x_expr_stmts_for_value);
}


# 1 "../../../kgccfe/gnu/MIPS/gt-stmt.h" 1
# 23 "../../../kgccfe/gnu/MIPS/gt-stmt.h"
void
  ...
  if (((x) != ((void *)0) && ((void *) (x)) != (void *) 1 && ! ggc_set_mark (x)))
    {
      ...
      switch (((*x)).desc)
        ...
        case COND_NESTING:
          ...
          break;
        case LOOP_NESTING:
          do { if ((*x).data.loop.start_label != ((void *)0)) gt_ggc_mx_rtx_def ((*x).data.loop.start_label); } while (0);
          do { if ((*x).data.loop.end_label != ((void *)0)) gt_ggc_mx_rtx_def ((*x).data.loop.end_label); } while (0);
          do { if ((*x).data.loop.alt_end_label != ((void *)0)) gt_ggc_mx_rtx_def ((*x).data.loop.alt_end_label); } while (0);
          do { if ((*x).data.loop.continue_label != ((void *)0)) gt_ggc_mx_rtx_def ((*x).data.loop.continue_label); } while (0);
          break;
        case BLOCK_NESTING:
  ...
  if (((x) != ((void *)0) && ((void *) (x)) != (void *) 1 && ! ggc_set_mark (x)))
    {
      ...
      do { if ((*x).x_loop_stack != ((void *)0)) gt_ggc_mx_nesting ((*x).x_loop_stack); } while (0);
      ...
      do { if ((*x).x_last_expr_type != ((void *)0)) gt_ggc_mx_lang_tree_node ((*x).x_last_expr_type); } while (0);
      do { if ((*x).x_last_expr_value != ((void *)0)) gt_ggc_mx_rtx_def ((*x).x_last_expr_value); } while (0);
      do { if ((*x).x_goto_fixup_chain != ((void *)0)) gt_ggc_mx_goto_fixup ((*x).x_goto_fixup_chain); } while (0);
  }
}
# 6642 "../../../kgccfe/gnu/stmt.c" 2
