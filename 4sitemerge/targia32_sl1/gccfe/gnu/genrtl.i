...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((1) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));

  ((rt)->code = (enum rtx_code) (code));
  ((rt)->mode = (enum machine_mode) (mode));
  (((rt)->fld[0]).rtstr) = arg0;
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((2) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((3) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((4) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((9) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((10) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((8) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((7) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((5) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((0) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
     ...
     long long arg0;
{
  ...
  ((rt)->code = (enum rtx_code) (code));
  ((rt)->mode = (enum machine_mode) (mode));
  (((rt)->fld[0]).rtwint) = arg0;

  return rt;
}

rtx
gen_rtx_fmt_www (code, mode, arg0, arg1, arg2)
     enum rtx_code code;
     enum machine_mode mode;
     long long arg0;
     long long arg1;
     long long arg2;
{
  ...
  ((rt)->mode = (enum machine_mode) (mode));
  (((rt)->fld[0]).rtwint) = arg0;
  (((rt)->fld[1]).rtwint) = arg1;
  (((rt)->fld[2]).rtwint) = arg2;
...
{
  rtx rt;
  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((13) - 1) * sizeof (rtunion)));
  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));
  ...
  (((rt)->fld[8]).rtint) = arg8;
  (((rt)->fld[9]).rtbit) = arg9;
  (((rt)->fld[10]).rtbit) = arg10;
  (((rt)->fld[11]).rtint) = arg11;
  (((rt)->fld[12]).rtint) = arg12;
     ...
     union tree_node *arg9;
{
  ...
  (((rt)->fld[6]).rtint) = arg6;
  (((rt)->fld[7]).rtint) = arg7;
  (((rt)->fld[8]).rttree) = arg8;
  (((rt)->fld[9]).rttree) = arg9;
