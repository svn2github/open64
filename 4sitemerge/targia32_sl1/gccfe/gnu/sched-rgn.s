...
.L68:
	...
	je	.L69
	.loc 1 525 0
	leal	__FUNCTION__.10957@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$525, 4(%esp)
...
.LFE24:
	...
	.section	.rodata
	.type	__FUNCTION__.12556, @object
	.size	__FUNCTION__.12556, 17
__FUNCTION__.12556:
...
.L280:
	...
	jle	.L294
	.loc 1 1227 0
	leal	__FUNCTION__.12556@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1227, 4(%esp)
	leal	.LC3@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE54:
	...
	.section	.rodata
	.type	__FUNCTION__.14881, @object
	.size	__FUNCTION__.14881, 16
__FUNCTION__.14881:
...
.L773:
	...
	je	.L795
	.loc 1 2615 0
	leal	__FUNCTION__.14881@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2615, 4(%esp)
	leal	.LC3@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE56:
	...
	.section	.rodata
	.type	__FUNCTION__.15257, @object
	.size	__FUNCTION__.15257, 15
__FUNCTION__.15257:
...
.L844:
	...
	jle	.L847
	.loc 1 2857 0
	leal	__FUNCTION__.15257@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2857, 4(%esp)
	leal	.LC3@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE84:
	...
	.file 19 "../../../kgccfe/gnu/MIPS/insn-attr.h"
	.file 20 "../../../kgccfe/gnu/target.h"
	.text
.Letext0:
