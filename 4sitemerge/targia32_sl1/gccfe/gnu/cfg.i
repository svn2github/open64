...
clear_edges ()
{
      ...
      while (e)
 {
  ...
  (&entry_exit_blocks[0])->succ = ((void *)0);

  if (n_edges)
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 214, __FUNCTION__);
}
...
alloc_block ()
{
  ...
  if (first_deleted_block)
    ...
    {
      bb = (basic_block) __extension__ ({ struct obstack *__h = (&flow_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((sizeof *bb)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); });
...
compact_blocks ()
{
  ...
  if (i != n_basic_blocks)
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 274, __FUNCTION__);
     ...
     int flags;
{
  ...
  if (first_deleted_edge)
    ...
    {
      e = (edge) __extension__ ({ struct obstack *__h = (&flow_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((sizeof *e)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); });
      memset (e, 0, sizeof *e);
    }
  n_edges++;
     ...
     int flags;
{
  ...
  use_edge_cache = (edge_cache
      && src != (&entry_exit_blocks[0]) && dst != (&entry_exit_blocks[1]));
  ...
  switch (use_edge_cache)
    ...
    default:
      ...
      if (! ((edge_cache[src->index])->elms [(dst->index) / ((unsigned) (8 * 8))] >> (dst->index) % ((unsigned) (8 * 8)) & 1))
 break;
 ...
 if (e->dest == dst)
  ...
  if (use_edge_cache)
    ((edge_cache[src->index])->elms [(dst->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (dst->index) % ((unsigned) (8 * 8)));
     ...
     edge e;
{
  ...
  if (!tmp)
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 422, __FUNCTION__);
  if (last_succ)
  ...
  if (!tmp)
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 432, __FUNCTION__);
  if (last_pred)
     ...
     FILE *file;
{
 ...
 if ((((reg_n_info)->data.reg[i])->basic_block) >= 0)
   fprintf (file, " in block %d", (((reg_n_info)->data.reg[i])->basic_block));
 ...
 if ((cfun->emit->x_regno_reg_rtx)[i] != ((void *)0)
     && (mode_size[(int) (((enum machine_mode) ((cfun->emit->x_regno_reg_rtx)[i])->mode))]) != ((target_flags & 0x00002000) ? 8 : 4))
   fprintf (file, "; %d bytes", (mode_size[(int) (((enum machine_mode) ((cfun->emit->x_regno_reg_rtx)[i])->mode))]));

 class = reg_preferred_class (i);
 altclass = reg_alternate_class (i);
 if (class != GR_REGS || altclass != ALL_REGS)
   {
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      ...
      fprintf (file, "\nBasic block %d: first insn %d, last %d, ",
        bb->index, (((bb->head)->fld[0]).rtint), (((bb->end)->fld[0]).rtint));
     ...
     int do_succ;
{
  ...
  if (side == (&entry_exit_blocks[0]))
    fputs_unlocked (" ENTRY", file);
  else if (side == (&entry_exit_blocks[1]))
     ...
     int size;
{
  ...
  if (bb->aux || !first_block_aux_obj)
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 718, __FUNCTION__);
  bb->aux = __extension__ ({ struct obstack *__h = (&block_aux_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((size)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); });
     ...
     int size;
{
  ...
  if (!initialized)
    ...
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 740, __FUNCTION__);
  first_block_aux_obj = (char *) __extension__ ({ struct obstack *__h = (&block_aux_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((0)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); });
  if (size)
    {
      basic_block bb;
...
free_aux_for_blocks ()
{
  if (!first_block_aux_obj)
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 769, __FUNCTION__);
  __extension__ ({ struct obstack *__o = (&block_aux_obstack); void *__obj = (first_block_aux_obj); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
     ...
     int size;
{
  ...
  if (e->aux || !first_edge_aux_obj)
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 786, __FUNCTION__);
  e->aux = __extension__ ({ struct obstack *__h = (&edge_aux_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((size)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); });
  memset (e->aux, 0, size);
}
     ...
     int size;
{
  ...
  if (!initialized)
    ...
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 808, __FUNCTION__);

  first_edge_aux_obj = (char *) __extension__ ({ struct obstack *__h = (&edge_aux_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((0)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); });
  if (size)
    {
      basic_block bb;
...
free_aux_for_edges ()
{
  if (!first_edge_aux_obj)
    fancy_abort ("../../../kgccfe/gnu/cfg.c", 847, __FUNCTION__);
  __extension__ ({ struct obstack *__o = (&edge_aux_obstack); void *__obj = (first_edge_aux_obj); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
