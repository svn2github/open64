...
# 64 "../../../kgccfe/gnu/varasm.c" 2
# 75 "../../../kgccfe/gnu/varasm.c"
     ...
     unsigned int flags;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/varasm.c", 421, __FUNCTION__);
     ...
     int reloc;
{
  ...
  if (decl != (tree) ((void *)0) && !(tree_code_type[(int) (((enum tree_code) (decl)->common.code))] == 'd'))
    fancy_abort ("../../../kgccfe/gnu/varasm.c", 449, __FUNCTION__);
  if (name == ((void *)0))
     ...
     const char *asmspec;
{
  ...
  if (((enum tree_code) (decl)->common.code) == PARM_DECL
   ...
   && !((decl)->decl.regdecl_flag)))
    fancy_abort ("../../../kgccfe/gnu/varasm.c", 806, __FUNCTION__);

  else if (((enum tree_code) (decl)->common.code) == TYPE_DECL
    || ((enum tree_code) (decl)->common.code) == LABEL_DECL)
    fancy_abort ("../../../kgccfe/gnu/varasm.c", 810, __FUNCTION__);
     ...
     tree var;
{
  if (((enum rtx_code) (((var)->decl.rtl ? (var)->decl.rtl : (make_decl_rtl (var, ((void *)0)), (var)->decl.rtl)))->code) != MEM)
    fancy_abort ("../../../kgccfe/gnu/varasm.c", 971, __FUNCTION__);
     ...
     tree string;
{
  ...
  WFE_Assemble_Asm(((string)->string.pointer));
     ...
     int size;
{
  ...
  return;
# 1326 "../../../kgccfe/gnu/varasm.c"
}
# 1367 "../../../kgccfe/gnu/varasm.c"
static _Bool
 ...
 default:
  ...
  switch (destination)
    ...
    case asm_dest_local:
      ...
      break;
    default:
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 1438, __FUNCTION__);
    }

  return 1;
}
# 1454 "../../../kgccfe/gnu/varasm.c"
void
     ...
     int force;
{
  ...
  if (((enum rtx_code) (x)->code) == CONST_DOUBLE) {
        ...
        ival |= (unsigned int) (((x)->fld[0]).rtwint);
  }
  else {
        ival = (((x)->fld[0]).rtwint);
  }
     ...
     unsigned int align;
{
  ...
  WFE_Add_Aggregate_Init_Real (d, (mode_size[(int) (mode)]));
  return;
# 2124 "../../../kgccfe/gnu/varasm.c"
}
     ...
     struct addr_const *value;
{
 ...
 break;
  ...
  switch (((enum tree_code) (target)->common.code))
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 2190, __FUNCTION__);
    }

  if (((enum rtx_code) (x)->code) != MEM)
    fancy_abort ("../../../kgccfe/gnu/varasm.c", 2194, __FUNCTION__);
  x = (((x)->fld[0]).rtx);
     ...
     tree exp;
{
 ...
 if (((enum rtx_code) (value.base)->code) == SYMBOL_REF)
   ...
   fancy_abort ("../../../kgccfe/gnu/varasm.c", 2374, __FUNCTION__);
      }
      return hi;
     ...
     tree t2;
{
 ...
 if (nt1 != t1 || nt2 != t2)
  ...
  fancy_abort ("../../../kgccfe/gnu/varasm.c", 2552, __FUNCTION__);
}
     ...
     tree exp;
{
 ...
 if (t != exp)
   ...
   fancy_abort ("../../../kgccfe/gnu/varasm.c", 2687, __FUNCTION__);
      }
    }
}
# 2706 "../../../kgccfe/gnu/varasm.c"
rtx
      ...
      if (((enum machine_mode) (x)->mode) != VOIDmode)
 {
   ...
   switch (r->class)
     ...
     case rvc_nan:
       ...
       break;
     default:
       fancy_abort ("../../../kgccfe/gnu/varasm.c", 3034, __FUNCTION__);
     }
 }
      else
 {
  ...
  struct real_value *d = &value->un.fp_vec[i];
         ...
         switch (r->class)
           ...
           case rvc_nan:
             ...
             break;
           default:
             fancy_abort ("../../../kgccfe/gnu/varasm.c", 3094, __FUNCTION__);
           }
       }
   }
 else
   fancy_abort ("../../../kgccfe/gnu/varasm.c", 3099, __FUNCTION__);
      }
      break;
     ...
     rtx addr;
{
  ...
  fancy_abort ("../../../kgccfe/gnu/varasm.c", 3376, __FUNCTION__);
}
...
# 3483 "../../../kgccfe/gnu/varasm.c"
 ...
 case LABEL_REF:
   ...
   if ((((tmp))->volatil)
    ...
    && (((tmp)->fld[5]).rtint) == NOTE_INSN_DELETED))
     {
       fancy_abort ("../../../kgccfe/gnu/varasm.c", 3499, __FUNCTION__);
       x = (const_int_rtx[64]);
     }
   break;
 ...
 case MODE_FLOAT:
   if (((enum rtx_code) (x)->code) != CONST_DOUBLE)
     fancy_abort ("../../../kgccfe/gnu/varasm.c", 3526, __FUNCTION__);
 ...
 case MODE_VECTOR_FLOAT:
   {
     ...
     if (((enum rtx_code) (x)->code) != CONST_VECTOR)
       fancy_abort ("../../../kgccfe/gnu/varasm.c", 3543, __FUNCTION__);
 ...
 case MODE_VECTOR_INT:
   {
     ...
     if (((enum rtx_code) (x)->code) != CONST_VECTOR)
       fancy_abort ("../../../kgccfe/gnu/varasm.c", 3562, __FUNCTION__);
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/varasm.c", 3576, __FUNCTION__);
 }
     ...
     rtx x;
{
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/varasm.c", 3692, __FUNCTION__);
 }
    }
}
     ...
     unsigned int align;
{
  ...
  if (((enum tree_code) (exp)->common.code) == FDESC_EXPR)
    {
      ...
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 4091, __FUNCTION__);
  ...
  switch (code)
    ...
    case REFERENCE_TYPE:
      ...
      {
        WFE_Add_Aggregate_Init_Address (((exp)->exp.operands[0]));
        return;
      }
      else if (((enum tree_code) (exp)->common.code) == PLUS_EXPR && code == POINTER_TYPE
      ...
      if (code == INTEGER_TYPE &&
          ((enum tree_code) (exp)->common.code) == PLUS_EXPR &&
          ((enum tree_code) (((exp)->common.type))->common.code) == POINTER_TYPE) {
        WFE_Add_Aggregate_Init_Address (exp);
        return;
      }
 ...
 error ("initializer for floating value is not a floating constant");
      ...
      assemble_real ((*((exp)->real_cst.real_cst_ptr)),
       mode_for_size (size * 8, MODE_FLOAT, 0),
       align);
      break;
 ...
 {
   thissize = ((((exp)->string.length)) < (size) ? (((exp)->string.length)) : (size));
   assemble_string (((exp)->string.pointer), thissize);
 }
 ...
 fancy_abort ("../../../kgccfe/gnu/varasm.c", 4184, __FUNCTION__);
      break;
 ...
 fancy_abort ("../../../kgccfe/gnu/varasm.c", 4192, __FUNCTION__);
      return;
      ...
      else if (((enum tree_code) (exp)->common.code) == CONSTRUCTOR)
 {
   ...
   if (get_set_constructor_bytes (exp, buffer, thissize))
     fancy_abort ("../../../kgccfe/gnu/varasm.c", 4204, __FUNCTION__);
 ...
 error ("unknown set constructor type");
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 4215, __FUNCTION__);
    }
     ...
     unsigned int align;
{
  ...
  if ((8 * 8) < 8)
    fancy_abort ("../../../kgccfe/gnu/varasm.c", 4286, __FUNCTION__);
      ...
      else if (field == 0 || !((field)->decl.bit_field_flag))
 {
    ...
    && ! ((((((field)->common.type))->type.values))->type.maxval))
  {
    ...
    if (fieldsize != 0 && ((field)->common.chain) != (tree) ((void *)0))
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 4399, __FUNCTION__);
  }
...
# 4466 "../../../kgccfe/gnu/varasm.c"
       ...
       if (((target_flags & 0x00010000) != 0))
  {
    ...
    if (shift < (8 * 8))
      ...
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 4514, __FUNCTION__);
       ...
       else
  {
    ...
    if (shift < (8 * 8))
      ...
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 4547, __FUNCTION__);
     ...
     tree decl;
{
  if (((enum tree_code) (decl)->common.code) != VAR_DECL && ((enum tree_code) (decl)->common.code) != FUNCTION_DECL)
    fancy_abort ("../../../kgccfe/gnu/varasm.c", 4859, __FUNCTION__);
  ...
  if (((enum tree_code) (decl)->common.code) == VAR_DECL
    ...
    fancy_abort ("../../../kgccfe/gnu/varasm.c", 4876, __FUNCTION__);
}
     ...
     tree decl;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/varasm.c", 4902, __FUNCTION__);
 ...
 fancy_abort ("../../../kgccfe/gnu/varasm.c", 4912, __FUNCTION__);
      return kind;
    }
     ...
     tree decl;
{
 ...
 return VISIBILITY_PROTECTED;
      ...
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 4955, __FUNCTION__);
    }

  return VISIBILITY_DEFAULT;
}
# 4968 "../../../kgccfe/gnu/varasm.c"
unsigned int
     ...
     unsigned int flags __attribute__ ((__unused__));
{
  ...
  fancy_abort ("../../../kgccfe/gnu/varasm.c", 5039, __FUNCTION__);
}
     ...
     int shlib;
{
  switch (categorize_decl_for_section (decl, reloc, shlib))
    ...
    case SECCAT_TEXT:
      ...
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 5362, __FUNCTION__);
    case SECCAT_RODATA:
      readonly_data_section ();
      break;
    case SECCAT_RODATA_MERGE_STR:
    ...
    case SECCAT_TBSS:
      ...
      break;
    default:
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 5413, __FUNCTION__);
    }
}
     ...
     int shlib;
{
  ...
  switch (categorize_decl_for_section (decl, reloc, shlib))
    ...
    case SECCAT_TBSS:
      ...
      break;
    default:
      fancy_abort ("../../../kgccfe/gnu/varasm.c", 5476, __FUNCTION__);
    }
  plen = strlen (prefix);
...
# 1 "../../../kgccfe/gnu/MIPS/gt-varasm.h" 1
# 23 "../../../kgccfe/gnu/MIPS/gt-varasm.h"
void
