...
# 5 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
# 6 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
# 1 "../../../kgccfe/gnu/MIPS/insn-config.h" 1
# 7 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
# 8 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
# 9 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
# 10 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
# 11 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
# 12 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
# 13 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
# 1 "../../../kgccfe/gnu/except.h" 1
# 31 "../../../kgccfe/gnu/except.h"
# 1 "../../../kgccfe/gnu/rtl.h" 1
# 32 "../../../kgccfe/gnu/except.h" 2
...
# 14 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
# 16 "../../../kgccfe/gnu/MIPS/insn-peep.c" 2
...
peephole (ins1)
     rtx ins1;
{
  rtx insn __attribute__ ((__unused__)), x __attribute__ ((__unused__)), pat __attribute__ ((__unused__));

  if ((((ins1)->fld[2]).rtx)
      && ((enum rtx_code) ((((ins1)->fld[2]).rtx))->code) == BARRIER)
    return 0;

  insn = ins1;
  pat = (((insn)->fld[5]).rtx);
  x = pat;
  if (((enum rtx_code) (x)->code) != SET) goto L529;
  x = (((pat)->fld[0]).rtx);
  peep_operand[0] = x;
  ...
  if (((enum rtx_code) (x)->code) != SET) goto L529;
  x = (((pat)->fld[0]).rtx);
  if (((enum rtx_code) (x)->code) != PC) goto L529;
  x = (((pat)->fld[1]).rtx);
  if (((enum rtx_code) (x)->code) != IF_THEN_ELSE) goto L529;
  x = ((((((pat)->fld[1]).rtx))->fld[0]).rtx);
  peep_operand[2] = x;
  if (! equality_op (x, SImode)) goto L529;
  x = (((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx);
  if (!rtx_equal_p (peep_operand[0], x)) goto L529;
  x = (((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx);
  if (((enum rtx_code) (x)->code) != CONST_INT) goto L529;
  if ((((x)->fld[0]).rtwint) != 0) goto L529;
  x = ((((((pat)->fld[1]).rtx))->fld[1]).rtx);
  peep_operand[3] = x;
  if (! pc_or_label_operand (x, VOIDmode)) goto L529;
  x = ((((((pat)->fld[1]).rtx))->fld[2]).rtx);
  peep_operand[4] = x;
  if (! pc_or_label_operand (x, VOIDmode)) goto L529;
  if (! ((target_flags & 0x00100000)
   && ((enum rtx_code) (peep_operand[0])->code) == REG
   && (((peep_operand[0])->fld[0]).rtuint) == 24
   && dead_or_set_p (insn, peep_operand[0])
   && ((enum rtx_code) (peep_operand[1])->code) == REG
   && ((((((peep_operand[1])->fld[0]).rtuint)) >= 2 && ((((peep_operand[1])->fld[0]).rtuint)) <= 7) || ((((peep_operand[1])->fld[0]).rtuint)) == 16 || ((((peep_operand[1])->fld[0]).rtuint)) == 17))) goto L529;
  (((ins1)->fld[5]).rtx) = gen_rtx_fmt_E (PARALLEL, (VOIDmode), (gen_rtvec_v (5, peep_operand)));
  (((ins1)->fld[6]).rtint) = 529;
  delete_for_peephole ((((ins1)->fld[2]).rtx), insn);
 ...
 L529:
  ...
  pat = (((insn)->fld[5]).rtx);
  x = pat;
  if (((enum rtx_code) (x)->code) != SET) goto L530;
  x = (((pat)->fld[0]).rtx);
  peep_operand[0] = x;
  ...
  if (((enum rtx_code) (x)->code) != SET) goto L530;
  x = (((pat)->fld[0]).rtx);
  if (((enum rtx_code) (x)->code) != PC) goto L530;
  x = (((pat)->fld[1]).rtx);
  if (((enum rtx_code) (x)->code) != IF_THEN_ELSE) goto L530;
  x = ((((((pat)->fld[1]).rtx))->fld[0]).rtx);
  peep_operand[2] = x;
  if (! equality_op (x, DImode)) goto L530;
  x = (((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx);
  if (!rtx_equal_p (peep_operand[0], x)) goto L530;
  x = (((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx);
  if (((enum rtx_code) (x)->code) != CONST_INT) goto L530;
  if ((((x)->fld[0]).rtwint) != 0) goto L530;
  x = ((((((pat)->fld[1]).rtx))->fld[1]).rtx);
  peep_operand[3] = x;
  ...
  if (! ((target_flags & 0x00100000) && (target_flags & 0x00002000)
   ...
   && dead_or_set_p (insn, peep_operand[0])
   && ((enum rtx_code) (peep_operand[1])->code) == REG
   && ((((((peep_operand[1])->fld[0]).rtuint)) >= 2 && ((((peep_operand[1])->fld[0]).rtuint)) <= 7) || ((((peep_operand[1])->fld[0]).rtuint)) == 16 || ((((peep_operand[1])->fld[0]).rtuint)) == 17))) goto L530;
  (((ins1)->fld[5]).rtx) = gen_rtx_fmt_E (PARALLEL, (VOIDmode), (gen_rtvec_v (5, peep_operand)));
  (((ins1)->fld[6]).rtint) = 530;
  delete_for_peephole ((((ins1)->fld[2]).rtx), insn);
  return (((insn)->fld[2]).rtx);
 L530:
  ...
  pat = (((insn)->fld[5]).rtx);
  x = pat;
  if (((enum rtx_code) (x)->code) != SET) goto L531;
  x = (((pat)->fld[0]).rtx);
  peep_operand[0] = x;
  ...
  if (((enum rtx_code) (x)->code) != SET) goto L531;
  x = (((pat)->fld[0]).rtx);
  if (((enum rtx_code) (x)->code) != PC) goto L531;
  x = (((pat)->fld[1]).rtx);
  if (((enum rtx_code) (x)->code) != IF_THEN_ELSE) goto L531;
  x = ((((((pat)->fld[1]).rtx))->fld[0]).rtx);
  peep_operand[2] = x;
  if (! equality_op (x, SImode)) goto L531;
  x = (((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx);
  if (!rtx_equal_p (peep_operand[0], x)) goto L531;
  x = (((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx);
  if (((enum rtx_code) (x)->code) != CONST_INT) goto L531;
  if ((((x)->fld[0]).rtwint) != 0) goto L531;
  x = ((((((pat)->fld[1]).rtx))->fld[1]).rtx);
  peep_operand[3] = x;
  ...
  if (! ((target_flags & 0x00100000)
   && ((enum rtx_code) (peep_operand[1])->code) == REG
   && (((peep_operand[1])->fld[0]).rtuint) == 24
   && ((enum rtx_code) (peep_operand[0])->code) == REG
   && ((((((peep_operand[0])->fld[0]).rtuint)) >= 2 && ((((peep_operand[0])->fld[0]).rtuint)) <= 7) || ((((peep_operand[0])->fld[0]).rtuint)) == 16 || ((((peep_operand[0])->fld[0]).rtuint)) == 17)
   && dead_or_set_p (insn, peep_operand[0]))) goto L531;
  (((ins1)->fld[5]).rtx) = gen_rtx_fmt_E (PARALLEL, (VOIDmode), (gen_rtvec_v (5, peep_operand)));
  (((ins1)->fld[6]).rtint) = 531;
  delete_for_peephole ((((ins1)->fld[2]).rtx), insn);
  return (((insn)->fld[2]).rtx);
 L531:
  ...
  pat = (((insn)->fld[5]).rtx);
  x = pat;
  if (((enum rtx_code) (x)->code) != SET) goto L532;
  x = (((pat)->fld[0]).rtx);
  peep_operand[0] = x;
  ...
  if (((enum rtx_code) (x)->code) != SET) goto L532;
  x = (((pat)->fld[0]).rtx);
  if (((enum rtx_code) (x)->code) != PC) goto L532;
  x = (((pat)->fld[1]).rtx);
  if (((enum rtx_code) (x)->code) != IF_THEN_ELSE) goto L532;
  x = ((((((pat)->fld[1]).rtx))->fld[0]).rtx);
  peep_operand[2] = x;
  if (! equality_op (x, DImode)) goto L532;
  x = (((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx);
  if (!rtx_equal_p (peep_operand[0], x)) goto L532;
  x = (((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx);
  if (((enum rtx_code) (x)->code) != CONST_INT) goto L532;
  if ((((x)->fld[0]).rtwint) != 0) goto L532;
  x = ((((((pat)->fld[1]).rtx))->fld[1]).rtx);
  peep_operand[3] = x;
  ...
  if (! ((target_flags & 0x00100000) && (target_flags & 0x00002000)
   ...
   && ((enum rtx_code) (peep_operand[0])->code) == REG
   && ((((((peep_operand[0])->fld[0]).rtuint)) >= 2 && ((((peep_operand[0])->fld[0]).rtuint)) <= 7) || ((((peep_operand[0])->fld[0]).rtuint)) == 16 || ((((peep_operand[0])->fld[0]).rtuint)) == 17)
   && dead_or_set_p (insn, peep_operand[0]))) goto L532;
  (((ins1)->fld[5]).rtx) = gen_rtx_fmt_E (PARALLEL, (VOIDmode), (gen_rtvec_v (5, peep_operand)));
  (((ins1)->fld[6]).rtint) = 532;
  delete_for_peephole ((((ins1)->fld[2]).rtx), insn);
  return (((insn)->fld[2]).rtx);
 L532:
