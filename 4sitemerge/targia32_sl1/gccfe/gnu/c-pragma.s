...
.LFE20:
	...
	.align 4
.LC17:
	.string	"malformed #pragma frequency_hint, ignored"
.LC18:
	.string	"never"
.LC19:
	.string	"init"
.LC20:
	...
	.align 4
.LC21:
	.string	"frequency hint should be one of \"never\",\"init\",\"frequent\", ignored"
	.text
	.type	handle_pragma_freq_hint, @function
...
.L122:
	...
	ret
.LFE21:
	.size	handle_pragma_freq_hint, .-handle_pragma_freq_hint
	.section	.rodata
.LC22:
	.string	"pack"
.LC23:
...
.LCFI36:
	...
	movl	parse_in@GOT(%ebx), %eax
	movl	(%eax), %edx
	leal	handle_pragma_freq_hint@GOTOFF(%ebx), %eax
	movl	%eax, 12(%esp)
...
.LFB23:
	.file 2 "../../../kgccfe/gnu/MIPS/gt-c-pragma.h"
	.loc 2 26 0
	pushl	%ebp
.LCFI37:
	movl	%esp, %ebp
...
.LEFDE16:
	...
	.file 13 "../../../kgccfe/gnu/c-pragma.h"
	.file 14 "../../../kgccfe/gnu/ggc.h"
...
.LLST8:
	...
	.uleb128 0x35
	.long	0x5fa2
	.string	"handle_pragma_freq_hint"
	.byte	0x1
	.value	0x1ef
	.long	.LFB21
	.long	.LFE21
