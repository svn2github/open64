...
notice_new_block:
.LFB15:
	.file 1 "../../../kgccfe/gnu/cfgcleanup.c"
	.loc 1 98 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LFE20:
	...
	.section	.rodata
	.type	__FUNCTION__.10878, @object
	.size	__FUNCTION__.10878, 18
__FUNCTION__.10878:
	.string	"try_forward_edges"
	.align 4
.LC1:
	.string	"../../../kgccfe/gnu/cfgcleanup.c"
.LC2:
...
.LBE13:
	...
	jl	.L188
	.loc 1 508 0
	leal	__FUNCTION__.10878@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$508, 4(%esp)
...
.LFE23:
	...
	.section	.rodata
	.align 32
	.type	__FUNCTION__.11169, @object
	.size	__FUNCTION__.11169, 38
__FUNCTION__.11169:
...
.LCFI42:
	...
	je	.L284
	.loc 1 724 0
	leal	__FUNCTION__.11169@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$724, 4(%esp)
	leal	.LC1@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE24:
	...
	.section	.rodata
	.align 32
	.type	__FUNCTION__.11204, @object
	.size	__FUNCTION__.11204, 36
__FUNCTION__.11204:
...
.L301:
	...
	je	.L304
	.loc 1 794 0
	leal	__FUNCTION__.11204@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$794, 4(%esp)
	leal	.LC1@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE38:
	...
	.file 6 "../../../kgccfe/gnu/cselib.h"
	.file 7 "../../../kgccfe/gnu/varray.h"
	.file 8 "../../../kgccfe/gnu/bitmap.h"
	.file 9 "../../../kgccfe/gnu/sbitmap.h"
	.file 10 "../../../kgccfe/gnu/output.h"
