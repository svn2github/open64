...
# 25 "../../../kgccfe/gnu/hashtable.c" 2
# 33 "../../../kgccfe/gnu/hashtable.c"
static unsigned int calc_hash (const unsigned char *, unsigned int);
static void ht_expand (hash_table *);
# 49 "../../../kgccfe/gnu/hashtable.c"
void
...
ht_destroy (table)
     hash_table *table;
{
  __extension__ ({ struct obstack *__o = (&table->stack); void *__obj = (((void *)0)); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
  free (table->entries);
  free (table);
}
# 116 "../../../kgccfe/gnu/hashtable.c"
hashnode
     ...
     enum ht_lookup_option insert;
{
 ...
 break;
      ...
      if (node->hash_value == hash && ((node)->len) == len
          && !memcmp (((node)->str), str, len))
 {
   if (insert == HT_ALLOCED)


     __extension__ ({ struct obstack *__o = (&table->stack); void *__obj = ((void *) str); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
   return node;
 }
