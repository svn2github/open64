...
static _Bool fold_real_zero_addition_p (tree, tree, int);
# 164 "../../../kgccfe/gnu/fold-const.c"
static void
encode (words, low, hi)
     long long *words;
     unsigned long long low;
     ...
     int overflow;
{
  ...
  if ((((enum tree_code) (((t)->common.type))->common.code) == POINTER_TYPE || ((enum tree_code) (((t)->common.type))->common.code) == REFERENCE_TYPE))
    prec = ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32);
  else
     ...
     long long *hquo, *hrem;
{
      ...
      for (i = num_hi_sig - den_hi_sig - 1; i >= 0; i--)
 {
   ...
   if (num[num_hi_sig] < (long long) carry)
     {
       quo_est--;
       carry = 0;
       for (j = 0; j <= den_hi_sig; j++)
 ...
 if (((unsigned long long) habs_den
  ...
  && (labs_den < ltwice)))
   ...
   return overflow;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/fold-const.c", 839, __FUNCTION__);
    }
     ...
     int notrunc;
{
 ...
 low = int2l, hi = int2h;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/fold-const.c", 1183, __FUNCTION__);
    }
     ...
     int notrunc;
{
 ...
 return arg2;
      ...
      t = build_real (((arg1)->common.type),
        real_value_truncate (((((arg1)->common.type))->type.mode),
        value));
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/fold-const.c", 1344, __FUNCTION__);
 }
      return t;
    }
  return 0;
     ...
     tree arg0, arg1;
{
  ...
  if (((enum tree_code) (type)->common.code) != INTEGER_TYPE || ! ((type)->type.no_force_blk_flag)
    ...
    fancy_abort ("../../../kgccfe/gnu/fold-const.c", 1450, __FUNCTION__);
     ...
     tree arg0, arg1;
{
  ...
  if (((enum tree_code) (type)->common.code) != INTEGER_TYPE || ! ((type)->type.no_force_blk_flag)
      || type != ((arg1)->common.type))
    fancy_abort ("../../../kgccfe/gnu/fold-const.c", 1487, __FUNCTION__);
     ...
     tree arg1;
{
      ...
      else if (((enum tree_code) (arg1)->common.code) == REAL_CST)
 {
   ...
   else if (! (real_compare (LT_EXPR, &(l), &(x))
        && !no_upper_bound
        && real_compare (LT_EXPR, &(x), &(u))))
     overflow = 1;

   {
     long long low, high;
     real_to_integer2 (&low, &high, &(x));
     ...
     enum tree_code code;
{
  switch (code)
    ...
    case LE_EXPR:
      return GT_EXPR;
    default:
      fancy_abort ("../../../kgccfe/gnu/fold-const.c", 1701, __FUNCTION__);
    }
}
     ...
     enum tree_code code;
{
  switch (code)
    ...
    case LE_EXPR:
      return GE_EXPR;
    default:
      fancy_abort ("../../../kgccfe/gnu/fold-const.c", 1726, __FUNCTION__);
    }
}
     ...
     enum tree_code code;
{
  switch (code)
    ...
    case GE_EXPR:
      return 6;
    default:
      fancy_abort ("../../../kgccfe/gnu/fold-const.c", 1754, __FUNCTION__);
    }
}
     ...
     int code;
{
  switch (code)
    ...
    case 6:
      return GE_EXPR;
    default:
      fancy_abort ("../../../kgccfe/gnu/fold-const.c", 1781, __FUNCTION__);
    }
}
     ...
     tree arg;
{
 ...
 break;
  ...
  if (((enum tree_code) (((arg)->common.type))->common.code) != BOOLEAN_TYPE)
    fancy_abort ("../../../kgccfe/gnu/fold-const.c", 2357, __FUNCTION__);
  return build1 (TRUTH_NOT_EXPR, type, arg);
}
# 2370 "../../../kgccfe/gnu/fold-const.c"
static tree
     ...
     tree val;
{
  ...
  if (width > (8 * 8))
    {
      hi = (unsigned long long) 1 << (width - (8 * 8) - 1);
      lo = 0;
    }
  else
    {
      hi = 0;
      lo = (unsigned long long) 1 << (width - 1);
    }

  if ((((val)->int_cst.int_cst).high) == hi && (((val)->int_cst.int_cst).low) == lo)
    return exp;
     ...
     int upper0_p, upper1_p;
{
  ...
  switch (code)
    ...
    case GE_EXPR:
      ...
      break;
    default:
      fancy_abort ("../../../kgccfe/gnu/fold-const.c", 2883, __FUNCTION__);
    }
 ...
 case LT_EXPR: case LE_EXPR: case GE_EXPR: case GT_EXPR:
   ...
   switch (code)
     ...
     case LE_EXPR:
       ...
       break;
     default:
       fancy_abort ("../../../kgccfe/gnu/fold-const.c", 2977, __FUNCTION__);
     }
 ...
 case NOP_EXPR: case NON_LVALUE_EXPR: case CONVERT_EXPR:
  ...
  = ((equiv_type)->type.maxval) ? ((equiv_type)->type.maxval)
    : ((type)->type.maxval);
       ...
       if (((type)->type.precision) == ((((exp)->common.type))->type.precision))
     ...
     tree low, high;
{
 ...
 {
   hi = 0;
   lo = ((unsigned long long) 1 << (prec - 1)) - 1;
 }
      else
 {
   hi = ((long long) 1 << (prec - (8 * 8) - 1)) - 1;
   lo = (unsigned long long) -1;
 }
      ...
      if ((((high)->int_cst.int_cst).high) == hi && (((high)->int_cst.int_cst).low) == lo)
 {
   ...
   return fold (build (GT_EXPR, type, exp,
         convert (etype, global_trees[TI_INTEGER_ZERO])));
 }
    }
     ...
     tree exp;
{
  ...
  else if (((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 2
    && lhs != 0 && rhs != 0
...
# 3516 "../../../kgccfe/gnu/fold-const.c"
static tree
fold_truthop (code, truth_type, lhs, rhs)
     enum tree_code code;
     tree truth_type, lhs, rhs;
{
# 3530 "../../../kgccfe/gnu/fold-const.c"
  ...
  if (simple_operand_p (ll_arg)
      ...
      && !(((enum tree_code) (((ll_arg)->common.type))->common.code) == REAL_TYPE || (((enum tree_code) (((ll_arg)->common.type))->common.code) == COMPLEX_TYPE && ((enum tree_code) (((((ll_arg)->common.type))->common.type))->common.code) == REAL_TYPE)))
    {
      int compcode;
 ...
 return build (compcode_to_comparison (compcode),
  ...
  if (((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 2
 ...
 return build (NE_EXPR, truth_type,
        build (BIT_IOR_EXPR, ((ll_arg)->common.type),
        ll_arg, rl_arg),
     ...
     tree wide_type;
{
  ...
  tree ctype = (wide_type != 0 && ((mode_size[(int) (((wide_type)->type.mode))])
...
# 4152 "../../../kgccfe/gnu/fold-const.c"
   ...
   && (t2 = extract_muldiv (op1, c, code, wide_type)) != 0)
 {
   ...
   return fold (build (tcode, ctype, convert (ctype, t1),
    ...
    case WITH_RECORD_EXPR:
      if ((t1 = extract_muldiv (((t)->exp.operands[0]), c, code, wide_type)) != 0)
 return build (WITH_RECORD_EXPR, ((t1)->common.type), t1,
        ((t)->exp.operands[1]));
      break;
   ...
   || integer_zerop (const_binop (TRUNC_MOD_EXPR, op1, c, 0)))
 {
   ...
   if (op1 == 0 || ((op1)->common.public_flag))
     break;
 }
      else
 break;
 ...
 return fold (build (tcode, ctype, convert (ctype, op0), t1));
      ...
      if (((enum tree_code) (ctype)->common.code) == INTEGER_TYPE &&
          code == TRUNC_DIV_EXPR &&
          tcode == MULT_EXPR)
        return 0;
# 4325 "../../../kgccfe/gnu/fold-const.c"
      if ((! ((ctype)->common.unsigned_flag)



           || (((ctype)->type.no_force_blk_flag))
     ...
     tree s;
{
  ...
  if (code == COMPOUND_EXPR && ((enum tree_code) (((t)->exp.operands[0]))->common.code) == CONVERT_EXPR
      && ((((t)->exp.operands[0]))->exp.operands[0]) == s)
    return ((t)->exp.operands[1]);



  else if (code == COND_EXPR)
    {
      ((t)->exp.operands[0]) = strip_compound_expr (((t)->exp.operands[0]), s);
      ((t)->exp.operands[1]) = strip_compound_expr (((t)->exp.operands[1]), s);
      ((t)->exp.operands[2]) = strip_compound_expr (((t)->exp.operands[2]), s);
    }
     ...
     tree type;
{
  if (type == integer_types[itk_int])
    return value ? global_trees[TI_INTEGER_ONE] : global_trees[TI_INTEGER_ZERO];
  else if (((enum tree_code) (type)->common.code) == BOOLEAN_TYPE)
    return (*lang_hooks.truthvalue_conversion) (value ? global_trees[TI_INTEGER_ONE] :
      global_trees[TI_INTEGER_ZERO]);
  else
    {
      tree t = build_int_2_wide ((unsigned long long) (value), (long long) (0));
     ...
     int lim;
{
  ...
  if (((enum tree_code) (expr)->common.code) != COND_EXPR)
    return 0;
  else if (lim <= 0)
    return 0;

  ctrue = count_cond (((expr)->exp.operands[1]), lim - 1);
  cfalse = count_cond (((expr)->exp.operands[2]), lim - 1 - ctrue);
  return ((lim) < (1 + ctrue + cfalse) ? (lim) : (1 + ctrue + cfalse));
}
# 4448 "../../../kgccfe/gnu/fold-const.c"
static tree
   ...
   if (! cond_first_p)
     {
       ...
       lhs_type = global_trees[TI_VOID_TYPE];
     }
   else
     lhs = true_value;
 }
   ...
   if (! cond_first_p)
     {
       ...
       rhs_type = global_trees[TI_VOID_TYPE];
     }
   else
     rhs = false_value;
 }
  ...
  else
    {
      ...
      test = cond;
      true_value = convert (testtype, global_trees[TI_INTEGER_ONE]);
      false_value = convert (testtype, global_trees[TI_INTEGER_ZERO]);
    }
# 4545 "../../../kgccfe/gnu/fold-const.c"
  if (((enum tree_code) (arg)->common.code) == SAVE_EXPR)
    save = 1;
  else if (lhs == 0 && rhs == 0
    && !((arg)->common.constant_flag)
    && (*lang_hooks.decls.global_bindings_p) () == 0
    && ((((enum tree_code) (arg)->common.code) != VAR_DECL && ((enum tree_code) (arg)->common.code) != PARM_DECL)
        || ((arg)->common.side_effects_flag)))
    {
      if (((enum tree_code) (true_value)->common.code) != COND_EXPR)
 lhs = fold (build (lhs_code, lhs_type, *true_lhs, *true_rhs));

      if (((enum tree_code) (false_value)->common.code) != COND_EXPR)
 rhs = fold (build (rhs_code, rhs_type, *false_lhs, *false_rhs));

      if ((lhs == 0 || ! ((lhs)->common.constant_flag))
   && (rhs == 0 || !((rhs)->common.constant_flag)))
 {
   arg = save_expr (arg);
   lhs = rhs = 0;
   save = 1;
  ...
  if (save)
    ...
    convert (global_trees[TI_VOID_TYPE], arg),
    strip_compound_expr (test, arg));
  else
    return convert (type, test);
}
# 4596 "../../../kgccfe/gnu/fold-const.c"
static _Bool
     ...
     int negate;
{
  ...
  if (!((((mode_class[(int) (((type)->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((type)->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((type)->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1) && !flag_unsafe_math_optimizations))
    return 1;
  ...
  return negate && !((((mode_class[(int) (((type)->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((type)->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((type)->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_unsafe_math_optimizations);
}
# 4634 "../../../kgccfe/gnu/fold-const.c"
tree
fold (expr)
     tree expr;
{
 ...
 wins = 0;
  ...
  else if (((kind) == '<' || (kind) == '1' || (kind) == '2' || (kind) == 'e') || kind == 'r')
    {
      ...
      for (i = 0; i < len; i++)
 {
  ...
  if ((code == PLUS_EXPR || code == MULT_EXPR || code == MIN_EXPR
       ...
       || code == BIT_AND_EXPR)
      && ((((enum tree_code) (arg0)->common.code) == INTEGER_CST && ((enum tree_code) (arg1)->common.code) != INTEGER_CST)
   || (((enum tree_code) (arg0)->common.code) == REAL_CST && ((enum tree_code) (arg1)->common.code) != REAL_CST)))
    {
...
# 4763 "../../../kgccfe/gnu/fold-const.c"
 ...
 return build (COMPOUND_EXPR, type, ((arg0)->exp.operands[0]),
        fold (build1 (code, type, ((arg0)->exp.operands[1]))));
      else if (((enum tree_code) (arg0)->common.code) == COND_EXPR)
 {
   ...
   t = fold (build (COND_EXPR, type, ((arg0)->exp.operands[0]),
      arg01, arg02));
# 4810 "../../../kgccfe/gnu/fold-const.c"
   if ((code == NOP_EXPR || code == CONVERT_EXPR
        || code == NON_LVALUE_EXPR)
       && ((enum tree_code) (t)->common.code) == COND_EXPR
       && ((enum tree_code) (((t)->exp.operands[1]))->common.code) == code
       && ((enum tree_code) (((t)->exp.operands[2]))->common.code) == code
       && ! (((enum tree_code) (((t)->exp.operands[1]))->common.code) == VOID_TYPE)
       && ! (((enum tree_code) (((t)->exp.operands[2]))->common.code) == VOID_TYPE)
       && (((((((t)->exp.operands[1]))->exp.operands[0]))->common.type)
    == ((((((t)->exp.operands[2]))->exp.operands[0]))->common.type))
       && ! ((((enum tree_code) (((t)->common.type))->common.code) == INTEGER_TYPE || ((enum tree_code) (((t)->common.type))->common.code) == ENUMERAL_TYPE || ((enum tree_code) (((t)->common.type))->common.code) == BOOLEAN_TYPE || ((enum tree_code) (((t)->common.type))->common.code) == CHAR_TYPE)
      && ((((enum tree_code) (((((((t)->exp.operands[1]))->exp.operands[0]))->common.type))->common.code) == INTEGER_TYPE || ((enum tree_code) (((((((t)->exp.operands[1]))->exp.operands[0]))->common.type))->common.code) == ENUMERAL_TYPE || ((enum tree_code) (((((((t)->exp.operands[1]))->exp.operands[0]))->common.type))->common.code) == BOOLEAN_TYPE || ((enum tree_code) (((((((t)->exp.operands[1]))->exp.operands[0]))->common.type))->common.code) == CHAR_TYPE))

      && ((((t)->common.type))->type.precision) <= (8 * ((target_flags & 0x00002000) ? 8 : 4))))
     t = build1 (code, type,
   build (COND_EXPR,
          ((((((t)->exp.operands[1]))->exp.operands[0]))->common.type),

          ((t)->exp.operands[0]),
          ((((t)->exp.operands[1]))->exp.operands[0]),
          ((((t)->exp.operands[2]))->exp.operands[0])));
   return t;
 }
      else if (tree_code_type[(int) (((enum tree_code) (arg0)->common.code))] == '<')
 return fold (build (COND_EXPR, type, arg0,
       fold (build1 (code, type, global_trees[TI_INTEGER_ONE])),
       fold (build1 (code, type, global_trees[TI_INTEGER_ZERO]))));
   }
  else if (tree_code_type[(int) (code)] == '2'
    || tree_code_type[(int) (code)] == '<')
    {
      if (((enum tree_code) (arg1)->common.code) == COMPOUND_EXPR
   && ! ((((arg1)->exp.operands[0]))->common.side_effects_flag)
   && ! ((arg0)->common.side_effects_flag))
 return build (COMPOUND_EXPR, type, ((arg1)->exp.operands[0]),
        fold (build (code, type,
       arg0, ((arg1)->exp.operands[1]))));
      else if ((((enum tree_code) (arg1)->common.code) == COND_EXPR
  || (tree_code_type[(int) (((enum tree_code) (arg1)->common.code))] == '<'
      && tree_code_type[(int) (code)] != '<'))
        && (((enum tree_code) (arg0)->common.code) != COND_EXPR
 ...
 return
   fold_binary_op_with_conditional_arg (code, type, arg1, arg0,
                             0);
      else if (((enum tree_code) (arg0)->common.code) == COMPOUND_EXPR)
 return build (COMPOUND_EXPR, type, ((arg0)->exp.operands[0]),
        fold (build (code, type, ((arg0)->exp.operands[1]), arg1)));
      else if ((((enum tree_code) (arg0)->common.code) == COND_EXPR
  || (tree_code_type[(int) (((enum tree_code) (arg0)->common.code))] == '<'
      && tree_code_type[(int) (code)] != '<'))
        && (((enum tree_code) (arg1)->common.code) != COND_EXPR
     || count_cond (arg0, 25) + count_cond (arg1, 25) <= 25)
        && (! ((arg1)->common.side_effects_flag)
     || ((*lang_hooks.decls.global_bindings_p) () == 0
 ...
 return
   fold_binary_op_with_conditional_arg (code, type, arg0, arg1,
    ...
    return build (COMPOUND_EXPR, type, ((arg1)->exp.operands[0]),
    fold (build (code, type, arg0, ((arg1)->exp.operands[1]))));
  ...
  switch (code)
    ...
    case FIX_TRUNC_EXPR:
      ...
      if (((((t)->exp.operands[0]))->common.type) == ((t)->common.type))
   ...
   || ((enum tree_code) (((t)->exp.operands[0]))->common.code) == CONVERT_EXPR)
 {
   ...
   int final_int = (((enum tree_code) (final_type)->common.code) == INTEGER_TYPE || ((enum tree_code) (final_type)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (final_type)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (final_type)->common.code) == CHAR_TYPE);
   int final_ptr = (((enum tree_code) (final_type)->common.code) == POINTER_TYPE || ((enum tree_code) (final_type)->common.code) == REFERENCE_TYPE);
   int final_float = (((enum tree_code) (final_type)->common.code) == REAL_TYPE || (((enum tree_code) (final_type)->common.code) == COMPLEX_TYPE && ((enum tree_code) (((final_type)->common.type))->common.code) == REAL_TYPE));
   unsigned int final_prec = ((final_type)->type.precision);
   int final_unsignedp = ((final_type)->common.unsigned_flag);





   if (((inside_type)->type.main_variant) == ((final_type)->type.main_variant)
       && ((inter_int && final_int) || (inter_float && final_float))
       && inter_prec >= final_prec)
     return convert (final_type, ((((t)->exp.operands[0]))->exp.operands[0]));
   ...
   if ((((inter_int || inter_ptr) && (inside_int || inside_ptr))
       ...
       && ! (final_prec != (mode_bitsize[(int) (((final_type)->type.mode))])
      && ((final_type)->type.mode) == ((inter_type)->type.mode))
       && ! final_ptr)
     return convert (final_type, ((((t)->exp.operands[0]))->exp.operands[0]));
...
# 4967 "../../../kgccfe/gnu/fold-const.c"
        ...
        && ((((((((t)->exp.operands[0]))->exp.operands[0]))->exp.operands[1]))->decl.bit_field_flag)))
 {
   ...
   if (t == orig_t)
     t = copy_node (t);
   ((t)->exp.operands[0]) = ((prev)->exp.operands[1]);

   t = build (COMPOUND_EXPR, ((t)->common.type), prev, fold (t));
   ...
   return t;
      ...
      if ((((enum tree_code) (((t)->common.type))->common.code) == INTEGER_TYPE || ((enum tree_code) (((t)->common.type))->common.code) == ENUMERAL_TYPE || ((enum tree_code) (((t)->common.type))->common.code) == BOOLEAN_TYPE || ((enum tree_code) (((t)->common.type))->common.code) == CHAR_TYPE)
   && ((enum tree_code) (((t)->common.type))->common.code) != BOOLEAN_TYPE
   ...
   if (((((and)->common.type))->common.unsigned_flag)
    ...
    <= ((((and)->common.type))->type.precision)))
     ...
     && host_integerp (and1, 1))
     {
       ...
       if (change
    && (((target_flags & 0x00002000) && ((((((and0)->common.type))->type.mode)) == SImode || (((((and0)->common.type))->type.mode)) == CCmode) ? SIGN_EXTEND : ZERO_EXTEND)
        == ZERO_EXTEND))
  {
    tree uns = (*lang_hooks.types.unsigned_type) (((and0)->common.type));
   ...
   if (change)
     return fold (build (BIT_AND_EXPR, ((t)->common.type),
    convert (((t)->common.type), and0),
    convert (((t)->common.type), and1)));
 }

      if (!wins)
 {
   if (((t)->common.constant_flag) != ((arg0)->common.constant_flag))
     {
       if (t == orig_t)
  t = copy_node (t);
       ((t)->common.constant_flag) = ((arg0)->common.constant_flag);
     }
   return t;
 }
 ...
 return build1 (VIEW_CONVERT_EXPR, type,
         ((((t)->exp.operands[0]))->exp.operands[0]));
      return t;

    case COMPONENT_REF:
      if (((enum tree_code) (arg0)->common.code) == CONSTRUCTOR)
 {
   tree m = purpose_member (arg1, (((arg0))->exp.operands[1]));
   if (m)
     t = ((m)->list.value);
 }
      return t;
 ...
 return convert (type, ((arg0)->exp.operands[0]));





      else if (((enum tree_code) (arg0)->common.code) == MINUS_EXPR
 ...
 return build (MINUS_EXPR, type, ((arg0)->exp.operands[1]),
        ((arg0)->exp.operands[0]));
      ...
      if (wins)
 {
  ...
  t = build_real (type,
    real_arithmetic2 (NEGATE_EXPR, &((*((arg0)->real_cst.real_cst_ptr))), ((void *)0)));
     }
 }
      else if (((enum tree_code) (arg0)->common.code) == ABS_EXPR || ((enum tree_code) (arg0)->common.code) == NEGATE_EXPR)
 return build1 (ABS_EXPR, type, ((arg0)->exp.operands[0]));
      return t;
 ...
 return build (COMPLEX_EXPR, type,
        ((arg0)->exp.operands[0]),
        negate_expr (((arg0)->exp.operands[1])));
 ...
 return fold (build (((enum tree_code) (arg0)->common.code), type,
       fold (build1 (CONJ_EXPR, type,
       ((arg0)->exp.operands[0]))),
       fold (build1 (CONJ_EXPR,
       type, ((arg0)->exp.operands[1])))));
      ...
      else if (! (((enum tree_code) (type)->common.code) == REAL_TYPE || (((enum tree_code) (type)->common.code) == COMPLEX_TYPE && ((enum tree_code) (((type)->common.type))->common.code) == REAL_TYPE)))
 {
  ...
  return fold (build (MULT_EXPR, type,
      ...
      else if (fold_real_zero_addition_p (((arg0)->common.type), arg1, 0))
 return non_lvalue (convert (type, arg0));


      else if (fold_real_zero_addition_p (((arg1)->common.type), arg0, 0))
      ...
      if (t1 != (tree) ((void *)0))
 {
   ...
   return t1;
    ...
    case MINUS_EXPR:
      ...
      if (((enum tree_code) (arg1)->common.code) == NEGATE_EXPR)
 return fold (build (PLUS_EXPR, type, arg0, ((arg1)->exp.operands[0])));

      if (((enum tree_code) (arg0)->common.code) == NEGATE_EXPR && ((enum tree_code) (arg1)->common.code) == REAL_CST)
 return
   fold (build (MINUS_EXPR, type,
         build_real (((arg1)->common.type),
       real_arithmetic2 (NEGATE_EXPR, &((*((arg1)->real_cst.real_cst_ptr))), ((void *)0))),
         ((arg0)->exp.operands[0])));
 ...
 return convert (type, global_trees[TI_INTEGER_ZERO]);
    ...
    case MULT_EXPR:
      ...
      if (((enum tree_code) (arg0)->common.code) == NEGATE_EXPR && ((enum tree_code) (arg1)->common.code) == NEGATE_EXPR)
 return fold (build (MULT_EXPR, type, ((arg0)->exp.operands[0]),
       ((arg1)->exp.operands[0])));
      ...
      else
 {
   ...
   if (!((((mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)
       && !((((mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1) && !flag_unsafe_math_optimizations)
       && real_zerop (arg1))
     return omit_one_operand (type, arg1, arg0);

   if (!(flag_signaling_nans && ((((mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((((arg0)->common.type))->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
       && real_onep (arg1))
     return non_lvalue (convert (type, arg0));
   ...
   && ((((((arg0)->exp.operands[0]))->common.type))->common.unsigned_flag))
 {
   ...
   if (prec < (8 * ((target_flags & 0x00002000) ? 8 : 4)) && prec < (8 * 8)
       && (~(((arg1)->int_cst.int_cst).low)
    & (((long long) 1 << prec) - 1)) == 0)
     return build1 (NOP_EXPR, type, ((arg0)->exp.operands[0]));
 }
      ...
      if (((enum tree_code) (arg1)->common.code) == INTEGER_CST)
 {
   ...
   goto bit_and;
    ...
    case RDIV_EXPR:
      ...
      if (((enum tree_code) (arg1)->common.code) == REAL_CST
   && !(((mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0)
   && real_zerop (arg1))
 return t;


      if (((enum tree_code) (arg0)->common.code) == NEGATE_EXPR && ((enum tree_code) (arg1)->common.code) == NEGATE_EXPR)
 return fold (build (RDIV_EXPR, type, ((arg0)->exp.operands[0]),
       ((arg1)->exp.operands[0])));
 ...
 {
   return fold (build (RDIV_EXPR, type, ((arg0)->exp.operands[0]),
         build (MULT_EXPR, type, ((arg0)->exp.operands[1]),
         arg1)));
 }
      ...
      if (code == LROTATE_EXPR && ((enum tree_code) (arg1)->common.code) == INTEGER_CST)
 {
   if (t == orig_t)
     t = copy_node (t);
   ((t)->common.code = (enum tree_code) (RROTATE_EXPR));
   code = RROTATE_EXPR;
   ((t)->exp.operands[1]) = arg1
     = const_binop
       (MINUS_EXPR,
        convert (((arg1)->common.type),
   build_int_2_wide ((unsigned long long) ((mode_bitsize[(int) (((type)->type.mode))])), (long long) (0))),
        arg1, 0);
   ...
   && (((enum tree_code) (arg0)->common.code) == BIT_AND_EXPR
       || ((enum tree_code) (arg0)->common.code) == BIT_ANDTC_EXPR
       || ((enum tree_code) (arg0)->common.code) == BIT_IOR_EXPR
       || ((enum tree_code) (arg0)->common.code) == BIT_XOR_EXPR)
   && ((enum tree_code) (((arg0)->exp.operands[1]))->common.code) == INTEGER_CST)
 return fold (build (((enum tree_code) (arg0)->common.code), type,
   ...
   && (((((arg1)->int_cst.int_cst).low)
       ...
       == (unsigned int) (mode_bitsize[(int) (((type)->type.mode))])))
 return ((arg0)->exp.operands[0]);
 ...
 return omit_one_operand (type, arg0, arg1);
      if ((((enum tree_code) (type)->common.code) == INTEGER_TYPE || ((enum tree_code) (type)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (type)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type)->common.code) == CHAR_TYPE)
   && operand_equal_p (arg1, ((type)->type.minval), 1))
 return omit_one_operand (type, arg1, arg0);
      goto associate;
 ...
 return omit_one_operand (type, arg0, arg1);
      if ((((enum tree_code) (type)->common.code) == INTEGER_TYPE || ((enum tree_code) (type)->common.code) == ENUMERAL_TYPE || ((enum tree_code) (type)->common.code) == BOOLEAN_TYPE || ((enum tree_code) (type)->common.code) == CHAR_TYPE)
   && ((type)->type.maxval)
   && operand_equal_p (arg1, ((type)->type.maxval), 1))
 return omit_one_operand (type, arg1, arg0);
      goto associate;
   ...
   && ! ((((arg0)->exp.operands[1]))->common.side_effects_flag))
 {
   ...
   if (operand_equal_p (a00, a10, 0))
     return fold (build (((enum tree_code) (arg0)->common.code), type, a00,
    fold (build (code, type, a01, a11))));
   else if (commutative && operand_equal_p (a00, a11, 0))
     return fold (build (((enum tree_code) (arg0)->common.code), type, a00,
    fold (build (code, type, a01, a10))));
   else if (commutative && operand_equal_p (a01, a10, 0))
     return fold (build (((enum tree_code) (arg0)->common.code), type, a01,
      ...
      if ((((enum tree_code) (((arg0)->common.type))->common.code) == REAL_TYPE || (((enum tree_code) (((arg0)->common.type))->common.code) == COMPLEX_TYPE && ((enum tree_code) (((((arg0)->common.type))->common.type))->common.code) == REAL_TYPE)))
 {
   ...
   if (((enum tree_code) (arg1)->common.code) == REAL_CST
       && real_isnegzero (&((*((arg1)->real_cst.real_cst_ptr)))))
  ...
  || (((enum tree_code) (((arg1)->common.type))->common.code) == POINTER_TYPE || ((enum tree_code) (((arg1)->common.type))->common.code) == REFERENCE_TYPE)))
   {
     ...
     signed_max = ((unsigned long long) 1 << (width - 1)) - 1;

     if (((((arg1)->common.type))->common.unsigned_flag))
       {
         max = ((unsigned long long) 2 << (width - 1)) - 1;
  min = 0;
       }
     else
       {
         max = signed_max;
  min = ((unsigned long long) -1 << (width - 1));
       }
  ...
  if (code == LE_EXPR || code == GT_EXPR)
    {
      ...
      return fold
        (build (code == LE_EXPR ? GE_EXPR: LT_EXPR,
         ...
         convert (st1, global_trees[TI_INTEGER_ZERO])));
    }
       }
   }
      }
 ...
 return fold (build (code, type,
     ...
     || (((enum tree_code) (t1)->common.code) == INTEGER_CST
         ...
         && (((((tem)->common.type))->common.unsigned_flag) ||
             !((((t1)->common.type))->common.unsigned_flag))
 ...
 return fold (build (code == EQ_EXPR ? NE_EXPR : EQ_EXPR, type,
   ...
   && integer_zerop (arg1))
 {
   tree arg00 = sign_bit_p (((arg0)->exp.operands[0]),
       ((arg0)->exp.operands[1]));
   if (arg00 != (tree) ((void *)0))
   {
     ...
     return fold (build (code == EQ_EXPR ? GE_EXPR : LT_EXPR, type,
           convert (stype, arg00),
    convert (stype, global_trees[TI_INTEGER_ZERO])));
   }
 }
      ...
      if (operand_equal_p (arg0, arg1, 0))
 {
  ...
  break;
     ...
     default:
       fancy_abort ("../../../kgccfe/gnu/fold-const.c", 6611, __FUNCTION__);
     }
 }
# 6628 "../../../kgccfe/gnu/fold-const.c"
...
# 6837 "../../../kgccfe/gnu/fold-const.c"
      else if (((enum tree_code) (arg0)->common.code) == REAL_CST && ((enum tree_code) (arg1)->common.code) == REAL_CST)
 {
   ...
   if (real_isnan (&((*((arg0)->real_cst.real_cst_ptr))))
       || real_isnan (&((*((arg1)->real_cst.real_cst_ptr)))))
     t1 = build_int_2_wide ((unsigned long long) (invert && code == LT_EXPR), (long long) (0));

   else if (code == EQ_EXPR)
     t1 = build_int_2_wide ((unsigned long long) (real_compare (EQ_EXPR, &((*((arg0)->real_cst.real_cst_ptr))), &((*((arg1)->real_cst.real_cst_ptr))))), (long long) (0));


   else
     t1 = build_int_2_wide ((unsigned long long) (real_compare (LT_EXPR, &((*((arg0)->real_cst.real_cst_ptr))), &((*((arg1)->real_cst.real_cst_ptr))))), (long long) (0));
 ...
 return pedantic_non_lvalue
   (((t)->exp.operands[(integer_zerop (arg0) ? 2 : 1)]));
      else if (operand_equal_p (arg1, ((expr)->exp.operands[2]), 0))
 return pedantic_omit_one_operand (type, arg1, arg0);
      ...
      if (integer_zerop (arg1)
   || (((arg1)->common.constant_flag) && ! ((((t)->exp.operands[2]))->common.constant_flag))
   || (tree_code_type[(int) (((enum tree_code) (arg0)->common.code))] == '<'
       ...
       ((arg0)->exp.operands[1]))))
 {
   ...
   if (((enum tree_code) (tem)->common.code) != TRUTH_NOT_EXPR)
    ...
    ((t)->exp.operands[2]), ((t)->exp.operands[1]));
       arg0 = tem;
   ...
   && !((((mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1) && !flag_unsafe_math_optimizations))
 {
   tree arg2 = ((t)->exp.operands[2]);
   enum tree_code comp_code = ((enum tree_code) (arg0)->common.code);

   while ((((enum tree_code) (arg2)->common.code) == NOP_EXPR || ((enum tree_code) (arg2)->common.code) == CONVERT_EXPR || ((enum tree_code) (arg2)->common.code) == NON_LVALUE_EXPR) && ((arg2)->exp.operands[0]) != global_trees[TI_ERROR_MARK] && (((((arg2)->common.type))->type.mode) == ((((((arg2)->exp.operands[0]))->common.type))->type.mode))) (arg2) = ((arg2)->exp.operands[0]);
# 6942 "../../../kgccfe/gnu/fold-const.c"
   if (((((enum tree_code) (((((arg0)->exp.operands[1]))->common.type))->common.code) == REAL_TYPE || (((enum tree_code) (((((arg0)->exp.operands[1]))->common.type))->common.code) == COMPLEX_TYPE && ((enum tree_code) (((((((arg0)->exp.operands[1]))->common.type))->common.type))->common.code) == REAL_TYPE))
        ? real_zerop (((arg0)->exp.operands[1]))
  ...
  return
    pedantic_non_lvalue
      (convert (type,
         negate_expr
         (convert (((((t)->exp.operands[1]))->common.type),
     arg1))));
       case NE_EXPR:
  ...
  return pedantic_non_lvalue
    (negate_expr (convert (type,
      fold (build1 (ABS_EXPR,
             ...
             arg1)))));
       default:
  fancy_abort ("../../../kgccfe/gnu/fold-const.c", 6977, __FUNCTION__);
       }
   ...
   if (integer_zerop (((arg0)->exp.operands[1])) && integer_zerop (arg2))
     {
       if (comp_code == NE_EXPR)
  return pedantic_non_lvalue (convert (type, arg1));
       else if (comp_code == EQ_EXPR)
  return pedantic_non_lvalue (convert (type, global_trees[TI_INTEGER_ZERO]));
     }
# 7019 "../../../kgccfe/gnu/fold-const.c"
   if (operand_equal_for_comparison_p (((arg0)->exp.operands[1]),
           arg2, ((arg0)->exp.operands[0])))
     {
       tree comp_op0 = ((arg0)->exp.operands[0]);
       tree comp_op1 = ((arg0)->exp.operands[1]);
  ...
  case LT_EXPR:
    ...
    if (!((((mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((((arg1)->common.type))->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
      return pedantic_non_lvalue
  ...
  case GT_EXPR:
    ...
    break;
  default:
    fancy_abort ("../../../kgccfe/gnu/fold-const.c", 7061, __FUNCTION__);
  }
     }
  ...
  arg1 = convert (type, ((arg0)->exp.operands[1]));
  t = build (code, type, ((t)->exp.operands[0]), arg1,
      ((t)->exp.operands[2]));
  break;
  ...
  if (! operand_equal_p (arg2, ((type)->type.maxval), 1)
      && operand_equal_p (((arg0)->exp.operands[1]),
     const_binop (PLUS_EXPR, arg2,
           global_trees[TI_INTEGER_ONE], 0), 1))
    return pedantic_non_lvalue
  ...
  if (! operand_equal_p (arg2, ((type)->type.minval), 1)
      && operand_equal_p (((arg0)->exp.operands[1]),
  ...
  break;
       default:
  fancy_abort ("../../../kgccfe/gnu/fold-const.c", 7125, __FUNCTION__);
       }
 }



      if ((((arg1)->common.constant_flag) || (tree_code_type[(int) (((enum tree_code) (arg1)->common.code))] == 'd')
    || ((enum tree_code) (arg1)->common.code) == SAVE_EXPR)
   && ! (((((t)->exp.operands[2]))->common.constant_flag)
  || (tree_code_type[(int) (((enum tree_code) (((t)->exp.operands[2]))->common.code))] == 'd')
  || ((enum tree_code) (((t)->exp.operands[2]))->common.code) == SAVE_EXPR))
 {
 ...
 return pedantic_non_lvalue (convert (type,
   ...
   && operand_equal_p (((((arg0)->exp.operands[0]))->exp.operands[1]),
         arg1, 1))
 return pedantic_non_lvalue (convert (type, ((arg0)->exp.operands[0])));
   ...
   && truth_value_p (((enum tree_code) (arg1)->common.code)))
 {
   ...
   if (((enum tree_code) (tem)->common.code) != TRUTH_NOT_EXPR)
    ...
    case COMPOUND_EXPR:
      ...
      if (((arg0)->common.side_effects_flag) || pedantic)
 return t;
 ...
 return t;
    ...
    case CALL_EXPR:
      ...
      if (((enum tree_code) (((expr)->exp.operands[0]))->common.code) == ADDR_EXPR
   && (((enum tree_code) (((((expr)->exp.operands[0]))->exp.operands[0]))->common.code)
       == FUNCTION_DECL)
   && (((((((expr)->exp.operands[0]))->exp.operands[0]))->decl.built_in_class) != NOT_BUILT_IN))
 {
     ...
     tree t;
{
 ...
 || tree_expr_nonnegative_p (((t)->exp.operands[1]));
    ...
    case NON_LVALUE_EXPR:
      return tree_expr_nonnegative_p (((t)->exp.operands[0]));
    case RTL_EXPR:
      return rtl_expr_nonnegative_p ((*(rtx *) &(t)->exp.operands[1]));
     ...
     rtx r;
{
  switch (((enum rtx_code) (r)->code))
    {
    case CONST_INT:
      return (((r)->fld[0]).rtwint) >= 0;

    case CONST_DOUBLE:
      if (((enum machine_mode) (r)->mode) == VOIDmode)
 return (((r)->fld[1]).rtwint) >= 0;
      return 0;
 ...
 units = (((((r)->fld[0]).rtvec))->num_elem);

 for (i = 0; i < units; ++i)
   {
     elt = (((((r)->fld[0]).rtvec))->elem[i]);
...
# 1 "../../../kgccfe/gnu/MIPS/gt-fold-const.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-fold-const.h"
...
# 7718 "../../../kgccfe/gnu/fold-const.c" 2
