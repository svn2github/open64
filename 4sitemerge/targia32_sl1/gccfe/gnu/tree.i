...
# 58 "../../../kgccfe/gnu/tree.c" 2



extern int _obstack_allocated_p (struct obstack *h, void * obj);
# 106 "../../../kgccfe/gnu/tree.c"
     ...
     tree node;
{
 ...
 length = (sizeof (struct tree_common)
    + tree_code_length[(int) (code)] * sizeof (char *));
 if (code == TREE_VEC)
   length += ((node)->vec.length) * sizeof (char *) - sizeof (char *);
 return length;
      }

    default:
      fancy_abort ("../../../kgccfe/gnu/tree.c", 224, __FUNCTION__);
    }
}
     ...
     enum tree_code code;
{
  ...
  if (code == TREE_VEC)
    fancy_abort ("../../../kgccfe/gnu/tree.c", 249, __FUNCTION__);

  (((tree)&ttmp)->common.code = (enum tree_code) (code));
  length = tree_size ((tree)&ttmp);
# 305 "../../../kgccfe/gnu/tree.c"
  t = ((union tree_node *) ggc_alloc (length));

  memset ((void *) t, 0, length);
  ...
  switch (type)
    ...
    case 's':
      ...
      ((t)->common.type) = global_trees[TI_VOID_TYPE];
      break;
  ...
  for (link = vals; link; link = ((link)->common.chain))
    {
      ...
      over1 |= ((value)->common.public_flag);
      over2 |= ((value)->common.static_flag);
    }
     ...
     struct real_value d;
{
  ...
  dp = ggc_alloc (sizeof (struct real_value));
...
real_value_from_int_cst (type, i)
     tree type __attribute__ ((__unused__)), i;
{
  struct real_value d;
  ...
  if (! ((((i)->common.type))->common.unsigned_flag))
    real_from_integer (&(d), ((type)->type.mode), (((i)->int_cst.int_cst).low), (((i)->int_cst.int_cst).high), 0);

  else
    real_from_integer (&(d), ((type)->type.mode), (((i)->int_cst.int_cst).low), (((i)->int_cst.int_cst).high), 1);
     ...
     const char *str;
{
  ...
  ((s)->string.length) = len;
  ((s)->string.pointer) = ggc_alloc_string (str, len);
     ...
     int len;
{
  ...
  memset ((void *) t, 0, length);
  ((t)->common.code = (enum tree_code) (TREE_VEC));
  ((t)->vec.length) = len;
     ...
     tree expr;
{
  ...
  if (!uns)
    return ((((expr)->int_cst.int_cst).low) == ~(unsigned long long) 0
     && (((expr)->int_cst.int_cst).high) == -1);



  prec = (mode_bitsize[(int) (((((expr)->common.type))->type.mode))]);
  if (prec >= (8 * 8))
    {
      long long high_value;
      int shift_amount;

      shift_amount = prec - (8 * 8);

      if (shift_amount > (8 * 8))

 fancy_abort ("../../../kgccfe/gnu/tree.c", 703, __FUNCTION__);
      else if (shift_amount == (8 * 8))


 high_value = -1;
      else
 high_value = ((long long) 1 << shift_amount) - 1;

      return ((((expr)->int_cst.int_cst).low) == ~(unsigned long long) 0
       && (((expr)->int_cst.int_cst).high) == high_value);
    }
  else
    return (((expr)->int_cst.int_cst).low) == ((unsigned long long) 1 << prec) - 1;
}
     ...
     tree expr;
{
  ...
  prec = ((((enum tree_code) (((expr)->common.type))->common.code) == POINTER_TYPE || ((enum tree_code) (((expr)->common.type))->common.code) == REFERENCE_TYPE)
   ? ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32) : ((((expr)->common.type))->type.precision));
     ...
     tree expr;
{
 ...
 low &= ~((long long) (-1) << prec);
  ...
  return (high != 0 ? (8 * 8) + exact_log2_wide ((unsigned long long) (high))
   : exact_log2_wide ((unsigned long long) (low)));
}
     ...
     tree expr;
{
 ...
 low &= ~((long long) (-1) << prec);
  ...
  return (high != 0 ? (8 * 8) + floor_log2_wide ((unsigned long long) (high))
   : floor_log2_wide ((unsigned long long) (low)));
}
     ...
     tree chain;
{
  ...
  tree in_tail = chain;
  tree out_tail = (tree) ((void *)0);

  while (in_tail)
    {
      tree next = tree_cons ((tree) ((void *)0), in_tail, (tree) ((void *)0));
      if (out_tail)
     ...
     tree purpose, value, chain;
{
  ...
  node = ((union tree_node *) ggc_alloc (sizeof (struct tree_list)));
     ...
     tree type;
{
  ...
  if (t == 0
      ...
      || (long long) (((t)->int_cst.int_cst).low) < 0)
    return -1;
     ...
     tree type;
{
  ...
  return (integer_zerop (min)
   ? max
   : fold (build (MINUS_EXPR, ((max)->common.type), max, min)));
}
     ...
     tree arg;
{
  switch (((enum tree_code) (arg)->common.code))
    ...
    case COMPONENT_REF:
      return (! ((((arg)->exp.operands[1]))->decl.bit_field_flag)
       && staticp (((arg)->exp.operands[0])));

    case BIT_FIELD_REF:
      return 0;
# 1392 "../../../kgccfe/gnu/tree.c"
    case ARRAY_REF:
     ...
     tree expr;
{
  ...
  for (inner = t;
       (tree_code_type[(int) (((enum tree_code) (inner)->common.code))] == '1'
 || (tree_code_type[(int) (((enum tree_code) (inner)->common.code))] == '2'
     && ((((inner)->exp.operands[1]))->common.constant_flag)));
  ...
  if (((inner)->common.constant_flag)
      || (((inner)->common.readonly_flag) && ! ((inner)->common.side_effects_flag))
      || ((enum tree_code) (inner)->common.code) == SAVE_EXPR || ((enum tree_code) (inner)->common.code) == ERROR_MARK)
    return t;
# 1471 "../../../kgccfe/gnu/tree.c"
  if (contains_placeholder_p (t))
    return t;

  t = build (SAVE_EXPR, ((expr)->common.type), t, current_function_decl, (tree) ((void *)0));
     ...
     tree expr;
{
  ...
  t = build1 (UNSAVE_EXPR, ((expr)->common.type), expr);
     ...
     tree t;
{
  ...
  switch (code)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/tree.c", 1560, __FUNCTION__);
    }
}
     ...
     tree expr;
{
  switch (((enum tree_code) (expr)->common.code))
    {
    case SAVE_EXPR:
      if (! (((expr))->common.asm_written_flag))
 (*(rtx *) &(expr)->exp.operands[2]) = 0;
      break;
 ...
 break;
    ...
    case RTL_EXPR:
      ...
      if ((*(rtx *) &(expr)->exp.operands[0]) != 0)
 fancy_abort ("../../../kgccfe/gnu/tree.c", 1593, __FUNCTION__);
      break;
     ...
     tree expr;
{
  ...
  switch (tree_code_type[(int) (code)])
    ...
    case 'x':
      if (code == TREE_LIST)
 {
   lhd_unsave_expr_now (((expr)->list.value));
   lhd_unsave_expr_now (((expr)->common.chain));
 }
      break;
 ...
 for (i = first_rtl_op (code) - 1; i >= 0; i--)
   lhd_unsave_expr_now (((expr)->exp.operands[i]));
      }
      break;

    default:
      fancy_abort ("../../../kgccfe/gnu/tree.c", 1647, __FUNCTION__);
    }

  return expr;
}
# 1669 "../../../kgccfe/gnu/tree.c"
int
     ...
     tree expr;
{
 ...
 {
   tmp = unsafe_for_reeval (((exp)->list.value));
     ...
     tree exp;
{
  ...
  switch (tree_code_type[(int) (code)])
    ...
    case 'r':
      ...
      return contains_placeholder_p (((exp)->exp.operands[0]));

    case 'x':
      if (code == TREE_LIST)
 return (contains_placeholder_p (((exp)->list.value))
  || (((exp)->common.chain) != 0
      && contains_placeholder_p (((exp)->common.chain))));
      break;
 ...
 case COMPOUND_EXPR:
   ...
   return contains_placeholder_p (((exp)->exp.operands[1]));
 ...
 case COND_EXPR:
   return (contains_placeholder_p (((exp)->exp.operands[0]))
    || contains_placeholder_p (((exp)->exp.operands[1]))
    || contains_placeholder_p (((exp)->exp.operands[2])));

 case SAVE_EXPR:


   if ((((exp))->common.unsigned_flag) || (*(rtx *) &(exp)->exp.operands[2]) != 0)
     return 0;

   (((exp))->common.unsigned_flag) = 1;
   result = contains_placeholder_p (((exp)->exp.operands[0]));
   if (result)
     (((exp))->common.unsigned_flag) = 0;

   return result;

 case CALL_EXPR:
   return (((exp)->exp.operands[1]) != 0
    && contains_placeholder_p (((exp)->exp.operands[1])));
     ...
     tree exp;
{
 ...
 {
   cmp = has_cleanups (((exp)->list.value));
   if (cmp)
     return cmp;
 }
      return 0;
     ...
     tree r;
{
 ...
 {
   op0 = (((exp)->common.chain) == 0
   ? 0 : substitute_in_expr (((exp)->common.chain), f, r));
   op1 = substitute_in_expr (((exp)->list.value), f, r);
   if (op0 == ((exp)->common.chain) && op1 == ((exp)->list.value))
     return exp;

   return tree_cons (((exp)->list.purpose), op1, op0);
 }

      fancy_abort ("../../../kgccfe/gnu/tree.c", 1933, __FUNCTION__);
 ...
 {
 case 1:
   op0 = substitute_in_expr (((exp)->exp.operands[0]), f, r);
   ...
   new = fold (build1 (code, ((exp)->common.type), op0));
   break;
 ...
 case 2:
   ...
   if (code == RTL_EXPR)
     ...
     fancy_abort ("../../../kgccfe/gnu/tree.c", 1958, __FUNCTION__);

   op0 = substitute_in_expr (((exp)->exp.operands[0]), f, r);
   op1 = substitute_in_expr (((exp)->exp.operands[1]), f, r);
   if (op0 == ((exp)->exp.operands[0]) && op1 == ((exp)->exp.operands[1]))
     return exp;

   new = fold (build (code, ((exp)->common.type), op0, op1));
   break;
 ...
 case 3:
   ...
   if (code == SAVE_EXPR)
     ...
     {
       op1 = substitute_in_expr (((exp)->exp.operands[1]), f, r);
       if (op1 == ((exp)->exp.operands[1]))
  return exp;

       return build (code, ((exp)->common.type),
       ((exp)->exp.operands[0]), op1, (tree) ((void *)0));
     }

   else if (code != COND_EXPR)
     fancy_abort ("../../../kgccfe/gnu/tree.c", 1985, __FUNCTION__);

   op0 = substitute_in_expr (((exp)->exp.operands[0]), f, r);
   op1 = substitute_in_expr (((exp)->exp.operands[1]), f, r);
   op2 = substitute_in_expr (((exp)->exp.operands[2]), f, r);
   if (op0 == ((exp)->exp.operands[0]) && op1 == ((exp)->exp.operands[1])
       && op2 == ((exp)->exp.operands[2]))
     return exp;

   new = fold (build (code, ((exp)->common.type), op0, op1, op2));
   break;

 default:
   fancy_abort ("../../../kgccfe/gnu/tree.c", 1998, __FUNCTION__);
 }
 ...
 case COMPONENT_REF:
   ...
   new = fold (build (code, ((exp)->common.type), op0,
        ((exp)->exp.operands[1])));
   break;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/tree.c", 2052, __FUNCTION__);
 }
      break;

    default:
      fancy_abort ("../../../kgccfe/gnu/tree.c", 2057, __FUNCTION__);
    }

  ((new)->common.readonly_flag) = ((exp)->common.readonly_flag);
  return new;
}
# 2072 "../../../kgccfe/gnu/tree.c"
tree
     ...
     tree ref;
{
  ...
  switch (code)
    ...
    case RTL_EXPR:
      result = build1 (INDIRECT_REF, ((ref)->common.type),
         save_expr (build1 (ADDR_EXPR,
       build_pointer_type (((ref)->common.type)),
       ref)));
      break;
     ...
     tree e;
{
 ...
 return save_expr (e);
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/tree.c", 2228, __FUNCTION__);
    }
...
build (enum tree_code code, tree tt, ...)
{
  ...
  if (length == 2)
    {
      ...
      tree arg0 = __builtin_va_arg(p,tree);
      tree arg1 = __builtin_va_arg(p,tree);
      ...
      if (arg0 && fro > 0)
 {
   ...
   if (!((arg0)->common.constant_flag))
     constant = 0;
      ...
      if (arg1 && fro > 1)
 {
   if (((arg1)->common.side_effects_flag))
     ((t)->common.side_effects_flag) = 1;
   if (!((arg1)->common.readonly_flag))
     ((t)->common.readonly_flag) = 0;
 ...
 fancy_abort ("../../../kgccfe/gnu/tree.c", 2315, __FUNCTION__);
      ((t)->exp.operands[0]) = arg0;
    }
  else
    {
      for (i = 0; i < length; i++)
 {
   tree operand = __builtin_va_arg(p,tree);
  ...
  ((t)->common.side_effects_flag) = 1;
       if (!((operand)->common.constant_flag))
  constant = 0;
     }
 }
    }
     ...
     tree node;
{
  ...
  tree t;
# 2370 "../../../kgccfe/gnu/tree.c"
  length = sizeof (struct tree_exp);

  t = ((union tree_node *) ggc_alloc (length));

  memset ((void *) t, 0, sizeof (struct tree_common));
  ...
  switch (code)
    ...
    default:
      if (tree_code_type[(int) (code)] == '1' && node && ((node)->common.constant_flag))
 ((t)->common.constant_flag) = 1;
      break;
    }
...
build_nt (enum tree_code code, ...)
{
  ...
  for (i = 0; i < length; i++)
    ((t)->exp.operands[i]) = __builtin_va_arg(p,tree);
     ...
     tree name, type;
{
  ...
  if (code == VAR_DECL || code == PARM_DECL || code == RESULT_DECL)
    ...
    ((t)->decl.mode) = ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? DImode : SImode);
...
build_block (vars, tags, subblocks, supercontext, chain)
     tree vars, tags __attribute__ ((__unused__)), subblocks, supercontext, chain;
{
     ...
     int line, col;
{
  ...
  static tree last_filenode = (tree) ((void *)0);
  tree wfl = make_node (EXPR_WITH_FILE_LOCATION);

  (((wfl))->exp.operands[0]) = node;
  (((wfl)->exp.complexity) = ((line) << 12) | ((col) & 0xfff));
  if (file != last_file)
    {
      last_file = file;
      last_filenode = file ? (__builtin_constant_p (file) ? get_identifier_with_length ((file), (unsigned) strlen (file)) : (get_identifier) (file)) : (tree) ((void *)0);
    }

  (((wfl))->exp.operands[1]) = last_filenode;
  if (node)
    {
      ((wfl)->common.side_effects_flag) = ((node)->common.side_effects_flag);
      ((wfl)->common.type) = ((node)->common.type);
    }
  ...
  if (! attribute_list_equal (((ttype)->type.attributes), attribute))
    {
      ...
      hashcode = (((size_t) (((enum tree_code) (ntype)->common.code)) & 0777777)
    + ((size_t) (((ntype)->common.type)) & 0777777)
    + attribute_hash_list (attribute));

      switch (((enum tree_code) (ntype)->common.code))
 {
 case FUNCTION_TYPE:
   hashcode += ((size_t) (((ntype)->type.values)) & 0777777);
   break;
 case ARRAY_TYPE:
   hashcode += ((size_t) (((ntype)->type.values)) & 0777777);
   break;
 case INTEGER_TYPE:
   hashcode += ((size_t) (((ntype)->type.maxval)) & 0777777);
   break;
 case REAL_TYPE:
   hashcode += ((size_t) (((ntype)->type.precision)) & 0777777);
   break;
 default:
   break;
 }
      ...
      ttype = build_qualified_type (ntype, ((((ttype)->common.readonly_flag) * 0x1) | (((ttype)->common.volatile_flag) * 0x2) | (((ttype)->type.restrict_flag) * 0x4) | ((((enum tree_code) (ttype)->common.code) == RECORD_TYPE && ((ttype)->common.type)) * 0x8)));
    }

  return ttype;
}
# 2602 "../../../kgccfe/gnu/tree.c"
int
     ...
     tree ident;
{
  ...
  if (strcmp (attr, ((char *)(ident)->identifier.id.str)) == 0)
    return 1;

  p = ((char *)(ident)->identifier.id.str);
  ident_len = strlen (p);
  ...
  if (attr[0] == '_')
   ...
   || attr[attr_len - 2] != '_'
   || attr[attr_len - 1] != '_')
 fancy_abort ("../../../kgccfe/gnu/tree.c", 2626, __FUNCTION__);
     ...
     tree list;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/tree.c", 2659, __FUNCTION__);
     ...
     tree a1, a2;
{
      ...
      else
 {
   ...
   for (; a2 != 0; a2 = ((a2)->common.chain))
     {
       tree a;
       for (a = lookup_attribute (((char *)(((a2)->list.purpose))->identifier.id.str),
      attributes);
     a != (tree) ((void *)0);
     a = lookup_attribute (((char *)(((a2)->list.purpose))->identifier.id.str),
      ((a)->common.chain)))
  {
    if (simple_cst_equal (((a)->list.value), ((a2)->list.value)) == 1)
      break;
  }
       if (a == (tree) ((void *)0))
  {
     ...
     int type_quals;
{
  ...
  ((type)->common.sbuf) = (type_quals & 0x10) != 0;
  ((type)->common.sdram) = (type_quals & 0x20) != 0;
  ((type)->common.v1buf) = (type_quals & 0x40) != 0;
  ((type)->common.v2buf) = (type_quals & 0x80) != 0;
  ((type)->common.v4buf) = (type_quals & 0x100) != 0;
     ...
     int type_quals;
{
  ...
  for (t = ((type)->type.main_variant); t; t = ((t)->type.next_variant))
    if (((((t)->common.readonly_flag) * 0x1) | (((t)->common.volatile_flag) * 0x2) | (((t)->type.restrict_flag) * 0x4) | ((((enum tree_code) (t)->common.code) == RECORD_TYPE && ((t)->common.type)) * 0x8)) == type_quals && ((t)->type.name) == ((type)->type.name)
...
_Bool Check_Vbuf_Type_Spec(type)
     tree type;
{
...
# 2865 "../../../kgccfe/gnu/tree.c"
        return ( ((type)->type.mode) == QImode);
}
     ...
     tree list;
{
  ...
  for (hashcode = 0, tail = list; tail; tail = ((tail)->common.chain))
    hashcode += ((size_t) (((tail)->list.value)) & 0777777);
     ...
     const void *vb;
{
  ...
  if (a->hash == b->hash
      ...
      && (((a->type)->type.maxval) == ((b->type)->type.maxval)
   ...
   || tree_int_cst_equal (((a->type)->type.minval),
     ((b->type)->type.minval)))
      ...
      && (((a->type)->type.values) == ((b->type)->type.values)
   || (((a->type)->type.values)
       && ((enum tree_code) (((a->type)->type.values))->common.code) == TREE_LIST
       && ((b->type)->type.values)
       && ((enum tree_code) (((b->type)->type.values))->common.code) == TREE_LIST
       && type_list_equal (((a->type)->type.values),
      ((b->type)->type.values)))))
    return 1;
  return 0;
}
     ...
     tree list;
{
  ...
  for (hashcode = 0, tail = list; tail; tail = ((tail)->common.chain))
    ...
    hashcode += ((size_t) (((tail)->list.purpose)) & 0777777);
  return hashcode;
}
     ...
     tree l1, l2;
{
  ...
  for (; t2 != 0; t2 = ((t2)->common.chain))
    {
      tree attr;
      for (attr = lookup_attribute (((char *)(((t2)->list.purpose))->identifier.id.str), l1);
    attr != (tree) ((void *)0);
    attr = lookup_attribute (((char *)(((t2)->list.purpose))->identifier.id.str),
        ((attr)->common.chain)))
 {
   if (simple_cst_equal (((t2)->list.value), ((attr)->list.value)) == 1)
     break;
 }
     ...
     tree type;
{
  ...
  for (t = ((type)->type.values); t; t = ((t)->common.chain))


    if ((((enum tree_code) (((t)->list.value))->common.code) == VOID_TYPE))
      break;
    else
      ++i;
     ...
     tree t1, t2;
{
 ...
 return 0;
  ...
  return (((unsigned long long) (((t1)->int_cst.int_cst).high) < (unsigned long long) (((t2)->int_cst.int_cst).high)) || (((unsigned long long) (((t1)->int_cst.int_cst).high) == (unsigned long long) (((t2)->int_cst.int_cst).high)) && (((t1)->int_cst.int_cst).low) < (((t2)->int_cst.int_cst).low)));
}
     ...
     int pos;
{
  if (host_integerp (t, pos))
    ...
    fancy_abort ("../../../kgccfe/gnu/tree.c", 3320, __FUNCTION__);
}
     ...
     tree t;
{
  ...
  prec = (mode_bitsize[(int) (((((t)->common.type))->type.mode))]) - 1;
     ...
     tree l1, l2;
{
  while (l1 != (tree) ((void *)0) && l2 != (tree) ((void *)0))
    {
      if (simple_cst_equal (((l1)->list.value), ((l2)->list.value)) != 1)
 return 0;
     ...
     tree t1, t2;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/tree.c", 3434, __FUNCTION__);
...
# 3547 "../../../kgccfe/gnu/tree.c"
tree
build_pointer_type (to_type)
     tree to_type;
{
  tree t = ((to_type)->type.pointer_to);
...
build_reference_type (to_type)
     tree to_type;
{
  tree t = ((to_type)->type.reference_to);
     ...
     tree t;
{
  switch (((enum tree_code) (t)->common.code))
    {
    case POINTER_TYPE:
      return build_pointer_type (build_type_no_quals (((t)->common.type)));
    case REFERENCE_TYPE:
      return build_reference_type (build_type_no_quals (((t)->common.type)));
    default:
      return ((t)->type.main_variant);
    }
}
# 3629 "../../../kgccfe/gnu/tree.c"
tree
     ...
     tree itype1, itype2;
{
  ...
  if (((enum tree_code) (itype1)->common.code) == INTEGER_TYPE)
   ...
   || simple_cst_equal (((itype1)->type.size), ((itype2)->type.size)) != 1
   || ((itype1)->type.align) != ((itype2)->type.align))
 return 0;

      if (1 == simple_cst_equal (((itype1)->type.minval),
     ((itype2)->type.minval))
   && 1 == simple_cst_equal (((itype1)->type.maxval),
        ((itype2)->type.maxval)))
 return 1;
    }
     ...
     tree elt_type, index_type;
{
  ...
  hashcode = ((size_t) (elt_type) & 0777777) + ((size_t) (index_type) & 0777777);
     ...
     tree value_type, arg_types;
{
  ...
  hashcode = ((size_t) (value_type) & 0777777) + type_hash_list (arg_types);
  t = type_hash_canon (hashcode, t);
...
build_function_type_list (tree return_type, ...)
{
  ...
  { va_list p; __builtin_va_start(p,return_type); { struct Qdmy;
  struct Qdmy;

  t = __builtin_va_arg(p,tree);
  for (args = (tree) ((void *)0); t != (tree) ((void *)0); t = __builtin_va_arg(p,tree))
     ...
     tree basetype, type;
{
  ...
  if (((enum tree_code) (type)->common.code) != FUNCTION_TYPE)
    fancy_abort ("../../../kgccfe/gnu/tree.c", 3854, __FUNCTION__);
  ...
  hashcode = ((size_t) (basetype) & 0777777) + ((size_t) (type) & 0777777);
  t = type_hash_canon (hashcode, t);
     ...
     tree component_type;
{
  ...
  set_type_quals (t, ((((component_type)->common.readonly_flag) * 0x1) | (((component_type)->common.volatile_flag) * 0x2) | (((component_type)->type.restrict_flag) * 0x4) | ((((enum tree_code) (component_type)->common.code) == RECORD_TYPE && ((component_type)->common.type)) * 0x8)));


  hashcode = ((size_t) (component_type) & 0777777);
  t = type_hash_canon (hashcode, t);
 ...
 name = 0;
      ...
      if (name != 0)
 ((t)->type.name) = (__builtin_constant_p (name) ? get_identifier_with_length ((name), (unsigned) strlen (name)) : (get_identifier) (name));
    }

  return t;
}
# 3986 "../../../kgccfe/gnu/tree.c"
tree
     ...
     int *unsignedp_ptr;
{
      ...
      else
 {
  ...
  if (((enum tree_code) (op)->common.code) == COMPONENT_REF
      ...
      && ((((op)->exp.operands[1]))->decl.size) != 0)
    {
      unsigned long long innerprec
 = tree_low_cst (((((op)->exp.operands[1]))->decl.size), 1);
      tree type = (*lang_hooks.types.type_for_size) (innerprec,
           ((op)->common.unsigned_flag));
# 4146 "../../../kgccfe/gnu/tree.c"
      if (innerprec < ((((op)->common.type))->type.precision)
     ...
     tree c, type;
{
  ...
  if (((type)->type.maxval) != (tree) ((void *)0)
      && ((type)->type.minval) != (tree) ((void *)0)
 ...
 return (! (((unsigned long long) (((((type)->type.maxval))->int_cst.int_cst).high) < (unsigned long long) (((c)->int_cst.int_cst).high)) || (((unsigned long long) (((((type)->type.maxval))->int_cst.int_cst).high) == (unsigned long long) (((c)->int_cst.int_cst).high)) && (((((type)->type.maxval))->int_cst.int_cst).low) < (((c)->int_cst.int_cst).low)))
  && ! (((unsigned long long) (((c)->int_cst.int_cst).high) < (unsigned long long) (((((type)->type.minval))->int_cst.int_cst).high)) || (((unsigned long long) (((c)->int_cst.int_cst).high) == (unsigned long long) (((((type)->type.minval))->int_cst.int_cst).high)) && (((c)->int_cst.int_cst).low) < (((((type)->type.minval))->int_cst.int_cst).low)))

  && ! ((((c)->int_cst.int_cst).high) < 0
        && ! ((((c)->common.type))->common.unsigned_flag)));
      else
 return (! ((((((type)->type.maxval))->int_cst.int_cst).high) < (((c)->int_cst.int_cst).high) || ((((((type)->type.maxval))->int_cst.int_cst).high) == (((c)->int_cst.int_cst).high) && (((((type)->type.maxval))->int_cst.int_cst).low) < (((c)->int_cst.int_cst).low)))
  && ! ((((c)->int_cst.int_cst).high) < (((((type)->type.minval))->int_cst.int_cst).high) || ((((c)->int_cst.int_cst).high) == (((((type)->type.minval))->int_cst.int_cst).high) && (((c)->int_cst.int_cst).low) < (((((type)->type.minval))->int_cst.int_cst).low)))
     ...
     tree type;
{
  ...
  if (((type)->type.size)
      && ((type)->type.size) != global_trees[TI_ERROR_MARK]
  ...
  if ((((enum tree_code) (type)->common.code) == POINTER_TYPE
      ...
      && variably_modified_type_p (((type)->common.type)))
    return 1;
  ...
  if (((enum tree_code) (type)->common.code) == FUNCTION_TYPE
      || ((enum tree_code) (type)->common.code) == METHOD_TYPE)
    {
      ...
      if (variably_modified_type_p (((type)->common.type)))
 return 1;
      for (parm = ((type)->type.values);
    parm && parm != global_trees[TI_VOID_LIST_NODE];
    parm = ((parm)->common.chain))
 if (variably_modified_type_p (((parm)->list.value)))
   return 1;
    }
     ...
     tree decl;
{
  ...
  if (((enum tree_code) (decl)->common.code) == SAVE_EXPR)
    ...
    context
      = ((((((((((decl)->common.type))->type.values))->list.value))->common.type))->type.main_variant);
     ...
     tree decl;
{
 ...
 return (tree) ((void *)0);
   ...
   || ((enum tree_code) (context)->common.code) == QUAL_UNION_TYPE)
 return context;
 ...
 fancy_abort ("../../../kgccfe/gnu/tree.c", 4341, __FUNCTION__);
    }
  return (tree) ((void *)0);
}
     ...
     tree call;
{
  ...
  if (((enum tree_code) (call)->common.code) != CALL_EXPR)
    fancy_abort ("../../../kgccfe/gnu/tree.c", 4359, __FUNCTION__);
...
default_flag_random_seed ()
{
...

 {
   ...
   value = (((unsigned long long) tv.tv_usec << 16)
     ^ tv.tv_sec ^ getpid ());
 }
  ...
  new_random_seed = xmalloc ((8 * 8) / 3 + 2);
  sprintf (new_random_seed, "%llu", value);
     ...
     char *template;
{
  ...
  for (i = 0; i < strlen (flag_random_seed); i++)
    v = (v << 4) ^ (v >> ((8 * 8) - 4)) ^ flag_random_seed[i];
     ...
     const char *type;
{
 ...
 file = input_filename;
      ...
      q = (char *) __builtin_alloca(7 + strlen (name) + strlen (file));
  ...
  buf = (char *) __builtin_alloca(sizeof ("_GLOBAL__%s_%s") + strlen (p) + strlen (type));
     ...
     int bit_size;
{
  int i;
  tree vals;
  long long domain_min
    = tree_low_cst (((((((init)->common.type))->type.values))->type.minval), 0);
  ...
  for (vals = ((init)->exp.operands[1]);
    ...
    {
      if (!host_integerp (((vals)->list.value), 0)
   || (((vals)->list.purpose) != (tree) ((void *)0)
       && !host_integerp (((vals)->list.purpose), 0)))
 non_const_bits
   = tree_cons (((vals)->list.purpose), ((vals)->list.value), non_const_bits);
      else if (((vals)->list.purpose) != (tree) ((void *)0))
 {
   ...
   long long hi_index
     = tree_low_cst (((vals)->list.value), 0) - domain_min;

   if (lo_index < 0 || lo_index >= bit_size
       || hi_index < 0 || hi_index >= bit_size)
     fancy_abort ("../../../kgccfe/gnu/tree.c", 4638, __FUNCTION__);
     ...
     int wd_size;
{
  ...
  char *bit_buffer = (char *) __builtin_alloca(bit_size);
     ...
     tree t;
{
  ...
  {
    tree index = build_int_2_wide ((unsigned long long) ((((mode_unit_size[(int) ((t->type.mode))]) == 0) ? 0 : ((mode_size[(int) ((t->type.mode))]) / (mode_unit_size[(int) ((t->type.mode))]))) - 1), (long long) (0));
...
build_common_tree_nodes (signed_char)
     int signed_char;
{
  global_trees[TI_ERROR_MARK] = make_node (ERROR_MARK);
  ...
  integer_types[itk_int] = make_signed_type (((target_flags & 0x00000001) ? 64 : 32));
  integer_types[itk_unsigned_int] = make_unsigned_type (((target_flags & 0x00000001) ? 64 : 32));
  integer_types[itk_long] = make_signed_type (((target_flags & 0x00000002) ? 64 : 32));
  integer_types[itk_unsigned_long] = make_unsigned_type (((target_flags & 0x00000002) ? 64 : 32));
  integer_types[itk_long_long] = make_signed_type (64);
  integer_types[itk_unsigned_long_long] = make_unsigned_type (64);

  global_trees[TI_INTQI_TYPE] = make_signed_type ((mode_bitsize[(int) (QImode)]));
  global_trees[TI_INTHI_TYPE] = make_signed_type ((mode_bitsize[(int) (HImode)]));
  global_trees[TI_INTSI_TYPE] = make_signed_type ((mode_bitsize[(int) (SImode)]));
  global_trees[TI_INTDI_TYPE] = make_signed_type ((mode_bitsize[(int) (DImode)]));
  global_trees[TI_INTTI_TYPE] = make_signed_type ((mode_bitsize[(int) (TImode)]));

  global_trees[TI_UINTQI_TYPE] = make_unsigned_type ((mode_bitsize[(int) (QImode)]));
  global_trees[TI_UINTHI_TYPE] = make_unsigned_type ((mode_bitsize[(int) (HImode)]));
  global_trees[TI_UINTSI_TYPE] = make_unsigned_type ((mode_bitsize[(int) (SImode)]));
  global_trees[TI_UINTDI_TYPE] = make_unsigned_type ((mode_bitsize[(int) (DImode)]));
  global_trees[TI_UINTTI_TYPE] = make_unsigned_type ((mode_bitsize[(int) (TImode)]));
}
     ...
     int short_double;
{
  ...
  global_trees[TI_INTEGER_ZERO] = build_int_2_wide ((unsigned long long) (0), (long long) (0));
  global_trees[TI_INTEGER_ONE] = build_int_2_wide ((unsigned long long) (1), (long long) (0));
  global_trees[TI_INTEGER_MINUS_ONE] = build_int_2_wide ((unsigned long long) (-1), (long long) (-1));

  global_trees[TI_SIZE_ZERO] = size_int_wide ((long long) (0), SIZETYPE);
  global_trees[TI_SIZE_ONE] = size_int_wide ((long long) (1), SIZETYPE);
  global_trees[TI_BITSIZE_ZERO] = size_int_wide ((long long) (0), BITSIZETYPE);
  global_trees[TI_BITSIZE_ONE] = size_int_wide ((long long) (1), BITSIZETYPE);
  global_trees[TI_BITSIZE_UNIT] = size_int_wide ((long long) (8), BITSIZETYPE);

  global_trees[TI_VOID_TYPE] = make_node (VOID_TYPE);
  ...
  global_trees[TI_NULL_POINTER] = build_int_2_wide ((unsigned long long) (0), (long long) (0));
  ...
  global_trees[TI_FLOAT_TYPE] = make_node (REAL_TYPE);
  ((global_trees[TI_FLOAT_TYPE])->type.precision) = 32;
  layout_type (global_trees[TI_FLOAT_TYPE]);

  global_trees[TI_DOUBLE_TYPE] = make_node (REAL_TYPE);
  if (short_double)
  ...
  global_trees[TI_LONG_DOUBLE_TYPE] = make_node (REAL_TYPE);
  ((global_trees[TI_LONG_DOUBLE_TYPE])->type.precision) = (mips_abi == 1 || mips_abi == 2 ? 128 : 64);
  layout_type (global_trees[TI_LONG_DOUBLE_TYPE]);

  global_trees[TI_COMPLEX_INTEGER_TYPE] = make_node (COMPLEX_TYPE);
  ((global_trees[TI_COMPLEX_INTEGER_TYPE])->common.type) = integer_types[itk_int];
  layout_type (global_trees[TI_COMPLEX_INTEGER_TYPE]);

  global_trees[TI_COMPLEX_FLOAT_TYPE] = make_node (COMPLEX_TYPE);
  ((global_trees[TI_COMPLEX_FLOAT_TYPE])->common.type) = global_trees[TI_FLOAT_TYPE];
  layout_type (global_trees[TI_COMPLEX_FLOAT_TYPE]);

  global_trees[TI_COMPLEX_DOUBLE_TYPE] = make_node (COMPLEX_TYPE);
  ...
  global_trees[TI_COMPLEX_LONG_DOUBLE_TYPE] = make_node (COMPLEX_TYPE);
  ...
  global_trees[TI_UV4SI_TYPE]
    = make_vector (V4SImode, global_trees[TI_UINTSI_TYPE], 1);
  global_trees[TI_UV2HI_TYPE]
    = make_vector (V2HImode, global_trees[TI_UINTHI_TYPE], 1);
  global_trees[TI_UV2SI_TYPE]
    = make_vector (V2SImode, global_trees[TI_UINTSI_TYPE], 1);
  global_trees[TI_UV2DI_TYPE]
    = make_vector (V2DImode, global_trees[TI_UINTDI_TYPE], 1);
  global_trees[TI_UV4HI_TYPE]
    = make_vector (V4HImode, global_trees[TI_UINTHI_TYPE], 1);
  global_trees[TI_UV8QI_TYPE]
    = make_vector (V8QImode, global_trees[TI_UINTQI_TYPE], 1);
  global_trees[TI_UV8HI_TYPE]
    = make_vector (V8HImode, global_trees[TI_UINTHI_TYPE], 1);
  global_trees[TI_UV16QI_TYPE]
    = make_vector (V16QImode, global_trees[TI_UINTQI_TYPE], 1);
  global_trees[TI_UV1DI_TYPE]
    = make_vector (V1DImode, global_trees[TI_UINTDI_TYPE], 1);

  global_trees[TI_V16SF_TYPE] = make_vector (V16SFmode, global_trees[TI_FLOAT_TYPE], 0);
  global_trees[TI_V4SF_TYPE] = make_vector (V4SFmode, global_trees[TI_FLOAT_TYPE], 0);
  global_trees[TI_V4SI_TYPE] = make_vector (V4SImode, global_trees[TI_INTSI_TYPE], 0);
  global_trees[TI_V2HI_TYPE] = make_vector (V2HImode, global_trees[TI_INTHI_TYPE], 0);
  global_trees[TI_V2SI_TYPE] = make_vector (V2SImode, global_trees[TI_INTSI_TYPE], 0);
  global_trees[TI_V2DI_TYPE] = make_vector (V2DImode, global_trees[TI_INTDI_TYPE], 0);
  global_trees[TI_V4HI_TYPE] = make_vector (V4HImode, global_trees[TI_INTHI_TYPE], 0);
  global_trees[TI_V8QI_TYPE] = make_vector (V8QImode, global_trees[TI_INTQI_TYPE], 0);
  global_trees[TI_V8HI_TYPE] = make_vector (V8HImode, global_trees[TI_INTHI_TYPE], 0);
  global_trees[TI_V2SF_TYPE] = make_vector (V2SFmode, global_trees[TI_FLOAT_TYPE], 0);
  global_trees[TI_V2DF_TYPE] = make_vector (V2DFmode, global_trees[TI_DOUBLE_TYPE], 0);
  global_trees[TI_V16QI_TYPE] = make_vector (V16QImode, global_trees[TI_INTQI_TYPE], 0);
  global_trees[TI_V1DI_TYPE] = make_vector (V1DImode, global_trees[TI_INTDI_TYPE], 0);
}
     ...
     int unsignedp;
{
  ...
  ((t)->type.mode) = mode;
  ((((t)->common.type))->common.unsigned_flag) = unsignedp;
  finish_vector_type (t);
     ...
     tree init;
{
 ...
 || (real_zerop (init)
    ...
    case CONSTRUCTOR:
      {
 if ((((enum tree_code) (((init)->common.type))->common.code) == ARRAY_TYPE || ((enum tree_code) (((init)->common.type))->common.code) == RECORD_TYPE || ((enum tree_code) (((init)->common.type))->common.code) == UNION_TYPE || ((enum tree_code) (((init)->common.type))->common.code) == QUAL_UNION_TYPE || ((enum tree_code) (((init)->common.type))->common.code) == SET_TYPE))
   {
     tree aggr_init = ((init)->exp.operands[1]);

     while (aggr_init)
       {
  if (! initializer_zerop (((aggr_init)->list.value)))
    return 0;
  aggr_init = ((aggr_init)->common.chain);
       }
     return 1;
   }
 return 0;
...
# 1 "../../../kgccfe/gnu/MIPS/gt-tree.h" 1
# 23 "../../../kgccfe/gnu/MIPS/gt-tree.h"
void
  ...
  if (((x) != ((void *)0) && ((void *) (x)) != (void *) 1 && ! ggc_set_mark (x)))
    {
      if ((*x).entries != ((void *)0)) {
        ...
        for (i1 = 0; i1 < (size_t)(((*x)).size); i1++) {
          do { if ((*x).entries[i1] != ((void *)0)) gt_ggc_mx_type_hash ((*x).entries[i1]); } while (0);
        }
      }
  }
}
