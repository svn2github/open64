...
# 28 "../../../kgccfe/gnu/cfganal.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 29 "../../../kgccfe/gnu/cfganal.c" 2
...
static void flow_dfs_compute_reverse_add_bb
  (depth_first_search_ds, basic_block);
...
static _Bool need_fake_edge_p (rtx);
static _Bool flow_active_insn_p (rtx);
     ...
     basic_block bb;
{
  ...
  for (insn = bb->head; insn != bb->end; insn = (((insn)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && flow_active_insn_p (insn))
      return 0;

  return (!((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i')
...
mark_dfs_back_edges ()
{
  ...
  stack[sp++] = (&entry_exit_blocks[0])->succ;
  ...
  while (sp)
    {
      ...
      if (dest != (&entry_exit_blocks[1]) && ! ((visited)->elms [(dest->index) / ((unsigned) (8 * 8))] >> (dest->index) % ((unsigned) (8 * 8)) & 1))
 {

   ((visited)->elms [(dest->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (dest->index) % ((unsigned) (8 * 8)));
 ...
 {
   if (dest != (&entry_exit_blocks[1]) && src != (&entry_exit_blocks[0])
       && pre[src->index] >= pre[dest->index]
       && post[dest->index] == 0)
     e->flags |= 32, found = 1;

   if (! e->succ_next && src != (&entry_exit_blocks[0]))
...
set_edge_can_fallthru_flag ()
{
 ...
 continue;
      if (!invert_jump (bb->end, (((bb->end)->fld[9]).rtx), 0))
 continue;
      invert_jump (bb->end, (((bb->end)->fld[9]).rtx), 0);
      bb->succ->flags |= 64;
     ...
     rtx insn;
{
  ...
  return ((((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == ASM_OPERANDS
    && ((((((insn)->fld[5]).rtx)))->volatil))
   || (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL
       && asm_noperands (insn) != -1
       && (((((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0])))->volatil))
   || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == ASM_INPUT);
}
# 282 "../../../kgccfe/gnu/cfganal.c"
int
     ...
     sbitmap blocks;
{
  ...
  if (! blocks)
    ...
    check_last_block = ((blocks)->elms [((&entry_exit_blocks[1])->prev_bb->index) / ((unsigned) (8 * 8))] >> ((&entry_exit_blocks[1])->prev_bb->index) % ((unsigned) (8 * 8)) & 1);
# 311 "../../../kgccfe/gnu/cfganal.c"
  if (check_last_block)
    {
      basic_block bb = (&entry_exit_blocks[1])->prev_bb;
      rtx insn = bb->end;
 ...
 continue;
      ...
      if (blocks && !((blocks)->elms [(i) / ((unsigned) (8 * 8))] >> (i) % ((unsigned) (8 * 8)) & 1))
 continue;
      ...
      for (insn = bb->end; ; insn = prev_insn)
 {
  ...
  while (split_at_insn != bb->end
         && keep_with_call_p ((((split_at_insn)->fld[2]).rtx)))
    split_at_insn = (((split_at_insn)->fld[2]).rtx);
# 380 "../../../kgccfe/gnu/cfganal.c"
     ...
     struct edge_list *elist;
{
  ...
  for (x = 0; x < elist->num_edges; x++)
    {
      fprintf (f, " %-4d - edge(", x);
      if (((elist)->index_to_edge[(x)]->src) == (&entry_exit_blocks[0]))
 fprintf (f, "entry,");
      else
 fprintf (f, "%d,", ((elist)->index_to_edge[(x)]->src)->index);

      if (((elist)->index_to_edge[(x)]->dest) == (&entry_exit_blocks[1]))
 fprintf (f, "exit)\n");
      else
     ...
     struct edge_list *elist;
{
      ...
      for (e = bb->succ; e; e = e->succ_next)
 {
  ...
  for (p = (&entry_exit_blocks[0]); p != (&entry_exit_blocks[1]); p = p->next_bb)
    for (s = (&entry_exit_blocks[0])->next_bb; s != ((void *)0); s = s->next_bb)
      {
 int found_edge = 0;
     ...
     FILE *file;
{
  ...
  fprintf (file, "%s { ", str);
  do { unsigned int word_num_; unsigned int bit_num_ = (0) % (unsigned int) ((unsigned) (8 * 8)); unsigned int size_ = (nodes)->size; unsigned long long *ptr_ = (nodes)->elms; for (word_num_ = (0) / (unsigned int) ((unsigned) (8 * 8)); word_num_ < size_; word_num_++, bit_num_ = 0) { unsigned long long word_ = ptr_[word_num_]; if (word_ != 0) for (; bit_num_ < ((unsigned) (8 * 8)); bit_num_++) { unsigned long long _mask = (unsigned long long) 1 << bit_num_; if ((word_ & _mask) != 0) { word_ &= ~ _mask; (node) = word_num_ * ((unsigned) (8 * 8)) + bit_num_; {fprintf (file, "%d ", node);}; if (word_ == 0) break; } } } } while (0);
  fputs_unlocked ("}\n", file);
}
...
add_noreturn_fake_exit_edges ()
{
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    if (bb->succ == ((void *)0))
      make_single_succ_edge (bb, (&entry_exit_blocks[1]), 16);
}
# 722 "../../../kgccfe/gnu/cfganal.c"
void
connect_infinite_loops_to_exit ()
{
  ...
  flow_dfs_compute_reverse_add_bb (&dfs_ds, (&entry_exit_blocks[1]));
 ...
 break;
      ...
      make_edge (unvisited_block, (&entry_exit_blocks[1]), 16);
     ...
     int *rc_order;
{
      ...
      else
 {
  ...
  if (dfsnum > n_basic_blocks)
    fancy_abort ("../../../kgccfe/gnu/cfganal.c", 895, __FUNCTION__);


  if (dfsnum < n_basic_blocks)
    fancy_abort ("../../../kgccfe/gnu/cfganal.c", 899, __FUNCTION__);
     ...
     int *pot_order;
{
 ...
 sp--;
  ...
  i = 0;
  node = &dfst[(&entry_exit_blocks[0])->next_bb->index];
  pot_order[i++] = 0;
...
# 1062 "../../../kgccfe/gnu/cfganal.c"
static void
flow_dfs_compute_reverse_init (data)
     depth_first_search_ds data;
{

  data->stack = (basic_block *) xmalloc ((n_basic_blocks - ((-3) + 1))
      * sizeof (basic_block));
  data->sp = 0;
     ...
     basic_block bb;
{
  ...
  ((data->visited_blocks)->elms [(bb->index - ((-3) + 1)) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (bb->index - ((-3) + 1)) % ((unsigned) (8 * 8)));
}
     ...
     depth_first_search_ds data;
{
 ...
 if (!((data->visited_blocks)->elms [(e->src->index - ((-3) + 1)) / ((unsigned) (8 * 8))] >> (e->src->index - ((-3) + 1)) % ((unsigned) (8 * 8)) & 1))
  ...
  for (bb = (&entry_exit_blocks[1]); bb != ((void *)0); bb = bb->prev_bb)
    if (!((data->visited_blocks)->elms [(bb->index - ((-3) + 1)) / ((unsigned) (8 * 8))] >> (bb->index - ((-3) + 1)) % ((unsigned) (8 * 8)) & 1))
      return bb;
...
dfs_enumerate_from (bb, reverse, predicate, rslt, rslt_max, data)
     basic_block bb;
     int reverse;
     _Bool (*predicate) (basic_block, void *);
     basic_block *rslt;
     int rslt_max;
     void *data;
{
  ...
  while (sp)
    {
     ...
     if (!(e->src->flags & 8) && predicate (e->src, data))
       {
         if (tv == rslt_max)
           fancy_abort ("../../../kgccfe/gnu/cfganal.c", 1163, __FUNCTION__);
         rslt[tv++] = st[sp++] = e->src;
         e->src->flags |= 8;
       }
        }
     ...
     if (!(e->dest->flags & 8) && predicate (e->dest, data))
       {
         if (tv == rslt_max)
           fancy_abort ("../../../kgccfe/gnu/cfganal.c", 1174, __FUNCTION__);
