...
# 56 "../../../kgccfe/gnu/emit-rtl.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 57 "../../../kgccfe/gnu/emit-rtl.c" 2
...
static rtx static_regno_reg_rtx[176];
...
static mem_attrs *get_mem_attrs (long long, tree, rtx, rtx, unsigned int, enum machine_mode);
...
const_int_htab_hash (x)
     const void *x;
{
  return (hashval_t) ((((struct rtx_def *) x)->fld[0]).rtwint);
}
...
const_int_htab_eq (x, y)
     ...
     const void *y;
{
  return (((((rtx) x)->fld[0]).rtwint) == *((const long long *) y));
}
     ...
     const void *x;
{
  ...
  if (((enum machine_mode) (value)->mode) == VOIDmode)
    h = (((value)->fld[0]).rtwint) ^ (((value)->fld[1]).rtwint);
  else
    h = real_hash (((struct real_value *)&(((value)->fld[0]).rtwint)));
  return h;
}
     ...
     const void *y;
{
  ...
  if (((enum machine_mode) (a)->mode) == VOIDmode)
    return ((((a)->fld[0]).rtwint) == (((b)->fld[0]).rtwint)
     && (((a)->fld[1]).rtwint) == (((b)->fld[1]).rtwint));
  else
    return real_identical (((struct real_value *)&(((a)->fld[0]).rtwint)),
      ((struct real_value *)&(((b)->fld[0]).rtwint)));
}
     ...
     const void *x;
{
  ...
  return (p->alias ^ (p->align * 1000)
   ^ ((p->offset ? (((p->offset)->fld[0]).rtwint) : 0) * 50000)
   ^ ((p->size ? (((p->size)->fld[0]).rtwint) : 0) * 2500000)
   ^ (size_t) p->expr);
}
     ...
     enum machine_mode mode;
{
  ...
  if (alias == 0 && expr == 0 && offset == 0
      && (size == 0
   || (mode != BLKmode && (mode_size[(int) (mode)]) == (((size)->fld[0]).rtwint)))
      && (align == 8
   || (1
...
gen_raw_REG (mode, regno)
     ...
     int regno;
{
  rtx x = gen_rtx_fmt_i0 (REG, (mode), (regno));
  (((x)->fld[1]).rtuint) = regno;
  return x;
}
...
gen_int_mode (c, mode)
     ...
     enum machine_mode mode;
{
  return gen_rtx_CONST_INT (VOIDmode, (long long) (trunc_int_for_mode (c, mode)));
}
# 387 "../../../kgccfe/gnu/emit-rtl.c"
static rtx
     ...
     enum machine_mode mode;
{
  ...
  ((real)->mode = (enum machine_mode) (mode));

  memcpy (&(((real)->fld[0]).rtwint), &value, sizeof (struct real_value));
     ...
     enum machine_mode mode;
{
  ...
  if (mode != VOIDmode)
   ...
   && (mode_class[(int) (mode)]) != MODE_PARTIAL_INT

   && (mode_class[(int) (mode)]) != MODE_VECTOR_INT
   && (mode_class[(int) (mode)]) != MODE_VECTOR_FLOAT)
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 434, __FUNCTION__);




      width = (mode_bitsize[(int) (mode)]);
      if (width < (8 * 8)
   && ((i0 & ((long long) (-1) << (width - 1)))
       != ((long long) (-1) << (width - 1))))
 i0 &= ((long long) 1 << width) - 1, i1 = 0;
      else if (width == (8 * 8)
        && ! (i1 == ~0 && i0 < 0))
 i1 = 0;
      else if (width > 2 * (8 * 8))

 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 449, __FUNCTION__);
# 460 "../../../kgccfe/gnu/emit-rtl.c"
      if (width < (8 * 8)
   && (i0 & ((long long) 1 << (width - 1))))
 i0 |= ((long long) (-1) << width);
# 482 "../../../kgccfe/gnu/emit-rtl.c"
      if (width <= (8 * 8))
 i1 = (i0 < 0) ? ~(long long) 0 : 0;
    }


  if ((i1 == 0 && i0 >= 0) || (i1 == ~0 && i0 < 0))
    return gen_rtx_CONST_INT (VOIDmode, (long long) (i0));


  value = rtx_alloc (CONST_DOUBLE);
  ((value)->mode = (enum machine_mode) (VOIDmode));

  (((value)->fld[0]).rtwint) = i0;
  (((value)->fld[1]).rtwint) = i1;

  for (i = 2; i < (sizeof "www" - 1); i++)
    (((value)->fld[i]).rtwint) = 0;
...
gen_rtx_REG (mode, regno)
     ...
     unsigned int regno;
{
# 522 "../../../kgccfe/gnu/emit-rtl.c"
  if (mode == (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) && !reload_in_progress)
    {
      if (regno == (0 + 1)
   && (!reload_completed || frame_pointer_needed))
 return (global_rtl[GR_FRAME_POINTER]);

      if (regno == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)
   && (!reload_completed || frame_pointer_needed))
     ...
     int offset;
{
  ...
  if ((offset % (mode_size[(int) (mode)])) != 0)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 593, __FUNCTION__);
# 603 "../../../kgccfe/gnu/emit-rtl.c"
...
gen_rtx (enum rtx_code code, enum machine_mode mode, ...)
{
  ...
  switch (code)
    {
    case CONST_INT:
      rt_val = gen_rtx_CONST_INT (mode, __builtin_va_arg(p,long long));
      break;

    case CONST_DOUBLE:
      {
 long long arg0 = __builtin_va_arg(p,long long);
 long long arg1 = __builtin_va_arg(p,long long);
      ...
      for (i = 0; i < (rtx_length[(int) (code)]); i++)
 {
   switch (*fmt++)
     ...
     case 'i':
       (((rt_val)->fld[i]).rtint) = __builtin_va_arg(p,int);
       break;

     case 'w':
       (((rt_val)->fld[i]).rtwint) = __builtin_va_arg(p,long long);
       break;

     case 's':
       (((rt_val)->fld[i]).rtstr) = __builtin_va_arg(p,char *);
       break;

     case 'e':
     case 'u':
       (((rt_val)->fld[i]).rtx) = __builtin_va_arg(p,rtx);
       break;

     case 'E':
       (((rt_val)->fld[i]).rtvec) = __builtin_va_arg(p,rtvec);
       break;

     case 'b':
       (((rt_val)->fld[i]).rtbit) = __builtin_va_arg(p,bitmap);
       break;

     case 't':
       (((rt_val)->fld[i]).rttree) = __builtin_va_arg(p,tree);
       break;

     default:
       fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 726, __FUNCTION__);
     }
 }
      break;
    }
...
gen_rtvec (int n, ...)
{
  ...
  { va_list p; __builtin_va_start(p,n); { struct Qdmy;
  struct Qdmy;
     ...
     enum machine_mode mode;
{
  ...
  if (no_new_pseudos)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 799, __FUNCTION__);
   ...
   || (mode_class[(int) (mode)]) == MODE_COMPLEX_INT))
    {
      ...
      enum machine_mode partmode = inner_mode_array[(int) (mode)];
     ...
     rtx reg;
{
  if (((enum rtx_code) (reg)->code) == CONCAT)
    {
      ((((((reg)->fld[0]).rtx)))->volatil) = 1;
      ((((((reg)->fld[1]).rtx)))->volatil) = 1;
    }
  else if (((enum rtx_code) (reg)->code) == REG)
    (((reg))->volatil) = 1;
  else
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 864, __FUNCTION__);
}
  ...
  if (! (((reg))->frame_related))
    {
      ...
      if (align)
 (cfun->emit->regno_pointer_align[(((reg)->fld[0]).rtuint)]) = align;
    }
  else if (align && align < (cfun->emit->regno_pointer_align[(((reg)->fld[0]).rtuint)]))
     ...
     int check_mode;
{
  ...
  if (((enum rtx_code) (x)->code) != SUBREG
    ...
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 928, __FUNCTION__);
  base_regno = (((reg)->fld[0]).rtuint);
  if (base_regno >= 176)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 931, __FUNCTION__);
  if (check_mode && ! mips_hard_regno_mode_ok[ (int)(((enum machine_mode) (reg)->mode)) ][ (base_regno) ])
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 933, __FUNCTION__);
  ...
  byte_offset = (((x)->fld[1]).rtuint);
  if ((byte_offset % (mode_size[(int) (mode)])) != 0)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 942, __FUNCTION__);

  final_regno = subreg_regno (x);

  return final_regno;
}
# 960 "../../../kgccfe/gnu/emit-rtl.c"
rtx
gen_lowpart_common (mode, x)
     enum machine_mode mode;
     rtx x;
{
  int msize = (mode_size[(int) (mode)]);
  int xsize = (mode_size[(int) (((enum machine_mode) (x)->mode))]);
  int offset = 0;
  ...
  if (((enum machine_mode) (x)->mode) != VOIDmode
      && ((msize + (((target_flags & 0x00002000) ? 8 : 4) - 1)) / ((target_flags & 0x00002000) ? 8 : 4)
   > ((xsize + (((target_flags & 0x00002000) ? 8 : 4) - 1)) / ((target_flags & 0x00002000) ? 8 : 4))))
    return 0;


  if ((mode_class[(int) (mode)]) == MODE_FLOAT
      && ((enum machine_mode) (x)->mode) != VOIDmode && msize > xsize)
    return 0;
  ...
  if ((((enum rtx_code) (x)->code) == ZERO_EXTEND || ((enum rtx_code) (x)->code) == SIGN_EXTEND)
   ...
   || (mode_class[(int) (mode)]) == MODE_PARTIAL_INT))
    {
# 997 "../../../kgccfe/gnu/emit-rtl.c"
      if (((enum machine_mode) ((((x)->fld[0]).rtx))->mode) == mode)
 return (((x)->fld[0]).rtx);
      else if ((mode_size[(int) (mode)]) < (mode_size[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]))
 return gen_lowpart_common (mode, (((x)->fld[0]).rtx));
      else if ((mode_size[(int) (mode)]) < (mode_size[(int) (((enum machine_mode) (x)->mode))]))
 return gen_rtx_fmt_e (((enum rtx_code) (x)->code), mode, (((x)->fld[0]).rtx));
    }
    ...
    return simplify_gen_subreg (mode, x, ((enum machine_mode) (x)->mode), offset);
  else if (((mode_class[(int) (mode)]) == MODE_VECTOR_INT
     || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT)
    && ((enum machine_mode) (x)->mode) == VOIDmode)
    return simplify_gen_subreg (mode, x, int_mode_for_mode (mode), offset);


  else if (((mode_class[(int) (mode)]) == MODE_INT
     || (mode_class[(int) (mode)]) == MODE_PARTIAL_INT)
    && ((enum machine_mode) (x)->mode) == VOIDmode
    && (((enum rtx_code) (x)->code) == CONST_INT || ((enum rtx_code) (x)->code) == CONST_DOUBLE))
    {




      if ((mode_bitsize[(int) (mode)]) >= 2 * (8 * 8))
 return x;
      else if ((mode_bitsize[(int) (mode)]) > (8 * 8))
 return 0;
      else if ((mode_bitsize[(int) (mode)]) == (8 * 8))
 return (((enum rtx_code) (x)->code) == CONST_INT ? x
  : gen_rtx_CONST_INT (VOIDmode, (long long) ((((x)->fld[0]).rtwint))));
      else
 {

   long long val = (((enum rtx_code) (x)->code) == CONST_INT ? (((x)->fld[0]).rtwint)
          : (((x)->fld[0]).rtwint));


   val = trunc_int_for_mode (val, mode);

   return (((enum rtx_code) (x)->code) == CONST_INT && (((x)->fld[0]).rtwint) == val ? x
    : gen_rtx_CONST_INT (VOIDmode, (long long) (val)));
 }
    }
# 1050 "../../../kgccfe/gnu/emit-rtl.c"
  else if ((mode_class[(int) (mode)]) == MODE_FLOAT
    && (mode_bitsize[(int) (mode)]) == 32
    && ((enum rtx_code) (x)->code) == CONST_INT)
    {
      struct real_value r;
      long i = (((x)->fld[0]).rtwint);

      real_from_target (&r, &i, mode);
      return const_double_from_real_value (r, mode);
    }
  else if ((mode_class[(int) (mode)]) == MODE_FLOAT
    && (mode_bitsize[(int) (mode)]) == 64
    && (((enum rtx_code) (x)->code) == CONST_INT || ((enum rtx_code) (x)->code) == CONST_DOUBLE)
    && ((enum machine_mode) (x)->mode) == VOIDmode)
    {
      struct real_value r;
 ...
 i[0] = low, i[1] = high;
    ...
    && (mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_FLOAT)
    {
      struct real_value r;
      long i[4];
      int endian = ((target_flags & 0x00010000) != 0) ? 1 : 0;



      memcpy (&(r), &((((x))->fld[0]).rtwint), sizeof (struct real_value));
      switch ((mode_bitsize[(int) (((enum machine_mode) (x)->mode))]))
 {
 case 32:
   ((i[3 * endian]) = real_to_target (((void *)0), &(r), mode_for_size (32, MODE_FLOAT, 0)));
   i[1] = 0;
   i[2] = 0;
   i[3 - 3 * endian] = 0;
   break;
 case 64:
   real_to_target (i + 2 * endian, &(r), mode_for_size (64, MODE_FLOAT, 0));
   i[2 - 2 * endian] = 0;
   i[3 - 2 * endian] = 0;
   break;
 case 96:
   real_to_target (i + endian, &(r), mode_for_size ((mips_abi == 1 || mips_abi == 2 ? 128 : 64), MODE_FLOAT, 0));
   i[3 - 3 * endian] = 0;
   break;
 case 128:
   real_to_target (i, &(r), mode_for_size ((mips_abi == 1 || mips_abi == 2 ? 128 : 64), MODE_FLOAT, 0));
   break;
 default:
   fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1126, __FUNCTION__);
 }
      ...
      if ((8 * 8) != 64)
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1134, __FUNCTION__);

      return immed_double_const ((((unsigned long) i[3 * endian])
      | ((long long) i[1 + endian] << 32)),
     (((unsigned long) i[2 - endian])
      | ((long long) i[3 - 3 * endian] << 32)),
     mode);
...
gen_realpart (mode, x)
     ...
     rtx x;
{
# 1165 "../../../kgccfe/gnu/emit-rtl.c"
  if (((enum rtx_code) (x)->code) == CONCAT && ((enum machine_mode) ((((x)->fld[0]).rtx))->mode) == mode)
    return (((x)->fld[0]).rtx);
...
{
  if (((enum rtx_code) (x)->code) != SUBREG)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1204, __FUNCTION__);

  return ((unsigned int) (((x)->fld[1]).rtuint)
   < (mode_unit_size[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]));
}
# 1217 "../../../kgccfe/gnu/emit-rtl.c"
rtx
gen_lowpart (mode, x)
     enum machine_mode mode;
     rtx x;
{
  ...
  if (result)
  ...
  else if (((enum rtx_code) (x)->code) == REG)
    {
      ...
      if (result == 0)
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1231, __FUNCTION__);
      return result;
    }
 ...
 offset -= (((((target_flags & 0x00002000) ? 8 : 4)) < ((mode_size[(int) (mode)])) ? (((target_flags & 0x00002000) ? 8 : 4)) : ((mode_size[(int) (mode)])))
  ...
  else if (((enum rtx_code) (x)->code) == ADDRESSOF)
    return gen_lowpart (mode, force_reg (((enum machine_mode) (x)->mode), x));
  else
...
gen_highpart (mode, x)
     ...
     rtx x;
{
  unsigned int msize = (mode_size[(int) (mode)]);
  rtx result;



  if (msize > ((target_flags & 0x00002000) ? 8 : 4)
      && msize != (mode_unit_size[(int) (((enum machine_mode) (x)->mode))]))
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1280, __FUNCTION__);
     ...
     rtx exp;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1315, __FUNCTION__);
     ...
     enum machine_mode outermode, innermode;
{
  ...
  int difference = ((mode_size[(int) (innermode)]) - (mode_size[(int) (outermode)]));

  if (difference > 0)
    {
      if (((target_flags & 0x00010000) != 0))
 offset += (difference / ((target_flags & 0x00002000) ? 8 : 4)) * ((target_flags & 0x00002000) ? 8 : 4);
      if (((target_flags & 0x00010000) != 0))
 offset += difference % ((target_flags & 0x00002000) ? 8 : 4);
    }
     ...
     enum machine_mode outermode, innermode;
{
  ...
  if ((mode_size[(int) (innermode)]) < (mode_size[(int) (outermode)]))
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1353, __FUNCTION__);
     ...
     rtx x;
{
  if (((enum rtx_code) (x)->code) != SUBREG)
    return 1;
  else if (((enum machine_mode) ((((x)->fld[0]).rtx))->mode) == VOIDmode)
    return 0;

  return (subreg_lowpart_offset (((enum machine_mode) (x)->mode), ((enum machine_mode) ((((x)->fld[0]).rtx))->mode))
   == (((x)->fld[1]).rtuint));
}
...
constant_subword (op, offset, mode)
     ...
     enum machine_mode mode;
{
  int size_ratio = (8 * 8) / (8 * ((target_flags & 0x00002000) ? 8 : 4));
  long long val;
  ...
  if ((8 * 8) >= (8 * ((target_flags & 0x00002000) ? 8 : 4))
      ...
      && ((enum rtx_code) (op)->code) == CONST_DOUBLE)
    {
      ...
      memcpy (&(rv), &((((op))->fld[0]).rtwint), sizeof (struct real_value));
      real_to_target (k, &(rv), mode_for_size (64, MODE_FLOAT, 0));
# 1424 "../../../kgccfe/gnu/emit-rtl.c"
      if ((8 * ((target_flags & 0x00002000) ? 8 : 4)) == 32)
 {
   val = k[offset];
   val = ((val & 0xffffffff) ^ 0x80000000) - 0x80000000;
   return gen_rtx_CONST_INT (VOIDmode, (long long) (val));
 }

      else if ((8 * ((target_flags & 0x00002000) ? 8 : 4)) >= 64 && offset == 0)
 {
   val = k[! ((target_flags & 0x00010000) != 0)];
   val = (((val & 0xffffffff) ^ 0x80000000) - 0x80000000) << 32;
   val |= (long long) k[((target_flags & 0x00010000) != 0)] & 0xffffffff;
   return gen_rtx_CONST_INT (VOIDmode, (long long) (val));
 }

      else if ((8 * ((target_flags & 0x00002000) ? 8 : 4)) == 16)
 {
   val = k[offset >> 1];
   if ((offset & 1) == ! ((target_flags & 0x00010000) != 0))
     val >>= 16;
   val = ((val & 0xffff) ^ 0x8000) - 0x8000;
   return gen_rtx_CONST_INT (VOIDmode, (long long) (val));
 }
      else
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1448, __FUNCTION__);
    }
    ...
    && ((enum rtx_code) (op)->code) == CONST_DOUBLE)
    {
      ...
      memcpy (&(rv), &((((op))->fld[0]).rtwint), sizeof (struct real_value));
      real_to_target (k, &(rv), mode_for_size ((mips_abi == 1 || mips_abi == 2 ? 128 : 64), MODE_FLOAT, 0));
      ...
      if ((8 * ((target_flags & 0x00002000) ? 8 : 4)) == 32)
 {
   ...
   return gen_rtx_CONST_INT (VOIDmode, (long long) (val));
      ...
      else if ((8 * ((target_flags & 0x00002000) ? 8 : 4)) >= 64 && offset <= 1)
 {
   val = k[offset * 2 + ! ((target_flags & 0x00010000) != 0)];
   val = (((val & 0xffffffff) ^ 0x80000000) - 0x80000000) << 32;
   val |= (long long) k[offset * 2 + ((target_flags & 0x00010000) != 0)] & 0xffffffff;
   return gen_rtx_CONST_INT (VOIDmode, (long long) (val));
 }

      else
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1477, __FUNCTION__);
    }
  ...
  if ((mode_class[(int) (mode)]) == MODE_FLOAT
      ...
      && ((enum rtx_code) (op)->code) == CONST_DOUBLE)
    {
      ...
      memcpy (&(rv), &((((op))->fld[0]).rtwint), sizeof (struct real_value));
      ((l) = real_to_target (((void *)0), &(rv), mode_for_size (32, MODE_FLOAT, 0)));


      val = l;
      val = ((val & 0xffffffff) ^ 0x80000000) - 0x80000000;

      if ((8 * ((target_flags & 0x00002000) ? 8 : 4)) == 16)
 {
   if ((offset & 1) == ! ((target_flags & 0x00010000) != 0))
     val >>= 16;
   val = ((val & 0xffff) ^ 0x8000) - 0x8000;
...
# 1515 "../../../kgccfe/gnu/emit-rtl.c"
  if (op == (const_int_rtx[64]))
    return op;

  if ((mode_class[(int) (mode)]) != MODE_INT
      || (((enum rtx_code) (op)->code) != CONST_INT && ((enum rtx_code) (op)->code) != CONST_DOUBLE)
      || (8 * ((target_flags & 0x00002000) ? 8 : 4)) > (8 * 8))
    return 0;

  if (((target_flags & 0x00010000) != 0))
    offset = (mode_size[(int) (mode)]) / ((target_flags & 0x00002000) ? 8 : 4) - 1 - offset;



  val = (offset / size_ratio == 0
  ? (((enum rtx_code) (op)->code) == CONST_INT ? (((op)->fld[0]).rtwint) : (((op)->fld[0]).rtwint))
  : (((enum rtx_code) (op)->code) == CONST_INT
     ? ((((op)->fld[0]).rtwint) < 0 ? ~0 : 0) : (((op)->fld[1]).rtwint)));


  if ((8 * ((target_flags & 0x00002000) ? 8 : 4)) < (8 * 8))
    val = ((val >> ((offset % size_ratio) * (8 * ((target_flags & 0x00002000) ? 8 : 4)))));

  val = trunc_int_for_mode (val, word_mode);

  return gen_rtx_CONST_INT (VOIDmode, (long long) (val));
}
# 1567 "../../../kgccfe/gnu/emit-rtl.c"
rtx
     ...
     enum machine_mode mode;
{
  ...
  if (mode == VOIDmode)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1578, __FUNCTION__);
  ...
  if (mode != BLKmode
      && (offset + 1) * ((target_flags & 0x00002000) ? 8 : 4) > (mode_size[(int) (mode)]))
    return (const_int_rtx[64]);


  if (((enum rtx_code) (op)->code) == MEM)
    {
      rtx new = adjust_address_1 (op, word_mode, offset * ((target_flags & 0x00002000) ? 8 : 4), 0, 1);
 ...
 {
   if (! strict_memory_address_p (word_mode, (((new)->fld[0]).rtx)))
     return 0;
 }
      else
 return replace_equiv_address (new, (((new)->fld[0]).rtx));
    }


  return simplify_gen_subreg (word_mode, op, mode, (offset * ((target_flags & 0x00002000) ? 8 : 4)));
}
     ...
     enum machine_mode mode;
{
 ...
 op = force_reg (mode, op);
  ...
  if (result == 0)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1640, __FUNCTION__);
     ...
     rtx insn;
{
  ...
  if (((enum rtx_code) (body)->code) == SET)
    ...
    comp = ((((((((body)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx);

  if (((enum rtx_code) (comp)->code) == COMPARE)
    {
      rtx op0 = (((comp)->fld[0]).rtx);
      rtx op1 = (((comp)->fld[1]).rtx);
      (((comp)->fld[0]).rtx) = op1;
      (((comp)->fld[1]).rtx) = op0;
    }
  else
 ...
 ((((((((body)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx) = new;
    }
}
     ...
     tree ref;
{
 ...
 inner = (tree) ((void *)0);
  ...
  if (inner == ((ref)->exp.operands[0]))
    ...
    return build (COMPONENT_REF, ((ref)->common.type), inner,
    ((ref)->exp.operands[1]));
}
...
set_mem_attributes_minus_bitpos (ref, t, objectp, bitpos)
     ...
     long long bitpos;
{
  long long alias = ((((ref)->fld[1]).rtmem) == 0 ? 0 : (((ref)->fld[1]).rtmem)->alias);
  tree expr = ((((ref)->fld[1]).rtmem) == 0 ? 0 : (((ref)->fld[1]).rtmem)->expr);
  rtx offset = ((((ref)->fld[1]).rtmem) == 0 ? 0 : (((ref)->fld[1]).rtmem)->offset);
  rtx size = ((((ref)->fld[1]).rtmem) != 0 ? (((ref)->fld[1]).rtmem)->size : ((enum machine_mode) (ref)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (ref)->mode))]))) : 0);
  unsigned int align = ((((ref)->fld[1]).rtmem) != 0 ? (((ref)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (ref)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (ref)->mode)) : 8));
  long long apply_bitpos = 0;
  tree type;
  ...
  if ((tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 'd') && ref == (((t)->decl.rtl != ((void *)0)) ? ((t)->decl.rtl ? (t)->decl.rtl : (make_decl_rtl (t, ((void *)0)), (t)->decl.rtl)) : ((void *)0)))
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 1750, __FUNCTION__);
  ...
  && (((type)->common.readonly_flag) || ((t)->common.readonly_flag)))
 || (! (tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 't') && ((t)->common.constant_flag)));
  ...
  if (((type)->type.size_unit) && host_integerp (((type)->type.size_unit), 1))
    size = gen_rtx_CONST_INT (VOIDmode, (long long) (tree_low_cst (((type)->type.size_unit), 1)));
      ...
      if ((tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 'd'))
 {
   ...
   size = (((t)->decl.size_unit)
    ...
    ? gen_rtx_CONST_INT (VOIDmode, (long long) (tree_low_cst (((t)->decl.size_unit), 1))) : 0);
      ...
      else if (tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 'c')
 {
   ...
   align = ((((enum tree_code) (t)->common.code) == STRING_CST || ((enum tree_code) (t)->common.code) == CONSTRUCTOR) && (align) < (8 * ((target_flags & 0x00002000) ? 8 : 4)) ? (8 * ((target_flags & 0x00002000) ? 8 : 4)) : (align));
      ...
      else if (((enum tree_code) (t)->common.code) == ARRAY_REF)
 {
  ...
  index = build (WITH_RECORD_EXPR, ((index)->common.type), index, t2);
       if (! ((unit_size)->common.constant_flag)
    && contains_placeholder_p (unit_size))
  unit_size = build (WITH_RECORD_EXPR, sizetype_tab[(int) SIZETYPE],
       unit_size, array);

       off_tree
  = fold (build (PLUS_EXPR, sizetype_tab[(int) SIZETYPE],
          fold (build (MULT_EXPR, sizetype_tab[(int) SIZETYPE],
         index,
         unit_size)),
          off_tree));
  ...
  {
    long long ioff = tree_low_cst (off_tree, 1);
    long long aoff = (ioff & -ioff) * 8;
    align = ((t2)->decl.u1.a.align);
    if (aoff && aoff < align)
             align = aoff;
    offset = gen_rtx_CONST_INT (VOIDmode, (long long) (ioff));
    apply_bitpos = bitpos;
  }
     }
   else if (((enum tree_code) (t2)->common.code) == COMPONENT_REF)
     {
       ...
       if (host_integerp (off_tree, 1))
  {
    offset = gen_rtx_CONST_INT (VOIDmode, (long long) (tree_low_cst (off_tree, 1)));
    apply_bitpos = bitpos;
  }
        ...
        && ((enum tree_code) (((t)->exp.operands[0]))->common.code) == PARM_DECL)
 {
  ...
  if (apply_bitpos)
    {
      offset = plus_constant_wide ((offset), (long long) (-(apply_bitpos / 8)));
      if (size)
 size = plus_constant_wide ((size), (long long) (apply_bitpos / 8));
    }
  ...
  if ((((ref))->in_struct) || (((ref))->frame_related))
    return;
     ...
     long long set;
{
  ...
  (((mem)->fld[1]).rtmem) = get_mem_attrs (set, ((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->expr), ((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->offset),
       ((((mem)->fld[1]).rtmem) != 0 ? (((mem)->fld[1]).rtmem)->size : ((enum machine_mode) (mem)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (mem)->mode))]))) : 0), ((((mem)->fld[1]).rtmem) != 0 ? (((mem)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (mem)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (mem)->mode)) : 8)),
...
set_mem_align (mem, align)
     ...
     unsigned int align;
{
  (((mem)->fld[1]).rtmem) = get_mem_attrs (((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->alias), ((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->expr),
       ((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->offset), ((((mem)->fld[1]).rtmem) != 0 ? (((mem)->fld[1]).rtmem)->size : ((enum machine_mode) (mem)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (mem)->mode))]))) : 0), align,
       ((enum machine_mode) (mem)->mode));
}
...
{
  (((mem)->fld[1]).rtmem)
    = get_mem_attrs (((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->alias), expr, ((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->offset),
       ((((mem)->fld[1]).rtmem) != 0 ? (((mem)->fld[1]).rtmem)->size : ((enum machine_mode) (mem)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (mem)->mode))]))) : 0), ((((mem)->fld[1]).rtmem) != 0 ? (((mem)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (mem)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (mem)->mode)) : 8)), ((enum machine_mode) (mem)->mode));
}
...
{
  (((mem)->fld[1]).rtmem) = get_mem_attrs (((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->alias), ((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->expr),
       offset, ((((mem)->fld[1]).rtmem) != 0 ? (((mem)->fld[1]).rtmem)->size : ((enum machine_mode) (mem)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (mem)->mode))]))) : 0), ((((mem)->fld[1]).rtmem) != 0 ? (((mem)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (mem)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (mem)->mode)) : 8)),
       ((enum machine_mode) (mem)->mode));
}
...
{
  (((mem)->fld[1]).rtmem) = get_mem_attrs (((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->alias), ((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->expr),
       ((((mem)->fld[1]).rtmem) == 0 ? 0 : (((mem)->fld[1]).rtmem)->offset), size, ((((mem)->fld[1]).rtmem) != 0 ? (((mem)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (mem)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (mem)->mode)) : 8)),
       ((enum machine_mode) (mem)->mode));
}
     ...
     int validate;
{
  ...
  if (((enum rtx_code) (memref)->code) != MEM)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 2039, __FUNCTION__);
  if (mode == VOIDmode)
      ...
      if (reload_in_progress || reload_completed)
 {
   if (! memory_address_p (mode, addr))
     fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 2050, __FUNCTION__);
 }
      else
 addr = memory_address (mode, addr);
    }

  if (rtx_equal_p (addr, (((memref)->fld[0]).rtx)) && mode == ((enum machine_mode) (memref)->mode))
    return memref;

  new = gen_rtx_MEM (mode, addr);
  ((((new))->volatil) = (((memref))->volatil), (((new))->in_struct) = (((memref))->in_struct), (((new))->frame_related) = (((memref))->frame_related), (((new))->call) = (((memref))->call), (((new))->unchanging) = (((memref))->unchanging), (((new))->jump) = (((memref))->jump), (((new)->fld[1]).rtmem) = (((memref)->fld[1]).rtmem));
  return new;
}
     ...
     rtx addr;
{
  ...
  (((new)->fld[1]).rtmem)
    = get_mem_attrs (((((memref)->fld[1]).rtmem) == 0 ? 0 : (((memref)->fld[1]).rtmem)->alias), 0, 0,
       mmode == BLKmode ? 0 : gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (mmode)]))),
       (mmode == BLKmode ? 8
...
adjust_address_1 (memref, mode, offset, validate, adjust)
     ...
     int validate, adjust;
{
  rtx addr = (((memref)->fld[0]).rtx);
  rtx new;
  rtx memoffset = ((((memref)->fld[1]).rtmem) == 0 ? 0 : (((memref)->fld[1]).rtmem)->offset);
  rtx size = 0;
  unsigned int memalign = ((((memref)->fld[1]).rtmem) != 0 ? (((memref)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (memref)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (memref)->mode)) : 8));
 ...
 addr = gen_rtx_fmt_ee (LO_SUM, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), ((((addr)->fld[0]).rtx)), (plus_constant_wide (((((addr)->fld[1]).rtx)), (long long) (offset))));

      else
 addr = plus_constant_wide ((addr), (long long) (offset));
    }
  ...
  if (memoffset)
    memoffset = gen_rtx_CONST_INT (VOIDmode, (long long) (offset + (((memoffset)->fld[0]).rtwint)));
  ...
  if (offset != 0)
    memalign
      = ((memalign) < ((unsigned long long) (offset & -offset) * 8) ? (memalign) : ((unsigned long long) (offset & -offset) * 8));



  if (((enum machine_mode) (new)->mode) != BLKmode)
    size = gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (new)->mode))])));
  else if (((((memref)->fld[1]).rtmem) != 0 ? (((memref)->fld[1]).rtmem)->size : ((enum machine_mode) (memref)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (memref)->mode))]))) : 0))
    size = plus_constant_wide ((((((memref)->fld[1]).rtmem) != 0 ? (((memref)->fld[1]).rtmem)->size : ((enum machine_mode) (memref)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (memref)->mode))]))) : 0)), (long long) (-offset));

  (((new)->fld[1]).rtmem) = get_mem_attrs (((((memref)->fld[1]).rtmem) == 0 ? 0 : (((memref)->fld[1]).rtmem)->alias), ((((memref)->fld[1]).rtmem) == 0 ? 0 : (((memref)->fld[1]).rtmem)->expr),
...
offset_address (memref, offset, pow2)
     ...
     long long pow2;
{
  rtx new, addr = (((memref)->fld[0]).rtx);

  new = simplify_gen_binary (PLUS, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), addr, offset);
# 2191 "../../../kgccfe/gnu/emit-rtl.c"
  if (! memory_address_p (((enum machine_mode) (memref)->mode), new)
      && ((enum rtx_code) (addr)->code) == PLUS
      && (((addr)->fld[0]).rtx) == pic_offset_table_rtx)
    {
      addr = force_reg (((enum machine_mode) (addr)->mode), addr);
      new = simplify_gen_binary (PLUS, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), addr, offset);
    }

  update_temp_slot_address ((((memref)->fld[0]).rtx), new);
  new = change_address_1 (memref, VOIDmode, new, 1);



  (((new)->fld[1]).rtmem)
    = get_mem_attrs (((((memref)->fld[1]).rtmem) == 0 ? 0 : (((memref)->fld[1]).rtmem)->alias), ((((memref)->fld[1]).rtmem) == 0 ? 0 : (((memref)->fld[1]).rtmem)->expr), 0, 0,
       ((((((memref)->fld[1]).rtmem) != 0 ? (((memref)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (memref)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (memref)->mode)) : 8))) < ((unsigned long long) pow2 * 8) ? (((((memref)->fld[1]).rtmem) != 0 ? (((memref)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (memref)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (memref)->mode)) : 8))) : ((unsigned long long) pow2 * 8)),
     ...
     rtx addr;
{
  ...
  update_temp_slot_address ((((memref)->fld[0]).rtx), addr);
     ...
     long long offset;
{
  ...
  tree expr = ((((new)->fld[1]).rtmem) == 0 ? 0 : (((new)->fld[1]).rtmem)->expr);
  rtx memoffset = ((((new)->fld[1]).rtmem) == 0 ? 0 : (((new)->fld[1]).rtmem)->offset);
      ...
      if (((enum tree_code) (expr)->common.code) == COMPONENT_REF)
 {
   ...
   if (((enum tree_code) (((field)->decl.size_unit))->common.code) == INTEGER_CST
       ...
       && (((memoffset)->fld[0]).rtwint) >= 0)
     break;

   if (! host_integerp (((field)->decl.arguments), 1))
     {
       expr = (tree) ((void *)0);
       break;
     }
   ...
   memoffset = (gen_rtx_CONST_INT (VOIDmode, (long long) ((((memoffset)->fld[0]).rtwint) + tree_low_cst (((field)->decl.arguments), 1) + (tree_low_cst (((field)->decl.u2.t), 1) / 8))));
        ...
        && (! memoffset || (((memoffset)->fld[0]).rtwint) >= 0))
 break;
      else
 {
  ...
  (((new)->fld[1]).rtmem) = get_mem_attrs (0, expr, memoffset, gen_rtx_CONST_INT (VOIDmode, (long long) (size)),
       ((((new)->fld[1]).rtmem) != 0 ? (((new)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (new)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (new)->mode)) : 8)), mode);
     ...
     rtx first, last;
{
  ...
  for (insn = first; insn; insn = (((insn)->fld[2]).rtx))
    (cfun->emit->x_cur_insn_uid) = (((cfun->emit->x_cur_insn_uid)) > ((((insn)->fld[0]).rtint)) ? ((cfun->emit->x_cur_insn_uid)) : ((((insn)->fld[0]).rtint)));
     ...
     int first, last;
{
  ...
  (cfun->emit->x_first_label_num) = first;
  last_label_num = last;
}
...
restore_emit_status (p)
     struct function *p __attribute__ ((__unused__));
{
  last_label_num = 0;
}
     ...
     rtx insn;
{
  ...
  for (decl = ((fndecl)->decl.arguments); decl; decl = ((decl)->common.chain))
    ((decl)->decl.rtl = (copy_rtx_if_shared (((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))));
     ...
     rtx insn;
{
  ...
  for (p = insn; p; p = (((p)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i'))
      {
 reset_used_flags ((((p)->fld[5]).rtx));
 reset_used_flags ((((p)->fld[8]).rtx));
 reset_used_flags ((((p)->fld[7]).rtx));
      }
     ...
     rtx insn;
{
 ...
 (((insn)->fld[8]).rtx) = copy_rtx_if_shared ((((insn)->fld[8]).rtx));
 (((insn)->fld[7]).rtx) = copy_rtx_if_shared ((((insn)->fld[7]).rtx));
      }
}
     ...
     tree blk;
{
  ...
  for (t = ((blk)->block.vars); t; t = ((t)->common.chain))
    if (((t)->decl.rtl != ((void *)0)))
      ((t)->decl.rtl = (copy_rtx_if_shared (((t)->decl.rtl ? (t)->decl.rtl : (make_decl_rtl (t, ((void *)0)), (t)->decl.rtl)))));
     ...
     rtx may_share;
{
  ...
  copy = rtx_alloc (code);
  ((copy)->mode = (enum machine_mode) (((enum machine_mode) (orig)->mode)));
 ...
 {
 case 'e':
   (((copy)->fld[i]).rtx) = (((orig)->fld[i]).rtx);
   if ((((orig)->fld[i]).rtx) != ((void *)0) && (((orig)->fld[i]).rtx) != may_share)
     (((copy)->fld[i]).rtx) = copy_most_rtx ((((orig)->fld[i]).rtx), may_share);
   break;
 ...
 case 'V':
   ...
   if ((((orig)->fld[i]).rtvec) != ((void *)0))
     {
       (((copy)->fld[i]).rtvec) = rtvec_alloc ((((((orig)->fld[i]).rtvec))->num_elem));
       for (j = 0; j < (((((copy)->fld[i]).rtvec))->num_elem); j++)
  (((((copy)->fld[i]).rtvec))->elem[j])
    = copy_most_rtx ((((((orig)->fld[i]).rtvec))->elem[j]), may_share);
     }
   break;

 case 'w':
   (((copy)->fld[i]).rtwint) = (((orig)->fld[i]).rtwint);
   break;
 ...
 case 't':
   (((copy)->fld[i]).rttree) = (((orig)->fld[i]).rttree);
   break;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 2592, __FUNCTION__);
 }
    }
  return copy;
}
     ...
     rtx orig;
{
 ...
 return x;
    ...
    case MEM:
# 2659 "../../../kgccfe/gnu/emit-rtl.c"
      if ((((enum rtx_code) ((((x)->fld[0]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((x)->fld[0]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((x)->fld[0]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((x)->fld[0]).rtx))->code) == HIGH || (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == CONST && ! (flag_pic && pic_address_needs_scratch ((((x)->fld[0]).rtx))) && ((target_flags & 0x00000010) || mips_abi == 0))))
 return x;
  ...
  if (((x)->used))
    {
      ...
      (sizeof (*copy) - sizeof (copy->fld)
       + sizeof (copy->fld[0]) * (rtx_length[(int) (code)])));
      x = copy;
      copied = 1;
    }
  ((x)->used) = 1;
 ...
 case 'E':
   if ((((x)->fld[i]).rtvec) != ((void *)0))
     {
       int j;
       int len = (((((x)->fld[i]).rtvec))->num_elem);

       if (copied && len > 0)
  (((x)->fld[i]).rtvec) = gen_rtvec_v (len, (((x)->fld[i]).rtvec)->elem);
       for (j = 0; j < len; j++)
  (((((x)->fld[i]).rtvec))->elem[j]) = copy_rtx_if_shared ((((((x)->fld[i]).rtvec))->elem[j]));
     }
   break;
 }
    }
     ...
     rtx x;
{
 ...
 {
 case 'e':
   reset_used_flags ((((x)->fld[i]).rtx));
   break;

 case 'E':
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     reset_used_flags ((((((x)->fld[i]).rtvec))->elem[j]));
   break;
 }
    }
}
...
{
  if ((((insn)->fld[1]).rtx) != 0)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 2835, __FUNCTION__);
...
{
  if ((((insn)->fld[2]).rtx) != 0)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 2854, __FUNCTION__);
     ...
     FILE *stream;
{
 ...
 fprintf (stream, "Renumbering insn %d to %d\n",
   (((insn)->fld[0]).rtint), (cfun->emit->x_cur_insn_uid));
      (((insn)->fld[0]).rtint) = (cfun->emit->x_cur_insn_uid)++;
    }
}
  ...
  if (insn)
    {
      ...
      if (insn && ((enum rtx_code) (insn)->code) == INSN
   && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SEQUENCE)
 insn = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem) - 1]);
    }
     ...
     rtx insn;
{
  while (insn)
    {
      insn = (((insn)->fld[2]).rtx);
      if (insn == 0 || ((enum rtx_code) (insn)->code) == INSN
   || ((enum rtx_code) (insn)->code) == CALL_INSN || ((enum rtx_code) (insn)->code) == JUMP_INSN)
 break;
    }
     ...
     rtx insn;
{
  while (insn)
    {
      insn = (((insn)->fld[1]).rtx);
      if (insn == 0 || ((enum rtx_code) (insn)->code) == INSN || ((enum rtx_code) (insn)->code) == CALL_INSN
     ...
     rtx x;
{
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 mark_label_nuses ((((x)->fld[i]).rtx));
      else if (fmt[i] == 'E')
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   mark_label_nuses ((((((x)->fld[i]).rtvec))->elem[j]));
    }
}
# 3232 "../../../kgccfe/gnu/emit-rtl.c"
rtx
try_split (pat, trial, last)
     rtx pat, trial;
     int last;
{
  rtx before = (((trial)->fld[1]).rtx);
  rtx after = (((trial)->fld[2]).rtx);
  int has_barrier = 0;
  rtx tem;
  rtx note, seq;
  int probability;
  ...
  if (any_condjump_p (trial)
    ...
    split_branch_probability = ((((((note)->fld[0]).rtx))->fld[0]).rtwint);
  ...
  while (1)
    {
      if (((rtx_class[(int) (((enum rtx_code) (insn_last)->code))]) == 'i')
   && rtx_equal_p ((((insn_last)->fld[5]).rtx), pat))
 return trial;
      if (!(((insn_last)->fld[2]).rtx))
 break;
      insn_last = (((insn_last)->fld[2]).rtx);
    }


  for (insn = insn_last; insn ; insn = (((insn)->fld[1]).rtx))
    {
      if (((enum rtx_code) (insn)->code) == JUMP_INSN)
 {
   mark_jump_label ((((insn)->fld[5]).rtx), insn, 0);
   njumps++;
   if (probability != -1
       && any_condjump_p (insn)
       && !find_reg_note (insn, REG_BR_PROB, 0))
     {
       ...
       if (njumps != 1)
  fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3295, __FUNCTION__);
       (((insn)->fld[8]).rtx)
  = gen_rtx_fmt_ee (EXPR_LIST, (REG_BR_PROB), (gen_rtx_CONST_INT (VOIDmode, (long long) (probability))), ((((insn)->fld[8]).rtx)));
 ...
 if (((enum rtx_code) (insn)->code) == CALL_INSN)
  ...
  for (note = (((trial)->fld[8]).rtx); note; note = (((note)->fld[1]).rtx))
    {
 ...
 case REG_EH_REGION:
  ...
  (((insn)->fld[8]).rtx)
    = gen_rtx_fmt_ee (EXPR_LIST, (REG_EH_REGION), ((((note)->fld[0]).rtx)), ((((insn)->fld[8]).rtx)));
   ...
   while (insn != (rtx) 0)
     {
       if (((enum rtx_code) (insn)->code) == CALL_INSN)
  (((insn)->fld[8]).rtx)
    = gen_rtx_fmt_ee (EXPR_LIST, (((enum reg_note) ((enum machine_mode) (note)->mode))), ((((note)->fld[0]).rtx)), ((((insn)->fld[8]).rtx)));
      ...
      while (insn != (rtx) 0)
 {
   if (((enum rtx_code) (insn)->code) == INSN)
     mark_label_nuses ((((insn)->fld[5]).rtx));

   insn = (((insn)->fld[1]).rtx);
 }
    }

  tem = emit_insn_after_scope (seq, trial, (((trial)->fld[4]).rttree));
  ...
  for (tem = (((before)->fld[2]).rtx); tem != after; tem = (((tem)->fld[2]).rtx))
    if (! (((tem))->volatil) && ((rtx_class[(int) (((enum rtx_code) (tem)->code))]) == 'i'))
      tem = try_split ((((tem)->fld[5]).rtx), tem, 1);



  return last
    ? (after ? (((after)->fld[1]).rtx) : (cfun->emit->x_last_insn))
    : (((before)->fld[2]).rtx);
}
     ...
     rtx pattern;
{
  ...
  (((insn)->fld[0]).rtint) = (cfun->emit->x_cur_insn_uid)++;
  (((insn)->fld[5]).rtx) = pattern;
  (((insn)->fld[6]).rtint) = -1;
  (((insn)->fld[7]).rtx) = ((void *)0);
  (((insn)->fld[8]).rtx) = ((void *)0);
  (((insn)->fld[4]).rttree) = ((void *)0);
  (((insn)->fld[3]).bb) = ((void *)0);
# 3437 "../../../kgccfe/gnu/emit-rtl.c"
  return insn;
}
...
add_insn (insn)
     rtx insn;
{
  (((insn)->fld[1]).rtx) = (cfun->emit->x_last_insn);
  (((insn)->fld[2]).rtx) = 0;

  if (((void *)0) != (cfun->emit->x_last_insn))
    ((((cfun->emit->x_last_insn))->fld[2]).rtx) = insn;
...
add_insn_after (insn, after)
     rtx insn, after;
{
  rtx next = (((after)->fld[2]).rtx);
  basic_block bb;

  if (optimize && (((after))->volatil))
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3516, __FUNCTION__);
  ...
  if (next)
    {
      (((next)->fld[1]).rtx) = insn;
      if (((enum rtx_code) (next)->code) == INSN && ((enum rtx_code) ((((next)->fld[5]).rtx))->code) == SEQUENCE)
 (((((((((((next)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[1]).rtx) = insn;
    }
 ...
 if (after == stack->last)
   {
     ...
     break;
      ...
      if (stack == 0)
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3541, __FUNCTION__);
    }
 ...
 bb->flags |= 1;
   ...
   && (((enum rtx_code) (insn)->code) != NOTE
       || (((insn)->fld[5]).rtint) != NOTE_INSN_BASIC_BLOCK))
 bb->end = insn;
    }

  (((after)->fld[2]).rtx) = insn;
  if (((enum rtx_code) (after)->code) == INSN && ((enum rtx_code) ((((after)->fld[5]).rtx))->code) == SEQUENCE)
    {
      rtx sequence = (((after)->fld[5]).rtx);
      ((((((((sequence)->fld[0]).rtvec))->elem[(((((sequence)->fld[0]).rtvec))->num_elem) - 1]))->fld[2]).rtx) = insn;
    }
}
...
add_insn_before (insn, before)
     rtx insn, before;
{
  rtx prev = (((before)->fld[1]).rtx);
  basic_block bb;

  if (optimize && (((before))->volatil))
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3582, __FUNCTION__);
  ...
  if (prev)
    {
      (((prev)->fld[2]).rtx) = insn;
      if (((enum rtx_code) (prev)->code) == INSN && ((enum rtx_code) ((((prev)->fld[5]).rtx))->code) == SEQUENCE)
 {
   rtx sequence = (((prev)->fld[5]).rtx);
   ((((((((sequence)->fld[0]).rtvec))->elem[(((((sequence)->fld[0]).rtvec))->num_elem) - 1]))->fld[2]).rtx) = insn;
 }
    }
 ...
 if (before == stack->first)
   {
     ...
     break;
      ...
      if (stack == 0)
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3610, __FUNCTION__);
    }
 ...
 bb->flags |= 1;
   ...
   && (((enum rtx_code) (insn)->code) != NOTE
       || (((insn)->fld[5]).rtint) != NOTE_INSN_BASIC_BLOCK))
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3627, __FUNCTION__);
    }

  (((before)->fld[1]).rtx) = insn;
  if (((enum rtx_code) (before)->code) == INSN && ((enum rtx_code) ((((before)->fld[5]).rtx))->code) == SEQUENCE)
    (((((((((((before)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[1]).rtx) = insn;
}
     ...
     rtx insn;
{
 ...
 {
   rtx sequence = (((prev)->fld[5]).rtx);
   ((((((((sequence)->fld[0]).rtvec))->elem[(((((sequence)->fld[0]).rtvec))->num_elem) - 1]))->fld[2]).rtx) = next;
 }
    }
 ...
 if (insn == stack->first)
   {
     ...
     break;
      ...
      if (stack == 0)
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3668, __FUNCTION__);
    }
  ...
  if (next)
    {
      (((next)->fld[1]).rtx) = prev;
      if (((enum rtx_code) (next)->code) == INSN && ((enum rtx_code) ((((next)->fld[5]).rtx))->code) == SEQUENCE)
 (((((((((((next)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[1]).rtx) = prev;
    }
 ...
 if (insn == stack->last)
   {
     ...
     break;
      ...
      if (stack == 0)
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3691, __FUNCTION__);
    }
      ...
      if (bb->head == insn)
 {
   ...
   if (((enum rtx_code) (insn)->code) == NOTE)
     fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3703, __FUNCTION__);
   bb->head = next;
 }
      if (bb->end == insn)
 bb->end = prev;
     ...
     rtx from, to, after;
{
  ...
  if ((cfun->emit->x_last_insn) == to)
    (cfun->emit->x_last_insn) = (((from)->fld[1]).rtx);
  if ((cfun->emit->x_first_insn) == from)
    (cfun->emit->x_first_insn) = (((to)->fld[2]).rtx);
     ...
     rtx from, to, after;
{
 ...
 bb->end = to;
      ...
      for (x = from; x != (((to)->fld[2]).rtx); x = (((x)->fld[2]).rtx))
 ((((x)->fld[3]).bb) = bb);
    }
}
     ...
     rtx from, to, after;
{
  ...
  if (from_line)
    emit_line_note_after ((((from_line)->fld[4]).rtstr),
     (((from_line)->fld[5]).rtint),
     after);
  if (after_line)
    emit_line_note_after ((((after_line)->fld[4]).rtstr),
     (((after_line)->fld[5]).rtint),
     to);
}
...
remove_unnecessary_notes ()
{
  ...
  for (insn = (((get_insns ())->fld[2]).rtx); insn; insn = next)
    {
 ...
 case NOTE_INSN_EH_REGION_END:
   ...
   if (eh_stack == (rtx) 0)
     fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3871, __FUNCTION__);

   if (((((((eh_stack)->fld[0]).rtx))->fld[4]).rtint) != (((insn)->fld[4]).rtint))
     fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3874, __FUNCTION__);
   tmp = eh_stack;
   eh_stack = (((eh_stack)->fld[1]).rtx);
 ...
 case NOTE_INSN_BLOCK_BEG:
   ...
   if ((((insn)->fld[4]).rttree) == (tree) ((void *)0))
     fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3884, __FUNCTION__);
 ...
 case NOTE_INSN_BLOCK_END:
   ...
   if (block_stack == (rtx) 0)
     fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3891, __FUNCTION__);

   if (((((((block_stack)->fld[0]).rtx))->fld[4]).rttree) != (((insn)->fld[4]).rttree))
     fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3894, __FUNCTION__);
   tmp = block_stack;
   block_stack = (((block_stack)->fld[1]).rtx);
   free_INSN_LIST_node (tmp);
   ...
   for (tmp = (((insn)->fld[1]).rtx); tmp; tmp = (((tmp)->fld[1]).rtx))
     {
  ...
  continue;
       ...
       if ((((tmp)->fld[5]).rtint) == NOTE_INSN_BLOCK_BEG)
  {
    ...
    if (! is_body_block ((((insn)->fld[4]).rttree))
        && (*debug_hooks->ignore_block) ((((insn)->fld[4]).rttree)))
      {
        remove_insn (tmp);
        remove_insn (insn);
      }
    break;
       ...
       else if ((((tmp)->fld[5]).rtint) == NOTE_INSN_BLOCK_END)
  ...
  if (block_stack || eh_stack)
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 3944, __FUNCTION__);
}
# 3975 "../../../kgccfe/gnu/emit-rtl.c"
rtx
     ...
     rtx label, before;
{
  ...
  if ((((label)->fld[0]).rtint) == 0)
    {
      (((label)->fld[0]).rtint) = (cfun->emit->x_cur_insn_uid)++;
     ...
     rtx before;
{
  ...
  (((note)->fld[0]).rtint) = (cfun->emit->x_cur_insn_uid)++;
  (((note)->fld[4]).rtstr) = 0;
  (((note)->fld[5]).rtint) = subtype;
  (((note)->fld[3]).bb) = ((void *)0);
     ...
     rtx first, after;
{
  ...
  if (((enum rtx_code) (after)->code) != BARRIER
    ...
    {
      bb->flags |= 1;
      for (last = first; (((last)->fld[2]).rtx); last = (((last)->fld[2]).rtx))
 ...
 bb->end = last;
  ...
  after_after = (((after)->fld[2]).rtx);

  (((after)->fld[2]).rtx) = first;
  (((first)->fld[1]).rtx) = after;
  (((last)->fld[2]).rtx) = after_after;
  if (after_after)
    (((after_after)->fld[1]).rtx) = last;
     ...
     rtx after;
{
  ...
  note = rtx_alloc (NOTE);
  (((note)->fld[0]).rtint) = (cfun->emit->x_cur_insn_uid)++;
  (((note)->fld[4]).rtstr) = file;
  (((note)->fld[5]).rtint) = line;
  (((note)->fld[3]).bb) = ((void *)0);
  add_insn_after (note, after);
  return note;
}
...
emit_barrier ()
{
  ...
  (((barrier)->fld[0]).rtint) = (cfun->emit->x_cur_insn_uid)++;
  add_insn (barrier);
  return barrier;
}
     ...
     int line;
{
  ...
  if (line > 0)
    {
      if (file && (cfun->emit->x_last_filename) && !strcmp (file, (cfun->emit->x_last_filename))
   && line == (cfun->emit->x_last_linenum))
 return 0;
      (cfun->emit->x_last_filename) = file;
      (cfun->emit->x_last_linenum) = line;
    }
     ...
     rtx datum;
{
  ...
  switch (kind)
    ...
    case REG_EQUIV:
      ...
      if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL && multiple_sets (insn))
 {
   if (note)
     fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 4759, __FUNCTION__);
   return (rtx) 0;
 }
 ...
 return (rtx) 0;
  ...
  if (note)
    {
      (((note)->fld[0]).rtx) = datum;
      return note;
    }

  (((insn)->fld[8]).rtx) = gen_rtx_fmt_ee (EXPR_LIST, (kind), (datum), ((((insn)->fld[8]).rtx)));
  return (((insn)->fld[8]).rtx);
}
     ...
     rtx x;
{
 ...
 if (((enum rtx_code) ((((((x)->fld[0]).rtvec))->elem[j]))->code) == CALL)
   return CALL_INSN;
 else if (((enum rtx_code) ((((((x)->fld[0]).rtvec))->elem[j]))->code) == SET
   && ((((((((x)->fld[0]).rtvec))->elem[j]))->fld[0]).rtx) == (global_rtl[GR_PC]))
   return JUMP_INSN;
 else if (((enum rtx_code) ((((((x)->fld[0]).rtvec))->elem[j]))->code) == SET
   && ((enum rtx_code) (((((((((x)->fld[0]).rtvec))->elem[j]))->fld[1]).rtx))->code) == CALL)
   return CALL_INSN;
    }
  return INSN;
}
     ...
     rtx x;
{
 ...
 return emit_barrier ();
    ...
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 4844, __FUNCTION__);
}


static struct sequence_stack *free_sequence_stack;
# 4858 "../../../kgccfe/gnu/emit-rtl.c"
void
start_sequence ()
{
  ...
  tem->sequence_rtl_expr = (cfun->emit->sequence_rtl_expr);
     ...
     rtx first, last;
{
  ...
  if (last && (((last)->fld[2]).rtx))
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 4924, __FUNCTION__);
}
...
push_topmost_sequence ()
{
  ...
  (cfun->emit->sequence_rtl_expr) = top->sequence_rtl_expr;
}
...
end_sequence ()
{
  ...
  (cfun->emit->sequence_rtl_expr) = tem->sequence_rtl_expr;
...
end_full_sequence (first, last)
     rtx *first, *last;
{
  *first = (cfun->emit->x_first_insn);
  *last = (cfun->emit->x_last_insn);
  end_sequence ();
}
     ...
     struct emit_status *es;
{
  ...
  ptr[((176))] = (global_rtl[GR_VIRTUAL_INCOMING_ARGS]);
  ptr[(((176)) + 1)] = (global_rtl[GR_VIRTUAL_STACK_ARGS]);
  ptr[(((176)) + 2)] = (global_rtl[GR_VIRTUAL_STACK_DYNAMIC]);
  ptr[(((176)) + 3)] = (global_rtl[GR_VIRTUAL_OUTGOING_ARGS]);
  ptr[(((176)) + 4)] = (global_rtl[GR_VIRTUAL_CFA]);
}
     ...
     rtx orig;
{
 ...
 if (copy_insn_scratch_in[i] == orig)
   return copy_insn_scratch_out[i];
    ...
    case CONST:
      ...
      if (((enum rtx_code) ((((orig)->fld[0]).rtx))->code) == PLUS
   && ((enum rtx_code) (((((((orig)->fld[0]).rtx))->fld[0]).rtx))->code) == SYMBOL_REF
   && ((enum rtx_code) (((((((orig)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST_INT)
 return orig;
      break;
 ...
 {
 case 'e':
   if ((((orig)->fld[i]).rtx) != ((void *)0))
     (((copy)->fld[i]).rtx) = copy_insn_1 ((((orig)->fld[i]).rtx));
   break;

 case 'E':
 case 'V':
   if ((((orig)->fld[i]).rtvec) == orig_asm_constraints_vector)
     (((copy)->fld[i]).rtvec) = copy_asm_constraints_vector;
   else if ((((orig)->fld[i]).rtvec) == orig_asm_operands_vector)
     (((copy)->fld[i]).rtvec) = copy_asm_operands_vector;
   else if ((((orig)->fld[i]).rtvec) != ((void *)0))
     {
       (((copy)->fld[i]).rtvec) = rtvec_alloc ((((((orig)->fld[i]).rtvec))->num_elem));
       for (j = 0; j < (((((copy)->fld[i]).rtvec))->num_elem); j++)
  (((((copy)->fld[i]).rtvec))->elem[j]) = copy_insn_1 ((((((orig)->fld[i]).rtvec))->elem[j]));
     }
   break;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 5159, __FUNCTION__);
 }
    }
  ...
  if (code == SCRATCH)
    {
      ...
      if (i >= 30)
 fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 5167, __FUNCTION__);
  ...
  else if (code == ASM_OPERANDS)
    {
      ...
      orig_asm_constraints_vector = (((orig)->fld[4]).rtvec);
      copy_asm_constraints_vector = (((copy)->fld[4]).rtvec);
    }
...
init_emit ()
{
  ...
  (cfun->emit->sequence_rtl_expr) = ((void *)0);
  (cfun->emit->x_cur_insn_uid) = 1;
  (cfun->emit->x_reg_rtx_no) = (((176)) + 4) + 1;
  (cfun->emit->x_last_linenum) = 0;
  (cfun->emit->x_last_filename) = 0;
  ...
  f->emit->regno_pointer_align_length = (((176)) + 4) + 101;
  ...
  (cfun->emit->regno_pointer_align[(0 + 29)]) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
  (cfun->emit->regno_pointer_align[(0 + 1)]) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
  (cfun->emit->regno_pointer_align[((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)]) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
  (cfun->emit->regno_pointer_align[0]) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);

  (cfun->emit->regno_pointer_align[((176))]) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
  (cfun->emit->regno_pointer_align[(((176)) + 1)]) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
  (cfun->emit->regno_pointer_align[(((176)) + 2)]) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
  (cfun->emit->regno_pointer_align[(((176)) + 3)]) = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
  (cfun->emit->regno_pointer_align[(((176)) + 4)]) = (8 * ((target_flags & 0x00002000) ? 8 : 4));
     ...
     enum machine_mode mode;
{
  ...
  if (!(const_tiny_rtx[0][(int) (inner)]))
    fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 5292, __FUNCTION__);
...
gen_rtx_CONST_VECTOR (mode, v)
     ...
     rtvec v;
{
  rtx inner_zero = (const_tiny_rtx[0][(int) (inner_mode_array[(int) (mode)])]);
  int i;

  for (i = (((mode_unit_size[(int) ((mode))]) == 0) ? 0 : ((mode_size[(int) ((mode))]) / (mode_unit_size[(int) ((mode))]))) - 1; i >= 0; i--)
     ...
     int line_numbers;
{
  ...
  for (mode = class_narrowest_mode[(int) (MODE_INT)]; mode != VOIDmode;
    ...
    {
      if ((mode_bitsize[(int) (mode)]) == 8
   && byte_mode == VOIDmode)
 byte_mode = mode;

      if ((mode_bitsize[(int) (mode)]) == (8 * ((target_flags & 0x00002000) ? 8 : 4))
   && word_mode == VOIDmode)
 word_mode = mode;
    }
  ...
  for (mode = class_narrowest_mode[(int) (MODE_FLOAT)]; mode != VOIDmode;
       mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
    {
      if ((mode_bitsize[(int) (mode)]) == 64
   && double_mode == VOIDmode)
 double_mode = mode;
    }

  ptr_mode = mode_for_size (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32), (mode_class[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]), 0);





  (global_rtl[GR_PC]) = gen_rtx (PC, VOIDmode);
  (global_rtl[GR_CC0]) = gen_rtx (CC0, VOIDmode);
  (global_rtl[GR_STACK_POINTER]) = gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (0 + 29));
  (global_rtl[GR_FRAME_POINTER]) = gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (0 + 1));
  if ((global_rtl[GR_HARD_FRAME_POINTER]) == 0)
    (global_rtl[GR_HARD_FRAME_POINTER]) = gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode),
       ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30));
  if ((global_rtl[GR_ARG_POINTER]) == 0)
    (global_rtl[GR_ARG_POINTER]) = gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 0);
  (global_rtl[GR_VIRTUAL_INCOMING_ARGS]) =
    gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), ((176)));
  (global_rtl[GR_VIRTUAL_STACK_ARGS]) =
    gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (((176)) + 1));
  (global_rtl[GR_VIRTUAL_STACK_DYNAMIC]) =
    gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (((176)) + 2));
  (global_rtl[GR_VIRTUAL_OUTGOING_ARGS]) =
    gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (((176)) + 3));
  (global_rtl[GR_VIRTUAL_CFA]) = gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (((176)) + 4));



  for (i = 0; i < 176; i++)
    static_regno_reg_rtx[i] = gen_raw_REG (reg_raw_mode[i], i);
# 5414 "../../../kgccfe/gnu/emit-rtl.c"
  for (i = - 64; i <= 64; i++)
    const_int_rtx[i + 64] =
      gen_rtx_fmt_w (CONST_INT, (VOIDmode), ((long long) i));
 ...
 const_tiny_rtx[i][(int) mode] =
   const_double_from_real_value (*r, mode);
      ...
      const_tiny_rtx[i][(int) VOIDmode] = gen_rtx_CONST_INT (VOIDmode, (long long) (i));

      for (mode = class_narrowest_mode[(int) (MODE_INT)]; mode != VOIDmode;
    mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
 const_tiny_rtx[i][(int) mode] = gen_rtx_CONST_INT (VOIDmode, (long long) (i));

      for (mode = class_narrowest_mode[(int) (MODE_PARTIAL_INT)];
    mode != VOIDmode;
    mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
 const_tiny_rtx[i][(int) mode] = gen_rtx_CONST_INT (VOIDmode, (long long) (i));
    }

  for (mode = class_narrowest_mode[(int) (MODE_VECTOR_INT)];
       mode != VOIDmode;
       mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
    const_tiny_rtx[0][(int) mode] = gen_const_vector_0 (mode);

  for (mode = class_narrowest_mode[(int) (MODE_VECTOR_FLOAT)];
       mode != VOIDmode;
       mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
    const_tiny_rtx[0][(int) mode] = gen_const_vector_0 (mode);

  for (i = (int) CCmode; i < (int) MAX_MACHINE_MODE; ++i)
    if ((mode_class[(int) ((enum machine_mode) i)]) == MODE_CC)
  ...
  return_address_pointer_rtx
    = gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 75);



  struct_value_rtx = 0;
# 5487 "../../../kgccfe/gnu/emit-rtl.c"
  struct_value_incoming_rtx = struct_value_rtx;




  static_chain_rtx = gen_rtx_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (0 + 2));
...
# 5513 "../../../kgccfe/gnu/emit-rtl.c"
  if ((0 + 28) != (~(unsigned int) 0))
    pic_offset_table_rtx = gen_raw_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (0 + 28));
}
     ...
     rtx insn, after;
{
  ...
  switch (((enum rtx_code) (insn)->code))
    {
    case INSN:
      new = emit_insn_after (copy_insn ((((insn)->fld[5]).rtx)), after);
      break;

    case JUMP_INSN:
      new = emit_jump_insn_after (copy_insn ((((insn)->fld[5]).rtx)), after);
      break;

    case CALL_INSN:
      new = emit_call_insn_after (copy_insn ((((insn)->fld[5]).rtx)), after);
      if ((((insn)->fld[9]).rtx))
 (((new)->fld[9]).rtx)
   = copy_insn ((((insn)->fld[9]).rtx));
      (((new))->jump) = (((insn))->jump);
      (((new))->unchanging) = (((insn))->unchanging);
      break;

    default:
      fancy_abort ("../../../kgccfe/gnu/emit-rtl.c", 5569, __FUNCTION__);
    }


  mark_jump_label ((((new)->fld[5]).rtx), new, 0);

  (((new)->fld[4]).rttree) = (((insn)->fld[4]).rttree);
 ...
 if (((enum rtx_code) (link)->code) == EXPR_LIST)
   (((new)->fld[8]).rtx)
     = copy_insn_1 (gen_rtx_fmt_ee (EXPR_LIST, (((enum reg_note) ((enum machine_mode) (link)->mode))), ((((link)->fld[0]).rtx)), ((((new)->fld[8]).rtx))));


 else
   (((new)->fld[8]).rtx)
     = copy_insn_1 (gen_rtx_fmt_ue (INSN_LIST, (((enum reg_note) ((enum machine_mode) (link)->mode))), ((((link)->fld[0]).rtx)), ((((new)->fld[8]).rtx))));
...
# 1 "../../../kgccfe/gnu/MIPS/gt-emit-rtl.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-emit-rtl.h"
...
const struct ggc_root_tab gt_ggc_rd_gt_emit_rtl_h[] = {
  { &free_sequence_stack, 1, sizeof (free_sequence_stack), ((void *)0) },
  { ((void *)0), 0, 0, ((void *)0) }
};
