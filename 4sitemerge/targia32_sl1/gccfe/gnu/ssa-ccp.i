...
# 69 "../../../kgccfe/gnu/ssa-ccp.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 70 "../../../kgccfe/gnu/ssa-ccp.c" 2
...
# 72 "../../../kgccfe/gnu/ssa-ccp.c" 2
# 1 "../../../kgccfe/gnu/errors.h" 1
# 32 "../../../kgccfe/gnu/errors.h"
extern void warning (const char *, ...);
extern void error (const char *, ...);
extern void fatal (const char *, ...) __attribute__ ((__noreturn__));
extern void internal_error (const char *, ...) __attribute__ ((__noreturn__));
...
{
  unsigned int i;
  rtx phi_node_expr = ((void *)0);
  unsigned int phi_node_name = (((((((((phi_node)->fld[5]).rtx))->fld[0]).rtx))->fld[0]).rtuint);
  latticevalue phi_node_lattice_val = UNDEFINED;
  rtx pat = (((phi_node)->fld[5]).rtx);
  rtvec phi_vec = ((((((pat)->fld[1]).rtx))->fld[0]).rtvec);
  unsigned int num_elem = ((phi_vec)->num_elem);

  for (i = 0; i < num_elem; i += 2)
    {
      if (((executable_edges)->elms [((find_edge_index ((edges), ((((basic_block_info)->data.bb[((((((phi_vec)->elem[i + 1]))->fld[0]).rtwint))]))), (block)))) / ((unsigned) (8 * 8))] >> ((find_edge_index ((edges), ((((basic_block_info)->data.bb[((((((phi_vec)->elem[i + 1]))->fld[0]).rtwint))]))), (block)))) % ((unsigned) (8 * 8)) & 1))


 {
   unsigned int current_parm
     = (((((phi_vec)->elem[i]))->fld[0]).rtuint);
  ...
  if (phi_node_lattice_val != values[phi_node_name].lattice_val)
    {
      ...
      ((ssa_edges)->elms [(phi_node_name) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (phi_node_name) % ((unsigned) (8 * 8)));
    }
}
     ...
     rtx insn;
{
  ...
  for (currdef = ((df_analyzer)->insns[(((insn)->fld[0]).rtint)].defs); currdef;
       currdef = currdef->next)
    {
      if (values[((((((enum rtx_code) ((currdef->ref)->reg)->code) == SUBREG ? ((((currdef->ref)->reg)->fld[0]).rtx) : ((currdef->ref)->reg)))->fld[0]).rtuint)].lattice_val != UNDEFINED)
 ((ssa_edges)->elms [(((((((enum rtx_code) ((currdef->ref)->reg)->code) == SUBREG ? ((((currdef->ref)->reg)->fld[0]).rtx) : ((currdef->ref)->reg)))->fld[0]).rtuint)) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (((((((enum rtx_code) ((currdef->ref)->reg)->code) == SUBREG ? ((((currdef->ref)->reg)->fld[0]).rtx) : ((currdef->ref)->reg)))->fld[0]).rtuint)) % ((unsigned) (8 * 8)));
      values[((((((enum rtx_code) ((currdef->ref)->reg)->code) == SUBREG ? ((((currdef->ref)->reg)->fld[0]).rtx) : ((currdef->ref)->reg)))->fld[0]).rtuint)].lattice_val = UNDEFINED;
    }
}
     ...
     rtx insn;
{
  ...
  for (currdef = ((df_analyzer)->insns[(((insn)->fld[0]).rtint)].defs); currdef;
       currdef = currdef->next)
    {
      if (values[((((((enum rtx_code) ((currdef->ref)->reg)->code) == SUBREG ? ((((currdef->ref)->reg)->fld[0]).rtx) : ((currdef->ref)->reg)))->fld[0]).rtuint)].lattice_val != VARYING)
 ((ssa_edges)->elms [(((((((enum rtx_code) ((currdef->ref)->reg)->code) == SUBREG ? ((((currdef->ref)->reg)->fld[0]).rtx) : ((currdef->ref)->reg)))->fld[0]).rtuint)) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (((((((enum rtx_code) ((currdef->ref)->reg)->code) == SUBREG ? ((((currdef->ref)->reg)->fld[0]).rtx) : ((currdef->ref)->reg)))->fld[0]).rtuint)) % ((unsigned) (8 * 8)));
      values[((((((enum rtx_code) ((currdef->ref)->reg)->code) == SUBREG ? ((((currdef->ref)->reg)->fld[0]).rtx) : ((currdef->ref)->reg)))->fld[0]).rtuint)].lattice_val = VARYING;
    }
}
     ...
     basic_block block;
{
  ...
  if (((enum rtx_code) (insn)->code) == CALL_INSN && block->end == insn)
    {
      edge curredge;
 ...
 {
   int index = (find_edge_index ((edges), (curredge->src), (curredge->dest)));

   if (((executable_edges)->elms [(index) / ((unsigned) (8 * 8))] >> (index) % ((unsigned) (8 * 8)) & 1))
     continue;

   ((executable_edges)->elms [(index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (index) % ((unsigned) (8 * 8)));
  ...
  if (((enum rtx_code) (dest)->code) != REG && dest != (global_rtl[GR_PC]))
    {
      defs_to_varying (insn);
      return;
    }
  ...
  if (((enum rtx_code) (src)->code) == CONST_INT && ((enum rtx_code) (insn)->code) == INSN)
    {
      unsigned int resultreg = (((dest)->fld[0]).rtuint);

      values[resultreg].lattice_val = CONSTANT;
      values[resultreg].const_value = ((((((insn)->fld[5]).rtx))->fld[1]).rtx);
      ((ssa_edges)->elms [(resultreg) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (resultreg) % ((unsigned) (8 * 8)));
    }


  else if (((enum rtx_code) (src)->code) == REG && ((enum rtx_code) (dest)->code) == REG)
    {
      unsigned int old_value = (((src)->fld[0]).rtuint);
      latticevalue old_lattice_value = values[old_value].lattice_val;
      unsigned int new_value = (((dest)->fld[0]).rtuint);



      if (values[new_value].lattice_val != old_lattice_value
   || values[new_value].const_value != values[old_value].const_value)
 ((ssa_edges)->elms [(new_value) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (new_value) % ((unsigned) (8 * 8)));
...
# 341 "../../../kgccfe/gnu/ssa-ccp.c"
      ...
      else
 {
   ...
   comparison_code = ((enum rtx_code) ((((src)->fld[0]).rtx))->code);
   comparison_src0 = ((((((src)->fld[0]).rtx))->fld[0]).rtx);
   comparison_src1 = ((((((src)->fld[0]).rtx))->fld[1]).rtx);




   if ((((enum rtx_code) (comparison_src0)->code) == REG
        && values[(((comparison_src0)->fld[0]).rtuint)].lattice_val == UNDEFINED)
       || (((enum rtx_code) (comparison_src1)->code) == REG
           && values[(((comparison_src1)->fld[0]).rtuint)].lattice_val == UNDEFINED))
     return;



   if ((((enum rtx_code) (comparison_src0)->code) == REG
        && values[(((comparison_src0)->fld[0]).rtuint)].lattice_val == VARYING)
       || (((enum rtx_code) (comparison_src1)->code) == REG
           && values[(((comparison_src1)->fld[0]).rtuint)].lattice_val == VARYING))
     {
       for (curredge = block->succ; curredge;
            curredge = curredge->succ_next)
         {
   ...
   if (((enum rtx_code) (comparison_src0)->code) == REG
       && values[(((comparison_src0)->fld[0]).rtuint)].lattice_val == CONSTANT)
     comparison_src0 = values[(((comparison_src0)->fld[0]).rtuint)].const_value;

   if (((enum rtx_code) (comparison_src1)->code) == REG
       && values[(((comparison_src1)->fld[0]).rtuint)].lattice_val == CONSTANT)
     comparison_src1 = values[(((comparison_src1)->fld[0]).rtuint)].const_value;
...
# 435 "../../../kgccfe/gnu/ssa-ccp.c"
  ...
  else if (!((insn) && ((enum rtx_code) (insn)->code) == INSN && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET && ((enum rtx_code) (((((((insn)->fld[5]).rtx))->fld[1]).rtx))->code) == PHI))
    {
      rtx simplified = ((void *)0);
# 459 "../../../kgccfe/gnu/ssa-ccp.c"
      switch ((rtx_class[(int) (((enum rtx_code) (src)->code))]))
 {
   case '<':
     {
       rtx src0 = (((src)->fld[0]).rtx);
       rtx src1 = (((src)->fld[1]).rtx);
       enum machine_mode mode;


       if ((((enum rtx_code) (src0)->code) == REG
     && values[(((src0)->fld[0]).rtuint)].lattice_val == UNDEFINED)
    || (((enum rtx_code) (src1)->code) == REG
        && values[(((src1)->fld[0]).rtuint)].lattice_val == UNDEFINED))
  {
    defs_to_undefined (insn);
    break;
  }
       ...
       mode = ((enum machine_mode) (src0)->mode);
       if (mode == VOIDmode)
  mode = ((enum machine_mode) (src1)->mode);



       if (((enum rtx_code) (src0)->code) == REG
    && values[(((src0)->fld[0]).rtuint)].lattice_val == CONSTANT)
  src0 = values[(((src0)->fld[0]).rtuint)].const_value;

       if (((enum rtx_code) (src1)->code) == REG
    && values[(((src1)->fld[0]).rtuint)].lattice_val == CONSTANT)
  src1 = values[(((src1)->fld[0]).rtuint)].const_value;



       simplified = simplify_relational_operation (((enum rtx_code) (src)->code),
         mode, src0, src1);
       break;
   ...
   case '1':
     {
       rtx src0 = (((src)->fld[0]).rtx);
       enum machine_mode mode0 = ((enum machine_mode) (src0)->mode);
  ...
  src0 = values[(((src0)->fld[0]).rtuint)].const_value;
       ...
       simplified = simplify_unary_operation (((enum rtx_code) (src)->code),
  ...
  src1 = values[(((src1)->fld[0]).rtuint)].const_value;
       ...
       simplified = simplify_binary_operation (((enum rtx_code) (src)->code),
            ((enum machine_mode) (src)->mode),
            src0, src1);
       break;
     }
   ...
   case 'b':
    ...
    || (((enum rtx_code) (src1)->code) == REG
        && values[(((src1)->fld[0]).rtuint)].lattice_val == UNDEFINED)
    || (((enum rtx_code) (src2)->code) == REG
        && values[(((src2)->fld[0]).rtuint)].lattice_val == UNDEFINED))
  {
    defs_to_undefined (insn);
    break;
  }
  ...
  src1 = values[(((src1)->fld[0]).rtuint)].const_value;
       ...
       if (((enum rtx_code) (src2)->code) == REG
    && values[(((src2)->fld[0]).rtuint)].lattice_val == CONSTANT)
  src2 = values[(((src2)->fld[0]).rtuint)].const_value;



       simplified = simplify_ternary_operation (((enum rtx_code) (src)->code),
             ((enum machine_mode) (src)->mode),
             ((enum machine_mode) (src)->mode),
             src0, src1, src2);
       break;
   ...
   default:
     defs_to_varying (insn);
      ...
      if (simplified && ((enum rtx_code) (simplified)->code) == CONST_INT)
 {
   if (values[(((dest)->fld[0]).rtuint)].lattice_val != CONSTANT
       || values[(((dest)->fld[0]).rtuint)].const_value != simplified)
     ((ssa_edges)->elms [((((dest)->fld[0]).rtuint)) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << ((((dest)->fld[0]).rtuint)) % ((unsigned) (8 * 8)));

   values[(((dest)->fld[0]).rtuint)].lattice_val = CONSTANT;
   values[(((dest)->fld[0]).rtuint)].const_value = simplified;
 }
      else
 defs_to_varying (insn);
  ...
  while (flow_edges != ((void *)0))
    {
      ...
      flow_edges = edge_info[(find_edge_index ((edges), (flow_edges->src), (flow_edges->dest)))];


      if (succ_block == (&entry_exit_blocks[1]))
 continue;



      for (curr_phi_node = first_insn_after_basic_block_note (succ_block);
    ((curr_phi_node) && ((enum rtx_code) (curr_phi_node)->code) == INSN && ((enum rtx_code) ((((curr_phi_node)->fld[5]).rtx))->code) == SET && ((enum rtx_code) (((((((curr_phi_node)->fld[5]).rtx))->fld[1]).rtx))->code) == PHI);
    curr_phi_node = (((curr_phi_node)->fld[2]).rtx))
 visit_phi_node (curr_phi_node, succ_block);



      if (!((executable_blocks)->elms [(succ_block->index) / ((unsigned) (8 * 8))] >> (succ_block->index) % ((unsigned) (8 * 8)) & 1))
 {
   rtx currinsn;
   edge succ_edge = succ_block->succ;


   ((executable_blocks)->elms [(succ_block->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (succ_block->index) % ((unsigned) (8 * 8)));


   currinsn = succ_block->head;
   while (currinsn != succ_block->end)
     {
       if (((rtx_class[(int) (((enum rtx_code) (currinsn)->code))]) == 'i'))
  visit_expression (currinsn, succ_block);

       currinsn = (((currinsn)->fld[2]).rtx);
     }
   ...
   if (succ_edge != ((void *)0)
       && succ_edge->succ_next == ((void *)0)
       && !((executable_edges)->elms [((find_edge_index ((edges), (succ_edge->src), (succ_edge->dest)))) / ((unsigned) (8 * 8))] >> ((find_edge_index ((edges), (succ_edge->src), (succ_edge->dest)))) % ((unsigned) (8 * 8)) & 1))

     {
       ((executable_edges)->elms [((find_edge_index ((edges), (succ_edge->src), (succ_edge->dest)))) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << ((find_edge_index ((edges), (succ_edge->src), (succ_edge->dest)))) % ((unsigned) (8 * 8)));

       edge_info[(find_edge_index ((edges), (succ_edge->src), (succ_edge->dest)))] = flow_edges;
...
follow_def_use_chains ()
{
  ...
  while (sbitmap_first_set_bit (ssa_edges) >= 0)
    {
      ...
      ((ssa_edges)->elms [(member) / ((unsigned) (8 * 8))] &= ~((unsigned long long) 1 << (member) % ((unsigned) (8 * 8))));
    ...
    curruse = curruse->next)
 {
   ...
   useinsn = ((curruse->ref)->insn);
   if (((useinsn) && ((enum rtx_code) (useinsn)->code) == INSN && ((enum rtx_code) ((((useinsn)->fld[5]).rtx))->code) == SET && ((enum rtx_code) (((((((useinsn)->fld[5]).rtx))->fld[1]).rtx))->code) == PHI))
     {
       if (((executable_blocks)->elms [(((((useinsn)->fld[3]).bb)->index + 0)) / ((unsigned) (8 * 8))] >> (((((useinsn)->fld[3]).bb)->index + 0)) % ((unsigned) (8 * 8)) & 1))
  visit_phi_node (useinsn, (((useinsn)->fld[3]).bb));
     }
   else
     {
       if (((executable_blocks)->elms [(((((useinsn)->fld[3]).bb)->index + 0)) / ((unsigned) (8 * 8))] >> (((((useinsn)->fld[3]).bb)->index + 0)) % ((unsigned) (8 * 8)) & 1))
  visit_expression (useinsn, (((useinsn)->fld[3]).bb));
     }
 }
    }
}
# 736 "../../../kgccfe/gnu/ssa-ccp.c"
static void
     ...
     sbitmap executable_edges;
{
  ...
  for (i = 0; i < ((edges)->num_edges); i++)
    {
      if (!((executable_edges)->elms [(i) / ((unsigned) (8 * 8))] >> (i) % ((unsigned) (8 * 8)) & 1))
 {
   edge edge = ((edges)->index_to_edge[(i)]);
   ...
   if (edge->dest != (&entry_exit_blocks[1]))
     {
  ...
  {
    remove_phi_alternative ((((insn)->fld[5]).rtx), edge->src);
    if (rtl_dump_file)
      fprintf (rtl_dump_file,
        "Removing alternative for bb %d of phi %d\n",
        edge->src->index, (((((((((insn)->fld[5]).rtx))->fld[0]).rtx))->fld[0]).rtuint));
    insn = (((insn)->fld[2]).rtx);
  }
     }
   if (rtl_dump_file)
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      ...
      if (bb->pred == ((void *)0) || ((enum rtx_code) (insn)->code) != JUMP_INSN)
 continue;



      if (condjump_p (insn) && ! simplejump_p (insn)
   && bb->succ && bb->succ->succ_next == ((void *)0))
 {
   ...
   if (edge->flags & 1)
     ...
     {
       ((((((insn)->fld[5]).rtx))->fld[1]).rtx) = gen_rtx_fmt_u00 (LABEL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), ((((insn)->fld[9]).rtx)));
   ...
   df_insn_modify (df_analyzer, (((insn)->fld[3]).bb), insn);
 }
    }
}
# 849 "../../../kgccfe/gnu/ssa-ccp.c"
static void
ssa_ccp_substitute_constants ()
{
  unsigned int i;

  for (i = 176; i < ((ssa_definition)->num_elements); i++)
    {
      if (values[i].lattice_val == CONSTANT)
 {
   rtx def = ((ssa_definition)->data.rtx[i]);
   rtx set = (((rtx_class[(int) (((enum rtx_code) (def)->code))]) == 'i') ? (((enum rtx_code) ((((def)->fld[5]).rtx))->code) == SET ? (((def)->fld[5]).rtx) : single_set_2 (def, (((def)->fld[5]).rtx))) : (rtx) 0);
   struct df_link *curruse;

   if (! set)
     continue;
# 872 "../../../kgccfe/gnu/ssa-ccp.c"
   if (! ((def) && ((enum rtx_code) (def)->code) == INSN && ((enum rtx_code) ((((def)->fld[5]).rtx))->code) == SET && ((enum rtx_code) (((((((def)->fld[5]).rtx))->fld[1]).rtx))->code) == PHI)
       && ! ((((enum rtx_code) (def)->code) == INSN
       && ((enum rtx_code) ((((set)->fld[1]).rtx))->code) == CONST_INT)))
     {
       if (rtl_dump_file)
  fprintf (rtl_dump_file,
    "Register %d is now set to a constant\n",
    (((((((((def)->fld[5]).rtx))->fld[0]).rtx))->fld[0]).rtuint));
       (((set)->fld[1]).rtx) = values[i].const_value;
       (((def)->fld[6]).rtint) = -1;
       df_insn_modify (df_analyzer, (((def)->fld[3]).bb), def);
     }
   ...
   for (curruse = df_analyzer->regs[i].uses;
        ...
        curruse = curruse->next)
     {
       ...
       if (!(((useinsn))->volatil)
    && ! (((enum rtx_code) (useinsn)->code) == NOTE
   && (((useinsn)->fld[5]).rtint) == NOTE_INSN_DELETED)
    && (((enum rtx_code) (useinsn)->code) == INSN
        || ((enum rtx_code) (useinsn)->code) == JUMP_INSN))
  {

    if (validate_replace_src ((cfun->emit->x_regno_reg_rtx) [i],
   ...
   fprintf (rtl_dump_file,
     ...
     i, (((useinsn)->fld[0]).rtint));
        (((useinsn)->fld[6]).rtint) = -1;
...
ssa_ccp_df_delete_unreachable_insns ()
{
      ...
      if (!(b->flags & 4))
 {
   ...
   while (1)
     {
       rtx next = (((start)->fld[2]).rtx);

       if (((enum rtx_code) (start)->code) == INSN
    || ((enum rtx_code) (start)->code) == CALL_INSN
    || ((enum rtx_code) (start)->code) == JUMP_INSN)
  df_insn_delete (df_analyzer, (((start)->fld[3]).bb), start);
...
ssa_const_prop ()
{
  ...
  values = (value *) xmalloc (((ssa_definition)->num_elements) * sizeof (value));
  for (i = 0; i < ((ssa_definition)->num_elements); i++)
    {
      if (i < 176)
 values[i].lattice_val = VARYING;
      else
 values[i].lattice_val = UNDEFINED;
      values[i].const_value = ((void *)0);
    }

  ssa_edges = sbitmap_alloc (((ssa_definition)->num_elements));
  sbitmap_zero (ssa_edges);

  executable_blocks = sbitmap_alloc (last_basic_block);
  sbitmap_zero (executable_blocks);

  executable_edges = sbitmap_alloc (((edges)->num_edges));
  sbitmap_zero (executable_edges);

  edge_info = (edge *) xmalloc (((edges)->num_edges) * sizeof (edge));
  flow_edges = (&entry_exit_blocks[0])->succ;



  for (curredge = (&entry_exit_blocks[0])->succ; curredge;
       curredge = curredge->succ_next)
    {
      int index = (find_edge_index ((edges), (curredge->src), (curredge->dest)));
      ((executable_edges)->elms [(index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (index) % ((unsigned) (8 * 8)));
     ...
     void *data;
{
   ...
   || ((enum rtx_code) (dest)->code) == ZERO_EXTRACT)
 {
   ...
   if (((enum rtx_code) (reg)->code) == REG)
     ((worklist)->elms [((((reg)->fld[0]).rtuint)) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << ((((reg)->fld[0]).rtuint)) % ((unsigned) (8 * 8)));
 }

      if (((enum rtx_code) (dest)->code) == REG)
 {
   for_each_rtx (&(((x)->fld[1]).rtx), mark_references, data);
   return -1;
 }
    ...
    {
      ((worklist)->elms [((((x)->fld[0]).rtuint)) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << ((((x)->fld[0]).rtuint)) % ((unsigned) (8 * 8)));
      return -1;
    }
...
ssa_fast_dce (df)
     struct df *df;
{
  sbitmap worklist = sbitmap_alloc (((ssa_definition)->num_elements));
  ...
  while (sbitmap_first_set_bit (worklist) >= 0)
    {
      ...
      ((worklist)->elms [(reg) / ((unsigned) (8 * 8))] &= ~((unsigned long long) 1 << (reg) % ((unsigned) (8 * 8))));




      if (reg < 176
   || ! ((ssa_definition)->data.rtx[reg])
   || (((((ssa_definition)->data.rtx[reg])))->volatil)
   || (((enum rtx_code) (((ssa_definition)->data.rtx[reg]))->code) == NOTE
       && ((((((ssa_definition)->data.rtx[reg]))->fld[5]).rtint)
    == NOTE_INSN_DELETED))
   || side_effects_p ((((((ssa_definition)->data.rtx[reg]))->fld[5]).rtx)))
 continue;
      ...
      for (curruse = df->regs[reg].uses; curruse; curruse = curruse->next)
 {
   if (curruse->ref
       && ((curruse->ref)->insn)
       && ! (((((curruse->ref)->insn)))->volatil)
       && ! (((enum rtx_code) (((curruse->ref)->insn))->code) == NOTE
      && ((((((curruse->ref)->insn))->fld[5]).rtint)
   == NOTE_INSN_DELETED))
       && ((curruse->ref)->insn) != ((ssa_definition)->data.rtx[reg]))
     {
       found_use = 1;
       break;
     }
      ...
      if (! found_use)
 {
   rtx def = ((ssa_definition)->data.rtx[reg]);



   for_each_rtx (&(((def)->fld[5]).rtx), mark_references, worklist);



   df_insn_delete (df, (((def)->fld[3]).bb), def);

   ((ssa_definition)->data.rtx[reg]) = ((void *)0);
 }
    }
