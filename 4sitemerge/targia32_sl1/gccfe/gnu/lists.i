     ...
     rtx *listp, *unused_listp;
{
  ...
  (((prev_link)->fld[1]).rtx) = *unused_listp;
  *unused_listp = *listp;
  *listp = 0;
}
     ...
     rtx val, next;
{
  ...
  if (unused_insn_list)
    {
      r = unused_insn_list;
      unused_insn_list = (((r)->fld[1]).rtx);
      (((r)->fld[0]).rtx) = val;
      (((r)->fld[1]).rtx) = next;
      ((r)->mode = (enum machine_mode) ((enum machine_mode) (VOIDmode)));
    }
  else
     ...
     rtx val, next;
{
  ...
  if (unused_expr_list)
    {
      r = unused_expr_list;
      unused_expr_list = (((r)->fld[1]).rtx);
      (((r)->fld[0]).rtx) = val;
      (((r)->fld[1]).rtx) = next;
      ((r)->mode = (enum machine_mode) ((enum machine_mode) (kind)));
    }
  else
...
free_EXPR_LIST_node (ptr)
     rtx ptr;
{
  (((ptr)->fld[1]).rtx) = unused_expr_list;
...
free_INSN_LIST_node (ptr)
     rtx ptr;
{
  (((ptr)->fld[1]).rtx) = unused_insn_list;
  unused_insn_list = ptr;
}

# 1 "../../../kgccfe/gnu/MIPS/gt-lists.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-lists.h"
const struct ggc_root_tab gt_ggc_rd_gt_lists_h[] = {
  { &unused_expr_list, 1, sizeof (unused_expr_list), ((void *)0) },
  { &unused_insn_list, 1, sizeof (unused_insn_list), ((void *)0) },
  { ((void *)0), 0, 0, ((void *)0) }
};
# 148 "../../../kgccfe/gnu/lists.c" 2
