...
.LFE21:
	...
	.section	.rodata
	.type	__FUNCTION__.9955, @object
	.size	__FUNCTION__.9955, 22
__FUNCTION__.9955:
...
.L123:
	.loc 1 428 0
	leal	__FUNCTION__.9955@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$428, 4(%esp)
...
.LFE22:
	...
	.section	.rodata
	.type	__FUNCTION__.9988, @object
	.size	__FUNCTION__.9988, 23
__FUNCTION__.9988:
...
.L131:
	.loc 1 460 0
	leal	__FUNCTION__.9988@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$460, 4(%esp)
	leal	.LC26@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
