...
.LFE21:
	...
	.section	.rodata
	.type	__FUNCTION__.11294, @object
	.size	__FUNCTION__.11294, 25
__FUNCTION__.11294:
	.string	"duplicate_loop_exit_test"
.LC0:
	.string	"../../../kgccfe/gnu/jump.c"
	.text
...
.LBE7:
	.loc 1 498 0
	leal	__FUNCTION__.11294@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$498, 4(%esp)
...
.LFE27:
	...
	.section	.rodata
	.type	__FUNCTION__.11674, @object
	.size	__FUNCTION__.11674, 18
__FUNCTION__.11674:
...
.L256:
	.loc 1 831 0
	leal	__FUNCTION__.11674@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$831, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE28:
	...
	.section	.rodata
	.align 32
	.type	__FUNCTION__.11695, @object
	.size	__FUNCTION__.11695, 34
__FUNCTION__.11695:
...
.L274:
	.loc 1 875 0
	leal	__FUNCTION__.11695@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$875, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE29:
	...
	.section	.rodata
	.type	__FUNCTION__.11720, @object
	.size	__FUNCTION__.11720, 15
__FUNCTION__.11720:
...
.L293:
	.loc 1 922 0
	leal	__FUNCTION__.11720@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$922, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L311:
	.loc 1 954 0
	leal	__FUNCTION__.11737@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$954, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE31:
	...
	.section	.rodata
	.type	__FUNCTION__.11754, @object
	.size	__FUNCTION__.11754, 17
__FUNCTION__.11754:
...
.L321:
	.loc 1 984 0
	leal	__FUNCTION__.11754@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$984, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE58:
	...
	.section	.rodata
	.type	__FUNCTION__.12882, @object
	.size	__FUNCTION__.12882, 13
__FUNCTION__.12882:
	.string	"invert_exp_1"
	.text
...
.LCFI170:
	...
	jne	.L847
	.loc 1 2140 0
	leal	__FUNCTION__.12882@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2140, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE61:
	...
	.section	.rodata
	.type	__FUNCTION__.12932, @object
	.size	__FUNCTION__.12932, 12
__FUNCTION__.12932:
	.string	"invert_jump"
	.text
.globl invert_jump
...
.L869:
	...
	jne	.L871
	.loc 1 2236 0
	leal	__FUNCTION__.12932@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2236, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L942:
	.loc 1 2434 0
	leal	__FUNCTION__.12979@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2434, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE64:
	...
	.section	.rodata
	.type	__FUNCTION__.13297, @object
	.size	__FUNCTION__.13297, 16
__FUNCTION__.13297:
...
.L989:
	.loc 1 2475 0
	leal	__FUNCTION__.13297@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2475, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
