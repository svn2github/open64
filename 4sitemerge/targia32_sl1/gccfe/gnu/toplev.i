...
# 59 "../../../kgccfe/gnu/toplev.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 60 "../../../kgccfe/gnu/toplev.c" 2
# 1 "../../../kgccfe/gnu/MIPS/insn-flags.h" 1
# 61 "../../../kgccfe/gnu/toplev.c" 2
...
# 71 "../../../kgccfe/gnu/toplev.c" 2
# 1 "../../../kgccfe/gnu/graph.h" 1
# 24 "../../../kgccfe/gnu/graph.h"
...
# 86 "../../../kgccfe/gnu/toplev.c" 2


# 1 "../../../kgccfe/gnu/defaults.h" 1
# 89 "../../../kgccfe/gnu/toplev.c" 2
...
# 98 "../../../kgccfe/gnu/toplev.c" 2
# 112 "../../../kgccfe/gnu/toplev.c"
...
# 486 "../../../kgccfe/gnu/toplev.c"
int flag_caller_saves = 0;
# 500 "../../../kgccfe/gnu/toplev.c"
...
# 848 "../../../kgccfe/gnu/toplev.c"
int flag_verbose_asm = 0;
# 857 "../../../kgccfe/gnu/toplev.c"
...
# 1 "../../../kgccfe/gnu/MIPS/options.h" 1
# 1 "../../../kgccfe/gnu/cp/lang-options.h" 1
# 22 "../../../kgccfe/gnu/cp/lang-options.h"
{ ((void *)0), "C++" },
...
# 1 "../../../kgccfe/gnu/MIPS/options.h" 2
# 1462 "../../../kgccfe/gnu/toplev.c" 2
...
do_abort ()
{
  fancy_abort ("../../../kgccfe/gnu/toplev.c", 1754, __FUNCTION__);
}
...
{
  fancy_abort ("../../../kgccfe/gnu/toplev.c", 1764, __FUNCTION__);
}
...
pop_srcloc ()
{
  ...
  if (!input_file_stack)
    fancy_abort ("../../../kgccfe/gnu/toplev.c", 2230, __FUNCTION__);
...
# 2828 "../../../kgccfe/gnu/toplev.c"
  insns = get_insns ();


  unshare_all_rtl (current_function_decl, insns);
# 2843 "../../../kgccfe/gnu/toplev.c"
      ...
      if (flag_reorder_blocks)
 {
  ...
  timevar_push (TV_FINAL);
  {
    ...
    if (((enum rtx_code) (x)->code) != MEM)
      fancy_abort ("../../../kgccfe/gnu/toplev.c", 3759, __FUNCTION__);
    x = (((x)->fld[0]).rtx);
    if (((enum rtx_code) (x)->code) != SYMBOL_REF)
      fancy_abort ("../../../kgccfe/gnu/toplev.c", 3762, __FUNCTION__);
  ...
  ggc_collect ();
# 3807 "../../../kgccfe/gnu/toplev.c"
  timevar_push (TV_SYMOUT);
  (*debug_hooks->function_decl) (decl);
  timevar_pop (TV_SYMOUT);

 exit_rest_of_compilation:
# 3821 "../../../kgccfe/gnu/toplev.c"
  reload_completed = 0;
  flow2_completed = 0;
  no_new_pseudos = 0;
     ...
     const char *indent;
{
  ...
  fnotice (file,
    ...
    , indent, *indent != 0 ? " " : "",
    lang_hooks.name, version_string, "key-linux",
...
# 5401 "../../../kgccfe/gnu/toplev.c"
  if (write_symbols == DWARF_DEBUG)
    debug_hooks = &dwarf_debug_hooks;
# 5416 "../../../kgccfe/gnu/toplev.c"
