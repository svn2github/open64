...
.LFE23:
	...
	.section	.rodata
	.type	__FUNCTION__.13504, @object
	.size	__FUNCTION__.13504, 17
__FUNCTION__.13504:
	.string	"instrument_edges"
.LC0:
	.string	"../../../kgccfe/gnu/profile.c"
.LC1:
	.string	" (and split)"
.LC2:
	.string	""
...
.LBB5:
	...
	je	.L134
	.loc 2 202 0
	leal	__FUNCTION__.13504@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$202, 4(%esp)
...
.LFE28:
	...
	.local	ignore_next_note.14169
	.comm	ignore_next_note.14169,4,4
	.section	.rodata
	.type	__FUNCTION__.14152, @object
	.size	__FUNCTION__.14152, 12
__FUNCTION__.14152:
	.string	"branch_prob"
.LC16:
...
.L374:
	...
	jne	.L376
	.loc 2 843 0
	leal	__FUNCTION__.14152@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$843, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L420:
	...
	jne	.L423
	.loc 2 938 0
	movl	$1, ignore_next_note.14169@GOTOFF(%ebx)
	jmp	.L421
.L423:
	.loc 2 939 0
	movl	-36(%ebp), %eax
	...
	jle	.L421
	.loc 2 941 0
	movl	ignore_next_note.14169@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	je	.L426
	.loc 2 942 0
	movl	$0, ignore_next_note.14169@GOTOFF(%ebx)
	jmp	.L421
.L426:
	.loc 2 947 0
...
.LFE30:
	...
	.section	.rodata
	.type	__FUNCTION__.14468, @object
	.size	__FUNCTION__.14468, 13
__FUNCTION__.14468:
	.string	"union_groups"
	.text
...
.LCFI75:
	...
	jne	.L491
	.loc 2 1114 0
	leal	__FUNCTION__.14468@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1114, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE44:
	...
	.file 11 "../../../kgccfe/gnu/bitmap.h"
	.file 12 "../../../kgccfe/gnu/tree.h"
	.file 13 "../../../kgccfe/gnu/hashtable.h"
	.file 14 "../../../kgccfe/gnu/location.h"
	.file 15 "../../../kgccfe/gnu/function.h"
	.file 16 "../../../kgccfe/gnu/MIPS/mips.h"
	.file 17 "../../../kgccfe/omp_types.h"
	.file 18 "../../../kgccfe/gnu/sbitmap.h"
	.file 19 "../../../kgccfe/gnu/flags.h"
	.file 20 "../../../kgccfe/gnu/output.h"
	.file 21 "../../../kgccfe/gnu/target.h"
	.file 22 "../../../kgccfe/gnu/profile.h"
	.file 23 "../../../kgccfe/gnu/langhooks.h"
	.file 24 "../../../kgccfe/gnu/MIPS/gt-profile.h"
	.file 25 "../../../kgccfe/gnu/ggc.h"
	.text
.Letext0:
