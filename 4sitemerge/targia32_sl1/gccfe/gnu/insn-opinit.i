# 1 "../../../kgccfe/gnu/MIPS/insn-opinit.c"
...
# 5 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2
...
# 6 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2
...
# 7 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2
...
# 8 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2
# 1 "../../../kgccfe/gnu/MIPS/insn-config.h" 1
# 9 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2
...
# 10 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2
...
# 11 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2
...
# 12 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2
...
# 13 "../../../kgccfe/gnu/MIPS/insn-opinit.c" 2

void
init_all_optabs ()
{
  if (((! (target_flags & 0x00000100)) && (! (target_flags & 0x00020000))))
    (optab_table[OTI_addv])->handlers[(int) (int) DFmode].insn_code =
    (optab_table[OTI_add])->handlers[(int) (int) DFmode].insn_code = CODE_FOR_adddf3;
  if (((! (target_flags & 0x00000100))))
    (optab_table[OTI_addv])->handlers[(int) (int) SFmode].insn_code =
    (optab_table[OTI_add])->handlers[(int) (int) SFmode].insn_code = CODE_FOR_addsf3;
  if (((! (target_flags & 0x00000100)) && (! (target_flags & 0x00020000))))
    (optab_table[OTI_subv])->handlers[(int) (int) DFmode].insn_code =
    (optab_table[OTI_sub])->handlers[(int) (int) DFmode].insn_code = CODE_FOR_subdf3;
  if (((! (target_flags & 0x00000100))))
    (optab_table[OTI_subv])->handlers[(int) (int) SFmode].insn_code =
    (optab_table[OTI_sub])->handlers[(int) (int) SFmode].insn_code = CODE_FOR_subsf3;
  if (((target_flags & 0x00002000)))
    (optab_table[OTI_smul_highpart])->handlers[(int) DImode].insn_code = CODE_FOR_smuldi3_highpart;
  if (((target_flags & 0x00002000)))
    (optab_table[OTI_umul_highpart])->handlers[(int) DImode].insn_code = CODE_FOR_umuldi3_highpart;
  if (((! (target_flags & 0x00000100)) && (! (target_flags & 0x00020000))))
    (optab_table[OTI_sdiv])->handlers[(int) DFmode].insn_code = CODE_FOR_divdf3;
  if (((! (target_flags & 0x00000100))))
    (optab_table[OTI_sdiv])->handlers[(int) SFmode].insn_code = CODE_FOR_divsf3;
  if (((! (target_flags & 0x00000100)) && (!(mips_isa == 1)) && (! (target_flags & 0x00020000))))
    (optab_table[OTI_sqrt])->handlers[(int) DFmode].insn_code = CODE_FOR_sqrtdf2;
  if (((! (target_flags & 0x00000100)) && (!(mips_isa == 1))))
    (optab_table[OTI_sqrt])->handlers[(int) SFmode].insn_code = CODE_FOR_sqrtsf2;
  if ((!(target_flags & 0x00100000)))
    (optab_table[OTI_abs])->handlers[(int) SImode].insn_code = CODE_FOR_abssi2;
  if (((target_flags & 0x00002000) && !(target_flags & 0x00100000)))
    (optab_table[OTI_abs])->handlers[(int) DImode].insn_code = CODE_FOR_absdi2;
  if (((! (target_flags & 0x00000100)) && (! (target_flags & 0x00020000))))
    (optab_table[OTI_absv])->handlers[(int) (int) DFmode].insn_code =
    (optab_table[OTI_abs])->handlers[(int) (int) DFmode].insn_code = CODE_FOR_absdf2;
  if (((! (target_flags & 0x00000100))))
    (optab_table[OTI_absv])->handlers[(int) (int) SFmode].insn_code =
    (optab_table[OTI_abs])->handlers[(int) (int) SFmode].insn_code = CODE_FOR_abssf2;
  if ((!(target_flags & 0x00100000)))
    (optab_table[OTI_ffs])->handlers[(int) SImode].insn_code = CODE_FOR_ffssi2;
  if (((target_flags & 0x00002000) && !(target_flags & 0x00100000)))
    (optab_table[OTI_ffs])->handlers[(int) DImode].insn_code = CODE_FOR_ffsdi2;
  (optab_table[OTI_neg])->handlers[(int) SImode].insn_code = CODE_FOR_negsi2;
  if (((! (target_flags & 0x00000100)) && (! (target_flags & 0x00020000))))
    (optab_table[OTI_negv])->handlers[(int) (int) DFmode].insn_code =
    (optab_table[OTI_neg])->handlers[(int) (int) DFmode].insn_code = CODE_FOR_negdf2;
  if (((! (target_flags & 0x00000100))))
    (optab_table[OTI_negv])->handlers[(int) (int) SFmode].insn_code =
    (optab_table[OTI_neg])->handlers[(int) (int) SFmode].insn_code = CODE_FOR_negsf2;
  (optab_table[OTI_one_cmpl])->handlers[(int) SImode].insn_code = CODE_FOR_one_cmplsi2;
  (optab_table[OTI_one_cmpl])->handlers[(int) DImode].insn_code = CODE_FOR_one_cmpldi2;
  if (((! (target_flags & 0x00000100)) && (! (target_flags & 0x00020000))))
  ...
  if ((((mips_isa == 4) || (mips_isa == 32) || (mips_isa == 64)) && (! (target_flags & 0x00000100))))
    (optab_table[OTI_mov])->handlers[(int) CCmode].insn_code = CODE_FOR_movcc;
  if ((((mips_arch == PROCESSOR_R5400) || (mips_arch == PROCESSOR_R5500) || (mips_arch == PROCESSOR_SR71000) )))
    (optab_table[OTI_rotr])->handlers[(int) SImode].insn_code = CODE_FOR_rotrsi3;
  if ((((target_flags & 0x00002000) && ((mips_arch == PROCESSOR_R5400) || (mips_arch == PROCESSOR_R5500) || (mips_arch == PROCESSOR_SR71000) ))))
    (optab_table[OTI_rotr])->handlers[(int) DImode].insn_code = CODE_FOR_rotrdi3;
  (optab_table[OTI_add])->handlers[(int) SImode].insn_code = CODE_FOR_addsi3;
  if (((target_flags & 0x00002000) || (!(target_flags & 0) && !(target_flags & 0x00100000))))
    (optab_table[OTI_add])->handlers[(int) DImode].insn_code = CODE_FOR_adddi3;
  (optab_table[OTI_sub])->handlers[(int) SImode].insn_code = CODE_FOR_subsi3;
  if (((target_flags & 0x00002000) || (!(target_flags & 0) && !(target_flags & 0x00100000))))
    (optab_table[OTI_sub])->handlers[(int) DImode].insn_code = CODE_FOR_subdi3;
  if (((! (target_flags & 0x00000100)) && (! (target_flags & 0x00020000))))
    (optab_table[OTI_smulv])->handlers[(int) (int) DFmode].insn_code =
    (optab_table[OTI_smul])->handlers[(int) (int) DFmode].insn_code = CODE_FOR_muldf3;
  if (((! (target_flags & 0x00000100))))
    (optab_table[OTI_smulv])->handlers[(int) (int) SFmode].insn_code =
    (optab_table[OTI_smul])->handlers[(int) (int) SFmode].insn_code = CODE_FOR_mulsf3;
  (optab_table[OTI_smul])->handlers[(int) SImode].insn_code = CODE_FOR_mulsi3;
  if (((target_flags & 0x00002000)))
    (optab_table[OTI_smul])->handlers[(int) DImode].insn_code = CODE_FOR_muldi3;
  (optab_table[OTI_smul_widen])->handlers[(int) DImode].insn_code = CODE_FOR_mulsidi3;
  (optab_table[OTI_umul_widen])->handlers[(int) DImode].insn_code = CODE_FOR_umulsidi3;
  (optab_table[OTI_smul_highpart])->handlers[(int) SImode].insn_code = CODE_FOR_smulsi3_highpart;
  (optab_table[OTI_umul_highpart])->handlers[(int) SImode].insn_code = CODE_FOR_umulsi3_highpart;
  if ((optimize))
    (optab_table[OTI_sdivmod])->handlers[(int) SImode].insn_code = CODE_FOR_divmodsi4;
  if (((target_flags & 0x00002000) && optimize))
    (optab_table[OTI_sdivmod])->handlers[(int) DImode].insn_code = CODE_FOR_divmoddi4;
  if ((optimize))
    (optab_table[OTI_udivmod])->handlers[(int) SImode].insn_code = CODE_FOR_udivmodsi4;
  if (((target_flags & 0x00002000) && optimize))
    (optab_table[OTI_udivmod])->handlers[(int) DImode].insn_code = CODE_FOR_udivmoddi4;
  if ((!optimize))
    (optab_table[OTI_sdiv])->handlers[(int) SImode].insn_code = CODE_FOR_divsi3;
  if (((target_flags & 0x00002000) && !optimize))
    (optab_table[OTI_sdiv])->handlers[(int) DImode].insn_code = CODE_FOR_divdi3;
  if ((!optimize))
    (optab_table[OTI_smod])->handlers[(int) SImode].insn_code = CODE_FOR_modsi3;
  if (((target_flags & 0x00002000) && !optimize))
    (optab_table[OTI_smod])->handlers[(int) DImode].insn_code = CODE_FOR_moddi3;
  if ((!optimize))
    (optab_table[OTI_udiv])->handlers[(int) SImode].insn_code = CODE_FOR_udivsi3;
  if (((target_flags & 0x00002000) && !optimize))
    (optab_table[OTI_udiv])->handlers[(int) DImode].insn_code = CODE_FOR_udivdi3;
  if ((!optimize))
    (optab_table[OTI_umod])->handlers[(int) SImode].insn_code = CODE_FOR_umodsi3;
  if (((target_flags & 0x00002000) && !optimize))
    (optab_table[OTI_umod])->handlers[(int) DImode].insn_code = CODE_FOR_umoddi3;
  if ((((target_flags & 0x00002000) || !(target_flags & 0)) && !(target_flags & 0x00100000)))
    (optab_table[OTI_neg])->handlers[(int) DImode].insn_code = CODE_FOR_negdi2;
  (optab_table[OTI_and])->handlers[(int) SImode].insn_code = CODE_FOR_andsi3;
  if (1)
    (optab_table[OTI_and])->handlers[(int) DImode].insn_code = CODE_FOR_anddi3;
  (optab_table[OTI_ior])->handlers[(int) SImode].insn_code = CODE_FOR_iorsi3;
  if (1)
    (optab_table[OTI_ior])->handlers[(int) DImode].insn_code = CODE_FOR_iordi3;
  (optab_table[OTI_xor])->handlers[(int) SImode].insn_code = CODE_FOR_xorsi3;
  if (1)
    (optab_table[OTI_xor])->handlers[(int) DImode].insn_code = CODE_FOR_xordi3;
  if (((target_flags & 0x00002000)))
  ...
  if (((! (target_flags & 0x00000100)) && (target_flags & 0x00002000) && (! (target_flags & 0x00020000))))
  ...
  (optab_table[OTI_mov])->handlers[(int) DImode].insn_code = CODE_FOR_movdi;
  if (((target_flags & 0x00002000)))
    reload_in_optab[(int) DImode] = CODE_FOR_reload_indi;
  if (((target_flags & 0x00002000)))
    reload_out_optab[(int) DImode] = CODE_FOR_reload_outdi;
  (optab_table[OTI_mov])->handlers[(int) SImode].insn_code = CODE_FOR_movsi;
  if (((target_flags & 0x00002000) || (target_flags & 0x00100000)))
  ...
  (optab_table[OTI_mov])->handlers[(int) HImode].insn_code = CODE_FOR_movhi;
  (optab_table[OTI_mov])->handlers[(int) QImode].insn_code = CODE_FOR_movqi;
  (optab_table[OTI_mov])->handlers[(int) SFmode].insn_code = CODE_FOR_movsf;
  (optab_table[OTI_mov])->handlers[(int) DFmode].insn_code = CODE_FOR_movdf;
  if ((!(target_flags & 0x00100000)))
    movstr_optab[(int) SImode] = CODE_FOR_movstrsi;
  (optab_table[OTI_ashl])->handlers[(int) SImode].insn_code = CODE_FOR_ashlsi3;
  if (((target_flags & 0x00002000) || (!(target_flags & 0) && !(target_flags & 0x00100000))))
    (optab_table[OTI_ashl])->handlers[(int) DImode].insn_code = CODE_FOR_ashldi3;
  (optab_table[OTI_ashr])->handlers[(int) SImode].insn_code = CODE_FOR_ashrsi3;
  if (((target_flags & 0x00002000) || (!(target_flags & 0) && !(target_flags & 0x00100000))))
    (optab_table[OTI_ashr])->handlers[(int) DImode].insn_code = CODE_FOR_ashrdi3;
  (optab_table[OTI_lshr])->handlers[(int) SImode].insn_code = CODE_FOR_lshrsi3;
  if (((target_flags & 0x00002000) || (!(target_flags & 0) && !(target_flags & 0x00100000))))
    (optab_table[OTI_lshr])->handlers[(int) DImode].insn_code = CODE_FOR_lshrdi3;
  (optab_table[OTI_cmp])->handlers[(int) SImode].insn_code = CODE_FOR_cmpsi;
  (optab_table[OTI_tst])->handlers[(int) SImode].insn_code = CODE_FOR_tstsi;
  if (((target_flags & 0x00002000)))
    (optab_table[OTI_cmp])->handlers[(int) DImode].insn_code = CODE_FOR_cmpdi;
  if (((target_flags & 0x00002000)))
    (optab_table[OTI_tst])->handlers[(int) DImode].insn_code = CODE_FOR_tstdi;
  if (((! (target_flags & 0x00000100)) && (! (target_flags & 0x00020000))))
    (optab_table[OTI_cmp])->handlers[(int) DFmode].insn_code = CODE_FOR_cmpdf;
  if (((! (target_flags & 0x00000100))))
    (optab_table[OTI_cmp])->handlers[(int) SFmode].insn_code = CODE_FOR_cmpsf;
