...
static _Bool attributes_initialized = 0;
...
# 137 "../../../kgccfe/gnu/attribs.c"
  attributes_initialized = 1;
}
# 153 "../../../kgccfe/gnu/attribs.c"
tree
     ...
     int flags;
{
  ...
  if ((tree_code_type[(int) (((enum tree_code) (*node)->common.code))] == 'd') && ((enum tree_code) (*node)->common.code) == FUNCTION_DECL
  ...
  for (a = attributes; a; a = ((a)->common.chain))
    {
      ...
      tree args = ((a)->list.value);
      tree *anode = node;
      const struct attribute_spec *spec = ((void *)0);
      _Bool no_add_attrs = 0;
      size_t i;
      ...
      if (!no_add_attrs)
 {
   ...
   for (a = lookup_attribute (spec->name, old_attrs);
     ...
     {
       if (simple_cst_equal (((a)->list.value), args) == 1)
  break;
     }
   ...
   if (a == (tree) ((void *)0))
     {
       ...
       if ((tree_code_type[(int) (((enum tree_code) (*anode)->common.code))] == 'd'))
  ((*anode)->decl.attributes) = tree_cons (name, args, old_attrs);
       else if (flags & (int) ATTR_FLAG_TYPE_IN_PLACE)
  ((*anode)->type.attributes) = tree_cons (name, args, old_attrs);
       else
  ...
  while (attrs)
    {
      warning ("`%s' attribute ignored",
        ((char *)(((attrs)->list.purpose))->identifier.id.str));
