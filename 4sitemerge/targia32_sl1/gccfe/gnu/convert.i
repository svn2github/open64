     ...
     tree type, expr;
{
  ...
  switch (((enum tree_code) (((expr)->common.type))->common.code))
    ...
    case BOOLEAN_TYPE:
    case CHAR_TYPE:
      if (((((expr)->common.type))->type.precision) == ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32))
 return build1 (CONVERT_EXPR, type, expr);

      return
 convert_to_pointer (type,
       convert ((*lang_hooks.types.type_for_size)
         (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32), 0), expr));
  ...
  switch (((enum tree_code) (((expr)->common.type))->common.code))
    ...
    case COMPLEX_TYPE:
      return convert (type,
        ...
        ((((expr)->common.type))->common.type), expr)));
     ...
     tree type, expr;
{
 ...
 return build1 (NOP_EXPR, type, expr);
        ...
        || outprec != (mode_bitsize[(int) (((type)->type.mode))]))
 return build1 (NOP_EXPR, type,
         convert ((*lang_hooks.types.type_for_mode)
    (((type)->type.mode), ((type)->common.unsigned_flag)),
    expr));
# 231 "../../../kgccfe/gnu/convert.c"
      switch (ex_form)
 {
 case RSHIFT_EXPR:
 ...
 trunc1:
   {
     ...
     if (outprec >= (8 * ((target_flags & 0x00002000) ? 8 : 4))
  || ((target_flags & 0x00002000) ? ((inprec) <= 32 || (outprec) > 32) : 1)
...
# 355 "../../../kgccfe/gnu/convert.c"
 ...
 case NOP_EXPR:
   ...
   if (((enum tree_code) (((((expr)->exp.operands[0]))->common.type))->common.code) == VECTOR_TYPE
       && ((mode_size[(int) (((((((expr)->exp.operands[0]))->common.type))->type.mode))])
 ...
 default:
   break;
    ...
    case VECTOR_TYPE:
      if ((mode_size[(int) (((type)->type.mode))])
   != (mode_size[(int) (((((expr)->common.type))->type.mode))]))
 {
