...
# 24 "../../../kgccfe/gnu/hash.c" 2
# 1 "../../../kgccfe/gnu/hash.h" 1
# 26 "../../../kgccfe/gnu/hash.h"
...
# 27 "../../../kgccfe/gnu/hash.c" 2
# 37 "../../../kgccfe/gnu/hash.c"
void
...
hash_table_init (table, newfunc, hash, comp)
     ...
     _Bool (*comp) (hash_table_key, hash_table_key);
{
  hash_table_init_n (table, newfunc, hash, comp, 1009);
}
...
hash_table_free (table)
     struct hash_table *table;
{
  __extension__ ({ struct obstack *__o = (&table->memory); void *__obj = ((void *) ((void *)0)); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
}
...
hash_lookup (table, key, create, copy)
     ...
     hash_table_key key;
     int create;
     hash_table_key (*copy) (struct obstack* memory, hash_table_key key);

{
 ...
 && (*table->comp)(hashp->key, key))
  ...
  hashp = (*table->newfunc) ((struct hash_entry *) ((void *)0), table, key);
  if (hashp == 0)
    return 0;
...
hash_newfunc (entry, table, p)
     ...
     struct hash_table *table;
     hash_table_key p __attribute__ ((__unused__));
{
  if (entry == 0)
...
hash_traverse (table, func, info)
     struct hash_table *table;
     _Bool (*func) (struct hash_entry *, hash_table_key);
     void * info;
{
  unsigned int i;
  struct hash_entry *p;
     ...
     hash_table_key k;
{
  ...
  new = (char *) __extension__ ({ struct obstack *__h = (memory); __extension__ ({ struct obstack *__o = (__h); int __len = ((strlen (string) + 1)); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); });
  strcpy (new, string);
