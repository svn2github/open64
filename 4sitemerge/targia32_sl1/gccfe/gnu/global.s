...
.Ltext0:
	.section	.rodata
	.type	__FUNCTION__.10246, @object
	.size	__FUNCTION__.10246, 13
__FUNCTION__.10246:
	.string	"global_alloc"
	.align 32
	.type	eliminables.10223, @object
	.size	eliminables.10223, 72
eliminables.10223:
	.long	0
	.long	29
	.long	0
	...
	.long	17
.LC0:
	.string	"../../../kgccfe/gnu/global.c"
	.text
.globl global_alloc
	.type	global_alloc, @function
global_alloc:
.LFB15:
	.file 1 "../../../kgccfe/gnu/global.c"
	.loc 1 319 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.L8:
	.loc 1 346 0
	movl	-80(%ebp), %eax
	movl	eliminables.10223@GOTOFF(%ebx,%eax,8), %eax
	movl	%eax, %edx
	shrl	$6, %edx
	movl	%edx, -308(%ebp)
	movl	-80(%ebp), %eax
...
.L129:
	...
	jne	.L9
	movl	-80(%ebp), %eax
	movl	4+eliminables.10223@GOTOFF(%ebx,%eax,8), %eax
	cmpl	$29, %eax
	jne	.L11
...
.L71:
	...
	jne	.L74
	.loc 1 434 0
	leal	__FUNCTION__.10246@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$434, 4(%esp)
