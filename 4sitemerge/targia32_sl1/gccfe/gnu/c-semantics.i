     ...
     tree *t;
{
  ...
  *t = build_nt (EXPR_STMT, c_global_trees[CTI_VOID_ZERO]);
  (current_stmt_tree ()->x_last_stmt) = *t;
  (current_stmt_tree ()->x_last_expr_type) = (tree) ((void *)0);
  (current_stmt_tree ()->x_last_expr_filename) = input_filename;
}
...
add_stmt (t)
     tree t;
{
  if (input_filename != (current_stmt_tree ()->x_last_expr_filename))
    {


      int add = (strcmp (input_filename, (current_stmt_tree ()->x_last_expr_filename)) != 0);
      (current_stmt_tree ()->x_last_expr_filename) = input_filename;
      if (add)
 {
   tree pos = build_nt (FILE_STMT, (__builtin_constant_p (input_filename) ? get_identifier_with_length ((input_filename), (unsigned) strlen (input_filename)) : (get_identifier) (input_filename)));
   add_stmt (pos);
 }
    }


  (((current_stmt_tree ()->x_last_stmt))->common.chain) = t;
  (current_stmt_tree ()->x_last_stmt) = t;



  ((((current_stmt_tree ()->x_last_stmt)))->common.lang_flag_1) = stmts_are_full_exprs_p ();


  if (current_function_decl)
    ++((current_function_decl)->decl.u1.i);
     ...
     int partial_p;
{
  ...
  ss = build_stmt (SCOPE_STMT, (tree) ((void *)0));
  ((((ss))->common.lang_flag_0)) = begin_p;
  ((((ss))->common.lang_flag_4)) = partial_p;


  if (begin_p)
    {
      top = tree_cons (ss, (tree) ((void *)0), top);
      *stack_ptr = top;
    }
  else
    {
      ((top)->list.value) = ss;
      *stack_ptr = ((top)->common.chain);
    }
     ...
     tree *t;
{
  ...
  stmt = ((*t)->common.chain);
  *t = stmt;
  (current_stmt_tree ()->x_last_stmt) = (tree) ((void *)0);

  if (cfun && stmt)
    {


      ((((stmt))->exp.complexity)) = lineno;
      ((((stmt))->common.lang_flag_2)) = 1;
    }
}
     ...
     tree decl;
{
  ...
  if (((decl)->common.asm_written_flag))
    return;
# 270 "../../../kgccfe/gnu/c-semantics.c"
  if (decl_assembler_name (decl) != ((decl)->decl.name)
      && !((decl)->decl.rtl != ((void *)0)))
    asmspec = ((char *)(decl_assembler_name (decl))->identifier.id.str);
     ...
     tree decl;
{
 ...
 rest_of_decl_compilation
   (decl, ((char *)(decl_assembler_name (decl))->identifier.id.str),
                  0, 0);
      else
 expand_decl (decl);
    }
     ...
     tree destination;
{
  if (((enum tree_code) (destination)->common.code) == IDENTIFIER_NODE)
    fancy_abort ("../../../kgccfe/gnu/c-semantics.c", 322, __FUNCTION__);
     ...
     tree t;
{
 ...
 expand_anon_union_decl (decl, (tree) ((void *)0),
    ...
    make_rtl_for_local_static (decl);
  else if (((enum tree_code) (decl)->common.code) == LABEL_DECL
     ...
     tree t;
{
  tree cond;
  genrtl_do_pushlevel ();
  cond = expand_cond ((((t))->exp.operands[0]));
  emit_line_note (input_filename, lineno);
  ...
  if ((((t))->exp.operands[1]))
    dump_parse_tree ("then clause", (((t))->exp.operands[1]));

  if ((((t))->exp.operands[2]))
    {
      expand_start_else ();
      expand_stmt ((((t))->exp.operands[2]));

      dump_parse_tree ("else clause", (((t))->exp.operands[2]));
...
genrtl_do_stmt (t)
     tree t;
{
  tree cond = (((t))->exp.operands[0]);
# 488 "../../../kgccfe/gnu/c-semantics.c"
    {
      emit_nop ();
      emit_line_note (input_filename, lineno);
     ...
     tree t;
{
  ...
  if (((t)->common.addressable_flag))
  {
    tree init_expr = (((t))->exp.operands[0]);

    expand_start_null_loop ();
    if (((enum tree_code) (init_expr)->common.code) == EXPR_STMT)
      init_expr = ((init_expr)->exp.operands[0]);
    if (((enum tree_code) (init_expr)->common.code) != MODIFY_EXPR &&
        ((enum tree_code) (init_expr)->common.code) != VAR_DECL)
      fancy_abort ("../../../kgccfe/gnu/c-semantics.c", 557, __FUNCTION__);
    expand_start_do_loop (init_expr, (((t))->exp.operands[1]), (((t))->exp.operands[2]), get_loop_stack());
    expand_stmt ((((t))->exp.operands[3]));
  ...
  expand_start_loop_continue_elsewhere (1);
  genrtl_do_pushlevel ();
  cond = expand_cond ((((t))->exp.operands[1]));
  ...
  expand_loop_continue_here ();
  if ((((t))->exp.operands[2]))
    genrtl_expr_stmt ((((t))->exp.operands[2]));
  expand_end_loop ();
  }
}
...
genrtl_scope_stmt (t)
     tree t;
{
  tree block = ((((t))->exp.operands[0]));

  if (!((((t))->common.lang_flag_3)))
    {
      if (((((t))->common.lang_flag_0)))
 expand_start_bindings_and_block (2 * ((((((t)))->exp.operands[0])) == (tree) ((void *)0)), block);
      else if ((!(((((t)))->common.lang_flag_0))))
 expand_end_bindings ((tree) ((void *)0), !((((((t)))->exp.operands[0])) == (tree) ((void *)0)), 0);
    }
  else if (!((((((t)))->exp.operands[0])) == (tree) ((void *)0)))
    {
      rtx note = emit_note (((void *)0),
  ...
  if (block && (!(((((t)))->common.lang_flag_0))))
    {
      tree fn;

      for (fn = ((block)->block.vars); fn; fn = ((fn)->common.chain))
 {
   if (((enum tree_code) (fn)->common.code) == FUNCTION_DECL
       && ((fn)->decl.context) == current_function_decl
       && ((fn)->decl.u2.f)
       && !((fn)->common.asm_written_flag)
       && ((fn)->common.addressable_flag))
     {
     ...
     tree t;
{
  ...
  if (cond == global_trees[TI_ERROR_MARK])
    ...
    cond = c_global_trees[CTI_BOOLEAN_FALSE];

  emit_line_note (input_filename, lineno);
  expand_start_case (1, cond, ((cond)->common.type), "switch statement");
  expand_stmt ((((t))->exp.operands[1]));
  expand_end_case_type (cond, (((t))->exp.operands[2]));
}
     ...
     tree case_label;
{
  ...
  if (cleanup)
    {
      ...
      warning ("destructor needed for `%#D'", (((cleanup)->list.purpose)));
      ...
      if (!explained)
 {
  ...
  add_case_node ((((case_label))->exp.operands[0]), (((case_label))->exp.operands[1]),
   (((case_label))->exp.operands[2]), &duplicate);
}
     ...
     int asm_input_p;
{
  ...
  emit_line_note (input_filename, lineno);
  if (asm_input_p)
    expand_asm (string, cv_qualifier != (tree) ((void *)0));
  else
    c_expand_asm_operands (string, output_operands, input_operands,
      clobbers, cv_qualifier != (tree) ((void *)0),
     ...
     tree t;
{
  ...
  if (!decl || (((decl)->decl.size) && ((decl)->common.type) != global_trees[TI_ERROR_MARK]))
    expand_decl_cleanup_eh (decl, (((t))->exp.operands[1]), ((t)->common.static_flag));
}
     ...
     tree t;
{
  ...
  current_stmt_tree ()->stmts_are_full_exprs_p = (((t))->common.lang_flag_1);
}
...
process_omp_stmt (tree t)
{
  switch (t->omp.choice)
  {
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/c-semantics.c", 933, __FUNCTION__);
  }
}
...
expand_stmt (t)
     tree t;
{
  while (t && t != global_trees[TI_ERROR_MARK])
    {
 ...
 case EXPR_STMT:
   genrtl_expr_stmt_value ((((t))->exp.operands[0]), ((t)->common.addressable_flag),
      ((t)->common.chain) == ((void *)0)
      || (((enum tree_code) (((t)->common.chain))->common.code) == SCOPE_STMT
          && ((((t)->common.chain))->common.chain) == ((void *)0)));
   break;
 ...
 case GOTO_STMT:
   ...
   if (!((((t))->common.lang_flag_0))
     ...
     {
       rtx note = emit_note (((void *)0), NOTE_INSN_PREDICTION);

       (((note)->fld[4]).rtint) = ((PRED_GOTO<<8)+(NOT_TAKEN));
     }
   genrtl_goto_stmt ((((t))->exp.operands[0]));
   break;

 case ASM_STMT:
   genrtl_asm_stmt ((((t))->exp.operands[0]), (((t))->exp.operands[1]),
      (((t))->exp.operands[2]), (((t))->exp.operands[3]),
      (((t))->exp.operands[4]), (((t)->common.lang_flag_0)));
   break;
 ...
 default:
   if (lang_expand_stmt)
     ...
     fancy_abort ("../../../kgccfe/gnu/c-semantics.c", 1055, __FUNCTION__);
   break;
 }
