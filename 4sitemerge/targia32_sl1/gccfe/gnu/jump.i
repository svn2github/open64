...
# 44 "../../../kgccfe/gnu/jump.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 45 "../../../kgccfe/gnu/jump.c" 2
...
# 54 "../../../kgccfe/gnu/jump.c" 2
# 62 "../../../kgccfe/gnu/jump.c"
     ...
     rtx f;
{
  ...
  for (insn = (cfun->expr->x_forced_labels); insn; insn = (((insn)->fld[1]).rtx))
    if (((enum rtx_code) ((((insn)->fld[0]).rtx))->code) == CODE_LABEL)
      ((((((insn)->fld[0]).rtx))->fld[4]).rtint)++;
}
# 105 "../../../kgccfe/gnu/jump.c"
void
cleanup_barriers ()
{
  rtx insn, next, prev;
     ...
     rtx f;
{
  ...
  for (insn = f; insn; insn = (((insn)->fld[2]).rtx))
    if (((enum rtx_code) (insn)->code) == NOTE)
      {
 if ((((insn)->fld[5]).rtint) == NOTE_INSN_FUNCTION_BEG)


   last_note = (rtx) 0;
 else if ((((insn)->fld[5]).rtint) >= 0)
   {

     if (last_note
  && (((insn)->fld[4]).rtstr) == (((last_note)->fld[4]).rtstr)
  && (((insn)->fld[5]).rtint) == (((last_note)->fld[5]).rtint))
       {
     ...
     rtx f;
{
 ...
 (((insn)->fld[4]).rtint) = ((((insn))->in_struct) != 0);
      ...
      else if (((enum rtx_code) (insn)->code) == INSN || ((enum rtx_code) (insn)->code) == CALL_INSN)
 {
   ...
   for (note = (((insn)->fld[8]).rtx); note; note = next)
     {
       next = (((note)->fld[1]).rtx);
       if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_LABEL
    && ! reg_mentioned_p ((((note)->fld[0]).rtx), (((insn)->fld[5]).rtx)))
  remove_note (insn, note);
     }
 }
      if ((((insn)->fld[0]).rtint) > largest_uid)
 largest_uid = (((insn)->fld[0]).rtint);
    }
     ...
     rtx f;
{
 ...
 if (((enum rtx_code) (insn)->code) == CALL_INSN
   ...
   {
     mark_all_labels (((((((insn)->fld[5]).rtx))->fld[0]).rtx));
     mark_all_labels (((((((insn)->fld[5]).rtx))->fld[1]).rtx));
     mark_all_labels (((((((insn)->fld[5]).rtx))->fld[2]).rtx));



     if (((((((insn)->fld[5]).rtx))->fld[3]).rtx))
       {
  rtx label_ref = gen_rtx_fmt_u00 (LABEL_REF, (VOIDmode), (((((((insn)->fld[5]).rtx))->fld[3]).rtx)));

  mark_jump_label (label_ref, insn, 0);
  ((((((insn)->fld[5]).rtx))->fld[3]).rtx) = (((label_ref)->fld[0]).rtx);
       }
  ...
  if (label_note)
    {
      ...
      rtx label_ref = gen_rtx_fmt_u00 (LABEL_REF, (VOIDmode), ((((label_note)->fld[0]).rtx)));


      mark_jump_label (label_ref, insn, 0);
      (((label_note)->fld[0]).rtx) = (((label_ref)->fld[0]).rtx);
      (((insn)->fld[9]).rtx) = (((label_note)->fld[0]).rtx);
    }
       }
   }
      }
}
# 311 "../../../kgccfe/gnu/jump.c"
static int
     ...
     rtx loop_start;
{
  ...
  int num_insns = 0;
  rtx exitcode
    = ((((((next_nonnote_insn_in_loop (loop_start))->fld[9]).rtx))->fld[2]).rtx);
  rtx lastexit;
  int max_reg = max_reg_num ();
  rtx *reg_map = 0;
  rtx loop_pre_header_label;
# 338 "../../../kgccfe/gnu/jump.c"
  for (insn = exitcode;
       insn
 ...
 case INSN:
   ...
   while ((p = find_reg_note (insn, REG_WAS_0, (rtx) 0)) != 0)
     remove_note (insn, p);
   if (++num_insns > 20
 ...
 default:
  ...
  for (insn = exitcode; insn != lastexit; insn = (((insn)->fld[2]).rtx))
 ...
 && ((reg = (((set)->fld[0]).rtx), ((enum rtx_code) (reg)->code) == REG)
     || (((enum rtx_code) (reg)->code) == SUBREG
  && (reg = (((reg)->fld[0]).rtx), ((enum rtx_code) (reg)->code) == REG)))
 && (((reg)->fld[0]).rtuint) >= 176
 && (((reg_n_info)->data.reg[(((reg)->fld[0]).rtuint)])->first_uid) == (((insn)->fld[0]).rtint))
      {
 for (p = (((insn)->fld[2]).rtx); p != lastexit; p = (((p)->fld[2]).rtx))
   if ((((reg_n_info)->data.reg[(((reg)->fld[0]).rtuint)])->last_uid) == (((p)->fld[0]).rtint))
     break;
 ...
 if (p != lastexit)
   {
     ...
     reg_map[(((reg)->fld[0]).rtuint)] = gen_reg_rtx (((enum machine_mode) (reg)->mode));
   }
      }
 ...
 case NOTE:
   ...
   if ((((insn)->fld[5]).rtint) >= 0)
     {
       copy = emit_note_before ((((insn)->fld[5]).rtint), loop_start);
       (((copy)->fld[4]).rtstr) = (((insn)->fld[4]).rtstr);
     }
   break;

 case INSN:
   copy = emit_insn_before (copy_insn ((((insn)->fld[5]).rtx)), loop_start);
   if (reg_map)
     replace_regs ((((copy)->fld[5]).rtx), reg_map, max_reg, 1);

   mark_jump_label ((((copy)->fld[5]).rtx), copy, 0);
  ...
  if (((enum rtx_code) (link)->code) == EXPR_LIST)
    (((copy)->fld[8]).rtx)
      = copy_insn_1 (gen_rtx_fmt_ee (EXPR_LIST, (((enum reg_note) ((enum machine_mode) (link)->mode))), ((((link)->fld[0]).rtx)), ((((copy)->fld[8]).rtx))));


  else
    (((copy)->fld[8]).rtx)
      = copy_insn_1 (gen_rtx_fmt_ue (INSN_LIST, (((enum reg_note) ((enum machine_mode) (link)->mode))), ((((link)->fld[0]).rtx)), ((((copy)->fld[8]).rtx))));


       }

   if (reg_map && (((copy)->fld[8]).rtx))
     replace_regs ((((copy)->fld[8]).rtx), reg_map, max_reg, 1);
   break;

 case JUMP_INSN:
   copy = emit_jump_insn_before (copy_insn ((((insn)->fld[5]).rtx)),
     loop_start);
   (((copy)->fld[4]).rttree) = (((insn)->fld[4]).rttree);
   if (reg_map)
     replace_regs ((((copy)->fld[5]).rtx), reg_map, max_reg, 1);
   ...
   if ((((insn)->fld[8]).rtx))
     {
       (((copy)->fld[8]).rtx) = copy_insn_1 ((((insn)->fld[8]).rtx));
       if (reg_map)
  replace_regs ((((copy)->fld[8]).rtx), reg_map, max_reg, 1);
     }
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/jump.c", 498, __FUNCTION__);
 }
 ...
 first_copy = copy;
  ...
  if (! copy || ((enum rtx_code) (copy)->code) != BARRIER)
    {
       ...
       || (((insn)->fld[5]).rtint) == NOTE_INSN_LOOP_VTOP))
 {
   if (insn == start)
   ...
   else
     {
       ...
       (((insn)->fld[1]).rtx) = (((start)->fld[1]).rtx);
       (((insn)->fld[2]).rtx) = start;
...
# 682 "../../../kgccfe/gnu/jump.c"
    ...
    prev = prev_nonnote_insn (prev))
 {
   ...
   if (set && ((enum rtx_code) (set)->code) == SET
       && rtx_equal_p ((((set)->fld[0]).rtx), arg0))
     {
       ...
       if (((enum rtx_code) (src)->code) == COMPARE)
  {
    ...
    mode = ((enum machine_mode) (arg0)->mode);
    if (mode == VOIDmode)
      mode = ((enum machine_mode) ((((comparison)->fld[1]).rtx))->mode);
    break;
  }
...
reversed_comparison_code (comparison, insn)
     rtx comparison, insn;
{
  if ((rtx_class[(int) (((enum rtx_code) (comparison)->code))]) != '<')
    return UNKNOWN;
  return reversed_comparison_code_parts (((enum rtx_code) (comparison)->code),
      (((comparison)->fld[0]).rtx),
      (((comparison)->fld[1]).rtx), insn);
}
# 791 "../../../kgccfe/gnu/jump.c"
enum rtx_code
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/jump.c", 831, __FUNCTION__);
    }
}
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/jump.c", 875, __FUNCTION__);
    }
}
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/jump.c", 922, __FUNCTION__);
    }
}
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/jump.c", 954, __FUNCTION__);
    }
}
     ...
     enum rtx_code code;
{
  switch (code)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/jump.c", 984, __FUNCTION__);
    }
}
     ...
     rtx insn;
{
  return (((enum rtx_code) (insn)->code) == JUMP_INSN
   ...
   && ((enum rtx_code) (((((((insn)->fld[5]).rtx))->fld[0]).rtx))->code) == PC
   && ((enum rtx_code) (((((((insn)->fld[5]).rtx))->fld[1]).rtx))->code) == LABEL_REF);
}
     ...
     rtx insn;
{
  ...
  return (((enum rtx_code) (insn)->code) == JUMP_INSN
          && (((insn)->fld[9]).rtx)
          && ((((((insn)->fld[9]).rtx))->fld[2]).rtx)
          && (table = next_active_insn ((((insn)->fld[9]).rtx)))
     ...
     rtx insn;
{
  ...
  if (((enum rtx_code) (x)->code) != PARALLEL)
    ...
    x = (((((x)->fld[0]).rtvec))->elem[0]);

  if (((enum rtx_code) (x)->code) != SET)
    return 0;
  if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) != PC)
    return 0;
  if (((enum rtx_code) ((((x)->fld[1]).rtx))->code) == LABEL_REF)
    return 1;
  if (((enum rtx_code) ((((x)->fld[1]).rtx))->code) != IF_THEN_ELSE)
    return 0;
  if (((((((x)->fld[1]).rtx))->fld[2]).rtx) == (global_rtl[GR_PC])
      && (((enum rtx_code) (((((((x)->fld[1]).rtx))->fld[1]).rtx))->code) == LABEL_REF
   || ((enum rtx_code) (((((((x)->fld[1]).rtx))->fld[1]).rtx))->code) == RETURN))
    return 1;
  if (((((((x)->fld[1]).rtx))->fld[1]).rtx) == (global_rtl[GR_PC])
      && (((enum rtx_code) (((((((x)->fld[1]).rtx))->fld[2]).rtx))->code) == LABEL_REF
   || ((enum rtx_code) (((((((x)->fld[1]).rtx))->fld[2]).rtx))->code) == RETURN))
    return 1;
  return 0;
}
     ...
     rtx insn;
{
  ...
  if (((enum rtx_code) (pat)->code) == SET && ((enum rtx_code) ((((pat)->fld[0]).rtx))->code) == PC)
    return pat;
     ...
     rtx insn;
{
  ...
  a = ((enum rtx_code) (((((((x)->fld[1]).rtx))->fld[1]).rtx))->code);
  b = ((enum rtx_code) (((((((x)->fld[1]).rtx))->fld[2]).rtx))->code);
     ...
     rtx insn;
{
  ...
  if (((enum rtx_code) (x)->code) != IF_THEN_ELSE)
    return (rtx) 0;
  if ((((x)->fld[2]).rtx) == (global_rtl[GR_PC]) && ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == LABEL_REF)
    return (((x)->fld[1]).rtx);
  if ((((x)->fld[1]).rtx) == (global_rtl[GR_PC]) && ((enum rtx_code) ((((x)->fld[2]).rtx))->code) == LABEL_REF)
    return (((x)->fld[2]).rtx);
  return (rtx) 0;
}
     ...
     rtx insn;
{
  if (((enum rtx_code) (insn)->code) != JUMP_INSN)
    return 0;
  return for_each_rtx (&(((insn)->fld[5]).rtx), returnjump_p_1, ((void *)0));
}
     ...
     rtx insn;
{
  ...
  if (set == ((void *)0))
    return 0;
  if (((enum rtx_code) ((((set)->fld[0]).rtx))->code) != PC)
    return 0;
  if (side_effects_p ((((set)->fld[1]).rtx)))
    return 0;

  return 1;
}
# 1360 "../../../kgccfe/gnu/jump.c"
rtx
follow_jumps (label)
     rtx label;
{
 ...
 && (((((insn)->fld[9]).rtx) != 0 && any_uncondjump_p (insn)
      && onlyjump_p (insn))
 ...
 for (tem = value; tem != insn; tem = (((tem)->fld[2]).rtx))
   if (((enum rtx_code) (tem)->code) == NOTE
       && ((((tem)->fld[5]).rtint) == NOTE_INSN_LOOP_BEG


    || (flag_test_coverage && (((tem)->fld[5]).rtint) > 0)))
     return value;


      if ((((insn)->fld[9]).rtx) == label)
 return label;

      tem = next_active_insn ((((insn)->fld[9]).rtx));
      if (tem && (((enum rtx_code) ((((tem)->fld[5]).rtx))->code) == ADDR_VEC
    || ((enum rtx_code) ((((tem)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
 break;

      value = (((insn)->fld[9]).rtx);
    }
  if (depth == 10)
    return label;
  return value;
}
# 1424 "../../../kgccfe/gnu/jump.c"
void
     ...
     int in_mem;
{
 ...
 mark_jump_label (get_pool_constant (x), insn, in_mem);
    ...
    case LABEL_REF:
      {
 rtx label = (((x)->fld[0]).rtx);



 if (((enum rtx_code) (label)->code) == NOTE
     && (((label)->fld[5]).rtint) == NOTE_INSN_DELETED_LABEL)
   break;

 if (((enum rtx_code) (label)->code) != CODE_LABEL)
   fancy_abort ("../../../kgccfe/gnu/jump.c", 1469, __FUNCTION__);
 ...
 if (insn)
  ...
  if (! find_reg_note (insn, REG_LABEL, label))
    (((insn)->fld[8]).rtx) = gen_rtx_fmt_ue (INSN_LIST, (REG_LABEL), (label), ((((insn)->fld[8]).rtx)));
      ...
      if (! (((insn))->volatil))
 {
   ...
   for (i = 0; i < (((((x)->fld[eltnum]).rtvec))->num_elem); i++)
     mark_jump_label ((((((x)->fld[eltnum]).rtvec))->elem[i]), (rtx) 0, in_mem);
 }
      return;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 mark_jump_label ((((x)->fld[i]).rtx), insn, in_mem);
      else if (fmt[i] == 'E')
 {
   int j;
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     mark_jump_label ((((((x)->fld[i]).rtvec))->elem[j]), insn, in_mem);
 }
    }
}
     ...
     rtx insn;
{
  ...
  if (set && ((enum rtx_code) ((((set)->fld[0]).rtx))->code) == PC)
...
{
  if (((enum rtx_code) (insn)->code) != BARRIER)
    fancy_abort ("../../../kgccfe/gnu/jump.c", 1549, __FUNCTION__);
     ...
     rtx insn;
{
  ...
  for (our_prev = prev_nonnote_insn (insn);
    ...
    {
      rtx pat = (((our_prev)->fld[5]).rtx);



      if (((enum rtx_code) (our_prev)->code) == CALL_INSN
   && (! (((our_prev))->unchanging)
       || ((enum rtx_code) (pat)->code) != SET || ((enum rtx_code) ((((pat)->fld[1]).rtx))->code) != CALL))
 break;
 ...
 break;
   ...
   && ((enum rtx_code) ((((pat)->fld[0]).rtx))->code) == INSN)
      ...
      if (reg_set_p (reg, pat))
 {
  ...
  {
    rtx part = (((((pat)->fld[0]).rtvec))->elem[i]);
  ...
  delete_computation (our_prev);
     ...
     {
       int dest_regno = ((((((pat)->fld[0]).rtx))->fld[0]).rtuint);
       int dest_endregno
  = (dest_regno
     + (dest_regno < 176
        ? mips_hard_regno_nregs (dest_regno, ((enum machine_mode) ((((pat)->fld[0]).rtx))->mode)) : 1));
         ...
         && dest_endregno >= endregno)
  {
    ...
    (((our_prev)->fld[8]).rtx)
      = gen_rtx_fmt_ee (EXPR_LIST, (REG_UNUSED), (reg), ((((our_prev)->fld[8]).rtx)));
 ...
 {
   (((note)->fld[1]).rtx) = (((our_prev)->fld[8]).rtx);
   (((our_prev)->fld[8]).rtx) = note;
   break;
 }
    }
}
# 1686 "../../../kgccfe/gnu/jump.c"
static void
delete_computation (insn)
     rtx insn;
{
  rtx note, next;
# 1716 "../../../kgccfe/gnu/jump.c"
  for (note = (((insn)->fld[8]).rtx); note; note = next)
    {
      next = (((note)->fld[1]).rtx);
     ...
     rtx insn;
{
  ...
  rtx note;
  rtx next = (((insn)->fld[2]).rtx), prev = (((insn)->fld[1]).rtx);
  ...
  if (((enum rtx_code) (insn)->code) == JUMP_INSN && (((insn)->fld[9]).rtx))
    {
      rtx lab = (((insn)->fld[9]).rtx), lab_next;

      if ((((lab)->fld[4]).rtint) == 0)
 {
   ...
   return next;
      ...
      else if ((lab_next = next_nonnote_insn (lab)) != ((void *)0)
        && ((enum rtx_code) (lab_next)->code) == JUMP_INSN
        && (((enum rtx_code) ((((lab_next)->fld[5]).rtx))->code) == ADDR_VEC
     || ((enum rtx_code) ((((lab_next)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
 {
   ...
   || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
    {
      ...
      for (i = 0; i < len; i++)
 if ((((((((((((pat)->fld[diff_vec_p]).rtvec))->elem[i]))->fld[0]).rtx))->fld[4]).rtint) == 0)
   delete_related_insns (((((((((pat)->fld[diff_vec_p]).rtvec))->elem[i]))->fld[0]).rtx));
      while (next && (((next))->volatil))
 next = (((next)->fld[2]).rtx);
      return next;
    }
 ...
 if (((((((note)->fld[0]).rtx))->fld[4]).rtint) == 0)
   delete_related_insns ((((note)->fld[0]).rtx));
  ...
  if (was_code_label
      ...
      && (((enum rtx_code) (((((((insn)->fld[2]).rtx))->fld[5]).rtx))->code) == ADDR_VEC
   || ((enum rtx_code) (((((((insn)->fld[2]).rtx))->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
    next = delete_related_insns ((((insn)->fld[2]).rtx));
  ...
  if (was_code_label && prev && ((enum rtx_code) (prev)->code) == BARRIER)
    {
      enum rtx_code code;
      while (next != 0
      && ((rtx_class[(int) (code = ((enum rtx_code) (next)->code))]) == 'i'
   || code == NOTE || code == BARRIER
   || (code == CODE_LABEL && (((next))->volatil))))
 {
   if (code == NOTE
       && (((next)->fld[5]).rtint) != NOTE_INSN_FUNCTION_END)
     next = (((next)->fld[2]).rtx);
     ...
     rtx avoided_insn, finish;
{
 ...
 break;
  ...
  for (; insn != ((void *)0); insn = (((insn)->fld[2]).rtx))
    {
   ...
   && (((insn)->fld[5]).rtint) >= 0)
 {
   if (a_line_note == ((void *)0))
     ...
     two_avoided_lines |= ((((a_line_note)->fld[5]).rtint)
      != (((insn)->fld[5]).rtint));
 }
 ...
 reached_end = 1;
  ...
  if (two_avoided_lines && contains_insn)
    warning_with_file_and_line ((((a_line_note)->fld[4]).rtstr),
    (((a_line_note)->fld[5]).rtint),
      ...
      if ((((x)->fld[0]).rtx) == olabel)
 {
   ...
   return;
  ...
  else if (code == RETURN && olabel == 0)
    {
      ...
      if (loc == &(((insn)->fld[5]).rtx))
 x = gen_rtx_fmt_ee (SET, (VOIDmode), ((global_rtl[GR_PC])), (x));
      validate_change (insn, loc, x, 1);
      return;
    }

  if (code == SET && nlabel == 0 && (((x)->fld[0]).rtx) == (global_rtl[GR_PC])
      && ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == LABEL_REF
      && ((((((x)->fld[1]).rtx))->fld[0]).rtx) == olabel)
    {
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 redirect_exp_1 (&(((x)->fld[i]).rtx), olabel, nlabel, insn);
      else if (fmt[i] == 'E')
 {
   int j;
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     redirect_exp_1 (&(((((x)->fld[i]).rtvec))->elem[j]), olabel, nlabel, insn);
 }
    }
}
     ...
     rtx insn;
{
  ...
  if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL)
    loc = &((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]);
  else
    loc = &(((insn)->fld[5]).rtx);
     ...
     rtx jump, nlabel;
{
  ...
  if (((enum rtx_code) ((((jump)->fld[5]).rtx))->code) == PARALLEL)
    loc = &((((((((jump)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]);
  else
    loc = &(((jump)->fld[5]).rtx);

  redirect_exp_1 (loc, (((jump)->fld[9]).rtx), nlabel, jump);
  return num_validated_changes () > ochanges;
}
# 2096 "../../../kgccfe/gnu/jump.c"
int
redirect_jump (jump, nlabel, delete_unused)
     rtx jump, nlabel;
     int delete_unused;
{
  rtx olabel = (((jump)->fld[9]).rtx);
  ...
  if (olabel && nlabel
      && (((olabel)->fld[2]).rtx)
      && ((enum rtx_code) ((((olabel)->fld[2]).rtx))->code) == NOTE
      && ((((((olabel)->fld[2]).rtx))->fld[5]).rtint) == NOTE_INSN_FUNCTION_END)
    emit_note_after (NOTE_INSN_FUNCTION_END, nlabel);

  if (olabel && --(((olabel)->fld[4]).rtint) == 0 && delete_unused
     ...
     rtx insn;
{
  ...
  if (!x)
    fancy_abort ("../../../kgccfe/gnu/jump.c", 2140, __FUNCTION__);
  x = (((x)->fld[1]).rtx);
 ...
 {
   validate_change (insn, &(((x)->fld[0]).rtx),
      gen_rtx_fmt_ee (reversed_code,
        ((enum machine_mode) (comp)->mode), (((comp)->fld[0]).rtx),
        (((comp)->fld[1]).rtx)),
      1);
   return;
 }
      ...
      tem = (((x)->fld[1]).rtx);
      validate_change (insn, &(((x)->fld[1]).rtx), (((x)->fld[2]).rtx), 1);
      validate_change (insn, &(((x)->fld[2]).rtx), tem, 1);
    }
  else
    fancy_abort ("../../../kgccfe/gnu/jump.c", 2173, __FUNCTION__);
}
     ...
     int delete_unused;
{
  ...
  if (! invert_exp (jump))
    ...
    fancy_abort ("../../../kgccfe/gnu/jump.c", 2236, __FUNCTION__);

  return 0;
}
# 2255 "../../../kgccfe/gnu/jump.c"
int
     ...
     rtx x, y;
{
 ...
 return rtx_equal_p (x, y);
      ...
      if (code == SUBREG)
 {
   reg_x = ((((((x)->fld[0]).rtx))->fld[0]).rtuint);
   byte_x = (((x)->fld[1]).rtuint);
 ...
 {
   reg_y = ((((((y)->fld[0]).rtx))->fld[0]).rtuint);
   byte_y = (((y)->fld[1]).rtuint);
 ...
 return (((x)->fld[0]).rtx) == (((y)->fld[0]).rtx);
  ...
  if ((code == EQ || code == NE || (rtx_class[(int) (code)]) == 'c')
      && code != PLUS)
    return ((rtx_renumbered_equal_p ((((x)->fld[0]).rtx), (((y)->fld[0]).rtx))
      && rtx_renumbered_equal_p ((((x)->fld[1]).rtx), (((y)->fld[1]).rtx)))
     || (rtx_renumbered_equal_p ((((x)->fld[0]).rtx), (((y)->fld[1]).rtx))
  && rtx_renumbered_equal_p ((((x)->fld[1]).rtx), (((y)->fld[0]).rtx))));
 ...
 case 't':
   if ((((x)->fld[i]).rttree) != (((y)->fld[i]).rttree))
     return 0;
   break;
 ...
 case 'E':
   ...
   for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
     if (!rtx_renumbered_equal_p ((((((x)->fld[i]).rtvec))->elem[j]), (((((y)->fld[i]).rtvec))->elem[j])))
       return 0;
   break;

 default:
   fancy_abort ("../../../kgccfe/gnu/jump.c", 2434, __FUNCTION__);
 }
    }
  return 1;
}
     ...
     rtx x;
{
  if (((enum rtx_code) (x)->code) == REG)
    {
      if ((((x)->fld[0]).rtuint) >= 176 && reg_renumber[(((x)->fld[0]).rtuint)] >= 0)
 return reg_renumber[(((x)->fld[0]).rtuint)];
      return (((x)->fld[0]).rtuint);
    }
  if (((enum rtx_code) (x)->code) == SUBREG)
    {
      int base = true_regnum ((((x)->fld[0]).rtx));
      if (base >= 0 && base < 176)
 return base + subreg_regno_offset (((((((x)->fld[0]).rtx))->fld[0]).rtuint),
        ((enum machine_mode) ((((x)->fld[0]).rtx))->mode),
        (((x)->fld[1]).rtuint), ((enum machine_mode) (x)->mode));
    }
  return -1;
}
     ...
     rtx reg;
{
  if ((((enum rtx_code) (reg)->code) == REG))
    return (((reg)->fld[0]).rtuint);
  if (((enum rtx_code) (reg)->code) == SUBREG)
    return ((((((reg)->fld[0]).rtx))->fld[0]).rtuint);
  fancy_abort ("../../../kgccfe/gnu/jump.c", 2475, __FUNCTION__);
}
