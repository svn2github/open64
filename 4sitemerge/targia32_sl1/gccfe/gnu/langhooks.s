...
.LFE26:
	...
	.section	.rodata
	.type	__FUNCTION__.12369, @object
	.size	__FUNCTION__.12369, 28
__FUNCTION__.12369:
	.string	"lhd_set_decl_assembler_name"
	.align 4
.LC0:
	.string	"../../../kgccfe/gnu/langhooks.c"
	.text
...
.L37:
	.loc 1 175 0
	leal	__FUNCTION__.12369@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$175, 4(%esp)
...
.LFE29:
	...
	.section	.rodata
	.type	__FUNCTION__.12400, @object
	.size	__FUNCTION__.12400, 21
__FUNCTION__.12400:
...
.LCFI38:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 199 0
	leal	__FUNCTION__.12400@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$199, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE30:
	...
	.section	.rodata
	.type	__FUNCTION__.12405, @object
	.size	__FUNCTION__.12405, 26
__FUNCTION__.12405:
...
.LCFI42:
	...
	je	.L54
	.loc 1 210 0
	leal	__FUNCTION__.12405@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$210, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE33:
	...
	.section	.rodata
	.type	__FUNCTION__.12425, @object
	.size	__FUNCTION__.12425, 16
__FUNCTION__.12425:
...
.LCFI50:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 242 0
	leal	__FUNCTION__.12425@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$242, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
