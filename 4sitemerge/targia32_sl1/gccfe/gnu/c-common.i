...
# 46 "../../../kgccfe/gnu/c-common.c" 2
# 1 "../../../kgccfe/gnu/diagnostic.h" 1
# 30 "../../../kgccfe/gnu/diagnostic.h"
typedef struct
{
...
# 131 "../../../kgccfe/gnu/diagnostic.h"
  printer_fn format_decoder;
} ;
# 172 "../../../kgccfe/gnu/diagnostic.h"
...
# 265 "../../../kgccfe/gnu/diagnostic.h"
extern diagnostic_context *global_dc;
# 286 "../../../kgccfe/gnu/diagnostic.h"
...
# 55 "../../../kgccfe/gnu/c-common.c" 2

cpp_reader *parse_in;
# 106 "../../../kgccfe/gnu/c-common.c"
enum c_language_kind c_language;
# 202 "../../../kgccfe/gnu/c-common.c"
     ...
     int complain;
{
  ...
  (void) (((op == SIZEOF_EXPR || op == ALIGNOF_EXPR) == 0) ? (fancy_abort ("../../../kgccfe/gnu/c-common.c", 3103, __FUNCTION__), 0) : 0);
 ...
 value = size_int_wide ((long long) (((type)->type.align) / 8), SIZETYPE);
  ...
  (void) (((!((((value)->common.type))->type.no_force_blk_flag)) == 0) ? (fancy_abort ("../../../kgccfe/gnu/c-common.c", 3146, __FUNCTION__), 0) : 0);
...
# 1 "../../../kgccfe/gnu/builtin-attrs.def" 1
# 52 "../../../kgccfe/gnu/builtin-attrs.def"
ATTR_NULL,
# 61 "../../../kgccfe/gnu/builtin-attrs.def"
ATTR_0, ATTR_LIST_0,
ATTR_1, ATTR_LIST_1,
ATTR_2, ATTR_LIST_2,
ATTR_3, ATTR_LIST_3,
...
ATTR_NONNULL_3,
# 118 "../../../kgccfe/gnu/builtin-attrs.def"
...
ATTR_FORMAT_ARG_1,
ATTR_FORMAT_ARG_2,
# 155 "../../../kgccfe/gnu/builtin-attrs.def"
ATTR_fscanf,
ATTR_vfprintf,
ATTR_strftime,
...
c_common_nodes_and_builtins ()
{
  enum builtin_type
  {
# 3251 "../../../kgccfe/gnu/c-common.c"
# 1 "../../../kgccfe/gnu/builtin-types.def" 1
# 62 "../../../kgccfe/gnu/builtin-types.def"
BT_VOID,
BT_INT,
BT_UNSIGNED,
BT_LONG,
...
BT_FN_VOID_PTR_PTR_SHORT_INT_INT,
...
BT_FN_INT_PTR_SHORT_SHORT_SHORT,
...
BT_FN_VOID_INT_PTR_SHORT_SHORT_SHORT,
...
BT_FN_SHORT_PTR_INT_PTR_INT_INT,

BT_FN_INT_PTR_INT_PTR_INT_INT,
...
BT_FN_INT_PTR_SHORT_PTR_SHORT_SHORT,

BT_FN_INT_INT_SHORT_PTR_SHORT_SHORT_SHORT,

BT_FN_INT_PTR_INT_PTR_INT_INT_INT,

BT_FN_VOID_PTR_INT_INT_INT_INT_INT,
...
BT_FN_INT_INT_SHORT_PTR_SHORT_SHORT_SHORT_SHORT,
...
BT_FN_INT_INT_INT_SHORT_PTR_INT_INT_INT,
...
BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT,
...
BT_FN_INT_INT_PTR_INT_PTR_INT_INT,

BT_FN_INT_INT_INT_INT_PTR_INT_INT,

BT_FN_INT_INT_PTR_INT_PTR_INT_INT_INT_INT,

BT_FN_INT_INT_INT_PTR_INT_INT_INT,

BT_FN_INT_INT_INT_PTR_INT_INT_INT_INT,

BT_FN_INT_INT_PTR_INT_PTR_INT_INT_INT,
...
# 3252 "../../../kgccfe/gnu/c-common.c" 2
# 3270 "../../../kgccfe/gnu/c-common.c"
    BT_LAST
  };
...
builtin_types[(int) BT_FN_PTR_PTR_SHORT] = build_function_type (builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], global_trees[TI_VOID_LIST_NODE])));
...
builtin_types[(int) BT_FN_PTR_INT_PTR] = build_function_type (builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], global_trees[TI_VOID_LIST_NODE])));
...
builtin_types[(int) BT_INT_INT_SHORT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], global_trees[TI_VOID_LIST_NODE])));
builtin_types[(int) BT_FN_VOID_PTR_SHORT] = build_function_type (builtin_types[(int) BT_VOID], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], global_trees[TI_VOID_LIST_NODE])));
...
builtin_types[(int) BT_FN_VOID_PTR_PTR_SHORT_INT_INT] = build_function_type (builtin_types[(int) BT_VOID], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE]))))));
...
builtin_types[(int) BT_FN_INT_PTR_SHORT_SHORT_SHORT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], global_trees[TI_VOID_LIST_NODE])))));
...
builtin_types[(int) BT_FN_VOID_INT_PTR_SHORT_SHORT_SHORT] = build_function_type (builtin_types[(int) BT_VOID], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], global_trees[TI_VOID_LIST_NODE]))))));
...
builtin_types[(int) BT_FN_SHORT_PTR_INT_PTR_INT_INT] = build_function_type (builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE]))))));

builtin_types[(int) BT_FN_INT_PTR_INT_PTR_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE]))))));
...
builtin_types[(int) BT_FN_INT_PTR_SHORT_PTR_SHORT_SHORT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], global_trees[TI_VOID_LIST_NODE]))))));

builtin_types[(int) BT_FN_INT_INT_SHORT_PTR_SHORT_SHORT_SHORT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], global_trees[TI_VOID_LIST_NODE])))))));

builtin_types[(int) BT_FN_INT_PTR_INT_PTR_INT_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE])))))));

builtin_types[(int) BT_FN_VOID_PTR_INT_INT_INT_INT_INT] = build_function_type (builtin_types[(int) BT_VOID], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE])))))));
...
builtin_types[(int) BT_FN_INT_INT_SHORT_PTR_SHORT_SHORT_SHORT_SHORT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_SHORT], global_trees[TI_VOID_LIST_NODE]))))))));

builtin_types[(int) BT_FN_VOID_PTR_INT_INT_INT_INT_INT_INT] = build_function_type (builtin_types[(int) BT_VOID], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE]))))))));
...
builtin_types[(int) BT_FN_INT_INT_INT_SHORT_PTR_INT_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_SHORT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE]))))))));
...
builtin_types[(int) BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE])))))))));
...
builtin_types[(int) BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE]))))))));

builtin_types[(int) BT_FN_INT_INT_PTR_INT_PTR_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE])))))));

builtin_types[(int) BT_FN_INT_INT_INT_INT_PTR_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE])))))));

builtin_types[(int) BT_FN_INT_INT_PTR_INT_PTR_INT_INT_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE])))))))));

builtin_types[(int) BT_FN_INT_INT_INT_PTR_INT_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE])))))));

builtin_types[(int) BT_FN_INT_INT_INT_PTR_INT_INT_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE]))))))));

builtin_types[(int) BT_FN_INT_INT_PTR_INT_PTR_INT_INT_INT] = build_function_type (builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_PTR], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], tree_cons ((tree) ((void *)0), builtin_types[(int) BT_INT], global_trees[TI_VOID_LIST_NODE]))))))));
...
if ("__builtin_ffs") { tree decl; if (strncmp ("__builtin_ffs", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 258, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_ffs", builtin_types[BT_FN_INT_INT], BUILT_IN_FFS, BUILT_IN_NORMAL, (1 ? ("__builtin_ffs" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_CONST_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_ffs", "__builtin_ffs" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT], builtin_types[BT_FN_INT_INT], BUILT_IN_FFS, BUILT_IN_NORMAL, 1, 1, built_in_attributes[(int) ATTR_CONST_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_FFS] = decl; }



if ("__builtin_index") { tree decl; if (strncmp ("__builtin_index", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 262, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_index", builtin_types[BT_FN_STRING_CONST_STRING_INT], BUILT_IN_INDEX, BUILT_IN_NORMAL, (1 ? ("__builtin_index" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_index", "__builtin_index" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_CONST_STRING_INT], builtin_types[BT_FN_STRING_CONST_STRING_INT], BUILT_IN_INDEX, BUILT_IN_NORMAL, 1, 1, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_INDEX] = decl; }



if ("__builtin_rindex") { tree decl; if (strncmp ("__builtin_rindex", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 266, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_rindex", builtin_types[BT_FN_STRING_CONST_STRING_INT], BUILT_IN_RINDEX, BUILT_IN_NORMAL, (1 ? ("__builtin_rindex" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_rindex", "__builtin_rindex" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_CONST_STRING_INT], builtin_types[BT_FN_STRING_CONST_STRING_INT], BUILT_IN_RINDEX, BUILT_IN_NORMAL, 1, 1, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_RINDEX] = decl; }




if ("__builtin_memcpy") { tree decl; if (strncmp ("__builtin_memcpy", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 271, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_memcpy", builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], BUILT_IN_MEMCPY, BUILT_IN_NORMAL, (1 ? ("__builtin_memcpy" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_memcpy", "__builtin_memcpy" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], BUILT_IN_MEMCPY, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_MEMCPY] = decl; }



if ("__builtin_memmove") { tree decl; if (strncmp ("__builtin_memmove", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 275, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_memmove", builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], BUILT_IN_MEMMOVE, BUILT_IN_NORMAL, (1 ? ("__builtin_memmove" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_memmove", "__builtin_memmove" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], BUILT_IN_MEMMOVE, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_MEMMOVE] = decl; }



if ("__builtin_memcmp") { tree decl; if (strncmp ("__builtin_memcmp", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 279, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_memcmp", builtin_types[BT_FN_INT_CONST_PTR_CONST_PTR_SIZE], BUILT_IN_MEMCMP, BUILT_IN_NORMAL, (1 ? ("__builtin_memcmp" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_memcmp", "__builtin_memcmp" + strlen ("__builtin_"), builtin_types[BT_FN_INT_CONST_PTR_CONST_PTR_SIZE], builtin_types[BT_FN_INT_CONST_PTR_CONST_PTR_SIZE], BUILT_IN_MEMCMP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_MEMCMP] = decl; }



if ("__builtin_memset") { tree decl; if (strncmp ("__builtin_memset", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 283, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_memset", builtin_types[BT_FN_PTR_PTR_INT_SIZE], BUILT_IN_MEMSET, BUILT_IN_NORMAL, (1 ? ("__builtin_memset" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_memset", "__builtin_memset" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR_INT_SIZE], builtin_types[BT_FN_PTR_PTR_INT_SIZE], BUILT_IN_MEMSET, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_MEMSET] = decl; }



if ("__builtin_mempcpy") { tree decl; if (strncmp ("__builtin_mempcpy", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 287, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_mempcpy", builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], BUILT_IN_MEMPCPY, BUILT_IN_NORMAL, (1 ? ("__builtin_mempcpy" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_mempcpy", "__builtin_mempcpy" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], builtin_types[BT_FN_PTR_PTR_CONST_PTR_SIZE], BUILT_IN_MEMPCPY, BUILT_IN_NORMAL, 1, 1, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_MEMPCPY] = decl; }




if ("__builtin_strcat") { tree decl; if (strncmp ("__builtin_strcat", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 292, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strcat", builtin_types[BT_FN_STRING_STRING_CONST_STRING], BUILT_IN_STRCAT, BUILT_IN_NORMAL, (1 ? ("__builtin_strcat" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strcat", "__builtin_strcat" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_STRING_CONST_STRING], builtin_types[BT_FN_STRING_STRING_CONST_STRING], BUILT_IN_STRCAT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRCAT] = decl; }



if ("__builtin_strncat") { tree decl; if (strncmp ("__builtin_strncat", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 296, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strncat", builtin_types[BT_FN_STRING_STRING_CONST_STRING_SIZE], BUILT_IN_STRNCAT, BUILT_IN_NORMAL, (1 ? ("__builtin_strncat" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strncat", "__builtin_strncat" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_STRING_CONST_STRING_SIZE], builtin_types[BT_FN_STRING_STRING_CONST_STRING_SIZE], BUILT_IN_STRNCAT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRNCAT] = decl; }



if ("__builtin_stpcpy") { tree decl; if (strncmp ("__builtin_stpcpy", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 300, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_stpcpy", builtin_types[BT_FN_STRING_STRING_CONST_STRING], BUILT_IN_STPCPY, BUILT_IN_NORMAL, (1 ? ("__builtin_stpcpy" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_stpcpy", "__builtin_stpcpy" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_STRING_CONST_STRING], builtin_types[BT_FN_STRING_STRING_CONST_STRING], BUILT_IN_STPCPY, BUILT_IN_NORMAL, 1, 1, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STPCPY] = decl; }



if ("__builtin_strcpy") { tree decl; if (strncmp ("__builtin_strcpy", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 304, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strcpy", builtin_types[BT_FN_STRING_STRING_CONST_STRING], BUILT_IN_STRCPY, BUILT_IN_NORMAL, (1 ? ("__builtin_strcpy" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strcpy", "__builtin_strcpy" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_STRING_CONST_STRING], builtin_types[BT_FN_STRING_STRING_CONST_STRING], BUILT_IN_STRCPY, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRCPY] = decl; }



if ("__builtin_strncpy") { tree decl; if (strncmp ("__builtin_strncpy", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 308, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strncpy", builtin_types[BT_FN_STRING_STRING_CONST_STRING_SIZE], BUILT_IN_STRNCPY, BUILT_IN_NORMAL, (1 ? ("__builtin_strncpy" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strncpy", "__builtin_strncpy" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_STRING_CONST_STRING_SIZE], builtin_types[BT_FN_STRING_STRING_CONST_STRING_SIZE], BUILT_IN_STRNCPY, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRNCPY] = decl; }



if ("__builtin_strcmp") { tree decl; if (strncmp ("__builtin_strcmp", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 312, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strcmp", builtin_types[BT_FN_INT_CONST_STRING_CONST_STRING], BUILT_IN_STRCMP, BUILT_IN_NORMAL, (1 ? ("__builtin_strcmp" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strcmp", "__builtin_strcmp" + strlen ("__builtin_"), builtin_types[BT_FN_INT_CONST_STRING_CONST_STRING], builtin_types[BT_FN_INT_CONST_STRING_CONST_STRING], BUILT_IN_STRCMP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRCMP] = decl; }



if ("__builtin_strncmp") { tree decl; if (strncmp ("__builtin_strncmp", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 316, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strncmp", builtin_types[BT_FN_INT_CONST_STRING_CONST_STRING_SIZE], BUILT_IN_STRNCMP, BUILT_IN_NORMAL, (1 ? ("__builtin_strncmp" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strncmp", "__builtin_strncmp" + strlen ("__builtin_"), builtin_types[BT_FN_INT_CONST_STRING_CONST_STRING_SIZE], builtin_types[BT_FN_INT_CONST_STRING_CONST_STRING_SIZE], BUILT_IN_STRNCMP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRNCMP] = decl; }



if ("__builtin_strlen") { tree decl; if (strncmp ("__builtin_strlen", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 320, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strlen", builtin_types[BT_FN_SIZE_CONST_STRING], BUILT_IN_STRLEN, BUILT_IN_NORMAL, (1 ? ("__builtin_strlen" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strlen", "__builtin_strlen" + strlen ("__builtin_"), builtin_types[BT_FN_SIZE_CONST_STRING], builtin_types[BT_FN_SIZE_CONST_STRING], BUILT_IN_STRLEN, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRLEN] = decl; }



if ("__builtin_strstr") { tree decl; if (strncmp ("__builtin_strstr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 324, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strstr", builtin_types[BT_FN_STRING_CONST_STRING_CONST_STRING], BUILT_IN_STRSTR, BUILT_IN_NORMAL, (1 ? ("__builtin_strstr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strstr", "__builtin_strstr" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_CONST_STRING_CONST_STRING], builtin_types[BT_FN_STRING_CONST_STRING_CONST_STRING], BUILT_IN_STRSTR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRSTR] = decl; }



if ("__builtin_strpbrk") { tree decl; if (strncmp ("__builtin_strpbrk", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 328, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strpbrk", builtin_types[BT_FN_STRING_CONST_STRING_CONST_STRING], BUILT_IN_STRPBRK, BUILT_IN_NORMAL, (1 ? ("__builtin_strpbrk" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strpbrk", "__builtin_strpbrk" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_CONST_STRING_CONST_STRING], builtin_types[BT_FN_STRING_CONST_STRING_CONST_STRING], BUILT_IN_STRPBRK, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRPBRK] = decl; }



if ("__builtin_strspn") { tree decl; if (strncmp ("__builtin_strspn", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 332, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strspn", builtin_types[BT_FN_SIZE_CONST_STRING_CONST_STRING], BUILT_IN_STRSPN, BUILT_IN_NORMAL, (1 ? ("__builtin_strspn" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strspn", "__builtin_strspn" + strlen ("__builtin_"), builtin_types[BT_FN_SIZE_CONST_STRING_CONST_STRING], builtin_types[BT_FN_SIZE_CONST_STRING_CONST_STRING], BUILT_IN_STRSPN, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRSPN] = decl; }



if ("__builtin_strcspn") { tree decl; if (strncmp ("__builtin_strcspn", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 336, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strcspn", builtin_types[BT_FN_SIZE_CONST_STRING_CONST_STRING], BUILT_IN_STRCSPN, BUILT_IN_NORMAL, (1 ? ("__builtin_strcspn" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strcspn", "__builtin_strcspn" + strlen ("__builtin_"), builtin_types[BT_FN_SIZE_CONST_STRING_CONST_STRING], builtin_types[BT_FN_SIZE_CONST_STRING_CONST_STRING], BUILT_IN_STRCSPN, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRCSPN] = decl; }



if ("__builtin_strchr") { tree decl; if (strncmp ("__builtin_strchr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 340, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strchr", builtin_types[BT_FN_STRING_CONST_STRING_INT], BUILT_IN_STRCHR, BUILT_IN_NORMAL, (1 ? ("__builtin_strchr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strchr", "__builtin_strchr" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_CONST_STRING_INT], builtin_types[BT_FN_STRING_CONST_STRING_INT], BUILT_IN_STRCHR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRCHR] = decl; }



if ("__builtin_strrchr") { tree decl; if (strncmp ("__builtin_strrchr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 344, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_strrchr", builtin_types[BT_FN_STRING_CONST_STRING_INT], BUILT_IN_STRRCHR, BUILT_IN_NORMAL, (1 ? ("__builtin_strrchr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_strrchr", "__builtin_strrchr" + strlen ("__builtin_"), builtin_types[BT_FN_STRING_CONST_STRING_INT], builtin_types[BT_FN_STRING_CONST_STRING_INT], BUILT_IN_STRRCHR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_STRRCHR] = decl; }





if ("__builtin_floor") { tree decl; if (strncmp ("__builtin_floor", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 353, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_floor", builtin_types[BT_FN_DOUBLE_DOUBLE], BUILT_IN_FLOOR, BUILT_IN_NORMAL, (1 ? ("__builtin_floor" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) flag_errno_math ? ATTR_NOTHROW_LIST : (flag_unsafe_math_optimizations ? ATTR_CONST_NOTHROW_LIST : ATTR_PURE_NOTHROW_LIST)]); else decl = builtin_function_2 ("__builtin_floor", "__builtin_floor" + strlen ("__builtin_"), builtin_types[BT_FN_DOUBLE_DOUBLE], builtin_types[BT_FN_DOUBLE_DOUBLE], BUILT_IN_FLOOR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) flag_errno_math ? ATTR_NOTHROW_LIST : (flag_unsafe_math_optimizations ? ATTR_CONST_NOTHROW_LIST : ATTR_PURE_NOTHROW_LIST)]); built_in_decls[(int) BUILT_IN_FLOOR] = decl; }
...
if ("__builtin_tan") { tree decl; if (strncmp ("__builtin_tan", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 383, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_tan", builtin_types[BT_FN_DOUBLE_DOUBLE], BUILT_IN_TAN, BUILT_IN_NORMAL, (1 ? ("__builtin_tan" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) flag_unsafe_math_optimizations ? ATTR_CONST_NOTHROW_LIST : ATTR_PURE_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_tan", "__builtin_tan" + strlen ("__builtin_"), builtin_types[BT_FN_DOUBLE_DOUBLE], builtin_types[BT_FN_DOUBLE_DOUBLE], BUILT_IN_TAN, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) flag_unsafe_math_optimizations ? ATTR_CONST_NOTHROW_LIST : ATTR_PURE_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_TAN] = decl; }
# 388 "../../../kgccfe/gnu/builtins.def"
if ("__builtin_intrinsic_peripheral_RW_begin") { tree decl; if (strncmp ("__builtin_intrinsic_peripheral_RW_begin", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 391, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_peripheral_RW_begin", builtin_types[BT_FN_VOID], BUILT_IN_PERIPHERAL_RW_BEGIN, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_peripheral_RW_begin" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_peripheral_RW_begin", "__builtin_intrinsic_peripheral_RW_begin" + strlen ("__builtin_"), builtin_types[BT_FN_VOID], builtin_types[BT_FN_VOID], BUILT_IN_PERIPHERAL_RW_BEGIN, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_PERIPHERAL_RW_BEGIN] = decl; }




if ("__builtin_intrinsic_peripheral_RW_end") { tree decl; if (strncmp ("__builtin_intrinsic_peripheral_RW_end", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 396, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_peripheral_RW_end", builtin_types[BT_FN_VOID], BUILT_IN_PERIPHERAL_RW_END, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_peripheral_RW_end" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_peripheral_RW_end", "__builtin_intrinsic_peripheral_RW_end" + strlen ("__builtin_"), builtin_types[BT_FN_VOID], builtin_types[BT_FN_VOID], BUILT_IN_PERIPHERAL_RW_END, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_PERIPHERAL_RW_END] = decl; }





if ("__builtin_intrinsic_vbuf_offset") { tree decl; if (strncmp ("__builtin_intrinsic_vbuf_offset", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 402, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_vbuf_offset", builtin_types[BT_FN_PTR_PTR], BUILT_IN_VBUF_OFFSET, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_vbuf_offset" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_vbuf_offset", "__builtin_intrinsic_vbuf_offset" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR], builtin_types[BT_FN_PTR_PTR], BUILT_IN_VBUF_OFFSET, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_VBUF_OFFSET] = decl; }




if ("__builtin_intrinsic_sbuf_offset") { tree decl; if (strncmp ("__builtin_intrinsic_sbuf_offset", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 407, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_sbuf_offset", builtin_types[BT_FN_PTR_PTR], BUILT_IN_SBUF_OFFSET, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_sbuf_offset" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_sbuf_offset", "__builtin_intrinsic_sbuf_offset" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR], builtin_types[BT_FN_PTR_PTR], BUILT_IN_SBUF_OFFSET, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_SBUF_OFFSET] = decl; }




if ("__builtin_SL1_L_muld_shl_hi") { tree decl; if (strncmp ("__builtin_SL1_L_muld_shl_hi", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 412, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_muld_shl_hi", builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_MUL_SHIFT_HI, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_muld_shl_hi" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_muld_shl_hi", "__builtin_SL1_L_muld_shl_hi" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_MUL_SHIFT_HI, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_MUL_SHIFT_HI] = decl; }



if ("__builtin_SL1_L_muld_shl") { tree decl; if (strncmp ("__builtin_SL1_L_muld_shl", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 416, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_muld_shl", builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_MUL_SHIFT, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_muld_shl" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_muld_shl", "__builtin_SL1_L_muld_shl" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_MUL_SHIFT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_MUL_SHIFT] = decl; }



if ("__builtin_SL1_lead") { tree decl; if (strncmp ("__builtin_SL1_lead", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 420, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_lead", builtin_types[BT_FN_SHORT_INT_INT], BUILD_IN_C3_LEAD, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_lead" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_lead", "__builtin_SL1_lead" + strlen ("__builtin_"), builtin_types[BT_FN_SHORT_INT_INT], builtin_types[BT_FN_SHORT_INT_INT], BUILD_IN_C3_LEAD, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_LEAD] = decl; }



if ("__builtin_SL1_L_mac") { tree decl; if (strncmp ("__builtin_SL1_L_mac", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 424, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_mac", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILD_IN_C3_MAC, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_mac" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_mac", "__builtin_SL1_L_mac" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILD_IN_C3_MAC, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MAC] = decl; }



if ("__builtin_SL1_L_msu") { tree decl; if (strncmp ("__builtin_SL1_L_msu", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 428, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_msu", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILD_IN_C3_MACN, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_msu" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_msu", "__builtin_SL1_L_msu" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILD_IN_C3_MACN, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MACN] = decl; }



if ("__builtin_SL1_shl_round_shr") { tree decl; if (strncmp ("__builtin_SL1_shl_round_shr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 432, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_shl_round_shr", builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], BUILD_IN_C3_ROUND, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_shl_round_shr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_shl_round_shr", "__builtin_SL1_shl_round_shr" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], BUILD_IN_C3_ROUND, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_ROUND] = decl; }



if ("__builtin_SL1_L_sadd_shl") { tree decl; if (strncmp ("__builtin_SL1_L_sadd_shl", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 436, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_sadd_shl", builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_C3_SAADDS, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_sadd_shl" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_sadd_shl", "__builtin_SL1_L_sadd_shl" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_C3_SAADDS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAADDS] = decl; }



if ("__builtin_SL1_L_ssub_shl") { tree decl; if (strncmp ("__builtin_SL1_L_ssub_shl", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 440, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_ssub_shl", builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_C3_SASUBS, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_ssub_shl" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_ssub_shl", "__builtin_SL1_L_ssub_shl" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_C3_SASUBS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SASUBS] = decl; }



if ("__builtin_SL1_L_mul_shr") { tree decl; if (strncmp ("__builtin_SL1_L_mul_shr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 444, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_mul_shr", builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], BUILD_IN_C3_MULA, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_mul_shr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_mul_shr", "__builtin_SL1_L_mul_shr" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], BUILD_IN_C3_MULA, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MULA] = decl; }



if ("__builtin_SL1_L_acquire_acc") { tree decl; if (strncmp ("__builtin_SL1_L_acquire_acc", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 448, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_acquire_acc", builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_INIT_ACC, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_acquire_acc" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_acquire_acc", "__builtin_SL1_L_acquire_acc" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_INIT_ACC, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_INIT_ACC] = decl; }



if ("__builtin_SL1_L_free_acc") { tree decl; if (strncmp ("__builtin_SL1_L_free_acc", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 452, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_free_acc", builtin_types[BT_FN_INT_INT_SHORT], BUILD_IN_C3_SAVE_ACC, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_free_acc" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_free_acc", "__builtin_SL1_L_free_acc" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT], builtin_types[BT_FN_INT_INT_SHORT], BUILD_IN_C3_SAVE_ACC, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAVE_ACC] = decl; }



if ("__builtin_SL1_L_mpy_32_16") { tree decl; if (strncmp ("__builtin_SL1_L_mpy_32_16", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 456, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_mpy_32_16", builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_MPY_32_16, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_mpy_32_16" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_mpy_32_16", "__builtin_SL1_L_mpy_32_16" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILD_IN_MPY_32_16, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_MPY_32_16] = decl; }



if ("__builtin_intrinsic_c3_macd") { tree decl; if (strncmp ("__builtin_intrinsic_c3_macd", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 460, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c3_macd", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILD_IN_C3_MACD, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c3_macd" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c3_macd", "__builtin_intrinsic_c3_macd" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILD_IN_C3_MACD, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MACD] = decl; }



if ("__builtin_SL1_L_muld_shr") { tree decl; if (strncmp ("__builtin_SL1_L_muld_shr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 464, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_muld_shr", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILD_IN_C3_MULAD, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_muld_shr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_muld_shr", "__builtin_SL1_L_muld_shr" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILD_IN_C3_MULAD, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MULAD] = decl; }



if ("__builtin_SL1_sadd_shl") { tree decl; if (strncmp ("__builtin_SL1_sadd_shl", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 468, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_sadd_shl", builtin_types[BT_FN_SHORT_INT_INT_INT], BUILD_IN_C3_SAADDSH, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_sadd_shl" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_sadd_shl", "__builtin_SL1_sadd_shl" + strlen ("__builtin_"), builtin_types[BT_FN_SHORT_INT_INT_INT], builtin_types[BT_FN_SHORT_INT_INT_INT], BUILD_IN_C3_SAADDSH, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAADDSH] = decl; }



if ("__builtin_SL1_ssub_shl") { tree decl; if (strncmp ("__builtin_SL1_ssub_shl", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 472, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_ssub_shl", builtin_types[BT_FN_SHORT_INT_INT_INT], BUILD_IN_C3_SASUBSH, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_ssub_shl" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_ssub_shl", "__builtin_SL1_ssub_shl" + strlen ("__builtin_"), builtin_types[BT_FN_SHORT_INT_INT_INT], builtin_types[BT_FN_SHORT_INT_INT_INT], BUILD_IN_C3_SASUBSH, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SASUBSH] = decl; }



if ("__builtin_SL1_L_copy_shr_acc") { tree decl; if (strncmp ("__builtin_SL1_L_copy_shr_acc", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 476, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_copy_shr_acc", builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_C3_MVFS, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_copy_shr_acc" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_copy_shr_acc", "__builtin_SL1_L_copy_shr_acc" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_C3_MVFS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MVFS] = decl; }



if ("__builtin_SL1_acquire_addr") { tree decl; if (strncmp ("__builtin_SL1_acquire_addr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 480, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_acquire_addr", builtin_types[BT_FN_PTR_PTR_SHORT], BUILD_IN_C3_INIT_ADDR, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_acquire_addr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_acquire_addr", "__builtin_SL1_acquire_addr" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR_SHORT], builtin_types[BT_FN_PTR_PTR_SHORT], BUILD_IN_C3_INIT_ADDR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_INIT_ADDR] = decl; }



if ("__builtin_SL1_free_addr") { tree decl; if (strncmp ("__builtin_SL1_free_addr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 484, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_free_addr", builtin_types[BT_FN_PTR_PTR], BUILD_IN_C3_SAVE_ADDR, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_free_addr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_free_addr", "__builtin_SL1_free_addr" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR], builtin_types[BT_FN_PTR_PTR], BUILD_IN_C3_SAVE_ADDR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAVE_ADDR] = decl; }



if ("__builtin_SL1_L_mac_p") { tree decl; if (strncmp ("__builtin_SL1_L_mac_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 488, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_mac_p", builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_MAC_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_mac_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_mac_p", "__builtin_SL1_L_mac_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT], builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_MAC_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MAC_A] = decl; }



if ("__builtin_SL1_L_msu_p") { tree decl; if (strncmp ("__builtin_SL1_L_msu_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 492, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_msu_p", builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_MACN_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_msu_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_msu_p", "__builtin_SL1_L_msu_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT], builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_MACN_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MACN_A] = decl; }



if ("__builtin_SL1_L_dmac_p") { tree decl; if (strncmp ("__builtin_SL1_L_dmac_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 496, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_dmac_p", builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_DMAC_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_dmac_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_dmac_p", "__builtin_SL1_L_dmac_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_DMAC_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DMAC_A] = decl; }



if ("__builtin_SL1_L_dmacn_p") { tree decl; if (strncmp ("__builtin_SL1_L_dmacn_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 500, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_dmacn_p", builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_DMACN_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_dmacn_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_dmacn_p", "__builtin_SL1_L_dmacn_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_DMACN_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DMACN_A] = decl; }



if ("__builtin_SL1_L_acquire_dacc") { tree decl; if (strncmp ("__builtin_SL1_L_acquire_dacc", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 504, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_acquire_dacc", builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_INIT_DACC, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_acquire_dacc" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_acquire_dacc", "__builtin_SL1_L_acquire_dacc" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_INIT_DACC, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_INIT_DACC] = decl; }



if ("__builtin_SL1_L_free_dacc") { tree decl; if (strncmp ("__builtin_SL1_L_free_dacc", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 508, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_free_dacc", builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_SAVE_DACC, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_free_dacc" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_free_dacc", "__builtin_SL1_L_free_dacc" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_SAVE_DACC, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAVE_DACC] = decl; }



if ("__builtin_SL1_sadd_p") { tree decl; if (strncmp ("__builtin_SL1_sadd_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 512, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_sadd_p", builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_SAADDH_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_sadd_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_sadd_p", "__builtin_SL1_sadd_p" + strlen ("__builtin_"), builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_SAADDH_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAADDH_A] = decl; }



if ("__builtin_SL1_ssub_p") { tree decl; if (strncmp ("__builtin_SL1_ssub_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 516, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_ssub_p", builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_SASUBH_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_ssub_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_ssub_p", "__builtin_SL1_ssub_p" + strlen ("__builtin_"), builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_SASUBH_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SASUBH_A] = decl; }



if ("__builtin_SL1_smul_shl_hi") { tree decl; if (strncmp ("__builtin_SL1_smul_shl_hi", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 520, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_smul_shl_hi", builtin_types[BT_FN_SHORT_INT_INT_INT], BUILD_IN_C3_SAMULSH, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_smul_shl_hi" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_smul_shl_hi", "__builtin_SL1_smul_shl_hi" + strlen ("__builtin_"), builtin_types[BT_FN_SHORT_INT_INT_INT], builtin_types[BT_FN_SHORT_INT_INT_INT], BUILD_IN_C3_SAMULSH, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAMULSH] = decl; }



if ("__builtin_SL1_L_mul_shr_p") { tree decl; if (strncmp ("__builtin_SL1_L_mul_shr_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 524, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_mul_shr_p", builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_MULA_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_mul_shr_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_mul_shr_p", "__builtin_SL1_L_mul_shr_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_MULA_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MULA_A] = decl; }



if ("__builtin_SL1_smul_hi_p") { tree decl; if (strncmp ("__builtin_SL1_smul_hi_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 528, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_smul_hi_p", builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_SAMULH_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_smul_hi_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_smul_hi_p", "__builtin_SL1_smul_hi_p" + strlen ("__builtin_"), builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], builtin_types[BT_FN_SHORT_PTR_INT_PTR_INT_INT], BUILD_IN_C3_SAMULH_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAMULH_A] = decl; }



if ("__builtin_intrinsic_c3_ptr") { tree decl; if (strncmp ("__builtin_intrinsic_c3_ptr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 532, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c3_ptr", builtin_types[BT_FN_PTR_INT_PTR], BUILD_IN_C3_PTR, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c3_ptr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c3_ptr", "__builtin_intrinsic_c3_ptr" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_INT_PTR], builtin_types[BT_FN_PTR_INT_PTR], BUILD_IN_C3_PTR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_PTR] = decl; }



if ("__builtin_SL1_L_mac_v_p") { tree decl; if (strncmp ("__builtin_SL1_L_mac_v_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 536, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_mac_v_p", builtin_types[BT_FN_INT_INT_INT_INT_PTR_INT_INT], BUILD_IN_C3_MAC_AR, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_mac_v_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_mac_v_p", "__builtin_SL1_L_mac_v_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_PTR_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_PTR_INT_INT], BUILD_IN_C3_MAC_AR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MAC_AR] = decl; }



if ("__builtin_SL1_L_msu_v_p") { tree decl; if (strncmp ("__builtin_SL1_L_msu_v_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 540, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_msu_v_p", builtin_types[BT_FN_INT_INT_INT_INT_PTR_INT_INT], BUILD_IN_C3_MACN_AR, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_msu_v_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_msu_v_p", "__builtin_SL1_L_msu_v_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_PTR_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_PTR_INT_INT], BUILD_IN_C3_MACN_AR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MACN_AR] = decl; }



if ("__builtin_SL1_L_mul_shr_v_p") { tree decl; if (strncmp ("__builtin_SL1_L_mul_shr_v_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 544, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_mul_shr_v_p", builtin_types[BT_FN_INT_INT_INT_SHORT_PTR_INT_INT_INT], BUILD_IN_C3_MULA_AR, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_mul_shr_v_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_mul_shr_v_p", "__builtin_SL1_L_mul_shr_v_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_SHORT_PTR_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_SHORT_PTR_INT_INT_INT], BUILD_IN_C3_MULA_AR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MULA_AR] = decl; }



if ("__builtin_intrinsic_c3_init_ptr") { tree decl; if (strncmp ("__builtin_intrinsic_c3_init_ptr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 548, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c3_init_ptr", builtin_types[BT_FN_PTR_PTR], BUILD_IN_C3_INIT_PTR, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c3_init_ptr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c3_init_ptr", "__builtin_intrinsic_c3_init_ptr" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR], builtin_types[BT_FN_PTR_PTR], BUILD_IN_C3_INIT_PTR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_INIT_PTR] = decl; }



if ("__builtin_SL1_trback") { tree decl; if (strncmp ("__builtin_SL1_trback", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 552, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_trback", builtin_types[BT_FN_VOID_PTR_INT], BUILD_IN_C3_TRBACK, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_trback" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_trback", "__builtin_SL1_trback" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_PTR_INT], builtin_types[BT_FN_VOID_PTR_INT], BUILD_IN_C3_TRBACK, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_TRBACK] = decl; }



if ("__builtin_SL1_viterbi") { tree decl; if (strncmp ("__builtin_SL1_viterbi", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 556, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_viterbi", builtin_types[BT_FN_VOID_PTR_INT], BUILD_IN_C3_VITERBI, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_viterbi" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_viterbi", "__builtin_SL1_viterbi" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_PTR_INT], builtin_types[BT_FN_VOID_PTR_INT], BUILD_IN_C3_VITERBI, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_VITERBI] = decl; }



if ("__builtin_SL1_dmul_shr") { tree decl; if (strncmp ("__builtin_SL1_dmul_shr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 560, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_dmul_shr", builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], BUILD_IN_C3_DMULT, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_dmul_shr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_dmul_shr", "__builtin_SL1_dmul_shr" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], BUILD_IN_C3_DMULT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DMULT] = decl; }



if ("__builtin_SL1_L_dmul_shr_p") { tree decl; if (strncmp ("__builtin_SL1_L_dmul_shr_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 564, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_dmul_shr_p", builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_DMULT_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_dmul_shr_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_dmul_shr_p", "__builtin_SL1_L_dmul_shr_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_DMULT_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DMULT_A] = decl; }



if ("__builtin_SL1_dmuln_shr") { tree decl; if (strncmp ("__builtin_SL1_dmuln_shr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 568, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_dmuln_shr", builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], BUILD_IN_C3_DMULTN, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_dmuln_shr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_dmuln_shr", "__builtin_SL1_dmuln_shr" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], builtin_types[BT_FN_INT_INT_SHORT_SHORT_INT_INT], BUILD_IN_C3_DMULTN, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DMULTN] = decl; }



if ("__builtin_SL1_L_dmuln_shr_p") { tree decl; if (strncmp ("__builtin_SL1_L_dmuln_shr_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 572, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_dmuln_shr_p", builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_DMULTN_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_dmuln_shr_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_dmuln_shr_p", "__builtin_SL1_L_dmuln_shr_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_PTR_INT_PTR_INT_INT_INT], BUILD_IN_C3_DMULTN_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DMULTN_A] = decl; }



if ("__builtin_SL1_set_circularbuf") { tree decl; if (strncmp ("__builtin_SL1_set_circularbuf", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 576, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_set_circularbuf", builtin_types[BT_FN_VOID_PTR_PTR_SHORT_INT_INT], BUILD_IN_SET_CIRCBUF, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_set_circularbuf" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_set_circularbuf", "__builtin_SL1_set_circularbuf" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_PTR_PTR_SHORT_INT_INT], builtin_types[BT_FN_VOID_PTR_PTR_SHORT_INT_INT], BUILD_IN_SET_CIRCBUF, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_SET_CIRCBUF] = decl; }



if ("__builtin_SL1_reset_circularbuf") { tree decl; if (strncmp ("__builtin_SL1_reset_circularbuf", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 580, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_reset_circularbuf", builtin_types[BT_FN_VOID_SHORT], BUILD_IN_RESET_CIRCBUF, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_reset_circularbuf" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_reset_circularbuf", "__builtin_SL1_reset_circularbuf" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_SHORT], builtin_types[BT_FN_VOID_SHORT], BUILD_IN_RESET_CIRCBUF, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_RESET_CIRCBUF] = decl; }



if ("__builtin_SL1_sdadd") { tree decl; if (strncmp ("__builtin_SL1_sdadd", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 584, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_sdadd", builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_DADD, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_sdadd" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_sdadd", "__builtin_SL1_sdadd" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_DADD, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DADD] = decl; }



if ("__builtin_SL1_sdsub") { tree decl; if (strncmp ("__builtin_SL1_sdsub", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 588, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_sdsub", builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_DSUB, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_sdsub" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_sdsub", "__builtin_SL1_sdsub" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT], BUILD_IN_C3_DSUB, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DSUB] = decl; }



if ("__builtin_SL1_fft") { tree decl; if (strncmp ("__builtin_SL1_fft", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 592, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_fft", builtin_types[BT_FN_VOID_PTR_INT], BUILD_IN_C3_FFT, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_fft" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_fft", "__builtin_SL1_fft" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_PTR_INT], builtin_types[BT_FN_VOID_PTR_INT], BUILD_IN_C3_FFT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_FFT] = decl; }



if ("__builtin_SL1_fft_load") { tree decl; if (strncmp ("__builtin_SL1_fft_load", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 596, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_fft_load", builtin_types[BT_FN_INT_PTR_SHORT_SHORT_SHORT], BUILD_IN_C3_FFTLD, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_fft_load" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_fft_load", "__builtin_SL1_fft_load" + strlen ("__builtin_"), builtin_types[BT_FN_INT_PTR_SHORT_SHORT_SHORT], builtin_types[BT_FN_INT_PTR_SHORT_SHORT_SHORT], BUILD_IN_C3_FFTLD, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_FFTLD] = decl; }



if ("__builtin_SL1_fft_store") { tree decl; if (strncmp ("__builtin_SL1_fft_store", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 600, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_fft_store", builtin_types[BT_FN_VOID_INT_PTR_SHORT_SHORT_SHORT], BUILD_IN_C3_FFTST, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_fft_store" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_fft_store", "__builtin_SL1_fft_store" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_PTR_SHORT_SHORT_SHORT], builtin_types[BT_FN_VOID_INT_PTR_SHORT_SHORT_SHORT], BUILD_IN_C3_FFTST, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_FFTST] = decl; }



if ("__builtin_SL1_deposit") { tree decl; if (strncmp ("__builtin_SL1_deposit", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 604, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_deposit", builtin_types[BT_FN_INT_INT_INT_SHORT_SHORT], BUILD_IN_DEPOSIT, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_deposit" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_deposit", "__builtin_SL1_deposit" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_INT_SHORT_SHORT], BUILD_IN_DEPOSIT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_DEPOSIT] = decl; }



if ("__builtin_SL1_extract") { tree decl; if (strncmp ("__builtin_SL1_extract", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 608, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_extract", builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_EXTRACT, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_extract" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_extract", "__builtin_SL1_extract" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_EXTRACT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_EXTRACT] = decl; }



if ("__builtin_SL1_L_bitr") { tree decl; if (strncmp ("__builtin_SL1_L_bitr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 612, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_bitr", builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_C3_BITR, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_bitr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_bitr", "__builtin_SL1_L_bitr" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_C3_BITR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_BITR] = decl; }



if ("__builtin_SL1_L_dmac") { tree decl; if (strncmp ("__builtin_SL1_L_dmac", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 616, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_dmac", builtin_types[BT_FN_INT_INT_SHORT_INT_INT_SHORT], BUILD_IN_C3_DMAC, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_dmac" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_dmac", "__builtin_SL1_L_dmac" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_INT_INT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_INT_INT_SHORT], BUILD_IN_C3_DMAC, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DMAC] = decl; }



if ("__builtin_SL1_L_dmacn") { tree decl; if (strncmp ("__builtin_SL1_L_dmacn", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 620, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_dmacn", builtin_types[BT_FN_INT_INT_SHORT_INT_INT_SHORT], BUILD_IN_C3_DMACN, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_dmacn" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_dmacn", "__builtin_SL1_L_dmacn" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_INT_INT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_INT_INT_SHORT], BUILD_IN_C3_DMACN, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DMACN] = decl; }



if ("__builtin_SL1_load") { tree decl; if (strncmp ("__builtin_SL1_load", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 624, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_load", builtin_types[BT_FN_INT_PTR_SHORT_SHORT_SHORT], BUILD_IN_C3_LOAD, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_load" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_load", "__builtin_SL1_load" + strlen ("__builtin_"), builtin_types[BT_FN_INT_PTR_SHORT_SHORT_SHORT], builtin_types[BT_FN_INT_PTR_SHORT_SHORT_SHORT], BUILD_IN_C3_LOAD, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_LOAD] = decl; }



if ("__builtin_SL1_store") { tree decl; if (strncmp ("__builtin_SL1_store", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 628, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_store", builtin_types[BT_FN_VOID_INT_PTR_SHORT_SHORT_SHORT], BUILD_IN_C3_STORE, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_store" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_store", "__builtin_SL1_store" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_PTR_SHORT_SHORT_SHORT], builtin_types[BT_FN_VOID_INT_PTR_SHORT_SHORT_SHORT], BUILD_IN_C3_STORE, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_STORE] = decl; }



if ("__builtin_SL1_L_revb") { tree decl; if (strncmp ("__builtin_SL1_L_revb", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 632, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_revb", builtin_types[BT_FN_INT_INT_SHORT], BUILD_IN_C3_REVB, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_revb" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_revb", "__builtin_SL1_L_revb" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT], builtin_types[BT_FN_INT_INT_SHORT], BUILD_IN_C3_REVB, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_REVB] = decl; }



if ("__builtin_SL1_dshl_i") { tree decl; if (strncmp ("__builtin_SL1_dshl_i", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 636, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_dshl_i", builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_C3_DSHL_I, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_dshl_i" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_dshl_i", "__builtin_SL1_dshl_i" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_C3_DSHL_I, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DSHL_I] = decl; }



if ("__builtin_SL1_dshr_i") { tree decl; if (strncmp ("__builtin_SL1_dshr_i", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 640, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_dshr_i", builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_C3_DSHR_I, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_dshr_i" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_dshr_i", "__builtin_SL1_dshr_i" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT], BUILD_IN_C3_DSHR_I, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_DSHR_I] = decl; }



if ("__builtin_SL1_L_maci") { tree decl; if (strncmp ("__builtin_SL1_L_maci", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 644, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_maci", builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], BUILD_IN_C3_MAC_I, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_maci" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_maci", "__builtin_SL1_L_maci" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], BUILD_IN_C3_MAC_I, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MAC_I] = decl; }



if ("__builtin_SL1_L_macni") { tree decl; if (strncmp ("__builtin_SL1_L_macni", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 648, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_macni", builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], BUILD_IN_C3_MACN_I, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_macni" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_macni", "__builtin_SL1_L_macni" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT], BUILD_IN_C3_MACN_I, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MACN_I] = decl; }



if ("__builtin_SL1_L_mula_shr_i") { tree decl; if (strncmp ("__builtin_SL1_L_mula_shr_i", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 652, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_mula_shr_i", builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT_SHORT], BUILD_IN_C3_MULA_I, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_mula_shr_i" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_mula_shr_i", "__builtin_SL1_L_mula_shr_i" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT_SHORT], BUILD_IN_C3_MULA_I, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_MULA_I] = decl; }



if ("__builtin_SL1_L_saadd_p") { tree decl; if (strncmp ("__builtin_SL1_L_saadd_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 656, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_saadd_p", builtin_types[BT_FN_INT_PTR_SHORT_PTR_SHORT_SHORT], BUILD_IN_C3_SAADD_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_saadd_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_saadd_p", "__builtin_SL1_L_saadd_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_PTR_SHORT_PTR_SHORT_SHORT], builtin_types[BT_FN_INT_PTR_SHORT_PTR_SHORT_SHORT], BUILD_IN_C3_SAADD_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAADD_A] = decl; }



if ("__builtin_SL1_L_shl_add") { tree decl; if (strncmp ("__builtin_SL1_L_shl_add", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 660, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_shl_add", builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT_SHORT], BUILD_IN_C3_SADDHA, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_shl_add" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_shl_add", "__builtin_SL1_L_shl_add" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_SHORT_SHORT_SHORT], BUILD_IN_C3_SADDHA, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SADDHA] = decl; }



if ("__builtin_SL1_L_shl_add_p") { tree decl; if (strncmp ("__builtin_SL1_L_shl_add_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 664, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_shl_add_p", builtin_types[BT_FN_INT_INT_SHORT_PTR_SHORT_SHORT_SHORT_SHORT], BUILD_IN_C3_SAADDHA_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_shl_add_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_shl_add_p", "__builtin_SL1_L_shl_add_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_SHORT_PTR_SHORT_SHORT_SHORT_SHORT], builtin_types[BT_FN_INT_INT_SHORT_PTR_SHORT_SHORT_SHORT_SHORT], BUILD_IN_C3_SAADDHA_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SAADDHA_A] = decl; }



if ("__builtin_SL1_L_sasub_p") { tree decl; if (strncmp ("__builtin_SL1_L_sasub_p", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 668, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_L_sasub_p", builtin_types[BT_FN_INT_PTR_SHORT_PTR_SHORT_SHORT], BUILD_IN_C3_SASUB_A, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_L_sasub_p" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_L_sasub_p", "__builtin_SL1_L_sasub_p" + strlen ("__builtin_"), builtin_types[BT_FN_INT_PTR_SHORT_PTR_SHORT_SHORT], builtin_types[BT_FN_INT_PTR_SHORT_PTR_SHORT_SHORT], BUILD_IN_C3_SASUB_A, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_C3_SASUB_A] = decl; }



if ("__builtin_SL1_copy_addr") { tree decl; if (strncmp ("__builtin_SL1_copy_addr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 672, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_copy_addr", builtin_types[BT_FN_PTR_PTR], BUILD_IN_COPY_ADDR, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_copy_addr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_copy_addr", "__builtin_SL1_copy_addr" + strlen ("__builtin_"), builtin_types[BT_FN_PTR_PTR], builtin_types[BT_FN_PTR_PTR], BUILD_IN_COPY_ADDR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_COPY_ADDR] = decl; }



if ("__builtin_SL1_set_addr") { tree decl; if (strncmp ("__builtin_SL1_set_addr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 676, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_SL1_set_addr", builtin_types[BT_FN_VOID_PTR_SHORT], BUILD_IN_SET_ADDR, BUILT_IN_NORMAL, (1 ? ("__builtin_SL1_set_addr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_SL1_set_addr", "__builtin_SL1_set_addr" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_PTR_SHORT], builtin_types[BT_FN_VOID_PTR_SHORT], BUILD_IN_SET_ADDR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILD_IN_SET_ADDR] = decl; }




if ("__builtin_intrinsic_c2_mvgr_g2r") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mvgr_g2r", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 681, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mvgr_g2r", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MVGR_G2R, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mvgr_g2r" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mvgr_g2r", "__builtin_intrinsic_c2_mvgr_g2r" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MVGR_G2R, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MVGR_G2R] = decl; }




if ("__builtin_intrinsic_c2_mvgr_r2g") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mvgr_r2g", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 686, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mvgr_r2g", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MVGR_R2G, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mvgr_r2g" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mvgr_r2g", "__builtin_intrinsic_c2_mvgr_r2g" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MVGR_R2G, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MVGR_R2G] = decl; }




if ("__builtin_intrinsic_c2_mvgr_g2s") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mvgr_g2s", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 691, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mvgr_g2s", builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_MVGR_G2S, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mvgr_g2s" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mvgr_g2s", "__builtin_intrinsic_c2_mvgr_g2s" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT], builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_MVGR_G2S, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MVGR_G2S] = decl; }




if ("__builtin_intrinsic_c2_mvgr_s2g") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mvgr_s2g", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 696, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mvgr_s2g", builtin_types[BT_FN_INT_INT], BUILT_IN_C2_MVGR_S2G, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mvgr_s2g" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mvgr_s2g", "__builtin_intrinsic_c2_mvgr_s2g" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT], builtin_types[BT_FN_INT_INT], BUILT_IN_C2_MVGR_S2G, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MVGR_S2G] = decl; }





if ("__builtin_intrinsic_c2_mvgc_c2g") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mvgc_c2g", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 702, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mvgc_c2g", builtin_types[BT_FN_INT_INT], BUILT_IN_C2_MVGC_C2G, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mvgc_c2g" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mvgc_c2g", "__builtin_intrinsic_c2_mvgc_c2g" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT], builtin_types[BT_FN_INT_INT], BUILT_IN_C2_MVGC_C2G, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MVGC_C2G] = decl; }




if ("__builtin_intrinsic_c2_mvgc_g2c") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mvgc_g2c", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 707, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mvgc_g2c", builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_MVGC_G2C, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mvgc_g2c" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mvgc_g2c", "__builtin_intrinsic_c2_mvgc_g2c" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT], builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_MVGC_G2C, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MVGC_G2C] = decl; }





if ("__builtin_intrinsic_c2_ld_v") { tree decl; if (strncmp ("__builtin_intrinsic_c2_ld_v", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 713, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_ld_v", builtin_types[BT_FN_VOID_INT_PTR_INT_INT_INT_INT], BUILT_IN_C2_LD_V, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_ld_v" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_ld_v", "__builtin_intrinsic_c2_ld_v" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_PTR_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_PTR_INT_INT_INT_INT], BUILT_IN_C2_LD_V, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LD_V] = decl; }




if ("__builtin_intrinsic_c2_ld_g") { tree decl; if (strncmp ("__builtin_intrinsic_c2_ld_g", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 718, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_ld_g", builtin_types[BT_FN_INT_PTR_INT_INT_INT], BUILT_IN_C2_LD_G, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_ld_g" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_ld_g", "__builtin_intrinsic_c2_ld_g" + strlen ("__builtin_"), builtin_types[BT_FN_INT_PTR_INT_INT_INT], builtin_types[BT_FN_INT_PTR_INT_INT_INT], BUILT_IN_C2_LD_G, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LD_G] = decl; }




if ("__builtin_intrinsic_c2_ld_s") { tree decl; if (strncmp ("__builtin_intrinsic_c2_ld_s", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 723, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_ld_s", builtin_types[BT_FN_VOID_INT_PTR_INT_INT_INT], BUILT_IN_C2_LD_S, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_ld_s" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_ld_s", "__builtin_intrinsic_c2_ld_s" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_PTR_INT_INT_INT], builtin_types[BT_FN_VOID_INT_PTR_INT_INT_INT], BUILT_IN_C2_LD_S, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LD_S] = decl; }




if ("__builtin_intrinsic_c2_st_v") { tree decl; if (strncmp ("__builtin_intrinsic_c2_st_v", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 728, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_st_v", builtin_types[BT_FN_VOID_INT_PTR_INT_INT], BUILT_IN_C2_ST_V, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_st_v" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_st_v", "__builtin_intrinsic_c2_st_v" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_PTR_INT_INT], builtin_types[BT_FN_VOID_INT_PTR_INT_INT], BUILT_IN_C2_ST_V, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ST_V] = decl; }




if ("__builtin_intrinsic_c2_st_g") { tree decl; if (strncmp ("__builtin_intrinsic_c2_st_g", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 733, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_st_g", builtin_types[BT_FN_VOID_INT_PTR_INT_INT], BUILT_IN_C2_ST_G, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_st_g" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_st_g", "__builtin_intrinsic_c2_st_g" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_PTR_INT_INT], builtin_types[BT_FN_VOID_INT_PTR_INT_INT], BUILT_IN_C2_ST_G, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ST_G] = decl; }




if ("__builtin_intrinsic_c2_ld_g_imm") { tree decl; if (strncmp ("__builtin_intrinsic_c2_ld_g_imm", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 738, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_ld_g_imm", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_LD_G_IMM, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_ld_g_imm" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_ld_g_imm", "__builtin_intrinsic_c2_ld_g_imm" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_LD_G_IMM, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LD_G_IMM] = decl; }




if ("__builtin_intrinsic_c2_ld_c_imm") { tree decl; if (strncmp ("__builtin_intrinsic_c2_ld_c_imm", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 743, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_ld_c_imm", builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_LD_C_IMM, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_ld_c_imm" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_ld_c_imm", "__builtin_intrinsic_c2_ld_c_imm" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT], builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_LD_C_IMM, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LD_C_IMM] = decl; }




if ("__builtin_intrinsic_c2_ld_v_imm") { tree decl; if (strncmp ("__builtin_intrinsic_c2_ld_v_imm", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 748, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_ld_v_imm", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_LD_V_IMM, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_ld_v_imm" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_ld_v_imm", "__builtin_intrinsic_c2_ld_v_imm" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_LD_V_IMM, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LD_V_IMM] = decl; }





if ("__builtin_intrinsic_c2_st_v_imm") { tree decl; if (strncmp ("__builtin_intrinsic_c2_st_v_imm", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 754, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_st_v_imm", builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_ST_V_IMM, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_st_v_imm" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_st_v_imm", "__builtin_intrinsic_c2_st_v_imm" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_ST_V_IMM, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ST_V_IMM] = decl; }




if ("__builtin_intrinsic_c2_st_c_imm") { tree decl; if (strncmp ("__builtin_intrinsic_c2_st_c_imm", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 759, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_st_c_imm", builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_ST_C_IMM, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_st_c_imm" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_st_c_imm", "__builtin_intrinsic_c2_st_c_imm" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT], builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_ST_C_IMM, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ST_C_IMM] = decl; }




if ("__builtin_intrinsic_c2_st_g_imm") { tree decl; if (strncmp ("__builtin_intrinsic_c2_st_g_imm", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 764, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_st_g_imm", builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_ST_G_IMM, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_st_g_imm" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_st_g_imm", "__builtin_intrinsic_c2_st_g_imm" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_ST_G_IMM, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ST_G_IMM] = decl; }




if ("__builtin_intrinsic_c2_vadds") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vadds", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 769, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vadds", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VADDS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vadds" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vadds", "__builtin_intrinsic_c2_vadds" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VADDS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VADDS] = decl; }




if ("__builtin_intrinsic_c2_vsubs") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vsubs", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 774, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vsubs", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VSUBS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vsubs" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vsubs", "__builtin_intrinsic_c2_vsubs" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VSUBS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VSUBS] = decl; }




if ("__builtin_intrinsic_c2_vmul") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vmul", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 779, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vmul", builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_VMUL, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vmul" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vmul", "__builtin_intrinsic_c2_vmul" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_VMUL, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VMUL] = decl; }




if ("__builtin_intrinsic_c2_vneg") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vneg", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 784, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vneg", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VNEG, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vneg" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vneg", "__builtin_intrinsic_c2_vneg" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VNEG, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VNEG] = decl; }




if ("__builtin_intrinsic_c2_vshft") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vshft", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 789, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vshft", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VSHFT, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vshft" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vshft", "__builtin_intrinsic_c2_vshft" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VSHFT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VSHFT] = decl; }




if ("__builtin_intrinsic_c2_vclp") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vclp", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 794, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vclp", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VCLP, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vclp" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vclp", "__builtin_intrinsic_c2_vclp" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VCLP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VCLP] = decl; }




if ("__builtin_intrinsic_c2_vclg") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vclg", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 799, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vclg", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VCLG, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vclg" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vclg", "__builtin_intrinsic_c2_vclg" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VCLG, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VCLG] = decl; }




if ("__builtin_intrinsic_c2_vcmov") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vcmov", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 804, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vcmov", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VCMOV, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vcmov" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vcmov", "__builtin_intrinsic_c2_vcmov" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VCMOV, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VCMOV] = decl; }




if ("__builtin_intrinsic_c2_lczero") { tree decl; if (strncmp ("__builtin_intrinsic_c2_lczero", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 809, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_lczero", builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_LCZERO, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_lczero" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_lczero", "__builtin_intrinsic_c2_lczero" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_LCZERO, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LCZERO] = decl; }




if ("__builtin_intrinsic_c2_vrnd") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vrnd", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 814, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vrnd", builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_VRND, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vrnd" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vrnd", "__builtin_intrinsic_c2_vrnd" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_VRND, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VRND] = decl; }




if ("__builtin_intrinsic_c2_vspas") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vspas", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 819, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vspas", builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_VSPAS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vspas" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vspas", "__builtin_intrinsic_c2_vspas" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT], BUILT_IN_C2_VSPAS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VSPAS] = decl; }




if ("__builtin_intrinsic_c2_vspel") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vspel", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 824, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vspel", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VSPEL, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vspel" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vspel", "__builtin_intrinsic_c2_vspel" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_VSPEL, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VSPEL] = decl; }




if ("__builtin_intrinsic_c2_vspel_mac") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vspel_mac", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 829, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vspel_mac", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VSPEL_MAC, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vspel_mac" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vspel_mac", "__builtin_intrinsic_c2_vspel_mac" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VSPEL_MAC, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VSPEL_MAC] = decl; }
...
if ("__builtin_intrinsic_c2_mmul") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mmul", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 836, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mmul", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MMUL, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mmul" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mmul", "__builtin_intrinsic_c2_mmul" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MMUL, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MMUL] = decl; }




if ("__builtin_intrinsic_c2_vmov") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vmov", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 841, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vmov", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VMOV, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vmov" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vmov", "__builtin_intrinsic_c2_vmov" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VMOV, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VMOV] = decl; }





if ("__builtin_intrinsic_c2_vcopy") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vcopy", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 847, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vcopy", builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_VCOPY, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vcopy" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vcopy", "__builtin_intrinsic_c2_vcopy" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT], builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_VCOPY, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VCOPY] = decl; }





if ("__builtin_intrinsic_c2_vcmpr") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vcmpr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 853, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vcmpr", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VCMPR, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vcmpr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vcmpr", "__builtin_intrinsic_c2_vcmpr" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_VCMPR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VCMPR] = decl; }




if ("__builtin_intrinsic_c2_sad") { tree decl; if (strncmp ("__builtin_intrinsic_c2_sad", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 858, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_sad", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SAD, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_sad" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_sad", "__builtin_intrinsic_c2_sad" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SAD, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SAD] = decl; }




if ("__builtin_intrinsic_c2_sad_tmp") { tree decl; if (strncmp ("__builtin_intrinsic_c2_sad_tmp", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 863, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_sad_tmp", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SAD_TMP, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_sad_tmp" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_sad_tmp", "__builtin_intrinsic_c2_sad_tmp" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SAD_TMP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SAD_TMP] = decl; }





if ("__builtin_intrinsic_c2_satd") { tree decl; if (strncmp ("__builtin_intrinsic_c2_satd", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 869, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_satd", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_SATD, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_satd" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_satd", "__builtin_intrinsic_c2_satd" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_SATD, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SATD] = decl; }





if ("__builtin_intrinsic_c2_intra") { tree decl; if (strncmp ("__builtin_intrinsic_c2_intra", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 875, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_intra", builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_INTRA, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_intra" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_intra", "__builtin_intrinsic_c2_intra" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_INTRA, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_INTRA] = decl; }




if ("__builtin_intrinsic_c2_mvsel") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mvsel", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 880, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mvsel", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_MVSEL, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mvsel" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mvsel", "__builtin_intrinsic_c2_mvsel" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_MVSEL, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MVSEL] = decl; }




if ("__builtin_intrinsic_c2_bcst") { tree decl; if (strncmp ("__builtin_intrinsic_c2_bcst", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 885, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_bcst", builtin_types[BT_FN_INT_INT_INT], BUILT_IN_C2_BCST, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_bcst" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_bcst", "__builtin_intrinsic_c2_bcst" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT], BUILT_IN_C2_BCST, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_BCST] = decl; }




if ("__builtin_intrinsic_c2_vlcs_r") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vlcs_r", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 890, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vlcs_r", builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_VLCS_R, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vlcs_r" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vlcs_r", "__builtin_intrinsic_c2_vlcs_r" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_VLCS_R, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VLCS_R] = decl; }




if ("__builtin_intrinsic_c2_vlcs") { tree decl; if (strncmp ("__builtin_intrinsic_c2_vlcs", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 895, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_vlcs", builtin_types[BT_FN_INT], BUILT_IN_C2_VLCS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_vlcs" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_vlcs", "__builtin_intrinsic_c2_vlcs" + strlen ("__builtin_"), builtin_types[BT_FN_INT], builtin_types[BT_FN_INT], BUILT_IN_C2_VLCS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_VLCS] = decl; }





if ("__builtin_intrinsic_c2_adds") { tree decl; if (strncmp ("__builtin_intrinsic_c2_adds", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 901, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_adds", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_ADDS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_adds" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_adds", "__builtin_intrinsic_c2_adds" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_ADDS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ADDS] = decl; }




if ("__builtin_intrinsic_c2_adds_r") { tree decl; if (strncmp ("__builtin_intrinsic_c2_adds_r", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 906, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_adds_r", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_ADDS_R, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_adds_r" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_adds_r", "__builtin_intrinsic_c2_adds_r" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_ADDS_R, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ADDS_R] = decl; }





if ("__builtin_intrinsic_c2_subs") { tree decl; if (strncmp ("__builtin_intrinsic_c2_subs", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 912, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_subs", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SUBS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_subs" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_subs", "__builtin_intrinsic_c2_subs" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SUBS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SUBS] = decl; }




if ("__builtin_intrinsic_c2_subs_r") { tree decl; if (strncmp ("__builtin_intrinsic_c2_subs_r", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 917, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_subs_r", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SUBS_R, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_subs_r" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_subs_r", "__builtin_intrinsic_c2_subs_r" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SUBS_R, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SUBS_R] = decl; }
...
if ("__builtin_intrinsic_c2_muls") { tree decl; if (strncmp ("__builtin_intrinsic_c2_muls", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 924, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_muls", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MULS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_muls" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_muls", "__builtin_intrinsic_c2_muls" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MULS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MULS] = decl; }





if ("__builtin_intrinsic_c2_mads") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mads", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 930, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mads", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MADS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mads" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mads", "__builtin_intrinsic_c2_mads" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_MADS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MADS] = decl; }




if ("__builtin_intrinsic_c2_smads") { tree decl; if (strncmp ("__builtin_intrinsic_c2_smads", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 935, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_smads", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SMADS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_smads" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_smads", "__builtin_intrinsic_c2_smads" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SMADS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SMADS] = decl; }





if ("__builtin_intrinsic_c2_cmov") { tree decl; if (strncmp ("__builtin_intrinsic_c2_cmov", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 941, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_cmov", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_CMOV, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_cmov" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_cmov", "__builtin_intrinsic_c2_cmov" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_CMOV, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_CMOV] = decl; }




if ("__builtin_intrinsic_c2_mov") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mov", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 946, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mov", builtin_types[BT_FN_INT_INT], BUILT_IN_C2_MOV, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mov" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mov", "__builtin_intrinsic_c2_mov" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT], builtin_types[BT_FN_INT_INT], BUILT_IN_C2_MOV, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MOV] = decl; }




if ("__builtin_intrinsic_c2_mov_r") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mov_r", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 951, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mov_r", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_MOV_R, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mov_r" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mov_r", "__builtin_intrinsic_c2_mov_r" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_MOV_R, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MOV_R] = decl; }




if ("__builtin_intrinsic_c2_clp") { tree decl; if (strncmp ("__builtin_intrinsic_c2_clp", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 956, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_clp", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_CLP, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_clp" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_clp", "__builtin_intrinsic_c2_clp" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_CLP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_CLP] = decl; }




if ("__builtin_intrinsic_c2_chkrng") { tree decl; if (strncmp ("__builtin_intrinsic_c2_chkrng", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 961, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_chkrng", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_CHKRNG, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_chkrng" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_chkrng", "__builtin_intrinsic_c2_chkrng" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_CHKRNG, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_CHKRNG] = decl; }




if ("__builtin_intrinsic_c2_scond") { tree decl; if (strncmp ("__builtin_intrinsic_c2_scond", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 966, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_scond", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_scond" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_scond", "__builtin_intrinsic_c2_scond" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SCOND] = decl; }




if ("__builtin_intrinsic_c2_scond_r_wb") { tree decl; if (strncmp ("__builtin_intrinsic_c2_scond_r_wb", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 971, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_scond_r_wb", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND_R_WB, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_scond_r_wb" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_scond_r_wb", "__builtin_intrinsic_c2_scond_r_wb" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND_R_WB, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SCOND_R_WB] = decl; }




if ("__builtin_intrinsic_c2_scond_r") { tree decl; if (strncmp ("__builtin_intrinsic_c2_scond_r", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 976, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_scond_r", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND_R, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_scond_r" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_scond_r", "__builtin_intrinsic_c2_scond_r" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND_R, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SCOND_R] = decl; }





if ("__builtin_intrinsic_c2_scond_br") { tree decl; if (strncmp ("__builtin_intrinsic_c2_scond_br", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 982, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_scond_br", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND_BR, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_scond_br" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_scond_br", "__builtin_intrinsic_c2_scond_br" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND_BR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SCOND_BR] = decl; }




if ("__builtin_intrinsic_c2_scond_br_r") { tree decl; if (strncmp ("__builtin_intrinsic_c2_scond_br_r", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 987, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_scond_br_r", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND_BR_R, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_scond_br_r" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_scond_br_r", "__builtin_intrinsic_c2_scond_br_r" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_SCOND_BR_R, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SCOND_BR_R] = decl; }





if ("__builtin_intrinsic_c2_bop") { tree decl; if (strncmp ("__builtin_intrinsic_c2_bop", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 993, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_bop", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_BOP, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_bop" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_bop", "__builtin_intrinsic_c2_bop" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_BOP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_BOP] = decl; }




if ("__builtin_intrinsic_c2_bdep") { tree decl; if (strncmp ("__builtin_intrinsic_c2_bdep", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 998, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_bdep", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_BDEP, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_bdep" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_bdep", "__builtin_intrinsic_c2_bdep" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_BDEP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_BDEP] = decl; }




if ("__builtin_intrinsic_c2_wrap") { tree decl; if (strncmp ("__builtin_intrinsic_c2_wrap", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1003, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_wrap", builtin_types[BT_FN_INT_INT_INT], BUILT_IN_C2_WRAP, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_wrap" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_wrap", "__builtin_intrinsic_c2_wrap" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT], BUILT_IN_C2_WRAP, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_WRAP] = decl; }




if ("__builtin_intrinsic_c2_bxtr") { tree decl; if (strncmp ("__builtin_intrinsic_c2_bxtr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1008, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_bxtr", builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_BXTR, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_bxtr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_bxtr", "__builtin_intrinsic_c2_bxtr" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT_INT], BUILT_IN_C2_BXTR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_BXTR] = decl; }




if ("__builtin_intrinsic_c2_sum4") { tree decl; if (strncmp ("__builtin_intrinsic_c2_sum4", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1013, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_sum4", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SUM4, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_sum4" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_sum4", "__builtin_intrinsic_c2_sum4" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SUM4, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SUM4] = decl; }




if ("__builtin_intrinsic_c2_sum3_saddr") { tree decl; if (strncmp ("__builtin_intrinsic_c2_sum3_saddr", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1018, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_sum3_saddr", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SUM3_SADDR, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_sum3_saddr" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_sum3_saddr", "__builtin_intrinsic_c2_sum3_saddr" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_SUM3_SADDR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SUM3_SADDR] = decl; }





if ("__builtin_intrinsic_c2_sum4_r") { tree decl; if (strncmp ("__builtin_intrinsic_c2_sum4_r", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1024, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_sum4_r", builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_SUM4_R, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_sum4_r" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_sum4_r", "__builtin_intrinsic_c2_sum4_r" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT_INT_INT], BUILT_IN_C2_SUM4_R, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_SUM4_R] = decl; }




if ("__builtin_intrinsic_c2_med") { tree decl; if (strncmp ("__builtin_intrinsic_c2_med", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1029, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_med", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_MED, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_med" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_med", "__builtin_intrinsic_c2_med" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_MED, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MED] = decl; }




if ("__builtin_intrinsic_c2_gsums") { tree decl; if (strncmp ("__builtin_intrinsic_c2_gsums", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1034, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_gsums", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_GSUMS, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_gsums" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_gsums", "__builtin_intrinsic_c2_gsums" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_GSUMS, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_GSUMS] = decl; }




if ("__builtin_intrinsic_c2_clzob") { tree decl; if (strncmp ("__builtin_intrinsic_c2_clzob", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1039, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_clzob", builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_CLZOB, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_clzob" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_clzob", "__builtin_intrinsic_c2_clzob" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT_INT], BUILT_IN_C2_CLZOB, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_CLZOB] = decl; }




if ("__builtin_intrinsic_c2_thctrl") { tree decl; if (strncmp ("__builtin_intrinsic_c2_thctrl", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1044, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_thctrl", builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_THCTRL, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_thctrl" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_thctrl", "__builtin_intrinsic_c2_thctrl" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT], builtin_types[BT_FN_VOID_INT_INT], BUILT_IN_C2_THCTRL, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_THCTRL] = decl; }




if ("__builtin_intrinsic_c2_br_f") { tree decl; if (strncmp ("__builtin_intrinsic_c2_br_f", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1049, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_br_f", builtin_types[BT_FN_VOID_INT], BUILT_IN_C2_BR_F, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_br_f" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_br_f", "__builtin_intrinsic_c2_br_f" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT], builtin_types[BT_FN_VOID_INT], BUILT_IN_C2_BR_F, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_BR_F] = decl; }




if ("__builtin_intrinsic_c2_br_t") { tree decl; if (strncmp ("__builtin_intrinsic_c2_br_t", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1054, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_br_t", builtin_types[BT_FN_VOID_INT], BUILT_IN_C2_BR_T, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_br_t" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_br_t", "__builtin_intrinsic_c2_br_t" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT], builtin_types[BT_FN_VOID_INT], BUILT_IN_C2_BR_T, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_BR_T] = decl; }





if ("__builtin_intrinsic_c2_ld_v2g") { tree decl; if (strncmp ("__builtin_intrinsic_c2_ld_v2g", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1060, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_ld_v2g", builtin_types[BT_FN_INT_PTR_INT_INT], BUILT_IN_C2_LD_V2G, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_ld_v2g" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_ld_v2g", "__builtin_intrinsic_c2_ld_v2g" + strlen ("__builtin_"), builtin_types[BT_FN_INT_PTR_INT_INT], builtin_types[BT_FN_INT_PTR_INT_INT], BUILT_IN_C2_LD_V2G, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LD_V2G] = decl; }




if ("__builtin_intrinsic_c2_ld_v2g_imm") { tree decl; if (strncmp ("__builtin_intrinsic_c2_ld_v2g_imm", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1065, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_ld_v2g_imm", builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_LD_V2G_IMM, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_ld_v2g_imm" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_ld_v2g_imm", "__builtin_intrinsic_c2_ld_v2g_imm" + strlen ("__builtin_"), builtin_types[BT_FN_INT_INT_INT_INT], builtin_types[BT_FN_INT_INT_INT_INT], BUILT_IN_C2_LD_V2G_IMM, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_LD_V2G_IMM] = decl; }




if ("__builtin_intrinsic_c2_st_g2v") { tree decl; if (strncmp ("__builtin_intrinsic_c2_st_g2v", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1070, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_st_g2v", builtin_types[BT_FN_VOID_INT_PTR_INT], BUILT_IN_C2_ST_G2V, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_st_g2v" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_st_g2v", "__builtin_intrinsic_c2_st_g2v" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_PTR_INT], builtin_types[BT_FN_VOID_INT_PTR_INT], BUILT_IN_C2_ST_G2V, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ST_G2V] = decl; }




if ("__builtin_intrinsic_c2_st_g2v_imm") { tree decl; if (strncmp ("__builtin_intrinsic_c2_st_g2v_imm", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1075, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_st_g2v_imm", builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_ST_G2V_IMM, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_st_g2v_imm" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_st_g2v_imm", "__builtin_intrinsic_c2_st_g2v_imm" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_ST_G2V_IMM, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_ST_G2V_IMM] = decl; }




if ("__builtin_intrinsic_c2_mvgr_r2s") { tree decl; if (strncmp ("__builtin_intrinsic_c2_mvgr_r2s", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1080, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_mvgr_r2s", builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_MVGR_R2S, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_mvgr_r2s" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_mvgr_r2s", "__builtin_intrinsic_c2_mvgr_r2s" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT_INT_INT], builtin_types[BT_FN_VOID_INT_INT_INT], BUILT_IN_C2_MVGR_R2S, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_MVGR_R2S] = decl; }




if ("__builtin_intrinsic_c2_fork") { tree decl; if (strncmp ("__builtin_intrinsic_c2_fork", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1085, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_fork", builtin_types[BT_FN_VOID_INT], BUILT_IN_C2_FORK, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_fork" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_fork", "__builtin_intrinsic_c2_fork" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT], builtin_types[BT_FN_VOID_INT], BUILT_IN_C2_FORK, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_FORK] = decl; }




if ("__builtin_intrinsic_c2_joint") { tree decl; if (strncmp ("__builtin_intrinsic_c2_joint", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1090, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_joint", builtin_types[BT_FN_VOID], BUILT_IN_C2_JOINT, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_joint" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_joint", "__builtin_intrinsic_c2_joint" + strlen ("__builtin_"), builtin_types[BT_FN_VOID], builtin_types[BT_FN_VOID], BUILT_IN_C2_JOINT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_JOINT] = decl; }




if ("__builtin_intrinsic_c2_thread_major") { tree decl; if (strncmp ("__builtin_intrinsic_c2_thread_major", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1095, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_thread_major", builtin_types[BT_FN_INT], BUILT_IN_C2_THREAD_MAJOR, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_thread_major" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_thread_major", "__builtin_intrinsic_c2_thread_major" + strlen ("__builtin_"), builtin_types[BT_FN_INT], builtin_types[BT_FN_INT], BUILT_IN_C2_THREAD_MAJOR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_THREAD_MAJOR] = decl; }




if ("__builtin_intrinsic_c2_thread_minor") { tree decl; if (strncmp ("__builtin_intrinsic_c2_thread_minor", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1100, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_intrinsic_c2_thread_minor", builtin_types[BT_FN_INT], BUILT_IN_C2_THREAD_MINOR, BUILT_IN_NORMAL, (1 ? ("__builtin_intrinsic_c2_thread_minor" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin_intrinsic_c2_thread_minor", "__builtin_intrinsic_c2_thread_minor" + strlen ("__builtin_"), builtin_types[BT_FN_INT], builtin_types[BT_FN_INT], BUILT_IN_C2_THREAD_MINOR, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) ATTR_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN_C2_THREAD_MINOR] = decl; }
# 1146 "../../../kgccfe/gnu/builtins.def"
if ("__builtin_sqrt") { tree decl; if (strncmp ("__builtin_sqrt", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1152, __FUNCTION__); if (!1) decl = builtin_function ("__builtin_sqrt", builtin_types[BT_FN_DOUBLE_DOUBLE], BUILT_IN_SQRT, BUILT_IN_NORMAL, (1 ? ("__builtin_sqrt" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) flag_errno_math ? ATTR_NOTHROW_LIST : (flag_unsafe_math_optimizations ? ATTR_CONST_NOTHROW_LIST : ATTR_PURE_NOTHROW_LIST)]); else decl = builtin_function_2 ("__builtin_sqrt", "__builtin_sqrt" + strlen ("__builtin_"), builtin_types[BT_FN_DOUBLE_DOUBLE], builtin_types[BT_FN_DOUBLE_DOUBLE], BUILT_IN_SQRT, BUILT_IN_NORMAL, 1, 0, built_in_attributes[(int) flag_errno_math ? ATTR_NOTHROW_LIST : (flag_unsafe_math_optimizations ? ATTR_CONST_NOTHROW_LIST : ATTR_PURE_NOTHROW_LIST)]); built_in_decls[(int) BUILT_IN_SQRT] = decl; }
...
if ("__builtin__Exit") { tree decl; if (strncmp ("__builtin__Exit", "__builtin_", strlen ("__builtin_")) != 0) fancy_abort ("../../../kgccfe/gnu/builtins.def", 1621, __FUNCTION__); if (!1) decl = builtin_function ("__builtin__Exit", builtin_types[BT_FN_VOID_INT], BUILT_IN__EXIT2, NOT_BUILT_IN, (0 ? ("__builtin__Exit" + strlen ("__builtin_")) : ((void *)0)), built_in_attributes[(int) ATTR_NORETURN_NOTHROW_LIST]); else decl = builtin_function_2 ("__builtin__Exit", "__builtin__Exit" + strlen ("__builtin_"), builtin_types[BT_FN_VOID_INT], builtin_types[BT_FN_VOID_INT], BUILT_IN__EXIT2, NOT_BUILT_IN, 0, !flag_isoc99, built_in_attributes[(int) ATTR_NORETURN_NOTHROW_LIST]); built_in_decls[(int) BUILT_IN__EXIT2] = decl; }
# 3756 "../../../kgccfe/gnu/c-common.c" 2
     ...
     int modifier;
{
 ...
 if (((enum tree_code) (((exp)->exp.operands[0]))->common.code) == ADDR_EXPR
  ...
  == BUILT_IN_FRONTEND))
   ...
   fancy_abort ("../../../kgccfe/gnu/c-common.c", 4507, __FUNCTION__);
      }
      break;
 ...
 return expand_expr (decl, target, tmode, modifier);
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/c-common.c", 4521, __FUNCTION__);
    }

  fancy_abort ("../../../kgccfe/gnu/c-common.c", 4524, __FUNCTION__);
  return ((void *)0);
}
     ...
     tree arg;
{
  ...
  switch (code)
    ...
    case POSTDECREMENT_EXPR:
      ...
      break;
    default:
      fancy_abort ("../../../kgccfe/gnu/c-common.c", 4909, __FUNCTION__);
    }
...
# 5016 "../../../kgccfe/gnu/c-common.c"
  max_10_exp = fmt->emax * log10_b;
  sprintf (name, "__%s_MAX_10_EXP__", name_prefix);
  builtin_define_with_int_value (name, max_10_exp);
# 5029 "../../../kgccfe/gnu/c-common.c"
  {
     ...
     int is_long;
{
 ...
 "340282366920938463463374607431768211455" };
  ...
  switch (((type)->type.precision))
    ...
    default: fancy_abort ("../../../kgccfe/gnu/c-common.c", 5348, __FUNCTION__);
    }
  ...
  if (((enum tree_code) (*node)->common.code) == FUNCTION_DECL)
    {
      ...
      ((*node)->decl.always_inline_attrib) = 1;
...
# 6428 "../../../kgccfe/gnu/c-common.c"
 ...
 fancy_abort ("../../../kgccfe/gnu/c-common.c", 6479, __FUNCTION__);
     ...
     unsigned long long param_num;
{
  ...
  for (; args; args = ((args)->common.chain))
    {
      if (! get_nonnull_operand (((args)->list.value), &arg_num))
        fancy_abort ("../../../kgccfe/gnu/c-common.c", 6814, __FUNCTION__);
     ...
     unsigned long long param_num;
{
 ...
 if (is_attribute_p ("format_arg", ((attrs)->list.purpose)))
  ...
  || (((format_num_expr)->int_cst.int_cst).high) != 0)
       fancy_abort ("../../../kgccfe/gnu/c-common.c", 6956, __FUNCTION__);
...
# 1 "../../../kgccfe/gnu/MIPS/gt-c-common.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-c-common.h"
