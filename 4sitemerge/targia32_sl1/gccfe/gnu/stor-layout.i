...
static unsigned int update_alignment_for_field
                                        (record_layout_info, tree, unsigned int);
...
get_pending_sizes ()
{
  ...
  for (t = chain; t; t = ((t)->common.chain))
    (((((t)->list.value)))->exp.operands[1]) = current_function_decl;
     ...
     tree expr;
{
  ...
  for (t = pending_sizes; t; t = ((t)->common.chain))
    if (((t)->list.value) == expr)
      return 1;
  return 0;
}
     ...
     tree expr;
{
  ...
  while (tree_code_type[(int) (((enum tree_code) (expr)->common.code))] == '1'
  || (tree_code_type[(int) (((enum tree_code) (expr)->common.code))] == '2'
     && ((((expr)->exp.operands[1]))->common.constant_flag)))
    expr = ((expr)->exp.operands[0]);

  if (((enum tree_code) (expr)->common.code) == SAVE_EXPR)
    pending_sizes = tree_cons ((tree) ((void *)0), expr, pending_sizes);
}
...
{
  if (pending_sizes)
    fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 154, __FUNCTION__);
     ...
     tree size;
{
  ...
  size = save_expr (size);
# 185 "../../../kgccfe/gnu/stor-layout.c"
  if (((enum tree_code) (size)->common.code) == SAVE_EXPR)
    (((size))->common.asm_written_flag) = 1;
 ...
 error ("variable-size type declared outside of any function");
  ...
  if (immediate_size_expand)
    ...
    expand_expr (size, expand_expr (global_trees[TI_INTEGER_ZERO], (rtx) 0, VOIDmode, 0),
   VOIDmode, 0);
     ...
     int limit;
{
  ...
  if (limit && size > (mips_abi == 1 || mips_abi == 2 ? 128 : 64))
    return BLKmode;


  for (mode = class_narrowest_mode[(int) (class)]; mode != VOIDmode;
       mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
    if ((mode_bitsize[(int) (mode)]) == size)
      return mode;
     ...
     int limit;
{
  if (((enum tree_code) (size)->common.code) != INTEGER_CST
    ...
    return mode_for_size ((((size)->int_cst.int_cst).low), class, limit);
}
     ...
     enum mode_class class;
{
  ...
  fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 277, __FUNCTION__);
}
     ...
     enum machine_mode mode;
{
  switch ((mode_class[(int) (mode)]))
    ...
    case MODE_VECTOR_FLOAT:
      mode = mode_for_size ((mode_bitsize[(int) (mode)]), MODE_INT, 0);
      break;
 ...
 break;
    ...
    case MODE_CC:
    default:
      fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 308, __FUNCTION__);
    }
     ...
     enum machine_mode mode;
{
  ...
  if ((mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT
      || (mode_class[(int) (mode)]) == MODE_COMPLEX_INT)
    alignment = (mode_unit_size[(int) (mode)]);
  else
    alignment = (mode_size[(int) (mode)]);


  alignment = alignment & -alignment;
  alignment *= 8;

  alignment = (((mips_abi == 1 || mips_abi == 2 ? 128 : 64)) < (((1) > (alignment) ? (1) : (alignment))) ? ((mips_abi == 1 || mips_abi == 2 ? 128 : 64)) : (((1) > (alignment) ? (1) : (alignment))));
  return alignment;
}
...
round_up (value, divisor)
     ...
     int divisor;
{
  tree arg = size_int_type_wide ((long long) (divisor), ((value)->common.type));
     ...
     unsigned int known_align;
{
  ...
  if (code == CONST_DECL)
    ...
    fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 388, __FUNCTION__);
...
# 405 "../../../kgccfe/gnu/stor-layout.c"
  ...
  if (! (code == FIELD_DECL && ((decl)->decl.bit_field_flag))
      && (((decl)->decl.u1.a.align) == 0
   || (! (code == FIELD_DECL && ((decl)->decl.regdecl_flag))
       && ((type)->type.align) > ((decl)->decl.u1.a.align))))
    {
  ...
  if (code == FIELD_DECL)
    {
      ((decl)->decl.result) = ((decl)->decl.bit_field_flag) ? type : 0;
 ...
 ((decl)->decl.u1.a.align) = ((((decl)->decl.u1.a.align)) < (maximum_field_alignment) ? (((decl)->decl.u1.a.align)) : (maximum_field_alignment));
      ...
      else if (((decl)->decl.regdecl_flag)
     ...
     || ((enum tree_code) (((decl)->decl.size_unit))->common.code) == INTEGER_CST))
 {
  ...
  if (code == FIELD_DECL && ((decl)->decl.bit_field_flag)
      ...
      && (mode_class[(int) (((type)->type.mode))]) == MODE_INT)
    {
      ...
      if (xmode != BLKmode && known_align >= get_mode_alignment (xmode))
 {
  ...
  if (code == FIELD_DECL && ((decl)->decl.bit_field_flag)
      && ((type)->type.mode) == BLKmode && ((decl)->decl.mode) == BLKmode
 ...
 {
   unsigned int size_as_int = (((size)->int_cst.int_cst).low);
  ...
  if (rtl)
    {
      ((rtl)->mode = (enum machine_mode) (((decl)->decl.mode)));
      ((decl)->decl.rtl = (0));
...
assign_field_ids (tree rec)
{
  ...
  if (((rec)->type.field_ids_used) > 0)
    return;
  next_field_id = 1;
  for (field = ((rec)->type.values); field; field = ((field)->common.chain))
    {
      ((field)->decl.sgi_u1.field_id) = next_field_id;
      fields_in_field = ((((field)->common.type))->type.field_ids_used);
   ...
   (((enum tree_code) (((field)->common.type))->common.code) == RECORD_TYPE ||
    ...
    ((enum tree_code) (((field)->common.type))->common.code) == QUAL_UNION_TYPE)) {
   assign_field_ids(((field)->common.type));
          fields_in_field = ((((field)->common.type))->type.field_ids_used);
 }
      next_field_id += fields_in_field + 1;
    }

  ((rec)->type.field_ids_used) = next_field_id - 1;
}
# 567 "../../../kgccfe/gnu/stor-layout.c"
record_layout_info
     ...
     tree t;
{
  ...
  rli->offset_align = ((rli->record_align) > ((mips_abi == 1 || mips_abi == 2 ? 128 : 64)) ? (rli->record_align) : ((mips_abi == 1 || mips_abi == 2 ? 128 : 64)));



  if (! ((t)->type.packed_flag))
    rli->record_align = ((rli->record_align) > (8) ? (rli->record_align) : (8));
  ...
  *poffset
    ...
    convert (sizetype_tab[(int) SIZETYPE],
      size_binop (FLOOR_DIV_EXPR, pos,
           size_int_wide ((long long) (off_align / 8), BITSIZETYPE))),

    size_int_wide ((long long) (off_align / 8), SIZETYPE));
     ...
     tree pos;
{
  *poffset = size_binop (MULT_EXPR,
    convert (sizetype_tab[(int) SIZETYPE],
      size_binop (FLOOR_DIV_EXPR, pos,
           size_int_wide ((long long) (off_align), BITSIZETYPE))),
    size_int_wide ((long long) (off_align / 8), SIZETYPE));
  *pbitpos = size_binop (FLOOR_MOD_EXPR, pos, size_int_wide ((long long) (off_align), BITSIZETYPE));
}
     ...
     unsigned int off_align;
{
 ...
 = size_binop (PLUS_EXPR, *poffset,
      ...
      *pbitpos
 = size_binop (FLOOR_MOD_EXPR, *pbitpos, size_int_wide ((long long) (off_align), BITSIZETYPE));
    }
}
...
# 776 "../../../kgccfe/gnu/stor-layout.c"
       ...
       && ! integer_zerop (((rli->prev_field)->decl.size))))
 {
   ...
   rli->unpadded_align = ((rli->unpadded_align) > (((field)->decl.u1.a.align)) ? (rli->unpadded_align) : (((field)->decl.u1.a.align)));
 }
      else
 desired_align = 1;
    }
  ...
  if (1 && type != global_trees[TI_ERROR_MARK]
 ...
 rli->record_align = ((rli->record_align) > (desired_align) ? (rli->record_align) : (desired_align));
      else if (! ((field)->decl.regdecl_flag) && !user_align)
 desired_align = ((type)->type.align);
      ...
      if (((field)->decl.name) != 0)
 {
  ...
  ((field)->decl.u1.a.align) = desired_align;
     ...
     tree field;
{
  ...
  ((field)->decl.u1.a.off_align = exact_log2_wide ((unsigned long long) (((mips_abi == 1 || mips_abi == 2 ? 128 : 64)) & -((mips_abi == 1 || mips_abi == 2 ? 128 : 64)))));
     ...
     tree field;
{
  ...
  if (((enum tree_code) (field)->common.code) == VAR_DECL)
    {
      rli->pending_statics = tree_cons ((tree) ((void *)0), field,
     rli->pending_statics);
      return;
    }
  ...
  if (! integer_zerop (rli->bitpos))
    ...
    known_align = (mips_abi == 1 || mips_abi == 2 ? 128 : 64);
 ...
 rli->offset_align = desired_align;
  ...
  if (1
      ...
      && host_integerp (((type)->type.size), 1))
    {
      ...
      long long field_size = tree_low_cst (dsize, 1);
      long long offset = tree_low_cst (rli->offset, 0);
      long long bit_offset = tree_low_cst (rli->bitpos, 0);
# 1019 "../../../kgccfe/gnu/stor-layout.c"
      if ((((offset * 8 + bit_offset + field_size +
      type_align - 1)
     / type_align)
    - (offset * 8 + bit_offset) / type_align)
   > tree_low_cst (((type)->type.size), 1) / type_align)
 rli->bitpos = round_up (rli->bitpos, type_align);

      ((rli->t)->type.user_align) |= ((type)->type.user_align);
    }
# 1087 "../../../kgccfe/gnu/stor-layout.c"
  if ((* targetm.ms_bitfield_layout_p) (rli->t)
      ...
      if (rli->prev_field )
 {
   ...
   if (((field)->decl.result)
     ...
     ((((rli->prev_field)->common.type))->type.size)) )
     {
       ...
       int bitsize = (((((field)->decl.size))->int_cst.int_cst).low);
       ...
       if (rli->remaining_in_alignment < bitsize)
  {
    ...
    rli->remaining_in_alignment = (((type_size)->int_cst.int_cst).low);
  }
       rli->remaining_in_alignment -= bitsize;
     }
   else
     {
# 1140 "../../../kgccfe/gnu/stor-layout.c"
...
# 1177 "../../../kgccfe/gnu/stor-layout.c"
        ...
        : !integer_zerop (((field)->decl.size)) ))
 {
   ...
   if (((field)->decl.size) != ((void *)0))
    ...
    = (((((((field)->common.type))->type.size))->int_cst.int_cst).low)
      - (((((field)->decl.size))->int_cst.int_cst).low);
  ...
  ((field)->decl.u1.a.off_align = exact_log2_wide ((unsigned long long) ((rli->offset_align) & -(rli->offset_align))));
  ...
  if (! integer_zerop (((field)->decl.u2.t)))
    ...
    actual_align = (mips_abi == 1 || mips_abi == 2 ? 128 : 64);
  else if (host_integerp (((field)->decl.arguments), 1))
    actual_align = (8
     * (tree_low_cst (((field)->decl.arguments), 1)
        & - tree_low_cst (((field)->decl.arguments), 1)));
  else
    actual_align = (((unsigned long long)1) << (field)->decl.u1.a.off_align);
...
# 1253 "../../../kgccfe/gnu/stor-layout.c"
 ...
 = size_binop (PLUS_EXPR, rli->offset, ((field)->decl.size_unit));
      rli->bitpos = global_trees[TI_BITSIZE_ZERO];
      rli->offset_align = ((rli->offset_align) < (((field)->decl.u1.a.align)) ? (rli->offset_align) : (((field)->decl.u1.a.align)));
    }
  else
    {
     ...
     record_layout_info rli;
{
  ...
  if (((rli->t)->type.binfo) && ((((rli->t)->type.binfo))->vec.length) > 6)
    {
      ((((rli->t)->type.binfo))->vec.a[6]) = unpadded_size;
      ((((rli->t)->type.binfo))->vec.a[7]) = unpadded_size_unit;
    }
# 1323 "../../../kgccfe/gnu/stor-layout.c"
      ...
      if (simple_cst_equal (unpacked_size, ((rli->t)->type.size)))
 {
  ...
  name = ((char *)(((rli->t)->type.name))->identifier.id.str);
       else
  name = ((char *)(((((rli->t)->type.name))->decl.name))->identifier.id.str);
     ...
     tree type;
{
 ...
 return;
      ...
      if (bitpos / (8 * ((target_flags & 0x00002000) ? 8 : 4))
   != ((tree_low_cst (((field)->decl.size), 1) + bitpos - 1)
       / (8 * ((target_flags & 0x00002000) ? 8 : 4)))

   && tree_low_cst (((field)->decl.size), 1) % (8 * ((target_flags & 0x00002000) ? 8 : 4)) != 0)
 return;
...
# 1441 "../../../kgccfe/gnu/stor-layout.c"
  ...
  if (((type)->type.mode) != BLKmode
      && 1
      && ! (((type)->type.align) >= (mips_abi == 1 || mips_abi == 2 ? 128 : 64)
     ...
     int free_p;
{
  ...
  if( rli->t && ((rli->t)->type.ty_idx) != 0 ) {
    int itemp = 0;
    itemp = log2( ((rli->t)->type.align) >> 3 );
    ((rli->t)->type.ty_idx) = ( ((rli->t)->type.ty_idx) & ~0x1f ) | itemp;
  }
  ...
  while (rli->pending_statics)
    {
      layout_decl (((rli->pending_statics)->list.value), 0);
...
# 1603 "../../../kgccfe/gnu/stor-layout.c"
void
layout_type (type)
     tree type;
{
  if (type == 0)
    fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 1608, __FUNCTION__);
  ...
  switch (((enum tree_code) (type)->common.code))
    ...
    case LANG_TYPE:
      ...
      fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 1619, __FUNCTION__);
 ...
 ((type)->common.unsigned_flag) = 1;
      ...
      ((type)->type.mode) = smallest_mode_for_size (((type)->type.precision),
       MODE_INT);
      ((type)->type.size) = size_int_wide ((long long) ((mode_bitsize[(int) (((type)->type.mode))])), BITSIZETYPE);
      ((type)->type.size_unit) = size_int_wide ((long long) ((mode_size[(int) (((type)->type.mode))])), SIZETYPE);
      break;
 ...
 ((type)->common.unsigned_flag) = ((subtype)->common.unsigned_flag);
 ((type)->type.size) = size_int_wide ((long long) ((mode_bitsize[(int) (((type)->type.mode))])), BITSIZETYPE);
 ((type)->type.size_unit) = size_int_wide ((long long) ((mode_size[(int) (((type)->type.mode))])), SIZETYPE);
      }
      break;
    ...
    case OFFSET_TYPE:
      ((type)->type.size) = size_int_wide ((long long) (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32)), BITSIZETYPE);
      ((type)->type.size_unit) = size_int_wide ((long long) (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32) / 8), SIZETYPE);


      ((type)->type.mode) = mode_for_size (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32), MODE_INT, 0);
      break;

    case FUNCTION_TYPE:
    case METHOD_TYPE:
      ((type)->type.mode) = mode_for_size (2 * ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32), MODE_INT, 0);
      ((type)->type.size) = size_int_wide ((long long) (2 * ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32)), BITSIZETYPE);
      ((type)->type.size_unit) = size_int_wide ((long long) ((2 * ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32)) / 8), SIZETYPE);
      break;

    case POINTER_TYPE:
    case REFERENCE_TYPE:
      {
 int nbits = ((((enum tree_code) (type)->common.code) == REFERENCE_TYPE
        && reference_types_internal)
       ? (mode_bitsize[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]) : ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32));

 ((type)->type.mode) = nbits == ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 64 : 32) ? ptr_mode : (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode);
 ((type)->type.size) = size_int_wide ((long long) (nbits), BITSIZETYPE);
 ((type)->type.size_unit) = size_int_wide ((long long) (nbits / 8), SIZETYPE);
 ((type)->common.unsigned_flag) = 1;
...
# 1788 "../../../kgccfe/gnu/stor-layout.c"
 ...
 if (((type)->type.size) != 0
  ...
  = mode_for_size_tree (((type)->type.size), MODE_INT, 1);
     ...
     if (((type)->type.mode) != BLKmode
  && 1 && ((type)->type.align) < (mips_abi == 1 || mips_abi == 2 ? 128 : 64)
  && ((type)->type.align) < get_mode_alignment (((type)->type.mode))
  && ((type)->type.mode) != BLKmode)
       {
  ((type)->type.no_force_blk_flag) = 1;
 ...
 if (((enum tree_code) (type)->common.code) == QUAL_UNION_TYPE)
   ((type)->type.values) = nreverse (((type)->type.values));
 ...
 finish_record_layout (rli, 1);
    ...
    case SET_TYPE:
      if (((enum tree_code) (((((type)->type.values))->type.maxval))->common.code) != INTEGER_CST
   || ((enum tree_code) (((((type)->type.values))->type.minval))->common.code) != INTEGER_CST)
 fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 1855, __FUNCTION__);
      else
 {
   ...
   unsigned int alignment
     = set_alignment ? set_alignment : (8 * ((target_flags & 0x00002000) ? 8 : 4));
   int size_in_bits
     = ((((((((type)->type.values))->type.maxval))->int_cst.int_cst).low)
        - (((((((type)->type.values))->type.minval))->int_cst.int_cst).low) + 1);
   int rounded_size
   ...
   ((type)->type.size) = size_int_wide ((long long) (rounded_size), BITSIZETYPE);
   ((type)->type.size_unit) = size_int_wide ((long long) (rounded_size / 8), SIZETYPE);
   ...
   ((type)->type.precision) = size_in_bits;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 1891, __FUNCTION__);
    }
  ...
  if (! sizetype_set)
    early_type_list = tree_cons ((tree) ((void *)0), type, early_type_list);
...
initialize_sizetypes ()
{
  ...
  ((t)->type.user_align) = 0;
  ((t)->type.size) = build_int_2_wide ((unsigned long long) ((mode_bitsize[(int) (SImode)])), (long long) (0));
  ((t)->type.size_unit) = build_int_2_wide ((unsigned long long) ((mode_size[(int) (SImode)])), (long long) (0));
  ((t)->common.unsigned_flag) = 1;
  ((t)->type.precision) = (mode_bitsize[(int) (SImode)]);
  ((t)->type.minval) = build_int_2_wide ((unsigned long long) (0), (long long) (0));
  ((t)->type.no_force_blk_flag) = 1;



  ((t)->type.maxval) = build_int_2_wide ((unsigned long long) (1000), (long long) (0));



  sizetype_tab[(int) SIZETYPE] = t;
  sizetype_tab[(int) BITSIZETYPE] = copy_node (t);
     ...
     tree type;
{
  ...
  int precision = ((oprecision + ((8 > 1) + (8 > 2) + (8 > 4) + (8 > 8) + (8 > 16) + (8 > 32) + (8 > 64) + (8 > 128) + (8 > 256)) + 1) < (2 * (8 * 8)) ? (oprecision + ((8 > 1) + (8 > 2) + (8 > 4) + (8 > 8) + (8 > 16) + (8 > 32) + (8 > 64) + (8 > 128) + (8 > 256)) + 1) : (2 * (8 * 8)));

  unsigned int i;
  tree t;

  if (sizetype_set)
    fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 1995, __FUNCTION__);


  sizetype_tab[(int) SIZETYPE] = copy_node (type);
  ((sizetype_tab[(int) SIZETYPE])->type.values) = type;
  ((sizetype_tab[(int) SIZETYPE])->type.no_force_blk_flag) = 1;
  sizetype_tab[(int) BITSIZETYPE] = make_node (INTEGER_TYPE);
  ...
  if (((type)->common.unsigned_flag))
    {
      ...
      sizetype_tab[(int) SSIZETYPE] = copy_node (make_signed_type (oprecision));
      sizetype_tab[(int) SBITSIZETYPE] = copy_node (make_signed_type (precision));
    }
  else
    {
      sizetype_tab[(int) SSIZETYPE] = sizetype_tab[(int) SIZETYPE];
      sizetype_tab[(int) SBITSIZETYPE] = sizetype_tab[(int) BITSIZETYPE];
      sizetype_tab[(int) USIZETYPE] = copy_node (make_unsigned_type (oprecision));
      sizetype_tab[(int) UBITSIZETYPE] = copy_node (make_unsigned_type (precision));
    }

  ((sizetype_tab[(int) BITSIZETYPE])->type.name) = (__builtin_constant_p ("bit_size_type") ? get_identifier_with_length (("bit_size_type"), (unsigned) strlen ("bit_size_type")) : (get_identifier) ("bit_size_type"));
  ...
  for (t = early_type_list; t != 0; t = ((t)->common.chain))
    {
      if (((enum tree_code) (((t)->list.value))->common.code) != INTEGER_TYPE)
 fancy_abort ("../../../kgccfe/gnu/stor-layout.c", 2045, __FUNCTION__);

      ((((((t)->list.value))->type.size))->common.type) = sizetype_tab[(int) BITSIZETYPE];
      ((((((t)->list.value))->type.size_unit))->common.type) = sizetype_tab[(int) SIZETYPE];
    }
     ...
     tree type;
{
  ...
  ((type)->type.minval)
    = build_int_2_wide ((unsigned long long) ((precision - (8 * 8) > 0 ? 0 : (long long) (-1) << (precision - 1))), (long long) ((((long long) (-1) << (precision - (8 * 8) - 1 > 0 ? precision - (8 * 8) - 1 : 0)))));
  ...
  ((type)->type.maxval)
    = build_int_2_wide ((unsigned long long) ((precision - (8 * 8) > 0 ? -1 : ((long long) 1 << (precision - 1)) - 1)), (long long) ((precision - (8 * 8) - 1 > 0 ? (((long long) 1 << (precision - (8 * 8) - 1))) - 1 : 0)));
  ...
  ((((type)->type.minval))->common.type) = type;
  ((((type)->type.maxval))->common.type) = type;
     ...
     tree type;
{
  ...
  ((type)->type.minval) = build_int_2_wide ((unsigned long long) (0), (long long) (0));
  ((type)->type.maxval)
    = build_int_2_wide ((unsigned long long) (precision - (8 * 8) >= 0 ? -1 : ((long long) 1 << precision) - 1), (long long) (precision - (8 * 8) > 0 ? ((unsigned long long) ~0 >> ((8 * 8) - (precision - (8 * 8)))) : 0));
     ...
     int volatilep;
{
 ...
 break;
  ...
  if (mode == VOIDmode
      ...
      || ((unit) < ((mips_abi == 1 || mips_abi == 2 ? 128 : 64)) ? (unit) : ((mips_abi == 1 || mips_abi == 2 ? 128 : 64))) > align
      || (largest_mode != VOIDmode && unit > (mode_bitsize[(int) (largest_mode)])))
    return VOIDmode;
  ...
  if (1 && ! volatilep)
    {
      ...
      for (tmode = class_narrowest_mode[(int) (MODE_INT)]; tmode != VOIDmode;
    tmode = ((enum machine_mode)mode_wider_mode[(int) (tmode)]))
 {
   unit = (mode_bitsize[(int) (tmode)]);
   if (bitpos / unit == (bitpos + bitsize - 1) / unit
       && unit <= (8 * ((target_flags & 0x00002000) ? 8 : 4))
       && unit <= ((align) < ((mips_abi == 1 || mips_abi == 2 ? 128 : 64)) ? (align) : ((mips_abi == 1 || mips_abi == 2 ? 128 : 64)))
       && (largest_mode == VOIDmode
    || unit <= (mode_bitsize[(int) (largest_mode)])))
     wide_mode = tmode;
 }
...
# 1 "../../../kgccfe/gnu/MIPS/gt-stor-layout.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-stor-layout.h"
...
# 2195 "../../../kgccfe/gnu/stor-layout.c" 2
