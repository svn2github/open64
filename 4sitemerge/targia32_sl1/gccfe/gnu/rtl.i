...
# 158 "../../../kgccfe/gnu/machmode.def"
4,
# 101 "../../../kgccfe/gnu/rtl.c" 2
};
# 112 "../../../kgccfe/gnu/rtl.c"
...
(unsigned char) HImode,
(unsigned char) SImode,
(unsigned char) DImode,
...
(unsigned char) PHImode,
(unsigned char) PSImode,
(unsigned char) PDImode,
(unsigned char) VOIDmode,

(unsigned char) HFmode,
(unsigned char) TQFmode,
(unsigned char) SFmode,
(unsigned char) DFmode,
(unsigned char) XFmode,
(unsigned char) TFmode,
(unsigned char) VOIDmode,


(unsigned char) HCmode,
(unsigned char) SCmode,
(unsigned char) DCmode,
(unsigned char) XCmode,
(unsigned char) TCmode,
(unsigned char) VOIDmode,

(unsigned char) CHImode,
(unsigned char) CSImode,
(unsigned char) CDImode,
(unsigned char) CTImode,
(unsigned char) COImode,
(unsigned char) VOIDmode,
...
(unsigned char) V2QImode,
(unsigned char) V4QImode,
(unsigned char) V8QImode,
(unsigned char) V16QImode,
(unsigned char) V8SImode,

(unsigned char) V2HImode,
(unsigned char) V2SImode,
(unsigned char) V2DImode,
(unsigned char) V8DImode,

(unsigned char) V4HImode,
(unsigned char) V4SImode,
(unsigned char) V4DImode,
(unsigned char) VOIDmode,

(unsigned char) V8HImode,

(unsigned char) V4SFmode,
(unsigned char) V8SFmode,

(unsigned char) V2DFmode,
(unsigned char) V8DFmode,

(unsigned char) V4DFmode,
(unsigned char) VOIDmode,
(unsigned char) VOIDmode,
...
# 158 "../../../kgccfe/gnu/machmode.def"
(unsigned char) VOIDmode,
# 114 "../../../kgccfe/gnu/rtl.c" 2
};
# 123 "../../../kgccfe/gnu/rtl.c"
const unsigned long long mode_mask_array[(int) MAX_MACHINE_MODE] = {
# 1 "../../../kgccfe/gnu/machmode.def" 1
# 74 "../../../kgccfe/gnu/machmode.def"
((0) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (0)) - 1,

((1) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (1)) - 1,
((8) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8)) - 1,
((8*2) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*2)) - 1,
((8*4) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*4)) - 1,
((8*8) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*8)) - 1,
((8*16) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*16)) - 1,
((8*32) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*32)) - 1,
...
((8) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8)) - 1,
((8*2) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*2)) - 1,
((8*3) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*3)) - 1,
((8*4) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*4)) - 1,
((8*8) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*8)) - 1,
((8*12) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*12)) - 1,
((8*16) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*16)) - 1,
...
((8*8) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*8)) - 1,
((8*16) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*16)) - 1,
((8*24) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*24)) - 1,
((8*32) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*32)) - 1,
...
((8*16) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*16)) - 1,
((8*32) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*32)) - 1,
((8*64) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*64)) - 1,
...
((8*32) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*32)) - 1,
((8*64) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*64)) - 1,
((512) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (512)) - 1,
...
# 158 "../../../kgccfe/gnu/machmode.def"
((8*4) >= (8 * 8)) ? ~(unsigned long long) 0 : ((unsigned long long) 1 << (8*4)) - 1,
# 125 "../../../kgccfe/gnu/rtl.c" 2
};
# 134 "../../../kgccfe/gnu/rtl.c"
...
# 158 "../../../kgccfe/gnu/machmode.def"
VOIDmode,
# 136 "../../../kgccfe/gnu/rtl.c" 2
};
# 147 "../../../kgccfe/gnu/rtl.c"
...
const char rtx_class[((int) LAST_AND_UNUSED_RTX_CODE)] = {
     ...
     int n;
{
  ...
  rt = ((struct rtvec_def *) ggc_alloc (sizeof (struct rtvec_def) + ((n) - 1) * sizeof (rtx)));
...
{
  rtx rt;
  int n = (rtx_length[(int) (code)]);

  rt = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((n) - 1) * sizeof (rtunion)));
     ...
     rtx orig;
{
 ...
 case 'e':
   if ((((orig)->fld[i]).rtx) != ((void *)0))
     (((copy)->fld[i]).rtx) = copy_rtx ((((orig)->fld[i]).rtx));
   break;
 ...
 case 'V':
  ...
  (((((copy)->fld[i]).rtvec))->elem[j]) = copy_rtx ((((((orig)->fld[i]).rtvec))->elem[j]));
     }
   break;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/rtl.c", 378, __FUNCTION__);
 }
    }
  return copy;
}
...
shallow_copy_rtx (orig)
     rtx orig;
{
  enum rtx_code code = ((enum rtx_code) (orig)->code);
  size_t n = (rtx_length[(int) (code)]);
  rtx copy = ((struct rtx_def *) ggc_alloc (sizeof (struct rtx_def) + ((n) - 1) * sizeof (rtunion)));
     ...
     rtx x, y;
{
 ...
 case 'E':
   ...
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     if (rtx_equal_p ((((((x)->fld[i]).rtvec))->elem[j]), (((((y)->fld[i]).rtvec))->elem[j])) == 0)
       return 0;
   break;

 case 'e':
   if (rtx_equal_p ((((x)->fld[i]).rtx), (((y)->fld[i]).rtx)) == 0)
     return 0;
   break;

 case 'S':
 case 's':
   if (((((x)->fld[i]).rtstr) || (((y)->fld[i]).rtstr))
       && (! (((x)->fld[i]).rtstr) || ! (((y)->fld[i]).rtstr)
    || strcmp ((((x)->fld[i]).rtstr), (((y)->fld[i]).rtstr))))
     return 0;
   break;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/rtl.c", 519, __FUNCTION__);
 }
    }
  return 1;
}
