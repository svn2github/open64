...
# 45 "../../../kgccfe/gnu/builtins.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 46 "../../../kgccfe/gnu/builtins.c" 2
...
# 57 "../../../kgccfe/gnu/builtins.c" 2
# 74 "../../../kgccfe/gnu/builtins.c"
...
static rtx expand_builtin_constant_p (tree);
...
static rtx builtin_memcpy_read_str (void *, long long, enum machine_mode);
...
static rtx builtin_strncpy_read_str (void *, long long, enum machine_mode);

static rtx expand_builtin_strncpy (tree, rtx, enum machine_mode);

static rtx builtin_memset_read_str (void *, long long, enum machine_mode);

static rtx builtin_memset_gen_str (void *, long long, enum machine_mode);

static rtx expand_builtin_memset (tree, rtx, enum machine_mode);

static rtx expand_builtin_bzero (tree);
static rtx expand_builtin_strlen (tree, rtx);
...
static rtx expand_builtin_ffs (tree, rtx, rtx);
static rtx expand_builtin_frame_address (tree);
...
static _Bool readonly_data_expr (tree);
# 185 "../../../kgccfe/gnu/builtins.c"
static int
...
# 263 "../../../kgccfe/gnu/builtins.c"
static tree
c_strlen (src, only_value)
     tree src;
     int only_value;
{
  tree offset_node;
 ...
 return len1;
  ...
  if (((enum tree_code) (src)->common.code) == COMPOUND_EXPR
      && (only_value || !((((src)->exp.operands[0]))->common.side_effects_flag)))
    src = ((src)->exp.operands[1]);

  src = string_constant (src, &offset_node);
  if (src == 0)
    return 0;

  max = ((src)->string.length) - 1;
 ...
 if (ptr[i] == 0)
   return 0;
# 314 "../../../kgccfe/gnu/builtins.c"
      return size_diffop (size_int_wide ((long long) (max), SIZETYPE), offset_node);
    }
  ...
  return size_int_wide ((long long) (strlen (ptr + offset)), SSIZETYPE);
}
     ...
     tree src;
{
  ...
  if (offset_node == 0)
    return ((src)->string.pointer);
  else if (!host_integerp (offset_node, 1)
    || compare_tree_int (offset_node, ((src)->string.length) - 1) > 0)
    return 0;

  return ((src)->string.pointer) + tree_low_cst (offset_node, 1);
}
     ...
     enum machine_mode mode;
{
  ...
  if ((mode_class[(int) (mode)]) != MODE_INT)
    fancy_abort ("../../../kgccfe/gnu/builtins.c", 378, __FUNCTION__);
  c[0] = 0;
  c[1] = 0;
  ch = 1;
  for (i = 0; i < (mode_size[(int) (mode)]); i++)
    {
      j = i;
      if (((target_flags & 0x00010000) != 0))
 j = (mode_size[(int) (mode)]) - i - 1;
      if (((target_flags & 0x00010000) != 0) != ((target_flags & 0x00010000) != 0)
   && (mode_size[(int) (mode)]) > ((target_flags & 0x00002000) ? 8 : 4))
 j = j + ((target_flags & 0x00002000) ? 8 : 4) - 2 * (j % ((target_flags & 0x00002000) ? 8 : 4)) - 1;
      j *= 8;
      if (j > 2 * (8 * 8))
 fancy_abort ("../../../kgccfe/gnu/builtins.c", 392, __FUNCTION__);
      if (ch)
...
target_char_cast (cst, p)
     ...
     char *p;
{
  unsigned long long val, hostval;
  ...
  if (8 < (8 * 8))
    val &= (((unsigned long long) 1) << 8) - 1;

  hostval = val;
  if (8 < (8 * 8))
    hostval &= (((unsigned long long) 1) << 8) - 1;
...
# 460 "../../../kgccfe/gnu/builtins.c"
  for (i = 0; i < count; i++)
    {
      ...
      tem = memory_address ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), tem);
  ...
  tem = (((count) == 0) ? (leaf_function_p () ? gen_rtx_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 0 + 31) : gen_rtx_MEM ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), gen_rtx_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 75))) : (rtx) 0);
...
static long long setjmp_alias_set = -1;
...
expand_builtin_setjmp_setup (buf_addr, receiver_label)
     ...
     rtx receiver_label;
{
  enum machine_mode sa_mode = (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode);
  rtx stack_save;
  rtx mem;
  ...
  buf_addr = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), force_operand (buf_addr, (rtx) 0));

  emit_queue ();
# 526 "../../../kgccfe/gnu/builtins.c"
  mem = gen_rtx_MEM ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), buf_addr);
  set_mem_alias_set (mem, setjmp_alias_set);
  emit_move_insn (mem, (global_rtl[GR_VIRTUAL_STACK_ARGS]));

  mem = gen_rtx_MEM ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), plus_constant_wide ((buf_addr), (long long) ((mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))])))),
  set_mem_alias_set (mem, setjmp_alias_set);

  emit_move_insn (validize_mem (mem),
    force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), gen_rtx_fmt_u00 (LABEL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (receiver_label))));

  stack_save = gen_rtx_MEM (sa_mode,
       plus_constant_wide ((buf_addr), (long long) (2 * (mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]))));
...
expand_builtin_setjmp_receiver (receiver_label)
     rtx receiver_label __attribute__ ((__unused__));
{
     ...
     rtx target;
{
  ...
  buf_addr = expand_expr (((arglist)->list.value), (rtx) 0, VOIDmode, 0);
     ...
     rtx buf_addr, value;
{
  ...
  buf_addr = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), buf_addr);
  ...
  if (value != (const_int_rtx[64 +1]))
    fancy_abort ("../../../kgccfe/gnu/builtins.c", 709, __FUNCTION__);
  ...
  if (((target_flags & 0x00000400)))
    ...
    {
      fp = gen_rtx_MEM ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), buf_addr);
      lab = gen_rtx_MEM ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), plus_constant_wide ((buf_addr), (long long) ((mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]))));


      stack = gen_rtx_MEM (sa_mode, plus_constant_wide ((buf_addr), (long long) (2 * (mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]))));

      set_mem_alias_set (fp, setjmp_alias_set);
      set_mem_alias_set (lab, setjmp_alias_set);
      set_mem_alias_set (stack, setjmp_alias_set);
# 740 "../../../kgccfe/gnu/builtins.c"
 {
   lab = copy_to_reg (lab);
  ...
  for (insn = get_last_insn (); insn; insn = (((insn)->fld[1]).rtx))
    {
      if (insn == last)
 fancy_abort ("../../../kgccfe/gnu/builtins.c", 760, __FUNCTION__);
      if (((enum rtx_code) (insn)->code) == JUMP_INSN)
 {
   (((insn)->fld[8]).rtx) = alloc_EXPR_LIST (REG_NON_LOCAL_GOTO, (const_int_rtx[64]),
           (((insn)->fld[8]).rtx));
   break;
 }
     ...
     tree arglist;
{
  ...
  arg0 = ((arglist)->list.value);



  if (((arglist)->common.chain))
    {
      arg1 = ((((arglist)->common.chain))->list.value);
      if (((((arglist)->common.chain))->common.chain))
 arg2 = ((((((arglist)->common.chain))->common.chain))->list.value);
      else
 arg2 = build_int_2_wide ((unsigned long long) (3), (long long) (0));
    }
  else
    {
  ...
  op0 = expand_expr (arg0, (rtx) 0, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), EXPAND_NORMAL);
  ...
  if ((((op1)->fld[0]).rtwint) != 0 && (((op1)->fld[0]).rtwint) != 1)
    {
  ...
  if ((((op2)->fld[0]).rtwint) < 0 || (((op2)->fld[0]).rtwint) > 3)
    {
  ...
  if (((((mips_isa == 4) || (mips_isa == 32) || (mips_isa == 64)) && !(target_flags & 0x00100000))))
   ...
   || (((enum machine_mode) (op0)->mode) != (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)))
 {
     ...
     tree exp;
{
  ...
  if (((enum tree_code) (exp)->common.code) == ADDR_EXPR)
    ...
    {
      exp = build1 (INDIRECT_REF, ((((exp)->common.type))->common.type), exp);
...
# 907 "../../../kgccfe/gnu/builtins.c"
static enum machine_mode apply_args_mode[176];
...
static enum machine_mode apply_result_mode[176];





static int apply_args_reg_offset[176];
...
apply_args_size ()
{
  ...
  if (size < 0)
    {
      ...
      size = (mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]);
 ...
 if (((((unsigned long long) (((regno)) - ((0 + 4))) <= ((((0 + 4) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((0 + 4)))) || (((unsigned long long) (((regno)) - ((32 + 12))) <= ((((32 + 12) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((32 + 12)))) && ((regno) % ((target_flags & 0x00000200) || (target_flags & 0x00020000) ? 1 : 2) == 0) && mips_abi != 4)) && !fixed_regs[regno]))
   ...
   mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
    ...
    && mips_hard_regno_nregs (regno, mode) == 1)
  best_mode = mode;
  ...
  if (mips_hard_regno_mode_ok[ (int)(mode) ][ (regno) ]
    ...
    best_mode = mode;
     ...
     mode = best_mode;
     if (mode == VOIDmode)
       fancy_abort ("../../../kgccfe/gnu/builtins.c", 1002, __FUNCTION__);
  ...
  if (size < 0)
    {
      ...
      for (regno = 0; regno < 176; regno++)
 if (((regno) == (0 + 2) || (regno) == (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) || ((mips_abi == 1 || mips_abi == 2 ? 128 : 64) == 128 && (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) != (0 + 2) && (regno) == (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) + 2)))
   {
  ...
  if (mips_hard_regno_mode_ok[ (int)(mode) ][ (regno) ]
    ...
    best_mode = mode;
     ...
     mode = best_mode;
     if (mode == VOIDmode)
       fancy_abort ("../../../kgccfe/gnu/builtins.c", 1074, __FUNCTION__);
     ...
     rtx result;
{
  ...
  enum machine_mode mode;
  rtx reg, mem;
  rtx *savevec = (rtx *) __builtin_alloca(176 * sizeof (rtx));
...
expand_builtin_apply_args_1 ()
{
 ...
 size += (mode_size[(int) (mode)]);
  ...
  emit_move_insn (adjust_address_1 (registers, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 0, 1, 1),
    copy_to_reg ((global_rtl[GR_VIRTUAL_INCOMING_ARGS])));
  size = (mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]);
  ...
  if (struct_value_incoming_rtx)
    {
      emit_move_insn (adjust_address_1 (registers, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), size, 1, 1),
        copy_to_reg (struct_value_incoming_rtx));
      size += (mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]);
    }


  return copy_addr_to_reg ((((registers)->fld[0]).rtx));
}
# 1187 "../../../kgccfe/gnu/builtins.c"
static rtx
expand_builtin_apply_args ()
{
    ...
    return (cfun->expr->x_apply_args_value);
  {
    ...
    emit_insn_before (seq, (((get_insns ())->fld[2]).rtx));
     ...
     rtx function, arguments, argsize;
{
  ...
  incoming_args = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode));
  emit_move_insn (incoming_args, gen_rtx_MEM ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), arguments));
  ...
  dest = allocate_dynamic_stack_space (argsize, 0, 8);
  dest = gen_rtx_MEM (BLKmode, dest);
  set_mem_align (dest, ((mips_abi == 4 || mips_abi == 1 || mips_abi == 2 || (mips_abi == 3 && (target_flags & 0x00002000))) ? 64 : 32));
  src = gen_rtx_MEM (BLKmode, incoming_args);
  set_mem_align (src, ((mips_abi == 4 || mips_abi == 1 || mips_abi == 2 || (mips_abi == 3 && (target_flags & 0x00002000))) ? 64 : 32));
  emit_block_move (dest, src, argsize, BLOCK_OP_NORMAL);


  apply_args_size ();
  arguments = gen_rtx_MEM (BLKmode, arguments);
  set_mem_align (arguments, ((mips_abi == 4 || mips_abi == 1 || mips_abi == 2 || (mips_abi == 3 && (target_flags & 0x00002000))) ? 64 : 32));
 ...
 size += (mode_size[(int) (mode)]);
  ...
  if (struct_value_rtx)
    {
      rtx value = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode));
      emit_move_insn (value, adjust_address_1 (arguments, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), size, 1, 1));
 ...
 use_reg (&call_fusage, struct_value_rtx);
  ...
  function = prepare_call_address (function, (tree) ((void *)0), &call_fusage, 0, 0);




  if (((enum rtx_code) (function)->code) != SYMBOL_REF)
    function = memory_address (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? DImode : SImode), function);



  if (1)
    emit_call_insn (gen_untyped_call (gen_rtx_MEM (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? DImode : SImode), function),
 ...
 if ((mode = apply_result_mode[regno]) != VOIDmode)
   {
     if (valreg)
       fancy_abort ("../../../kgccfe/gnu/builtins.c", 1343, __FUNCTION__);
     valreg = gen_rtx_REG (mode, regno);
   }

      emit_call_insn (gen_call_value ((valreg), (gen_rtx_MEM (((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? DImode : SImode), function)), ((const_int_rtx[64])), ((rtx) 0)));
    ...
    fancy_abort ("../../../kgccfe/gnu/builtins.c", 1355, __FUNCTION__);
  ...
  if (! call_insn)
    fancy_abort ("../../../kgccfe/gnu/builtins.c", 1364, __FUNCTION__);
 ...
 ;
  ...
  return copy_addr_to_reg ((((result)->fld[0]).rtx));
}
     ...
     tree type;
{
  switch (((enum tree_code) (type)->common.code))
    ...
    case ARRAY_TYPE: return (((type)->type.string_flag)
...
{
  if (arglist != 0)
    return gen_rtx_CONST_INT (VOIDmode, (long long) (type_to_class (((((arglist)->list.value))->common.type))));
  return gen_rtx_CONST_INT (VOIDmode, (long long) (no_type_class));
}
     ...
     tree exp;
{
  ...
  tmp = expand_expr (arglist, (rtx) 0, VOIDmode, 0);
  tmp = gen_rtx_fmt_e (CONSTANT_P_RTX, (value_mode), (tmp));
  return tmp;
}
     ...
     rtx target, subtarget;
{
  ...
  switch (((fndecl)->decl.u1.f))
    ...
    case BUILT_IN_SQRTF:
    case BUILT_IN_SQRTL:
      builtin_optab = (optab_table[OTI_sqrt]); break;
    case BUILT_IN_EXP:
    case BUILT_IN_EXPF:
    case BUILT_IN_EXPL:
      builtin_optab = (optab_table[OTI_exp]); break;
    case BUILT_IN_LOG:
    case BUILT_IN_LOGF:
    case BUILT_IN_LOGL:
      builtin_optab = (optab_table[OTI_log]); break;
    default:
      fancy_abort ("../../../kgccfe/gnu/builtins.c", 1590, __FUNCTION__);
    }



  argmode = ((((((arglist)->list.value))->common.type))->type.mode);
  ...
  if (flag_errno_math && ((((mode_class[(int) (argmode)]) == MODE_FLOAT || (mode_class[(int) (argmode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (argmode)]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
    {
      rtx lab1;
     ...
     rtx target;
{
  ...
  if (!validate_arglist (arglist, POINTER_TYPE, VOID_TYPE))
    ...
    {
      rtx pat;
      tree len, src = ((arglist)->list.value);
      ...
      if (len && ((enum tree_code) (len)->common.code) == INTEGER_CST)
 {
   ...
   return expand_expr (len, target, value_mode, EXPAND_NORMAL);
      ...
      align = get_pointer_alignment (src, (mips_abi == 1 || mips_abi == 2 ? 128 : 64)) / 8;
      ...
      while (insn_mode != VOIDmode)
 {
   ...
   insn_mode = ((enum machine_mode)mode_wider_mode[(int) (insn_mode)]);
 }
 ...
 return 0;
      ...
      && (((result)->fld[0]).rtuint) >= 176))
 result = gen_reg_rtx (insn_mode);




      src_reg = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode));
 ...
 char_rtx = copy_to_mode_reg (char_mode, char_rtx);
      ...
      pat = (*insn_data[(int) (icode)].genfun) (result, gen_rtx_MEM (BLKmode, src_reg),
        char_rtx, gen_rtx_CONST_INT (VOIDmode, (long long) (align)));
      if (! pat)
 return 0;
      emit_insn (pat);
 ...
 emit_insn_before (pat, get_insns ());
      ...
      if (((enum machine_mode) (result)->mode) == value_mode)
 target = result;
      else if (target != 0)
     ...
     enum machine_mode mode;
{
  if (!validate_arglist (arglist, POINTER_TYPE, INTEGER_TYPE, VOID_TYPE))
    ...
    {
      tree s1 = ((arglist)->list.value), s2 = ((((arglist)->common.chain))->list.value);
      const char *p1;
      ...
      if (p1 != ((void *)0))
 {
   ...
   return expand_expr (fold (build (PLUS_EXPR, ((s1)->common.type),
        s1, size_int_wide ((long long) (r - p1), SSIZETYPE))),
     ...
     enum machine_mode mode;
{
  ...
  if (offset < 0
      || ((unsigned long long) offset + (mode_size[(int) (mode)])
   > strlen (str) + 1))
    fancy_abort ("../../../kgccfe/gnu/builtins.c", 2008, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  if (!validate_arglist (arglist,
  ...
  else
    {
      ...
      const char *src_str;
      unsigned int src_align = get_pointer_alignment (src, (mips_abi == 1 || mips_abi == 2 ? 128 : 64));
      unsigned int dest_align
 = get_pointer_alignment (dest, (mips_abi == 1 || mips_abi == 2 ? 128 : 64));
 ...
 return 0;
   ...
   && (unsigned long long) (((len_rtx)->fld[0]).rtwint) <= strlen (src_str) + 1
   && can_store_by_pieces ((((len_rtx)->fld[0]).rtwint), builtin_memcpy_read_str,
      (void *) src_str, dest_align))
 {
   dest_mem = store_by_pieces (dest_mem, (((len_rtx)->fld[0]).rtwint),
          builtin_memcpy_read_str,
          (void *) src_str, dest_align, 0);
   dest_mem = force_operand ((((dest_mem)->fld[0]).rtx), (rtx) 0);
   ...
   return dest_mem;
      ...
      if (dest_addr == 0)
 {
   dest_addr = force_operand ((((dest_mem)->fld[0]).rtx), (rtx) 0);
     ...
     int endp;
{
      ...
      (void *) src_str, dest_align))
 {
   ...
   && can_move_by_pieces ((((len_rtx)->fld[0]).rtwint),
     ((dest_align) < (src_align) ? (dest_align) : (src_align))))
 {
   ...
   src_mem = get_memory_rtx (src);
   set_mem_align (src_mem, src_align);
   dest_mem = move_by_pieces (dest_mem, src_mem, (((len_rtx)->fld[0]).rtwint),
     ...
     enum machine_mode mode;
{
 ...
 return 0;
      ...
      if (readonly_data_expr (src))
        {
   tree const fn = built_in_decls[BUILT_IN_MEMCPY];
   if (!fn)
     return 0;
   return expand_expr (build_function_call_expr (fn, arglist),
         target, mode, EXPAND_NORMAL);
     ...
     tree arglist;
{
  ...
  src = ((arglist)->list.value);
  dest = ((((arglist)->common.chain))->list.value);
  size = ((((((arglist)->common.chain))->common.chain))->list.value);
  ...
  newarglist = build_tree_list ((tree) ((void *)0), convert (sizetype_tab[(int) SIZETYPE], size));
  newarglist = tree_cons ((tree) ((void *)0), src, newarglist);
  newarglist = tree_cons ((tree) ((void *)0), dest, newarglist);
     ...
     enum machine_mode mode;
{
  ...
  src = ((((arglist)->common.chain))->list.value);
  len = c_strlen (src, 1);
  if (len == 0 || ((len)->common.side_effects_flag))
    return 0;

  dst = ((arglist)->list.value);
  len = size_binop (PLUS_EXPR, len, size_int_wide ((long long) (1), SSIZETYPE));
  arglist = build_tree_list ((tree) ((void *)0), len);
  arglist = tree_cons ((tree) ((void *)0), src, arglist);
  arglist = tree_cons ((tree) ((void *)0), dst, arglist);
  return expand_expr (build_function_call_expr (fn, arglist),
        target, mode, EXPAND_NORMAL);
}
     ...
     enum machine_mode mode;
{
 ...
 return 0;
      ...
      len = fold (size_binop (PLUS_EXPR, len, size_int_wide ((long long) (1), SSIZETYPE)));
      newarglist = copy_list (arglist);
      chainon (newarglist, build_tree_list ((tree) ((void *)0), len));
      return expand_builtin_mempcpy (newarglist, target, mode, 2);
    }
}
     ...
     enum machine_mode mode;
{
  ...
  if ((unsigned long long) offset > strlen (str))
    return (const_int_rtx[64]);
     ...
     enum machine_mode mode;
{
  if (!validate_arglist (arglist,
    ...
    {
      tree slen = c_strlen (((((arglist)->common.chain))->list.value), 1);
      tree len = ((((((arglist)->common.chain))->common.chain))->list.value);
      tree fn;
      ...
      if (integer_zerop (len))
 {
   ...
   expand_expr (((((arglist)->common.chain))->list.value), (const_int_rtx[64]),
         VOIDmode, EXPAND_NORMAL);

   return expand_expr (((arglist)->list.value), target, mode,
         EXPAND_NORMAL);
 }
 ...
 return 0;
      ...
      slen = size_binop (PLUS_EXPR, slen, size_int_wide ((long long) (1), SSIZETYPE));
      ...
      if (tree_int_cst_lt (slen, len))
 {
   ...
   unsigned int dest_align
     = get_pointer_alignment (dest, (mips_abi == 1 || mips_abi == 2 ? 128 : 64));
   const char *p = c_getstr (((((arglist)->common.chain))->list.value));
   rtx dest_mem;
     ...
     enum machine_mode mode;
{
  ...
  char *p = __builtin_alloca((mode_size[(int) (mode)]));

  memset (p, *c, (mode_size[(int) (mode)]));
     ...
     enum machine_mode mode;
{
  ...
  if (!validate_arglist (arglist,
    ...
    {
      tree dest = ((arglist)->list.value);
      tree val = ((((arglist)->common.chain))->list.value);
      tree len = ((((((arglist)->common.chain))->common.chain))->list.value);
      char c;
      ...
      if (((enum tree_code) (val)->common.code) != INTEGER_CST)
 {
   ...
   val = fold (build1 (CONVERT_EXPR, integer_types[itk_unsigned_char], val));
      ...
      if (c)
 {
   if (!host_integerp (len, 1))
     return 0;
   if (!can_store_by_pieces (tree_low_cst (len, 1),
        builtin_memset_read_str, (void *) &c,
        dest_align))
     return 0;
     ...
     tree exp;
{
  ...
  dest = ((arglist)->list.value);
  size = ((((arglist)->common.chain))->list.value);
  ...
  newarglist = build_tree_list ((tree) ((void *)0), convert (sizetype_tab[(int) SIZETYPE], size));
  newarglist = tree_cons ((tree) ((void *)0), global_trees[TI_INTEGER_ZERO], newarglist);
  newarglist = tree_cons ((tree) ((void *)0), dest, newarglist);

  ((exp)->exp.operands[1]) = newarglist;
  result = expand_builtin_memset (exp, (const_int_rtx[64]), VOIDmode);
...
expand_builtin_memcmp (exp, arglist, target, mode)
     tree exp __attribute__ ((__unused__));
     tree arglist;
     rtx target;
     enum machine_mode mode;
{
  ...
  arg1 = ((arglist)->list.value);
  arg2 = ((((arglist)->common.chain))->list.value);
  len = ((((((arglist)->common.chain))->common.chain))->list.value);
  ...
  if (host_integerp (len, 1) && tree_low_cst (len, 1) == 1)
    {
      ...
      tree ind1 =
      fold (build1 (CONVERT_EXPR, integer_types[itk_int],
      ...
      tree result = fold (build (MINUS_EXPR, integer_types[itk_int], ind1, ind2));
      return expand_expr (result, target, mode, EXPAND_NORMAL);
    }
# 2803 "../../../kgccfe/gnu/builtins.c"
  return 0;
}
     ...
     enum machine_mode mode;
{
  ...
  arg1 = ((arglist)->list.value);
  arg2 = ((((arglist)->common.chain))->list.value);
  arg3 = ((((((arglist)->common.chain))->common.chain))->list.value);
     ...
     enum machine_mode mode;
{
      ...
      if (p1 && p2)
 {
   ...
   return expand_expr (size_int_wide ((long long) (r), SIZETYPE), target, mode, EXPAND_NORMAL);
 }
     ...
     enum machine_mode mode;
{
      ...
      if (p1 && *p1 == '\0')
 {
   ...
   return (const_int_rtx[64]);
      ...
      if (p2 && *p2 == '\0')
 {
   tree newarglist = build_tree_list ((tree) ((void *)0), s1),
...
expand_builtin_saveregs ()
{
  ...
  start_sequence ();
# 3291 "../../../kgccfe/gnu/builtins.c"
  error ("__builtin_saveregs not supported by this target");
  val = (const_int_rtx[64]);
     ...
     tree exp;
{
  ...
  if (sizeof (CUMULATIVE_ARGS) % sizeof (int) != 0)
    fancy_abort ("../../../kgccfe/gnu/builtins.c", 3328, __FUNCTION__);

  if (arglist != 0)
    {
      if (!host_integerp (((arglist)->list.value), 0))
 error ("argument of `__builtin_args_info' must be constant");
      else
 {
   long long wordnum = tree_low_cst (((arglist)->list.value), 0);

   if (wordnum < 0 || wordnum >= nwords)
     error ("argument of `__builtin_args_info' out of range");
   else
     return gen_rtx_CONST_INT (VOIDmode, (long long) (word_ptr[wordnum]));
 }
    }
  else
     ...
     tree arglist;
{
 ...
 warning ("second parameter of `va_start' not last named argument");
  ...
  return expand_binop ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (optab_table[OTI_add]),
     ...
     int needs_lvalue;
{
      ...
      if (((enum tree_code) (((valist)->common.type))->common.code) == ARRAY_TYPE)
 {
   ...
   tree p2 = build_pointer_type (global_trees[TI_VA_LIST_TYPE]);
      ...
      if (! needs_lvalue)
 {
   ...
   ((valist)->common.side_effects_flag) = 1;
      ...
      if (((valist)->common.side_effects_flag))
 valist = save_expr (valist);
      valist = fold (build1 (INDIRECT_REF, ((((valist)->common.type))->common.type),
        valist));
    }
     ...
     rtx nextarg;
{
  ...
  t = build (MODIFY_EXPR, ((valist)->common.type), valist,
      make_tree (global_trees[TI_PTR_TYPE], nextarg));
     ...
     tree arglist;
{
  ...
  valist = stabilize_va_list (((arglist)->list.value), 1);
     ...
     tree valist, type;
{
  ...
  align = size_int_wide ((long long) (((mips_abi == 4 || mips_abi == 1 || mips_abi == 2 || (mips_abi == 3 && (target_flags & 0x00002000))) ? 64 : 32) / 8), SIZETYPE);
  alignm1 = size_int_wide ((long long) (((mips_abi == 4 || mips_abi == 1 || mips_abi == 2 || (mips_abi == 3 && (target_flags & 0x00002000))) ? 64 : 32) / 8 - 1), SIZETYPE);
  if (type == global_trees[TI_ERROR_MARK]
    ...
    rounded_size = fold (build (MULT_EXPR, sizetype_tab[(int) SIZETYPE],
    fold (build (TRUNC_DIV_EXPR, sizetype_tab[(int) SIZETYPE],
  ...
  addr_tree = valist;
  if (((target_flags & 0x00002000) || mips_abi == 5 ? ((target_flags & 0x00010000) != 0) : !((target_flags & 0x00010000) != 0)) && ! integer_zerop (rounded_size))
    {

      addr_tree = fold (build (PLUS_EXPR, ((addr_tree)->common.type), addr_tree,
          fold (build (COND_EXPR, sizetype_tab[(int) SIZETYPE],
         fold (build (GT_EXPR, sizetype_tab[(int) SIZETYPE],
        rounded_size,
        align)),
         global_trees[TI_SIZE_ZERO],
         fold (build (MINUS_EXPR, sizetype_tab[(int) SIZETYPE],
        rounded_size,
        type_size))))));
    }

  addr = expand_expr (addr_tree, (rtx) 0, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), EXPAND_NORMAL);
  ...
  if (! integer_zerop (rounded_size))
    {
      t = build (MODIFY_EXPR, ((valist)->common.type), valist,
   build (PLUS_EXPR, ((valist)->common.type), valist,
   rounded_size));
      ((t)->common.side_effects_flag) = 1;
      expand_expr (t, (const_int_rtx[64]), VOIDmode, EXPAND_NORMAL);
    }
     ...
     tree valist, type;
{
      ...
      if (((promoted_type)->type.name))
 {
   if (((enum tree_code) (((promoted_type)->type.name))->common.code) == IDENTIFIER_NODE)
     pname = ((char *)(((promoted_type)->type.name))->identifier.id.str);
   else if (((enum tree_code) (((promoted_type)->type.name))->common.code) == TYPE_DECL
     && ((((promoted_type)->type.name))->decl.name))
     pname = ((char *)(((((promoted_type)->type.name))->decl.name))->identifier.id.str);
 }
...
expand_builtin_va_end (arglist)
     tree arglist;
{
  tree valist = ((arglist)->list.value);
     ...
     tree arglist;
{
  ...
  if (((enum tree_code) (global_trees[TI_VA_LIST_TYPE])->common.code) != ARRAY_TYPE)
    {
      t = build (MODIFY_EXPR, global_trees[TI_VA_LIST_TYPE], dst, src);
      ((t)->common.side_effects_flag) = 1;
      expand_expr (t, (const_int_rtx[64]), VOIDmode, EXPAND_NORMAL);
    }
  else
    {
      ...
      dstb = expand_expr (dst, (rtx) 0, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), EXPAND_NORMAL);
      srcb = expand_expr (src, (rtx) 0, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), EXPAND_NORMAL);
      size = expand_expr (((global_trees[TI_VA_LIST_TYPE])->type.size_unit), (rtx) 0,
     VOIDmode, EXPAND_NORMAL);
# 3723 "../../../kgccfe/gnu/builtins.c"
     ...
     tree exp;
{
  ...
  if (arglist == 0)
    ...
    return (const_int_rtx[64]);
  else if (! host_integerp (((arglist)->list.value), 1))
    {
 ...
 = expand_builtin_return_addr (((fndecl)->decl.u1.f),
          tree_low_cst (((arglist)->list.value), 1),
 ...
 return tem;
   ...
   && ! (((enum rtx_code) (tem)->code) == LABEL_REF || ((enum rtx_code) (tem)->code) == SYMBOL_REF || ((enum rtx_code) (tem)->code) == CONST_INT || ((enum rtx_code) (tem)->code) == CONST_DOUBLE || ((enum rtx_code) (tem)->code) == CONST || ((enum rtx_code) (tem)->code) == HIGH || ((enum rtx_code) (tem)->code) == CONST_VECTOR || ((enum rtx_code) (tem)->code) == CONSTANT_P_RTX))
 tem = copy_to_mode_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), tem);
      return tem;
    }
}
     ...
     rtx target, subtarget;
{
  ...
  target = expand_unop (((((((arglist)->list.value))->common.type))->type.mode),
   (optab_table[OTI_ffs]), op0, target, 1);
  if (target == 0)
    fancy_abort ("../../../kgccfe/gnu/builtins.c", 3839, __FUNCTION__);
  return target;
}
# 3932 "../../../kgccfe/gnu/builtins.c"
static rtx
     ...
     rtx target;
{
  ...
  if (arglist == (tree) ((void *)0)
    ...
    return (const_int_rtx[64]);
  exp = ((arglist)->list.value);
  c = ((((arglist)->common.chain))->list.value);
  ...
  if (flag_guess_branch_prob && ((enum rtx_code) (target)->code) != CONST_INT)
    {
      ...
      note = emit_note (((void *)0), NOTE_INSN_EXPECTED_VALUE);
      (((note)->fld[4]).rtx) = gen_rtx_fmt_ee (EQ, (VOIDmode), (target), (rtx_c));
    }

  return target;
}
# 3978 "../../../kgccfe/gnu/builtins.c"
rtx
...
{
  tree arglist = ((exp)->exp.operands[1]);
  tree arg0 = ((arglist)->list.value);
  tree arg1 = ((((arglist)->common.chain))->list.value);
  rtx ret = (rtx) 0;
      ...
      while (insn != (rtx) 0)
 {
   ...
   if (((enum rtx_code) (insn)->code) == JUMP_INSN && any_condjump_p (insn)
       && (pattern = pc_set (insn)) != (rtx) 0)
     {
       rtx ifelse = (((pattern)->fld[1]).rtx);
       rtx label;
       int taken;

       if (((enum rtx_code) (ifelse)->code) != IF_THEN_ELSE)
  goto do_next_insn;

       if (((enum rtx_code) ((((ifelse)->fld[1]).rtx))->code) == LABEL_REF)
  {
    taken = 1;
    label = ((((((ifelse)->fld[1]).rtx))->fld[0]).rtx);
  }

       else if (((enum rtx_code) ((((ifelse)->fld[2]).rtx))->code) == LABEL_REF)
  {
    taken = 0;
    label = ((((((ifelse)->fld[2]).rtx))->fld[0]).rtx);
  }


       else if (((enum rtx_code) ((((ifelse)->fld[1]).rtx))->code) == RETURN)
  {
    taken = 1;
    label = (rtx) 0;
  }

       else if (((enum rtx_code) ((((ifelse)->fld[2]).rtx))->code) == RETURN)
  {
    taken = 0;
    label = (rtx) 0;
  }
     ...
     enum machine_mode mode;
{
 ...
 return 0;
     ...
     (const_int_rtx[64]), VOIDmode, EXPAND_NORMAL);
      if (target == (const_int_rtx[64]))
 return (const_int_rtx[64]);
      exp = build_int_2_wide ((unsigned long long) (strlen (fmt_str)), (long long) (0));
      exp = fold (build1 (NOP_EXPR, integer_types[itk_int], exp));
 ...
 len = (tree) ((void *)0);
      ...
      arglist = build_tree_list ((tree) ((void *)0), arg);
      arglist = tree_cons ((tree) ((void *)0), dest, arglist);
...
# 4296 "../../../kgccfe/gnu/builtins.c"
      case BUILT_IN_STRCMP:
      case BUILT_IN_FFS:
# 4306 "../../../kgccfe/gnu/builtins.c"
 ...
 if (((((arg)->list.value))->common.volatile_flag))
   {
     volatilep = 1;
     break;
   }
 ...
 {
   for (arg = arglist; arg; arg = ((arg)->common.chain))
     expand_expr (((arg)->list.value), (const_int_rtx[64]),
    VOIDmode, EXPAND_NORMAL);
   return (const_int_rtx[64]);
 }
    }
  ...
  switch (fcode)
    ...
    case BUILT_IN_FABSL:
      ...
      fancy_abort ("../../../kgccfe/gnu/builtins.c", 4358, __FUNCTION__);
    ...
    case BUILT_IN_CIMAGL:
      ...
      fancy_abort ("../../../kgccfe/gnu/builtins.c", 4371, __FUNCTION__);
...
# 4417 "../../../kgccfe/gnu/builtins.c"
      ...
      else
 {
   ...
   for (t = arglist, i = 0; t; t = ((t)->common.chain), i++)
     ops[i] = expand_expr (((t)->list.value), (rtx) 0, VOIDmode, 0);
   ...
   return expand_builtin_apply (ops[0], ops[1], ops[2]);
    ...
    case BUILT_IN_RETURN:
      if (validate_arglist (arglist, POINTER_TYPE, VOID_TYPE))
 expand_builtin_return (expand_expr (((arglist)->list.value),
         (rtx) 0, VOIDmode, 0));
      return (const_int_rtx[64]);
 ...
 return (((((((current_function_decl)->decl.result))->decl.rtl ? (((current_function_decl)->decl.result))->decl.rtl : (make_decl_rtl (((current_function_decl)->decl.result), ((void *)0)), (((current_function_decl)->decl.result))->decl.rtl)))->fld[0]).rtx);
 ...
 return target;
      break;
# 4518 "../../../kgccfe/gnu/builtins.c"
    case BUILT_IN_STRNCAT:
      target = expand_builtin_strncat (arglist, target, mode);
      if (target)
 return target;
      break;
# 4564 "../../../kgccfe/gnu/builtins.c"
    case BUILT_IN_MEMCPY:
...
# 4614 "../../../kgccfe/gnu/builtins.c"
 ...
 return target;
      break;
# 4632 "../../../kgccfe/gnu/builtins.c"
    case BUILT_IN_LONGJMP:
      if (!validate_arglist (arglist, POINTER_TYPE, INTEGER_TYPE, VOID_TYPE))
 break;
      else
 {
# 4651 "../../../kgccfe/gnu/builtins.c"
   return (const_int_rtx[64]);
 }
...
# 4671 "../../../kgccfe/gnu/builtins.c"
 ...
 return target;
    ...
    case BUILT_IN_INIT_DWARF_REG_SIZES:
      expand_builtin_init_dwarf_reg_sizes (((arglist)->list.value));
      return (const_int_rtx[64]);

    case BUILT_IN_FROB_RETURN_ADDR:
      return expand_builtin_frob_return_addr (((arglist)->list.value));
    case BUILT_IN_EXTRACT_RETURN_ADDR:
      return expand_builtin_extract_return_addr (((arglist)->list.value));
    case BUILT_IN_EH_RETURN:
      expand_builtin_eh_return (((arglist)->list.value),
    ((((arglist)->common.chain))->list.value));
      return (const_int_rtx[64]);
    ...
    case BUILT_IN_EXTEND_POINTER:
      return expand_builtin_extend_pointer (((arglist)->list.value));
...
# 4739 "../../../kgccfe/gnu/builtins.c"
    default:
      if (!((fndecl)->decl.assembler_name != (tree) ((void *)0)))
...
# 4783 "../../../kgccfe/gnu/builtins.c"
  if (((arglist)->common.side_effects_flag) || cse_not_expected
...
{
  if (arglist == 0)
    return build_int_2_wide ((unsigned long long) (no_type_class), (long long) (0));

  return build_int_2_wide ((unsigned long long) (type_to_class (((((arglist)->list.value))->common.type))), (long long) (0));
}
     ...
     int warn;
{
  ...
  if (!(((mode_class[(int) (((type)->type.mode))]) == MODE_FLOAT || (mode_class[(int) (((type)->type.mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((type)->type.mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && warn)
     ...
     int quiet;
{
  ...
  if (!validate_arglist (arglist, POINTER_TYPE, VOID_TYPE))
    return 0;
  str = c_getstr (((arglist)->list.value));
  if (!str)
    return 0;
     ...
     tree exp;
{
  ...
  switch (fcode)
    ...
    case BUILT_IN_STRLEN:
      if (validate_arglist (arglist, POINTER_TYPE, VOID_TYPE))
 {
   tree len = c_strlen (((arglist)->list.value), 0);
   if (len)
     {

       if (global_trees[TI_SIZE_TYPE])
  len = convert (global_trees[TI_SIZE_TYPE], len);
       return len;
     }
 }
      break;
    ...
    case BUILT_IN_INFF:
    case BUILT_IN_INFL:
      return fold_builtin_inf (((((fndecl)->common.type))->common.type), 1);

    case BUILT_IN_HUGE_VAL:
    case BUILT_IN_HUGE_VALF:
    case BUILT_IN_HUGE_VALL:
      return fold_builtin_inf (((((fndecl)->common.type))->common.type), 0);

    case BUILT_IN_NAN:
    case BUILT_IN_NANF:
    case BUILT_IN_NANL:
      return fold_builtin_nan (arglist, ((((fndecl)->common.type))->common.type), 1);

    case BUILT_IN_NANS:
    case BUILT_IN_NANSF:
    case BUILT_IN_NANSL:
      return fold_builtin_nan (arglist, ((((fndecl)->common.type))->common.type), 0);
...
validate_arglist (tree arglist, ...)
{
  ...
  do
    {
      code = __builtin_va_arg(ap,enum tree_code);
      switch (code)
 {
 case 0:
 ...
 default:
   ...
   if (arglist == 0
       || code != ((enum tree_code) (((((arglist)->list.value))->common.type))->common.code))
     goto end;
   break;
 }
      arglist = ((arglist)->common.chain);
...
default_expand_builtin (exp, target, subtarget, mode, ignore)
     tree exp __attribute__ ((__unused__));
     rtx target __attribute__ ((__unused__));
     rtx subtarget __attribute__ ((__unused__));
     ...
     tree exp;
{
  ...
  if (((enum tree_code) (exp)->common.code) == ADDR_EXPR)
    return decl_readonly_section (((exp)->exp.operands[0]), 0);
  else
    return 0;
}
