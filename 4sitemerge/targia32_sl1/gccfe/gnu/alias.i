...
# 41 "../../../kgccfe/gnu/alias.c" 2
# 72 "../../../kgccfe/gnu/alias.c"
typedef struct alias_set_entry
{

  long long alias_set;
# 84 "../../../kgccfe/gnu/alias.c"
  splay_tree children;
...
rtx get_addr (rtx);
static int memrefs_conflict_p (int, rtx, int, rtx, long long);
...
static rtx static_reg_base_value[176];
# 176 "../../../kgccfe/gnu/alias.c"
...
# 199 "../../../kgccfe/gnu/alias.c"
char *reg_known_equiv_p;



static _Bool copying_arguments;
...
mems_in_disjoint_alias_sets_p (mem1, mem2)
     ...
     rtx mem2;
{
# 242 "../../../kgccfe/gnu/alias.c"
  return ! alias_sets_conflict_p (((((mem1)->fld[1]).rtmem) == 0 ? 0 : (((mem1)->fld[1]).rtmem)->alias), ((((mem2)->fld[1]).rtmem) == 0 ? 0 : (((mem2)->fld[1]).rtmem)->alias));
}
     ...
     tree type;
{
  ...
  for (field = ((type)->type.values); field != 0; field = ((field)->common.chain))
     ...
     tree t;
{
 ...
 return set;
      ...
      while (((enum tree_code) (inner)->common.code) == PLACEHOLDER_EXPR
      ...
      if (((enum tree_code) (inner)->common.code) == INDIRECT_REF)
 {
       ...
       if (((decl)->decl.pointer_alias_set) == -2)
  {
    ...
    long long pointed_to_alias_set
      = get_alias_set (((((decl)->common.type))->common.type));
    ...
    if (pointed_to_alias_set == 0)
     ...
     return 0;
      ...
      placeholder_ptr = 0;
      while (((enum tree_code) (t)->common.code) == PLACEHOLDER_EXPR
      || (handled_component_p (t) && ! can_address_p (t)))
 {
   if (((enum tree_code) (t)->common.code) == PLACEHOLDER_EXPR)
 ...
 return ((((((t)->decl.rtl ? (t)->decl.rtl : (make_decl_rtl (t, ((void *)0)), (t)->decl.rtl)))->fld[1]).rtmem) == 0 ? 0 : (((((t)->decl.rtl ? (t)->decl.rtl : (make_decl_rtl (t, ((void *)0)), (t)->decl.rtl)))->fld[1]).rtmem)->alias);
...
new_alias_set ()
{
  static long long last_alias_set;
     ...
     long long subset;
{
  ...
  if (superset == 0)
    fancy_abort ("../../../kgccfe/gnu/alias.c", 639, __FUNCTION__);
...
record_component_aliases (type)
     tree type;
{
  long long superset = get_alias_set (type);
  tree field;
 ...
 record_alias_subset (superset, get_alias_set (((type)->common.type)));
    ...
    case QUAL_UNION_TYPE:
      ...
      if (((type)->type.binfo) != ((void *)0) && ((((type)->type.binfo))->vec.a[4]) != ((void *)0))
 {
   int i;
   for (i = 0; i < ((((((type)->type.binfo))->vec.a[4]))->vec.length); i++)
     {
       tree binfo = ((((((type)->type.binfo))->vec.a[4]))->vec.a[i]);
     ...
     rtx src;
{
  ...
  switch (((enum rtx_code) (src)->code))
    ...
    case REG:
      ...
      if (regno < 176 && copying_arguments)
   ...
   && regno < reg_base_value_size)
 {
   ...
   && ((((src)->fld[0]).rtx) == (global_rtl[GR_ARG_POINTER])
       || (((enum rtx_code) ((((src)->fld[0]).rtx))->code) == PLUS
    && ((((((src)->fld[0]).rtx))->fld[0]).rtx) == (global_rtl[GR_ARG_POINTER]))))
 ...
 break;
    ...
    case MINUS:
      {
 rtx temp, src_0 = (((src)->fld[0]).rtx), src_1 = (((src)->fld[1]).rtx);
 ...
 if (((enum rtx_code) (src_1)->code) == CONST_INT || (((enum rtx_code) (src_0)->code) == LABEL_REF || ((enum rtx_code) (src_0)->code) == SYMBOL_REF || ((enum rtx_code) (src_0)->code) == CONST_INT || ((enum rtx_code) (src_0)->code) == CONST_DOUBLE || ((enum rtx_code) (src_0)->code) == CONST || ((enum rtx_code) (src_0)->code) == HIGH || ((enum rtx_code) (src_0)->code) == CONST_VECTOR || ((enum rtx_code) (src_0)->code) == CONSTANT_P_RTX))
   return find_base_value (src_0);
 else if (((enum rtx_code) (src_0)->code) == CONST_INT || (((enum rtx_code) (src_1)->code) == LABEL_REF || ((enum rtx_code) (src_1)->code) == SYMBOL_REF || ((enum rtx_code) (src_1)->code) == CONST_INT || ((enum rtx_code) (src_1)->code) == CONST_DOUBLE || ((enum rtx_code) (src_1)->code) == CONST || ((enum rtx_code) (src_1)->code) == HIGH || ((enum rtx_code) (src_1)->code) == CONST_VECTOR || ((enum rtx_code) (src_1)->code) == CONSTANT_P_RTX))
   return find_base_value (src_1);
 ...
 return 0;
    ...
    case LO_SUM:
      ...
      return find_base_value ((((src)->fld[1]).rtx));

    case AND:


      if (((enum rtx_code) ((((src)->fld[1]).rtx))->code) == CONST_INT && ((((((src)->fld[1]).rtx))->fld[0]).rtwint) != 0)
 return find_base_value ((((src)->fld[0]).rtx));
      return 0;

    case TRUNCATE:
      if ((mode_size[(int) (((enum machine_mode) (src)->mode))]) < (mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]))
 break;
    ...
    case SIGN_EXTEND:
      {
 rtx temp = find_base_value ((((src)->fld[0]).rtx));
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  if (regno >= reg_base_value_size)
    fancy_abort ("../../../kgccfe/gnu/alias.c", 944, __FUNCTION__);
      ...
      if (reg_seen[regno])
 {
   ...
   return;
      ...
      reg_seen[regno] = 1;
      new_reg_base_value[regno] = gen_rtx_fmt_e (ADDRESS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (gen_rtx_CONST_INT (VOIDmode, (long long) (unique_id++))));
  ...
  if (new_reg_base_value[regno])
    switch (((enum rtx_code) (src)->code))
      ...
      case LO_SUM:
      case MINUS:
 if ((((src)->fld[0]).rtx) != dest && (((src)->fld[1]).rtx) != dest)
   new_reg_base_value[regno] = 0;
 break;
      case PLUS:
...

 {
   ...
   if ((((src)->fld[0]).rtx) == dest)
     other = (((src)->fld[1]).rtx);
   else if ((((src)->fld[1]).rtx) == dest)
     other = (((src)->fld[0]).rtx);
   ...
   break;
      ...
      case AND:
 if ((((src)->fld[0]).rtx) != dest || ((enum rtx_code) ((((src)->fld[1]).rtx))->code) != CONST_INT)
   new_reg_base_value[regno] = 0;
 break;
      default:
 new_reg_base_value[regno] = 0;
 break;
  ...
  else if ((regno >= 176 || ! fixed_regs[regno])
     ...
     int invariant;
{
  ...
  if (((enum rtx_code) (val)->code) == REG)
    {
      if ((((val)->fld[0]).rtuint) < reg_base_value_size)
 reg_base_value[regno] = reg_base_value[(((val)->fld[0]).rtuint)];
     ...
     rtx reg;
{
  ...
  if (regno < reg_known_value_size && regno >= 176)
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) == REG && (((x)->fld[0]).rtuint) >= 176
      && (((x)->fld[0]).rtuint) < reg_known_value_size)
    return reg_known_value[(((x)->fld[0]).rtuint)] == x
      ? x : canon_rtx (reg_known_value[(((x)->fld[0]).rtuint)]);
  else if (((enum rtx_code) (x)->code) == PLUS)
    {
      rtx x0 = canon_rtx ((((x)->fld[0]).rtx));
      rtx x1 = canon_rtx ((((x)->fld[1]).rtx));

      if (x0 != (((x)->fld[0]).rtx) || x1 != (((x)->fld[1]).rtx))
 {
   if (((enum rtx_code) (x0)->code) == CONST_INT)
     return plus_constant_wide ((x1), (long long) ((((x0)->fld[0]).rtwint)));
   else if (((enum rtx_code) (x1)->code) == CONST_INT)
     return plus_constant_wide ((x0), (long long) ((((x1)->fld[0]).rtwint)));
   return gen_rtx_fmt_ee (PLUS, (((enum machine_mode) (x)->mode)), (x0), (x1));
    ...
    x = replace_equiv_address_nv (x, canon_rtx ((((x)->fld[0]).rtx)));
     ...
     rtx x, y;
{
  ...
  switch (code)
    {
    case VALUE:
      return (((x)->fld[0]).rt_cselib) == (((y)->fld[0]).rt_cselib);
    ...
    case ADDRESSOF:
      return ((((x)->fld[1]).rtint) == (((y)->fld[1]).rtint)
       && rtx_equal_for_memref_p ((((x)->fld[0]).rtx), (((y)->fld[0]).rtx)));
  ...
  if (code == EQ || code == NE || (rtx_class[(int) (code)]) == 'c')
    return ((rtx_equal_for_memref_p ((((x)->fld[0]).rtx), (((y)->fld[0]).rtx))
      && rtx_equal_for_memref_p ((((x)->fld[1]).rtx), (((y)->fld[1]).rtx)))
     || (rtx_equal_for_memref_p ((((x)->fld[0]).rtx), (((y)->fld[1]).rtx))
  && rtx_equal_for_memref_p ((((x)->fld[1]).rtx), (((y)->fld[0]).rtx))));
  else if ((rtx_class[(int) (code)]) == '<' || (rtx_class[(int) (code)]) == '2')
    return (rtx_equal_for_memref_p ((((x)->fld[0]).rtx), (((y)->fld[0]).rtx))
     && rtx_equal_for_memref_p ((((x)->fld[1]).rtx), (((y)->fld[1]).rtx)));
 ...
 case 'E':
   ...
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     if (rtx_equal_for_memref_p ((((((x)->fld[i]).rtvec))->elem[j]),
     (((((y)->fld[i]).rtvec))->elem[j])) == 0)
       return 0;
   break;

 case 'e':
   if (rtx_equal_for_memref_p ((((x)->fld[i]).rtx), (((y)->fld[i]).rtx)) == 0)
     return 0;
   break;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/alias.c", 1225, __FUNCTION__);
 }
    }
  return 1;
}
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      ...
      if (fmt[i] == 'e')
 {
   t = find_symbolic_term ((((x)->fld[i]).rtx));
   if (t != 0)
     return t;
 }
      else if (fmt[i] == 'E')
     ...
     rtx x;
{
  ...
  switch (((enum rtx_code) (x)->code))
    {
    case REG:
      return ((((x)->fld[0]).rtuint) < reg_base_value_size ? reg_base_value[(((x)->fld[0]).rtuint)] : 0);

    case TRUNCATE:
      if ((mode_size[(int) (((enum machine_mode) (x)->mode))]) < (mode_size[(int) ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))]))
 return 0;
    ...
    case PRE_MODIFY:
    case POST_MODIFY:
      return find_base_term ((((x)->fld[0]).rtx));

    case ZERO_EXTEND:
    case SIGN_EXTEND:
      {
 rtx temp = find_base_term ((((x)->fld[0]).rtx));
 ...
 return 0;
    ...
    case MINUS:
      {
 rtx tmp1 = (((x)->fld[0]).rtx);
 rtx tmp2 = (((x)->fld[1]).rtx);
# 1339 "../../../kgccfe/gnu/alias.c"
 if (tmp1 == pic_offset_table_rtx && (((enum rtx_code) (tmp2)->code) == LABEL_REF || ((enum rtx_code) (tmp2)->code) == SYMBOL_REF || ((enum rtx_code) (tmp2)->code) == CONST_INT || ((enum rtx_code) (tmp2)->code) == CONST_DOUBLE || ((enum rtx_code) (tmp2)->code) == CONST || ((enum rtx_code) (tmp2)->code) == HIGH || ((enum rtx_code) (tmp2)->code) == CONST_VECTOR || ((enum rtx_code) (tmp2)->code) == CONSTANT_P_RTX))
 ...
 return find_base_term ((((x)->fld[0]).rtx));
    ...
    case ADDRESSOF:
      return (((((global_rtl[GR_FRAME_POINTER]))->fld[0]).rtuint) < reg_base_value_size ? reg_base_value[((((global_rtl[GR_FRAME_POINTER]))->fld[0]).rtuint)] : 0);
     ...
     enum machine_mode x_mode, y_mode;
{
 ...
 return 1;
   ...
   && (((enum rtx_code) ((((x)->fld[1]).rtx))->code) != CONST_INT
       || (int) (mode_unit_size[(int) (y_mode)]) < -((((((x)->fld[1]).rtx))->fld[0]).rtwint)))
 return 1;
      if (((enum rtx_code) (y)->code) == AND
   && (((enum rtx_code) ((((y)->fld[1]).rtx))->code) != CONST_INT
       || (int) (mode_unit_size[(int) (x_mode)]) < -((((((y)->fld[1]).rtx))->fld[0]).rtwint)))
 return 1;
  ...
  if ((((enum rtx_code) (x_base)->code) == ADDRESS && ((enum machine_mode) (x_base)->mode) == (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))
      || (((enum rtx_code) (y_base)->code) == ADDRESS && ((enum machine_mode) (y_base)->mode) == (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)))
    return 0;
     ...
     rtx x;
{
  ...
  for (l = v->locs; l; l = l->next)
    if ((((enum rtx_code) (l->loc)->code) == LABEL_REF || ((enum rtx_code) (l->loc)->code) == SYMBOL_REF || ((enum rtx_code) (l->loc)->code) == CONST_INT || ((enum rtx_code) (l->loc)->code) == CONST_DOUBLE || ((enum rtx_code) (l->loc)->code) == CONST || ((enum rtx_code) (l->loc)->code) == HIGH || ((enum rtx_code) (l->loc)->code) == CONST_VECTOR || ((enum rtx_code) (l->loc)->code) == CONSTANT_P_RTX))
      return l->loc;
  for (l = v->locs; l; l = l->next)
     ...
     int n_refs;
{
  ...
  if (offset)
    addr = gen_rtx_fmt_ee (PLUS, (((enum machine_mode) (addr)->mode)), ((((addr)->fld[0]).rtx)), (gen_rtx_CONST_INT (VOIDmode, (long long) (offset))));
  else
    addr = (((addr)->fld[0]).rtx);

  return addr;
}
# 1556 "../../../kgccfe/gnu/alias.c"
static int
     ...
     long long c;
{
      ...
      if (((enum rtx_code) (y)->code) == PLUS)
 {
  ...
  return memrefs_conflict_p (xsize, x0, ysize, y0,
        c - (((x1)->fld[0]).rtwint) + (((y1)->fld[0]).rtwint));
       else
  return memrefs_conflict_p (xsize, x0, ysize, y,
        c - (((x1)->fld[0]).rtwint));
     }
   else if (((enum rtx_code) (y1)->code) == CONST_INT)
     return memrefs_conflict_p (xsize, x, ysize, y0, c + (((y1)->fld[0]).rtwint));

   return 1;
 }
      else if (((enum rtx_code) (x1)->code) == CONST_INT)
 return memrefs_conflict_p (xsize, x0, ysize, y, c - (((x1)->fld[0]).rtwint));
    }
      ...
      case MULT:
 {
   ...
   rtx x0, y0;
   rtx x1 = canon_rtx ((((x)->fld[1]).rtx));
   rtx y1 = canon_rtx ((((y)->fld[1]).rtx));
   if (! rtx_equal_for_memref_p (x1, y1))
     return 1;
   x0 = canon_rtx ((((x)->fld[0]).rtx));
   y0 = canon_rtx ((((y)->fld[0]).rtx));
   if (rtx_equal_for_memref_p (x0, y0))
   ...
   if (((enum rtx_code) (x1)->code) != CONST_INT)
     return 1;
   xsize /= (((x1)->fld[0]).rtwint);
   ysize /= (((x1)->fld[0]).rtwint);
   c /= (((x1)->fld[0]).rtwint);
   return memrefs_conflict_p (xsize, x0, ysize, y0, c);
 }
 ...
 if (alias_invariant)
   {
     unsigned int r_x = (((x)->fld[0]).rtuint), r_y = (((y)->fld[0]).rtuint);
     rtx i_x, i_y;
 ...
 break;
  ...
  if (((enum rtx_code) (x)->code) == AND && ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_INT)
    {
      if (((enum rtx_code) (y)->code) == AND || ysize < -((((((x)->fld[1]).rtx))->fld[0]).rtwint))
 xsize = -1;
      return memrefs_conflict_p (xsize, (((x)->fld[0]).rtx), ysize, y, c);
    }
  if (((enum rtx_code) (y)->code) == AND && ((enum rtx_code) ((((y)->fld[1]).rtx))->code) == CONST_INT)
    {




      if (((enum rtx_code) (x)->code) == AND || xsize < -((((((y)->fld[1]).rtx))->fld[0]).rtwint))
 ysize = -1;
      return memrefs_conflict_p (xsize, x, ysize, (((y)->fld[0]).rtx), c);
    }

  if (((enum rtx_code) (x)->code) == ADDRESSOF)
    {
      if (y == (global_rtl[GR_FRAME_POINTER])
   || ((enum rtx_code) (y)->code) == ADDRESSOF)
 return xsize <= 0 || ysize <= 0;
    }
  if (((enum rtx_code) (y)->code) == ADDRESSOF)
    {
      if (x == (global_rtl[GR_FRAME_POINTER]))
 return xsize <= 0 || ysize <= 0;
    }
 ...
 {
   c += ((((y)->fld[0]).rtwint) - (((x)->fld[0]).rtwint));
   return (xsize <= 0 || ysize <= 0
    || (c >= 0 && xsize > c) || (c < 0 && ysize+c > 0));
 }
      ...
      if (((enum rtx_code) (x)->code) == CONST)
 {
   if (((enum rtx_code) (y)->code) == CONST)
     return memrefs_conflict_p (xsize, canon_rtx ((((x)->fld[0]).rtx)),
           ysize, canon_rtx ((((y)->fld[0]).rtx)), c);
   else
     return memrefs_conflict_p (xsize, canon_rtx ((((x)->fld[0]).rtx)),
           ysize, y, c);
 }
 ...
 return memrefs_conflict_p (xsize, x, ysize,
       canon_rtx ((((y)->fld[0]).rtx)), c);

      if ((((enum rtx_code) (y)->code) == LABEL_REF || ((enum rtx_code) (y)->code) == SYMBOL_REF || ((enum rtx_code) (y)->code) == CONST_INT || ((enum rtx_code) (y)->code) == CONST_DOUBLE || ((enum rtx_code) (y)->code) == CONST || ((enum rtx_code) (y)->code) == HIGH || ((enum rtx_code) (y)->code) == CONST_VECTOR || ((enum rtx_code) (y)->code) == CONSTANT_P_RTX))
 return (xsize <= 0 || ysize <= 0
  || (rtx_equal_for_memref_p (x, y)
      && ((c >= 0 && xsize > c) || (c < 0 && ysize+c > 0))));
     ...
     int (*varies_p) (rtx, int);
{
  ...
  if ((((mem1))->frame_related) && (((mem2))->in_struct)
      && !varies_p (mem1_addr, 1) && varies_p (mem2_addr, 1))


    return mem1;

  if ((((mem1))->in_struct) && (((mem2))->frame_related)
      && varies_p (mem1_addr, 1) && !varies_p (mem2_addr, 1))
...
aliases_everything_p (mem)
     rtx mem;
{
  if (((enum rtx_code) ((((mem)->fld[0]).rtx))->code) == AND)
     ...
     rtx offset;
{
 ...
 return (rtx) 0;
      ioffset += (tree_low_cst (((field)->decl.arguments), 1)
  ...
  return gen_rtx_CONST_INT (VOIDmode, (long long) (ioffset));
}
...
nonoverlapping_memrefs_p (x, y)
     rtx x, y;
{
  tree exprx = ((((x)->fld[1]).rtmem) == 0 ? 0 : (((x)->fld[1]).rtmem)->expr), expry = ((((y)->fld[1]).rtmem) == 0 ? 0 : (((y)->fld[1]).rtmem)->expr);
  rtx rtlx, rtly;
  rtx basex, basey;
  rtx moffsetx, moffsety;
  long long offsetx = 0, offsety = 0, sizex, sizey, tem;
  ...
  moffsetx = ((((x)->fld[1]).rtmem) == 0 ? 0 : (((x)->fld[1]).rtmem)->offset);
  if (((enum tree_code) (exprx)->common.code) == COMPONENT_REF)
    {
 ...
 return 0;
  ...
  moffsety = ((((y)->fld[1]).rtmem) == 0 ? 0 : (((y)->fld[1]).rtmem)->offset);
 ...
 return 0;
  ...
  basex = ((enum rtx_code) (rtlx)->code) == MEM ? (((rtlx)->fld[0]).rtx) : rtlx;
  if (((enum rtx_code) (basex)->code) == PLUS && ((enum rtx_code) ((((basex)->fld[1]).rtx))->code) == CONST_INT)
    offsetx = ((((((basex)->fld[1]).rtx))->fld[0]).rtwint), basex = (((basex)->fld[0]).rtx);

  basey = ((enum rtx_code) (rtly)->code) == MEM ? (((rtly)->fld[0]).rtx) : rtly;
  if (((enum rtx_code) (basey)->code) == PLUS && ((enum rtx_code) ((((basey)->fld[1]).rtx))->code) == CONST_INT)
    offsety = ((((((basey)->fld[1]).rtx))->fld[0]).rtwint), basey = (((basey)->fld[0]).rtx);
  ...
  if (! rtx_equal_p (basex, basey))
    return (((((enum rtx_code) (basex)->code) == LABEL_REF || ((enum rtx_code) (basex)->code) == SYMBOL_REF || ((enum rtx_code) (basex)->code) == CONST_INT || ((enum rtx_code) (basex)->code) == CONST_DOUBLE || ((enum rtx_code) (basex)->code) == CONST || ((enum rtx_code) (basex)->code) == HIGH || ((enum rtx_code) (basex)->code) == CONST_VECTOR || ((enum rtx_code) (basex)->code) == CONSTANT_P_RTX) && (((enum rtx_code) (basey)->code) == LABEL_REF || ((enum rtx_code) (basey)->code) == SYMBOL_REF || ((enum rtx_code) (basey)->code) == CONST_INT || ((enum rtx_code) (basey)->code) == CONST_DOUBLE || ((enum rtx_code) (basey)->code) == CONST || ((enum rtx_code) (basey)->code) == HIGH || ((enum rtx_code) (basey)->code) == CONST_VECTOR || ((enum rtx_code) (basey)->code) == CONSTANT_P_RTX))
     || ((((enum rtx_code) (basex)->code) == LABEL_REF || ((enum rtx_code) (basex)->code) == SYMBOL_REF || ((enum rtx_code) (basex)->code) == CONST_INT || ((enum rtx_code) (basex)->code) == CONST_DOUBLE || ((enum rtx_code) (basex)->code) == CONST || ((enum rtx_code) (basex)->code) == HIGH || ((enum rtx_code) (basex)->code) == CONST_VECTOR || ((enum rtx_code) (basex)->code) == CONSTANT_P_RTX) && (((enum rtx_code) (basey)->code) == REG)
  && (((((basey)->fld[0]).rtuint)) == (0 + 29) || ((((basey)->fld[0]).rtuint)) == (0 + 1) || ((((basey)->fld[0]).rtuint)) == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30) || ((((basey)->fld[0]).rtuint)) == 0 || (((((basey)->fld[0]).rtuint)) >= (176) && ((((basey)->fld[0]).rtuint)) <= (((176)) + 4))))
     || ((((enum rtx_code) (basey)->code) == LABEL_REF || ((enum rtx_code) (basey)->code) == SYMBOL_REF || ((enum rtx_code) (basey)->code) == CONST_INT || ((enum rtx_code) (basey)->code) == CONST_DOUBLE || ((enum rtx_code) (basey)->code) == CONST || ((enum rtx_code) (basey)->code) == HIGH || ((enum rtx_code) (basey)->code) == CONST_VECTOR || ((enum rtx_code) (basey)->code) == CONSTANT_P_RTX) && (((enum rtx_code) (basex)->code) == REG)
  && (((((basex)->fld[0]).rtuint)) == (0 + 29) || ((((basex)->fld[0]).rtuint)) == (0 + 1) || ((((basex)->fld[0]).rtuint)) == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30) || ((((basex)->fld[0]).rtuint)) == 0 || (((((basex)->fld[0]).rtuint)) >= (176) && ((((basex)->fld[0]).rtuint)) <= (((176)) + 4)))));

  sizex = (((enum rtx_code) (rtlx)->code) != MEM ? (int) (mode_size[(int) (((enum machine_mode) (rtlx)->mode))])
    : ((((rtlx)->fld[1]).rtmem) != 0 ? (((rtlx)->fld[1]).rtmem)->size : ((enum machine_mode) (rtlx)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (rtlx)->mode))]))) : 0) ? (((((((rtlx)->fld[1]).rtmem) != 0 ? (((rtlx)->fld[1]).rtmem)->size : ((enum machine_mode) (rtlx)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (rtlx)->mode))]))) : 0))->fld[0]).rtwint)
    : -1);
  sizey = (((enum rtx_code) (rtly)->code) != MEM ? (int) (mode_size[(int) (((enum machine_mode) (rtly)->mode))])
    : ((((rtly)->fld[1]).rtmem) != 0 ? (((rtly)->fld[1]).rtmem)->size : ((enum machine_mode) (rtly)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (rtly)->mode))]))) : 0) ? (((((((rtly)->fld[1]).rtmem) != 0 ? (((rtly)->fld[1]).rtmem)->size : ((enum machine_mode) (rtly)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (rtly)->mode))]))) : 0))->fld[0]).rtwint) :
    -1);



  if (moffsetx)
    offsetx += (((moffsetx)->fld[0]).rtwint), sizex -= (((moffsetx)->fld[0]).rtwint);
  if (moffsety)
    offsety += (((moffsety)->fld[0]).rtwint), sizey -= (((moffsety)->fld[0]).rtwint);




  if (((((x)->fld[1]).rtmem) != 0 ? (((x)->fld[1]).rtmem)->size : ((enum machine_mode) (x)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (x)->mode))]))) : 0) && moffsetx)
    sizex = (((((((x)->fld[1]).rtmem) != 0 ? (((x)->fld[1]).rtmem)->size : ((enum machine_mode) (x)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (x)->mode))]))) : 0))->fld[0]).rtwint);
  if (((((y)->fld[1]).rtmem) != 0 ? (((y)->fld[1]).rtmem)->size : ((enum machine_mode) (y)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (y)->mode))]))) : 0) && moffsety)
    sizey = (((((((y)->fld[1]).rtmem) != 0 ? (((y)->fld[1]).rtmem)->size : ((enum machine_mode) (y)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (y)->mode))]))) : 0))->fld[0]).rtwint);
     ...
     int (*varies) (rtx, int);
{
  ...
  if (((enum machine_mode) (x)->mode) == BLKmode && ((enum rtx_code) ((((x)->fld[0]).rtx))->code) == SCRATCH)
    return 1;
  if (((enum machine_mode) (mem)->mode) == BLKmode && ((enum rtx_code) ((((mem)->fld[0]).rtx))->code) == SCRATCH)
    return 1;

  if (mems_in_disjoint_alias_sets_p (x, mem))
    return 0;
# 2101 "../../../kgccfe/gnu/alias.c"
  ...
  x_addr = get_addr ((((x)->fld[0]).rtx));
  mem_addr = get_addr ((((mem)->fld[0]).rtx));
  ...
  if (! memrefs_conflict_p ((mode_size[(int) (mem_mode)]), mem_addr,
       ((mode_size[(int) (((enum machine_mode) (x)->mode))])), x_addr, 0))
    return 0;
     ...
     int writep;
{
 ...
 return 0;
  ...
  if (!memrefs_conflict_p (((mode_size[(int) (((enum machine_mode) (mem)->mode))])), mem_addr,
      ((mode_size[(int) (((enum machine_mode) (x)->mode))])), x_addr, 0))
    return 0;
     ...
     void *data __attribute__ ((__unused__));
{
 ...
 return 0;
    ...
    case MEM:
      ...
      if ((((x))->volatil))
 return 1;
      base = find_base_term ((((x)->fld[0]).rtx));
      if (base)
 {
   ...
   if (((enum rtx_code) (base)->code) == ADDRESS
       && ((enum machine_mode) (base)->mode) == (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)
       && ((((base)->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER])
    || (((base)->fld[0]).rtx) == (global_rtl[GR_ARG_POINTER])

    || (((base)->fld[0]).rtx) == (global_rtl[GR_HARD_FRAME_POINTER])

    || (((base)->fld[0]).rtx) == (global_rtl[GR_FRAME_POINTER])))
     return 0;
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  switch (((enum rtx_code) (x)->code))
    ...
    case SET:
      if (nonlocal_mentioned_p ((((x)->fld[1]).rtx)))
 return 1;

      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == MEM)
 return nonlocal_mentioned_p (((((((x)->fld[0]).rtx))->fld[0]).rtx));
  ...
  && ((((mode_size[(int) (((enum machine_mode) (((((((x)->fld[0]).rtx))->fld[0]).rtx))->mode))])
    ...
    + (((target_flags & 0x00002000) ? 8 : 4) - 1)) / ((target_flags & 0x00002000) ? 8 : 4)))))
 return nonlocal_mentioned_p ((((x)->fld[0]).rtx));
      return 0;
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  switch (((enum rtx_code) (x)->code))
    ...
    case SET:
      if (nonlocal_mentioned_p ((((x)->fld[0]).rtx)))
 return 1;
      return nonlocal_set_p ((((x)->fld[1]).rtx));
...
mark_constant_function ()
{
  ...
  if (((current_function_decl)->common.readonly_flag)
      ...
      || ((((current_function_decl)->common.type))->type.mode) == VOIDmode
 ...
 continue;
   ...
   || volatile_refs_p ((((insn)->fld[5]).rtx)))
 break;
...
init_alias_once ()
{
  ...
  for (i = 0; i < 176; i++)
    ...
    if (((((unsigned long long) (((i)) - ((0 + 4))) <= ((((0 + 4) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((0 + 4)))) || (((unsigned long long) (((i)) - ((32 + 12))) <= ((((32 + 12) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((32 + 12)))) && ((i) % ((target_flags & 0x00000200) || (target_flags & 0x00020000) ? 1 : 2) == 0) && mips_abi != 4)) && !fixed_regs[i])
 && mips_hard_regno_mode_ok[ (int)((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)) ][ (i) ])
      static_reg_base_value[i]
 = gen_rtx_fmt_e (ADDRESS, (VOIDmode), (gen_rtx_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), i)));

  static_reg_base_value[(0 + 29)]
    = gen_rtx_fmt_e (ADDRESS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), ((global_rtl[GR_STACK_POINTER])));
  static_reg_base_value[0]
    = gen_rtx_fmt_e (ADDRESS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), ((global_rtl[GR_ARG_POINTER])));
  static_reg_base_value[(0 + 1)]
    = gen_rtx_fmt_e (ADDRESS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), ((global_rtl[GR_FRAME_POINTER])));

  static_reg_base_value[((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)]
    = gen_rtx_fmt_e (ADDRESS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), ((global_rtl[GR_HARD_FRAME_POINTER])));
...
init_alias_analysis ()
{
  ...
  reg_known_value
    = (rtx *) xcalloc ((maxreg - 176), sizeof (rtx))
    - 176;
  reg_known_equiv_p
    = (char*) xcalloc ((maxreg - 176), sizeof (char))
    - 176;
...
# 2774 "../../../kgccfe/gnu/alias.c"
      ...
      for (insn = get_insns (); insn; insn = (((insn)->fld[2]).rtx))
 {
  ...
  record_set (((((((insn)->fld[5]).rtx))->fld[0]).rtx), (rtx) 0, ((void *)0));
       else
  note_stores ((((insn)->fld[5]).rtx), record_set, ((void *)0));
    ...
    && ((((((set)->fld[0]).rtx))->fld[0]).rtuint) >= 176)
  {
    ...
    if ((((insn)->fld[8]).rtx) != 0
     ...
     || (note = find_reg_note (insn, REG_EQUIV, (rtx) 0)) != 0)
        && ((enum rtx_code) ((((note)->fld[0]).rtx))->code) != EXPR_LIST
        && ! rtx_varies_p ((((note)->fld[0]).rtx), 1)
        && ! reg_overlap_mentioned_p ((((set)->fld[0]).rtx), (((note)->fld[0]).rtx)))
      {
        reg_known_value[regno] = (((note)->fld[0]).rtx);
        reg_known_equiv_p[regno] = ((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_EQUIV;
      }
      ...
      && (reg_known_value[((((((src)->fld[0]).rtx))->fld[0]).rtuint)])
      && ((enum rtx_code) ((((src)->fld[1]).rtx))->code) == CONST_INT)
      {
        rtx op0 = (((src)->fld[0]).rtx);
        op0 = reg_known_value[(((op0)->fld[0]).rtuint)];
        reg_known_value[regno]
   = plus_constant_wide ((op0), (long long) (((((((src)->fld[1]).rtx))->fld[0]).rtwint)));
      ...
      for (ui = 0; ui < reg_base_value_size; ui++)
 {
  ...
  for (i = 176; i < maxreg; i++)
    if (reg_known_value[i] == 0)
      reg_known_value[i] = (cfun->emit->x_regno_reg_rtx)[i];
# 2880 "../../../kgccfe/gnu/alias.c"
  pass = 0;
  do
    {
      changed = 0;
      ...
      for (ui = 0; ui < reg_base_value_size; ui++)
 {
   ...
   if (base && ((enum rtx_code) (base)->code) == REG)
     {
       unsigned int base_regno = (((base)->fld[0]).rtuint);
       if (base_regno == ui)
  reg_base_value[ui] = 0;
       else
...
end_alias_analysis ()
{
  free (reg_known_value + 176);
  reg_known_value = 0;
  reg_known_value_size = 0;
  free (reg_known_equiv_p + 176);
  reg_known_equiv_p = 0;
  reg_base_value = 0;
...
# 1 "../../../kgccfe/gnu/MIPS/gt-alias.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-alias.h"
static void gt_ggc_ma_reg_base_value (void *);
static void
      ...
      void *x_p;
{
  ...
  if (((x) != ((void *)0) && ((void *) (x)) != (void *) 1 && ! ggc_set_mark (x)))
    for (i = 0; i < (reg_base_value_size); i++)
      do { if (x[i] != ((void *)0)) gt_ggc_mx_rtx_def (x[i]); } while (0);
}
