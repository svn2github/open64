...
# 138 "../../../kgccfe/gnu/unroll.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 139 "../../../kgccfe/gnu/unroll.c" 2
...
# 140 "../../../kgccfe/gnu/unroll.c" 2
# 1 "../../../kgccfe/gnu/regs.h" 1
# 24 "../../../kgccfe/gnu/regs.h"
...
# 151 "../../../kgccfe/gnu/unroll.c" 2
# 161 "../../../kgccfe/gnu/unroll.c"
...
static rtx simplify_cmp_and_jump_insns (enum rtx_code, enum machine_mode, rtx, rtx, rtx);
...
static void copy_loop_body (struct loop *, rtx, rtx, struct inline_remap *, rtx, int, enum unroll_types, rtx, rtx, rtx, rtx);


static int find_splittable_regs (const struct loop *, enum unroll_types, int);

static int find_splittable_givs (const struct loop *, struct iv_class *, enum unroll_types, rtx, int);
     ...
     int strength_reduce_p;
{
  ...
  if (insn_count > (compiler_params[(int) PARAM_MAX_UNROLLED_INSNS].value) / 2)
    {
      if (loop_dump_stream)
 fprintf (loop_dump_stream, "Unrolling failure: Loop too big.\n");
      return;
    }
# 281 "../../../kgccfe/gnu/unroll.c"
  if (! strength_reduce_p)
    loop_info->n_iterations = 0;

  if (loop_dump_stream && loop_info->n_iterations > 0)
    {
      fputs_unlocked ("Loop unrolling: ", loop_dump_stream);
      fprintf (loop_dump_stream, "%lld",
...
# 318 "../../../kgccfe/gnu/unroll.c"
      ...
      if (ujump && ((enum rtx_code) (last_loop_insn)->code) == JUMP_INSN)
 {
  ...
  if (loop_info->n_iterations > 0
      ...
      && loop_info->n_iterations < (unsigned) (compiler_params[(int) PARAM_MAX_UNROLLED_INSNS].value)
      && loop_info->n_iterations * insn_count < (unsigned) (compiler_params[(int) PARAM_MAX_UNROLLED_INSNS].value))
    {
 ...
 while (factors[i].count--)
   {
     if (temp * factors[i].factor < (unsigned) (compiler_params[(int) PARAM_MAX_UNROLLED_INSNS].value))
       {
 ...
 unroll_type = UNROLL_MODULO;
  ...
  if (unroll_type == UNROLL_NAIVE)
    {
      if (8 * insn_count < (compiler_params[(int) PARAM_MAX_UNROLLED_INSNS].value))
 unroll_number = 8;
      else if (4 * insn_count < (compiler_params[(int) PARAM_MAX_UNROLLED_INSNS].value))
 unroll_number = 4;
      else
 unroll_number = 2;
    }
  ...
  if (unroll_type == UNROLL_COMPLETELY)
    {
      ...
      insert_before = (((last_loop_insn)->fld[2]).rtx);


      if (((enum rtx_code) (last_loop_insn)->code) == BARRIER)
 copy_end = ((((((last_loop_insn)->fld[1]).rtx))->fld[1]).rtx);
      else if (((enum rtx_code) (last_loop_insn)->code) == JUMP_INSN)
 {
   copy_end = (((last_loop_insn)->fld[1]).rtx);
      ...
      else
 {
   ...
   return;
  ...
  else if (unroll_type == UNROLL_MODULO)
    {
      ...
      if (((enum rtx_code) (last_loop_insn)->code) == BARRIER)
 {
   insert_before = (((last_loop_insn)->fld[1]).rtx);
   copy_end = (((insert_before)->fld[1]).rtx);
 }
      else if (((enum rtx_code) (last_loop_insn)->code) == JUMP_INSN)
 {
...
# 581 "../../../kgccfe/gnu/unroll.c"
 ...
 copy_start = loop_start;
  ...
  start_label = (((copy_start)->fld[2]).rtx);

  while (((enum rtx_code) (start_label)->code) == NOTE)
    start_label = (((start_label)->fld[2]).rtx);
 ...
 fprintf (loop_dump_stream,
  ...
  if (unroll_type == UNROLL_NAIVE
      ...
      && ((enum rtx_code) ((((last_loop_insn)->fld[1]).rtx))->code) == JUMP_INSN
      && start_label != ((((((last_loop_insn)->fld[1]).rtx))->fld[9]).rtx))
    {
  ...
  if (unroll_type == UNROLL_NAIVE
      ...
      && start_label != (((last_loop_insn)->fld[9]).rtx))
    {
...
# 696 "../../../kgccfe/gnu/unroll.c"
  for (insn = copy_start; insn != loop_end; insn = (((insn)->fld[2]).rtx))
    {
      rtx note;

      if (((enum rtx_code) (insn)->code) == CODE_LABEL)
 local_label[(((insn)->fld[6]).rtint)] = 1;
      else if (((enum rtx_code) (insn)->code) == JUMP_INSN)
 {
   if ((((insn)->fld[9]).rtx))
     ((map)->label_map[((((((insn)->fld[9]).rtx))->fld[6]).rtint)] = ((((insn)->fld[9]).rtx)));


   else if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == ADDR_VEC
     || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == ADDR_DIFF_VEC)
     {
       rtx pat = (((insn)->fld[5]).rtx);
       int diff_vec_p = ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == ADDR_DIFF_VEC;
       int len = (((((pat)->fld[diff_vec_p]).rtvec))->num_elem);
       rtx label;

       for (i = 0; i < len; i++)
  {
    label = ((((((((pat)->fld[diff_vec_p]).rtvec))->elem[i]))->fld[0]).rtx);
    ((map)->label_map[(((label)->fld[6]).rtint)] = (label));
  }
     }
 }
      if ((note = find_reg_note (insn, REG_LABEL, (rtx) 0)))
 ((map)->label_map[((((((note)->fld[0]).rtx))->fld[6]).rtint)] = ((((note)->fld[0]).rtx)));
  ...
  map->inline_target = 0;
# 743 "../../../kgccfe/gnu/unroll.c"
  maxregnum = max_reg_num ();


  max_local_regnum = maxregnum;
# 756 "../../../kgccfe/gnu/unroll.c"
  ...
  if ((((copy_end)->fld[0]).rtint) < max_uid_for_loop)
    {
      int copy_start_luid = ((((copy_start)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((copy_start)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 766, __FUNCTION__), -1));
      int copy_end_luid = ((((copy_end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((copy_end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 767, __FUNCTION__), -1));



      if (((enum rtx_code) (copy_end)->code) == JUMP_INSN)
 copy_end_luid--;
# 786 "../../../kgccfe/gnu/unroll.c"
 ...
 copy_start_luid++;
      ...
      for (r = 176; r < max_reg_before_loop; ++r)
 if ((((reg_n_info)->data.reg[r])->first_uid) > 0 && (((reg_n_info)->data.reg[r])->first_uid) < max_uid_for_loop
     && uid_luid[(((reg_n_info)->data.reg[r])->first_uid)] >= copy_start_luid
     && (((reg_n_info)->data.reg[r])->last_uid) > 0 && (((reg_n_info)->data.reg[r])->last_uid) < max_uid_for_loop
     && uid_luid[(((reg_n_info)->data.reg[r])->last_uid)] <= copy_end_luid)
   {
# 809 "../../../kgccfe/gnu/unroll.c"
...
# 846 "../../../kgccfe/gnu/unroll.c"
          ...
          &mode))
 {
   ...
   neg_inc = 0;
   abs_inc = (((increment)->fld[0]).rtwint);
   if (abs_inc < 0)
     {
       abs_inc = -abs_inc;
       neg_inc = 1;
...
# 912 "../../../kgccfe/gnu/unroll.c"
   ...
   diff = simplify_gen_binary (AND, mode, diff,
          gen_rtx_CONST_INT (VOIDmode, (long long) (unroll_number*abs_inc - 1)));
   diff = force_operand (diff, (rtx) 0);
       ...
       else
  {
    ...
    cmp_code = LE;
       ...
       insn = simplify_cmp_and_jump_insns (cmp_code, mode, diff,
        gen_rtx_CONST_INT (VOIDmode, (long long) (abs_inc*cmp_const)),
        labels[i]);
       if (insn)
         predict_insn (insn, PRED_LOOP_PRECONDITIONING,
         10000 / (unroll_number - i));
     }
# 1013 "../../../kgccfe/gnu/unroll.c"
   if (abs_inc != 1)
     {
       int cmp_const;
       enum rtx_code cmp_code;
       ...
       else
  {
    ...
    cmp_code = GE;
       ...
       simplify_cmp_and_jump_insns (cmp_code, mode, diff,
        gen_rtx_CONST_INT (VOIDmode, (long long) (cmp_const)), labels[0]);
     }
   ...
   if (((enum rtx_code) (last_loop_insn)->code) == BARRIER)
     ...
     fancy_abort ("../../../kgccfe/gnu/unroll.c", 1055, __FUNCTION__);

   for (i = 1; i < unroll_number; i++)
     {
       emit_label_after (labels[unroll_number - i],
    (((loop_start)->fld[1]).rtx));

       memset ((char *) map->insn_map, 0, max_insnno * sizeof (rtx));
       memset ((char *) &((map->const_equiv_varray)->data.const_equiv[0]),
  ...
  if (local_label[j])
    ((map)->label_map[j] = (gen_label_rtx ()));
       ...
       for (r = 176; r < max_local_regnum; r++)
  if (local_regno[r])
    {
      map->reg_map[r]
        = gen_reg_rtx (((enum machine_mode) ((cfun->emit->x_regno_reg_rtx)[r])->mode));
      record_base_value ((((map->reg_map[r])->fld[0]).rtuint),
       ...
       if (i == unroll_number - 1)
  {
   ...
   emit_label_after (labels[0], (((loop_start)->fld[1]).rtx));
 ...
 fprintf (loop_dump_stream,
  ...
  (((loop->end)->fld[4]).rtint) = loop_preconditioned;
# 1156 "../../../kgccfe/gnu/unroll.c"
  ...
  for (bl = ivs->list; bl; bl = bl->next)
    {
      if ((((bl->biv->src_reg)->fld[0]).rtuint) != bl->regno)
 map->reg_map[bl->regno] = bl->biv->src_reg;
  ...
  if (unroll_type == UNROLL_MODULO)
    {
      insn = (((copy_end)->fld[2]).rtx);
      if (((enum rtx_code) (insn)->code) == INSN || ((enum rtx_code) (insn)->code) == JUMP_INSN)
 (((insn)->fld[5]).rtx) = remap_split_bivs (loop, (((insn)->fld[5]).rtx));
    }
  ...
  for (i = 0; i < unroll_number; i++)
    {
      memset ((char *) map->insn_map, 0, max_insnno * sizeof (rtx));
      memset ((char *) &((map->const_equiv_varray)->data.const_equiv[0]), 0,
 ...
 {
   insn = (((copy_start)->fld[1]).rtx);
   pattern = (((insn)->fld[5]).rtx);

   tem = get_label_from_map (map,
        (((((((((pattern)->fld[1]).rtx))->fld[0]).rtx))->fld[6]).rtint));

   (((pattern)->fld[1]).rtx) = gen_rtx_fmt_u00 (LABEL_REF, (VOIDmode), (tem));
...
# 1263 "../../../kgccfe/gnu/unroll.c"
  ...
  insn = (((copy_start)->fld[2]).rtx);
  while (insn != safety_label)
    {
# 1282 "../../../kgccfe/gnu/unroll.c"
      if (insn != start_label
   && ! (((enum rtx_code) (insn)->code) == CODE_LABEL && (((insn)->fld[7]).rtstr))
 ...
 insn = (((insn)->fld[2]).rtx);
  ...
  if ((((safety_label))->volatil))
    fancy_abort ("../../../kgccfe/gnu/unroll.c", 1294, __FUNCTION__);
     ...
     enum machine_mode *mode;
{
  ...
  if (loop_info->n_iterations > 0)
    {
      if ((((loop_info->increment)->fld[0]).rtwint) > 0)
 {
   *initial_value = (const_int_rtx[64]);
   *increment = (const_int_rtx[64 +1]);
   *final_value = gen_rtx_CONST_INT (VOIDmode, (long long) (loop_info->n_iterations));
 }
      else
 {
   *initial_value = gen_rtx_CONST_INT (VOIDmode, (long long) (loop_info->n_iterations));
   *increment = (const_int_rtx[64 -1]);
   *final_value = (const_int_rtx[64]);
      ...
      *mode = word_mode;
      ...
      if (loop_dump_stream)
 {
   fputs_unlocked ("Preconditioning: Success, number of iterations known, ", loop_dump_stream);
 ...
 fprintf (loop_dump_stream,
  ...
  else if ((exact_log2_wide ((unsigned long long) ((((loop_info->increment)->fld[0]).rtwint))) < 0)
    && (exact_log2_wide ((unsigned long long) (-(((loop_info->increment)->fld[0]).rtwint))) < 0))
    {
      if (loop_dump_stream)
 fprintf (loop_dump_stream,
 ...
 fprintf (loop_dump_stream,
  ...
  if ((((enum rtx_code) (loop_info->final_value)->code) == REG
       && (((loop_info->final_value)->fld[0]).rtuint) >= max_reg_before_loop)
      || (((enum rtx_code) (loop_info->final_value)->code) == PLUS
   && ((((((loop_info->final_value)->fld[0]).rtx))->fld[0]).rtuint) >= max_reg_before_loop)
 ...
 fprintf (loop_dump_stream,
  ...
  if ((mode_class[(int) (((enum machine_mode) (loop_info->final_value)->mode))]) == MODE_FLOAT
      || (mode_class[(int) (((enum machine_mode) (loop_info->initial_value)->mode))]) == MODE_FLOAT)
    {
      if (loop_dump_stream)
 fprintf (loop_dump_stream,
  ...
  if (uid_luid[(((reg_n_info)->data.reg[(((loop_info->iteration_var)->fld[0]).rtuint)])->first_uid)]
      > ((((loop_start)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop_start)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 1506, __FUNCTION__), -1)))
    {
      if (loop_dump_stream)
 fprintf (loop_dump_stream,
 ...
 *mode = word_mode;
    ...
    && ((mode_size[(int) (*mode)])
        < (mode_size[(int) (((enum machine_mode) (*initial_value)->mode))])))
    *mode = ((enum machine_mode) (*initial_value)->mode);
     ...
     int maxregnum;
{
  ...
  map->reg_map[(((176)) + 1)]
    = (cfun->emit->x_regno_reg_rtx)[(((176)) + 1)];
  map->reg_map[((176))]
    = (cfun->emit->x_regno_reg_rtx)[((176))];
}
# 1580 "../../../kgccfe/gnu/unroll.c"
static rtx
     ...
     unsigned int regno;
{
 ...
 retry:
  ...
  if (((enum rtx_code) ((((pattern)->fld[1]).rtx))->code) != PLUS)
    {


      src_insn = (((src_insn)->fld[1]).rtx);
      pattern = (((rtx_class[(int) (((enum rtx_code) (src_insn)->code))]) == 'i') ? (((enum rtx_code) ((((src_insn)->fld[5]).rtx))->code) == SET ? (((src_insn)->fld[5]).rtx) : single_set_2 (src_insn, (((src_insn)->fld[5]).rtx))) : (rtx) 0);
      if (((enum rtx_code) ((((pattern)->fld[1]).rtx))->code) != PLUS)
 fancy_abort ("../../../kgccfe/gnu/unroll.c", 1599, __FUNCTION__);
  ...
  increment = ((((((pattern)->fld[1]).rtx))->fld[1]).rtx);
        ...
        || ((enum rtx_code) (increment)->code) == LSHIFTRT)
 {
   ...
   rtx second_part = (((increment)->fld[1]).rtx);
   enum rtx_code code = ((enum rtx_code) (increment)->code);

   increment = find_last_value ((((increment)->fld[0]).rtx),
           &src_insn, (rtx) 0, 0);
   ...
   if (((enum rtx_code) (second_part)->code) != CONST_INT
     ...
     fancy_abort ("../../../kgccfe/gnu/unroll.c", 1647, __FUNCTION__);

   if (code == IOR)
     increment = gen_rtx_CONST_INT (VOIDmode, (long long) ((((increment)->fld[0]).rtwint) | (((second_part)->fld[0]).rtwint)));
   else if (code == PLUS)
     increment = gen_rtx_CONST_INT (VOIDmode, (long long) ((((increment)->fld[0]).rtwint) + (((second_part)->fld[0]).rtwint)));
   else if (code == ASHIFT)
     increment = gen_rtx_CONST_INT (VOIDmode, (long long) ((((increment)->fld[0]).rtwint) << (((second_part)->fld[0]).rtwint)));
   else
     increment = gen_rtx_CONST_INT (VOIDmode, (long long) ((unsigned long long) (((increment)->fld[0]).rtwint) >> (((second_part)->fld[0]).rtwint)));
 }

      if (((enum rtx_code) (increment)->code) != CONST_INT)
 fancy_abort ("../../../kgccfe/gnu/unroll.c", 1660, __FUNCTION__);
  ...
  if (increment_total)
    increment_total = gen_rtx_CONST_INT (VOIDmode, (long long) ((((increment_total)->fld[0]).rtwint) + (((increment)->fld[0]).rtwint)));
  else
    increment_total = increment;



  if (((enum rtx_code) (((((((pattern)->fld[1]).rtx))->fld[0]).rtx))->code) != REG
      || (((((((((pattern)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtuint) != regno)
    {
      ...
      if (tries == 0)
 {
   ...
   goto retry;
      ...
      fancy_abort ("../../../kgccfe/gnu/unroll.c", 1693, __FUNCTION__);
    }
     ...
     struct inline_remap *map;
{
  ...
  copy = rtx_alloc (((enum rtx_code) (notes)->code));
  ((copy)->mode = (enum machine_mode) ((enum machine_mode) (((enum reg_note) ((enum machine_mode) (notes)->mode)))));

  if (((enum rtx_code) (notes)->code) == EXPR_LIST)
    (((copy)->fld[0]).rtx) = copy_rtx_and_substitute ((((notes)->fld[0]).rtx), map, 0);
  else if (((enum rtx_code) (notes)->code) == INSN_LIST)

    (((copy)->fld[0]).rtx) = copy_rtx ((((notes)->fld[0]).rtx));
  else
    fancy_abort ("../../../kgccfe/gnu/unroll.c", 1722, __FUNCTION__);

  (((copy)->fld[1]).rtx) = initial_reg_note_copy ((((notes)->fld[1]).rtx), map);
     ...
     struct inline_remap *map;
{
      ...
      if (((enum rtx_code) (note)->code) == INSN_LIST)
 {
   ...
   if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_WAS_0)
     {
       *notesp = (((note)->fld[1]).rtx);
       continue;
     }
   else
     {
       rtx insn = map->insn_map[((((((note)->fld[0]).rtx))->fld[0]).rtint)];
       ...
       if (!insn)
  {
    if (((enum reg_note) ((enum machine_mode) (note)->mode)) != REG_LABEL)
      fancy_abort ("../../../kgccfe/gnu/unroll.c", 1760, __FUNCTION__);
  }
       else
         (((note)->fld[0]).rtx) = insn;
     }
     ...
     rtx start_label, loop_end, insert_before, copy_notes_from;
{
  ...
  if (! last_iteration)
    {
      ...
      ((map)->label_map[(((start_label)->fld[6]).rtint)] = (final_label));
    }
  else
    ((map)->label_map[(((start_label)->fld[6]).rtint)] = (start_label));
 ...
 case INSN:
   ...
   copy = 0;
   giv_inc = 0;
# 1834 "../../../kgccfe/gnu/unroll.c"
   if ((set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0))
       && ((enum rtx_code) ((((set)->fld[0]).rtx))->code) == REG
       && addr_combined_regs[((((((set)->fld[0]).rtx))->fld[0]).rtuint)])
     {
       struct iv_class *bl;
       struct induction *v, *tv;
       unsigned int regno = ((((((set)->fld[0]).rtx))->fld[0]).rtuint);

       v = addr_combined_regs[((((((set)->fld[0]).rtx))->fld[0]).rtuint)];
  ...
  if (tv->giv_type == DEST_ADDR && tv->same == v)
    {
      ...
      this_giv_inc = (((giv_inc)->fld[0]).rtwint);
      if (tv->mult_val != v->mult_val)
        this_giv_inc = (this_giv_inc / (((v->mult_val)->fld[0]).rtwint)
          * (((tv->mult_val)->fld[0]).rtwint));

      tv->dest_reg = plus_constant_wide ((tv->dest_reg), (long long) (this_giv_inc));
   ...
   if (((enum rtx_code) (tv->dest_reg)->code) == REG)
     ...
     dest_reg = (((tv->dest_reg)->fld[0]).rtx);
   ...
   if (! tv->same_insn && ! tv->shared)
     {
       ...
       value = plus_constant_wide ((tv->dest_reg), (long long) (tv->const_adjust));
    ...
    emit_unrolled_add (dest_reg, (((value)->fld[0]).rtx),
         (((value)->fld[1]).rtx));
         }
     }
   ...
   tv->dest_reg = plus_constant_wide ((dest_reg), (long long) (-tv->const_adjust));
   ...
   *tv->location = tv->dest_reg;
   ...
   if ((set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0))
       && ((enum rtx_code) ((((set)->fld[0]).rtx))->code) == REG
       && splittable_regs[((((((set)->fld[0]).rtx))->fld[0]).rtuint)])
     {
       unsigned int regno = ((((((set)->fld[0]).rtx))->fld[0]).rtuint);
  ...
  giv_inc = calculate_giv_inc (set, insn, regno);
       ...
       src_regno = (((giv_src_reg)->fld[0]).rtuint);
       ...
       if (unroll_type == UNROLL_COMPLETELY)
  {
    ...
    splittable_regs[regno]
      = plus_constant_wide ((splittable_regs[src_regno]), (long long) ((((giv_inc)->fld[0]).rtwint)));


    if (((enum rtx_code) (splittable_regs[regno])->code) == PLUS)
      {
        giv_src_reg = (((splittable_regs[regno])->fld[0]).rtx);
        giv_inc = (((splittable_regs[regno])->fld[1]).rtx);
      }
    else
      {
...
# 2018 "../../../kgccfe/gnu/unroll.c"
    if (! last_iteration
        || (splittable_regs_updates[regno]-- != 1))
      {
        ...
        record_base_value ((((tem)->fld[0]).rtuint),
      giv_inc == (const_int_rtx[64])
      ? giv_src_reg
   ...
   (((copy)->fld[8]).rtx) = initial_reg_note_copy ((((insn)->fld[8]).rtx), map);
   ...
   if ((tem = find_reg_note (copy, REG_EQUAL, (rtx) 0))
       && !loop_invariant_p (loop, (((tem)->fld[0]).rtx)))
     remove_note (copy, tem);
# 2080 "../../../kgccfe/gnu/unroll.c"
 ...
 case JUMP_INSN:
   ...
   if ((((insn)->fld[9]).rtx))
     {
       (((copy)->fld[9]).rtx) = get_label_from_map (map,
            ((((((insn)->fld[9]).rtx))->fld[6]).rtint));

       ((((((copy)->fld[9]).rtx))->fld[4]).rtint)++;
     }
   if ((((insn)->fld[9]).rtx) == start_label && insn == copy_end
       && ! last_iteration)
     {
       ...
       if (!invert_jump (copy, exit_label, 0))
  {
    ...
    (((jmp)->fld[9]).rtx) = exit_label;
    (((exit_label)->fld[4]).rtint)++;
    jmp = emit_barrier_after (jmp);
    emit_label_after (lab, jmp);
    (((lab)->fld[4]).rtint) = 0;
    if (!redirect_jump (copy, lab, 0))
      fancy_abort ("../../../kgccfe/gnu/unroll.c", 2135, __FUNCTION__);
  }
     }
   ...
   if ((((insn)->fld[9]).rtx))
     {
       ...
       if ((set = (((rtx_class[(int) (((enum rtx_code) (copy)->code))]) == 'i') ? (((enum rtx_code) ((((copy)->fld[5]).rtx))->code) == SET ? (((copy)->fld[5]).rtx) : single_set_2 (copy, (((copy)->fld[5]).rtx))) : (rtx) 0)))
  {
    tem = (((set)->fld[1]).rtx);
    if (((enum rtx_code) (tem)->code) == LABEL_REF)
      ...
      {
        if ((((tem)->fld[1]).rtx) != (global_rtl[GR_PC]))
   label = ((((((tem)->fld[1]).rtx))->fld[0]).rtx);
        else
   label = ((((((tem)->fld[2]).rtx))->fld[0]).rtx);
      }
  }

       if (label && ((enum rtx_code) (label)->code) == CODE_LABEL)
  (((copy)->fld[9]).rtx) = label;
       else
  {
   ...
   else if (((enum rtx_code) ((((copy)->fld[5]).rtx))->code) == ADDR_VEC
     || ((enum rtx_code) ((((copy)->fld[5]).rtx))->code) == ADDR_DIFF_VEC)
     {
       rtx pat = (((copy)->fld[5]).rtx);
       int diff_vec_p = ((enum rtx_code) (pat)->code) == ADDR_DIFF_VEC;
       int len = (((((pat)->fld[diff_vec_p]).rtvec))->num_elem);
       int i;

       for (i = 0; i < len; i++)
  (((((((((((pat)->fld[diff_vec_p]).rtvec))->elem[i]))->fld[0]).rtx))->fld[4]).rtint)++;
     }
 ...
 case NOTE:
   ...
   if ((((insn)->fld[5]).rtint) != NOTE_INSN_DELETED
       && (((insn)->fld[5]).rtint) != NOTE_INSN_DELETED_LABEL
       && (((insn)->fld[5]).rtint) != NOTE_INSN_BASIC_BLOCK
       && (((((insn)->fld[5]).rtint) != NOTE_INSN_LOOP_VTOP
     && (((insn)->fld[5]).rtint) != NOTE_INSN_LOOP_CONT)
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/unroll.c", 2283, __FUNCTION__);
 }
  ...
  do
   ...
   && map->insn_map[(((insn)->fld[0]).rtint)])
 final_reg_note_copy (&(((map->insn_map[(((insn)->fld[0]).rtint)])->fld[8]).rtx), map);
    }
  while (insn != copy_end);
# 2312 "../../../kgccfe/gnu/unroll.c"
  if (! last_iteration)
    {
      for (insn = copy_notes_from; insn != loop_end; insn = (((insn)->fld[2]).rtx))
 {
   ...
   if (((enum rtx_code) (insn)->code) == NOTE
       ...
       && (((insn)->fld[5]).rtint) != NOTE_INSN_LOOP_VTOP
       && (((insn)->fld[5]).rtint) != NOTE_INSN_LOOP_CONT)
     emit_note ((((insn)->fld[4]).rtstr), (((insn)->fld[5]).rtint));
 }
    }

  if (final_label && (((final_label)->fld[4]).rtint) > 0)
     ...
     rtx insn;
{
  ...
  for (p = (((insn)->fld[2]).rtx); p != loop_end; p = (((p)->fld[2]).rtx))
    {
      if (((enum rtx_code) (p)->code) == JUMP_INSN)
 {
   target_insn = (((p)->fld[9]).rtx);




   for (q = loop_start; q != insn; q = (((q)->fld[2]).rtx))
     if (q == target_insn)
       return 1;
 }
    }
     ...
     enum machine_mode mode;
{
  ...
  if ((((enum machine_mode) (mult1)->mode) != mode && ((enum machine_mode) (mult1)->mode) != VOIDmode)
    ...
    fancy_abort ("../../../kgccfe/gnu/unroll.c", 2425, __FUNCTION__);
     ...
     const struct iv_class *bl;
{
  struct induction *v;
  rtx result;
# 2475 "../../../kgccfe/gnu/unroll.c"
  result = (const_int_rtx[64]);
  for (v = bl->biv; v; v = v->next_iv)
    {
      if (v->always_computable && v->mult_val == (const_int_rtx[64 +1])
   && ! v->maybe_multiple
   && ((mode_class[(int) (v->mode)]) == MODE_INT || (mode_class[(int) (v->mode)]) == MODE_PARTIAL_INT))
     ...
     int unroll_number;
{
 ...
 continue;
# 2545 "../../../kgccfe/gnu/unroll.c"
      biv_splittable = 1;
      biv_final_value = 0;
      if (unroll_type != UNROLL_COMPLETELY
   && (loop->exit_count || unroll_type == UNROLL_NAIVE)
   && (uid_luid[(((reg_n_info)->data.reg[bl->regno])->last_uid)] >= ((((loop->end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 2549, __FUNCTION__), -1))
       || ! bl->init_insn
       || (((bl->init_insn)->fld[0]).rtint) >= max_uid_for_loop
       || (uid_luid[(((reg_n_info)->data.reg[bl->regno])->first_uid)]
    < ((((bl->init_insn)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((bl->init_insn)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 2553, __FUNCTION__), -1)))
 ...
 if ((tem = (((rtx_class[(int) (((enum rtx_code) (v->insn)->code))]) == 'i') ? (((enum rtx_code) ((((v->insn)->fld[5]).rtx))->code) == SET ? (((v->insn)->fld[5]).rtx) : single_set_2 (v->insn, (((v->insn)->fld[5]).rtx))) : (rtx) 0)) == 0
     || ((enum rtx_code) ((((tem)->fld[0]).rtx))->code) != REG
     || ((((((tem)->fld[0]).rtx))->fld[0]).rtuint) != bl->regno
     || ((enum rtx_code) ((((tem)->fld[1]).rtx))->code) != PLUS)
   biv_splittable = 0;
# 2575 "../../../kgccfe/gnu/unroll.c"
      if (biv_splittable == 1)
 {
   if (unroll_type == UNROLL_COMPLETELY)
     {
    ...
    && ((((bl->initial_value)->fld[0]).rtuint) == bl->regno
        || (((bl->initial_value)->fld[0]).rtuint) < 176
        || ! loop_invariant_p (loop, bl->initial_value)))
  {
    rtx tem = gen_reg_rtx (bl->biv->mode);

    record_base_value ((((tem)->fld[0]).rtuint), bl->biv->add_val, 0);
      ...
      if (biv_final_value)
 {
  ...
  fprintf (loop_dump_stream, "Biv %d mapped to %d for split.\n",
    (((bl->biv->src_reg)->fld[0]).rtuint), (((tem)->fld[0]).rtuint));
...
find_splittable_givs (loop, bl, unroll_type, increment, unroll_number)
     ...
     enum unroll_types unroll_type;
     rtx increment;
     int unroll_number __attribute__ ((__unused__));
{
  struct loop_ivs *ivs = (&((struct loop_info *) (loop)->aux)->ivs);
...
# 2730 "../../../kgccfe/gnu/unroll.c"
   ...
   && ((((v->dest_reg)->fld[0]).rtuint) >= max_reg_before_loop
       || ((((reg_n_info)->data.reg[(((v->dest_reg)->fld[0]).rtuint)])->first_uid) != (((v->insn)->fld[0]).rtint)



    && (! (tem = find_reg_note (v->insn, REG_RETVAL, (rtx) 0))
        || ((((reg_n_info)->data.reg[(((v->dest_reg)->fld[0]).rtuint)])->first_uid)
     != ((((((tem)->fld[0]).rtx))->fld[0]).rtint))))

       || (uid_luid[(((reg_n_info)->data.reg[(((v->dest_reg)->fld[0]).rtuint)])->last_uid)]
    >= ((((loop->end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 2747, __FUNCTION__), -1))))
   && ! (final_value = v->final_value))
 continue;
# 2779 "../../../kgccfe/gnu/unroll.c"
      if (unroll_type == UNROLL_COMPLETELY)
 {
  ...
  fprintf (loop_dump_stream,
    "giv combined with unreduced giv not split.\n");
   ...
   else if (v->giv_type == DEST_REG)
     {
       ...
       if (unroll_type == UNROLL_COMPLETELY
    && ((enum rtx_code) (value)->code) != CONST_INT
    && ((enum rtx_code) (value)->code) != REG
    && (((enum rtx_code) (value)->code) != PLUS
        || ((enum rtx_code) ((((value)->fld[0]).rtx))->code) != REG
        || ((enum rtx_code) ((((value)->fld[1]).rtx))->code) != CONST_INT))
  {
    rtx tem = gen_reg_rtx (v->mode);
    record_base_value ((((tem)->fld[0]).rtuint), v->add_val, 0);
...
# 2865 "../../../kgccfe/gnu/unroll.c"
      ...
      if (((enum rtx_code) (v->new_reg)->code) == REG)
 {
   int count = 1;
   if (! v->ignore)
     count = ivs->regs[(((v->src_reg)->fld[0]).rtuint)].iv.class->biv_count;
      ...
      if (loop_dump_stream)
 {
   ...
   if (((enum rtx_code) (v->dest_reg)->code) == CONST_INT)
     ...
     regnum = ((((((v->dest_reg)->fld[0]).rtx))->fld[0]).rtuint);
   else
     regnum = (((v->dest_reg)->fld[0]).rtuint);
   fprintf (loop_dump_stream, "Giv %d at insn %d safe to split.\n",
     regnum, (((v->insn)->fld[0]).rtint));
 }
    }

  return result;
}
# 2911 "../../../kgccfe/gnu/unroll.c"
static int
     ...
     rtx reg;
{
  ...
  (((label)->fld[1]).rtx) = loop->exit_labels;

  for (; label; label = (((label)->fld[1]).rtx))
    {




      insn = ((((((label)->fld[0]).rtx))->fld[2]).rtx);
      while (insn)
 {
  ...
  return 0;
       ...
       if (note && reg_overlap_mentioned_p (reg, (((note)->fld[0]).rtx)))
  return 0;
       ...
       if (set && rtx_equal_p ((((set)->fld[0]).rtx), reg))
  break;
     }
...
final_biv_value (loop, bl)
     ...
     struct iv_class *bl;
{
  unsigned long long n_iterations = ((struct loop_info *) (loop)->aux)->n_iterations;
  rtx increment, tem;



  if ((mode_class[(int) (bl->biv->mode)]) != MODE_INT)
    return 0;
      ...
      if (increment && loop_invariant_p (loop, increment))
 {
   ...
   record_base_value ((((tem)->fld[0]).rtuint), bl->biv->add_val, 0);
   loop_iv_add_mult_sink (loop, increment, gen_rtx_CONST_INT (VOIDmode, (long long) (n_iterations)),
     ...
     struct induction *v;
{
 ...
 fprintf (loop_dump_stream,
   ...
   (((v->dest_reg)->fld[0]).rtuint));
      return (const_int_rtx[64]);
    }
# 3099 "../../../kgccfe/gnu/unroll.c"
  if (n_iterations != 0
      && ! loop->exit_count
      && v->always_executed)
    {
# 3114 "../../../kgccfe/gnu/unroll.c"
      increment = biv_total_increment (bl);

      if (increment && loop_invariant_p (loop, increment)
   && loop_invariant_p (loop, bl->initial_value))
 {
# 3130 "../../../kgccfe/gnu/unroll.c"
   tem = gen_reg_rtx (v->mode);
   record_base_value ((((tem)->fld[0]).rtuint), bl->biv->add_val, 0);
   loop_iv_add_mult_sink (loop, extend_value_for_giv (v, increment),
     gen_rtx_CONST_INT (VOIDmode, (long long) (n_iterations)),
     extend_value_for_giv (v, bl->initial_value),
     tem);


   for (insn = (((v->insn)->fld[2]).rtx); insn != loop_end;
        insn = (((insn)->fld[2]).rtx))
     {
       struct induction *biv;
  ...
  if (v->replaceable)
    fancy_abort ("../../../kgccfe/gnu/unroll.c", 3170, __FUNCTION__);
     ...
     rtx reg;
{
  ...
  ret = reg;
  for (insn = (((loop_start)->fld[1]).rtx); insn; insn = (((insn)->fld[1]).rtx))
    {
      if (((enum rtx_code) (insn)->code) == CODE_LABEL)
 break;

      else if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && reg_set_p (reg, insn))
 {
   ...
   if ((set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0))
       && ((((set)->fld[0]).rtx) == reg))
     {
       ...
       if (note && ((enum rtx_code) ((((note)->fld[0]).rtx))->code) != EXPR_LIST
  ...
  if (((enum rtx_code) (op)->code) == PLUS)
    {
      if ((((op)->fld[0]).rtx) == reg)
 return (((op)->fld[1]).rtx);
      else if ((((op)->fld[1]).rtx) == reg)
 return (((op)->fld[0]).rtx);
    }

  fancy_abort ("../../../kgccfe/gnu/unroll.c", 3259, __FUNCTION__);
}
     ...
     rtx op0, op1;
{
 ...
 op01 = (((op0)->fld[1]).rtx), op00 = (((op0)->fld[0]).rtx);
      else
 op01 = (const_int_rtx[64]), op00 = op0;

      if (((enum rtx_code) (op1)->code) == PLUS)
 op11 = (((op1)->fld[1]).rtx), op10 = (((op1)->fld[0]).rtx);
      else
     ...
     struct loop *loop;
{
  ...
  enum rtx_code comparison_code;
  long long inc;
  unsigned long long abs_inc;
  unsigned long long abs_diff;
  int off_by_one;
  int increment_dir;
  ...
  last_loop_insn = (((loop->end)->fld[1]).rtx);
 ...
 fprintf (loop_dump_stream,
  ...
  if (((((((last_loop_insn)->fld[9]).rtx))->fld[4]).rtint) > 1)
    {
      if (loop_dump_stream)
 fprintf (loop_dump_stream,
  ...
  if (loop->top && loop->cont)
    {
      rtx temp = (((last_loop_insn)->fld[1]).rtx);
      ...
      do
 {
       ...
       if ((((temp)->fld[9]).rtx) == 0)
  {
    ...
    ((((((temp)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop

    && (((((((temp)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((((temp)->fld[9]).rtx))->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 3384, __FUNCTION__), -1)) > ((((loop->top)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->top)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 3384, __FUNCTION__), -1))
    && (((((((temp)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((((temp)->fld[9]).rtx))->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 3385, __FUNCTION__), -1)) < ((((loop->cont)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->cont)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/unroll.c", 3385, __FUNCTION__), -1)))
  {
    if (loop_dump_stream)
      fprintf
        (loop_dump_stream,
    ...
    return 0;
      ...
      while ((temp = (((temp)->fld[1]).rtx)) != loop->cont);
    }
 ...
 fprintf (loop_dump_stream,
  ...
  iteration_var = (((comparison)->fld[0]).rtx);
 ...
 fprintf (loop_dump_stream,
  ...
  if ((unsigned) (((iteration_var)->fld[0]).rtuint) >= ivs->n_regs
      && ! (((iteration_var))->volatil))
    fancy_abort ("../../../kgccfe/gnu/unroll.c", 3434, __FUNCTION__);
 ...
 fprintf (loop_dump_stream,
  ...
  else if (((mode_bitsize[(int) (((enum machine_mode) (iteration_var)->mode))])
     > (8 * 8)))
    {
      if (loop_dump_stream)
 fprintf (loop_dump_stream,
  ...
  else if ((mode_class[(int) (((enum machine_mode) (iteration_var)->mode))]) != MODE_INT)
    {
      if (loop_dump_stream)
 fprintf (loop_dump_stream,
  ...
  else if (ivs->regs[(((iteration_var)->fld[0]).rtuint)].type == BASIC_INDUCT)
    {
      if ((((iteration_var)->fld[0]).rtuint) >= ivs->n_regs)
 fancy_abort ("../../../kgccfe/gnu/unroll.c", 3479, __FUNCTION__);


      bl = ivs->regs[(((iteration_var)->fld[0]).rtuint)].iv.class;
      ...
      if (!bl->biv->always_executed || bl->biv->maybe_multiple)
 {
  ...
  else if (ivs->regs[(((iteration_var)->fld[0]).rtuint)].type == GENERAL_INDUCT)
    {
      long long offset = 0;
      struct induction *v = ivs->regs[(((iteration_var)->fld[0]).rtuint)].iv.info;
      rtx biv_initial_value;

      if ((((v->src_reg)->fld[0]).rtuint) >= ivs->n_regs)
 fancy_abort ("../../../kgccfe/gnu/unroll.c", 3501, __FUNCTION__);
      ...
      if (increment)
 {
       ...
       if (loop_insn_first_p (v->insn, biv_inc->insn))
  {
   ...
   fprintf (loop_dump_stream,
     ...
     (((biv_inc->add_val)->fld[0]).rtuint));
   return 0;
      }

    offset -= (((biv_inc->add_val)->fld[0]).rtwint);
  }
     }
 }
      if (loop_dump_stream)
 ...
 = fold_rtx_mult_add (v->mult_val,
        plus_constant_wide ((biv_initial_value), (long long) (offset)),
        v->add_val, v->mode);
    }
  else
    {
 ...
 fprintf (loop_dump_stream,
  ...
  switch (comparison_code)
    ...
    case NE:
      ...
      break;
    default:
      fancy_abort ("../../../kgccfe/gnu/unroll.c", 3603, __FUNCTION__);
    }
...
# 3630 "../../../kgccfe/gnu/unroll.c"
  if (off_by_one)
    final_value = plus_constant_wide ((final_value), (long long) (off_by_one));
# 3642 "../../../kgccfe/gnu/unroll.c"
  loop_info->initial_value = initial_value;
  loop_info->comparison_value = comparison_value;
  loop_info->final_value = plus_constant_wide ((comparison_value), (long long) (off_by_one));
 ...
 reg2 = (((final_value)->fld[0]).rtx), const2 = (((final_value)->fld[1]).rtx);
      else
 ...
 {
   rtx temp;
# 3704 "../../../kgccfe/gnu/unroll.c"
   temp = loop_find_equiv_value (loop, reg1);

   if (((enum rtx_code) (temp)->code) == MINUS && (((enum rtx_code) ((((temp)->fld[0]).rtx))->code) == REG))
     {
       rtx temp2 = loop_find_equiv_value (loop, (((temp)->fld[0]).rtx));

       if (((enum rtx_code) (temp2)->code) == PLUS
    && (((temp2)->fld[0]).rtx) == (((temp)->fld[1]).rtx))
  initial_value = (((temp2)->fld[1]).rtx);
     }
 }
    }
# 3726 "../../../kgccfe/gnu/unroll.c"
  if (loop->vtop
 ...
 fprintf (loop_dump_stream, "Loop iterations: EQ comparison loop.\n");
      ...
      inc_once = gen_int_mode ((((initial_value)->fld[0]).rtwint) + (((increment)->fld[0]).rtwint),
 ...
 loop_info->final_value
   = gen_int_mode (((((loop_info->initial_value)->fld[0]).rtwint)
      + loop_info->n_iterations * (((increment)->fld[0]).rtwint)),
     ((enum machine_mode) (iteration_var)->mode));
      else
 loop_info->final_value
   = plus_constant_wide ((loop_info->initial_value), (long long) (loop_info->n_iterations * (((increment)->fld[0]).rtwint)));

      loop_info->final_equiv_value
 = gen_int_mode (((((initial_value)->fld[0]).rtwint)
    + loop_info->n_iterations * (((increment)->fld[0]).rtwint)),
   ((enum machine_mode) (iteration_var)->mode));
  ...
  if (unsigned_p)
    final_larger
      = ((unsigned long long) (((final_value)->fld[0]).rtwint)
  > (unsigned long long) (((initial_value)->fld[0]).rtwint))
 - ((unsigned long long) (((final_value)->fld[0]).rtwint)
    < (unsigned long long) (((initial_value)->fld[0]).rtwint));
  else
    final_larger = ((((final_value)->fld[0]).rtwint) > (((initial_value)->fld[0]).rtwint))
      - ((((final_value)->fld[0]).rtwint) < (((initial_value)->fld[0]).rtwint));

  if ((((increment)->fld[0]).rtwint) > 0)
    increment_dir = 1;
  else if ((((increment)->fld[0]).rtwint) == 0)
    increment_dir = 0;
  else
    increment_dir = -1;
# 3877 "../../../kgccfe/gnu/unroll.c"
 ...
 fprintf (loop_dump_stream, "Loop iterations: Not normal loop.\n");
  ...
  inc = (((increment)->fld[0]).rtwint);
  if (inc > 0)
    {
      abs_diff = (((final_value)->fld[0]).rtwint) - (((initial_value)->fld[0]).rtwint);
      abs_inc = inc;
    }
  else if (inc < 0)
    {
      abs_diff = (((initial_value)->fld[0]).rtwint) - (((final_value)->fld[0]).rtwint);
      abs_inc = -inc;
    }
  else
    fancy_abort ("../../../kgccfe/gnu/unroll.c", 3904, __FUNCTION__);





  abs_diff &= ((unsigned long long) 1
        << ((mode_bitsize[(int) (((enum machine_mode) (iteration_var)->mode))]) - 1)
        << 1) - 1;
     ...
     rtx x;
{
  ...
  switch (code)
    ...
    case REG:
      ...
      if ((((x)->fld[0]).rtuint) < ivs->n_regs
   && ivs->regs[(((x)->fld[0]).rtuint)].type == BASIC_INDUCT)
 return ivs->regs[(((x)->fld[0]).rtuint)].iv.class->biv->src_reg;
      break;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 (((x)->fld[i]).rtx) = remap_split_bivs (loop, (((x)->fld[i]).rtx));
      else if (fmt[i] == 'E')
 {
   int j;
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     (((((x)->fld[i]).rtvec))->elem[j]) = remap_split_bivs (loop, (((((x)->fld[i]).rtvec))->elem[j]));
 }
    }
  return x;
}
# 4002 "../../../kgccfe/gnu/unroll.c"
int
...
{
  int passed_jump = 0;
  rtx p = (((copy_start)->fld[2]).rtx);

  while ((((p)->fld[0]).rtint) != first_uid)
    {
      if (((enum rtx_code) (p)->code) == JUMP_INSN)
 passed_jump = 1;
 ...
 return 0;
  ...
  if (! ((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i') || ! dead_or_set_regno_p (p, regno))
    return 0;
     ...
     rtx loop_cont;
{
  ...
  if ((((label)->fld[6]).rtint) == ((((((label_ref)->fld[0]).rtx))->fld[6]).rtint))
    return loop_start;
  else
    return (rtx) 0;
}
