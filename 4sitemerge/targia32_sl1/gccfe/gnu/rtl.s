...
.globl mode_bitsize
	.align 32
	.type	mode_bitsize, @object
	.size	mode_bitsize, 108
mode_bitsize:
	.value	0
	.value	1
	.value	8
...
.globl mode_unit_size
	.align 32
	.type	mode_unit_size, @object
	.size	mode_unit_size, 54
mode_unit_size:
	.byte	0
	.byte	1
	.byte	1
...
.globl mode_wider_mode
	.align 32
	.type	mode_wider_mode, @object
	.size	mode_wider_mode, 54
mode_wider_mode:
	.byte	0
	.byte	2
	.byte	3
...
.globl mode_mask_array
	.align 32
	.type	mode_mask_array, @object
	.size	mode_mask_array, 432
mode_mask_array:
	.long	0
	.long	0
	.long	1
...
.globl inner_mode_array
	.align 32
	.type	inner_mode_array, @object
	.size	inner_mode_array, 216
inner_mode_array:
	.long	0
	.long	0
	.long	0
...
.globl class_narrowest_mode
	.align 32
	.type	class_narrowest_mode, @object
...
.LC287:
	...
	.section	.data.rel.ro.local
	.align 32
	.type	note_insn_name, @object
	.size	note_insn_name, 80
note_insn_name:
	.long	.LC253
	.long	.LC269
	.long	.LC270
...
.LC316:
	...
	.section	.data.rel.ro.local
	.align 32
	.type	reg_note_name, @object
	.size	reg_note_name, 120
reg_note_name:
	.long	.LC253
	.long	.LC288
	.long	.LC289
...
.LCFI8:
	...
	ret
.LFE16:
	.size	rtx_alloc, .-rtx_alloc
	.section	.rodata
	.type	__FUNCTION__.8485, @object
	.size	__FUNCTION__.8485, 9
__FUNCTION__.8485:
	.string	"copy_rtx"
.LC317:
	.string	"../../../kgccfe/gnu/rtl.c"
	.text
.globl copy_rtx
...
.L18:
	.loc 1 378 0
	leal	__FUNCTION__.8485@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$378, 4(%esp)
...
.LCFI20:
	...
	ret
.LFE18:
	.size	shallow_copy_rtx, .-shallow_copy_rtx
	.section	.rodata
	.type	__FUNCTION__.8603, @object
	.size	__FUNCTION__.8603, 12
__FUNCTION__.8603:
	.string	"rtx_equal_p"
	.text
.globl rtx_equal_p
...
.L58:
	.loc 1 519 0
	leal	__FUNCTION__.8603@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$519, 4(%esp)
	leal	.LC317@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LLST4:
	...
	.byte	0x5
	.byte	0x3
	.long	__FUNCTION__.8485
	.byte	0x0
	.uleb128 0x19
	.long	0x11cd
	.byte	0x1
	.string	"shallow_copy_rtx"
	.byte	0x1
	.value	0x185
	.byte	0x1
	.long	0x98
