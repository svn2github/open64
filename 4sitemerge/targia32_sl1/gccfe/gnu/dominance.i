     ...
     enum cdi_direction reverse;
{
      ...
      while (e)
 {
       ...
       if (bn == ex_block || di->dfs_order[bn->index])
  {
   ...
   if (bn == en_block)
     fancy_abort ("../../../kgccfe/gnu/dominance.c", 279, __FUNCTION__);
     ...
     enum cdi_direction reverse;
{
      ...
      for (b = (&entry_exit_blocks[1])->prev_bb; b != (&entry_exit_blocks[0]); b = b->prev_bb)
 {
  ...
  if (di->nodes != (unsigned int) n_basic_blocks + 1)
    fancy_abort ("../../../kgccfe/gnu/dominance.c", 356, __FUNCTION__);
}
     ...
     basic_block bb, dominated_by;
{
  ...
  if (dominated_by != ((void *)0))
    {
      if (bb == dominated_by)
 fancy_abort ("../../../kgccfe/gnu/dominance.c", 642, __FUNCTION__);
      if (!et_forest_add_edge (dom->forest, ((et_forest_node_t)(((dom)->varray)->data.generic[(dominated_by)->index + 2])), bb_node))
 fancy_abort ("../../../kgccfe/gnu/dominance.c", 644, __FUNCTION__);
    }
}
     ...
     dominance_info dom;
{
      ...
      if (dom_bb != get_immediate_dominator (dom, bb))
 {
  ...
  if (err)
    fancy_abort ("../../../kgccfe/gnu/dominance.c", 734, __FUNCTION__);
}
