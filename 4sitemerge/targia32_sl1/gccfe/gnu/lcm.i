...
# 59 "../../../kgccfe/gnu/lcm.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 60 "../../../kgccfe/gnu/lcm.c" 2
     ...
     sbitmap *antout;
{
 ...
 for (e = bb->pred; e; e = e->pred_next)
   if (!e->src->aux && e->src != (&entry_exit_blocks[0]))
     {
       *qin++ = e->src;
       e->src->aux = e;
       qlen++;
  ...
  for (x = 0; x < num_edges; x++)
    {
      ...
      if (pred == (&entry_exit_blocks[0]))
 sbitmap_copy (earliest[x], antin[succ->index]);
      else
 {
   if (succ == (&entry_exit_blocks[1]))
...
# 289 "../../../kgccfe/gnu/lcm.c"
 ...
 if (sbitmap_union_of_diff_cg (later[(size_t) e->aux],
     ...
     && e->dest != (&entry_exit_blocks[1]) && e->dest->aux == 0)
   {
     *qin++ = e->dest;
     e->dest->aux = e;
     qlen++;
  ...
  for (e = (&entry_exit_blocks[1])->pred; e != ((void *)0); e = e->pred_next)
     ...
     sbitmap *avloc, *kill, *avout, *avin;
{
  ...
  for (e = (&entry_exit_blocks[0])->succ; e; e = e->succ_next)
    e->dest->aux = (&entry_exit_blocks[0]);
 ...
 for (e = bb->succ; e; e = e->succ_next)
   if (!e->dest->aux && e->dest != (&entry_exit_blocks[1]))
     {
       *qin++ = e->dest;
       e->dest->aux = e;
       qlen++;
     ...
     sbitmap *farthest, *st_avloc, *nearer, *nearerout;
{
 ...
 if (sbitmap_union_of_diff_cg (nearer[(size_t) e->aux],
     ...
     && e->src != (&entry_exit_blocks[0]) && e->src->aux == 0)
   {
     *tos++ = e->src;
     e->src->aux = e;
   }
  ...
  for (e = (&entry_exit_blocks[0])->succ; e != ((void *)0); e = e->succ_next)
...
# 814 "../../../kgccfe/gnu/lcm.c"
  ...
  *delete = sbitmap_vector_alloc (last_basic_block, n_exprs);
  ...
  free(nearerout);
  free(nearer);
# 832 "../../../kgccfe/gnu/lcm.c"
  return edge_list;
}
# 863 "../../../kgccfe/gnu/lcm.c"
struct seginfo
{
  int mode;
  rtx insn_ptr;
