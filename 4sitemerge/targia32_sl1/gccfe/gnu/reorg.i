...
# 130 "../../../kgccfe/gnu/reorg.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 131 "../../../kgccfe/gnu/reorg.c" 2
# 1 "../../../kgccfe/gnu/conditions.h" 1
# 132 "../../../kgccfe/gnu/reorg.c" 2
     ...
     int labels_p;
{
  ...
  switch (((enum rtx_code) (insn)->code))
    ...
    case INSN:
      ...
      return (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SEQUENCE
       || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == ASM_INPUT
       || asm_noperands ((((insn)->fld[5]).rtx)) >= 0);

    default:
      fancy_abort ("../../../kgccfe/gnu/reorg.c", 260, __FUNCTION__);
    }
}
     ...
     int include_delayed_effects;
{
  ...
  do { (&insn_res)->memory = (&insn_res)->unch_memory = (&insn_res)->volatil = (&insn_res)->cc = 0; do { HARD_REG_ELT_TYPE *scan_tp_ = ((&insn_res)->regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); } while (0);
     ...
     int include_delayed_effects;
{
  ...
  do { (&insn_sets)->memory = (&insn_sets)->unch_memory = (&insn_sets)->volatil = (&insn_sets)->cc = 0; do { HARD_REG_ELT_TYPE *scan_tp_ = ((&insn_sets)->regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); } while (0);
...
find_end_label ()
{
  ...
  if (((enum rtx_code) (insn)->code) == BARRIER
      && ((enum rtx_code) ((((insn)->fld[1]).rtx))->code) == JUMP_INSN
      && ((enum rtx_code) (((((((insn)->fld[1]).rtx))->fld[5]).rtx))->code) == RETURN)
    {
      rtx temp = ((((((insn)->fld[1]).rtx))->fld[1]).rtx);
      end_of_function_label = gen_label_rtx ();
      (((end_of_function_label)->fld[4]).rtint) = 0;


      while (((enum rtx_code) (temp)->code) == USE)
 temp = (((temp)->fld[1]).rtx);
  ...
  else
    {
      ...
      while (insn && ! (((enum rtx_code) (insn)->code) == JUMP_INSN
      ...
      if (insn)
 {
   ...
   while (((enum rtx_code) (insn)->code) == USE)
     insn = (((insn)->fld[1]).rtx);
      ...
      else
 {
  ...
  __extension__ ({ struct obstack *__o = (&unfilled_slots_obstack); if (__o->next_free + sizeof (void *) > __o->chunk_limit) _obstack_newchunk (__o, sizeof (void *)); *((void **)__o->next_free) = ((void *)insn); (__o->next_free) += 4 ; (void) 0; });
     }
  ...
  ++(((end_of_function_label)->fld[4]).rtint);

  return end_of_function_label;
}
# 430 "../../../kgccfe/gnu/reorg.c"
static rtx
     ...
     int length;
{
  ...
  rtx seq = gen_rtx_fmt_E (SEQUENCE, (VOIDmode), (seqv));
  ...
  if ((((insn)->fld[2]).rtx) && ((enum rtx_code) ((((insn)->fld[2]).rtx))->code) == BARRIER)
    {
      delete_related_insns ((((insn)->fld[2]).rtx));
      last = get_last_insn ();
      had_barrier = 1;
    }
  ...
  (((((seq)->fld[0]).rtvec))->elem[0]) = delay_insn;
  ...
  for (li = list; li; li = (((li)->fld[1]).rtx), i++)
    {
      ...
      (((((seq)->fld[0]).rtvec))->elem[i]) = tem;
      (((tem)->fld[1]).rtx) = (((((seq)->fld[0]).rtvec))->elem[i - 1]);
      ((((((((seq)->fld[0]).rtvec))->elem[i - 1]))->fld[2]).rtx) = tem;

      for (note = (((tem)->fld[8]).rtx); note; note = next)
 {
   next = (((note)->fld[1]).rtx);
   switch (((enum reg_note) ((enum machine_mode) (note)->mode)))
     ...
     case REG_LABEL:
       ...
       if (((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CODE_LABEL)
  ((((((note)->fld[0]).rtx))->fld[4]).rtint) ++;
       break;
  ...
  ((((((((seq)->fld[0]).rtvec))->elem[length]))->fld[2]).rtx) = (((seq_insn)->fld[2]).rtx);





  if ((((seq_insn)->fld[1]).rtx) && ((enum rtx_code) ((((seq_insn)->fld[1]).rtx))->code) == INSN
      && ((enum rtx_code) (((((((seq_insn)->fld[1]).rtx))->fld[5]).rtx))->code) == SEQUENCE)
    ((((((((((((((seq_insn)->fld[1]).rtx))->fld[5]).rtx))->fld[0]).rtvec))->elem[(((((((((((seq_insn)->fld[1]).rtx))->fld[5]).rtx))->fld[0]).rtvec))->num_elem) - 1]))->fld[2]).rtx)

      = seq_insn;

  if ((((seq_insn)->fld[2]).rtx) && ((enum rtx_code) ((((seq_insn)->fld[2]).rtx))->code) == INSN
      && ((enum rtx_code) (((((((seq_insn)->fld[2]).rtx))->fld[5]).rtx))->code) == SEQUENCE)
    ((((((((((((((seq_insn)->fld[2]).rtx))->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[1]).rtx) = seq_insn;
  ...
  if (i != length + 1)
    fancy_abort ("../../../kgccfe/gnu/reorg.c", 542, __FUNCTION__);
  ...
  if (delay_list == 0)
    {
      ...
      return gen_rtx_fmt_ue (INSN_LIST, (VOIDmode), (insn), ((rtx) 0));
    }
     ...
     rtx insn;
{
  ...
  seq = (((seq_insn)->fld[5]).rtx);



  if ((((((seq)->fld[0]).rtvec))->num_elem) > 2)
    for (i = 1; i < (((((seq)->fld[0]).rtvec))->num_elem); i++)
      if ((((((seq)->fld[0]).rtvec))->elem[i]) != insn)
 delay_list = add_to_delay_list ((((((seq)->fld[0]).rtvec))->elem[i]), delay_list);



  prev = (((seq_insn)->fld[1]).rtx);
  trial = (((((seq)->fld[0]).rtvec))->elem[0]);
  delete_related_insns (seq_insn);
  add_insn_after (trial, prev);

  if (((enum rtx_code) (trial)->code) == JUMP_INSN
      && (simplejump_p (trial) || ((enum rtx_code) ((((trial)->fld[5]).rtx))->code) == RETURN))
    emit_barrier_after (trial);



  if (delay_list)
    trial = emit_delay_sequence (trial, delay_list, (((((seq)->fld[0]).rtvec))->num_elem) - 2);
  else if (((enum rtx_code) (trial)->code) == JUMP_INSN
    || ((enum rtx_code) (trial)->code) == CALL_INSN
    || ((enum rtx_code) (trial)->code) == INSN)
    (((trial))->unchanging) = 0;

  (((insn))->in_struct) = 0;


  __extension__ ({ struct obstack *__o = (&unfilled_slots_obstack); if (__o->next_free + sizeof (void *) > __o->chunk_limit) _obstack_newchunk (__o, sizeof (void *)); *((void **)__o->next_free) = ((void *)trial); (__o->next_free) += 4 ; (void) 0; });
     ...
     rtx insn;
{
  ...
  flags = get_jump_flags (insn, (((insn)->fld[9]).rtx));

  if (trial == 0
      || ((enum rtx_code) (trial)->code) != INSN
      || ((enum rtx_code) ((((trial)->fld[5]).rtx))->code) == SEQUENCE
      || ((((trial)->fld[6]).rtint) >= 0 ? (((trial)->fld[6]).rtint) : recog_memoized_1 (trial)) < 0
  ...
  if ((next_trial == next_active_insn ((((insn)->fld[9]).rtx))
       && ! (next_trial == 0 && (cfun->epilogue_delay_list) != 0))
      || (next_trial != 0
   && ((enum rtx_code) (next_trial)->code) == JUMP_INSN
   && (((insn)->fld[9]).rtx) == (((next_trial)->fld[9]).rtx)
   && (simplejump_p (next_trial)
       || ((enum rtx_code) ((((next_trial)->fld[5]).rtx))->code) == RETURN)))
    {
      if (eligible_for_annul_false (insn, 0, trial, flags))
 {
   if (invert_jump (insn, (((insn)->fld[9]).rtx), 1))
     (((trial))->in_struct) = 1;
   else if (! 0)
     return 0;
 }
      ...
      if (next_trial && ((enum rtx_code) (next_trial)->code) == JUMP_INSN
   && (simplejump_p (next_trial)
       || ((enum rtx_code) ((((next_trial)->fld[5]).rtx))->code) == RETURN))
 {
   target_label = (((next_trial)->fld[9]).rtx);
   if (target_label == 0)
     ...
     rtx insn, label;
{
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/reorg.c", 867, __FUNCTION__);
 }
    }
  else
    flags |= (0x8 | 0x4);
     ...
     rtx insn;
{
  ...
  for (; insn; insn = next)
    {
      if (((enum rtx_code) (insn)->code) == INSN && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SEQUENCE)
     ...
     rtx jump_insn, condition;
{
  ...
  if (note)
    {
      int prob = ((((((note)->fld[0]).rtx))->fld[0]).rtwint);

      if (prob >= 10000 * 9 / 10)
 return 2;
      else if (prob >= 10000 / 2)
 return 1;
      else if (prob >= 10000 / 10)
 return 0;
      else
 return -1;
    }
  ...
  if (((enum rtx_code) ((((jump_insn)->fld[5]).rtx))->code) == SET
      && ((enum rtx_code) (((((((jump_insn)->fld[5]).rtx))->fld[1]).rtx))->code) == IF_THEN_ELSE
      && ((((enum rtx_code) ((((((((((jump_insn)->fld[5]).rtx))->fld[1]).rtx))->fld[1]).rtx))->code) == LABEL_REF
    && ((((((((((((jump_insn)->fld[5]).rtx))->fld[1]).rtx))->fld[1]).rtx)))->in_struct))
   || (((enum rtx_code) ((((((((((jump_insn)->fld[5]).rtx))->fld[1]).rtx))->fld[2]).rtx))->code) == LABEL_REF
       && ((((((((((((jump_insn)->fld[5]).rtx))->fld[1]).rtx))->fld[2]).rtx)))->in_struct))))
    return -1;
 ...
 if ((((insn)->fld[5]).rtint) == NOTE_INSN_LOOP_BEG)
   return 2;
    ...
    insn && ((enum rtx_code) (insn)->code) == NOTE;
    insn = (((insn)->fld[1]).rtx))
 if ((((insn)->fld[5]).rtint) == NOTE_INSN_LOOP_VTOP)
   return 1;
    }
  ...
  switch (((enum rtx_code) (condition)->code))
    ...
    case LE:
    case LT:
      if ((((condition)->fld[1]).rtx) == (const_int_rtx[64]))
 return 0;
      break;
    case GE:
    case GT:
     ...
     rtx target;
{
  ...
  if (((enum rtx_code) (pat)->code) == RETURN)
    return target == 0 ? const_true_rtx : 0;

  else if (((enum rtx_code) (pat)->code) != SET || (((pat)->fld[0]).rtx) != (global_rtl[GR_PC]))
    return 0;

  src = (((pat)->fld[1]).rtx);
  if (((enum rtx_code) (src)->code) == LABEL_REF && (((src)->fld[0]).rtx) == target)
    return const_true_rtx;

  else if (((enum rtx_code) (src)->code) == IF_THEN_ELSE
    && ((target == 0 && ((enum rtx_code) ((((src)->fld[1]).rtx))->code) == RETURN)
        || (((enum rtx_code) ((((src)->fld[1]).rtx))->code) == LABEL_REF
     && ((((((src)->fld[1]).rtx))->fld[0]).rtx) == target))
    && (((src)->fld[2]).rtx) == (global_rtl[GR_PC]))
    return (((src)->fld[0]).rtx);

  else if (((enum rtx_code) (src)->code) == IF_THEN_ELSE
    && ((target == 0 && ((enum rtx_code) ((((src)->fld[2]).rtx))->code) == RETURN)
        || (((enum rtx_code) ((((src)->fld[2]).rtx))->code) == LABEL_REF
     && ((((((src)->fld[2]).rtx))->fld[0]).rtx) == target))
    && (((src)->fld[1]).rtx) == (global_rtl[GR_PC]))
    {
      enum rtx_code rev;
      rev = reversed_comparison_code ((((src)->fld[0]).rtx), insn);
      if (rev != UNKNOWN)
 return gen_rtx_fmt_ee (rev, ((enum machine_mode) ((((src)->fld[0]).rtx))->mode),
          ((((((src)->fld[0]).rtx))->fld[0]).rtx),
          ((((((src)->fld[0]).rtx))->fld[1]).rtx));
    }
...
condition_dominates_p (condition, insn)
     ...
     rtx insn;
{
  rtx other_condition = get_branch_condition (insn, (((insn)->fld[9]).rtx));
  enum rtx_code code = ((enum rtx_code) (condition)->code);
  ...
  other_code = ((enum rtx_code) (other_condition)->code);
     ...
     rtx jump, newlabel, seq;
{
  ...
  for (i = 1; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
    ...
    ((((jump))->unchanging)
     && ((((((((pat)->fld[0]).rtvec))->elem[i])))->in_struct))
    ? eligible_for_annul_false (jump, i - 1,
           (((((pat)->fld[0]).rtvec))->elem[i]), flags) :
    ...
    eligible_for_delay (jump, i - 1, (((((pat)->fld[0]).rtvec))->elem[i]), flags)))
      break;
     ...
     rtx jump, newlabel, delay_list;
{
  ...
  flags = get_jump_flags (jump, newlabel);
  for (li = delay_list, i = 0; li; li = (((li)->fld[1]).rtx), i++)
    if (! (

    ((((jump))->unchanging)
     && ((((((li)->fld[0]).rtx)))->in_struct))
    ? eligible_for_annul_false (jump, i, (((li)->fld[0]).rtx), flags) :
    ...
    eligible_for_delay (jump, i, (((li)->fld[0]).rtx), flags)))
      break;
     ...
     rtx delay_list;
{
  ...
  if (delay_list)
    {
      for (temp = delay_list; temp; temp = (((temp)->fld[1]).rtx))
 {
   rtx trial = (((temp)->fld[0]).rtx);

   if ((annul_true_p && (((trial))->in_struct))
       || (!annul_true_p && !(((trial))->in_struct)))
     return 0;
 }
    }
...
# 1282 "../../../kgccfe/gnu/reorg.c"
  do { (&cc_set)->memory = (&cc_set)->unch_memory = (&cc_set)->volatil = (&cc_set)->cc = 0; do { HARD_REG_ELT_TYPE *scan_tp_ = ((&cc_set)->regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); } while (0);
  for (temp = delay_list; temp; temp = (((temp)->fld[1]).rtx))
    {
      rtx trial = (((temp)->fld[0]).rtx);

      mark_set_resources (trial, &cc_set, 0, MARK_SRC_DEST_CALL);
      if (insn_references_resource_p ((((((seq)->fld[0]).rtvec))->elem[0]), &cc_set, 0))
 return delay_list;
    }

  if ((((((seq)->fld[0]).rtvec))->num_elem) - 1 > slots_remaining
      || ! condition_dominates_p (condition, (((((seq)->fld[0]).rtvec))->elem[0]))
      || ! (((rtx_class[(int) (((enum rtx_code) ((((((seq)->fld[0]).rtvec))->elem[0]))->code))]) == 'i') ? (((enum rtx_code) (((((((((seq)->fld[0]).rtvec))->elem[0]))->fld[5]).rtx))->code) == SET ? ((((((((seq)->fld[0]).rtvec))->elem[0]))->fld[5]).rtx) : single_set_2 ((((((seq)->fld[0]).rtvec))->elem[0]), ((((((((seq)->fld[0]).rtvec))->elem[0]))->fld[5]).rtx))) : (rtx) 0))
    return delay_list;
# 1305 "../../../kgccfe/gnu/reorg.c"
  for (i = 1; i < (((((seq)->fld[0]).rtvec))->num_elem); i++)
    {
      rtx trial = (((((seq)->fld[0]).rtvec))->elem[i]);
      int flags;
   ...
   || (((((((((seq)->fld[0]).rtvec))->elem[0])))->unchanging)
       && ! (((trial))->in_struct)))
 return delay_list;
 ...
 continue;
      ...
      flags = get_jump_flags (insn, ((((((((seq)->fld[0]).rtvec))->elem[0]))->fld[9]).rtx));

      if (! must_annul
   && ((condition == const_true_rtx
        || (! insn_sets_resource_p (trial, other_needed, 0)
     && ! may_trap_p ((((trial)->fld[5]).rtx)))))
   ? eligible_for_delay (insn, total_slots_filled, trial, flags)
   : (must_annul || (delay_list == ((void *)0) && new_delay_list == ((void *)0)))
      && (must_annul = 1,
  ...
  *pnew_thread = next_active_insn (((((((((seq)->fld[0]).rtvec))->elem[0]))->fld[9]).rtx));
     ...
     int *pannul_p;
{
  ...
  if (! simplejump_p ((((((seq)->fld[0]).rtvec))->elem[0]))
      && ((enum rtx_code) (((((((((seq)->fld[0]).rtvec))->elem[0]))->fld[5]).rtx))->code) != RETURN)
    return delay_list;
      ...
      if (redundant_insn (trial, insn, delay_list))
 {
   ...
   : (must_annul || delay_list == ((void *)0)) && (must_annul = 1,
...
# 1466 "../../../kgccfe/gnu/reorg.c"
static void
try_merge_delay_insns (insn, thread)
     rtx insn, thread;
{
  rtx trial, next_trial;
  rtx delay_insn = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]);
  int annul_p = (((delay_insn))->unchanging);
  int slot_number = 1;
  int num_slots = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem);
  rtx next_to_match = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[slot_number]);
  struct resources set, needed;
  rtx merged_insns = 0;
  int i;
  int flags;

  flags = get_jump_flags (delay_insn, (((delay_insn)->fld[9]).rtx));

  do { (&needed)->memory = (&needed)->unch_memory = (&needed)->volatil = (&needed)->cc = 0; do { HARD_REG_ELT_TYPE *scan_tp_ = ((&needed)->regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); } while (0);
  do { (&set)->memory = (&set)->unch_memory = (&set)->volatil = (&set)->cc = 0; do { HARD_REG_ELT_TYPE *scan_tp_ = ((&set)->regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); } while (0);
  ...
  if (! annul_p)
    for (i = 1 ; i < num_slots; i++)
      if (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]))
 mark_referenced_resources (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]), &needed, 1);

  for (trial = thread; !stop_search_p (trial, 1); trial = next_trial)
    {
      rtx pat = (((trial)->fld[5]).rtx);
      rtx oldtrial = trial;
   ...
   && (((enum rtx_code) (pat)->code) == USE || ((enum rtx_code) (pat)->code) == CLOBBER))
 continue;

      if (((enum rtx_code) (next_to_match)->code) == ((enum rtx_code) (trial)->code)
   ...
   && rtx_equal_p ((((next_to_match)->fld[5]).rtx), (((trial)->fld[5]).rtx))
   ...
   && eligible_for_delay (delay_insn, slot_number - 1, trial, flags))
 {
  ...
  thread = next_active_insn (thread);
     ...
     merged_insns = gen_rtx_fmt_ue (INSN_LIST, (VOIDmode), (trial), (merged_insns));

   if (++slot_number == num_slots)
     break;

   next_to_match = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[slot_number]);
 }
  ...
  if (slot_number != num_slots
      && trial && ((enum rtx_code) (trial)->code) == INSN
      && ((enum rtx_code) ((((trial)->fld[5]).rtx))->code) == SEQUENCE
      && ! (((((((((((trial)->fld[5]).rtx))->fld[0]).rtvec))->elem[0])))->unchanging))
    {
      rtx pat = (((trial)->fld[5]).rtx);
      rtx filled_insn = (((((pat)->fld[0]).rtvec))->elem[0]);
      ...
      for (i = 1; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
 {
   rtx dtrial = (((((pat)->fld[0]).rtvec))->elem[i]);
   ...
   if (! insn_references_resource_p (dtrial, &set, 1)
       ...
       && rtx_equal_p ((((next_to_match)->fld[5]).rtx), (((dtrial)->fld[5]).rtx))
  ...
  merged_insns = gen_rtx_fmt_ue (INSN_LIST, (SImode), (dtrial), (merged_insns));
 ...
 {
   if (((enum machine_mode) (merged_insns)->mode) == SImode)
     {
       rtx new;

       update_block ((((merged_insns)->fld[0]).rtx), thread);
       new = delete_from_delay_slot ((((merged_insns)->fld[0]).rtx));
       if ((((thread))->volatil))
  thread = new;
     }
   else
     {
       update_block ((((merged_insns)->fld[0]).rtx), thread);
       delete_related_insns ((((merged_insns)->fld[0]).rtx));
     }
 }
 ...
 (((((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i])))->in_struct) = 0;
    }
}
# 1657 "../../../kgccfe/gnu/reorg.c"
static rtx
     ...
     rtx delay_list;
{
  ...
  if (find_reg_note (insn, REG_UNUSED, (rtx) 0) != 0)
    return 0;


  for (trial = (((target)->fld[1]).rtx),
  insns_to_search = (compiler_params[(int) PARAM_MAX_DELAY_SLOT_INSN_SEARCH].value);
       trial && insns_to_search > 0;
       trial = (((trial)->fld[1]).rtx), --insns_to_search)
    {
      if (((enum rtx_code) (trial)->code) == CODE_LABEL)
 return 0;

      if (! ((rtx_class[(int) (((enum rtx_code) (trial)->code))]) == 'i'))
 continue;

      pat = (((trial)->fld[5]).rtx);
      if (((enum rtx_code) (pat)->code) == USE || ((enum rtx_code) (pat)->code) == CLOBBER)
 continue;
      ...
      if (((enum rtx_code) (pat)->code) == SEQUENCE)
 {
   ...
   if (((enum rtx_code) ((((((pat)->fld[0]).rtvec))->elem[0]))->code) == CALL_INSN)
     return 0;
# 1714 "../../../kgccfe/gnu/reorg.c"
   for (i = (((((pat)->fld[0]).rtvec))->num_elem) - 1; i > 0; i--)
     if (((enum rtx_code) ((((((pat)->fld[0]).rtvec))->elem[i]))->code) == ((enum rtx_code) (insn)->code)
  && rtx_equal_p (((((((((pat)->fld[0]).rtvec))->elem[i]))->fld[5]).rtx), ipat)
  && ! find_reg_note ((((((pat)->fld[0]).rtvec))->elem[i]), REG_UNUSED, (rtx) 0))
       break;
   ...
   if (i > 0)
     break;
      ...
      else if (((enum rtx_code) (trial)->code) == ((enum rtx_code) (insn)->code) && rtx_equal_p (pat, ipat)
        && ! find_reg_note (trial, REG_UNUSED, (rtx) 0))
 break;
    }
  ...
  if (((enum rtx_code) (target)->code) == INSN && ((enum rtx_code) ((((target)->fld[5]).rtx))->code) == SEQUENCE)
    target_main = ((((((((target)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]);
  ...
  do { HARD_REG_ELT_TYPE *scan_tp_ = (needed.regs), *scan_fp_ = (set.regs); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
 ...
 return 0;
  ...
  if (((enum rtx_code) (target)->code) == INSN && ((enum rtx_code) ((((target)->fld[5]).rtx))->code) == SEQUENCE)
    for (i = 1; i < ((((((((target)->fld[5]).rtx))->fld[0]).rtvec))->num_elem); i++)
      if (insn_sets_resource_p (((((((((target)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]), &needed, 1))
 return 0;
  ...
  for (trial = (((target)->fld[1]).rtx),
  insns_to_search = (compiler_params[(int) PARAM_MAX_DELAY_SLOT_INSN_SEARCH].value);
       trial && ((enum rtx_code) (trial)->code) != CODE_LABEL && insns_to_search > 0;
       trial = (((trial)->fld[1]).rtx), --insns_to_search)
    {
      if (((enum rtx_code) (trial)->code) != INSN && ((enum rtx_code) (trial)->code) != CALL_INSN
   && ((enum rtx_code) (trial)->code) != JUMP_INSN)
 continue;
      ...
      if (((enum rtx_code) (pat)->code) == SEQUENCE)
 {
   ...
   if (((enum rtx_code) ((((((pat)->fld[0]).rtvec))->elem[0]))->code) == CALL_INSN)
     return 0;
# 1815 "../../../kgccfe/gnu/reorg.c"
   for (i = (((((pat)->fld[0]).rtvec))->num_elem) - 1; i > 0; i--)
     {
       rtx candidate = (((((pat)->fld[0]).rtvec))->elem[i]);



       if (rtx_equal_p ((((candidate)->fld[5]).rtx), ipat)
    && ! (((((((((pat)->fld[0]).rtvec))->elem[0])))->unchanging)
   && (((candidate))->in_struct)))
  {
    ...
    return candidate;
       ...
       if ((! ((((((((pat)->fld[0]).rtvec))->elem[0])))->unchanging)
     || ! (((candidate))->in_struct))
  ...
  return 0;
   ...
   if (insn_sets_resource_p ((((((pat)->fld[0]).rtvec))->elem[0]), &needed, 1))
     return 0;
 }
      else
 {
     ...
     int allow_fallthrough;
{
 ...
 && (insn != label || (((insn)->fld[4]).rtint) != 1))
  ...
  for (insn = prev_nonnote_insn (thread);
       insn == 0 || ((enum rtx_code) (insn)->code) != BARRIER;
     ...
     rtx where;
{
  ...
  emit_insn_before (gen_rtx_fmt_e (USE, (VOIDmode), (insn)), where);
     ...
     rtx insn, delayed_insn;
{
  ...
  for (p = next_nonnote_insn (insn); p != delayed_insn;
    ...
    for (link = (((p)->fld[8]).rtx); link; link = next)
      {
 next = (((link)->fld[1]).rtx);
 ...
 if (reg_referenced_p ((((link)->fld[0]).rtx), (((insn)->fld[5]).rtx)))
   {

     remove_note (p, link);
     (((link)->fld[1]).rtx) = (((insn)->fld[8]).rtx);
     (((insn)->fld[8]).rtx) = link;
   }
      }
}
# 1989 "../../../kgccfe/gnu/reorg.c"
static void
     ...
     rtx start_insn, stop_insn;
{
 ...
 if (reg_set_p ((((link)->fld[0]).rtx), (((start_insn)->fld[5]).rtx)))
   {
     remove_note (p, link);
     return;
   }
     ...
     rtx insn, redundant_insn;
{
  ...
  for (link = (((insn)->fld[8]).rtx); link; link = next)
    {
      next = (((link)->fld[1]).rtx);
 ...
 continue;
      ...
      if (! find_regno_note (redundant_insn, REG_UNUSED,
        ((((((link)->fld[0]).rtx))->fld[0]).rtuint)))
 remove_note (insn, link);
    }
}
# 2054 "../../../kgccfe/gnu/reorg.c"
static void
     ...
     int non_jumps_p;
{
  ...
  for (i = 0; i < num_unfilled_slots; i++)
   ...
   || (((enum rtx_code) (insn)->code) == JUMP_INSN && non_jumps_p)
   || (((enum rtx_code) (insn)->code) != JUMP_INSN && ! non_jumps_p))
 continue;
...
# 2097 "../../../kgccfe/gnu/reorg.c"
      if (slots_to_fill == 0)
 continue;
# 2118 "../../../kgccfe/gnu/reorg.c"
      slots_filled = 0;
      delay_list = 0;
   ...
   && ! can_throw_internal (trial))
 {
   ...
   tmp = &((rtx *) ((&unfilled_slots_obstack)->object_base))[i + 1];
   while (*tmp != trial && tmp != ((rtx *) ((&unfilled_slots_obstack)->next_free)))
     tmp++;
    ...
    if (eligible_for_delay (insn, slots_filled, trial, flags))
      {
        ...
        delay_list = gen_rtx_fmt_ue (INSN_LIST, (VOIDmode), (trial), (delay_list));
...
# 2256 "../../../kgccfe/gnu/reorg.c"
      if (slots_filled != slots_to_fill
# 2277 "../../../kgccfe/gnu/reorg.c"
    ...
    && (((insn)->fld[9]).rtx) != 0)))
 {
  ...
  if (((enum rtx_code) (trial)->code) == CODE_LABEL
      || ((enum rtx_code) (trial)->code) == BARRIER)
    break;
  ...
  if (((enum rtx_code) (pat)->code) == SEQUENCE)
    trial_delay = (((((pat)->fld[0]).rtvec))->elem[0]);
  else
    trial_delay = trial;


  if (((enum rtx_code) (trial_delay)->code) == JUMP_INSN)
    break;
  ...
  if (((enum rtx_code) (trial_delay)->code) == CALL_INSN
      || ((enum rtx_code) (trial_delay)->code) == JUMP_INSN)
    maybe_never = 1;
       }
   ...
   if (slots_to_fill != slots_filled
       ...
       && ((enum rtx_code) (trial)->code) == JUMP_INSN
       && simplejump_p (trial)
       && (target == 0 || (((trial)->fld[9]).rtx) == target)
       && (next_trial = next_active_insn ((((trial)->fld[9]).rtx))) != 0
       && ! (((enum rtx_code) (next_trial)->code) == INSN
      && ((enum rtx_code) ((((next_trial)->fld[5]).rtx))->code) == SEQUENCE)
       && ((enum rtx_code) (next_trial)->code) != JUMP_INSN
       ...
       && ! (maybe_never && may_trap_p ((((next_trial)->fld[5]).rtx)))
       && (next_trial = try_split ((((next_trial)->fld[5]).rtx), next_trial, 0))
 ...
 delay_list
   = fill_slots_from_thread (insn, const_true_rtx,
        next_active_insn ((((insn)->fld[9]).rtx)),
        ((void *)0), 1, 1,
        own_thread_p ((((insn)->fld[9]).rtx),
        (((insn)->fld[9]).rtx), 0),
...
# 2532 "../../../kgccfe/gnu/reorg.c"
}
# 2558 "../../../kgccfe/gnu/reorg.c"
static rtx
     ...
     rtx delay_list;
{
  ...
  if ((condition == const_true_rtx && ! thread_if_true)
    ...
    fancy_abort ("../../../kgccfe/gnu/reorg.c", 2581, __FUNCTION__);
  ...
  if (condition == const_true_rtx)
    do { (&opposite_needed)->memory = (&opposite_needed)->unch_memory = (&opposite_needed)->volatil = (&opposite_needed)->cc = 0; do { HARD_REG_ELT_TYPE *scan_tp_ = ((&opposite_needed)->regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); } while (0);
  else
  ...
  new_thread = thread = try_split ((((thread)->fld[5]).rtx), thread, 0);
   ...
   && ! can_throw_internal (trial))
 {
  ...
  thread = trial;
       pat = (((trial)->fld[5]).rtx);
       if ((must_annul || delay_list == ((void *)0)) && (thread_if_true
     ? check_annul_list_true_false (0, delay_list)
...
# 2728 "../../../kgccfe/gnu/reorg.c"
        ...
        if (trial == thread)
   {
     ...
     if (new_thread == trial)
       new_thread = thread;
        ...
        if (note && ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CODE_LABEL)
   ((((((note)->fld[0]).rtx))->fld[4]).rtint)++;
         ...
         delay_list)))
   {
    ...
    continue;
      ...
      set.cc = 1;
# 2816 "../../../kgccfe/gnu/reorg.c"
      if (((enum rtx_code) (trial)->code) == INSN && ((enum rtx_code) (pat)->code) == SET
   && ((enum rtx_code) ((((pat)->fld[1]).rtx))->code) == REG
   && ((enum rtx_code) ((((pat)->fld[0]).rtx))->code) == REG)
 {
   rtx next = next_nonnote_insn (trial);

   if (next && ((enum rtx_code) (next)->code) == INSN
       && ((enum rtx_code) ((((next)->fld[5]).rtx))->code) != USE
       && ! reg_set_p ((((pat)->fld[0]).rtx), next)
       && ! reg_set_p ((((pat)->fld[1]).rtx), next)
       && reg_referenced_p ((((pat)->fld[0]).rtx), (((next)->fld[5]).rtx))
       && ! modified_in_p ((((pat)->fld[0]).rtx), next))
  ...
  if (trial && ((enum rtx_code) (trial)->code) == INSN
      && ((enum rtx_code) ((((trial)->fld[5]).rtx))->code) == SEQUENCE
      && ((enum rtx_code) (((((((((trial)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->code) == JUMP_INSN)
    {
 ...
 {
   delay_list
     = steal_delay_list_from_target (insn, condition, (((trial)->fld[5]).rtx),
 ...
 delay_list
  ...
  if (delay_list == 0 && likely && new_thread
      && ((enum rtx_code) (new_thread)->code) == INSN
      && ((enum rtx_code) ((((new_thread)->fld[5]).rtx))->code) != ASM_INPUT
      && asm_noperands ((((new_thread)->fld[5]).rtx)) < 0)
    {
      rtx pat = (((new_thread)->fld[5]).rtx);
      rtx dest;
      rtx src;
   ...
   && ! side_effects_p (pat))
 {
   ...
   if (((enum rtx_code) (other)->code) == CONST_INT)
     new_arith = gen_rtx_fmt_ee (((enum rtx_code) (src)->code), ((enum machine_mode) (src)->mode), dest,
     negate_rtx (((enum machine_mode) (src)->mode), other));
   else
     new_arith = gen_rtx_fmt_ee (((enum rtx_code) (src)->code) == PLUS ? MINUS : PLUS,
     ((enum machine_mode) (src)->mode), dest, other);

   ninsn = emit_insn_after (gen_rtx_fmt_ee (SET, (VOIDmode), (dest), (new_arith)),
       insn);

   if (((((ninsn)->fld[6]).rtint) >= 0 ? (((ninsn)->fld[6]).rtint) : recog_memoized_1 (ninsn)) < 0
  ...
  if (new_thread != thread)
    {
      ...
      if (! thread_if_true)
 fancy_abort ("../../../kgccfe/gnu/reorg.c", 2950, __FUNCTION__);

      if (new_thread && ((enum rtx_code) (new_thread)->code) == JUMP_INSN
   && (simplejump_p (new_thread)
       || ((enum rtx_code) ((((new_thread)->fld[5]).rtx))->code) == RETURN)
   && redirect_with_delay_list_safe_p (insn,
           (((new_thread)->fld[9]).rtx),
           delay_list))
 new_thread = follow_jumps ((((new_thread)->fld[9]).rtx));

      if (new_thread == 0)
 label = find_end_label ();
      else if (((enum rtx_code) (new_thread)->code) == CODE_LABEL)
 label = new_thread;
      else
...
fill_eager_delay_slots ()
{
 ...
 continue;
      ...
      slots_to_fill = num_delay_slots (insn);
# 3018 "../../../kgccfe/gnu/reorg.c"
      if (slots_to_fill == 0)
 continue;

      slots_filled = 0;
      target_label = (((insn)->fld[9]).rtx);
     ...
     rtx first;
{
   ...
   && (target_label = (((insn)->fld[9]).rtx)) != 0)
 {
   ...
   if (target_label != (((insn)->fld[9]).rtx))
     reorg_redirect_jump (insn, target_label);
   ...
   if (next && ((enum rtx_code) (next)->code) == JUMP_INSN
       && (simplejump_p (next) || ((enum rtx_code) ((((next)->fld[5]).rtx))->code) == RETURN)
       && next_active_insn (target_label) == next_active_insn (next)
       && no_labels_between_p (insn, next))
     {
       rtx label = (((next)->fld[9]).rtx);
# 3165 "../../../kgccfe/gnu/reorg.c"
       ++(((target_label)->fld[4]).rtint);
       if (label)
  ++(((label)->fld[4]).rtint);
  ...
  --(((label)->fld[4]).rtint);
       ...
       if (--(((target_label)->fld[4]).rtint) == 0)
  delete_related_insns (target_label);

       continue;
     }
 }
# 3193 "../../../kgccfe/gnu/reorg.c"
      if (((enum rtx_code) (insn)->code) == JUMP_INSN
   && (simplejump_p (insn) || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == RETURN)
   ...
   && 0 > mostly_true_jump (other,
       get_branch_condition (other,
        (((other)->fld[9]).rtx))))
 {
   rtx other_target = (((other)->fld[9]).rtx);
   target_label = (((insn)->fld[9]).rtx);
 ...
 continue;
      ...
      pat = (((insn)->fld[5]).rtx);
      delay_insn = (((((pat)->fld[0]).rtvec))->elem[0]);




      if (redundant_insn ((((((pat)->fld[0]).rtvec))->elem[1]), delay_insn, 0))
 {
   delete_from_delay_slot ((((((pat)->fld[0]).rtvec))->elem[1]));
   next = prev_active_insn (next);
   continue;
 }
# 3234 "../../../kgccfe/gnu/reorg.c"
      if (optimize_size
   && ((enum rtx_code) ((((delay_insn)->fld[5]).rtx))->code) == RETURN
   && next
   && ((enum rtx_code) (next)->code) == JUMP_INSN
   && ((enum rtx_code) ((((next)->fld[5]).rtx))->code) == RETURN)
 {
   rtx after;
   int i;
# 3252 "../../../kgccfe/gnu/reorg.c"
   for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
     ((((((((pat)->fld[0]).rtvec))->elem[i])))->in_struct) = 0;

   trial = (((insn)->fld[1]).rtx);
   delete_related_insns (insn);
   if (((enum rtx_code) (pat)->code) != SEQUENCE)
     fancy_abort ("../../../kgccfe/gnu/reorg.c", 3258, __FUNCTION__);
   after = trial;
   for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
     {
       rtx this_insn = (((((pat)->fld[0]).rtvec))->elem[i]);
   ...
   continue;
      ...
      if (((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->code) != JUMP_INSN
   || ! (condjump_p (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))
  || condjump_in_parallel_p (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))))
 continue;

      target_label = (((delay_insn)->fld[9]).rtx);
      ...
      if (target_label)
 {
   ...
   if (trial && ((enum rtx_code) ((((trial)->fld[5]).rtx))->code) != SEQUENCE
  ...
  tmp = find_end_label ();
       ...
       target_label = get_label_before ((((tmp)->fld[1]).rtx));
   ...
   if (trial && ((enum rtx_code) ((((trial)->fld[5]).rtx))->code) == SEQUENCE
       && ((((((((trial)->fld[5]).rtx))->fld[0]).rtvec))->num_elem) == 2
       && ((enum rtx_code) (((((((((trial)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->code) == JUMP_INSN
       && (simplejump_p (((((((((trial)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))
    || ((enum rtx_code) ((((((((((((trial)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[5]).rtx))->code) == RETURN)
       && redundant_insn (((((((((trial)->fld[5]).rtx))->fld[0]).rtvec))->elem[1]), insn, 0))
     {
       target_label = (((((((((((trial)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[9]).rtx);
       if (target_label == 0)
  target_label = find_end_label ();
...
# 3359 "../../../kgccfe/gnu/reorg.c"
   )
 {
   rtx after;
   int i;
# 3375 "../../../kgccfe/gnu/reorg.c"
   for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
     ((((((((pat)->fld[0]).rtvec))->elem[i])))->in_struct) = 0;
   ...
   delete_related_insns (insn);
   if (((enum rtx_code) (pat)->code) != SEQUENCE)
     fancy_abort ("../../../kgccfe/gnu/reorg.c", 3381, __FUNCTION__);
   after = trial;
   for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
     {
       rtx this_insn = (((((pat)->fld[0]).rtvec))->elem[i]);
   ...
   && rtx_equal_p ((((next)->fld[5]).rtx), ((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[5]).rtx)))
 {
   delete_related_insns (insn);
   continue;
 }
      ...
      if (! (((delay_insn))->unchanging)
   && next && ((enum rtx_code) (next)->code) == JUMP_INSN
   && (simplejump_p (next) || ((enum rtx_code) ((((next)->fld[5]).rtx))->code) == RETURN)
   && next_active_insn (target_label) == next_active_insn (next)
   && no_labels_between_p (insn, next))
 {
   rtx label = (((next)->fld[9]).rtx);
   rtx old_label = (((delay_insn)->fld[9]).rtx);
       ...
       if (invert_jump (delay_insn, label, 1))
  {
    ...
    for (i = 1; i < ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem); i++)
      {
        rtx slot = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]);
        (((slot))->in_struct) = ! (((slot))->in_struct);
      }
    ...
    next = insn;
       ...
       if (old_label && --(((old_label)->fld[4]).rtint) == 0)
  delete_related_insns (old_label);
      ...
      if (((((((((pat)->fld[0]).rtvec))->elem[1])))->in_struct)
   && own_thread_p ((((insn)->fld[2]).rtx), 0, 1))
 try_merge_delay_insns (insn, next);
      else if (! ((((((((pat)->fld[0]).rtvec))->elem[1])))->in_struct)
     ...
     rtx first;
{
  ...
  int slots, i;
# 3499 "../../../kgccfe/gnu/reorg.c"
  for (insn = first; insn; insn = (((insn)->fld[2]).rtx))
    if (((enum rtx_code) (insn)->code) == JUMP_INSN && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == RETURN)
      {
  ...
  for (insn = first; insn; insn = (((insn)->fld[2]).rtx))
    {
      ...
      if (((enum rtx_code) (insn)->code) != INSN
   || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != SEQUENCE
   || ((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->code) != JUMP_INSN
   || (((((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[9]).rtx) != end_of_function_label)
 continue;

      pat = (((insn)->fld[5]).rtx);
      jump_insn = (((((pat)->fld[0]).rtvec))->elem[0]);
      ...
      if (! reorg_redirect_jump (jump_insn, (rtx) 0))
 {
   ...
   continue;
      ...
      flags = get_jump_flags (jump_insn, (((jump_insn)->fld[9]).rtx));
 ...
 continue;
      ...
      if (((enum rtx_code) ((((jump_insn)->fld[5]).rtx))->code) == RETURN)
 {
   rtx prev = (((insn)->fld[1]).rtx);

   delete_related_insns (insn);
   for (i = 1; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
     prev = emit_insn_after (((((((((pat)->fld[0]).rtvec))->elem[i]))->fld[5]).rtx), prev);

   insn = emit_jump_insn_after ((((jump_insn)->fld[5]).rtx), prev);
 ...
 reorg_redirect_jump (jump_insn, real_return_label);
  ...
  if (--(((real_return_label)->fld[4]).rtint) == 0)
...
# 3630 "../../../kgccfe/gnu/reorg.c"
 ...
 max_uid = (((insn)->fld[0]).rtint);
   ...
   && (((insn)->fld[5]).rtint) == NOTE_INSN_EPILOGUE_BEG)
 epilogue_insn = insn;
    }
 ...
 __extension__ ({ struct obstack *__o = (&unfilled_slots_obstack); if (__o->next_free + sizeof (void *) > __o->chunk_limit) _obstack_newchunk (__o, sizeof (void *)); *((void **)__o->next_free) = ((void *)insn); (__o->next_free) += 4 ; (void) 0; });
   ...
   && (condjump_p (insn) || condjump_in_parallel_p (insn))
   && (((insn)->fld[9]).rtx) != 0
   && ((target = prev_label (next_active_insn ((((insn)->fld[9]).rtx))))
       != (((insn)->fld[9]).rtx)))
  ...
  for (insn = first; insn; insn = next)
    {
      ...
      if (((enum rtx_code) (insn)->code) == INSN && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == USE
   && ((rtx_class[(int) (((enum rtx_code) (((((((insn)->fld[5]).rtx))->fld[0]).rtx))->code))]) == 'i'))
 next = delete_related_insns (insn);
  ...
  if (end_of_function_label && --(((end_of_function_label)->fld[4]).rtint) == 0)
    delete_related_insns (end_of_function_label);


  if ((mips_can_use_return_insn ()) && end_of_function_label != 0)
    make_return_insns (first);
  ...
  if (file)
    {
      int i, j, need_comma;
      int total_delay_slots[3 + 1];
      int total_annul_slots[3 + 1];
      ...
      for (insn = first; insn; insn = (((insn)->fld[2]).rtx))
 {
   if (! (((insn))->volatil)
       ...
       && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != CLOBBER)
     {
       if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SEQUENCE)
  {
    j = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem) - 1;
    if (j > 3)
      j = 3;
    if ((((((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0])))->unchanging))
      total_annul_slots[j]++;
    else
      total_delay_slots[j]++;
  }
      ...
      if (((enum rtx_code) (insn)->code) == INSN)
 {
   ...
   if (((enum rtx_code) (pat)->code) == SEQUENCE)
     insn = (((((pat)->fld[0]).rtvec))->elem[0]);
 }
      if (((enum rtx_code) (insn)->code) != JUMP_INSN)
 continue;

      pred_flags = get_jump_flags (insn, (((insn)->fld[9]).rtx));
      (((insn)->fld[8]).rtx) = gen_rtx_fmt_ee (EXPR_LIST, (REG_BR_PRED), (gen_rtx_CONST_INT (VOIDmode, (long long) (pred_flags))), ((((insn)->fld[8]).rtx)));
