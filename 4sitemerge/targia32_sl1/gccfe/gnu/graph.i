     ...
     rtx tmp_rtx;
{
 ...
 case no_graph:
  ...
  switch (graph_dump_format)
    ...
    case vcg:
      fprintf (fp, "node: {\n  title: \"%s.%d\"\n  color: %s\n  label: \"%s %d\n",
        ...
        (rtx_name[(int) (((enum rtx_code) (tmp_rtx)->code))]), (((tmp_rtx)->fld[0]).rtint));
      break;
    case no_graph:
      break;
    }
  ...
  if (((enum rtx_code) (tmp_rtx)->code) == NOTE)
    {
      const char *name = "";
      if ((((tmp_rtx)->fld[5]).rtint) < 0)
 name = (note_insn_name[((((tmp_rtx)->fld[5]).rtint)) - (int) NOTE_INSN_BIAS]);
      fprintf (fp, " %s", name);
    }
  else if (((rtx_class[(int) (((enum rtx_code) (tmp_rtx)->code))]) == 'i'))
    print_rtl_single (fp, (((tmp_rtx)->fld[5]).rtx));
  else
     ...
     rtx rtx_first;
{
  ...
  char *buf = (char *) __builtin_alloca(namelen + suffixlen + extlen);
  FILE *fp;
 ...
 {
   rtx x;
   start[(((bb->head)->fld[0]).rtint)] = bb->index;
   end[(((bb->end)->fld[0]).rtint)] = bb->index;
   for (x = bb->head; x != (rtx) 0; x = (((x)->fld[2]).rtx))
     {
       in_bb_p[(((x)->fld[0]).rtint)]
  = (in_bb_p[(((x)->fld[0]).rtint)] == NOT_IN_BB)
  ...
  break;
      ...
      for (tmp_rtx = (((rtx_first)->fld[2]).rtx); ((void *)0) != tmp_rtx;
    tmp_rtx = (((tmp_rtx)->fld[2]).rtx))
 {
   int edge_printed = 0;
   rtx next_insn;

   if (start[(((tmp_rtx)->fld[0]).rtint)] < 0 && end[(((tmp_rtx)->fld[0]).rtint)] < 0)
     {
       if (((enum rtx_code) (tmp_rtx)->code) == BARRIER)
  continue;
       if (((enum rtx_code) (tmp_rtx)->code) == NOTE
    && (1 || in_bb_p[(((tmp_rtx)->fld[0]).rtint)] == NOT_IN_BB))
  continue;
     }

   if ((i = start[(((tmp_rtx)->fld[0]).rtint)]) >= 0)
     {

       start_bb (fp, i);

       if (i == 0)
  draw_edge (fp, 0, (((tmp_rtx)->fld[0]).rtint), 1, 0);
     }
   ...
   if ((i = end[(((tmp_rtx)->fld[0]).rtint)]) >= 0)
     {
       edge e;
       ...
       for (e = bb->succ; e ; e = e->succ_next)
  {
    if (e->dest != (&entry_exit_blocks[1]))
      {
        ...
        draw_edge (fp, (((tmp_rtx)->fld[0]).rtint),
     (((block_head)->fld[0]).rtint),
   ...
   edge_printed = 1;
      ...
      {
        draw_edge (fp, (((tmp_rtx)->fld[0]).rtint), 999999,
     next_insn != 0,
     (e->flags & 2 ? 2 : 0));
  ...
  draw_edge (fp, (((tmp_rtx)->fld[0]).rtint),
      next_insn ? (((next_insn)->fld[0]).rtint) : 999999, 0, 0);
       else
  {
    ...
    draw_edge (fp, (((tmp_rtx)->fld[0]).rtint),
        next_insn ? (((next_insn)->fld[0]).rtint) : 999999, 0, 3);
  }
     }
 }
     ...
     const char *suffix;
{
  ...
  size_t suffixlen = strlen (suffix);
  size_t extlen = strlen (graph_ext[graph_dump_format]) + 1;
  char *buf = (char *) __builtin_alloca(namelen + extlen + suffixlen);
  FILE *fp;
  ...
  switch (graph_dump_format)
    ...
    case vcg:
      ...
      break;
    case no_graph:
      fancy_abort ("../../../kgccfe/gnu/graph.c", 428, __FUNCTION__);
    }
     ...
     const char *suffix;
{
 ...
 case vcg:
   ...
   break;
 case no_graph:
   fancy_abort ("../../../kgccfe/gnu/graph.c", 460, __FUNCTION__);
 }
