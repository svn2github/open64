...
.LFE29:
	...
	.size	__FUNCTION__.11861, 16
__FUNCTION__.11861:
	.string	"compute_inverse"
	.align 4
.LC4:
	.string	"../../../kgccfe/gnu/ggc-page.c"
	.text
...
.LCFI56:
	...
	je	.L94
	.loc 1 1230 0
	leal	__FUNCTION__.11861@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1230, 4(%esp)
...
.LFE30:
	...
	.section	.rodata
	.type	__FUNCTION__.11893, @object
	.size	__FUNCTION__.11893, 9
__FUNCTION__.11893:
	.string	"init_ggc"
	.text
.globl init_ggc
...
.LBB5:
	...
	je	.L105
	.loc 1 1289 0
	leal	__FUNCTION__.11893@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1289, 4(%esp)
	leal	.LC4@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE31:
	...
	.section	.rodata
	.type	__FUNCTION__.11981, @object
	.size	__FUNCTION__.11981, 17
__FUNCTION__.11981:
...
.LCFI64:
	...
	jbe	.L129
	.loc 1 1357 0
	leal	__FUNCTION__.11981@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1357, 4(%esp)
	leal	.LC4@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L131:
	...
	jb	.L139
	.loc 1 1395 0
	leal	__FUNCTION__.11999@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1395, 4(%esp)
	leal	.LC4@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE36:
	...
	.section	.rodata
	.type	__FUNCTION__.11612, @object
	.size	__FUNCTION__.11612, 10
__FUNCTION__.11612:
	.string	"free_page"
	.text
...
.LBE15:
	.loc 1 896 0
	leal	__FUNCTION__.11612@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$896, 4(%esp)
	leal	.LC4@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
