...
static _Bool inside_basic_block_p (rtx);
     ...
     rtx insn;
{
  switch (((enum rtx_code) (insn)->code))
    ...
    case JUMP_INSN:
      return (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != ADDR_VEC
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/cfgbuild.c", 96, __FUNCTION__);
    }
}
     ...
     rtx insn;
{
  ...
  switch (((enum rtx_code) (insn)->code))
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/cfgbuild.c", 139, __FUNCTION__);
    }
}
     ...
     rtx lvl;
{
  ...
  for (insn = f; insn; insn = (((insn)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && ((enum rtx_code) (insn)->code) != JUMP_INSN)
      {
 rtx note;
# 208 "../../../kgccfe/gnu/cfgbuild.c"
 for (note = (((insn)->fld[8]).rtx); note; note = (((note)->fld[1]).rtx))
   if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_LABEL)
     {
       rtx lab = (((note)->fld[0]).rtx), next;

       if ((next = next_nonnote_insn (lab)) != ((void *)0)
  ...
  ;
       else if (((enum rtx_code) (lab)->code) == NOTE)
  ;
       else if (((enum rtx_code) ((((insn)->fld[2]).rtx))->code) == JUMP_INSN
         && find_reg_note ((((insn)->fld[2]).rtx), REG_LABEL, lab))
  ;
       else
  lvl = alloc_EXPR_LIST (0, (((note)->fld[0]).rtx), lvl);
     }
      }
     ...
     int flags;
{
  if (((enum rtx_code) (label)->code) != CODE_LABEL)
    fancy_abort ("../../../kgccfe/gnu/cfgbuild.c", 244, __FUNCTION__);
  ...
  cached_make_edge (edge_cache, src, (((label)->fld[3]).bb), flags);
}
     ...
     rtx insn;
{
  ...
  for (i = handlers; i; i = (((i)->fld[1]).rtx))
    make_label_edge (edge_cache, src, (((i)->fld[0]).rtx),
       2 | 8 | is_call);

  free_INSN_LIST_list (&handlers);
}
# 285 "../../../kgccfe/gnu/cfgbuild.c"
static void
     ...
     int update_p;
{
  ...
  if ((cfun->expr->x_forced_labels) || label_value_list || cfun->max_jumptable_ents > 100)
    {
  ...
  ((edge_cache[bb->index])->elms [(e->dest->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (e->dest->index) % ((unsigned) (8 * 8)));
   }
    }



  if (min == (&entry_exit_blocks[0])->next_bb)
    cached_make_edge (edge_cache, (&entry_exit_blocks[0]), min,
        1);
  ...
  for (bb = min; bb != max->next_bb; bb = bb->next_bb)
    {
      ...
      if (((enum rtx_code) (bb->head)->code) == CODE_LABEL && (((enum label_kind) (((bb->head)->jump << 1) | (bb->head)->call)) != LABEL_NORMAL))
 cached_make_edge (((void *)0), (&entry_exit_blocks[0]), bb, 0);
      ...
      if (code == JUMP_INSN)
 {
   ...
   if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == RESX)
   ...
   else if ((tmp = (((insn)->fld[9]).rtx)) != (rtx) 0
  ...
  make_label_edge (edge_cache, bb,
     (((((((((tmp)->fld[1]).rtx))->fld[2]).rtx))->fld[0]).rtx), 0);
   ...
   else if (computed_jump_p (insn))
     {
       ...
       for (x = label_value_list; x; x = (((x)->fld[1]).rtx))
  make_label_edge (edge_cache, bb, (((x)->fld[0]).rtx), 2);
  ...
  make_label_edge (edge_cache, bb, (((x)->fld[0]).rtx), 2);
     ...
     cached_make_edge (edge_cache, bb, (&entry_exit_blocks[1]), 0);


   else
     {
       if (! (((insn)->fld[9]).rtx))
  fancy_abort ("../../../kgccfe/gnu/cfgbuild.c", 408, __FUNCTION__);
       make_label_edge (edge_cache, bb, (((insn)->fld[9]).rtx), 0);
     }
 }
 ...
 cached_make_edge (edge_cache, bb, (&entry_exit_blocks[1]),
     2 | 4);
      ...
      else if (code == CALL_INSN || flag_non_call_exceptions)
 {
   ...
   if (code == CALL_INSN && (cfun->x_nonlocal_goto_handler_labels))
     {
# 441 "../../../kgccfe/gnu/cfgbuild.c"
       rtx note = find_reg_note (insn, REG_EH_REGION, (rtx) 0);

       if (!note || ((((((note)->fld[0]).rtx))->fld[0]).rtwint) >= 0)
  for (x = (cfun->x_nonlocal_goto_handler_labels); x; x = (((x)->fld[1]).rtx))
    make_label_edge (edge_cache, bb, (((x)->fld[0]).rtx),
       2 | 4);
     }
 }
      ...
      if (!insn || (bb->next_bb == (&entry_exit_blocks[1]) && force_fallthru))
 cached_make_edge (edge_cache, bb, (&entry_exit_blocks[1]), 1);
      else if (bb->next_bb != (&entry_exit_blocks[1]))
 {
     ...
     rtx f;
{
  ...
  rtx head = (rtx) 0;
  rtx end = (rtx) 0;
  basic_block prev = (&entry_exit_blocks[0]);
   ...
   if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == CALL_PLACEHOLDER)
     {
       ...
       lvl = find_label_refs (((((((insn)->fld[5]).rtx))->fld[0]).rtx), lvl);
       lvl = find_label_refs (((((((insn)->fld[5]).rtx))->fld[1]).rtx), lvl);
       lvl = find_label_refs (((((((insn)->fld[5]).rtx))->fld[2]).rtx), lvl);

       if (((((((insn)->fld[5]).rtx))->fld[3]).rtx) != (rtx) 0)
  trll = alloc_EXPR_LIST (0, ((((((insn)->fld[5]).rtx))->fld[3]).rtx), trll);
     }
   break;

 default:
   fancy_abort ("../../../kgccfe/gnu/cfgbuild.c", 559, __FUNCTION__);
 }

      if (((enum rtx_code) (insn)->code) == INSN || ((enum rtx_code) (insn)->code) == CALL_INSN)
 {
   rtx note;
# 574 "../../../kgccfe/gnu/cfgbuild.c"
   for (note = (((insn)->fld[8]).rtx); note; note = (((note)->fld[1]).rtx))
     if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_LABEL)
       {
  rtx lab = (((note)->fld[0]).rtx), next;
  ...
  if (last_basic_block != n_basic_blocks)
    fancy_abort ("../../../kgccfe/gnu/cfgbuild.c", 601, __FUNCTION__);
...
find_basic_blocks (f, nregs, file)
     rtx f;
     int nregs __attribute__ ((__unused__));
     FILE *file __attribute__ ((__unused__));
{
  ...
  last_basic_block = 0;
  (&entry_exit_blocks[0])->next_bb = (&entry_exit_blocks[1]);
  (&entry_exit_blocks[1])->prev_bb = (&entry_exit_blocks[0]);
# 650 "../../../kgccfe/gnu/cfgbuild.c"
  basic_block_info = varray_init (n_basic_blocks, VARRAY_DATA_BB, "basic_block_info");

  find_basic_blocks_1 (f);


  make_edges (label_value_list, (&entry_exit_blocks[0])->next_bb, (&entry_exit_blocks[1])->prev_bb, 0);
  ...
  while (1)
    {
      ...
      if (code == CODE_LABEL)
 {
   fallthru = split_block (bb, (((insn)->fld[1]).rtx));
   ...
   if ((((enum label_kind) (((insn)->jump << 1) | (insn)->call)) != LABEL_NORMAL))
     make_edge ((&entry_exit_blocks[0]), bb, 0);
 }
     ...
     basic_block b;
{
  ...
  if (b->succ && b->succ->succ_next && !b->succ->succ_next->succ_next)
    {
      rtx note = find_reg_note (b->end, REG_BR_PROB, ((void *)0));
      int probability;

      if (!note)
 return;

      probability = ((((((find_reg_note (b->end, REG_BR_PROB, ((void *)0)))->fld[0]).rtx))->fld[0]).rtwint);
     ...
     sbitmap blocks;
{
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    ((bb)->aux = (void *) (size_t) (((blocks)->elms [(bb->index) / ((unsigned) (8 * 8))] >> (bb->index) % ((unsigned) (8 * 8)) & 1) ? BLOCK_TO_SPLIT : BLOCK_ORIGINAL));
  ...
  min = max = bb;
  for (; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    if ((enum state) ((size_t) (bb)->aux) != BLOCK_ORIGINAL)
      max = bb;



  make_edges (((void *)0), min, max, 1);
