...
.LC382:
	.string	"rtvec "
.LC383:
	.string	"struct bitmap_head_def *"
.LC384:
	.string	"union tree_node *"
.LC385:
	.string	"struct basic_block_def *"
	.text
	.type	type_from_format, @function
type_from_format:
.LFB15:
	.file 1 "../../../kgccfe/gnu/gengenrtl.c"
	.loc 1 63 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.L12:
	...
	ret
.LFE15:
	.size	type_from_format, .-type_from_format
	.section	.rodata
.LC386:
	.string	"XINT"
.LC387:
...
.LC393:
	.string	"XBBDEF"
	.text
	.type	accessor_from_format, @function
...
.L25:
	...
	ret
.LFE16:
	.size	accessor_from_format, .-accessor_from_format
...
.L42:
	...
	ret
.LFE18:
	.size	special_rtx, .-special_rtx
	.type	excluded_rtx, @function
excluded_rtx:
.LFB19:
	.loc 1 163 0
	pushl	%ebp
...
.LCFI23:
	...
	ret
.LFE19:
	.size	excluded_rtx, .-excluded_rtx
	.type	find_formats, @function
find_formats:
.LFB20:
	.loc 1 171 0
	pushl	%ebp
...
.L47:
	...
	ret
.LFE20:
	.size	find_formats, .-find_formats
	.section	.rodata
	.align 4
.LC394:
	.string	"extern rtx gen_rtx_fmt_%s\tPARAMS ((RTX_CODE, "
.LC395:
	.string	"enum machine_mode mode"
.LC396:
	.string	"\n\t\t\t\t      "
.LC397:
	.string	" %sarg%d"
...
.LC410:
	.string	"  rtx rt;"
.LC411:
	.string	"  rt = ggc_alloc_rtx (%d);\n"
	.align 4
.LC412:
	.string	"  memset (rt, 0, sizeof (struct rtx_def) - sizeof (rtunion));\n"
.LC413:
	.string	"  PUT_CODE (rt, code);"
.LC414:
	.string	"  PUT_MODE (rt, mode);"
.LC415:
	.string	"  %s (rt, %d) = arg%d;\n"
.LC416:
	.string	"  X0EXP (rt, %d) = NULL_RTX;\n"
.LC417:
	.string	"\n  return rt;\n}\n"
	.text
	.type	gendef, @function
gendef:
.LFB23:
	.loc 1 260 0
	pushl	%ebp
...
.LFE23:
	...
	.align 4
.LC418:
	.string	"/* Generated automatically by gengenrtl from rtl.def.  */\n"
	.text
	.type	genlegend, @function
genlegend:
.LFB24:
	.loc 1 300 0
	pushl	%ebp
...
.LCFI48:
	...
	ret
.LFE24:
	.size	genlegend, .-genlegend
	.section	.rodata
.LC419:
	.string	"#ifndef GCC_GENRTL_H"
.LC420:
	.string	"#define GCC_GENRTL_H\n"
.LC421:
	.string	"\n#endif /* GCC_GENRTL_H */"
	.text
	.type	genheader, @function
genheader:
.LFB25:
	.loc 1 308 0
	pushl	%ebp
...
.LC426:
	...
	.align 4
.LC427:
	.string	"extern struct obstack *rtl_obstack;\n"
	.text
