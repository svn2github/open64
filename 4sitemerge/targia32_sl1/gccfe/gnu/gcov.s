...
.L387:
	...
	movl	%eax, 4(%esp)
	leal	buffer.7325@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
	call	sprintf@PLT
	movl	%eax, -20(%ebp)
	.loc 2 1159 0
...
.L392:
	...
	addl	$1, %eax
	movl	-20(%ebp), %edx
	movzbl	buffer.7325@GOTOFF(%ebx,%edx), %edx
	movb	%dl, buffer.7325@GOTOFF(%ebx,%eax)
	.loc 2 1165 0
	subl	$1, -20(%ebp)
	.loc 2 1167 0
	subl	$1, 24(%ebp)
	...
	movl	-20(%ebp), %eax
	addl	$1, %eax
	movb	$46, buffer.7325@GOTOFF(%ebx,%eax)
	jmp	.L394
.L376:
.LBE15:
	.loc 2 1172 0
