...
# 35 "../../../kgccfe/gnu/conflict.c" 2
# 64 "../../../kgccfe/gnu/conflict.c"
     ...
     int num_regs;
{
  ...
  _obstack_begin ((&graph->arc_obstack), 0, 0, (void *(*) (long)) xmalloc, (void (*) (void *)) free);
...
conflict_graph_delete (graph)
     conflict_graph graph;
{
  __extension__ ({ struct obstack *__o = (&graph->arc_obstack); void *__obj = (((void *)0)); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
     ...
     int reg2;
{
  ...
  if (reg1 == reg2)
    fancy_abort ("../../../kgccfe/gnu/conflict.c", 203, __FUNCTION__);
     ...
     void *contextp;
{
  ...
  if (reg1 == context->reg)
    ...
    fancy_abort ("../../../kgccfe/gnu/conflict.c", 352, __FUNCTION__);
     ...
     void *data;
{
  ...
  bitmap_set_bit (set, (((reg)->fld[0]).rtuint));
}
# 441 "../../../kgccfe/gnu/conflict.c"
conflict_graph
  ...
  for (bb = (&entry_exit_blocks[1])->prev_bb; bb != (&entry_exit_blocks[0]); bb = bb->prev_bb)
    {
      ...
      head = bb->head;
      insn = bb->end;
      for (insn = bb->end; insn != head; insn = (((insn)->fld[1]).rtx))
 {
   int born_reg;
   int live_reg;
   rtx link;
   ...
   if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
     {
       ...
       bitmap_clear (born);
       note_stores ((((insn)->fld[5]).rtx), mark_reg, born);
