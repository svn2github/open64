...
# 63 "../../../kgccfe/gnu/genrecog.c" 2
# 1 "../../../kgccfe/gnu/gensupport.h" 1
# 24 "../../../kgccfe/gnu/gensupport.h"
struct obstack;
...
static const struct pred_table
{
  ...
  const enum rtx_code codes[((int) LAST_AND_UNUSED_RTX_CODE)];
} preds[] = {
     ...
     int n;
{
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/genrecog.c", 407, __FUNCTION__);
 }
    }
     ...
     int n;
{
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/genrecog.c", 460, __FUNCTION__);
 }
    }
     ...
     int set_code;
{
 ...
 if (code == MATCH_OPERAND)
   {
     const char constraints0 = (((pattern)->fld[2]).rtstr)[0];





     if (((enum rtx_code) (insn)->code) == DEFINE_EXPAND
  || ((enum rtx_code) (insn)->code) == DEFINE_SPLIT
  || ((enum rtx_code) (insn)->code) == DEFINE_PEEPHOLE2)
       {
  if (constraints0)
    message_with_line (pattern_lineno,
         "warning: constraints not supported in %s",
         rtx_name[((enum rtx_code) (insn)->code)]);
       }
...
# 624 "../../../kgccfe/gnu/genrecog.c"
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/genrecog.c", 756, __FUNCTION__);
 }
    }
}
# 773 "../../../kgccfe/gnu/genrecog.c"
static struct decision *
...
# 881 "../../../kgccfe/gnu/genrecog.c"
      ...
      if (fmt[i] == 'i')
 {
   if (i == 0)
     ...
     fancy_abort ("../../../kgccfe/gnu/genrecog.c", 979, __FUNCTION__);
 }
      else if (fmt[i] == 'w')
 {
   ...
   if (i != 0)
     fancy_abort ("../../../kgccfe/gnu/genrecog.c", 990, __FUNCTION__);
 ...
 {
   if (i != 0)
     fancy_abort ("../../../kgccfe/gnu/genrecog.c", 998, __FUNCTION__);
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/genrecog.c", 1035, __FUNCTION__);
 }
    }
 ...
 fini:
  ...
  if (this->tests == ((void *)0))
    fancy_abort ("../../../kgccfe/gnu/genrecog.c", 1058, __FUNCTION__);
     ...
     int toplevel;
{
  ...
  int cmp;
# 1240 "../../../kgccfe/gnu/genrecog.c"
  cmp = strcmp (d1->position, d2->position);
  if (cmp != 0)
    {
      if (toplevel)
 fancy_abort ("../../../kgccfe/gnu/genrecog.c", 1244, __FUNCTION__);
     ...
     struct decision_test *d1, *d2;
{
  switch (d1->type)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/genrecog.c", 1323, __FUNCTION__);
    }
}
     ...
     struct decision_head *oldh, *addh;
{
  ...
  if (strcmp (oldh->first->position, addh->first->position))
    fancy_abort ("../../../kgccfe/gnu/genrecog.c", 1429, __FUNCTION__);
     ...
     const char *indent;
{
  ...
  for (old_has_insn = odepth - 1; old_has_insn >= 0; --old_has_insn)
    if ((_sch_istable[(oldpos[old_has_insn]) & 0xff] & (unsigned short)(_sch_isupper)))
      break;
  for (new_has_insn = ndepth - 1; new_has_insn >= 0; --new_has_insn)
    if ((_sch_istable[(newpos[new_has_insn]) & 0xff] & (unsigned short)(_sch_isupper)))
      break;
  ...
  while (depth < ndepth)
    {
      ...
      if ((_sch_istable[(newpos[depth]) & 0xff] & (unsigned short)(_sch_isupper)))
 {
  ...
  printf ("%s  goto ret0;\n", indent);
   ...
   printf ("%sx%d = PATTERN (tem);\n", indent, depth + 1);
      ...
      else if ((_sch_istable[(newpos[depth]) & 0xff] & (unsigned short)(_sch_islower)))
...
# 1842 "../../../kgccfe/gnu/genrecog.c"
 ...
 case DT_elt_zero_wide_safe:
   ...
   break;
 default:
   fancy_abort ("../../../kgccfe/gnu/genrecog.c", 1925, __FUNCTION__);
 }
      printf (")\n%s    {\n", indent);
      ...
      do
 {
   ...
   switch (type)
     ...
     case DT_elt_zero_wide:
     case DT_elt_zero_wide_safe:
       printf ("%lldLL", p->tests->u.intval);
       break;
     default:
       fancy_abort ("../../../kgccfe/gnu/genrecog.c", 1958, __FUNCTION__);
     }
     ...
     enum routine_type subroutine_type;
{
 ...
 case RECOG:
   if (p->u.insn.num_clobbers_to_add == 0)
     fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2039, __FUNCTION__);
   printf ("pnum_clobbers != NULL");
   break;

 default:
   fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2044, __FUNCTION__);
 }
      break;

    default:
      fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2049, __FUNCTION__);
    }
}
     ...
     enum routine_type subroutine_type;
{
      ...
      if (test->next)
 {
   ...
   if (test->type != DT_accept_insn)
     fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2088, __FUNCTION__);
 }
    }


  if (test->next)
    fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2094, __FUNCTION__);
 ...
 case PEEPHOLE2:
   {
     ...
     for (i = strlen (p->position) - 1; i >= 0; --i)
       if ((_sch_istable[(p->position[i]) & 0xff] & (unsigned short)(_sch_isupper)))
  {
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2130, __FUNCTION__);
 }
    }
  else
    {
     ...
     enum routine_type subroutine_type;
{
 ...
 case PEEPHOLE2:
   return -1;
 default:
   fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2167, __FUNCTION__);
 }
    }
     ...
     enum routine_type type;
{
  ...
  if (truth == 0)
    fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2471, __FUNCTION__);
     ...
     char **argv;
{
  ...
  if (init_md_reader_args (argc, argv) != 0)
    return (1);
     ...
     struct decision_test *test;
{
  switch (test->type)
    {
    case DT_mode:
      fprintf (stderr, "mode=%s", (mode_name[(int) (test->u.mode)]));
      break;
    case DT_code:
      fprintf (stderr, "code=%s", (rtx_name[(int) (test->u.code)]));
      break;
    case DT_veclen:
    ...
    case DT_elt_zero_wide:
      ...
      fprintf (stderr, "%lld", test->u.intval);
      break;
    case DT_elt_zero_wide_safe:
 ...
 fprintf (stderr, "c_test=\"%s\"", sub);
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/genrecog.c", 2825, __FUNCTION__);
    }
}
