...
# 575 "../../../kgccfe/gnu/dwarfout.c" 2
# 1 "../../../kgccfe/gnu/dwarf.h" 1
# 34 "../../../kgccfe/gnu/dwarf.h"
enum dwarf_tag {
    TAG_padding = 0x0000,
...
# 587 "../../../kgccfe/gnu/dwarfout.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 588 "../../../kgccfe/gnu/dwarfout.c" 2
...
# 595 "../../../kgccfe/gnu/dwarfout.c" 2


# 1 "../../../kgccfe/gnu/defaults.h" 1
# 598 "../../../kgccfe/gnu/dwarfout.c" 2
# 657 "../../../kgccfe/gnu/dwarfout.c"
...
static __inline__ int type_is_fundamental (tree);
static void equate_decl_number_to_die_number (tree);
static __inline__ void equate_type_number_to_die_number (tree);
static void output_reg_number (rtx);
static void output_mem_loc_descriptor (rtx);
static void output_loc_descriptor (rtx);
static void output_bound_representation (tree, unsigned, int);
static void output_enumeral_list (tree);
static __inline__ long long ceiling (long long, unsigned int);
static __inline__ tree field_type (tree);
static __inline__ unsigned int simple_type_align_in_bits (tree);
static __inline__ unsigned long long simple_type_size_in_bits (tree);
static long long field_byte_offset (tree);
static __inline__ void sibling_attribute (void);
...
static __inline__ void name_attribute (const char *);
static __inline__ void fund_type_attribute (unsigned);
static void mod_fund_type_attribute (tree, int, int);
static __inline__ void user_def_type_attribute (tree);
...
static __inline__ void bit_offset_attribute (tree);
static __inline__ void bit_size_attribute (tree);
static __inline__ void element_list_attribute (tree);
static __inline__ void stmt_list_attribute (const char *);
static __inline__ void low_pc_attribute (const char *);
static __inline__ void high_pc_attribute (const char *);
static __inline__ void body_begin_attribute (const char *);
static __inline__ void body_end_attribute (const char *);
static __inline__ void language_attribute (unsigned);
static __inline__ void member_attribute (tree);



static __inline__ void comp_dir_attribute (const char *);
static __inline__ void sf_names_attribute (const char *);
static __inline__ void src_info_attribute (const char *);
static __inline__ void mac_info_attribute (const char *);
static __inline__ void prototyped_attribute (tree);
static __inline__ void producer_attribute (const char *);
static __inline__ void inline_attribute (tree);
static __inline__ void containing_type_attribute (tree);
static __inline__ void abstract_origin_attribute (tree);



static __inline__ void pure_or_virtual_attribute (tree);
static void name_and_src_coords_attributes (tree);
static void type_attribute (tree, int, int);
static const char *type_tag (tree);
static __inline__ void dienum_push (void);
static __inline__ void dienum_pop (void);
static __inline__ tree member_declared_type (tree);
     ...
     tree type;
{
 ...
 if (((type)->type.name) != 0
     ...
     && ((enum tree_code) (((((type)->type.name))->decl.name))->common.code) == IDENTIFIER_NODE)
   {
     const char *const name =
 ...
 if (((type)->type.precision) == ((target_flags & 0x00000001) ? 64 : 32))
   return (((type)->common.unsigned_flag) ? FT_unsigned_integer : FT_integer);

 if (((type)->type.precision) == ((target_flags & 0x00000002) ? 64 : 32))
   return (((type)->common.unsigned_flag) ? FT_unsigned_long : FT_long);

 if (((type)->type.precision) == 64)
   return (((type)->common.unsigned_flag) ? FT_unsigned_long_long : FT_long_long);

 if (((type)->type.precision) == 16)
   return (((type)->common.unsigned_flag) ? FT_unsigned_short : FT_short);

 if (((type)->type.precision) == 8)
   return (((type)->common.unsigned_flag) ? FT_unsigned_char : FT_char);

 if (((type)->type.mode) == TImode)
   return (((type)->common.unsigned_flag) ? FT_unsigned_int128 : FT_int128);


 if (((type)->type.precision) == 1)
   return FT_boolean;

 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 1816, __FUNCTION__);
 ...
 if (((type)->type.precision) == (mips_abi == 1 || mips_abi == 2 ? 128 : 64))
   return FT_ext_prec_float;
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 1857, __FUNCTION__);
 ...
 return FT_boolean;
      ...
      default:
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 1869, __FUNCTION__);
    }
  return 0;
}
# 1884 "../../../kgccfe/gnu/dwarfout.c"
static tree
     ...
     int count;
{
 ...
 return global_trees[TI_ERROR_MARK];
      ...
      case POINTER_TYPE:
      case REFERENCE_TYPE:
 return root_type_1 (((type)->common.type), count+1);
     ...
     int count;
{
  ...
  if (((type)->common.readonly_flag) || decl_const)
    dw2_asm_output_data (1, MOD_const, "%s", dwarf_typemod_name (MOD_const));;
  if (((type)->common.volatile_flag) || decl_volatile)
    dw2_asm_output_data (1, MOD_volatile, "%s", dwarf_typemod_name (MOD_volatile));;
  switch (((enum tree_code) (type)->common.code))
    {
      case POINTER_TYPE:
 dw2_asm_output_data (1, MOD_pointer_to, "%s", dwarf_typemod_name (MOD_pointer_to));;
 write_modifier_bytes_1 (((type)->common.type), 0, 0, count+1);
 return;

      case REFERENCE_TYPE:
 dw2_asm_output_data (1, MOD_reference_to, "%s", dwarf_typemod_name (MOD_reference_to));;
 write_modifier_bytes_1 (((type)->common.type), 0, 0, count+1);
 return;
     ...
     tree type;
{
 ...
 return 0;
      ...
      default:
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 2004, __FUNCTION__);
    }
  return 0;
}
# 2022 "../../../kgccfe/gnu/dwarfout.c"
static void
     ...
     tree decl;
{
  ...
  sprintf (decl_label, "*.L_E%u", ((decl)->decl.uid));
  sprintf (die_label, "*.L_D%u", current_dienum);
  do { fputc_unlocked ('\t', asm_out_file); assemble_name (asm_out_file, decl_label); fputs_unlocked (" = ", asm_out_file); assemble_name (asm_out_file, die_label); fputc_unlocked ('\n', asm_out_file); } while (0);
}
# 2054 "../../../kgccfe/gnu/dwarfout.c"
     ...
     tree type;
{
  ...
  sprintf (type_label, "*.L_T%u", ((type)->type.uid));
  sprintf (die_label, "*.L_D%u", current_dienum);
  do { fputc_unlocked ('\t', asm_out_file); assemble_name (asm_out_file, type_label); fputs_unlocked (" = ", asm_out_file); assemble_name (asm_out_file, die_label); fputc_unlocked ('\n', asm_out_file); } while (0);
}
     ...
     rtx rtl;
{
  ...
  dw2_assemble_integer (4, gen_rtx_CONST_INT (VOIDmode, (long long) (mips_dbx_regno[ (regno) ])));
  if (flag_debug_asm)
    {
      fprintf (asm_out_file, "\t%s ", " #");
      fprintf ((asm_out_file), "%s", reg_names[(((rtl)->fld[0]).rtuint)]);
    }
  fputc_unlocked ('\n', asm_out_file);
}
# 2105 "../../../kgccfe/gnu/dwarfout.c"
static void
output_mem_loc_descriptor (rtl)
     rtx rtl;
{
# 2118 "../../../kgccfe/gnu/dwarfout.c"
 ...
 rtl = (((rtl)->fld[0]).rtx);
      ...
      case REG:
# 2152 "../../../kgccfe/gnu/dwarfout.c"
 dw2_asm_output_data (1, OP_BASEREG, "%s", dwarf_stack_op_name (OP_BASEREG));
 output_reg_number (rtl);
 break;

      case MEM:
 output_mem_loc_descriptor ((((rtl)->fld[0]).rtx));
 dw2_asm_output_data (1, OP_DEREF4, "%s", dwarf_stack_op_name (OP_DEREF4));
 break;

      case CONST:
      case SYMBOL_REF:
 dw2_asm_output_data (1, OP_ADDR, "%s", dwarf_stack_op_name (OP_ADDR));
 dw2_asm_output_addr_rtx (4, rtl, ((void *)0));
 break;

      case PLUS:
 output_mem_loc_descriptor ((((rtl)->fld[0]).rtx));
 output_mem_loc_descriptor ((((rtl)->fld[1]).rtx));
 dw2_asm_output_data (1, OP_ADD, "%s", dwarf_stack_op_name (OP_ADD));
 break;

      case CONST_INT:
 dw2_asm_output_data (1, OP_CONST, "%s", dwarf_stack_op_name (OP_CONST));
 dw2_asm_output_data (4, (((rtl)->fld[0]).rtwint), ((void *)0));
 break;
 ...
 output_mem_loc_descriptor ((((rtl)->fld[0]).rtx));
 output_mem_loc_descriptor ((((rtl)->fld[1]).rtx));
 dw2_asm_output_data (1, OP_MULT, "%s", dwarf_stack_op_name (OP_MULT));
 break;

      default:
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 2188, __FUNCTION__);
    }
}
     ...
     rtx rtl;
{
 ...
 rtl = (((rtl)->fld[0]).rtx);
    ...
    case REG:
 dw2_asm_output_data (1, OP_REG, "%s", dwarf_stack_op_name (OP_REG));
 output_reg_number (rtl);
 break;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 2225, __FUNCTION__);
    }
}
     ...
     char u_or_l;
{
 ...
 dw2_asm_output_data (4, tree_low_cst (bound, 0), ((void *)0));
      break;
 ...
 sprintf (begin_label, "*.L_b%u_%u_%c",
   current_dienum, dim_num, u_or_l);

 sprintf (end_label, "*.L_b%u_%u_%c_e",
   current_dienum, dim_num, u_or_l);

 dw2_asm_output_delta (2, end_label, begin_label, ((void *)0));
 do { assemble_name ((asm_out_file), (begin_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
# 2293 "../../../kgccfe/gnu/dwarfout.c"
 if (! optimize)
   {
     while (((enum tree_code) (bound)->common.code) == NOP_EXPR
     || ((enum tree_code) (bound)->common.code) == CONVERT_EXPR)
       bound = ((bound)->exp.operands[0]);

     if (((enum tree_code) (bound)->common.code) == SAVE_EXPR
  && (*(rtx *) &(bound)->exp.operands[2]))
       output_loc_descriptor
  (eliminate_regs ((*(rtx *) &(bound)->exp.operands[2]), 0, (rtx) 0));
   }

 do { assemble_name ((asm_out_file), (end_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
      }
      break;
     ...
     tree link;
{
  if (link)
    {
      output_enumeral_list (((link)->common.chain));

      if (host_integerp (((link)->list.value), 0))
 dw2_asm_output_data (4, tree_low_cst (((link)->list.value), 0), ((void *)0));


      mips_output_ascii ((asm_out_file), ((char *)(((link)->list.purpose))->identifier.id.str), strlen (((char *)(((link)->list.purpose))->identifier.id.str))+1);
     ...
     tree decl;
{
  ...
  long long object_offset_in_align_units;
  long long object_offset_in_bits;
  long long object_offset_in_bytes;
  tree type;
  ...
  if (((enum tree_code) (decl)->common.code) != FIELD_DECL)
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 2424, __FUNCTION__);
  ...
  type_align_in_bytes = type_align_in_bits / 8;
# 2498 "../../../kgccfe/gnu/dwarfout.c"
...
# 2550 "../../../kgccfe/gnu/dwarfout.c"
static __inline__ void
sibling_attribute ()
{
  char label[30];

  dw2_asm_output_data (2, AT_sibling, "%s", dwarf_attr_name (AT_sibling));
  sprintf (label, "*.L_D%u", pending_sibling_stack[pending_siblings-1]);
  dw2_asm_output_addr (4, label, ((void *)0));
}
     ...
     rtx rtl;
{
  ...
  dw2_asm_output_data (2, AT_location, "%s", dwarf_attr_name (AT_location));
  sprintf (begin_label, "*.L_l%u", current_dienum);
  sprintf (end_label, "*.L_l%u_e", current_dienum);
  dw2_asm_output_delta (2, end_label, begin_label, ((void *)0));
  do { assemble_name ((asm_out_file), (begin_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
# 2599 "../../../kgccfe/gnu/dwarfout.c"
  if (! is_pseudo_reg (rtl)
      && (((enum rtx_code) (rtl)->code) != MEM || ! is_pseudo_reg ((((rtl)->fld[0]).rtx))))
    output_loc_descriptor (rtl);

  do { assemble_name ((asm_out_file), (end_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
}
# 2627 "../../../kgccfe/gnu/dwarfout.c"
static void
     ...
     tree t;
{
  ...
  if (((enum tree_code) (t)->common.code) == TREE_VEC)
    object_offset_in_bytes = tree_low_cst ((((t))->vec.a[1]), 0);
  else
  ...
  do { assemble_name ((asm_out_file), (begin_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  dw2_asm_output_data (1, OP_CONST, "%s", dwarf_stack_op_name (OP_CONST));
  dw2_asm_output_data (4, object_offset_in_bytes, ((void *)0));
  dw2_asm_output_data (1, OP_ADD, "%s", dwarf_stack_op_name (OP_ADD));
  do { assemble_name ((asm_out_file), (end_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
}
     ...
     rtx rtl;
{
  ...
  dw2_asm_output_data (2, AT_const_value_block4, "%s", dwarf_attr_name (AT_const_value_block4));
  sprintf (begin_label, "*.L_l%u", current_dienum);
  sprintf (end_label, "*.L_l%u_e", current_dienum);
  dw2_asm_output_delta (4, end_label, begin_label, ((void *)0));
  do { assemble_name ((asm_out_file), (begin_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);

  switch (((enum rtx_code) (rtl)->code))
    {
      case CONST_INT:
# 2681 "../../../kgccfe/gnu/dwarfout.c"
 dw2_asm_output_data (4, (unsigned) (((rtl)->fld[0]).rtwint), ((void *)0));
 break;
 ...
 dw2_asm_output_data (8, VALUE, ((void *)0));


 break;

      case CONST_STRING:
 mips_output_ascii ((asm_out_file), (((rtl)->fld[0]).rtstr), strlen ((((rtl)->fld[0]).rtstr))+1);
 break;
 ...
 break;
      ...
      case PLUS:
# 2721 "../../../kgccfe/gnu/dwarfout.c"
 break;

      default:
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 2724, __FUNCTION__);
    }

  do { assemble_name ((asm_out_file), (end_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
}
# 2742 "../../../kgccfe/gnu/dwarfout.c"
static void
  ...
  if ((((enum tree_code) (decl)->common.code) != VAR_DECL) && (((enum tree_code) (decl)->common.code) != PARM_DECL))
    {
      ...
      fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 2754, __FUNCTION__);
      return;
    }
# 2832 "../../../kgccfe/gnu/dwarfout.c"
  rtl = ((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl));
 ...
 if (declared_type == passed_type)
   ...
   if (((enum tree_code) (declared_type)->common.code) == INTEGER_TYPE)

     if (((declared_type)->type.size) <= ((passed_type)->type.size))
       rtl = ((decl)->decl.u2.r);
      }
  ...
  switch (((enum rtx_code) (rtl)->code))
    ...
    case CONCAT:
      ...
      location_attribute ((((rtl)->fld[0]).rtx));
      break;

    default:
      fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 2895, __FUNCTION__);
    }
}
     ...
     const char *name_string;
{
  if (name_string && *name_string)
    {
      dw2_asm_output_data (2, AT_name, "%s", dwarf_attr_name (AT_name));
      mips_output_ascii ((asm_out_file), name_string, strlen (name_string)+1);
    }
}
...
fund_type_attribute (ft_code)
     unsigned ft_code;
{
  dw2_asm_output_data (2, AT_fund_type, "%s", dwarf_attr_name (AT_fund_type));
  dw2_asm_output_data (2, ft_code, "%s", dwarf_fund_type_name (ft_code));
}
     ...
     int decl_volatile;
{
  ...
  dw2_asm_output_data (2, AT_mod_fund_type, "%s", dwarf_attr_name (AT_mod_fund_type));
  sprintf (begin_label, "*.L_t%u", current_dienum);
  sprintf (end_label, "*.L_t%u_e", current_dienum);
  dw2_asm_output_delta (2, end_label, begin_label, ((void *)0));
  do { assemble_name ((asm_out_file), (begin_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  write_modifier_bytes (type, decl_const, decl_volatile);
  dw2_asm_output_data (2, fundamental_type_code (root_type (type)), "%s", dwarf_fund_type_name (fundamental_type_code (root_type (type))));
...
user_def_type_attribute (type)
     tree type;
{
  char ud_type_name[30];

  dw2_asm_output_data (2, AT_user_def_type, "%s", dwarf_attr_name (AT_user_def_type));
  sprintf (ud_type_name, "*.L_T%u", ((type)->type.uid));
  dw2_asm_output_addr (4, ud_type_name, ((void *)0));
}
     ...
     int decl_volatile;
{
  ...
  dw2_asm_output_data (2, AT_mod_u_d_type, "%s", dwarf_attr_name (AT_mod_u_d_type));
  sprintf (begin_label, "*.L_t%u", current_dienum);
  sprintf (end_label, "*.L_t%u_e", current_dienum);
  dw2_asm_output_delta (2, end_label, begin_label, ((void *)0));
  do { assemble_name ((asm_out_file), (begin_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  write_modifier_bytes (type, decl_const, decl_volatile);
  sprintf (ud_type_name, "*.L_T%u", ((root_type (type))->type.uid));
  dw2_asm_output_addr (4, ud_type_name, ((void *)0));
  do { assemble_name ((asm_out_file), (end_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
}
# 2986 "../../../kgccfe/gnu/dwarfout.c"
static void
     ...
     tree type;
{
  ...
  dw2_asm_output_data (2, AT_subscr_data, "%s", dwarf_attr_name (AT_subscr_data));
  sprintf (begin_label, "*.L_s%u", current_dienum);
  sprintf (end_label, "*.L_s%u_e", current_dienum);
  dw2_asm_output_delta (2, end_label, begin_label, ((void *)0));
  do { assemble_name ((asm_out_file), (begin_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
# 3009 "../../../kgccfe/gnu/dwarfout.c"
      ...
      if (domain)
 {
   ...
   tree lower = ((domain)->type.minval);
   tree upper = ((domain)->type.maxval);


   if (! type_is_fundamental (domain))
     fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3028, __FUNCTION__);


   dw2_asm_output_data (1, (((1) ? 0 : 4) | ((((enum tree_code) (lower)->common.code) == INTEGER_CST) ? 0 : 2) | ((upper && ((enum tree_code) (upper)->common.code) == INTEGER_CST) ? 0 : 1)), "%s", dwarf_fmt_byte_name ((((1) ? 0 : 4) | ((((enum tree_code) (lower)->common.code) == INTEGER_CST) ? 0 : 2) | ((upper && ((enum tree_code) (upper)->common.code) == INTEGER_CST) ? 0 : 1))));;




   dw2_asm_output_data (2, fundamental_type_code (domain), "%s", dwarf_fund_type_name (fundamental_type_code (domain)));
 ...
 {
# 3058 "../../../kgccfe/gnu/dwarfout.c"
   dw2_asm_output_data (1, FMT_FT_C_X, "%s", dwarf_fmt_byte_name (FMT_FT_C_X));;



   dw2_asm_output_data (2, FT_integer, "%s", dwarf_fund_type_name (FT_integer));
  ...
  dw2_asm_output_data (1, FMT_ET, "%s", dwarf_fmt_byte_name (FMT_ET));;
     ...
     tree tree_node;
{
  ...
  dw2_asm_output_data (2, AT_byte_size, "%s", dwarf_attr_name (AT_byte_size));
 ...
 break;
      ...
      default:
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3116, __FUNCTION__);
    }
  ...
  dw2_asm_output_data (4, size, ((void *)0));
}
# 3145 "../../../kgccfe/gnu/dwarfout.c"
static __inline__ void
     ...
     tree decl;
{
  ...
  if (!type
    ...
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3159, __FUNCTION__);
  ...
  if (! ((target_flags & 0x00010000) != 0))
    {
      highest_order_field_bit_offset += tree_low_cst (((decl)->decl.size), 1);
  ...
  dw2_asm_output_data (2, AT_bit_offset, "%s", dwarf_attr_name (AT_bit_offset));
  dw2_asm_output_data (2, bit_offset, ((void *)0));
}
    ...
    tree decl;
{
  ...
  if (((enum tree_code) (decl)->common.code) != FIELD_DECL
      || ! ((decl)->decl.result))
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3205, __FUNCTION__);

  if (host_integerp (((decl)->decl.size), 1))
    {
      dw2_asm_output_data (2, AT_bit_size, "%s", dwarf_attr_name (AT_bit_size));
      dw2_asm_output_data (4, tree_low_cst (((decl)->decl.size), 1), ((void *)0));
     ...
     tree element;
{
  ...
  dw2_asm_output_data (2, AT_element_list, "%s", dwarf_attr_name (AT_element_list));
  sprintf (begin_label, "*.L_e%u", current_dienum);
  sprintf (end_label, "*.L_e%u_e", current_dienum);
  dw2_asm_output_delta (4, end_label, begin_label, ((void *)0));
  do { assemble_name ((asm_out_file), (begin_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
...
stmt_list_attribute (label)
    const char *label;
{
  dw2_asm_output_data (2, AT_stmt_list, "%s", dwarf_attr_name (AT_stmt_list));
...
{
  dw2_asm_output_data (2, AT_low_pc, "%s", dwarf_attr_name (AT_low_pc));
  dw2_asm_output_addr (4, asm_low_label, ((void *)0));
}
...
{
  dw2_asm_output_data (2, AT_high_pc, "%s", dwarf_attr_name (AT_high_pc));
  dw2_asm_output_addr (4, asm_high_label, ((void *)0));
}
...
{
  dw2_asm_output_data (2, AT_body_begin, "%s", dwarf_attr_name (AT_body_begin));
  dw2_asm_output_addr (4, asm_begin_label, ((void *)0));
}
...
{
  dw2_asm_output_data (2, AT_body_end, "%s", dwarf_attr_name (AT_body_end));
  dw2_asm_output_addr (4, asm_end_label, ((void *)0));
}
...
{
  dw2_asm_output_data (2, AT_language, "%s", dwarf_attr_name (AT_language));
  dw2_asm_output_data (4, language_code, ((void *)0));
}
     ...
     tree context;
{
  ...
  if (context != ((void *)0) && is_tagged_type (context))
    {
      dw2_asm_output_data (2, AT_member, "%s", dwarf_attr_name (AT_member));
      sprintf (label, "*.L_T%u", ((context)->type.uid));
      dw2_asm_output_addr (4, label, ((void *)0));
    }
}
# 3349 "../../../kgccfe/gnu/dwarfout.c"
static __inline__ void
comp_dir_attribute (dirname)
     const char *dirname;
{
  dw2_asm_output_data (2, AT_comp_dir, "%s", dwarf_attr_name (AT_comp_dir));
  mips_output_ascii ((asm_out_file), dirname, strlen (dirname)+1);
}
...
{
  dw2_asm_output_data (2, AT_sf_names, "%s", dwarf_attr_name (AT_sf_names));

  dw2_asm_output_addr (4, sf_names_start_label, ((void *)0));
}
...
{
  dw2_asm_output_data (2, AT_src_info, "%s", dwarf_attr_name (AT_src_info));

  dw2_asm_output_addr (4, src_info_start_label, ((void *)0));
}
...
{
  dw2_asm_output_data (2, AT_mac_info, "%s", dwarf_attr_name (AT_mac_info));

  dw2_asm_output_addr (4, mac_info_start_label, ((void *)0));
}
     ...
     tree func_type;
{
  if ((strcmp (lang_hooks.name, "GNU C") == 0)
    ...
    {
      dw2_asm_output_data (2, AT_prototyped, "%s", dwarf_attr_name (AT_prototyped));
      mips_output_ascii ((asm_out_file), "", strlen ("")+1);
    }
}
...
producer_attribute (producer)
     const char *producer;
{
  dw2_asm_output_data (2, AT_producer, "%s", dwarf_attr_name (AT_producer));
  mips_output_ascii ((asm_out_file), producer, strlen (producer)+1);
}
     ...
     tree decl;
{
  if (((decl)->decl.inline_flag))
    {
      dw2_asm_output_data (2, AT_inline, "%s", dwarf_attr_name (AT_inline));
      mips_output_ascii ((asm_out_file), "", strlen ("")+1);
    }
}
     ...
     tree containing_type;
{
  ...
  dw2_asm_output_data (2, AT_containing_type, "%s", dwarf_attr_name (AT_containing_type));
  sprintf (label, "*.L_T%u", ((containing_type)->type.uid));
  dw2_asm_output_addr (4, label, ((void *)0));
}
     ...
     tree origin;
{
  ...
  dw2_asm_output_data (2, AT_abstract_origin, "%s", dwarf_attr_name (AT_abstract_origin));
  switch (tree_code_type[(int) (((enum tree_code) (origin)->common.code))])
    {
    case 'd':
      sprintf (label, "*.L_E%u", ((origin)->decl.uid));
      break;

    case 't':
      sprintf (label, "*.L_T%u", ((origin)->type.uid));
      break;

    default:
      fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3444, __FUNCTION__);

    }
  dw2_asm_output_addr (4, label, ((void *)0));
}
# 3462 "../../../kgccfe/gnu/dwarfout.c"
static __inline__ void
pure_or_virtual_attribute (func_decl)
     tree func_decl;
{
  if (((func_decl)->decl.virtual_flag))
    {
 ...
 dw2_asm_output_data (2, AT_virtual, "%s", dwarf_attr_name (AT_virtual));
      mips_output_ascii ((asm_out_file), "", strlen ("")+1);
    }
}
# 3485 "../../../kgccfe/gnu/dwarfout.c"
static void
name_and_src_coords_attributes (decl)
    tree decl;
{
  tree decl_name = ((decl)->decl.name);

  if (decl_name && ((char *)(decl_name)->identifier.id.str))
    {
      name_attribute (((char *)(decl_name)->identifier.id.str));
# 3515 "../../../kgccfe/gnu/dwarfout.c"
    }
}
     ...
     int decl_volatile;
{
  ...
  root_type_modified = (code == POINTER_TYPE || code == REFERENCE_TYPE
   ...
   || ((type)->common.readonly_flag) || ((type)->common.volatile_flag));
...
dienum_push ()
{
 ...
 = (unsigned *) xrealloc (pending_sibling_stack,
  ...
  pending_siblings++;
  pending_sibling_stack[pending_siblings-1] = next_unused_dienum++;
}
    ...
    tree decl;
{
  ...
  if (((enum rtx_code) (x)->code) != MEM)
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3657, __FUNCTION__);
  x = (((x)->fld[0]).rtx);
  if (((enum rtx_code) (x)->code) != SYMBOL_REF)
        fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3660, __FUNCTION__);
  fnname = (((x)->fld[0]).rtstr);
  return fnname;
}
# 3672 "../../../kgccfe/gnu/dwarfout.c"
static void
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_array_type, "%s", dwarf_tag_name (TAG_array_type));;
  sibling_attribute ();
  equate_type_number_to_die_number (type);
  member_attribute (((type)->type.context));
# 3696 "../../../kgccfe/gnu/dwarfout.c"
  subscript_data_attribute (type);
}
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_set_type, "%s", dwarf_tag_name (TAG_set_type));;
  sibling_attribute ();
  equate_type_number_to_die_number (type);
  member_attribute (((type)->type.context));
  type_attribute (((type)->common.type), 0, 0);
}
# 3742 "../../../kgccfe/gnu/dwarfout.c"
static void
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_enumeration_type, "%s", dwarf_tag_name (TAG_enumeration_type));;
  sibling_attribute ();
  if (!((type)->common.asm_written_flag))
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3751, __FUNCTION__);
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_structure_type, "%s", dwarf_tag_name (TAG_structure_type));;
  sibling_attribute ();
  if (!((type)->common.asm_written_flag))
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3766, __FUNCTION__);
  abstract_origin_attribute (type);
}
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_union_type, "%s", dwarf_tag_name (TAG_union_type));;
  sibling_attribute ();
  if (!((type)->common.asm_written_flag))
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3781, __FUNCTION__);
  abstract_origin_attribute (type);
}
  ...
  if ((((type)->type.size) != (tree) ((void *)0)))
    {
      ...
      element_list_attribute (((type)->type.values));
    }
}
# 3825 "../../../kgccfe/gnu/dwarfout.c"
static void
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_formal_parameter, "%s", dwarf_tag_name (TAG_formal_parameter));;
  sibling_attribute ();
 ...
 if (origin != ((void *)0))
 ...
 else
   {
     ...
     type_attribute (((node)->common.type),
       ((node)->common.readonly_flag), ((node)->common.volatile_flag));
   }
 if (((node)->decl.abstract_flag))
   ...
   location_or_const_value_attribute (node);
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3860, __FUNCTION__);
    }
}
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_global_subroutine, "%s", dwarf_tag_name (TAG_global_subroutine));;
  sibling_attribute ();
  dienum_push ();
  if (origin != ((void *)0))
    abstract_origin_attribute (origin);
  else
    {
      ...
      member_attribute (((decl)->decl.context));
      type_attribute (((type)->common.type), 0, 0);
  ...
  if (((decl)->decl.abstract_flag))
    ...
    {
      if (! ((decl)->decl.external_flag) && ! in_class
   && decl == current_function_decl)
 {
   char label[30];

   low_pc_attribute (function_start_label (decl));
   sprintf (label, "*.L_f%u_e", (cfun->funcdef_no));
   ...
   if (use_gnu_debug_info_extensions)
     {
       ...
       sprintf (label, "*.L_b%u_e", (cfun->funcdef_no));
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_global_variable, "%s", dwarf_tag_name (TAG_global_variable));;
  sibling_attribute ();
  if (origin != ((void *)0))
    abstract_origin_attribute (origin);
  else
    {
      name_and_src_coords_attributes (decl);
      member_attribute (((decl)->decl.context));
      type_attribute (((decl)->common.type),
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_label, "%s", dwarf_tag_name (TAG_label));;
  sibling_attribute ();
  if (origin != ((void *)0))
    abstract_origin_attribute (origin);
  else
  ...
  if (((decl)->decl.abstract_flag))
    ...
    {
      rtx insn = ((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl));
        ...
        && (((insn)->fld[5]).rtint) == NOTE_INSN_DELETED_LABEL)))
 {
   ...
   if ((((insn))->volatil))
     fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 3980, __FUNCTION__);
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_lexical_block, "%s", dwarf_tag_name (TAG_lexical_block));;
  sibling_attribute ();
  dienum_push ();
  if (! ((stmt)->block.abstract_flag))
    {
      ...
      sprintf (begin_label, "*.L_B%u", ((stmt)->block.block_num));
      low_pc_attribute (begin_label);
      sprintf (end_label, "*.L_B%u_e", ((stmt)->block.block_num));
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_inlined_subroutine, "%s", dwarf_tag_name (TAG_inlined_subroutine));;
  sibling_attribute ();
  dienum_push ();
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_local_variable, "%s", dwarf_tag_name (TAG_local_variable));;
  sibling_attribute ();
  if (origin != ((void *)0))
    abstract_origin_attribute (origin);
  else
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_member, "%s", dwarf_tag_name (TAG_member));;
  sibling_attribute ();
  name_and_src_coords_attributes (decl);
  member_attribute (((decl)->decl.context));
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_ptr_to_member_type, "%s", dwarf_tag_name (TAG_ptr_to_member_type));;
  sibling_attribute ();
  equate_type_number_to_die_number (type);
  member_attribute (((type)->type.context));
  containing_type_attribute (((type)->type.maxval));
  type_attribute (((type)->common.type), 0, 0);
}
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_compile_unit, "%s", dwarf_tag_name (TAG_compile_unit));;
  sibling_attribute ();
  dienum_push ();
  ...
  low_pc_attribute ("*.L_text_b");
  high_pc_attribute ("*.L_text_e");
  if (debug_info_level >= DINFO_LEVEL_NORMAL)
    stmt_list_attribute ("*.L_line_b");
  ...
  if (debug_info_level >= DINFO_LEVEL_NORMAL && use_gnu_debug_info_extensions)
    {
      sf_names_attribute ("*.L_sfnames_b");
      src_info_attribute ("*.L_srcinfo_b");
      if (debug_info_level >= DINFO_LEVEL_VERBOSE)
 mac_info_attribute ("*.L_macinfo_b");
    }
}
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_string_type, "%s", dwarf_tag_name (TAG_string_type));;
  sibling_attribute ();
  equate_type_number_to_die_number (type);
  member_attribute (((type)->type.context));
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_inheritance, "%s", dwarf_tag_name (TAG_inheritance));;
  sibling_attribute ();
  type_attribute (((binfo)->common.type), 0, 0);
  ...
  if (((binfo)->common.public_flag))
    {
      dw2_asm_output_data (2, AT_public, "%s", dwarf_attr_name (AT_public));
      mips_output_ascii ((asm_out_file), "", strlen ("")+1);
    }
  else if (((binfo)->common.protected_flag))
    {
      dw2_asm_output_data (2, AT_protected, "%s", dwarf_attr_name (AT_protected));
      mips_output_ascii ((asm_out_file), "", strlen ("")+1);
    }
}
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_subroutine, "%s", dwarf_tag_name (TAG_subroutine));;
  sibling_attribute ();
  dienum_push ();
  if (origin != ((void *)0))
    abstract_origin_attribute (origin);
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_subroutine_type, "%s", dwarf_tag_name (TAG_subroutine_type));;
  sibling_attribute ();
  dienum_push ();
  equate_type_number_to_die_number (type);
  prototyped_attribute (type);
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_typedef, "%s", dwarf_tag_name (TAG_typedef));;
  sibling_attribute ();
  if (origin != ((void *)0))
    abstract_origin_attribute (origin);
  else
     ...
     void *arg;
{
  ...
  dw2_asm_output_data (2, TAG_unspecified_parameters, "%s", dwarf_tag_name (TAG_unspecified_parameters));;
  sibling_attribute ();
# 4380 "../../../kgccfe/gnu/dwarfout.c"
  if (((enum tree_code) (decl_or_type)->common.code) == FUNCTION_DECL && ((decl_or_type)->decl.initial))
    {
      name_attribute ("...");
...
# 4403 "../../../kgccfe/gnu/dwarfout.c"
static void
output_die (die_specific_output_function, param)
     void (*die_specific_output_function) (void *);
     void *param;
{
  char begin_label[30];
  char end_label[30];

  current_dienum = pending_sibling_stack[pending_siblings-1];
  pending_sibling_stack[pending_siblings-1] = next_unused_dienum;

  sprintf (begin_label, "*.L_D%u", current_dienum);
  sprintf (end_label, "*.L_D%u_e", current_dienum);
...
end_sibling_chain ()
{
  ...
  dw2_asm_output_data (4, 4, ((void *)0));

  dienum_pop ();
}
# 4467 "../../../kgccfe/gnu/dwarfout.c"
static void
     ...
     tree function_or_method_type;
{
  ...
  tree first_parm_type = ((function_or_method_type)->type.values);




  int save_asm_written = ((function_or_method_type)->common.asm_written_flag);
  ((function_or_method_type)->common.asm_written_flag) = 1;
# 4490 "../../../kgccfe/gnu/dwarfout.c"
  if (((enum tree_code) (function_or_method_type)->common.code) == METHOD_TYPE)
    first_parm_type = ((first_parm_type)->common.chain);




  for (link = first_parm_type; link; link = ((link)->common.chain))
    {
 ...
 break;
  ...
  ((function_or_method_type)->common.asm_written_flag) = save_asm_written;
}
...
# 4588 "../../../kgccfe/gnu/dwarfout.c"
static __inline__ int
type_ok_for_scope (type, scope)
    tree type;
    tree scope;
{
# 4604 "../../../kgccfe/gnu/dwarfout.c"
  return is_tagged_type (type)
  ? (((type)->type.context) == scope

     || (scope == (tree) ((void *)0)
  && ((enum tree_code) (((type)->type.context))->common.code) == NAMESPACE_DECL)
     || (scope == (tree) ((void *)0) && is_tagged_type (((type)->type.context))
  && ((((type)->type.context))->common.asm_written_flag)))
  : (scope == (tree) ((void *)0) || ! is_tagged_type (scope));
}
# 4625 "../../../kgccfe/gnu/dwarfout.c"
static void
     ...
     tree containing_scope;
{
      ...
      if (type_ok_for_scope (type, containing_scope))
 {
   ...
   ((type)->common.asm_written_flag) = 0;
...
output_type (type, containing_scope)
     ...
     tree containing_scope;
{
  if (type == 0 || type == global_trees[TI_ERROR_MARK])
    return;
  ...
  if (((type)->common.asm_written_flag))
    {
      if (finalizing && (((enum tree_code) (type)->common.code) == ARRAY_TYPE || ((enum tree_code) (type)->common.code) == RECORD_TYPE || ((enum tree_code) (type)->common.code) == UNION_TYPE || ((enum tree_code) (type)->common.code) == QUAL_UNION_TYPE || ((enum tree_code) (type)->common.code) == SET_TYPE))
 {
   tree member;
   ...
   for (member = ((type)->type.values); member;
        member = ((member)->common.chain))
     if (((enum tree_code) (member)->common.code) == TYPE_DECL
  && ! ((((member)->common.type))->common.asm_written_flag))
       output_type (((member)->common.type), containing_scope);
 }
      return;
    }
  ...
  if (((type)->type.context)
      && (tree_code_type[(int) (((enum tree_code) (((type)->type.context))->common.code))] == 't')
      && ! ((((type)->type.context))->common.asm_written_flag))
    {
      output_type (((type)->type.context), containing_scope);
      return;
    }
 ...
 break;
      ...
      case VECTOR_TYPE:
 output_type (((type)->type.values), containing_scope);
 break;
 ...
 output_type (((type)->common.type), containing_scope);
 break;

      case OFFSET_TYPE:


 output_type (((type)->type.maxval), containing_scope);
 ...
 break;
      ...
      case FILE_TYPE:
 output_type (((type)->common.type), containing_scope);
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 4784, __FUNCTION__);
 break;
 ...
 break;
      ...
      case UNION_TYPE:
      case QUAL_UNION_TYPE:
# 4857 "../../../kgccfe/gnu/dwarfout.c"
 if (!(((type)->type.size) != (tree) ((void *)0))
     && (((type)->type.context) == ((void *)0)
  ...
  || ((enum tree_code) (((type)->type.context))->common.code) == NAMESPACE_DECL)
     && !finalizing)
   {
     ...
     if (! decl_function_context (((type)->common.chain)))
       add_incomplete_type (type);
     return;
   }
 ...
 switch (((enum tree_code) (type)->common.code))
   ...
   default:
     fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 4892, __FUNCTION__);
   }
# 4912 "../../../kgccfe/gnu/dwarfout.c"
 if ((((type)->type.size) != (tree) ((void *)0)))
   {

     if (((type)->type.binfo) && ((((type)->type.binfo))->vec.a[4]))
       {
  register tree bases = ((((type)->type.binfo))->vec.a[4]);
  register int n_bases = ((bases)->vec.length);
  register int i;

  for (i = 0; i < n_bases; i++)
    {
      tree binfo = ((bases)->vec.a[i]);
      output_type (((binfo)->common.type), containing_scope);
...

     {
       ...
       for (normal_member = ((type)->type.values);
     normal_member;
     normal_member = ((normal_member)->common.chain))
...

     {
       ...
       for (func_member = ((type)->type.maxval);
     func_member;
     func_member = ((func_member)->common.chain))
  {

    if (((func_member)->decl.abstract_origin))
      continue;
 ...
 break;
      ...
      default:
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 4984, __FUNCTION__);
    }
     ...
     tree type;
{
  ...
  if (type != type_main_variant (type))
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 5003, __FUNCTION__);

  if (!((type)->common.asm_written_flag))
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 5006, __FUNCTION__);
 ...
 break;
      ...
      default:
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 5027, __FUNCTION__);
    }
}
      ...
      if (! is_body_block (origin ? origin : stmt))
 {
   ...
   if (debug_info_level > DINFO_LEVEL_TERSE)
   ...
   else
     {
       ...
       for (decl = ((stmt)->block.vars); decl; decl = ((decl)->common.chain))
...
# 5110 "../../../kgccfe/gnu/dwarfout.c"
  if (origin_code == FUNCTION_DECL && ((stmt)->block.abstract_flag))
                                                              ;
...
is_redundant_typedef (decl)
     tree decl;
{
  if ((((decl)->decl.name) == ((void *)0) || (((decl)->decl.artificial_flag) && is_tagged_type (((decl)->common.type)) && decl == ((((decl)->common.type))->common.chain))))
    return 1;
     ...
     tree containing_scope;
{
  ...
  if ((((enum tree_code) (((decl)->common.type))->common.code) == RECORD_TYPE
      ...
      && ((((decl)->decl.name) == 0 && ((((decl)->common.type))->type.name) == 0)
   || (((((decl)->common.type))->type.values)
       && (((enum tree_code) (((((decl)->common.type))->type.values))->common.code) == ERROR_MARK))))
    return;



  if (((decl)->decl.ignored_flag))
    return;
  ...
  switch (((enum tree_code) (decl)->common.code))
   ...
   break;
      ...
      output_type (((((decl)->common.type))->common.type), containing_scope);
 ...
 if (origin)
   output_type (origin, containing_scope);
      ...
      if (((decl)->decl.inline_flag) && ! ((decl)->decl.abstract_flag)
   && ! (containing_scope && (tree_code_type[(int) (((enum tree_code) (containing_scope)->common.code))] == 't')))
      ...
      if (((decl)->common.public_flag))
 {
   ...
   sprintf (label, "*.L_P%u", next_pubname_number++);
   do { assemble_name ((asm_out_file), (label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
 }



      output_die (((decl)->common.public_flag) || ((decl)->decl.external_flag)
    ? output_global_subroutine_die
    : output_local_subroutine_die,
    decl);
# 5288 "../../../kgccfe/gnu/dwarfout.c"
      if (decl != current_function_decl || in_class)
 output_formal_types (((decl)->common.type));
      else
 {
...
# 5351 "../../../kgccfe/gnu/dwarfout.c"
   output_pending_types_for_scope (decl);
# 5362 "../../../kgccfe/gnu/dwarfout.c"
   {
     tree fn_arg_types = ((((decl)->common.type))->type.values);
  ...
  if (!((decl)->decl.initial))
   ...
   {
     tree outer_scope = ((decl)->decl.initial);

     if (outer_scope && ((enum tree_code) (outer_scope)->common.code) != ERROR_MARK)
       {
# 5406 "../../../kgccfe/gnu/dwarfout.c"
  ...
  output_pending_types_for_scope (decl);
    ...
    case TYPE_DECL:
      ...
      if (debug_info_level <= DINFO_LEVEL_TERSE)
 if (! (((decl)->decl.name) == ((void *)0) || (((decl)->decl.artificial_flag) && is_tagged_type (((decl)->common.type)) && decl == ((((decl)->common.type))->common.chain)))
     || (! (((((decl)->common.type))->type.size) == 0) && ! in_class))
   return;
# 5445 "../../../kgccfe/gnu/dwarfout.c"
      if ((((decl)->decl.name) == ((void *)0) || (((decl)->decl.artificial_flag) && is_tagged_type (((decl)->common.type)) && decl == ((((decl)->common.type))->common.chain))) && ((decl)->decl.abstract_origin))
 {
   output_tagged_type_instantiation (((decl)->common.type));
   return;
 }

      output_type (((decl)->common.type), containing_scope);
 ...
 if (origin)
   output_type (origin, containing_scope);
      ...
      if (((decl)->common.public_flag) && ! ((decl)->decl.abstract_flag))
 {
   char label[30];
 ...
 if (origin != ((void *)0) && ((enum tree_code) (origin)->common.code) == PARM_DECL)
   func = output_formal_parameter_die;
 else
   {
     if (((decl)->common.public_flag) || ((decl)->decl.external_flag))
      ...
      if (((decl)->decl.name) != 0)
 {
   ...
   output_die (output_member_die, decl);
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 5550, __FUNCTION__);
    }
}
     ...
     int set_finalizing;
{
  ...
  switch (((enum tree_code) (decl)->common.code))
    ...
    case FUNCTION_DECL:
      ...
      if (((decl)->decl.external_flag) && ((decl)->decl.u1.f))
 return;
# 5663 "../../../kgccfe/gnu/dwarfout.c"
      if (((decl)->decl.initial) == (tree) ((void *)0))
 return;
   ...
   && ! ((decl)->decl.abstract_flag))
 {
   ...
   sprintf (label, "*.L_P%u", next_pubname_number);
   dw2_asm_output_addr (4, label, ((void *)0));
   mips_output_ascii ((asm_out_file), ((char *)(((decl)->decl.name))->identifier.id.str), strlen (((char *)(((decl)->decl.name))->identifier.id.str))+1);
...
# 5698 "../../../kgccfe/gnu/dwarfout.c"
   ...
   if (((decl)->decl.initial) == ((void *)0))
     {
       ...
       dw2_asm_output_addr (4, ((char *)(decl_assembler_name (decl))->identifier.id.str), ((void *)0));

       dw2_asm_output_data (4, (unsigned) int_size_in_bytes (((decl)->common.type)), ((void *)0));
 ...
 return;
    ...
    case TYPE_DECL:
# 5765 "../../../kgccfe/gnu/dwarfout.c"
      if ((((decl)->decl.locus).line) == 0
   && (type_is_fundamental (((decl)->common.type))
       || ((enum tree_code) (((decl)->common.type))->common.code) == LANG_TYPE))
 return;
 ...
 if (! (((decl)->decl.name) == ((void *)0) || (((decl)->decl.artificial_flag) && is_tagged_type (((decl)->common.type)) && decl == ((((decl)->common.type))->common.chain)))
  ...
  output_decl (decl, (tree) ((void *)0));
# 5803 "../../../kgccfe/gnu/dwarfout.c"
  output_pending_types_for_scope ((tree) ((void *)0));
  ...
  if (! ((decl)->decl.context))
    {
      if (pending_types != 0)
 fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 5813, __FUNCTION__);
    }
     ...
     unsigned int blocknum;
{
  ...
  function_section (current_function_decl);
  sprintf (label, "*.L_B%u_e", blocknum);
  do { assemble_name ((asm_out_file), (label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
}
     ...
     const char *file __attribute__ ((__unused__));
{
  ...
  function_section (current_function_decl);
  sprintf (label, "*.L_b%u", (cfun->funcdef_no));
  do { assemble_name ((asm_out_file), (label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
}
...
generate_new_sfname_entry ()
{
  ...
  sprintf (label, "*.L_F%u", filename_table[0].number);
  do { assemble_name ((asm_out_file), (label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  mips_output_ascii ((asm_out_file), filename_table[0].name ? filename_table[0].name : "", strlen (filename_table[0].name ? filename_table[0].name : "")+1);



  fprintf ((asm_out_file), "%s\n", "\t.previous");
}
# 5975 "../../../kgccfe/gnu/dwarfout.c"
static unsigned
     ...
     unsigned files_entry_num;
{
  ...
  sprintf (label, "*.L_LE%u", line_entry_num);
  dw2_asm_output_delta (4, label, "*.L_line_b", ((void *)0));
  sprintf (label, "*.L_F%u", files_entry_num);
  dw2_asm_output_delta (4, label, "*.L_sfnames_b", ((void *)0));
  fprintf ((asm_out_file), "%s\n", "\t.previous");
}
     ...
     const char *filename;
{
  if (debug_info_level >= DINFO_LEVEL_NORMAL
      ...
      && ((current_function_decl)->decl.section_name) == (tree) ((void *)0))
    {
      ...
      function_section (current_function_decl);
      sprintf (label, "*.L_LC%u", ++last_line_entry_num);
      do { assemble_name ((asm_out_file), (label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
 ...
 {
   char line_entry_label[30];

   sprintf (line_entry_label, "*.L_LE%u", last_line_entry_num);
   do { assemble_name ((asm_out_file), (line_entry_label)); fputs_unlocked (":\n", (asm_out_file)); } while (0);
 }
 ...
 if (tail != ((void *)0))
   filename = tail;
      ...
      dw2_asm_output_data (2, 0xffff, ((void *)0));
      dw2_asm_output_delta (4, label, "*.L_text_b", ((void *)0));
      fprintf ((asm_out_file), "%s\n", "\t.previous");
     ...
     const char *string;
{
  ...
  assemble_integer (gen_rtx_fmt_ee (PLUS, (SImode), (gen_rtx_CONST_INT (VOIDmode, (long long) (type << 24))), (offset)),
      4, 8, 1);
  mips_output_ascii ((asm_out_file), string, strlen (string)+1);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
}
     ...
     const char *filename;
{
  ...
  sprintf (label, "*.L_F%u", lookup_filename (filename));
  label1 = (*label == '*') + label;
  label2 = (*"*.L_sfnames_b" == '*') + "*.L_sfnames_b";
  generate_macinfo_entry (MACINFO_start,
     gen_rtx_fmt_ee (MINUS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (label1))), (gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (label2)))),
...
dwarfout_end_source_file (lineno)
     unsigned lineno;
{
  generate_macinfo_entry (MACINFO_resume, gen_rtx_CONST_INT (VOIDmode, (long long) (lineno)), "");
}
     ...
     const char *buffer;
{
  ...
  generate_macinfo_entry (MACINFO_define, gen_rtx_CONST_INT (VOIDmode, (long long) (lineno)), buffer);
}
...
dwarfout_undef (lineno, buffer)
     ...
     const char *buffer;
{
  generate_macinfo_entry (MACINFO_undef, gen_rtx_CONST_INT (VOIDmode, (long long) (lineno)), buffer);
}
     ...
     const char *main_input_filename;
{
 ...
 xmalloc (64 * sizeof (unsigned));
  ...
  filename_table
    = (filename_entry *)
 xmalloc (64 * sizeof (filename_entry));
  ft_entries_allocated = 64;
  ft_entries = 0;
  ...
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".text");
  do { assemble_name ((asm_out_file), ("*.L_text_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
  ...
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".data");
  do { assemble_name ((asm_out_file), ("*.L_data_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
# 6257 "../../../kgccfe/gnu/dwarfout.c"
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".rodata");
  do { assemble_name ((asm_out_file), ("*.L_rodata_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
# 6273 "../../../kgccfe/gnu/dwarfout.c"
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".bss");
  do { assemble_name ((asm_out_file), ("*.L_bss_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
      ...
      if (use_gnu_debug_info_extensions)
 {
   ...
   fputc_unlocked ('\n', asm_out_file);
   fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".debug_sfnames");
   do { assemble_name ((asm_out_file), ("*.L_sfnames_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
   {
   ...
   && use_gnu_debug_info_extensions)
 {
   ...
   fputc_unlocked ('\n', asm_out_file);
   fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".debug_macinfo");
   do { assemble_name ((asm_out_file), ("*.L_macinfo_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
   fprintf ((asm_out_file), "%s\n", "\t.previous");
 }
      ...
      fputc_unlocked ('\n', asm_out_file);
      fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".line");
      do { assemble_name ((asm_out_file), ("*.L_line_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
      dw2_asm_output_delta (4, "*.L_line_e", "*.L_line_b", ((void *)0));
      dw2_asm_output_addr (4, "*.L_text_b", ((void *)0));
      fprintf ((asm_out_file), "%s\n", "\t.previous");
      ...
      if (use_gnu_debug_info_extensions)
 {
   ...
   fputc_unlocked ('\n', asm_out_file);
   fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".debug_srcinfo");
   do { assemble_name ((asm_out_file), ("*.L_srcinfo_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
   dw2_asm_output_addr (4, "*.L_line_b", ((void *)0));
   dw2_asm_output_addr (4, "*.L_sfnames_b", ((void *)0));
   dw2_asm_output_addr (4, "*.L_text_b", ((void *)0));
   dw2_asm_output_addr (4, "*.L_text_e", ((void *)0));



   dw2_asm_output_data (4, -1, ((void *)0));
   ...
   fprintf ((asm_out_file), "%s\n", "\t.previous");
      ...
      fputc_unlocked ('\n', asm_out_file);
      fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".debug_pubnames");
      dw2_asm_output_addr (4, "*.L_debug_b", ((void *)0));
      fprintf ((asm_out_file), "%s\n", "\t.previous");
      ...
      fputc_unlocked ('\n', asm_out_file);
      fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".debug_aranges");
      dw2_asm_output_delta (4, "*.L_debug_aranges_end", "*.L_debug_aranges_begin", ((void *)0));


      do { assemble_name ((asm_out_file), ("*.L_debug_aranges_begin")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
      dw2_asm_output_data (1, 1, ((void *)0));
      dw2_asm_output_addr (4, "*.L_debug_b", ((void *)0));
      fprintf ((asm_out_file), "%s\n", "\t.previous");
    }
  ...
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".debug");
  do { assemble_name ((asm_out_file), ("*.L_debug_b")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
...
dwarfout_finish (main_input_filename)
     const char *main_input_filename __attribute__ ((__unused__));
{
  char label[30];
...
# 6422 "../../../kgccfe/gnu/dwarfout.c"
  ...
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".text");
  do { assemble_name ((asm_out_file), ("*.L_text_e")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
  ...
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".data");
  do { assemble_name ((asm_out_file), ("*.L_data_e")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
# 6454 "../../../kgccfe/gnu/dwarfout.c"
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".rodata");
  do { assemble_name ((asm_out_file), ("*.L_rodata_e")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
# 6470 "../../../kgccfe/gnu/dwarfout.c"
  fputc_unlocked ('\n', asm_out_file);
  fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".bss");
  do { assemble_name ((asm_out_file), ("*.L_bss_e")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
  fprintf ((asm_out_file), "%s\n", "\t.previous");
  ...
  if (debug_info_level >= DINFO_LEVEL_NORMAL)
    {
      ...
      fputc_unlocked ('\n', asm_out_file);
      fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".line");
      do { assemble_name ((asm_out_file), ("*.L_line_last")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
      dw2_asm_output_data (4, 0, ((void *)0));
      dw2_asm_output_data (2, 0xffff, ((void *)0));
      dw2_asm_output_delta (4, "*.L_text_e", "*.L_text_b", ((void *)0));
      do { assemble_name ((asm_out_file), ("*.L_line_e")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
      fprintf ((asm_out_file), "%s\n", "\t.previous");
      ...
      if (use_gnu_debug_info_extensions)
 {
   ...
   fputc_unlocked ('\n', asm_out_file);
   fprintf ((asm_out_file), "%s%s\n", "\t.section\t", ".debug_srcinfo");
   dw2_asm_output_delta (4, "*.L_line_last", "*.L_line_b", ((void *)0));
...
# 6535 "../../../kgccfe/gnu/dwarfout.c"
      ...
      dw2_asm_output_addr (4, "*.L_data_b", ((void *)0));
      dw2_asm_output_delta (4, "*.L_data_e", "*.L_data_b", ((void *)0));
      ...
      dw2_asm_output_addr (4, "*.L_rodata_b", ((void *)0));
      dw2_asm_output_delta (4, "*.L_rodata_e", "*.L_rodata_b", ((void *)0));
# 6560 "../../../kgccfe/gnu/dwarfout.c"
      dw2_asm_output_addr (4, "*.L_bss_b", ((void *)0));
      dw2_asm_output_delta (4, "*.L_bss_e", "*.L_bss_b", ((void *)0));

      dw2_asm_output_data (4, 0, ((void *)0));
      dw2_asm_output_data (4, 0, ((void *)0));

      do { assemble_name ((asm_out_file), ("*.L_debug_aranges_end")); fputs_unlocked (":\n", (asm_out_file)); } while (0);
      fprintf ((asm_out_file), "%s\n", "\t.previous");
    }
  ...
  if (pending_types != 0)
    fancy_abort ("../../../kgccfe/gnu/dwarfout.c", 6574, __FUNCTION__);
}
