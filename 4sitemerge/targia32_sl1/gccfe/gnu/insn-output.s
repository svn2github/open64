...
output_0:
.LFB15:
	.file 1 "../../../kgccfe/gnu/MIPS/insn-output.c"
	.loc 1 32 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.L97:
	...
	movl	which_alternative@GOT(%ecx), %eax
	movl	(%eax), %eax
	movl	macc.11950@GOTOFF(%ecx,%eax,4), %eax
	movl	%eax, -4(%ebp)
	jmp	.L94
.L100:
	.loc 1 315 0
	...
	jne	.L104
	.loc 1 318 0
	movl	madd.11949@GOTOFF(%ecx), %eax
	movl	%eax, -4(%ebp)
	jmp	.L94
.L104:
	.loc 1 320 0
...
.L102:
	...
	movl	which_alternative@GOT(%ecx), %eax
	movl	(%eax), %eax
	movl	madd.11949@GOTOFF(%ecx,%eax,4), %eax
	movl	%eax, -4(%ebp)
.L94:
	movl	-4(%ebp), %eax
.LBE3:
...
.LBB5:
	...
	movl	which_alternative@GOT(%ecx), %eax
	movl	(%eax), %eax
	movl	sign.12097@GOTOFF(%ecx,%eax,4), %eax
	movl	%eax, -4(%ebp)
	jmp	.L150
.L148:
	.loc 1 480 0
	movl	which_alternative@GOT(%ecx), %eax
	movl	(%eax), %eax
	movl	zero.12098@GOTOFF(%ecx,%eax,4), %eax
	movl	%eax, -4(%ebp)
.L150:
	movl	-4(%ebp), %eax
.LBE5:
...
.LBB6:
	...
	movl	which_alternative@GOT(%ecx), %eax
	movl	(%eax), %eax
	movl	sign.12115@GOTOFF(%ecx,%eax,4), %eax
	movl	%eax, -4(%ebp)
	jmp	.L155
.L153:
	.loc 1 498 0
	movl	which_alternative@GOT(%ecx), %eax
	movl	(%eax), %eax
	movl	zero.12116@GOTOFF(%ecx,%eax,4), %eax
	movl	%eax, -4(%ebp)
.L155:
	movl	-4(%ebp), %eax
.LBE6:
...
.LFE41:
	...
	.section	.rodata
	.type	__FUNCTION__.12147, @object
	.size	__FUNCTION__.12147, 10
__FUNCTION__.12147:
	.string	"output_54"
.LC59:
	.string	"maddu\t%1,%2"
.LC60:
	...
	.align 4
.LC61:
	.string	"../../../kgccfe/gnu/MIPS/insn-output.c"
	.text
...
.L171:
	.loc 1 552 0
	leal	__FUNCTION__.12147@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$552, 4(%esp)
...
.LFE133:
	...
	.section	.rodata
	.type	__FUNCTION__.13656, @object
	.size	__FUNCTION__.13656, 11
__FUNCTION__.13656:
	.string	"output_218"
.LC144:
	.string	"drorv\t%0,%1,%2"
...
.L567:
	.loc 1 2085 0
	leal	__FUNCTION__.13656@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2085, 4(%esp)
	leal	.LC61@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LBB26:
	...
	je	.L820
	.loc 1 3104 0
	leal	__FUNCTION__.14573@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3104, 4(%esp)
	leal	.LC61@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE195:
	...
	.section	.rodata
	.type	__FUNCTION__.14592, @object
	.size	__FUNCTION__.14592, 11
__FUNCTION__.14592:
	.string	"output_336"
	.text
...
.LBB27:
	...
	je	.L824
	.loc 1 3123 0
	leal	__FUNCTION__.14592@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$3123, 4(%esp)
	leal	.LC61@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
