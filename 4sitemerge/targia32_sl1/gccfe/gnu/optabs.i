...
# 32 "../../../kgccfe/gnu/optabs.c" 2



# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 36 "../../../kgccfe/gnu/optabs.c" 2
...
# 50 "../../../kgccfe/gnu/optabs.c" 2
# 60 "../../../kgccfe/gnu/optabs.c"
...
enum insn_code floattab[(int) MAX_MACHINE_MODE][(int) MAX_MACHINE_MODE][2];
...
enum insn_code movcc_gen_code[(int) MAX_MACHINE_MODE];
...
static rtx widen_operand (rtx, enum machine_mode, enum machine_mode, int, int);

static int expand_cmplxdiv_straight (rtx, rtx, rtx, rtx, rtx, rtx, enum machine_mode, int, enum optab_methods, enum mode_class, optab);



static int expand_cmplxdiv_wide (rtx, rtx, rtx, rtx, rtx, rtx, enum machine_mode, int, enum optab_methods, enum mode_class, optab);



static void prepare_cmp_insn (rtx *, rtx *, enum rtx_code *, rtx, enum machine_mode *, int *, enum can_compare_purpose);


static enum insn_code can_fix_p (enum machine_mode, enum machine_mode, int, int *);
...
static __inline__ optab init_optab (enum rtx_code);
static __inline__ optab init_optabv (enum rtx_code);
...
static void emit_cmp_and_jump_insn_1 (rtx, rtx, enum machine_mode, enum rtx_code, int, rtx);

static void prepare_float_lib_cmp (rtx *, rtx *, enum rtx_code *, enum machine_mode *, int *);

static rtx expand_vector_binop (enum machine_mode, optab, rtx, rtx, rtx, int, enum optab_methods);


static rtx expand_vector_unop (enum machine_mode, optab, rtx, rtx, int);
# 151 "../../../kgccfe/gnu/optabs.c"
static int
     ...
     rtx op0, op1;
{
  ...
  if (! insns
      || ! ((rtx_class[(int) (((enum rtx_code) (insns)->code))]) == 'i')
      || (((insns)->fld[2]).rtx) == (rtx) 0)
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 164, __FUNCTION__);

  if ((rtx_class[(int) (code)]) != '1' && (rtx_class[(int) (code)]) != '2'
      && (rtx_class[(int) (code)]) != 'c' && (rtx_class[(int) (code)]) != '<')
    return 1;
  ...
  for (last_insn = insns;
       (((last_insn)->fld[2]).rtx) != (rtx) 0;
       last_insn = (((last_insn)->fld[2]).rtx))
    ;

  set = (((rtx_class[(int) (((enum rtx_code) (last_insn)->code))]) == 'i') ? (((enum rtx_code) ((((last_insn)->fld[5]).rtx))->code) == SET ? (((last_insn)->fld[5]).rtx) : single_set_2 (last_insn, (((last_insn)->fld[5]).rtx))) : (rtx) 0);
  if (set == (rtx) 0)
    return 1;

  if (! rtx_equal_p ((((set)->fld[0]).rtx), target)


      && (((enum rtx_code) ((((set)->fld[0]).rtx))->code) != STRICT_LOW_PART
   || ! rtx_equal_p ((((((((((set)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx),
       target)))
    return 1;
     ...
     int no_extend;
{
  ...
  emit_move_insn (gen_lowpart (((enum machine_mode) (op)->mode), result), op);
  return result;
}
     ...
     enum optab_methods methods;
{
  ...
  if (binop == 0)
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 665, __FUNCTION__);

  return expand_binop (mode, binop, op0, op1, target, unsignedp, methods);
}
# 681 "../../../kgccfe/gnu/optabs.c"
rtx
     ...
     enum optab_methods methods;
{
  ...
  if ((((enum rtx_code) (op0)->code) == LABEL_REF || ((enum rtx_code) (op0)->code) == SYMBOL_REF || ((enum rtx_code) (op0)->code) == CONST_INT || ((enum rtx_code) (op0)->code) == CONST_DOUBLE || ((enum rtx_code) (op0)->code) == CONST || ((enum rtx_code) (op0)->code) == HIGH || ((enum rtx_code) (op0)->code) == CONST_VECTOR || ((enum rtx_code) (op0)->code) == CONSTANT_P_RTX) && preserve_subexpressions_p ()
      && rtx_cost (op0, binoptab->code) > ((1) * 4))
    op0 = force_reg (mode, op0);

  if ((((enum rtx_code) (op1)->code) == LABEL_REF || ((enum rtx_code) (op1)->code) == SYMBOL_REF || ((enum rtx_code) (op1)->code) == CONST_INT || ((enum rtx_code) (op1)->code) == CONST_DOUBLE || ((enum rtx_code) (op1)->code) == CONST || ((enum rtx_code) (op1)->code) == HIGH || ((enum rtx_code) (op1)->code) == CONST_VECTOR || ((enum rtx_code) (op1)->code) == CONSTANT_P_RTX) && preserve_subexpressions_p ()
  ...
  if ((rtx_class[(int) (binoptab->code)]) == 'c'
 ...
 temp = gen_reg_rtx (mode);
      ...
      pat = (*insn_data[(int) (icode)].genfun) (temp, xop0, xop1);
      if (pat)
 {



   if (((rtx_class[(int) (((enum rtx_code) (pat)->code))]) == 'i') && (((pat)->fld[2]).rtx) != (rtx) 0
 ...
 delete_insns_since (last);
  ...
  if (binoptab == (optab_table[OTI_smul]) && ((enum machine_mode)mode_wider_mode[(int) (mode)]) != VOIDmode
      && (((unsignedp ? (optab_table[OTI_umul_widen]) : (optab_table[OTI_smul_widen]))
    ->handlers[(int) ((enum machine_mode)mode_wider_mode[(int) (mode)])].insn_code)
   != CODE_FOR_nothing))
    {
      temp = expand_binop (((enum machine_mode)mode_wider_mode[(int) (mode)]),
      unsignedp ? (optab_table[OTI_umul_widen]) : (optab_table[OTI_smul_widen]),
      ...
      if (temp != 0)
 {
  ...
  if ((class == MODE_INT || class == MODE_FLOAT || class == MODE_COMPLEX_FLOAT)
    ...
    for (wider_mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]); wider_mode != VOIDmode;
  wider_mode = ((enum machine_mode)mode_wider_mode[(int) (wider_mode)]))
      {
 if (binoptab->handlers[(int) wider_mode].insn_code != CODE_FOR_nothing
     || (binoptab == (optab_table[OTI_smul])
  && ((enum machine_mode)mode_wider_mode[(int) (wider_mode)]) != VOIDmode
  && (((unsignedp ? (optab_table[OTI_umul_widen]) : (optab_table[OTI_smul_widen]))
       ->handlers[(int) ((enum machine_mode)mode_wider_mode[(int) (wider_mode)])].insn_code)
      != CODE_FOR_nothing)))
   {
     rtx xop0 = op0, xop1 = op1;
     int no_extend = 0;
 ...
 target = gen_reg_rtx (mode);
      ...
      for (i = 0; i < (mode_bitsize[(int) (mode)]) / (8 * ((target_flags & 0x00002000) ? 8 : 4)); i++)
 {
   ...
   if (target_piece != x)
     emit_move_insn (target_piece, x);
      ...
      if (i == (mode_bitsize[(int) (mode)]) / (8 * ((target_flags & 0x00002000) ? 8 : 4)))
 {
  ...
  if ((binoptab == (optab_table[OTI_lshr]) || binoptab == (optab_table[OTI_ashl])
      ...
      && (mode_size[(int) (mode)]) == 2 * ((target_flags & 0x00002000) ? 8 : 4)
      && binoptab->handlers[(int) word_mode].insn_code != CODE_FOR_nothing
 ...
 target = gen_reg_rtx (mode);
      ...
      outof_word = left_shift ^ ! ((target_flags & 0x00010000) != 0);
      ...
      if (shift_count >= (8 * ((target_flags & 0x00002000) ? 8 : 4)))
 {
   inter = expand_binop (word_mode, binoptab,
          outof_input,
          gen_rtx_CONST_INT (VOIDmode, (long long) (shift_count - (8 * ((target_flags & 0x00002000) ? 8 : 4)))),
   ...
   if (inter != 0 && binoptab != (optab_table[OTI_ashr]))
     ...
     inter = expand_binop (word_mode, binoptab,
      outof_input,
      gen_rtx_CONST_INT (VOIDmode, (long long) ((8 * ((target_flags & 0x00002000) ? 8 : 4)) - 1)),
      ...
      else
 {
   ...
   carries = expand_binop (word_mode, reverse_unsigned_shift,
      outof_input,
      gen_rtx_CONST_INT (VOIDmode, (long long) ((8 * ((target_flags & 0x00002000) ? 8 : 4)) - shift_count)),
      ...
      else
 {
   ...
   reverse_unsigned_shift = (left_shift ^ (shift_count < (8 * ((target_flags & 0x00002000) ? 8 : 4)))
        ? (optab_table[OTI_lshr]) : (optab_table[OTI_ashl]));

   unsigned_shift = (left_shift ^ (shift_count < (8 * ((target_flags & 0x00002000) ? 8 : 4)))
       ? (optab_table[OTI_ashl]) : (optab_table[OTI_lshr]));

   if (shift_count > (8 * ((target_flags & 0x00002000) ? 8 : 4)))
     {
       first_shift_count = gen_rtx_CONST_INT (VOIDmode, (long long) (shift_count - (8 * ((target_flags & 0x00002000) ? 8 : 4))));
       second_shift_count = gen_rtx_CONST_INT (VOIDmode, (long long) (2 * (8 * ((target_flags & 0x00002000) ? 8 : 4)) - shift_count));
     }
   else
     {
       first_shift_count = gen_rtx_CONST_INT (VOIDmode, (long long) ((8 * ((target_flags & 0x00002000) ? 8 : 4)) - shift_count));
       second_shift_count = gen_rtx_CONST_INT (VOIDmode, (long long) (shift_count));
     }
      ...
      if (inter != 0)
 {
  ...
  if ((binoptab == (optab_table[OTI_add]) || binoptab == (optab_table[OTI_sub]))
      ...
      && binoptab->handlers[(int) word_mode].insn_code != CODE_FOR_nothing)
    {
      ...
      const unsigned int nwords = (mode_bitsize[(int) (mode)]) / (8 * ((target_flags & 0x00002000) ? 8 : 4));
      ...
      for (i = 0; i < nwords; i++)
 {
       ...
       if (i + 1 < nwords)
  {
   ...
   carry_in = carry_out;
      ...
      if (i == (mode_bitsize[(int) (mode)]) / (unsigned) (8 * ((target_flags & 0x00002000) ? 8 : 4)))
 {
...
# 1383 "../../../kgccfe/gnu/optabs.c"
  if (binoptab == (optab_table[OTI_smul])
   ...
   || ((optab_table[OTI_smul_widen])->handlers[(int) mode].insn_code
       != CODE_FOR_nothing)))
    {
      int low = (((target_flags & 0x00010000) != 0) ? 1 : 0);
      int high = (((target_flags & 0x00010000) != 0) ? 0 : 1);
      ...
      if ((optab_table[OTI_umul_widen])->handlers[(int) mode].insn_code != CODE_FOR_nothing)
 {
   ...
   && (optab_table[OTI_smul_widen])->handlers[(int) mode].insn_code
        != CODE_FOR_nothing)
 {
   rtx wordm1 = gen_rtx_CONST_INT (VOIDmode, (long long) ((8 * ((target_flags & 0x00002000) ? 8 : 4)) - 1));
...
# 1540 "../../../kgccfe/gnu/optabs.c"
  if (class == MODE_COMPLEX_FLOAT || class == MODE_COMPLEX_INT)
    {
      ...
      enum machine_mode submode = inner_mode_array[(int) (mode)];

      if (submode == BLKmode)
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 1553, __FUNCTION__);
 ...
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 1580, __FUNCTION__);
 ...
 case DIV:
  ...
  default:
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 1754, __FUNCTION__);
  }
     }
   break;

 default:
   fancy_abort ("../../../kgccfe/gnu/optabs.c", 1760, __FUNCTION__);
 }
     ...
     enum optab_methods methods;
{
  ...
  submode = inner_mode_array[(int) (mode)];





  for (tmode = class_narrowest_mode[(int) (class)];
       (mode_size[(int) (tmode)]) < (mode_size[(int) (mode)]);
       tmode = ((enum machine_mode)mode_wider_mode[(int) (tmode)]))
    {
      if (inner_mode_array[(int) (tmode)] == inner_mode_array[(int) (mode)]
 ...
 submode = tmode;
    ...
    case MULT:
    case DIV:
      subsize = (mode_size[(int) (submode)]);
      subbitsize = (mode_bitsize[(int) (submode)]);
      elts = size / subsize;



      if (subsize == (mode_unit_size[(int) (mode)]) && methods == OPTAB_DIRECT)
 return 0;
      ...
      for (i = 0; i < elts; ++i)
 {
   ...
   if (((enum rtx_code) (target)->code) == REG
    ...
    ? subsize < ((target_flags & 0x00002000) ? 8 : 4)
    : ((i * subsize) % ((target_flags & 0x00002000) ? 8 : 4)) != 0))
     t = (rtx) 0;
   else
  ...
  res = expand_divmod (0, TRUNC_DIV_EXPR, submode,
   ...
   if (t)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/optabs.c", 2014, __FUNCTION__);
    }
     ...
     int unsignedp;
{
  ...
  for (tmode = class_narrowest_mode[(int) ((mode_class[(int) (mode)]))];
       (mode_size[(int) (tmode)]) < (mode_size[(int) (mode)]);
       tmode = ((enum machine_mode)mode_wider_mode[(int) (tmode)]))
    {
      if (inner_mode_array[(int) (tmode)] == inner_mode_array[(int) (mode)]
 ...
 submode = tmode;
  ...
  if (unoptab == (optab_table[OTI_neg]) && (mode_class[(int) (submode)]) == MODE_INT
     ...
     int unsignedp;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 2277, __FUNCTION__);

      pat = (*insn_data[(int) (icode)].genfun) (targ0, xop0, xop1, targ1);
      if (pat)
 {
   emit_insn (pat);
   return 1;
     ...
     int unsignedp;
{
  ...
  if (unop == 0)
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 2334, __FUNCTION__);

  return expand_unop (mode, unop, op0, target, unsignedp);
}
# 2350 "../../../kgccfe/gnu/optabs.c"
rtx
     ...
     int unsignedp;
{
 ...
 temp = gen_reg_rtx (mode);
      ...
      pat = (*insn_data[(int) (icode)].genfun) (temp, xop0);
      if (pat)
 {
   if (((rtx_class[(int) (((enum rtx_code) (pat)->code))]) == 'i') && (((pat)->fld[2]).rtx) != (rtx) 0
      ...
      for (i = 0; i < (mode_bitsize[(int) (mode)]) / (8 * ((target_flags & 0x00002000) ? 8 : 4)); i++)
 {
   ...
   if (target_piece != x)
    ...
    && (class == MODE_COMPLEX_FLOAT || class == MODE_COMPLEX_INT))
    {
      ...
      if (submode == BLKmode)
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 2503, __FUNCTION__);
  ...
  if (unoptab->handlers[(int) mode].libfunc)
    {
      ...
      value = emit_library_call_value (unoptab->handlers[(int) mode].libfunc,
           (rtx) 0, LCT_CONST, mode, 1, op0, mode);
      insns = get_insns ();
      end_sequence ();
     ...
     int safe;
{
 ...
 return temp;
  ...
  if ((mode_class[(int) (mode)]) == MODE_INT && ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 2)
    {
      rtx extended = expand_shift (RSHIFT_EXPR, mode, op0,
       size_int_wide ((long long) ((mode_bitsize[(int) (mode)]) - 1), SIZETYPE),
       (rtx) 0, 0);
     ...
     int unsignedp;
{
  ...
  if (submode == BLKmode)
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 2747, __FUNCTION__);
  ...
  if (this_abs_optab->handlers[(int) mode].libfunc)
    {
      ...
      value = emit_library_call_value ((optab_table[OTI_abs])->handlers[(int) mode].libfunc,
     ...
     enum rtx_code code;
{
  ...
  pat = (*insn_data[(int) (icode)].genfun) (temp, op0);

  if (((rtx_class[(int) (((enum rtx_code) (pat)->code))]) == 'i') && (((pat)->fld[2]).rtx) != (rtx) 0 && code != UNKNOWN)
     ...
     rtx equiv;
{
 ...
 remove_note (insn, note);
      ...
      if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == USE
      ...
      else if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL)
 {
   for (i = 0; i < ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem); i++)
     if (((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]))->code) == SET)
       {
  set = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]);
  break;
       }
 }

      if (set == 0)
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 3044, __FUNCTION__);

      if (! reg_overlap_mentioned_p (target, (((set)->fld[0]).rtx)))
 {
   if ((((insn)->fld[1]).rtx))
     ((((((insn)->fld[1]).rtx))->fld[2]).rtx) = next;
   else
     insns = next;

   if (next)
     (((next)->fld[1]).rtx) = (((insn)->fld[1]).rtx);
 ...
 (((insn)->fld[8]).rtx) = gen_rtx_fmt_ee (EXPR_LIST, (REG_NO_CONFLICT), (op1), ((((insn)->fld[8]).rtx)));


      if (op0 && ((enum rtx_code) (op0)->code) == REG)
 (((insn)->fld[8]).rtx) = gen_rtx_fmt_ee (EXPR_LIST, (REG_NO_CONFLICT), (op0), ((((insn)->fld[8]).rtx)));
 ...
 set_unique_reg_note (last, REG_EQUAL, equiv);
  ...
  if (prev == 0)
    ...
    first = (((prev)->fld[2]).rtx);


  (((first)->fld[8]).rtx) = gen_rtx_fmt_ue (INSN_LIST, (REG_LIBCALL), (last), ((((first)->fld[8]).rtx)));

  (((last)->fld[8]).rtx) = gen_rtx_fmt_ue (INSN_LIST, (REG_RETVAL), (first), ((((last)->fld[8]).rtx)));

  return last;
}
# 3138 "../../../kgccfe/gnu/optabs.c"
void
     ...
     rtx equiv;
{
 ...
 if (((enum rtx_code) (insn)->code) == CALL_INSN)
   {
     ...
     if (note != 0 && ((((((note)->fld[0]).rtx))->fld[0]).rtwint) <= 0)
       remove_note (insn, note);
   }
    }
  else
      ...
      if (((enum rtx_code) (insn)->code) == CALL_INSN)
 {
   ...
   if (note != 0)
     (((note)->fld[0]).rtx) = gen_rtx_CONST_INT (VOIDmode, (long long) (-1));
   else
     (((insn)->fld[8]).rtx) = gen_rtx_fmt_ee (EXPR_LIST, (REG_EH_REGION), (gen_rtx_CONST_INT (VOIDmode, (long long) (-1))), ((((insn)->fld[8]).rtx)));
 ...
 remove_note (insn, note);
   ...
   && (insn == insns
       || ((! ((rtx_class[(int) (((enum rtx_code) (insns)->code))]) == 'i')
     || ! reg_mentioned_p ((((set)->fld[0]).rtx), (((insns)->fld[5]).rtx)))
    && ! reg_used_between_p ((((set)->fld[0]).rtx), insns, insn)
    && ! modified_in_p ((((set)->fld[1]).rtx), insns)
    && ! modified_between_p ((((set)->fld[1]).rtx), insns, insn))))
 {
   if ((((insn)->fld[1]).rtx))
     ((((((insn)->fld[1]).rtx))->fld[2]).rtx) = next;
   else
  ...
  if (!flag_non_call_exceptions || !may_trap_p (equiv))
    {
      ...
      _Bool attach_libcall_retval_notes = 1;
      next = (((last)->fld[2]).rtx);
      for (insn = first; insn != next; insn = (((insn)->fld[2]).rtx))
     ...
     enum can_compare_purpose purpose;
{
  ...
  if ((((enum rtx_code) (x)->code) == LABEL_REF || ((enum rtx_code) (x)->code) == SYMBOL_REF || ((enum rtx_code) (x)->code) == CONST_INT || ((enum rtx_code) (x)->code) == CONST_DOUBLE || ((enum rtx_code) (x)->code) == CONST || ((enum rtx_code) (x)->code) == HIGH || ((enum rtx_code) (x)->code) == CONST_VECTOR || ((enum rtx_code) (x)->code) == CONSTANT_P_RTX) && preserve_subexpressions_p ()
      && rtx_cost (x, COMPARE) > ((1) * 4))
    x = force_reg (mode, x);

  if ((((enum rtx_code) (y)->code) == LABEL_REF || ((enum rtx_code) (y)->code) == SYMBOL_REF || ((enum rtx_code) (y)->code) == CONST_INT || ((enum rtx_code) (y)->code) == CONST_DOUBLE || ((enum rtx_code) (y)->code) == CONST || ((enum rtx_code) (y)->code) == HIGH || ((enum rtx_code) (y)->code) == CONST_VECTOR || ((enum rtx_code) (y)->code) == CONSTANT_P_RTX) && preserve_subexpressions_p ()
      && rtx_cost (y, COMPARE) > ((1) * 4))
    y = force_reg (mode, y);
# 3407 "../../../kgccfe/gnu/optabs.c"
 ...
 = gen_rtx_CONST_INT (VOIDmode, (long long) (((((((x)->fld[1]).rtmem) != 0 ? (((x)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (x)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (x)->mode)) : 8))) < (((((y)->fld[1]).rtmem) != 0 ? (((y)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (y)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (y)->mode)) : 8))) ? (((((x)->fld[1]).rtmem) != 0 ? (((x)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (x)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (x)->mode)) : 8))) : (((((y)->fld[1]).rtmem) != 0 ? (((y)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (y)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (y)->mode)) : 8)))) / 8));
      ...
      if (size == 0)
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 3424, __FUNCTION__);
# 3493 "../../../kgccfe/gnu/optabs.c"
 {

   result = emit_library_call_value ((libfunc_table[LTI_memcmp]), (rtx) 0, LCT_PURE_MAKE_BLOCK,
         ((integer_types[itk_int])->type.mode), 3,
         (((x)->fld[0]).rtx), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (((y)->fld[0]).rtx), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode),
         convert_to_mode (((sizetype_tab[(int) SIZETYPE])->type.mode), size,
            ((sizetype_tab[(int) SIZETYPE])->common.unsigned_flag)),
         ((sizetype_tab[(int) SIZETYPE])->type.mode));
# 3511 "../../../kgccfe/gnu/optabs.c"
 ...
 libfunc = (optab_table[OTI_ucmp])->handlers[(int) mode].libfunc;
  ...
  if (class == MODE_FLOAT)
    ...
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 3552, __FUNCTION__);
}
     ...
     rtx label;
{
  ...
  do
    {
      ...
      ((test)->mode = (enum machine_mode) (wider_mode));
      ...
      if (label)
 {
   ...
   if (icode != CODE_FOR_nothing
       && (*insn_data[icode].operand[0].predicate) (test, wider_mode))
     {
       ...
       emit_jump_insn ((*insn_data[(int) (icode)].genfun) (test, x, y, label));
       return;
     }
 }
      ...
      if (icode != CODE_FOR_nothing)
 {
   ...
   emit_insn ((*insn_data[(int) (icode)].genfun) (x, y));
   if (label)
     emit_jump_insn ((*bcc_gen_fctn[(int) comparison]) (label));
   return;
 }
 ...
 break;
  ...
  fancy_abort ("../../../kgccfe/gnu/optabs.c", 3653, __FUNCTION__);
}
# 3673 "../../../kgccfe/gnu/optabs.c"
void
  ...
  if (swap_commutative_operands_p (x, y))
    {
      ...
      if (! label)
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 3690, __FUNCTION__);

      op0 = y, op1 = x;
      comparison = swap_condition (comparison);
    }
# 3704 "../../../kgccfe/gnu/optabs.c"
  emit_queue ();
  if (unsignedp)
     ...
     int *punsignedp;
{
  ...
  if (mode == HFmode)
    switch (comparison)
      {
      case EQ:
 libfunc = (libfunc_table[LTI_eqhf2]);
 break;

      case NE:
 libfunc = (libfunc_table[LTI_nehf2]);
 break;

      case GT:
 libfunc = (libfunc_table[LTI_gthf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LT;
     libfunc = (libfunc_table[LTI_lthf2]);
   }
 break;

      case GE:
 libfunc = (libfunc_table[LTI_gehf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LE;
     libfunc = (libfunc_table[LTI_lehf2]);
   }
 break;
 ...
 break;
      ...
      case UNORDERED:
 libfunc = (libfunc_table[LTI_unordhf2]);
 break;
 ...
 break;
    ...
    switch (comparison)
      {
      case EQ:
 libfunc = (libfunc_table[LTI_eqsf2]);
 break;

      case NE:
 libfunc = (libfunc_table[LTI_nesf2]);
 break;

      case GT:
 libfunc = (libfunc_table[LTI_gtsf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LT;
     libfunc = (libfunc_table[LTI_ltsf2]);
   }
 break;

      case GE:
 libfunc = (libfunc_table[LTI_gesf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LE;
     libfunc = (libfunc_table[LTI_lesf2]);
   }
 break;
 ...
 break;
      ...
      case UNORDERED:
 libfunc = (libfunc_table[LTI_unordsf2]);
 break;
 ...
 break;
    ...
    switch (comparison)
      {
      case EQ:
 libfunc = (libfunc_table[LTI_eqdf2]);
 break;

      case NE:
 libfunc = (libfunc_table[LTI_nedf2]);
 break;

      case GT:
 libfunc = (libfunc_table[LTI_gtdf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LT;
     libfunc = (libfunc_table[LTI_ltdf2]);
   }
 break;

      case GE:
 libfunc = (libfunc_table[LTI_gedf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LE;
     libfunc = (libfunc_table[LTI_ledf2]);
   }
 break;
 ...
 break;
      ...
      case UNORDERED:
 libfunc = (libfunc_table[LTI_unorddf2]);
 break;
 ...
 break;
    ...
    switch (comparison)
      {
      case EQ:
 libfunc = (libfunc_table[LTI_eqxf2]);
 break;

      case NE:
 libfunc = (libfunc_table[LTI_nexf2]);
 break;

      case GT:
 libfunc = (libfunc_table[LTI_gtxf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LT;
     libfunc = (libfunc_table[LTI_ltxf2]);
   }
 break;

      case GE:
 libfunc = (libfunc_table[LTI_gexf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LE;
     libfunc = (libfunc_table[LTI_lexf2]);
   }
 break;
 ...
 break;
      ...
      case UNORDERED:
 libfunc = (libfunc_table[LTI_unordxf2]);
 break;
 ...
 break;
    ...
    switch (comparison)
      {
      case EQ:
 libfunc = (libfunc_table[LTI_eqtf2]);
 break;

      case NE:
 libfunc = (libfunc_table[LTI_netf2]);
 break;

      case GT:
 libfunc = (libfunc_table[LTI_gttf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LT;
     libfunc = (libfunc_table[LTI_lttf2]);
   }
 break;

      case GE:
 libfunc = (libfunc_table[LTI_getf2]);
 if (libfunc == (rtx) 0)
   {
     tmp = x; x = y; y = tmp;
     *pcomparison = LE;
     libfunc = (libfunc_table[LTI_letf2]);
   }
 break;
 ...
 break;
      ...
      case UNORDERED:
 libfunc = (libfunc_table[LTI_unordtf2]);
 break;
 ...
 break;
    ...
    wider_mode = ((enum machine_mode)mode_wider_mode[(int) (wider_mode)]))
 {
   if (((optab_table[OTI_cmp])->handlers[(int) wider_mode].insn_code
        != CODE_FOR_nothing)
       || ((optab_table[OTI_cmp])->handlers[(int) wider_mode].libfunc != 0))
     {
       x = protect_from_queue (x, 0);
       y = protect_from_queue (y, 0);
      ...
      fancy_abort ("../../../kgccfe/gnu/optabs.c", 4053, __FUNCTION__);
    }

  if (libfunc == 0)
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 4057, __FUNCTION__);
     ...
     rtx loc;
{
  ...
  (loc, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))))
    loc = copy_to_mode_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), loc);

  emit_jump_insn (gen_indirect_jump (loc));
  emit_barrier ();
}
# 4103 "../../../kgccfe/gnu/optabs.c"
rtx
     ...
     int unsignedp;
{
  ...
  if (code == LT && ((enum rtx_code) (op1)->code) == CONST_INT && (((op1)->fld[0]).rtwint) == 1)
    code = LE, op1 = (const_int_rtx[64]);
  else if (code == GT && ((enum rtx_code) (op1)->code) == CONST_INT && (((op1)->fld[0]).rtwint) == -1)
  ...
  insn = (*insn_data[(int) (icode)].genfun) (subtarget, comparison, op2, op3);
     ...
     rtx x, y;
{
  ...
  (x, insn_data[icode].operand[0].mode))
    ...
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 4258, __FUNCTION__);

  return ((*insn_data[(int) (icode)].genfun) (x, x, y));
}
     ...
     rtx r0, r1, c;
{
  ...
  return ((*insn_data[(int) (icode)].genfun) (r0, r1, c));
}
     ...
     rtx x, y;
{
  ...
  if (((enum machine_mode) (x)->mode) == VOIDmode)
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 4290, __FUNCTION__);
     ...
     rtx x, y;
{
  ...
  (x, insn_data[icode].operand[0].mode))
     ...
     (x, insn_data[icode].operand[1].mode))
      || ! ((*insn_data[icode].operand[2].predicate)
     (y, insn_data[icode].operand[2].mode)))
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 4322, __FUNCTION__);
     ...
     rtx x, y;
{
  ...
  if (((enum machine_mode) (x)->mode) == VOIDmode)
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 4354, __FUNCTION__);
     ...
     rtx x, y;
{
  ...
  insn_code = (optab_table[OTI_mov])->handlers[(int) mode].insn_code;





  if ((mode_class[(int) (mode)]) == MODE_CC && insn_code == CODE_FOR_nothing)
    {
 ...
 for (tmode = QImode; tmode != VOIDmode;
      tmode = ((enum machine_mode)mode_wider_mode[(int) (tmode)]))
   if ((mode_size[(int) (tmode)]) == (mode_size[(int) (mode)]))
     break;

      if (tmode == VOIDmode)
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 4407, __FUNCTION__);
# 4416 "../../../kgccfe/gnu/optabs.c"
      ...
      else
 {
   ...
   y = gen_lowpart (tmode, y);
      ...
      return ((*insn_data[(int) (insn_code)].genfun) (x, y));
    }
...
gen_extend_insn (x, y, mto, mfrom, unsignedp)
     ...
     int unsignedp;
{
  return ((*insn_data[(int) (extendtab[(int) mto][(int) mfrom][unsignedp != 0])].genfun) (x, y));
}
# 4487 "../../../kgccfe/gnu/optabs.c"
     ...
     int *truncp_ptr;
{
  *truncp_ptr = 0;
  ...
  if ((optab_table[OTI_ftrunc])->handlers[(int) fltmode].insn_code != CODE_FOR_nothing)
    {
      *truncp_ptr = 1;
     ...
     int unsignedp;
{
  ...
  if (((enum machine_mode) (from)->mode) == VOIDmode)
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 4531, __FUNCTION__);
  ...
  for (fmode = ((enum machine_mode) (to)->mode); fmode != VOIDmode;
       fmode = ((enum machine_mode)mode_wider_mode[(int) (fmode)]))
    for (imode = ((enum machine_mode) (from)->mode); imode != VOIDmode;
  imode = ((enum machine_mode)mode_wider_mode[(int) (imode)]))
      {
 int doing_unsigned = unsignedp;

 if (fmode != ((enum machine_mode) (to)->mode)
     && significand_size (fmode) < (mode_bitsize[(int) (((enum machine_mode) (from)->mode))]))
   continue;
...
# 4690 "../../../kgccfe/gnu/optabs.c"
    {
      ...
      if ((mode_size[(int) (((enum machine_mode) (from)->mode))]) < (mode_size[(int) (SImode)]))
 from = convert_to_mode (SImode, from, unsignedp);

      if (flag_force_mem)
 from = force_not_mem (from);

      if (((enum machine_mode) (to)->mode) == SFmode)
 {
   if (((enum machine_mode) (from)->mode) == SImode)
     libfcn = (libfunc_table[LTI_floatsisf]);
   else if (((enum machine_mode) (from)->mode) == DImode)
     libfcn = (libfunc_table[LTI_floatdisf]);
   else if (((enum machine_mode) (from)->mode) == TImode)
     libfcn = (libfunc_table[LTI_floattisf]);
   else
     fancy_abort ("../../../kgccfe/gnu/optabs.c", 4713, __FUNCTION__);
 }
      else if (((enum machine_mode) (to)->mode) == DFmode)
 {
   if (((enum machine_mode) (from)->mode) == SImode)
     libfcn = (libfunc_table[LTI_floatsidf]);
   else if (((enum machine_mode) (from)->mode) == DImode)
     libfcn = (libfunc_table[LTI_floatdidf]);
   else if (((enum machine_mode) (from)->mode) == TImode)
     libfcn = (libfunc_table[LTI_floattidf]);
   else
     fancy_abort ("../../../kgccfe/gnu/optabs.c", 4724, __FUNCTION__);
 }
      else if (((enum machine_mode) (to)->mode) == XFmode)
 {
   if (((enum machine_mode) (from)->mode) == SImode)
     libfcn = (libfunc_table[LTI_floatsixf]);
   else if (((enum machine_mode) (from)->mode) == DImode)
     libfcn = (libfunc_table[LTI_floatdixf]);
   else if (((enum machine_mode) (from)->mode) == TImode)
     libfcn = (libfunc_table[LTI_floattixf]);
   else
     fancy_abort ("../../../kgccfe/gnu/optabs.c", 4735, __FUNCTION__);
 }
      else if (((enum machine_mode) (to)->mode) == TFmode)
 {
   if (((enum machine_mode) (from)->mode) == SImode)
     libfcn = (libfunc_table[LTI_floatsitf]);
   else if (((enum machine_mode) (from)->mode) == DImode)
     libfcn = (libfunc_table[LTI_floatditf]);
   else if (((enum machine_mode) (from)->mode) == TImode)
     libfcn = (libfunc_table[LTI_floattitf]);
   else
     fancy_abort ("../../../kgccfe/gnu/optabs.c", 4746, __FUNCTION__);
 }
      else
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 4749, __FUNCTION__);

      start_sequence ();

      value = emit_library_call_value (libfcn, (rtx) 0, LCT_CONST,
     ...
     rtx x;
{
  ...
  return expand_unop (((enum machine_mode) (x)->mode), (optab_table[OTI_ftrunc]), x, temp, 0);
}
...
# 4846 "../../../kgccfe/gnu/optabs.c"
  if (unsignedp && (mode_bitsize[(int) (((enum machine_mode) (to)->mode))]) <= (8 * 8))
    for (fmode = ((enum machine_mode) (from)->mode); fmode != VOIDmode;
  fmode = ((enum machine_mode)mode_wider_mode[(int) (fmode)]))

      if ((mode_bitsize[(int) (fmode)]) > (mode_bitsize[(int) (((enum machine_mode) (to)->mode))])
   && CODE_FOR_nothing != can_fix_p (((enum machine_mode) (to)->mode), fmode, 0,
         &must_trunc))
 {
   int bitsize;
   ...
   bitsize = (mode_bitsize[(int) (((enum machine_mode) (to)->mode))]);
  ...
  if ((mode_size[(int) (((enum machine_mode) (to)->mode))]) < (mode_size[(int) (SImode)]))
    {
      target = gen_reg_rtx (SImode);

      expand_fix (target, from, unsignedp);
    }
  else if (((enum machine_mode) (from)->mode) == SFmode)
    {
      if (((enum machine_mode) (to)->mode) == SImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunssfsi]) : (libfunc_table[LTI_fixsfsi]);
      else if (((enum machine_mode) (to)->mode) == DImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunssfdi]) : (libfunc_table[LTI_fixsfdi]);
      else if (((enum machine_mode) (to)->mode) == TImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunssfti]) : (libfunc_table[LTI_fixsfti]);
      else
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 4936, __FUNCTION__);
    }
  else if (((enum machine_mode) (from)->mode) == DFmode)
    {
      if (((enum machine_mode) (to)->mode) == SImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunsdfsi]) : (libfunc_table[LTI_fixdfsi]);
      else if (((enum machine_mode) (to)->mode) == DImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunsdfdi]) : (libfunc_table[LTI_fixdfdi]);
      else if (((enum machine_mode) (to)->mode) == TImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunsdfti]) : (libfunc_table[LTI_fixdfti]);
      else
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 4947, __FUNCTION__);
    }
  else if (((enum machine_mode) (from)->mode) == XFmode)
    {
      if (((enum machine_mode) (to)->mode) == SImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunsxfsi]) : (libfunc_table[LTI_fixxfsi]);
      else if (((enum machine_mode) (to)->mode) == DImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunsxfdi]) : (libfunc_table[LTI_fixxfdi]);
      else if (((enum machine_mode) (to)->mode) == TImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunsxfti]) : (libfunc_table[LTI_fixxfti]);
      else
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 4958, __FUNCTION__);
    }
  else if (((enum machine_mode) (from)->mode) == TFmode)
    {
      if (((enum machine_mode) (to)->mode) == SImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunstfsi]) : (libfunc_table[LTI_fixtfsi]);
      else if (((enum machine_mode) (to)->mode) == DImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunstfdi]) : (libfunc_table[LTI_fixtfdi]);
      else if (((enum machine_mode) (to)->mode) == TImode)
 libfcn = unsignedp ? (libfunc_table[LTI_fixunstfti]) : (libfunc_table[LTI_fixtfti]);
      else
 fancy_abort ("../../../kgccfe/gnu/optabs.c", 4969, __FUNCTION__);
    }
  else
    fancy_abort ("../../../kgccfe/gnu/optabs.c", 4972, __FUNCTION__);
     ...
     int suffix;
{
  ...
  for (mode = first_mode; (int) mode <= (int) last_mode;
    ...
    {
      const char *mname = (mode_name[(int) (mode)]);
      unsigned mname_len = strlen (mname);
      char *libfunc_name = __builtin_alloca(2 + opname_len + mname_len + 1 + 1);
      char *p;
      const char *q;
 ...
 *p++ = _sch_tolower[(*q) & 0xff];
 ...
 = gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (ggc_alloc_string (libfunc_name, p - libfunc_name)));
     ...
     const char *name;
{
  ...
  tree decl = build_decl (FUNCTION_DECL, (__builtin_constant_p (name) ? get_identifier_with_length ((name), (unsigned) strlen (name)) : (get_identifier) (name)),
     build_function_type (integer_types[itk_int], (tree) ((void *)0)));
  ((decl)->decl.artificial_flag) = 1;
  ((decl)->decl.external_flag) = 1;
  ((decl)->common.public_flag) = 1;


  return (((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[0]).rtx);
}
...
init_optabs ()
{
  ...
  for (i = 0; i < (sizeof (fixtab) / sizeof ((fixtab)[0])); i++)
    for (j = 0; j < (sizeof (fixtab[0]) / sizeof ((fixtab[0])[0])); j++)
      for (k = 0; k < (sizeof (fixtab[0][0]) / sizeof ((fixtab[0][0])[0])); k++)
 fixtab[i][j][k] = CODE_FOR_nothing;

  for (i = 0; i < (sizeof (fixtrunctab) / sizeof ((fixtrunctab)[0])); i++)
    for (j = 0; j < (sizeof (fixtrunctab[0]) / sizeof ((fixtrunctab[0])[0])); j++)
      for (k = 0; k < (sizeof (fixtrunctab[0][0]) / sizeof ((fixtrunctab[0][0])[0])); k++)
 fixtrunctab[i][j][k] = CODE_FOR_nothing;

  for (i = 0; i < (sizeof (floattab) / sizeof ((floattab)[0])); i++)
    for (j = 0; j < (sizeof (floattab[0]) / sizeof ((floattab[0])[0])); j++)
      for (k = 0; k < (sizeof (floattab[0][0]) / sizeof ((floattab[0][0])[0])); k++)
 floattab[i][j][k] = CODE_FOR_nothing;

  for (i = 0; i < (sizeof (extendtab) / sizeof ((extendtab)[0])); i++)
    for (j = 0; j < (sizeof (extendtab[0]) / sizeof ((extendtab[0])[0])); j++)
      for (k = 0; k < (sizeof (extendtab[0][0]) / sizeof ((extendtab[0][0])[0])); k++)
...
# 5364 "../../../kgccfe/gnu/optabs.c"
  (optab_table[OTI_abs])->handlers[(int) DCmode].libfunc
    = init_one_libfunc ("cabs");


  (optab_table[OTI_ffs])->handlers[(int) mode_for_size (((target_flags & 0x00000001) ? 64 : 32), MODE_INT, 0)].libfunc
    = init_one_libfunc ("ffs");

  (libfunc_table[LTI_extendsfdf2]) = init_one_libfunc ("__extendsfdf2");
  (libfunc_table[LTI_extendsfxf2]) = init_one_libfunc ("__extendsfxf2");
  (libfunc_table[LTI_extendsftf2]) = init_one_libfunc ("__extendsftf2");
  (libfunc_table[LTI_extenddfxf2]) = init_one_libfunc ("__extenddfxf2");
  (libfunc_table[LTI_extenddftf2]) = init_one_libfunc ("__extenddftf2");

  (libfunc_table[LTI_truncdfsf2]) = init_one_libfunc ("__truncdfsf2");
  (libfunc_table[LTI_truncxfsf2]) = init_one_libfunc ("__truncxfsf2");
  (libfunc_table[LTI_trunctfsf2]) = init_one_libfunc ("__trunctfsf2");
  (libfunc_table[LTI_truncxfdf2]) = init_one_libfunc ("__truncxfdf2");
  (libfunc_table[LTI_trunctfdf2]) = init_one_libfunc ("__trunctfdf2");
  ...
  (libfunc_table[LTI_bcopy]) = init_one_libfunc ("bcopy");
  (libfunc_table[LTI_memcmp]) = init_one_libfunc ("memcmp");
  (libfunc_table[LTI_bcmp]) = init_one_libfunc ("__gcc_bcmp");
  (libfunc_table[LTI_memset]) = init_one_libfunc ("memset");
  (libfunc_table[LTI_bzero]) = init_one_libfunc ("bzero");
  ...
  (libfunc_table[LTI_eqhf2]) = init_one_libfunc ("__eqhf2");
  (libfunc_table[LTI_nehf2]) = init_one_libfunc ("__nehf2");
  (libfunc_table[LTI_gthf2]) = init_one_libfunc ("__gthf2");
  (libfunc_table[LTI_gehf2]) = init_one_libfunc ("__gehf2");
  (libfunc_table[LTI_lthf2]) = init_one_libfunc ("__lthf2");
  (libfunc_table[LTI_lehf2]) = init_one_libfunc ("__lehf2");
  (libfunc_table[LTI_unordhf2]) = init_one_libfunc ("__unordhf2");

  (libfunc_table[LTI_eqsf2]) = init_one_libfunc ("__eqsf2");
  (libfunc_table[LTI_nesf2]) = init_one_libfunc ("__nesf2");
  (libfunc_table[LTI_gtsf2]) = init_one_libfunc ("__gtsf2");
  (libfunc_table[LTI_gesf2]) = init_one_libfunc ("__gesf2");
  (libfunc_table[LTI_ltsf2]) = init_one_libfunc ("__ltsf2");
  (libfunc_table[LTI_lesf2]) = init_one_libfunc ("__lesf2");
  (libfunc_table[LTI_unordsf2]) = init_one_libfunc ("__unordsf2");

  (libfunc_table[LTI_eqdf2]) = init_one_libfunc ("__eqdf2");
  (libfunc_table[LTI_nedf2]) = init_one_libfunc ("__nedf2");
  (libfunc_table[LTI_gtdf2]) = init_one_libfunc ("__gtdf2");
  (libfunc_table[LTI_gedf2]) = init_one_libfunc ("__gedf2");
  (libfunc_table[LTI_ltdf2]) = init_one_libfunc ("__ltdf2");
  (libfunc_table[LTI_ledf2]) = init_one_libfunc ("__ledf2");
  (libfunc_table[LTI_unorddf2]) = init_one_libfunc ("__unorddf2");

  (libfunc_table[LTI_eqxf2]) = init_one_libfunc ("__eqxf2");
  (libfunc_table[LTI_nexf2]) = init_one_libfunc ("__nexf2");
  (libfunc_table[LTI_gtxf2]) = init_one_libfunc ("__gtxf2");
  (libfunc_table[LTI_gexf2]) = init_one_libfunc ("__gexf2");
  (libfunc_table[LTI_ltxf2]) = init_one_libfunc ("__ltxf2");
  (libfunc_table[LTI_lexf2]) = init_one_libfunc ("__lexf2");
  (libfunc_table[LTI_unordxf2]) = init_one_libfunc ("__unordxf2");

  (libfunc_table[LTI_eqtf2]) = init_one_libfunc ("__eqtf2");
  (libfunc_table[LTI_netf2]) = init_one_libfunc ("__netf2");
  (libfunc_table[LTI_gttf2]) = init_one_libfunc ("__gttf2");
  (libfunc_table[LTI_getf2]) = init_one_libfunc ("__getf2");
  (libfunc_table[LTI_lttf2]) = init_one_libfunc ("__lttf2");
  (libfunc_table[LTI_letf2]) = init_one_libfunc ("__letf2");
  (libfunc_table[LTI_unordtf2]) = init_one_libfunc ("__unordtf2");

  (libfunc_table[LTI_floatsisf]) = init_one_libfunc ("__floatsisf");
  (libfunc_table[LTI_floatdisf]) = init_one_libfunc ("__floatdisf");
  (libfunc_table[LTI_floattisf]) = init_one_libfunc ("__floattisf");

  (libfunc_table[LTI_floatsidf]) = init_one_libfunc ("__floatsidf");
  (libfunc_table[LTI_floatdidf]) = init_one_libfunc ("__floatdidf");
  (libfunc_table[LTI_floattidf]) = init_one_libfunc ("__floattidf");

  (libfunc_table[LTI_floatsixf]) = init_one_libfunc ("__floatsixf");
  (libfunc_table[LTI_floatdixf]) = init_one_libfunc ("__floatdixf");
  (libfunc_table[LTI_floattixf]) = init_one_libfunc ("__floattixf");

  (libfunc_table[LTI_floatsitf]) = init_one_libfunc ("__floatsitf");
  (libfunc_table[LTI_floatditf]) = init_one_libfunc ("__floatditf");
  (libfunc_table[LTI_floattitf]) = init_one_libfunc ("__floattitf");

  (libfunc_table[LTI_fixsfsi]) = init_one_libfunc ("__fixsfsi");
  (libfunc_table[LTI_fixsfdi]) = init_one_libfunc ("__fixsfdi");
  (libfunc_table[LTI_fixsfti]) = init_one_libfunc ("__fixsfti");

  (libfunc_table[LTI_fixdfsi]) = init_one_libfunc ("__fixdfsi");
  (libfunc_table[LTI_fixdfdi]) = init_one_libfunc ("__fixdfdi");
  (libfunc_table[LTI_fixdfti]) = init_one_libfunc ("__fixdfti");

  (libfunc_table[LTI_fixxfsi]) = init_one_libfunc ("__fixxfsi");
  (libfunc_table[LTI_fixxfdi]) = init_one_libfunc ("__fixxfdi");
  (libfunc_table[LTI_fixxfti]) = init_one_libfunc ("__fixxfti");

  (libfunc_table[LTI_fixtfsi]) = init_one_libfunc ("__fixtfsi");
  (libfunc_table[LTI_fixtfdi]) = init_one_libfunc ("__fixtfdi");
  (libfunc_table[LTI_fixtfti]) = init_one_libfunc ("__fixtfti");

  (libfunc_table[LTI_fixunssfsi]) = init_one_libfunc ("__fixunssfsi");
  (libfunc_table[LTI_fixunssfdi]) = init_one_libfunc ("__fixunssfdi");
  (libfunc_table[LTI_fixunssfti]) = init_one_libfunc ("__fixunssfti");

  (libfunc_table[LTI_fixunsdfsi]) = init_one_libfunc ("__fixunsdfsi");
  (libfunc_table[LTI_fixunsdfdi]) = init_one_libfunc ("__fixunsdfdi");
  (libfunc_table[LTI_fixunsdfti]) = init_one_libfunc ("__fixunsdfti");

  (libfunc_table[LTI_fixunsxfsi]) = init_one_libfunc ("__fixunsxfsi");
  (libfunc_table[LTI_fixunsxfdi]) = init_one_libfunc ("__fixunsxfdi");
  (libfunc_table[LTI_fixunsxfti]) = init_one_libfunc ("__fixunsxfti");

  (libfunc_table[LTI_fixunstfsi]) = init_one_libfunc ("__fixunstfsi");
  (libfunc_table[LTI_fixunstfdi]) = init_one_libfunc ("__fixunstfdi");
  (libfunc_table[LTI_fixunstfti]) = init_one_libfunc ("__fixunstfti");
  ...
  if (((!(mips_isa == 1) && !(target_flags & 0x00100000))))
    trap_rtx = gen_rtx_fmt_ee (EQ, VOIDmode, (rtx) 0, (rtx) 0);



  do { if (! (target_flags & 0x00100000) || ! mips16_hard_float) ; else { (optab_table[OTI_add])->handlers[(int) SFmode].libfunc = init_one_libfunc ("__mips16_addsf3"); (optab_table[OTI_sub])->handlers[(int) SFmode].libfunc = init_one_libfunc ("__mips16_subsf3"); (optab_table[OTI_smul])->handlers[(int) SFmode].libfunc = init_one_libfunc ("__mips16_mulsf3"); (optab_table[OTI_sdiv])->handlers[(int) SFmode].libfunc = init_one_libfunc ("__mips16_divsf3"); (libfunc_table[LTI_eqsf2]) = init_one_libfunc ("__mips16_eqsf2"); (libfunc_table[LTI_nesf2]) = init_one_libfunc ("__mips16_nesf2"); (libfunc_table[LTI_gtsf2]) = init_one_libfunc ("__mips16_gtsf2"); (libfunc_table[LTI_gesf2]) = init_one_libfunc ("__mips16_gesf2"); (libfunc_table[LTI_ltsf2]) = init_one_libfunc ("__mips16_ltsf2"); (libfunc_table[LTI_lesf2]) = init_one_libfunc ("__mips16_lesf2"); (libfunc_table[LTI_floatsisf]) = init_one_libfunc ("__mips16_floatsisf"); (libfunc_table[LTI_fixsfsi]) = init_one_libfunc ("__mips16_fixsfsi"); if ((! (target_flags & 0x00020000))) { (optab_table[OTI_add])->handlers[(int) DFmode].libfunc = init_one_libfunc ("__mips16_adddf3"); (optab_table[OTI_sub])->handlers[(int) DFmode].libfunc = init_one_libfunc ("__mips16_subdf3"); (optab_table[OTI_smul])->handlers[(int) DFmode].libfunc = init_one_libfunc ("__mips16_muldf3"); (optab_table[OTI_sdiv])->handlers[(int) DFmode].libfunc = init_one_libfunc ("__mips16_divdf3"); (libfunc_table[LTI_extendsfdf2]) = init_one_libfunc ("__mips16_extendsfdf2"); (libfunc_table[LTI_truncdfsf2]) = init_one_libfunc ("__mips16_truncdfsf2"); (libfunc_table[LTI_eqdf2]) = init_one_libfunc ("__mips16_eqdf2"); (libfunc_table[LTI_nedf2]) = init_one_libfunc ("__mips16_nedf2"); (libfunc_table[LTI_gtdf2]) = init_one_libfunc ("__mips16_gtdf2"); (libfunc_table[LTI_gedf2]) = init_one_libfunc ("__mips16_gedf2"); (libfunc_table[LTI_ltdf2]) = init_one_libfunc ("__mips16_ltdf2"); (libfunc_table[LTI_ledf2]) = init_one_libfunc ("__mips16_ledf2"); (libfunc_table[LTI_floatsidf]) = init_one_libfunc ("__mips16_floatsidf"); (libfunc_table[LTI_fixdfsi]) = init_one_libfunc ("__mips16_fixdfsi"); } } } while (0);
...
gen_cond_trap (code, op1, op2, tcode)
     enum rtx_code code __attribute__ ((__unused__));
     rtx op1, op2 __attribute__ ((__unused__)), tcode __attribute__ ((__unused__));
{
  ...
  emit_insn ((*insn_data[(int) (icode)].genfun) (op1, op2));

  ((trap_rtx)->code = (enum rtx_code) (code));
...
# 1 "../../../kgccfe/gnu/MIPS/gt-optabs.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-optabs.h"
