...
# 33 "../../../kgccfe/gnu/cfglayout.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 34 "../../../kgccfe/gnu/cfglayout.c" 2
...
static void cleanup_unconditional_jumps (void);
static void fixup_fallthru_exit_predecessor (void);
static rtx unlink_insn_chain (rtx, rtx);
...
unlink_insn_chain (first, last)
     ...
     rtx last;
{
  rtx prevfirst = (((first)->fld[1]).rtx);
  rtx nextlast = (((last)->fld[2]).rtx);

  (((first)->fld[1]).rtx) = ((void *)0);
  (((last)->fld[2]).rtx) = ((void *)0);
  if (prevfirst)
    (((prevfirst)->fld[2]).rtx) = nextlast;
  if (nextlast)
    (((nextlast)->fld[1]).rtx) = prevfirst;
  else
     ...
     basic_block bb;
{
  ...
  for (last_insn = insn = bb->end; (insn = (((insn)->fld[2]).rtx)) != 0; )
    {
      if (insn == next_head)
 break;
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      ...
      if ((((bb->head)->fld[1]).rtx) && next_insn != bb->head)
 ((reorder_block_def) (bb)->aux)->header = unlink_insn_chain (next_insn,
           (((bb->head)->fld[1]).rtx));
      end = skip_insns_after_block (bb);
      if ((((bb->end)->fld[2]).rtx) && bb->end != end)
 ((reorder_block_def) (bb)->aux)->footer = unlink_insn_chain ((((bb->end)->fld[2]).rtx), end);
      next_insn = (((bb->end)->fld[2]).rtx);
    }
...
scope_to_insns_initialize ()
{
  ...
  for (insn = get_insns (); insn; insn = next)
   ...
   && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != ADDR_DIFF_VEC)
        (((insn)->fld[4]).rttree) = block;
      else if (((enum rtx_code) (insn)->code) == NOTE)
 {
   switch ((((insn)->fld[5]).rtint))
     {
     case NOTE_INSN_BLOCK_BEG:
       block = (((insn)->fld[4]).rttree);
       delete_insn (insn);
       break;
     case NOTE_INSN_BLOCK_END:
       block = ((block)->block.supercontext);
       delete_insn (insn);
       break;
     default:
       break;
     ...
     tree s1, s2;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 301, __FUNCTION__);
      ...
      if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SEQUENCE)
 {
   ...
   for (i = 0; i < (((((body)->fld[0]).rtvec))->num_elem); i++)
     this_block = choose_inner_scope (this_block,
          ((((((((body)->fld[0]).rtvec))->elem[i]))->fld[4]).rttree));
 }
      if (! this_block)
 continue;
...
fixup_reorder_chain ()
{
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb, index = 0;
       bb != 0;
       bb = ((reorder_block_def) (bb)->aux)->next, index++)
    {
      if (((reorder_block_def) (bb)->aux)->header)
 {
   if (insn)
     (((insn)->fld[2]).rtx) = ((reorder_block_def) (bb)->aux)->header;
   else
     set_first_insn (((reorder_block_def) (bb)->aux)->header);
   (((((reorder_block_def) (bb)->aux)->header)->fld[1]).rtx) = insn;
   insn = ((reorder_block_def) (bb)->aux)->header;
   while ((((insn)->fld[2]).rtx))
     insn = (((insn)->fld[2]).rtx);
 }
      if (insn)
 (((insn)->fld[2]).rtx) = bb->head;
      else
 set_first_insn (bb->head);
      (((bb->head)->fld[1]).rtx) = insn;
      insn = bb->end;
      if (((reorder_block_def) (bb)->aux)->footer)
 {
   (((insn)->fld[2]).rtx) = ((reorder_block_def) (bb)->aux)->footer;
   (((((reorder_block_def) (bb)->aux)->footer)->fld[1]).rtx) = insn;
   while ((((insn)->fld[2]).rtx))
     insn = (((insn)->fld[2]).rtx);
 }
    }
  ...
  if (index != n_basic_blocks)
    fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 423, __FUNCTION__);

  (((insn)->fld[2]).rtx) = function_footer;
  if (function_footer)
    (((function_footer)->fld[1]).rtx) = insn;
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb ; bb = ((reorder_block_def) (bb)->aux)->next)
    {
   ...
   if (any_condjump_p (bb_end_insn))
     {
       ...
       if (((reorder_block_def) (bb)->aux)->next == e_fall->dest
           || (!((reorder_block_def) (bb)->aux)->next
        && e_fall->dest == (&entry_exit_blocks[1])))
  continue;

       if (!e_taken)
  e_taken = e_fall;
# 480 "../../../kgccfe/gnu/cfglayout.c"
       if (!e_taken)
  {
    rtx note;
    edge e_fake;
   ...
   e_fall->count = 0;
       ...
       else if (((reorder_block_def) (bb)->aux)->next != e_taken->dest)
  {
    rtx note = find_reg_note (bb_end_insn, REG_BR_PROB, 0);

    if (note
        && ((((((note)->fld[0]).rtx))->fld[0]).rtwint) < 10000 / 2
        ...
        label_for_bb (e_fall->dest), 0))
  {
    ...
    continue;
   ...
   else
     {
       ...
       if (! e_fall)
  continue;
# 549 "../../../kgccfe/gnu/cfglayout.c"
       fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 549, __FUNCTION__);
      ...
      else
 {
   ...
   if (!((reorder_block_def) (bb)->aux)->next && e_fall->dest == (&entry_exit_blocks[1]))
     continue;
 }
      ...
      if (nb)
 {
   ...
   ((reorder_block_def) (nb)->aux)->visited = 1;
   ((reorder_block_def) (nb)->aux)->next = ((reorder_block_def) (bb)->aux)->next;
   ((reorder_block_def) (bb)->aux)->next = nb;
  ...
  if (rtl_dump_file)
    {
      ...
      for (bb = (&entry_exit_blocks[0])->next_bb, index = 0; bb; bb = ((reorder_block_def) (bb)->aux)->next, index ++)
 {
   fprintf (rtl_dump_file, " %i ", index);
   if (((reorder_block_def) (bb)->aux)->original)
     fprintf (rtl_dump_file, "duplicate of %i ",
       ((reorder_block_def) (bb)->aux)->original->index);
   else if (forwarder_block_p (bb) && ((enum rtx_code) (bb->head)->code) != CODE_LABEL)
  ...
  prev_bb = (&entry_exit_blocks[0]);
  bb = (&entry_exit_blocks[0])->next_bb;
  index = 0;

  for (; bb; prev_bb = bb, bb = ((reorder_block_def) (bb)->aux)->next, index ++)
    {
      bb->index = index;
  ...
  prev_bb->next_bb = (&entry_exit_blocks[1]);
  (&entry_exit_blocks[1])->prev_bb = prev_bb;
}
...
verify_insn_chain ()
{
  ...
  for (prevx = ((void *)0), insn_cnt1 = 1, x = get_insns ();
       x != 0;
       prevx = x, insn_cnt1++, x = (((x)->fld[2]).rtx))
    if ((((x)->fld[1]).rtx) != prevx)
      fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 634, __FUNCTION__);

  if (prevx != get_last_insn ())
    fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 637, __FUNCTION__);

  for (nextx = ((void *)0), insn_cnt2 = 1, x = get_last_insn ();
       x != 0;
       nextx = x, insn_cnt2++, x = (((x)->fld[1]).rtx))
    if ((((x)->fld[2]).rtx) != nextx)
      fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 643, __FUNCTION__);

  if (insn_cnt1 != insn_cnt2)
    fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 646, __FUNCTION__);
}
...
cleanup_unconditional_jumps ()
{
 ...
 {
   rtx insn;
   if (((enum rtx_code) (bb->head)->code) != CODE_LABEL && forwarder_block_p (bb)
       && bb->prev_bb != (&entry_exit_blocks[0]))
     {
...
fixup_fallthru_exit_predecessor ()
{
  ...
  if (bb && ((reorder_block_def) (bb)->aux)->next)
    {
      basic_block c = (&entry_exit_blocks[0])->next_bb;

      while (((reorder_block_def) (c)->aux)->next != bb)
 c = ((reorder_block_def) (c)->aux)->next;

      ((reorder_block_def) (c)->aux)->next = ((reorder_block_def) (bb)->aux)->next;
      while (((reorder_block_def) (c)->aux)->next)
 c = ((reorder_block_def) (c)->aux)->next;

      ((reorder_block_def) (c)->aux)->next = bb;
      ((reorder_block_def) (bb)->aux)->next = ((void *)0);
    }
}
     ...
     basic_block bb;
{
  ...
  if (bb == (&entry_exit_blocks[1]) || bb == (&entry_exit_blocks[0]))
    return 0;



  for (s = bb->succ; s; s = s->succ_next)
    if (s->dest == (&entry_exit_blocks[1]) && s->flags & 1)
       return 0;




  if (((enum rtx_code) (bb->end)->code) == JUMP_INSN && (((bb->end)->fld[9]).rtx)
      && (next = next_nonnote_insn ((((bb->end)->fld[9]).rtx)))
     ...
     rtx from, to;
{
  ...
  last = emit_note (((void *)0), NOTE_INSN_DELETED);



  for (insn = from; insn != (((to)->fld[2]).rtx); insn = (((insn)->fld[2]).rtx))
    {
      rtx new;
      switch (((enum rtx_code) (insn)->code))
 {
 ...
 case NOTE:
   switch ((((insn)->fld[5]).rtint))
     ...
     case NOTE_INSN_EH_REGION_END:
       ...
       fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 839, __FUNCTION__);
       break;
  ...
  fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 847, __FUNCTION__);
   ...
   break;
 default:
   fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 854, __FUNCTION__);
 }
    }
  insn = (((last)->fld[2]).rtx);
  delete_insn (last);
     ...
     basic_block dest;
{
  ...
  if (e->flags & 1)
    {
      ...
      if (((enum rtx_code) (src->end)->code) == JUMP_INSN
   && (((src->end)->fld[9]).rtx) == e->dest->head)
 {
          if (!redirect_jump (src->end, block_label (dest), 0))
     fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 883, __FUNCTION__);
 }
   ...
   && !src->succ->succ_next->succ_next)
 {
  ...
  if (simplejump_p (src->end))
    {
      delete_insn (src->end);
      delete_barrier ((((src->end)->fld[2]).rtx));
      src->succ->flags |= 1;
    }
     ...
     edge e;
{
  ...
  if (bb->count < new_count)
    new_count = bb->count;
  if (!bb->pred)
    fancy_abort ("../../../kgccfe/gnu/cfglayout.c", 926, __FUNCTION__);
  ...
  if (((reorder_block_def) (bb)->aux)->header)
    {
      ...
      while ((((insn)->fld[2]).rtx))
 insn = (((insn)->fld[2]).rtx);
      insn = duplicate_insn_chain (((reorder_block_def) (bb)->aux)->header, insn);
      if (insn)
 ((reorder_block_def) (new_bb)->aux)->header = unlink_insn_chain (insn, get_last_insn ());
    }

  if (((reorder_block_def) (bb)->aux)->footer)
    {
      insn = ((reorder_block_def) (bb)->aux)->footer;
      while ((((insn)->fld[2]).rtx))
 insn = (((insn)->fld[2]).rtx);
      insn = duplicate_insn_chain (((reorder_block_def) (bb)->aux)->footer, insn);
      if (insn)
 ((reorder_block_def) (new_bb)->aux)->footer = unlink_insn_chain (insn, get_last_insn ());
    }
 ...
 n->count = 0;
  ...
  ((reorder_block_def) (new_bb)->aux)->original = bb;
  return new_bb;
}
