...
# 60 "../../../kgccfe/gnu/final.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 61 "../../../kgccfe/gnu/final.c" 2
...
# 63 "../../../kgccfe/gnu/final.c" 2
# 1 "../../../kgccfe/gnu/conditions.h" 1
# 64 "../../../kgccfe/gnu/final.c" 2
...
# 77 "../../../kgccfe/gnu/final.c" 2
# 1 "../../../kgccfe/gnu/profile.h" 1
# 24 "../../../kgccfe/gnu/profile.h"
struct profile_info
  {
...
# 78 "../../../kgccfe/gnu/final.c" 2
# 1 "../../../kgccfe/gnu/cfglayout.h" 1
# 22 "../../../kgccfe/gnu/cfglayout.h"
...
# 79 "../../../kgccfe/gnu/final.c" 2

# 1 "../../../kgccfe/gnu/defaults.h" 1
# 81 "../../../kgccfe/gnu/final.c" 2
# 1 "../../../kgccfe/gnu/insn-addr.h" 1
# 82 "../../../kgccfe/gnu/final.c" 2
# 90 "../../../kgccfe/gnu/final.c"
...
# 91 "../../../kgccfe/gnu/final.c" 2
# 120 "../../../kgccfe/gnu/final.c"
...
# 180 "../../../kgccfe/gnu/final.c"
char regs_ever_live[176];
...
static void notice_source_line (rtx);
  ...
  if (profile_arc_flag && profile_info.count_instrumented_edges)
    {
      ...
      string_type = build_pointer_type (integer_types[itk_char]);


      structure_decl = make_node (RECORD_TYPE);
      structure_pointer_type = build_pointer_type (structure_decl);
# 301 "../../../kgccfe/gnu/final.c"
      decl_chain =
 build_decl (FIELD_DECL, (__builtin_constant_p ("zero_word") ? get_identifier_with_length (("zero_word"), (unsigned) strlen ("zero_word")) : (get_identifier) ("zero_word")),
      integer_types[itk_long]);
      value_chain = build_tree_list (decl_chain,
         convert (integer_types[itk_long],
 ...
 field_decl =
   build_decl (FIELD_DECL, (__builtin_constant_p ("filename") ? get_identifier_with_length (("filename"), (unsigned) strlen ("filename")) : (get_identifier) ("filename")), string_type);
 ((field_decl)->common.chain) = decl_chain;
 decl_chain = field_decl;

 cwd = getpwd ();
 da_filename_len = strlen (filename) + strlen (cwd) + 4 + 1;
 da_filename = (char *) __builtin_alloca(da_filename_len);
 ...
 domain_type = build_index_type (build_int_2_wide ((unsigned long long) (da_filename_len), (long long) (0)));
 ((string_cst)->common.type)
   = build_array_type (integer_types[itk_char], domain_type);
 value_chain = tree_cons (field_decl,
     ...
     value_chain);
      ...
      {
 tree gcov_type_type = make_unsigned_type (64);
 tree gcov_type_pointer_type = build_pointer_type (gcov_type_type);
 tree domain_tree
   = build_index_type (build_int_2_wide ((unsigned long long) (profile_info. count_instrumented_edges - 1), (long long) (0)));
 ...
 field_decl =
   build_decl (FIELD_DECL, (__builtin_constant_p ("counts") ? get_identifier_with_length (("counts"), (unsigned) strlen ("counts")) : (get_identifier) ("counts")),
 ...
 counts_table
   = build (VAR_DECL, gcov_type_array_type, (tree) ((void *)0), (tree) ((void *)0));
 ((counts_table)->common.static_flag) = 1;
 sprintf ((name), "*%s%s%ld", ("$"), ("LPBX"), (long)(2));
 ((counts_table)->decl.name) = (__builtin_constant_p (name) ? get_identifier_with_length ((name), (unsigned) strlen (name)) : (get_identifier) (name));
 ...
 value_chain = tree_cons (field_decl,
     build1 (ADDR_EXPR,
      ...
      field_decl
 = build_decl (FIELD_DECL, (__builtin_constant_p ("ncounts") ? get_identifier_with_length (("ncounts"), (unsigned) strlen ("ncounts")) : (get_identifier) ("ncounts")),
        integer_types[itk_long]);
      ((field_decl)->common.chain) = decl_chain;
      decl_chain = field_decl;
      ...
      value_chain = tree_cons (field_decl,
          convert (integer_types[itk_long],
     build_int_2_wide ((unsigned long long) (profile_info. count_instrumented_edges), (long long) (0))), value_chain);



      field_decl
 = build_decl (FIELD_DECL, (__builtin_constant_p ("next") ? get_identifier_with_length (("next"), (unsigned) strlen ("next")) : (get_identifier) ("next")),
        structure_pointer_type);
      ((field_decl)->common.chain) = decl_chain;
      decl_chain = field_decl;

      value_chain = tree_cons (field_decl, global_trees[TI_NULL_POINTER], value_chain);



      field_decl
 = build_decl (FIELD_DECL, (__builtin_constant_p ("sizeof_bb") ? get_identifier_with_length (("sizeof_bb"), (unsigned) strlen ("sizeof_bb")) : (get_identifier) ("sizeof_bb")),
        integer_types[itk_long]);
      ((field_decl)->common.chain) = decl_chain;
      decl_chain = field_decl;

      sizeof_field_value = tree_cons (field_decl, ((void *)0), value_chain);
 ...
 tree domain;
 tree array_value_chain = (tree) ((void *)0);
 ...
 checksum_field = build_decl (FIELD_DECL, (__builtin_constant_p ("checksum") ? get_identifier_with_length (("checksum"), (unsigned) strlen ("checksum")) : (get_identifier) ("checksum")),
         integer_types[itk_long]);

 arc_count_field
   = build_decl (FIELD_DECL, (__builtin_constant_p ("arc_count") ? get_identifier_with_length (("arc_count"), (unsigned) strlen ("arc_count")) : (get_identifier) ("arc_count")),
          integer_types[itk_int]);
 ((checksum_field)->common.chain) = arc_count_field;

 name_field
   = build_decl (FIELD_DECL, (__builtin_constant_p ("name") ? get_identifier_with_length (("name"), (unsigned) strlen ("name")) : (get_identifier) ("name")), string_type);
 ((arc_count_field)->common.chain) = name_field;

 ((bb_fn_struct_type)->type.values) = checksum_field;
 ...
 domain = build_index_type (build_int_2_wide ((unsigned long long) (num_nodes), (long long) (0)));
 ...
 for (item = functions_head; item != 0; item = item->next)
   {
     ...
     convert (integer_types[itk_long],
       build_int_2_wide ((unsigned long long) (item->cfg_checksum), (long long) (0))));
     field_value_chain
       = tree_cons (arc_count_field,
      convert (integer_types[itk_int],
        build_int_2_wide ((unsigned long long) (item->count_edges), (long long) (0))),
      field_value_chain);

     name_len = strlen (item->name);
     string_cst = build_string (name_len + 1, item->name);
     domain_type = build_index_type (build_int_2_wide ((unsigned long long) (name_len), (long long) (0)));
     ((string_cst)->common.type)
       = build_array_type (integer_types[itk_char], domain_type);
     ...
     array_value_chain
       = tree_cons ((tree) ((void *)0), build (CONSTRUCTOR,
          bb_fn_struct_type, (tree) ((void *)0),
 ...
 field_value = build_tree_list (arc_count_field,
           convert (integer_types[itk_int],
      build_int_2_wide ((unsigned long long) (-1), (long long) (0))));

 array_value_chain = tree_cons ((tree) ((void *)0),
           build (CONSTRUCTOR, bb_fn_struct_type,
           (tree) ((void *)0), field_value),
           array_value_chain);



 field_decl
   = build_decl (FIELD_DECL, (__builtin_constant_p ("function_infos") ? get_identifier_with_length (("function_infos"), (unsigned) strlen ("function_infos")) : (get_identifier) ("function_infos")),
 ...
 decl_chain = field_decl;
      ...
      ((structure_decl)->type.values) = nreverse (decl_chain);
      layout_type (structure_decl);

      structure_value
 = build (VAR_DECL, structure_decl, (tree) ((void *)0), (tree) ((void *)0));
      ((structure_value)->decl.initial)
 = build (CONSTRUCTOR, structure_decl, (tree) ((void *)0),
          nreverse (value_chain));
      ((structure_value)->common.static_flag) = 1;
      sprintf ((name), "*%s%s%ld", ("$"), ("LPBX"), (long)(0));
      ((structure_value)->decl.name) = (__builtin_constant_p (name) ? get_identifier_with_length ((name), (unsigned) strlen (name)) : (get_identifier) (name));


      ((sizeof_field_value)->list.value)
 = convert (integer_types[itk_long],
     build_int_2_wide ((unsigned long long) (int_size_in_bytes (structure_decl)), (long long) (0)));
...
{
  if (final_sequence != 0)
    return (((((final_sequence)->fld[0]).rtvec))->num_elem) - 1;
  else
    return 0;
}
# 597 "../../../kgccfe/gnu/final.c"
     ...
     rtx insn __attribute__ ((__unused__));
{
  ...
  if (insn_lengths_max_uid > (((insn)->fld[0]).rtint))
    return insn_lengths[(((insn)->fld[0]).rtint)];
  else
 ...
 if (((enum rtx_code) (body)->code) == USE || ((enum rtx_code) (body)->code) == CLOBBER)
   ...
   for (i = 0; i < (((((body)->fld[0]).rtvec))->num_elem); i++)
     length += get_attr_length ((((((body)->fld[0]).rtvec))->elem[i]));
 else
   length = insn_default_length (insn);
 break;
...
# 796 "../../../kgccfe/gnu/final.c"
static int
final_addr_vec_align (addr_vec)
     rtx addr_vec;
{
  int align = (mode_size[(int) (((enum machine_mode) ((((addr_vec)->fld[5]).rtx))->mode))]);

  if (align > (mips_abi == 1 || mips_abi == 2 ? 128 : 64) / 8)
    align = (mips_abi == 1 || mips_abi == 2 ? 128 : 64) / 8;
  return exact_log2_wide ((unsigned long long) (align));

}
# 817 "../../../kgccfe/gnu/final.c"
static int min_labelno, max_labelno;
# 827 "../../../kgccfe/gnu/final.c"
int
label_to_alignment (label)
     rtx label;
{
  return (label_align[(((label)->fld[6]).rtint) - min_labelno].alignment);
}
# 863 "../../../kgccfe/gnu/final.c"
static int
align_fuzz (start, end, known_align_log, growth)
     ...
     unsigned growth;
{
  int uid = (((start)->fld[0]).rtint);
  rtx align_label;
  int known_align = 1 << known_align_log;
  int end_shuid = (uid_shuid[(((end)->fld[0]).rtint)]);
  int fuzz = 0;
  ...
  for (align_label = uid_align[uid]; align_label; align_label = uid_align[uid])
    {
      ...
      uid = (((align_label)->fld[0]).rtint);
      align_addr = ((insn_addresses_)->data.i[(uid)]) - insn_lengths[uid];
      if (uid_shuid[uid] > end_shuid)
 break;
      known_align_log = (label_align[(((align_label)->fld[6]).rtint) - min_labelno].alignment);
     ...
     rtx branch;
{
  ...
  seq = ((((((branch)->fld[1]).rtx))->fld[2]).rtx);
  seq_uid = (((seq)->fld[0]).rtint);
  ...
  dest = (((branch)->fld[9]).rtx);



  if ((uid_shuid[(((seq)->fld[0]).rtint)]) < (uid_shuid[(((dest)->fld[0]).rtint)]))
    {
...
# 993 "../../../kgccfe/gnu/final.c"
      if (!has_fallthru
   && (branch_frequency > 10000 / 10
       || (bb->frequency > bb->prev_bb->frequency * 10
    && (bb->prev_bb->frequency
        <= (&entry_exit_blocks[0])->frequency / 2))))
 {
   log = align_jumps_log;
   if (max_log < log)
     {
   ...
   if (max_log < log)
     {
      ...
      (label_align[(((label)->fld[6]).rtint) - min_labelno].alignment) = max_log;
      (label_align[(((label)->fld[6]).rtint) - min_labelno].max_skip) = max_skip;
    }
}
# 1041 "../../../kgccfe/gnu/final.c"
void
shorten_branches (first)
     rtx first __attribute__ ((__unused__));
{
  rtx insn;
  int max_uid;
  int i;
 ...
 fancy_abort ("../../../kgccfe/gnu/final.c", 1083, __FUNCTION__);
  ...
  for (insn = get_insns (), i = 1; insn; insn = (((insn)->fld[2]).rtx))
    {
      int log;

      (uid_shuid[(((insn)->fld[0]).rtint)]) = i++;
      ...
      else if (((enum rtx_code) (insn)->code) == CODE_LABEL)
 {
   ...
   log = (label_align[(((insn)->fld[6]).rtint) - min_labelno].alignment);
   if (max_log < log)
     {
       max_log = log;
       max_skip = (label_align[(((insn)->fld[6]).rtint) - min_labelno].max_skip);
     }
  ...
  if (((enum rtx_code) (nextbody)->code) == ADDR_VEC
   ...
   (label_align[(((insn)->fld[6]).rtint) - min_labelno].alignment) = max_log;
   (label_align[(((insn)->fld[6]).rtint) - min_labelno].max_skip) = max_skip;
   max_log = 0;
   max_skip = 0;
 }
      else if (((enum rtx_code) (insn)->code) == BARRIER)
 {
   ...
   for (label = insn; label && ! ((rtx_class[(int) (((enum rtx_code) (label)->code))]) == 'i');
        label = (((label)->fld[2]).rtx))
     if (((enum rtx_code) (label)->code) == CODE_LABEL)
       {
  log = 0;
  if (max_log < log)
  ...
  for (i = 16; --i >= 0;)
    align_tab[i] = (rtx) 0;
  seq = get_last_insn ();
  for (; seq; seq = (((seq)->fld[1]).rtx))
    {
      int uid = (((seq)->fld[0]).rtint);
      int log;
      log = (((enum rtx_code) (seq)->code) == CODE_LABEL ? (label_align[(((seq)->fld[6]).rtint) - min_labelno].alignment) : 0);
...
# 1263 "../../../kgccfe/gnu/final.c"
  for (insn_current_address = 0, insn = first;
       insn != 0;
       insn_current_address += insn_lengths[uid], insn = (((insn)->fld[2]).rtx))
    {
      uid = (((insn)->fld[0]).rtint);

      insn_lengths[uid] = 0;

      if (((enum rtx_code) (insn)->code) == CODE_LABEL)
 {
   int log = (label_align[(((insn)->fld[6]).rtint) - min_labelno].alignment);
   if (log)
     {
       int align = 1 << log;
      ...
      if (((enum rtx_code) (body)->code) == ADDR_VEC || ((enum rtx_code) (body)->code) == ADDR_DIFF_VEC)
 {
   ...
   if (0 || !1)
     insn_lengths[uid] = ((((((body)->fld[((enum rtx_code) (body)->code) == ADDR_DIFF_VEC]).rtvec))->num_elem)
      ...
      else if (((enum rtx_code) (body)->code) == SEQUENCE)
 {
   ...
   const_delay_slots = const_num_delay_slots ((((((body)->fld[0]).rtvec))->elem[0]));
   ...
   for (i = 0; i < (((((body)->fld[0]).rtvec))->num_elem); i++)
     {
       rtx inner_insn = (((((body)->fld[0]).rtvec))->elem[i]);
       int inner_uid = (((inner_insn)->fld[0]).rtint);
       int inner_length;

       if (((enum rtx_code) (body)->code) == ASM_INPUT
    || asm_noperands (((((((((body)->fld[0]).rtvec))->elem[i]))->fld[5]).rtx)) >= 0)
  inner_length = (asm_insn_count ((((inner_insn)->fld[5]).rtx))
      ...
      else if (((enum rtx_code) (body)->code) != USE && ((enum rtx_code) (body)->code) != CLOBBER)
 {
   ...
   varying_length[uid] = insn_variable_length_p (insn);
      ...
      ((insn_lengths[uid]) = mips_adjust_insn_length ((insn), (insn_lengths[uid])));
      if (insn_lengths[uid] < 0)
 _fatal_insn ("negative insn length", insn, "../../../kgccfe/gnu/final.c", 1352, __FUNCTION__);
...
# 1509 "../../../kgccfe/gnu/final.c"
       ...
       for (i = 0; i < (((((body)->fld[0]).rtvec))->num_elem); i++)
  {
   ...
   ((new_length) = mips_adjust_insn_length ((insn), (new_length)));
...
# 1627 "../../../kgccfe/gnu/final.c"
void
final_start_function (first, file, optimize)
     rtx first;
     FILE *file;
     int optimize __attribute__ ((__unused__));
{
  block_depth = 0;

  this_is_asm_operands = 0;
# 1650 "../../../kgccfe/gnu/final.c"
  if ((((first)->fld[5]).rtint) != NOTE_INSN_DELETED)
...
profile_function (file)
     FILE *file __attribute__ ((__unused__));
{
# 1728 "../../../kgccfe/gnu/final.c"
  if (! 0)
    {
      int align = (((mips_abi == 1 || mips_abi == 2 ? 128 : 64)) < (((target_flags & 0x00000002) ? 64 : 32)) ? ((mips_abi == 1 || mips_abi == 2 ? 128 : 64)) : (((target_flags & 0x00000002) ? 64 : 32)));
      data_section ();
      fprintf (file, "\t.align\t%d\n", (floor_log2_wide ((unsigned long long) (align / 8))));
      fprintf (file, "%s%s%d:\n", "$", "LP", (cfun->funcdef_no));
      assemble_integer ((const_int_rtx[64]), ((target_flags & 0x00000002) ? 64 : 32) / 8, align, 1);
    }

  function_section (current_function_decl);
# 1763 "../../../kgccfe/gnu/final.c"
  { if ((target_flags & 0x00100000)) sorry ("mips16 function profiling"); fprintf (file, "\t.set\tnoat\n"); fprintf (file, "\tmove\t%s,%s\t\t# save current return address\n", reg_names[0 + 1], reg_names[0 + 31]); fprintf (file, "\t%s\t%s,%s,%d\t\t# _mcount pops 2 words from  stack\n", (target_flags & 0x00002000) ? "dsubu" : "subu", reg_names[(0 + 29)], reg_names[(0 + 29)], (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? 16 : 8); fprintf (file, "\tjal\t_mcount\n"); fprintf (file, "\t.set\tat\n"); };
# 1788 "../../../kgccfe/gnu/final.c"
}
     ...
     int prescan;
{
  ...
  new_block = 1;
# 1867 "../../../kgccfe/gnu/final.c"
    {
      for (insn = first; insn; insn = (((insn)->fld[2]).rtx))
 if (((enum rtx_code) (insn)->code) == NOTE && (((insn)->fld[5]).rtint) > max_line)
   max_line = (((insn)->fld[5]).rtint);
    }
 ...
 line_note_exists[(((insn)->fld[5]).rtint)] = 1;
# 1893 "../../../kgccfe/gnu/final.c"
    }
  ...
  for (insn = (((first)->fld[2]).rtx); insn;)
    {

      if ((unsigned) (((insn)->fld[0]).rtint) >= ((insn_addresses_)->num_elements))
 {
   ...
   if (((enum rtx_code) (insn)->code) == NOTE)
     ...
     fancy_abort ("../../../kgccfe/gnu/final.c", 1910, __FUNCTION__);
 }
      else
 insn_current_address = ((insn_addresses_)->data.i[((((insn)->fld[0]).rtint))]);
  ...
  if (cfun->arc_profile)
    {
      ...
      *functions_tail = new_item;
      ...
      new_item->next = 0;
      new_item->name = xstrdup (((char *)(decl_assembler_name (current_function_decl))->identifier.id.str));
     ...
     rtx insn;
{
  ...
  switch (insn_data[code].output_format)
    ...
    case 3:
      if (insn == ((void *)0))
 fancy_abort ("../../../kgccfe/gnu/final.c", 1954, __FUNCTION__);
      return (*(insn_output_fn) output) (recog_data.operand, insn);

    default:
      fancy_abort ("../../../kgccfe/gnu/final.c", 1958, __FUNCTION__);
    }
}
...
output_alternate_entry_point (file, insn)
     ...
     rtx insn;
{
  const char *name = (((insn)->fld[7]).rtstr);
  ...
  switch (((enum label_kind) (((insn)->jump << 1) | (insn)->call)))
    ...
    case LABEL_NORMAL:
    default:
      fancy_abort ("../../../kgccfe/gnu/final.c", 1991, __FUNCTION__);
    }
}
# 2003 "../../../kgccfe/gnu/final.c"
rtx
final_scan_insn (insn, file, optimize, prescan, nopeepholes)
     ...
     int optimize __attribute__ ((__unused__));
     int prescan;
     int nopeepholes __attribute__ ((__unused__));
{
 ...
 case NOTE_INSN_EH_REGION_BEG:
   fprintf (asm_out_file, "%s%s%d:\n", "$", "LEHB", (((insn)->fld[4]).rtint));

   break;

 case NOTE_INSN_EH_REGION_END:
   fprintf (asm_out_file, "%s%s%d:\n", "$", "LEHE", (((insn)->fld[4]).rtint));
 ...
 case NOTE_INSN_BLOCK_BEG:
   if (debug_info_level == DINFO_LEVEL_NORMAL
     ...
     {
       int n = (((((insn)->fld[4]).rttree))->block.block_num);
       ...
       (((((insn)->fld[4]).rttree))->common.asm_written_flag) = 1;
     }
   break;
 ...
 case NOTE_INSN_BLOCK_END:
   if (debug_info_level == DINFO_LEVEL_NORMAL
       ...
       || write_symbols == VMS_DEBUG)
     {
       ...
       --block_depth;
       if (block_depth < 0)
  fancy_abort ("../../../kgccfe/gnu/final.c", 2111, __FUNCTION__);
 ...
 default:
   if ((((insn)->fld[5]).rtint) <= 0)
     fancy_abort ("../../../kgccfe/gnu/final.c", 2129, __FUNCTION__);
...

   {
     ...
     for (note = (((insn)->fld[2]).rtx); note; note = (((note)->fld[2]).rtx))
       {
  if (((enum rtx_code) (note)->code) != NOTE && ((enum rtx_code) (note)->code) != CODE_LABEL)
    break;



  else if (((enum rtx_code) (note)->code) == NOTE
    && ((((note)->fld[5]).rtint) == NOTE_INSN_BLOCK_BEG
        || (((note)->fld[5]).rtint) == NOTE_INSN_BLOCK_END
        || (((note)->fld[5]).rtint) == NOTE_INSN_FUNCTION_BEG))
    break;
  else if (((enum rtx_code) (note)->code) == NOTE && (((note)->fld[5]).rtint) > 0)
    {


      int num;
      for (num = (((insn)->fld[5]).rtint) + 1;
           num < (((note)->fld[5]).rtint);
           num++)
        if (line_note_exists[num])
   break;

      if (num >= (((note)->fld[5]).rtint))
        note_after = 1;
      break;
    }
       }
 ...
 dwarf2out_frame_debug (insn);
    ...
    case CODE_LABEL:
      ...
      if ((((insn)->fld[6]).rtint) <= max_labelno)
 {
   int align = (label_align[(((insn)->fld[6]).rtint) - min_labelno].alignment);




   if (align && (((insn)->fld[2]).rtx))
     {
...
# 2236 "../../../kgccfe/gnu/final.c"
      ...
      if (app_on)
 {
   ...
   app_on = 0;
      ...
      if ((((insn)->fld[2]).rtx) != 0
   && ((enum rtx_code) ((((insn)->fld[2]).rtx))->code) == JUMP_INSN)
 {
   rtx nextbody = ((((((insn)->fld[2]).rtx))->fld[5]).rtx);
       ...
       if (! 0)
  {
    ...
    log_align = final_addr_vec_align ((((insn)->fld[2]).rtx));
  ...
  function_section (current_function_decl);
       ...
       do { if ((target_flags & 0x00004000) || (target_flags & 0x00100000)) function_section (current_function_decl); fprintf (file, "%s%s%d:\n", "$", "L", (((insn)->fld[6]).rtint)); } while (0);
...
# 2365 "../../../kgccfe/gnu/final.c"
     vlen = (((((body)->fld[((enum rtx_code) (body)->code) == ADDR_DIFF_VEC]).rtvec))->num_elem);
     for (idx = 0; idx < vlen; idx++)
       {
  if (((enum rtx_code) (body)->code) == ADDR_VEC)
    {

      fprintf (file, "\t%s\t%sL%d\n", (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? ".dword" : ".word", "$", (((((((((((body)->fld[0]).rtvec))->elem[idx]))->fld[0]).rtx))->fld[6]).rtint));
  ...
  else
    {
      ...
      do { if ((target_flags & 0x00100000)) fprintf (file, "\t.half\t%sL%d-%sL%d\n", "$", (((((((((((body)->fld[1]).rtvec))->elem[idx]))->fld[0]).rtx))->fld[6]).rtint), "$", (((((((((body)->fld[0]).rtx))->fld[0]).rtx))->fld[6]).rtint)); else if ((target_flags & 0x00004000)) fprintf (file, "\t%s\t%sL%d-%sLS%d\n", (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? ".dword" : ".word", "$", (((((((((((body)->fld[1]).rtvec))->elem[idx]))->fld[0]).rtx))->fld[6]).rtint), "$", (((((((((body)->fld[0]).rtx))->fld[0]).rtx))->fld[6]).rtint)); else if (mips_abi == 0 || mips_abi == 4) fprintf (file, "\t%s\t%sL%d\n", (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? ".gpdword" : ".gpword", "$", (((((((((((body)->fld[1]).rtvec))->elem[idx]))->fld[0]).rtx))->fld[6]).rtint)); else fprintf (file, "\t%s\t%sL%d\n", (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode) == DImode ? ".dword" : ".word", "$", (((((((((((body)->fld[1]).rtvec))->elem[idx]))->fld[0]).rtx))->fld[6]).rtint)); } while (0);
 ...
 if (((enum rtx_code) (body)->code) == ASM_INPUT)
   {
     const char *string = (((body)->fld[0]).rtstr);
 ...
 if (asm_noperands (body) >= 0)
   {
     ...
     rtx *ops = (rtx *) __builtin_alloca(noperands * sizeof (rtx));
     const char *string;
     ...
     string = decode_asm_operands (body, ops, ((void *)0), ((void *)0), ((void *)0));
 ...
 if (((enum rtx_code) (body)->code) == SEQUENCE)
   {
     ...
     next = final_scan_insn ((((((body)->fld[0]).rtvec))->elem[0]), file, 0, prescan, 1);
     if (next != (((((body)->fld[0]).rtvec))->elem[1]))
       {
  final_sequence = 0;
  return next;
       }

     for (i = 1; i < (((((body)->fld[0]).rtvec))->num_elem); i++)
       {
  rtx insn = (((((body)->fld[0]).rtvec))->elem[i]);
  ...
  while (insn != next);
     ...
     do { if (set_nomacro > 0 && --set_nomacro == 0) fputs_unlocked ("\t.set\tmacro\n", file); if (set_noreorder > 0 && --set_noreorder == 0) fputs_unlocked ("\t.set\treorder\n", file); dslots_jump_filled++; fputs_unlocked ("\n", file); } while (0);
     ...
     if (((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[0]))->code) == CALL_INSN)
       {
  ;
       }
     break;
 ...
 body = (((insn)->fld[5]).rtx);
# 2571 "../../../kgccfe/gnu/final.c"
 if (final_sequence == 0
     && prescan >= 0
     && ((enum rtx_code) (insn)->code) == INSN && ((enum rtx_code) (body)->code) == SET
     && ((enum rtx_code) ((((body)->fld[1]).rtx))->code) == REG
     && ((enum rtx_code) ((((body)->fld[0]).rtx))->code) == REG
     && ((((((body)->fld[1]).rtx))->fld[0]).rtuint) == ((((((body)->fld[0]).rtx))->fld[0]).rtuint))
   break;
# 2722 "../../../kgccfe/gnu/final.c"
 insn_code_number = ((((insn)->fld[6]).rtint) >= 0 ? (((insn)->fld[6]).rtint) : recog_memoized_1 (insn));
 ...
 if (! constrain_operands_cached (1))
   _fatal_insn_not_found (insn, "../../../kgccfe/gnu/final.c", 2734, __FUNCTION__);
...
# 2761 "../../../kgccfe/gnu/final.c"
 ...
 if (template == 0)
   {
     ...
     if (prev_nonnote_insn (insn) != last_ignored_compare)
       fancy_abort ("../../../kgccfe/gnu/final.c", 2779, __FUNCTION__);
     new_block = 0;
 ...
 if (template[0] == '#' && template[1] == '\0')
   {
     ...
     if (new == insn && (((new)->fld[5]).rtx) == body)
       _fatal_insn ("could not split insn", insn, "../../../kgccfe/gnu/final.c", 2805, __FUNCTION__);





     fancy_abort ("../../../kgccfe/gnu/final.c", 2811, __FUNCTION__);
 ...
 if (((enum rtx_code) (insn)->code) == INSN && dwarf2out_do_frame ())
   dwarf2out_frame_debug (insn);
# 2850 "../../../kgccfe/gnu/final.c"
 note = find_reg_note (insn, REG_VTABLE_REF, (rtx) 0);
 if (note)
   assemble_vtable_entry (((((((note)->fld[0]).rtx))->fld[0]).rtx),
     (((((((((note)->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtwint));
...
notice_source_line (insn)
     rtx insn;
{
  const char *filename = (((insn)->fld[4]).rtstr);

  last_filename = filename;
  last_linenum = (((insn)->fld[5]).rtint);
     ...
     rtx *xp;
{
  ...
  if (((enum rtx_code) (y)->code) == MEM)
    *xp = adjust_address_1 (y, ((enum machine_mode) (x)->mode), (((x)->fld[1]).rtuint), 1, 1);
  else
    {
 ...
 *xp = new;
      ...
      else if (((enum rtx_code) (y)->code) == REG)
 {
   ...
   ((x)->code = (enum rtx_code) (REG));
   (((x)->fld[0]).rtuint) = regno;
   (((x)->fld[1]).rtuint) = (((y)->fld[1]).rtuint);


   ((x)->used) = 0;
 }
      else
 fancy_abort ("../../../kgccfe/gnu/final.c", 2944, __FUNCTION__);
    }
     ...
     rtx *xp;
{
  ...
  switch (((enum rtx_code) (x)->code))
    ...
    case PLUS:
    case MULT:
      (((x)->fld[0]).rtx) = walk_alter_subreg (&(((x)->fld[0]).rtx));
      (((x)->fld[1]).rtx) = walk_alter_subreg (&(((x)->fld[1]).rtx));
      break;
...
output_asm_name ()
{
  if (debug_insn)
    {
      int num = (((debug_insn)->fld[6]).rtint);
      fprintf (asm_out_file, "\t%s %d\t%s",
        " #", (((debug_insn)->fld[0]).rtint),
        insn_data[num].name);
     ...
     int *paddressp;
{
  ...
  *paddressp = 0;
  ...
  if (((enum rtx_code) (op)->code) == REG && (((op)->fld[1]).rtuint) >= 176)
    return (cfun->emit->regno_decl[(((op)->fld[1]).rtuint)]);
  else if (((enum rtx_code) (op)->code) != MEM)
    return 0;

  if (((((op)->fld[1]).rtmem) == 0 ? 0 : (((op)->fld[1]).rtmem)->expr) != 0)
    return ((((op)->fld[1]).rtmem) == 0 ? 0 : (((op)->fld[1]).rtmem)->expr);
  ...
  *paddressp = 1;
  ...
  if ((expr = get_mem_expr_from_op (op, &inner_addressp)) && ! inner_addressp)
    ...
    && (expr = get_mem_expr_from_op ((((op)->fld[1]).rtx), &inner_addressp)))
    return expr;

  while ((rtx_class[(int) (((enum rtx_code) (op)->code))]) == '1'
  || (rtx_class[(int) (((enum rtx_code) (op)->code))]) == '2')
    op = (((op)->fld[0]).rtx);
...
# 3332 "../../../kgccfe/gnu/final.c"
 break;
# 3387 "../../../kgccfe/gnu/final.c"
      case '%':
 ...
 if (*p == '%')
 ...
 else if ((_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isalpha)))
   {
     ...
     if (! (_sch_istable[(*p) & 0xff] & (unsigned short)(_sch_isdigit)))
       ...
       {
  if ((((enum rtx_code) (operands[c])->code) == LABEL_REF || ((enum rtx_code) (operands[c])->code) == SYMBOL_REF || ((enum rtx_code) (operands[c])->code) == CONST_INT || ((enum rtx_code) (operands[c])->code) == HIGH || (((enum rtx_code) (operands[c])->code) == CONST && ! (flag_pic && pic_address_needs_scratch (operands[c])) && ((target_flags & 0x00000010) || mips_abi == 0))))
  ...
  if (((enum rtx_code) (operands[c])->code) == CONST_INT)
    fprintf (asm_out_file, "%lld",
      - (((operands[c])->fld[0]).rtwint));
  else
    {
      putc_unlocked ('-', asm_out_file);
      output_addr_const (asm_out_file, operands[c]);
 ...
 else if (mips_print_operand_punct[(unsigned char) *p])
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) == CODE_LABEL
   ...
   && (((x)->fld[5]).rtint) == NOTE_INSN_DELETED_LABEL))
    sprintf ((buf), "*%s%s%ld", ("$"), ("L"), (long)((((x)->fld[6]).rtint)));
  else
    output_operand_lossage ("`%%l' operand isn't a label");

  assemble_name (asm_out_file, buf);
}
# 3520 "../../../kgccfe/gnu/final.c"
static void
     ...
     int code __attribute__ ((__unused__));
{
  ...
  if (x && ((enum rtx_code) (x)->code) == REG && (((x)->fld[0]).rtuint) >= 176)
    fancy_abort ("../../../kgccfe/gnu/final.c", 3532, __FUNCTION__);
     ...
     rtx x;
{
 ...
 restart:
  switch (((enum rtx_code) (x)->code))
    ...
    case SYMBOL_REF:
      ...
      assemble_name (file, (((x)->fld[0]).rtstr));
    ...
    case CONST_INT:
      fprintf (file, "%lld", (((x)->fld[0]).rtwint));
      break;

    case CONST:


      output_addr_const (file, (((x)->fld[0]).rtx));
      break;
      ...
      if (((enum machine_mode) (x)->mode) == VOIDmode)
 {
   ...
   if ((((x)->fld[1]).rtwint))
     fprintf (file, "0x%llx%016llx",
       (((x)->fld[1]).rtwint), (((x)->fld[0]).rtwint));
   else if ((((x)->fld[0]).rtwint) < 0)
     fprintf (file, "0x%llx", (((x)->fld[0]).rtwint));
   else
     fprintf (file, "%lld", (((x)->fld[0]).rtwint));
 }
      else
 ...
 {
   output_addr_const (file, (((x)->fld[1]).rtx));
   if (((((((x)->fld[0]).rtx))->fld[0]).rtwint) >= 0)
     fprintf (file, "+");
   output_addr_const (file, (((x)->fld[0]).rtx));
 }
      else
 ...
 goto restart;
   ...
   || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == PC
...
asm_fprintf (FILE *file, const char *p, ...)
{
  ...
  { va_list argptr; __builtin_va_start(argptr,p); { struct Qdmy;
  struct Qdmy;
  struct Qdmy;
...
# 3725 "../../../kgccfe/gnu/final.c"
 ...
 switch (c)
   ...
   case 'o':
     *q++ = c;
     *q = 0;
     fprintf (file, buf, __builtin_va_arg(argptr,int));
     break;

   case 'w':
# 3757 "../../../kgccfe/gnu/final.c"
     *q++ = 'l';
     *q++ = 'l';
     ...
     *q++ = *p++;
     *q = 0;
     fprintf (file, buf, __builtin_va_arg(argptr,long long));
     break;
   ...
   case 'l':
     ...
     *q++ = *p++;
     *q = 0;
     fprintf (file, buf, __builtin_va_arg(argptr,long));
     break;
   ...
   case 'g':
     *q++ = c;
     *q = 0;
     fprintf (file, buf, __builtin_va_arg(argptr,double));
     break;

   case 's':
     *q++ = c;
     *q = 0;
     fprintf (file, buf, __builtin_va_arg(argptr,char *));
     break;
   ...
   case 'U':
     ...
     break;
# 3830 "../../../kgccfe/gnu/final.c"
   default:
     fancy_abort ("../../../kgccfe/gnu/final.c", 3831, __FUNCTION__);
   }
 break;
     ...
     rtx *first, *second;
{
  if (((enum rtx_code) (value)->code) == CONST_INT)
    {
      if ((8 * 8) >= (2 * (8 * ((target_flags & 0x00002000) ? 8 : 4))))
 {



   unsigned long long low, high;
   unsigned long long mask, sign_bit, sign_extend;


   sign_bit = 1;
   sign_bit <<= (8 * ((target_flags & 0x00002000) ? 8 : 4)) - 1;
   ...
   high = (((value)->fld[0]).rtwint);
   high >>= (8 * ((target_flags & 0x00002000) ? 8 : 4)) - 1;
   high >>= 1;
   high &= mask;
   if (high & sign_bit)
     high |= sign_extend;
   ...
   if (((target_flags & 0x00010000) != 0))
     {
       *first = gen_rtx_CONST_INT (VOIDmode, (long long) (high));
       *second = gen_rtx_CONST_INT (VOIDmode, (long long) (low));
     }
   else
     {
       *first = gen_rtx_CONST_INT (VOIDmode, (long long) (low));
       *second = gen_rtx_CONST_INT (VOIDmode, (long long) (high));
     }
 }
      else
 {
   ...
   rtx high = ((((value)->fld[0]).rtwint) < 0 ? (const_int_rtx[64 -1]) : (const_int_rtx[64]));
   if (((target_flags & 0x00010000) != 0))
     {
       *first = high;
       *second = value;
  ...
  else if (((enum rtx_code) (value)->code) != CONST_DOUBLE)
    {
      if (((target_flags & 0x00010000) != 0))
 {
      ...
      else
 {
  ...
  else if (((enum machine_mode) (value)->mode) == VOIDmode

    || (mode_class[(int) (((enum machine_mode) (value)->mode))]) == MODE_INT)
    {


      if (((target_flags & 0x00010000) != 0))
 {
   *first = gen_rtx_CONST_INT (VOIDmode, (long long) ((((value)->fld[1]).rtwint)));
   *second = gen_rtx_CONST_INT (VOIDmode, (long long) ((((value)->fld[0]).rtwint)));
 }
      else
 {
   *first = gen_rtx_CONST_INT (VOIDmode, (long long) ((((value)->fld[0]).rtwint)));
   *second = gen_rtx_CONST_INT (VOIDmode, (long long) ((((value)->fld[1]).rtwint)));
 }
    }
  else
    {
      struct real_value r;
      long l[2];
      memcpy (&(r), &((((value))->fld[0]).rtwint), sizeof (struct real_value));
...
# 3980 "../../../kgccfe/gnu/final.c"
      *first = gen_rtx_CONST_INT (VOIDmode, (long long) ((long long) l[0]));
      *second = gen_rtx_CONST_INT (VOIDmode, (long long) ((long long) l[1]));
    }
}
...
leaf_function_p ()
{
 ...
 return 0;
      if (((enum rtx_code) (insn)->code) == INSN
   && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SEQUENCE
   && ((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->code) == CALL_INSN
   && ! (((((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0])))->jump))
 return 0;
    }
     ...
     rtx insn;
{
  ...
  if (!uid_shuid)
    fancy_abort ("../../../kgccfe/gnu/final.c", 4036, __FUNCTION__);
  insn_id = (uid_shuid[(((insn)->fld[0]).rtint)]);
  label_id = (uid_shuid[((((((insn)->fld[9]).rtx))->fld[0]).rtint)]);

  if (!insn_id || !label_id)
    fancy_abort ("../../../kgccfe/gnu/final.c", 4041, __FUNCTION__);
