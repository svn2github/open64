...
# 45 "../../../kgccfe/gnu/loop.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 46 "../../../kgccfe/gnu/loop.c" 2
...
# 55 "../../../kgccfe/gnu/loop.c" 2
# 1 "../../../kgccfe/gnu/MIPS/insn-flags.h" 1
# 56 "../../../kgccfe/gnu/loop.c" 2
...
# 57 "../../../kgccfe/gnu/loop.c" 2
# 161 "../../../kgccfe/gnu/loop.c"
int *uid_luid;
     ...
     int flags;
{
 ...
 max_loop_num++;
  ...
  if (get_max_uid () > max_uid_for_loop)
    fancy_abort ("../../../kgccfe/gnu/loop.c", 520, __FUNCTION__);
...
# 661 "../../../kgccfe/gnu/loop.c"
  ...
  if (((enum rtx_code) (p)->code) == JUMP_INSN)
   ...
   && (((((((p)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop && (((((((p)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((((p)->fld[9]).rtx))->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 703, __FUNCTION__), -1)) >= ((((loop_start)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop_start)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 703, __FUNCTION__), -1)) && (((((((p)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((((p)->fld[9]).rtx))->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 703, __FUNCTION__), -1)) <= ((((loop_end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop_end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 703, __FUNCTION__), -1))))
 {
   loop->top = next_label (loop->scan_start);
   loop->scan_start = (((p)->fld[9]).rtx);
 }
    }
# 718 "../../../kgccfe/gnu/loop.c"
...
# 891 "../../../kgccfe/gnu/loop.c"
   ...
   regs->array[regno+i].set_in_loop = 0;
    ...
    m->global = ((uid_luid[(((reg_n_info)->data.reg[regno])->last_uid)] > (((((loop)->end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((loop)->end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 951, __FUNCTION__), -1)) || uid_luid[(((reg_n_info)->data.reg[regno])->first_uid)] < (((((loop)->start)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((loop)->start)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 951, __FUNCTION__), -1))));
    m->match = 0;
     ...
     struct loop_regs *regs;
{
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/loop.c", 1743, __FUNCTION__);
 }
    }
  return 1;
}
...
# 1886 "../../../kgccfe/gnu/loop.c"
       ...
       else if (m->move_insn)
  {
    ...
    for (count = m->consec; count >= 0; count--)
     ...
     && (temp = find_reg_note (p, REG_LIBCALL, (rtx) 0)))
   fancy_abort ("../../../kgccfe/gnu/loop.c", 1942, __FUNCTION__);
...
# 2043 "../../../kgccfe/gnu/loop.c"
        ...
        if (m->savemode != VOIDmode)
   {
     ...
     if (tem == 0)
       fancy_abort ("../../../kgccfe/gnu/loop.c", 2105, __FUNCTION__);
     if (tem != reg)
       ...
       if (! m->partial)
  {
    ...
    for (i = 0; i < ((regno) < 176 ? (int) mips_hard_regno_nregs ((regno), ((enum machine_mode) (m->set_dest)->mode)) : 1); i++)
      regs->array[regno+i].set_in_loop = 0;
       ...
       if (uid_luid[(((reg_n_info)->data.reg[regno])->first_uid)] > ((((loop_start)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop_start)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 2214, __FUNCTION__), -1)))



  (((reg_n_info)->data.reg[regno])->first_uid) = (((loop_start)->fld[0]).rtint);
       if (uid_luid[(((reg_n_info)->data.reg[regno])->last_uid)] < ((((loop_end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop_end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 2219, __FUNCTION__), -1)))
     ...
     struct loops *loops;
{
 ...
 switch ((((insn)->fld[5]).rtint))
   ...
   case NOTE_INSN_LOOP_END:
     if (! current_loop)
       fancy_abort ("../../../kgccfe/gnu/loop.c", 2704, __FUNCTION__);
...
# 2903 "../../../kgccfe/gnu/loop.c"
   ...
   if (squeeze_notes (&new_label, &last_insn_to_move))
     fancy_abort ("../../../kgccfe/gnu/loop.c", 2917, __FUNCTION__);
   ...
   if ((((insn)->fld[9]).rtx))
         ...
         if ((((r)->fld[0]).rtx) == (((insn)->fld[9]).rtx))
    {
     ...
     loop = loop->outer)
       ...
       if (! r)
         fancy_abort ("../../../kgccfe/gnu/loop.c", 2953, __FUNCTION__);
     }
...
labels_in_range_p (insn, end)
     ...
     int end;
{
  while (insn && ((((insn)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((insn)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 3145, __FUNCTION__), -1)) <= end)
    {
     ...
     rtx x, y;
{
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/loop.c", 3718, __FUNCTION__);
 }
    }
  return 1;
}
...
# 4247 "../../../kgccfe/gnu/loop.c"
static rtx note_insn;



static rtx addr_placeholder;
# 4290 "../../../kgccfe/gnu/loop.c"
void
...
# 4407 "../../../kgccfe/gnu/loop.c"
      if (((enum rtx_code) (p)->code) == JUMP_INSN
   && (((p)->fld[9]).rtx) == (((loop->start)->fld[2]).rtx))
 past_loop_latch = 1;
# 4421 "../../../kgccfe/gnu/loop.c"
...
loop_biv_eliminable_p (loop, bl, threshold, insn_count)
     ...
     int insn_count;
{
# 4654 "../../../kgccfe/gnu/loop.c"
  if ((uid_luid[(((reg_n_info)->data.reg[bl->regno])->last_uid)] < ((((loop->end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 4654, __FUNCTION__), -1))
       && bl->init_insn
       && (((bl->init_insn)->fld[0]).rtint) < max_uid_for_loop
       && uid_luid[(((reg_n_info)->data.reg[bl->regno])->first_uid)] >= ((((bl->init_insn)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((bl->init_insn)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 4657, __FUNCTION__), -1))
     ...
     rtx test_reg;
{
  ...
  add_cost = iv_add_mult_cost (bl->biv->add_val, v->mult_val,
          test_reg, test_reg);
# 4982 "../../../kgccfe/gnu/loop.c"
  if (! v->replaceable && ! bl->eliminable
      && (((v->dest_reg))->volatil))
    benefit -= copy_cost;
# 4994 "../../../kgccfe/gnu/loop.c"
  benefit -= add_cost * bl->biv_count;
# 5028 "../../../kgccfe/gnu/loop.c"
  return benefit;
}
...
# 5823 "../../../kgccfe/gnu/loop.c"
 ...
 bl->giv_count++;
    ...
    fancy_abort ("../../../kgccfe/gnu/loop.c", 5866, __FUNCTION__);
...
# 5885 "../../../kgccfe/gnu/loop.c"
   ...
   < ((((loop->end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 5888, __FUNCTION__), -1))
   && (! not_every_iteration
       || last_use_this_basic_block (dest_reg, insn)))
 {
# 5906 "../../../kgccfe/gnu/loop.c"
   v->replaceable = 1;
   v->not_replaceable = 0;
   for (b = bl->biv; b; b = b->next_iv)
     {
       if ((((b->insn)->fld[0]).rtint) >= max_uid_for_loop
    || ((((((b->insn)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((b->insn)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 5911, __FUNCTION__), -1))
         >= uid_luid[(((reg_n_info)->data.reg[(((dest_reg)->fld[0]).rtuint)])->first_uid)])
        && (((((b->insn)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((b->insn)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 5913, __FUNCTION__), -1))
     <= uid_luid[(((reg_n_info)->data.reg[(((dest_reg)->fld[0]).rtuint)])->last_uid)])))
  {
    v->replaceable = 0;
    v->not_replaceable = 1;
     ...
     enum machine_mode addr_mode;
{
      ...
      else
 {
   ...
   *mult_val = (const_int_rtx[64 +1]);
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/loop.c", 6536, __FUNCTION__);
    }
     ...
     int *benefit;
{
 ...
 switch (((enum rtx_code) (arg0)->code))
   ...
   default:
     fancy_abort ("../../../kgccfe/gnu/loop.c", 6659, __FUNCTION__);
   }
...
# 6773 "../../../kgccfe/gnu/loop.c"
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/loop.c", 6800, __FUNCTION__);
 }
     ...
     struct loop_info *loop_info;
{
 ...
 switch (code)
  ...
  if (u_start_val <= max && u_end_val <= max)
   ...
   default:
     fancy_abort ("../../../kgccfe/gnu/loop.c", 7548, __FUNCTION__);
   }
     ...
     rtx insn, reference;
{
 ...
 return 1;
   ...
   && ((enum rtx_code) (p)->code) != NOTE)
 return ((((p)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((p)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 8767, __FUNCTION__), -1)) <= ((((q)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((q)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 8767, __FUNCTION__), -1));
     ...
     rtx insn;
{
  ...
  if (((enum rtx_code) (x)->code) == REG && (((x)->fld[0]).rtuint) < max_reg_before_loop
      ...
      && uid_luid[(((reg_n_info)->data.reg[(((x)->fld[0]).rtuint)])->last_uid)] < ((((insn)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((insn)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 9246, __FUNCTION__), -1)))
    {
       ...
       && any_uncondjump_p (p)))
 {
   ...
   if (
    ...
    && (((((((p)->fld[9]).rtx))->fld[0]).rtint) >= max_uid_for_loop
        || (((((((p)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((((p)->fld[9]).rtx))->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 9881, __FUNCTION__), -1)) < ((((loop->start)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->start)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 9881, __FUNCTION__), -1))
        || (((((((p)->fld[9]).rtx))->fld[0]).rtint) < max_uid_for_loop ? uid_luid[((((((p)->fld[9]).rtx))->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 9882, __FUNCTION__), -1)) > ((((loop->end)->fld[0]).rtint) < max_uid_for_loop ? uid_luid[(((loop->end)->fld[0]).rtint)] : (fancy_abort ("../../../kgccfe/gnu/loop.c", 9882, __FUNCTION__), -1)))))
     return;
     ...
     unsigned int regno;
{
 ...
 {
   if (init_insn)
     fancy_abort ("../../../kgccfe/gnu/loop.c", 10245, __FUNCTION__);
      ...
      if (init_insn && insn != init_insn)
 {
  ...
  if (! init_insn)
    fancy_abort ("../../../kgccfe/gnu/loop.c", 10279, __FUNCTION__);
  if (apply_change_group ())
    {
      if (loop_dump_stream)
     ...
     int verbose;
{
 ...
 case TRUNCATE:
   ...
   break;
 default:
   fancy_abort ("../../../kgccfe/gnu/loop.c", 10853, __FUNCTION__);
 }
    }
