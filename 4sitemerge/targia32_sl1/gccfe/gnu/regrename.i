...
# 33 "../../../kgccfe/gnu/regrename.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 34 "../../../kgccfe/gnu/regrename.c" 2
...
# 44 "../../../kgccfe/gnu/regrename.c" 2


# 1 "../../../kgccfe/gnu/defaults.h" 1
# 47 "../../../kgccfe/gnu/regrename.c" 2
...
static void merge_overlapping_regs (basic_block, HARD_REG_SET *, struct du_chain *);
     ...
     void *data;
{
  ...
  if (regno + nregs > 176)
    fancy_abort ("../../../kgccfe/gnu/regrename.c", 122, __FUNCTION__);

  while (nregs-- > 0)
    ((*pset)[(regno + nregs) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((regno + nregs) % ((unsigned) (8 * 8))));
}
     ...
     rtx notes;
{
 ...
 if (regno + nregs > 176)
   fancy_abort ("../../../kgccfe/gnu/regrename.c", 147, __FUNCTION__);
     ...
     struct du_chain *chain;
{
  ...
  do { do { HARD_REG_ELT_TYPE *scan_tp_ = (live); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); reg_set_to_hard_reg_set (&live, b->global_live_at_start); } while (0);
  insn = b->head;
  while (t)
    {
      ...
      while (insn != t->insn)
 {
   if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
     {
       clear_dead_regs (&live, REG_DEAD, (((insn)->fld[8]).rtx));
       note_stores ((((insn)->fld[5]).rtx), note_sets, (void *) &live);


       if (t != chain)
  do { HARD_REG_ELT_TYPE *scan_tp_ = (*pset), *scan_fp_ = (live); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
       clear_dead_regs (&live, REG_UNUSED, (((insn)->fld[8]).rtx));
     }
   insn = (((insn)->fld[2]).rtx);
 }
      ...
      if (! t->next_use)
 note_stores ((((insn)->fld[5]).rtx), note_sets, (void *) pset);
...
regrename_optimize ()
{
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      ...
      do { HARD_REG_ELT_TYPE *scan_tp_ = (unavailable); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
      ...
      if (frame_pointer_needed)
 {
   ...
   for (i = mips_hard_regno_nregs ((0 + 1), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)); i--;)
     ((unavailable)[((0 + 1) + i) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << (((0 + 1) + i) % ((unsigned) (8 * 8))));


   for (i = mips_hard_regno_nregs (((target_flags & 0x00100000) ? 0 + 17 : 0 + 30), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)); i--;)
     ((unavailable)[(((target_flags & 0x00100000) ? 0 + 17 : 0 + 30) + i) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((((target_flags & 0x00100000) ? 0 + 17 : 0 + 30) + i) % ((unsigned) (8 * 8))));

 }

      do { HARD_REG_ELT_TYPE *scan_tp_ = (regs_seen); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
      while (all_chains)
 {
...
# 268 "../../../kgccfe/gnu/regrename.c"
   if (fixed_regs[reg] || global_regs[reg]

       || (frame_pointer_needed && reg == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30))
   ...
   do { HARD_REG_ELT_TYPE *scan_tp_ = (this_unavailable), *scan_fp_ = (unavailable); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);
   ...
   for (last = this; last->next_use; last = last->next_use)
     {
       n_uses++;
       do { HARD_REG_ELT_TYPE *scan_tp_ = (this_unavailable), *scan_fp_ = (reg_class_contents[last->class]); scan_tp_[0] |= ~ scan_fp_[0]; scan_tp_[1] |= ~ scan_fp_[1]; scan_tp_[2] |= ~ scan_fp_[2]; } while (0);
   ...
   if (this->need_caller_save_reg)
     do { HARD_REG_ELT_TYPE *scan_tp_ = (this_unavailable), *scan_fp_ = (call_used_reg_set); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

   merge_overlapping_regs (bb, &this_unavailable, this);



   for (new_reg = 0; new_reg < 176; new_reg++)
     {
       int nregs = mips_hard_regno_nregs (new_reg, ((enum machine_mode) (*this->loc)->mode));

       for (i = nregs - 1; i >= 0; --i)
         if ((!!((this_unavailable)[(new_reg + i) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((new_reg + i) % ((unsigned) (8 * 8))))))
      || fixed_regs[new_reg + i]
      || global_regs[new_reg + i]

      || (! regs_ever_live[new_reg + i]
   && ! call_used_regs[new_reg + i])
# 322 "../../../kgccfe/gnu/regrename.c"
      )
    break;
       if (i >= 0)
  continue;
  ...
  if (! mips_hard_regno_mode_ok[ (int)(((enum machine_mode) (*tmp->loc)->mode)) ][ (new_reg) ]
  ...
  __extension__ ({ struct obstack *__o = (&rename_obstack); void *__obj = (((void *)0)); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
     ...
     int earlyclobber;
{
  ...
  int this_nregs = mips_hard_regno_nregs (this_regno, mode);
...
# 447 "../../../kgccfe/gnu/regrename.c"
      if (*this->loc == (global_rtl[GR_CC0]))
 p = &this->next_chain;
      else
 {
   int regno = (((*this->loc)->fld[0]).rtuint);
   int nregs = mips_hard_regno_nregs (regno, ((enum machine_mode) (*this->loc)->mode));
   ...
   if (action == mark_read)
     {
       if (! exact_match)
  fancy_abort ("../../../kgccfe/gnu/regrename.c", 465, __FUNCTION__);
     ...
     enum machine_mode mode;
{
 ...
 if (locI)
   scan_rtx_address (insn, locI, NO_REGS, action, mode);
 if (locB)
   scan_rtx_address (insn, locB, ((target_flags & 0x00100000) ? M16_REGS : GR_REGS), action, mode);
 return;
      }
   ...
   ((target_flags & 0x00100000) ? M16_REGS : GR_REGS), action,
     ...
     int earlyclobber;
{
  ...
  type == OP_IN ? OP_IN : OP_INOUT, earlyclobber);
    ...
    case PRE_MODIFY:
      ...
      fancy_abort ("../../../kgccfe/gnu/regrename.c", 724, __FUNCTION__);
     ...
     basic_block bb;
{
      ...
      if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
 {
   ...
   int alt;
   int predicated;
# 789 "../../../kgccfe/gnu/regrename.c"
   icode = ((((insn)->fld[6]).rtint) >= 0 ? (((insn)->fld[6]).rtint) : recog_memoized_1 (insn));
   extract_insn (insn);
   if (! constrain_operands (1))
     _fatal_insn_not_found (insn, "../../../kgccfe/gnu/regrename.c", 792, __FUNCTION__);
   ...
   predicated = ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == COND_EXEC;
   for (i = 0; i < n_ops; ++i)
     {
  ...
  old_dups[i] = recog_data.operand[dup_num];
   ...
   scan_rtx (insn, &(((insn)->fld[5]).rtx), NO_REGS, terminate_all_read,
      OP_IN, 0);
   ...
   if (((enum rtx_code) (insn)->code) == CALL_INSN && (((insn)->fld[9]).rtx))
     scan_rtx (insn, &(((insn)->fld[9]).rtx),
  ...
  *recog_data.dup_loc[i] = (global_rtl[GR_CC0]);
   ...
   scan_rtx (insn, &(((insn)->fld[5]).rtx), NO_REGS, terminate_write, OP_IN, 0);
  ...
  while (chains)
    {
      ...
      int nregs = mips_hard_regno_nregs (r, ((enum machine_mode) (*this->loc)->mode));
     ...
     struct value_data *vd;
{
  ...
  if ((((enum rtx_code) (x)->code) == REG))
    {
      ...
      unsigned int n = mips_hard_regno_nregs (regno, ((enum machine_mode) (x)->mode));
      unsigned int i, j;
      ...
      for (; j < regno; ++j)
 {
   if (vd->e[j].mode == VOIDmode)
     continue;
   n = mips_hard_regno_nregs (j, vd->e[j].mode);
   if (j + n > regno)
     for (i = 0; i < n; ++i)
  ...
  if ((rtx_class[(int) (((enum rtx_code) (x)->code))]) == 'a')
    {
      x = (((x)->fld[0]).rtx);
      kill_value (x, vd);
      set_value_regno ((((x)->fld[0]).rtuint), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), vd);
      return -1;
    }
     ...
     struct value_data *vd;
{
  ...
  if (frame_pointer_needed && dr == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30))
    return;


  dn = mips_hard_regno_nregs (dr, ((enum machine_mode) (dest)->mode));
  sn = mips_hard_regno_nregs (sr, ((enum machine_mode) (dest)->mode));
  if ((dr > sr && dr < sr + sn)
      || (sr > dr && sr < dr + dn))
    return;
...
# 1292 "../../../kgccfe/gnu/regrename.c"
  else if (sn < (unsigned int) mips_hard_regno_nregs (sr, vd->e[sr].mode)
    && ((mode_size[(int) (vd->e[sr].mode)]) > ((target_flags & 0x00002000) ? 8 : 4)
     ...
     unsigned int regno __attribute__ ((__unused__));
{
  ...
  return !mips_cannot_change_mode_class (orig_mode, new_mode, mips_regno_to_class[ (regno) ]);
     ...
     unsigned int regno, copy_regno;
{
  if (orig_mode == new_mode)
    return gen_rtx_fmt_i0 (REG, (new_mode), (regno));
  else if (mode_change_ok (orig_mode, new_mode, regno))
    {
      int copy_nregs = mips_hard_regno_nregs (copy_regno, copy_mode);
      int use_nregs = mips_hard_regno_nregs (copy_regno, new_mode);
      int copy_offset
 = (mode_size[(int) (copy_mode)]) / copy_nregs * (copy_nregs - use_nregs);
      int offset
 = (mode_size[(int) (orig_mode)]) - (mode_size[(int) (new_mode)]) - copy_offset;
      int byteoffset = offset % ((target_flags & 0x00002000) ? 8 : 4);
      int wordoffset = offset - byteoffset;

      offset = ((((target_flags & 0x00010000) != 0) ? wordoffset : 0)
  + (((target_flags & 0x00010000) != 0) ? byteoffset : 0));
      return gen_rtx_fmt_i0 (REG, (new_mode), (regno + subreg_regno_offset (regno, orig_mode, offset, new_mode)));
     ...
     struct value_data *vd;
{
  ...
  unsigned int i;
# 1387 "../../../kgccfe/gnu/regrename.c"
  if (mode != vd->e[regno].mode)
    {
      if (mips_hard_regno_nregs (regno, mode)
   > mips_hard_regno_nregs (regno, vd->e[regno].mode))
 return (rtx) 0;
    }
  ...
  for (i = vd->e[regno].oldest_regno; i != regno; i = vd->e[i].next_regno)
    ...
    if ((!!((reg_class_contents[class])[(i) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))))))
     ...
     struct value_data *vd;
{
 ...
 if (locI)
   changed |= replace_oldest_value_addr (locI, NO_REGS, mode,
      insn, vd);
 if (locB)
     ...
     struct value_data *vd;
{
      ...
      if (! ((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
 {
   if (insn == bb->end)
     ...
     continue;
      ...
      extract_insn (insn);
      if (! constrain_operands (1))
 _fatal_insn_not_found (insn, "../../../kgccfe/gnu/regrename.c", 1611, __FUNCTION__);
      preprocess_constraints ();
      alt = which_alternative;
      n_ops = recog_data.n_operands;
      is_asm = asm_noperands ((((insn)->fld[5]).rtx)) >= 0;
 ...
 if (recog_op_alt[i][alt].earlyclobber)
   kill_value (recog_data.operand[i], vd);
      ...
      note_stores ((((insn)->fld[5]).rtx), kill_clobbered_value, vd);



      for_each_rtx (&(((insn)->fld[5]).rtx), kill_autoinc_value, vd);
      ...
      if (set && (((enum rtx_code) ((((set)->fld[1]).rtx))->code) == REG))
 {
  ...
  goto no_move_special_case;
   ...
   if ((((enum rtx_code) ((((set)->fld[0]).rtx))->code) == REG))
     {
       new = find_oldest_value_reg (mips_regno_to_class[ (regno) ], src, vd);
 ...
 for (i = 0; i < 176; i++)
   if ((!!((regs_invalidated_by_call)[(i) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8)))))))
     kill_value_regno (i, vd);
      ...
      note_stores ((((insn)->fld[5]).rtx), kill_set_value, vd);
...
copyprop_hardreg_forward ()
{
 ...
 for (bbp = bb; bbp && bbp != bb->pred->src; bbp = bbp->prev_bb);
   ...
   && ! bb->pred->pred_next
   && ! (bb->pred->flags & (4 | 8))
   && bb->pred->src != (&entry_exit_blocks[0])
   && bbp)
     ...
     struct value_data *vd;
{
  ...
  do { HARD_REG_ELT_TYPE *scan_tp_ = (set); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
 ...
 ((set)[(i) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))));
 fprintf (stderr, "[%u %s] ", i, (mode_name[(int) (vd->e[i].mode)]));

 for (j = vd->e[i].next_regno;
      j != (~(unsigned int) 0);
      j = vd->e[j].next_regno)
   {
     if ((!!((set)[(j) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((j) % ((unsigned) (8 * 8)))))))
       {
  ...
  return;
     ...
     ((set)[(j) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((j) % ((unsigned) (8 * 8))));
     fprintf (stderr, "[%u %s] ", j, (mode_name[(int) (vd->e[j].mode)]));
   }
 fputc_unlocked ('\n', stderr);
      }

  for (i = 0; i < 176; ++i)
    if (! (!!((set)[(i) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))))))
 && (vd->e[i].mode != VOIDmode
     || vd->e[i].oldest_regno != i
     || vd->e[i].next_regno != (~(unsigned int) 0)))
