...
# 34 "../../../kgccfe/gnu/global.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 35 "../../../kgccfe/gnu/global.c" 2
...
# 38 "../../../kgccfe/gnu/global.c" 2
# 80 "../../../kgccfe/gnu/global.c"
...
static int local_reg_n_refs[176];


static int local_reg_freq[176];




static int local_reg_live_length[176];
# 242 "../../../kgccfe/gnu/global.c"
static long long *allocnos_live;
# 283 "../../../kgccfe/gnu/global.c"
static rtx *regs_set;
     ...
     FILE *file;
{
  ...
  static const struct {const int from, to; } eliminables[] = {{ 0, (0 + 29)}, { 0, 0 + 30}, { 0, 0 + 17}, { 75, (0 + 29)}, { 75, 0 + 30}, { 75, 0 + 17}, { (0 + 1), (0 + 29)}, { (0 + 1), 0 + 30}, { (0 + 1), 0 + 17}};
  ...
  do { HARD_REG_ELT_TYPE *scan_tp_ = (no_global_alloc_regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
  ...
  for (i = 0; i < (sizeof (eliminables) / sizeof ((eliminables)[0])); i++)
    {
      ((eliminable_regset)[(eliminables[i].from) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((eliminables[i].from) % ((unsigned) (8 * 8))));

      if (! (((eliminables[i].from) == 75 && (((eliminables[i].to) == (0 + 29) && ! frame_pointer_needed) || (eliminables[i].to) == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30))) || ((eliminables[i].from) != 75 && ((eliminables[i].to) == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30) || ((eliminables[i].to) == (0 + 29) && ! frame_pointer_needed && ! ((target_flags & 0x00100000) && (target_flags & 0x00002000)) && (! (target_flags & 0x00100000) || compute_frame_size (get_frame_size ()) < 32768)))))
   || (eliminables[i].to == (0 + 29) && need_fp))
 ((no_global_alloc_regs)[(eliminables[i].from) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((eliminables[i].from) % ((unsigned) (8 * 8))));
    }

  ((eliminable_regset)[(((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)) % ((unsigned) (8 * 8))));
  if (need_fp)
    ((no_global_alloc_regs)[(((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)) % ((unsigned) (8 * 8))));
# 368 "../../../kgccfe/gnu/global.c"
  do { HARD_REG_ELT_TYPE *scan_tp_ = (regs_used_so_far); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
# 389 "../../../kgccfe/gnu/global.c"
  for (i = 0; i < 176; i++)
    if (regs_ever_live[i] || call_used_regs[i])
      ((regs_used_so_far)[(i) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))));


  for (i = 176; i < (size_t) max_regno; i++)
    if (reg_renumber[i] >= 0)
      ((regs_used_so_far)[(reg_renumber[i]) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((reg_renumber[i]) % ((unsigned) (8 * 8))));
  ...
  for (x = regs_may_share; x; x = ((((((x)->fld[1]).rtx))->fld[1]).rtx))
    {
      int r1 = ((((((x)->fld[0]).rtx))->fld[0]).rtuint);
      int r2 = (((((((((x)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtuint);
      if (r1 > r2)
 reg_may_share[r1] = r2;
      else
 reg_may_share[r2] = r1;
 ...
 if ((((reg_n_info)->data.reg[i])->live_length) == 0)
   fancy_abort ("../../../kgccfe/gnu/global.c", 434, __FUNCTION__);
      }
    else
      reg_allocno[i] = -1;
 ...
 allocno[num].reg = i;
 allocno[num].size = (((mode_size[(int) (((enum machine_mode) ((cfun->emit->x_regno_reg_rtx)[i])->mode))]) + ((target_flags & 0x00002000) ? 8 : 4) - 1) / ((target_flags & 0x00002000) ? 8 : 4));
 ...
 int endregno = regno + mips_hard_regno_nregs (regno, ((enum machine_mode) ((cfun->emit->x_regno_reg_rtx)[i])->mode));
 int j;
 ...
 for (j = regno; j < endregno; j++)
  ...
  allocno_row_words = (max_allocno + (8 * 8) - 1) / (8 * 8);




  conflicts = (long long *) xcalloc (max_allocno * allocno_row_words,
        sizeof (long long));

  allocnos_live = (long long *) xmalloc (allocno_row_words * sizeof (long long));
  ...
  if (max_allocno > 0)
    {
      ...
      mirror_conflicts ();
# 509 "../../../kgccfe/gnu/global.c"
      for (i = 0; i < (size_t) max_allocno; i++)
 {
   do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[i].hard_reg_conflicts), *scan_fp_ = (eliminable_regset); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);

   do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[i].hard_reg_copy_preferences), *scan_fp_ = (eliminable_regset); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);

   do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[i].hard_reg_preferences), *scan_fp_ = (eliminable_regset); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);
     ...
     const void * v2p;
{
  ...
  int pri1
    = (((double) (floor_log2_wide ((unsigned long long) (allocno[v1].n_refs)) * allocno[v1].freq)
 / allocno[v1].live_length)
       * (10000 / 1000) * allocno[v1].size);
  int pri2
    = (((double) (floor_log2_wide ((unsigned long long) (allocno[v2].n_refs)) * allocno[v2].freq)
...
# 724 "../../../kgccfe/gnu/global.c"
      ...
      while (1)
 {
   ...
   if (code == INSN || code == CALL_INSN || code == JUMP_INSN)
     {
# 762 "../../../kgccfe/gnu/global.c"
       note_stores ((((insn)->fld[5]).rtx), mark_reg_clobber, ((void *)0));



       for (link = (((insn)->fld[8]).rtx); link; link = (((link)->fld[1]).rtx))
  if (((enum reg_note) ((enum machine_mode) (link)->mode)) == REG_DEAD)
    mark_reg_death ((((link)->fld[0]).rtx));
       ...
       note_stores ((((insn)->fld[5]).rtx), mark_reg_store, ((void *)0));
# 794 "../../../kgccfe/gnu/global.c"
    ...
    if (((enum reg_note) ((enum machine_mode) (link)->mode)) == REG_DEAD)
      {
        ...
        int i;
        rtx reg = (((link)->fld[0]).rtx);

        for (i = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
   {
     rtx set = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]);
     if (((enum rtx_code) (set)->code) == SET
         && ((enum rtx_code) ((((set)->fld[0]).rtx))->code) != REG
         && !rtx_equal_p (reg, (((set)->fld[0]).rtx))
         && reg_overlap_mentioned_p (reg, (((set)->fld[0]).rtx)))
       used_in_output = 1;
   }
        if (used_in_output)
       ...
       while (n_regs_set-- > 0)
  {
    rtx note = find_regno_note (insn, REG_UNUSED,
           (((regs_set[n_regs_set])->fld[0]).rtuint));
    if (note)
      mark_reg_death ((((note)->fld[0]).rtx));
  }
     }
...
expand_preferences ()
{
 ...
 && ((enum rtx_code) ((((set)->fld[0]).rtx))->code) == REG
 && reg_allocno[((((((set)->fld[0]).rtx))->fld[0]).rtuint)] >= 0)
      for (link = (((insn)->fld[8]).rtx); link; link = (((link)->fld[1]).rtx))
 if (((enum reg_note) ((enum machine_mode) (link)->mode)) == REG_DEAD
     && ((enum rtx_code) ((((link)->fld[0]).rtx))->code) == REG
     && reg_allocno[((((((link)->fld[0]).rtx))->fld[0]).rtuint)] >= 0
     && ! (conflicts[(reg_allocno[((((((set)->fld[0]).rtx))->fld[0]).rtuint)]) * allocno_row_words + (unsigned) (reg_allocno[((((((link)->fld[0]).rtx))->fld[0]).rtuint)]) / (8 * 8)] & ((long long) 1 << ((unsigned) (reg_allocno[((((((link)->fld[0]).rtx))->fld[0]).rtuint)]) % (8 * 8)))))

   {
     int a1 = reg_allocno[((((((set)->fld[0]).rtx))->fld[0]).rtuint)];
     int a2 = reg_allocno[((((((link)->fld[0]).rtx))->fld[0]).rtuint)];

     if ((((link)->fld[0]).rtx) == (((set)->fld[1]).rtx))
       {
  do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[a1].hard_reg_copy_preferences), *scan_fp_ = (allocno[a2].hard_reg_copy_preferences); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

  do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[a2].hard_reg_copy_preferences), *scan_fp_ = (allocno[a1].hard_reg_copy_preferences); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

       }

     do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[a1].hard_reg_preferences), *scan_fp_ = (allocno[a2].hard_reg_preferences); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

     do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[a2].hard_reg_preferences), *scan_fp_ = (allocno[a1].hard_reg_preferences); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

     do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[a1].hard_reg_full_preferences), *scan_fp_ = (allocno[a2].hard_reg_full_preferences); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

     do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[a2].hard_reg_full_preferences), *scan_fp_ = (allocno[a1].hard_reg_full_preferences); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

   }
}
# 891 "../../../kgccfe/gnu/global.c"
static void
prune_preferences ()
{
  int i;
  ...
  for (i = max_allocno - 1; i >= 0; i--)
    {
      ...
      do { HARD_REG_ELT_TYPE *scan_tp_ = (temp), *scan_fp_ = (allocno[num].hard_reg_conflicts); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);

      if (allocno[num].calls_crossed == 0)
 do { HARD_REG_ELT_TYPE *scan_tp_ = (temp), *scan_fp_ = (fixed_reg_set); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
      else
 do { HARD_REG_ELT_TYPE *scan_tp_ = (temp), *scan_fp_ = (call_used_reg_set); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

      do { HARD_REG_ELT_TYPE *scan_tp_ = (temp), *scan_fp_ = (reg_class_contents[(int) reg_preferred_class (allocno[num].reg)]); scan_tp_[0] |= ~ scan_fp_[0]; scan_tp_[1] |= ~ scan_fp_[1]; scan_tp_[2] |= ~ scan_fp_[2]; } while (0);



      do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[num].hard_reg_preferences), *scan_fp_ = (temp); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);
      do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[num].hard_reg_copy_preferences), *scan_fp_ = (temp); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);
      do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[num].hard_reg_full_preferences), *scan_fp_ = (temp); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);
    }
  ...
  for (i = max_allocno - 1; i >= 0; i--)
    {
      ...
      do { HARD_REG_ELT_TYPE *scan_tp_ = (temp); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
      do { HARD_REG_ELT_TYPE *scan_tp_ = (temp2); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);

      do { int i_; int allocno_; long long *p_ = (conflicts + num * allocno_row_words); for (i_ = allocno_row_words - 1, allocno_ = 0; i_ >= 0; i_--, allocno_ += (8 * 8)) { unsigned long long word_ = (unsigned long long) *p_++; for ((allocno2) = allocno_; word_; word_ >>= 1, (allocno2)++) { if (word_ & 1) {{ if (allocno_to_order[allocno2] > i) { if (allocno[allocno2].size <= allocno[num].size) do { HARD_REG_ELT_TYPE *scan_tp_ = (temp), *scan_fp_ = (allocno[allocno2].hard_reg_full_preferences); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0); else do { HARD_REG_ELT_TYPE *scan_tp_ = (temp2), *scan_fp_ = (allocno[allocno2].hard_reg_full_preferences); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0); } };} } } } while (0);
# 954 "../../../kgccfe/gnu/global.c"
      do { HARD_REG_ELT_TYPE *scan_tp_ = (temp), *scan_fp_ = (allocno[num].hard_reg_full_preferences); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);
      do { HARD_REG_ELT_TYPE *scan_tp_ = (temp), *scan_fp_ = (temp2); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
      do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[num].regs_someone_prefers), *scan_fp_ = (temp); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);
    }
  free (allocno_to_order);
}
# 979 "../../../kgccfe/gnu/global.c"
static void
     ...
     int retrying;
{
  ...
  if (accept_call_clobbered)
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used1), *scan_fp_ = (call_fixed_reg_set); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);
  else if (allocno[num].calls_crossed == 0)
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used1), *scan_fp_ = (fixed_reg_set); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);
  else
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used1), *scan_fp_ = (call_used_reg_set); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);


  do { HARD_REG_ELT_TYPE *scan_tp_ = (used1), *scan_fp_ = (no_global_alloc_regs); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
  if (losers)
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used1), *scan_fp_ = (losers); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

  do { HARD_REG_ELT_TYPE *scan_tp_ = (used1), *scan_fp_ = (reg_class_contents[(int) class]); scan_tp_[0] |= ~ scan_fp_[0]; scan_tp_[1] |= ~ scan_fp_[1]; scan_tp_[2] |= ~ scan_fp_[2]; } while (0);
  do { HARD_REG_ELT_TYPE *scan_tp_ = (used2), *scan_fp_ = (used1); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);

  do { HARD_REG_ELT_TYPE *scan_tp_ = (used1), *scan_fp_ = (allocno[num].hard_reg_conflicts); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);


  cannot_change_mode_set_regs (&used1, mode, allocno[num].reg);
# 1022 "../../../kgccfe/gnu/global.c"
  do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (used1); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);
  do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (regs_used_so_far); scan_tp_[0] |= ~ scan_fp_[0]; scan_tp_[1] |= ~ scan_fp_[1]; scan_tp_[2] |= ~ scan_fp_[2]; } while (0);
  do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (allocno[num].regs_someone_prefers); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
      ...
      for (i = 0; i < 176; i++)
 {
   ...
   if (! (!!((used)[(regno) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8))))))
    ...
    || ! 0))
     {
       int j;
       int lim = regno + mips_hard_regno_nregs (regno, mode);
       for (j = regno + 1;
     (j < lim
      && ! (!!((used)[(j) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((j) % ((unsigned) (8 * 8)))))));
     j++);
       if (j == lim)
  {
    best_reg = regno;
...
# 1075 "../../../kgccfe/gnu/global.c"
  do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[num].hard_reg_copy_preferences), *scan_fp_ = (used); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);
  do { HARD_REG_ELT_TYPE *scan_xp_ = (allocno[num].hard_reg_copy_preferences), *scan_yp_ = (reg_class_contents[(int) NO_REGS]); if ((0 == (scan_xp_[0] & ~ scan_yp_[0])) && (0 == (scan_xp_[1] & ~ scan_yp_[1])) && (0 == (scan_xp_[2] & ~ scan_yp_[2]))) goto no_copy_prefs; } while (0);


  if (best_reg >= 0)
    {
      for (i = 0; i < 176; i++)
 if ((!!((allocno[num].hard_reg_copy_preferences)[(i) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))))))
     && mips_hard_regno_mode_ok[ (int)(mode) ][ (i) ]
     && (allocno[num].calls_crossed == 0
  || accept_call_clobbered
  || ! 0)
     && (mips_regno_to_class[ (i) ] == mips_regno_to_class[ (best_reg) ]
  || reg_class_subset_p (mips_regno_to_class[ (i) ],
           mips_regno_to_class[ (best_reg) ])
  || reg_class_subset_p (mips_regno_to_class[ (best_reg) ],
           mips_regno_to_class[ (i) ])))
     {
       int j;
       int lim = i + mips_hard_regno_nregs (i, mode);
       for (j = i + 1;
     (j < lim
      && ! (!!((used)[(j) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((j) % ((unsigned) (8 * 8))))))
      && (mips_regno_to_class[ (j) ]
       == mips_regno_to_class[ (best_reg + (j - i)) ]
   || reg_class_subset_p (mips_regno_to_class[ (j) ],
            mips_regno_to_class[ (best_reg + (j - i)) ])
   || reg_class_subset_p (mips_regno_to_class[ (best_reg + (j - i)) ],
            mips_regno_to_class[ (j) ])));
     j++);
       if (j == lim)
  {
 ...
 no_copy_prefs:
  ...
  do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[num].hard_reg_preferences), *scan_fp_ = (used); scan_tp_[0] &= ~ scan_fp_[0]; scan_tp_[1] &= ~ scan_fp_[1]; scan_tp_[2] &= ~ scan_fp_[2]; } while (0);
  do { HARD_REG_ELT_TYPE *scan_xp_ = (allocno[num].hard_reg_preferences), *scan_yp_ = (reg_class_contents[(int) NO_REGS]); if ((0 == (scan_xp_[0] & ~ scan_yp_[0])) && (0 == (scan_xp_[1] & ~ scan_yp_[1])) && (0 == (scan_xp_[2] & ~ scan_yp_[2]))) goto no_prefs; } while (0);


  if (best_reg >= 0)
    {
      for (i = 0; i < 176; i++)
 if ((!!((allocno[num].hard_reg_preferences)[(i) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))))))
     && mips_hard_regno_mode_ok[ (int)(mode) ][ (i) ]
     && (allocno[num].calls_crossed == 0
  || accept_call_clobbered
  || ! 0)
...

 {
   ...
   if (! losers)
     do { HARD_REG_ELT_TYPE *scan_tp_ = (new_losers); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
   else
     do { HARD_REG_ELT_TYPE *scan_tp_ = (new_losers), *scan_fp_ = (losers); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);

   do { HARD_REG_ELT_TYPE *scan_tp_ = (new_losers), *scan_fp_ = (losing_caller_save_reg_set); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
      ...
      for (i = 176 - 1; i >= 0; i--)
 {
   ...
   if (local_reg_n_refs[regno] != 0
       ...
       && ! (!!((used2)[(regno) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8))))))
       && mips_hard_regno_mode_ok[ (int)(mode) ][ (regno) ]
    ...
    || ! 0)
       ...
       && ! invalid_mode_change_p (regno, mips_regno_to_class[ (regno) ],
       mode)
       ...
       if (tmp1 < tmp2)
  {
   ...
   int endregno
     = r + mips_hard_regno_nregs (r, ((enum machine_mode) ((cfun->emit->x_regno_reg_rtx)[k])->mode));
 ...
 for (j = 176; j < max_regno; j++)
   if (reg_allocno[j] == num)
     reg_renumber[j] = best_reg;


      do { HARD_REG_ELT_TYPE *scan_tp_ = (this_reg); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
      lim = best_reg + mips_hard_regno_nregs (best_reg, mode);
      for (j = best_reg; j < lim; j++)
 {
   ((this_reg)[(j) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((j) % ((unsigned) (8 * 8))));
   ((regs_used_so_far)[(j) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((j) % ((unsigned) (8 * 8))));
   ...
   local_reg_freq[j] = 0;
      ...
      lim = num;
      do { int i_; int allocno_; long long *p_ = (conflicts + lim * allocno_row_words); for (i_ = allocno_row_words - 1, allocno_ = 0; i_ >= 0; i_--, allocno_ += (8 * 8)) { unsigned long long word_ = (unsigned long long) *p_++; for ((j) = allocno_; word_; word_ >>= 1, (j)++) { if (word_ & 1) {{ do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[j].hard_reg_conflicts), *scan_fp_ = (this_reg); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0); };} } } } while (0);



    }
}
# 1299 "../../../kgccfe/gnu/global.c"
void
     ...
     HARD_REG_SET forbidden_regs;
{
 ...
 find_reg (alloc_no, forbidden_regs, 1, 0, 1);
      ...
      if (reg_renumber[regno] >= 0)
 {
   ((((cfun->emit->x_regno_reg_rtx)[regno])->fld[0]).rtuint) = reg_renumber[regno];
     ...
     int regno;
{
  ...
  if (regno < 176)
    ...
    do { int i_; int allocno_; long long *p_ = (allocnos_live); for (i_ = allocno_row_words - 1, allocno_ = 0; i_ >= 0; i_--, allocno_ += (8 * 8)) { unsigned long long word_ = (unsigned long long) *p_++; for ((j) = allocno_; word_; word_ >>= 1, (j)++) { if (word_ & 1) {{ ((allocno[j].hard_reg_conflicts)[(regno) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8)))); };} } } } while (0);
...

    {
      ...
      do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[ialloc].hard_reg_conflicts), *scan_fp_ = (hard_regs_live); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
      for (j = allocno_row_words - 1; j >= 0; j--)
 {
# 1365 "../../../kgccfe/gnu/global.c"
  ...
  while (--len >= 0)
    {
      ...
      do { HARD_REG_ELT_TYPE *scan_tp_ = (allocno[num].hard_reg_conflicts), *scan_fp_ = (hard_regs_live); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
    }
}
...
mirror_conflicts ()
{
  ...
  int rwb = rw * (8 * 8);
  long long *p = conflicts;
  long long *q0 = conflicts, *q1, *q2;
      ...
      for (j = allocno_row_words - 1, q1 = q0; j >= 0; j--, q1 += rwb)
 {
   ...
   for (word = (unsigned long long) *p++, q2 = q1; word;
        word >>= 1, q2 += rw)
     {
       if (word & 1)
  *q2 |= mask;
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  if (setter && ((enum rtx_code) (setter)->code) != CLOBBER)
    set_preference (reg, (((setter)->fld[1]).rtx));
 ...
 {
   (allocnos_live[(unsigned) (reg_allocno[regno]) / (8 * 8)] |= ((long long) 1 << ((unsigned) (reg_allocno[regno]) % (8 * 8))));
   record_one_conflict (regno);
 }
    }
  ...
  if (regno < 176 && ! fixed_regs[regno])
    {
      int last = regno + mips_hard_regno_nregs (regno, ((enum machine_mode) (reg)->mode));
      while (regno < last)
 {
   record_one_conflict (regno);
   ((hard_regs_live)[(regno) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8))));
   regno++;
 }
    }
}
...
{
  int last = regno + mips_hard_regno_nregs (regno, mode);
  while (regno < last)
    {
      ((hard_regs_live)[(regno) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8))));
      regno++;
     ...
     rtx dest, src;
{
  ...
  if ((rtx_format[(int) (((enum rtx_code) (src)->code))])[0] == 'e')
    src = (((src)->fld[0]).rtx), copy = 0;




  if (((enum rtx_code) (src)->code) == REG)
    src_regno = (((src)->fld[0]).rtuint);
  else if (((enum rtx_code) (src)->code) == SUBREG && ((enum rtx_code) ((((src)->fld[0]).rtx))->code) == REG)
    {
      src_regno = ((((((src)->fld[0]).rtx))->fld[0]).rtuint);

      if (((((((src)->fld[0]).rtx))->fld[0]).rtuint) < 176)
 offset += subreg_regno_offset (((((((src)->fld[0]).rtx))->fld[0]).rtuint),
           ((enum machine_mode) ((((src)->fld[0]).rtx))->mode),
           (((src)->fld[1]).rtuint),
           ((enum machine_mode) (src)->mode));
      else
 offset += ((((src)->fld[1]).rtuint)
  ...
  if (((enum rtx_code) (dest)->code) == REG)
    dest_regno = (((dest)->fld[0]).rtuint);
  else if (((enum rtx_code) (dest)->code) == SUBREG && ((enum rtx_code) ((((dest)->fld[0]).rtx))->code) == REG)
    {
      dest_regno = ((((((dest)->fld[0]).rtx))->fld[0]).rtuint);

      if (((((((dest)->fld[0]).rtx))->fld[0]).rtuint) < 176)
 offset -= subreg_regno_offset (((((((dest)->fld[0]).rtx))->fld[0]).rtuint),
           ((enum machine_mode) ((((dest)->fld[0]).rtx))->mode),
           (((dest)->fld[1]).rtuint),
           ((enum machine_mode) (dest)->mode));
      else
 offset -= ((((dest)->fld[1]).rtuint)
     / ((target_flags & 0x00002000) ? 8 : 4));
    }
  else
    return;
  ...
  if (dest_regno < 176 && src_regno >= 176
 ...
 {
   if (copy)
     ((allocno[reg_allocno[src_regno]].hard_reg_copy_preferences)[(dest_regno) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((dest_regno) % ((unsigned) (8 * 8))));


   ((allocno[reg_allocno[src_regno]].hard_reg_preferences)[(dest_regno) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((dest_regno) % ((unsigned) (8 * 8))));

   for (i = dest_regno;
        i < dest_regno + mips_hard_regno_nregs (dest_regno, ((enum machine_mode) (dest)->mode));
        i++)
     ((allocno[reg_allocno[src_regno]].hard_reg_full_preferences)[(i) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))));
 }
    }

  if (src_regno < 176 && dest_regno >= 176
 ...
 {
   if (copy)
     ((allocno[reg_allocno[dest_regno]].hard_reg_copy_preferences)[(src_regno) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((src_regno) % ((unsigned) (8 * 8))));


   ((allocno[reg_allocno[dest_regno]].hard_reg_preferences)[(src_regno) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((src_regno) % ((unsigned) (8 * 8))));

   for (i = src_regno;
        i < src_regno + mips_hard_regno_nregs (src_regno, ((enum machine_mode) (src)->mode));
        i++)
     ((allocno[reg_allocno[dest_regno]].hard_reg_full_preferences)[(i) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))));
 }
    }
}
     ...
     rtx first;
{
      ...
      if (first == b->head)
 {
   ...
   do { bitmap_element *ptr_ = (b->global_live_at_start)->first; unsigned int indx_ = (0) / ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))); unsigned bit_num_ = (0) % (unsigned) (8 * 4); unsigned word_num_ = (0) / (unsigned) (8 * 4) % ((128 + (8 * 4) - 1) / (8 * 4)); while (ptr_ != 0 && ptr_->indx < indx_) ptr_ = ptr_->next; if (ptr_ != 0 && ptr_->indx != indx_) { bit_num_ = 0; word_num_ = 0; } for (; ptr_ != 0; ptr_ = ptr_->next) { for (; word_num_ < ((128 + (8 * 4) - 1) / (8 * 4)); word_num_++) { BITMAP_WORD word_ = ptr_->bits[word_num_]; if (word_ != 0) { for (; bit_num_ < (unsigned) (8 * 4); bit_num_++) { BITMAP_WORD mask_ = ((BITMAP_WORD) 1) << bit_num_; if ((word_ & mask_) != 0) { word_ &= ~ mask_; (i) = (ptr_->indx * ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))) + word_num_ * (unsigned) (8 * 4) + bit_num_); { if (i < 176 ? ! (!!((eliminable_regset)[(i) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8)))))) : reg_renumber[i] >= 0) bitmap_set_bit (live_relevant_regs, i); }; if (word_ == 0) break; } } } bit_num_ = 0; } word_num_ = 0; } } while (0);
   ...
   if (((rtx_class[(int) (((enum rtx_code) (first)->code))]) == 'i'))
     {
       ...
       for (link = (((first)->fld[8]).rtx); link; link = (((link)->fld[1]).rtx))
  if (((enum reg_note) ((enum machine_mode) (link)->mode)) == REG_DEAD
      && ((enum rtx_code) ((((link)->fld[0]).rtx))->code) == REG)
    reg_dies (((((((link)->fld[0]).rtx))->fld[0]).rtuint), ((enum machine_mode) ((((link)->fld[0]).rtx))->mode),
       c);
       ...
       note_stores ((((first)->fld[5]).rtx), reg_becomes_live,
      &c->dead_or_set);
     }
   else
     bitmap_copy (&c->live_throughout, live_relevant_regs);
 ...
 b = b->next_bb;
      ...
      if (b == (&entry_exit_blocks[1]))
 {
   for (first = (((first)->fld[2]).rtx) ; first; first = (((first)->fld[2]).rtx))
     if (((rtx_class[(int) (((enum rtx_code) (first)->code))]) == 'i')
  && ((enum rtx_code) ((((first)->fld[5]).rtx))->code) != USE
  && ! ((((enum rtx_code) ((((first)->fld[5]).rtx))->code) == ADDR_VEC
         || ((enum rtx_code) ((((first)->fld[5]).rtx))->code) == ADDR_DIFF_VEC)
        && prev_real_insn (first) != 0
        && ((enum rtx_code) (prev_real_insn (first))->code) == JUMP_INSN))
       fancy_abort ("../../../kgccfe/gnu/global.c", 1888, __FUNCTION__);
   break;
 }
    }
     ...
     FILE *file;
{
 ...
 if ((conflicts[(j) * allocno_row_words + (unsigned) (i) / (8 * 8)] & ((long long) 1 << ((unsigned) (i) % (8 * 8)))))
   fprintf (file, " %d", allocno[j].reg);
      for (j = 0; j < 176; j++)
 if ((!!((allocno[i].hard_reg_conflicts)[(j) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((j) % ((unsigned) (8 * 8)))))))
   fprintf (file, " %d", j);
      fprintf (file, "\n");

      has_preferences = 0;
      for (j = 0; j < 176; j++)
 if ((!!((allocno[i].hard_reg_preferences)[(j) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((j) % ((unsigned) (8 * 8)))))))
   has_preferences = 1;
