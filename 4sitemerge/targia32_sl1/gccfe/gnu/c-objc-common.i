...
# 28 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 29 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 30 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 31 "../../../kgccfe/gnu/c-objc-common.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 32 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 33 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 34 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 35 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 36 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 37 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 38 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 39 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 40 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 42 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 43 "../../../kgccfe/gnu/c-objc-common.c" 2
...
# 44 "../../../kgccfe/gnu/c-objc-common.c" 2

static _Bool c_tree_printer (output_buffer *, text_info *);
     ...
     tree fn;
{
  ...
  return (((fn)->decl.lang_specific)->base.declared_inline) && ((fn)->decl.external_flag);
}
     ...
     void *fn;
{
 ...
 default:
   break;
    ...
    case DECL_STMT:
      ...
      if (((enum tree_code) (((node)->exp.operands[0]))->common.code) == FUNCTION_DECL
   && ((((node)->exp.operands[0]))->decl.initial))
 return node;
      break;
 ...
 return node;
      ...
      if (((enum tree_code) (t)->common.code) == LABEL_DECL
   && ((t)->decl.context) && ((t)->decl.context) != fn)
 return node;
    ...
    case RECORD_TYPE:
    case UNION_TYPE:
# 154 "../../../kgccfe/gnu/c-objc-common.c"
      for (t = ((node)->type.values); t; t = ((t)->common.chain))
 if (variably_modified_type_p (((t)->common.type)))
   return node;
     ...
     tree *fnp;
{
  ...
  if (!(((fn)->decl.lang_specific)->base.declared_inline) && !(*targetm.binds_local_p) (fn))
    goto cannot_inline;
 ...
 goto cannot_inline;
    ...
    {
# 214 "../../../kgccfe/gnu/c-objc-common.c"
 ...
 (&((fn)->decl.saved_tree), inline_forbidden_p, fn))
    goto cannot_inline;
...
c_warn_unused_global_decl (decl)
     tree decl;
{
  if (((enum tree_code) (decl)->common.code) == FUNCTION_DECL && (((decl)->decl.lang_specific)->base.declared_inline))
    return 0;
     ...
     const char *filename;
{
  ...
  (&(global_dc)->buffer)->format_decoder = &c_tree_printer;
...
expand_deferred_fns ()
{
  ...
  int i;
# 317 "../../../kgccfe/gnu/c-objc-common.c"
  for (i = (((deferred_fns)->elements_used) - 1); i >= 0; i--)
     ...
     int method_type;
{
  ...
  tree void_list_node_1 = build_tree_list ((tree) ((void *)0), global_trees[TI_VOID_TYPE]);
  tree body;

  start_function (void_list_node_1,
    build_nt (CALL_EXPR, fnname,
       tree_cons ((tree) ((void *)0), (tree) ((void *)0), void_list_node_1),
       (tree) ((void *)0)),
    (tree) ((void *)0));
  store_parm_decls ();
     ...
     tree body;
{
  ...
  ((((((scope)->list.purpose)))->exp.operands[0])) = block;
  ((((((scope)->list.value)))->exp.operands[0])) = block;

  do { (((body))->exp.operands[0]) = ((body)->common.chain); ((body)->common.chain) = (tree) ((void *)0); (current_stmt_tree ()->x_last_stmt) = body; } while (0);
  ...
  if (static_ctors)
    {
      ...
      for (; static_ctors; static_ctors = ((static_ctors)->common.chain))
 c_expand_expr_stmt (build_function_call (((static_ctors)->list.value),
       (tree) ((void *)0)));
  ...
  if (static_dtors)
    {
      ...
      for (; static_dtors; static_dtors = ((static_dtors)->common.chain))
 c_expand_expr_stmt (build_function_call (((static_dtors)->list.value),
       (tree) ((void *)0)));
...

  {
    ...
    if (stream)
      {
 dump_node (getdecls (), flags & ~(1 << 1), stream);
 dump_end (TDI_all, stream);
      }
  }
}
# 434 "../../../kgccfe/gnu/c-objc-common.c"
static _Bool
c_tree_printer (buffer, text)
     output_buffer *buffer;
     text_info *text;
{
  tree t = __builtin_va_arg(*text->args_ptr,tree);
...
# 1 "../../../kgccfe/gnu/MIPS/gt-c-objc-common.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-c-objc-common.h"
const struct ggc_root_tab gt_ggc_r_gt_c_objc_common_h[] = {
  {
    &deferred_fns,
    1,
    sizeof (deferred_fns),
...
# 459 "../../../kgccfe/gnu/c-objc-common.c" 2
