...
# 36 "../../../kgccfe/gnu/tree-inline.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 37 "../../../kgccfe/gnu/tree-inline.c" 2
...
# 42 "../../../kgccfe/gnu/tree-inline.c" 2




# 1 "../../../kgccfe/gnu/c-common.h" 1
# 32 "../../../kgccfe/gnu/c-common.h"
...
static tree declare_return_variable (inline_data *, tree *);
...
static int inlinable_function_p (tree, inline_data *);
     ...
     inline_data *id;
{
  ...
  fn = ((id->fns)->data.tree[(id->fns)->elements_used - 1]);
 ...
 ((t)->decl.bit_field_flag) = 0;




      if (((t)->common.type) && ((enum tree_code) (((t)->common.type))->common.code) == ARRAY_TYPE
   && ((((t)->common.type))->type.values))
 {
   ((t)->common.type) = copy_node (((t)->common.type));
   ((((t)->common.type))->type.values)
     = copy_node (((((t)->common.type))->type.values));
   walk_tree (&((((((t)->common.type))->type.values))->type.maxval),
       copy_body_r, id, ((void *)0));
 }


      if (! ((t)->decl.name) && ((t)->common.type)
   && (*lang_hooks.tree_inlining.anon_aggr_type_p) (((t)->common.type)))
 {
   ...
   for (src = (((t))->decl.arguments); src;
        src = ((src)->common.chain))
     {
       tree member = remap_decl (((src)->list.value), id);

       if (((src)->list.purpose))
  fancy_abort ("../../../kgccfe/gnu/tree-inline.c", 203, __FUNCTION__);
       members = tree_cons (((void *)0), member, members);
     }
   (((t))->decl.arguments) = nreverse (members);
 }
...
remap_block (scope_stmt, decls, id)
     ...
     inline_data *id;
{
# 249 "../../../kgccfe/gnu/tree-inline.c"
  if (id->in_target_cleanup_p)
    {
      ((((scope_stmt))->exp.operands[0])) = (tree) ((void *)0);
      return;
    }


  if (((((scope_stmt))->common.lang_flag_0)) && ((((scope_stmt))->exp.operands[0])))
    {
      tree old_block;
      tree new_block;
      tree old_var;
      ...
      old_block = ((((scope_stmt))->exp.operands[0]));
      new_block = make_node (BLOCK);
      ((new_block)->common.used_flag) = ((old_block)->common.used_flag);
      ((new_block)->block.abstract_origin) = old_block;
      ((((scope_stmt))->exp.operands[0])) = new_block;


      for (old_var = decls ? decls : ((old_block)->block.vars);
    old_var;
    old_var = ((old_var)->common.chain))
 {
   tree new_var;
   ...
   if (!new_var || !(tree_code_type[(int) (((enum tree_code) (new_var)->common.code))] == 'd'))
     ;
   else
     {
       ((new_var)->common.chain) = ((new_block)->block.vars);
       ((new_block)->block.vars) = new_var;




       if (((new_var)->decl.sgi_u1.st))
        ((new_var)->decl.sgi_u1.st) = Create_ST_For_Tree (new_var);

     }
 }

      ((new_block)->block.vars) = nreverse (((new_block)->block.vars));
      fn = ((id->fns)->data.tree[0]);
      if (id->cloning_p)
      ...
      else
 {
  ...
  else if ((!(((((scope_stmt)))->common.lang_flag_0))) && ((((scope_stmt))->exp.operands[0])))
    {
      splay_tree_node n;


      n = splay_tree_lookup (id->decl_map,
        (splay_tree_key) ((((scope_stmt))->exp.operands[0])));
      if (! n)
 fancy_abort ("../../../kgccfe/gnu/tree-inline.c", 335, __FUNCTION__);
      ((((scope_stmt))->exp.operands[0])) = (tree) n->value;
    }
# 401 "../../../kgccfe/gnu/tree-inline.c"
}
     ...
     inline_data *id;
{
  ...
  block = ((((*tp))->exp.operands[0]));

  copy_tree_r (tp, walk_subtrees, ((void *)0));

  ((((*tp))->exp.operands[0])) = block;


  remap_block (*tp, (tree) ((void *)0), id);
}
     ...
     void *data;
{
  ...
  id = (inline_data *) data;
  fn = ((id->fns)->data.tree[(id->fns)->elements_used - 1]);
# 461 "../../../kgccfe/gnu/tree-inline.c"
  if (((enum tree_code) (*tp)->common.code) == RETURN_STMT && id->ret_label)
...

    {
      ...
      ((goto_stmt)->common.chain) = ((return_stmt)->common.chain);
      ((((goto_stmt))->common.lang_flag_0)) = 1;
# 484 "../../../kgccfe/gnu/tree-inline.c"
      if ((((return_stmt))->exp.operands[0]))
 {
   *tp = build_stmt (EXPR_STMT,
       (((return_stmt))->exp.operands[0]));
   (((*tp))->common.lang_flag_1) = 1;

   ((*tp)->common.chain) = goto_stmt;
 }
# 501 "../../../kgccfe/gnu/tree-inline.c"
      else
 *tp = goto_stmt;
    }
  ...
  else if ((*lang_hooks.tree_inlining.auto_var_in_fn_p) (*tp, fn))
    {
      ...
      if (! new_decl)
 fancy_abort ("../../../kgccfe/gnu/tree-inline.c", 515, __FUNCTION__);
    ...
    remap_save_expr (tp, id->decl_map, ((id->fns)->data.tree[0]),
       walk_subtrees);
  else if (((enum tree_code) (*tp)->common.code) == UNSAVE_EXPR)

    fancy_abort ("../../../kgccfe/gnu/tree-inline.c", 530, __FUNCTION__);



  else if (((enum tree_code) (*tp)->common.code) == SCOPE_STMT && !id->in_target_cleanup_p)
    copy_scope_stmt (tp, walk_subtrees, id);
# 562 "../../../kgccfe/gnu/tree-inline.c"
  else
    {


      if (((enum tree_code) (*tp)->common.code) == VAR_DECL && (tree_code_type[(int) (((enum tree_code) (*tp)->common.code))] == 'd') &&
          ((*tp)->decl.context) == fn && ((*tp)->common.static_flag))
        ((*tp)->decl.promote_static) = 1;
      ...
      if (((enum tree_code) (*tp)->common.code) == TARGET_EXPR && ((*tp)->exp.operands[3]))
 {
   ...
   ((*tp)->exp.operands[3]) = (tree) ((void *)0);
      ...
      else if (((enum tree_code) (*tp)->common.code) == MODIFY_EXPR
     ...
     (((*tp)->exp.operands[0]), fn)))
 {
   ...
   tree decl = ((*tp)->exp.operands[0]), value;
   splay_tree_node n;
   ...
   if (n)
     {
       ...
       if (((value)->common.constant_flag) || (((value)->common.readonly_flag) && (tree_code_type[(int) (((enum tree_code) (value)->common.code))] == 'd')))
  *tp = value;
     }
 }
    }
     ...
     inline_data *id;
{
  ...
  body = ((((id->fns)->data.tree[(id->fns)->elements_used - 1]))->decl.saved_tree);
...

{
  ...
  for (p = parms, a = args; p;
       a = a ? ((a)->common.chain) : a, p = ((p)->common.chain))
    {
      ...
      value = (*lang_hooks.tree_inlining.convert_parm_for_inlining)
       (p, a ? ((a)->list.value) : (tree) ((void *)0), fn);
   ...
   && value && !((value)->common.side_effects_flag))
 {

   value = fold ((tree_code_type[(int) (((enum tree_code) (value)->common.code))] == 'd') ? decl_constant_value (value) : value);
   ...
   if (((value)->common.constant_flag) || (((value)->common.readonly_flag) && (tree_code_type[(int) (((enum tree_code) (value)->common.code))] == 'd')))
     {
       ...
       if ((tree_code_type[(int) (((enum tree_code) (value)->common.code))] == 'd'))
  value = build1 (NOP_EXPR, ((value)->common.type), value);


       else if (((value)->common.type) != ((p)->common.type))
  value = fold (build1 (NOP_EXPR, ((p)->common.type), value));
     ...
     (splay_tree_value) value);
      ...
      var = copy_decl_for_inlining (p, fn, ((id->fns)->data.tree[0]));
 ...
 var_sub = build1 (INDIRECT_REF, ((p)->common.type), var);
      else
 var_sub = var;
    ...
    (splay_tree_value) var_sub);
      ...
      ((init_stmt)->common.chain) = init_stmts;
      init_stmts = init_stmt;
# 736 "../../../kgccfe/gnu/tree-inline.c"
      if (! ((((p)->common.type))->type.needs_constructing_flag))

 ((var)->decl.initial) = value;
      else
 {
# 750 "../../../kgccfe/gnu/tree-inline.c"
   ((var)->common.readonly_flag) = 0;


   init_stmt = build_stmt (EXPR_STMT,
      build (INIT_EXPR, ((p)->common.type),
      var, value));
      ...
      if (cleanup)
 {
   ...
   ((cleanup_stmt)->common.chain) = init_stmts;
   init_stmts = cleanup_stmt;
 }
# 789 "../../../kgccfe/gnu/tree-inline.c"
    }
  ...
  for (; a; a = ((a)->common.chain))
    {
      tree init_stmt;
      tree value = ((a)->list.value);

      if (! value || ! ((value)->common.side_effects_flag))
 continue;
...
{
  tree fn = ((id->fns)->data.tree[(id->fns)->elements_used - 1]);
  ...
  (result, fn, ((id->fns)->data.tree[0]), id->decl_map,
  ...
  if (((var)->common.type) == ((((fn)->common.type))->common.type))
    *use_stmt = build_stmt (EXPR_STMT, var);
  else
    *use_stmt = build_stmt (EXPR_STMT,
       build1 (NOP_EXPR, ((((fn)->common.type))->common.type),
        var));
  ((*use_stmt)->common.addressable_flag) = 1;



  if (need_return_decl)
    return build_stmt (DECL_STMT, var);
# 891 "../../../kgccfe/gnu/tree-inline.c"
  else
    return (tree) ((void *)0);
}
...
tree_inlinable_function_p (fn)
     tree fn;
{
  return inlinable_function_p (fn, ((void *)0));
}
...
find_alloca_call (exp)
     tree exp;
{
  return walk_tree_without_duplicates (&exp, find_alloca_call_1, ((void *)0));
}
     ...
     void *data __attribute__ ((__unused__));
{
  ...
  if (((enum tree_code) (exp)->common.code) == CALL_EXPR
      ...
      && (decl = ((((exp)->exp.operands[0]))->exp.operands[0]),
   ((enum tree_code) (decl)->common.code) == FUNCTION_DECL)
      && ((decl)->decl.built_in_class) == BUILT_IN_NORMAL
      && ((decl)->decl.u1.f) == BUILT_IN_LONGJMP)
    return decl;
...
find_builtin_longjmp_call (exp)
     tree exp;
{
  return walk_tree_without_duplicates (&exp, find_builtin_longjmp_call_1, ((void *)0));
}
     ...
     inline_data *id;
{
  int inlinable;
  int currfn_insns;
  int max_inline_insns_single = (compiler_params[(int) PARAM_MAX_INLINE_INSNS_SINGLE].value);
  ...
  if (((fn)->decl.inlined_function_flag))
    max_inline_insns_single = (compiler_params[(int) PARAM_MAX_INLINE_INSNS_AUTO].value);


  currfn_insns = ((fn)->decl.u1.i) * (10);
...
# 999 "../../../kgccfe/gnu/tree-inline.c"
  ...
  else if (find_builtin_longjmp_call (((fn)->decl.saved_tree)))
    ;




  else if (lookup_attribute ("always_inline", ((fn)->decl.attributes)) == ((void *)0)
    && find_alloca_call (((fn)->decl.saved_tree)))
    ;
  ...
  if (! (*lang_hooks.tree_inlining.disregard_inline_limits) (fn)
      && inlinable
      && currfn_insns > (compiler_params[(int) PARAM_MIN_INLINE_INSNS].value))
    {
      int sum_insns = (id ? id->inlined_stmts : 0) * (10)
       + currfn_insns;



      if (sum_insns > (compiler_params[(int) PARAM_MAX_INLINE_INSNS].value) * 128)
  inlinable = 0;




      else if (sum_insns > (compiler_params[(int) PARAM_MAX_INLINE_INSNS].value))
 {
   int max_curr = (compiler_params[(int) PARAM_MAX_INLINE_INSNS_SINGLE].value)
   - (sum_insns - (compiler_params[(int) PARAM_MAX_INLINE_INSNS].value)) / (compiler_params[(int) PARAM_MAX_INLINE_SLOPE].value);
  ...
  if (! inlinable || ((fn)->decl.uninlinable))
    return 0;
 ...
 if (((id->fns)->data.tree[i]) == fn)
   return 0;

      if (((fn)->decl.inlined_fns))
 {
   int j;
   tree inlined_fns = ((fn)->decl.inlined_fns);

   for (j = 0; j < ((inlined_fns)->vec.length); ++j)
     if (((inlined_fns)->vec.a[j]) == ((id->fns)->data.tree[0]))
       return 0;
 }
    }
     ...
     void *data;
{
  ...
  if (((enum tree_code) (*tp)->common.code) == TARGET_EXPR)
    {
      ...
      *walk_subtrees = 0;
      ...
      do { if ((id->target_exprs)->elements_used >= (id->target_exprs)->num_elements) (((id->target_exprs)) = varray_grow ((id->target_exprs), 2 * (id->target_exprs)->num_elements)); (id->target_exprs)->data.tree[(id->target_exprs)->elements_used++] = (*tp); } while (0);
      ...
      for (i = 0; i < len; ++i)
 {
   ...
   walk_tree (&((*tp)->exp.operands[i]), expand_call_inline, data,
       id->tree_pruner);
   if (i == 2)
     --id->in_target_cleanup_p;
 }
  ...
  else if (((enum tree_code) (t)->common.code) == EXPR_WITH_FILE_LOCATION)
    {

      *walk_subtrees = 0;

      push_srcloc (((char *)((((t))->exp.operands[1]))->identifier.id.str), (((t)->exp.complexity) >> 12));
      walk_tree (&(((t))->exp.operands[0]), expand_call_inline, data,
   id->tree_pruner);
...
# 1189 "../../../kgccfe/gnu/tree-inline.c"
  ...
  if (!inlinable_function_p (fn, id))
    {
      if (warn_inline && ((fn)->decl.inline_flag) && !((fn)->decl.inlined_function_flag)
   && !((fn)->decl.in_system_header_flag))
 {
  ...
  push_srcloc ((((fn)->decl.locus).file), (((fn)->decl.locus).line));
  ...
  expr = build1 (STMT_EXPR, ((((fn)->common.type))->common.type), make_node (COMPOUND_STMT));

  (((expr))->common.lang_flag_0) = 1;
  stmt = (((expr))->exp.operands[0]);
# 1241 "../../../kgccfe/gnu/tree-inline.c"
  st = id->decl_map;
  ...
  arg_inits = initialize_inlined_parameters (id, ((t)->exp.operands[1]), fn);
  ...
  (((stmt))->exp.operands[0]) = chainon ((((stmt))->exp.operands[0]), arg_inits);
# 1274 "../../../kgccfe/gnu/tree-inline.c"
  do { if ((id->fns)->elements_used >= (id->fns)->num_elements) (((id->fns)) = varray_grow ((id->fns), 2 * (id->fns)->num_elements)); (id->fns)->data.tree[(id->fns)->elements_used++] = (fn); } while (0);
 ...
 if (((id->inlined_fns)->data.tree[i]) == fn)
   break;
      if (i < 0)
 do { if ((id->inlined_fns)->elements_used >= (id->inlined_fns)->num_elements) (((id->inlined_fns)) = varray_grow ((id->inlined_fns), 2 * (id->inlined_fns)->num_elements)); (id->inlined_fns)->data.tree[(id->inlined_fns)->elements_used++] = (fn); } while (0);
    }



  id->ret_label = build_decl (LABEL_DECL, (tree) ((void *)0), (tree) ((void *)0));
  ((id->ret_label)->decl.context) = ((id->fns)->data.tree[0]);

  if (! ((fn)->decl.initial)
      || ((enum tree_code) (((fn)->decl.initial))->common.code) != BLOCK)
    fancy_abort ("../../../kgccfe/gnu/tree-inline.c", 1296, __FUNCTION__);





  scope_stmt = build_stmt (SCOPE_STMT, ((fn)->decl.initial));
  ((((scope_stmt))->common.lang_flag_0)) = 1;
  ((((scope_stmt))->common.lang_flag_3)) = 1;
  remap_block (scope_stmt, ((fn)->decl.arguments), id);
  ((scope_stmt)->common.chain) = (((stmt))->exp.operands[0]);
  (((stmt))->exp.operands[0]) = scope_stmt;



  if (((((scope_stmt))->exp.operands[0])))
    ((((((scope_stmt))->exp.operands[0])))->block.abstract_origin) = (((fn)->decl.abstract_origin) ? ((fn)->decl.abstract_origin) : (fn));


  (((stmt))->exp.operands[0])
    = chainon ((((stmt))->exp.operands[0]),
        declare_return_variable (id, &use_stmt));
# 1335 "../../../kgccfe/gnu/tree-inline.c"
  inlined_body = &(((stmt))->exp.operands[0]);
  while (*inlined_body)
    inlined_body = &((*inlined_body)->common.chain);
  *inlined_body = copy_body (id);
# 1356 "../../../kgccfe/gnu/tree-inline.c"
  (((stmt))->exp.operands[0])
    = chainon ((((stmt))->exp.operands[0]),
        build_stmt (LABEL_STMT, id->ret_label));
# 1371 "../../../kgccfe/gnu/tree-inline.c"
  (((stmt))->exp.operands[0]) = chainon ((((stmt))->exp.operands[0]), use_stmt);


  scope_stmt = build_stmt (SCOPE_STMT, ((fn)->decl.initial));
  ((((scope_stmt))->common.lang_flag_3)) = 1;
  remap_block (scope_stmt, (tree) ((void *)0), id);
  (((stmt))->exp.operands[0])
    = chainon ((((stmt))->exp.operands[0]), scope_stmt);
# 1395 "../../../kgccfe/gnu/tree-inline.c"
  ...
  chain = ((*tp)->common.chain);
  *tp = build_expr_wfl (expr, (((fn)->decl.locus).file), (((fn)->decl.locus).line),
           0);
  ...
  ((((id->fns)->data.tree[0]))->decl.u1.i) += ((fn)->decl.u1.i);

  id->inlined_stmts += ((fn)->decl.u1.i) - 1;


  expand_calls_inline (inlined_body, id);
  ((id->fns)->elements_used--);



  if (((id->fns)->elements_used) == id->first_inlined_fn)
    id->inlined_stmts = 0;
     ...
     tree fn;
{
  ...
  if (current_function_decl)
    {
      do { if ((id.fns)->elements_used >= (id.fns)->num_elements) (((id.fns)) = varray_grow ((id.fns), 2 * (id.fns)->num_elements)); (id.fns)->data.tree[(id.fns)->elements_used++] = (current_function_decl); } while (0);
  ...
  id.target_exprs = varray_init (32, VARRAY_DATA_TREE, "target_exprs");
  ...
  if (((fn)->decl.lang_specific))
    {
      tree ifn = make_tree_vec (((id.inlined_fns)->elements_used));

      if (((id.inlined_fns)->elements_used))
 memcpy (&((ifn)->vec.a[0]), &((id.inlined_fns)->data.tree[0]),
     ...
     void *arg_map;
{
  ...
  do { if ((id.fns)->elements_used >= (id.fns)->num_elements) (((id.fns)) = varray_grow ((id.fns), 2 * (id.fns)->num_elements)); (id.fns)->data.tree[(id.fns)->elements_used++] = (clone); } while (0);
  do { if ((id.fns)->elements_used >= (id.fns)->num_elements) (((id.fns)) = varray_grow ((id.fns), 2 * (id.fns)->num_elements)); (id.fns)->data.tree[(id.fns)->elements_used++] = (fn); } while (0);
  ...
  ((((clone)->decl.saved_tree))->common.chain) = copy_body (&id);
}
# 1554 "../../../kgccfe/gnu/tree-inline.c"
tree
...
# 1583 "../../../kgccfe/gnu/tree-inline.c"
 ...
 return (tree) ((void *)0);
  ...
  if (((tree_code_type[(int) (code)]) == '<' || (tree_code_type[(int) (code)]) == '1' || (tree_code_type[(int) (code)]) == '2' || (tree_code_type[(int) (code)]) == 'e')
      || tree_code_type[(int) (code)] == 'r'
      || tree_code_type[(int) (code)] == 's')
...

    {
      ...
      if (statement_code_p (code) && !((((*tp))->common.lang_flag_2)))
 lineno = ((((*tp))->exp.complexity));
      ...
      if (statement_code_p (code))
 {
   if (code == DECL_STMT
       && (((*tp))->exp.operands[0])
       && (tree_code_type[(int) (((enum tree_code) ((((*tp))->exp.operands[0]))->common.code))] == 'd'))
     {
       ...
       do { result = walk_tree (&((((((*tp))->exp.operands[0]))->decl.initial)), func, data, htab); if (result) return result; } while (0);
       do { result = walk_tree (&((((((*tp))->exp.operands[0]))->decl.size)), func, data, htab); if (result) return result; } while (0);
       do { result = walk_tree (&((((((*tp))->exp.operands[0]))->decl.size_unit)), func, data, htab); if (result) return result; } while (0);
     }
   ...
   do { tp = & (((*tp)->common.chain)); goto tail_recurse; } while (0);
    ...
    {
      do { tp = & (((*tp)->common.type)); goto tail_recurse; } while (0);
    }
  else if (tree_code_type[(int) (code)] == 't')
    {
      do { result = walk_tree (&(((*tp)->type.size)), func, data, htab); if (result) return result; } while (0);
      do { result = walk_tree (&(((*tp)->type.size_unit)), func, data, htab); if (result) return result; } while (0);
  ...
  switch (code)
    ...
    case TREE_LIST:
      do { result = walk_tree (&(((*tp)->list.value)), func, data, htab); if (result) return result; } while (0);
      do { tp = & (((*tp)->common.chain)); goto tail_recurse; } while (0);
      break;
 ...
 do { tp = & (((*tp)->vec.a[0])); goto tail_recurse; } while (0);
    ...
    case METHOD_TYPE:
      do { result = walk_tree (&(((*tp)->type.maxval)), func, data, htab); if (result) return result; } while (0);


    case FUNCTION_TYPE:
      do { result = walk_tree (&(((*tp)->common.type)), func, data, htab); if (result) return result; } while (0);
      {
 tree arg = ((*tp)->type.values);


 for (; arg; arg = ((arg)->common.chain))
   do { result = walk_tree (&(((arg)->list.value)), func, data, htab); if (result) return result; } while (0);
      }
      break;

    case ARRAY_TYPE:
      do { result = walk_tree (&(((*tp)->common.type)), func, data, htab); if (result) return result; } while (0);
      do { tp = & (((*tp)->type.values)); goto tail_recurse; } while (0);

    case INTEGER_TYPE:
      do { result = walk_tree (&(((*tp)->type.minval)), func, data, htab); if (result) return result; } while (0);
      do { tp = & (((*tp)->type.maxval)); goto tail_recurse; } while (0);

    case OFFSET_TYPE:
      do { result = walk_tree (&(((*tp)->common.type)), func, data, htab); if (result) return result; } while (0);
      do { tp = & (((*tp)->type.maxval)); goto tail_recurse; } while (0);
# 1790 "../../../kgccfe/gnu/tree-inline.c"
    default:
      fancy_abort ("../../../kgccfe/gnu/tree-inline.c", 1791, __FUNCTION__);
    }
     ...
     void *data __attribute__ ((__unused__));
{
 ...
 ((*tp)->common.chain) = chain;
      ...
      if (((enum tree_code) (*tp)->common.code) == SCOPE_STMT)
 ((((*tp))->exp.operands[0])) = (tree) ((void *)0);
  ...
  else if (tree_code_type[(int) (code)] == 't' && !variably_modified_type_p (*tp))
     ...
     int *walk_subtrees;
{
  ...
  if (!n)
    ...
    (splay_tree_value) global_trees[TI_ERROR_MARK]);
    }
  else
