...
# 34 "../../../kgccfe/gnu/ggc-common.c" 2
# 45 "../../../kgccfe/gnu/ggc-common.c"
 ...
 (*cb)(elt);
  ...
  for (ct = gt_ggc_cache_rtab; *ct; ct++)
    for (cti = *ct; cti->base != ((void *)0); cti++)
      if (*cti->base)
 htab_traverse (*cti->base, ggc_htab_delete, (void *) cti);
}
     ...
     ggc_statistics *stats;
{
  ...
  for (code = 0; code < ((int) LAST_AND_UNUSED_RTX_CODE); ++code)
    {
 ...
 fprintf (stream, "%-17s%10u%16ld%c %10.3f\n",
   ...
   ((unsigned long) ((ggc_stats->size_trees[code]) < 1024*10 ? (ggc_stats->size_trees[code]) : ((ggc_stats->size_trees[code]) < 1024*1024*10 ? (ggc_stats->size_trees[code]) / 1024 : (ggc_stats->size_trees[code]) / (1024*1024)))),
   ((ggc_stats->size_trees[code]) < 1024*10 ? ' ' : ((ggc_stats->size_trees[code]) < 1024*1024*10 ? 'k' : 'M')),
  ...
  fprintf (stream,
    ...
    ((unsigned long) ((ggc_stats->total_size_trees) < 1024*10 ? (ggc_stats->total_size_trees) : ((ggc_stats->total_size_trees) < 1024*1024*10 ? (ggc_stats->total_size_trees) / 1024 : (ggc_stats->total_size_trees) / (1024*1024)))),
    ((ggc_stats->total_size_trees) < 1024*10 ? ' ' : ((ggc_stats->total_size_trees) < 1024*1024*10 ? 'k' : 'M')));
 ...
 fprintf (stream, "%-17s%10u%16ld%c %10.3f\n",
   ...
   ((unsigned long) ((ggc_stats->size_rtxs[code]) < 1024*10 ? (ggc_stats->size_rtxs[code]) : ((ggc_stats->size_rtxs[code]) < 1024*1024*10 ? (ggc_stats->size_rtxs[code]) / 1024 : (ggc_stats->size_rtxs[code]) / (1024*1024)))),
   ((ggc_stats->size_rtxs[code]) < 1024*10 ? ' ' : ((ggc_stats->size_rtxs[code]) < 1024*1024*10 ? 'k' : 'M')),
  ...
  fprintf (stream,
    ...
    ((unsigned long) ((ggc_stats->total_size_rtxs) < 1024*10 ? (ggc_stats->total_size_rtxs) : ((ggc_stats->total_size_rtxs) < 1024*1024*10 ? (ggc_stats->total_size_rtxs) / 1024 : (ggc_stats->total_size_rtxs) / (1024*1024)))),
    ((ggc_stats->total_size_rtxs) < 1024*10 ? ' ' : ((ggc_stats->total_size_rtxs) < 1024*1024*10 ? 'k' : 'M')));
     ...
     double limit;
{
  ...
  if (getrlimit (__RLIMIT_RSS, &rlim) == 0
      && rlim.rlim_cur != (rlim_t) ((unsigned long int)(~0UL))
      && rlim.rlim_cur < limit)
    limit = rlim.rlim_cur;
