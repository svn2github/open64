...
# 29 "../../../kgccfe/gnu/langhooks.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 30 "../../../kgccfe/gnu/langhooks.c" 2
     ...
     tree decl;
{
  ...
  if (((enum tree_code) (decl)->common.code) == FUNCTION_DECL
   ...
   && (((decl)->common.static_flag)
    ...
    fancy_abort ("../../../kgccfe/gnu/langhooks.c", 175, __FUNCTION__);
}
...
{
  fancy_abort ("../../../kgccfe/gnu/langhooks.c", 199, __FUNCTION__);
}
     ...
     tree value __attribute__ ((__unused__)), type;
{
  ...
  fancy_abort ("../../../kgccfe/gnu/langhooks.c", 210, __FUNCTION__);
}
...
{
  fancy_abort ("../../../kgccfe/gnu/langhooks.c", 242, __FUNCTION__);
}
