...
# 90 "../../../kgccfe/gnu/dbxout.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 91 "../../../kgccfe/gnu/dbxout.c" 2
...
# 93 "../../../kgccfe/gnu/dbxout.c" 2
# 1 "../../../kgccfe/gnu/dbxout.h" 1
# 21 "../../../kgccfe/gnu/dbxout.h"
...
# 101 "../../../kgccfe/gnu/dbxout.c" 2
# 160 "../../../kgccfe/gnu/dbxout.c"
...
# 176 "../../../kgccfe/gnu/dbxout.c" 2
# 199 "../../../kgccfe/gnu/dbxout.c"
static FILE *asmfile;
...
static void print_octal (unsigned long long, int);
static void print_wide_int (long long);
...
dbxout_function_end ()
{
  ...
  sprintf ((lscope_label_name), "*%s%s%ld", ("$"), ("Lscope"), (long)(scope_labelno));
  fprintf (asmfile, "%s%s%d:\n", "$", "Lscope", scope_labelno);
  scope_labelno++;
  ...
  fprintf (asmfile, "%s\"\",%d,0,0,", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"), N_FUN);
  assemble_name (asmfile, lscope_label_name);
  putc_unlocked ('-', asmfile);
  assemble_name (asmfile, ((((((((current_function_decl)->decl.rtl ? (current_function_decl)->decl.rtl : (make_decl_rtl (current_function_decl, ((void *)0)), (current_function_decl)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtstr));
  fprintf (asmfile, "\n");
     ...
     const char *input_file_name;
{
      ...
      if (cwd)
 {
   ...
   fprintf (asmfile, "%s", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"));
...
# 475 "../../../kgccfe/gnu/dbxout.c"
  ...
  fprintf (asmfile, "%s\"%s\",%d,0,0,0\n",
    (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"), "gcc2_compiled.", N_OPT);
  ...
  next_file_number = 1;
# 514 "../../../kgccfe/gnu/dbxout.c"
  dbxout_symbol (((integer_types[itk_int])->type.name), 0);
  dbxout_symbol (((integer_types[itk_char])->type.name), 0);
     ...
     tree syms;
{
  if (syms)
    {
      dbxout_typedefs (((syms)->common.chain));
     ...
     unsigned int line __attribute__ ((__unused__));
{
  ...
  fprintf (asmfile, "%s%d,0,0,0\n", (((target_flags & 0x00000010)) ? "\t.stabn\t" : " #.stabn\t"), N_EINCL);
  ...
  if (filename && (lastfile == 0 || strcmp (filename, lastfile)))
    {
      ...
      sprintf ((ltext_label_name), "*%s%s%ld", ("$"), ("Ltext"), (long)(source_label_number));

      fprintf (file, "%s", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"));
     ...
     const char *filename;
{
  ...
  do { static int sym_lineno = 1; char temp[256]; sprintf ((temp), "*%s%s%ld", ("$"), ("LM"), (long)(sym_lineno)); fprintf (asmfile, "\t.stabn 68,0,%d,", lineno); assemble_name (asmfile, temp); putc_unlocked ('-', asmfile); assemble_name (asmfile, ((((((((current_function_decl)->decl.rtl ? (current_function_decl)->decl.rtl : (make_decl_rtl (current_function_decl, ((void *)0)), (current_function_decl)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtstr)); putc_unlocked ('\n', asmfile); fprintf (asmfile, "%s%s%d:\n", "$", "LM", sym_lineno); sym_lineno += 1; } while (0);
     ...
     tree decl;
{
  ...
  if (use_gnu_debug_info_extensions
      ...
      && ! ((target_flags & 0x00000008) && ! (target_flags & 0x00000010) && ! (target_flags & 0x00100000))
     ...
     tree type;
{
 ...
 value = '3';
    ...
    fancy_abort ("../../../kgccfe/gnu/dbxout.c", 754, __FUNCTION__);

  putc_unlocked (value, asmfile);
     ...
     tree type;
{
      ...
      else if (((enum tree_code) (tem)->common.code) != CONST_DECL)
 {
   ...
   if (tem != ((type)->type.values))
     do {if (current_sym_nchars > 1500) dbxout_continue ();} while (0);

   if (((tem)->decl.name))
     {
       fprintf (asmfile, "%s:", ((char *)(((tem)->decl.name))->identifier.id.str));
       ...
       if (((tem)->common.static_flag) && use_gnu_debug_info_extensions)
  {
    ...
    have_used_extensions = 1;
    fprintf (asmfile, ":%s;", ((char *)(name)->identifier.id.str));
     ...
     const char *debug_name;
{
  ...
  if (((enum tree_code) (((decl)->common.type))->common.code) == FUNCTION_TYPE)
    ...
    {
      tree firstarg = ((((((decl)->common.type))->type.values))->list.value);
 ...
 c2 = '.';
  ...
  (current_sym_nchars += (((decl_assembler_name (decl))->identifier.id.len) + 6 - (debug_name - ((char *)(decl_assembler_name (decl))->identifier.id.str))));
...
# 974 "../../../kgccfe/gnu/dbxout.c"
...

 {
   ...
   debug_name = ((char *)(decl_assembler_name (fndecl))->identifier.id.str);
...
# 1337 "../../../kgccfe/gnu/dbxout.c"
   ...
   if (((type)->type.string_flag))
     {
      ...
      putc_unlocked ('S', asmfile);
      (current_sym_nchars += (1));
      dbxout_type (((type)->type.values), 0);
      break;
      ...
      if (((type)->type.packed_flag) && use_gnu_debug_info_extensions)
 {
   ...
   break;
      ...
      if (((type)->type.string_flag) && use_gnu_debug_info_extensions)
 {
   have_used_extensions = 1;
   fprintf (asmfile, "@S;");
   (current_sym_nchars += (3));
 }
      tem = ((type)->type.values);
      if (tem == ((void *)0))
 {
   fprintf (asmfile, "ar");
   (current_sym_nchars += (2));
 ...
 if (((type)->type.binfo) != 0
     && ((enum tree_code) (((type)->type.binfo))->common.code) == TREE_VEC
     && ((((type)->type.binfo))->vec.a[4]) != 0)
   n_baseclasses = ((((((type)->type.binfo))->vec.a[4]))->vec.length);
 ...
 for (i = 0; i < n_baseclasses; i++)
   {
     tree child = (((((((type)->type.binfo)))->vec.a[4]))->vec.a[i]);

     if (use_gnu_debug_info_extensions)
       {
  have_used_extensions = 1;
  putc_unlocked (((child)->common.static_flag) ? '1' : '0', asmfile);
  putc_unlocked (((child)->common.public_flag) ? '2' : '0', asmfile);
  (current_sym_nchars += (2));
  if (((child)->common.static_flag) && strcmp (lang_hooks.name, "GNU C++") == 0)



    print_wide_int (tree_low_cst (((child)->vec.a[5]), 0)
      * 8);
  else
    print_wide_int (tree_low_cst ((((child))->vec.a[1]), 0)
      * 8);
  putc_unlocked (',', asmfile);
  (current_sym_nchars += (1));
   ...
   && ((type)->type.precision) != ((integer_types[itk_int])->type.precision))
 {
   ...
   (current_sym_nchars += (5));
      ...
      for (tem = ((type)->type.values); tem; tem = ((tem)->common.chain))
 {
   fprintf (asmfile, "%s:", ((char *)(((tem)->list.purpose))->identifier.id.str));
   (current_sym_nchars += (((((tem)->list.purpose))->identifier.id.len) + 1));
   if ((((((tem)->list.value))->int_cst.int_cst).high) == 0)
     print_wide_int ((((((tem)->list.value))->int_cst.int_cst).low));
   else if ((((((tem)->list.value))->int_cst.int_cst).high) == -1
     && (long long) (((((tem)->list.value))->int_cst.int_cst).low) < 0)
     print_wide_int ((((((tem)->list.value))->int_cst.int_cst).low));
   else
     print_int_cst_octal (((tem)->list.value));
 ...
 have_used_extensions = 1;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/dbxout.c", 1793, __FUNCTION__);
    }
}
...
print_int_cst_octal (c)
     tree c;
{
  unsigned long long high = (((c)->int_cst.int_cst).high);
  unsigned long long low = (((c)->int_cst.int_cst).low);
  int excess = (3 - ((8 * 8) % 3));
  ...
  if (width == (8 * 8) * 2)
    ...
    high &= (((long long) 1 << (width - (8 * 8))) - 1);
  else if (width == (8 * 8))
    high = 0;
  else
    high = 0, low &= (((long long) 1 << width) - 1);
  ...
  if (excess == 3)
    {
      print_octal (high, (8 * 8) / 3);
      print_octal (low, (8 * 8) / 3);
    }
  else
    {
      unsigned long long beg = high >> excess;
      unsigned long long middle
 = ((high & (((long long) 1 << excess) - 1)) << (3 - excess)
    | (low >> ((8 * 8) / 3 * 3)));
      unsigned long long end
 = low & (((unsigned long long) 1
    << ((8 * 8) / 3 * 3))
   - 1);

      fprintf (asmfile, "%o%01o", (int) beg, (int) middle);
      (current_sym_nchars += (2));
      print_octal (end, (8 * 8) / 3);
    }
}
     ...
     tree type;
{
  tree t;
  if (((type)->type.name) == 0)
    fancy_abort ("../../../kgccfe/gnu/dbxout.c", 1888, __FUNCTION__);
  if (((enum tree_code) (((type)->type.name))->common.code) == IDENTIFIER_NODE)
    ...
    fancy_abort ("../../../kgccfe/gnu/dbxout.c", 1898, __FUNCTION__);

  fprintf (asmfile, "%s", ((char *)(t)->identifier.id.str));
...
dbxout_symbol (decl, local)
     tree decl;
     int local __attribute__ ((__unused__));
{
 ...
 break;
      ...
      fprintf (asmfile, "%s\"%s:%c", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"),
        ((char *)(decl_assembler_name (decl))->identifier.id.str),
        ((decl)->common.public_flag) ? 'F' : 'f');
      result = 1;

      current_sym_code = N_FUN;
      current_sym_addr = (((((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)))->fld[0]).rtx);
 ...
 fprintf (asmfile, ",%s,%s",
   ((char *)(decl_assembler_name (decl))->identifier.id.str),
   ((char *)(((context)->decl.name))->identifier.id.str));

      dbxout_finish_symbol (decl);
      break;

    case TYPE_DECL:
# 2024 "../../../kgccfe/gnu/dbxout.c"
 ...
 if (((decl)->decl.name))
  ...
  fprintf (asmfile, "%s\"%s:T", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"),
  ...
  dbxout_class_name_qualifiers (decl);
     ...
     fprintf (asmfile, "%s:", ((char *)(((decl)->decl.name))->identifier.id.str));
 ...
 if (!did_output && ((enum tree_code) (type)->common.code) == ENUMERAL_TYPE)
   {
     ...
     fprintf (asmfile, "%s\" :T", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"));
     dbxout_type (type, 1);
     dbxout_finish_symbol ((tree) ((void *)0));
   }
 ...
 break;
    ...
    case PARM_DECL:
      ...
      fancy_abort ("../../../kgccfe/gnu/dbxout.c", 2166, __FUNCTION__);
       ...
       || ((enum tree_code) (((decl)->decl.context))->common.code) == BLOCK))
 {
   if (((decl)->common.public_flag) == 0)
     {
       ...
       const char *name = ((char *)(((decl)->decl.name))->identifier.id.str);

       if (((enum tree_code) (((decl)->common.type))->common.code) == INTEGER_TYPE
    || ((enum tree_code) (((decl)->common.type))->common.code) == ENUMERAL_TYPE)
  {
    long long ival = tree_low_cst (((decl)->decl.initial), 0);



    fprintf (asmfile, "%s\"%s:c=i", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"), name);

    fprintf (asmfile, "%lld", ival);
       ...
       else if (((enum tree_code) (((decl)->common.type))->common.code) == REAL_TYPE)
  {
      ...
      ((decl)->decl.rtl = (eliminate_regs (((decl)->decl.rtl ? (decl)->decl.rtl : (make_decl_rtl (decl, ((void *)0)), (decl)->decl.rtl)), 0, (rtx) 0)));
  ...
  if (((enum rtx_code) (home)->code) == SUBREG)
    {
      ...
      while (((enum rtx_code) (value)->code) == SUBREG)
 value = (((value)->fld[0]).rtx);
      if (((enum rtx_code) (value)->code) == REG)
 {
   if ((((value)->fld[0]).rtuint) >= 176)
     return 0;
 }
  ...
  if (((enum rtx_code) (home)->code) == REG)
    {
      regno = (((home)->fld[0]).rtuint);
      if (regno >= 176)
 return 0;
    }
# 2284 "../../../kgccfe/gnu/dbxout.c"
  if (((enum rtx_code) (home)->code) == MEM
      && ((enum rtx_code) ((((home)->fld[0]).rtx))->code) == SYMBOL_REF)
    {
 ...
 {
   current_sym_addr = (((home)->fld[0]).rtx);
    ...
    && (((current_sym_addr))->unchanging))
  {
    ...
    if (((enum rtx_code) (tmp)->code) == SYMBOL_REF
        || ((enum rtx_code) (tmp)->code) == LABEL_REF)
  ...
  else if (regno >= 0)
    {
      ...
      current_sym_value = mips_dbx_regno[ (regno) ];
    }
  else if (((enum rtx_code) (home)->code) == MEM
    && (((enum rtx_code) ((((home)->fld[0]).rtx))->code) == MEM
        || (((enum rtx_code) ((((home)->fld[0]).rtx))->code) == REG
     && ((((((home)->fld[0]).rtx))->fld[0]).rtuint) != ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)
     && ((((((home)->fld[0]).rtx))->fld[0]).rtuint) != (0 + 29)

     && ((((((home)->fld[0]).rtx))->fld[0]).rtuint) != 0
    ...
    {
      if (((enum rtx_code) ((((home)->fld[0]).rtx))->code) == REG)
 {
   letter = 'r';
   current_sym_code = N_RSYM;
   if (((((((home)->fld[0]).rtx))->fld[0]).rtuint) >= 176)
     return 0;
   current_sym_value = mips_dbx_regno[ (((((((home)->fld[0]).rtx))->fld[0]).rtuint)) ];
 }
      else
 {
   current_sym_code = N_LSYM;
   ...
   current_sym_value
     = mips_debugger_offset (((((((home)->fld[0]).rtx))->fld[0]).rtx), (long long) 0);
 }
    ...
    {
      current_sym_code = N_LSYM;
      current_sym_value = mips_debugger_offset ((((home)->fld[0]).rtx), (long long) 0);
    }
  else if (((enum rtx_code) (home)->code) == MEM
    && ((enum rtx_code) ((((home)->fld[0]).rtx))->code) == PLUS
    && ((enum rtx_code) (((((((home)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST_INT)
    {
      current_sym_code = N_LSYM;
    ...
    && ((enum rtx_code) ((((home)->fld[0]).rtx))->code) == CONST)
    {
# 2411 "../../../kgccfe/gnu/dbxout.c"
      current_sym_code = N_LCSYM;
      letter = 'V';
      current_sym_addr = ((((((home)->fld[0]).rtx))->fld[0]).rtx);
    }
 ...
 dbxout_symbol_location (decl, subtype, "$imag", (((home)->fld[0]).rtx));
      else
 dbxout_symbol_location (decl, subtype, "$real", (((home)->fld[0]).rtx));
      ...
      if (((target_flags & 0x00010000) != 0))
 dbxout_symbol_location (decl, subtype, "$real", (((home)->fld[1]).rtx));
      else
 dbxout_symbol_location (decl, subtype, "$imag", (((home)->fld[1]).rtx));
      return 1;
    }
  else
     ...
     int letter;
{
  ...
  if (name == 0)
    name = "(anon)";
  fprintf (asmfile, "%s\"%s%s:", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"), name,
    (suffix ? suffix : ""));
...
# 2559 "../../../kgccfe/gnu/dbxout.c"
void
dbxout_parms (parms)
     tree parms;
{
  for (; parms; parms = ((parms)->common.chain))
    if (((parms)->decl.name) && ((parms)->common.type) != global_trees[TI_ERROR_MARK])
      {
 ...
 ((parms)->decl.rtl = (eliminate_regs (((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)), 0, (rtx) 0)));
# 2581 "../../../kgccfe/gnu/dbxout.c"
 if ((((enum rtx_code) (((parms)->decl.u2.r))->code) == MEM))
   {
     rtx addr = (((((parms)->decl.u2.r))->fld[0]).rtx);
  ...
  && ((enum rtx_code) ((((addr)->fld[1]).rtx))->code) == CONST_INT)
       current_sym_value = ((((((addr)->fld[1]).rtx))->fld[0]).rtwint);
     else
       current_sym_value = 0;
  ...
  fprintf (asmfile, "%s\"%s:%c", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"),
    ((char *)(((parms)->decl.name))->identifier.id.str),
    'p');
       }
     else
       {
  current_sym_nchars = 8;
  fprintf (asmfile, "%s\"(anon):%c", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"),
    'p');
       }
# 2628 "../../../kgccfe/gnu/dbxout.c"
     dbxout_type (((parms)->decl.initial), 0);
     current_sym_value = mips_debugger_offset (addr, (long long) current_sym_value);
 ...
 else if (((enum rtx_code) (((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->code) == REG)
   {
     ...
     regparm_letter = 'P';
     current_sym_addr = 0;
# 2650 "../../../kgccfe/gnu/dbxout.c"
     if ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtuint) < 176)
       {
  ...
  parm_type = ((parms)->common.type);
     ...
     current_sym_value = mips_dbx_regno[ ((((best_rtl)->fld[0]).rtuint)) ];
  ...
  fprintf (asmfile, "%s\"(anon):%c", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"),
   ...
   && ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == REG
   && ((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtuint) != ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)
   && ((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtuint) != (0 + 29)

   && ((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtuint) != 0
   ...
   )
   {
     ...
     if (((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtuint) < 176)
       current_sym_value = ((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtuint);
     else
       current_sym_value = (((((parms)->decl.u2.r))->fld[0]).rtuint);
     ...
     if (((parms)->decl.name))
       {
  current_sym_nchars
    = 2 + strlen (((char *)(((parms)->decl.name))->identifier.id.str));
  ...
  fprintf (asmfile, "%s\"(anon):%c", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"),
   ...
   && ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == MEM)
   {
     ...
     const char *const decl_name = (((parms)->decl.name)
         ? ((char *)(((parms)->decl.name))->identifier.id.str)
         : "(anon)");
     if (((enum rtx_code) (((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtx))->code) == REG)
       current_sym_value = 0;
     else
       current_sym_value
         = ((((((((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtwint);
     current_sym_addr = 0;
     current_sym_code = N_PSYM;

     ;
     fprintf (asmfile, "%s\"%s:v", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"), decl_name);

     current_sym_value
       = mips_debugger_offset (((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtx), (long long) current_sym_value);

     dbxout_type (((parms)->common.type), 0);
     dbxout_finish_symbol (parms);
   }
 else if (((enum rtx_code) (((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->code) == MEM
   && (((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx) != (const_int_rtx[64])



   && ! (((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == CONST || ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == HIGH || ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == CONSTANT_P_RTX))
   {
     ...
     if (((enum rtx_code) ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->code) == REG)
       current_sym_value = 0;
     else
  current_sym_value
    = (((((((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtwint);
  ...
  && (mode_size[(int) (((((parms)->common.type))->type.mode))]) < ((target_flags & 0x00002000) ? 8 : 4))
       {
  current_sym_value +=
      (mode_size[(int) (((enum machine_mode) (((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->mode))])
      - (mode_size[(int) (((((parms)->common.type))->type.mode))]);
       }
  ...
  'p');
     ...
     current_sym_value
       = mips_debugger_offset ((((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtx), (long long) current_sym_value);
     ...
     tree parms;
{
 ...
 if (((enum rtx_code) (((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->code) == REG
     && (((((parms)->decl.rtl ? (parms)->decl.rtl : (make_decl_rtl (parms, ((void *)0)), (parms)->decl.rtl)))->fld[0]).rtuint) < 176)
     ...
     tree args;
{
  ...
  if (current_function_func_begin_label != (tree) ((void *)0))
    begin_label = ((char *)(current_function_func_begin_label)->identifier.id.str);
  else
    begin_label = ((((((((current_function_decl)->decl.rtl ? (current_function_decl)->decl.rtl : (make_decl_rtl (current_function_decl, ((void *)0)), (current_function_decl)->decl.rtl)))->fld[0]).rtx))->fld[0]).rtstr);
   ...
   if (depth > 0 && did_output)
     {
       ...
       sprintf ((buf), "*%s%s%ld", ("$"), ("LBB"), (long)(blocknum));
    ...
    while (decl)
      {
        ...
        fprintf (asmfile, "%s\"%s:C1\",%d,0,0,", (((target_flags & 0x00000010)) ? "\t.stabs\t" : " #.stabs\t"),
          ((char *)(((decl)->decl.name))->identifier.id.str), N_CATCH);
       ...
       fprintf (asmfile, "%s%d,0,0,", (((target_flags & 0x00000010)) ? "\t.stabn\t" : " #.stabn\t"), N_LBRAC);
       assemble_name (asmfile, buf);
...
# 2978 "../../../kgccfe/gnu/dbxout.c"
   ...
   if (depth > 0 && did_output)
     {
       char buf[20];
       sprintf ((buf), "*%s%s%ld", ("$"), ("LBE"), (long)(blocknum));



       fprintf (asmfile, "%s%d,0,0,", (((target_flags & 0x00000010)) ? "\t.stabn\t" : " #.stabn\t"), N_RBRAC);
       assemble_name (asmfile, buf);
