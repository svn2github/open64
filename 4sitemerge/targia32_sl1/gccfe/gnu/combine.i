...
# 83 "../../../kgccfe/gnu/combine.c" 2


# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 86 "../../../kgccfe/gnu/combine.c" 2
...
# 126 "../../../kgccfe/gnu/combine.c"
static int *uid_cuid;
static int max_uid_cuid;
# 148 "../../../kgccfe/gnu/combine.c"
     ...
     rtx *into, newval;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/combine.c", 456, __FUNCTION__);
   ...
   || (((enum rtx_code) (oldval)->code) == ZERO_EXTEND
       && ((enum rtx_code) ((((oldval)->fld[0]).rtx))->code) == CONST_INT))
 fancy_abort ("../../../kgccfe/gnu/combine.c", 468, __FUNCTION__);
     }
  ...
  if (dest == (global_rtl[GR_STACK_POINTER])
   ...
   && (find_reg_fusage (i3, USE, dest)
    ...
    && global_regs[(((dest)->fld[0]).rtuint)])))
      ...
      || 0
      || (succ && 0)
# 1104 "../../../kgccfe/gnu/combine.c"
      || (succ && ! all_adjacent
   && reg_used_between_p (dest, succ, i3))
# 1115 "../../../kgccfe/gnu/combine.c"
      || (! all_adjacent
  ...
  if (((enum rtx_code) (x)->code) == SET)
    {
      ...
      || ((enum rtx_code) (inner_dest)->code) == ZERO_EXTRACT)
 inner_dest = (((inner_dest)->fld[0]).rtx);
# 1373 "../../../kgccfe/gnu/combine.c"
      if ((inner_dest != dest
    && (reg_overlap_mentioned_p (i2dest, inner_dest)
        || (i1dest && reg_overlap_mentioned_p (i1dest, inner_dest))))
# 1387 "../../../kgccfe/gnu/combine.c"
...
# 1633 "../../../kgccfe/gnu/combine.c"
      ...
      if (subreg_lowpart_p (((((((i3)->fld[5]).rtx))->fld[0]).rtx)))
 {
   ...
   if ((8 * 8) < (8 * ((target_flags & 0x00002000) ? 8 : 4)))
     fancy_abort ("../../../kgccfe/gnu/combine.c", 1698, __FUNCTION__);
 ...
 fancy_abort ("../../../kgccfe/gnu/combine.c", 1721, __FUNCTION__);
      ...
      if (i == 1)
 {
  ...
  if (((enum rtx_code) (i2src)->code) == MULT
   ...
   && ((enum rtx_code) (((((((i3)->fld[5]).rtx))->fld[1]).rtx))->code) == MULT))
    have_mult = 1;
# 1860 "../../../kgccfe/gnu/combine.c"
  added_sets_2 = ! dead_or_set_p (i3, i2dest);

  added_sets_1
    = i1 && ! (i1_feeds_i3 ? dead_or_set_p (i3, i1dest)
        : (dead_or_set_p (i3, i1dest) || dead_or_set_p (i2, i1dest)));
# 1873 "../../../kgccfe/gnu/combine.c"
...
# 3562 "../../../kgccfe/gnu/combine.c"
         ...
         && ((enum rtx_code) (x)->code) == ZERO_EXTEND)
  {
    ...
    if (! x)
      fancy_abort ("../../../kgccfe/gnu/combine.c", 3594, __FUNCTION__);
  }
       else
...
# 4491 "../../../kgccfe/gnu/combine.c"
 ...
 if (((enum rtx_code) (op1)->code) != PARALLEL)
   fancy_abort ("../../../kgccfe/gnu/combine.c", 4703, __FUNCTION__);
...
# 5597 "../../../kgccfe/gnu/combine.c"
 ...
 return reversed;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/combine.c", 5700, __FUNCTION__);
    }

  return x;
}
# 5719 "../../../kgccfe/gnu/combine.c"
static rtx
     ...
     rtx x;
{
  ...
  switch (((enum rtx_code) (x)->code))
    ...
    case ZERO_EXTEND:
      unsignedp = 1;
    case SIGN_EXTEND:
# 5741 "../../../kgccfe/gnu/combine.c"
      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == CONST_INT)
 return x;
# 5753 "../../../kgccfe/gnu/combine.c"
...
# 6039 "../../../kgccfe/gnu/combine.c"
    }

  return x;
}
# 6071 "../../../kgccfe/gnu/combine.c"
static rtx
     ...
     unsigned long long known_ret;
{
  ...
  if (mode_width > (8 * 8))
    ...
    return nonzero;
# 8257 "../../../kgccfe/gnu/combine.c"
  code = ((enum rtx_code) (x)->code);
  switch (code)
    {
    case REG:
# 8273 "../../../kgccfe/gnu/combine.c"
...
# 8393 "../../../kgccfe/gnu/combine.c"
 ...
 switch (code)
   ...
   case UMOD:
     ...
     break;
   default:
     fancy_abort ("../../../kgccfe/gnu/combine.c", 8517, __FUNCTION__);
   }
     ...
     rtx elim_i2, elim_i1;
{
 ...
 case REG_NON_LOCAL_GOTO:
   if (((enum rtx_code) (i3)->code) == JUMP_INSN)
     ...
     fancy_abort ("../../../kgccfe/gnu/combine.c", 12546, __FUNCTION__);
   break;
 ...
 case REG_EH_REGION:
  ...
  place = i2;
     ...
     fancy_abort ("../../../kgccfe/gnu/combine.c", 12566, __FUNCTION__);
   break;
 ...
 case REG_SETJMP:
   ...
   if (((enum rtx_code) (i3)->code) == CALL_INSN)
     ...
     fancy_abort ("../../../kgccfe/gnu/combine.c", 12579, __FUNCTION__);
   break;

 case REG_UNUSED:
# 12600 "../../../kgccfe/gnu/combine.c"
...
# 12638 "../../../kgccfe/gnu/combine.c"
 ...
 case REG_LABEL:
  ...
  fancy_abort ("../../../kgccfe/gnu/combine.c", 12687, __FUNCTION__);
  ...
  fancy_abort ("../../../kgccfe/gnu/combine.c", 12695, __FUNCTION__);
...
# 12967 "../../../kgccfe/gnu/combine.c"
 ...
 default:
   ...
   fancy_abort ("../../../kgccfe/gnu/combine.c", 13042, __FUNCTION__);
 }
     ...
     rtx insn;
{
  ...
  if ((((insn)->fld[0]).rtint) > max_uid_cuid)
    fancy_abort ("../../../kgccfe/gnu/combine.c", 13172, __FUNCTION__);
