...
# 35 "../../../kgccfe/gnu/timevar.c" 2
# 115 "../../../kgccfe/gnu/timevar.c"
static float ticks_to_msec;
# 124 "../../../kgccfe/gnu/timevar.c"
...
# 127 "../../../kgccfe/gnu/timevar.c" 2
# 135 "../../../kgccfe/gnu/timevar.c"
struct timevar_def
{
...
static void timevar_accumulate
  (struct timevar_time_def *, struct timevar_time_def *, struct timevar_time_def *);
...
timevars[TV_TO_SSA].name = "convert to SSA";
timevars[TV_SSA_CCP].name = "SSA CCP";
timevars[TV_SSA_DCE].name = "SSA aggressive DCE";
timevars[TV_FROM_SSA].name = "convert from SSA";
timevars[TV_FINAL].name = "final";
timevars[TV_SYMOUT].name = "symout";


timevars[TV_REST_OF_COMPILATION].name = "rest of compilation";
# 252 "../../../kgccfe/gnu/timevar.c" 2



  ticks_to_msec = (1 / (float)sysconf (_SC_CLK_TCK));




}
# 269 "../../../kgccfe/gnu/timevar.c"
void
     ...
     timevar_id_t timevar;
{
  ...
  if (tv->standalone)
    fancy_abort ("../../../kgccfe/gnu/timevar.c", 285, __FUNCTION__);
  ...
  if (&timevars[timevar] != stack->timevar)
    {
      ...
      fancy_abort ("../../../kgccfe/gnu/timevar.c", 336, __FUNCTION__);
    }
     ...
     timevar_id_t timevar;
{
  ...
  if (tv->standalone)
    fancy_abort ("../../../kgccfe/gnu/timevar.c", 377, __FUNCTION__);
  tv->standalone = 1;
     ...
     timevar_id_t timevar;
{
  ...
  if (!tv->standalone)
    fancy_abort ("../../../kgccfe/gnu/timevar.c", 398, __FUNCTION__);
