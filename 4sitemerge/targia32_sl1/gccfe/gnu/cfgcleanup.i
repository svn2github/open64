...
# 41 "../../../kgccfe/gnu/cfgcleanup.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 42 "../../../kgccfe/gnu/cfgcleanup.c" 2
...
# 68 "../../../kgccfe/gnu/cfgcleanup.c"
static _Bool try_crossjump_to_edge (int, edge, edge);
static _Bool try_crossjump_bb (int, basic_block);
static _Bool outgoing_edges_match (int, basic_block, basic_block);

static int flow_find_cross_jump (int, basic_block, basic_block, rtx *, rtx *);

static _Bool insns_match_p (int, rtx, rtx);

static _Bool label_is_jump_target_p (rtx, rtx);
static _Bool tail_recursion_label_p (rtx);
static void merge_blocks_move_predecessor_nojumps (basic_block, basic_block);

static void merge_blocks_move_successor_nojumps (basic_block, basic_block);

static _Bool merge_blocks (edge,basic_block,basic_block, int);

static _Bool try_optimize_cfg (int);
static _Bool try_simplify_condjump (basic_block);
static _Bool try_forward_edges (int, basic_block);
static edge thread_jump (int, edge, basic_block);
static _Bool mark_effect (rtx, bitmap);
     ...
     basic_block cbranch_block;
{
  ...
  if (jump_block->pred->pred_next
      || jump_block->next_bb == (&entry_exit_blocks[1])
  ...
  if (rtl_dump_file)
    fprintf (rtl_dump_file, "Simplifying condjump %i around jump %i\n",
      (((cbranch_insn)->fld[0]).rtint), (((jump_block->end)->fld[0]).rtint));
  ...
  for (insn = jump_block->head; insn != (((jump_block->end)->fld[2]).rtx);
       insn = next)
    {
      next = (((insn)->fld[2]).rtx);
     ...
     regset nonequal;
{
  ...
  switch (((enum rtx_code) (exp)->code))
    ...
    case CLOBBER:
      if ((((enum rtx_code) ((((exp)->fld[0]).rtx))->code) == REG))
 {
   dest = (((exp)->fld[0]).rtx);
   ...
   if (regno < 176)
     {
       int n = mips_hard_regno_nregs (regno, ((enum machine_mode) (dest)->mode));
       while (--n > 0)
  bitmap_clear_bit (nonequal, regno + n);
    ...
    case SET:
      if (rtx_equal_for_cselib_p ((((exp)->fld[0]).rtx), (((exp)->fld[1]).rtx)))
 return 0;
      dest = (((exp)->fld[0]).rtx);
     ...
     basic_block b;
{
  ...
  set2 = pc_set (b->end);
  if (((e->flags & 1) != 0)
      != (((((((set1)->fld[1]).rtx))->fld[1]).rtx) == (global_rtl[GR_PC])))
    reverse1 = 1;

  cond1 = ((((((set1)->fld[1]).rtx))->fld[0]).rtx);
  cond2 = ((((((set2)->fld[1]).rtx))->fld[0]).rtx);
  if (reverse1)
  ...
  if (!rtx_equal_p ((((cond1)->fld[0]).rtx), (((cond2)->fld[0]).rtx))
      || !rtx_equal_p ((((cond1)->fld[1]).rtx), (((cond2)->fld[1]).rtx)))
    return ((void *)0);



  for (insn = (((b->head)->fld[2]).rtx); insn != (((b->end)->fld[2]).rtx);
       insn = (((insn)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && side_effects_p ((((insn)->fld[5]).rtx)))
      {
 (b)->aux = (void *) (long) ((enum bb_flags) (b)->aux | (BB_NONTHREADABLE_BLOCK));
 return ((void *)0);
      }
  ...
  for (insn = (((e->src->head)->fld[2]).rtx); insn != (((e->src->end)->fld[2]).rtx);
       insn = (((insn)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
      cselib_process_insn (insn);

  nonequal = bitmap_initialize ((bitmap) xmalloc (sizeof (bitmap_head)), 1);
  ...
  for (insn = (((b->head)->fld[2]).rtx); insn != (((b->end)->fld[2]).rtx) && !failed;
       insn = (((insn)->fld[2]).rtx))
    {
      if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
 {
  ...
  failed |= mark_effect ((((((pat)->fld[0]).rtvec))->elem[i]), nonequal);
     }
   else
  ...
  if ((comparison_dominates_p (code1, code2) != 0)
      != (((((((set2)->fld[1]).rtx))->fld[1]).rtx) == (global_rtl[GR_PC])))
     ...
     int mode;
{
      ...
      while (counter < n_basic_blocks)
 {
   ...
   _Bool new_target_threaded = 0;

   if (((enum bb_flags) (target)->aux & BB_FORWARDER_BLOCK)
       && target->succ->dest != (&entry_exit_blocks[1]))
     {
       ...
       if (t)
  {
        ...
        if (i < nthreaded_edges)
   {
    ...
    if (nthreaded_edges >= n_basic_blocks)
      fancy_abort ("../../../kgccfe/gnu/cfgcleanup.c", 508, __FUNCTION__);
  ...
  insn = (((insn)->fld[2]).rtx);
       ...
       for (; insn && ((enum rtx_code) (insn)->code) != CODE_LABEL && !((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i');
     insn = (((insn)->fld[2]).rtx))
  if (((enum rtx_code) (insn)->code) == NOTE
      ...
      else
 {
   ...
   if (threaded && target != (&entry_exit_blocks[1]))
     {
       ...
       if (first->succ->succ_next)
  {
    ...
    if (n >= nthreaded_edges)
      fancy_abort ("../../../kgccfe/gnu/cfgcleanup.c", 614, __FUNCTION__);
    t = threaded_edges [n++];
    if (t->src != first)
      fancy_abort ("../../../kgccfe/gnu/cfgcleanup.c", 617, __FUNCTION__);
    if (first->frequency)
     ...
     rtx label, jump_insn;
{
  ...
  if (tmp != (rtx) 0
      ...
      && (tmp = (((tmp)->fld[5]).rtx),
   ((enum rtx_code) (tmp)->code) == ADDR_VEC
   || ((enum rtx_code) (tmp)->code) == ADDR_DIFF_VEC))
    {
      rtvec vec = (((tmp)->fld[((enum rtx_code) (tmp)->code) == ADDR_DIFF_VEC]).rtvec);
      int i, veclen = ((vec)->num_elem);

      for (i = 0; i < veclen; ++i)
 if ((((((vec)->elem[i]))->fld[0]).rtx) == label)
   return 1;
    }
     ...
     rtx label;
{
  ...
  for (x = tail_recursion_label_list; x; x = (((x)->fld[1]).rtx))
    if (label == (((x)->fld[0]).rtx))
      return 1;
     ...
     basic_block a, b;
{
  ...
  if (((enum rtx_code) (barrier)->code) != BARRIER)
    fancy_abort ("../../../kgccfe/gnu/cfgcleanup.c", 724, __FUNCTION__);
  delete_insn (barrier);
# 734 "../../../kgccfe/gnu/cfgcleanup.c"
  if (squeeze_notes (&a->head, &a->end))
    fancy_abort ("../../../kgccfe/gnu/cfgcleanup.c", 735, __FUNCTION__);


  if (a->end != (((b->head)->fld[1]).rtx))
    reorder_insns_nobb (a->head, a->end, (((b->head)->fld[1]).rtx));
  a->flags |= 1;
     ...
     basic_block a, b;
{
  ...
  real_b_end = b->end;
  barrier = (((b->end)->fld[2]).rtx);


  if (barrier
      && ((enum rtx_code) (barrier)->code) == CODE_LABEL
      && (((barrier)->fld[2]).rtx)
      && ((enum rtx_code) ((((barrier)->fld[2]).rtx))->code) == JUMP_INSN
      && (((enum rtx_code) (((((((barrier)->fld[2]).rtx))->fld[5]).rtx))->code) == ADDR_VEC
   || ((enum rtx_code) (((((((barrier)->fld[2]).rtx))->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
    {


      b->end = (((barrier)->fld[2]).rtx);
      barrier = (((b->end)->fld[2]).rtx);
    }
  ...
  if (barrier && ((enum rtx_code) (barrier)->code) == BARRIER)
    delete_insn (barrier);
# 793 "../../../kgccfe/gnu/cfgcleanup.c"
  if (squeeze_notes (&b->head, &b->end))
    fancy_abort ("../../../kgccfe/gnu/cfgcleanup.c", 794, __FUNCTION__);
     ...
     int mode;
{
  ...
  if ((mode & 8)
      && ((enum rtx_code) (c->head)->code) == CODE_LABEL
 ...
 fprintf (rtl_dump_file, "Merged %d and %d without moving.\n",
   b_index, c_index);
  ...
  else if (mode & 1)
    {
      ...
      _Bool c_has_outgoing_fallthru;
      _Bool b_has_incoming_fallthru;
      ...
      if (b_has_incoming_fallthru)
 {
   ...
   if (b_fallthru_edge->src == (&entry_exit_blocks[0]))
     return 0;
     ...
     rtx i1, i2;
{
  ...
  if (((enum rtx_code) (p1)->code) != ((enum rtx_code) (p2)->code))
    return 0;
# 936 "../../../kgccfe/gnu/cfgcleanup.c"
  if (((enum rtx_code) (i1)->code) == CALL_INSN
      && (!rtx_equal_p ((((i1)->fld[9]).rtx),
          (((i2)->fld[9]).rtx))
   || (((i1))->jump) != (((i2))->jump)))
    return 0;
# 976 "../../../kgccfe/gnu/cfgcleanup.c"
  if (reload_completed
   ...
   && (! reload_completed
       || ((((enum rtx_code) ((((equiv1)->fld[0]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((equiv1)->fld[0]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((equiv1)->fld[0]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((equiv1)->fld[0]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) ((((equiv1)->fld[0]).rtx))->code) == CONST || ((enum rtx_code) ((((equiv1)->fld[0]).rtx))->code) == HIGH || ((enum rtx_code) ((((equiv1)->fld[0]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) ((((equiv1)->fld[0]).rtx))->code) == CONSTANT_P_RTX)
    && rtx_equal_p ((((equiv1)->fld[0]).rtx), (((equiv2)->fld[0]).rtx)))))
 {
   rtx s1 = (((rtx_class[(int) (((enum rtx_code) (i1)->code))]) == 'i') ? (((enum rtx_code) ((((i1)->fld[5]).rtx))->code) == SET ? (((i1)->fld[5]).rtx) : single_set_2 (i1, (((i1)->fld[5]).rtx))) : (rtx) 0);
   rtx s2 = (((rtx_class[(int) (((enum rtx_code) (i2)->code))]) == 'i') ? (((enum rtx_code) ((((i2)->fld[5]).rtx))->code) == SET ? (((i2)->fld[5]).rtx) : single_set_2 (i2, (((i2)->fld[5]).rtx))) : (rtx) 0);
   if (s1 != 0 && s2 != 0
       && rtx_renumbered_equal_p ((((s1)->fld[0]).rtx), (((s2)->fld[0]).rtx)))
     {
       validate_change (i1, &(((s1)->fld[1]).rtx), (((equiv1)->fld[0]).rtx), 1);
       validate_change (i2, &(((s2)->fld[1]).rtx), (((equiv2)->fld[0]).rtx), 1);
     ...
     rtx *f1, *f2;
{
  ...
  if (onlyjump_p (i1)
      || (returnjump_p (i1) && !side_effects_p ((((i1)->fld[5]).rtx))))
    {
      last1 = i1;
      i1 = (((i1)->fld[1]).rtx);
    }
  ...
  i2 = bb2->end;
  if (onlyjump_p (i2)
      || (returnjump_p (i2) && !side_effects_p ((((i2)->fld[5]).rtx))))
    {
      last2 = i2;
  ...
  while (1)
    {
      ...
      while (!((rtx_class[(int) (((enum rtx_code) (i1)->code))]) == 'i') && i1 != bb1->head)
 i1 = (((i1)->fld[1]).rtx);

      while (!((rtx_class[(int) (((enum rtx_code) (i2)->code))]) == 'i') && i2 != bb2->head)
 i2 = (((i2)->fld[1]).rtx);
 ...
 break;
      ...
      if (((rtx_class[(int) (((enum rtx_code) (i1)->code))]) == 'i'))
 {
...
# 1103 "../../../kgccfe/gnu/cfgcleanup.c"
  if (ninsns)
    {
      while (last1 != bb1->head && !((rtx_class[(int) (((enum rtx_code) ((((last1)->fld[1]).rtx))->code))]) == 'i'))
 last1 = (((last1)->fld[1]).rtx);

      if (last1 != bb1->head && ((enum rtx_code) ((((last1)->fld[1]).rtx))->code) == CODE_LABEL)
 last1 = (((last1)->fld[1]).rtx);

      while (last2 != bb2->head && !((rtx_class[(int) (((enum rtx_code) ((((last2)->fld[1]).rtx))->code))]) == 'i'))
 last2 = (((last2)->fld[1]).rtx);

      if (last2 != bb2->head && ((enum rtx_code) ((((last2)->fld[1]).rtx))->code) == CODE_LABEL)
 last2 = (((last2)->fld[1]).rtx);
     ...
     basic_block bb2;
{
  ...
  if (bb1->succ && !bb1->succ->succ_next
      ...
      && (((enum rtx_code) (bb1->end)->code) != JUMP_INSN || simplejump_p (bb1->end)))
    return (bb2->succ && !bb2->succ->succ_next
     && (bb2->succ->flags & ((2 | 4 | 8) | 16)) == 0
     && (((enum rtx_code) (bb2->end)->code) != JUMP_INSN || simplejump_p (bb2->end)));
...
# 1177 "../../../kgccfe/gnu/cfgcleanup.c"
 ...
 return 0;
      ...
      set1 = pc_set (bb1->end);
      set2 = pc_set (bb2->end);
      if ((((((((set1)->fld[1]).rtx))->fld[1]).rtx) == (global_rtl[GR_PC]))
   != (((((((set2)->fld[1]).rtx))->fld[1]).rtx) == (global_rtl[GR_PC])))
 reverse = !reverse;
 ...
 return 0;
      ...
      match = ((code1 == code2
  && rtx_renumbered_equal_p ((((cond1)->fld[0]).rtx), (((cond2)->fld[0]).rtx))
  && rtx_renumbered_equal_p ((((cond1)->fld[1]).rtx), (((cond2)->fld[1]).rtx)))
        || (code1 == swap_condition (code2)
     && rtx_renumbered_equal_p ((((cond1)->fld[1]).rtx),
           (((cond2)->fld[0]).rtx))
     && rtx_renumbered_equal_p ((((cond1)->fld[0]).rtx),
           (((cond2)->fld[1]).rtx))));
...
# 1281 "../../../kgccfe/gnu/cfgcleanup.c"
 ...
 return 0;
...

  {
    ...
    if (n1 && (!n2 || (((n1)->fld[0]).rtx) != (((n2)->fld[0]).rtx)))
      return 0;
  }
     ...
     edge e1, e2;
{
  ...
  if (src1 == (&entry_exit_blocks[0]) || src2 == (&entry_exit_blocks[0]))
    return 0;
  if (src1 == src2)
    return 0;
 ...
 fprintf (rtl_dump_file, "Splitting bb %i before %i insns\n",
   src2->index, nmatch);
      redirect_to = split_block (src2, (((newpos2)->fld[1]).rtx))->dest;
    }
 ...
 s->probability
  ...
  if (((enum rtx_code) (newpos1)->code) == CODE_LABEL)
    newpos1 = (((newpos1)->fld[2]).rtx);

  if (((enum rtx_code) (newpos1)->code) == NOTE)
    newpos1 = (((newpos1)->fld[2]).rtx);

  redirect_from = split_block (src1, (((newpos1)->fld[1]).rtx))->src;
     ...
     basic_block bb;
{
  ...
  fallthru = ((void *)0);
  max = (compiler_params[(int) PARAM_MAX_CROSSJUMP_EDGES].value);
     ...
     int mode;
{
      ...
      do
 {
   ...
   for (b = (&entry_exit_blocks[0])->next_bb; b != (&entry_exit_blocks[1]);)
     {
       basic_block c;
       edge s;
       _Bool changed_here = 0;
       ...
       while (b->pred == ((void *)0))
  {
    ...
    && (b->pred->flags & 1)
    && !(b->pred->flags & (2 | 4 | 8))
    && ((enum rtx_code) (b->head)->code) == CODE_LABEL
    && (!(mode & 8)
    ...
    && (b->pred->src == (&entry_exit_blocks[0])
        || ((enum rtx_code) (b->pred->src->end)->code) != JUMP_INSN
        || ! label_is_jump_target_p (b->head,
         b->pred->src->end)))
  {
    rtx label = b->head;

    b->head = (((b->head)->fld[2]).rtx);
    ...
    && n_basic_blocks > 1)
  {
    ...
    c = b->prev_bb == (&entry_exit_blocks[0]) ? b->next_bb : b->prev_bb;
    ...
    b = c;
       ...
       while ((s = b->succ) != ((void *)0)
       && s->succ_next == ((void *)0)
       && !(s->flags & (2 | 4 | 8))
       && (c = s->dest) != (&entry_exit_blocks[1])
  ...
  changed_here = 1;
       ...
       if ((mode & 1) && try_simplify_condjump (b))
  changed_here = 1;
       ...
       if (b->succ
    && ! b->succ->succ_next
    && b->succ->dest != (&entry_exit_blocks[1])
    && onlyjump_p (b->end)
  ...
  changed = 1;
   ...
   if ((mode & 2)
       && try_crossjump_bb (mode, (&entry_exit_blocks[1])))
     changed = 1;
...
delete_unreachable_blocks ()
{
  ...
  for (b = (&entry_exit_blocks[0])->next_bb; b != (&entry_exit_blocks[1]); b = next_bb)
    {
      next_bb = b->next_bb;
