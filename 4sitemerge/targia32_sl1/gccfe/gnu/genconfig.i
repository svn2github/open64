     ...
     int non_pc_set_src;
{
  ...
  switch (code)
    ...
    case MATCH_OPERAND:
      if ((((part)->fld[0]).rtint) > max_recog_operands)
 max_recog_operands = (((part)->fld[0]).rtint);
      return;
 ...
 max_recog_operands = (((part)->fld[0]).rtint);
    ...
    case LABEL_REF:
      if (((enum rtx_code) ((((part)->fld[0]).rtx))->code) == MATCH_OPERAND)
 break;
      return;
 ...
 have_lo_sum_flag = 1;
    ...
    case SET:
      walk_insn_part ((((part)->fld[0]).rtx), 0, recog_p);
      walk_insn_part ((((part)->fld[1]).rtx), recog_p,
        ((enum rtx_code) ((((part)->fld[0]).rtx))->code) != PC);
      return;
   ...
   && ((enum rtx_code) ((((part)->fld[1]).rtx))->code) == MATCH_OPERAND
   && ((enum rtx_code) ((((part)->fld[2]).rtx))->code) == MATCH_OPERAND)
 have_cmove_flag = 1;
      break;
 ...
 have_cond_exec_flag = 1;
  ...
  for (i = 0; i < (rtx_length[(int) (((enum rtx_code) (part)->code))]); i++)
    switch (*format_ptr++)
      ...
      case 'e':
      case 'u':
 walk_insn_part ((((part)->fld[i]).rtx), recog_p, non_pc_set_src);
 break;
      case 'E':
 if ((((part)->fld[i]).rtvec) != ((void *)0))
   for (j = 0; j < (((((part)->fld[i]).rtvec))->num_elem); j++)
     walk_insn_part ((((((part)->fld[i]).rtvec))->elem[j]), recog_p, non_pc_set_src);
 break;
      }
}
     ...
     rtx insn;
{
  ...
  if ((((insn)->fld[1]).rtvec) != 0)
    for (i = 0; i < (((((insn)->fld[1]).rtvec))->num_elem); i++)
      walk_insn_part ((((((insn)->fld[1]).rtvec))->elem[i]), 1, 0);
     ...
     rtx insn;
{
 ...
 walk_insn_part ((((((insn)->fld[1]).rtvec))->elem[i]), 0, 0);
     ...
     rtx split;
{
  ...
  for (i = 0; i < (((((split)->fld[0]).rtvec))->num_elem); i++)
    walk_insn_part ((((((split)->fld[0]).rtvec))->elem[i]), 1, 0);

  if ((((((split)->fld[2]).rtvec))->num_elem) > max_insns_per_split)
    max_insns_per_split = (((((split)->fld[2]).rtvec))->num_elem);
}
     ...
     rtx peep;
{
  ...
  for (i = 0; i < (((((peep)->fld[0]).rtvec))->num_elem); i++)
    walk_insn_part ((((((peep)->fld[0]).rtvec))->elem[i]), 1, 0);
}
     ...
     rtx peep;
{
  ...
  for (i = (((((peep)->fld[0]).rtvec))->num_elem) - 1; i >= 0; --i)
    walk_insn_part ((((((peep)->fld[0]).rtvec))->elem[i]), 1, 0);


  for (i = (((((peep)->fld[0]).rtvec))->num_elem) - 1, n = 0; i >= 0; --i)
    if (((enum rtx_code) ((((((peep)->fld[0]).rtvec))->elem[i]))->code) != MATCH_DUP
 && ((enum rtx_code) ((((((peep)->fld[0]).rtvec))->elem[i]))->code) != MATCH_SCRATCH)
      n++;
     ...
     char **argv;
{
 ...
 break;
      ...
      switch (((enum rtx_code) (desc)->code))
 {
     case DEFINE_INSN:
     gen_insn (desc);
     break;
