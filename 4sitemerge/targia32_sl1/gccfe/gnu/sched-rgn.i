...
# 58 "../../../kgccfe/gnu/sched-rgn.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 59 "../../../kgccfe/gnu/sched-rgn.c" 2
...
# 64 "../../../kgccfe/gnu/sched-rgn.c" 2
# 1 "../../../kgccfe/gnu/sched-int.h" 1
# 24 "../../../kgccfe/gnu/sched-int.h"
...
# 261 "../../../kgccfe/gnu/sched-int.h"
extern FILE *sched_dump;
extern int sched_verbose;
# 325 "../../../kgccfe/gnu/sched-int.h"
enum INSN_TRAP_CLASS
{
  TRAP_FREE = 0, IFREE = 1, PFREE_CANDIDATE = 2,
  PRISKY_CANDIDATE = 3, IRISKY = 4, TRAP_RISKY = 5
};
# 343 "../../../kgccfe/gnu/sched-int.h"
...
# 66 "../../../kgccfe/gnu/sched-rgn.c" 2
# 88 "../../../kgccfe/gnu/sched-rgn.c"
...
static sbitmap *dom;
# 238 "../../../kgccfe/gnu/sched-rgn.c"
static float *prob;
# 247 "../../../kgccfe/gnu/sched-rgn.c"
...
static _Bool sets_likely_spilled (rtx);
     ...
     bitlst *bl;
{
  ...
  do { unsigned int word_num_; unsigned int bit_num_ = (0) % (unsigned int) ((unsigned) (8 * 8)); unsigned int size_ = (set)->size; unsigned long long *ptr_ = (set)->elms; for (word_num_ = (0) / (unsigned int) ((unsigned) (8 * 8)); word_num_ < size_; word_num_++, bit_num_ = 0) { unsigned long long word_ = ptr_[word_num_]; if (word_ != 0) for (; bit_num_ < ((unsigned) (8 * 8)); bit_num_++) { unsigned long long _mask = (unsigned long long) 1 << bit_num_; if ((word_ & _mask) != 0) { word_ &= ~ _mask; (i) = word_num_ * ((unsigned) (8 * 8)) + bit_num_; { bitlst_table[bitlst_table_last++] = i; (bl->nr_members)++; }; if (word_ == 0) break; } } } } while (0);
...
debug_regions ()
{
      ...
      for (bb = 0; bb < rgn_table[rgn].rgn_nr_blocks; bb++)
 {
   ...
   if (bb != (block_to_bb[(rgn_bb_table[current_blocks + (bb)])]))
     fancy_abort ("../../../kgccfe/gnu/sched-rgn.c", 525, __FUNCTION__);
...
{
  (*num_bbs)++;
  (*num_insns) += ((h_i_d[(((((((basic_block_info)->data.bb[(block)]))->end))->fld[0]).rtint)].luid) -
     (h_i_d[(((((((basic_block_info)->data.bb[(block)]))->head))->fld[0]).rtint)].luid));
  if ((*num_bbs > 10) || (*num_insns > 100))
    return 1;
  else
    return 0;
}
# 619 "../../../kgccfe/gnu/sched-rgn.c"
static void
...
# 659 "../../../kgccfe/gnu/sched-rgn.c"
  ...
  while (1)
    {
      if (current_edge == 0 || ((passed)->elms [(current_edge) / ((unsigned) (8 * 8))] >> (current_edge) % ((unsigned) (8 * 8)) & 1))
 {



   while (sp >= 0
   && (current_edge == 0 || ((passed)->elms [(current_edge) / ((unsigned) (8 * 8))] >> (current_edge) % ((unsigned) (8 * 8)) & 1)))
     {

       current_edge = stack[sp--];
       node = (edge_table[current_edge].from_block);
       child = (edge_table[current_edge].to_block);
       ((in_stack)->elms [(child) / ((unsigned) (8 * 8))] &= ~((unsigned long long) 1 << (child) % ((unsigned) (8 * 8))));
       if (max_hdr[child] >= 0 && ((in_stack)->elms [(max_hdr[child]) / ((unsigned) (8 * 8))] >> (max_hdr[child]) % ((unsigned) (8 * 8)) & 1))
  { if (max_hdr[node] == -1) max_hdr[node] = max_hdr[child]; else if (dfs_nr[max_hdr[node]] > dfs_nr[max_hdr[child]]) ((inner)->elms [(max_hdr[child]) / ((unsigned) (8 * 8))] &= ~((unsigned long long) 1 << (max_hdr[child]) % ((unsigned) (8 * 8)))); else if (dfs_nr[max_hdr[node]] < dfs_nr[max_hdr[child]]) { ((inner)->elms [(max_hdr[node]) / ((unsigned) (8 * 8))] &= ~((unsigned long long) 1 << (max_hdr[node]) % ((unsigned) (8 * 8)))); max_hdr[node] = max_hdr[child]; } };
       current_edge = (edge_table[current_edge].next_out);
     }


   if (sp < 0 && ((passed)->elms [(current_edge) / ((unsigned) (8 * 8))] >> (current_edge) % ((unsigned) (8 * 8)) & 1))
     break;
   ...
   continue;
      ...
      node = (edge_table[current_edge].from_block);
      child = (edge_table[current_edge].to_block);
      ((in_stack)->elms [(node) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (node) % ((unsigned) (8 * 8)));
      dfs_nr[node] = ++count;




      if (((in_stack)->elms [(child) / ((unsigned) (8 * 8))] >> (child) % ((unsigned) (8 * 8)) & 1))
 {
   no_loops = 0;
   ((header)->elms [(child) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (child) % ((unsigned) (8 * 8)));
   { if (max_hdr[node] == -1) max_hdr[node] = child; else if (dfs_nr[max_hdr[node]] > dfs_nr[child]) ((inner)->elms [(child) / ((unsigned) (8 * 8))] &= ~((unsigned long long) 1 << (child) % ((unsigned) (8 * 8)))); else if (dfs_nr[max_hdr[node]] < dfs_nr[child]) { ((inner)->elms [(max_hdr[node]) / ((unsigned) (8 * 8))] &= ~((unsigned long long) 1 << (max_hdr[node]) % ((unsigned) (8 * 8)))); max_hdr[node] = child; } };
   ((passed)->elms [(current_edge) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (current_edge) % ((unsigned) (8 * 8)));
   current_edge = (edge_table[current_edge].next_out);
   continue;
 }
...
# 760 "../../../kgccfe/gnu/sched-rgn.c"
      if (current_edge == 0)
 dfs_nr[child] = ++count;
    }
# 771 "../../../kgccfe/gnu/sched-rgn.c"
  unreachable = 0;
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
  ...
  if (!unreachable)
    {
      ...
      if (no_loops)
 ((header)->elms [(0) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (0) % ((unsigned) (8 * 8)));
      ...
      for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
 {
   if (((header)->elms [(bb->index) / ((unsigned) (8 * 8))] >> (bb->index) % ((unsigned) (8 * 8)) & 1) && ((inner)->elms [(bb->index) / ((unsigned) (8 * 8))] >> (bb->index) % ((unsigned) (8 * 8)) & 1))
     {
       edge e;
       basic_block jbb;
# 827 "../../../kgccfe/gnu/sched-rgn.c"
       for (jbb = (&entry_exit_blocks[0])->next_bb; jbb != (&entry_exit_blocks[1]); jbb = jbb->next_bb)
  {
  ...
  if (e->dest != (&entry_exit_blocks[1]))
    --degree[e->dest->index];
       ...
       num_bbs = 1;
       num_insns = ((h_i_d[(((bb->end)->fld[0]).rtint)].luid)
      - (h_i_d[(((bb->head)->fld[0]).rtint)].luid));
       ...
       if (no_loops)
  {
    for (jbb = (&entry_exit_blocks[0])->next_bb; jbb != (&entry_exit_blocks[1]); jbb = jbb->next_bb)
      ...
      if (jbb->succ
   && jbb->succ->dest == (&entry_exit_blocks[1])
   && jbb->succ->succ_next == ((void *)0))
        {
   queue[++tail] = jbb->index;
   ((in_queue)->elms [(jbb->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (jbb->index) % ((unsigned) (8 * 8)));
       ...
       else
  {
        ...
        if (max_hdr[node] == loop_head && node != bb->index)
   {
     ...
     queue[++tail] = node;
     ((in_queue)->elms [(node) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (node) % ((unsigned) (8 * 8)));
       ...
       while (head < tail && !too_large_failure)
  {
     ...
     || max_hdr[node] != loop_head)
   {
     ...
     break;
        ...
        else if (!((in_queue)->elms [(node) / ((unsigned) (8 * 8))] >> (node) % ((unsigned) (8 * 8)) & 1) && node != bb->index)
   {
     queue[++tail] = node;
     ((in_queue)->elms [(node) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (node) % ((unsigned) (8 * 8)));
     ...
     int bb;
{
  ...
  if ((!bb))
    {
      ((dom[bb])->elms [(0) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (0) % ((unsigned) (8 * 8)));
      prob[bb] = 1.0;
      return;
    }
  ...
  do
    {
      ...
      ((ancestor_edges[bb])->elms [((edge_to_bit[nxt_in_edge])) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << ((edge_to_bit[nxt_in_edge])) % ((unsigned) (8 * 8)));
      ...
      ((pot_split[bb])->elms [((edge_to_bit[fst_out_edge])) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << ((edge_to_bit[fst_out_edge])) % ((unsigned) (8 * 8)));
      ...
      while (fst_out_edge != nxt_out_edge)
 {
   ...
   if ((containing_rgn[(edge_table[nxt_out_edge].to_block)]) !=
       (containing_rgn[(rgn_bb_table[current_blocks + (bb)])]))
     ++nr_rgn_out_edges;
   ((pot_split[bb])->elms [((edge_to_bit[nxt_out_edge])) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << ((edge_to_bit[nxt_out_edge])) % ((unsigned) (8 * 8)));
 ...
 prob[bb] += prob[(block_to_bb[pred])] / nr_out_edges;
  ...
  ((dom[bb])->elms [(bb) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (bb) % ((unsigned) (8 * 8)));
     ...
     int trg;
{
  ...
  for (i = trg + 1; i < current_nr_blocks; i++)
    {
      ...
      sp->is_valid = ( ((dom[i])->elms [(trg) / ((unsigned) (8 * 8))] >> (trg) % ((unsigned) (8 * 8)) & 1) );
      if (sp->is_valid)
 {
      ...
      if (sp->is_valid)
 {
   ...
   update_blocks = (char *) __builtin_alloca(last_basic_block);
       ...
       do
  {
   ...
   if (bblst_last > bblst_size)
     fancy_abort ("../../../kgccfe/gnu/sched-rgn.c", 1227, __FUNCTION__);
 }
      else
 {
     ...
     rtx x;
{
 ...
 if (((((((((reg)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx) != 0)
   if (check_live_1 (src, ((((((((reg)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx)))
     return 1;
      ...
      if (regno < 176)
 {
   ...
   int j = mips_hard_regno_nregs (regno, ((enum machine_mode) (reg)->mode));
   while (--j >= 0)
     {
  ...
  if (((enum rtx_code) (reg)->code) == PARALLEL)
    {
      ...
      for (i = (((((reg)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
 if (((((((((reg)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx) != 0)
   update_live_1 (src, ((((((((reg)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx));
     ...
     int src;
{
  ...
  if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET
    ...
    return check_live_1 (src, (((insn)->fld[5]).rtx));
  else if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL)
    {
      int j;
      for (j = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem) - 1; j >= 0; j--)
 if ((((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[j]))->code) == SET
      || ((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[j]))->code) == CLOBBER)
     && !check_live_1 (src, ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[j])))
   return 0;
     ...
     int src;
{
  ...
  if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET
      || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == CLOBBER)
    update_live_1 (src, (((insn)->fld[5]).rtx));
  else if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL)
    {
      int j;
      for (j = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem) - 1; j >= 0; j--)
 if (((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[j]))->code) == SET
     || ((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[j]))->code) == CLOBBER)
   update_live_1 (src, ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[j]));
    }
}
# 1499 "../../../kgccfe/gnu/sched-rgn.c"
static void
     ...
     rtx load_insn;
{
  ...
  for (link = (h_i_d[(((load_insn)->fld[0]).rtint)].depend); link; link = (((link)->fld[1]).rtx))
    if (((enum machine_mode) (link)->mode) == VOIDmode)
      (h_i_d[((((((link)->fld[0]).rtx))->fld[0]).rtint)].fed_by_spec_load) = 1;
}
     ...
     int load_insn_bb;
{
  ...
  for (link = (h_i_d[(((insn)->fld[0]).rtint)].depend); link; link = (((link)->fld[1]).rtx))
    {
      rtx next = (((link)->fld[0]).rtx);
      if (((containing_rgn[((((next)->fld[3]).bb)->index + 0)]) ==
    (containing_rgn[(rgn_bb_table[current_blocks + (load_insn_bb)])]))
   && (((block_to_bb[((((next)->fld[3]).bb)->index + 0)])) == load_insn_bb || (!((block_to_bb[((((next)->fld[3]).bb)->index + 0)]))) || (((ancestor_edges[load_insn_bb])->elms [((edge_to_bit[(in_edges[(rgn_bb_table[current_blocks + (((block_to_bb[((((next)->fld[3]).bb)->index + 0)])))])])])) / ((unsigned) (8 * 8))] >> ((edge_to_bit[(in_edges[(rgn_bb_table[current_blocks + (((block_to_bb[((((next)->fld[3]).bb)->index + 0)])))])])])) % ((unsigned) (8 * 8)) & 1)))
   && load_insn_bb != ((block_to_bb[((((next)->fld[3]).bb)->index + 0)]))
     ...
     int bb_src, bb_trg;
{
  ...
  for (link = (((load_insn)->fld[7]).rtx); link; link = (((link)->fld[1]).rtx))
    {
      rtx insn1 = (((link)->fld[0]).rtx);
 ...
 continue;
      ...
      if (((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])) == bb_src
   || ((containing_rgn[((((insn1)->fld[3]).bb)->index + 0)])
       != (containing_rgn[(rgn_bb_table[current_blocks + (bb_src)])]))
   || (!(bb_trg == ((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])) || (!bb_trg) || (((ancestor_edges[((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)]))])->elms [((edge_to_bit[(in_edges[(rgn_bb_table[current_blocks + (bb_trg)])])])) / ((unsigned) (8 * 8))] >> ((edge_to_bit[(in_edges[(rgn_bb_table[current_blocks + (bb_trg)])])])) % ((unsigned) (8 * 8)) & 1)))
       && !(((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])) == bb_trg || (!((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)]))) || (((ancestor_edges[bb_trg])->elms [((edge_to_bit[(in_edges[(rgn_bb_table[current_blocks + (((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])))])])])) / ((unsigned) (8 * 8))] >> ((edge_to_bit[(in_edges[(rgn_bb_table[current_blocks + (((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])))])])])) % ((unsigned) (8 * 8)) & 1)))))
 continue;
     ...
     int bb_src, bb_trg;
{
  ...
  for (back_link = (((load_insn)->fld[7]).rtx);
       back_link; back_link = (((back_link)->fld[1]).rtx))
    {
      rtx insn1 = (((back_link)->fld[0]).rtx);
      ...
      if (((enum machine_mode) (back_link)->mode) == VOIDmode)
 {
   ...
   for (fore_link = (h_i_d[(((insn1)->fld[0]).rtint)].depend);
        fore_link; fore_link = (((fore_link)->fld[1]).rtx))
     {
       rtx insn2 = (((fore_link)->fld[0]).rtx);
       if (((enum machine_mode) (fore_link)->mode) == VOIDmode)
  {
    ...
    if (((block_to_bb[((((insn2)->fld[3]).bb)->index + 0)])) == bb_trg)

      return 1;

    if (*(candp->split_bbs.first_member) == ((((insn2)->fld[3]).bb)->index + 0))
...
is_prisky (load_insn, bb_src, bb_trg)
     ...
     int bb_src, bb_trg;
{
  if ((h_i_d[(((load_insn)->fld[0]).rtint)].fed_by_spec_load))
    return 1;

  if ((((load_insn)->fld[7]).rtx) == ((void *)0))
     ...
     int bb_src, bb_trg;
{
  ...
  if (!flag_schedule_speculative_load)
    return 0;
  (h_i_d[(((insn)->fld[0]).rtint)].is_load_insn) = 1;
  switch (insn_class)
    {
    case IFREE:
      return (1);
     ...
     struct ready_list *ready;
{
  ...
  for (insn = (((prev_head)->fld[2]).rtx); insn != next_tail; insn = (((insn)->fld[2]).rtx))
    {
      rtx next;
 ...
 continue;
      ...
      if ((h_i_d[(((insn)->fld[0]).rtint)].dep_count) == 0
   && (! ((rtx_class[(int) (((enum rtx_code) (next)->code))]) == 'i') || (((next))->in_struct) == 0))
 ...
 src_next_tail = (((tail)->fld[2]).rtx);
 src_head = head;

 for (insn = src_head; insn != src_next_tail; insn = (((insn)->fld[2]).rtx))
   {
     if (! ((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
       continue;

     if (!(h_i_d[(((insn)->fld[0]).rtint)].cant_move)
  && (!(( candidate_table[(block_to_bb[((((insn)->fld[3]).bb)->index + 0)])].is_speculative ))
  ...
  if ((h_i_d[(((insn)->fld[0]).rtint)].dep_count) == 0
      && (! next
   || ! ((rtx_class[(int) (((enum rtx_code) (next)->code))]) == 'i')
   || (((next))->in_struct) == 0))
    ready_add (ready, insn);
       }
   }
     ...
     rtx insn;
{
  ...
  if (((block_to_bb[((((insn)->fld[3]).bb)->index + 0)])) != target_bb)
    {
      rtx temp;
      basic_block b1;

      if ((( candidate_table[(block_to_bb[((((insn)->fld[3]).bb)->index + 0)])].is_speculative )))
 {
   if (!check_live (insn, ((block_to_bb[((((insn)->fld[3]).bb)->index + 0)]))))
     return 0;
   update_live (insn, ((block_to_bb[((((insn)->fld[3]).bb)->index + 0)])));


   if ((h_i_d[(((insn)->fld[0]).rtint)].is_load_insn) || (h_i_d[(((insn)->fld[0]).rtint)].fed_by_spec_load))
     set_spec_fed (insn);
     ...
     rtx next;
{
  ...
  if (((block_to_bb[((((next)->fld[3]).bb)->index + 0)])) != target_bb
      && (!( candidate_table[((block_to_bb[((((next)->fld[3]).bb)->index + 0)]))].is_valid )
   || (h_i_d[(((next)->fld[0]).rtint)].cant_move)
   || ((( candidate_table[(block_to_bb[((((next)->fld[3]).bb)->index + 0)])].is_speculative ))
       && (0
    || (targetm.sched.use_dfa_pipeline_interface
        && (*targetm.sched.use_dfa_pipeline_interface) ()
        && ((((next)->fld[6]).rtint) >= 0 ? (((next)->fld[6]).rtint) : recog_memoized_1 (next)) >= 0
        && min_insn_conflict_delay (curr_state, next,
        next) > 3)
    || ((!targetm.sched.use_dfa_pipeline_interface
         || !(*targetm.sched.use_dfa_pipeline_interface) ())
        && insn_issue_delay (next) > 3)
    || !check_live (next, ((block_to_bb[((((next)->fld[3]).bb)->index + 0)])))
    || !is_exception_free (next, ((block_to_bb[((((next)->fld[3]).bb)->index + 0)])), target_bb)))))
    return 0;
  return 1;
}
     ...
     int aligned;
{
  ...
  if (aligned)
    sprintf (tmp, "b%3d: i%4d", ((block_to_bb[((((insn)->fld[3]).bb)->index + 0)])), (((insn)->fld[0]).rtint));
  else
    {
      if (current_nr_blocks > 1 && ((block_to_bb[((((insn)->fld[3]).bb)->index + 0)])) != target_bb)
 sprintf (tmp, "%d/b%d", (((insn)->fld[0]).rtint), ((block_to_bb[((((insn)->fld[3]).bb)->index + 0)])));
      else
 sprintf (tmp, "%d", (((insn)->fld[0]).rtint));
    }
  return tmp;
}
     ...
     rtx insn1, insn2;
{
  ...
  if (((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])) != ((block_to_bb[((((insn2)->fld[3]).bb)->index + 0)])))
    {
      int spec_val, prob_val;


      if ((((block_to_bb[((((insn2)->fld[3]).bb)->index + 0)])) == target_bb) && (((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])) != target_bb))
 return 1;
      if ((((block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])) == target_bb) && (((block_to_bb[((((insn2)->fld[3]).bb)->index + 0)])) != target_bb))
 return -1;


      spec_val = (( candidate_table[(block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])].is_speculative )) - (( candidate_table[(block_to_bb[((((insn2)->fld[3]).bb)->index + 0)])].is_speculative ));
      if (spec_val)
 return spec_val;


      prob_val = (( candidate_table[(block_to_bb[((((insn2)->fld[3]).bb)->index + 0)])].src_prob )) - (( candidate_table[(block_to_bb[((((insn1)->fld[3]).bb)->index + 0)])].src_prob ));
      if (prob_val)
 return prob_val;
    }
  return 0;
...
contributes_to_priority (next, insn)
     rtx next, insn;
{
  return ((((next)->fld[3]).bb)->index + 0) == ((((insn)->fld[3]).bb)->index + 0);
}
...
compute_jump_reg_dependencies (insn, cond_set, used, set)
     ...
     regset cond_set __attribute__ ((__unused__));
     regset used __attribute__ ((__unused__));
     regset set __attribute__ ((__unused__));
{
...
sets_likely_spilled_1 (x, pat, data)
     ...
     void *data;
{
  _Bool *ret = (_Bool *) data;

  if (((enum rtx_code) (pat)->code) == SET
      && (((enum rtx_code) (x)->code) == REG)
      && (((x)->fld[0]).rtuint) < 176
      && (reg_class_size[(int) (mips_regno_to_class[ ((((x)->fld[0]).rtuint)) ])] == 1))
    *ret = 1;
}
...
# 2109 "../../../kgccfe/gnu/sched-rgn.c"
  ...
  || (((enum rtx_code) (insn)->code) == INSN
   ...
   || (!reload_completed
       && sets_likely_spilled ((((insn)->fld[5]).rtx)))))
  || ((enum rtx_code) (insn)->code) == NOTE)
    {
      if (((enum rtx_code) (insn)->code) != NOTE)
 {
   if (last != 0 && !find_insn_list (insn, (((last)->fld[7]).rtx)))
     {
       add_dependence (last, insn, REG_DEP_ANTI);
       (h_i_d[(((insn)->fld[0]).rtint)].ref_count)++;
     }
 ...
 if ((h_i_d[(((insn)->fld[0]).rtint)].ref_count) != 0)
   continue;

 add_dependence (last, insn, REG_DEP_ANTI);
 (h_i_d[(((insn)->fld[0]).rtint)].ref_count) = 1;
...
{
  rtx new = old;
  for (; copy ; copy = (((copy)->fld[1]).rtx))
    new = alloc_INSN_LIST ((((copy)->fld[0]).rtx), new);
  return new;
}
     ...
     rtx *old_insns_p, *old_mems_p;
{
  ...
  while (copy_insns)
    {
      new_insns = alloc_INSN_LIST ((((copy_insns)->fld[0]).rtx), new_insns);
      new_mems = alloc_EXPR_LIST (VOIDmode, (((copy_mems)->fld[0]).rtx), new_mems);
      copy_insns = (((copy_insns)->fld[1]).rtx);
      copy_mems = (((copy_mems)->fld[1]).rtx);
    }
...
debug_dependencies ()
{
      ...
      if (1)
 {
  ...
  {
    int n;
    fprintf (sched_dump, ";;   %6d ", (((insn)->fld[0]).rtint));
    if (((enum rtx_code) (insn)->code) == NOTE)
      {
        n = (((insn)->fld[5]).rtint);
        if (n < 0)
    ...
    && (*targetm.sched.use_dfa_pipeline_interface) ())
  {
    fprintf (sched_dump,
      ...
      (((insn)->fld[0]).rtint),
      (((insn)->fld[6]).rtint),
      ((block_to_bb[((((insn)->fld[3]).bb)->index + 0)])),
      (h_i_d[(((insn)->fld[0]).rtint)].dep_count),
      (h_i_d[(((insn)->fld[0]).rtint)].priority),
      insn_cost (insn, 0, 0));
       ...
       else
  {
    ...
    insn_print_units (insn);
       ...
       fprintf (sched_dump, "\t: ");
       for (link = (h_i_d[(((insn)->fld[0]).rtint)].depend); link; link = (((link)->fld[1]).rtx))
  fprintf (sched_dump, "%d ", ((((((link)->fld[0]).rtx))->fld[0]).rtint));
       fprintf (sched_dump, "\n");
     }
 }
    }
     ...
     int rgn;
{
 ...
 continue;
      ...
      current_sched_info->prev_head = (((head)->fld[1]).rtx);
      current_sched_info->next_tail = (((tail)->fld[2]).rtx);
      ...
      if (((rtx_class[(int) (((enum rtx_code) (head)->code))]) == 'i'))
 {
   ...
   for (note = (((head)->fld[8]).rtx); note; note = (((note)->fld[1]).rtx))
 ...
 = current_nr_blocks > 1 && !flag_schedule_interblock;
      ...
      if (head == ((((basic_block_info)->data.bb[(b)]))->head))
 ((((basic_block_info)->data.bb[(b)]))->head) = current_sched_info->head;
      if (tail == ((((basic_block_info)->data.bb[(b)]))->end))
 ((((basic_block_info)->data.bb[(b)]))->end) = current_sched_info->tail;
      ...
      if (current_nr_blocks > 1)
 {
  ...
  if (sched_rgn_n_insns != rgn_n_insns)
    fancy_abort ("../../../kgccfe/gnu/sched-rgn.c", 2615, __FUNCTION__);
...
# 2694 "../../../kgccfe/gnu/sched-rgn.c"
      ...
      for (rgn = 0; rgn < nr_regions; rgn++)
 {
   ...
   for (b = (rgn_table[rgn].rgn_nr_blocks) - 1; b >= 0; --b)
     ((blocks)->elms [(rgn_bb_table[(rgn_table[rgn].rgn_blocks) + b]) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (rgn_bb_table[(rgn_table[rgn].rgn_blocks) + b]) % ((unsigned) (8 * 8)));
...
# 2784 "../../../kgccfe/gnu/sched-rgn.c"
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    ((large_region_blocks)->elms [(bb->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (bb->index) % ((unsigned) (8 * 8)));
  ...
  for (rgn = 0; rgn < nr_regions; rgn++)
    if ((rgn_table[rgn].rgn_nr_blocks) > 1)
      ...
      {
 ((blocks)->elms [(rgn_bb_table[(rgn_table[rgn].rgn_blocks)]) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (rgn_bb_table[(rgn_table[rgn].rgn_blocks)]) % ((unsigned) (8 * 8)));
 ((large_region_blocks)->elms [(rgn_bb_table[(rgn_table[rgn].rgn_blocks)]) / ((unsigned) (8 * 8))] &= ~((unsigned long long) 1 << (rgn_bb_table[(rgn_table[rgn].rgn_blocks)]) % ((unsigned) (8 * 8))));
      }
 ...
 if ((rgn_table[rgn].rgn_nr_blocks) == 1)
  ...
  != count_or_remove_death_notes (blocks, 0))
       fancy_abort ("../../../kgccfe/gnu/sched-rgn.c", 2832, __FUNCTION__);
   }
 ...
 {
   if (nr_inter > 0)
     fancy_abort ("../../../kgccfe/gnu/sched-rgn.c", 2857, __FUNCTION__);
 }
      fprintf (sched_dump, "\n\n");
    }
