     ...
     tree expr;
{
 ...
 fprintf (outfile, ".%s",
   ((char *)(((((expr)->exp.operands[1]))->decl.name))->identifier.id.str));
    }
    ...
    fprintf (outfile, " %s", ((char *)(((expr)->decl.name))->identifier.id.str));
     ...
     rtx in_rtx;
{
 ...
 fprintf (outfile, "\n%s%*s", print_rtx_head, indent * 2, "");
  ...
  is_insn = ((rtx_class[(int) (((enum rtx_code) (in_rtx)->code))]) == 'i');
      ...
      if (! flag_simple)
 {
  ...
  fprintf (outfile, ":%s", (mode_name[(int) (((enum machine_mode) (in_rtx)->mode))]));
     }
 }
    }


  if (((enum rtx_code) (in_rtx)->code) == CONST_DOUBLE && ((mode_class[(int) (((enum machine_mode) (in_rtx)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (in_rtx)->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) (in_rtx)->mode))]) == MODE_VECTOR_FLOAT))
    i = 5;
 ...
 if (i == 1 && ((enum rtx_code) (in_rtx)->code) == REG)
   {
     if ((((in_rtx)->fld[0]).rtuint) != (((in_rtx)->fld[1]).rtuint))
       fprintf (outfile, " [%d]", (((in_rtx)->fld[1]).rtuint));
     break;
   }
 if (i == 4 && ((enum rtx_code) (in_rtx)->code) == NOTE)
   {
     switch ((((in_rtx)->fld[5]).rtint))
       {
  ...
  if (flag_dump_unnumbered)
    ...
    fprintf (outfile, " %d", (((in_rtx)->fld[4]).rtint));
  sawclose = 1;
  break;
  ...
  if (flag_dump_unnumbered)
    ...
    fprintf (outfile, "%p",
      (char *) (((in_rtx)->fld[4]).rttree));
  sawclose = 1;
  break;

       case NOTE_INSN_BASIC_BLOCK:
  {
    basic_block bb = (((in_rtx)->fld[4]).bb);
    if (bb != 0)
  ...
  if (!sawclose)
    fprintf (outfile, " ");
  print_rtx ((((in_rtx)->fld[4]).rtx));
  indent -= 2;
  break;

       case NOTE_INSN_DELETED_LABEL:
  if ((((in_rtx)->fld[4]).rtstr))
    fprintf (outfile, " (\"%s\")", (((in_rtx)->fld[4]).rtstr));
  else
    fprintf (outfile, " \"\"");
  break;

       case NOTE_INSN_PREDICTION:
  if ((((in_rtx)->fld[4]).rtint))
    fprintf (outfile, " [ %d %d ] ",
      (int)((((in_rtx)->fld[4]).rtint)>>8),
      (int) ((((in_rtx)->fld[4]).rtint)&0xff));
  else
  ...
  break;
       ...
       default:
  {
    const char * const str = (((in_rtx)->fld[i]).rtstr);

    if ((((in_rtx)->fld[5]).rtint) < 0)
      ;
    else if (str == 0)
      fputs_unlocked (dump_for_graph ? " \\\"\\\"" : " \"\"", outfile);
    else
 ...
 fputs_unlocked (" [", outfile);
 if (((void *)0) != (((in_rtx)->fld[i]).rtvec))
   {
     indent += 2;
     if ((((((in_rtx)->fld[i]).rtvec))->num_elem))
       sawclose = 1;

     for (j = 0; j < (((((in_rtx)->fld[i]).rtvec))->num_elem); j++)
       print_rtx ((((((in_rtx)->fld[i]).rtvec))->elem[j]));
 ...
 if (! flag_simple)
   fprintf (outfile, " ");
 fprintf (outfile, "%lld", (((in_rtx)->fld[i]).rtwint));
 if (! flag_simple)
   {
     fprintf (outfile, " [");
     fprintf (outfile, "0x%llx", (((in_rtx)->fld[i]).rtwint));
     fprintf (outfile, "]");
   }
 break;

      case 'i':
 if (i == 6 && ((enum rtx_code) (in_rtx)->code) == NOTE)
   {


     if ((((in_rtx)->fld[5]).rtint) == NOTE_INSN_DELETED_LABEL)
       fprintf (outfile, " %d", (((in_rtx)->fld[i]).rtint));
   }
 else
   {
     int value = (((in_rtx)->fld[i]).rtint);
     const char *name;

     if (((enum rtx_code) (in_rtx)->code) == REG && value < 176)
       {
  fputc_unlocked (' ', outfile);
  fprintf ((outfile), "%d %s", (((in_rtx)->fld[0]).rtuint), debug_reg_names[(((in_rtx)->fld[0]).rtuint)]);
       }
  ...
  if (value == ((176)))
    ...
    fprintf (outfile, " %d virtual-reg-%d", value,
     ...
     if (is_insn && &(((in_rtx)->fld[6]).rtint) == &(((in_rtx)->fld[i]).rtint)
  && (((in_rtx)->fld[i]).rtint) >= 0
  && (name = get_insn_name ((((in_rtx)->fld[i]).rtint))) != ((void *)0))
 ...
 break;
      ...
      case 'n':
 if ((((in_rtx)->fld[i]).rtint) >= (int) NOTE_INSN_BIAS
     && (((in_rtx)->fld[i]).rtint) < (int) NOTE_INSN_MAX)
   fprintf (outfile, " %s", (note_insn_name[((((in_rtx)->fld[i]).rtint)) - (int) NOTE_INSN_BIAS]));
 else
   fprintf (outfile, " %d", (((in_rtx)->fld[i]).rtint));
 sawclose = 0;
 break;
      ...
      case 'u':
 if ((((in_rtx)->fld[i]).rtx) != ((void *)0))
   {
     rtx sub = (((in_rtx)->fld[i]).rtx);
  ...
  if (subc == NOTE
      && (((sub)->fld[5]).rtint) == NOTE_INSN_DELETED_LABEL)
    {
      if (flag_dump_unnumbered)
        ...
        fprintf (outfile, " [%d deleted]", (((sub)->fld[0]).rtint));
      sawclose = 0;
      break;
    }
  ...
  if (subc != CODE_LABEL)
    goto do_e;
     ...
     if (flag_dump_unnumbered)
       ...
       fprintf (outfile, " %d", (((sub)->fld[0]).rtint));
   }
 else
 ...
 break;
      ...
      case 'b':
 if ((((in_rtx)->fld[i]).rtbit) == ((void *)0))
   fputs_unlocked (" {null}", outfile);
 else
   bitmap_print (outfile, (((in_rtx)->fld[i]).rtbit), " {", "}");
 sawclose = 0;
 break;

      case 't':
 putc_unlocked (' ', outfile);
 fprintf (outfile, "%p", (char *) (((in_rtx)->fld[i]).rttree));
 break;
 ...
 break;
      ...
      case 'B':
 if ((((in_rtx)->fld[i]).bb))
   fprintf (outfile, " %i", (((in_rtx)->fld[i]).bb)->index);
 break;
 ...
 fprintf (stderr,
   ...
   format_ptr[-1]);
 fancy_abort ("../../../kgccfe/gnu/print-rtl.c", 489, __FUNCTION__);
      }
  ...
  switch (((enum rtx_code) (in_rtx)->code))
    ...
    case MEM:
      fputs_unlocked (" [", outfile);
      fprintf (outfile, "%lld", ((((in_rtx)->fld[1]).rtmem) == 0 ? 0 : (((in_rtx)->fld[1]).rtmem)->alias));

      if (((((in_rtx)->fld[1]).rtmem) == 0 ? 0 : (((in_rtx)->fld[1]).rtmem)->expr))
 print_mem_expr (outfile, ((((in_rtx)->fld[1]).rtmem) == 0 ? 0 : (((in_rtx)->fld[1]).rtmem)->expr));

      if (((((in_rtx)->fld[1]).rtmem) == 0 ? 0 : (((in_rtx)->fld[1]).rtmem)->offset))
 {
   fputc_unlocked ('+', outfile);
   fprintf (outfile, "%lld",
     (((((((in_rtx)->fld[1]).rtmem) == 0 ? 0 : (((in_rtx)->fld[1]).rtmem)->offset))->fld[0]).rtwint));
 }

      if (((((in_rtx)->fld[1]).rtmem) != 0 ? (((in_rtx)->fld[1]).rtmem)->size : ((enum machine_mode) (in_rtx)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (in_rtx)->mode))]))) : 0))
 {
   fputs_unlocked (" S", outfile);
   fprintf (outfile, "%lld",
     (((((((in_rtx)->fld[1]).rtmem) != 0 ? (((in_rtx)->fld[1]).rtmem)->size : ((enum machine_mode) (in_rtx)->mode) != BLKmode ? gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_size[(int) (((enum machine_mode) (in_rtx)->mode))]))) : 0))->fld[0]).rtwint));
 }

      if (((((in_rtx)->fld[1]).rtmem) != 0 ? (((in_rtx)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (in_rtx)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (in_rtx)->mode)) : 8)) != 1)
 fprintf (outfile, " A%u", ((((in_rtx)->fld[1]).rtmem) != 0 ? (((in_rtx)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (in_rtx)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (in_rtx)->mode)) : 8)));

      fputc_unlocked (']', outfile);
      break;

    case CONST_DOUBLE:
      if (((mode_class[(int) (((enum machine_mode) (in_rtx)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (in_rtx)->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) (in_rtx)->mode))]) == MODE_VECTOR_FLOAT))
 {
   char s[60];

   real_to_decimal (s, ((struct real_value *)&(((in_rtx)->fld[0]).rtwint)),
      sizeof (s), 0, 1);
   fprintf (outfile, " %s", s);

   real_to_hexadecimal (s, ((struct real_value *)&(((in_rtx)->fld[0]).rtwint)),
          sizeof (s), 0, 1);
   fprintf (outfile, " [%s]", s);
 }
      break;
    ...
    case CODE_LABEL:
      fprintf (outfile, " [%d uses]", (((in_rtx)->fld[4]).rtint));
      switch (((enum label_kind) (((in_rtx)->jump << 1) | (in_rtx)->call)))
 {
   ...
   default: fancy_abort ("../../../kgccfe/gnu/print-rtl.c", 546, __FUNCTION__);
 }
      break;
      ...
      if (debug_call_placeholder_verbose)
 {
   ...
   for (tem = (((in_rtx)->fld[0]).rtx); tem != 0; tem = (((tem)->fld[2]).rtx))
     {
       fputs_unlocked ("\n    ", outfile);
       print_inline_rtx (outfile, tem, 4);
     }

   tem = (((in_rtx)->fld[1]).rtx);
   if (tem)
     fputs_unlocked ("\n    ])\n  (const_string \"tail_call\") (sequence [", outfile);

   for (; tem != 0; tem = (((tem)->fld[2]).rtx))
     {
       fputs_unlocked ("\n    ", outfile);
       print_inline_rtx (outfile, tem, 4);
     }

   tem = (((in_rtx)->fld[2]).rtx);
   if (tem)
   ...
   break;
      ...
      for (tem = (((in_rtx)->fld[0]).rtx); tem != 0; tem = (((tem)->fld[2]).rtx))
 if (((enum rtx_code) (tem)->code) == CALL_INSN)
   {
     fprintf (outfile, " ");
     print_rtx (tem);
     break;
     ...
     int n;
{
 ...
 x = (((x)->fld[1]).rtx);
  ...
  for (i = count, insn = x; i > 0 && insn != 0; i--, insn = (((insn)->fld[2]).rtx))
    {
      debug_rtx (insn);
      fprintf (stderr, "\n");
    }
     ...
     rtx rtx_first;
{
  ...
  if (rtx_first == 0)
    ...
    switch (((enum rtx_code) (rtx_first)->code))
      ...
      case CODE_LABEL:
      case BARRIER:
 for (tmp_rtx = rtx_first; tmp_rtx != 0; tmp_rtx = (((tmp_rtx)->fld[2]).rtx))
   if (! flag_dump_unnumbered
       || ((enum rtx_code) (tmp_rtx)->code) != NOTE || (((tmp_rtx)->fld[5]).rtint) < 0)
     {
     ...
     rtx x;
{
  ...
  sawclose = 0;
  if (! flag_dump_unnumbered
      || ((enum rtx_code) (x)->code) != NOTE || (((x)->fld[5]).rtint) < 0)
    {
      fputs_unlocked (print_rtx_head, outfile);
      print_rtx (x);
      putc_unlocked ('\n', outf);
