     ...
     char *name;
{
 ...
 ;
      ...
      key = (char *) __builtin_alloca(keylen + 1);
  ...
  const char *key;
{
      ...
      if (key[0] != '$')
 {
   ...
   free_key = 1;
      ...
      result = concat (key, &path[strlen (std_prefix)], ((void *)0));
      if (free_key)
 free ((char *) key);
