...
hook_void_tree_int (a, b)
     tree a __attribute__ ((__unused__));
...
hook_void_FILEptr_constcharptr (a, b)
     FILE *a __attribute__ ((__unused__));
     const char *b __attribute__ ((__unused__));
{
}
...
hook_bool_tree_hwi_hwi_tree_false (a, b, c, d)
     tree a __attribute__ ((__unused__));
     long long b __attribute__ ((__unused__));
     long long c __attribute__ ((__unused__));
     tree d __attribute__ ((__unused__));
{
  return 0;
}
...
hook_int_tree_tree_1 (a, b)
     tree a __attribute__ ((__unused__));
     tree b __attribute__ ((__unused__));
{
  return 1;
}
