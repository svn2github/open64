...
fix_sched_param:
.LFB15:
	.file 1 "../../../kgccfe/gnu/haifa-sched.c"
	.loc 1 192 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LFE33:
	...
	.section	.rodata
	.type	__FUNCTION__.11470, @object
	.size	__FUNCTION__.11470, 14
__FUNCTION__.11470:
	.string	"ready_lastpos"
	.align 4
.LC2:
	.string	"../../../kgccfe/gnu/haifa-sched.c"
	.text
...
.LCFI56:
	...
	jne	.L231
	.loc 1 1128 0
	leal	__FUNCTION__.11470@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1128, 4(%esp)
...
.LFE44:
	...
	.section	.rodata
	.type	__FUNCTION__.11940, @object
	.size	__FUNCTION__.11940, 14
__FUNCTION__.11940:
...
.LBB15:
	...
	jne	.L352
	.loc 1 1510 0
	leal	__FUNCTION__.11940@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1510, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LBB16:
	...
	jne	.L426
	.loc 1 1690 0
	leal	__FUNCTION__.12116@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1690, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE56:
	...
	.section	.rodata
	.type	__FUNCTION__.11550, @object
	.size	__FUNCTION__.11550, 14
__FUNCTION__.11550:
...
.L554:
	.loc 1 1183 0
	leal	__FUNCTION__.11550@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1183, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE57:
	...
	.section	.rodata
	.type	__FUNCTION__.11526, @object
	.size	__FUNCTION__.11526, 19
__FUNCTION__.11526:
...
.LCFI147:
	...
	jne	.L578
	.loc 1 1160 0
	leal	__FUNCTION__.11526@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1160, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L587:
	.loc 1 1202 0
	leal	__FUNCTION__.11571@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1202, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE58:
	...
	.section	.rodata
	.type	__FUNCTION__.12582, @object
	.size	__FUNCTION__.12582, 15
__FUNCTION__.12582:
...
.LCFI161:
	...
	je	.L597
	.loc 1 2146 0
	leal	__FUNCTION__.12582@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2146, 4(%esp)
	leal	.LC2@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE92:
	...
	.file 9 "../../../kgccfe/gnu/MIPS/insn-attr.h"
	...
	.file 14 "../../../kgccfe/gnu/varray.h"
	.file 15 "../../../kgccfe/gnu/regs.h"
	.file 16 "../../../kgccfe/gnu/flags.h"
	.file 17 "../../../kgccfe/gnu/target.h"
	.text
.Letext0:
