...
alloc_qty:
.LFB15:
	.file 1 "../../../kgccfe/gnu/local-alloc.c"
	.loc 1 309 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LFE24:
	...
	.size	__FUNCTION__.11393, 18
__FUNCTION__.11393:
	.string	"update_equiv_regs"
	.align 4
.LC0:
	.string	"../../../kgccfe/gnu/local-alloc.c"
	.text
...
.L296:
	.loc 1 1070 0
	leal	__FUNCTION__.11393@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1070, 4(%esp)
...
.LFE26:
	...
	.section	.rodata
	.type	__FUNCTION__.11932, @object
	.size	__FUNCTION__.11932, 12
__FUNCTION__.11932:
	.string	"block_alloc"
	.text
...
.L354:
	...
	jle	.L355
	.loc 1 1232 0
	leal	__FUNCTION__.11932@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1232, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE37:
	...
	.section	.rodata
	.type	__FUNCTION__.14087, @object
	.size	__FUNCTION__.14087, 14
__FUNCTION__.14087:
	.string	"find_free_reg"
	.align 32
	.type	eliminables.14086, @object
	.size	eliminables.14086, 72
eliminables.14086:
	.long	0
	.long	29
	.long	0
...
.L742:
	.loc 1 2182 0
	leal	__FUNCTION__.14087@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2182, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L760:
	.loc 1 2213 0
	movl	-116(%ebp), %eax
	movl	eliminables.14086@GOTOFF(%ebx,%eax,8), %eax
	movl	%eax, %edi
	shrl	$6, %edi
	movl	%edi, -276(%ebp)
	movl	-116(%ebp), %eax
