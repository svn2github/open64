...
static char *affix_data_type (const char *) __attribute__ ((__malloc__));
...
# 73 "../../../kgccfe/gnu/c-aux-info.c"
static char *
affix_data_type (param)
     const char *param;
{
  char *const type_or_decl = (__extension__ ({ const char *const libiberty_optr = (param); const unsigned long libiberty_len = strlen (libiberty_optr) + 1; char *const libiberty_nptr = __builtin_alloca(libiberty_len); (char *) memcpy (libiberty_nptr, libiberty_optr, libiberty_len); }));
  char *p = type_or_decl;
     ...
     formals_style style;
{
  ...
  formal_type = ((fntype)->type.values);
  while (formal_type && ((formal_type)->list.value) != global_trees[TI_VOID_TYPE])
    {
      ...
      this_type = gen_type ("", ((formal_type)->list.value), ansi);
      formal_list
 = ((strlen (this_type))
...
# 178 "../../../kgccfe/gnu/c-aux-info.c"
  if (!*formal_list)
    {
      if (((fntype)->type.values))
     ...
     tree fntype;
{
  ...
  return (!formal_type && ((fntype)->type.values));
}
# 240 "../../../kgccfe/gnu/c-aux-info.c"
static const char *
     ...
     formals_style style;
{
  ...
  if (((t)->type.name) && ((enum tree_code) (((t)->type.name))->common.code) == TYPE_DECL)
    data_type = ((char *)(((((t)->type.name))->decl.name))->identifier.id.str);
  else
    {
   ...
   else
     {
      ...
      ((t)->common.type), style);
        ...
        case IDENTIFIER_NODE:
          data_type = ((char *)(t)->identifier.id.str);
          break;
# 384 "../../../kgccfe/gnu/c-aux-info.c"
        case RECORD_TYPE:
   if (((t)->type.name))
     data_type = ((char *)(((t)->type.name))->identifier.id.str);
   else
     {
       data_type = "";
       chain_p = ((t)->type.values);
       while (chain_p)
  {
       ...
       while (chain_p)
  {
   ...
   ((char *)(((chain_p)->list.purpose))->identifier.id.str), ((void *)0));
    chain_p = ((chain_p)->common.chain);
    if (chain_p)
      data_type = concat (data_type, ", ", ((void *)0));
  }
   ...
   break;
        ...
        case TYPE_DECL:
          data_type = ((char *)(((t)->decl.name))->identifier.id.str);
          break;
        ...
        case INTEGER_TYPE:
          ...
          if (((t)->common.unsigned_flag) && ((((t)->common.readonly_flag) * 0x1) | (((t)->common.volatile_flag) * 0x2) | (((t)->type.restrict_flag) * 0x4) | ((((enum tree_code) (t)->common.code) == RECORD_TYPE && ((t)->common.type)) * 0x8)))
 ...
 case ERROR_MARK:
   ...
   break;
        ...
        default:
          fancy_abort ("../../../kgccfe/gnu/c-aux-info.c", 467, __FUNCTION__);
        }
    }
  if (((t)->common.readonly_flag))
    ret_val = concat ("const ", ret_val, ((void *)0));
     ...
     formals_style style;
{
  ...
  if (((decl)->decl.name))
    ret_val = ((char *)(((decl)->decl.name))->identifier.id.str);
  else
    ret_val = "";
      ...
      if (! compiled_from_record++)
 {
   ...
   fprintf (aux_info_file, "/* compiled from: . */\n");
      ...
      fprintf (aux_info_file, "/* %s:%d:%c%c */ %s;",
        (((fndecl)->decl.locus).file),
        (((fndecl)->decl.locus).line),
