...
typedef struct function_format_info
{
  ...
  unsigned long long format_num;
  unsigned long long first_arg_num;
} function_format_info;

static _Bool decode_format_attr (tree, function_format_info *, int);
     ...
     _Bool *no_add_attrs;
{
 ...
 ;
      ...
      if (! argument
   || ((enum tree_code) (((argument)->list.value))->common.code) != POINTER_TYPE
   || (((((((argument)->list.value))->common.type))->type.main_variant)
...
{
  tree type = *node;
  tree format_num_expr = ((args)->list.value);
  unsigned long long format_num;
  unsigned long long arg_num;
  tree argument;
...
decode_format_attr (args, info, validated_p)
     ...
     int validated_p;
{
  tree format_type_id = ((args)->list.value);
  tree format_num_expr = ((((args)->common.chain))->list.value);
  tree first_arg_num_expr
    = ((((((args)->common.chain))->common.chain))->list.value);

  if (((enum tree_code) (format_type_id)->common.code) != IDENTIFIER_NODE)
    {
      if (validated_p)
 fancy_abort ("../../../kgccfe/gnu/c-format.c", 238, __FUNCTION__);
      error ("unrecognized format specifier");
      return 0;
    }
  else
    {
      const char *p = ((char *)(format_type_id)->identifier.id.str);
 ...
 {
   if (validated_p)
     fancy_abort ("../../../kgccfe/gnu/c-format.c", 251, __FUNCTION__);
  ...
  while (((enum tree_code) (first_arg_num_expr)->common.code) == NOP_EXPR
  || ((enum tree_code) (first_arg_num_expr)->common.code) == CONVERT_EXPR
  || ((enum tree_code) (first_arg_num_expr)->common.code) == NON_LVALUE_EXPR)
    first_arg_num_expr = ((first_arg_num_expr)->exp.operands[0]);

  if (((enum tree_code) (format_num_expr)->common.code) != INTEGER_CST
      || (((format_num_expr)->int_cst.int_cst).high) != 0
      || ((enum tree_code) (first_arg_num_expr)->common.code) != INTEGER_CST
      || (((first_arg_num_expr)->int_cst.int_cst).high) != 0)
    {
      if (validated_p)
 fancy_abort ("../../../kgccfe/gnu/c-format.c", 275, __FUNCTION__);
      error ("format string has invalid operand number");
      return 0;
    }

  info->format_num = (((format_num_expr)->int_cst.int_cst).low);
  info->first_arg_num = (((first_arg_num_expr)->int_cst.int_cst).low);
  if (info->first_arg_num != 0 && info->first_arg_num <= info->format_num)
    {
      if (validated_p)
 fancy_abort ("../../../kgccfe/gnu/c-format.c", 285, __FUNCTION__);
...
static const format_char_info print_char_table[] =
{
  ...
  { "fgG", 0, STD_C89, { { STD_C89, ((void *)0), &global_trees[TI_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) }, { STD_C99, ((void *)0), &global_trees[TI_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { STD_C89, ((void *)0), &global_trees[TI_LONG_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) } }, "-wp0 +#'", "" },
  { "eE", 0, STD_C89, { { STD_C89, ((void *)0), &global_trees[TI_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) }, { STD_C99, ((void *)0), &global_trees[TI_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { STD_C89, ((void *)0), &global_trees[TI_LONG_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) } }, "-wp0 +#", "" },
  ...
  { "F", 0, STD_C99, { { STD_C99, ((void *)0), &global_trees[TI_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) }, { STD_C99, ((void *)0), &global_trees[TI_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { STD_C99, ((void *)0), &global_trees[TI_LONG_DOUBLE_TYPE] }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) }, { 0, ((void *)0), ((void *)0) } }, "-wp0 +#'", "" },
...
static void check_format_arg (void *, tree, unsigned long long);
static void check_format_info_main (int *, format_check_results *, function_format_info *, const char *, int, tree, unsigned long long);
...
static int maybe_read_dollar_number (int *, const char **, int, tree, tree *, const format_kind_info *);


static void finish_dollar_format_checking (int *, format_check_results *, int);

static const format_flag_spec *get_flag_spec (const format_flag_spec *, int, const char *);
     ...
     tree params;
{
      ...
      if (is_attribute_p ("format", ((a)->list.purpose)))
 {
   ...
   function_format_info info;
   decode_format_attr (((a)->list.value), &info, 1);
  ...
  if (is_attribute_p ("format", ((c)->list.purpose))
      && (decode_format_type (((char *)(((((c)->list.value))->list.value))->identifier.id.str))
     ...
     tree params;
{
      ...
      if (first_arg_num > 0)
 {
   ...
   while (params)
     {
       dollar_arguments_pointer_p[i] = (((enum tree_code) (((((params)->list.value))->common.type))->common.code)
            == POINTER_TYPE);
       params = ((params)->common.chain);
       i++;
     }
  ...
  if (pedantic && !dollar_format_warned)
    {
      status_warning (status,
        ...
        (c_language == clk_cplusplus ? "ISO C++" : ((STD_EXT) == STD_EXT ? "ISO C" : "ISO C90")));
 ...
 *param_ptr = ((*param_ptr)->common.chain);
      ...
      if (*param_ptr == 0)
 {
   ...
   fancy_abort ("../../../kgccfe/gnu/c-format.c", 1199, __FUNCTION__);
 }
    }
  else
    *param_ptr = 0;
     ...
     const char *predicates;
{
 ...
 return &spec[i];
  ...
  if (predicates == ((void *)0))
    fancy_abort ("../../../kgccfe/gnu/c-format.c", 1277, __FUNCTION__);
  else
    return ((void *)0);
}
     ...
     unsigned long long arg_num;
{
   ...
   || (offset = tree_low_cst (arg1, 0)) < 0)
 {
  ...
  if (((enum tree_code) (format_tree)->common.code) == VAR_DECL
      ...
      && ((enum tree_code) (array_init)->common.code) == STRING_CST)
    {
  ...
  if (((enum tree_code) (format_tree)->common.code) != STRING_CST)
    {
      res->number_non_literal++;
      return;
    }
  ...
  format_chars = ((format_tree)->string.pointer);
  format_length = ((format_tree)->string.length);
  if (array_size != 0)
    {

      if (((enum tree_code) (array_size)->common.code) != INTEGER_CST)
 fancy_abort ("../../../kgccfe/gnu/c-format.c", 1487, __FUNCTION__);
      if (host_integerp (array_size, 0))
 {
   long long array_size_value = (((array_size)->int_cst.int_cst).low);
     ...
     unsigned long long arg_num;
{
      ...
      && strchr (fki->flag_chars, *format_chars) != 0)
 {
   ...
   if (strchr (flag_chars, *format_chars) != 0)
     {
       status_warning (status, "repeated %s in format", (s->name));
     }
   else
     {
       i = strlen (flag_chars);
   ...
   if (pedantic)
     {
       ...
       if (((int)((length_chars_std) == STD_C9L ? (warn_long_long ? STD_C99 : STD_C89) : (length_chars_std))) > ((int)(c_language == clk_cplusplus ? STD_C94 : (flag_isoc99 ? STD_C99 : (flag_isoc94 ? STD_C94 : STD_C89)))))
  status_warning (status, "%s does not support the `%s' %s length modifier",
    (c_language == clk_cplusplus ? "ISO C++" : ((length_chars_std) == STD_EXT ? "ISO C" : "ISO C90")), length_chars,
    fki->name);
     }
 }
      ...
      if (fci->format_chars == 0)
 {
   ...
   continue;
      ...
      if (pedantic)
 {
   if (((int)((fci->std) == STD_C9L ? (warn_long_long ? STD_C99 : STD_C89) : (fci->std))) > ((int)(c_language == clk_cplusplus ? STD_C94 : (flag_isoc99 ? STD_C99 : (flag_isoc94 ? STD_C94 : STD_C89)))))
     status_warning (status, "%s does not support the `%%%c' %s format",
       (c_language == clk_cplusplus ? "ISO C++" : ((fci->std) == STD_EXT ? "ISO C" : "ISO C90")), format_char, fki->name);
 }
 ...
 for (i = 0; flag_chars[i] != 0; i++)
  ...
  if (((int)((s->std) == STD_C9L ? (warn_long_long ? STD_C99 : STD_C89) : (s->std))) > ((int)(c_language == clk_cplusplus ? STD_C94 : (flag_isoc99 ? STD_C99 : (flag_isoc94 ? STD_C94 : STD_C89)))))
    status_warning (status, "%s does not support %s",
      (c_language == clk_cplusplus ? "ISO C++" : ((s->std) == STD_EXT ? "ISO C" : "ISO C90")), (s->long_name));
  ...
  if (t != ((void *)0) && ((int)((t->std) == STD_C9L ? (warn_long_long ? STD_C99 : STD_C89) : (t->std))) > ((int)((s->std) == STD_C9L ? (warn_long_long ? STD_C99 : STD_C89) : (s->std))))
    {
      const char *long_name = (t->long_name != ((void *)0)
          ? t->long_name
          : s->long_name);
      if (((int)((t->std) == STD_C9L ? (warn_long_long ? STD_C99 : STD_C89) : (t->std))) > ((int)(c_language == clk_cplusplus ? STD_C94 : (flag_isoc99 ? STD_C99 : (flag_isoc94 ? STD_C94 : STD_C89)))))
        status_warning (status, "%s does not support %s with the `%%%c' %s format",
          (c_language == clk_cplusplus ? "ISO C++" : ((t->std) == STD_EXT ? "ISO C" : "ISO C90")), (long_name),
      ...
      if (fki->flags & (int) FMT_FLAG_ARG_CONVERT)
 {
       ...
       if (params == 0)
  {
    ...
    return;
     ...
     {
       if (((int)((wanted_type_std) == STD_C9L ? (warn_long_long ? STD_C99 : STD_C89) : (wanted_type_std))) > ((int)(c_language == clk_cplusplus ? STD_C94 : (flag_isoc99 ? STD_C99 : (flag_isoc94 ? STD_C94 : STD_C89)))))
  status_warning (status, "%s does not support the `%%%s%c' %s format",
    (c_language == clk_cplusplus ? "ISO C++" : ((wanted_type_std) == STD_EXT ? "ISO C" : "ISO C90")), length_chars,
    format_char, fki->name);
     }
 }
     ...
     format_wanted_type *types;
{
 ...
 continue;
      ...
      if (wanted_type == 0)
 fancy_abort ("../../../kgccfe/gnu/c-format.c", 2202, __FUNCTION__);
      if (wanted_type == global_trees[TI_VOID_TYPE] && types->pointer_count == 0)
 fancy_abort ("../../../kgccfe/gnu/c-format.c", 2204, __FUNCTION__);
 ...
 this = ((char *)(((((wanted_type)->type.name))->decl.name))->identifier.id.str);
 that = 0;
 if (((orig_cur_type)->type.name) != 0
     && ((enum tree_code) (orig_cur_type)->common.code) != INTEGER_TYPE
     && !(((enum tree_code) (orig_cur_type)->common.code) == POINTER_TYPE
   && ((enum tree_code) (((orig_cur_type)->common.type))->common.code) == INTEGER_TYPE))
   {
     if (((enum tree_code) (((orig_cur_type)->type.name))->common.code) == TYPE_DECL
  && ((((orig_cur_type)->type.name))->decl.name) != 0)
       that = ((char *)(((((orig_cur_type)->type.name))->decl.name))->identifier.id.str);
     else
       that = ((char *)(((orig_cur_type)->type.name))->identifier.id.str);
   }
 ...
 if (that == 0)
   {
     if (((enum tree_code) (orig_cur_type)->common.code) == POINTER_TYPE)
       that = ("pointer");
     else
       that = ("different type");
   }
 ...
 if (((enum tree_code) (orig_cur_type)->common.code) == INTEGER_TYPE
     && ((enum tree_code) (wanted_type)->common.code) == INTEGER_TYPE
     && ((orig_cur_type)->type.precision) == ((wanted_type)->type.precision)
     && ((orig_cur_type)->type.name) != 0
     && ((enum tree_code) (((orig_cur_type)->type.name))->common.code) == TYPE_DECL)
   that = ((char *)(((((orig_cur_type)->type.name))->decl.name))->identifier.id.str);
