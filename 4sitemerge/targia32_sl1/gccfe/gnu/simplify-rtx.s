...
neg_const_int:
.LFB15:
	.file 1 "../../../kgccfe/gnu/simplify-rtx.c"
	.loc 1 97 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LFE21:
	...
	.section	.rodata
	.type	__FUNCTION__.13723, @object
	.size	__FUNCTION__.13723, 25
__FUNCTION__.13723:
	.string	"simplify_unary_operation"
	.align 4
.LC0:
	.string	"../../../kgccfe/gnu/simplify-rtx.c"
	.text
...
.LCFI35:
	...
	je	.L106
	.loc 1 387 0
	leal	__FUNCTION__.13723@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$387, 4(%esp)
...
.LFE22:
	...
	.section	.rodata
	.type	__FUNCTION__.14184, @object
	.size	__FUNCTION__.14184, 26
__FUNCTION__.14184:
...
.LCFI41:
	...
	jne	.L285
	.loc 1 793 0
	leal	__FUNCTION__.14184@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$793, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE25:
	...
	.section	.rodata
	.type	__FUNCTION__.15819, @object
	.size	__FUNCTION__.15819, 30
__FUNCTION__.15819:
...
.L964:
	.loc 1 1925 0
	leal	__FUNCTION__.15819@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1925, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE26:
	...
	.section	.rodata
	.type	__FUNCTION__.16371, @object
	.size	__FUNCTION__.16371, 27
__FUNCTION__.16371:
...
.L1301:
	.loc 1 2321 0
	leal	__FUNCTION__.16371@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2321, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE27:
	...
	.section	.rodata
	.type	__FUNCTION__.16614, @object
	.size	__FUNCTION__.16614, 16
__FUNCTION__.16614:
...
.L1325:
	.loc 1 2360 0
	leal	__FUNCTION__.16614@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2360, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE28:
	...
	.section	.rodata
	.type	__FUNCTION__.17290, @object
	.size	__FUNCTION__.17290, 20
__FUNCTION__.17290:
...
.L1555:
	.loc 1 2744 0
	leal	__FUNCTION__.17290@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2744, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
