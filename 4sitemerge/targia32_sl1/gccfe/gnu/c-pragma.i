...
# 157 "../../../kgccfe/gnu/c-pragma.c"
static void
handle_pragma_pack (dummy)
     cpp_reader *dummy __attribute__ ((__unused__));
{
  tree x, id = 0;
  int align = -1;
 ...
 do { warning ("malformed '#pragma pack' - ignored"); return; } while (0);
  ...
  else if (token == CPP_NAME)
    {
      ...
      const char *op = ((char *)(x)->identifier.id.str);
      if (!strcmp (op, "push"))
 action = push;
 ...
 do { warning ("alignment must be a small power of two, not %d", align); return; } while (0);
  ...
  switch (action)
    {
    case set: (maximum_field_alignment = (align)); break;
    case push: do { warning ("#pragma pack(push[, id], <n>) is not supported on this target"); return; } while (0); break;
    case pop: do { warning ("#pragma pack(pop[, id], <n>) is not supported on this target"); return; } while (0); break;
    }
}
     ...
     tree decl, value;
{
  if (value)
    {
      value = build_string (((value)->identifier.id.len),
       ((char *)(value)->identifier.id.str));
      decl_attributes (&decl, build_tree_list ((__builtin_constant_p ("alias") ? get_identifier_with_length (("alias"), (unsigned) strlen ("alias")) : (get_identifier) ("alias")),
     ...
     tree decl;
{
  ...
  for (p = &pending_weaks; (t = *p) ; p = &((t)->common.chain))
    if (id == ((t)->list.purpose))
      {
 apply_pragma_weak (decl, ((t)->list.value));
 *p = ((t)->common.chain);
 break;
      }
}
...
# 357 "../../../kgccfe/gnu/c-pragma.c"
static tree pending_redefine_extname;
# 397 "../../../kgccfe/gnu/c-pragma.c"
void
     ...
     tree decl, asmname;
{
  ...
  if (((char *)(oldname)->identifier.id.str)[0] == '*')
    {
      const char *oldasmname = ((char *)(oldname)->identifier.id.str) + 1;
      if (asmname && strcmp (((asmname)->string.pointer), oldasmname) != 0)
 warning ("asm declaration conflicts with previous rename");
...

  {
    ...
    for (p = &pending_redefine_extname; (t = *p) ; p = &((t)->common.chain))
      if (oldname == ((t)->list.purpose))
 {
   const char *newname = ((char *)(((t)->list.value))->identifier.id.str);

   if (asmname && strcmp (((asmname)->string.pointer), newname) != 0)
     ...
     cpp_reader *dummy __attribute__ ((__unused__));
{
  ...
  if (c_lex (&hint) != CPP_NAME)
    do { warning ("malformed #pragma frequency_hint, ignored"); return; } while (0);
  ...
  hint_name = ((char *)(hint)->identifier.id.str);
  if (strcmp (hint_name, "never") &&
      strcmp (hint_name, "init") &&
      strcmp (hint_name, "frequent"))
    {
      do { warning ("frequency hint should be one of \"never\",\"init\",\"frequent\", ignored"); return; } while (0);
      return;
    }
...
# 1 "../../../kgccfe/gnu/MIPS/gt-c-pragma.h" 1
# 23 "../../../kgccfe/gnu/MIPS/gt-c-pragma.h"
void
