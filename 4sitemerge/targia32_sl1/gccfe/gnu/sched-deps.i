...
# 35 "../../../kgccfe/gnu/sched-deps.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 36 "../../../kgccfe/gnu/sched-deps.c" 2
     ...
     enum reg_note dep_type;
{
 ...
 return 0;
  ...
  if (next && ((rtx_class[(int) (((enum rtx_code) (next)->code))]) == 'i') && (((next))->in_struct))
    {
# 236 "../../../kgccfe/gnu/sched-deps.c"
      rtx nnext;
      while ((nnext = next_nonnote_insn (next)) != ((void *)0)
      && ((rtx_class[(int) (((enum rtx_code) (nnext)->code))]) == 'i')
      && (((nnext))->in_struct))
 next = nnext;
...
# 268 "../../../kgccfe/gnu/sched-deps.c"
 ...
 fancy_abort ("../../../kgccfe/gnu/sched-deps.c", 273, __FUNCTION__);
      ...
      if ((((link)->fld[0]).rtx) == elem)
 {
  ...
  fancy_abort ("../../../kgccfe/gnu/sched-deps.c", 308, __FUNCTION__);
     }
  ...
  link = alloc_INSN_LIST (elem, (((insn)->fld[7]).rtx));
  (((insn)->fld[7]).rtx) = link;
     ...
     rtx elem;
{
  ...
  for (prev = 0, link = (((insn)->fld[7]).rtx); link; link = next)
    {
      next = (((link)->fld[1]).rtx);
      if ((((link)->fld[0]).rtx) == elem)
 {
 ...
 prev = link;
  ...
  if (!found)
    fancy_abort ("../../../kgccfe/gnu/sched-deps.c", 434, __FUNCTION__);
  return;
}
     ...
     rtx insn;
{
  ...
  while (insn && ((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && (((insn))->in_struct));
     ...
     rtx insn;
{
  ...
  if (find_insn_list (prev, (((insn)->fld[7]).rtx)))
    remove_dependence (insn, prev);

  for (link = (((prev)->fld[7]).rtx); link; link = (((link)->fld[1]).rtx))
    add_dependence (insn, (((link)->fld[0]).rtx), ((enum reg_note) ((enum machine_mode) (link)->mode)));
}
# 500 "../../../kgccfe/gnu/sched-deps.c"
void
     ...
     rtx insn;
{
  ...
  if (((enum rtx_code) (dest)->code) == REG)
    {
      ...
      if (regno < 176)
 {
   int i = mips_hard_regno_nregs (regno, ((enum machine_mode) (dest)->mode));
   if (code == SET)
     {
       while (--i >= 0)
      ...
      else if (regno >= deps->max_reg)
 {
   if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != USE
     ...
     fancy_abort ("../../../kgccfe/gnu/sched-deps.c", 621, __FUNCTION__);
 }
      else
 {
   if (code == SET)
      ...
      if (current_sched_info->use_cselib)
 {
   ...
   cselib_lookup ((((t)->fld[0]).rtx), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 1);
     ...
     rtx insn;
{
  ...
  switch (code)
    ...
    case LABEL_REF:
      ...
      return;
# 743 "../../../kgccfe/gnu/sched-deps.c"
    case REG:
      {
 int regno = (((x)->fld[0]).rtuint);
 if (regno < 176)
   {
     int i = mips_hard_regno_nregs (regno, ((enum machine_mode) (x)->mode));
     while (--i >= 0)
 ...
 else if (regno >= deps->max_reg)
   {
     if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != USE
  && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) != CLOBBER)
       fancy_abort ("../../../kgccfe/gnu/sched-deps.c", 759, __FUNCTION__);
   }
 else
   {
     ...
     rtx loop_notes;
{
      ...
      else
 {
   ...
   bitmap_operation (reg_pending_uses, reg_pending_uses, &tmp_uses, BITMAP_IOR);
 ...
 {
   do { bitmap_element *ptr_ = (&deps->reg_last_in_use)->first; unsigned int indx_ = (0) / ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))); unsigned bit_num_ = (0) % (unsigned) (8 * 4); unsigned word_num_ = (0) / (unsigned) (8 * 4) % ((128 + (8 * 4) - 1) / (8 * 4)); while (ptr_ != 0 && ptr_->indx < indx_) ptr_ = ptr_->next; if (ptr_ != 0 && ptr_->indx != indx_) { bit_num_ = 0; word_num_ = 0; } for (; ptr_ != 0; ptr_ = ptr_->next) { for (; word_num_ < ((128 + (8 * 4) - 1) / (8 * 4)); word_num_++) { BITMAP_WORD word_ = ptr_->bits[word_num_]; if (word_ != 0) { for (; bit_num_ < (unsigned) (8 * 4); bit_num_++) { BITMAP_WORD mask_ = ((BITMAP_WORD) 1) << bit_num_; if ((word_ & mask_) != 0) { word_ &= ~ mask_; (i) = (ptr_->indx * ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))) + word_num_ * (unsigned) (8 * 4) + bit_num_); { struct deps_reg *reg_last = &deps->reg_last[i]; add_dependence_list_and_free (insn, &reg_last->uses, REG_DEP_ANTI); add_dependence_list_and_free (insn, &reg_last->sets, 0); add_dependence_list_and_free (insn, &reg_last->clobbers, 0); reg_last->uses_length = 0; reg_last->clobbers_length = 0; }; if (word_ == 0) break; } } } bit_num_ = 0; } word_num_ = 0; } } while (0);
# 1079 "../../../kgccfe/gnu/sched-deps.c"
 }
...
# 1201 "../../../kgccfe/gnu/sched-deps.c"
  if (deps->in_post_call_group_p)
    {
      rtx tmp, set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0);
     ...
     rtx head, tail;
{
      ...
      if (((enum rtx_code) (insn)->code) == INSN || ((enum rtx_code) (insn)->code) == JUMP_INSN)
 {
  ...
  deps->last_pending_memory_flush
   ...
   sched_analyze_insn (deps, (((insn)->fld[5]).rtx), insn, loop_notes);
   loop_notes = 0;
 }
     ...
     || (((insn)->fld[5]).rtint) == NOTE_INSN_EH_REGION_END))
 {
   ...
   if ((((insn)->fld[5]).rtint) == NOTE_INSN_EH_REGION_BEG
       || (((insn)->fld[5]).rtint) == NOTE_INSN_EH_REGION_END)
     rtx_region = gen_rtx_CONST_INT (VOIDmode, (long long) ((((insn)->fld[4]).rtint)));
   else
   ...
   loop_notes = alloc_EXPR_LIST (REG_SAVE_NOTE,
     ...
     loop_notes);
   loop_notes = alloc_EXPR_LIST (REG_SAVE_NOTE,
     gen_rtx_CONST_INT (VOIDmode, (long long) ((((insn)->fld[5]).rtint))),
     loop_notes);
...
# 1387 "../../../kgccfe/gnu/sched-deps.c"
   ...
   && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == CLOBBER
          && (r0 = ((((((insn)->fld[5]).rtx))->fld[0]).rtx), ((enum rtx_code) (r0)->code) == REG)
   && ((enum rtx_code) (((((((insn)->fld[5]).rtx))->fld[0]).rtx))->code) == REG

   && (link = find_reg_note (insn, REG_LIBCALL, (rtx) 0)) != 0
   && (end_seq = (((link)->fld[0]).rtx)) != 0



   && (set = (((rtx_class[(int) (((enum rtx_code) (end_seq)->code))]) == 'i') ? (((enum rtx_code) ((((end_seq)->fld[5]).rtx))->code) == SET ? (((end_seq)->fld[5]).rtx) : single_set_2 (end_seq, (((end_seq)->fld[5]).rtx))) : (rtx) 0)) != 0
   && (((set)->fld[0]).rtx) == r0 && (((set)->fld[1]).rtx) == r0


   && find_reg_note (end_seq, REG_EQUAL, (rtx) 0) != 0
   && find_reg_note (end_seq, REG_RETVAL, (rtx) 0) != 0)
 deps->libcall_block_tail_insn = (((link)->fld[0]).rtx);
      ...
      if (insn == tail)
 {
  ...
  fancy_abort ("../../../kgccfe/gnu/sched-deps.c", 1422, __FUNCTION__);
}
...
{
  rtx new_link;
# 1457 "../../../kgccfe/gnu/sched-deps.c"
  new_link = alloc_INSN_LIST (to, (h_i_d[(((from)->fld[0]).rtint)].depend));

  ((new_link)->mode = (enum machine_mode) ((enum machine_mode) (dep_type)));

  (h_i_d[(((from)->fld[0]).rtint)].depend) = new_link;
  (h_i_d[(((to)->fld[0]).rtint)].dep_count) += 1;
}
     ...
     rtx head, tail;
{
 ...
 continue;
      ...
      for (link = (((insn)->fld[7]).rtx); link; link = (((link)->fld[1]).rtx))
 add_forward_dependence (group_leader ((((link)->fld[0]).rtx)), insn,
...
init_deps (deps)
     struct deps *deps;
{
  int max_reg = (reload_completed ? 176 : max_reg_num ());
