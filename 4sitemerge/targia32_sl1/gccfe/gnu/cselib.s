...
.LFE20:
	...
	.section	.rodata
	.type	__FUNCTION__.11429, @object
	.size	__FUNCTION__.11429, 22
__FUNCTION__.11429:
	.string	"entry_and_rtx_equal_p"
.LC0:
	.string	"../../../kgccfe/gnu/cselib.c"
	.text
...
.L31:
	.loc 1 256 0
	leal	__FUNCTION__.11429@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$256, 4(%esp)
...
.LFE25:
	...
	.section	.rodata
	.type	__FUNCTION__.11569, @object
	.size	__FUNCTION__.11569, 22
__FUNCTION__.11569:
...
.L85:
	...
	je	.L89
	.loc 1 385 0
	leal	__FUNCTION__.11569@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$385, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE26:
	...
	.section	.rodata
	.type	__FUNCTION__.11616, @object
	.size	__FUNCTION__.11616, 23
__FUNCTION__.11616:
...
.L130:
	.loc 1 521 0
	leal	__FUNCTION__.11616@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$521, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE27:
	...
	.section	.rodata
	.type	__FUNCTION__.11748, @object
	.size	__FUNCTION__.11748, 14
__FUNCTION__.11748:
...
.L158:
	...
	jne	.L163
	.loc 1 539 0
	leal	__FUNCTION__.11748@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$539, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L231:
	...
	jne	.L232
	.loc 1 700 0
	leal	__FUNCTION__.11955@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$700, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE32:
	...
	.section	.rodata
	.type	__FUNCTION__.12055, @object
	.size	__FUNCTION__.12055, 23
__FUNCTION__.12055:
...
.L269:
	...
	jne	.L270
	.loc 1 796 0
	leal	__FUNCTION__.12055@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$796, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LCFI86:
	...
	js	.L329
	.loc 1 958 0
	leal	__FUNCTION__.12280@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$958, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LEFDE60:
	...
	.file 14 "../../../kgccfe/gnu/hard-reg-set.h"
	.file 15 "../../../kgccfe/gnu/MIPS/mips.h"
	.file 16 "../../../kgccfe/gnu/flags.h"
	.file 17 "../../../kgccfe/gnu/MIPS/gt-cselib.h"
	.text
.Letext0:
