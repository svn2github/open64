...
# 37 "../../../kgccfe/gnu/c-lang.c" 2

static void c_init_options (void);
# 124 "../../../kgccfe/gnu/c-lang.c"
const struct lang_hooks lang_hooks = { "GNU C", sizeof (struct lang_identifier), c_init_options, c_common_decode_option, c_common_post_options, c_objc_common_init, c_common_finish, c_common_parse_file, lhd_clear_binding_stack, c_common_get_alias_set, lhd_return_tree, c_expand_expr, c_common_truthvalue_conversion, c_insert_default_attributes, c_safe_from_p, c_finish_incomplete_decl, c_common_unsafe_for_reeval, c_mark_addressable, c_staticp, c_dup_lang_specific_decl, lhd_unsave_expr_now, lhd_return_null_tree, lhd_set_decl_assembler_name, lhd_can_use_bit_fields_p, 0, lhd_do_nothing, lhd_print_tree_nothing, lhd_print_tree_nothing, lhd_print_tree_nothing, c_print_identifier, lhd_decl_printable_name, lhd_print_error_function, lhd_expr_size, ((void *)0), c_common_attribute_table, c_common_format_attribute_table, { lhd_do_nothing_f, lhd_do_nothing_f, c_push_function_context, c_pop_function_context }, { lhd_tree_inlining_walk_subtrees, c_cannot_inline_tree_fn, c_disregard_inline_limits, lhd_tree_inlining_add_pending_fn_decls, lhd_tree_inlining_tree_chain_matters_p, lhd_tree_inlining_auto_var_in_fn_p, lhd_tree_inlining_copy_res_decl_for_inlining, anon_aggr_type_p, hook_bool_tree_false, lhd_tree_inlining_start_inlining, lhd_tree_inlining_end_inlining, c_convert_parm_for_inlining }, { c_dump_tree, lhd_tree_dump_type_quals }, { pushlevel, poplevel, global_bindings_p, insert_block, set_block, pushdecl, getdecls, c_warn_unused_global_decl, write_global_declarations, lhd_decl_ok_for_sibcall, }, { make_node, c_common_type_for_mode, c_common_type_for_size, c_common_unsigned_type, c_common_signed_type, c_common_signed_or_unsigned_type, c_type_promotes_to, c_incomplete_type_error } };
...
'e',
# 134 "../../../kgccfe/gnu/c-lang.c" 2
};
# 143 "../../../kgccfe/gnu/c-lang.c"
...
lookup_interface (arg)
     tree arg __attribute__ ((__unused__));
{
  return 0;
}
...
objc_comptypes (lhs, rhs, reflexive)
     tree lhs __attribute__ ((__unused__));
     tree rhs __attribute__ ((__unused__));
     int reflexive __attribute__ ((__unused__));
{
  return -1;
}
...
tree
lookup_objc_ivar (id)
     tree id __attribute__ ((__unused__));
{
  return 0;
}
...
# 1 "../../../kgccfe/gnu/MIPS/gtype-c.h" 1
# 22 "../../../kgccfe/gnu/MIPS/gtype-c.h"
