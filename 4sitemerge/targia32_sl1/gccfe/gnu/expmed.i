...
# 37 "../../../kgccfe/gnu/expmed.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 38 "../../../kgccfe/gnu/expmed.c" 2
...
# 43 "../../../kgccfe/gnu/expmed.c" 2

static void store_fixed_bit_field (rtx, unsigned long long, unsigned long long, unsigned long long, rtx);


static void store_split_bit_field (rtx, unsigned long long, unsigned long long, rtx);

static rtx extract_fixed_bit_field (enum machine_mode, rtx, unsigned long long, unsigned long long, unsigned long long, rtx, int);
...
static rtx extract_split_bit_field (rtx, unsigned long long, unsigned long long, int);
...
# 101 "../../../kgccfe/gnu/expmed.c"
static int add_cost, negate_cost, zero_cost;
static int shift_cost[64];
static int shiftadd_cost[64];
static int shiftsub_cost[64];
static int mul_cost[(int) MAX_MACHINE_MODE];
static int div_cost[(int) MAX_MACHINE_MODE];
static int mul_widen_cost[(int) MAX_MACHINE_MODE];
static int mul_highpart_cost[(int) MAX_MACHINE_MODE];
...
init_expmed ()
{
  ...
  add_cost = rtx_cost (gen_rtx_fmt_ee (PLUS, (word_mode), (reg), (reg)), SET);

  shift_insn = emit_insn (gen_rtx_fmt_ee (SET, (VOIDmode), (reg), (gen_rtx_fmt_ee (ASHIFT, (word_mode), (reg), ((const_int_rtx[64]))))));



  shiftadd_insn
    = emit_insn (gen_rtx_fmt_ee (SET, (VOIDmode), (reg), (gen_rtx_fmt_ee (PLUS, (word_mode), (gen_rtx_fmt_ee (MULT, (word_mode), (reg), ((const_int_rtx[64])))), (reg)))));
  ...
  shiftsub_insn
    = emit_insn (gen_rtx_fmt_ee (SET, (VOIDmode), (reg), (gen_rtx_fmt_ee (MINUS, (word_mode), (gen_rtx_fmt_ee (MULT, (word_mode), (reg), ((const_int_rtx[64])))), (reg)))));
  ...
  for (m = 1; m < 64; m++)
    {
      rtx c_int = gen_rtx_CONST_INT (VOIDmode, (long long) ((long long) 1 << m));
      shift_cost[m] = shiftadd_cost[m] = shiftsub_cost[m] = 32000;

      (((((((((shift_insn)->fld[5]).rtx))->fld[1]).rtx))->fld[1]).rtx) = gen_rtx_CONST_INT (VOIDmode, (long long) (m));
      if (recog ((((shift_insn)->fld[5]).rtx), shift_insn, &dummy) >= 0)
 shift_cost[m] = rtx_cost (((((((shift_insn)->fld[5]).rtx))->fld[1]).rtx), SET);

      ((((((((((((shiftadd_insn)->fld[5]).rtx))->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx) = c_int;
      if (recog ((((shiftadd_insn)->fld[5]).rtx), shiftadd_insn, &dummy) >= 0)
 shiftadd_cost[m] = rtx_cost (((((((shiftadd_insn)->fld[5]).rtx))->fld[1]).rtx), SET);

      ((((((((((((shiftsub_insn)->fld[5]).rtx))->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx) = c_int;
      if (recog ((((shiftsub_insn)->fld[5]).rtx), shiftsub_insn, &dummy) >= 0)
 shiftsub_cost[m] = rtx_cost (((((((shiftsub_insn)->fld[5]).rtx))->fld[1]).rtx), SET);
    }

  negate_cost = rtx_cost (gen_rtx_fmt_e (NEG, (word_mode), (reg)), SET);

  sdiv_pow2_cheap
    = (rtx_cost (gen_rtx_fmt_ee (DIV, (word_mode), (reg), (gen_rtx_CONST_INT (VOIDmode, (long long) (32)))), SET)
       <= 2 * add_cost);
  smod_pow2_cheap
    = (rtx_cost (gen_rtx_fmt_ee (MOD, (word_mode), (reg), (gen_rtx_CONST_INT (VOIDmode, (long long) (32)))), SET)
       <= 2 * add_cost);
  ...
  for (mode = class_narrowest_mode[(int) (MODE_INT)];
       ...
       mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
    {
      ...
      div_cost[(int) mode] = rtx_cost (gen_rtx_fmt_ee (UDIV, (mode), (reg), (reg)), SET);
      mul_cost[(int) mode] = rtx_cost (gen_rtx_fmt_ee (MULT, (mode), (reg), (reg)), SET);
      wider_mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]);
      if (wider_mode != VOIDmode)
 {
   ...
   mul_highpart_cost[(int) mode]
     = rtx_cost (gen_rtx_fmt_e (TRUNCATE, (mode), (gen_rtx_fmt_ee (LSHIFTRT, (wider_mode), (gen_rtx_fmt_ee (MULT, (wider_mode), (gen_rtx_fmt_e (ZERO_EXTEND, (wider_mode), (reg))), (gen_rtx_fmt_e (ZERO_EXTEND, (wider_mode), (reg))))), (gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_bitsize[(int) (mode)]))))))),
# 202 "../../../kgccfe/gnu/expmed.c"
   SET);
 }
    }
     ...
     int opno;
{
      ...
      if ((!(target_flags & 0x00100000)))
 {
   ...
   break;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/expmed.c", 264, __FUNCTION__);
    }
...
{
  unsigned int unit
    = (((enum rtx_code) (str_rtx)->code) == MEM) ? 8 : (8 * ((target_flags & 0x00002000) ? 8 : 4));
  unsigned long long offset = bitnum / unit;
  unsigned long long bitpos = bitnum % unit;
  rtx op0 = str_rtx;
  int byte_offset;
  ...
  if (total_size >= 0)
    total_size -= (bitpos / (mips_abi == 1 || mips_abi == 2 ? 128 : 64)
     * ((mips_abi == 1 || mips_abi == 2 ? 128 : 64) / 8));
  ...
  while (((enum rtx_code) (op0)->code) == SUBREG)
    {
      ...
      offset += ((((op0)->fld[1]).rtuint) / ((target_flags & 0x00002000) ? 8 : 4));
...
# 347 "../../../kgccfe/gnu/expmed.c"
  byte_offset = (bitnum % (8 * ((target_flags & 0x00002000) ? 8 : 4))) / 8
                + (offset * ((target_flags & 0x00002000) ? 8 : 4));

  if (bitpos == 0
      && bitsize == (mode_bitsize[(int) (fieldmode)])
      && (((enum rtx_code) (op0)->code) != MEM
   ? (((mode_size[(int) (fieldmode)]) >= ((target_flags & 0x00002000) ? 8 : 4)
      || (mode_size[(int) (((enum machine_mode) (op0)->mode))]) == (mode_size[(int) (fieldmode)]))
      && byte_offset % (mode_size[(int) (fieldmode)]) == 0)
   : (! 1
      || (offset * 8 % bitsize == 0
   && ((((op0)->fld[1]).rtmem) != 0 ? (((op0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (op0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (op0)->mode)) : 8)) % (mode_bitsize[(int) (fieldmode)]) == 0))))
    {
      if (((enum machine_mode) (op0)->mode) != fieldmode)
 {
   if (((enum rtx_code) (op0)->code) == SUBREG)
     {
       if (((enum machine_mode) ((((op0)->fld[0]).rtx))->mode) == fieldmode
    || (mode_class[(int) (fieldmode)]) == MODE_INT
    || (mode_class[(int) (fieldmode)]) == MODE_PARTIAL_INT)
  op0 = (((op0)->fld[0]).rtx);
       else



  fancy_abort ("../../../kgccfe/gnu/expmed.c", 372, __FUNCTION__);
     }
 ...
 if (((enum rtx_code) (op0)->code) == MEM)
   ...
   fancy_abort ("../../../kgccfe/gnu/expmed.c", 396, __FUNCTION__);
      }
  }
  ...
  if (((target_flags & 0x00010000) != 0)
      && ((enum rtx_code) (op0)->code) != MEM
      && unit > (mode_bitsize[(int) (((enum machine_mode) (op0)->mode))]))
    bitpos += unit - (mode_bitsize[(int) (((enum machine_mode) (op0)->mode))]);




  if (((enum rtx_code) (op0)->code) != MEM
      && (((target_flags & 0x00010000) != 0) ? bitpos + bitsize == unit : bitpos == 0)
      && bitsize == (mode_bitsize[(int) (fieldmode)])
      && ((optab_table[OTI_movstrict])->handlers[(int) fieldmode].insn_code
   != CODE_FOR_nothing))
    {
      int icode = (optab_table[OTI_movstrict])->handlers[(int) fieldmode].insn_code;


      if (((enum rtx_code) (value)->code) == CONST_INT || ((enum rtx_code) (value)->code) == REG)
 value = gen_lowpart (fieldmode, value);
      else if (!(((enum rtx_code) (value)->code) == SYMBOL_REF
   || ((enum rtx_code) (value)->code) == LABEL_REF
   || ((enum rtx_code) (value)->code) == CONST))
      ...
      if (((enum rtx_code) (op0)->code) == SUBREG)
 {
   if (((enum machine_mode) ((((op0)->fld[0]).rtx))->mode) == fieldmode
     ...
     fancy_abort ("../../../kgccfe/gnu/expmed.c", 449, __FUNCTION__);
 }

      emit_insn ((*insn_data[(int) (icode)].genfun)
   (gen_rtx_SUBREG (fieldmode, op0,
      (bitnum % (8 * ((target_flags & 0x00002000) ? 8 : 4))) / 8
      + (offset * ((target_flags & 0x00002000) ? 8 : 4))),
      value));
  ...
  if (bitsize > (8 * ((target_flags & 0x00002000) ? 8 : 4)))
    {
      ...
      unsigned int backwards = ((target_flags & 0x00010000) != 0) && fieldmode != BLKmode;
      unsigned int nwords = (bitsize + ((8 * ((target_flags & 0x00002000) ? 8 : 4)) - 1)) / (8 * ((target_flags & 0x00002000) ? 8 : 4));
      unsigned int i;
      ...
      fieldmode = smallest_mode_for_size (nwords * (8 * ((target_flags & 0x00002000) ? 8 : 4)), MODE_INT);
      ...
      for (i = 0; i < nwords; i++)
 {
   ...
   unsigned int bit_offset = (backwards
         ? (((int) bitsize - ((int) i + 1) * (8 * ((target_flags & 0x00002000) ? 8 : 4))) > (0) ? ((int) bitsize - ((int) i + 1) * (8 * ((target_flags & 0x00002000) ? 8 : 4))) : (0))


         : (int) i * (8 * ((target_flags & 0x00002000) ? 8 : 4)));

   store_bit_field (op0, (((8 * ((target_flags & 0x00002000) ? 8 : 4))) < (bitsize - i * (8 * ((target_flags & 0x00002000) ? 8 : 4))) ? ((8 * ((target_flags & 0x00002000) ? 8 : 4))) : (bitsize - i * (8 * ((target_flags & 0x00002000) ? 8 : 4)))),

      bitnum + bit_offset, word_mode,
      operand_subword_force (value, wordnum,
        (((enum machine_mode) (value)->mode) == VOIDmode
         ? fieldmode
         : ((enum machine_mode) (value)->mode))),
      total_size);
 }
      return value;
    }
   ...
   || (mode_size[(int) (((enum machine_mode) (op0)->mode))]) > ((target_flags & 0x00002000) ? 8 : 4))
 {
  ...
  fancy_abort ("../../../kgccfe/gnu/expmed.c", 527, __FUNCTION__);
     }
   op0 = gen_rtx_SUBREG (mode_for_size ((8 * ((target_flags & 0x00002000) ? 8 : 4)), MODE_INT, 0),
                  op0, (offset * ((target_flags & 0x00002000) ? 8 : 4)));
 }
      offset = 0;
    }
  else
  ...
  if ((mode_class[(int) (((enum machine_mode) (value)->mode))]) != MODE_INT
      && (mode_class[(int) (((enum machine_mode) (value)->mode))]) != MODE_PARTIAL_INT)
    value = gen_lowpart ((((enum machine_mode) (value)->mode) == VOIDmode
     ? word_mode : int_mode_for_mode (((enum machine_mode) (value)->mode))),
    value);
  ...
  if ((!(target_flags & 0x00100000))
      && ((enum machine_mode) (value)->mode) != BLKmode
      && !(bitsize == 1 && ((enum rtx_code) (value)->code) == CONST_INT)

      && ((mode_bitsize[(int) (op_mode)]) >= bitsize)
      && ! ((((enum rtx_code) (op0)->code) == REG || ((enum rtx_code) (op0)->code) == SUBREG)
     && (bitsize + bitpos > (mode_bitsize[(int) (op_mode)]))))
    {
      int xbitpos = bitpos;
      rtx value1;
      rtx xop0 = op0;
  ...
  (op0, VOIDmode)))
 {
   ...
   if (((enum machine_mode) (op0)->mode) == BLKmode
       || (mode_size[(int) (((enum machine_mode) (op0)->mode))]) > (mode_size[(int) (maxmode)]))
     bestmode
       = get_best_mode (bitsize, bitnum, ((((op0)->fld[1]).rtmem) != 0 ? (((op0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (op0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (op0)->mode)) : 8)), maxmode,
          (((op0))->volatil));
   else
   ...
   if (bestmode == VOIDmode
       || (1
    && (mode_bitsize[(int) (bestmode)]) > ((((op0)->fld[1]).rtmem) != 0 ? (((op0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (op0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (op0)->mode)) : 8))))
     goto insv_loses;



   unit = (mode_bitsize[(int) (bestmode)]);
   offset = (bitnum / unit) * (mode_size[(int) (bestmode)]);
   bitpos = bitnum % unit;
 ...
 xop0 = gen_rtx_SUBREG (maxmode, (((xop0)->fld[0]).rtx), (((xop0)->fld[1]).rtuint));
 ...
 xop0 = gen_rtx_SUBREG (maxmode, xop0, 0);
      ...
      if (0 != ((target_flags & 0x00010000) != 0))
 xbitpos = unit - bitsize - xbitpos;



      if (0 && ((enum rtx_code) (xop0)->code) != MEM)
 xbitpos += (mode_bitsize[(int) (maxmode)]) - unit;

      unit = (mode_bitsize[(int) (maxmode)]);


      value1 = value;
      if (((enum machine_mode) (value)->mode) != maxmode)
 {
   if ((mode_bitsize[(int) (((enum machine_mode) (value)->mode))]) >= bitsize)
     {




       if ((mode_size[(int) (((enum machine_mode) (value)->mode))]) < (mode_size[(int) (maxmode)]))
  {
    rtx tmp;

    tmp = simplify_subreg (maxmode, value1, ((enum machine_mode) (value)->mode), 0);
    if (! tmp)
      tmp = simplify_gen_subreg (maxmode,
            force_reg (((enum machine_mode) (value)->mode),
         value1),
            ((enum machine_mode) (value)->mode), 0);
    value1 = tmp;
  }
       else
  value1 = gen_lowpart (maxmode, value1);
     }
   else if (((enum rtx_code) (value)->code) == CONST_INT)
     value1 = gen_int_mode ((((value)->fld[0]).rtwint), maxmode);
   else if (!(((enum rtx_code) (value)->code) == LABEL_REF || ((enum rtx_code) (value)->code) == SYMBOL_REF || ((enum rtx_code) (value)->code) == CONST_INT || ((enum rtx_code) (value)->code) == CONST_DOUBLE || ((enum rtx_code) (value)->code) == CONST || ((enum rtx_code) (value)->code) == HIGH || ((enum rtx_code) (value)->code) == CONST_VECTOR || ((enum rtx_code) (value)->code) == CONSTANT_P_RTX))




     fancy_abort ("../../../kgccfe/gnu/expmed.c", 672, __FUNCTION__);
 }
 ...
 value1 = force_reg (maxmode, value1);
      ...
      pat = gen_insv (xop0, gen_rtx_CONST_INT (VOIDmode, (long long) (bitsize)), gen_rtx_CONST_INT (VOIDmode, (long long) (xbitpos)), value1);
      if (pat)
 emit_insn (pat);
      else
 {
...
# 708 "../../../kgccfe/gnu/expmed.c"
static void
store_fixed_bit_field (op0, offset, bitsize, bitpos, value)
     rtx op0;
     unsigned long long offset, bitsize, bitpos;
     rtx value;
{
  enum machine_mode mode;
  unsigned int total_bits = (8 * ((target_flags & 0x00002000) ? 8 : 4));
  rtx subtarget, temp;
  int all_zero = 0;
  int all_one = 0;
# 727 "../../../kgccfe/gnu/expmed.c"
  if (((enum rtx_code) (op0)->code) == REG || ((enum rtx_code) (op0)->code) == SUBREG)
    {
      if (offset != 0)
 fancy_abort ("../../../kgccfe/gnu/expmed.c", 730, __FUNCTION__);

      if (bitsize + bitpos > (8 * ((target_flags & 0x00002000) ? 8 : 4)))
 {
   ...
   return;
  ...
  else
    {
      ...
      if ((mode_bitsize[(int) (mode)]) == 0
   || (mode_bitsize[(int) (mode)]) > (mode_bitsize[(int) (word_mode)]))
 mode = word_mode;
      mode = get_best_mode (bitsize, bitpos + offset * 8,
       ((((op0)->fld[1]).rtmem) != 0 ? (((op0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (op0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (op0)->mode)) : 8)), mode, (((op0))->volatil));
      ...
      if (mode == VOIDmode)
 {
   ...
   return;
      ...
      total_bits = (mode_bitsize[(int) (mode)]);
      ...
      if (bitpos >= total_bits)
 {
  ...
  if (((enum rtx_code) (value)->code) == CONST_INT)
    {
      long long v = (((value)->fld[0]).rtwint);

      if (bitsize < (8 * 8))
 v &= ((long long) 1 << bitsize) - 1;
 ...
 all_one = 1;
    ...
    {
      int must_and = ((mode_bitsize[(int) (((enum machine_mode) (value)->mode))]) != bitsize
        && bitpos + bitsize != (mode_bitsize[(int) (mode)]));

      if (((enum machine_mode) (value)->mode) != mode)
 {
   if ((((enum rtx_code) (value)->code) == REG || ((enum rtx_code) (value)->code) == SUBREG)
       && (mode_size[(int) (mode)]) < (mode_size[(int) (((enum machine_mode) (value)->mode))]))
     ...
     value = convert_to_mode (mode, value, 1);
      ...
      if (must_and)
 value = expand_binop (mode, (optab_table[OTI_and]), value,
         mask_rtx (mode, 0, bitsize, 0),
         (rtx) 0, 1, OPTAB_LIB_WIDEN);
      if (bitpos > 0)
 value = expand_shift (LSHIFT_EXPR, mode, value,
         build_int_2_wide ((unsigned long long) (bitpos), (long long) (0)), (rtx) 0, 1);
    }
  ...
  if (! all_zero)
    temp = expand_binop (mode, (optab_table[OTI_ior]), temp, value,
    subtarget, 1, OPTAB_LIB_WIDEN);
  if (op0 != temp)
    emit_move_insn (op0, temp);
}
# 874 "../../../kgccfe/gnu/expmed.c"
static void
store_split_bit_field (op0, bitsize, bitpos, value)
     rtx op0;
     unsigned long long bitsize, bitpos;
     rtx value;
{
  unsigned int unit;
  ...
  if (((enum rtx_code) (op0)->code) == REG || ((enum rtx_code) (op0)->code) == SUBREG)
    unit = (8 * ((target_flags & 0x00002000) ? 8 : 4));
  else
    unit = ((((((op0)->fld[1]).rtmem) != 0 ? (((op0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (op0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (op0)->mode)) : 8))) < ((8 * ((target_flags & 0x00002000) ? 8 : 4))) ? (((((op0)->fld[1]).rtmem) != 0 ? (((op0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (op0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (op0)->mode)) : 8))) : ((8 * ((target_flags & 0x00002000) ? 8 : 4))));
  ...
  if ((((enum rtx_code) (value)->code) == LABEL_REF || ((enum rtx_code) (value)->code) == SYMBOL_REF || ((enum rtx_code) (value)->code) == CONST_INT || ((enum rtx_code) (value)->code) == CONST_DOUBLE || ((enum rtx_code) (value)->code) == CONST || ((enum rtx_code) (value)->code) == HIGH || ((enum rtx_code) (value)->code) == CONST_VECTOR || ((enum rtx_code) (value)->code) == CONSTANT_P_RTX) && ((enum rtx_code) (value)->code) != CONST_INT)
    {
 ...
 value = gen_lowpart_common (word_mode,
        force_reg (((enum machine_mode) (value)->mode) != VOIDmode
            ? ((enum machine_mode) (value)->mode)
            : word_mode, value));
    }
  else if (((enum rtx_code) (value)->code) == ADDRESSOF)
    value = copy_to_reg (value);

  while (bitsdone < bitsize)
    {
      unsigned long long thissize;
      rtx part, word;
      unsigned long long thispos;
      ...
      thissize = ((bitsize - bitsdone) < ((8 * ((target_flags & 0x00002000) ? 8 : 4))) ? (bitsize - bitsdone) : ((8 * ((target_flags & 0x00002000) ? 8 : 4))));
      ...
      if (((target_flags & 0x00010000) != 0))
 {
   ...
   if (((enum rtx_code) (value)->code) != MEM || ((enum machine_mode) (value)->mode) == BLKmode)
     total_bits = (8 * ((target_flags & 0x00002000) ? 8 : 4));
   else
     total_bits = (mode_bitsize[(int) (((enum machine_mode) (value)->mode))]);


   if (((enum rtx_code) (value)->code) == CONST_INT)
     part = gen_rtx_CONST_INT (VOIDmode, (long long) (((unsigned long long) ((((value)->fld[0]).rtwint)) >> (bitsize - bitsdone - thissize)) & (((long long) 1 << thissize) - 1)));
      ...
      else
 {
   ...
   if (((enum rtx_code) (value)->code) == CONST_INT)
     part = gen_rtx_CONST_INT (VOIDmode, (long long) (((unsigned long long) ((((value)->fld[0]).rtwint)) >> bitsdone) & (((long long) 1 << thissize) - 1)));
     ...
     part = extract_fixed_bit_field (word_mode, value, 0, thissize,
      ...
      if (((enum rtx_code) (op0)->code) == SUBREG)
 {
   int word_offset = ((((op0)->fld[1]).rtuint) / ((target_flags & 0x00002000) ? 8 : 4)) + offset;
   word = operand_subword_force ((((op0)->fld[0]).rtx), word_offset,
     ...
     long long total_size;
{
      ...
      if (bitpos > unit)
 {
  ...
  if (((enum rtx_code) (op0)->code) == REG
      && mode == ((enum machine_mode) (op0)->mode)
      && bitnum == 0
      && bitsize == (mode_bitsize[(int) (((enum machine_mode) (op0)->mode))]))
    {
 ...
 if (((enum rtx_code) (op0)->code) == MEM)
   ...
   fancy_abort ("../../../kgccfe/gnu/expmed.c", 1079, __FUNCTION__);
      }
  }
  ...
  byte_offset = bitpos / 8 + offset * ((target_flags & 0x00002000) ? 8 : 4);
  ...
  mode1 = (((mode_class[(int) (tmode)]) == MODE_VECTOR_INT || (mode_class[(int) (tmode)]) == MODE_VECTOR_FLOAT)
     ? mode
     : mode_for_size (bitsize, (mode_class[(int) (tmode)]), 0));

  if (((((enum rtx_code) (op0)->code) != MEM
 && ((target_flags & 0x00002000) ? (((mode_bitsize[(int) (((enum machine_mode) (op0)->mode))])) <= 32 || ((mode_bitsize[(int) (mode)])) > 32) : 1)

 && (mode_size[(int) (mode1)]) != 0
 && byte_offset % (mode_size[(int) (mode1)]) == 0)
       || (((enum rtx_code) (op0)->code) == MEM
    && (! 1
        || (offset * 8 % bitsize == 0
     && ((((op0)->fld[1]).rtmem) != 0 ? (((op0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (op0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (op0)->mode)) : 8)) % bitsize == 0))))
      && ((bitsize >= (8 * ((target_flags & 0x00002000) ? 8 : 4)) && bitsize == (mode_bitsize[(int) (mode)])
    && bitpos % (8 * ((target_flags & 0x00002000) ? 8 : 4)) == 0)
   || (mode_for_size (bitsize, (mode_class[(int) (tmode)]), 0) != BLKmode




       && (((target_flags & 0x00010000) != 0)
    ? bitpos + bitsize == (8 * ((target_flags & 0x00002000) ? 8 : 4))
    : bitpos == 0))))
    {
      if (mode1 != ((enum machine_mode) (op0)->mode))
 {
   if (((enum rtx_code) (op0)->code) == SUBREG)
     {
       if (((enum machine_mode) ((((op0)->fld[0]).rtx))->mode) == mode1
    || (mode_class[(int) (mode1)]) == MODE_INT
    || (mode_class[(int) (mode1)]) == MODE_PARTIAL_INT)
  op0 = (((op0)->fld[0]).rtx);
       else
      ...
      for (i = 0; i < nwords; i++)
 {
   ...
   unsigned int wordnum
     = (((target_flags & 0x00010000) != 0)
        ? (mode_size[(int) (((enum machine_mode) (target)->mode))]) / ((target_flags & 0x00002000) ? 8 : 4) - i - 1
        : i);

   unsigned int bit_offset = (((target_flags & 0x00010000) != 0)
         ? ((0) > (((int) bitsize - ((int) i + 1) * (int) (8 * ((target_flags & 0x00002000) ? 8 : 4)))) ? (0) : (((int) bitsize - ((int) i + 1) * (int) (8 * ((target_flags & 0x00002000) ? 8 : 4)))))

         : (int) i * (8 * ((target_flags & 0x00002000) ? 8 : 4)));
   rtx target_part = operand_subword (target, wordnum, 1, VOIDmode);
   rtx result_part
     = extract_bit_field (op0, (((8 * ((target_flags & 0x00002000) ? 8 : 4))) < (bitsize - i * (8 * ((target_flags & 0x00002000) ? 8 : 4))) ? ((8 * ((target_flags & 0x00002000) ? 8 : 4))) : (bitsize - i * (8 * ((target_flags & 0x00002000) ? 8 : 4)))),

     bitnum + bit_offset, 1, target_part, mode,
     word_mode, total_size);

   if (target_part == 0)
     fancy_abort ("../../../kgccfe/gnu/expmed.c", 1201, __FUNCTION__);
      ...
      if (unsignedp)
 {
   ...
   if ((mode_size[(int) (((enum machine_mode) (target)->mode))]) > nwords * ((target_flags & 0x00002000) ? 8 : 4))
     {
       unsigned int i, total_words;

       total_words = (mode_size[(int) (((enum machine_mode) (target)->mode))]) / ((target_flags & 0x00002000) ? 8 : 4);
       for (i = nwords; i < total_words; i++)
  emit_move_insn
    (operand_subword (target,
        ((target_flags & 0x00010000) != 0) ? total_words - i - 1 : i,
        1, VOIDmode),
     (const_int_rtx[64]));
     }
   return target;
      ...
      target = expand_shift (LSHIFT_EXPR, mode, target,
        build_int_2_wide ((unsigned long long) ((mode_bitsize[(int) (mode)]) - bitsize), (long long) (0)),
        (rtx) 0, 0);
      return expand_shift (RSHIFT_EXPR, mode, target,
      build_int_2_wide ((unsigned long long) ((mode_bitsize[(int) (mode)]) - bitsize), (long long) (0)),
      (rtx) 0, 0);
    }
# 1242 "../../../kgccfe/gnu/expmed.c"
  int_mode = int_mode_for_mode (tmode);
  if (int_mode == BLKmode)
    int_mode = int_mode_for_mode (mode);
  if (int_mode == BLKmode)
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 1246, __FUNCTION__);
   ...
   || (mode_size[(int) (((enum machine_mode) (op0)->mode))]) > ((target_flags & 0x00002000) ? 8 : 4))
 {
  ...
  if (unsignedp)
    {
      if ((!(target_flags & 0x00100000))
   && ((mode_bitsize[(int) (extzv_mode)]) >= bitsize)
   && ! ((((enum rtx_code) (op0)->code) == REG || ((enum rtx_code) (op0)->code) == SUBREG)
  && (bitsize + bitpos > (mode_bitsize[(int) (extzv_mode)]))))
 {
   unsigned long long xbitpos = bitpos, xoffset = offset;
       ...
       (xop0, ((enum machine_mode) (xop0)->mode))))
  {
    ...
    if (((enum machine_mode) (xop0)->mode) == BLKmode
        || ((mode_size[(int) (((enum machine_mode) (op0)->mode))])
     > (mode_size[(int) (maxmode)])))
      bestmode = get_best_mode (bitsize, bitnum,
           ((((xop0)->fld[1]).rtmem) != 0 ? (((xop0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (xop0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (xop0)->mode)) : 8)), maxmode,
           (((xop0))->volatil));
    else
    ...
    if (bestmode == VOIDmode
        || (1
     && (mode_bitsize[(int) (bestmode)]) > ((((xop0)->fld[1]).rtmem) != 0 ? (((xop0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (xop0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (xop0)->mode)) : 8))))
      goto extzv_loses;



    unit = (mode_bitsize[(int) (bestmode)]);
    xoffset = (bitnum / unit) * (mode_size[(int) (bestmode)]);
    xbitpos = bitnum % unit;
  ...
  {
    int wider = ((mode_size[(int) (maxmode)])
          > (mode_size[(int) (((enum machine_mode) (xtarget)->mode))]));
  ...
  xtarget = gen_reg_rtx (maxmode);
   ...
   bitsize_rtx = gen_rtx_CONST_INT (VOIDmode, (long long) (bitsize));
   bitpos_rtx = gen_rtx_CONST_INT (VOIDmode, (long long) (xbitpos));
 ...
 target = extract_fixed_bit_field (int_mode, op0, offset, bitsize,
    ...
    {
      if ((!(target_flags & 0x00100000))
   && ((mode_bitsize[(int) (extv_mode)]) >= bitsize)
   && ! ((((enum rtx_code) (op0)->code) == REG || ((enum rtx_code) (op0)->code) == SUBREG)
  && (bitsize + bitpos > (mode_bitsize[(int) (extv_mode)]))))
 {
  ...
  if (((enum machine_mode) (target)->mode) != tmode && ((enum machine_mode) (target)->mode) != mode)
    {
      ...
      if ((mode_class[(int) (tmode)]) != MODE_INT
   && (mode_class[(int) (tmode)]) != MODE_PARTIAL_INT)
 {
   target = convert_to_mode (mode_for_size ((mode_bitsize[(int) (tmode)]),
         MODE_INT, 0),
        target, unsignedp);
     ...
     int unsignedp;
{
 ...
 return extract_split_bit_field (op0, bitsize, bitpos, unsignedp);
  ...
  else
    {
      ...
      mode = get_best_mode (bitsize, bitpos + offset * 8,
       ((((op0)->fld[1]).rtmem) != 0 ? (((op0)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (op0)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (op0)->mode)) : 8)), word_mode, (((op0))->volatil));
      ...
      if (bitpos)
 {
   ...
   tree amount = build_int_2_wide ((unsigned long long) (bitpos), (long long) (0));


   rtx subtarget = (target != 0 && ((enum rtx_code) (target)->code) == REG
      && !(((target))->integrated)
      ? target : 0);
 ...
 op0 = convert_to_mode (tmode, op0, 1);
      ...
      if ((mode_bitsize[(int) (mode)]) != bitpos + bitsize)
 return expand_binop (((enum machine_mode) (op0)->mode), (optab_table[OTI_and]), op0,
  ...
  for (mode = class_narrowest_mode[(int) (MODE_INT)]; mode != VOIDmode;
       mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]))
    if ((mode_bitsize[(int) (mode)]) >= bitsize + bitpos)
      {
 ...
 break;
  ...
  if ((mode_bitsize[(int) (mode)]) != (bitsize + bitpos))
    {
      tree amount
 = build_int_2_wide ((unsigned long long) ((mode_bitsize[(int) (mode)]) - (bitsize + bitpos)), (long long) (0));
...
{
  long long masklow, maskhigh;

  if (bitpos < (8 * 8))
    masklow = (long long) -1 << bitpos;
  else
    masklow = 0;

  if (bitpos + bitsize < (8 * 8))
    masklow &= ((unsigned long long) -1
  >> ((8 * 8) - bitpos - bitsize));

  if (bitpos <= (8 * 8))
    maskhigh = -1;
  else
    maskhigh = (long long) -1 << (bitpos - (8 * 8));

  if (bitpos + bitsize > (8 * 8))
    maskhigh &= ((unsigned long long) -1
   >> (2 * (8 * 8) - bitpos - bitsize));
  else
    maskhigh = 0;
...
lshift_value (mode, value, bitpos, bitsize)
     ...
     int bitpos, bitsize;
{
  unsigned long long v = (((value)->fld[0]).rtwint);
  long long low, high;

  if (bitsize < (8 * 8))
    v &= ~((long long) -1 << bitsize);

  if (bitpos < (8 * 8))
    {
      low = v << bitpos;
      high = (bitpos > 0 ? (v >> ((8 * 8) - bitpos)) : 0);
    }
  else
    {
      low = 0;
     ...
     int unsignedp;
{
      ...
      if (((target_flags & 0x00010000) != 0))
 {
   if (bitsize != bitsdone)
     ...
     build_int_2_wide ((unsigned long long) (bitsize - bitsdone), (long long) (0)), 0, 1);
 }
      else
 {
   if (bitsdone != thissize)
     part = expand_shift (LSHIFT_EXPR, word_mode, part,
     build_int_2_wide ((unsigned long long) (bitsdone - thissize), (long long) (0)), 0, 1);
 }
 ...
 result = expand_binop (word_mode, (optab_table[OTI_ior]), part, result, (rtx) 0, 1,
  ...
  return expand_shift (RSHIFT_EXPR, word_mode, result,
         build_int_2_wide ((unsigned long long) ((8 * ((target_flags & 0x00002000) ? 8 : 4)) - bitsize), (long long) (0)), (rtx) 0, 0);
}
...
expand_inc (target, inc)
     rtx target, inc;
{
  rtx value = expand_binop (((enum machine_mode) (target)->mode), (optab_table[OTI_add]),
       target, inc,
...
expand_dec (target, dec)
     rtx target, dec;
{
  rtx value = expand_binop (((enum machine_mode) (target)->mode), (optab_table[OTI_sub]),
       target, dec,
       target, 0, OPTAB_LIB_WIDEN);
  if (value != target)
    emit_move_insn (target, value);
}
# 1908 "../../../kgccfe/gnu/expmed.c"
rtx
     ...
     int unsignedp;
{
  ...
  if (1)
   ...
   && ((unsigned long long) (((op1)->fld[0]).rtwint) >=
       (unsigned long long) (mode_bitsize[(int) (mode)])))
 op1 = gen_rtx_CONST_INT (VOIDmode, (long long) ((unsigned long long) (((op1)->fld[0]).rtwint) % (mode_bitsize[(int) (mode)])));
...
# 1975 "../../../kgccfe/gnu/expmed.c"
  ...
  = fold (build (MINUS_EXPR, type,
          convert (type,
     build_int_2_wide ((unsigned long long) ((mode_bitsize[(int) (mode)])), (long long) (0))),
   ...
   if (temp == 0 && ((enum rtx_code) (op1)->code) == CONST_INT
       && (((op1)->fld[0]).rtwint) > 0
       && (unsigned int) (((op1)->fld[0]).rtwint) < (mode_bitsize[(int) (mode)]))
     temp = expand_binop (mode,
     left ? (optab_table[OTI_rotr]) : (optab_table[OTI_rotl]),
     shifted,
     gen_rtx_CONST_INT (VOIDmode, (long long) ((mode_bitsize[(int) (mode)]) - (((op1)->fld[0]).rtwint))),
   ...
   && (! unsignedp || (! left && methods == OPTAB_WIDEN)))
 {
  ...
  if (temp == 0)
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 2045, __FUNCTION__);
  return temp;
}
...
static void synth_mult (struct algorithm *, unsigned long long, int);


static unsigned long long choose_multiplier (unsigned long long, int, int, unsigned long long *, int *, int *);



static unsigned long long invert_mod2n (unsigned long long, int);
     ...
     int cost_limit;
{
      ...
      else
 {
  ...
  alg_in = (struct algorithm *)__builtin_alloca(sizeof (struct algorithm));
  best_alg = (struct algorithm *)__builtin_alloca(sizeof (struct algorithm));
  ...
  if ((t & 1) == 0)
    {
      m = floor_log2_wide ((unsigned long long) (t & -t));
      if (m < (8 * ((target_flags & 0x00002000) ? 8 : 4)))
 {
   q = t >> m;
   cost = shift_cost[m];
...
# 2234 "../../../kgccfe/gnu/expmed.c"
  for (m = floor_log2_wide ((unsigned long long) (t - 1)); m >= 2; m--)
    {
      unsigned long long d;

      d = ((unsigned long long) 1 << m) + 1;
      if (t % d == 0 && t > d && m < (8 * ((target_flags & 0x00002000) ? 8 : 4)))
 {
   cost = ((shiftadd_cost[m]) < (add_cost + shift_cost[m]) ? (shiftadd_cost[m]) : (add_cost + shift_cost[m]));
   ...
   break;
      ...
      if (t % d == 0 && t > d && m < (8 * ((target_flags & 0x00002000) ? 8 : 4)))
 {
   cost = ((shiftsub_cost[m]) < (add_cost + shift_cost[m]) ? (shiftsub_cost[m]) : (add_cost + shift_cost[m]));
   synth_mult (alg_in, t / d, cost_limit - cost);
  ...
  if ((t & 1) != 0)
    {
      q = t - 1;
      q = q & -q;
      m = exact_log2_wide ((unsigned long long) (q));
      if (m >= 0 && m < (8 * ((target_flags & 0x00002000) ? 8 : 4)))
 {
...
{
  rtx const_op1 = op1;
# 2365 "../../../kgccfe/gnu/expmed.c"
  if (((enum rtx_code) (op1)->code) == CONST_DOUBLE
      && (mode_class[(int) (((enum machine_mode) (op1)->mode))]) == MODE_INT
      && (8 * 4) >= (8 * ((target_flags & 0x00002000) ? 8 : 4))
      && (((op1)->fld[1]).rtwint) == 0)
    const_op1 = gen_rtx_CONST_INT (VOIDmode, (long long) ((((op1)->fld[0]).rtwint)));
  else if ((8 * 4) < (mode_bitsize[(int) (mode)])
  ...
  if (const_op1 && ((enum rtx_code) (const_op1)->code) == CONST_INT
      && (unsignedp || ! flag_trapv))
    {
      ...
      long long val = (((op1)->fld[0]).rtwint);
      long long val_so_far;
      rtx insn;
      int mult_cost;
      ...
      mult_cost = rtx_cost (gen_rtx_fmt_ee (MULT, (mode), (op0), (op1)), SET);
      mult_cost = ((12 * add_cost) < (mult_cost) ? (12 * add_cost) : (mult_cost));

      synth_mult (&alg, val, mult_cost);



      if ((8 * 4) >= (mode_bitsize[(int) (mode)]))
 {
   synth_mult (&alg2, - val,
      ...
      if (alg.cost < mult_cost)
 {
   ...
   if (alg.op[0] == alg_zero)
     ...
     fancy_abort ("../../../kgccfe/gnu/expmed.c", 2448, __FUNCTION__);
  ...
  case alg_shift:
    accum = expand_shift (LSHIFT_EXPR, mode, accum,
     build_int_2_wide ((unsigned long long) (log), (long long) (0)), (rtx) 0, 0);
    val_so_far <<= log;
    break;
  ...
  case alg_add_t2_m:
    accum = expand_shift (LSHIFT_EXPR, mode, accum,
     build_int_2_wide ((unsigned long long) (log), (long long) (0)), shift_subtarget,
     0);
  ...
  default:
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 2526, __FUNCTION__);
  }
  ...
  {
    nmode = ((enum machine_mode) ((((accum)->fld[0]).rtx))->mode);
    tem = gen_lowpart (nmode, op0);
       ...
       set_unique_reg_note (insn,
             REG_EQUAL,
       gen_rtx_fmt_ee (MULT, (nmode), (tem), (gen_rtx_CONST_INT (VOIDmode, (long long) (val_so_far)))));
   ...
   if (val != val_so_far)
     fancy_abort ("../../../kgccfe/gnu/expmed.c", 2560, __FUNCTION__);
  ...
  op0 = expand_binop (mode,
        ! unsignedp
        && flag_trapv && ((mode_class[(int) (mode)]) == MODE_INT)
        ? (optab_table[OTI_smulv]) : (optab_table[OTI_smul]),
        op0, op1, target, unsignedp, OPTAB_LIB_WIDEN);
  if (op0 == 0)
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 2574, __FUNCTION__);
  return op0;
}
...
{
  return floor_log2_wide ((unsigned long long) (x - 1)) + 1;
}
# 2603 "../../../kgccfe/gnu/expmed.c"
static
unsigned long long
choose_multiplier (d, n, precision, multiplier_ptr, post_shift_ptr, lgup_ptr)
     ...
     int n;
     int precision;
     unsigned long long *multiplier_ptr;
     int *post_shift_ptr;
     int *lgup_ptr;
{
  long long mhigh_hi, mlow_hi;
  unsigned long long mhigh_lo, mlow_lo;
  int lgup, post_shift;
  int pow, pow2;
  unsigned long long nl, dummy1;
  long long nh, dummy2;
  ...
  if (lgup > n)
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 2624, __FUNCTION__);
  ...
  if (pow == 2 * (8 * 8))
    {
      ...
      fancy_abort ("../../../kgccfe/gnu/expmed.c", 2633, __FUNCTION__);
    }


 if (pow >= (8 * 8))
    {
      nh = (long long) 1 << (pow - (8 * 8));
      nl = 0;
    }
  else
    {
      nh = 0;
      nl = (unsigned long long) 1 << pow;
    }
  div_and_round_double (TRUNC_DIV_EXPR, 1, nl, nh, d, (long long) 0,
   &mlow_lo, &mlow_hi, &dummy1, &dummy2);


  if (pow2 >= (8 * 8))
    nh |= (long long) 1 << (pow2 - (8 * 8));
  else
    nl |= (unsigned long long) 1 << pow2;
  div_and_round_double (TRUNC_DIV_EXPR, 1, nl, nh, d, (long long) 0,
   &mhigh_lo, &mhigh_hi, &dummy1, &dummy2);

  if (mhigh_hi && nh - d >= d)
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 2659, __FUNCTION__);
  if (mhigh_hi > 1 || mlow_hi > 1)
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 2661, __FUNCTION__);

  if (! (mlow_hi < mhigh_hi || (mlow_hi == mhigh_hi && mlow_lo < mhigh_lo)))
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 2664, __FUNCTION__);
  ...
  for (post_shift = lgup; post_shift > 0; post_shift--)
    {
      unsigned long long ml_lo = (mlow_hi << ((8 * 8) - 1)) | (mlow_lo >> 1);
      unsigned long long mh_lo = (mhigh_hi << ((8 * 8) - 1)) | (mhigh_lo >> 1);
      if (ml_lo >= mh_lo)
 break;
     ...
     int unsignedp;
{
  ...
  tem = expand_shift (RSHIFT_EXPR, mode, op0,
        build_int_2_wide ((unsigned long long) ((mode_bitsize[(int) (mode)]) - 1), (long long) (0)),
        (rtx) 0, 0);
...
# 2775 "../../../kgccfe/gnu/expmed.c"
rtx
expand_mult_highpart (mode, op0, cnst1, target, unsignedp, max_cost)
     enum machine_mode mode;
     rtx op0, target;
     unsigned long long cnst1;
     int unsignedp;
     int max_cost;
{
  enum machine_mode wider_mode = ((enum machine_mode)mode_wider_mode[(int) (mode)]);
  optab mul_highpart_optab;
  optab moptab;
  rtx tem;
  int size = (mode_bitsize[(int) (mode)]);
  rtx op1, wide_op1;


  if (size > (8 * 8))
    fancy_abort ("../../../kgccfe/gnu/expmed.c", 2792, __FUNCTION__);
  ...
  if (size < (8 * ((target_flags & 0x00002000) ? 8 : 4))
      && mul_cost[(int) wider_mode] + shift_cost[size-1] < max_cost)
    {
      ...
      tem = expand_mult (wider_mode, op0, wide_op1, (rtx) 0, 0);
      tem = expand_shift (RSHIFT_EXPR, wider_mode, tem,
     build_int_2_wide ((unsigned long long) (size), (long long) (0)), (rtx) 0, 1);
  ...
  if (mul_highpart_cost[(int) mode] < max_cost)
    {
      mul_highpart_optab = unsignedp ? (optab_table[OTI_umul_highpart]) : (optab_table[OTI_smul_highpart]);
 ...
 return target;
  ...
  if (size - 1 < (8 * ((target_flags & 0x00002000) ? 8 : 4))
      && (mul_highpart_cost[(int) mode] + 2 * shift_cost[size-1] + 4 * add_cost
   < max_cost))
    {
      mul_highpart_optab = unsignedp ? (optab_table[OTI_smul_highpart]) : (optab_table[OTI_umul_highpart]);
      target = expand_binop (mode, mul_highpart_optab,
        op0, op1, target, unsignedp, OPTAB_DIRECT);
      if (target)
 ...
 return expand_mult_highpart_adjust (mode, target, op0,
  ...
  if ((optab_table[OTI_smul])->handlers[(int) wider_mode].insn_code != CODE_FOR_nothing
      && size - 1 < (8 * ((target_flags & 0x00002000) ? 8 : 4))
      && mul_cost[(int) wider_mode] + shift_cost[size-1] < max_cost)
    {
      op1 = wide_op1;
      goto try;
     ...
     int unsignedp;
{
  ...
  static long long last_div_const = 0;

  op1_is_constant = ((enum rtx_code) (op1)->code) == CONST_INT;
  op1_is_pow2 = (op1_is_constant
   && ((((((((op1)->fld[0]).rtwint)) & (((((op1)->fld[0]).rtwint)) - 1)) == 0)
        || (! unsignedp && (((-(((op1)->fld[0]).rtwint)) & ((-(((op1)->fld[0]).rtwint)) - 1)) == 0)))));
# 3008 "../../../kgccfe/gnu/expmed.c"
 ...
 return (const_int_rtx[64]);
      return expand_unop (mode, flag_trapv && (mode_class[(int) (mode)]) == MODE_INT
  ...
  if (target
      ...
      && (((((enum rtx_code) (target)->code) == REG) && (((target))->integrated))
...
# 3054 "../../../kgccfe/gnu/expmed.c"
  ...
  for (compute_mode = mode; compute_mode != VOIDmode;
       compute_mode = ((enum machine_mode)mode_wider_mode[(int) (compute_mode)]))
 ...
 break;
  ...
  size = (mode_bitsize[(int) (compute_mode)]);
# 3095 "../../../kgccfe/gnu/expmed.c"
  max_cost = div_cost[(int) compute_mode]
    - (rem_flag && ! (last_div_const != 0 && op1_is_constant
        && (((op1)->fld[0]).rtwint) == last_div_const)
       ? mul_cost[(int) compute_mode] + add_cost : 0);

  last_div_const = ! rem_flag && op1_is_constant ? (((op1)->fld[0]).rtwint) : 0;
 ...
 if (op1_is_constant)
  ...
  int dummy;
  unsigned long long d = (((op1)->fld[0]).rtwint);

  if ((((d) & ((d) - 1)) == 0))
    {
      pre_shift = floor_log2_wide ((unsigned long long) (d));
      if (rem_flag)
        {
   remainder
     = expand_binop (compute_mode, (optab_table[OTI_and]), op0,
       gen_rtx_CONST_INT (VOIDmode, (long long) (((long long) 1 << pre_shift) - 1)),
       remainder, 1,
       OPTAB_LIB_WIDEN);
   if (remainder)
     return gen_lowpart (mode, remainder);
      ...
      quotient = expand_shift (RSHIFT_EXPR, compute_mode, op0,
          build_int_2_wide ((unsigned long long) (pre_shift), (long long) (0)),
          tquotient, 1);
    }
  else if (size <= (8 * 8))
    {
      if (d >= ((unsigned long long) 1 << (size - 1)))
        {
   ...
   if (mh != 0 && (d & 1) == 0)
     {
       pre_shift = floor_log2_wide ((unsigned long long) (d & -d));
       mh = choose_multiplier (d >> pre_shift, size,
          size - pre_shift,
          &ml, &post_shift, &dummy);
       if (mh)
         fancy_abort ("../../../kgccfe/gnu/expmed.c", 3202, __FUNCTION__);
     }
   else
     pre_shift = 0;
   ...
   if (mh != 0)
     {
       ...
       if (post_shift - 1 >= (8 * ((target_flags & 0x00002000) ? 8 : 4)))
         goto fail1;
      ...
      (rtx) 0);
       t3 = expand_shift (RSHIFT_EXPR, compute_mode, t2,
            build_int_2_wide ((unsigned long long) (1), (long long) (0)), (rtx) 0,1);
       t4 = force_operand (gen_rtx_fmt_ee (PLUS, (compute_mode), (t1), (t3)),

      (rtx) 0);
       quotient
         = expand_shift (RSHIFT_EXPR, compute_mode, t4,
           build_int_2_wide ((unsigned long long) (post_shift - 1), (long long) (0)),
           tquotient, 1);
     }
   else
     {
       ...
       if (pre_shift >= (8 * ((target_flags & 0x00002000) ? 8 : 4))
    || post_shift >= (8 * ((target_flags & 0x00002000) ? 8 : 4)))
         goto fail1;
       ...
       quotient
         = expand_shift (RSHIFT_EXPR, compute_mode, t2,
           build_int_2_wide ((unsigned long long) (post_shift), (long long) (0)),
           tquotient, 1);
     }
        }
    }
  ...
  if (d == 1)
    ...
    quotient = expand_unop (compute_mode, (optab_table[OTI_neg]), op0,
       tquotient, 0);
  else if (abs_d == (unsigned long long) 1 << (size - 1))
    {
    ...
    && (((rem_flag ? (optab_table[OTI_smod]) : (optab_table[OTI_sdiv]))
         ...
         != CODE_FOR_nothing)
        || ((optab_table[OTI_sdivmod])->handlers[(int) compute_mode]
     .insn_code != CODE_FOR_nothing)))
    ;
  else if ((((abs_d) & ((abs_d) - 1)) == 0))
    {
      lgup = floor_log2_wide ((unsigned long long) (abs_d));
      if (((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) < 1 || (abs_d != 2 && ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) < 3))
        {
   ...
   quotient = expand_shift (RSHIFT_EXPR, compute_mode, t1,
       build_int_2_wide ((unsigned long long) (lgup), (long long) (0)),
       tquotient, 0);
        }
      else
        {
   rtx t1, t2, t3;
   t1 = expand_shift (RSHIFT_EXPR, compute_mode, op0,
        build_int_2_wide ((unsigned long long) (size - 1), (long long) (0)),
        (rtx) 0, 0);
   t2 = expand_shift (RSHIFT_EXPR, compute_mode, t1,
        build_int_2_wide ((unsigned long long) (size - lgup), (long long) (0)),
        (rtx) 0, 1);
   ...
   if (insn != last
       && (set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0)) != 0
       && (((set)->fld[0]).rtx) == quotient
       && abs_d < ((unsigned long long) 1
     << ((8 * 8) - 1)))
     set_unique_reg_note (insn,
              REG_EQUAL,
            gen_rtx_fmt_ee (DIV, (compute_mode), (op0), (gen_rtx_CONST_INT (VOIDmode, (long long) (trunc_int_for_mode (abs_d, compute_mode))))));
   ...
   quotient = expand_unop (compute_mode, (optab_table[OTI_neg]),
  ...
  else if (size <= (8 * 8))
    {
      choose_multiplier (abs_d, size, size - 1,
           &ml, &post_shift, &lgup);
      if (ml < (unsigned long long) 1 << (size - 1))
        {
   rtx t1, t2, t3;

   if (post_shift >= (8 * ((target_flags & 0x00002000) ? 8 : 4))
       || size - 1 >= (8 * ((target_flags & 0x00002000) ? 8 : 4)))
     goto fail1;
   ...
   if (t1 == 0)
     goto fail1;
   t2 = expand_shift (RSHIFT_EXPR, compute_mode, t1,
        build_int_2_wide ((unsigned long long) (post_shift), (long long) (0)), (rtx) 0, 0);
   t3 = expand_shift (RSHIFT_EXPR, compute_mode, op0,
        build_int_2_wide ((unsigned long long) (size - 1), (long long) (0)), (rtx) 0, 0);
   if (d < 0)
     quotient
   ...
   ml |= (~(unsigned long long) 0) << (size - 1);
   extra_cost = (shift_cost[post_shift]
 ...
 if (op1_is_constant && (8 * 8) >= size)
   ...
   if (remainder)
  ...
  else
    {
      ...
      mh = choose_multiplier (d, size, size - 1,
         &ml, &post_shift, &lgup);
      if (mh)
        fancy_abort ("../../../kgccfe/gnu/expmed.c", 3490, __FUNCTION__);
  ...
  t1 = force_operand (gen_rtx_fmt_ee (PLUS, (compute_mode), (op0), ((const_int_rtx[64 -1]))), (rtx) 0);
 ...
 if (unsignedp)
   {
     if (op1_is_constant && ((((((op1)->fld[0]).rtwint)) & (((((op1)->fld[0]).rtwint)) - 1)) == 0))
       {
  rtx t1, t2, t3;
  unsigned long long d = (((op1)->fld[0]).rtwint);
  t1 = expand_shift (RSHIFT_EXPR, compute_mode, op0,
       build_int_2_wide ((unsigned long long) (floor_log2_wide ((unsigned long long) (d))), (long long) (0)),
       tquotient, 1);
  t2 = expand_binop (compute_mode, (optab_table[OTI_and]), op0,
       gen_rtx_CONST_INT (VOIDmode, (long long) (d - 1)),
       (rtx) 0, 1, OPTAB_LIB_WIDEN);
 ...
 if (op1_is_constant && (8 * 8) >= size)
   {
     ...
     t1 = expand_shift (RSHIFT_EXPR, compute_mode, op0,
          build_int_2_wide ((unsigned long long) (pre_shift), (long long) (0)), (rtx) 0, unsignedp);
 ...
 if (unsignedp)
  ...
  remainder = expand_binop (compute_mode, (optab_table[OTI_sub]), op0, tem,
     ...
     tem = plus_constant_wide ((op1), (long long) (-1));
 ...
 return gen_lowpart (mode, rem_flag ? remainder : quotient);
      ...
      default:
 fancy_abort ("../../../kgccfe/gnu/expmed.c", 3939, __FUNCTION__);
      }
     ...
     rtx x;
{
  ...
  switch (((enum rtx_code) (x)->code))
    {
    case CONST_INT:
      t = build_int_2_wide ((unsigned long long) ((((x)->fld[0]).rtwint)), (long long) ((((type)->common.unsigned_flag) && ((mode_bitsize[(int) (((type)->type.mode))]) < (8 * 8))) || (((x)->fld[0]).rtwint) >= 0 ? 0 : -1));
 ...
 {
   t = build_int_2_wide ((unsigned long long) ((((x)->fld[0]).rtwint)), (long long) ((((x)->fld[1]).rtwint)));
   ((t)->common.type) = type;
 }
      else
 {
   ...
   memcpy (&(d), &((((x))->fld[0]).rtwint), sizeof (struct real_value));
   t = build_real (type, d);
 }
 ...
 for (i = units - 1; i >= 0; --i)
   {
     ...
     t = tree_cons ((tree) ((void *)0), make_tree (type, elt), t);
   }
 ...
 return build_vector (type, t);
    ...
    case PLUS:
      return fold (build (PLUS_EXPR, type, make_tree (type, (((x)->fld[0]).rtx)),
     make_tree (type, (((x)->fld[1]).rtx))));

    case MINUS:
      return fold (build (MINUS_EXPR, type, make_tree (type, (((x)->fld[0]).rtx)),
     make_tree (type, (((x)->fld[1]).rtx))));

    case NEG:
      return fold (build1 (NEGATE_EXPR, type, make_tree (type, (((x)->fld[0]).rtx))));

    case MULT:
      return fold (build (MULT_EXPR, type, make_tree (type, (((x)->fld[0]).rtx)),
     make_tree (type, (((x)->fld[1]).rtx))));

    case ASHIFT:
      return fold (build (LSHIFT_EXPR, type, make_tree (type, (((x)->fld[0]).rtx)),
     make_tree (type, (((x)->fld[1]).rtx))));
 ...
 t = type;
    ...
    case SIGN_EXTEND:
    case ZERO_EXTEND:
      t = (*lang_hooks.types.type_for_mode) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode),
          ((enum rtx_code) (x)->code) == ZERO_EXTEND);
      return fold (convert (type, make_tree (t, (((x)->fld[0]).rtx))));

   default:
      t = make_node (RTL_EXPR);
      ((t)->common.type) = type;
# 4162 "../../../kgccfe/gnu/expmed.c"
      (*(rtx *) &(t)->exp.operands[1]) = x;


      (*(rtx *) &(t)->exp.operands[0]) = 0;
      return t;
    }
}
# 4177 "../../../kgccfe/gnu/expmed.c"
_Bool
     ...
     int normalizep;
{
 ...
 op1 = (const_int_rtx[64]), code = EQ;
  ...
  if ((mode_bitsize[(int) (mode)]) == (8 * ((target_flags & 0x00002000) ? 8 : 4)) * 2
      ...
      if (code == EQ || code == NE)
 {
   ...
   op01 = simplify_gen_subreg (word_mode, op0, mode, ((target_flags & 0x00002000) ? 8 : 4));
      ...
      else if (code == LT || code == GE)
 {
  ...
  if (op1 == (const_int_rtx[64]) && (code == LT || code == GE)
   ...
   || ((mode_bitsize[(int) (mode)]) <= (8 * 8)
    ...
    == (long long) 1 << ((mode_bitsize[(int) (mode)]) - 1)))))
    {
      subtarget = target;
      ...
      if ((mode_size[(int) (target_mode)]) > (mode_size[(int) (mode)]))
 {
   op0 = protect_from_queue (op0, 0);
...
# 4435 "../../../kgccfe/gnu/expmed.c"
 ...
 return (comparison == (const_int_rtx[64]) ? (const_int_rtx[64])
  : normalizep == 1 ? (const_int_rtx[64 +1])
  : normalizep == -1 ? (const_int_rtx[64 -1])
  : const_true_rtx);
 ...
 subtarget = gen_reg_rtx (compare_mode);
      ...
      pattern = (*insn_data[(int) (icode)].genfun) (subtarget);
      if (pattern)
 {
   emit_insn (pattern);
# 4476 "../../../kgccfe/gnu/expmed.c"
   if ((mode_size[(int) (target_mode)]) > (mode_size[(int) (compare_mode)]))
     {
       convert_move (target, subtarget,
       ((mode_bitsize[(int) (compare_mode)])
        <= (8 * 8))
       && 0 == (1
         & ((long long) 1
     << ((mode_bitsize[(int) (compare_mode)]) -1))));
       op0 = target;
   ...
   else if ((mode_bitsize[(int) (compare_mode)]) <= (8 * 8)
     && (1
         & ((long long) 1
     << ((mode_bitsize[(int) (compare_mode)]) - 1))))
     op0 = expand_shift (RSHIFT_EXPR, compare_mode, op0,
    size_int_wide ((long long) ((mode_bitsize[(int) (compare_mode)]) - 1), SIZETYPE),
    subtarget, normalizep == 1);
   else if (1 & 1)
     {
  ...
  op0 = expand_unop (compare_mode, (optab_table[OTI_neg]), op0, op0, 0);
     ...
     fancy_abort ("../../../kgccfe/gnu/expmed.c", 4522, __FUNCTION__);
...
# 4551 "../../../kgccfe/gnu/expmed.c"
  if (((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) > 0
      && (mode_class[(int) (mode)]) == MODE_INT && (code == EQ || code == NE)
      && op1 != (const_int_rtx[64]))
    {
 ...
 delete_insns_since (last);
  ...
  if (((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) == 0
      || (mode_class[(int) (mode)]) != MODE_INT || op1 != (const_int_rtx[64])
      || (code != EQ && code != NE
   && (((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) <= 1 || (code != LE && code != GT))))
    return 0;
 ...
 subtarget = 0;
  ...
  if (code == EQ || code == NE)
    {
# 4649 "../../../kgccfe/gnu/expmed.c"
      if ((optab_table[OTI_abs])->handlers[(int) mode].insn_code != CODE_FOR_nothing)
 tem = expand_unop (mode, (optab_table[OTI_abs]), op0, subtarget, 1);
      else if ((optab_table[OTI_ffs])->handlers[(int) mode].insn_code != CODE_FOR_nothing)
   ...
   if (code == EQ)
    ...
    0, OPTAB_WIDEN);
     ...
     tem = expand_unop (mode, (optab_table[OTI_neg]), tem, subtarget, 0);
      ...
      if (tem == 0 && (code == NE || ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) > 1))
 {
   if (rtx_equal_p (subtarget, op0))
     subtarget = 0;
     ...
     enum machine_mode mode;
{
 ...
 case EQ:
   if (arg2 != (const_int_rtx[64]) || mode != ((enum machine_mode) (arg1)->mode))
     fancy_abort ("../../../kgccfe/gnu/expmed.c", 4799, __FUNCTION__);
   do_jump_by_parts_equality_rtx (arg1, label2, label);
   break;

 case NE:
   if (arg2 != (const_int_rtx[64]) || mode != ((enum machine_mode) (arg1)->mode))
     fancy_abort ("../../../kgccfe/gnu/expmed.c", 4805, __FUNCTION__);
   do_jump_by_parts_equality_rtx (arg1, label, label2);
   break;

 default:
   fancy_abort ("../../../kgccfe/gnu/expmed.c", 4810, __FUNCTION__);
 }
