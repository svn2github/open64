...
# 64 "../../../kgccfe/gnu/cfgrtl.c" 2

# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 66 "../../../kgccfe/gnu/cfgrtl.c" 2
# 76 "../../../kgccfe/gnu/cfgrtl.c"
...
static _Bool try_redirect_by_replacing_jump (edge, basic_block);
static rtx last_loop_beg_note (rtx);
static _Bool back_edge_of_syntactic_loop_p (basic_block, basic_block);
static basic_block force_nonfallthru_and_redirect (edge, basic_block);
...
can_delete_note_p (note)
     rtx note;
{
  return ((((note)->fld[5]).rtint) == NOTE_INSN_DELETED
   || (((note)->fld[5]).rtint) == NOTE_INSN_BASIC_BLOCK
   || (((note)->fld[5]).rtint) == NOTE_INSN_PREDICTION);
}
  ...
  if (really_delete)
    {
      ...
      if ((((insn))->volatil))
 fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 144, __FUNCTION__);
      remove_insn (insn);
      (((insn))->volatil) = 1;
    }
  ...
  if (((enum rtx_code) (insn)->code) == JUMP_INSN
      && (((insn)->fld[9]).rtx)
      && ((enum rtx_code) ((((insn)->fld[9]).rtx))->code) == CODE_LABEL)
    ((((((insn)->fld[9]).rtx))->fld[4]).rtint)--;


  else if ((note = find_reg_note (insn, REG_LABEL, (rtx) 0)) != (rtx) 0
    && ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CODE_LABEL)
   ...
   || ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
    {
      ...
      for (i = 0; i < len; i++)
 {
   rtx label = ((((((((pat)->fld[diff_vec_p]).rtvec))->elem[i]))->fld[0]).rtx);
     ...
     rtx insn;
{
  ...
  if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i')
      && (((insn)->fld[3]).bb)
      && (((insn)->fld[3]).bb)->end == insn)
    purge = 1;
  x = delete_insn (insn);
  if (purge)
    purge_dead_edges ((((insn)->fld[3]).bb));
  return x;
}
     ...
     rtx first, last;
{
  ...
  if (((rtx_class[(int) (((enum rtx_code) (last)->code))]) == 'i')
      && (((last)->fld[3]).bb)
      && (((last)->fld[3]).bb)->end == last)
    purge = 1;
  delete_insn_chain (first, last);
  if (purge)
    purge_dead_edges ((((last)->fld[3]).bb));
}
# 253 "../../../kgccfe/gnu/cfgrtl.c"
basic_block
     ...
     basic_block after;
{
 ...
 {
   after = (((head)->fld[1]).rtx);
   head = bb_note;
 }

      if (after != bb_note && (((after)->fld[2]).rtx) != bb_note)
     ...
     basic_block after;
{
  ...
  ((basic_block_info) = varray_grow (basic_block_info, last_basic_block+1));
     ...
     basic_block b;
{
  ...
  rtx insn, end, tmp;
# 372 "../../../kgccfe/gnu/cfgrtl.c"
  for (insn = (((b->head)->fld[1]).rtx); insn; insn = (((insn)->fld[1]).rtx))
    {
      if (((enum rtx_code) (insn)->code) != NOTE)
 break;
      if ((((insn)->fld[5]).rtint) == NOTE_INSN_PREDICTION
 ...
 (((insn)->fld[5]).rtint) = NOTE_INSN_DELETED;
  ...
  if (((enum rtx_code) (end)->code) == JUMP_INSN
      && (tmp = (((end)->fld[9]).rtx)) != (rtx) 0
      && (tmp = (((tmp)->fld[2]).rtx)) != (rtx) 0
     ...
     rtx insn;
{
  ...
  new_bb = create_basic_block ((((insn)->fld[2]).rtx), bb->end, bb);
     ...
     basic_block a, b;
{
 ...
 b_empty = 1;
      ...
      b_head = (((b_head)->fld[2]).rtx);
    }



  if ((((enum rtx_code) (b_head)->code) == NOTE && (((b_head)->fld[5]).rtint) == NOTE_INSN_BASIC_BLOCK))
    {
      if (b_head == b_end)
 b_empty = 1;
      if (! del_last)
  ...
  if (((enum rtx_code) (a_end)->code) == JUMP_INSN)
    {
      ...
      for (prev = (((a_end)->fld[1]).rtx); ; prev = (((prev)->fld[1]).rtx))
 if (((enum rtx_code) (prev)->code) != NOTE
   ...
   break;
      ...
      del_first = a_end;
# 606 "../../../kgccfe/gnu/cfgrtl.c"
      a_end = (((del_first)->fld[1]).rtx);
    }
  else if (((enum rtx_code) ((((a_end)->fld[2]).rtx))->code) == BARRIER)
    del_first = (((a_end)->fld[2]).rtx);
  ...
  if (!b_empty)
    {
      ...
      for (x = a_end; x != b_end; x = (((x)->fld[2]).rtx))
 ((((x)->fld[3]).bb) = a);
     ...
     basic_block block;
{
  ...
  if (((enum rtx_code) (block->head)->code) != CODE_LABEL)
    {
     ...
     basic_block target;
{
  ...
  if (tmp || !onlyjump_p (insn))
    return 0;
  if (flow2_completed && (((insn)->fld[9]).rtx)
      && (table = ((((((insn)->fld[9]).rtx))->fld[2]).rtx)) != (rtx) 0
 ...
 fprintf (rtl_dump_file, "Removing jump %i.\n", (((insn)->fld[0]).rtint));
      ...
      delete_insn_chain (kill_from, (((target->head)->fld[1]).rtx));
    }
 ...
 fprintf (rtl_dump_file, "Redirecting jump %i from %i to %i.\n",
   (((insn)->fld[0]).rtint), e->dest->index, target->index);
      if (!redirect_jump (insn, block_label (target), 0))
 {
   if (target == (&entry_exit_blocks[1]))
     return 0;
   fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 734, __FUNCTION__);
 }
    }


  else if (target == (&entry_exit_blocks[1]))
    return 0;
  ...
  else
    {
      ...
      (((src->end)->fld[9]).rtx) = target_label;
      (((target_label)->fld[4]).rtint)++;
      if (rtl_dump_file)
 fprintf (rtl_dump_file, "Replacing insn %i by jump %i\n",
   (((insn)->fld[0]).rtint), (((src->end)->fld[0]).rtint));
      ...
      if ((tmp = (((insn)->fld[9]).rtx)) != (rtx) 0
   && (tmp = (((tmp)->fld[2]).rtx)) != (rtx) 0
   && ((enum rtx_code) (tmp)->code) == JUMP_INSN
   && (((enum rtx_code) ((((tmp)->fld[5]).rtx))->code) == ADDR_VEC
       || ((enum rtx_code) ((((tmp)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
 {
   delete_insn_chain ((((insn)->fld[9]).rtx), tmp);
 }
 ...
 emit_barrier_after (src->end);
  ...
  while (((enum rtx_code) (e->src->end)->code) == NOTE
  && (((e->src->end)->fld[5]).rtint) >= 0)
     ...
     rtx insn;
{
  ...
  for (insn = (((insn)->fld[2]).rtx); insn && ((enum rtx_code) (insn)->code) == NOTE
     ...
     basic_block target;
{
   ...
   || ((enum rtx_code) ((((tmp)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
    {
      ...
      if (target == (&entry_exit_blocks[1]))
 return 0;
      if (((enum rtx_code) ((((tmp)->fld[5]).rtx))->code) == ADDR_VEC)
 vec = ((((((tmp)->fld[5]).rtx))->fld[0]).rtvec);
      else
 vec = ((((((tmp)->fld[5]).rtx))->fld[1]).rtvec);

      for (j = ((vec)->num_elem) - 1; j >= 0; --j)
 if ((((((vec)->elem[j]))->fld[0]).rtx) == old_label)
   {
     ((vec)->elem[j]) = gen_rtx_fmt_u00 (LABEL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (new_label));
     --(((old_label)->fld[4]).rtint);
     ++(((new_label)->fld[4]).rtint);
   }


      if ((tmp = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0)) != ((void *)0)
   && (((tmp)->fld[0]).rtx) == (global_rtl[GR_PC])
   && ((enum rtx_code) ((((tmp)->fld[1]).rtx))->code) == IF_THEN_ELSE
   && ((enum rtx_code) (((((((tmp)->fld[1]).rtx))->fld[2]).rtx))->code) == LABEL_REF
   && (((((((((tmp)->fld[1]).rtx))->fld[2]).rtx))->fld[0]).rtx) == old_label)
 {
   ((((((tmp)->fld[1]).rtx))->fld[2]).rtx) = gen_rtx_fmt_u00 (LABEL_REF, (VOIDmode), (new_label));
 ...
 return 0;
      ...
      if ((((insn)->fld[9]).rtx) != old_label)
 fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 911, __FUNCTION__);
      ...
      if (!redirect_jump (insn, block_label (target), 0))
 {
   if (target == (&entry_exit_blocks[1]))
     return 0;
   fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 920, __FUNCTION__);
 }
    }
     ...
     basic_block target;
{
  ...
  if (e->src != (&entry_exit_blocks[0]) && e->dest != (&entry_exit_blocks[1])
      && any_condjump_p (e->src->end)


      && e->src->next_bb == e->dest
      && (((e->src->end)->fld[9]).rtx) == e->dest->head)
    {
      rtx note;
      edge b = unchecked_make_edge (e->src, target, 0);

      if (!redirect_jump (e->src->end, block_label (target), 0))
 fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 961, __FUNCTION__);
      note = find_reg_note (e->src->end, REG_BR_PROB, (rtx) 0);
      if (note)
 {
  ...
  if (e->flags & 2)
    {
      ...
      if (e->dest != target)
 fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 986, __FUNCTION__);
      abnormal_edge_flags = e->flags & ~(1 | 64);
      e->flags &= 1 | 64;
    }
  else if (!(e->flags & 1))
    fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 991, __FUNCTION__);
  else if (e->src == (&entry_exit_blocks[0]))
    {


      edge *pe1;
      basic_block bb = create_basic_block (e->dest->head, ((void *)0), (&entry_exit_blocks[0]));



      e->src = bb;
      for (pe1 = &(&entry_exit_blocks[0])->succ; *pe1; pe1 = &(*pe1)->succ_next)
 if (*pe1 == e)
   {
     *pe1 = e->succ_next;
     break;
      ...
      e->succ_next = 0;
      bb->succ = e;
      make_single_succ_edge ((&entry_exit_blocks[0]), bb, 1);
    }
  ...
  if (e->src->succ->succ_next || abnormal_edge_flags)
    {
      ...
      if (note != ((void *)0)
   && ((enum rtx_code) (note)->code) == CODE_LABEL
   && (((note)->fld[2]).rtx)
   && ((enum rtx_code) ((((note)->fld[2]).rtx))->code) == JUMP_INSN
   && (((enum rtx_code) (((((((note)->fld[2]).rtx))->fld[5]).rtx))->code) == ADDR_DIFF_VEC
       || ((enum rtx_code) (((((((note)->fld[2]).rtx))->fld[5]).rtx))->code) == ADDR_VEC))
 note = ((((((note)->fld[2]).rtx))->fld[2]).rtx);
      ...
      if (target->global_live_at_start)
 {
   jump_block->global_live_at_start
     = bitmap_initialize ((bitmap) __extension__ ({ struct obstack *__h = (&flow_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((sizeof (bitmap_head))); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); }), 1);
 ...
 fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 1067, __FUNCTION__);
    }
  else
    {
      rtx label = block_label (target);
      emit_jump_insn_after (gen_jump (label), jump_block->end);
      (((jump_block->end)->fld[9]).rtx) = label;
      (((label)->fld[4]).rtint)++;
    }
...
{
  rtx q;
# 1135 "../../../kgccfe/gnu/cfgrtl.c"
  for (q = (((b->end)->fld[2]).rtx); q != c->head; q = (((q)->fld[2]).rtx))
   ...
   || (b->succ == e && e->succ_next == ((void *)0))))
    {
      ...
      while (((enum rtx_code) (q)->code) == NOTE && (((q)->fld[5]).rtint) >= 0)
 q = (((q)->fld[1]).rtx);
    }


  if (q != (((c->head)->fld[1]).rtx))
    delete_insn_chain ((((q)->fld[2]).rtx), (((c->head)->fld[1]).rtx));
...
tidy_fallthru_edges ()
{
  ...
  for (b = (&entry_exit_blocks[0])->next_bb; b != (&entry_exit_blocks[1])->prev_bb; b = b->next_bb)
    {
      edge s;

      c = b->next_bb;
# 1201 "../../../kgccfe/gnu/cfgrtl.c"
      if ((s = b->succ) != ((void *)0)
   && ! (s->flags & (2 | 4 | 8))
   && s->succ_next == ((void *)0)
   && s->dest == c

   && (((enum rtx_code) (b->end)->code) != JUMP_INSN
       || onlyjump_p (b->end)))
     ...
     edge edge_in;
{
  ...
  if ((edge_in->flags & 2) != 0)
    fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 1264, __FUNCTION__);
...
# 1298 "../../../kgccfe/gnu/cfgrtl.c"
  if (edge_in->dest != (&entry_exit_blocks[1])
      && (((edge_in->dest->head)->fld[1]).rtx)
      && ((enum rtx_code) ((((edge_in->dest->head)->fld[1]).rtx))->code) == NOTE
      && (((((((edge_in->dest->head)->fld[1]).rtx))->fld[5]).rtint)
   == NOTE_INSN_LOOP_BEG)
      && !back_edge_of_syntactic_loop_p (edge_in->dest, edge_in->src))
    before = (((edge_in->dest->head)->fld[1]).rtx);
  else if (edge_in->dest != (&entry_exit_blocks[1]))
  ...
  bb->frequency = (((edge_in)->src->frequency * (edge_in)->probability + 10000 / 2) / 10000);
  ...
  edge_out = make_single_succ_edge (bb, edge_in->dest, 1);
 ...
 fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 1332, __FUNCTION__);
    }
  else
     ...
     edge e;
{
  ...
  if ((e->flags & 2) && ((e)->src->succ->succ_next && (e)->dest->pred->pred_next))
    fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 1352, __FUNCTION__);
     ...
     int watch_calls;
{
  ...
  if (watch_calls && (e->flags & 1) && !e->dest->pred->pred_next
      ...
      && ((enum rtx_code) (e->src->end)->code) == CALL_INSN)
    {
  ...
  if (!before && !after)
    {
      ...
      if (e->dest->pred->pred_next == ((void *)0) && e->dest != (&entry_exit_blocks[1]))
 {
   bb = e->dest;
   ...
   if (((enum rtx_code) (tmp)->code) == CODE_LABEL)
     tmp = (((tmp)->fld[2]).rtx);
   if ((((enum rtx_code) (tmp)->code) == NOTE && (((tmp)->fld[5]).rtint) == NOTE_INSN_BASIC_BLOCK))
     tmp = (((tmp)->fld[2]).rtx);
   if (tmp == bb->head)
     before = tmp;
   else if (tmp)
        ...
        && e->src != (&entry_exit_blocks[0]))
 {
   ...
   if (((enum rtx_code) (bb->end)->code) == JUMP_INSN)
     for (before = bb->end;
   ((enum rtx_code) ((((before)->fld[1]).rtx))->code) == NOTE
   && ((((((before)->fld[1]).rtx))->fld[5]).rtint) ==
   NOTE_INSN_LOOP_BEG; before = (((before)->fld[1]).rtx))
       ;
   else
     {

       if ((e->flags & 1) == 0)
  fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 1444, __FUNCTION__);
 ...
 fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 1477, __FUNCTION__);
 ...
 delete_insn (before);
    ...
    fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 1486, __FUNCTION__);
...
commit_edge_insertions ()
{
  ...
  for (bb = (&entry_exit_blocks[0]); bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      edge e, next;
     ...
     FILE *outf;
{
  ...
  fputs_unlocked (";; Predecessors: ", outf);
  for (e = bb->pred; e; e = e->pred_next)
    dump_edge_info (outf, e, 0);
  putc_unlocked ('\n', outf);

  fputs_unlocked (";; Registers live at start:", outf);
  dump_regset (bb->global_live_at_start, outf);
  putc_unlocked ('\n', outf);

  for (insn = bb->head, last = (((bb->end)->fld[2]).rtx); insn != last;
       insn = (((insn)->fld[2]).rtx))
    print_rtl_single (outf, insn);

  fputs_unlocked (";; Registers live at end:", outf);
  dump_regset (bb->global_live_at_end, outf);
  putc_unlocked ('\n', outf);

  fputs_unlocked (";; Successors: ", outf);
...
debug_bb_n (n)
     int n;
{
  dump_bb ((((basic_block_info)->data.bb[(n)])), stderr);
}
     ...
     rtx rtx_first;
{
      ...
      for (bb = (&entry_exit_blocks[1])->prev_bb; bb != (&entry_exit_blocks[0]); bb = bb->prev_bb)
 {
   ...
   start[(((bb->head)->fld[0]).rtint)] = bb;
   end[(((bb->end)->fld[0]).rtint)] = bb;
   for (x = bb->head; x != (rtx) 0; x = (((x)->fld[2]).rtx))
     {
  ...
  break;
      ...
      for (tmp_rtx = rtx_first; ((void *)0) != tmp_rtx; tmp_rtx = (((tmp_rtx)->fld[2]).rtx))
 {
   int did_output;

   if ((bb = start[(((tmp_rtx)->fld[0]).rtint)]) != ((void *)0))
     {
   ...
   if (in_bb_p[(((tmp_rtx)->fld[0]).rtint)] == NOT_IN_BB
       && ((enum rtx_code) (tmp_rtx)->code) != NOTE
       && ((enum rtx_code) (tmp_rtx)->code) != BARRIER)
     fprintf (outf, ";; Insn is not within a basic block\n");
   else if (in_bb_p[(((tmp_rtx)->fld[0]).rtint)] == IN_MULTIPLE_BB)
     fprintf (outf, ";; Insn is in multiple basic blocks\n");

   did_output = print_rtl_single (outf, tmp_rtx);

   if ((bb = end[(((tmp_rtx)->fld[0]).rtint)]) != ((void *)0))
     {
  ...
  if ((cfun->epilogue_delay_list) != 0)
    ...
    tmp_rtx = (((tmp_rtx)->fld[1]).rtx))
 print_rtl_single (outf, (((tmp_rtx)->fld[0]).rtx));
    }
}
     ...
     basic_block bb;
{
  ...
  if (((enum rtx_code) (bb->end)->code) != JUMP_INSN)
    return;
  note = find_reg_note (bb->end, REG_BR_PROB, (rtx) 0);
  if (!note || ((((((note)->fld[0]).rtx))->fld[0]).rtwint) == ((bb)->succ->flags & 1 ? (bb)->succ->succ_next : (bb)->succ)->probability)
    return;
  (((note)->fld[0]).rtx) = gen_rtx_CONST_INT (VOIDmode, (long long) (((bb)->succ->flags & 1 ? (bb)->succ->succ_next : (bb)->succ)->probability));
}
# 1756 "../../../kgccfe/gnu/cfgrtl.c"
void
verify_flow_info ()
{
  ...
  last_bb_seen = (&entry_exit_blocks[0]);
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != ((void *)0); bb = bb->next_bb)
    {
  ...
  for (bb = (&entry_exit_blocks[1])->prev_bb; bb != (&entry_exit_blocks[0]); bb = bb->prev_bb)
    {
      ...
      for (x = last_head; x != (rtx) 0; x = (((x)->fld[1]).rtx))
 if (x == end)
   break;
      ...
      if (!x)
 {
   ...
   (((end)->fld[0]).rtint), bb->index);
   err = 1;
 }



      for (; x != (rtx) 0; x = (((x)->fld[1]).rtx))
 {



   if (bb_info[(((x)->fld[0]).rtint)] != ((void *)0))
     {
       error ("insn %d is in multiple basic blocks (%d and %d)",
       (((x)->fld[0]).rtint), bb->index, bb_info[(((x)->fld[0]).rtint)]->index);
       err = 1;
     }

   bb_info[(((x)->fld[0]).rtint)] = bb;
  ...
  for (bb = (&entry_exit_blocks[1])->prev_bb; bb != (&entry_exit_blocks[0]); bb = bb->prev_bb)
    {
      ...
      if (((rtx_class[(int) (((enum rtx_code) (bb->end)->code))]) == 'i')
   && (note = find_reg_note (bb->end, REG_BR_PROB, (rtx) 0))
   && bb->succ && bb->succ->succ_next
   && any_condjump_p (bb->end))
 {
   if (((((((note)->fld[0]).rtx))->fld[0]).rtwint) != ((bb)->succ->flags & 1 ? (bb)->succ->succ_next : (bb)->succ)->probability)
     {
       error ("verify_flow_info: REG_BR_PROB does not match cfg %i %i",
       ((((((note)->fld[0]).rtx))->fld[0]).rtwint), ((bb)->succ->flags & 1 ? (bb)->succ->succ_next : (bb)->succ)->probability);
       err = 1;
     }
 }
      if (bb->count < 0)
      ...
      for (e = bb->succ; e; e = e->succ_next)
 {
  ...
  for (insn = (((e->src->end)->fld[2]).rtx); insn != e->dest->head;
       insn = (((insn)->fld[2]).rtx))
    if (((enum rtx_code) (insn)->code) == BARRIER

        || ((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i')
        ...
        )
      {
        ...
        e->src->index, e->dest->index);
        _fatal_insn ("wrong insn in the fallthru edge", insn, "../../../kgccfe/gnu/cfgrtl.c", 1934, __FUNCTION__);
        err = 1;
      }
     }
   ...
   edge_checksum[e->dest->index + 2] += (size_t) e;
      ...
      if (n_eh && ((enum rtx_code) ((((bb->end)->fld[5]).rtx))->code) != RESX
   && !find_reg_note (bb->end, REG_EH_REGION, (rtx) 0))
 {
   error ("Missing REG_EH_REGION note in the end of bb %i", bb->index);
   err = 1;
 }
      if (n_branch
   && (((enum rtx_code) (bb->end)->code) != JUMP_INSN
      ...
      if (n_branch != 1 && any_uncondjump_p (bb->end))
 {
   ...
   && (((bb->end)->fld[9]).rtx) != bb->next_bb->head)
 {
   error ("Wrong amount of branch edges after conditional jump %i", bb->index);
   err = 1;
 }
      if (n_call && ((enum rtx_code) (bb->end)->code) != CALL_INSN)
 {
   error ("Call edges for non-call insn in bb %i", bb->index);
   err = 1;
 }
      if (n_abnormal
   && (((enum rtx_code) (bb->end)->code) != CALL_INSN && n_call != n_abnormal)
   && (((enum rtx_code) (bb->end)->code) != JUMP_INSN
       || any_condjump_p (bb->end)
      ...
      if (!n_fallthru)
 {
   ...
   for (insn = bb->end; !insn || ((enum rtx_code) (insn)->code) != BARRIER;
        insn = (((insn)->fld[2]).rtx))
     if (!insn
      ...
      for (e = bb->pred; e; e = e->pred_next)
 {
   ...
   edge_checksum[e->dest->index + 2] -= (size_t) e;
      ...
      for (x = bb->head; x != (((bb->end)->fld[2]).rtx); x = (((x)->fld[2]).rtx))
 if ((((x)->fld[3]).bb) != bb)
   {
     debug_rtx (x);
     if (! (((x)->fld[3]).bb))
  ...
  ("insn %d inside basic block %d but block_for_insn is NULL",
   (((x)->fld[0]).rtint), bb->index);
     else
       error
  ("insn %d inside basic block %d but block_for_insn is %i",
   (((x)->fld[0]).rtint), bb->index, (((x)->fld[3]).bb)->index);
      ...
      if (((enum rtx_code) (x)->code) == CODE_LABEL)
 {
   ...
   x = (((x)->fld[2]).rtx);
      ...
      if (!(((enum rtx_code) (x)->code) == NOTE && (((x)->fld[5]).rtint) == NOTE_INSN_BASIC_BLOCK) || (((x)->fld[4]).bb) != bb)
 {
   error ("NOTE_INSN_BASIC_BLOCK is missing for block %d",
   bb->index);
   err = 1;
 ...
 for (x = (((x)->fld[2]).rtx); x; x = (((x)->fld[2]).rtx))
   {
     if ((((enum rtx_code) (x)->code) == NOTE && (((x)->fld[5]).rtint) == NOTE_INSN_BASIC_BLOCK))
       {
  ...
  || ((enum rtx_code) (x)->code) == CODE_LABEL
  || ((enum rtx_code) (x)->code) == BARRIER)
       {
  error ("in basic block %d:", bb->index);
  _fatal_insn ("flow control insn inside a basic block", x, "../../../kgccfe/gnu/cfgrtl.c", 2091, __FUNCTION__);
       }
   }
    }
 ...
 err = 1;
  ...
  for (x = rtx_first; x; x = (((x)->fld[2]).rtx))
    {
      if ((((enum rtx_code) (x)->code) == NOTE && (((x)->fld[5]).rtint) == NOTE_INSN_BASIC_BLOCK))
 {
   bb = (((x)->fld[4]).bb);
      ...
      if (!bb_info[(((x)->fld[0]).rtint)])
 {
   switch (((enum rtx_code) (x)->code))
     ...
     case CODE_LABEL:
       ...
       if ((((x)->fld[2]).rtx)
    && ((enum rtx_code) ((((x)->fld[2]).rtx))->code) == JUMP_INSN
    && (((enum rtx_code) (((((((x)->fld[2]).rtx))->fld[5]).rtx))->code) == ADDR_DIFF_VEC
        || ((enum rtx_code) (((((((x)->fld[2]).rtx))->fld[5]).rtx))->code) == ADDR_VEC))
  x = (((x)->fld[2]).rtx);
     ...
     default:
       _fatal_insn ("insn outside basic block", x, "../../../kgccfe/gnu/cfgrtl.c", 2150, __FUNCTION__);
     }
 }
   ...
   && ! ((((x)->fld[2]).rtx) && ((enum rtx_code) ((((x)->fld[2]).rtx))->code) == BARRIER))
     _fatal_insn ("return not followed by barrier", x, "../../../kgccfe/gnu/cfgrtl.c", 2158, __FUNCTION__);
    }
     ...
     basic_block bb;
{
      ...
      for (e = bb->succ; e; e = next)
 {
   ...
   if ((e->flags & 1) && any_condjump_p (insn))
     ...
     continue;
   else if (e->dest != (&entry_exit_blocks[1])
     && e->dest->head == (((insn)->fld[9]).rtx))


     continue;
   else if (e->dest == (&entry_exit_blocks[1]) && returnjump_p (insn))
      ...
      else
 {
   ...
   b->probability = ((((((note)->fld[0]).rtx))->fld[0]).rtwint);
      ...
      if (!(e->flags & 1))
 {
  ...
  if (!bb->succ || bb->succ->succ_next)
    fancy_abort ("../../../kgccfe/gnu/cfgrtl.c", 2335, __FUNCTION__);
     ...
     int update_life_p;
{
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      _Bool purged_here = purge_dead_edges (bb);
