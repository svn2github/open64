...
.LFB15:
	.file 1 "../../../kgccfe/gnu/dependence.c"
	.loc 1 229 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LFE15:
	...
	.local	loop_def.12174
	.comm	loop_def.12174,4,4
	.local	du_idx.12173
	.comm	du_idx.12173,4,4
	.local	current_loop.12172
	.comm	current_loop.12172,4,4
	.local	nloop.12171
	.comm	nloop.12171,4,4
	.local	outer_loop.12170
	.comm	outer_loop.12170,4,4
...
.LCFI9:
	...
	jne	.L71
	.loc 1 276 0
	movl	$0, outer_loop.12170@GOTOFF(%ebx)
	.loc 1 277 0
	movl	$0, nloop.12171@GOTOFF(%ebx)
	.loc 1 278 0
	movl	$0, du_idx.12173@GOTOFF(%ebx)
	.loc 1 281 0
	jmp	.L71
.L16:
	.loc 1 282 0
...
.L26:
	.loc 1 295 0
	movl	nloop.12171@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L30
	movl	-36(%ebp), %eax
	movl	%eax, outer_loop.12170@GOTOFF(%ebx)
.L30:
	.loc 1 296 0
	movl	nloop.12171@GOTOFF(%ebx), %eax
	addl	$1, %eax
	movl	%eax, nloop.12171@GOTOFF(%ebx)
	.loc 1 297 0
	movl	-36(%ebp), %eax
	movl	%eax, current_loop.12172@GOTOFF(%ebx)
	.loc 1 298 0
	movl	nloop.12171@GOTOFF(%ebx), %eax
	movl	outer_loop.12170@GOTOFF(%ebx), %edx
	movl	%eax, 8(%esp)
	movl	%edx, 4(%esp)
	movl	-36(%ebp), %eax
	movl	%eax, (%esp)
	call	add_loop
	movl	%eax, loop_def.12174@GOTOFF(%ebx)
	.loc 1 299 0
	movl	loop_def.12174@GOTOFF(%ebx), %ecx
	movl	-36(%ebp), %eax
	movl	28(%eax), %esi
	movl	-36(%ebp), %eax
	movl	24(%eax), %edx
	...
	jne	.L32
	.loc 1 303 0
	movl	loop_def.12174@GOTOFF(%ebx), %eax
	movl	$1, 12(%eax)
.L32:
	.loc 1 305 0
	movl	-36(%ebp), %eax
	...
	movl	%eax, nloop.12171@GOTOFF(%ebx)
	.loc 1 307 0
	movl	$0, current_loop.12172@GOTOFF(%ebx)
	.loc 1 308 0
	movl	-36(%ebp), %eax
	movl	(%eax), %eax
	movl	%eax, -36(%ebp)
...
.L46:
	...
	.loc 1 341 0
	movl	def_use_chain@GOTOFF(%ebx), %eax
	movl	du_idx.12173@GOTOFF(%ebx), %edx
	movl	16(%eax,%edx,4), %eax
	movl	%eax, -28(%ebp)
	leal	1(%edx), %eax
	movl	%eax, du_idx.12173@GOTOFF(%ebx)
	.loc 1 342 0
	movl	-28(%ebp), %edx
	movl	12(%ebp), %eax
	movl	%eax, 16(%edx)
	...
	movl	%edx, (%eax)
	.loc 1 345 0
	movl	current_loop.12172@GOTOFF(%ebx), %edx
	movl	-28(%ebp), %eax
	movl	%edx, 4(%eax)
	.loc 1 346 0
	movl	-28(%ebp), %edx
...
.L55:
	.loc 1 367 0
	movl	du_idx.12173@GOTOFF(%ebx), %eax
	cmpl	%eax, -24(%ebp)
	jge	.L57
	movl	def_use_chain@GOTOFF(%ebx), %edx
	movl	-24(%ebp), %eax
...
.LFE32:
	...
	.section	.rodata
	.align 32
	.type	direction_merge.13515, @object
	.size	direction_merge.13515, 256
direction_merge.13515:
	.long	0
	.long	1
	.long	1
	.long	5
...
.L432:
	...
	leal	0(,%ecx,8), %eax
	addl	%edx, %eax
	movl	direction_merge.13515@GOTOFF(%ebx,%eax,4), %eax
	movl	%eax, (%esi)
	.loc 1 1247 0
	addl	$1, -16(%ebp)
.L428:
...
.LLST23:
	...
	.byte	0x1
	.string	"../../../kgccfe/gnu/dependence.c"
