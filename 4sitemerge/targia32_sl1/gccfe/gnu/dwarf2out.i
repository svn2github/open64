...
# 57 "../../../kgccfe/gnu/dwarf2out.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 58 "../../../kgccfe/gnu/dwarf2out.c" 2
...
# 78 "../../../kgccfe/gnu/dwarf2out.c" 2


# 1 "../../../kgccfe/gnu/defaults.h" 1
# 81 "../../../kgccfe/gnu/dwarf2out.c" 2
# 1 "../../../kgccfe/wfe_dst.h" 1
# 141 "../../../kgccfe/wfe_dst.h"
...
# 82 "../../../kgccfe/gnu/dwarf2out.c" 2
# 109 "../../../kgccfe/gnu/dwarf2out.c"
int
dwarf2out_do_frame ()
{
     ...
     rtx rtl;
{
 ...
 case REG:
   if ((((rtl)->fld[0]).rtuint) != (0 + 29))
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 915, __FUNCTION__);
   offset = 0;
   break;

 case PLUS:
   if (((((((rtl)->fld[0]).rtx))->fld[0]).rtuint) != (0 + 29))
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 921, __FUNCTION__);
   offset = ((((((rtl)->fld[1]).rtx))->fld[0]).rtwint);
   break;

 case MINUS:
   if (((((((rtl)->fld[0]).rtx))->fld[0]).rtuint) != (0 + 29))
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 927, __FUNCTION__);
   offset = -((((((rtl)->fld[1]).rtx))->fld[0]).rtwint);
   break;

 default:
   fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 932, __FUNCTION__);
 }
 ...
 fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 942, __FUNCTION__);
      initial_return_save ((((rtl)->fld[0]).rtx));
      return;

    default:
      fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 947, __FUNCTION__);
    }
     ...
     rtx pattern;
{
 ...
 case POST_MODIFY:
  ...
  fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 994, __FUNCTION__);
     ...
     rtx insn;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1049, __FUNCTION__);
     ...
     const char *label;
{
 ...
 if (((enum rtx_code) ((((((expr)->fld[0]).rtvec))->elem[par_index]))->code) == SET
  ...
  if (((enum rtx_code) (expr)->code) != SET)
    fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1349, __FUNCTION__);
 ...
 case REG:
   if (cfa.reg == (unsigned) (((src)->fld[0]).rtuint))
     ...
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1368, __FUNCTION__);
 ...
 case LO_SUM:
  ...
  case REG:
    if ((unsigned) ((((((src)->fld[1]).rtx))->fld[0]).rtuint) != cfa_temp.reg)
      fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1393, __FUNCTION__);
    offset = cfa_temp.offset;
    break;
  default:
    fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1397, __FUNCTION__);
  }
       ...
       if ((((src)->fld[0]).rtx) == (global_rtl[GR_HARD_FRAME_POINTER]))
  {
    ...
    if (cfa.reg != (unsigned) ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30))
      fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1404, __FUNCTION__);
    cfa.reg = (0 + 29);
  }
  ...
  fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1411, __FUNCTION__);
  ...
  fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1426, __FUNCTION__);
  ...
  fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1439, __FUNCTION__);
     }
   else
     {
       if (((enum rtx_code) (src)->code) == MINUS)
  fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1444, __FUNCTION__);
         ...
         && (((src)->fld[1]).rtx) == (global_rtl[GR_STACK_POINTER]))
  {
    ...
    if (cfa.reg != (0 + 29))
      fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1469, __FUNCTION__);
  ...
  fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1482, __FUNCTION__);
     }
   break;
 ...
 case IOR:
   if (((enum rtx_code) ((((src)->fld[0]).rtx))->code) != REG
       ...
       || ((enum rtx_code) ((((src)->fld[1]).rtx))->code) != CONST_INT)
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1497, __FUNCTION__);
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1511, __FUNCTION__);
 }
 ...
 fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1519, __FUNCTION__);
 ...
 case PRE_MODIFY:
   ...
   if (((enum rtx_code) ((((((((((dest)->fld[0]).rtx))->fld[1]).rtx))->fld[1]).rtx))->code) != CONST_INT)
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1530, __FUNCTION__);
   offset = -((((((((((((dest)->fld[0]).rtx))->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtwint);

   if ((((((((((dest)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint) != (0 + 29)
       || cfa_store.reg != (0 + 29))
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1535, __FUNCTION__);
 ...
 case PRE_DEC:
   ...
   if ((((((((((dest)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint) != (0 + 29)
       || cfa_store.reg != (0 + 29))
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1553, __FUNCTION__);
 ...
 case LO_SUM:
   if (((enum rtx_code) (((((((dest)->fld[0]).rtx))->fld[1]).rtx))->code) != CONST_INT)
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1568, __FUNCTION__);
   ...
   if (cfa_store.reg == (unsigned) (((((((((dest)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint))
     ...
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1578, __FUNCTION__);
   break;
 ...
 case REG:
   if (cfa_store.reg == (unsigned) ((((((dest)->fld[0]).rtx))->fld[0]).rtuint))
     ...
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1589, __FUNCTION__);
   break;


 case POST_INC:
   if (cfa_temp.reg != (unsigned) (((((((((dest)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint))
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1595, __FUNCTION__);
   offset = -cfa_temp.offset;
   cfa_temp.offset -= (mode_size[(int) (((enum machine_mode) (dest)->mode))]);
   break;

 default:
   fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1601, __FUNCTION__);
 }
   ...
   && (unsigned) (((src)->fld[0]).rtuint) == cfa.reg)
 {
  ...
  x = (((x)->fld[0]).rtx);
       if (((enum rtx_code) (x)->code) != REG)
  fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1628, __FUNCTION__);
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1643, __FUNCTION__);
    }
}
     ...
     rtx insn;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1666, __FUNCTION__);
     ...
     int for_eh;
{
 ...
 case DW_CFA_GNU_negative_offset_extended:
   ...
   fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1812, __FUNCTION__);
...
# 1904 "../../../kgccfe/gnu/dwarf2out.c"
      ...
      if ((libfunc_table[LTI_eh_personality]) && per_encoding == 0x50)
 {
   ...
   if (size_of_uleb128 (augmentation_size) != 1)
     fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 1949, __FUNCTION__);
 }
    }
      ...
      if (augmentation[0])
 {
       ...
       if (lsda_encoding == 0x50)
  {
    ...
    if (size_of_uleb128 (size) != 1)
      fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 2045, __FUNCTION__);
  }
...
dwarf2out_frame_init ()
{
  ...
  dwarf2out_def_cfa (((void *)0), (0 + 29), 0);
  initial_return_save (gen_rtx_REG (VOIDmode, 0 + 31));
...
# 2869 "../../../kgccfe/gnu/dwarf2out.c"
    ...
    case DW_OP_bra:
      ...
      fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 2882, __FUNCTION__);
    ...
    case (0x100 + DW_OP_addr):
      ...
      fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 2958, __FUNCTION__);
     ...
     dw_cfa_location *cfa;
{
  ...
  if (cfa->indirect == 0)
    fancy_abort ("../../../kgccfe/gnu/dwarf2out.c", 3014, __FUNCTION__);
...
# 12831 "../../../kgccfe/gnu/dwarf2out.c"
const struct gcc_debug_hooks dwarf2_debug_hooks;



# 1 "../../../kgccfe/gnu/MIPS/gt-dwarf2out.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-dwarf2out.h"
...
# 12835 "../../../kgccfe/gnu/dwarf2out.c" 2
