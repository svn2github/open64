...
# 140 "../../../kgccfe/gnu/flow.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 141 "../../../kgccfe/gnu/flow.c" 2
...
# 149 "../../../kgccfe/gnu/flow.c" 2
# 1 "../../../kgccfe/gnu/ssa.h" 1
# 24 "../../../kgccfe/gnu/ssa.h"
...
# 154 "../../../kgccfe/gnu/flow.c" 2
# 190 "../../../kgccfe/gnu/flow.c"
int flow2_completed;
...
static void mark_set_1 (struct propagate_block_info *, enum rtx_code, rtx, rtx, rtx, int);


static int find_regno_partial (rtx *, void *);
# 342 "../../../kgccfe/gnu/flow.c"
...
check_function_return_warnings ()
{
  if (warn_missing_noreturn
      ...
      && (&entry_exit_blocks[1])->pred == ((void *)0)
  ...
  if (((cfun->decl)->common.volatile_flag)
    ...
    && cfun->x_clobber_return_insn != ((void *)0)
    && (&entry_exit_blocks[1])->pred != ((void *)0))
    {
      ...
      if ((((cfun->x_clobber_return_insn)->fld[0]).rtint) < max_uid)
 {
   rtx insn;
     ...
     basic_block block;
{
  ...
  if (!(((enum rtx_code) (insn)->code) == NOTE && (((insn)->fld[5]).rtint) == NOTE_INSN_BASIC_BLOCK))
    fancy_abort ("../../../kgccfe/gnu/flow.c", 414, __FUNCTION__);
     ...
     int flags;
{
  ...
  do { HARD_REG_ELT_TYPE *scan_tp_ = (elim_reg_set); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);


  for (i = 0; i < (int) (sizeof (eliminables) / sizeof ((eliminables)[0])); i++)
    ((elim_reg_set)[(eliminables[i].from) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((eliminables[i].from) % ((unsigned) (8 * 8))));
...
# 464 "../../../kgccfe/gnu/flow.c"
  ...
  mark_regs_live_at_end ((&entry_exit_blocks[1])->global_live_at_start);
     ...
     basic_block bb;
{
  ...
  while (1)
    {
      if (((rtx_class[(int) (((enum rtx_code) (head)->code))]) == 'i'))
 {
   int r = for_each_rtx (&(((head)->fld[5]).rtx), verify_wide_reg_1, &regno);
   if (r == 1)
     return;
   if (r == 2)
     break;
 ...
 break;
  ...
  fancy_abort ("../../../kgccfe/gnu/flow.c", 561, __FUNCTION__);
}
     ...
     basic_block bb;
{
      ...
      if (! bitmap_equal_p (new_live_at_start, bb->global_live_at_start))
 {
   ...
   fancy_abort ("../../../kgccfe/gnu/flow.c", 587, __FUNCTION__);
 }
    }
  else
    {
     ...
     int prop_flags;
{
  ...
  if ((prop_flags & 32)
    ...
    fancy_abort ("../../../kgccfe/gnu/flow.c", 656, __FUNCTION__);
 ...
 count_or_remove_death_notes (blocks, 1);
  ...
  if (blocks)
    {
      do { unsigned int word_num_; unsigned int bit_num_ = (0) % (unsigned int) ((unsigned) (8 * 8)); unsigned int size_ = (blocks)->size; unsigned long long *ptr_ = (blocks)->elms; for (word_num_ = (0) / (unsigned int) ((unsigned) (8 * 8)); word_num_ < size_; word_num_++, bit_num_ = 0) { unsigned long long word_ = ptr_[word_num_]; if (word_ != 0) for (; bit_num_ < ((unsigned) (8 * 8)); bit_num_++) { unsigned long long _mask = (unsigned long long) 1 << bit_num_; if ((word_ & _mask) != 0) { word_ &= ~ _mask; (i) = word_num_ * ((unsigned) (8 * 8)) + bit_num_; { bb = (((basic_block_info)->data.bb[(i)])); bitmap_copy (tmp, bb->global_live_at_end); propagate_block (bb, tmp, ((void *)0), ((void *)0), stabilized_prop_flags); if (extent == UPDATE_LIFE_LOCAL) verify_local_live_at_start (tmp, bb); }; if (word_ == 0) break; } } } } while (0);
# 724 "../../../kgccfe/gnu/flow.c"
    }
  else
    {
      for (bb = (&entry_exit_blocks[1])->prev_bb; bb != (&entry_exit_blocks[0]); bb = bb->prev_bb)
  ...
  if (prop_flags & 4)
    {
      ...
      do { bitmap_element *ptr_ = ((&entry_exit_blocks[0])->global_live_at_end)->first; unsigned int indx_ = (176) / ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))); unsigned bit_num_ = (176) % (unsigned) (8 * 4); unsigned word_num_ = (176) / (unsigned) (8 * 4) % ((128 + (8 * 4) - 1) / (8 * 4)); while (ptr_ != 0 && ptr_->indx < indx_) ptr_ = ptr_->next; if (ptr_ != 0 && ptr_->indx != indx_) { bit_num_ = 0; word_num_ = 0; } for (; ptr_ != 0; ptr_ = ptr_->next) { for (; word_num_ < ((128 + (8 * 4) - 1) / (8 * 4)); word_num_++) { BITMAP_WORD word_ = ptr_->bits[word_num_]; if (word_ != 0) { for (; bit_num_ < (unsigned) (8 * 4); bit_num_++) { BITMAP_WORD mask_ = ((BITMAP_WORD) 1) << bit_num_; if ((word_ & mask_) != 0) { word_ &= ~ mask_; (i) = (ptr_->indx * ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))) + word_num_ * (unsigned) (8 * 4) + bit_num_); { (((reg_n_info)->data.reg[i])->basic_block) = -2; }; if (word_ == 0) break; } } } bit_num_ = 0; } word_num_ = 0; } } while (0);
# 758 "../../../kgccfe/gnu/flow.c"
      do { bitmap_element *ptr_ = (regs_live_at_setjmp)->first; unsigned int indx_ = (176) / ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))); unsigned bit_num_ = (176) % (unsigned) (8 * 4); unsigned word_num_ = (176) / (unsigned) (8 * 4) % ((128 + (8 * 4) - 1) / (8 * 4)); while (ptr_ != 0 && ptr_->indx < indx_) ptr_ = ptr_->next; if (ptr_ != 0 && ptr_->indx != indx_) { bit_num_ = 0; word_num_ = 0; } for (; ptr_ != 0; ptr_ = ptr_->next) { for (; word_num_ < ((128 + (8 * 4) - 1) / (8 * 4)); word_num_++) { BITMAP_WORD word_ = ptr_->bits[word_num_]; if (word_ != 0) { for (; bit_num_ < (unsigned) (8 * 4); bit_num_++) { BITMAP_WORD mask_ = ((BITMAP_WORD) 1) << bit_num_; if ((word_ & mask_) != 0) { word_ &= ~ mask_; (i) = (ptr_->indx * ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))) + word_num_ * (unsigned) (8 * 4) + bit_num_); { if ((cfun->emit->x_regno_reg_rtx)[i] != 0) { (((reg_n_info)->data.reg[i])->live_length) = -1; (((reg_n_info)->data.reg[i])->basic_block) = -1; } }; if (word_ == 0) break; } } } bit_num_ = 0; } word_num_ = 0; } } while (0);
# 767 "../../../kgccfe/gnu/flow.c"
    }
     ...
     int prop_flags;
{
      ...
      if (extent == UPDATE_LIFE_LOCAL)
 {
   if (bb->flags & 1)
     {
       ((update_life_blocks)->elms [(bb->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (bb->index) % ((unsigned) (8 * 8)));
       n++;
     }
 }
      else
     ...
     int keep_head_end_p;
{
 ...
 {
   clear_edges ();
   do { if (basic_block_info) { free (basic_block_info); basic_block_info = (varray_type) 0; } } while (0);
 }
      n_basic_blocks = 0;
      last_basic_block = 0;

      (&entry_exit_blocks[0])->aux = ((void *)0);
      (&entry_exit_blocks[0])->global_live_at_end = ((void *)0);
      (&entry_exit_blocks[1])->aux = ((void *)0);
      (&entry_exit_blocks[1])->global_live_at_start = ((void *)0);
    }
}
     ...
     rtx f __attribute__ ((__unused__));
{
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      for (insn = bb->head; insn != (((bb->end)->fld[2]).rtx); insn = next)
 {
   next = (((insn)->fld[2]).rtx);
   if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && noop_move_p (insn))
     {
       rtx note;
         ...
         && (((note)->fld[0]).rtx) != insn)
  {
    ...
    rtx retval_note = find_reg_note ((((note)->fld[0]).rtx),
         REG_RETVAL, (rtx) 0);
    (((new_libcall_insn)->fld[8]).rtx)
      = gen_rtx_fmt_ue (INSN_LIST, (REG_LIBCALL), ((((note)->fld[0]).rtx)), ((((new_libcall_insn)->fld[8]).rtx)));

    (((retval_note)->fld[0]).rtx) = new_libcall_insn;
  }
  ...
  for (insn = get_insns (); insn; insn = next)
    {
      next = (((insn)->fld[2]).rtx);
      if (((enum rtx_code) (insn)->code) == CODE_LABEL
   && (((insn)->fld[4]).rtint) == (((insn))->in_struct)
   && ((enum rtx_code) (next)->code) == JUMP_INSN
   && (((enum rtx_code) ((((next)->fld[5]).rtx))->code) == ADDR_VEC
       || ((enum rtx_code) ((((next)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
 {
   if (rtl_dump_file)
     ...
     void *data __attribute__ ((__unused__));
{
  if (x == (global_rtl[GR_STACK_POINTER])
   ...
   && (rtx_class[(int) (((enum rtx_code) ((((x)->fld[0]).rtx))->code))]) == 'a'
   && ((((((x)->fld[0]).rtx))->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER])))
     ...
     rtx f;
{
      ...
      if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
 {
   ...
   note_stores ((((insn)->fld[5]).rtx), notice_stack_pointer_modification_1,
         ((void *)0));
   if (! current_function_sp_is_unchanging)
     return;
 }
     ...
     void *xset;
{
  ...
  if (((enum machine_mode) (reg)->mode) == BLKmode)
    fancy_abort ("../../../kgccfe/gnu/flow.c", 966, __FUNCTION__);

  bitmap_set_bit (set, regno);
  if (regno < 176)
    {
      int n = mips_hard_regno_nregs (regno, ((enum machine_mode) (reg)->mode));
      while (--n > 0)
     ...
     regset set;
{
  ...
  if (! reload_completed || frame_pointer_needed)
    {
      bitmap_set_bit (set, (0 + 1));


      if (! 0)
 bitmap_set_bit (set, ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30));
 ...
 if (regs_ever_live[i] && ! 0
  ...
  if (reload_completed && (cfun->calls_eh_return))
    for (i = 0; ; ++i)
      {
 unsigned regno = ((i) < ((target_flags & 0x00100000) ? 2 : 4) ? (i) + (0 + 4) : (~(unsigned int) 0));
 ...
 bitmap_set_bit (set, regno);
  ...
  if ((! 1 || ! reload_completed)
    ...
    {
      rtx tmp = gen_rtx_REG ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 0 + 3);
      if (tmp && (((enum rtx_code) (tmp)->code) == REG))
 mark_reg (tmp, set);
    }
# 1068 "../../../kgccfe/gnu/flow.c"
...
set_phi_alternative_reg (insn, dest_regno, src_regno, data)
     ...
     int dest_regno __attribute__ ((__unused__));
     int src_regno;
     void *data;
{
  regset live = (regset) data;
  bitmap_set_bit (live, src_regno);
  return 0;
}
...
# 1112 "../../../kgccfe/gnu/flow.c"
  ...
  if (blocks_in)
    {
      for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
 if (((blocks_in)->elms [(bb->index) / ((unsigned) (8 * 8))] >> (bb->index) % ((unsigned) (8 * 8)) & 1))
   {
     *--qhead = bb;
     bb->aux = bb;
   }
      ...
      for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
 {
  ...
  (&entry_exit_blocks[0])->aux = (&entry_exit_blocks[1])->aux = ((void *)0);

  if (blocks_out)
    sbitmap_zero (blocks_out);
# 1175 "../../../kgccfe/gnu/flow.c"
  while (qhead != qtail)
    {
      int rescan, changed;
      basic_block bb;
      ...
      else
 {
   ...
   for (i = 0; i < 176; i++)
     if (0)
      ...
      bitmap_set_bit (new_live_at_end, (0 + 29));
      ...
      if (! reload_completed)
 {
   ...
   bitmap_set_bit (new_live_at_end, (0 + 1));




   if (fixed_regs[0])
     bitmap_set_bit (new_live_at_end, 0);
   ...
   if ((0 + 28) != (~(unsigned int) 0)
       && fixed_regs[(0 + 28)])
     bitmap_set_bit (new_live_at_end, (0 + 28));
 }
 ...
 {
   bb->local_set = bitmap_initialize ((bitmap) __extension__ ({ struct obstack *__h = (&flow_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((sizeof (bitmap_head))); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); }), 1);
   bb->cond_local_set = bitmap_initialize ((bitmap) __extension__ ({ struct obstack *__h = (&flow_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((sizeof (bitmap_head))); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); }), 1);
   rescan = 1;
 }
      else
 {
  ...
  continue;
      ...
      if (blocks_out)
 ((blocks_out)->elms [(bb->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (bb->index) % ((unsigned) (8 * 8)));
      ...
      for (e = bb->pred; e; e = e->pred_next)
 {
  ...
  if (blocks_out)
    {
      do { unsigned int word_num_; unsigned int bit_num_ = (0) % (unsigned int) ((unsigned) (8 * 8)); unsigned int size_ = (blocks_out)->size; unsigned long long *ptr_ = (blocks_out)->elms; for (word_num_ = (0) / (unsigned int) ((unsigned) (8 * 8)); word_num_ < size_; word_num_++, bit_num_ = 0) { unsigned long long word_ = ptr_[word_num_]; if (word_ != 0) for (; bit_num_ < ((unsigned) (8 * 8)); bit_num_++) { unsigned long long _mask = (unsigned long long) 1 << bit_num_; if ((word_ & _mask) != 0) { word_ &= ~ _mask; (i) = word_num_ * ((unsigned) (8 * 8)) + bit_num_; { basic_block bb = (((basic_block_info)->data.bb[(i)])); do { if (bb->local_set) { bitmap_clear (bb->local_set); (bb->local_set) = 0; } } while (0); do { if (bb->cond_local_set) { bitmap_clear (bb->cond_local_set); (bb->cond_local_set) = 0; } } while (0); }; if (word_ == 0) break; } } } } while (0);
     ...
     void *data;
{
  ...
  switch (((enum rtx_code) (*ptr)->code))
    ...
    case STRICT_LOW_PART:
      if (((enum rtx_code) ((((*ptr)->fld[0]).rtx))->code) == REG && ((((((*ptr)->fld[0]).rtx))->fld[0]).rtuint) == reg)
 {
   param->retval = (((*ptr)->fld[0]).rtx);
   return 1;
 }
      break;

    case SUBREG:
      if (((enum rtx_code) ((((*ptr)->fld[0]).rtx))->code) == REG
   && ((((((*ptr)->fld[0]).rtx))->fld[0]).rtuint) == reg)
 {
   param->retval = (((*ptr)->fld[0]).rtx);
   return 1;
 }
...
allocate_bb_life_data ()
{
  ...
  for (bb = (&entry_exit_blocks[0]); bb != ((void *)0); bb = bb->next_bb)
    {
      bb->global_live_at_start = bitmap_initialize ((bitmap) __extension__ ({ struct obstack *__h = (&flow_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((sizeof (bitmap_head))); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); }), 1);
      bb->global_live_at_end = bitmap_initialize ((bitmap) __extension__ ({ struct obstack *__h = (&flow_obstack); __extension__ ({ struct obstack *__o = (__h); int __len = ((sizeof (bitmap_head))); if (__o->chunk_limit - __o->next_free < __len) _obstack_newchunk (__o, __len); __o->next_free += __len; (void) 0; }); __extension__ ({ struct obstack *__o1 = (__h); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }); }), 1);
    }
...
# 1565 "../../../kgccfe/gnu/flow.c"
  if (inote && ((enum rtx_code) (inote)->code) == CODE_LABEL)
    {
      rtx label = (((inote)->fld[0]).rtx);
      rtx next;




      if ((((label)->fld[4]).rtint) == 1 + (((label))->in_struct)
   && (next = next_nonnote_insn (label)) != ((void *)0)
   && ((enum rtx_code) (next)->code) == JUMP_INSN
   && (((enum rtx_code) ((((next)->fld[5]).rtx))->code) == ADDR_VEC
       || ((enum rtx_code) ((((next)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
 {
   rtx pat = (((next)->fld[5]).rtx);
...
propagate_block_delete_libcall ( insn, note)
     rtx insn, note;
{
  rtx first = (((note)->fld[0]).rtx);
  rtx before = (((first)->fld[1]).rtx);
     ...
     rtx insn;
{
  ...
  if (flags & 16)
    {
      insn_is_dead = insn_dead_p (pbi, (((insn)->fld[5]).rtx), 0, (((insn)->fld[8]).rtx));
 ...
 _fatal_insn ("Attempt to delete prologue/epilogue insn:", insn, "../../../kgccfe/gnu/flow.c", 1654, __FUNCTION__);



      mark_set_regs (pbi, (((insn)->fld[5]).rtx), insn);
 ...
 {
# 1680 "../../../kgccfe/gnu/flow.c"
   if (note)
     {
       rtx libcall_note;

       libcall_note
  = find_reg_note ((((note)->fld[0]).rtx), REG_LIBCALL, (rtx) 0);
       remove_note ((((note)->fld[0]).rtx), libcall_note);
     }
   ...
   if (note)
     {
       ...
       retval_note
  = find_reg_note ((((note)->fld[0]).rtx), REG_RETVAL, (rtx) 0);
       remove_note ((((note)->fld[0]).rtx), retval_note);
     }
...
# 1731 "../../../kgccfe/gnu/flow.c"
  ...
  if (libcall_is_dead)
    {
      ...
      insn = (((note)->fld[0]).rtx);
      return (((insn)->fld[1]).rtx);
    }
  else if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET
    && ((((((insn)->fld[5]).rtx))->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER])
    && ((enum rtx_code) (((((((insn)->fld[5]).rtx))->fld[1]).rtx))->code) == PLUS
    && (((((((((insn)->fld[5]).rtx))->fld[1]).rtx))->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER])
    && ((enum rtx_code) ((((((((((insn)->fld[5]).rtx))->fld[1]).rtx))->fld[1]).rtx))->code) == CONST_INT)
      ...
      if (((enum rtx_code) (insn)->code) == CALL_INSN)
 {
   ...
   cond = (rtx) 0;
   if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == COND_EXEC)
     cond = ((((((insn)->fld[5]).rtx))->fld[0]).rtx);
   ...
   for (note = (((insn)->fld[9]).rtx);
        note;
        note = (((note)->fld[1]).rtx))
     if (((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CLOBBER)
       mark_set_1 (pbi, CLOBBER, ((((((note)->fld[0]).rtx))->fld[0]).rtx),
     cond, insn, pbi->flags);
   ...
   sibcall_p = (((insn))->jump);
   live_at_end = (&entry_exit_blocks[1])->global_live_at_start;
   for (i = 0; i < 176; i++)
     if ((!!((regs_invalidated_by_call)[(i) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((i) % ((unsigned) (8 * 8))))))
  && ! (sibcall_p
  ...
  mark_set_1 (pbi, CLOBBER, (cfun->emit->x_regno_reg_rtx)[i], cond, insn,
       pbi->flags & ~(1 | 4));
       }
 }
      ...
      if (! insn_is_dead)
 mark_used_regs (pbi, (((insn)->fld[5]).rtx), (rtx) 0, insn);
      if ((flags & 128)
   && ((note = find_reg_note (insn, REG_EQUAL, (rtx) 0))
       || (note = find_reg_note (insn, REG_EQUIV, (rtx) 0))))
 mark_used_regs (pbi, (((note)->fld[0]).rtx), (rtx) 0, insn);
      ...
      if (! insn_is_dead && ((enum rtx_code) (insn)->code) == CALL_INSN)
 {
   ...
   for (note = (((insn)->fld[9]).rtx);
        note;
        note = (((note)->fld[1]).rtx))
     if (((enum rtx_code) ((((note)->fld[0]).rtx))->code) == USE)
       mark_used_regs (pbi, ((((((note)->fld[0]).rtx))->fld[0]).rtx),
         cond, insn);


   bitmap_set_bit (pbi->reg_live, (0 + 29));
  ...
  if (flags & 4)
    do { bitmap_element *ptr_ = (pbi->reg_live)->first; unsigned int indx_ = (0) / ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))); unsigned bit_num_ = (0) % (unsigned) (8 * 4); unsigned word_num_ = (0) / (unsigned) (8 * 4) % ((128 + (8 * 4) - 1) / (8 * 4)); while (ptr_ != 0 && ptr_->indx < indx_) ptr_ = ptr_->next; if (ptr_ != 0 && ptr_->indx != indx_) { bit_num_ = 0; word_num_ = 0; } for (; ptr_ != 0; ptr_ = ptr_->next) { for (; word_num_ < ((128 + (8 * 4) - 1) / (8 * 4)); word_num_++) { BITMAP_WORD word_ = ptr_->bits[word_num_]; if (word_ != 0) { for (; bit_num_ < (unsigned) (8 * 4); bit_num_++) { BITMAP_WORD mask_ = ((BITMAP_WORD) 1) << bit_num_; if ((word_ & mask_) != 0) { word_ &= ~ mask_; (i) = (ptr_->indx * ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))) + word_num_ * (unsigned) (8 * 4) + bit_num_); { (((reg_n_info)->data.reg[i])->live_length)++; }; if (word_ == 0) break; } } } bit_num_ = 0; } word_num_ = 0; } } while (0);
     ...
     int flags;
{
  ...
  pbi->new_set = bitmap_initialize ((bitmap) xmalloc (sizeof (bitmap_head)), 1);
# 2003 "../../../kgccfe/gnu/flow.c"
  if (optimize
      && ! (((enum tree_code) (((current_function_decl)->common.type))->common.code) == FUNCTION_TYPE
     && (((((current_function_decl)->common.type))->type.no_force_blk_flag)))
   ...
   || (bb->succ->succ_next == ((void *)0)
       && bb->succ->dest == (&entry_exit_blocks[1])
       && ! (cfun->calls_eh_return))))
    {
      rtx insn, set;
      for (insn = bb->end; insn != bb->head; insn = (((insn)->fld[1]).rtx))
 if (((enum rtx_code) (insn)->code) == INSN
     ...
     && ((enum rtx_code) ((((set)->fld[0]).rtx))->code) == MEM)
   {
     ...
     if ((((canon_mem))->unchanging))
       continue;

     if ((((canon_mem)->fld[0]).rtx) == (global_rtl[GR_FRAME_POINTER])
  || (((enum rtx_code) ((((canon_mem)->fld[0]).rtx))->code) == PLUS
      && ((((((canon_mem)->fld[0]).rtx))->fld[0]).rtx) == (global_rtl[GR_FRAME_POINTER])
      && ((enum rtx_code) (((((((canon_mem)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST_INT))
...
# 2136 "../../../kgccfe/gnu/flow.c"
static int
insn_dead_p (pbi, x, call_ok, notes)
     struct propagate_block_info *pbi;
     rtx x;
     int call_ok;
     rtx notes __attribute__ ((__unused__));
{
...
# 2169 "../../../kgccfe/gnu/flow.c"
  if (code == SET)
    {
      ...
      if (((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CALL)
 {
   if (! call_ok)
     return 0;
 }
      ...
      else if (volatile_refs_p ((((x)->fld[1]).rtx)))
 return 0;
      ...
      if (((enum rtx_code) (r)->code) == MEM)
 {
   ...
   for (temp = pbi->mem_set_list; temp != 0; temp = (((temp)->fld[1]).rtx))
     if (anti_dependence (r, (((temp)->fld[0]).rtx)))
       {
  rtx mem = (((temp)->fld[0]).rtx);

  if (rtx_equal_p ((((canon_r)->fld[0]).rtx), (((mem)->fld[0]).rtx))
      && ((mode_size[(int) (((enum machine_mode) (canon_r)->mode))])
   <= (mode_size[(int) (((enum machine_mode) (mem)->mode))])))
    return 1;
# 2225 "../../../kgccfe/gnu/flow.c"
       }
 }
      else
 {
  ...
  return 0;
       ...
       if (regno < 176)
  {
    int n = mips_hard_regno_nregs (regno, ((enum machine_mode) (r)->mode));
  ...
  return 0;
    ...
    {
      int i = (((((x)->fld[0]).rtvec))->num_elem);

      for (i--; i >= 0; i--)
 if (((enum rtx_code) ((((((x)->fld[0]).rtvec))->elem[i]))->code) != CLOBBER
     && ((enum rtx_code) ((((((x)->fld[0]).rtvec))->elem[i]))->code) != USE
     && ! insn_dead_p (pbi, (((((x)->fld[0]).rtvec))->elem[i]), call_ok, (rtx) 0))
   return 0;
  ...
  else if (code == CLOBBER && ((enum rtx_code) ((((x)->fld[0]).rtx))->code) == REG
    && ((((((x)->fld[0]).rtx))->fld[0]).rtuint) >= 176
    && ! bitmap_bit_p (pbi->reg_live, ((((((x)->fld[0]).rtx))->fld[0]).rtuint)))
    return 1;
...
libcall_dead_p (pbi, note, insn)
     ...
     rtx insn;
{
  rtx x = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0);
      ...
      if (((enum rtx_code) (r)->code) == REG)
 {
   ...
   call_pat = (((call)->fld[5]).rtx);
   if (((enum rtx_code) (call_pat)->code) == PARALLEL)
     {
       for (i = (((((call_pat)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
  if (((enum rtx_code) ((((((call_pat)->fld[0]).rtvec))->elem[i]))->code) == SET
      && ((enum rtx_code) (((((((((call_pat)->fld[0]).rtvec))->elem[i]))->fld[1]).rtx))->code) == CALL)
    break;
  ...
  return 0;
       ...
       call_pat = (((((call_pat)->fld[0]).rtvec))->elem[i]);
     }

   return insn_dead_p (pbi, call_pat, 1, (((call)->fld[8]).rtx));
 }
    }
  return 1;
}
     ...
     unsigned int regno;
{
  if (n_basic_blocks == 0
   ...
   && (global_regs[regno]
       || fixed_regs[regno]
       || ((((unsigned long long) (((regno)) - ((0 + 4))) <= ((((0 + 4) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((0 + 4)))) || (((unsigned long long) (((regno)) - ((32 + 12))) <= ((((32 + 12) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((32 + 12)))) && ((regno) % ((target_flags & 0x00000200) || (target_flags & 0x00020000) ? 1 : 2) == 0) && mips_abi != 4)) && !fixed_regs[regno]))))
    return 0;

  return bitmap_bit_p ((&entry_exit_blocks[0])->next_bb->global_live_at_start, regno);
}
     ...
     rtx mem;
{
  ...
  for (i = pbi->mem_set_list; i ; i = (((i)->fld[1]).rtx))
    {
      rtx e = (((i)->fld[0]).rtx);
      if (rtx_equal_p ((((mem)->fld[0]).rtx), (((e)->fld[0]).rtx)))
 {
   if ((mode_size[(int) (((enum machine_mode) (mem)->mode))]) > (mode_size[(int) (((enum machine_mode) (e)->mode))]))
     {
     ...
     void *data;
{
  ...
  if ((rtx_class[(int) (((enum rtx_code) (x)->code))]) == 'a')
    {
      invalidate_mems_from_set (pbi, (((x)->fld[0]).rtx));
      return -1;
    }
     ...
     rtx exp;
{
  ...
  while (temp)
    {
      next = (((temp)->fld[1]).rtx);
      if (reg_overlap_mentioned_p (exp, (((temp)->fld[0]).rtx)))
 {
     ...
     rtx x, insn;
{
 ...
 if (((enum reg_note) ((enum machine_mode) (link)->mode)) == REG_INC)
   mark_set_1 (pbi, SET, (((link)->fld[0]).rtx),
 ...
 retry:
  switch (code = ((enum rtx_code) (x)->code))
    ...
    case SET:
    case CLOBBER:
      mark_set_1 (pbi, code, (((x)->fld[0]).rtx), cond, insn, pbi->flags);
      return;
 ...
 for (i = (((((x)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
   {
     ...
     switch (code = ((enum rtx_code) (sub)->code))
       ...
       case COND_EXEC:
  if (cond != (rtx) 0)
    fancy_abort ("../../../kgccfe/gnu/flow.c", 2567, __FUNCTION__);

  cond = (((sub)->fld[0]).rtx);
  sub = (((sub)->fld[1]).rtx);
  if (((enum rtx_code) (sub)->code) != SET && ((enum rtx_code) (sub)->code) != CLOBBER)
    break;


       case SET:
       case CLOBBER:
  mark_set_1 (pbi, code, (((sub)->fld[0]).rtx), cond, insn, pbi->flags);
  break;
     ...
     int flags;
{
  ...
  switch (((enum rtx_code) (reg)->code))
    ...
    case PARALLEL:
      ...
      for (i = (((((reg)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
 if (((((((((reg)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx) != 0)
   mark_set_1 (pbi, code, ((((((((reg)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx), cond, insn,
        flags);
      return;
 ...
 break;
      not_dead = (unsigned long) bitmap_bit_p (pbi->reg_live, (((reg)->fld[0]).rtuint));


    case REG:
      regno_last = regno_first = (((reg)->fld[0]).rtuint);
      if (regno_first < 176)
 regno_last += mips_hard_regno_nregs (regno_first, ((enum machine_mode) (reg)->mode)) - 1;
      break;

    case SUBREG:
      if (((enum rtx_code) ((((reg)->fld[0]).rtx))->code) == REG)
 {
   enum machine_mode outer_mode = ((enum machine_mode) (reg)->mode);
   enum machine_mode inner_mode = ((enum machine_mode) ((((reg)->fld[0]).rtx))->mode);




   regno_last = regno_first = ((((((reg)->fld[0]).rtx))->fld[0]).rtuint);
   if (regno_first < 176)
     {
       ...
       + mips_hard_regno_nregs (regno_first, outer_mode) - 1);
 ...
 for_each_rtx (&(((insn)->fld[5]).rtx), invalidate_mems_from_autoinc, pbi);
 ...
 add_to_mem_set_list (pbi, canon_rtx (reg));
  ...
  if (((enum rtx_code) (reg)->code) == REG
     ...
     && (! reload_completed || frame_pointer_needed))
      ...
      && ! (regno_first == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)
     && (! reload_completed || frame_pointer_needed))


      && ! (regno_first == 0 && fixed_regs[regno_first])
...
# 2767 "../../../kgccfe/gnu/flow.c"
     ...
     | 1 | 64))
 {
       ...
       for (i = regno_first; i <= regno_last; ++i)
  {
    ...
    (((reg_n_info)->data.reg[i])->freq) += (optimize_size || (flag_branch_probabilities && !(&entry_exit_blocks[0])->count) ? 1000 : ((pbi->bb)->frequency * 1000 / 10000) ? ((pbi->bb)->frequency * 1000 / 10000) : 1);
       ...
       else
  {
    ...
    if ((((reg_n_info)->data.reg[regno_first])->basic_block) == -1)
      (((reg_n_info)->data.reg[regno_first])->basic_block) = blocknum;
    else if ((((reg_n_info)->data.reg[regno_first])->basic_block) != blocknum)
      (((reg_n_info)->data.reg[regno_first])->basic_block) = -2;
  }
     }
   ...
   if (! some_was_dead)
     {
       if (flags & 2)
  {
# 2829 "../../../kgccfe/gnu/flow.c"
    if (y && (((((y)->fld[3]).bb)->index + 0) == blocknum)
        && (regno_first >= 176
     || asm_noperands ((((y)->fld[5]).rtx)) < 0))
      (((y)->fld[7]).rtx) = alloc_INSN_LIST (insn, (((y)->fld[7]).rtx));
  }
     }
   else if (not_dead)
     ;
       ...
       if (flags & 1)
  {
    ...
    (((insn)->fld[8]).rtx)
      = alloc_EXPR_LIST (REG_UNUSED, reg, (((insn)->fld[8]).rtx));
  }
     }
   else
     {
...
# 3567 "../../../kgccfe/gnu/flow.c"
static void
mark_used_reg (pbi, reg, cond, insn)
     struct propagate_block_info *pbi;
     rtx reg;
     rtx cond __attribute__ ((__unused__));
     rtx insn;
{
  ...
  if (pbi->flags & 4)
    {
      if (regno_first < 176)
 {
# 3618 "../../../kgccfe/gnu/flow.c"
   if (! ((!!((elim_reg_set)[(regno_first) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno_first) % ((unsigned) (8 * 8))))))
          && (regno_first == (0 + 1)
       || regno_first == 0)))
     for (i = regno_first; i <= regno_last; ++i)
       regs_ever_live[i] = 1;
      ...
      else
 {
   ...
   (((reg_n_info)->data.reg[regno_first])->freq) += (optimize_size || (flag_branch_probabilities && !(&entry_exit_blocks[0])->count) ? 1000 : ((pbi->bb)->frequency * 1000 / 10000) ? ((pbi->bb)->frequency * 1000 / 10000) : 1);
      ...
      if (! some_was_live)
 {
   if ((pbi->flags & 1)
     ...
     (((insn)->fld[8]).rtx)
       = alloc_EXPR_LIST (REG_DEAD, reg, (((insn)->fld[8]).rtx));
...
# 3749 "../../../kgccfe/gnu/flow.c"
    }
}
# 3759 "../../../kgccfe/gnu/flow.c"
static void
     ...
     rtx x, cond, insn;
{
 ...
 mark_used_regs (pbi, ((((((x)->fld[0]).rtx))->fld[0]).rtx), cond, insn);
      return;
      ...
      if (optimize && (flags & 256))
 {
   ...
   if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == SYMBOL_REF
  ...
  {
    next = (((temp)->fld[1]).rtx);
    if (anti_dependence ((((temp)->fld[0]).rtx), x))
      {
   ...
   && ((((((x)->fld[0]).rtx))->fld[0]).rtuint) >= 176)
 bitmap_set_bit (&subregs_of_mode, ((((((x)->fld[0]).rtx))->fld[0]).rtuint)
       * MAX_MACHINE_MODE
 ...
 if (((enum rtx_code) (testreg)->code) == MEM)
   {
     ...
     mark_used_regs (pbi, (((testreg)->fld[0]).rtx), cond, insn);
     mark_used_regs (pbi, (((x)->fld[1]).rtx), cond, insn);
     return;
   }
# 3892 "../../../kgccfe/gnu/flow.c"
 while (((enum rtx_code) (testreg)->code) == STRICT_LOW_PART
  ...
  && ((enum rtx_code) ((((testreg)->fld[0]).rtx))->code) == REG
  && ((((((testreg)->fld[0]).rtx))->fld[0]).rtuint) >= 176)
       bitmap_set_bit (&subregs_of_mode, ((((((testreg)->fld[0]).rtx))->fld[0]).rtuint)
      * MAX_MACHINE_MODE
     ...
     if (((enum rtx_code) (testreg)->code) == SUBREG
  && !((mode_size[(int) ((enum machine_mode) ((((testreg)->fld[0]).rtx))->mode)]
        + ((target_flags & 0x00002000) ? 8 : 4) - 1) / ((target_flags & 0x00002000) ? 8 : 4)
 ...
 if ((((enum rtx_code) (testreg)->code) == PARALLEL
  ...
  && ! (regno == 0 && fixed_regs[regno])
   ...
   {
     if (mark_dest)
       mark_used_regs (pbi, (((x)->fld[0]).rtx), cond, insn);
     mark_used_regs (pbi, (((x)->fld[1]).rtx), cond, insn);
     return;
   }
      }
...
# 3966 "../../../kgccfe/gnu/flow.c"
 ...
 if (code == ASM_OPERANDS)
   {
     ...
     for (j = 0; j < (((((x)->fld[3]).rtvec))->num_elem); j++)
       mark_used_regs (pbi, (((((x)->fld[3]).rtvec))->elem[j]), cond, insn);
   }
 break;
      }
    ...
    case COND_EXEC:
      if (cond != (rtx) 0)
 fancy_abort ("../../../kgccfe/gnu/flow.c", 3988, __FUNCTION__);

      mark_used_regs (pbi, (((x)->fld[0]).rtx), (rtx) 0, insn);
 ...
 if (fmt[i] == 'e')
  ...
  goto retry;
     ...
     mark_used_regs (pbi, (((x)->fld[i]).rtx), cond, insn);
   }
 else if (fmt[i] == 'E')
   {
     int j;
     for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
       mark_used_regs (pbi, (((((x)->fld[i]).rtvec))->elem[j]), cond, insn);
   }
      }
  }
}
# 4166 "../../../kgccfe/gnu/flow.c"
rtx
     ...
     long long plusconst;
{
  ...
  if (code == MEM && (((x)->fld[0]).rtx) == reg && plusconst == 0)
    return x;

  if (code == MEM && ((enum rtx_code) ((((x)->fld[0]).rtx))->code) == PLUS
      && ((((((x)->fld[0]).rtx))->fld[0]).rtx) == reg
      && ((enum rtx_code) (((((((x)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST_INT
      && (((((((((x)->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtwint) == plusconst)
    return x;
  ...
  if (code == SIGN_EXTRACT || code == ZERO_EXTRACT)
    {
      ...
      if (find_use_as_address ((((x)->fld[0]).rtx), reg, 0) != 0)
 return (rtx) (size_t) 1;
    }
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 {
   tem = find_use_as_address ((((x)->fld[i]).rtx), reg, plusconst);
   if (value == 0)
     value = tem;
   else if (tem != 0)
     return (rtx) (size_t) 1;
      ...
      else if (fmt[i] == 'E')
 {
   ...
   for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
     {
       tem = find_use_as_address ((((((x)->fld[i]).rtvec))->elem[j]), reg, plusconst);
       if (value == 0)
  value = tem;
       else if (tem != 0)
  return (rtx) (size_t) 1;
     ...
     FILE *outf;
{
  ...
  do { bitmap_element *ptr_ = (r)->first; unsigned int indx_ = (0) / ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))); unsigned bit_num_ = (0) % (unsigned) (8 * 4); unsigned word_num_ = (0) / (unsigned) (8 * 4) % ((128 + (8 * 4) - 1) / (8 * 4)); while (ptr_ != 0 && ptr_->indx < indx_) ptr_ = ptr_->next; if (ptr_ != 0 && ptr_->indx != indx_) { bit_num_ = 0; word_num_ = 0; } for (; ptr_ != 0; ptr_ = ptr_->next) { for (; word_num_ < ((128 + (8 * 4) - 1) / (8 * 4)); word_num_++) { BITMAP_WORD word_ = ptr_->bits[word_num_]; if (word_ != 0) { for (; bit_num_ < (unsigned) (8 * 4); bit_num_++) { BITMAP_WORD mask_ = ((BITMAP_WORD) 1) << bit_num_; if ((word_ & mask_) != 0) { word_ &= ~ mask_; (i) = (ptr_->indx * ((unsigned) (((128 + (8 * 4) - 1) / (8 * 4)) * (unsigned) (8 * 4))) + word_num_ * (unsigned) (8 * 4) + bit_num_); { fprintf (outf, " %d", i); if (i < 176) fprintf (outf, " [%s]", reg_names[i]); }; if (word_ == 0) break; } } } bit_num_ = 0; } word_num_ = 0; } } while (0);
...
# 4280 "../../../kgccfe/gnu/flow.c"
void
recompute_reg_usage (f, loop_step)
     rtx f __attribute__ ((__unused__));
     int loop_step __attribute__ ((__unused__));
{
  allocate_reg_life_data ();
  update_life_info (((void *)0), UPDATE_LIFE_LOCAL, 4);
}
  ...
  for (bb = (&entry_exit_blocks[1])->prev_bb; bb != (&entry_exit_blocks[0]); bb = bb->prev_bb)
    {
      ...
      if (blocks && ! ((blocks)->elms [(bb->index) / ((unsigned) (8 * 8))] >> (bb->index) % ((unsigned) (8 * 8)) & 1))
 continue;
      ...
      for (insn = bb->head;; insn = (((insn)->fld[2]).rtx))
 {
       ...
       while (link)
  {
    switch (((enum reg_note) ((enum machine_mode) (link)->mode)))
      {
      case REG_DEAD:
        if (((enum rtx_code) ((((link)->fld[0]).rtx))->code) == REG)
   {
     rtx reg = (((link)->fld[0]).rtx);
     int n;

     if ((((reg)->fld[0]).rtuint) >= 176)
       n = 1;
     else
       n = mips_hard_regno_nregs ((((reg)->fld[0]).rtuint), ((enum machine_mode) (reg)->mode));
     count += n;
   }
  ...
  if (!blocks)
    {
      for (insn = get_insns (); insn; insn = (((insn)->fld[2]).rtx))
 if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
   free_INSN_LIST_list (&(((insn)->fld[7]).rtx));
    }
  else
    do { unsigned int word_num_; unsigned int bit_num_ = (0) % (unsigned int) ((unsigned) (8 * 8)); unsigned int size_ = (blocks)->size; unsigned long long *ptr_ = (blocks)->elms; for (word_num_ = (0) / (unsigned int) ((unsigned) (8 * 8)); word_num_ < size_; word_num_++, bit_num_ = 0) { unsigned long long word_ = ptr_[word_num_]; if (word_ != 0) for (; bit_num_ < ((unsigned) (8 * 8)); bit_num_++) { unsigned long long _mask = (unsigned long long) 1 << bit_num_; if ((word_ & _mask) != 0) { word_ &= ~ _mask; (i) = word_num_ * ((unsigned) (8 * 8)) + bit_num_; { basic_block bb = (((basic_block_info)->data.bb[(i)])); for (insn = bb->head; insn != (((bb->end)->fld[2]).rtx); insn = (((insn)->fld[2]).rtx)) if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i')) free_INSN_LIST_list (&(((insn)->fld[7]).rtx)); }; if (word_ == 0) break; } } } } while (0);
# 4384 "../../../kgccfe/gnu/flow.c"
}
