...
# 28 "../../../kgccfe/gnu/rtlanal.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 29 "../../../kgccfe/gnu/rtlanal.c" 2
...
static _Bool hoist_test_store (rtx, rtx, regset);
     ...
     rtx x;
{
  ...
  switch (code)
    {
    case MEM:
      return ! (((x))->unchanging) || rtx_unstable_p ((((x)->fld[0]).rtx));
 ...
 for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
   if (rtx_unstable_p ((((((x)->fld[i]).rtvec))->elem[j])))
     return 1;
      }

  return 0;
}
# 131 "../../../kgccfe/gnu/rtlanal.c"
int
     ...
     int for_alias;
{
  ...
  switch (code)
    {
    case MEM:
      return ! (((x))->unchanging) || rtx_varies_p ((((x)->fld[0]).rtx), for_alias);
 ...
 return 0;
    ...
    case LO_SUM:
      ...
      return (! for_alias && rtx_varies_p ((((x)->fld[0]).rtx), for_alias))
      || rtx_varies_p ((((x)->fld[1]).rtx), for_alias);
 ...
 return 1;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    if (fmt[i] == 'e')
      {
 if (rtx_varies_p ((((x)->fld[i]).rtx), for_alias))
   return 1;
      }
    else if (fmt[i] == 'E')
      {
 int j;
 for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
   if (rtx_varies_p ((((((x)->fld[i]).rtvec))->elem[j]), for_alias))
     return 1;
      }
     ...
     rtx x;
{
 ...
 return 0;
   ...
   && (((x)->fld[0]).rtuint) <= (((176)) + 4))
 return 0;
      return 1;

    case CONST:
      return rtx_addr_can_trap_p ((((x)->fld[0]).rtx));
  ...
  || ((((x)->fld[0]).rtx) == pic_offset_table_rtx
    ...
    case LO_SUM:
    case PRE_MODIFY:
      return rtx_addr_can_trap_p ((((x)->fld[1]).rtx));
     ...
     int for_alias;
{
  ...
  if (code == MEM)
    return ((enum machine_mode) (x)->mode) == BLKmode || rtx_varies_p ((((x)->fld[0]).rtx), for_alias);

  fmt = (rtx_format[(int) (code)]);
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    if (fmt[i] == 'e')
      {
 if (rtx_addr_varies_p ((((x)->fld[i]).rtx), for_alias))
   return 1;
      }
    else if (fmt[i] == 'E')
      {
 int j;
 for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
   if (rtx_addr_varies_p ((((((x)->fld[i]).rtvec))->elem[j]), for_alias))
     return 1;
      }
  return 0;
}
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) == MINUS
      && ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_INT)
    return - ((((((x)->fld[1]).rtx))->fld[0]).rtwint);
     ...
     rtx *earliest;
{
  ...
  if (((enum rtx_code) (insn)->code) != JUMP_INSN
      || ! (label = (((insn)->fld[9]).rtx))
      || ! (table = (((label)->fld[2]).rtx))
      || ((enum rtx_code) (table)->code) != JUMP_INSN
      || (((enum rtx_code) ((((table)->fld[5]).rtx))->code) != ADDR_VEC
   && ((enum rtx_code) ((((table)->fld[5]).rtx))->code) != ADDR_DIFF_VEC)
  ...
  if (((enum rtx_code) (x)->code) == IF_THEN_ELSE
      && ((enum rtx_code) ((((x)->fld[2]).rtx))->code) == LABEL_REF)
    x = (((x)->fld[1]).rtx);
  ...
  if (((enum rtx_code) ((((table)->fld[5]).rtx))->code) == ADDR_DIFF_VEC
      ...
      for (i = 0; i < 2; i++)
 {
   ...
   if ((((enum rtx_code) (y)->code) == LABEL_REF && (((y)->fld[0]).rtx) == label))
     break;
 }
 ...
 break;
  ...
  if (((enum rtx_code) (x)->code) == PLUS || ((enum rtx_code) (x)->code) == MINUS)
    for (i = 0; i < 2; i++)
      if ((((x)->fld[i]).rtx) == pic_offset_table_rtx)
 {
   x = (((x)->fld[1 - i]).rtx);
   break;
 }
      ...
      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == REG)
 {
   ...
   return 0;
    ...
    case REG:
      ...
      if (regno < 176 && global_regs[regno])
 return 1;
      return 0;
     ...
     int count_dest;
{
 ...
 return 1;
    ...
    case SET:
      if ((((x)->fld[0]).rtx) == find && ! count_dest)
 return count_occurrences ((((x)->fld[1]).rtx), find, count_dest);
      break;
 ...
 {
 case 'e':
   count += count_occurrences ((((x)->fld[i]).rtx), find, count_dest);
   break;

 case 'E':
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     count += count_occurrences ((((((x)->fld[i]).rtvec))->elem[j]), find, count_dest);
   break;
 }
    }
  return count;
     ...
     rtx reg, in;
{
  ...
  switch (code)
    ...
    case REG:
      return ((enum rtx_code) (reg)->code) == REG && (((in)->fld[0]).rtuint) == (((reg)->fld[0]).rtuint);
    ...
    case CONST_INT:
      return ((enum rtx_code) (reg)->code) == CONST_INT && (((in)->fld[0]).rtwint) == (((reg)->fld[0]).rtwint);
      ...
      if (fmt[i] == 'E')
 {
   ...
   for (j = (((((in)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
     if (reg_mentioned_p (reg, (((((in)->fld[i]).rtvec))->elem[j])))
       return 1;
 }
      else if (fmt[i] == 'e'
        && reg_mentioned_p (reg, (((in)->fld[i]).rtx)))
 return 1;
    }
  return 0;
}
     ...
     rtx beg, end;
{
  ...
  if (beg == end)
    return 0;
  for (p = (((beg)->fld[2]).rtx); p != end; p = (((p)->fld[2]).rtx))
     ...
     rtx reg, from_insn, to_insn;
{
  ...
  for (insn = (((from_insn)->fld[2]).rtx); insn != to_insn; insn = (((insn)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i')
 && (reg_overlap_mentioned_p (reg, (((insn)->fld[5]).rtx))
     ...
     rtx body;
{
  ...
  switch (((enum rtx_code) (body)->code))
    {
    case SET:
      if (reg_overlap_mentioned_p (x, (((body)->fld[1]).rtx)))
 return 1;




      if (((enum rtx_code) ((((body)->fld[0]).rtx))->code) != CC0
   && ((enum rtx_code) ((((body)->fld[0]).rtx))->code) != PC
   && ((enum rtx_code) ((((body)->fld[0]).rtx))->code) != REG
   && ! (((enum rtx_code) ((((body)->fld[0]).rtx))->code) == SUBREG
  && ((enum rtx_code) (((((((body)->fld[0]).rtx))->fld[0]).rtx))->code) == REG
  && ((((mode_size[(int) (((enum machine_mode) (((((((body)->fld[0]).rtx))->fld[0]).rtx))->mode))])
        + (((target_flags & 0x00002000) ? 8 : 4) - 1)) / ((target_flags & 0x00002000) ? 8 : 4))
      == (((mode_size[(int) (((enum machine_mode) ((((body)->fld[0]).rtx))->mode))])
    + (((target_flags & 0x00002000) ? 8 : 4) - 1)) / ((target_flags & 0x00002000) ? 8 : 4))))
   && reg_overlap_mentioned_p (x, (((body)->fld[0]).rtx)))
 return 1;
      return 0;

    case ASM_OPERANDS:
      for (i = (((((body)->fld[3]).rtvec))->num_elem) - 1; i >= 0; i--)
 if (reg_overlap_mentioned_p (x, (((((body)->fld[3]).rtvec))->elem[i])))
   return 1;
      return 0;
    ...
    case TRAP_IF:
      return reg_overlap_mentioned_p (x, (((body)->fld[0]).rtx));
 ...
 if (reg_overlap_mentioned_p (x, (((((body)->fld[0]).rtvec))->elem[i])))
   return 1;
      return 0;

    case PARALLEL:
      for (i = (((((body)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
 if (reg_referenced_p (x, (((((body)->fld[0]).rtvec))->elem[i])))
   return 1;
      return 0;

    case CLOBBER:
      if (((enum rtx_code) ((((body)->fld[0]).rtx))->code) == MEM)
 if (reg_overlap_mentioned_p (x, ((((((body)->fld[0]).rtx))->fld[0]).rtx)))
   return 1;
      return 0;

    case COND_EXEC:
      if (reg_overlap_mentioned_p (x, (((body)->fld[0]).rtx)))
 return 1;
      return reg_referenced_p (x, (((body)->fld[1]).rtx));
     ...
     rtx reg, from_insn, to_insn;
{
  ...
  for (insn = (((from_insn)->fld[2]).rtx); insn != to_insn; insn = (((insn)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i')
 && (reg_referenced_p (reg, (((insn)->fld[5]).rtx))
    || (((enum rtx_code) (insn)->code) == CALL_INSN
       && find_reg_fusage (insn, USE, reg))))
      return 1;
  return 0;
     ...
     rtx start, end;
{
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e' && regs_set_between_p ((((x)->fld[i]).rtx), start, end))
 return 1;

      else if (fmt[i] == 'E')
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   if (regs_set_between_p ((((((x)->fld[i]).rtvec))->elem[j]), start, end))
     return 1;
    }
     ...
     rtx start, end;
{
 ...
 return 1;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e' && modified_between_p ((((x)->fld[i]).rtx), start, end))
 return 1;

      else if (fmt[i] == 'E')
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   if (modified_between_p ((((((x)->fld[i]).rtvec))->elem[j]), start, end))
     return 1;
    }
     ...
     rtx insn;
{
 ...
 return 1;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e' && modified_in_p ((((x)->fld[i]).rtx), insn))
 return 1;

      else if (fmt[i] == 'E')
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   if (modified_in_p ((((((x)->fld[i]).rtvec))->elem[j]), insn))
     return 1;
    }
     ...
     rtx x, y;
{
  ...
  if (! ((rtx_class[(int) (((enum rtx_code) (x)->code))]) == 'i') || ! ((rtx_class[(int) (((enum rtx_code) (y)->code))]) == 'i'))
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 1072, __FUNCTION__);

  tmp = (((y)->fld[5]).rtx);
  note_stores ((((x)->fld[5]).rtx), insn_dependent_p_1, &tmp);
  if (tmp == (rtx) 0)
    return 1;

  tmp = (((x)->fld[5]).rtx);
  note_stores ((((y)->fld[5]).rtx), insn_dependent_p_1, &tmp);
  if (tmp == (rtx) 0)
    return 1;
...
insn_dependent_p_1 (x, pat, data)
     rtx x;
     rtx pat __attribute__ ((__unused__));
     void *data;
{
  rtx * pinsn = (rtx *) data;
     ...
     rtx pat, insn;
{
  ...
  data.found = (rtx) 0;
  data.pat = pat;
  note_stores (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((insn)->fld[5]).rtx) : insn, set_of_1, &data);
  return data.found;
}
     ...
     rtx insn, pat;
{
 ...
 {
   rtx sub = (((((pat)->fld[0]).rtvec))->elem[i]);
   switch (((enum rtx_code) (sub)->code))
     ...
     case SET:
# 1165 "../../../kgccfe/gnu/rtlanal.c"
       if (!set_verified)
  {
    if (find_reg_note (insn, REG_UNUSED, (((set)->fld[0]).rtx))
        && !side_effects_p (set))
      set = ((void *)0);
    else
      set_verified = 1;
  ...
  set = sub, set_verified = 0;
       else if (!find_reg_note (insn, REG_UNUSED, (((sub)->fld[0]).rtx))
         || side_effects_p (sub))
  return (rtx) 0;
       break;
     ...
     rtx insn;
{
  ...
  if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL)
    {
      for (i = 0, found = 0; i < ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem); i++)
     ...
     rtx set;
{
  ...
  if (((enum rtx_code) (dst)->code) == SIGN_EXTRACT
    ...
    return rtx_equal_p ((((dst)->fld[0]).rtx), src)
    && ! ((target_flags & 0x00010000) != 0) && (((dst)->fld[2]).rtx) == (const_int_rtx[64]);
  ...
  if (((enum rtx_code) (src)->code) == SUBREG && ((enum rtx_code) (dst)->code) == SUBREG)
    {
      if ((((src)->fld[1]).rtuint) != (((dst)->fld[1]).rtuint))
 return 0;
      src = (((src)->fld[0]).rtx);
      dst = (((dst)->fld[0]).rtx);
    }
  ...
  return (((enum rtx_code) (src)->code) == REG && ((enum rtx_code) (dst)->code) == REG
   && (((src)->fld[0]).rtuint) == (((dst)->fld[0]).rtuint));
}
     ...
     rtx insn;
{
  ...
  if ((((insn)->fld[6]).rtint) == 2147483647)
    return 1;
  ...
  if (((enum rtx_code) (pat)->code) == PARALLEL)
    {
      ...
      for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
 {
   rtx tem = (((((pat)->fld[0]).rtvec))->elem[i]);
     ...
     int allow_hwreg;
{
  ...
  for (p = (((*pinsn)->fld[1]).rtx); p && ((enum rtx_code) (p)->code) != CODE_LABEL;
       p = (((p)->fld[1]).rtx))
 ...
 if (set && rtx_equal_p (x, (((set)->fld[0]).rtx)))
   {
     rtx src = (((set)->fld[1]).rtx);
     ...
     if ((valid_to == (rtx) 0
   || ! modified_between_p (src, (((p)->fld[1]).rtx), valid_to))


  && (! (((enum rtx_code) (src)->code) == REG
        && (((src)->fld[0]).rtuint) < 176) || allow_hwreg))
       {
  *pinsn = p;
  return src;
       }
     ...
     rtx *loc;
{
 ...
 repeat:
  ...
  switch (code)
    ...
    || x_regno == (0 + 1))
   && regno >= (176) && regno <= (((176)) + 4))
 return 1;

      return (endregno > x_regno
       && regno < x_regno + (x_regno < 176
        ? mips_hard_regno_nregs (x_regno, ((enum machine_mode) (x)->mode))
         : 1));
   ...
   && ((((((x)->fld[0]).rtx))->fld[0]).rtuint) < 176)
 {
   ...
   && ((((enum rtx_code) ((((x)->fld[0]).rtx))->code) == SUBREG
        ...
        && refers_to_regno_p (regno, endregno,
         ((((((x)->fld[0]).rtx))->fld[0]).rtx), loc))
       || (((enum rtx_code) ((((x)->fld[0]).rtx))->code) != REG
    && refers_to_regno_p (regno, endregno, (((x)->fld[0]).rtx), loc))))
 return 1;
      ...
      if (fmt[i] == 'e' && loc != &(((x)->fld[i]).rtx))
 {
   if (i == 0)
     ...
     if (refers_to_regno_p (regno, endregno, (((x)->fld[i]).rtx), loc))
       return 1;
 }
      else if (fmt[i] == 'E')
 {
  ...
  && refers_to_regno_p (regno, endregno, (((((x)->fld[i]).rtvec))->elem[j]), loc))
       return 1;
 }
    }
  return 0;
     ...
     rtx x, in;
{
 ...
 for (i = (rtx_length[(int) (((enum rtx_code) (in)->code))]) - 1; i >= 0; i--)
   if (fmt[i] == 'e' && reg_overlap_mentioned_p (x, (((in)->fld[i]).rtx)))
     return 1;
 ...
 for (i = (((((x)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
   if (((((((((x)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx) != 0
       && reg_overlap_mentioned_p (((((((((x)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx), in))
       return 1;
 return 0;
      }
  ...
  fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 1545, __FUNCTION__);
}
...
# 1569 "../../../kgccfe/gnu/rtlanal.c"
 ...
 if (set)
   {
     rtx last_value;
     if (((enum rtx_code) (set)->code) != SET || (((set)->fld[0]).rtx) != x)
       return 0;
     last_value = (((x)->fld[1]).rtx);
     if ((((enum rtx_code) (last_value)->code) == LABEL_REF || ((enum rtx_code) (last_value)->code) == SYMBOL_REF || ((enum rtx_code) (last_value)->code) == CONST_INT || ((enum rtx_code) (last_value)->code) == CONST_DOUBLE || ((enum rtx_code) (last_value)->code) == CONST || ((enum rtx_code) (last_value)->code) == HIGH || ((enum rtx_code) (last_value)->code) == CONST_VECTOR || ((enum rtx_code) (last_value)->code) == CONSTANT_P_RTX)
  || ((((enum rtx_code) (last_value)->code) == REG
       || ((enum rtx_code) (last_value)->code) == SUBREG)
...
# 1607 "../../../kgccfe/gnu/rtlanal.c"
void
note_stores (x, fun, data)
     rtx x;
     void (*fun) (rtx, rtx, void *);
     void *data;
{
  int i;
  ...
  if (((enum rtx_code) (x)->code) == SET || ((enum rtx_code) (x)->code) == CLOBBER)
    ...
    || ((((((dest)->fld[0]).rtx))->fld[0]).rtuint) >= 176))
      ...
      if (((enum rtx_code) (dest)->code) == PARALLEL)
 {
   for (i = (((((dest)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
     if (((((((((dest)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx) != 0)
       (*fun) (((((((((dest)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx), x, data);
 }
      else
 (*fun) (dest, x, data);
    }
    ...
    for (i = (((((x)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
      note_stores ((((((x)->fld[0]).rtvec))->elem[i]), fun, data);
}
# 1656 "../../../kgccfe/gnu/rtlanal.c"
void
     ...
     void *data;
{
  ...
  switch (((enum rtx_code) (body)->code))
    {
    case COND_EXEC:
      (*fun) (&(((body)->fld[0]).rtx), data);
      note_uses (&(((body)->fld[1]).rtx), fun, data);
      return;

    case PARALLEL:
      for (i = (((((body)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
 note_uses (&(((((body)->fld[0]).rtvec))->elem[i]), fun, data);
      return;
    ...
    case ASM_OPERANDS:
      for (i = (((((body)->fld[3]).rtvec))->num_elem) - 1; i >= 0; i--)
 (*fun) (&(((((body)->fld[3]).rtvec))->elem[i]), data);
      return;
    ...
    case UNSPEC_VOLATILE:
      for (i = (((((body)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
 (*fun) (&(((((body)->fld[0]).rtvec))->elem[i]), data);
      return;

    case CLOBBER:
      if (((enum rtx_code) ((((body)->fld[0]).rtx))->code) == MEM)
 (*fun) (&((((((body)->fld[0]).rtx))->fld[0]).rtx), data);
      return;
 ...
 (*fun) (&(((body)->fld[1]).rtx), data);

 if (((enum rtx_code) (dest)->code) == ZERO_EXTRACT)
   {
     (*fun) (&(((dest)->fld[1]).rtx), data);
     (*fun) (&(((dest)->fld[2]).rtx), data);
   }
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) != REG)
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 1764, __FUNCTION__);

  regno = (((x)->fld[0]).rtuint);
  last_regno = (regno >= 176 ? regno
  : regno + mips_hard_regno_nregs (regno, ((enum machine_mode) (x)->mode)) - 1);
     ...
     unsigned int test_regno;
{
 ...
 return 0;
      ...
      endregno = (regno >= 176 ? regno + 1
    : regno + mips_hard_regno_nregs (regno, ((enum machine_mode) (dest)->mode)));
  ...
  else if (((enum rtx_code) (pattern)->code) == PARALLEL)
    {
      ...
      for (i = (((((pattern)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
 {
   rtx body = (((((pattern)->fld[0]).rtvec))->elem[i]);
     ...
     unsigned int regno;
{
 ...
 && ((((((link)->fld[0]).rtx))->fld[0]).rtuint) <= regno
 && ((((((((link)->fld[0]).rtx))->fld[0]).rtuint)
      + (((((((link)->fld[0]).rtx))->fld[0]).rtuint) >= 176 ? 1
  : mips_hard_regno_nregs (((((((link)->fld[0]).rtx))->fld[0]).rtuint), ((enum machine_mode) ((((link)->fld[0]).rtx))->mode))))
     ...
     rtx insn;
{
  ...
  if ((((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0) == 0)
    return 0;
  else if ((note = find_reg_note (insn, REG_EQUIV, (rtx) 0)) != 0)
    return note;
  else
    return find_reg_note (insn, REG_EQUAL, (rtx) 0);
}
     ...
     rtx datum;
{
  ...
  if (! datum)
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 1948, __FUNCTION__);
  ...
  if (((enum rtx_code) (datum)->code) != REG)
    ...
    link;
    link = (((link)->fld[1]).rtx))
 if (((enum rtx_code) ((((link)->fld[0]).rtx))->code) == code
     && rtx_equal_p (datum, ((((((link)->fld[0]).rtx))->fld[0]).rtx)))
   return 1;
    }
  else
    {
      unsigned int regno = (((datum)->fld[0]).rtuint);
      ...
      if (regno < 176)
 {
   unsigned int end_regno
     = regno + mips_hard_regno_nregs (regno, ((enum machine_mode) (datum)->mode));
   unsigned int i;
     ...
     unsigned int regno;
{
  ...
  for (link = (((insn)->fld[9]).rtx); link; link = (((link)->fld[1]).rtx))
    {
      unsigned int regnote;
      rtx op, reg;

      if (((enum rtx_code) (op = (((link)->fld[0]).rtx))->code) == code
   && ((enum rtx_code) (reg = (((op)->fld[0]).rtx))->code) == REG
   && (regnote = (((reg)->fld[0]).rtuint)) <= regno
   && regnote + mips_hard_regno_nregs (regnote, ((enum machine_mode) (reg)->mode)) > regno)
 return 1;
    }
  ...
  for (link = (((insn)->fld[9]).rtx); link; link = (((link)->fld[1]).rtx))
    {
      ...
      if (((enum rtx_code) (u = (((link)->fld[0]).rtx))->code) == USE
   && ((enum rtx_code) (m = (((u)->fld[0]).rtx))->code) == MEM && ((enum machine_mode) (m)->mode) == BLKmode
   && ((enum rtx_code) ((((m)->fld[0]).rtx))->code) == SCRATCH)
 return 1;
    }
     ...
     rtx note;
{
  ...
  if ((((insn)->fld[8]).rtx) == note)
    {
      (((insn)->fld[8]).rtx) = (((note)->fld[1]).rtx);
      return;
    }

  for (link = (((insn)->fld[8]).rtx); link; link = (((link)->fld[1]).rtx))
    if ((((link)->fld[1]).rtx) == note)
      {
 (((link)->fld[1]).rtx) = (((note)->fld[1]).rtx);
 return;
      }

  fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 2066, __FUNCTION__);
}
     ...
     rtx *listp;
{
  ...
  while (temp)
    {
      if (node == (((temp)->fld[0]).rtx))
 {

   if (prev)
     (((prev)->fld[1]).rtx) = (((temp)->fld[1]).rtx);
   else
     *listp = (((temp)->fld[1]).rtx);
     ...
     rtx x;
{
 ...
 if (fmt[i] == 'e')
   {
     if (volatile_insn_p ((((x)->fld[i]).rtx)))
       return 1;
   }
 else if (fmt[i] == 'E')
   {
     int j;
     for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
       if (volatile_insn_p ((((((x)->fld[i]).rtvec))->elem[j])))
  return 1;
   }
      }
  }
     ...
     rtx x;
{
 ...
 if (fmt[i] == 'e')
   {
     if (volatile_refs_p ((((x)->fld[i]).rtx)))
       return 1;
   }
 else if (fmt[i] == 'E')
   {
     int j;
     for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
       if (volatile_refs_p ((((((x)->fld[i]).rtvec))->elem[j])))
  return 1;
   }
      }
  }
     ...
     rtx x;
{
 ...
 if (fmt[i] == 'e')
 ...
 else if (fmt[i] == 'E')
   {
     int j;
     for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
       if (side_effects_p ((((((x)->fld[i]).rtvec))->elem[j])))
  return 1;
   }
      }
  }
     ...
     rtx x;
{
 ...
 return 0;
    ...
    case UDIV:
    case UMOD:
      if ((flag_signaling_nans && ((((mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)))
 return 1;
 ...
 break;
      ...
      if (((((mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
 return 1;


      if (((((mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)
   || ((((mode_class[(int) (((enum machine_mode) ((((x)->fld[1]).rtx))->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[1]).rtx))->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[1]).rtx))->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
 return 1;
      break;
 ...
 return 1;
      ...
      if ((flag_signaling_nans && ((((mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
   || (flag_signaling_nans && ((((mode_class[(int) (((enum machine_mode) ((((x)->fld[1]).rtx))->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[1]).rtx))->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[1]).rtx))->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)))
 return 1;
      break;

    case FIX:

      if (flag_trapping_math && ((((mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) ((((x)->fld[0]).rtx))->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
 return 1;
      break;
    ...
    default:
      ...
      if ((mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_FLOAT
   && flag_trapping_math)
 return 1;
    }
      ...
      else if (fmt[i] == 'E')
 {
   int j;
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     if (may_trap_p ((((((x)->fld[i]).rtvec))->elem[j])))
       return 1;
 }
    }
  return 0;
     ...
     rtx x;
{
      ...
      else if (fmt[i] == 'E')
 {
   int j;
   for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
     if (inequality_comparisons_p ((((((x)->fld[i]).rtvec))->elem[j])))
       return 1;
 }
    }
     ...
     rtx x, from, to;
{
  ...
  if (((enum rtx_code) (x)->code) == SUBREG)
    {
      rtx new = replace_rtx ((((x)->fld[0]).rtx), from, to);
      ...
      if (((enum rtx_code) (new)->code) == CONST_INT)
 {
   x = simplify_subreg (((enum machine_mode) (x)->mode), new,
          ...
          (((x)->fld[1]).rtuint));
   if (! x)
     fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 2558, __FUNCTION__);
 }
      else
 (((x)->fld[0]).rtx) = new;
      ...
      if (((enum rtx_code) (new)->code) == CONST_INT)
 {
   ...
   if (! x)
     fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 2574, __FUNCTION__);
 }
      else
 (((x)->fld[0]).rtx) = new;
  ...
  for (i = (rtx_length[(int) (((enum rtx_code) (x)->code))]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 (((x)->fld[i]).rtx) = replace_rtx ((((x)->fld[i]).rtx), from, to);
      else if (fmt[i] == 'E')
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   (((((x)->fld[i]).rtvec))->elem[j]) = replace_rtx ((((((x)->fld[i]).rtvec))->elem[j]), from, to);
    }

  return x;
}
# 2607 "../../../kgccfe/gnu/rtlanal.c"
rtx
     ...
     int replace_dest;
{
  ...
  switch (code)
    ...
    case REG:
      ...
      if ((((x)->fld[0]).rtuint) < nregs && reg_map[(((x)->fld[0]).rtuint)] != 0)
 {



   if (((enum rtx_code) (reg_map[(((x)->fld[0]).rtuint)])->code) == SUBREG)
     return copy_rtx (reg_map[(((x)->fld[0]).rtuint)]);
   return reg_map[(((x)->fld[0]).rtuint)];
 }
      return x;

    case SUBREG:

      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == REG && ((((((x)->fld[0]).rtx))->fld[0]).rtuint) < nregs
   && reg_map[((((((x)->fld[0]).rtx))->fld[0]).rtuint)] != 0
   && ((enum rtx_code) (reg_map[((((((x)->fld[0]).rtx))->fld[0]).rtuint)])->code) == SUBREG)
 {
   rtx map_val = reg_map[((((((x)->fld[0]).rtx))->fld[0]).rtuint)];
   return simplify_gen_subreg (((enum machine_mode) (x)->mode), map_val,
    ...
    case SET:
      if (replace_dest)
 (((x)->fld[0]).rtx) = replace_regs ((((x)->fld[0]).rtx), reg_map, nregs, 0);

      else if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == MEM
        || ((enum rtx_code) ((((x)->fld[0]).rtx))->code) == STRICT_LOW_PART)



 ((((((x)->fld[0]).rtx))->fld[0]).rtx) = replace_regs (((((((x)->fld[0]).rtx))->fld[0]).rtx),
            reg_map, nregs, 0);
      else if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == ZERO_EXTRACT)

 break;

      (((x)->fld[1]).rtx) = replace_regs ((((x)->fld[1]).rtx), reg_map, nregs, 0);
      return x;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 (((x)->fld[i]).rtx) = replace_regs ((((x)->fld[i]).rtx), reg_map, nregs, replace_dest);
      else if (fmt[i] == 'E')
 {
   int j;
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     (((((x)->fld[i]).rtvec))->elem[j]) = replace_regs ((((((x)->fld[i]).rtvec))->elem[j]), reg_map,
           nregs, replace_dest);
 }
    }
  return x;
     ...
     rtx x;
{
  ...
  switch (code)
    ...
    case MEM:
      return ! (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == SYMBOL_REF
  && ((((((x)->fld[0]).rtx)))->unchanging));

    case IF_THEN_ELSE:
      return (computed_jump_p_1 ((((x)->fld[1]).rtx))
       || computed_jump_p_1 ((((x)->fld[2]).rtx)));
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e'
   && computed_jump_p_1 ((((x)->fld[i]).rtx)))
 return 1;

      else if (fmt[i] == 'E')
 for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
   if (computed_jump_p_1 ((((((x)->fld[i]).rtvec))->elem[j])))
     return 1;
    }
     ...
     rtx insn;
{
 ...
 {
   int len = (((((pat)->fld[0]).rtvec))->num_elem);
   int has_use_labelref = 0;

   for (i = len - 1; i >= 0; i--)
     if (((enum rtx_code) ((((((pat)->fld[0]).rtvec))->elem[i]))->code) == USE
  && (((enum rtx_code) (((((((((pat)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx))->code)
      == LABEL_REF))
       has_use_labelref = 1;

   if (! has_use_labelref)
     for (i = len - 1; i >= 0; i--)
       if (((enum rtx_code) ((((((pat)->fld[0]).rtvec))->elem[i]))->code) == SET
    && ((((((((pat)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx) == (global_rtl[GR_PC])
    && computed_jump_p_1 (((((((((pat)->fld[0]).rtvec))->elem[i]))->fld[1]).rtx)))
  return 1;
 }
      else if (((enum rtx_code) (pat)->code) == SET
        && (((pat)->fld[0]).rtx) == (global_rtl[GR_PC])
        && computed_jump_p_1 ((((pat)->fld[1]).rtx)))
 return 1;
    }
  return 0;
}
# 2808 "../../../kgccfe/gnu/rtlanal.c"
int
     ...
     void *data;
{
 ...
 {
 case 'e':
   result = for_each_rtx (&(((*x)->fld[i]).rtx), f, data);
   if (result != 0)
     return result;
   break;
   ...
   if ((((*x)->fld[i]).rtvec) != 0)
     {
       ...
       for (j = 0; j < (((((*x)->fld[i]).rtvec))->num_elem); ++j)
  {
    result = for_each_rtx (&(((((*x)->fld[i]).rtvec))->elem[j]), f, data);
    if (result != 0)
      return result;
  }
     }
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) == REG && (((x)->fld[0]).rtuint) == regno)
    return x;
  ...
  for (i = (rtx_length[(int) (((enum rtx_code) (x)->code))]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 {
   if ((tem = regno_use_in (regno, (((x)->fld[i]).rtx))))
     return tem;
 }
      else if (fmt[i] == 'E')
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   if ((tem = regno_use_in (regno , (((((x)->fld[i]).rtvec))->elem[j]))))
     return tem;
    }
     ...
     rtx op;
{
  ...
  if (((enum rtx_code) (op)->code) == SUBREG
      && (rtx_class[(int) (((enum rtx_code) ((((op)->fld[0]).rtx))->code))]) == 'o')
    return -2;




  if (((enum rtx_code) (op)->code) == NEG || ((enum rtx_code) (op)->code) == NOT
      || ((enum rtx_code) (op)->code) == MULT || ((enum rtx_code) (op)->code) == PLUS
      || ((enum rtx_code) (op)->code) == MINUS)
    return 2;



  if ((rtx_class[(int) (((enum rtx_code) (op)->code))]) == 'o')
    return -1;
  return 0;
}
     ...
     rtx x;
{
  switch (((enum rtx_code) (x)->code))
    ...
    case POST_MODIFY:
      ...
      if ((((x)->fld[0]).rtx) != (global_rtl[GR_STACK_POINTER]))
 return 1;
    default:
      break;
    }
     ...
     rtx x;
{
  ...
  if ((mode_bitsize[(int) (mode)]) > (mode_bitsize[(int) (inner_mode)]))
    return 0;

  if (((target_flags & 0x00010000) != 0) != ((target_flags & 0x00010000) != 0))


    if (((((x)->fld[1]).rtuint) % ((target_flags & 0x00002000) ? 8 : 4)
  + (mode_size[(int) (mode)])) > ((target_flags & 0x00002000) ? 8 : 4)
 && ((((x)->fld[1]).rtuint) % ((target_flags & 0x00002000) ? 8 : 4)
     || (mode_size[(int) (mode)]) % ((target_flags & 0x00002000) ? 8 : 4)))
 fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3102, __FUNCTION__);

  if (((target_flags & 0x00010000) != 0))
    word = ((mode_size[(int) (inner_mode)])
     - ((((x)->fld[1]).rtuint) + (mode_size[(int) (mode)]))) / ((target_flags & 0x00002000) ? 8 : 4);
  else
    word = (((x)->fld[1]).rtuint) / ((target_flags & 0x00002000) ? 8 : 4);
  bitpos = word * (8 * ((target_flags & 0x00002000) ? 8 : 4));

  if (((target_flags & 0x00010000) != 0))
    byte = ((mode_size[(int) (inner_mode)])
     - ((((x)->fld[1]).rtuint) + (mode_size[(int) (mode)]))) % ((target_flags & 0x00002000) ? 8 : 4);
  else
    byte = (((x)->fld[1]).rtuint) % ((target_flags & 0x00002000) ? 8 : 4);
  bitpos += byte * 8;
     ...
     enum machine_mode ymode;
{
  ...
  if (xregno >= 176)
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3139, __FUNCTION__);

  nregs_xmode = mips_hard_regno_nregs (xregno, xmode);
  nregs_ymode = mips_hard_regno_nregs (xregno, ymode);
  ...
  if (offset == 0
      ...
      && ((mode_size[(int) (ymode)]) > ((target_flags & 0x00002000) ? 8 : 4)
   ? ((target_flags & 0x00010000) != 0) : ((target_flags & 0x00010000) != 0)))
  ...
  mode_multiple = (mode_size[(int) (xmode)]) / (mode_size[(int) (ymode)]);
  if (mode_multiple == 0)
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3159, __FUNCTION__);

  y_offset = offset / (mode_size[(int) (ymode)]);
  nregs_multiple = nregs_xmode / nregs_ymode;
  return (y_offset / (mode_multiple / nregs_multiple)) * nregs_ymode;
}
# 3173 "../../../kgccfe/gnu/rtlanal.c"
_Bool
     ...
     enum machine_mode ymode;
{
  ...
  if (xregno >= 176)
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3185, __FUNCTION__);
  ...
  if (offset == subreg_lowpart_offset (ymode, xmode))
    return 1;
# 3214 "../../../kgccfe/gnu/rtlanal.c"
  offset -= subreg_lowpart_offset (ymode,
         mode_for_size ((mode_bitsize[(int) (xmode)])
          / nregs_xmode,
        MODE_INT, 0));
  ...
  mode_multiple = (mode_size[(int) (xmode)]) / (mode_size[(int) (ymode)]);
  if (mode_multiple == 0)
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3222, __FUNCTION__);
...
{
  unsigned int ret;
  rtx subreg = (((x)->fld[0]).rtx);
  int regno = (((subreg)->fld[0]).rtuint);
 ...
 void *data;
{
  ...
  if ((((enum rtx_code) (x)->code) == REG) && (((x)->fld[0]).rtuint) < 176
      && (!!((d->regs)[((((x)->fld[0]).rtuint)) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << (((((x)->fld[0]).rtuint)) % ((unsigned) (8 * 8)))))))
    {
      ((d->regs)[((((x)->fld[0]).rtuint)) / ((unsigned) (8 * 8))] &= ~(((HARD_REG_ELT_TYPE) (1)) << (((((x)->fld[0]).rtuint)) % ((unsigned) (8 * 8)))));
      d->nregs--;
    }
     ...
     rtx call_insn, boundary;
{
  ...
  do { HARD_REG_ELT_TYPE *scan_tp_ = (parm.regs); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
  parm.nregs = 0;
  for (p = (((call_insn)->fld[9]).rtx); p; p = (((p)->fld[1]).rtx))
    if (((enum rtx_code) ((((p)->fld[0]).rtx))->code) == USE
 && ((enum rtx_code) (((((((p)->fld[0]).rtx))->fld[0]).rtx))->code) == REG)
      {
 if ((((((((((p)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint) >= 176)
   fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3290, __FUNCTION__);



 if (!((((unsigned long long) ((((((((((((p)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint))) - ((0 + 4))) <= ((((0 + 4) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((0 + 4)))) || (((unsigned long long) ((((((((((((p)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint))) - ((32 + 12))) <= ((((32 + 12) + ((mips_abi == 0 || mips_abi == 4) ? 4 : 8) - 1)) - ((32 + 12)))) && (((((((((((p)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint)) % ((target_flags & 0x00000200) || (target_flags & 0x00020000) ? 1 : 2) == 0) && mips_abi != 4)) && !fixed_regs[(((((((((p)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint)]))
   continue;

 ((parm.regs)[((((((((((p)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint)) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << (((((((((((p)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtuint)) % ((unsigned) (8 * 8))));
 parm.nregs++;
      }
  before = call_insn;
 ...
 {
   if (before != boundary)
     fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3319, __FUNCTION__);
   break;
 }

      if (((rtx_class[(int) (((enum rtx_code) (before)->code))]) == 'i'))
 note_stores ((((before)->fld[5]).rtx), parms_set, &parm);
    }
  return before;
}
     ...
     rtx insn;
{
  ...
  if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && (set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0)) != ((void *)0))
    {
      if (((enum rtx_code) ((((set)->fld[0]).rtx))->code) == REG
   && ((((((set)->fld[0]).rtx))->fld[0]).rtuint) < 176
   && fixed_regs[((((((set)->fld[0]).rtx))->fld[0]).rtuint)]
   && general_operand ((((set)->fld[1]).rtx), VOIDmode))
 return 1;
      if (((enum rtx_code) ((((set)->fld[1]).rtx))->code) == REG
   && ((((((((set)->fld[1]).rtx))->fld[0]).rtuint)) == (0 + 2) || (((((((set)->fld[1]).rtx))->fld[0]).rtuint)) == (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) || ((mips_abi == 1 || mips_abi == 2 ? 128 : 64) == 128 && (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) != (0 + 2) && (((((((set)->fld[1]).rtx))->fld[0]).rtuint)) == (((target_flags & 0x00000100)) ? (0 + 2) : (32 + 0)) + 2))
     ...
     regset live;
{
  ...
  if (((enum rtx_code) (x)->code) == SUBREG && rtx_equal_p ((((x)->fld[0]).rtx), val))
    {
  ...
  if ((((x)->fld[0]).rtuint) < 176)
    {
      ...
      int n = mips_hard_regno_nregs (regno, ((enum machine_mode) (x)->mode));
     ...
     regset live;
{
  ...
  if (!(((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0))
    return 0;
  ...
  switch (((enum rtx_code) (pat)->code))
    {
    case SET:
      if (!hoist_test_store ((((pat)->fld[0]).rtx), val, live))
 return 0;
      break;
    case USE:
      ...
      for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
 {
   ...
   switch (((enum rtx_code) (x)->code))
     {
     case SET:
       if (!hoist_test_store ((((x)->fld[0]).rtx), val, live))
  return 0;
       break;
     case USE:
  ...
  return 0;
     ...
     default:
      ...
      break;
    default:
      fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3485, __FUNCTION__);
    }
  return 1;
}
     ...
     rtx insn, *xp, val, new;
{
  ...
  if (((enum rtx_code) (x)->code) == SUBREG && (((x)->fld[0]).rtx) == val)
  ...
  if (!(((enum rtx_code) (x)->code) == REG))
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3519, __FUNCTION__);
  ...
  (((insn)->fld[8]).rtx)
    = alloc_EXPR_LIST (REG_UNUSED, *xp, (((insn)->fld[8]).rtx));
}
     ...
     rtx insn, after, val, new;
{
  ...
  switch (((enum rtx_code) (pat)->code))
    {
    case SET:
      hoist_update_store (insn, &(((pat)->fld[0]).rtx), val, new);
      break;
    case USE:
      break;
    case CLOBBER:
      ...
      for (i = 0; i < (((((pat)->fld[0]).rtvec))->num_elem); i++)
 {
   ...
   switch (((enum rtx_code) (x)->code))
     {
     case SET:
       hoist_update_store (insn, &(((x)->fld[0]).rtx), val, new);
       break;
     case USE:
       break;
     case CLOBBER:
     ...
     default:
      ...
      break;
    default:
      fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3589, __FUNCTION__);
    }
  if (!apply_change_group ())
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3592, __FUNCTION__);
     ...
     edge e;
{
  ...
  if ((e->flags & 2) && ((e)->src->succ->succ_next && (e)->dest->pred->pred_next))
    fancy_abort ("../../../kgccfe/gnu/rtlanal.c", 3607, __FUNCTION__);
