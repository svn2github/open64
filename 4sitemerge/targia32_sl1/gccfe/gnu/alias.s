...
.LFE23:
	...
	.local	last_alias_set.14037
	.comm	last_alias_set.14037,8,8
.globl new_alias_set
...
.LCFI38:
	...
	je	.L220
	.loc 1 611 0
	movl	last_alias_set.14037@GOTOFF(%ecx), %eax
	movl	4+last_alias_set.14037@GOTOFF(%ecx), %edx
	addl	$1, %eax
	adcl	$0, %edx
	movl	%eax, last_alias_set.14037@GOTOFF(%ecx)
	movl	%edx, 4+last_alias_set.14037@GOTOFF(%ecx)
	movl	last_alias_set.14037@GOTOFF(%ecx), %eax
	movl	4+last_alias_set.14037@GOTOFF(%ecx), %edx
	movl	%eax, -8(%ebp)
	movl	%edx, -4(%ebp)
...
.LFE24:
	...
	.section	.rodata
	.type	__FUNCTION__.14051, @object
	.size	__FUNCTION__.14051, 20
__FUNCTION__.14051:
	.string	"record_alias_subset"
.LC0:
	.string	"../../../kgccfe/gnu/alias.c"
	.text
...
.LCFI42:
	...
	jne	.L227
	.loc 1 639 0
	leal	__FUNCTION__.14051@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$639, 4(%esp)
...
.LCFI50:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 737 0
	movl	set.14138@GOTOFF(%ebx), %eax
	movl	4+set.14138@GOTOFF(%ebx), %edx
	movl	%edx, %ecx
	xorl	$-1, %ecx
	xorl	$-1, %eax
	orl	%ecx, %eax
	...
	.loc 1 738 0
	call	new_alias_set@PLT
	movl	%eax, set.14138@GOTOFF(%ebx)
	movl	%edx, 4+set.14138@GOTOFF(%ebx)
.L260:
	.loc 1 740 0
	movl	set.14138@GOTOFF(%ebx), %eax
	movl	4+set.14138@GOTOFF(%ebx), %edx
...
.LCFI54:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 751 0
	movl	set.14147@GOTOFF(%ebx), %eax
	movl	4+set.14147@GOTOFF(%ebx), %edx
	movl	%edx, %ecx
	xorl	$-1, %ecx
	xorl	$-1, %eax
	orl	%ecx, %eax
	...
	.loc 1 752 0
	call	new_alias_set@PLT
	movl	%eax, set.14147@GOTOFF(%ebx)
	movl	%edx, 4+set.14147@GOTOFF(%ebx)
.L264:
	.loc 1 754 0
	movl	set.14147@GOTOFF(%ebx), %eax
	movl	4+set.14147@GOTOFF(%ebx), %edx
...
.LFE29:
	...
	.section	.rodata
	.type	__FUNCTION__.14385, @object
	.size	__FUNCTION__.14385, 11
__FUNCTION__.14385:
	.string	"record_set"
	.text
...
.LCFI63:
	...
	jb	.L354
	.loc 1 944 0
	leal	__FUNCTION__.14385@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$944, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE33:
	...
	.section	.rodata
	.type	__FUNCTION__.14659, @object
	.size	__FUNCTION__.14659, 23
__FUNCTION__.14659:
...
.L477:
	.loc 1 1225 0
	leal	__FUNCTION__.14659@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1225, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFB63:
	.file 2 "../../../kgccfe/gnu/MIPS/gt-alias.h"
	.loc 2 29 0
	pushl	%ebp
.LCFI195:
	movl	%esp, %ebp
...
.LEFDE96:
	...
	.file 7 "../../../kgccfe/gnu/cselib.h"
	.file 8 "../../../kgccfe/gnu/varray.h"
	.file 9 "../../../kgccfe/gnu/bitmap.h"
	...
	.file 16 "../../../kgccfe/gnu/basic-block.h"
	.file 17 "../../../kgccfe/gnu/sbitmap.h"
	.file 18 "/usr/lib/gcc/i486-linux-gnu/4.1.2/include/stddef.h"
	.file 19 "../../../kgccfe/gnu/hard-reg-set.h"
