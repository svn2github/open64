     ...
     int index;
{
  ...
  struct data *i, *last_named = ((void *)0);
...
# 394 "../../../kgccfe/gnu/genoutput.c"
 ...
 case 3:
   ...
   break;
 default:
   fancy_abort ("../../../kgccfe/gnu/genoutput.c", 402, __FUNCTION__);
 }
     ...
     int this_strict_low;
{
  ...
  switch (((enum rtx_code) (part)->code))
    {
    case MATCH_OPERAND:
      opno = (((part)->fld[0]).rtint);
      if (opno > max_opno)
 max_opno = opno;
      if (max_opno >= 40)
 {
      ...
      if (d->operand[opno].seen)
 {
   ...
   have_error = 1;
      ...
      d->operand[opno].mode = ((enum machine_mode) (part)->mode);
      d->operand[opno].strict_low = this_strict_low;
      d->operand[opno].predicate = (((part)->fld[1]).rtstr);
      d->operand[opno].constraint = strip_whitespace ((((part)->fld[2]).rtstr));
      ...
      if (d->operand[opno].seen)
 {
   ...
   have_error = 1;
      ...
      d->operand[opno].constraint = strip_whitespace ((((part)->fld[1]).rtstr));
      d->operand[opno].n_alternatives
 = n_occurrences (',', d->operand[opno].constraint) + 1;
 ...
 scan_operands (d, (((((part)->fld[2]).rtvec))->elem[i]), 0, 0);
      return;
    ...
    case ADDRESS:
      scan_operands (d, (((part)->fld[0]).rtx), 1, 0);
      return;

    case STRICT_LOW_PART:
      scan_operands (d, (((part)->fld[0]).rtx), 0, 1);
      return;
  ...
  format_ptr = (rtx_format[(int) (((enum rtx_code) (part)->code))]);

  for (i = 0; i < (rtx_length[(int) (((enum rtx_code) (part)->code))]); i++)
    switch (*format_ptr++)
      {
      case 'e':
      case 'u':
 scan_operands (d, (((part)->fld[i]).rtx), 0, 0);
 break;
      case 'E':
 if ((((part)->fld[i]).rtvec) != ((void *)0))
   for (j = 0; j < (((((part)->fld[i]).rtvec))->num_elem); j++)
     scan_operands (d, (((((part)->fld[i]).rtvec))->elem[j]), 0, 0);
 break;
      }
}
    ...
    const char *template;
{
 ...
 {
   while ((_sch_istable[(*cp) & 0xff] & (unsigned short)(_sch_isspace)))
     cp++;
     ...
     int lineno;
{
  ...
  *idata_end = d;
  ...
  for (i = 0; i < (((((insn)->fld[1]).rtvec))->num_elem); i++)
    scan_operands (d, (((((insn)->fld[1]).rtvec))->elem[i]), 0, 0);
  ...
  validate_insn_alternatives (d);
  place_operands (d);
  process_template (d, (((insn)->fld[3]).rtstr));
}
     ...
     int lineno;
{
  ...
  *idata_end = d;
  ...
  for (i = 0; i < (((((peep)->fld[0]).rtvec))->num_elem); i++)
    scan_operands (d, (((((peep)->fld[0]).rtvec))->elem[i]), 0, 0);
  ...
  validate_insn_alternatives (d);
  place_operands (d);
  process_template (d, (((peep)->fld[2]).rtstr));
}
     ...
     int lineno;
{
  ...
  *idata_end = d;
  ...
  for (i = 0; i < (((((split)->fld[0]).rtvec))->num_elem); i++)
    scan_operands (d, (((((split)->fld[0]).rtvec))->elem[i]), 0, 0);
     ...
     char **argv;
{
 ...
 gen_insn (desc, line_no);
      if (((enum rtx_code) (desc)->code) == DEFINE_PEEPHOLE)
 gen_peephole (desc, line_no);
      if (((enum rtx_code) (desc)->code) == DEFINE_EXPAND)
 gen_expand (desc, line_no);
      if (((enum rtx_code) (desc)->code) == DEFINE_SPLIT
    || ((enum rtx_code) (desc)->code) == DEFINE_PEEPHOLE2)
     ...
     const char *s;
{
  ...
  while ((ch = *s++) != '\0')
    if (! (_sch_istable[(ch) & 0xff] & (unsigned short)(_sch_isspace)))
      *p++ = ch;
