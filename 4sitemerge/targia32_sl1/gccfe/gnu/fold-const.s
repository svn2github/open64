...
encode:
.LFB15:
	.file 1 "../../../kgccfe/gnu/fold-const.c"
	.loc 1 169 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LFE24:
	...
	.section	.rodata
	.type	__FUNCTION__.12855, @object
	.size	__FUNCTION__.12855, 21
__FUNCTION__.12855:
...
.globl __umoddi3
	.align 4
.LC0:
	.string	"../../../kgccfe/gnu/fold-const.c"
	.text
...
.LBE4:
	.loc 1 839 0
	leal	__FUNCTION__.12855@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$839, 4(%esp)
...
.LFE28:
	...
	.section	.rodata
	.type	__FUNCTION__.13385, @object
	.size	__FUNCTION__.13385, 16
__FUNCTION__.13385:
...
.L325:
	.loc 1 1183 0
	leal	__FUNCTION__.13385@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1183, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LBE8:
	.loc 1 1344 0
	leal	__FUNCTION__.13614@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1344, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE34:
	...
	.section	.rodata
	.type	__FUNCTION__.13845, @object
	.size	__FUNCTION__.13845, 11
__FUNCTION__.13845:
	.string	"size_binop"
	.text
.globl size_binop
...
.L492:
	.loc 1 1450 0
	leal	__FUNCTION__.13845@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1450, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE35:
	...
	.section	.rodata
	.type	__FUNCTION__.13890, @object
	.size	__FUNCTION__.13890, 12
__FUNCTION__.13890:
	.string	"size_diffop"
	.text
.globl size_diffop
...
.L515:
	.loc 1 1487 0
	leal	__FUNCTION__.13890@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1487, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L597:
	.loc 1 1701 0
	leal	__FUNCTION__.14144@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1701, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L608:
	.loc 1 1726 0
	leal	__FUNCTION__.14157@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1726, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE41:
	...
	.section	.rodata
	.type	__FUNCTION__.14170, @object
	.size	__FUNCTION__.14170, 23
__FUNCTION__.14170:
...
.L618:
	.loc 1 1754 0
	leal	__FUNCTION__.14170@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1754, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L629:
	.loc 1 1781 0
	leal	__FUNCTION__.14183@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$1781, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.L904:
	...
	je	.L924
	.loc 1 2357 0
	leal	__FUNCTION__.14840@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2357, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE58:
	...
	.section	.rodata
	.type	__FUNCTION__.15476, @object
	.size	__FUNCTION__.15476, 12
__FUNCTION__.15476:
	.string	"range_binop"
	.text
...
.L1114:
	.loc 1 2883 0
	leal	__FUNCTION__.15476@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2883, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE59:
	...
	.section	.rodata
	.type	__FUNCTION__.15569, @object
	.size	__FUNCTION__.15569, 11
__FUNCTION__.15569:
	.string	"make_range"
	.text
...
.L1159:
	.loc 1 2977 0
	leal	__FUNCTION__.15569@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$2977, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LCFI256:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 4069 0
	movl	depth.16930@GOTOFF(%ebx), %eax
	cmpl	$3, %eax
	jle	.L1615
	.loc 1 4070 0
	movl	$0, -24(%ebp)
...
.L1615:
	...
	movl	depth.16930@GOTOFF(%ebx), %eax
	addl	$1, %eax
	movl	%eax, depth.16930@GOTOFF(%ebx)
	.loc 1 4073 0
	movl	20(%ebp), %eax
	movl	%eax, 12(%esp)
	movl	16(%ebp), %eax
...
.LFE73:
	...
	.section	.rodata
	.type	__FUNCTION__.17754, @object
	.size	__FUNCTION__.17754, 5
__FUNCTION__.17754:
	.string	"fold"
.globl __divdi3
	.text
...
.L2961:
	.loc 1 6611 0
	leal	__FUNCTION__.17754@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$6611, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
