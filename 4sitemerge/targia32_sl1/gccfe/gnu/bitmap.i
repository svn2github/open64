...
# 29 "../../../kgccfe/gnu/bitmap.c" 2


static struct obstack bitmap_obstack;
static int bitmap_obstack_init = 0;
# 43 "../../../kgccfe/gnu/bitmap.c"
...
static __inline__ bitmap_element *
  ...
  if (bitmap_obstack_init)
    {
      ...
      __extension__ ({ struct obstack *__o = (&bitmap_obstack); void *__obj = (((void *)0)); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
    }
}
...
# 587 "../../../kgccfe/gnu/bitmap.c"
 ...
 {
 default:
   fancy_abort ("../../../kgccfe/gnu/bitmap.c", 642, __FUNCTION__);
     ...
     bitmap head;
{
  ...
  fprintf (file, "\nfirst = ");
  fprintf (file, "%p", (void *) head->first);
  fprintf (file, " current = ");
  fprintf (file, "%p", (void *) head->current);
  fprintf (file, " indx = %u\n", head->indx);
  ...
  for (ptr = head->first; ptr; ptr = ptr->next)
    {
      ...
      fprintf (file, "\t");
      fprintf (file, "%p", (void *) ptr);
      fprintf (file, " next = ");
      fprintf (file, "%p", (void *) ptr->next);
      fprintf (file, " prev = ");
      fprintf (file, "%p", (void *) ptr->prev);
      fprintf (file, " indx = %u\n\t\tbits = {", ptr->indx);
...
# 1 "../../../kgccfe/gnu/MIPS/gt-bitmap.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-bitmap.h"
const struct ggc_root_tab gt_ggc_rd_gt_bitmap_h[] = {
  { &bitmap_ggc_free, 1, sizeof (bitmap_ggc_free), ((void *)0) },
  { ((void *)0), 0, 0, ((void *)0) }
};
# 847 "../../../kgccfe/gnu/bitmap.c" 2
