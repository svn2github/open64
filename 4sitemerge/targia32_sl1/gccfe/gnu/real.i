...
# 40 "../../../kgccfe/gnu/real.c" 2
# 90 "../../../kgccfe/gnu/real.c"
...
static _Bool sticky_rshift_significand (struct real_value *, const struct real_value *, unsigned int);


static void rshift_significand (struct real_value *, const struct real_value *, unsigned int);


static void lshift_significand (struct real_value *, const struct real_value *, unsigned int);


static void lshift_significand_1 (struct real_value *, const struct real_value *);

static _Bool add_significands (struct real_value *r, const struct real_value *, const struct real_value *);


static _Bool sub_significands (struct real_value *, const struct real_value *, const struct real_value *, int);
...
static _Bool test_significand_bit (struct real_value *, unsigned int);
static void clear_significand_below (struct real_value *, unsigned int);

static _Bool div_significands (struct real_value *, const struct real_value *, const struct real_value *);


static void normalize (struct real_value *);

static void do_add (struct real_value *, const struct real_value *, const struct real_value *, int);

static void do_multiply (struct real_value *, const struct real_value *, const struct real_value *);


static void do_divide (struct real_value *, const struct real_value *, const struct real_value *);
     ...
     int sign;
{
  ...
  r->class = rvc_nan;
  r->sign = sign;
  r->sig[((128 + (8 * 4)) / (8 * 4))-1] = ((unsigned long)1 << ((8 * 4) - 1)) >> 1;
}
     ...
     int sign;
{
  ...
  r->class = rvc_nan;
  r->sign = sign;
  r->sig[((128 + (8 * 4)) / (8 * 4))-1] = ((unsigned long)1 << ((8 * 4) - 1)) >> 2;
}
 ...
 *r = *a;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 635, __FUNCTION__);
    }
     ...
     const struct real_value *a, *b;
{
  ...
  switch (((a->class) << 2 | (b->class)))
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 765, __FUNCTION__);
    }
...
# 792 "../../../kgccfe/gnu/real.c"
 ...
 continue;
      ...
      for (j = 0; j < 2; ++j)
 {
   int exp = (a->exp - (2*((128 + (8 * 4)) / (8 * 4))-1-i)*((8 * 4)/2)
       + (b->exp - (1-j)*((8 * 4)/2)));
     ...
     const struct real_value *a, *b;
{
  ...
  switch (((a->class) << 2 | (b->class)))
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 902, __FUNCTION__);
    }
     ...
     int nan_result;
{
  ...
  switch (((a->class) << 2 | (b->class)))
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 972, __FUNCTION__);
    }
  ...
  *r = *a;
  ...
  switch (r->class)
    ...
    case rvc_normal:
      if (r->exp <= 0)
 get_zero (r, r->sign);
      else if (r->exp < (128 + (8 * 4)))
 clear_significand_below (r, (128 + (8 * 4)) - r->exp);
      break;

    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1012, __FUNCTION__);
    }
}
...
real_arithmetic (r, icode, op0, op1)
     struct real_value *r;
     int icode;
     const struct real_value *op0, *op1;
{
 ...
 *r = *op0;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1078, __FUNCTION__);
    }
}
     ...
     const struct real_value *op0, *op1;
{
  ...
  switch (code)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1131, __FUNCTION__);
    }
}
     ...
     const struct real_value *r;
{
  switch (r->class)
    ...
    case rvc_normal:
      return r->exp;
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1151, __FUNCTION__);
    }
}
     ...
     int exp;
{
 ...
 r->exp = exp;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1182, __FUNCTION__);
    }
}
     ...
     const struct real_value *a, *b;
{
 ...
 if (a->sig[i] != b->sig[i])
   return 0;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1252, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/real.c", 1334, __FUNCTION__);
 ...
 i = -i;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1343, __FUNCTION__);
    }
}
     ...
     const struct real_value *r;
{
  ...
  switch (r->class)
    ...
    case rvc_nan:
    overflow:
      high = (unsigned long long) 1 << ((8 * 8) - 1);
      if (r->sign)
 low = 0;
      else
 {
 ...
 goto overflow;
      ...
      rshift_significand (&t, r, 2*(8 * 8) - exp);
      if ((8 * 8) == (8 * 4))
 {
 ...
 fancy_abort ("../../../kgccfe/gnu/real.c", 1402, __FUNCTION__);
      ...
      if (r->sign)
 {
   if (low == 0)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1414, __FUNCTION__);
    }
     ...
     int crop_trailing_zeros;
{
  ...
  switch (r.class)
    ...
    case rvc_nan:
      ...
      return;
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1495, __FUNCTION__);
    }
  ...
  dec_exp = r.exp * 0.30102999566398119521;
  ...
  if (max_digits > buf_size)
    fancy_abort ("../../../kgccfe/gnu/real.c", 1513, __FUNCTION__);
  ...
  if (cmp_one > 0)
    {
      ...
      m = floor_log2_wide ((unsigned long long) (max_digits));
   ...
   if (cmp_significands (&v, &t) == 0)
     {
      ...
      if (r.exp > 0)
 {
   m = floor_log2_wide ((unsigned long long) ((int)(r.exp * 0.30102999566398119521))) + 1;
   do
     {
  ...
  if (digit == 0 && cmp_significand_0 (&r))
    {
      ...
      dec_exp -= 1;
      if (digit == 0)
 fancy_abort ("../../../kgccfe/gnu/real.c", 1656, __FUNCTION__);
    }
 ...
 *p++ = '0';
    ...
    fancy_abort ("../../../kgccfe/gnu/real.c", 1668, __FUNCTION__);
  else
    *p++ = digit + '0';
     ...
     int crop_trailing_zeros;
{
  ...
  switch (r->class)
    ...
    case rvc_nan:
      ...
      return;
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 1764, __FUNCTION__);
    }
  ...
  if (max_digits > buf_size)
    fancy_abort ("../../../kgccfe/gnu/real.c", 1775, __FUNCTION__);
  if (digits > max_digits)
    digits = max_digits;
     ...
     const char *str;
{
 ...
 str++;
      while (1)
 {
   d = (_hex_value[(unsigned char) (*str)]);
   if (d == 99)
     break;
   if (pos >= 0)
     {
     ...
     int unsigned_p;
{
 ...
 fancy_abort ("../../../kgccfe/gnu/real.c", 2050, __FUNCTION__);
...
ten_to_ptwo (n)
     int n;
{
  static struct real_value tens[(32 - 3)];

  if (n < 0 || n >= (32 - 3))
    fancy_abort ("../../../kgccfe/gnu/real.c", 2068, __FUNCTION__);
     ...
     int n;
{
  ...
  if (n < 0 || n >= (32 - 3))
    fancy_abort ("../../../kgccfe/gnu/real.c", 2101, __FUNCTION__);
     ...
     int n;
{
  ...
  if (n < 0 || n > 9)
    fancy_abort ("../../../kgccfe/gnu/real.c", 2118, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  if (fmt == ((void *)0))
    fancy_abort ("../../../kgccfe/gnu/real.c", 2179, __FUNCTION__);
      ...
      if (*str == '0')
 {
   if (*++str == 'x')
     ...
     base = 8;
      ...
      while ((d = (_hex_value[(unsigned char) (*str)])) < base)
 {
   struct real_value u;
   ...
   switch (base)
     ...
     case 10:
       ...
       break;
     default:
       fancy_abort ("../../../kgccfe/gnu/real.c", 2230, __FUNCTION__);
     }
 ...
 return 0;
      ...
      lshift_significand (r, r, (128 + (8 * 4)) - fmt->p);
 ...
 r->sig[((128 + (8 * 4)) / (8 * 4))-1] |= ((unsigned long)1 << ((8 * 4) - 1)) >> 2;
      ...
      if (!fmt->qnan_msb_set)
 r->sig[((128 + (8 * 4)) / (8 * 4))-1] ^= (((unsigned long)1 << ((8 * 4) - 1)) >> 1) | (((unsigned long)1 << ((8 * 4) - 1)) >> 2);
    }
     ...
     struct real_value *r;
{
 ...
 r->sig[((128 + (8 * 4)) / (8 * 4))-1] = ((unsigned long)1 << ((8 * 4) - 1)) >> 2;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 2342, __FUNCTION__);
    }
     ...
     const struct real_value *a;
{
  ...
  fmt = real_format_for_mode[mode - QFmode];
  if (fmt == ((void *)0))
    fancy_abort ("../../../kgccfe/gnu/real.c", 2448, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  fmt = real_format_for_mode[mode - QFmode];
  if (fmt == ((void *)0))
    fancy_abort ("../../../kgccfe/gnu/real.c", 2519, __FUNCTION__);
     ...
     enum machine_mode mode;
{
  ...
  fmt = real_format_for_mode[mode - QFmode];
  if (fmt == ((void *)0))
    fancy_abort ("../../../kgccfe/gnu/real.c", 2549, __FUNCTION__);
     ...
     const struct real_value *r;
{
 ...
 for (i = 0; i < ((128 + (8 * 4)) / (8 * 4)); ++i)
   h ^= r->sig[i];
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 2605, __FUNCTION__);
    }
...
static void encode_ieee_single (const struct real_format *fmt, long *, const struct real_value *);

static void decode_ieee_single (const struct real_format *, struct real_value *, const long *);
     ...
     const struct real_value *r;
{
  ...
  _Bool denormal = (r->sig[((128 + (8 * 4)) / (8 * 4))-1] & ((unsigned long)1 << ((8 * 4) - 1))) == 0;
 ...
 exp = 0;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 2667, __FUNCTION__);
    }
     ...
     const long *buf;
{
      ...
      if (image)
 {
   ...
   r->sign = sign;
   if (!fmt->qnan_msb_set)
     image ^= (((unsigned long)1 << ((8 * 4) - 1)) >> 1 | ((unsigned long)1 << ((8 * 4) - 1)) >> 2);
...
static void encode_ieee_double (const struct real_format *fmt, long *, const struct real_value *);

static void decode_ieee_double (const struct real_format *, struct real_value *, const long *);
     ...
     const struct real_value *r;
{
 ...
 exp = r->exp + 1023 - 1;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 2820, __FUNCTION__);
    }
...
static void encode_ieee_extended (const struct real_format *fmt, long *, const struct real_value *);

static void decode_ieee_extended (const struct real_format *, struct real_value *, const long *);


static void encode_ieee_extended_128 (const struct real_format *fmt, long *, const struct real_value *);


static void decode_ieee_extended_128 (const struct real_format *, struct real_value *, const long *);
...
# 3028 "../../../kgccfe/gnu/real.c"
 if (denormal)
 ...
 else
   {
     exp += 16383 - 1;
     if (exp < 0)
       fancy_abort ("../../../kgccfe/gnu/real.c", 3034, __FUNCTION__);
   }
 image_hi |= exp;
 ...
 if ((8 * 4) == 32)
 ...
 else
   {
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 3053, __FUNCTION__);
    }
...
encode_ieee_extended_128 (fmt, buf, r)
     ...
     const struct real_value *r;
{
  buf[3 * !((target_flags & 0x00010000) != 0)] = 0;
  encode_ieee_extended (fmt, buf+!!((target_flags & 0x00010000) != 0), r);
}
...
decode_ieee_extended_128 (fmt, r, buf)
     ...
     const long *buf;
{
  decode_ieee_extended (fmt, r, buf+!!((target_flags & 0x00010000) != 0));
}
...
# 3248 "../../../kgccfe/gnu/real.c"
static void encode_ibm_extended (const struct real_format *fmt, long *, const struct real_value *);

static void decode_ibm_extended (const struct real_format *, struct real_value *, const long *);


static void
encode_ibm_extended (fmt, buf, r)
     const struct real_format *fmt __attribute__ ((__unused__));
     long *buf;
     const struct real_value *r;
{
  ...
  switch (r->class)
    ...
    case rvc_zero:
      ...
      buf[0] = ((target_flags & 0x00010000) != 0) ? r->sign << 31 : 0;
      buf[1] = ((target_flags & 0x00010000) != 0) ? 0 : r->sign << 31;
      buf[2] = buf[0];
      buf[3] = buf[1];
      break;
    ...
    case rvc_normal:
      ...
      u = *r;
      clear_significand_below (&u, (128 + (8 * 4)) - 53);
      ...
      else
 {
   ...
   round_for_format (&ieee_double_format, &v);
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 3307, __FUNCTION__);
    }
}
...
static void encode_ieee_quad (const struct real_format *fmt, long *, const struct real_value *);

static void decode_ieee_quad (const struct real_format *, struct real_value *, const long *);
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   image2 &= 0xffffffff;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 3451, __FUNCTION__);
    }
...
# 3609 "../../../kgccfe/gnu/real.c"
static void encode_vax_f (const struct real_format *fmt, long *, const struct real_value *);

static void decode_vax_f (const struct real_format *, struct real_value *, const long *);

static void encode_vax_d (const struct real_format *fmt, long *, const struct real_value *);

static void decode_vax_d (const struct real_format *, struct real_value *, const long *);

static void encode_vax_g (const struct real_format *fmt, long *, const struct real_value *);

static void decode_vax_g (const struct real_format *, struct real_value *, const long *);
     ...
     const struct real_value *r;
{
  ...
  switch (r->class)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 3654, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   image0 = (image0 >> 8) & 0xffffff;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 3729, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   image0 = (image0 >> 11) & 0xfffff;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 3833, __FUNCTION__);
    }
...
# 3945 "../../../kgccfe/gnu/real.c"
static void encode_i370_single (const struct real_format *fmt, long *, const struct real_value *);

static void decode_i370_single (const struct real_format *, struct real_value *, const long *);

static void encode_i370_double (const struct real_format *fmt, long *, const struct real_value *);

static void decode_i370_double (const struct real_format *, struct real_value *, const long *);
     ...
     const struct real_value *r;
{
  ...
  switch (r->class)
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 3982, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      else
 {
   ...
   image_hi >>= 8;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 4055, __FUNCTION__);
    }
...
# 4154 "../../../kgccfe/gnu/real.c"
static void encode_c4x_single (const struct real_format *fmt, long *, const struct real_value *);

static void decode_c4x_single (const struct real_format *, struct real_value *, const long *);

static void encode_c4x_extended (const struct real_format *fmt, long *, const struct real_value *);

static void decode_c4x_extended (const struct real_format *, struct real_value *, const long *);
     ...
     const struct real_value *r;
{
      ...
      if (r->sign)
 {
   ...
   sig |= 0x800000;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 4198, __FUNCTION__);
    }
     ...
     const struct real_value *r;
{
      ...
      if (r->sign)
 {
   ...
   sig |= 0x80000000;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/real.c", 4280, __FUNCTION__);
    }
...
static void encode_internal (const struct real_format *fmt, long *, const struct real_value *);

static void decode_internal (const struct real_format *, struct real_value *, const long *);
