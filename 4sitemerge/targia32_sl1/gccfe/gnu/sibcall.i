...
# 29 "../../../kgccfe/gnu/sibcall.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 30 "../../../kgccfe/gnu/sibcall.c" 2
     ...
     rtx *p_hard_return, *p_soft_return;
{
  ...
  if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET
      && ((enum rtx_code) (((((((insn)->fld[5]).rtx))->fld[1]).rtx))->code) == CALL)
    hard = ((((((insn)->fld[5]).rtx))->fld[0]).rtx);
  else if (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == PARALLEL
    && ((enum rtx_code) (((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->code) == SET
    && ((enum rtx_code) ((((((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->code) == CALL)
    hard = (((((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[0]))->fld[0]).rtx);
  else
    return 0;


  if (((enum rtx_code) (hard)->code) != REG)
    return 0;
  ...
  if (((enum rtx_code) (soft)->code) != REG || (((soft)->fld[0]).rtuint) < 176)
    return 0;


  if (reg_set_between_p (soft, insn, (rtx) 0))
    return 0;
     ...
     rtx orig_insn;
{
  ...
  if (! identify_call_return_value ((((orig_insn)->fld[5]).rtx), &hardret, &softret))
    return orig_insn;
  ...
  if (return_value_pseudo)
    {
      if ((((set)->fld[0]).rtx) == return_value_pseudo
   && (((set)->fld[1]).rtx) == softret)
 return insn;
      return orig_insn;
    }
# 181 "../../../kgccfe/gnu/sibcall.c"
  if ((((set)->fld[0]).rtx) == (cfun->return_rtx)
      && (((enum rtx_code) ((((set)->fld[0]).rtx))->code) == REG)
      && (((((((set)->fld[0]).rtx))->fld[0]).rtuint)) == (((hardret)->fld[0]).rtuint)
      && (((set)->fld[1]).rtx) == softret)
    return insn;
     ...
     enum rtx_code code;
{
  ...
  if (insn
      ...
      && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == code
      && (((((((insn)->fld[5]).rtx))->fld[0]).rtx) == (cfun->return_rtx)
   || ((((((insn)->fld[5]).rtx))->fld[0]).rtx) == (const_int_rtx[64])))
    return insn;
     ...
     rtx orig_insn;
{
  ...
  if (insn
      ...
      && ((((((((((insn)->fld[5]).rtx))->fld[0]).rtx))->fld[0]).rtuint) >= 176))
    {
      ...
      if (!set_insn)
 return insn;
      set = (((rtx_class[(int) (((enum rtx_code) (set_insn)->code))]) == 'i') ? (((enum rtx_code) ((((set_insn)->fld[5]).rtx))->code) == SET ? (((set_insn)->fld[5]).rtx) : single_set_2 (set_insn, (((set_insn)->fld[5]).rtx))) : (rtx) 0);
      if (!set
   || (((set)->fld[1]).rtx) != ((((((insn)->fld[5]).rtx))->fld[0]).rtx)
   || (((set)->fld[0]).rtx) != (cfun->return_rtx))
 return insn;
      return set_insn;
    }
  return orig_insn;
     ...
     rtx orig_insn;
{
  ...
  if (insn
      ...
      && ((((((set)->fld[1]).rtx))->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER])
      && ((enum rtx_code) (((((((set)->fld[1]).rtx))->fld[1]).rtx))->code) == CONST_INT
      && (((set)->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER]))
    return insn;
     ...
     rtx orig_insn;
{
  ...
  if (insn && set && (((set)->fld[0]).rtx) == pic_offset_table_rtx)
    return insn;
     ...
     rtx end;
{
  ...
  end = next_nonnote_insn ((((end)->fld[1]).rtx));
     ...
     rtx x;
{
  ...
  if (code == ADDRESSOF || x == (cfun->internal_arg_pointer))
    return 1;
  ...
  for (i = 0; i < (rtx_length[(int) (code)]); i++, fmt++)
    {
      if (*fmt == 'e')
 {
   if (uses_addressof ((((x)->fld[i]).rtx)))
     return 1;
 }
      else if (*fmt == 'E')
 {
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     if (uses_addressof ((((((x)->fld[i]).rtvec))->elem[j])))
       return 1;
 }
    }
  return 0;
}
# 441 "../../../kgccfe/gnu/sibcall.c"
static int
     ...
     rtx seq;
{
  ...
  for (insn = seq; insn; insn = (((insn)->fld[2]).rtx))
 ...
 if (((enum rtx_code) (insn)->code) == CALL_INSN
   ...
   {
     if (((((((insn)->fld[5]).rtx))->fld[0]).rtx) != (rtx) 0
  && sequence_uses_addressof (((((((insn)->fld[5]).rtx))->fld[0]).rtx)))
       return 1;
     if (((((((insn)->fld[5]).rtx))->fld[1]).rtx) != (rtx) 0
  && sequence_uses_addressof (((((((insn)->fld[5]).rtx))->fld[1]).rtx)))
       return 1;
     if (((((((insn)->fld[5]).rtx))->fld[2]).rtx) != (rtx) 0
  && sequence_uses_addressof (((((((insn)->fld[5]).rtx))->fld[2]).rtx)))
       return 1;
   }
 else if (uses_addressof ((((insn)->fld[5]).rtx))
   || ((((insn)->fld[8]).rtx) && uses_addressof ((((insn)->fld[8]).rtx))))
   return 1;
      }
  return 0;
}
     ...
     rtx x;
{
  ...
  if (code == MEM)
    {
      if ((((x))->unchanging)
   && ((((x)->fld[0]).rtx) == (cfun->internal_arg_pointer)
 ...
 (((x))->unchanging) = 0;
  ...
  for (i = 0; i < (rtx_length[(int) (code)]); i++, fmt++)
    {
      if (*fmt == 'e')
 purge_mem_unchanging_flag ((((x)->fld[i]).rtx));
      else if (*fmt == 'E')
 for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
   purge_mem_unchanging_flag ((((((x)->fld[i]).rtvec))->elem[j]));
    }
}
     ...
     sibcall_use_t use;
{
  if (use == sibcall_use_tail_recursion)
    emit_insn_before (((((((insn)->fld[5]).rtx))->fld[2]).rtx), insn);
  else if (use == sibcall_use_sibcall)
    emit_insn_before (((((((insn)->fld[5]).rtx))->fld[1]).rtx), insn);
  else if (use == sibcall_use_normal)
    emit_insn_before (((((((insn)->fld[5]).rtx))->fld[0]).rtx), insn);
  else
    fancy_abort ("../../../kgccfe/gnu/sibcall.c", 550, __FUNCTION__);




  if (((((((insn)->fld[5]).rtx))->fld[3]).rtx))
    (((((((((insn)->fld[5]).rtx))->fld[3]).rtx)))->in_struct) = 0;


  remove_insn (insn);
}
# 571 "../../../kgccfe/gnu/sibcall.c"
void
optimize_sibling_and_tail_recursive_calls ()
{
  rtx insn, insns;
  basic_block alternate_exit = (&entry_exit_blocks[1]);
  _Bool no_sibcalls_this_function = 0;
  _Bool successful_replacement = 0;
  _Bool replaced_call_placeholder = 0;
  edge e;
  ...
  if (0 && current_function_has_exception_handlers ())
    no_sibcalls_this_function = 1;

  return_value_pseudo = (rtx) 0;
  ...
  for (e = (&entry_exit_blocks[1])->pred;
       e && alternate_exit == (&entry_exit_blocks[1]);
       e = e->pred_next)
    {
      rtx insn;

      if (e->dest != (&entry_exit_blocks[1]) || e->succ_next != ((void *)0))
 continue;



      for (insn = (&entry_exit_blocks[1])->prev_bb->head;
    insn;
    insn = (((insn)->fld[2]).rtx))
 {
   rtx set;
   ...
   if (((enum rtx_code) (insn)->code) == INSN
       ...
       && !return_value_pseudo)
     {
       return_value_pseudo = (((set)->fld[1]).rtx);
       continue;
     }
 ...
 return_value_pseudo = ((void *)0);
    }



  no_sibcalls_this_function |= sequence_uses_addressof (insns);
# 666 "../../../kgccfe/gnu/sibcall.c"
  for (insn = insns; insn; insn = (((insn)->fld[2]).rtx))
    {
      if (((enum rtx_code) (insn)->code) == CALL_INSN
   && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == CALL_PLACEHOLDER)
 {
   int sibcall = (((((((insn)->fld[5]).rtx))->fld[1]).rtx) != (rtx) 0);
   int tailrecursion = (((((((insn)->fld[5]).rtx))->fld[2]).rtx) != (rtx) 0);
   basic_block call_block = (((insn)->fld[3]).bb);





   if ((cfun->calls_alloca) || (cfun->stdarg))
     sibcall = 0;
   ...
   if (no_sibcalls_this_function
       ...
       || call_block->succ == ((void *)0)
       || call_block->succ->succ_next != ((void *)0)
       || (call_block->succ->dest != (&entry_exit_blocks[1])
...
# 736 "../../../kgccfe/gnu/sibcall.c"
 ...
 {
   if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
     purge_mem_unchanging_flag ((((insn)->fld[5]).rtx));
 }
