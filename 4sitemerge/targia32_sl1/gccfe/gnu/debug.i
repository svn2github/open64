...
debug_nothing_charstar (main_filename)
     const char *main_filename __attribute__ ((__unused__));
{
}
...
debug_nothing_int_charstar (line, text)
     ...
     const char *text __attribute__ ((__unused__));
{
}
...
debug_nothing_int_int (line, n)
     unsigned int line __attribute__ ((__unused__));
     unsigned int n __attribute__ ((__unused__));
{
}
