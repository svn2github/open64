...
# 28 "../../../kgccfe/gnu/ifcvt.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 29 "../../../kgccfe/gnu/ifcvt.c" 2
...
# 38 "../../../kgccfe/gnu/ifcvt.c" 2
# 67 "../../../kgccfe/gnu/ifcvt.c"
...
static int dead_or_predicable (basic_block, basic_block, basic_block, basic_block, int);
...
cond_exec_process_insns (ce_info, start, end, test, prob_val, mod_ok)
     ce_if_block_t *ce_info __attribute__ ((__unused__));
     rtx start;
     rtx end;
     rtx test;
     rtx prob_val;
     int mod_ok;
{
  ...
  for (insn = start; ; insn = (((insn)->fld[2]).rtx))
    {
      if (((enum rtx_code) (insn)->code) == NOTE)
 goto insn_done;

      if (((enum rtx_code) (insn)->code) != INSN && ((enum rtx_code) (insn)->code) != CALL_INSN)
 fancy_abort ("../../../kgccfe/gnu/ifcvt.c", 248, __FUNCTION__);


      if (reload_completed && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == USE)
 {
 ...
 {
   if (((enum machine_mode) (xtest)->mode) != ((enum machine_mode) ((((pattern)->fld[0]).rtx))->mode))
     return 0;

   xtest = gen_rtx_fmt_ee (AND, (((enum machine_mode) (xtest)->mode)), (xtest), ((((pattern)->fld[0]).rtx)));

   pattern = (((pattern)->fld[1]).rtx);
 }

      pattern = gen_rtx_fmt_ee (COND_EXEC, (VOIDmode), (xtest), (pattern));
# 299 "../../../kgccfe/gnu/ifcvt.c"
      validate_change (insn, &(((insn)->fld[5]).rtx), pattern, 1);

      if (((enum rtx_code) (insn)->code) == CALL_INSN && prob_val)
 validate_change (insn, &(((insn)->fld[8]).rtx),
     ...
     rtx jump;
{
  ...
  if (any_condjump_p (jump))
    test_if = (((pc_set (jump))->fld[1]).rtx);
  else
    return (rtx) 0;
  cond = (((test_if)->fld[0]).rtx);



  if (((enum rtx_code) ((((test_if)->fld[2]).rtx))->code) == LABEL_REF
      && ((((((test_if)->fld[2]).rtx))->fld[0]).rtx) == (((jump)->fld[9]).rtx))
    {
      enum rtx_code rev = reversed_comparison_code (cond, jump);
      if (rev == UNKNOWN)
 return (rtx) 0;

      cond = gen_rtx_fmt_ee (rev, ((enum machine_mode) (cond)->mode), (((cond)->fld[0]).rtx),
        (((cond)->fld[1]).rtx));
    }
     ...
     int do_multiple_p;
{
 ...
 return 0;
  ...
  max = (((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) + 1);
  ...
  if (false_code != UNKNOWN)
    false_expr = gen_rtx_fmt_ee (false_code, ((enum machine_mode) (true_expr)->mode),
     (((true_expr)->fld[0]).rtx), (((true_expr)->fld[1]).rtx));
  else
    false_expr = (rtx) 0;
# 436 "../../../kgccfe/gnu/ifcvt.c"
  true_prob_val = find_reg_note (test_bb->end, REG_BR_PROB, (rtx) 0);
  if (true_prob_val)
    {
      true_prob_val = (((true_prob_val)->fld[0]).rtx);
      false_prob_val = gen_rtx_CONST_INT (VOIDmode, (long long) (10000 - (((true_prob_val)->fld[0]).rtwint)));
    }
  else
...
static int noce_try_store_flag_inc (struct noce_if_info *);
     ...
     int reversep, normalize;
{
  ...
  cond_complex = (! general_operand ((((cond)->fld[0]).rtx), VOIDmode)
    || ! general_operand ((((cond)->fld[1]).rtx), VOIDmode));




  if (cond_complex)
    cond = ((((((pc_set (if_info->jump))->fld[1]).rtx))->fld[0]).rtx);
  ...
  if ((if_info->cond_earliest == if_info->jump || cond_complex)
      && (normalize == 0 || 1 == normalize))
    {
      ...
      tmp = gen_rtx_fmt_ee (code, ((enum machine_mode) (x)->mode), (((cond)->fld[0]).rtx),
       (((cond)->fld[1]).rtx));
      ...
      if (((((tmp)->fld[6]).rtint) >= 0 ? (((tmp)->fld[6]).rtint) : recog_memoized_1 (tmp)) >= 0)
 {
   tmp = get_insns ();
   end_sequence ();
   emit_insn (tmp);
  ...
  if (cond_complex || !((mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_INT || (mode_class[(int) (((enum machine_mode) (x)->mode))]) == MODE_PARTIAL_INT))
    return (rtx) 0;

  return emit_store_flag (x, code, (((cond)->fld[0]).rtx),
     (((cond)->fld[1]).rtx), VOIDmode,
     (code == LTU || code == LEU
     ...
     rtx x, y;
{
  ...
  outer = (((x)->fld[0]).rtx);
  inner = (((outer)->fld[0]).rtx);
  outmode = ((enum machine_mode) (outer)->mode);
  inmode = ((enum machine_mode) (inner)->mode);
  bitpos = (((outer)->fld[1]).rtuint) * 8;
  store_bit_field (inner, (mode_bitsize[(int) (outmode)]), bitpos, outmode, y,
     (mode_bitsize[(int) (inmode)]));
}
     ...
     struct noce_if_info *if_info;
{
 ...
 noce_emit_move_insn (if_info->x, target);
      ...
      seq = get_insns ();
      end_sequence ();
      emit_insn_before_scope (seq, if_info->jump, (((if_info->insn_a)->fld[4]).rttree));
     ...
     struct noce_if_info *if_info;
{
  rtx target, seq;
  int reversep;
  long long itrue, ifalse, diff, tmp;
  ...
  if (! no_new_pseudos
      ...
      && ((enum rtx_code) (if_info->b)->code) == CONST_INT)
    {
      ...
      ifalse = (((if_info->a)->fld[0]).rtwint);
      itrue = (((if_info->b)->fld[0]).rtwint);
 ...
 return 0;
      ...
      if (diff == 1 || diff == -1)
 normalize = 0;
      else if (ifalse == 0 && exact_log2_wide ((unsigned long long) (itrue)) >= 0
        && (1 == 1
     || ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 2))
 normalize = 1;
      else if (itrue == 0 && exact_log2_wide ((unsigned long long) (ifalse)) >= 0 && can_reverse
        && (1 == 1 || ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 2))
 ...
 normalize = -1;
        ...
        && (1 == -1 || ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 2))
 normalize = -1, reversep = 1;
      else if ((((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 2 && 1 == -1)
        || ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 3)
 normalize = -1;
      else
 return 0;
      ...
      if (diff == 1 || diff == -1)
 {
   target = expand_simple_binop (mode,
     (diff == 1
      ? PLUS : MINUS),
     gen_rtx_CONST_INT (VOIDmode, (long long) (ifalse)), target, if_info->x, 0,
     OPTAB_WIDEN);
 }



      else if (ifalse == 0 && (tmp = exact_log2_wide ((unsigned long long) (itrue))) >= 0)
 {
   target = expand_simple_binop (mode, ASHIFT,
     target, gen_rtx_CONST_INT (VOIDmode, (long long) (tmp)), if_info->x, 0,
     OPTAB_WIDEN);
 }
      ...
      else if (itrue == -1)
 {
   target = expand_simple_binop (mode, IOR,
     target, gen_rtx_CONST_INT (VOIDmode, (long long) (ifalse)), if_info->x, 0,
     OPTAB_WIDEN);
 }
      ...
      else
 {
   target = expand_simple_binop (mode, AND,
     target, gen_rtx_CONST_INT (VOIDmode, (long long) (diff)), if_info->x, 0,
     OPTAB_WIDEN);
   if (target)
     target = expand_simple_binop (mode, PLUS,
       target, gen_rtx_CONST_INT (VOIDmode, (long long) (ifalse)),
     ...
     struct noce_if_info *if_info;
{
  ...
  if (! no_new_pseudos
   ...
   || 0)
      ...
      && ((((if_info->a)->fld[1]).rtx) == (const_int_rtx[64 +1])
   || (((if_info->a)->fld[1]).rtx) == (const_int_rtx[64 -1]))
      && rtx_equal_p ((((if_info->a)->fld[0]).rtx), if_info->x)
      && (reversed_comparison_code (if_info->cond, if_info->jump)
   != UNKNOWN))
    {
      if (1 == ((((((if_info->a)->fld[1]).rtx))->fld[0]).rtwint))
 subtract = 0, normalize = 0;
      else if (-1 == ((((((if_info->a)->fld[1]).rtx))->fld[0]).rtwint))
 subtract = 1, normalize = 0;
      else
 subtract = 0, normalize = ((((((if_info->a)->fld[1]).rtx))->fld[0]).rtwint);
     ...
     struct noce_if_info *if_info;
{
  ...
  if (((((enum rtx_code) (if_info->a)->code) == LABEL_REF || ((enum rtx_code) (if_info->a)->code) == SYMBOL_REF || ((enum rtx_code) (if_info->a)->code) == CONST_INT || ((enum rtx_code) (if_info->a)->code) == CONST_DOUBLE || ((enum rtx_code) (if_info->a)->code) == CONST || ((enum rtx_code) (if_info->a)->code) == HIGH || ((enum rtx_code) (if_info->a)->code) == CONST_VECTOR || ((enum rtx_code) (if_info->a)->code) == CONSTANT_P_RTX) || register_operand (if_info->a, VOIDmode))
      && ((((enum rtx_code) (if_info->b)->code) == LABEL_REF || ((enum rtx_code) (if_info->b)->code) == SYMBOL_REF || ((enum rtx_code) (if_info->b)->code) == CONST_INT || ((enum rtx_code) (if_info->b)->code) == CONST_DOUBLE || ((enum rtx_code) (if_info->b)->code) == CONST || ((enum rtx_code) (if_info->b)->code) == HIGH || ((enum rtx_code) (if_info->b)->code) == CONST_VECTOR || ((enum rtx_code) (if_info->b)->code) == CONSTANT_P_RTX) || register_operand (if_info->b, VOIDmode)))
    {
      start_sequence ();

      code = ((enum rtx_code) (if_info->cond)->code);
      target = noce_emit_cmove (if_info, if_info->x, code,
    (((if_info->cond)->fld[0]).rtx),
    (((if_info->cond)->fld[1]).rtx),
    if_info->a, if_info->b);
     ...
     struct noce_if_info *if_info;
{
  ...
  if (! no_new_pseudos && cse_not_expected
      ...
      && ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) >= 5)
    {
      a = (((a)->fld[0]).rtx);
      b = (((b)->fld[0]).rtx);
      x = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode));
      is_mem = 1;
    }
...
# 1117 "../../../kgccfe/gnu/ifcvt.c"
      ...
      else
 {
   ...
   tmp = copy_rtx (insn_a);
   set = (((rtx_class[(int) (((enum rtx_code) (tmp)->code))]) == 'i') ? (((enum rtx_code) ((((tmp)->fld[5]).rtx))->code) == SET ? (((tmp)->fld[5]).rtx) : single_set_2 (tmp, (((tmp)->fld[5]).rtx))) : (rtx) 0);
   (((set)->fld[0]).rtx) = a;
   tmp = emit_insn ((((tmp)->fld[5]).rtx));
 }
      if (((((tmp)->fld[6]).rtint) >= 0 ? (((tmp)->fld[6]).rtint) : recog_memoized_1 (tmp)) < 0)
 goto end_seq_and_fail;
    }
...
# 1190 "../../../kgccfe/gnu/ifcvt.c"
 ...
 goto end_seq_and_fail;
  ...
  target = noce_emit_cmove (if_info, x, code, (((if_info->cond)->fld[0]).rtx),
       (((if_info->cond)->fld[1]).rtx), a, b);
 ...
 (((tmp))->in_struct) = 1;
      if ((((if_info->a))->frame_related) && (((if_info->b))->frame_related))
 (((tmp))->frame_related) = 1;
      if (((((if_info->a)->fld[1]).rtmem) == 0 ? 0 : (((if_info->a)->fld[1]).rtmem)->alias) == ((((if_info->b)->fld[1]).rtmem) == 0 ? 0 : (((if_info->b)->fld[1]).rtmem)->alias))
 set_mem_alias_set (tmp, ((((if_info->a)->fld[1]).rtmem) == 0 ? 0 : (((if_info->a)->fld[1]).rtmem)->alias));
      set_mem_align (tmp,
       ((((((if_info->a)->fld[1]).rtmem) != 0 ? (((if_info->a)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (if_info->a)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (if_info->a)->mode)) : 8))) < (((((if_info->b)->fld[1]).rtmem) != 0 ? (((if_info->b)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (if_info->b)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (if_info->b)->mode)) : 8))) ? (((((if_info->a)->fld[1]).rtmem) != 0 ? (((if_info->a)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (if_info->a)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (if_info->a)->mode)) : 8))) : (((((if_info->b)->fld[1]).rtmem) != 0 ? (((if_info->b)->fld[1]).rtmem)->align : (1 && ((enum machine_mode) (if_info->b)->mode) != BLKmode ? get_mode_alignment (((enum machine_mode) (if_info->b)->mode)) : 8)))));
  ...
  tmp = get_insns ();
  end_sequence ();
  emit_insn_before_scope (tmp, if_info->jump, (((if_info->insn_a)->fld[4]).rttree));
  return 1;
     ...
     rtx *earliest;
{
  ...
  reverse
    = ((enum rtx_code) (((((((set)->fld[1]).rtx))->fld[2]).rtx))->code) == LABEL_REF
      && (((((((((set)->fld[1]).rtx))->fld[2]).rtx))->fld[0]).rtx) == (((if_info->jump)->fld[9]).rtx);
# 1282 "../../../kgccfe/gnu/ifcvt.c"
  if (((enum rtx_code) (target)->code) == CONST_INT)
    {
      enum rtx_code code = ((enum rtx_code) (if_info->cond)->code);
      rtx op_a = (((if_info->cond)->fld[0]).rtx);
      rtx op_b = (((if_info->cond)->fld[1]).rtx);
      rtx prev_insn;


      prev_insn = (((if_info->cond_earliest)->fld[1]).rtx);
      if (prev_insn
   && ((rtx_class[(int) (((enum rtx_code) (prev_insn)->code))]) == 'i')
   && ((enum rtx_code) ((((prev_insn)->fld[5]).rtx))->code) == SET)
 {
   rtx src = find_reg_equal_equiv_note (prev_insn);
   if (!src)
     src = ((((((prev_insn)->fld[5]).rtx))->fld[1]).rtx);
   if (((enum rtx_code) (src)->code) == CONST_INT)
     {
       if (rtx_equal_p (op_a, ((((((prev_insn)->fld[5]).rtx))->fld[0]).rtx)))
  op_a = src;
       else if (rtx_equal_p (op_b, ((((((prev_insn)->fld[5]).rtx))->fld[0]).rtx)))
  op_b = src;
 ...
 {
   long long desired_val = (((target)->fld[0]).rtwint);
   long long actual_val = (((op_b)->fld[0]).rtwint);
  ...
  {
    code = LE;
    op_b = gen_rtx_CONST_INT (VOIDmode, (long long) (desired_val));
  }
       break;
     case LE:
       if (actual_val == desired_val - 1)
       ...
       if (actual_val == desired_val + 1)
  {
   ...
   || op_a != (((if_info->cond)->fld[0]).rtx)
   || op_b != (((if_info->cond)->fld[1]).rtx))
 {
  ...
  for (insn = if_info->jump; insn != *earliest; insn = (((insn)->fld[1]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && reg_overlap_mentioned_p (if_info->x, (((insn)->fld[5]).rtx)))
      return ((void *)0);


  for (insn = *earliest; insn != if_info->jump; insn = (((insn)->fld[2]).rtx))
     ...
     struct noce_if_info *if_info;
{
  ...
  if (((((mode_class[(int) (((enum machine_mode) (if_info->x)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (if_info->x)->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) (if_info->x)->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1) && !flag_unsafe_math_optimizations)
      || ((((mode_class[(int) (((enum machine_mode) (if_info->x)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (if_info->x)->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) (if_info->x)->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
    return 0;
  ...
  code = ((enum rtx_code) (cond)->code);
  if (rtx_equal_p ((((cond)->fld[0]).rtx), if_info->a))
    {
      if (! rtx_equal_p ((((cond)->fld[1]).rtx), if_info->b))
 return 0;
    }
  else if (rtx_equal_p ((((cond)->fld[1]).rtx), if_info->a))
    {
      if (! rtx_equal_p ((((cond)->fld[0]).rtx), if_info->b))
 return 0;
      code = swap_condition (code);
    }
  else
     ...
     struct noce_if_info *if_info;
{
  ...
  a = if_info->a;
  b = if_info->b;
  if (((enum rtx_code) (a)->code) == NEG && rtx_equal_p ((((a)->fld[0]).rtx), b))
    negate = 0;
  else if (((enum rtx_code) (b)->code) == NEG && rtx_equal_p ((((b)->fld[0]).rtx), a))
    {
      c = a; a = b; b = c;
      negate = 1;
    }
  ...
  if (rtx_equal_p ((((cond)->fld[0]).rtx), b))
    c = (((cond)->fld[1]).rtx);
  else if (rtx_equal_p ((((cond)->fld[1]).rtx), b))
    c = (((cond)->fld[0]).rtx);
  else
    return 0;
 ...
 return 0;
  ...
  if (((enum rtx_code) (c)->code) == MEM
      && ((enum rtx_code) ((((c)->fld[0]).rtx))->code) == SYMBOL_REF
      && ((((((c)->fld[0]).rtx)))->unchanging))
    c = get_pool_constant ((((c)->fld[0]).rtx));
  ...
  target = expand_simple_unop (((enum machine_mode) (if_info->x)->mode), ABS, b, if_info->x, 0);
     ...
     rtx *earliest;
{
  ...
  reverse = (((enum rtx_code) (((((((set)->fld[1]).rtx))->fld[2]).rtx))->code) == LABEL_REF
  ...
  cond = ((((((set)->fld[1]).rtx))->fld[0]).rtx);
  tmp = (((cond)->fld[0]).rtx);
  if ((((enum rtx_code) (tmp)->code) == REG) && (mode_class[(int) (((enum machine_mode) (tmp)->mode))]) == MODE_INT)
    {
      *earliest = jump;

      if (reverse)
 cond = gen_rtx_fmt_ee (reverse_condition (((enum rtx_code) (cond)->code)),
          ((enum machine_mode) (cond)->mode), tmp, (((cond)->fld[1]).rtx));
      return cond;
    }
  ...
  for (insn = *earliest; insn != jump; insn = (((insn)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && modified_in_p (tmp, insn))
      break;
  if (insn == jump)
    return tmp;
     ...
     rtx op;
{
  ...
  if (((enum rtx_code) (op)->code) == MEM)
    return ! side_effects_p ((((op)->fld[0]).rtx));
...
# 1726 "../../../kgccfe/gnu/ifcvt.c"
 ...
 return 0;
  ...
  if (((enum machine_mode) ((((cond)->fld[0]).rtx))->mode) == BLKmode)
    return 0;
  ...
  if (! insn_a
      ...
      || (set_a = (((rtx_class[(int) (((enum rtx_code) (insn_a)->code))]) == 'i') ? (((enum rtx_code) ((((insn_a)->fld[5]).rtx))->code) == SET ? (((insn_a)->fld[5]).rtx) : single_set_2 (insn_a, (((insn_a)->fld[5]).rtx))) : (rtx) 0)) == (rtx) 0)
    return 0;

  x = (((set_a)->fld[0]).rtx);
  a = (((set_a)->fld[1]).rtx);
# 1769 "../../../kgccfe/gnu/ifcvt.c"
  set_b = (rtx) 0;
  if (else_bb)
    {
   ...
   || (set_b = (((rtx_class[(int) (((enum rtx_code) (insn_b)->code))]) == 'i') ? (((enum rtx_code) ((((insn_b)->fld[5]).rtx))->code) == SET ? (((insn_b)->fld[5]).rtx) : single_set_2 (insn_b, (((insn_b)->fld[5]).rtx))) : (rtx) 0)) == (rtx) 0
   || ! rtx_equal_p (x, (((set_b)->fld[0]).rtx)))
 return 0;
    }
  else
    {
   ...
   || (set_b = (((rtx_class[(int) (((enum rtx_code) (insn_b)->code))]) == 'i') ? (((enum rtx_code) ((((insn_b)->fld[5]).rtx))->code) == SET ? (((insn_b)->fld[5]).rtx) : single_set_2 (insn_b, (((insn_b)->fld[5]).rtx))) : (rtx) 0)) == (rtx) 0
   || ! rtx_equal_p (x, (((set_b)->fld[0]).rtx))
   || reg_overlap_mentioned_p (x, (((set_b)->fld[1]).rtx))
   || modified_between_p ((((set_b)->fld[1]).rtx),
     (((if_info.cond_earliest)->fld[1]).rtx), jump)



   || reg_overlap_mentioned_p (x, cond)
   || reg_overlap_mentioned_p (x, a)
   || modified_between_p (x, (((if_info.cond_earliest)->fld[1]).rtx), jump))
 insn_b = set_b = (rtx) 0;
    }
   ...
   && (((x)->fld[0]).rtuint) < 176))
    {
      if (no_new_pseudos)
 return 0;
      x = gen_reg_rtx (((enum machine_mode) (((enum rtx_code) (x)->code) == STRICT_LOW_PART ? (((x)->fld[0]).rtx) : x)->mode));
      ...
      if (insn_b && else_bb)
 {
   ...
   if (else_bb && insn_b == else_bb->end)
     else_bb->end = (((insn_b)->fld[1]).rtx);
   reorder_insns (insn_b, insn_b, (((jump)->fld[1]).rtx));
  ...
  if (orig_x != x)
    {
      ...
      emit_insn_after_scope (insn_b, test_bb->end, (((insn_a)->fld[4]).rttree));
    }
     ...
     struct ce_if_block * ce_info;
{
      ...
      if (combo_bb->succ == ((struct edge_def *)((void *)0)))
 {
   if (find_reg_note (last, REG_NORETURN, ((void *)0)))
     ...
     && ((enum rtx_code) ((((last)->fld[5]).rtx))->code) == TRAP_IF
     && ((((((last)->fld[5]).rtx))->fld[0]).rtx) == const_true_rtx)
     ;
   else
     fancy_abort ("../../../kgccfe/gnu/ifcvt.c", 2045, __FUNCTION__);
 }
 ...
 ;
      else if (combo_bb->succ->dest == (&entry_exit_blocks[1])
 ...
 fancy_abort ("../../../kgccfe/gnu/ifcvt.c", 2060, __FUNCTION__);
    }
 ...
 fancy_abort ("../../../kgccfe/gnu/ifcvt.c", 2091, __FUNCTION__);


      if (join_bb != (&entry_exit_blocks[1]))
     ...
     int pass;
{
  ...
  memset ((void *) &ce_info, '\0', sizeof (ce_info));
  ...
  if (1 && ((!(mips_isa == 1) && !(target_flags & 0x00100000)))
     ...
     struct ce_if_block * ce_info;
{
  ...
  if (0 && reload_completed
      ...
      && test_bb->pred->flags == 1)
    {
      ...
      basic_block target_bb;
      int max_insns = (((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1) + 1);
      int n_insns;
  ...
  if (rtl_dump_file)
    {
      fprintf (rtl_dump_file, "\nIF-THEN%s block found, pass %d, start block %d [insn %d], then %d [%d]",
        (else_bb) ? "-ELSE" : "",
        ce_info->pass,
        test_bb->index, (test_bb->head) ? (int)(((test_bb->head)->fld[0]).rtint) : -1,
        then_bb->index, (then_bb->head) ? (int)(((then_bb->head)->fld[0]).rtint) : -1);

      if (else_bb)
 fprintf (rtl_dump_file, ", else %d [%d]",
   else_bb->index, (else_bb->head) ? (int)(((else_bb->head)->fld[0]).rtint) : -1);

      fprintf (rtl_dump_file, ", join %d [%d]",
        join_bb->index, (join_bb->head) ? (int)(((join_bb->head)->fld[0]).rtint) : -1);
 ...
 fprintf (rtl_dump_file, ", %d %s block%s last test %d [%d]",
   ...
   ((ce_info->last_test_bb->head)
    ? (int)(((ce_info->last_test_bb->head)->fld[0]).rtint)
    : -1));

      fputc_unlocked ('\n', rtl_dump_file);
    }
# 2448 "../../../kgccfe/gnu/ifcvt.c"
  next = then_bb;
  if (else_bb && (next = next->next_bb) != else_bb)
    return 0;
  if ((next = next->next_bb) != join_bb && join_bb != (&entry_exit_blocks[1]))
    {
      if (else_bb)
 join_bb = ((void *)0);
      else
     ...
     edge then_edge, else_edge;
{
 ...
 return 0;
  ...
  seq = gen_cond_trap (code, (((cond)->fld[0]).rtx), (((cond)->fld[1]).rtx),
         ((((((trap)->fld[5]).rtx))->fld[1]).rtx));
  if (seq == ((void *)0))
    return 0;


  emit_insn_before_scope (seq, cond_earliest, (((trap)->fld[4]).rttree));
  ...
  if (test_bb->next_bb == other_bb)
    {
      ...
      delete_insn (jump);
      memset ((void *) &new_ce_info, '\0', sizeof (new_ce_info));
     ...
     basic_block bb;
{
  ...
  if (! (trap == bb->end
  && ((enum rtx_code) ((((trap)->fld[5]).rtx))->code) == TRAP_IF
         && ((((((trap)->fld[5]).rtx))->fld[0]).rtx) == const_true_rtx))
    return (rtx) 0;

  return trap;
}
# 2672 "../../../kgccfe/gnu/ifcvt.c"
static int
      ...
      edge then_edge, else_edge;
{
  ...
  if (count_bb_insns (then_bb) > ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1))
    return 0;
      ...
      edge then_edge, else_edge;
{
  ...
  note = find_reg_note (test_bb->end, REG_BR_PROB, (rtx) 0);
  if (note && ((((((note)->fld[0]).rtx))->fld[0]).rtwint) >= 10000 / 2)
    ;
  ...
  if (count_bb_insns (else_bb) > ((! (target_flags & 0x00100000) && ((mips_tune == PROCESSOR_R4000) || (mips_tune == PROCESSOR_R6000))) ? 2 : 1))
    return 0;
...
dead_or_predicable (test_bb, merge_bb, other_bb, new_dest, reversep)
     ...
     int reversep;
{
  rtx head, end, jump, earliest, old_dest, new_label = (rtx) 0;
      ...
      if (head == end)
 {
   ...
   goto no_body;
      ...
      if ((label = (((end)->fld[9]).rtx)) != (rtx) 0
   && (tmp = (((label)->fld[2]).rtx)) != (rtx) 0
   && ((enum rtx_code) (tmp)->code) == JUMP_INSN
   && (((enum rtx_code) ((((tmp)->fld[5]).rtx))->code) == ADDR_VEC
       || ((enum rtx_code) ((((tmp)->fld[5]).rtx))->code) == ADDR_DIFF_VEC))
 {
   for (insn = head; insn != (((end)->fld[1]).rtx); insn = (((insn)->fld[2]).rtx))
      ...
      if (reversep)
 {
   ...
   cond = gen_rtx_fmt_ee (rev, ((enum machine_mode) (cond)->mode), (((cond)->fld[0]).rtx),
            (((cond)->fld[1]).rtx));
   if (prob_val)
     prob_val = gen_rtx_CONST_INT (VOIDmode, (long long) (10000 - (((prob_val)->fld[0]).rtwint)));
 }
      ...
      for (insn = head; ; insn = (((insn)->fld[2]).rtx))
 {
  ...
  return 0;
       ...
       if (for_each_rtx (&(((insn)->fld[5]).rtx), find_memory, ((void *)0)))
  return 0;
     }
   if (insn == end)
     break;
 ...
 goto cancel;
  ...
  if (other_bb != new_dest)
    {
      if (old_dest)
 (((old_dest)->fld[4]).rtint) -= 1;
      if (new_label)
 (((new_label)->fld[4]).rtint) += 1;
      (((jump)->fld[9]).rtx) = new_label;
      if (reversep)
      ...
      if (reversep)
 {
  ...
  if (head != ((void *)0))
    {
      if (end == merge_bb->end)
 merge_bb->end = (((head)->fld[1]).rtx);

      if (squeeze_notes (&head, &end))
 return 1;

      reorder_insns (head, end, (((earliest)->fld[1]).rtx));
    }
