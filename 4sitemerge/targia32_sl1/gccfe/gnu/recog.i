...
# 33 "../../../kgccfe/gnu/recog.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 34 "../../../kgccfe/gnu/recog.c" 2
...
# 37 "../../../kgccfe/gnu/recog.c" 2
# 1 "../../../kgccfe/gnu/regs.h" 1
# 25 "../../../kgccfe/gnu/regs.h"
...
# 124 "../../../kgccfe/gnu/recog.c"
int
recog_memoized_1 (insn)
     rtx insn;
{
  if ((((insn)->fld[6]).rtint) < 0)
    (((insn)->fld[6]).rtint) = recog ((((insn)->fld[5]).rtx), insn, 0);
  return (((insn)->fld[6]).rtint);
}
     ...
     rtx x;
{
  ...
  operands = (rtx *) __builtin_alloca(noperands * sizeof (rtx));
  constraints = (const char **) __builtin_alloca(noperands * sizeof (char *));
    ...
    int in_group;
{
  ...
  if (in_group == 0 && num_changes != 0)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 226, __FUNCTION__);
  ...
  if (object && ((enum rtx_code) (object)->code) != MEM)
    {
      ...
      changes[num_changes].old_code = (((object)->fld[6]).rtint);
      (((object)->fld[6]).rtint) = -1;
    }
     ...
     rtx insn;
{
  ...
  int icode = recog (pat, insn,
       ...
       ? &num_clobbers : 0);
  int is_asm = icode < 0 && asm_noperands ((((insn)->fld[5]).rtx)) >= 0;




  if ((is_asm && ! check_asm_operands ((((insn)->fld[5]).rtx)))
      || (!is_asm && icode < 0))
    return 1;
...
# 346 "../../../kgccfe/gnu/recog.c"
 ...
 {
   if (! memory_address_p (((enum machine_mode) (object)->mode), (((object)->fld[0]).rtx)))
     break;
 }
      else if (insn_invalid_p (object))
 {
   rtx pat = (((object)->fld[5]).rtx);
   ...
   if (((enum rtx_code) (pat)->code) == PARALLEL
       && ((enum rtx_code) ((((((pat)->fld[0]).rtvec))->elem[(((((pat)->fld[0]).rtvec))->num_elem) - 1]))->code) == CLOBBER
       && asm_noperands ((((object)->fld[5]).rtx)) < 0)
     {
       rtx newpat;

       if ((((((pat)->fld[0]).rtvec))->num_elem) == 2)
  newpat = (((((pat)->fld[0]).rtvec))->elem[0]);
       else
  {
    int j;

    newpat
      = gen_rtx_fmt_E (PARALLEL, (VOIDmode), (rtvec_alloc ((((((pat)->fld[0]).rtvec))->num_elem) - 1)));

    for (j = 0; j < (((((newpat)->fld[0]).rtvec))->num_elem); j++)
      (((((newpat)->fld[0]).rtvec))->elem[j]) = (((((pat)->fld[0]).rtvec))->elem[j]);
  }
# 397 "../../../kgccfe/gnu/recog.c"
       validate_change (object, &(((object)->fld[5]).rtx), newpat, 1);
       continue;
     }
  ...
  if (i == num_changes)
    {
      ...
      for (i = 0; i < num_changes; i++)
 if (changes[i].object
     && ((rtx_class[(int) (((enum rtx_code) (changes[i].object)->code))]) == 'i')
     && (bb = (((changes[i].object)->fld[3]).bb)))
   bb->flags |= 1;
     ...
     int num;
{
 ...
 (((changes[i].object)->fld[6]).rtint) = changes[i].old_code;
    }
  num_changes = num;
}
     ...
     rtx from, to, object;
{
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 validate_replace_rtx_1 (&(((x)->fld[i]).rtx), from, to, object);
      else if (fmt[i] == 'E')
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   validate_replace_rtx_1 (&(((((x)->fld[i]).rtvec))->elem[j]), from, to, object);
    }
  ...
  if (fmt[0] == 'e' && ((enum machine_mode) ((((x)->fld[0]).rtx))->mode) != VOIDmode)
    op0_mode = ((enum machine_mode) ((((x)->fld[0]).rtx))->mode);




  if (((rtx_class[(int) (code)]) == '<' || (rtx_class[(int) (code)]) == 'c')
      && swap_commutative_operands_p ((((x)->fld[0]).rtx), (((x)->fld[1]).rtx)))
    {
      validate_change (object, loc,
         gen_rtx_fmt_ee ((rtx_class[(int) (code)]) == 'c' ? code
           : swap_condition (code),
           ((enum machine_mode) (x)->mode), (((x)->fld[1]).rtx),
           (((x)->fld[0]).rtx)), 1);
      x = *loc;
      code = ((enum rtx_code) (x)->code);
    }
  ...
  switch (code)
    ...
    case PLUS:
      ...
      if (((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_INT && (((x)->fld[1]).rtx) == to)
 validate_change (object, loc,
    simplify_gen_binary
    (PLUS, ((enum machine_mode) (x)->mode), (((x)->fld[0]).rtx), (((x)->fld[1]).rtx)), 1);
      break;
    case MINUS:
      if (((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_INT
   || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_DOUBLE)
 validate_change (object, loc,
    simplify_gen_binary
    (PLUS, ((enum machine_mode) (x)->mode), (((x)->fld[0]).rtx),
 ...
 {
   new = simplify_gen_unary (code, ((enum machine_mode) (x)->mode), (((x)->fld[0]).rtx),
        op0_mode);
   ...
   validate_change (object, loc, new, 1);
    ...
    case SUBREG:
      ...
      new = simplify_subreg (((enum machine_mode) (x)->mode), (((x)->fld[0]).rtx), op0_mode,
        (((x)->fld[1]).rtuint));


      if (!new && ((enum machine_mode) ((((x)->fld[0]).rtx))->mode) == VOIDmode)
 new = gen_rtx_fmt_e (CLOBBER, (((enum machine_mode) (x)->mode)), ((const_int_rtx[64])));
      if (new)
 validate_change (object, loc, new, 1);
      break;
   ...
   && !((((((x)->fld[0]).rtx)))->volatil))
 {
   ...
   enum machine_mode is_mode = ((enum machine_mode) ((((x)->fld[0]).rtx))->mode);
   int pos = ((((((x)->fld[2]).rtx))->fld[0]).rtwint);
  ...
  offset =
    ((mode_size[(int) (is_mode)]) - (mode_size[(int) (wanted_mode)]) -
     offset);

       pos %= (mode_bitsize[(int) (wanted_mode)]);

       newmem = adjust_address_1 ((((x)->fld[0]).rtx), wanted_mode, offset, 0, 1);

       validate_change (object, &(((x)->fld[2]).rtx), gen_rtx_CONST_INT (VOIDmode, (long long) (pos)), 1);
       validate_change (object, &(((x)->fld[0]).rtx), newmem, 1);
     }
 }
...
validate_replace_rtx (from, to, insn)
     rtx from, to, insn;
{
  validate_replace_rtx_1 (&(((insn)->fld[5]).rtx), from, to, insn);
  return apply_change_group ();
}
     ...
     rtx from, to, insn;
{
  ...
  d.to = to;
  d.insn = insn;
  note_uses (&(((insn)->fld[5]).rtx), validate_replace_src_1, &d);
}
     ...
     rtx *loc;
{
  ...
  switch (code)
    ...
    case SET:
      ...
      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) != CC0
 ...
 break;
      ...
      return find_single_use_1 (dest, &(((x)->fld[1]).rtx));

    case MEM:
    case SUBREG:
      return find_single_use_1 (dest, &(((x)->fld[0]).rtx));
 ...
 {
   if (dest == (((x)->fld[i]).rtx)
       || (((enum rtx_code) (dest)->code) == REG && ((enum rtx_code) ((((x)->fld[i]).rtx))->code) == REG
    && (((dest)->fld[0]).rtuint) == ((((((x)->fld[i]).rtx))->fld[0]).rtuint)))
     this_result = loc;
   else
     this_result = find_single_use_1 (dest, &(((x)->fld[i]).rtx));
      ...
      else if (fmt[i] == 'E')
 {
   ...
   for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
     {
       if ((((((x)->fld[i]).rtvec))->elem[j]) == dest
    || (((enum rtx_code) (dest)->code) == REG
        && ((enum rtx_code) ((((((x)->fld[i]).rtvec))->elem[j]))->code) == REG
        && ((((((((x)->fld[i]).rtvec))->elem[j]))->fld[0]).rtuint) == (((dest)->fld[0]).rtuint)))
  this_result = loc;
       else
  this_result = find_single_use_1 (dest, &(((((x)->fld[i]).rtvec))->elem[j]));
...
# 908 "../../../kgccfe/gnu/recog.c"
  ...
  for (next = next_nonnote_insn (insn);
    ...
    if (((rtx_class[(int) (((enum rtx_code) (next)->code))]) == 'i') && dead_or_set_p (next, dest))
      {
 for (link = (((next)->fld[7]).rtx); link; link = (((link)->fld[1]).rtx))
   if ((((link)->fld[0]).rtx) == insn)
     break;

 if (link)
   {
     result = find_single_use_1 (dest, &(((next)->fld[5]).rtx));
     if (ploc)
       *ploc = next;
     return result;
   }
     ...
     enum machine_mode mode;
{
  ...
  if (((enum rtx_code) (op)->code) == CONST_INT
      && mode != VOIDmode
      && trunc_int_for_mode ((((op)->fld[0]).rtwint), mode) != (((op)->fld[0]).rtwint))
    return 0;
  ...
  if ((((enum rtx_code) (op)->code) == LABEL_REF || ((enum rtx_code) (op)->code) == SYMBOL_REF || ((enum rtx_code) (op)->code) == CONST_INT || ((enum rtx_code) (op)->code) == CONST_DOUBLE || ((enum rtx_code) (op)->code) == CONST || ((enum rtx_code) (op)->code) == HIGH || ((enum rtx_code) (op)->code) == CONST_VECTOR || ((enum rtx_code) (op)->code) == CONSTANT_P_RTX))
    return ((((enum machine_mode) (op)->mode) == VOIDmode || ((enum machine_mode) (op)->mode) == mode
     ...
     && (! flag_pic || (! pic_address_needs_scratch (op)))

     && ((((enum rtx_code) (op)->code) != CONST_DOUBLE || mips_const_double_ok (op, ((enum machine_mode) (op)->mode))) && ! (((enum rtx_code) (op)->code) == CONST && ! (target_flags & 0x00000010) && (mips_abi == 1 || mips_abi == 2)) && (! (target_flags & 0x00100000) || mips16_constant (op, ((enum machine_mode) (op)->mode), 0, 0))));
  ...
  if (code == SUBREG)
    {
      rtx sub = (((op)->fld[0]).rtx);




      if (((enum rtx_code) (sub)->code) == MEM
   && (mode_size[(int) (mode)]) > (mode_size[(int) (((enum machine_mode) (sub)->mode))]))
 return 0;
      ...
      if (!reload_completed && (((op)->fld[1]).rtuint) != 0
   && ((enum rtx_code) (sub)->code) == MEM)
 return 0;



      if ((mode_class[(int) (((enum machine_mode) (op)->mode))]) == MODE_FLOAT
   && (mode_size[(int) (((enum machine_mode) (op)->mode))]) > (mode_size[(int) (((enum machine_mode) (sub)->mode))]))
 return 0;
  ...
  if (code == REG)
    ...
    return ((((op)->fld[0]).rtuint) >= 176
     || mips_regno_to_class[ ((((op)->fld[0]).rtuint)) ] != NO_REGS);
 ...
 return 0;
      ...
      if (((enum rtx_code) (y)->code) == ADDRESSOF)
 return 1;


      mode = ((enum machine_mode) (op)->mode);
      { if (mips_legitimate_address_p (mode, y, 0)) goto win; };
    }
     ...
     enum machine_mode mode;
{
 ...
 return general_operand (op, mode);
   ...
   && (((sub)->fld[0]).rtuint) < 176
   && mips_cannot_change_mode_class (((enum machine_mode) (sub)->mode), mode, mips_regno_to_class[ ((((sub)->fld[0]).rtuint)) ])
   && (mode_class[(int) (((enum machine_mode) (sub)->mode))]) != MODE_COMPLEX_INT
   && (mode_class[(int) (((enum machine_mode) (sub)->mode))]) != MODE_COMPLEX_FLOAT)
 return 0;
 ...
 return 0;
  ...
  if (((enum rtx_code) (op)->code) == ADDRESSOF)
    return 1;
...
{
  return register_operand (op, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode));
}
     ...
     enum machine_mode mode;
{
  ...
  if (((enum rtx_code) (op)->code) == CONSTANT_P_RTX)
    return 1;
...
nonimmediate_operand (op, mode)
     ...
     enum machine_mode mode;
{
  return (general_operand (op, mode) && ! (((enum rtx_code) (op)->code) == LABEL_REF || ((enum rtx_code) (op)->code) == SYMBOL_REF || ((enum rtx_code) (op)->code) == CONST_INT || ((enum rtx_code) (op)->code) == CONST_DOUBLE || ((enum rtx_code) (op)->code) == CONST || ((enum rtx_code) (op)->code) == HIGH || ((enum rtx_code) (op)->code) == CONST_VECTOR || ((enum rtx_code) (op)->code) == CONSTANT_P_RTX));
}
  ...
  if (((enum rtx_code) (op)->code) == SUBREG)
    {
      ...
      if (! reload_completed && ((enum rtx_code) ((((op)->fld[0]).rtx))->code) == MEM)
 return general_operand (op, mode);
      op = (((op)->fld[0]).rtx);
    }
...
push_operand (op, mode)
     ...
     enum machine_mode mode;
{
  unsigned int rounded_size = (mode_size[(int) (mode)]);
  ...
  if (rounded_size == (mode_size[(int) (mode)]))
    {
 ...
 return 0;
   ...
   || ((enum rtx_code) ((((op)->fld[1]).rtx))->code) != PLUS
   || ((((((op)->fld[1]).rtx))->fld[0]).rtx) != (((op)->fld[0]).rtx)
   || ((enum rtx_code) (((((((op)->fld[1]).rtx))->fld[1]).rtx))->code) != CONST_INT

   || (((((((((op)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtwint) != - (int) rounded_size
 ...
 return 0;
  ...
  return (((op)->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER]);
}
...
memory_address_p (mode, addr)
     ...
     rtx addr;
{
  if (((enum rtx_code) (addr)->code) == ADDRESSOF)
    return 1;

  { if (mips_legitimate_address_p (mode, addr, 0)) goto win; };
  return 0;
     ...
     enum machine_mode mode;
{
  ...
  if (! reload_completed
      && ((enum rtx_code) (op)->code) == SUBREG && ((enum rtx_code) ((((op)->fld[0]).rtx))->code) == MEM)
    {
      int offset = (((op)->fld[1]).rtuint);
      rtx inner = (((op)->fld[0]).rtx);
 ...
 return 0;
      ...
      return ((offset == 0 && general_operand ((((inner)->fld[0]).rtx), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)))
       || (((enum rtx_code) ((((inner)->fld[0]).rtx))->code) == PLUS
    && ((enum rtx_code) (((((((inner)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST_INT
    && (((((((((inner)->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtwint) == -offset
    && general_operand (((((((inner)->fld[0]).rtx))->fld[0]).rtx), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))));
    }

  return (((enum rtx_code) (op)->code) == MEM
   && memory_operand (op, mode)
   && general_operand ((((op)->fld[0]).rtx), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)));
}
    ...
    enum machine_mode mode;
{
  return ((mode == VOIDmode || ((enum machine_mode) (op)->mode) == mode)
   && (rtx_class[(int) (((enum rtx_code) (op)->code))]) == '<');
}
     ...
     rtx body;
{
  switch (((enum rtx_code) (body)->code))
    ...
    case SET:
      if (((enum rtx_code) ((((body)->fld[1]).rtx))->code) == ASM_OPERANDS)

 return ((((((((body)->fld[1]).rtx))->fld[3]).rtvec))->num_elem) + 1;
      else
 return -1;
    case PARALLEL:
      if (((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[0]))->code) == SET
   && ((enum rtx_code) (((((((((body)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->code) == ASM_OPERANDS)
 {
   ...
   for (i = (((((body)->fld[0]).rtvec))->num_elem); i > 0; i--)
     {
       if (((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[i - 1]))->code) == SET)
  break;
       if (((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[i - 1]))->code) != CLOBBER)
  return -1;
     }
   ...
   for (i = 0; i < n_sets; i++)
     {
       rtx elt = (((((body)->fld[0]).rtvec))->elem[i]);
       if (((enum rtx_code) (elt)->code) != SET)
  return -1;
       if (((enum rtx_code) ((((elt)->fld[1]).rtx))->code) != ASM_OPERANDS)
  return -1;


       if (((((((elt)->fld[1]).rtx))->fld[3]).rtvec)
    != (((((((((((body)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[3]).rtvec))
  return -1;
     }
   return ((((((((((((((body)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[3]).rtvec))->num_elem)
    + n_sets);
 }
      else if (((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[0]))->code) == ASM_OPERANDS)
 {
   ...
   for (i = (((((body)->fld[0]).rtvec))->num_elem) - 1; i > 0; i--)
     if (((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[i]))->code) != CLOBBER)
       return -1;

   return ((((((((((body)->fld[0]).rtvec))->elem[0]))->fld[3]).rtvec))->num_elem);
 }
      else
 return -1;
    default:
     ...
     enum machine_mode *modes;
{
  ...
  if (((enum rtx_code) (body)->code) == SET && ((enum rtx_code) ((((body)->fld[1]).rtx))->code) == ASM_OPERANDS)
    {
 ...
 {
   if (operand_locs)
     operand_locs[i] = &(((((asmop)->fld[3]).rtvec))->elem[i - 1]);
   if (operands)
     operands[i] = (((((asmop)->fld[3]).rtvec))->elem[i - 1]);
   if (constraints)
     constraints[i] = ((((((((asmop)->fld[4]).rtvec))->elem[i - 1]))->fld[0]).rtstr);
   if (modes)
     modes[i] = ((enum machine_mode) ((((((asmop)->fld[4]).rtvec))->elem[i - 1]))->mode);
 }
 ...
 constraints[0] = (((asmop)->fld[1]).rtstr);
      if (modes)
 modes[0] = ((enum machine_mode) ((((body)->fld[0]).rtx))->mode);
 ...
 {
   if (operand_locs)
     operand_locs[i] = &(((((asmop)->fld[3]).rtvec))->elem[i]);
   if (operands)
     operands[i] = (((((asmop)->fld[3]).rtvec))->elem[i]);
   if (constraints)
     constraints[i] = ((((((((asmop)->fld[4]).rtvec))->elem[i]))->fld[0]).rtstr);
   if (modes)
     modes[i] = ((enum machine_mode) ((((((asmop)->fld[4]).rtvec))->elem[i]))->mode);
 }
      template = (((asmop)->fld[0]).rtstr);
    }
  else if (((enum rtx_code) (body)->code) == PARALLEL
    && ((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[0]))->code) == SET
    && ((enum rtx_code) (((((((((body)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->code) == ASM_OPERANDS)
    {
      rtx asmop = ((((((((body)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx);
      ...
      for (i = 0; i < nparallel; i++)
 {
   ...
   if (operands)
     operands[i] = ((((((((body)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx);
   if (operand_locs)
     operand_locs[i] = &((((((((body)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx);
   if (constraints)
     constraints[i] = (((((((((((body)->fld[0]).rtvec))->elem[i]))->fld[1]).rtx))->fld[1]).rtstr);
   if (modes)
     modes[i] = ((enum machine_mode) (((((((((body)->fld[0]).rtvec))->elem[i]))->fld[0]).rtx))->mode);
   nout++;
 }
 ...
 {
   if (operand_locs)
     operand_locs[i + nout] = &(((((asmop)->fld[3]).rtvec))->elem[i]);
   if (operands)
     operands[i + nout] = (((((asmop)->fld[3]).rtvec))->elem[i]);
   if (constraints)
     constraints[i + nout] = ((((((((asmop)->fld[4]).rtvec))->elem[i]))->fld[0]).rtstr);
   if (modes)
     modes[i + nout] = ((enum machine_mode) ((((((asmop)->fld[4]).rtvec))->elem[i]))->mode);
 }

      template = (((asmop)->fld[0]).rtstr);
    }
  else if (((enum rtx_code) (body)->code) == PARALLEL
    && ((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[0]))->code) == ASM_OPERANDS)
    {


      rtx asmop = (((((body)->fld[0]).rtvec))->elem[0]);
      int nin = (((((asmop)->fld[3]).rtvec))->num_elem);
     ...
     const char *constraint;
{
  ...
  if (reload_completed)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 1688, __FUNCTION__);
 ...
 case '<':
   ...
   if (((enum rtx_code) (op)->code) == MEM
       && (1
    || ((enum rtx_code) ((((op)->fld[0]).rtx))->code) == PRE_DEC
    || ((enum rtx_code) ((((op)->fld[0]).rtx))->code) == POST_DEC))
     return 1;
   break;
 ...
 case '>':
   if (((enum rtx_code) (op)->code) == MEM
       && (1
    || ((enum rtx_code) ((((op)->fld[0]).rtx))->code) == PRE_INC
    || ((enum rtx_code) ((((op)->fld[0]).rtx))->code) == POST_INC))
     return 1;
   break;
 ...
 case 'F':
   if (((enum rtx_code) (op)->code) == CONST_DOUBLE
    ...
    && (mode_class[(int) (((enum machine_mode) (op)->mode))]) == MODE_VECTOR_FLOAT))
     return 1;
   break;

 case 'G':
   if (((enum rtx_code) (op)->code) == CONST_DOUBLE
       && (('G') == 'G' && (op) == (const_tiny_rtx[0][(int) (((enum machine_mode) (op)->mode))])))
     return 1;
   break;
 case 'H':
   if (((enum rtx_code) (op)->code) == CONST_DOUBLE
       && (('H') == 'G' && (op) == (const_tiny_rtx[0][(int) (((enum machine_mode) (op)->mode))])))
     return 1;
   break;
 ...
 case 'I':
   if (((enum rtx_code) (op)->code) == CONST_INT
       && (('I') == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : ('I') == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : ('I') == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : ('I') == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : ('I') == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : ('I') == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : ('I') == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : ('I') == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
     return 1;
   break;
 case 'J':
   if (((enum rtx_code) (op)->code) == CONST_INT
       && (('J') == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : ('J') == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : ('J') == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : ('J') == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : ('J') == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : ('J') == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : ('J') == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : ('J') == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
     return 1;
   break;
 case 'K':
   if (((enum rtx_code) (op)->code) == CONST_INT
       && (('K') == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : ('K') == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : ('K') == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : ('K') == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : ('K') == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : ('K') == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : ('K') == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : ('K') == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
     return 1;
   break;
 case 'L':
   if (((enum rtx_code) (op)->code) == CONST_INT
       && (('L') == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : ('L') == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : ('L') == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : ('L') == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : ('L') == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : ('L') == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : ('L') == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : ('L') == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
     return 1;
   break;
 case 'M':
   if (((enum rtx_code) (op)->code) == CONST_INT
       && (('M') == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : ('M') == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : ('M') == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : ('M') == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : ('M') == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : ('M') == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : ('M') == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : ('M') == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
     return 1;
   break;
 case 'N':
   if (((enum rtx_code) (op)->code) == CONST_INT
       && (('N') == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : ('N') == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : ('N') == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : ('N') == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : ('N') == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : ('N') == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : ('N') == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : ('N') == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
     return 1;
   break;
 case 'O':
   if (((enum rtx_code) (op)->code) == CONST_INT
       && (('O') == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : ('O') == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : ('O') == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : ('O') == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : ('O') == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : ('O') == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : ('O') == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : ('O') == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
     return 1;
   break;
 case 'P':
   if (((enum rtx_code) (op)->code) == CONST_INT
       && (('P') == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : ('P') == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : ('P') == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : ('P') == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : ('P') == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : ('P') == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : ('P') == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : ('P') == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
     return 1;
   break;
 ...
 default:
  ...
  return 1;
   ...
   if ((((c) == 'T') ? double_memory_operand (op, ((enum machine_mode) (op)->mode)) : ((c) == 'Q') ? (((enum rtx_code) (op)->code) == CONST && mips16_gp_offset_p (op)) : (((enum rtx_code) (op)->code) != MEM) ? 0 : ((c) == 'R') ? simple_memory_operand (op, ((enum machine_mode) (op)->mode)) : 0))
     return 1;
   if (0)
     {
     ...
     rtx *p;
{
  ...
  if ((((*p)->fld[0]).rtx) && (((enum rtx_code) ((((*p)->fld[0]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((*p)->fld[0]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((*p)->fld[0]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((*p)->fld[0]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) ((((*p)->fld[0]).rtx))->code) == CONST || ((enum rtx_code) ((((*p)->fld[0]).rtx))->code) == HIGH || ((enum rtx_code) ((((*p)->fld[0]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) ((((*p)->fld[0]).rtx))->code) == CONSTANT_P_RTX)
      && (((*p)->fld[1]).rtx) && (((enum rtx_code) ((((*p)->fld[1]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((*p)->fld[1]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((*p)->fld[1]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((*p)->fld[1]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) ((((*p)->fld[1]).rtx))->code) == CONST || ((enum rtx_code) ((((*p)->fld[1]).rtx))->code) == HIGH || ((enum rtx_code) ((((*p)->fld[1]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) ((((*p)->fld[1]).rtx))->code) == CONSTANT_P_RTX))
    return p;
...
# 1939 "../../../kgccfe/gnu/recog.c"
int
offsettable_memref_p (op)
     rtx op;
{
  return ((((enum rtx_code) (op)->code) == MEM)
   && offsettable_address_p (1, ((enum machine_mode) (op)->mode), (((op)->fld[0]).rtx)));
}
...
{
  return ((((enum rtx_code) (op)->code) == MEM)
   && offsettable_address_p (0, ((enum machine_mode) (op)->mode), (((op)->fld[0]).rtx)));
}
# 1968 "../../../kgccfe/gnu/recog.c"
int
     ...
     rtx y;
{
  ...
  unsigned int mode_sz = (mode_size[(int) (mode)]);

  if ((((enum rtx_code) (y)->code) == LABEL_REF || ((enum rtx_code) (y)->code) == SYMBOL_REF || ((enum rtx_code) (y)->code) == CONST_INT || ((enum rtx_code) (y)->code) == HIGH || (((enum rtx_code) (y)->code) == CONST && ! (flag_pic && pic_address_needs_scratch (y)) && ((target_flags & 0x00000010) || mips_abi == 0))))
    return 1;
  ...
  if (mode_sz == 0)
    mode_sz = (mips_abi == 1 || mips_abi == 2 ? 128 : 64) / 8;
  ...
  if ((ycode == PLUS) && (y2 = find_constant_term_loc (&y1)))
    {
      ...
      y1 = *y2;
      *y2 = plus_constant_wide ((*y2), (long long) (mode_sz - 1));
  ...
  if (((enum rtx_code) (y)->code) == LO_SUM
    ...
    z = gen_rtx_fmt_ee (LO_SUM, (((enum machine_mode) (y)->mode)), ((((y)->fld[0]).rtx)), (plus_constant_wide (((((y)->fld[1]).rtx)), (long long) (mode_sz - 1))));

  else
    z = plus_constant_wide ((y), (long long) (mode_sz - 1));
...
mode_dependent_address_p (addr)
  rtx addr __attribute__ ((__unused__));
{
  {};
  return 0;

 win: __attribute__ ((__unused__))
  return 1;
}
...
extract_insn_cached (insn)
     rtx insn;
{
  if (recog_data.insn == insn && (((insn)->fld[6]).rtint) >= 0)
    return;
  extract_insn (insn);
     ...
     rtx insn;
{
  ...
  if (which_alternative == -1
    ...
    _fatal_insn_not_found (insn, "../../../kgccfe/gnu/recog.c", 2100, __FUNCTION__);
}
     ...
     rtx insn;
{
      ...
      if (noperands >= 0)
 {
   ...
   if (noperands > 30)
     fancy_abort ("../../../kgccfe/gnu/recog.c", 2160, __FUNCTION__);
  ...
  recog_data.n_alternatives += (*p++ == ',');
   ...
   break;
      ...
      _fatal_insn_not_found (insn, "../../../kgccfe/gnu/recog.c", 2176, __FUNCTION__);
    ...
    normal_insn:
      ...
      icode = ((((insn)->fld[6]).rtint) >= 0 ? (((insn)->fld[6]).rtint) : recog_memoized_1 (insn));
      if (icode < 0)
 _fatal_insn_not_found (insn, "../../../kgccfe/gnu/recog.c", 2185, __FUNCTION__);
      ...
      for (i = 0; i < noperands; i++)
 {
  ...
  if (recog_data.n_alternatives > 30)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 2209, __FUNCTION__);
}
      ...
      for (j = 0; j < recog_data.n_alternatives; j++)
 {
  ...
  case 'p':
    ...
    op_alt[j].class = reg_class_subunion[(int) op_alt[j].class]
      [(int) ((target_flags & 0x00100000) ? M16_REGS : GR_REGS)];
    break;

  case 'g': case 'r':
    op_alt[j].class = reg_class_subunion[(int) op_alt[j].class][(int) GR_REGS];
    break;
  ...
  default:
    ...
    op_alt[j].class = reg_class_subunion[(int) op_alt[j].class][(int) mips_char_to_class[(unsigned char)((unsigned char) c)]];
    break;
  }
     }
 }
     ...
     int strict;
{
      ...
      for (opno = 0; opno < recog_data.n_operands; opno++)
 {
   ...
   if ((rtx_class[(int) (((enum rtx_code) (op)->code))]) == '1')
     op = (((op)->fld[0]).rtx);

   if (((enum rtx_code) (op)->code) == SUBREG)
     {
       if (((enum rtx_code) ((((op)->fld[0]).rtx))->code) == REG
    && ((((((op)->fld[0]).rtx))->fld[0]).rtuint) < 176)
  offset = subreg_regno_offset (((((((op)->fld[0]).rtx))->fld[0]).rtuint),
...
# 2455 "../../../kgccfe/gnu/recog.c"
    ...
    if (strict < 0)
    ...
    else
      {
        ...
        if ((rtx_class[(int) (((enum rtx_code) (op1)->code))]) == '1')
   op1 = (((op1)->fld[0]).rtx);
        if ((rtx_class[(int) (((enum rtx_code) (op2)->code))]) == '1')
   op2 = (((op2)->fld[0]).rtx);
  ...
  if (strict < 0
      ...
      || (reload_in_progress
   && (((op)->fld[0]).rtuint) >= 176)
      || reg_fits_class_p (op, GR_REGS, offset, mode))
    win = 1;
  break;
  ...
  if (((enum rtx_code) (op)->code) == MEM
      ...
      || (strict < 0 && (((enum rtx_code) (op)->code) == LABEL_REF || ((enum rtx_code) (op)->code) == SYMBOL_REF || ((enum rtx_code) (op)->code) == CONST_INT || ((enum rtx_code) (op)->code) == CONST_DOUBLE || ((enum rtx_code) (op)->code) == CONST || ((enum rtx_code) (op)->code) == HIGH || ((enum rtx_code) (op)->code) == CONST_VECTOR || ((enum rtx_code) (op)->code) == CONSTANT_P_RTX))
  ...
  break;
       ...
       case 'H':
  if (((enum rtx_code) (op)->code) == CONST_DOUBLE
      && ((c) == 'G' && (op) == (const_tiny_rtx[0][(int) (((enum machine_mode) (op)->mode))])))
    win = 1;
  break;
  ...
  break;
       ...
       case 'P':
  if (((enum rtx_code) (op)->code) == CONST_INT
      && ((c) == 'I' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x8000) < 0x10000) : (c) == 'J' ? (((((op)->fld[0]).rtwint)) == 0) : (c) == 'K' ? ((unsigned long long) ((((op)->fld[0]).rtwint)) < 0x10000) : (c) == 'L' ? ((((((op)->fld[0]).rtwint)) & 0x0000ffff) == 0 && ((((((op)->fld[0]).rtwint)) & ~2147483647) == 0 || (((((op)->fld[0]).rtwint)) & ~2147483647) == ~2147483647)) : (c) == 'M' ? (((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != 0) && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) != ~0x0000ffff) && ((((((op)->fld[0]).rtwint)) & 0x0000ffff) != 0 || ((((((op)->fld[0]).rtwint)) & ~2147483647) != 0 && (((((op)->fld[0]).rtwint)) & ~2147483647) != ~2147483647))) : (c) == 'N' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0xffff) < 0xffff) : (c) == 'O' ? ((unsigned long long) (((((op)->fld[0]).rtwint)) + 0x4000) < 0x8000) : (c) == 'P' ? (((((op)->fld[0]).rtwint)) != 0 && ((((((op)->fld[0]).rtwint)) & ~0x0000ffff) == 0)) : 0))
    win = 1;
  break;
  ...
  if (((enum rtx_code) (op)->code) == MEM
   ...
   || (strict < 0
       && !((((enum rtx_code) (op)->code) == LABEL_REF || ((enum rtx_code) (op)->code) == SYMBOL_REF || ((enum rtx_code) (op)->code) == CONST_INT || ((enum rtx_code) (op)->code) == CONST_DOUBLE || ((enum rtx_code) (op)->code) == CONST || ((enum rtx_code) (op)->code) == HIGH || ((enum rtx_code) (op)->code) == CONST_VECTOR || ((enum rtx_code) (op)->code) == CONSTANT_P_RTX) || ((enum rtx_code) (op)->code) == MEM))
   || (reload_in_progress
       && !(((enum rtx_code) (op)->code) == REG
     && (((op)->fld[0]).rtuint) >= 176))))
    win = 1;
       ...
       default:
  {
    ...
    class = (c == 'r' ? GR_REGS : mips_char_to_class[(unsigned char)(c)]);
    if (class != NO_REGS)
      {
        if (strict < 0
     || (strict == 0
    ...
    else if ((((c) == 'T') ? double_memory_operand (op, ((enum machine_mode) (op)->mode)) : ((c) == 'Q') ? (((enum rtx_code) (op)->code) == CONST && mips16_gp_offset_p (op)) : (((enum rtx_code) (op)->code) != MEM) ? 0 : ((c) == 'R') ? simple_memory_operand (op, ((enum machine_mode) (op)->mode)) : 0))
      win = 1;

    if (0)
      {

        if (strict < 0 && ((enum rtx_code) (op)->code) == MEM)
   win = 1;


        if (strict < 0 && (((enum rtx_code) (op)->code) == LABEL_REF || ((enum rtx_code) (op)->code) == SYMBOL_REF || ((enum rtx_code) (op)->code) == CONST_INT || ((enum rtx_code) (op)->code) == CONST_DOUBLE || ((enum rtx_code) (op)->code) == CONST || ((enum rtx_code) (op)->code) == HIGH || ((enum rtx_code) (op)->code) == CONST_VECTOR || ((enum rtx_code) (op)->code) == CONSTANT_P_RTX))
   win = 1;


        if (reload_in_progress && ((enum rtx_code) (op)->code) == REG
     && (((op)->fld[0]).rtuint) >= 176)
   win = 1;
      }
    if (0)
...
reg_fits_class_p (operand, class, offset, mode)
     ...
     enum machine_mode mode;
{
  int regno = (((operand)->fld[0]).rtuint);
  if (regno < 176
      && (!!((reg_class_contents[(int) class])[(regno + offset) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno + offset) % ((unsigned) (8 * 8)))))))

    {
      int sr;
      regno += offset;
      for (sr = mips_hard_regno_nregs (regno, mode) - 1;
    sr > 0; sr--)
 if (! (!!((reg_class_contents[(int) class])[(regno + sr) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno + sr) % ((unsigned) (8 * 8)))))))
     ...
     rtx insn;
{
  ...
  else if ((set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0)) != ((void *)0) && set_noop_p (set))
    {
 ...
 delete_insn_and_edges (insn);
  ...
  else
    {
      ...
      rtx first = (((insn)->fld[1]).rtx);
      rtx last = try_split ((((insn)->fld[5]).rtx), insn, 1);
   ...
   if (reload_completed && first != last)
     {
       ...
       while (1)
  {
    if (((rtx_class[(int) (((enum rtx_code) (first)->code))]) == 'i'))
     ...
     int upd_life;
{
      ...
      for (insn = bb->head; !finish ; insn = next)
 {
  ...
  last = (((last)->fld[1]).rtx);
       ((blocks)->elms [(bb->index) / ((unsigned) (8 * 8))] |= (unsigned long long) 1 << (bb->index) % ((unsigned) (8 * 8)));
       changed = 1;
       insn = last;
     }
 }
...
# 2910 "../../../kgccfe/gnu/recog.c"
rtx
peep2_next_insn (n)
     int n;
{
  if (n >= 4 + 1)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 2915, __FUNCTION__);
...
{
  if (ofs >= 4 + 1)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 2935, __FUNCTION__);
  ...
  if (peep2_insn_data[ofs].insn == (rtx) 0)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 2942, __FUNCTION__);
     ...
     rtx reg;
{
  ...
  if (ofs >= 4 + 1)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 2957, __FUNCTION__);
  ...
  if (peep2_insn_data[ofs].insn == (rtx) 0)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 2964, __FUNCTION__);

  regno = (((reg)->fld[0]).rtuint);
  n = mips_hard_regno_nregs (regno, ((enum machine_mode) (reg)->mode));
  while (--n >= 0)
    if (bitmap_bit_p (peep2_insn_data[ofs].live_before, regno + n))
      return 0;
  return 1;
}
# 2985 "../../../kgccfe/gnu/recog.c"
rtx
     ...
     HARD_REG_SET *reg_set;
{
  ...
  if (from >= 4 + 1 || to >= 4 + 1)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 2998, __FUNCTION__);
  ...
  if (peep2_insn_data[from].insn == (rtx) 0)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 3008, __FUNCTION__);
  do { do { HARD_REG_ELT_TYPE *scan_tp_ = (live); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); reg_set_to_hard_reg_set (&live, peep2_insn_data[from].live_before); } while (0);
 ...
 from = 0;
      if (peep2_insn_data[from].insn == (rtx) 0)
 fancy_abort ("../../../kgccfe/gnu/recog.c", 3018, __FUNCTION__);
      do { do { HARD_REG_ELT_TYPE *scan_tp_ = (this_live); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); reg_set_to_hard_reg_set (&this_live, peep2_insn_data[from].live_before); } while (0);
      do { HARD_REG_ELT_TYPE *scan_tp_ = (live), *scan_fp_ = (this_live); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
    }

  class = (class_str[0] == 'r' ? GR_REGS
    : mips_char_to_class[(unsigned char)(class_str[0])]);
 ...
 continue;
      ...
      if ((regno == (0 + 1) || regno == ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30))
   && (! reload_completed || frame_pointer_needed))
 continue;

      success = 1;
      for (j = mips_hard_regno_nregs (regno, mode) - 1; j >= 0; j--)
 {
   if ((!!((*reg_set)[(regno + j) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno + j) % ((unsigned) (8 * 8))))))
       || (!!((live)[(regno + j) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno + j) % ((unsigned) (8 * 8)))))))
     {
       success = 0;
       break;
     }
 ...
 {
   for (j = mips_hard_regno_nregs (regno, mode) - 1; j >= 0; j--)
     ((*reg_set)[(regno + j) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((regno + j) % ((unsigned) (8 * 8))));
...
peephole2_optimize (dump_file)
     FILE *dump_file __attribute__ ((__unused__));
{
  ...
  _Bool do_cleanup_cfg = 0;
  _Bool do_rebuild_jump_labels = 0;
 ...
 peep2_insn_data[i].insn = (rtx) 0;
      ...
      pbi = init_propagate_block_info (bb, live, ((void *)0), ((void *)0), 1);
       ...
       if (try != ((void *)0))
  {
        ...
        while (new_insn != (rtx) 0)
   {
     if (((enum rtx_code) (new_insn)->code) == CALL_INSN)
       break;
     new_insn = (((new_insn)->fld[2]).rtx);
   }

        if (new_insn == (rtx) 0)
   fancy_abort ("../../../kgccfe/gnu/recog.c", 3188, __FUNCTION__);

        (((new_insn)->fld[9]).rtx)
   = (((old_insn)->fld[9]).rtx);

        for (note = (((old_insn)->fld[8]).rtx);
      note;
      note = (((note)->fld[1]).rtx))
   switch (((enum reg_note) ((enum machine_mode) (note)->mode)))
     ...
     case REG_ALWAYS_RETURN:
       (((new_insn)->fld[8]).rtx)
         = gen_rtx_fmt_ee (EXPR_LIST, (((enum reg_note) ((enum machine_mode) (note)->mode))), ((((note)->fld[0]).rtx)), ((((new_insn)->fld[8]).rtx)));
        ...
        while (++i <= match_len)
   {
     ...
     old_insn = peep2_insn_data[j].insn;
     if (((enum rtx_code) (old_insn)->code) == CALL_INSN)
       fancy_abort ("../../../kgccfe/gnu/recog.c", 3218, __FUNCTION__);
   }
        break;
      }
    ...
    try = emit_insn_after_scope (try, peep2_insn_data[i].insn,
            (((peep2_insn_data[i].insn)->fld[4]).rttree));
    before_try = (((insn)->fld[1]).rtx);
   ...
   if (eh_edge->flags & (8 | 4))
     break;
        ...
        for (x = try ; x != before_try ; x = (((x)->fld[1]).rtx))
   if (((enum rtx_code) (x)->code) == CALL_INSN
       || (flag_non_call_exceptions
    && may_trap_p ((((x)->fld[5]).rtx))
    && !find_reg_note (x, REG_EH_REGION, ((void *)0))))
     {
       if (note)
         (((x)->fld[8]).rtx)
           = gen_rtx_fmt_ee (EXPR_LIST, (REG_EH_REGION), ((((note)->fld[0]).rtx)), ((((x)->fld[8]).rtx)));
...
# 3372 "../../../kgccfe/gnu/recog.c"
}
# 3382 "../../../kgccfe/gnu/recog.c"
int
     ...
     rtx out_insn, in_insn;
{
  ...
  in_set = (((rtx_class[(int) (((enum rtx_code) (in_insn)->code))]) == 'i') ? (((enum rtx_code) ((((in_insn)->fld[5]).rtx))->code) == SET ? (((in_insn)->fld[5]).rtx) : single_set_2 (in_insn, (((in_insn)->fld[5]).rtx))) : (rtx) 0);
  if (! in_set)
    fancy_abort ("../../../kgccfe/gnu/recog.c", 3390, __FUNCTION__);

  if (((enum rtx_code) ((((in_set)->fld[0]).rtx))->code) != MEM)
    return 0;

  out_set = (((rtx_class[(int) (((enum rtx_code) (out_insn)->code))]) == 'i') ? (((enum rtx_code) ((((out_insn)->fld[5]).rtx))->code) == SET ? (((out_insn)->fld[5]).rtx) : single_set_2 (out_insn, (((out_insn)->fld[5]).rtx))) : (rtx) 0);
  if (out_set)
    {
      if (reg_mentioned_p ((((out_set)->fld[0]).rtx), (((in_set)->fld[0]).rtx)))
 return 0;
    }
  else
    {
      ...
      out_pat = (((out_insn)->fld[5]).rtx);
      if (((enum rtx_code) (out_pat)->code) != PARALLEL)
 fancy_abort ("../../../kgccfe/gnu/recog.c", 3408, __FUNCTION__);

      for (i = 0; i < (((((out_pat)->fld[0]).rtvec))->num_elem); i++)
 {
   rtx exp = (((((out_pat)->fld[0]).rtvec))->elem[i]);

   if (((enum rtx_code) (exp)->code) == CLOBBER)
     continue;

   if (((enum rtx_code) (exp)->code) != SET)
     fancy_abort ("../../../kgccfe/gnu/recog.c", 3418, __FUNCTION__);

   if (reg_mentioned_p ((((exp)->fld[0]).rtx), (((in_set)->fld[0]).rtx)))
     return 0;
 }
    }
     ...
     rtx out_insn, in_insn;
{
 ...
 return 0;
      fancy_abort ("../../../kgccfe/gnu/recog.c", 3444, __FUNCTION__);
    }

  if (((enum rtx_code) ((((in_set)->fld[1]).rtx))->code) != IF_THEN_ELSE)
    return 0;
  in_set = (((in_set)->fld[1]).rtx);

  out_set = (((rtx_class[(int) (((enum rtx_code) (out_insn)->code))]) == 'i') ? (((enum rtx_code) ((((out_insn)->fld[5]).rtx))->code) == SET ? (((out_insn)->fld[5]).rtx) : single_set_2 (out_insn, (((out_insn)->fld[5]).rtx))) : (rtx) 0);
  if (out_set)
    {
      if (reg_mentioned_p ((((out_set)->fld[0]).rtx), (((in_set)->fld[1]).rtx))
   || reg_mentioned_p ((((out_set)->fld[0]).rtx), (((in_set)->fld[2]).rtx)))
 return 0;
    }
  else
    {
      ...
      out_pat = (((out_insn)->fld[5]).rtx);
      if (((enum rtx_code) (out_pat)->code) != PARALLEL)
 fancy_abort ("../../../kgccfe/gnu/recog.c", 3465, __FUNCTION__);
      ...
      for (i = 0; i < (((((out_pat)->fld[0]).rtvec))->num_elem); i++)
 {
   ...
   if (((enum rtx_code) (exp)->code) != SET)
     fancy_abort ("../../../kgccfe/gnu/recog.c", 3475, __FUNCTION__);
