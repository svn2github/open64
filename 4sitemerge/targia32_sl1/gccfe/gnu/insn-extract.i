# 1 "../../../kgccfe/gnu/MIPS/insn-extract.c"
...
# 5 "../../../kgccfe/gnu/MIPS/insn-extract.c" 2
...
# 6 "../../../kgccfe/gnu/MIPS/insn-extract.c" 2
...
# 7 "../../../kgccfe/gnu/MIPS/insn-extract.c" 2
# 1 "../../../kgccfe/gnu/MIPS/insn-config.h" 1
# 8 "../../../kgccfe/gnu/MIPS/insn-extract.c" 2
...
# 9 "../../../kgccfe/gnu/MIPS/insn-extract.c" 2
...
# 10 "../../../kgccfe/gnu/MIPS/insn-extract.c" 2

static rtx junk __attribute__ ((__unused__));
void
insn_extract (insn)
     rtx insn;
{
  ...
  memset (ro, 0, sizeof (*ro) * 30);
  memset (ro_loc, 0, sizeof (*ro_loc) * 30);
  switch ((((insn)->fld[6]).rtint))
    {
    case -1:
      _fatal_insn_not_found (insn, "../../../kgccfe/gnu/MIPS/insn-extract.c", 26, __FUNCTION__);
    ...
    case 529:
      for (i = (((((pat)->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
          ro[i] = *(ro_loc[i] = &(((((pat)->fld[0]).rtvec))->elem[i]));
      break;
    ...
    case 324:
    case 321:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((pat)->fld[1]).rtx))->fld[1]).rtx));
      ro[2] = *(ro_loc[2] = &((((((pat)->fld[1]).rtx))->fld[2]).rtx));
      ro[3] = *(ro_loc[3] = &((((((pat)->fld[1]).rtx))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      break;
    ...
    case 319:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((pat)->fld[1]).rtx))->fld[1]).rtx));
      ro[3] = *(ro_loc[3] = &((((((pat)->fld[1]).rtx))->fld[2]).rtx));
      ro[4] = *(ro_loc[4] = &((((((pat)->fld[1]).rtx))->fld[0]).rtx));
      break;

    case 317:
    case 315:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((pat)->fld[1]).rtx));
      ro[2] = *(ro_loc[2] = &(((pat)->fld[2]).rtx));
      break;

    case 316:
    case 314:
      ro[0] = *(ro_loc[0] = &((((((pat)->fld[0]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((pat)->fld[1]).rtx));
      ro[2] = *(ro_loc[2] = &(((pat)->fld[2]).rtx));
      ro[3] = *(ro_loc[3] = &((((((pat)->fld[0]).rtx))->fld[1]).rtx));
      break;

    case 313:
    case 312:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx));
      ro[3] = *(ro_loc[3] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      recog_data.dup_loc[0] = &((((((((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx);
      recog_data.dup_num[0] = 1;
      recog_data.dup_loc[1] = &(((((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[1]).rtx))->fld[1]).rtx);
    ...
    case 297:
    case 296:
      ro[0] = *(ro_loc[0] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      break;

    case 294:
    case 293:
      ro[0] = *(ro_loc[0] = &((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtvec))->elem[0]));
      ro[1] = *(ro_loc[1] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      break;

    case 292:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtvec))->elem[0]));
      break;
    ...
    case 288:
      ro[0] = *(ro_loc[0] = &((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      break;

    case 287:
      ro[0] = *(ro_loc[0] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      break;
    ...
    case 286:
    case 285:
      ro[0] = *(ro_loc[0] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      recog_data.dup_loc[0] = &(((((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx))->fld[0]).rtx);
      recog_data.dup_num[0] = 1;
      break;

    case 284:
    case 283:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx))->fld[0]).rtx));
      break;

    case 282:
    case 281:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[1]).rtx));
      break;

    case 280:
    case 279:
      ro[0] = *(ro_loc[0] = &((((((pat)->fld[1]).rtx))->fld[0]).rtx));
      break;
    ...
    case 227:
      ro[0] = *(ro_loc[0] = &((((((pat)->fld[1]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((pat)->fld[1]).rtx))->fld[2]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      break;

    case 226:
    case 225:
      ro[0] = *(ro_loc[0] = &((((((pat)->fld[1]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((pat)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      break;
    ...
    case 190:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((pat)->fld[0]).rtvec))->elem[5]))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &((((((((pat)->fld[0]).rtvec))->elem[6]))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[5] = *(ro_loc[5] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      ro[6] = *(ro_loc[6] = &((((((((pat)->fld[0]).rtvec))->elem[3]))->fld[0]).rtx));
      ro[7] = *(ro_loc[7] = &((((((((pat)->fld[0]).rtvec))->elem[4]))->fld[0]).rtx));
      break;

    case 189:
      ro[0] = *(ro_loc[0] = &(((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtvec))->elem[0]));
      ro[1] = *(ro_loc[1] = &(((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtvec))->elem[1]));
      break;
    ...
    case 174:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[1]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((pat)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((pat)->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      break;
    ...
    case 331:
    case 168:
      ro[0] = *(ro_loc[0] = &(((((pat)->fld[0]).rtvec))->elem[0]));
      break;

    case 165:
      ro[0] = *(ro_loc[0] = &(((((((((pat)->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      break;
    ...
    case 153:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((pat)->fld[1]).rtx))->fld[0]).rtvec))->elem[0]));
      break;
    ...
    case 113:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((pat)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      break;
    ...
    case 92:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      break;
    ...
    case 89:
      ...
      ro[1] = *(ro_loc[1] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      break;

    case 84:
    case 83:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((pat)->fld[1]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((pat)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      break;
    ...
    case 72:
      ro[0] = *(ro_loc[0] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx))->fld[1]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx));
      break;

    case 71:
      ro[0] = *(ro_loc[0] = &((((((pat)->fld[0]).rtx))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((pat)->fld[0]).rtx))->fld[1]).rtx));
      ro[2] = *(ro_loc[2] = &(((pat)->fld[1]).rtx));
      break;
    ...
    case 67:
      ...
      ro[3] = *(ro_loc[3] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      recog_data.dup_loc[0] = &(((((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[1]).rtx))->fld[0]).rtx);
      recog_data.dup_num[0] = 1;
      recog_data.dup_loc[1] = &(((((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[1]).rtx))->fld[1]).rtx);
      recog_data.dup_num[1] = 2;
      break;
    ...
    case 61:
      ...
      ro[1] = *(ro_loc[1] = &((((((pat)->fld[1]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((pat)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &(((((((((pat)->fld[1]).rtx))->fld[1]).rtx))->fld[1]).rtx));
      break;

    case 60:
    case 59:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      ro[3] = *(ro_loc[3] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      break;
    ...
    case 55:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((pat)->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      ro[3] = *(ro_loc[3] = &((((((pat)->fld[1]).rtx))->fld[1]).rtx));
      break;

    case 54:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      ro[5] = *(ro_loc[5] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[6] = *(ro_loc[6] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      recog_data.dup_loc[0] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx);
    ...
    case 52:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      ro[3] = *(ro_loc[3] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      recog_data.dup_loc[0] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx);
      recog_data.dup_num[0] = 0;
    ...
    case 50:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      break;
    ...
    case 49:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      ro[5] = *(ro_loc[5] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx));
      ro[6] = *(ro_loc[6] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[7] = *(ro_loc[7] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      ro[8] = *(ro_loc[8] = &((((((((pat)->fld[0]).rtvec))->elem[3]))->fld[0]).rtx));
      break;
    ...
    case 48:
      ...
      ro[1] = *(ro_loc[1] = &((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      ro[5] = *(ro_loc[5] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx));
      ro[6] = *(ro_loc[6] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[7] = *(ro_loc[7] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      ro[8] = *(ro_loc[8] = &((((((((pat)->fld[0]).rtvec))->elem[3]))->fld[0]).rtx));
    ...
    case 46:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &(((((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[5] = *(ro_loc[5] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx))->fld[1]).rtx));
      ro[6] = *(ro_loc[6] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[7] = *(ro_loc[7] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      break;
    ...
    case 44:
      ro[0] = *(ro_loc[0] = &((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx));
      ro[5] = *(ro_loc[5] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[6] = *(ro_loc[6] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      break;
    ...
    case 39:
      ...
      ro[3] = *(ro_loc[3] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      ro[5] = *(ro_loc[5] = &((((((((pat)->fld[0]).rtvec))->elem[3]))->fld[0]).rtx));
      break;
    ...
    case 38:
      ...
      ro[1] = *(ro_loc[1] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtx));
      ro[3] = *(ro_loc[3] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx))->fld[1]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[5] = *(ro_loc[5] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      ro[6] = *(ro_loc[6] = &((((((((pat)->fld[0]).rtvec))->elem[3]))->fld[0]).rtx));
      ro[7] = *(ro_loc[7] = &((((((((pat)->fld[0]).rtvec))->elem[4]))->fld[0]).rtx));
    ...
    case 37:
      ...
      ro[1] = *(ro_loc[1] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[0]).rtx))->fld[1]).rtx));
      ro[3] = *(ro_loc[3] = &(((((((((((pat)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx))->fld[1]).rtx));
      ro[4] = *(ro_loc[4] = &((((((((pat)->fld[0]).rtvec))->elem[1]))->fld[0]).rtx));
      ro[5] = *(ro_loc[5] = &((((((((pat)->fld[0]).rtvec))->elem[2]))->fld[0]).rtx));
      ro[6] = *(ro_loc[6] = &((((((((pat)->fld[0]).rtvec))->elem[3]))->fld[0]).rtx));
      ro[7] = *(ro_loc[7] = &((((((((pat)->fld[0]).rtvec))->elem[4]))->fld[0]).rtx));
    ...
    case 11:
    case 5:
      ro[0] = *(ro_loc[0] = &((((((pat)->fld[1]).rtx))->fld[1]).rtx));
      break;
    ...
    case 1:
      ro[0] = *(ro_loc[0] = &(((pat)->fld[0]).rtx));
      ro[1] = *(ro_loc[1] = &((((((pat)->fld[0]).rtx))->fld[0]).rtx));
      ro[2] = *(ro_loc[2] = &((((((pat)->fld[0]).rtx))->fld[1]).rtx));
      break;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/MIPS/insn-extract.c", 773, __FUNCTION__);
    }
}
