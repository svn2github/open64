...
# 41 "../../../kgccfe/gnu/c-convert.c" 2
# 1 "../../../kgccfe/gnu/convert.h" 1
# 21 "../../../kgccfe/gnu/convert.h"
extern tree convert_to_integer (tree, tree);
extern tree convert_to_pointer (tree, tree);
extern tree convert_to_real (tree, tree);
extern tree convert_to_complex (tree, tree);
extern tree convert_to_vector (tree, tree);
# 42 "../../../kgccfe/gnu/c-convert.c" 2
...
# 44 "../../../kgccfe/gnu/c-convert.c" 2
# 72 "../../../kgccfe/gnu/c-convert.c"
tree
convert (type, expr)
     tree type, expr;
{
 ...
 return fold (build1 (NOP_EXPR, type, ((t)->exp.operands[0])));
      else
...
convert_floor_to_floorf (tree e)
{
  ...
  if (((enum tree_code) (e)->common.code) == CALL_EXPR &&
      (fn = get_callee_fndecl (e)) &&


      (((fn)->decl.built_in_class) != NOT_BUILT_IN) &&
      ((fn)->decl.u1.f) == BUILT_IN_FLOOR &&


      ((enum tree_code) (nop_expr = ((((e)->exp.operands[1]))->list.value))->common.code) == NOP_EXPR &&
      ((enum tree_code) (((nop_expr)->common.type))->common.code) == REAL_TYPE &&
      ((enum tree_code) (((((nop_expr)->common.type))->type.size))->common.code) == INTEGER_CST &&
      (((((((nop_expr)->common.type))->type.size))->int_cst.int_cst).low) == 64 &&

      ((enum tree_code) (((from =((nop_expr)->exp.operands[0]))->common.type))->common.code) == REAL_TYPE &&
      ((enum tree_code) (((((from)->common.type))->type.size))->common.code) == INTEGER_CST &&
      (((((((from)->common.type))->type.size))->int_cst.int_cst).low) == 32)
    {

      tree call_expr;
      tree floorf = built_in_decls[BUILT_IN_FLOORF];
      tree arg_list = build_tree_list ((tree) ((void *)0), from);
      call_expr = build1 (ADDR_EXPR,
     build_pointer_type (((floorf)->common.type)),
     floorf);
      call_expr = build (CALL_EXPR, ((((floorf)->common.type))->common.type),
