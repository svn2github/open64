...
# 28 "../../../kgccfe/gnu/rtl-error.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 29 "../../../kgccfe/gnu/rtl-error.c" 2
...
# 32 "../../../kgccfe/gnu/rtl-error.c" 2
# 1 "../../../kgccfe/gnu/diagnostic.h" 1
# 25 "../../../kgccfe/gnu/diagnostic.h"
     ...
     int *pline;
{
  ...
  if (((enum rtx_code) (body)->code) == SET && ((enum rtx_code) ((((body)->fld[1]).rtx))->code) == ASM_OPERANDS)
    ...
    asmop = ((((((((body)->fld[0]).rtvec))->elem[0]))->fld[1]).rtx);
  else if (((enum rtx_code) (body)->code) == PARALLEL
    && ((enum rtx_code) ((((((body)->fld[0]).rtvec))->elem[0]))->code) == ASM_OPERANDS)
    asmop = (((((body)->fld[0]).rtvec))->elem[0]);
  else
    asmop = ((void *)0);

  if (asmop)
    {
      *pfile = (((asmop)->fld[5]).rtstr);
      *pline = (((asmop)->fld[6]).rtint);
    }
  else
    {
     ...
     diagnostic_t kind;
{
  ...
  diagnostic_set_info (&diagnostic, msg, args_ptr, ((void *)0), 0, kind);
