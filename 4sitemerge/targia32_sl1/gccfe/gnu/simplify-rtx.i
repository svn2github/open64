...
# 24 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 25 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 26 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
extern void fancy_abort (const char *, int, const char *)
    __attribute__ ((__noreturn__));
# 27 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 28 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 29 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 31 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 32 "../../../kgccfe/gnu/simplify-rtx.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 33 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 34 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 35 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 36 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 37 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 38 "../../../kgccfe/gnu/simplify-rtx.c" 2
...
# 39 "../../../kgccfe/gnu/simplify-rtx.c" 2
# 84 "../../../kgccfe/gnu/simplify-rtx.c"
static rtx neg_const_int (enum machine_mode, rtx);
static int simplify_plus_minus_op_data_cmp (const void *, const void *);

static rtx simplify_plus_minus (enum rtx_code, enum machine_mode, rtx, rtx, int);
...
neg_const_int (mode, i)
     ...
     rtx i;
{
  return gen_int_mode (- (((i)->fld[0]).rtwint), mode);
}
     ...
     rtx op0, op1;
{
  ...
  if (op0 == (const_int_rtx[64]) && swap_commutative_operands_p (op0, op1))
  ...
  if (code == NE && op1 == (const_int_rtx[64])
      && (rtx_class[(int) (((enum rtx_code) (op0)->code))]) == '<')
    return op0;
  else if (code == EQ && op1 == (const_int_rtx[64]))
    {
     ...
     rtx new;
{
 ...
 rtx op = ((((x)->fld[0]).rtx) == old
    ? new : simplify_replace_rtx ((((x)->fld[0]).rtx), old, new));
 ...
 simplify_gen_binary (code, mode,
        simplify_replace_rtx ((((x)->fld[0]).rtx), old, new),
        simplify_replace_rtx ((((x)->fld[1]).rtx), old, new));
    case '<':
      {
 enum machine_mode op_mode = (((enum machine_mode) ((((x)->fld[0]).rtx))->mode) != VOIDmode
         ? ((enum machine_mode) ((((x)->fld[0]).rtx))->mode)
         : ((enum machine_mode) ((((x)->fld[1]).rtx))->mode));
 rtx op0 = simplify_replace_rtx ((((x)->fld[0]).rtx), old, new);
 rtx op1 = simplify_replace_rtx ((((x)->fld[1]).rtx), old, new);
 ...
 return
   simplify_gen_ternary (code, mode,
    ...
    op0,
    simplify_replace_rtx ((((x)->fld[1]).rtx), old, new),
    simplify_replace_rtx ((((x)->fld[2]).rtx), old, new));
      }
 ...
 {
   rtx exp;
   exp = simplify_gen_subreg (((enum machine_mode) (x)->mode),
         simplify_replace_rtx ((((x)->fld[0]).rtx),
               old, new),
         ((enum machine_mode) ((((x)->fld[0]).rtx))->mode),
         (((x)->fld[1]).rtuint));
   if (exp)
      ...
      else if (code == LO_SUM)
 {
   ...
   if (((enum rtx_code) (op0)->code) == HIGH && rtx_equal_p ((((op0)->fld[0]).rtx), op1))
     return op1;
 ...
 {
   if ((((enum rtx_code) (old)->code) == REG) && (((x)->fld[0]).rtuint) == (((old)->fld[0]).rtuint))
     return new;
 }
     ...
     enum machine_mode op_mode;
{
  ...
  if (code == VEC_DUPLICATE)
    {
      if (!((mode_class[(int) (mode)]) == MODE_VECTOR_INT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT))
 fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 387, __FUNCTION__);
      if (((enum machine_mode) (trueop)->mode) != VOIDmode
   && !((mode_class[(int) (((enum machine_mode) (trueop)->mode))]) == MODE_VECTOR_INT || (mode_class[(int) (((enum machine_mode) (trueop)->mode))]) == MODE_VECTOR_FLOAT)
   && inner_mode_array[(int) (mode)] != ((enum machine_mode) (trueop)->mode))
 fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 391, __FUNCTION__);
      if (((enum machine_mode) (trueop)->mode) != VOIDmode
   && ((mode_class[(int) (((enum machine_mode) (trueop)->mode))]) == MODE_VECTOR_INT || (mode_class[(int) (((enum machine_mode) (trueop)->mode))]) == MODE_VECTOR_FLOAT)
   && inner_mode_array[(int) (mode)] != inner_mode_array[(int) (((enum machine_mode) (trueop)->mode))])
 fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 395, __FUNCTION__);
      if (((enum rtx_code) (trueop)->code) == CONST_INT || ((enum rtx_code) (trueop)->code) == CONST_DOUBLE
   || ((enum rtx_code) (trueop)->code) == CONST_VECTOR)
 {
          int elt_size = (mode_size[(int) (inner_mode_array[(int) (mode)])]);
          unsigned n_elts = ((mode_size[(int) (mode)]) / elt_size);
   ...
   if (((enum rtx_code) (trueop)->code) != CONST_VECTOR)
   ...
   else
     {
       enum machine_mode inmode = ((enum machine_mode) (trueop)->mode);
              int in_elt_size = (mode_size[(int) (inner_mode_array[(int) (inmode)])]);
              unsigned in_n_elts = ((mode_size[(int) (inmode)]) / in_elt_size);

       if (in_n_elts >= n_elts || n_elts % in_n_elts)
  fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 414, __FUNCTION__);
       for (i = 0; i < n_elts; i++)
         ((v)->elem[i]) = (((((trueop)->fld[0]).rtvec))->elem[i % in_n_elts]);
     }
 ...
 lv = (((trueop)->fld[0]).rtwint), hv = ((((long long) lv) < 0) ? ((long long) -1) : ((long long) 0));
      else
 lv = (((trueop)->fld[0]).rtwint), hv = (((trueop)->fld[1]).rtwint);
      ...
      if (op_mode == VOIDmode)
 {
   ...
   if (hv < 0)
     return 0;
      ...
      else if ((mode_bitsize[(int) (op_mode)]) >= (8 * 8) * 2)
 ;
      else
 hv = 0, lv &= mode_mask_array[(int) (op_mode)];
  ...
  if (((enum rtx_code) (trueop)->code) == CONST_INT
      && width <= (8 * 8) && width > 0)
    {
      long long arg0 = (((trueop)->fld[0]).rtwint);
      long long val;
 ...
 case FFS:
   ...
   arg0 &= mode_mask_array[(int) (mode)];
   val = exact_log2_wide ((unsigned long long) (arg0 & (- arg0))) + 1;
   break;
 ...
 case ZERO_EXTEND:
   ...
   if (op_mode == VOIDmode)
     fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 505, __FUNCTION__);
   if ((mode_bitsize[(int) (op_mode)]) == (8 * 8))
     {



       if (width != (mode_bitsize[(int) (op_mode)]))
  fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 512, __FUNCTION__);
       val = arg0;
     }
   else if ((mode_bitsize[(int) (op_mode)]) < (8 * 8))
     val = arg0 & ~((long long) (-1) << (mode_bitsize[(int) (op_mode)]));
   else
     return 0;
   break;
   ...
   if ((mode_bitsize[(int) (op_mode)]) == (8 * 8))
     {
       ...
       if (width != (mode_bitsize[(int) (op_mode)]))
  fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 530, __FUNCTION__);
       val = arg0;
     }
   else if ((mode_bitsize[(int) (op_mode)]) < (8 * 8))
     {
       val
  = arg0 & ~((long long) (-1) << (mode_bitsize[(int) (op_mode)]));
       if (val
    & ((long long) 1 << ((mode_bitsize[(int) (op_mode)]) - 1)))
  val -= (long long) 1 << (mode_bitsize[(int) (op_mode)]);
     }
   else
     return 0;
   break;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 553, __FUNCTION__);
 }
    ...
    && (((enum rtx_code) (trueop)->code) == CONST_DOUBLE
        || ((enum rtx_code) (trueop)->code) == CONST_INT))
    {
      unsigned long long l1, lv;
      long long h1, hv;

      if (((enum rtx_code) (trueop)->code) == CONST_DOUBLE)
 l1 = (((trueop)->fld[0]).rtwint), h1 = (((trueop)->fld[1]).rtwint);
      else
 l1 = (((trueop)->fld[0]).rtwint), h1 = ((((long long) l1) < 0) ? ((long long) -1) : ((long long) 0));
 ...
 case FFS:
   hv = 0;
   if (l1 == 0)
     lv = (8 * 8) + exact_log2_wide ((unsigned long long) (h1 & (-h1))) + 1;
   else
     lv = exact_log2_wide ((unsigned long long) (l1 & (-l1))) + 1;
   break;
 ...
 case ZERO_EXTEND:
   if (op_mode == VOIDmode)
     fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 609, __FUNCTION__);

   if ((mode_bitsize[(int) (op_mode)]) > (8 * 8))
     return 0;

   hv = 0;
   lv = l1 & mode_mask_array[(int) (op_mode)];
   break;
 ...
 case SIGN_EXTEND:
   if (op_mode == VOIDmode
   ...
   else
     {
       ...
       if ((mode_bitsize[(int) (op_mode)]) < (8 * 8)
    && (lv & ((long long) 1
       << ((mode_bitsize[(int) (op_mode)]) - 1))) != 0)
  lv -= (long long) 1 << (mode_bitsize[(int) (op_mode)]);

       hv = ((((long long) lv) < 0) ? ((long long) -1) : ((long long) 0));
     }
   break;
 ...
 default:
   return 0;
    ...
    {
      struct real_value d;
      memcpy (&(d), &((((trueop))->fld[0]).rtwint), sizeof (struct real_value));
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 673, __FUNCTION__);
 }
      return const_double_from_real_value (d, mode);
    }

  else if (((enum rtx_code) (trueop)->code) == CONST_DOUBLE
    && (mode_class[(int) (((enum machine_mode) (trueop)->mode))]) == MODE_FLOAT
    ...
    && width <= (8 * 8) && width > 0)
    {
      ...
      switch (code)
 {
 case FIX: i = real_to_integer (&(d)); break;
 case UNSIGNED_FIX: i = real_to_integer (&(d)); break;
 default:
   fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 691, __FUNCTION__);
 }
 ...
 case NOT:
   ...
   if (mode == BImode && (rtx_class[(int) (((enum rtx_code) (op)->code))]) == '<'
       && ((reversed = reversed_comparison_code (op, (rtx) 0))
    != UNKNOWN))
     return gen_rtx_fmt_ee (reversed,
       op_mode, (((op)->fld[0]).rtx), (((op)->fld[1]).rtx));
   break;
 ...
 case SIGN_EXTEND:
   ...
   if (((enum rtx_code) (op)->code) == TRUNCATE
       && ((enum machine_mode) ((((op)->fld[0]).rtx))->mode) == mode
       && ((enum rtx_code) ((((op)->fld[0]).rtx))->code) == MINUS
       && ((enum rtx_code) (((((((op)->fld[0]).rtx))->fld[0]).rtx))->code) == LABEL_REF
       && ((enum rtx_code) (((((((op)->fld[0]).rtx))->fld[1]).rtx))->code) == LABEL_REF)
     return (((op)->fld[0]).rtx);
# 746 "../../../kgccfe/gnu/simplify-rtx.c"
   break;
# 761 "../../../kgccfe/gnu/simplify-rtx.c"
 default:
   break;
 }
...
simplify_binary_operation (code, mode, op0, op1)
     ...
     rtx op0, op1;
{
  long long arg0, arg1, arg0s, arg1s;
  long long val;
  unsigned int width = (mode_bitsize[(int) (mode)]);
  rtx tem;
  ...
  if ((rtx_class[(int) (code)]) == '<')
    fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 793, __FUNCTION__);
  ...
  if ((mode_class[(int) (mode)]) == MODE_FLOAT
    ...
    {
      struct real_value f0, f1, value;

      memcpy (&(f0), &((((trueop0))->fld[0]).rtwint), sizeof (struct real_value));
      memcpy (&(f1), &((((trueop1))->fld[0]).rtwint), sizeof (struct real_value));
      f0 = real_value_truncate (mode, f0);
      f1 = real_value_truncate (mode, f1);

      if (code == DIV
   && !(((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0)
 ...
 return 0;
  ...
  if ((mode_class[(int) (mode)]) == MODE_INT
   ...
   || ((enum rtx_code) (trueop1)->code) == CONST_INT))
    {
      unsigned long long l1, l2, lv;
      long long h1, h2, hv;

      if (((enum rtx_code) (trueop0)->code) == CONST_DOUBLE)
 l1 = (((trueop0)->fld[0]).rtwint), h1 = (((trueop0)->fld[1]).rtwint);
      else
 l1 = (((trueop0)->fld[0]).rtwint), h1 = ((((long long) l1) < 0) ? ((long long) -1) : ((long long) 0));

      if (((enum rtx_code) (trueop1)->code) == CONST_DOUBLE)
 l2 = (((trueop1)->fld[0]).rtwint), h2 = (((trueop1)->fld[1]).rtwint);
      else
 l2 = (((trueop1)->fld[0]).rtwint), h2 = ((((long long) l2) < 0) ? ((long long) -1) : ((long long) 0));
 ...
 case UMIN:
   if ((unsigned long long) h1 < (unsigned long long) h2
       || (h1 == h2
    && ((unsigned long long) l1
        < (unsigned long long) l2)))
     lv = l1, hv = h1;
 ...
 case ROTATE: case ROTATERT:
   ...
   if (1)
     l2 &= ((mode_bitsize[(int) (mode)]) - 1), h2 = 0;


   if (h2 != 0 || l2 >= (mode_bitsize[(int) (mode)]))
     return 0;

   if (code == LSHIFTRT || code == ASHIFTRT)
     rshift_double (l1, h1, l2, (mode_bitsize[(int) (mode)]), &lv, &hv,
      code == ASHIFTRT);
   else if (code == ASHIFT)
     lshift_double (l1, h1, l2, (mode_bitsize[(int) (mode)]), &lv, &hv, 1);
   else if (code == ROTATE)
     lrotate_double (l1, h1, l2, (mode_bitsize[(int) (mode)]), &lv, &hv);
   else
     rrotate_double (l1, h1, l2, (mode_bitsize[(int) (mode)]), &lv, &hv);
   break;
 ...
 case PLUS:
   ...
   if (!((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1) && !flag_unsafe_math_optimizations) && trueop1 == (const_tiny_rtx[0][(int) (mode)]))
     return op0;



   if (((enum rtx_code) (op0)->code) == NEG)
     return simplify_gen_binary (MINUS, mode, op1, (((op0)->fld[0]).rtx));
   else if (((enum rtx_code) (op1)->code) == NEG)
     return simplify_gen_binary (MINUS, mode, op0, (((op1)->fld[0]).rtx));


   if (((mode_class[(int) (mode)]) == MODE_INT || (mode_class[(int) (mode)]) == MODE_PARTIAL_INT || (mode_class[(int) (mode)]) == MODE_COMPLEX_INT || (mode_class[(int) (mode)]) == MODE_VECTOR_INT)
       && ((enum rtx_code) (op0)->code) == NOT
       && trueop1 == (const_int_rtx[64 +1]))
     return gen_rtx_fmt_e (NEG, (mode), ((((op0)->fld[0]).rtx)));
   ...
   if ((((enum rtx_code) (op0)->code) == LABEL_REF || ((enum rtx_code) (op0)->code) == SYMBOL_REF || ((enum rtx_code) (op0)->code) == CONST_INT || ((enum rtx_code) (op0)->code) == CONST_DOUBLE || ((enum rtx_code) (op0)->code) == CONST || ((enum rtx_code) (op0)->code) == HIGH || ((enum rtx_code) (op0)->code) == CONST_VECTOR || ((enum rtx_code) (op0)->code) == CONSTANT_P_RTX) && ((enum machine_mode) (op0)->mode) != VOIDmode
       && ((enum rtx_code) (op1)->code) == CONST_INT)
     return plus_constant_wide ((op0), (long long) ((((op1)->fld[0]).rtwint)));
   else if ((((enum rtx_code) (op1)->code) == LABEL_REF || ((enum rtx_code) (op1)->code) == SYMBOL_REF || ((enum rtx_code) (op1)->code) == CONST_INT || ((enum rtx_code) (op1)->code) == CONST_DOUBLE || ((enum rtx_code) (op1)->code) == CONST || ((enum rtx_code) (op1)->code) == HIGH || ((enum rtx_code) (op1)->code) == CONST_VECTOR || ((enum rtx_code) (op1)->code) == CONSTANT_P_RTX) && ((enum machine_mode) (op1)->mode) != VOIDmode
     && ((enum rtx_code) (op0)->code) == CONST_INT)
     return plus_constant_wide ((op1), (long long) ((((op0)->fld[0]).rtwint)));
   ...
   if (! ((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT))
     {
       long long coeff0 = 1, coeff1 = 1;
       rtx lhs = op0, rhs = op1;
       int had_mult = 0;

       if (((enum rtx_code) (lhs)->code) == NEG)
  coeff0 = -1, lhs = (((lhs)->fld[0]).rtx);
       else if (((enum rtx_code) (lhs)->code) == MULT
         && ((enum rtx_code) ((((lhs)->fld[1]).rtx))->code) == CONST_INT)
  {
    coeff0 = ((((((lhs)->fld[1]).rtx))->fld[0]).rtwint), lhs = (((lhs)->fld[0]).rtx);
    had_mult = 1;
  }
       else if (((enum rtx_code) (lhs)->code) == ASHIFT
         && ((enum rtx_code) ((((lhs)->fld[1]).rtx))->code) == CONST_INT
         && ((((((lhs)->fld[1]).rtx))->fld[0]).rtwint) >= 0
         && ((((((lhs)->fld[1]).rtx))->fld[0]).rtwint) < (8 * 8))
  {
    coeff0 = ((long long) 1) << ((((((lhs)->fld[1]).rtx))->fld[0]).rtwint);
    lhs = (((lhs)->fld[0]).rtx);
  }

       if (((enum rtx_code) (rhs)->code) == NEG)
  coeff1 = -1, rhs = (((rhs)->fld[0]).rtx);
       else if (((enum rtx_code) (rhs)->code) == MULT
         && ((enum rtx_code) ((((rhs)->fld[1]).rtx))->code) == CONST_INT)
  {
    coeff1 = ((((((rhs)->fld[1]).rtx))->fld[0]).rtwint), rhs = (((rhs)->fld[0]).rtx);
    had_mult = 1;
  }
       else if (((enum rtx_code) (rhs)->code) == ASHIFT
         && ((enum rtx_code) ((((rhs)->fld[1]).rtx))->code) == CONST_INT
         && ((((((rhs)->fld[1]).rtx))->fld[0]).rtwint) >= 0
         && ((((((rhs)->fld[1]).rtx))->fld[0]).rtwint) < (8 * 8))
  {
    coeff1 = ((long long) 1) << ((((((rhs)->fld[1]).rtx))->fld[0]).rtwint);
    rhs = (((rhs)->fld[0]).rtx);
  }
       ...
       if (rtx_equal_p (lhs, rhs))
  {
    tem = simplify_gen_binary (MULT, mode, lhs,
     gen_rtx_CONST_INT (VOIDmode, (long long) (coeff0 + coeff1)));
    return (((enum rtx_code) (tem)->code) == MULT && ! had_mult) ? 0 : tem;
  }
     }
   ...
   if (((mode_class[(int) (mode)]) == MODE_INT || (mode_class[(int) (mode)]) == MODE_PARTIAL_INT || (mode_class[(int) (mode)]) == MODE_COMPLEX_INT || (mode_class[(int) (mode)]) == MODE_VECTOR_INT)
    ...
    || (((enum rtx_code) (op1)->code) == CONST
        && ((enum rtx_code) ((((op1)->fld[0]).rtx))->code) == PLUS))
       && (tem = simplify_plus_minus (code, mode, op0, op1, 0)) != 0)
     return tem;
   break;

 case COMPARE:
# 1078 "../../../kgccfe/gnu/simplify-rtx.c"
   if (((((enum rtx_code) (op0)->code) == GT && ((enum rtx_code) (op1)->code) == LT)
        || (((enum rtx_code) (op0)->code) == GTU && ((enum rtx_code) (op1)->code) == LTU))
       && (((op0)->fld[1]).rtx) == (const_int_rtx[64]) && (((op1)->fld[1]).rtx) == (const_int_rtx[64]))
     {
       rtx xop00 = (((op0)->fld[0]).rtx);
       rtx xop10 = (((op1)->fld[0]).rtx);
    ...
    && (((xop00)->fld[0]).rtuint) == (((xop10)->fld[0]).rtuint)
    && (mode_class[(int) (((enum machine_mode) (xop00)->mode))]) == MODE_CC
    && (mode_class[(int) (((enum machine_mode) (xop10)->mode))]) == MODE_CC)
 ...
 case MINUS:
   ...
   if (!((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1) && !flag_unsafe_math_optimizations) && trueop0 == (const_tiny_rtx[0][(int) (mode)]))
     return gen_rtx_fmt_e (NEG, (mode), (op1));


   if (trueop0 == (const_int_rtx[64 -1]))
     return gen_rtx_fmt_e (NOT, (mode), (op1));




   if (!(((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1) && !flag_unsafe_math_optimizations)
       ...
       if (rtx_equal_p (lhs, rhs))
  {
   ...
   if (((enum rtx_code) (op1)->code) == NEG)
     return simplify_gen_binary (PLUS, mode, op0, (((op1)->fld[0]).rtx));
   ...
   if (((enum rtx_code) (op1)->code) == AND)
     {
      if (rtx_equal_p (op0, (((op1)->fld[0]).rtx)))
        return simplify_gen_binary (AND, mode, op0,
        gen_rtx_fmt_e (NOT, (mode), ((((op1)->fld[1]).rtx))));
      if (rtx_equal_p (op0, (((op1)->fld[1]).rtx)))
        return simplify_gen_binary (AND, mode, op0,
        gen_rtx_fmt_e (NOT, (mode), ((((op1)->fld[0]).rtx))));
    }
   break;
 ...
 case MULT:
   if (trueop1 == (const_int_rtx[64 -1]))
     {
       ...
       return tem ? tem : gen_rtx_fmt_e (NEG, (mode), (op0));
     }
   ...
   if (!((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)
   ...
   if (!(flag_signaling_nans && ((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
   ...
   if (((enum rtx_code) (trueop1)->code) == CONST_INT
       && (val = exact_log2_wide ((unsigned long long) ((((trueop1)->fld[0]).rtwint)))) >= 0
    ...
    || val != (8 * 8) - 1)
     ...
     return gen_rtx_fmt_ee (ASHIFT, (mode), (op0), (gen_rtx_CONST_INT (VOIDmode, (long long) (val))));


   if (((enum rtx_code) (trueop1)->code) == CONST_DOUBLE
       && (mode_class[(int) (((enum machine_mode) (trueop1)->mode))]) == MODE_FLOAT
       && ((enum machine_mode) (op0)->mode) == mode)
     {
       struct real_value d;
       memcpy (&(d), &((((trueop1))->fld[0]).rtwint), sizeof (struct real_value));

       if (real_compare (EQ_EXPR, &(d), &(dconst2)))
  return gen_rtx_fmt_ee (PLUS, (mode), (op0), (copy_rtx (op0)));

       if (real_compare (EQ_EXPR, &(d), &(dconstm1)))
  return gen_rtx_fmt_e (NEG, (mode), (op0));
     }
   break;
 ...
 case IOR:
   if (trueop1 == (const_int_rtx[64]))
     return op0;
   if (((enum rtx_code) (trueop1)->code) == CONST_INT
       && (((((trueop1)->fld[0]).rtwint) & mode_mask_array[(int) (mode)])
           == mode_mask_array[(int) (mode)]))
     return op1;
   if (rtx_equal_p (trueop0, trueop1) && ! side_effects_p (op0))
     return op0;

   if (((((enum rtx_code) (op0)->code) == NOT && rtx_equal_p ((((op0)->fld[0]).rtx), op1))
        || (((enum rtx_code) (op1)->code) == NOT && rtx_equal_p ((((op1)->fld[0]).rtx), op0)))
       && ! side_effects_p (op0)
 ...
 case XOR:
   ...
   if (((enum rtx_code) (trueop1)->code) == CONST_INT
       && (((((trueop1)->fld[0]).rtwint) & mode_mask_array[(int) (mode)])
    == mode_mask_array[(int) (mode)]))
     return gen_rtx_fmt_e (NOT, (mode), (op0));
 ...
 case UDIV:
   ...
   if (((enum rtx_code) (trueop1)->code) == CONST_INT
       && (arg1 = exact_log2_wide ((unsigned long long) ((((trueop1)->fld[0]).rtwint)))) > 0)
     return gen_rtx_fmt_ee (LSHIFTRT, (mode), (op0), (gen_rtx_CONST_INT (VOIDmode, (long long) (arg1))));
 ...
 case DIV:
   if (trueop1 == (const_tiny_rtx[1][(int) (mode)]))
     {
       ...
       if (x)
  return x;
       else if (mode != ((enum machine_mode) (op0)->mode) && ((enum machine_mode) (op0)->mode) != VOIDmode)
  ...
  return op0;
   ...
   if (!((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)
       && !((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1) && !flag_unsafe_math_optimizations)
       && trueop0 == (const_tiny_rtx[0][(int) (mode)])
       && ! side_effects_p (op1))
     return op0;



   else if (((enum rtx_code) (trueop1)->code) == CONST_DOUBLE
     && (mode_class[(int) (((enum machine_mode) (trueop1)->mode))]) == MODE_FLOAT
     && trueop1 != (const_tiny_rtx[0][(int) (mode)])
       ...
       if (! real_compare (EQ_EXPR, &(d), &(dconst0)))
  {
    ...
    return gen_rtx_fmt_ee (MULT, (mode), (op0), (const_double_from_real_value (d, mode)));
 ...
 case UMOD:
   ...
   if (((enum rtx_code) (trueop1)->code) == CONST_INT
       && exact_log2_wide ((unsigned long long) ((((trueop1)->fld[0]).rtwint))) > 0)
     return gen_rtx_fmt_ee (AND, (mode), (op0), (gen_rtx_CONST_INT (VOIDmode, (long long) ((((op1)->fld[0]).rtwint) - 1))));



 case MOD:
   if ((trueop0 == (const_int_rtx[64]) || trueop1 == (const_int_rtx[64 +1]))
 ...
 case ROTATE:
   ...
   if (((enum rtx_code) (trueop0)->code) == CONST_INT && width <= (8 * 8)
       && (unsigned long long) (((trueop0)->fld[0]).rtwint) == mode_mask_array[(int) (mode)]
       && ! side_effects_p (op1))
     return op0;
 ...
 case SMIN:
   if (width <= (8 * 8) && ((enum rtx_code) (trueop1)->code) == CONST_INT
       && (((trueop1)->fld[0]).rtwint) == (long long) 1 << (width -1)
       && ! side_effects_p (op0))
     return op1;
 ...
 case SMAX:
   if (width <= (8 * 8) && ((enum rtx_code) (trueop1)->code) == CONST_INT
       && ((unsigned long long) (((trueop1)->fld[0]).rtwint)
    == (unsigned long long) mode_mask_array[(int) (mode)] >> 1)
       && ! side_effects_p (op0))
     return op1;
   else if (rtx_equal_p (trueop0, trueop1) && ! side_effects_p (op0))
     return op0;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 1447, __FUNCTION__);
 }
  ...
  arg0 = (((trueop0)->fld[0]).rtwint);
  arg1 = (((trueop1)->fld[0]).rtwint);

  if (width < (8 * 8))
    {
      arg0 &= ((long long) 1 << width) - 1;
      arg1 &= ((long long) 1 << width) - 1;

      arg0s = arg0;
      if (arg0s & ((long long) 1 << (width - 1)))
 arg0s |= ((long long) (-1) << width);

      arg1s = arg1;
      if (arg1s & ((long long) 1 << (width - 1)))
 arg1s |= ((long long) (-1) << width);
    }
  else
    {
      arg0s = arg0;
 ...
 return 0;
   ...
   || (arg0s == (long long) 1 << ((8 * 8) - 1)
       && arg1s == -1))
 return 0;
      val = (unsigned long long) arg0 / arg1;
      break;
 ...
 return 0;
      ...
      arg1 %= width;
      val = ((((unsigned long long) arg0) << (width - arg1))
      | (((unsigned long long) arg0) >> arg1));
      break;
 ...
 return 0;
      ...
      arg1 %= width;
      val = ((((unsigned long long) arg0) << arg1)
      | (((unsigned long long) arg0) >> (width - arg1)));
      break;
    ...
    case UMIN:
      val = ((unsigned long long) arg0
      <= (unsigned long long) arg1 ? arg0 : arg1);
      break;
    ...
    default:
      fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 1623, __FUNCTION__);
    }
...
# 1643 "../../../kgccfe/gnu/simplify-rtx.c"
     ...
     int force;
{
      ...
      for (i = 0; i < n_ops; i++)
 {
  ...
  return (rtx) 0;
       ...
       ops[n_ops].op = (((this_op)->fld[1]).rtx);
       ops[n_ops].neg = (this_code == MINUS) ^ this_neg;
       n_ops++;

       ops[i].op = (((this_op)->fld[0]).rtx);
       input_ops++;
       changed = 1;
       break;
     ...
     case CONST:
       if (n_ops < 7
    && ((enum rtx_code) ((((this_op)->fld[0]).rtx))->code) == PLUS
    && (((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[0]).rtx))->code) == LABEL_REF || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[0]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[0]).rtx))->code) == CONST_INT || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[0]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[0]).rtx))->code) == CONST || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[0]).rtx))->code) == HIGH || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[0]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[0]).rtx))->code) == CONSTANT_P_RTX)
    && (((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[1]).rtx))->code) == LABEL_REF || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[1]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST_INT || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[1]).rtx))->code) == HIGH || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[1]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) (((((((this_op)->fld[0]).rtx))->fld[1]).rtx))->code) == CONSTANT_P_RTX))
  {
    ops[i].op = ((((((this_op)->fld[0]).rtx))->fld[0]).rtx);
    ops[n_ops].op = ((((((this_op)->fld[0]).rtx))->fld[1]).rtx);
 ...
 for (j = i + 1; j < n_ops; j++)
   {
     ...
     if (lhs != 0 && rhs != 0
  && (! first || ((((enum rtx_code) (lhs)->code) == LABEL_REF || ((enum rtx_code) (lhs)->code) == SYMBOL_REF || ((enum rtx_code) (lhs)->code) == CONST_INT || ((enum rtx_code) (lhs)->code) == CONST_DOUBLE || ((enum rtx_code) (lhs)->code) == CONST || ((enum rtx_code) (lhs)->code) == HIGH || ((enum rtx_code) (lhs)->code) == CONST_VECTOR || ((enum rtx_code) (lhs)->code) == CONSTANT_P_RTX) && (((enum rtx_code) (rhs)->code) == LABEL_REF || ((enum rtx_code) (rhs)->code) == SYMBOL_REF || ((enum rtx_code) (rhs)->code) == CONST_INT || ((enum rtx_code) (rhs)->code) == CONST_DOUBLE || ((enum rtx_code) (rhs)->code) == CONST || ((enum rtx_code) (rhs)->code) == HIGH || ((enum rtx_code) (rhs)->code) == CONST_VECTOR || ((enum rtx_code) (rhs)->code) == CONSTANT_P_RTX))))
       {
  ...
  if (tem
     ...
     && ((enum rtx_code) ((((tem)->fld[0]).rtx))->code) == ncode
     && ((((((tem)->fld[0]).rtx))->fld[0]).rtx) == lhs
     && ((((((tem)->fld[0]).rtx))->fld[1]).rtx) == rhs)
  ...
  if (n_ops > 1
      ...
      && (((enum rtx_code) (ops[n_ops - 2].op)->code) == LABEL_REF || ((enum rtx_code) (ops[n_ops - 2].op)->code) == SYMBOL_REF || ((enum rtx_code) (ops[n_ops - 2].op)->code) == CONST_INT || ((enum rtx_code) (ops[n_ops - 2].op)->code) == CONST_DOUBLE || ((enum rtx_code) (ops[n_ops - 2].op)->code) == CONST || ((enum rtx_code) (ops[n_ops - 2].op)->code) == HIGH || ((enum rtx_code) (ops[n_ops - 2].op)->code) == CONST_VECTOR || ((enum rtx_code) (ops[n_ops - 2].op)->code) == CONSTANT_P_RTX))
    {
      rtx value = ops[n_ops - 1].op;
      if (ops[n_ops - 1].neg ^ ops[n_ops - 2].neg)
 value = neg_const_int (mode, value);
      ops[n_ops - 2].op = plus_constant_wide ((ops[n_ops - 2].op), (long long) ((((value)->fld[0]).rtwint)));
      n_ops--;
    }
 ...
 ops[i].neg = 0;
  ...
  return negate ? gen_rtx_fmt_e (NEG, (mode), (result)) : result;
}
# 1911 "../../../kgccfe/gnu/simplify-rtx.c"
rtx
     ...
     rtx op0, op1;
{
  ...
  if (mode == VOIDmode
   ...
   || ((enum machine_mode) (op1)->mode) != VOIDmode))
    fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 1925, __FUNCTION__);
...
# 1961 "../../../kgccfe/gnu/simplify-rtx.c"
  if (((mode_class[(int) (mode)]) == MODE_INT || (mode_class[(int) (mode)]) == MODE_PARTIAL_INT || (mode_class[(int) (mode)]) == MODE_COMPLEX_INT || (mode_class[(int) (mode)]) == MODE_VECTOR_INT) && trueop1 != (const_int_rtx[64])
  ...
  if (!((((mode_class[(int) (((enum machine_mode) (trueop0)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (trueop0)->mode))]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (((enum machine_mode) (trueop0)->mode))]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)
    ...
    && ((enum rtx_code) (trueop1)->code) == CONST_DOUBLE
    && (mode_class[(int) (((enum machine_mode) (trueop0)->mode))]) == MODE_FLOAT)
    {
      struct real_value d0, d1;

      memcpy (&(d0), &((((trueop0))->fld[0]).rtwint), sizeof (struct real_value));
      memcpy (&(d1), &((((trueop1))->fld[0]).rtwint), sizeof (struct real_value));
 ...
 switch (code)
   ...
   default:
  ...
  else if (((mode_class[(int) (mode)]) == MODE_INT || mode == VOIDmode)
    && (((enum rtx_code) (trueop0)->code) == CONST_DOUBLE
        || ((enum rtx_code) (trueop0)->code) == CONST_INT)
    && (((enum rtx_code) (trueop1)->code) == CONST_DOUBLE
        || ((enum rtx_code) (trueop1)->code) == CONST_INT))
    {
      ...
      long long l0s, h0s, l1s, h1s;
      unsigned long long l0u, h0u, l1u, h1u;


      if (((enum rtx_code) (trueop0)->code) == CONST_DOUBLE)
 {
   l0u = l0s = (((trueop0)->fld[0]).rtwint);
   h0u = h0s = (((trueop0)->fld[1]).rtwint);
 }
      else
 {
   l0u = l0s = (((trueop0)->fld[0]).rtwint);
   h0u = h0s = ((((long long) l0s) < 0) ? ((long long) -1) : ((long long) 0));
 }

      if (((enum rtx_code) (trueop1)->code) == CONST_DOUBLE)
 {
   l1u = l1s = (((trueop1)->fld[0]).rtwint);
   h1u = h1s = (((trueop1)->fld[1]).rtwint);
 }
      else
 {
   l1u = l1s = (((trueop1)->fld[0]).rtwint);
   h1u = h1s = ((((long long) l1s) < 0) ? ((long long) -1) : ((long long) 0));
 }
 ...
 {
   l0u &= ((long long) 1 << width) - 1;
   l1u &= ((long long) 1 << width) - 1;

   if (l0s & ((long long) 1 << (width - 1)))
     l0s |= ((long long) (-1) << width);

   if (l1s & ((long long) 1 << (width - 1)))
     l1s |= ((long long) (-1) << width);
 }
      if (width != 0 && width <= (8 * 8))
 h0u = h1u = 0, h0s = ((((long long) l0s) < 0) ? ((long long) -1) : ((long long) 0)), h1s = ((((long long) l1s) < 0) ? ((long long) -1) : ((long long) 0));
 ...
 case EQ:
   ...
   if (((((op0) == (global_rtl[GR_FRAME_POINTER]) || (op0) == (global_rtl[GR_HARD_FRAME_POINTER]) || (op0) == (global_rtl[GR_VIRTUAL_STACK_ARGS]) || (op0) == (global_rtl[GR_VIRTUAL_INCOMING_ARGS]) || (((enum rtx_code) (op0)->code) == PLUS && ((enum rtx_code) ((((op0)->fld[1]).rtx))->code) == CONST_INT && ((((op0)->fld[0]).rtx) == (global_rtl[GR_FRAME_POINTER]) || (((op0)->fld[0]).rtx) == (global_rtl[GR_HARD_FRAME_POINTER]) || ((op0) == (global_rtl[GR_ARG_POINTER]) && fixed_regs[0]) || (((op0)->fld[0]).rtx) == (global_rtl[GR_VIRTUAL_STACK_ARGS]) || (((op0)->fld[0]).rtx) == (global_rtl[GR_VIRTUAL_INCOMING_ARGS]))) || (op0) == (global_rtl[GR_STACK_POINTER]) || (op0) == (global_rtl[GR_VIRTUAL_STACK_DYNAMIC]) || (op0) == (global_rtl[GR_VIRTUAL_OUTGOING_ARGS]) || (((enum rtx_code) (op0)->code) == PLUS && ((enum rtx_code) ((((op0)->fld[1]).rtx))->code) == CONST_INT && ((((op0)->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER]) || (((op0)->fld[0]).rtx) == (global_rtl[GR_VIRTUAL_STACK_DYNAMIC]) || (((op0)->fld[0]).rtx) == (global_rtl[GR_VIRTUAL_OUTGOING_ARGS]))) || ((enum rtx_code) (op0)->code) == ADDRESSOF) && trueop1 == (const_int_rtx[64]))
        || ((enum rtx_code) (trueop0)->code) == LABEL_REF)


       && op0 != (global_rtl[GR_ARG_POINTER])
 ...
 case LEU:
   ...
   if (((enum rtx_code) (trueop1)->code) == CONST_INT
       && (unsigned long long) (((trueop1)->fld[0]).rtwint) == mode_mask_array[(int) (mode)]
     && ((mode_class[(int) (mode)]) == MODE_INT || (mode_class[(int) (mode)]) == MODE_PARTIAL_INT || (mode_class[(int) (mode)]) == MODE_COMPLEX_INT || (mode_class[(int) (mode)]) == MODE_VECTOR_INT))
   return const_true_rtx;
   break;
 ...
 case LT:
   ...
   if (trueop1 == (const_tiny_rtx[0][(int) (mode)]) && !(flag_signaling_nans && ((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)))
     {
       tem = ((enum rtx_code) (trueop0)->code) == FLOAT_EXTEND ? (((trueop0)->fld[0]).rtx)
             : trueop0;
 ...
 case GE:
   ...
   if (trueop1 == (const_tiny_rtx[0][(int) (mode)]) && !((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only))
     {
       tem = ((enum rtx_code) (trueop0)->code) == FLOAT_EXTEND ? (((trueop0)->fld[0]).rtx)
             : trueop0;
       if (((enum rtx_code) (tem)->code) == ABS)
 ...
 default:
  ...
  switch (code)
    ...
    case UNORDERED:
      return (const_int_rtx[64]);
    default:
      fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2198, __FUNCTION__);
    }
}
     ...
     rtx op0, op1, op2;
{
  ...
  switch (code)
   ...
   && ((unsigned) (((op1)->fld[0]).rtwint) + (unsigned) (((op2)->fld[0]).rtwint) <= width)
   && width <= (unsigned) (8 * 8))
 {

   long long val = (((op0)->fld[0]).rtwint);

   if (0)
     val >>= ((mode_bitsize[(int) (op0_mode)])
       - (((op2)->fld[0]).rtwint) - (((op1)->fld[0]).rtwint));
   else
     val >>= (((op2)->fld[0]).rtwint);

   if ((8 * 8) != (((op1)->fld[0]).rtwint))
     {

       val &= ((long long) 1 << (((op1)->fld[0]).rtwint)) - 1;
 ...
 return op0 != (const_int_rtx[64]) ? op1 : op2;
      ...
      if (((enum rtx_code) (op0)->code) == NE && ! side_effects_p (op0)
   ...
   && rtx_equal_p ((((op0)->fld[1]).rtx), op2))
 return op1;
      else if (((enum rtx_code) (op0)->code) == EQ && ! side_effects_p (op0)
   && !((((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && 1 == 1 && !0) && !flag_finite_math_only)
   && rtx_equal_p ((((op0)->fld[1]).rtx), op1)
   && rtx_equal_p ((((op0)->fld[0]).rtx), op2))
 return op2;
      else if ((rtx_class[(int) (((enum rtx_code) (op0)->code))]) == '<' && ! side_effects_p (op0))
 {
   enum machine_mode cmp_mode = (((enum machine_mode) ((((op0)->fld[0]).rtx))->mode) == VOIDmode
     ? ((enum machine_mode) ((((op0)->fld[1]).rtx))->mode)
     : ((enum machine_mode) ((((op0)->fld[0]).rtx))->mode));
   rtx temp;
   if (cmp_mode == VOIDmode)
     cmp_mode = op0_mode;
   temp = simplify_relational_operation (((enum rtx_code) (op0)->code), cmp_mode,
             (((op0)->fld[0]).rtx), (((op0)->fld[1]).rtx));
   ...
   if (((enum rtx_code) (op1)->code) == CONST_INT && ((enum rtx_code) (op2)->code) == CONST_INT)
     {
       long long t = (((op1)->fld[0]).rtwint);
       long long f = (((op2)->fld[0]).rtwint);
  ...
  break;
       ...
       return gen_rtx_fmt_ee (code, mode, (((op0)->fld[0]).rtx), (((op0)->fld[1]).rtx));
     }
 }
      break;
    case VEC_MERGE:
   ...
   || !((mode_class[(int) (mode)]) == MODE_VECTOR_INT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT))
 fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2321, __FUNCTION__);
   ...
   && ((enum rtx_code) (op2)->code) == CONST_INT)
 {
   ...
   for (i = 0; i < n_elts; i++)
     ((v)->elem[i]) = ((((op2)->fld[0]).rtwint) & (1 << i)
    ? (((((op0)->fld[0]).rtvec))->elem[i])
    : (((((op1)->fld[0]).rtvec))->elem[i]));
   return gen_rtx_CONST_VECTOR (mode, v);
 }
      break;

    default:
      fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2343, __FUNCTION__);
    }
     ...
     enum machine_mode outermode, innermode;
{
  ...
  if (innermode == VOIDmode || outermode == VOIDmode
    ...
    fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2360, __FUNCTION__);

  if (((enum machine_mode) (op)->mode) != innermode
      && ((enum machine_mode) (op)->mode) != VOIDmode)
    fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2364, __FUNCTION__);

  if (byte % (mode_size[(int) (outermode)])
      || byte >= (mode_size[(int) (innermode)]))
    fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2368, __FUNCTION__);
  ...
  if (((enum rtx_code) (op)->code) == CONST_VECTOR)
    {
      int elt_size = (mode_size[(int) (inner_mode_array[(int) (innermode)])]);
      const unsigned int offset = byte / elt_size;
      rtx elt;

      if (inner_mode_array[(int) (innermode)] == outermode)
 {
   elt = (((((op)->fld[0]).rtvec))->elem[offset]);
   ...
   return copy_rtx (elt);
      ...
      else if (inner_mode_array[(int) (innermode)] == inner_mode_array[(int) (outermode)]
        && (mode_size[(int) (innermode)]) > (mode_size[(int) (outermode)]))
 {
   return (gen_rtx_CONST_VECTOR
    (outermode,
     gen_rtvec_v ((((mode_unit_size[(int) ((outermode))]) == 0) ? 0 : ((mode_size[(int) ((outermode))]) / (mode_unit_size[(int) ((outermode))]))),
    &(((((op)->fld[0]).rtvec))->elem[offset]))));
 }
      else if ((mode_class[(int) (outermode)]) == MODE_INT
        && ((mode_size[(int) (outermode)]) % elt_size == 0))
 {



   long long sum = 0, high = 0;
   unsigned n_elts = ((mode_size[(int) (outermode)]) / elt_size);
   unsigned i = ((target_flags & 0x00010000) != 0) ? offset : offset + n_elts - 1;
   unsigned step = ((target_flags & 0x00010000) != 0) ? 1 : -1;
   int shift = 8 * elt_size;

   for (; n_elts--; i += step)
     {
       elt = (((((op)->fld[0]).rtvec))->elem[i]);
       if (((enum rtx_code) (elt)->code) == CONST_DOUBLE
    && (mode_class[(int) (((enum machine_mode) (elt)->mode))]) == MODE_FLOAT)
  {
    elt = gen_lowpart_common (int_mode_for_mode (((enum machine_mode) (elt)->mode)),
         elt);
    if (! elt)
      return (rtx) 0;
  }
  ...
  return (rtx) 0;
       ...
       if (high >> ((8 * 8) - shift))
  return (rtx) 0;
       high = high << shift | sum >> ((8 * 8) - shift);
       sum = (sum << shift) + (((elt)->fld[0]).rtwint);
     }
   if ((mode_bitsize[(int) (outermode)]) <= (8 * 8))
     return gen_rtx_CONST_INT (VOIDmode, (long long) (trunc_int_for_mode (sum, outermode)));
   else if ((mode_bitsize[(int) (outermode)]) == 2* (8 * 8))
     return immed_double_const (sum, high, outermode);
   else
     return (rtx) 0;
 }
      else if ((mode_class[(int) (outermode)]) == MODE_INT
        && (elt_size % (mode_size[(int) (outermode)]) == 0))
 {
   enum machine_mode new_mode
     = int_mode_for_mode (inner_mode_array[(int) (innermode)]);
  ...
  if ((((enum rtx_code) (op)->code) == LABEL_REF || ((enum rtx_code) (op)->code) == SYMBOL_REF || ((enum rtx_code) (op)->code) == CONST_INT || ((enum rtx_code) (op)->code) == CONST_DOUBLE || ((enum rtx_code) (op)->code) == CONST || ((enum rtx_code) (op)->code) == HIGH || ((enum rtx_code) (op)->code) == CONST_VECTOR || ((enum rtx_code) (op)->code) == CONSTANT_P_RTX))
    {
      ...
      if ((mode_class[(int) (outermode)]) == MODE_VECTOR_INT
   || (mode_class[(int) (outermode)]) == MODE_VECTOR_FLOAT)
 {

   enum machine_mode submode = inner_mode_array[(int) (outermode)];
   int subsize = (mode_unit_size[(int) (outermode)]);
   int i, elts = (((mode_unit_size[(int) ((outermode))]) == 0) ? 0 : ((mode_size[(int) ((outermode))]) / (mode_unit_size[(int) ((outermode))])));
   ...
   for (i = 0; i < elts; i++, byte += subsize)
     {
       ...
       if (byte >= (mode_unit_size[(int) (innermode)]))
  elt = (const_tiny_rtx[0][(int) (submode)]);
       else
   ...
   && ((enum rtx_code) (op)->code) != CONST_VECTOR)
 {
   ...
   if (new)
     return new;
      ...
      if ((mode_size[(int) (outermode)]) == ((target_flags & 0x00002000) ? 8 : 4)
   && (mode_size[(int) (innermode)]) > ((target_flags & 0x00002000) ? 8 : 4)
   && (mode_class[(int) (outermode)]) == MODE_INT)
 {
   rtx new = constant_subword (op,
          (byte / ((target_flags & 0x00002000) ? 8 : 4)),
          innermode);
   if (new)
     return new;
 }

      if ((mode_class[(int) (outermode)]) != MODE_INT
   && (mode_class[(int) (outermode)]) != MODE_CC)
 {
 ...
 {
 case CONST_DOUBLE:
   if (((enum machine_mode) (op)->mode) != VOIDmode)
     break;
   ...
   if (((8 * ((target_flags & 0x00002000) ? 8 : 4)) > (8 * 8)
    ...
    && ((target_flags & 0x00010000) != 0)))
     part = !part;
   val = part ? (((op)->fld[1]).rtwint) : (((op)->fld[0]).rtwint);
   offset %= (8 * 8);



   innermode = mode_for_size ((8 * 8), MODE_INT, 0);
 ...
 case CONST_INT:
  ...
  offset = ((mode_bitsize[(int) (innermode)])
     - (mode_bitsize[(int) (outermode)]) - offset);
       if (((target_flags & 0x00010000) != 0) != ((target_flags & 0x00010000) != 0)
    && (mode_size[(int) (outermode)]) < ((target_flags & 0x00002000) ? 8 : 4))
  offset = (offset + (8 * ((target_flags & 0x00002000) ? 8 : 4)) - (mode_bitsize[(int) (outermode)])
     - 2 * (offset % (8 * ((target_flags & 0x00002000) ? 8 : 4))));
     }

   if (offset >= (8 * 8))
     return ((long long) val < 0) ? (const_int_rtx[64 -1]) : (const_int_rtx[64]);
   else
     {
       val >>= offset;
       if ((mode_bitsize[(int) (outermode)]) < (8 * 8))
 ...
 default:
  ...
  if (((enum rtx_code) (op)->code) == SUBREG)
    {
      enum machine_mode innermostmode = ((enum machine_mode) ((((op)->fld[0]).rtx))->mode);
      int final_offset = byte + (((op)->fld[1]).rtuint);
      rtx new;

      if (outermode == innermostmode
   && byte == 0 && (((op)->fld[1]).rtuint) == 0)
 return (((op)->fld[0]).rtx);
      ...
      if (byte == 0 && (mode_size[(int) (innermode)]) < (mode_size[(int) (outermode)]))
 {
   int difference = ((mode_size[(int) (innermode)]) - (mode_size[(int) (outermode)]));
   if (((target_flags & 0x00010000) != 0))
     final_offset += (difference / ((target_flags & 0x00002000) ? 8 : 4)) * ((target_flags & 0x00002000) ? 8 : 4);
   if (((target_flags & 0x00010000) != 0))
     final_offset += difference % ((target_flags & 0x00002000) ? 8 : 4);
 }
      if ((((op)->fld[1]).rtuint) == 0
   && (mode_size[(int) (innermostmode)]) < (mode_size[(int) (innermode)]))
 {
   int difference = ((mode_size[(int) (innermostmode)]) - (mode_size[(int) (innermode)]));
   if (((target_flags & 0x00010000) != 0))
     final_offset += (difference / ((target_flags & 0x00002000) ? 8 : 4)) * ((target_flags & 0x00002000) ? 8 : 4);
   if (((target_flags & 0x00010000) != 0))
     final_offset += difference % ((target_flags & 0x00002000) ? 8 : 4);
      ...
      if ((mode_size[(int) (innermostmode)]) > (mode_size[(int) (outermode)]))
 {

   if (final_offset < 0)
     return (rtx) 0;

   if (final_offset % (mode_size[(int) (outermode)])
       || (unsigned) final_offset >= (mode_size[(int) (innermostmode)]))
     return (rtx) 0;
 }
      else
 {
   int offset = 0;
   int difference = ((mode_size[(int) (innermostmode)]) - (mode_size[(int) (outermode)]));
   ...
   if (offset == final_offset)
     ...
     return (rtx) 0;
      ...
      new = simplify_subreg (outermode, (((op)->fld[0]).rtx),
        ((enum machine_mode) ((((op)->fld[0]).rtx))->mode),
        final_offset);
      if (new)
 return new;
      return gen_rtx_SUBREG (outermode, (((op)->fld[0]).rtx), final_offset);
    }
  ...
  if ((((enum rtx_code) (op)->code) == REG)
   ...
   || ! rtx_equal_function_value_matters)
      ...
      && ! (mips_cannot_change_mode_class (innermode, outermode, mips_regno_to_class[ ((((op)->fld[0]).rtuint)) ])
     && (mode_class[(int) (innermode)]) != MODE_COMPLEX_INT
     && (mode_class[(int) (innermode)]) != MODE_COMPLEX_FLOAT)

      && ((reload_completed && !frame_pointer_needed)
   || ((((op)->fld[0]).rtuint) != (0 + 1)

       && (((op)->fld[0]).rtuint) != ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)

      ))

      && (((op)->fld[0]).rtuint) != 0

      && (((op)->fld[0]).rtuint) != (0 + 29))
    {
      ...
      if (mips_hard_regno_mode_ok[ (int)(outermode) ][ (final_regno) ]
   || ! mips_hard_regno_mode_ok[ (int)(innermode) ][ ((((op)->fld[0]).rtuint)) ])
 {
   ...
   if (subreg_lowpart_offset (outermode, innermode) == byte)
     (((x)->fld[1]).rtuint) = (((op)->fld[1]).rtuint);
   return x;
 }
    }
  ...
  if (((enum rtx_code) (op)->code) == MEM
   ...
   || ! have_insn_for (SET, innermode))
      && (mode_size[(int) (outermode)]) <= (mode_size[(int) (((enum machine_mode) (op)->mode))]))
  ...
  if (((enum rtx_code) (op)->code) == CONCAT)
    {
      int is_realpart = byte < (mode_unit_size[(int) (innermode)]);
      rtx part = is_realpart ? (((op)->fld[0]).rtx) : (((op)->fld[1]).rtx);
      unsigned int final_offset;
      rtx res;

      final_offset = byte % ((mode_unit_size[(int) (innermode)]));
     ...
     enum machine_mode outermode, innermode;
{
  ...
  if (innermode == VOIDmode || outermode == VOIDmode
      || innermode == BLKmode || outermode == BLKmode)
    fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2744, __FUNCTION__);

  if (((enum machine_mode) (op)->mode) != innermode
      && ((enum machine_mode) (op)->mode) != VOIDmode)
    fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2748, __FUNCTION__);

  if (byte % (mode_size[(int) (outermode)])
      || byte >= (mode_size[(int) (innermode)]))
    fancy_abort ("../../../kgccfe/gnu/simplify-rtx.c", 2752, __FUNCTION__);
...
# 2806 "../../../kgccfe/gnu/simplify-rtx.c"
rtx
simplify_rtx (x)
     rtx x;
{
  ...
  switch ((rtx_class[(int) (code)]))
    ...
    case '1':
      return simplify_unary_operation (code, mode,
           (((x)->fld[0]).rtx), ((enum machine_mode) ((((x)->fld[0]).rtx))->mode));
    case 'c':
      if (swap_commutative_operands_p ((((x)->fld[0]).rtx), (((x)->fld[1]).rtx)))
 {
   rtx tem;
   ...
   return simplify_binary_operation (code, mode,
    ...
    case '2':
      return simplify_binary_operation (code, mode, (((x)->fld[0]).rtx), (((x)->fld[1]).rtx));

    case '3':
    case 'b':
      return simplify_ternary_operation (code, mode, ((enum machine_mode) ((((x)->fld[0]).rtx))->mode),
      (((x)->fld[0]).rtx), (((x)->fld[1]).rtx),
      (((x)->fld[2]).rtx));
    ...
    case 'x':
      ...
      if (code == SUBREG)
 return simplify_gen_subreg (mode, (((x)->fld[0]).rtx),
        ((enum machine_mode) ((((x)->fld[0]).rtx))->mode),
        (((x)->fld[1]).rtuint));
      return ((void *)0);
    default:
