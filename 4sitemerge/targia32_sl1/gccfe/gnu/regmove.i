...
# 32 "../../../kgccfe/gnu/regmove.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 33 "../../../kgccfe/gnu/regmove.c" 2
...
# 44 "../../../kgccfe/gnu/regmove.c" 2
# 54 "../../../kgccfe/gnu/regmove.c"
...
static int try_auto_increment (rtx, rtx, rtx, rtx, long long, int);
     ...
     int class0, class1;
{
  return (class0 == class1
   || (reg_class_subset_p (class0, class1)
       && ! (reg_class_size[(int) (class0)] == 1))
   || (reg_class_subset_p (class1, class0)
       && ! (reg_class_size[(int) (class1)] == 1)));
}
     ...
     int pre;
{
  ...
  rtx pset = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0);
  if (pset)
    {
 ...
 {
   int size = (mode_size[(int) (((enum machine_mode) (use)->mode))]);
   if (0
       || (0
  ...
  validate_change
    (inc_insn,
     &(((inc_insn_set)->fld[1]).rtx),
     ((((((inc_insn_set)->fld[1]).rtx))->fld[0]).rtx), 1);
       validate_change (insn, &(((use)->fld[0]).rtx),
          gen_rtx_fmt_e (inc_code, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), reg), 1);
       if (apply_change_group ())
  {
    ...
    (((insn)->fld[8]).rtx)
      = gen_rtx_fmt_ee (EXPR_LIST, (REG_INC), (reg), ((((insn)->fld[8]).rtx)));
...
# 167 "../../../kgccfe/gnu/regmove.c"
static rtx
discover_flags_reg ()
{
  rtx tmp;
  tmp = gen_rtx_REG (word_mode, 10000);
  tmp = gen_add3_insn (tmp, tmp, gen_rtx_CONST_INT (VOIDmode, (long long) (2)));
  ...
  if (((enum rtx_code) (tmp)->code) == SET)
  ...
  else if (((enum rtx_code) (tmp)->code) == PARALLEL)
    {
      ...
      if ((((((tmp)->fld[0]).rtvec))->num_elem) != 2)
 return (global_rtl[GR_PC]);
      tmp = (((((tmp)->fld[0]).rtvec))->elem[1]);
 ...
 return (global_rtl[GR_PC]);
   ...
   && ((enum rtx_code) ((((tmp)->fld[0]).rtx))->code) == REG
   && ((((((tmp)->fld[0]).rtx))->fld[0]).rtuint) < 176)
 return (global_rtl[GR_PC]);
      found = (((enum rtx_code) (tmp)->code) == REG && (((tmp)->fld[0]).rtuint) < 176);
...
# 238 "../../../kgccfe/gnu/regmove.c"
 ...
 ((insn)->mode = (enum machine_mode) (mode));
      return;
    }
  ...
  flags_regno = (((flags)->fld[0]).rtuint);
  flags_nregs = mips_hard_regno_nregs (flags_regno, ((enum machine_mode) (flags)->mode));

  flags_set_1_rtx = flags;


  for (block = (&entry_exit_blocks[1])->prev_bb; block != (&entry_exit_blocks[0]); block = block->prev_bb)
    {
      rtx insn, end;
      int live;
      ...
      while (1)
 {
  ...
  live = 0;
       ...
       ((insn)->mode = (enum machine_mode) ((live ? HImode : VOIDmode)));



       flags_set_1_set = 0;
       note_stores ((((insn)->fld[5]).rtx), flags_set_1, ((void *)0));
       if (flags_set_1_set)
  {
    live = 1;
    ((insn)->mode = (enum machine_mode) (QImode));
  }
     }
   else
     ((insn)->mode = (enum machine_mode) ((live ? HImode : VOIDmode)));
     ...
     rtx reg;
{
  ...
  if ((((reg_n_info)->data.reg[(((reg)->fld[0]).rtuint)])->live_length) < 0)
    return 0;

  src_regno = regno_src_regno[(((reg)->fld[0]).rtuint)];
     ...
     rtx src;
{
  ...
  rtx note;
  rtx dest_death = 0;
  int sregno = (((src)->fld[0]).rtuint);
  int dregno = (((dest)->fld[0]).rtuint);
  ...
  if (sregno == dregno
   ...
   && (sregno < 176
      ...
      || sregno == (0 + 29) || dregno == (0 + 29))
    return 0;

  for (p = (((insn)->fld[2]).rtx); p; p = (((p)->fld[2]).rtx))
    {


      if (perhaps_ends_bb_p (p))
 break;
      else if (! ((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i'))
 continue;
   ...
   || (sregno < 176
       && asm_noperands ((((p)->fld[5]).rtx)) >= 0
       && reg_overlap_mentioned_p (src, (((p)->fld[5]).rtx)))

   || (((enum rtx_code) ((((p)->fld[5]).rtx))->code) == USE
       && reg_overlap_mentioned_p (src, ((((((p)->fld[5]).rtx))->fld[0]).rtx))))
 break;



      if ((note = find_regno_note (p, REG_DEAD, sregno)) != 0
   && ((enum machine_mode) ((((note)->fld[0]).rtx))->mode) == ((enum machine_mode) (src)->mode))
 {
   int failed = 0;
   int d_length = 0;
   int s_length = 0;
   ...
   for (q = next_real_insn (insn);
        ...
        q = next_real_insn (q))
     {
       if (reg_overlap_mentioned_p (src, (((q)->fld[5]).rtx)))
  {
    ...
    if (sregno < 176
        && reg_mentioned_p (dest, (((q)->fld[5]).rtx)))
      failed = 1;
  ...
  {
    if (((enum machine_mode) ((((dest_death)->fld[0]).rtx))->mode) != ((enum machine_mode) (dest)->mode))
       ...
       if (sregno >= 176)
  {
   ...
   if (! dest_death
     ...
     {
       ((dest_death)->mode = (enum machine_mode) ((enum machine_mode) (REG_DEAD)));
   ...
   if (dest_death)
     {
       (((dest_death)->fld[1]).rtx) = (((p)->fld[8]).rtx);
       (((p)->fld[8]).rtx) = dest_death;
     ...
     rtx src;
{
 ...
 continue;
      ...
      if (set && (((set)->fld[1]).rtx) == dest && (((set)->fld[0]).rtx) == src
   && find_reg_note (p, REG_DEAD, dest))
 {
   ...
   for (q = insn; q != (((p)->fld[2]).rtx); q = (((q)->fld[2]).rtx))
     if (((rtx_class[(int) (((enum rtx_code) (q)->code))]) == 'i'))
       {
  if (reg_mentioned_p (dest, (((q)->fld[5]).rtx)))
    (((q)->fld[5]).rtx) = replace_rtx ((((q)->fld[5]).rtx), dest, src);
...
optimize_reg_copy_3 (insn, dest, src)
     ...
     rtx src;
{
  rtx src_reg = (((src)->fld[0]).rtx);
  int src_no = (((src_reg)->fld[0]).rtuint);
  int dst_no = (((dest)->fld[0]).rtuint);
  rtx p, set, subreg;
  ...
  if (src_no < 176
    ...
    return;
  for (p = (((insn)->fld[1]).rtx); p && ! reg_set_p (src_reg, p); p = (((p)->fld[1]).rtx))
  ...
  if (! (set = (((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i') ? (((enum rtx_code) ((((p)->fld[5]).rtx))->code) == SET ? (((p)->fld[5]).rtx) : single_set_2 (p, (((p)->fld[5]).rtx))) : (rtx) 0))
      || ((enum rtx_code) ((((set)->fld[1]).rtx))->code) != MEM


      || find_reg_note (p, REG_EQUIV, (rtx) 0)
      || (((set)->fld[0]).rtx) != src_reg)
    return;



  if (((((((set)->fld[1]).rtx)))->volatil))
    return;



  if ((mode_bitsize[(int) (((enum machine_mode) (src_reg)->mode))]) <= (mode_bitsize[(int) (((enum machine_mode) (src)->mode))])
      && !((target_flags & 0x00002000) ? (((mode_bitsize[(int) (((enum machine_mode) (src_reg)->mode))])) <= 32 || ((mode_bitsize[(int) (((enum machine_mode) (src)->mode))])) > 32) : 1))

    return;

  old_mode = ((enum machine_mode) (src_reg)->mode);
  ((src_reg)->mode = (enum machine_mode) (((enum machine_mode) (src)->mode)));
  (((src)->fld[0]).rtx) = (((set)->fld[1]).rtx);



  validate_change (p, &(((set)->fld[1]).rtx), src, 1);



  subreg = gen_lowpart_SUBREG (old_mode, src_reg);
  while (p = (((p)->fld[2]).rtx), p != insn)
    {
  ...
  if (! apply_change_group ())
    {
      ...
      ((src_reg)->mode = (enum machine_mode) (old_mode));
      (((src)->fld[0]).rtx) = src_reg;
    }
  else
    {
     ...
     int old_max_uid;
{
  ...
  if (((enum rtx_code) (src)->code) == REG
      && (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->live_length) > 0
      && ((enum rtx_code) (dest)->code) == REG
      && !(((dest))->unchanging)
      && (((reg_n_info)->data.reg[(((dest)->fld[0]).rtuint)])->live_length) > 0
      && (set = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0)) != (rtx) 0
      && !reg_mentioned_p (dest, (((set)->fld[1]).rtx))
   ...
   || ! validate_replace_rtx (src, dest, insn))
 {
   ...
   return;
      ...
      move_insn = (((insn)->fld[1]).rtx);
      p_move_notes = &(((move_insn)->fld[8]).rtx);
      p_insn_notes = &(((insn)->fld[8]).rtx);


      for (link = (((insn)->fld[8]).rtx); link != (rtx) 0; link = next)
 {
   next = (((link)->fld[1]).rtx);
   if ((((link)->fld[0]).rtx) == src)
     {
       *p_move_notes = link;
       p_move_notes = &(((link)->fld[1]).rtx);
     }
   else
     {
       *p_insn_notes = link;
       p_insn_notes = &(((link)->fld[1]).rtx);
     }
 }
      ...
      *p_insn_notes = (rtx) 0;
      ...
      insn_uid = (((insn)->fld[0]).rtint);
      move_uid = (((move_insn)->fld[0]).rtint);
      if (insn_uid < old_max_uid)
 {
   bb = regmove_bb_head[insn_uid];
   if (bb >= 0)
     {
       ((((basic_block_info)->data.bb[(bb)]))->head) = move_insn;
     ...
     rtx first;
{
  ...
  if ((((reg_n_info)->data.reg[(((reg)->fld[0]).rtuint)])->sets) != 1)
    return 0;


  for (p = (((insn)->fld[7]).rtx); p; p = (((p)->fld[1]).rtx))
    {
      rtx s;

      if (((enum reg_note) ((enum machine_mode) (p)->mode)) != 0)
 continue;
      s = (((rtx_class[(int) (((enum rtx_code) ((((p)->fld[0]).rtx))->code))]) == 'i') ? (((enum rtx_code) (((((((p)->fld[0]).rtx))->fld[5]).rtx))->code) == SET ? ((((((p)->fld[0]).rtx))->fld[5]).rtx) : single_set_2 ((((p)->fld[0]).rtx), ((((((p)->fld[0]).rtx))->fld[5]).rtx))) : (rtx) 0);
      if (s != 0
   && ((enum rtx_code) ((((s)->fld[0]).rtx))->code) == REG
   && ((((((s)->fld[0]).rtx))->fld[0]).rtuint) == (((reg)->fld[0]).rtuint))
 {
  ...
  for (p = first; p && p != insn; p = (((p)->fld[2]).rtx))
    {
      rtx s;

      if (! ((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i'))
 continue;
      s = (((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i') ? (((enum rtx_code) ((((p)->fld[5]).rtx))->code) == SET ? (((p)->fld[5]).rtx) : single_set_2 (p, (((p)->fld[5]).rtx))) : (rtx) 0);
      if (s != 0
   && ((enum rtx_code) ((((s)->fld[0]).rtx))->code) == REG
   && ((((((s)->fld[0]).rtx))->fld[0]).rtuint) == (((reg)->fld[0]).rtuint))
 {
     ...
     FILE *regmove_dump_file;
{
  ...
  if (find_regno_note (insn, REG_DEAD, (((src)->fld[0]).rtuint)))
    return 0;



  for (length = 0, p = (((insn)->fld[1]).rtx); p; p = (((p)->fld[1]).rtx))
    {
      rtx pset;
 ...
 continue;
      ...
      if (find_regno_note (p, REG_DEAD, (((dst)->fld[0]).rtuint)))
 dst_death = p;
      if (! dst_death)
 length++;

      pset = (((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i') ? (((enum rtx_code) ((((p)->fld[5]).rtx))->code) == SET ? (((p)->fld[5]).rtx) : single_set_2 (p, (((p)->fld[5]).rtx))) : (rtx) 0);
      if (pset && (((pset)->fld[0]).rtx) == dst
   && ((enum rtx_code) ((((pset)->fld[1]).rtx))->code) == PLUS
   && ((((((pset)->fld[1]).rtx))->fld[0]).rtx) == src
   && ((enum rtx_code) (((((((pset)->fld[1]).rtx))->fld[1]).rtx))->code) == CONST_INT)
 {
   long long newconst
     = (((offset)->fld[0]).rtwint) - (((((((((pset)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtwint);
   rtx add = gen_add3_insn (dst, dst, gen_rtx_CONST_INT (VOIDmode, (long long) (newconst)));

   if (add && validate_change (insn, &(((insn)->fld[5]).rtx), add, 0))
     {

       if (dst_death)
  {
    remove_death ((((dst)->fld[0]).rtuint), dst_death);
    (((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->live_length) += length;
    (((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->calls_crossed) += num_calls;
  }
  ...
  fprintf (regmove_dump_file,
    "Fixed operand of insn %d.\n",
     (((insn)->fld[0]).rtint));
# 1025 "../../../kgccfe/gnu/regmove.c"
       return 1;
     }
 }

      if (reg_set_p (dst, (((p)->fld[5]).rtx)))
 break;
      ...
      if (((enum rtx_code) (p)->code) == CALL_INSN)
 {
   ...
   if ((((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->calls_crossed) == 0)
     break;

   if (call_used_regs [(((dst)->fld[0]).rtuint)]
       || find_reg_fusage (p, CLOBBER, dst))
     break;
 }
      else if (reg_set_p (src, (((p)->fld[5]).rtx)))
 break;
    }
     ...
     FILE *regmove_dump_file;
{
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    regmove_bb_head[(((bb->head)->fld[0]).rtint)] = bb->index;
 ...
 fprintf (regmove_dump_file, "Starting %s pass...\n",
   pass ? "backward" : "forward");
    ...
    insn = pass ? (((insn)->fld[1]).rtx) : (((insn)->fld[2]).rtx))
 {
   rtx set;
   int op_no, match_no;
   ...
   if (flag_expensive_optimizations && ! pass
       && (((enum rtx_code) ((((set)->fld[1]).rtx))->code) == SIGN_EXTEND
    || ((enum rtx_code) ((((set)->fld[1]).rtx))->code) == ZERO_EXTEND)
       && ((enum rtx_code) (((((((set)->fld[1]).rtx))->fld[0]).rtx))->code) == REG
       && ((enum rtx_code) ((((set)->fld[0]).rtx))->code) == REG)
     optimize_reg_copy_3 (insn, (((set)->fld[0]).rtx), (((set)->fld[1]).rtx));
   ...
   if (flag_expensive_optimizations && ! pass
       ...
       && ((enum rtx_code) ((((set)->fld[0]).rtx))->code) == REG)
     {
       ...
       if ((find_reg_note (insn, REG_DEAD, (((set)->fld[1]).rtx))
     || optimize_reg_copy_1 (insn, (((set)->fld[0]).rtx), (((set)->fld[1]).rtx)))
    && ((((((set)->fld[0]).rtx))->fld[0]).rtuint) >= 176)
  {

    if (((((((set)->fld[1]).rtx))->fld[0]).rtuint) >= 176)
      optimize_reg_copy_2 (insn, (((set)->fld[0]).rtx), (((set)->fld[1]).rtx));
    if (regno_src_regno[((((((set)->fld[0]).rtx))->fld[0]).rtuint)] < 0
        && (((set)->fld[1]).rtx) != (((set)->fld[0]).rtx))
      {
        int srcregno = ((((((set)->fld[1]).rtx))->fld[0]).rtuint);
        if (regno_src_regno[srcregno] >= 0)
   srcregno = regno_src_regno[srcregno];
        regno_src_regno[((((((set)->fld[0]).rtx))->fld[0]).rtuint)] = srcregno;
      }
  }
     }
   if (! flag_regmove)
...
# 1159 "../../../kgccfe/gnu/regmove.c"
  ...
  continue;
    ...
    && (mode_size[(int) (((enum machine_mode) (dst)->mode))])
       >= (mode_size[(int) (((enum machine_mode) ((((dst)->fld[0]).rtx))->mode))]))
  {
    src_subreg
      = gen_rtx_SUBREG (((enum machine_mode) ((((dst)->fld[0]).rtx))->mode),
          src, (((dst)->fld[1]).rtuint));
    dst = (((dst)->fld[0]).rtx);
  }
       if (((enum rtx_code) (dst)->code) != REG
    || (((dst)->fld[0]).rtuint) < 176)
  continue;

       if ((((src)->fld[0]).rtuint) < 176)
  {
    if (match.commutative[op_no] < op_no)
      regno_src_regno[(((dst)->fld[0]).rtuint)] = (((src)->fld[0]).rtuint);
    continue;
  }

       if ((((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->live_length) < 0)
  continue;
  ...
  continue;
    ...
    && count_occurrences ((((insn)->fld[5]).rtx), src, 0) > 1)
  continue;


       if (recog_data.operand[match_no] != (((set)->fld[0]).rtx))
  continue;
    ...
    if (operands_match_p (comm, dst)
     ...
     >= replacement_quality (src)))
      continue;
       ...
       src_class = reg_preferred_class ((((src)->fld[0]).rtuint));
       dst_class = reg_preferred_class ((((dst)->fld[0]).rtuint));
      ...
      if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i'))
 {
  ...
  continue;
       ...
       if (((enum rtx_code) (dst)->code) != REG
    || (((dst)->fld[0]).rtuint) < 176
    || (((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->live_length) < 0
    || (((dst))->unchanging))
  continue;
       ...
       if ((((src)->fld[0]).rtuint) < 176)
  {
    if (((enum rtx_code) ((((set)->fld[1]).rtx))->code) == PLUS
        ...
        && ((((((set)->fld[1]).rtx))->fld[0]).rtx) == src
        && fixup_match_2 (insn, dst, src,
     ((((((set)->fld[1]).rtx))->fld[1]).rtx),
     regmove_dump_file))
      break;
    continue;
  }
...
# 1355 "../../../kgccfe/gnu/regmove.c"
       ...
       if (! regclass_compatible_p (src_class, dst_class))
  {
    ...
    continue;
       ...
       if (reg_overlap_mentioned_p (dst, (((set)->fld[1]).rtx)))
  {
    if (!copy_src)
      {
        copy_src = src;
  ...
  fprintf (regmove_dump_file,
    ...
    op_no, (((insn)->fld[0]).rtint), match_no);
       ...
       for (length = 0, p = (((insn)->fld[1]).rtx); p; p = (((p)->fld[1]).rtx))
  {
   ...
   {
     if (validate_change (p, &(((pset)->fld[0]).rtx),
            dst, 0))
       success = 1;
     else
       {
    ...
    if (reg_overlap_mentioned_p (src, (((p)->fld[5]).rtx))
        || reg_overlap_mentioned_p (dst, (((p)->fld[5]).rtx)))
      break;
    ...
    if (((enum rtx_code) (p)->code) == CALL_INSN)
      {
        ...
        if ((((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->calls_crossed) == 0)
   break;
      }
  }
       ...
       if (success)
  {
    ...
    if (reg_overlap_mentioned_p (src, (((p)->fld[5]).rtx)))
      {
        (((src_note)->fld[1]).rtx) = (((p)->fld[8]).rtx);
        (((p)->fld[8]).rtx) = src_note;
      }
    ...
    dstno = (((dst)->fld[0]).rtuint);
    srcno = (((src)->fld[0]).rtuint);
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      rtx end = bb->end;
      rtx new = end;
      rtx next = (((new)->fld[2]).rtx);
      while (next != 0 && (((next)->fld[0]).rtint) >= old_max_uid
      && (bb->next_bb == (&entry_exit_blocks[1]) || bb->next_bb->head != next))
 new = next, next = (((new)->fld[2]).rtx);
      bb->end = new;
    }
 ...
 switch (c)
  ...
  matchp->with[matchp->commutative[op_no]] = match;
   ...
   case 'C': case 'D': case 'W': case 'Y': case 'Z':
     if ((reg_class_size[(int) (mips_char_to_class[(unsigned char)((unsigned char) c)])] == 1))
     ...
     rtx insn;
{
 ...
 return;
  ...
  for (i = 0; i < (rtx_length[(int) (code)]); i++, fmt++)
    if (*fmt == 'e')
      replace_in_call_usage (&(((x)->fld[i]).rtx), dst_reg, src, insn);
    else if (*fmt == 'E')
      for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
 replace_in_call_usage (& (((((x)->fld[i]).rtvec))->elem[j]), dst_reg, src, insn);
}
# 1672 "../../../kgccfe/gnu/regmove.c"
static int
     ...
     FILE *regmove_dump_file;
{
  ...
  long long insn_const = 0, newconst;
  rtx overlap = 0;
  ...
  if (! src_note)
    {
# 1705 "../../../kgccfe/gnu/regmove.c"
      code = ((enum rtx_code) ((((set)->fld[1]).rtx))->code);
      if ((code == PLUS || code == LSHIFTRT
    || code == ASHIFT || code == ASHIFTRT)
   && ((((((set)->fld[1]).rtx))->fld[0]).rtx) == src
   && ((enum rtx_code) (((((((set)->fld[1]).rtx))->fld[1]).rtx))->code) == CONST_INT)
 insn_const = (((((((((set)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtwint);
      else if (! stable_and_no_regs_but_for_p ((((set)->fld[1]).rtx), src, dst))
 return 0;
      else
 ...
 code = NOTE;
  ...
  if (regmove_dump_file)
    fprintf (regmove_dump_file,
      "Could fix operand %d of insn %d matching operand %d.\n",
      operand_number, (((insn)->fld[0]).rtint), match_number);
  ...
  for (length = s_length = 0, p = (((insn)->fld[2]).rtx); p; p = (((p)->fld[2]).rtx))
    {
      if (((enum rtx_code) (p)->code) == CALL_INSN)
 replace_in_call_usage (& (((p)->fld[9]).rtx),
          (((dst)->fld[0]).rtuint), src, p);
 ...
 break;
      ...
      if ((dst_note = find_regno_note (p, REG_DEAD, (((dst)->fld[0]).rtuint)))
   && (((enum machine_mode) ((((dst_note)->fld[0]).rtx))->mode) == ((enum machine_mode) (dst)->mode)))
 {




   if (overlap && ((enum machine_mode) ((((p)->fld[1]).rtx))->mode) != VOIDmode)
     break;
       ...
       for (q = p; q; q = (((q)->fld[2]).rtx))
  {
    ...
    else if (! ((rtx_class[(int) (((enum rtx_code) (q)->code))]) == 'i'))
      continue;
    else if (reg_overlap_mentioned_p (src, (((q)->fld[5]).rtx))
      || reg_set_p (src, q))
      break;
  }
       if (q)
  set2 = (((rtx_class[(int) (((enum rtx_code) (q)->code))]) == 'i') ? (((enum rtx_code) ((((q)->fld[5]).rtx))->code) == SET ? (((q)->fld[5]).rtx) : single_set_2 (q, (((q)->fld[5]).rtx))) : (rtx) 0);
       if (! q || ! set2 || ((enum rtx_code) ((((set2)->fld[1]).rtx))->code) != code
    || ((((((set2)->fld[1]).rtx))->fld[0]).rtx) != src
        ...
        && ! find_reg_note (q, REG_DEAD, src)))
  {
    ...
    if (code == PLUS && backward
        ...
        && ! (dst_note && ! (((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->calls_crossed)
       && (((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i') ? (((enum rtx_code) ((((p)->fld[5]).rtx))->code) == SET ? (((p)->fld[5]).rtx) : single_set_2 (p, (((p)->fld[5]).rtx))) : (rtx) 0)
       && ((enum rtx_code) (((((((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i') ? (((enum rtx_code) ((((p)->fld[5]).rtx))->code) == SET ? (((p)->fld[5]).rtx) : single_set_2 (p, (((p)->fld[5]).rtx))) : (rtx) 0))->fld[0]).rtx))->code) == REG
       && ((((((((((rtx_class[(int) (((enum rtx_code) (p)->code))]) == 'i') ? (((enum rtx_code) ((((p)->fld[5]).rtx))->code) == SET ? (((p)->fld[5]).rtx) : single_set_2 (p, (((p)->fld[5]).rtx))) : (rtx) 0))->fld[0]).rtx))->fld[0]).rtuint)
    < 176))
  ...
  {
    newconst = (((((((((set2)->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtwint) - insn_const;

    if (code != PLUS
        && (newconst < 0
     || ((unsigned long long) newconst
         >= ((mode_bitsize[(int) (((enum machine_mode) ((((set2)->fld[1]).rtx))->mode))])))))

      break;
    if (code == PLUS)
      {
        post_inc = q;
        if ((((set2)->fld[0]).rtx) != src)
   post_inc_set = set2;
      }
  }
       ...
       validate_change (q, &((((((set2)->fld[1]).rtx))->fld[1]).rtx),
          gen_rtx_CONST_INT (VOIDmode, (long long) (newconst)), 1);
     }
   ...
   break;
      ...
      if (reg_overlap_mentioned_p (dst, (((p)->fld[5]).rtx)))
 break;
      if (! src_note && reg_overlap_mentioned_p (src, (((p)->fld[5]).rtx)))
 {
      ...
      if (((enum rtx_code) (p)->code) == CALL_INSN)
 {
  ...
  if (code == MINUS)
    {
      post_inc = emit_insn_after (copy_rtx ((((insn)->fld[5]).rtx)), p);
      if ((0 || 0)
   && search_end
   && try_auto_increment (search_end, post_inc, 0, src, newconst, 1))
 post_inc = 0;
      validate_change (insn, &((((((set)->fld[1]).rtx))->fld[1]).rtx), gen_rtx_CONST_INT (VOIDmode, (long long) (insn_const)), 0);
      (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->sets)++;
      (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->live_length)++;
    }
  if (overlap)
    {
 ...
 {
   rtx notes = (((insn)->fld[8]).rtx);

   emit_insn_after_with_line_notes (pat, (((p)->fld[1]).rtx), insn);
   delete_insn (insn);


   insn = p;
   while (! ((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') || (((insn)->fld[5]).rtx) != pat)
     insn = (((insn)->fld[1]).rtx);

   (((insn)->fld[8]).rtx) = notes;
 }
    }
  ...
  if (! overlap && (code == PLUS || code == MINUS))
    {
      ...
      if (note && (((enum rtx_code) ((((note)->fld[0]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CONST || ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == HIGH || ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CONSTANT_P_RTX))
 {
   for (q = (((insn)->fld[1]).rtx); q; q = (((q)->fld[1]).rtx))
     {
  ...
  num_calls2++;
   ...
   if (q && set2 && (((set2)->fld[0]).rtx) == src && (((enum rtx_code) ((((set2)->fld[1]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((set2)->fld[1]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((set2)->fld[1]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((set2)->fld[1]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) ((((set2)->fld[1]).rtx))->code) == CONST || ((enum rtx_code) ((((set2)->fld[1]).rtx))->code) == HIGH || ((enum rtx_code) ((((set2)->fld[1]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) ((((set2)->fld[1]).rtx))->code) == CONSTANT_P_RTX)
       && validate_change (insn, &(((set)->fld[1]).rtx), (((note)->fld[0]).rtx), 0))
     {
       delete_insn (q);
       (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->sets)--;
       (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->calls_crossed) -= num_calls2;
       (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->live_length) -= s_length2;
       insn_const = 0;
     }
 }
    }
  ...
  if (post_inc && code == PLUS
      ...
      && ((0 && newconst > 0 && newconst <= ((target_flags & 0x00002000) ? 8 : 4))
   || (0 && newconst < 0 && newconst >= -((target_flags & 0x00002000) ? 8 : 4)))
      && exact_log2_wide ((unsigned long long) (newconst)))
    {
      rtx q, inc_dest;

      inc_dest = post_inc_set ? (((post_inc_set)->fld[0]).rtx) : src;
      for (q = post_inc; (q = (((q)->fld[2]).rtx)); )
 {
   ...
   if (perhaps_ends_bb_p (q))
     ...
     && (reg_overlap_mentioned_p (src, (((q)->fld[5]).rtx))
         || reg_set_p (src, q)))
     break;
   else if (reg_set_p (inc_dest, q))
     break;
   else if (reg_overlap_mentioned_p (inc_dest, (((q)->fld[5]).rtx)))
     {
  ...
  if (reg_overlap_mentioned_p (dst, (((insn)->fld[5]).rtx)))
    {
      (((dst_note)->fld[1]).rtx) = (((insn)->fld[8]).rtx);
      (((insn)->fld[8]).rtx) = dst_note;
    }
 ...
 remove_note (insn, src_note);
      ...
      (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->calls_crossed) += s_num_calls;
    }

  (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->sets)++;
  (((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->sets)--;

  (((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->calls_crossed) -= num_calls;

  (((reg_n_info)->data.reg[(((src)->fld[0]).rtuint)])->live_length) += s_length;
  if ((((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->live_length) >= 0)
    {
      (((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->live_length) -= length;



      if ((((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->live_length) < 2)
 (((reg_n_info)->data.reg[(((dst)->fld[0]).rtuint)])->live_length) = 2;
    }
  if (regmove_dump_file)
    fprintf (regmove_dump_file,
      "Fixed operand %d of insn %d matching operand %d.\n",
     ...
     rtx x, src, dst;
{
 ...
 for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
   if (fmt[i] == 'e'
       && ! stable_and_no_regs_but_for_p ((((x)->fld[i]).rtx), src, dst))
       return 0;
 return 1;
      }
    case 'o':
 ...
 return x == src || x == dst;
      ...
      if (code == MEM
   && ! stable_and_no_regs_but_for_p ((((x)->fld[0]).rtx), src, dst))
 return 0;
...
static struct csa_memlist *record_one_stack_memref
  (rtx, rtx *, struct csa_memlist *);
static int try_apply_stack_adjustment
  (rtx, struct csa_memlist *, long long, long long);
...
{
  int i;
  rtx tmp = (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') ? (((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == SET ? (((insn)->fld[5]).rtx) : single_set_2 (insn, (((insn)->fld[5]).rtx))) : (rtx) 0);
  if (tmp)
    return tmp;
  ...
  tmp = (((insn)->fld[5]).rtx);
  if (((enum rtx_code) ((((((tmp)->fld[0]).rtvec))->elem[0]))->code) != SET)
    return (rtx) 0;

  for (i = 1; i < (((((tmp)->fld[0]).rtvec))->num_elem); ++i)
    {
      rtx this = (((((tmp)->fld[0]).rtvec))->elem[i]);


      if (((enum rtx_code) (this)->code) == SET
   && (((this)->fld[1]).rtx) == (((this)->fld[0]).rtx))
 ;
     ...
     struct csa_memlist *next_memlist;
{
  ...
  if ((((*mem)->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER]))
    ml->sp_offset = 0;
  else
    ml->sp_offset = (((((((((*mem)->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtwint);
...
try_apply_stack_adjustment (insn, memlist, new_adjust, delta)
     rtx insn;
     struct csa_memlist *memlist;
     long long new_adjust, delta;
{
  struct csa_memlist *ml;
  rtx set;

  set = single_set_for_csa (insn);
  validate_change (insn, &((((((set)->fld[1]).rtx))->fld[1]).rtx), gen_rtx_CONST_INT (VOIDmode, (long long) (new_adjust)), 1);

  for (ml = memlist; ml ; ml = ml->next)
    validate_change
      (ml->insn, ml->mem,
       replace_equiv_address_nv (*ml->mem,
     plus_constant_wide (((global_rtl[GR_STACK_POINTER])), (long long) (ml->sp_offset - delta))), 1);
     ...
     void *data;
{
      ...
      if (stack_memref_p (x))
 {
   ...
   return -1;
      ...
      return 1;
    case REG:
# 2328 "../../../kgccfe/gnu/regmove.c"
      if ((((x)->fld[0]).rtuint) == (0 + 29))
 return 1;
      break;
    default:
      break;
     ...
     basic_block bb;
{
      ...
      if (set)
 {
   ...
   if (dest == (global_rtl[GR_STACK_POINTER])
     ...
     {
       long long this_adjust = ((((((src)->fld[1]).rtx))->fld[0]).rtwint);
...
# 2403 "../../../kgccfe/gnu/regmove.c"
  ...
  delete_insn (insn);
   ...
   if (memlist == ((void *)0)
       ...
       && ((((enum rtx_code) ((((dest)->fld[0]).rtx))->code) == PRE_DEC
     && (last_sp_adjust
         == (long long) (mode_size[(int) (((enum machine_mode) (dest)->mode))])))
    || (((enum rtx_code) ((((dest)->fld[0]).rtx))->code) == PRE_MODIFY
        && ((enum rtx_code) (((((((dest)->fld[0]).rtx))->fld[1]).rtx))->code) == PLUS
        && (((((((((dest)->fld[0]).rtx))->fld[1]).rtx))->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER])
        && (((enum rtx_code) ((((((((((dest)->fld[0]).rtx))->fld[1]).rtx))->fld[1]).rtx))->code)
            == CONST_INT)
        && (((((((((((((dest)->fld[0]).rtx))->fld[1]).rtx))->fld[1]).rtx))->fld[0]).rtwint)
            == -last_sp_adjust)))
       && ((((((dest)->fld[0]).rtx))->fld[0]).rtx) == (global_rtl[GR_STACK_POINTER])
   ...
   && !for_each_rtx (&(((insn)->fld[5]).rtx), record_stack_memrefs, &data))
 {
   ...
   && (((enum rtx_code) (insn)->code) == CALL_INSN
       || reg_mentioned_p ((global_rtl[GR_STACK_POINTER]), (((insn)->fld[5]).rtx))))
 {
   if (last_sp_set && last_sp_adjust == 0)
     delete_insn (last_sp_set);
   free_csa_memlist (memlist);
