...
# 31 "../../../kgccfe/gnu/cselib.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 32 "../../../kgccfe/gnu/cselib.c" 2
...
static int cselib_invalidate_mem_1 (void **, void *);
static void cselib_invalidate_mem (rtx);
static void cselib_invalidate_rtx (rtx, rtx, void *);
static void cselib_record_set (rtx, cselib_val *, cselib_val *);

static void cselib_record_sets (rtx);
# 81 "../../../kgccfe/gnu/cselib.c"
static htab_t hash_table;



static rtx cselib_current_insn;
static _Bool cselib_current_insn_in_libcall;
...
static varray_type reg_values_old;
...
static varray_type used_regs_old;
     ...
     int clear_all;
{
  ...
  if (clear_all)
    for (i = 0; i < cselib_nregs; i++)
      ((reg_values)->data.te[(i)]) = 0;
  else
    for (i = 0; i < ((used_regs)->elements_used); i++)
      ((reg_values)->data.te[(((used_regs)->data.u[i]))]) = 0;

  max_value_regs = 0;

  ((used_regs)->elements_used = 0);
     ...
     const void *entry, *x_arg;
{
  ...
  if (((enum rtx_code) (x)->code) == CONST_INT
    ...
    fancy_abort ("../../../kgccfe/gnu/cselib.c", 256, __FUNCTION__);
  if (mode != ((enum machine_mode) (v->u.val_rtx)->mode))
    return 0;


  if (((enum rtx_code) (x)->code) == CONST
      && (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == CONST_INT
   || ((enum rtx_code) ((((x)->fld[0]).rtx))->code) == CONST_DOUBLE))
    x = (((x)->fld[0]).rtx);
     ...
     int only_useless;
{
  ...
  if (((enum rtx_code) (x)->code) == VALUE
      && (! only_useless || (((x)->fld[0]).rt_cselib)->locs == 0))
    return 1;

  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e' && references_value_p ((((x)->fld[i]).rtx), only_useless))
 return 1;
      else if (fmt[i] == 'E')
 for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
   if (references_value_p ((((((x)->fld[i]).rtvec))->elem[j]), only_useless))
     return 1;
    }
...
remove_useless_values ()
{
  ...
  if (n_useless_values != 0)
    fancy_abort ("../../../kgccfe/gnu/cselib.c", 385, __FUNCTION__);
}
     ...
     rtx x, y;
{
 ...
 y = e->u.val_rtx;
  ...
  if (((enum rtx_code) (x)->code) == VALUE)
    {
      cselib_val *e = (((x)->fld[0]).rt_cselib);
      struct elt_loc_list *l;
      ...
      for (l = e->locs; l; l = l->next)
 {
  ...
  if (((enum rtx_code) (y)->code) == VALUE)
    {
      cselib_val *e = (((y)->fld[0]).rt_cselib);
      struct elt_loc_list *l;
 ...
 case 'E':
   ...
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     if (! rtx_equal_for_cselib_p ((((((x)->fld[i]).rtvec))->elem[j]),
       (((((y)->fld[i]).rtvec))->elem[j])))
       return 0;
   break;

 case 'e':
   if (! rtx_equal_for_cselib_p ((((x)->fld[i]).rtx), (((y)->fld[i]).rtx)))
     return 0;
   break;
 ...
 default:
   fancy_abort ("../../../kgccfe/gnu/cselib.c", 521, __FUNCTION__);
 }
    }
  return 1;
}
     ...
     rtx x;
{
  if (((enum rtx_code) (x)->code) != CONST_INT
    ...
    return x;
  if (mode == VOIDmode)
    fancy_abort ("../../../kgccfe/gnu/cselib.c", 539, __FUNCTION__);
  return gen_rtx_fmt_e (CONST, (mode), (x));
}
# 552 "../../../kgccfe/gnu/cselib.c"
static unsigned int
     ...
     int create;
{
 ...
 return 0;
    ...
    case CONST_INT:
      hash += ((unsigned) CONST_INT << 7) + (unsigned) mode + (((x)->fld[0]).rtwint);
 ...
 return hash;
    ...
    case LABEL_REF:
      hash
 += ((unsigned) LABEL_REF << 7) + (unsigned long) (((x)->fld[0]).rtx);
      return hash ? hash : (unsigned int) LABEL_REF;

    case SYMBOL_REF:
      hash
 += ((unsigned) SYMBOL_REF << 7) + (unsigned long) (((x)->fld[0]).rtstr);
 ...
 for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
   {
     unsigned int tem_hash = hash_rtx ((((((x)->fld[i]).rtvec))->elem[j]), 0, create);
 ...
 {
   const unsigned char *p = (const unsigned char *) (((x)->fld[i]).rtstr);
 ...
 fancy_abort ("../../../kgccfe/gnu/cselib.c", 678, __FUNCTION__);
    }
     ...
     enum machine_mode mode;
{
  ...
  if (value == 0)
    fancy_abort ("../../../kgccfe/gnu/cselib.c", 700, __FUNCTION__);

  e->value = value;
  e->u.val_rtx = gen_rtx_fmt_0 (VALUE, (mode));
  (((e->u.val_rtx)->fld[0]).rt_cselib) = e;
  e->addr_list = 0;
  e->locs = 0;
  return e;
}
     ...
     rtx x;
{
 ...
 && ((((((l->loc)->fld[0]).rtx))->fld[0]).rt_cselib) == addr_elt)
      return;
     ...
     int create;
{
  ...
  if ((((x))->volatil) || mode == BLKmode
      || (((mode_class[(int) (mode)]) == MODE_FLOAT || (mode_class[(int) (mode)]) == MODE_COMPLEX_FLOAT || (mode_class[(int) (mode)]) == MODE_VECTOR_FLOAT) && flag_float_store))
    return 0;


  addr = cselib_lookup ((((x)->fld[0]).rtx), mode, create);
  if (! addr)
    return 0;
     ...
     rtx x;
{
  ...
  switch (code)
    {
    case REG:
      for (l = ((reg_values)->data.te[((((x)->fld[0]).rtuint))]); l; l = l->next)
 if (((enum machine_mode) (l->elt->u.val_rtx)->mode) == ((enum machine_mode) (x)->mode))
   return l->elt->u.val_rtx;

      fancy_abort ("../../../kgccfe/gnu/cselib.c", 796, __FUNCTION__);
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 {
   rtx t = cselib_subst_to_values ((((x)->fld[i]).rtx));

   if (t != (((x)->fld[i]).rtx) && x == copy)
      ...
      else if (fmt[i] == 'E')
 {
   ...
   for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
     {
       rtx t = cselib_subst_to_values ((((((x)->fld[i]).rtvec))->elem[j]));

       if (t != (((((x)->fld[i]).rtvec))->elem[j]) && (((x)->fld[i]).rtvec) == (((copy)->fld[i]).rtvec))
  {
    if (x == copy)
      copy = shallow_copy_rtx (x);

    (((copy)->fld[i]).rtvec) = rtvec_alloc ((((((x)->fld[i]).rtvec))->num_elem));
    for (k = 0; k < j; k++)
      (((((copy)->fld[i]).rtvec))->elem[k]) = (((((x)->fld[i]).rtvec))->elem[k]);
  }

       (((((copy)->fld[i]).rtvec))->elem[j]) = t;
     }
 }
    }
     ...
     int create;
{
  ...
  if (((enum rtx_code) (x)->code) == VALUE)
    return (((x)->fld[0]).rt_cselib);

  if (((enum rtx_code) (x)->code) == REG)
    {
      struct elt_list *l;
      unsigned int i = (((x)->fld[0]).rtuint);

      for (l = ((reg_values)->data.te[(i)]); l; l = l->next)
 ...
 return 0;
      ...
      if (i < 176)
 {
   unsigned int n = mips_hard_regno_nregs (i, mode);
   ...
   if (n > max_value_regs)
     max_value_regs = n;
      ...
      if (((reg_values)->data.te[(i)]) == 0)
        do { if ((used_regs)->elements_used >= (used_regs)->num_elements) (((used_regs)) = varray_grow ((used_regs), 2 * (used_regs)->num_elements)); (used_regs)->data.u[(used_regs)->elements_used++] = (i); } while (0);
      ((reg_values)->data.te[(i)]) = new_elt_list (((reg_values)->data.te[(i)]), e);
     ...
     enum machine_mode mode;
{
  ...
  if (reload_completed && regno >= 176
      && reg_renumber[regno] >= 0)
    fancy_abort ("../../../kgccfe/gnu/cselib.c", 958, __FUNCTION__);
  ...
  if (regno < 176)
    {
      if (mode == VOIDmode)
 fancy_abort ("../../../kgccfe/gnu/cselib.c", 967, __FUNCTION__);
 ...
 i = regno - max_value_regs;
  ...
  for (; i < endregno; i++)
    {
      struct elt_list **l = &((reg_values)->data.te[(i)]);
      ...
      while (*l)
 {
   ...
   if (i < 176)
     this_last += mips_hard_regno_nregs (i, ((enum machine_mode) (v->u.val_rtx)->mode)) - 1;
   ...
   for (p = &v->locs; ; p = &(*p)->next)
     {
       ...
       if (((enum rtx_code) (x)->code) == REG && (((x)->fld[0]).rtuint) == i)
  {
    unchain_one_elt_loc_list (p);
    break;
  }
     ...
     rtx val;
{
  ...
  switch (code)
    ...
    case MEM:
      if (((enum machine_mode) (mem_base)->mode) == BLKmode
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    {
      if (fmt[i] == 'e')
 {
   if (cselib_mem_conflict_p (mem_base, (((val)->fld[i]).rtx)))
     return 1;
 }
      else if (fmt[i] == 'E')
 for (j = 0; j < (((((val)->fld[i]).rtvec))->num_elem); j++)
   if (cselib_mem_conflict_p (mem_base, (((((val)->fld[i]).rtvec))->elem[j])))
     return 1;
    }
     ...
     void *info;
{
   ...
   || ! cselib_mem_conflict_p (mem_rtx, x))
 {
   ...
   continue;
      ...
      addr = cselib_lookup ((((x)->fld[0]).rtx), VOIDmode, 0);
...
cselib_invalidate_rtx (dest, ignore, data)
     rtx dest;
     rtx ignore __attribute__ ((__unused__));
     void *data __attribute__ ((__unused__));
{
  ...
  if (((enum rtx_code) (dest)->code) == REG)
    cselib_invalidate_regno ((((dest)->fld[0]).rtuint), ((enum machine_mode) (dest)->mode));
...
{
  int dreg = ((enum rtx_code) (dest)->code) == REG ? (int) (((dest)->fld[0]).rtuint) : -1;
  ...
  if (dreg >= 0)
    {
      if (((reg_values)->data.te[(dreg)]) == 0)
        do { if ((used_regs)->elements_used >= (used_regs)->num_elements) (((used_regs)) = varray_grow ((used_regs), 2 * (used_regs)->num_elements)); (used_regs)->data.u[(used_regs)->elements_used++] = (dreg); } while (0);

      if (dreg < 176)
 {
   unsigned int n = mips_hard_regno_nregs (dreg, ((enum machine_mode) (dest)->mode));

   if (n > max_value_regs)
     max_value_regs = n;
 }

      ((reg_values)->data.te[(dreg)]) = new_elt_list (((reg_values)->data.te[(dreg)]), src_elt);
      if (src_elt->locs == 0)
 n_useless_values--;
     ...
     rtx insn;
{
 ...
 {
   rtx x = (((((body)->fld[0]).rtvec))->elem[i]);

   if (((enum rtx_code) (x)->code) == SET)
     {
       sets[n_sets].src = (((x)->fld[1]).rtx);
 ...
 sets[i].dest = dest = (((dest)->fld[0]).rtx);
   ...
   if (((enum rtx_code) (dest)->code) == MEM)
     sets[i].dest_addr_elt = cselib_lookup ((((dest)->fld[0]).rtx), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 1);
   else
     ...
     rtx insn;
{
 ...
 cselib_invalidate_mem (callmem);
  ...
  cselib_record_sets (insn);
# 1366 "../../../kgccfe/gnu/cselib.c"
  if (((enum rtx_code) (insn)->code) == CALL_INSN)
    for (x = (((insn)->fld[9]).rtx); x; x = (((x)->fld[1]).rtx))
      if (((enum rtx_code) ((((x)->fld[0]).rtx))->code) == CLOBBER)
 cselib_invalidate_rtx (((((((x)->fld[0]).rtx))->fld[0]).rtx), (rtx) 0, ((void *)0));
...
cselib_update_varray_sizes ()
{
  ...
  cselib_nregs = nregs;
  ((reg_values) = varray_grow (reg_values, nregs));
  ((used_regs) = varray_grow (used_regs, nregs));
}
...
cselib_init ()
{
  ...
  if (reg_values_old != ((void *)0) && ((reg_values_old)->num_elements) >= cselib_nregs)
    {
    ...
    {
      reg_values = varray_init (cselib_nregs, VARRAY_DATA_TE, "reg_values");
      used_regs = varray_init (cselib_nregs, VARRAY_DATA_U, "used_regs");
    }
  hash_table = htab_create_alloc (31, get_value_hash, entry_and_rtx_equal_p, ((void *)0), ggc_calloc, ((void *)0));
...
# 1 "../../../kgccfe/gnu/MIPS/gt-cselib.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-cselib.h"
...
const struct ggc_root_tab gt_ggc_rd_gt_cselib_h[] = {
  { &empty_elt_loc_lists, 1, sizeof (empty_elt_loc_lists), ((void *)0) },
  { &empty_elt_lists, 1, sizeof (empty_elt_lists), ((void *)0) },
  { &empty_vals, 1, sizeof (empty_vals), ((void *)0) },
  { &used_regs_old, 1, sizeof (used_regs_old), ((void *)0) },
  { &reg_values_old, 1, sizeof (reg_values_old), ((void *)0) },
  { ((void *)0), 0, 0, ((void *)0) }
};
# 1436 "../../../kgccfe/gnu/cselib.c" 2
