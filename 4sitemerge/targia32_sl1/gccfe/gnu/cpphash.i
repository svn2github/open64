  ...
  if (pfile->our_hashtable)
    {
      ...
      __extension__ ({ struct obstack *__o = (&pfile->hash_ob); void *__obj = (0); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
    }
}
