...
# 71 "../../../kgccfe/gnu/local-alloc.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 72 "../../../kgccfe/gnu/local-alloc.c" 2
...
static int find_free_reg (enum reg_class, enum machine_mode, int, int, int, int, int);
...
# 378 "../../../kgccfe/gnu/local-alloc.c"
  for (i = 176; i < max_regno; i++)
    {
      if ((((reg_n_info)->data.reg[i])->basic_block) >= 0 && (((reg_n_info)->data.reg[i])->deaths) == 1)
 reg_qty[i] = -2;
      else
 reg_qty[i] = -1;
    }
      ...
      if (next_qty < 6)
 {
   for (i = 0; i < next_qty; i++)
     {
       do { HARD_REG_ELT_TYPE *scan_tp_ = (qty_phys_copy_sugg[i]); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
       qty_phys_num_copy_sugg[i] = 0;
       do { HARD_REG_ELT_TYPE *scan_tp_ = (qty_phys_sugg[i]); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0);
      ...
      else
 {
   ...
   memset ((char *) (qty_phys_copy_sugg), 0, (sizeof (*(qty_phys_copy_sugg))) * next_qty);;
   memset ((char *) (qty_phys_num_copy_sugg), 0, (sizeof (*(qty_phys_num_copy_sugg))) * next_qty);;
   memset ((char *) (qty_phys_sugg), 0, (sizeof (*(qty_phys_sugg))) * next_qty);;
   memset ((char *) (qty_phys_num_sugg), 0, (sizeof (*(qty_phys_num_sugg))) * next_qty);;
 }
     ...
     rtx memref;
{
  ...
  for (insn = start; insn && ! equiv_mem_modified; insn = (((insn)->fld[2]).rtx))
    {
 ...
 return 0;
      ...
      note_stores ((((insn)->fld[5]).rtx), validate_equiv_mem_from_store, ((void *)0));
 ...
 if ((((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_INC
     ...
     && reg_overlap_mentioned_p ((((note)->fld[0]).rtx), memref))
   return 0;
    }
     ...
     rtx x;
{
  ...
  switch (code)
    {
    case MEM:
      return ! (((x))->unchanging) || equiv_init_varies_p ((((x)->fld[0]).rtx));
    ...
    case REG:
      return reg_equiv[(((x)->fld[0]).rtuint)].replace == 0 && rtx_varies_p (x, 0);
 ...
 return 1;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    if (fmt[i] == 'e')
      {
 if (equiv_init_varies_p ((((x)->fld[i]).rtx)))
   return 1;
      }
    else if (fmt[i] == 'E')
      {
 ...
 for (j = 0; j < (((((x)->fld[i]).rtvec))->num_elem); j++)
   if (equiv_init_varies_p ((((((x)->fld[i]).rtvec))->elem[j])))
     return 1;
      }
     ...
     int regno;
{
  ...
  switch (code)
    {
    case SET:
      return equiv_init_movable_p ((((x)->fld[1]).rtx), regno);
    ...
    case REG:
      return (reg_equiv[(((x)->fld[0]).rtuint)].loop_depth >= reg_equiv[regno].loop_depth
       && reg_equiv[(((x)->fld[0]).rtuint)].replace)
      || ((((reg_n_info)->data.reg[(((x)->fld[0]).rtuint)])->basic_block) < 0 && ! rtx_varies_p (x, 0));
 ...
 return 0;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    switch (fmt[i])
      {
      case 'e':
 if (! equiv_init_movable_p ((((x)->fld[i]).rtx), regno))
   return 0;
 break;
      case 'E':
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   if (! equiv_init_movable_p ((((((x)->fld[i]).rtvec))->elem[j]), regno))
     return 0;
 break;
      }
     ...
     rtx x;
{
  ...
  switch (code)
    ...
    case REG:
      return reg_equiv[(((x)->fld[0]).rtuint)].replace;
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    switch (fmt[i])
      {
      case 'e':
 if (contains_replace_regs ((((x)->fld[i]).rtx)))
   return 1;
 break;
      case 'E':
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   if (contains_replace_regs ((((((x)->fld[i]).rtvec))->elem[j])))
     return 1;
 break;
      }
     ...
     rtx memref;
{
  ...
  switch (code)
    ...
    case REG:
      return (reg_equiv[(((x)->fld[0]).rtuint)].replacement
       && memref_referenced_p (memref,
          reg_equiv[(((x)->fld[0]).rtuint)].replacement));
 ...
 {
   if (memref_referenced_p (memref, ((((((x)->fld[0]).rtx))->fld[0]).rtx)))
     return 1;
 }
      else if (memref_referenced_p (memref, (((x)->fld[0]).rtx)))
 return 1;

      return memref_referenced_p (memref, (((x)->fld[1]).rtx));
  ...
  for (i = (rtx_length[(int) (code)]) - 1; i >= 0; i--)
    switch (fmt[i])
      {
      case 'e':
 if (memref_referenced_p (memref, (((x)->fld[i]).rtx)))
   return 1;
 break;
      case 'E':
 for (j = (((((x)->fld[i]).rtvec))->num_elem) - 1; j >= 0; j--)
   if (memref_referenced_p (memref, (((((x)->fld[i]).rtvec))->elem[j])))
     return 1;
 break;
      }
     ...
     rtx end;
{
  ...
  for (insn = (((start)->fld[2]).rtx); insn != (((end)->fld[2]).rtx);
       insn = (((insn)->fld[2]).rtx))
    if (((rtx_class[(int) (((enum rtx_code) (insn)->code))]) == 'i') && memref_referenced_p (memref, (((insn)->fld[5]).rtx)))
      return 1;

  return 0;
}
# 785 "../../../kgccfe/gnu/local-alloc.c"
int
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) == PLUS
      && ((((x)->fld[0]).rtx) == (global_rtl[GR_FRAME_POINTER]) || (((x)->fld[0]).rtx) == (global_rtl[GR_ARG_POINTER]))
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      ...
      for (insn = bb->head; insn != (((bb->end)->fld[2]).rtx); insn = (((insn)->fld[2]).rtx))
 {
   rtx note;
   rtx set;
   rtx dest, src;
   ...
   for (note = (((insn)->fld[8]).rtx); note; note = (((note)->fld[1]).rtx))
     if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_INC)
       no_equiv ((((note)->fld[0]).rtx), note, ((void *)0));
   ...
   if (set == 0)
     {
       note_stores ((((insn)->fld[5]).rtx), no_equiv, ((void *)0));
       continue;
     }
  ...
  {
    rtx part = ((((((((insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]);
    if (part != set)
   ...
   dest = (((set)->fld[0]).rtx);
   src = (((set)->fld[1]).rtx);
# 888 "../../../kgccfe/gnu/local-alloc.c"
   if (((enum rtx_code) (dest)->code) == MEM && ((enum rtx_code) (src)->code) == REG
       && (regno = (((src)->fld[0]).rtuint)) >= 176
       && (((reg_n_info)->data.reg[regno])->basic_block) >= 0
       && (((reg_n_info)->data.reg[regno])->sets) == 1
       && reg_equiv[regno].init_insns != 0
       && reg_equiv[regno].init_insns != (const_int_rtx[64])
       && ! find_reg_note ((((reg_equiv[regno].init_insns)->fld[0]).rtx),
      REG_EQUIV, (rtx) 0)
       && ! contains_replace_regs ((((dest)->fld[0]).rtx)))
     {
       rtx init_insn = (((reg_equiv[regno].init_insns)->fld[0]).rtx);
       if (validate_equiv_mem (init_insn, src, dest)
    && ! memref_used_between_p (dest, init_insn, insn))
  (((init_insn)->fld[8]).rtx)
    = gen_rtx_fmt_ee (EXPR_LIST, (REG_EQUIV), (dest), ((((init_insn)->fld[8]).rtx)));
     }
# 917 "../../../kgccfe/gnu/local-alloc.c"
   if (((enum rtx_code) (dest)->code) != REG
       || (regno = (((dest)->fld[0]).rtuint)) < 176
       || reg_equiv[regno].init_insns == (const_int_rtx[64])
       || ((reg_class_size[(int) (reg_preferred_class (regno))] == 1)
   ...
   if ((((reg_n_info)->data.reg[regno])->sets) != 1
       && (! note
    || rtx_varies_p ((((note)->fld[0]).rtx), 0)
    || (reg_equiv[regno].replacement
        && ! rtx_equal_p ((((note)->fld[0]).rtx),
     reg_equiv[regno].replacement))))
     {
   ...
   if (note && ! rtx_varies_p ((((note)->fld[0]).rtx), 0))
     ((note)->mode = (enum machine_mode) ((enum machine_mode) REG_EQUIV));
# 976 "../../../kgccfe/gnu/local-alloc.c"
   note = find_reg_note (insn, REG_EQUIV, (rtx) 0);

   if (note == 0 && (((reg_n_info)->data.reg[regno])->basic_block) >= 0
       && ((enum rtx_code) ((((set)->fld[1]).rtx))->code) == MEM
       && validate_equiv_mem (insn, dest, (((set)->fld[1]).rtx)))
     (((insn)->fld[8]).rtx) = note = gen_rtx_fmt_ee (EXPR_LIST, (REG_EQUIV), ((((set)->fld[1]).rtx)), ((((insn)->fld[8]).rtx)));
   ...
   if (note)
     {
       ...
       if (((enum rtx_code) ((((note)->fld[0]).rtx))->code) == LABEL_REF
    || (((enum rtx_code) ((((note)->fld[0]).rtx))->code) == CONST
        && ((enum rtx_code) (((((((note)->fld[0]).rtx))->fld[0]).rtx))->code) == PLUS
        && (((enum rtx_code) ((((((((((note)->fld[0]).rtx))->fld[0]).rtx))->fld[0]).rtx))->code)
     == LABEL_REF)))
  recorded_label_ref = 1;

       reg_equiv[regno].replacement = (((note)->fld[0]).rtx);
       reg_equiv[regno].src_p = &(((set)->fld[1]).rtx);
...
# 1021 "../../../kgccfe/gnu/local-alloc.c"
      if ((((reg_n_info)->data.reg[regno])->refs) == 2
   && (rtx_equal_p ((((note)->fld[0]).rtx), src)
       || ! equiv_init_varies_p (src))
   && ((enum rtx_code) (insn)->code) == INSN
   && equiv_init_movable_p ((((insn)->fld[5]).rtx), regno))
        reg_equiv[regno].replace = 1;
  }
     }
 }
    }
# 1040 "../../../kgccfe/gnu/local-alloc.c"
  for (bb = (&entry_exit_blocks[1])->prev_bb; bb != (&entry_exit_blocks[0]); bb = bb->prev_bb)
    {
      loop_depth = bb->loop_depth;
      for (insn = bb->end; insn != (((bb->head)->fld[1]).rtx); insn = (((insn)->fld[1]).rtx))
 {
   rtx link;
   ...
   for (link = (((insn)->fld[8]).rtx); link; link = (((link)->fld[1]).rtx))
    ...
    && reg_mentioned_p ((((link)->fld[0]).rtx), (((insn)->fld[5]).rtx)))
  {
    int regno = ((((((link)->fld[0]).rtx))->fld[0]).rtuint);
    rtx equiv_insn;
    ...
    if (reg_equiv[regno].init_insns == (rtx) 0
        || (((reg_equiv[regno].init_insns)->fld[1]).rtx) != (rtx) 0)
      fancy_abort ("../../../kgccfe/gnu/local-alloc.c", 1070, __FUNCTION__);
    equiv_insn = (((reg_equiv[regno].init_insns)->fld[0]).rtx);
    ...
    if (asm_noperands ((((equiv_insn)->fld[5]).rtx)) < 0
            ...
            *(reg_equiv[regno].src_p), insn))
      {
        ...
        for (last_link = link; (((last_link)->fld[1]).rtx);
      last_link = (((last_link)->fld[1]).rtx))
   ;


        equiv_link = (((equiv_insn)->fld[8]).rtx);
        while (equiv_link)
   {
     note = equiv_link;
     equiv_link = (((equiv_link)->fld[1]).rtx);
     if (((enum reg_note) ((enum machine_mode) (note)->mode)) == REG_DEAD)
       {
         remove_note (equiv_insn, note);
         (((last_link)->fld[1]).rtx) = note;
         (((note)->fld[1]).rtx) = (rtx) 0;
         last_link = note;
       }
   }
        ...
        reg_equiv[regno].init_insns
   = (((reg_equiv[regno].init_insns)->fld[1]).rtx);
      }


    else if ((((insn)->fld[1]).rtx) != equiv_insn)
      {
        rtx new_insn;

        new_insn = emit_insn_before ((((equiv_insn)->fld[5]).rtx), insn);
        (((new_insn)->fld[8]).rtx) = (((equiv_insn)->fld[8]).rtx);
        (((equiv_insn)->fld[8]).rtx) = 0;



        (((new_insn)->fld[6]).rtint) = (((equiv_insn)->fld[6]).rtint);

        delete_insn (equiv_insn);

        (((reg_equiv[regno].init_insns)->fld[0]).rtx) = new_insn;

        (((reg_n_info)->data.reg[regno])->basic_block) = bb->index;
        (((reg_n_info)->data.reg[regno])->calls_crossed) = 0;
        (((reg_n_info)->data.reg[regno])->live_length) = 2;

        if (insn == bb->head)
   bb->head = (((insn)->fld[1]).rtx);
...
# 1186 "../../../kgccfe/gnu/local-alloc.c"
static void
no_equiv (reg, store, data)
     rtx reg, store __attribute__ ((__unused__));
     void *data __attribute__ ((__unused__));
{
  int regno;
  rtx list;
     ...
     int b;
{
  ...
  insn = ((((basic_block_info)->data.bb[(b)]))->end);
  while (1)
    {
      if (((enum rtx_code) (insn)->code) != NOTE)
 if (++insn_count > max_uid)
   fancy_abort ("../../../kgccfe/gnu/local-alloc.c", 1232, __FUNCTION__);
      if (insn == ((((basic_block_info)->data.bb[(b)]))->head))
 break;
      insn = (((insn)->fld[1]).rtx);
    }
  ...
  do { do { HARD_REG_ELT_TYPE *scan_tp_ = (regs_live); scan_tp_[0] = 0; scan_tp_[1] = 0; scan_tp_[2] = 0; } while (0); reg_set_to_hard_reg_set (&regs_live, (((basic_block_info)->data.bb[(b)]))->global_live_at_start); } while (0);





  insn = ((((basic_block_info)->data.bb[(b)]))->head);
  while (1)
    {
      if (((enum rtx_code) (insn)->code) != NOTE)
 insn_number++;
...
# 1289 "../../../kgccfe/gnu/local-alloc.c"
       ...
       for (i = 1; i < recog_data.n_operands; i++)
  {
    ...
    if (hard_reg != (rtx) 0)
     ...
     && ((unsigned long long) (((((hard_reg)->fld[0]).rtuint)) - (0)) <= ((176 - 1) - (0)))

     && ! call_used_regs[(((hard_reg)->fld[0]).rtuint)])
   continue;
      }
...
# 1387 "../../../kgccfe/gnu/local-alloc.c"
   if (optimize
       && ((enum rtx_code) ((((insn)->fld[5]).rtx))->code) == CLOBBER
       && (r0 = ((((((insn)->fld[5]).rtx))->fld[0]).rtx),
    ((enum rtx_code) (r0)->code) == REG)
       ...
       && (((set)->fld[0]).rtx) == r0 && (((set)->fld[1]).rtx) == r0
       && (note = find_reg_note ((((link)->fld[0]).rtx), REG_EQUAL,
     (rtx) 0)) != 0)
     {
       if (r1 = (((note)->fld[0]).rtx), ((enum rtx_code) (r1)->code) == REG

    && no_conflict_p (insn, r0, r1))
  win = combine_regs (r1, r0, 1, insn_number, insn, 1);
       else if ((rtx_format[(int) (((enum rtx_code) ((((note)->fld[0]).rtx))->code))])[0] == 'e'
         && (r1 = ((((((note)->fld[0]).rtx))->fld[0]).rtx),
  ...
  win = combine_regs (r1, r0, 0, insn_number, insn, 1);
       ...
       else if ((((enum rtx_code) ((((note)->fld[0]).rtx))->code) == EQ
   || ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == NE
   || (rtx_class[(int) (((enum rtx_code) ((((note)->fld[0]).rtx))->code))]) == 'c')
         && (r1 = ((((((note)->fld[0]).rtx))->fld[1]).rtx),
      (((enum rtx_code) (r1)->code) == REG || ((enum rtx_code) (r1)->code) == SUBREG))
         && no_conflict_p (insn, r0, r1))
  win = combine_regs (r1, r0, 0, insn_number, insn, 1);
       ...
       if (win)
  no_conflict_combined_regno = (((r1)->fld[0]).rtuint);
     }
  ...
  r1 = (((r1)->fld[0]).rtx);
       combined_regno = (((r1)->fld[0]).rtuint);
     }
  ...
  && combined_regno != (int) ((((((link)->fld[0]).rtx))->fld[0]).rtuint)
  && (no_conflict_combined_regno != (int) ((((((link)->fld[0]).rtx))->fld[0]).rtuint)
      || ! find_reg_note (insn, REG_NO_CONFLICT,
     (((link)->fld[0]).rtx))))
       wipe_dead_reg ((((link)->fld[0]).rtx), 0);





   note_stores ((((insn)->fld[5]).rtx), reg_is_set, ((void *)0));
  ...
  && ((enum rtx_code) ((((link)->fld[0]).rtx))->code) == REG)
       wipe_dead_reg ((((link)->fld[0]).rtx), 1);




   if ((note = find_reg_note (insn, REG_RETVAL, (rtx) 0)) != 0
       && ((enum rtx_code) ((((note)->fld[0]).rtx))->code) == INSN
       && ((enum rtx_code) (((((((note)->fld[0]).rtx))->fld[5]).rtx))->code) == CLOBBER)
     no_conflict_combined_regno = -1;
      ...
      do { HARD_REG_ELT_TYPE *scan_tp_ = (regs_live_at[2 * insn_number]), *scan_fp_ = (regs_live); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
      do { HARD_REG_ELT_TYPE *scan_tp_ = (regs_live_at[2 * insn_number + 1]), *scan_fp_ = (regs_live); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

      if (insn == ((((basic_block_info)->data.bb[(b)]))->end))
 break;

      insn = (((insn)->fld[2]).rtx);
    }
# 1496 "../../../kgccfe/gnu/local-alloc.c"
...
# 1692 "../../../kgccfe/gnu/local-alloc.c"
static int
qty_compare (q1, q2)
     int q1, q2;
{
  return ((int) (((double) (floor_log2_wide ((unsigned long long) (qty[q2].n_refs)) * qty[q2].freq * qty[q2].size) / (qty[q2].death - qty[q2].birth)) * (10000 / 1000))) - ((int) (((double) (floor_log2_wide ((unsigned long long) (qty[q1].n_refs)) * qty[q1].freq * qty[q1].size) / (qty[q1].death - qty[q1].birth)) * (10000 / 1000)));
}
     ...
     const void * q2p;
{
  ...
  int tem = ((int) (((double) (floor_log2_wide ((unsigned long long) (qty[q2].n_refs)) * qty[q2].freq * qty[q2].size) / (qty[q2].death - qty[q2].birth)) * (10000 / 1000))) - ((int) (((double) (floor_log2_wide ((unsigned long long) (qty[q1].n_refs)) * qty[q1].freq * qty[q1].size) / (qty[q1].death - qty[q1].birth)) * (10000 / 1000)));
...
# 1727 "../../../kgccfe/gnu/local-alloc.c"
static int
qty_sugg_compare (q1, q2)
     int q1, q2;
{
  int tem = (qty_phys_num_copy_sugg[q1] ? qty_phys_num_copy_sugg[q1] : qty_phys_num_sugg[q1] * 176) - (qty_phys_num_copy_sugg[q2] ? qty_phys_num_copy_sugg[q2] : qty_phys_num_sugg[q2] * 176);
     ...
     const void * q2p;
{
  ...
  tem = ((int) (((double) (floor_log2_wide ((unsigned long long) (qty[q2].n_refs)) * qty[q2].freq * qty[q2].size) / (qty[q2].death - qty[q2].birth)) * (10000 / 1000))) - ((int) (((double) (floor_log2_wide ((unsigned long long) (qty[q1].n_refs)) * qty[q1].freq * qty[q1].size) / (qty[q1].death - qty[q1].birth)) * (10000 / 1000)));
  if (tem != 0)
    return tem;
     ...
     int already_dead;
{
  ...
  while (((enum rtx_code) (usedreg)->code) == SUBREG)
    {
      rtx subreg = (((usedreg)->fld[0]).rtx);

      if (((enum rtx_code) (subreg)->code) == REG)
 {
   if ((mode_size[(int) (((enum machine_mode) (subreg)->mode))]) > ((target_flags & 0x00002000) ? 8 : 4))
     may_save_copy = 0;

   if ((((subreg)->fld[0]).rtuint) < 176)
     offset += subreg_regno_offset ((((subreg)->fld[0]).rtuint),
        ((enum machine_mode) (subreg)->mode),
        (((usedreg)->fld[1]).rtuint),
        ((enum machine_mode) (usedreg)->mode));
   else
     offset += ((((usedreg)->fld[1]).rtuint)
  ...
  ureg = (((usedreg)->fld[0]).rtuint);
  if (ureg < 176)
    usize = mips_hard_regno_nregs (ureg, ((enum machine_mode) (usedreg)->mode));
  else
    usize = (((mode_size[(int) (((enum machine_mode) (usedreg)->mode))])
       + (((target_flags & 0x00002000) ? 8 : 4) - 1))
      / ((target_flags & 0x00002000) ? 8 : 4));

  while (((enum rtx_code) (setreg)->code) == SUBREG)
    {
      rtx subreg = (((setreg)->fld[0]).rtx);
      ...
      if (((enum rtx_code) (subreg)->code) == REG)
 {
  ...
  sreg = (((setreg)->fld[0]).rtuint);
  if (sreg < 176)
    ssize = mips_hard_regno_nregs (sreg, ((enum machine_mode) (setreg)->mode));
  else
    ssize = (((mode_size[(int) (((enum machine_mode) (setreg)->mode))])
       + (((target_flags & 0x00002000) ? 8 : 4) - 1))
      / ((target_flags & 0x00002000) ? 8 : 4));
  ...
  if ((ureg >= 176 && reg_qty[ureg] < 0)

      || (offset > 0 && usize + offset > ssize)
      || (offset < 0 && usize + offset < ssize)


      || (ssize > usize && ureg >= 176
   && usize < qty[reg_qty[ureg]].size)

      || (sreg >= 176 && reg_qty[sreg] == -1)
   ...
   && find_reg_note (insn, REG_NO_CONFLICT, usedreg))
      ...
      || !(((mode_class[(int) (((enum machine_mode) (usedreg)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (usedreg)->mode))]) == MODE_COMPLEX_FLOAT) == ((mode_class[(int) (((enum machine_mode) (setreg)->mode))]) == MODE_FLOAT || (mode_class[(int) (((enum machine_mode) (setreg)->mode))]) == MODE_COMPLEX_FLOAT)))
    return 0;
# 1903 "../../../kgccfe/gnu/local-alloc.c"
  if (ureg < 176)
    {
 ...
 {
   if (may_save_copy
       && ! (!!((qty_phys_copy_sugg[reg_qty[sreg]])[(ureg) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((ureg) % ((unsigned) (8 * 8)))))))
     {
       ((qty_phys_copy_sugg[reg_qty[sreg]])[(ureg) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((ureg) % ((unsigned) (8 * 8))));
       qty_phys_num_copy_sugg[reg_qty[sreg]]++;
     }
   else if (! (!!((qty_phys_sugg[reg_qty[sreg]])[(ureg) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((ureg) % ((unsigned) (8 * 8)))))))
     {
       ((qty_phys_sugg[reg_qty[sreg]])[(ureg) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((ureg) % ((unsigned) (8 * 8))));
  ...
  if (sreg < 176)
    {
      if (may_save_copy
   && ! (!!((qty_phys_copy_sugg[reg_qty[ureg]])[(sreg) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((sreg) % ((unsigned) (8 * 8)))))))
 {
   ((qty_phys_copy_sugg[reg_qty[ureg]])[(sreg) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((sreg) % ((unsigned) (8 * 8))));
   qty_phys_num_copy_sugg[reg_qty[ureg]]++;
 }
      else if (! (!!((qty_phys_sugg[reg_qty[ureg]])[(sreg) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((sreg) % ((unsigned) (8 * 8)))))))
 {
   ((qty_phys_sugg[reg_qty[ureg]])[(sreg) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((sreg) % ((unsigned) (8 * 8))));
     ...
     int birth;
{
  ...
  if (((enum rtx_code) (reg)->code) == SUBREG)
    {
      regno = ((((((reg)->fld[0]).rtx))->fld[0]).rtuint);
      if (regno < 176)
 ...
 post_mark_life (regno, ((enum machine_mode) (reg)->mode), 1, birth, 2 * this_insn_number);
    ...
    {
      if (reg_qty[regno] == -2)
 alloc_qty (regno, ((enum machine_mode) (reg)->mode), (((mode_size[(int) (((enum machine_mode) ((cfun->emit->x_regno_reg_rtx)[regno])->mode))]) + ((target_flags & 0x00002000) ? 8 : 4) - 1) / ((target_flags & 0x00002000) ? 8 : 4)), birth);
...
# 2115 "../../../kgccfe/gnu/local-alloc.c"
  if (((enum rtx_code) ((((this_insn)->fld[5]).rtx))->code) == PARALLEL
      && multiple_sets (this_insn))
    {
      int i;
      for (i = ((((((((this_insn)->fld[5]).rtx))->fld[0]).rtvec))->num_elem) - 1; i >= 0; i--)
 {
   rtx set = ((((((((this_insn)->fld[5]).rtx))->fld[0]).rtvec))->elem[i]);
     ...
     int born_index, dead_index;
{
  ...
  if (born_index < 0 || born_index > dead_index)
    fancy_abort ("../../../kgccfe/gnu/local-alloc.c", 2182, __FUNCTION__);
  ...
  if (accept_call_clobbered)
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (call_fixed_reg_set); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);
  else if (qty[qtyno].n_calls_crossed == 0)
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (fixed_reg_set); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);
  else
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (call_used_reg_set); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);

  if (accept_call_clobbered)
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (losing_caller_save_reg_set); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

  for (ins = born_index; ins < dead_index; ins++)
    do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (regs_live_at[ins]); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);

  do { HARD_REG_ELT_TYPE *scan_tp_ = (used), *scan_fp_ = (reg_class_contents[(int) class]); scan_tp_[0] |= ~ scan_fp_[0]; scan_tp_[1] |= ~ scan_fp_[1]; scan_tp_[2] |= ~ scan_fp_[2]; } while (0);
# 2212 "../../../kgccfe/gnu/local-alloc.c"
  for (i = 0; i < (int) (sizeof (eliminables) / sizeof ((eliminables)[0])); i++)
    ((used)[(eliminables[i].from) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((eliminables[i].from) % ((unsigned) (8 * 8))));



  ((used)[(((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)) % ((unsigned) (8 * 8))));
...
# 2233 "../../../kgccfe/gnu/local-alloc.c"
  do { HARD_REG_ELT_TYPE *scan_tp_ = (first_used), *scan_fp_ = (used); scan_tp_[0] = scan_fp_[0]; scan_tp_[1] = scan_fp_[1]; scan_tp_[2] = scan_fp_[2]; } while (0);

  if (just_try_suggested)
    {
      if (qty_phys_num_copy_sugg[qtyno] != 0)
 do { HARD_REG_ELT_TYPE *scan_tp_ = (first_used), *scan_fp_ = (qty_phys_copy_sugg[qtyno]); scan_tp_[0] |= ~ scan_fp_[0]; scan_tp_[1] |= ~ scan_fp_[1]; scan_tp_[2] |= ~ scan_fp_[2]; } while (0);
      else
 do { HARD_REG_ELT_TYPE *scan_tp_ = (first_used), *scan_fp_ = (qty_phys_sugg[qtyno]); scan_tp_[0] |= ~ scan_fp_[0]; scan_tp_[1] |= ~ scan_fp_[1]; scan_tp_[2] |= ~ scan_fp_[2]; } while (0);
    }


  do { HARD_REG_ELT_TYPE *scan_xp_ = (reg_class_contents[(int) ALL_REGS]), *scan_yp_ = (first_used); if ((0 == (scan_xp_[0] & ~ scan_yp_[0])) && (0 == (scan_xp_[1] & ~ scan_yp_[1])) && (0 == (scan_xp_[2] & ~ scan_yp_[2]))) goto fail; } while (0);
  ...
  for (i = 0; i < 176; i++)
    {
      ...
      if (! (!!((first_used)[(regno) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno) % ((unsigned) (8 * 8))))))
 ...
 {
   int j;
   int size1 = mips_hard_regno_nregs (regno, mode);
   for (j = 1; j < size1 && ! (!!((used)[(regno + j) / ((unsigned) (8 * 8))] & (((HARD_REG_ELT_TYPE) (1)) << ((regno + j) % ((unsigned) (8 * 8)))))); j++);
   if (j == size1)
     {
...
mark_life (regno, mode, life)
     ...
     int life;
{
  int j = mips_hard_regno_nregs (regno, mode);
  if (life)
    while (--j >= 0)
      ((regs_live)[(regno + j) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((regno + j) % ((unsigned) (8 * 8))));
  else
    while (--j >= 0)
      ((regs_live)[(regno + j) / ((unsigned) (8 * 8))] &= ~(((HARD_REG_ELT_TYPE) (1)) << ((regno + j) % ((unsigned) (8 * 8)))));
}
     ...
     int life, birth, death;
{
  ...
  while (--j >= 0)
    ((this_reg)[(regno + j) / ((unsigned) (8 * 8))] |= ((HARD_REG_ELT_TYPE) (1)) << ((regno + j) % ((unsigned) (8 * 8))));

  if (life)
    while (birth < death)
      {
 do { HARD_REG_ELT_TYPE *scan_tp_ = (regs_live_at[birth]), *scan_fp_ = (this_reg); scan_tp_[0] |= scan_fp_[0]; scan_tp_[1] |= scan_fp_[1]; scan_tp_[2] |= scan_fp_[2]; } while (0);
 birth++;
      }
  else
    while (birth < death)
...
# 2376 "../../../kgccfe/gnu/local-alloc.c"
static int
no_conflict_p (insn, r0, r1)
     rtx insn, r0 __attribute__ ((__unused__)), r1;
{
  int ok = 0;
  ...
  if (note == 0
      || (((enum rtx_code) (r1)->code) == REG && (((r1)->fld[0]).rtuint) < 176)
      || (((enum rtx_code) (r1)->code) == SUBREG && ((enum rtx_code) ((((r1)->fld[0]).rtx))->code) == REG
   && ((((((r1)->fld[0]).rtx))->fld[0]).rtuint) < 176))
    return 0;

  last = (((note)->fld[0]).rtx);

  for (p = (((insn)->fld[2]).rtx); p && p != last; p = (((p)->fld[2]).rtx))
