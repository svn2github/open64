...
# 40 "../../../kgccfe/gnu/explow.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 41 "../../../kgccfe/gnu/explow.c" 2
...
# 44 "../../../kgccfe/gnu/explow.c" 2


# 1 "../../../kgccfe/gnu/defaults.h" 1
# 47 "../../../kgccfe/gnu/explow.c" 2
     ...
     enum machine_mode mode;
{
  ...
  if (! ((mode_class[(int) (mode)]) == MODE_INT || (mode_class[(int) (mode)]) == MODE_PARTIAL_INT))
    fancy_abort ("../../../kgccfe/gnu/explow.c", 64, __FUNCTION__);
     ...
     long long c;
{
 ...
 restart:
  ...
  switch (code)
    {
    case CONST_INT:
      return gen_rtx_CONST_INT (VOIDmode, (long long) ((((x)->fld[0]).rtwint) + c));

    case CONST_DOUBLE:
      {
 unsigned long long l1 = (((x)->fld[0]).rtwint);
 long long h1 = (((x)->fld[1]).rtwint);
 unsigned long long l2 = c;
 long long h2 = c < 0 ? ~0 : 0;
   ...
   && ((((((x)->fld[0]).rtx)))->unchanging))
 {
   tem
     = force_const_mem (((enum machine_mode) (x)->mode),
          plus_constant_wide ((get_pool_constant ((((x)->fld[0]).rtx))), (long long) (c)));

   if (memory_address_p (((enum machine_mode) (tem)->mode), (((tem)->fld[0]).rtx)))
     return tem;
 }
      break;
    ...
    case PLUS:
# 168 "../../../kgccfe/gnu/explow.c"
      if (((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_INT)
 {
   c += ((((((x)->fld[1]).rtx))->fld[0]).rtwint);
   ...
   goto restart;
      ...
      else if ((((enum rtx_code) ((((x)->fld[1]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_DOUBLE || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == HIGH || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONST_VECTOR || ((enum rtx_code) ((((x)->fld[1]).rtx))->code) == CONSTANT_P_RTX))
 {
   x = gen_rtx_fmt_ee (PLUS, (mode), ((((x)->fld[0]).rtx)), (plus_constant_wide (((((x)->fld[1]).rtx)), (long long) (c))));
   c = 0;
 }
      else if (find_constant_term_loc (&y))
 {
   ...
   *const_loc = plus_constant_wide ((*const_loc), (long long) (c));
   x = copy;
   c = 0;
 }
      break;
  ...
  if (c != 0)
    x = gen_rtx_fmt_ee (PLUS, (mode), (x), (gen_rtx_CONST_INT (VOIDmode, (long long) (c))));
     ...
     rtx *constptr;
{
  ...
  x0 = eliminate_constant_term ((((x)->fld[0]).rtx), &tem);
  x1 = eliminate_constant_term ((((x)->fld[1]).rtx), &tem);
     ...
     rtx insn;
{
  ...
  for (insn = (((insn)->fld[2]).rtx); insn; insn = next)
    {
      next = (((insn)->fld[2]).rtx);
   ...
   || ((enum rtx_code) (insn)->code) == CALL_INSN)
 {
   if (reg_set_p (reg, insn))
     return 0;
   if (reg_mentioned_p (reg, (((insn)->fld[5]).rtx)))
     return insn;
  ...
  return 0;
   ...
   if (((enum rtx_code) (insn)->code) == CALL_INSN
       ...
       && call_used_regs[(((reg)->fld[0]).rtuint)])
     return 0;
 }
      else
 fancy_abort ("../../../kgccfe/gnu/explow.c", 292, __FUNCTION__);
    }
  return 0;
}
     ...
     tree exp;
{
  ...
  if (((enum tree_code) (size)->common.code) != INTEGER_CST
    ...
    size = build (WITH_RECORD_EXPR, sizetype_tab[(int) SIZETYPE], size, exp);
     ...
     rtx x;
{
  if (((enum rtx_code) (x)->code) == MEM
   ...
   && ((enum machine_mode) (x)->mode) != VOIDmode))
    ...
    {
      rtx op0 = break_out_memory_refs ((((x)->fld[0]).rtx));
      rtx op1 = break_out_memory_refs ((((x)->fld[1]).rtx));

      if (op0 != (((x)->fld[0]).rtx) || op1 != (((x)->fld[1]).rtx))
 x = gen_rtx_fmt_ee (((enum rtx_code) (x)->code), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), op0, op1);
    }

  return x;
}
# 465 "../../../kgccfe/gnu/explow.c"
rtx
copy_all_regs (x)
     rtx x;
{
  if (((enum rtx_code) (x)->code) == REG)
    {
      if ((((x)->fld[0]).rtuint) != (0 + 1)

   && (((x)->fld[0]).rtuint) != ((target_flags & 0x00100000) ? 0 + 17 : 0 + 30)
 ...
 x = copy_to_reg (x);
    ...
    || ((enum rtx_code) (x)->code) == MULT)
    {
      rtx op0 = copy_all_regs ((((x)->fld[0]).rtx));
      rtx op1 = copy_all_regs ((((x)->fld[1]).rtx));
      if (op0 != (((x)->fld[0]).rtx) || op1 != (((x)->fld[1]).rtx))
 x = gen_rtx_fmt_ee (((enum rtx_code) (x)->code), (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), op0, op1);
    }
  return x;
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) == ADDRESSOF)
    return x;
# 512 "../../../kgccfe/gnu/explow.c"
  if (! cse_not_expected && (((enum rtx_code) (x)->code) == LABEL_REF || ((enum rtx_code) (x)->code) == SYMBOL_REF || ((enum rtx_code) (x)->code) == CONST_INT || ((enum rtx_code) (x)->code) == CONST_DOUBLE || ((enum rtx_code) (x)->code) == CONST || ((enum rtx_code) (x)->code) == HIGH || ((enum rtx_code) (x)->code) == CONST_VECTOR || ((enum rtx_code) (x)->code) == CONSTANT_P_RTX) && (((enum rtx_code) (x)->code) == LABEL_REF || ((enum rtx_code) (x)->code) == SYMBOL_REF || ((enum rtx_code) (x)->code) == CONST_INT || ((enum rtx_code) (x)->code) == HIGH || (((enum rtx_code) (x)->code) == CONST && ! (flag_pic && pic_address_needs_scratch (x)) && ((target_flags & 0x00000010) || mips_abi == 0))))
    x = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), x);
 ...
 x = break_out_memory_refs (x);
      ...
      { if (mips_legitimate_address_p (mode, x, 0)) goto win; };
 ...
 goto win2;
      ...
      { register rtx xinsn = (x); if ((target_flags & 0)) { fprintf(stderr, ("\n========== LEGITIMIZE_ADDRESS\n")); debug_rtx(xinsn); } if (mips_split_addresses && mips_check_split (x, mode)) { x = gen_rtx_fmt_ee (LO_SUM, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (copy_to_mode_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), gen_rtx (HIGH, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), x))), (x)); goto win; } if (((enum rtx_code) (xinsn)->code) == CONST && ((flag_pic && pic_address_needs_scratch (xinsn)) || (!(target_flags & 0x00000010) && (mips_abi == 1 || mips_abi == 2)))) { rtx ptr_reg = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)); rtx constant = ((((((xinsn)->fld[0]).rtx))->fld[1]).rtx); emit_move_insn (ptr_reg, ((((((xinsn)->fld[0]).rtx))->fld[0]).rtx)); x = gen_rtx_fmt_ee (PLUS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (ptr_reg), (constant)); if (((unsigned long long) ((((constant)->fld[0]).rtwint) + 0x8000) < 0x10000)) goto win; xinsn = x; } if (((enum rtx_code) (xinsn)->code) == PLUS) { register rtx xplus0 = (((xinsn)->fld[0]).rtx); register rtx xplus1 = (((xinsn)->fld[1]).rtx); register enum rtx_code code0 = ((enum rtx_code) (xplus0)->code); register enum rtx_code code1 = ((enum rtx_code) (xplus1)->code); if (code0 != REG && code1 == REG) { xplus0 = (((xinsn)->fld[1]).rtx); xplus1 = (((xinsn)->fld[0]).rtx); code0 = ((enum rtx_code) (xplus0)->code); code1 = ((enum rtx_code) (xplus1)->code); } if (code0 == REG && mips_reg_mode_ok_for_base_p (xplus0, mode, 0) && code1 == CONST_INT && !((unsigned long long) ((((xplus1)->fld[0]).rtwint) + 0x8000) < 0x10000)) { rtx int_reg = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)); rtx ptr_reg = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)); emit_move_insn (int_reg, gen_rtx_CONST_INT (VOIDmode, (long long) ((((xplus1)->fld[0]).rtwint) & ~ 0x7fff))); emit_insn (gen_rtx_fmt_ee (SET, (VOIDmode), (ptr_reg), (gen_rtx_fmt_ee (PLUS, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (xplus0), (int_reg))))); x = plus_constant_wide ((ptr_reg), (long long) ((((xplus1)->fld[0]).rtwint) & 0x7fff)); goto win; } } if ((target_flags & 0)) fprintf(stderr, ("LEGITIMIZE_ADDRESS could not fix.\n")); };
# 555 "../../../kgccfe/gnu/explow.c"
      if (((enum rtx_code) (x)->code) == PLUS)
 {
 ...
 x = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), x);
  ...
  && ((((x)->fld[0]).rtx) == (global_rtl[GR_VIRTUAL_STACK_ARGS])
      || (((x)->fld[0]).rtx) == (global_rtl[GR_VIRTUAL_INCOMING_ARGS]))))
 {
   if (general_operand (x, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)))
     x = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), x);
   else
     x = force_operand (x, (rtx) 0);
 }
  ...
  if (oldx == x)
    ...
    mark_reg_pointer ((((x)->fld[0]).rtx), 8);
     ...
     rtx ref;
{
  if (((enum rtx_code) (ref)->code) != MEM)
    return ref;
  if (! (flag_force_addr && (((enum rtx_code) ((((ref)->fld[0]).rtx))->code) == LABEL_REF || ((enum rtx_code) ((((ref)->fld[0]).rtx))->code) == SYMBOL_REF || ((enum rtx_code) ((((ref)->fld[0]).rtx))->code) == CONST_INT || ((enum rtx_code) ((((ref)->fld[0]).rtx))->code) == HIGH || (((enum rtx_code) ((((ref)->fld[0]).rtx))->code) == CONST && ! (flag_pic && pic_address_needs_scratch ((((ref)->fld[0]).rtx))) && ((target_flags & 0x00000010) || mips_abi == 0))))
      && memory_address_p (((enum machine_mode) (ref)->mode), (((ref)->fld[0]).rtx)))
    return ref;


  return replace_equiv_address (ref, (((ref)->fld[0]).rtx));
}
...
# 678 "../../../kgccfe/gnu/explow.c"
  if ((((t)->common.readonly_flag) && (tree_code_type[(int) (((enum tree_code) (t)->common.code))] == 'd')
    ...
    || ((((t)->decl.initial))->common.constant_flag)))
     ...
     rtx x;
{
  ...
  if (((enum rtx_code) (x)->code) != MEM
      || ! rtx_unstable_p ((((x)->fld[0]).rtx)))
    return x;

  return
    replace_equiv_address (x, force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), copy_all_regs ((((x)->fld[0]).rtx))));
}
...
copy_addr_to_reg (x)
     rtx x;
{
  return copy_to_mode_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), x);
}
     ...
     rtx x;
{
  ...
  if (((enum machine_mode) (x)->mode) != mode && ((enum machine_mode) (x)->mode) != VOIDmode)
    fancy_abort ("../../../kgccfe/gnu/explow.c", 750, __FUNCTION__);
  if (x != temp)
    emit_move_insn (temp, x);
  return temp;
}
# 764 "../../../kgccfe/gnu/explow.c"
rtx
force_reg (mode, x)
     enum machine_mode mode;
     rtx x;
...
promote_mode (type, mode, punsignedp, for_call)
     ...
     enum machine_mode mode;
     int *punsignedp;
     int for_call __attribute__ ((__unused__));
{
  ...
  switch (code)
    ...
    case CHAR_TYPE: case REAL_TYPE: case OFFSET_TYPE:
      if ((mode_class[(int) (mode)]) == MODE_INT && (mode_size[(int) (mode)]) < 4) (mode) = SImode;;
      break;
# 878 "../../../kgccfe/gnu/explow.c"
    default:
      break;
    }
     ...
     rtx adjust;
{
  ...
  if (((enum rtx_code) (adjust)->code) == CONST_INT)
    (cfun->expr->x_stack_pointer_delta) -= (((adjust)->fld[0]).rtwint);

  temp = expand_binop ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode),
...
round_push (size)
     rtx size;
{
  int align = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128) / 8;
  if (align == 1)
    return size;
  if (((enum rtx_code) (size)->code) == CONST_INT)
    {
      int new = ((((size)->fld[0]).rtwint) + align - 1) / align * align;
      if ((((size)->fld[0]).rtwint) != new)
 size = gen_rtx_CONST_INT (VOIDmode, (long long) (new));
    }
  else
    {
      ...
      size = expand_binop ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (optab_table[OTI_add]), size, gen_rtx_CONST_INT (VOIDmode, (long long) (align - 1)),
      (rtx) 0, 1, OPTAB_LIB_WIDEN);
      size = expand_divmod (0, TRUNC_DIV_EXPR, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), size, gen_rtx_CONST_INT (VOIDmode, (long long) (align)),
       (rtx) 0, 1);
      size = expand_mult ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), size, gen_rtx_CONST_INT (VOIDmode, (long long) (align)), (rtx) 0, 1);
    }
  return size;
}
# 986 "../../../kgccfe/gnu/explow.c"
void
     ...
     rtx after;
{
  ...
  enum machine_mode mode = (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode);


  switch (save_level)
    {
# 1018 "../../../kgccfe/gnu/explow.c"
    default:
      break;
    }
      ...
      if (mode != VOIDmode)
 {
   if (save_level == SAVE_NONLOCAL)
     *psave = sa = assign_stack_local (mode, (mode_size[(int) (mode)]), 0);
   else
    ...
    {
      if (mode == VOIDmode || ((enum machine_mode) (sa)->mode) != mode)
 fancy_abort ("../../../kgccfe/gnu/explow.c", 1038, __FUNCTION__);
    }
     ...
     int known_align;
{
  ...
  if (((enum machine_mode) (size)->mode) != VOIDmode && ((enum machine_mode) (size)->mode) != (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))
    size = convert_to_mode ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), size, 1);




  cfun->preferred_stack_boundary = ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128);
# 1268 "../../../kgccfe/gnu/explow.c"
  if ((((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128) < (mips_abi == 1 || mips_abi == 2 ? 128 : 64)))
    size
      = force_operand (plus_constant_wide ((size), (long long) ((mips_abi == 1 || mips_abi == 2 ? 128 : 64) / 8 - 1)),

         (rtx) 0);
# 1344 "../../../kgccfe/gnu/explow.c"
  if ((((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128) < (mips_abi == 1 || mips_abi == 2 ? 128 : 64)) || known_align % ((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128) != 0)
  ...
  if ((cfun->expr->x_stack_pointer_delta) % (((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128) / 8))
    fancy_abort ("../../../kgccfe/gnu/explow.c", 1353, __FUNCTION__);



  if (flag_stack_check && ! 0)
    probe_stack_range ((4096 - ((target_flags & 0x00002000) ? 8 : 4)) + (75 * ((target_flags & 0x00002000) ? 8 : 4)), size);


  if (target == 0 || ((enum rtx_code) (target)->code) != REG
      || (((target)->fld[0]).rtuint) < 176
      || ((enum machine_mode) (target)->mode) != (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode))
    target = gen_reg_rtx ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode));

  mark_reg_pointer (target, known_align);
# 1392 "../../../kgccfe/gnu/explow.c"
    {
      ...
      if ((cfun->limit_stack))
 {
   ...
   available = expand_binop ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (optab_table[OTI_sub]),
   ...
   emit_cmp_and_jump_insns (available, size, GEU, (rtx) 0, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 1,
       space_available);
  ...
  if ((((mips_abi == 0 || mips_abi == 4 || mips_abi == 3) ? 64 : 128) < (mips_abi == 1 || mips_abi == 2 ? 128 : 64)))
    {
      ...
      target = expand_binop ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (optab_table[OTI_add]), target,
        gen_rtx_CONST_INT (VOIDmode, (long long) ((mips_abi == 1 || mips_abi == 2 ? 128 : 64) / 8 - 1)),
        (rtx) 0, 1, OPTAB_LIB_WIDEN);
      target = expand_divmod (0, TRUNC_DIV_EXPR, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), target,
         gen_rtx_CONST_INT (VOIDmode, (long long) ((mips_abi == 1 || mips_abi == 2 ? 128 : 64) / 8)),
         (rtx) 0, 1);
      target = expand_mult ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), target,
       gen_rtx_CONST_INT (VOIDmode, (long long) ((mips_abi == 1 || mips_abi == 2 ? 128 : 64) / 8)),
       (rtx) 0, 1);
    }
# 1464 "../../../kgccfe/gnu/explow.c"
  ...
  if (stack_check_libfunc != 0)
    {
     ...
     gen_rtx_fmt_ee (MINUS, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode),
              (global_rtl[GR_STACK_POINTER]),
              plus_constant_wide ((size), (long long) (first))));
...
# 1559 "../../../kgccfe/gnu/explow.c"
  else if (((enum rtx_code) (size)->code) == CONST_INT
    && (((size)->fld[0]).rtwint) < 10 * 4096)
    {
      long long offset;
    ...
    offset < (((size)->fld[0]).rtwint);
    offset = offset + 4096)
 emit_stack_probe (gen_rtx_fmt_ee (MINUS, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode),
       (global_rtl[GR_STACK_POINTER]),
       gen_rtx_CONST_INT (VOIDmode, (long long) (offset))));
    ...
    {
      rtx test_addr
 = force_operand (gen_rtx_fmt_ee (MINUS, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode),
      (global_rtl[GR_STACK_POINTER]),
      gen_rtx_CONST_INT (VOIDmode, (long long) (first + 4096))),
    (rtx) 0);
      rtx last_addr
 = force_operand (gen_rtx_fmt_ee (MINUS, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode),
      (global_rtl[GR_STACK_POINTER]),
      plus_constant_wide ((size), (long long) (first))),
    (rtx) 0);
      rtx incr = gen_rtx_CONST_INT (VOIDmode, (long long) (4096));
   ...
   || (((test_addr)->fld[0]).rtuint) < 176)
 test_addr = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), test_addr);
      ...
      temp = expand_binop ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), (optab_table[OTI_sub]), test_addr, incr, test_addr,
      1, OPTAB_WIDEN);
      ...
      if (temp != test_addr)
 fancy_abort ("../../../kgccfe/gnu/explow.c", 1623, __FUNCTION__);

      emit_label (test_lab);
      emit_cmp_and_jump_insns (test_addr, last_addr, GTU,
          (rtx) 0, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), 1, loop_lab);
      emit_jump (end_lab);
     ...
     int outgoing __attribute__ ((__unused__));
{
  rtx val;
    ...
    val = mips_function_value ((valtype), (func), VOIDmode);

  if (((enum rtx_code) (val)->code) == REG
      && ((enum machine_mode) (val)->mode) == BLKmode)
    {
      unsigned long long bytes = int_size_in_bytes (valtype);
    ...
    tmpmode = ((enum machine_mode)mode_wider_mode[(int) (tmpmode)]))
 {
   ...
   if ((mode_size[(int) (tmpmode)]) >= bytes)
     break;
      ...
      if (tmpmode == VOIDmode)
 fancy_abort ("../../../kgccfe/gnu/explow.c", 1681, __FUNCTION__);

      ((val)->mode = (enum machine_mode) (tmpmode));
    }
  return val;
}
...
hard_libcall_value (mode)
     enum machine_mode mode;
{
  return mips_function_value ((tree) ((void *)0), ((void *)0), (mode));
}
...
# 1 "../../../kgccfe/gnu/MIPS/gt-explow.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-explow.h"
