...
# 81 "../../../kgccfe/gnu/profile.c" 2
# 1 "../../../kgccfe/gnu/insn-config.h" 1
# 82 "../../../kgccfe/gnu/profile.c" 2
...
# 88 "../../../kgccfe/gnu/profile.c" 2


# 1 "../../../kgccfe/gnu/gcov-io.h" 1
# 35 "../../../kgccfe/gnu/gcov-io.h"
...
static int __write_long (long, FILE *, size_t)
 __attribute__ ((__unused__));
static int __fetch_gcov_type (gcov_type *, char *, size_t)
 __attribute__ ((__unused__));
static int __store_gcov_type (gcov_type, char *, size_t)
 __attribute__ ((__unused__));
static int __read_gcov_type (gcov_type *, FILE *, size_t)
 __attribute__ ((__unused__));
static int __write_gcov_type (gcov_type, FILE *, size_t)
 __attribute__ ((__unused__));
static int __write_gcov_string (const char *, size_t, FILE*, long)
 __attribute__ ((__unused__));
static int __read_gcov_string (char *, size_t, FILE*, long)
 __attribute__ ((__unused__));
     ...
     size_t bytes;
{
  ...
  if (bytes > 10 || __store_gcov_type (value, c, bytes))
    ...
    return fwrite_unlocked (c, 1, bytes, file) != bytes;
}
     ...
     long delim;
{
  ...
  if (fwrite_unlocked (string, temp, 1, file) != 1)
    return 1;
  ...
  if (temp)
    {
      ...
      if (fwrite_unlocked (c, sizeof (char), 4 - temp, file) != 4 - temp)
 return 1;
    }
     ...
     long delim;
{
  ...
  if (fseek (file, tmp - read_length, 1) < 0)
    return 1;
...
# 95 "../../../kgccfe/gnu/profile.c" 2


# 1 "../../../kgccfe/gnu/defaults.h" 1
# 98 "../../../kgccfe/gnu/profile.c" 2
...
static void init_edge_profiler (void);
static rtx gen_edge_profiler (int);
static void instrument_edges (struct edge_list *);
static void output_gcov_string (const char *, long);
     ...
     struct edge_list *el;
{
      ...
      while (e)
 {
   ...
   if (!inf->ignore && !inf->on_tree)
     {
       if (e->flags & 2)
  fancy_abort ("../../../kgccfe/gnu/profile.c", 202, __FUNCTION__);
       if (rtl_dump_file)
     ...
     long delimiter;
{
  ...
  fwrite_unlocked (string, temp, 1, bb_file);
  ...
  if (temp)
    {
      ...
      c[0] = c[1] = c[2] = c[3] = 0;
      fwrite_unlocked (c, sizeof (char), 4 - temp, bb_file);
    }
...
get_exec_counts ()
{
  ...
  const char *name = ((char *)(decl_assembler_name (current_function_decl))->identifier.id.str);
      ...
      if (__read_long (&extra_bytes, da_file, 4) != 0)
 {
   ...
   break;
      ...
      fseek (da_file, extra_bytes - (4 + 8 + 8), 1);
   ...
   if (strcmp (function_name_buffer, name) != 0)
     {
       ...
       if (fseek (da_file, arc_count * 8, 1) < 0)
  {
    okay = 0;
    break;
  }
...
compute_branch_probabilities ()
{
 ...
 if (!((struct edge_info *) (e)->aux)->ignore)
   ((struct bb_info *) (bb)->aux)->succ_count++;
      for (e = bb->pred; e; e = e->pred_next)
 if (!((struct edge_info *) (e)->aux)->ignore)
   ((struct bb_info *) (bb)->aux)->pred_count++;
    }


  ((struct bb_info *) ((&entry_exit_blocks[1]))->aux)->succ_count = 2;
  ((struct bb_info *) ((&entry_exit_blocks[0]))->aux)->pred_count = 2;
 ...
 if (!((struct edge_info *) (e)->aux)->ignore && !((struct edge_info *) (e)->aux)->on_tree)
  ...
  e->count = exec_counts[exec_counts_pos++];
     ...
     ((struct bb_info *) (bb)->aux)->succ_count--;
     ((struct bb_info *) (e->dest)->aux)->pred_count--;
     if (rtl_dump_file)
       {
  fprintf (rtl_dump_file, "\nRead edge from %i to %i, count:",
    bb->index, e->dest->index);
  fprintf (rtl_dump_file, "%lld",
    (long long) e->count);
       }
   }
    }
...
# 514 "../../../kgccfe/gnu/profile.c"
  ...
  while (changes)
    {
      passes++;
      changes = 0;
      for (bb = (&entry_exit_blocks[1]); bb != ((void *)0); bb = bb->prev_bb)
 {
   struct bb_info *bi = ((struct bb_info *) (bb)->aux);
   if (! bi->count_valid)
     {
       if (bi->succ_count == 0)
  {
       ...
       if (bi->succ_count == 1)
  {
    ...
    if (! e)
      fancy_abort ("../../../kgccfe/gnu/profile.c", 569, __FUNCTION__);
    ((struct edge_info *) (e)->aux)->count_valid = 1;
    e->count = total;
    bi->succ_count--;
       ...
       if (bi->pred_count == 1)
  {
    ...
    if (! e)
      fancy_abort ("../../../kgccfe/gnu/profile.c", 596, __FUNCTION__);
    ((struct edge_info *) (e)->aux)->count_valid = 1;
    e->count = total;
    bi->pred_count--;

    ((struct bb_info *) (e->src)->aux)->succ_count--;
    changes = 1;
  }
     }
 }
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      if (((struct bb_info *) (bb)->aux)->succ_count || ((struct bb_info *) (bb)->aux)->pred_count)
 fancy_abort ("../../../kgccfe/gnu/profile.c", 619, __FUNCTION__);
    }
      ...
      if (total)
 {
  ...
  index = 19;
       ...
       if (note)
  (((note)->fld[0]).rtx) = gen_rtx_CONST_INT (VOIDmode, (long long) (prob));
       else
  (((bb->end)->fld[8]).rtx)
    = gen_rtx_fmt_ee (EXPR_LIST, (REG_BR_PROB), (gen_rtx_CONST_INT (VOIDmode, (long long) (prob))), ((((bb->end)->fld[8]).rtx)));
  ...
  for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
    {
      ...
      for (e = bb->succ; e; e = e->succ_next)
 {
   chsum = ((chsum << 2) + (((e->dest) == (&entry_exit_blocks[0]) ? 0 : ((e->dest) == (&entry_exit_blocks[1]) ? last_basic_block + 1 : (e->dest)->index + 1)) + 1)) % 500000003;
 }

      chsum = (chsum << 2) % 500000003;
    }

  return chsum;
}
# 780 "../../../kgccfe/gnu/profile.c"
void
branch_prob ()
{
  basic_block bb;
...
# 814 "../../../kgccfe/gnu/profile.c"
    ...
    insn = (((insn)->fld[2]).rtx))
 {
   if (((enum rtx_code) (insn)->code) == CALL_INSN
     ...
     {
       if (((enum rtx_code) (bb->head)->code) == CODE_LABEL
    || insn != (((bb->head)->fld[2]).rtx))
  {
    e = split_block (bb, (((insn)->fld[1]).rtx));
    make_edge ((&entry_exit_blocks[0]), e->dest, 16);
    break;
  }
       else
  {
    ...
    if (bb == (&entry_exit_blocks[0]))
      fancy_abort ("../../../kgccfe/gnu/profile.c", 843, __FUNCTION__);
    make_edge ((&entry_exit_blocks[0]), bb, 16);
  }
     }
 }
      ...
      if (need_exit_edge && !have_exit_edge)
 {
   if (rtl_dump_file)
     fprintf (rtl_dump_file, "Adding fake exit edge to bb %i\n",
       bb->index);
   make_edge (bb, (&entry_exit_blocks[1]), 16);
 }
  ...
  for (i = 0 ; i < num_edges ; i++)
    {
      ...
      if ((e->flags & (2 | 4))
   && e->src != (&entry_exit_blocks[0]) && e->dest != (&entry_exit_blocks[1]))
 {
      ...
      for (bb = (&entry_exit_blocks[0])->next_bb; bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
 {
       ...
       if (((enum rtx_code) (insn)->code) == NOTE)
  {
    ...
    if ((((insn)->fld[5]).rtint) == NOTE_INSN_REPEATED_LINE_NUMBER)
      ignore_next_note = 1;
        ...
        else
   {
     ...
     if (! last_bb_file_name
         || strcmp ((((insn)->fld[4]).rtstr),
      last_bb_file_name))
       {
         if (last_bb_file_name)
    free (last_bb_file_name);
         last_bb_file_name
    = xstrdup ((((insn)->fld[4]).rtstr));
         output_gcov_string ((((insn)->fld[4]).rtstr),
        (long)-1);
       }
     ...
     __write_long ((((insn)->fld[5]).rtint), bb_file, 4);
   }
      }
  }
       insn = (((insn)->fld[2]).rtx);
  ...
  for (i = 0; i < num_edges; i++)
    {
      edge e = ((el)->index_to_edge[(i)]);
      struct edge_info *inf = ((struct edge_info *) (e)->aux);
      if ((e->flags & 16) && !inf->ignore && !inf->on_tree)
 {
   inf->ignore = 1;
   ignored_edges++;
 }
      ...
      for (bb = (&entry_exit_blocks[0]); bb != (&entry_exit_blocks[1]); bb = bb->next_bb)
 {
       ...
       if (!i->ignore)
  {
    ...
    __write_long (((e->dest) == (&entry_exit_blocks[0]) ? 0 : ((e->dest) == (&entry_exit_blocks[1]) ? last_basic_block + 1 : (e->dest)->index + 1)), bbg_file, 4);
     ...
     basic_block bb1, bb2;
{
  ...
  if (bb1g == bb2g)
    fancy_abort ("../../../kgccfe/gnu/profile.c", 1114, __FUNCTION__);

  bb1g->aux = bb2g;
}
# 1126 "../../../kgccfe/gnu/profile.c"
static void
find_spanning_tree (el)
     struct edge_list *el;
{
  ...
  union_groups ((&entry_exit_blocks[1]), (&entry_exit_blocks[0]));
  ...
  const char *filename;
{
  ...
  if (flag_test_coverage)
    {
      ...
      data_file = (char *) __builtin_alloca(len + 4);
 ...
 fatal_io_error ("can't open %s", data_file);
      ...
      bbg_file_name = (char *) __builtin_alloca(len + 5);
...
init_edge_profiler ()
{
  ...
  char buf[20];
  sprintf ((buf), "*%s%s%ld", ("$"), ("LPBX"), (long)(2));
  profiler_label = gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (ggc_alloc_string((buf), -1)));
}
...
gen_edge_profiler (edgeno)
     int edgeno;
{
  enum machine_mode mode = mode_for_size (64, MODE_INT, 0);
  rtx mem_ref, tmp;
  rtx sequence;

  start_sequence ();

  tmp = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode), profiler_label);
  tmp = plus_constant_wide ((tmp), (long long) (64 / 8 * edgeno));
  mem_ref = validize_mem (gen_rtx_MEM (mode, tmp));

  set_mem_alias_set (mem_ref, new_alias_set ());

  tmp = expand_simple_binop (mode, PLUS, mem_ref, (const_int_rtx[64 +1]),
...
# 1378 "../../../kgccfe/gnu/profile.c"
  fnname = get_file_function_name ('I');
  cfnname = ((char *)(fnname)->identifier.id.str);
  name = concat (cfnname, "GCOV", ((void *)0));
  fnname = (__builtin_constant_p (name) ? get_identifier_with_length ((name), (unsigned) strlen (name)) : (get_identifier) (name));
  free (name);

  fndecl = build_decl (FUNCTION_DECL, fnname,
         build_function_type (global_trees[TI_VOID_TYPE], (tree) ((void *)0)));
  ((fndecl)->decl.external_flag) = 0;



  ((fndecl)->common.public_flag) = ! targetm.have_ctors_dtors;

  ((fndecl)->common.used_flag) = 1;

  ((fndecl)->decl.result) = build_decl (RESULT_DECL, (tree) ((void *)0), global_trees[TI_VOID_TYPE]);
  ...
  sprintf ((buf), "*%s%s%ld", ("$"), ("LPBX"), (long)(0));
  table_address = force_reg ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode),
        gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), (ggc_alloc_string((buf), -1))));
  emit_library_call (gen_rtx_fmt_s (SYMBOL_REF, ((((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode)), ("__bb_init_func")), LCT_NORMAL,
       mode, 1, table_address, (((target_flags & 0x00000002) && (target_flags & 0x00002000)) ? DImode : SImode));
  ...
  if (targetm.have_ctors_dtors)
    (* targetm.asm_out.constructor) ((((((fndecl)->decl.rtl ? (fndecl)->decl.rtl : (make_decl_rtl (fndecl, ((void *)0)), (fndecl)->decl.rtl)))->fld[0]).rtx),
         65535);
}

# 1 "../../../kgccfe/gnu/MIPS/gt-profile.h" 1
# 25 "../../../kgccfe/gnu/MIPS/gt-profile.h"
const struct ggc_root_tab gt_ggc_r_gt_profile_h[] = {
  {
    &profiler_label,
    1,
    sizeof (profiler_label),
    &gt_ggc_mx_rtx_def

  },
  { ((void *)0), 0, 0, ((void *)0) }
};
# 1436 "../../../kgccfe/gnu/profile.c" 2
