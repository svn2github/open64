# 1 "../../../kgccfe/gnu/read-rtl.c"
# 1 "/usa/handong/simplnano/cmplr-open64-merge/targia32_sl1/gccfe/gnu//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../../kgccfe/gnu/read-rtl.c"
# 28 "../../../kgccfe/gnu/read-rtl.c"
# 1 "../../../kgccfe/gnu/MIPS/hconfig.h" 1




# 1 "../../../kgccfe/gnu/MIPS/auto-host.h" 1
# 6 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
...
# 21 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kgccfe/gnu/config/dbxelf.h" 1
# 22 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kgccfe/gnu/config/elfos.h" 1
# 23 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kgccfe/gnu/config/svr4.h" 1
# 24 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kgccfe/gnu/MIPS/linux.h" 1
# 25 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
...
# 26 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kgccfe/gnu/MIPS/linux.h" 1
# 27 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
# 1 "../../../kgccfe/gnu/defaults.h" 1
# 28 "../../../kgccfe/gnu/MIPS/hconfig.h" 2
# 29 "../../../kgccfe/gnu/read-rtl.c" 2
...
# 33 "../../../kgccfe/gnu/read-rtl.c" 2

static htab_t md_constants;

static void fatal_with_file_and_line (FILE *, const char *, ...)
  __attribute__ ((__format__ (__printf__, 2, 3))) __attribute__ ((__nonnull__ (2))) __attribute__ ((__noreturn__));
static void fatal_expected_char (FILE *, int, int) __attribute__ ((__noreturn__));
     ...
     FILE *infile;
{
  ...
  switch (c)
    ...
    case '\'':
      break;
# 255 "../../../kgccfe/gnu/read-rtl.c"
    case 'a': case 'b': case 'f': case 'n': case 'r': case 't': case 'v':
    case '0': case '1': case '2': case '3': case '4': case '5': case '6':
    case '7': case 'x':
      __extension__ ({ struct obstack *__o = (ob); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('\\'); (void) 0; });
      break;



    case ';':
      __extension__ ({ struct obstack *__o = (ob); int __len = (4); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), (("\\n\\t")), (__len)); __o->next_free += __len; (void) 0; });
      return;
  ...
  __extension__ ({ struct obstack *__o = (ob); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (c); (void) 0; });
}
     ...
     const void *def;
{
  ...
  for (result = i = 0;*string++ != '\0'; i++)
    result += ((unsigned char) *string << (i % 8));
  return result;
}
     ...
     const char *string;
{
  ...
  cp = string;
  while (*cp && (_sch_istable[(*cp) & 0xff] & (unsigned short)(_sch_isspace)))
    cp++;
  if (*cp == '-' || *cp == '+')
    cp++;
  if (*cp == 0)
    valid = 0;
  for (; *cp; cp++)
    if (! (_sch_istable[(*cp) & 0xff] & (unsigned short)(_sch_isdigit)))
      valid = 0;
  if (!valid)
     ...
     FILE *infile;
{
  ...
  if (!initialized) {
    _obstack_begin ((&rtl_obstack), 0, 0, (void *(*) (long)) xmalloc, (void (*) (void *)) free);
    initialized = 1;
  }
...
# 592 "../../../kgccfe/gnu/read-rtl.c"
 ...
 fatal_with_file_and_line (infile, "unknown mode `%s'", tmp_char);
      ...
      ((return_rtx)->mode = (enum machine_mode) ((enum machine_mode) j));
    }
  else
    ungetc (i, infile);
      ...
      case 'E':
 {
   ...
   _obstack_begin ((&vector_stack), 0, 0, (void *(*) (long)) xmalloc, (void (*) (void *)) free);
   while ((c = read_skip_spaces (infile)) && c != ']')
     {
       ungetc (c, infile);
       list_counter++;
       __extension__ ({ struct obstack *__o = (&vector_stack); if (__o->next_free + sizeof (void *) > __o->chunk_limit) _obstack_newchunk (__o, sizeof (void *)); *((void **)__o->next_free) = ((void *)(void *) read_rtx (infile)); (__o->next_free) += 4 ; (void) 0; });
     }
   if (list_counter > 0)
     {
       return_vec = rtvec_alloc (list_counter);
       memcpy (&return_vec->elem[0], __extension__ ({ struct obstack *__o1 = (&vector_stack); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; }),
        list_counter * sizeof (rtx));
     }
   (((return_rtx)->fld[i]).rtvec) = return_vec;
   __extension__ ({ struct obstack *__o = (&vector_stack); void *__obj = (((void *)0)); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });
      ...
      case 's':
 {
  ...
  if (*slash == '/' || *slash == '\\' || *slash == ':')
    fn = slash + 1;
       __extension__ ({ struct obstack *__o = (&rtl_obstack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('*'); (void) 0; });
       __extension__ ({ struct obstack *__o = (&rtl_obstack); int __len = (strlen (fn)); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((fn)), (__len)); __o->next_free += __len; (void) 0; });
       sprintf (line_name, ":%d", read_rtx_lineno);
       __extension__ ({ struct obstack *__o = (&rtl_obstack); int __len = (strlen (line_name)+1); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((line_name)), (__len)); __o->next_free += __len; (void) 0; });
       stringbuf = (char *) __extension__ ({ struct obstack *__o1 = (&rtl_obstack); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; });
     }
...
# 756 "../../../kgccfe/gnu/read-rtl.c"
 ...
 fancy_abort ("../../../kgccfe/gnu/read-rtl.c", 778, __FUNCTION__);
      }
