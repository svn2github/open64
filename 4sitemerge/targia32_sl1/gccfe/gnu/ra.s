...
.LFE18:
	...
	.section	.rodata
	.type	__FUNCTION__.11779, @object
	.size	__FUNCTION__.11779, 17
__FUNCTION__.11779:
	.string	"create_insn_info"
.LC0:
	.string	"../../../kgccfe/gnu/ra.c"
	.text
...
.L33:
	...
	jae	.L76
	.loc 1 282 0
	leal	__FUNCTION__.11779@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$282, 4(%esp)
...
.LFE20:
	...
	.section	.rodata
	.type	__FUNCTION__.11965, @object
	.size	__FUNCTION__.11965, 12
__FUNCTION__.11965:
	.string	"find_subweb"
	.text
.globl find_subweb
...
.LCFI31:
	...
	je	.L82
	.loc 1 308 0
	leal	__FUNCTION__.11965@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$308, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE28:
	...
	.section	.rodata
	.type	__FUNCTION__.12234, @object
	.size	__FUNCTION__.12234, 8
__FUNCTION__.12234:
	.string	"init_ra"
	.align 32
	.type	eliminables.12179, @object
	.size	eliminables.12179, 72
eliminables.12179:
	.long	0
	.long	29
	.long	0
...
.L150:
	.loc 1 489 0
	movl	-84(%ebp), %eax
	movl	eliminables.12179@GOTOFF(%ebx,%eax,8), %eax
	cmpl	$75, %eax
	jne	.L151
	movl	-84(%ebp), %eax
	movl	4+eliminables.12179@GOTOFF(%ebx,%eax,8), %eax
	cmpl	$29, %eax
	jne	.L153
...
.L236:
	...
	jne	.L238
	.loc 1 561 0
	leal	__FUNCTION__.12234@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$561, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE29:
	...
	.section	.rodata
	.type	__FUNCTION__.12531, @object
	.size	__FUNCTION__.12531, 9
__FUNCTION__.12531:
	.string	"check_df"
	.text
...
.L264:
	.loc 1 606 0
	leal	__FUNCTION__.12531@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$606, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
