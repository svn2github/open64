...
deps_may_trap_p:
.LFB15:
	.file 1 "../../../kgccfe/gnu/sched-deps.c"
	.loc 1 101 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LFE18:
	...
	.section	.rodata
	.type	__FUNCTION__.10571, @object
	.size	__FUNCTION__.10571, 15
__FUNCTION__.10571:
	.string	"add_dependence"
	.align 4
.LC0:
	.string	"../../../kgccfe/gnu/sched-deps.c"
	.text
...
.L71:
	.loc 1 273 0
	leal	__FUNCTION__.10571@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$273, 4(%esp)
...
.LFE21:
	...
	.section	.rodata
	.type	__FUNCTION__.11218, @object
	.size	__FUNCTION__.11218, 18
__FUNCTION__.11218:
...
.L134:
	...
	jne	.L152
	.loc 1 434 0
	leal	__FUNCTION__.11218@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$434, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE26:
	...
	.section	.rodata
	.type	__FUNCTION__.11488, @object
	.size	__FUNCTION__.11488, 16
__FUNCTION__.11488:
...
.LBE5:
	...
	je	.L230
	.loc 1 621 0
	leal	__FUNCTION__.11488@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$621, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE27:
	...
	.section	.rodata
	.type	__FUNCTION__.11670, @object
	.size	__FUNCTION__.11670, 16
__FUNCTION__.11670:
...
.LBE9:
	...
	je	.L319
	.loc 1 759 0
	leal	__FUNCTION__.11670@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$759, 4(%esp)
	leal	.LC0@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE29:
	...
	.section	.rodata
	.type	__FUNCTION__.12489, @object
	.size	__FUNCTION__.12489, 14
__FUNCTION__.12489:
...
.LEFDE46:
	...
	.file 10 "../../../kgccfe/gnu/sched-int.h"
