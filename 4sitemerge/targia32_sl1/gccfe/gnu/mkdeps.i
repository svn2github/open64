     ...
     const char *tgt;
{
  ...
  if (tgt[0] == '\0')
  ...
  else
    {
      ...
      char *o = (char *) __builtin_alloca(strlen (start) + strlen (".o") + 1);
      char *suffix;
