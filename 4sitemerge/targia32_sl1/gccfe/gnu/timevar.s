...
.LFE17:
	...
	.section	.rodata
	.type	__FUNCTION__.8393, @object
	.size	__FUNCTION__.8393, 13
__FUNCTION__.8393:
	.string	"timevar_push"
.LC52:
	.string	"../../../kgccfe/gnu/timevar.c"
	.text
.globl timevar_push
...
.LCFI13:
	...
	je	.L14
	.loc 1 285 0
	leal	__FUNCTION__.8393@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$285, 4(%esp)
...
.LFE18:
	...
	.section	.rodata
	.type	__FUNCTION__.8422, @object
	.size	__FUNCTION__.8422, 12
__FUNCTION__.8422:
	.string	"timevar_pop"
	.align 4
.LC53:
...
.LCFI17:
	...
	call	sorry@PLT
	.loc 1 336 0
	leal	__FUNCTION__.8422@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$336, 4(%esp)
	leal	.LC52@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LFE19:
	...
	.section	.rodata
	.type	__FUNCTION__.8447, @object
	.size	__FUNCTION__.8447, 14
__FUNCTION__.8447:
...
.LCFI21:
	...
	je	.L31
	.loc 1 377 0
	leal	__FUNCTION__.8447@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$377, 4(%esp)
	leal	.LC52@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
...
.LCFI25:
	...
	jne	.L37
	.loc 1 398 0
	leal	__FUNCTION__.8463@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$398, 4(%esp)
	leal	.LC52@GOTOFF(%ebx), %eax
	movl	%eax, (%esp)
