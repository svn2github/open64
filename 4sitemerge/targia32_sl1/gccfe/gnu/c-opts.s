...
.LC96:
	.string	"fenum-int-equiv"
.LC97:
	.string	"fexternal-templates"
.LC98:
	.string	"ffixed-form"
.LC99:
	.string	"ffixed-line-length-"
.LC100:
	.string	"ffor-scope"
.LC101:
...
.LC114:
	.string	"fname-mangling-version-"
.LC115:
	.string	"fnew-abi"
.LC116:
	.string	"fnext-runtime"
.LC117:
	.string	"fnonansi-builtins"
.LC118:
	.string	"fnonnull-objects"
.LC119:
...
.LC132:
	.string	"fstats"
.LC133:
	.string	"fstrict-prototype"
.LC134:
	.string	"ftabstop="
.LC135:
	.string	"ftemplate-depth-"
.LC136:
	.string	"fthis-is-variable"
.LC137:
...
.LC152:
	.string	"print-objc-runtime-info"
.LC153:
	.string	"remap"
.LC154:
	.string	"std=c++98"
...
.LC171:
	...
	.align 4
.LC172:
	.string	"no class name specified with \"-%s\""
.LC173:
	.string	"missing filename after \"-%s\""
.LC174:
	.string	"missing target after \"-%s\""
	.text
	.type	missing_arg, @function
missing_arg:
.LFB15:
	.file 1 "../../../kgccfe/gnu/c-opts.c"
	.loc 1 343 0
	pushl	%ebp
.LCFI0:
	movl	%esp, %ebp
...
.LCFI3:
	...
	.loc 1 344 0
	movl	8(%ebp), %eax
	movl	cl_options@GOTOFF(%ebx,%eax,8), %eax
	movl	%eax, -8(%ebp)
	.loc 1 346 0
	movl	8(%ebp), %eax
	movzwl	6+cl_options@GOTOFF(%ebx,%eax,8), %eax
	movzwl	%ax, %eax
	movl	%eax, -24(%ebp)
	cmpl	$13, -24(%ebp)
	jg	.L6
...
.L8:
	...
	ret
.LFE15:
	.size	missing_arg, .-missing_arg
	.type	find_opt, @function
find_opt:
.LFB16:
	.loc 1 393 0
	pushl	%ebp
...
.L11:
	...
	.loc 1 406 0
	movl	-28(%ebp), %eax
	movzbl	4+cl_options@GOTOFF(%ebx,%eax,8), %eax
	movzbl	%al, %eax
	movl	%eax, -16(%ebp)
	.loc 1 407 0
	movl	-28(%ebp), %eax
	movl	cl_options@GOTOFF(%ebx,%eax,8), %edx
	movl	-16(%ebp), %eax
	movl	%eax, 8(%esp)
	movl	%edx, 4(%esp)
	movl	8(%ebp), %eax
...
.L16:
	...
	.loc 1 425 0
	movl	-28(%ebp), %eax
	movzbl	5+cl_options@GOTOFF(%ebx,%eax,8), %eax
	movzbl	%al, %eax
	andl	$16, %eax
	testl	%eax, %eax
	je	.L10
...
.L18:
	...
	ret
.LFE16:
	.size	find_opt, .-find_opt
	.section	.rodata
	.type	__FUNCTION__.10448, @object
	.size	__FUNCTION__.10448, 10
__FUNCTION__.10448:
	.string	"defer_opt"
.LC175:
	.string	"../../../kgccfe/gnu/c-opts.c"
	.text
	.type	defer_opt, @function
defer_opt:
.LFB17:
	.loc 1 472 0
	pushl	%ebp
...
.LCFI11:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 475 0
	movl	deferred_opts@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L35
	.loc 1 478 0
	movl	save_argc@GOT(%ebx), %eax
	movl	(%eax), %eax
	movl	%eax, deferred_size@GOTOFF(%ebx)
	.loc 1 479 0
	movl	deferred_size@GOTOFF(%ebx), %eax
	sall	$3, %eax
	movl	%eax, (%esp)
	call	xmalloc@PLT
	movl	%eax, deferred_opts@GOTOFF(%ebx)
.L35:
	.loc 1 483 0
	movl	deferred_count@GOTOFF(%ebx), %edx
	movl	deferred_size@GOTOFF(%ebx), %eax
	cmpl	%eax, %edx
	jne	.L37
	.loc 1 484 0
	leal	__FUNCTION__.10448@GOTOFF(%ebx), %eax
	movl	%eax, 8(%esp)
	movl	$484, 4(%esp)
...
.L37:
	.loc 1 486 0
	movl	deferred_count@GOTOFF(%ebx), %eax
	sall	$3, %eax
	movl	%eax, %edx
	movl	deferred_opts@GOTOFF(%ebx), %eax
	addl	%eax, %edx
	...
	movl	deferred_count@GOTOFF(%ebx), %eax
	addl	$1, %eax
	movl	%eax, deferred_count@GOTOFF(%ebx)
	.loc 1 489 0
	addl	$20, %esp
	popl	%ebx
	popl	%ebp
...
.LFE18:
	...
	.section	.rodata
	.align 4
	.type	lang_flags.10496, @object
	.size	lang_flags.10496, 16
lang_flags.10496:
	.long	1
	.long	3
	.long	4
	...
	.align 4
.LC176:
	.string	"too many filenames given.  Type %s --help for usage"
	.align 4
.LC177:
	.string	"-Wno-strict-prototypes is not supported in C++"
	.align 4
.LC178:
	.string	"switch \"%s\" is no longer supported"
	.align 4
.LC179:
	.string	"switch \"%s\" is deprecated, please see documentation for details"
	.align 4
.LC180:
	.string	"-fhandle-exceptions has been renamed to -fexceptions (and is now on by default)"
	.align 4
.LC181:
	.string	"output filename specified twice"
	.text
.globl c_common_decode_option
	.type	c_common_decode_option, @function
...
.L50:
	.loc 1 546 0
	movl	in_fname@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L53
	.loc 1 547 0
	movl	-52(%ebp), %eax
	movl	%eax, in_fname@GOTOFF(%ebx)
	jmp	.L55
.L53:
	.loc 1 548 0
	movl	out_fname@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L56
	.loc 1 549 0
	movl	-52(%ebp), %eax
	movl	%eax, out_fname@GOTOFF(%ebx)
	jmp	.L55
.L56:
	.loc 1 552 0
...
.LBE2:
	...
	movl	(%eax), %eax
	leal	(%edx,%eax), %eax
	movl	lang_flags.10496@GOTOFF(%ebx,%eax,4), %eax
	movl	%eax, -36(%ebp)
	.loc 1 578 0
	movl	-52(%ebp), %edx
	addl	$1, %edx
	...
	sall	$3, %eax
	movl	%eax, %edx
	leal	cl_options@GOTOFF(%ebx), %eax
	leal	(%edx,%eax), %eax
	movl	%eax, -32(%ebp)
	.loc 1 586 0
	movl	-32(%ebp), %eax
...
.L83:
	.loc 1 642 0
	movl	flag_preprocess_only@GOT(%ebx), %eax
	movl	$1, (%eax)
	.loc 1 643 0
	jmp	.L65
.L84:
...
.L233:
	...
	.loc 1 663 0
	movl	-48(%ebp), %eax
	movl	%eax, deps_file@GOTOFF(%ebx)
	.loc 1 664 0
	jmp	.L65
.L87:
	.loc 1 667 0
	movb	$1, deps_seen@GOTOFF(%ebx)
	.loc 1 668 0
	movl	-48(%ebp), %eax
	movl	%eax, deps_file@GOTOFF(%ebx)
	.loc 1 669 0
...
.L135:
	.loc 1 911 0
	movzbl	-13(%ebp), %edx
	movl	warn_protocol@GOT(%ebx), %eax
	movl	%edx, (%eax)
	.loc 1 912 0
	jmp	.L65
.L139:
	.loc 1 915 0
	movzbl	-13(%ebp), %edx
	movl	warn_selector@GOT(%ebx), %eax
	movl	%edx, (%eax)
	.loc 1 916 0
	jmp	.L65
.L136:
...
.L148:
	.loc 1 967 0
	movzbl	-13(%ebp), %edx
	movl	warn_undeclared_selector@GOT(%ebx), %eax
	movl	%edx, (%eax)
	.loc 1 968 0
	jmp	.L65
.L149:
...
.L263:
	...
	movl	-48(%ebp), %eax
	movl	%eax, (%esp)
	call	disable_builtin_function@PLT
	.loc 1 1056 0
	jmp	.L65
.L168:
	.loc 1 1059 0
	movzbl	-13(%ebp), %edx
	movl	dollars_in_ident@GOT(%ebx), %eax
	movl	%edx, (%eax)
	.loc 1 1060 0
	jmp	.L65
.L169:
...
.L196:
	.loc 1 1091 0
	movzbl	-13(%ebp), %eax
	movl	flag_signed_bitfields@GOT(%ebx), %edx
	movl	%eax, (%edx)
	.loc 1 1092 0
	movl	explicit_flag_signed_bitfields@GOT(%ebx), %eax
	movl	$1, (%eax)
	.loc 1 1093 0
	jmp	.L65
.L197:
...
.L164:
	.loc 1 1113 0
	movzbl	-13(%ebp), %edx
	movl	flag_conserve_space@GOT(%ebx), %eax
	movl	%edx, (%eax)
	.loc 1 1114 0
	jmp	.L65
.L165:
...
.L166:
	.loc 1 1121 0
	movl	constant_string_class_name@GOT(%ebx), %edx
	movl	-48(%ebp), %eax
	movl	%eax, (%edx)
	.loc 1 1122 0
	jmp	.L65
...
.L187:
	.loc 1 1193 0
	movzbl	-13(%ebp), %edx
	movl	flag_optional_diags@GOT(%ebx), %eax
	movl	%edx, (%eax)
	.loc 1 1194 0
	jmp	.L65
.L188:
...
.L206:
	.loc 1 1253 0
	movl	flag_gen_declaration@GOT(%ebx), %eax
	movl	$1, (%eax)
	.loc 1 1254 0
	jmp	.L65
.L207:
...
.L214:
	.loc 1 1297 0
	movl	print_struct_values@GOT(%ebx), %eax
	movl	$1, (%eax)
	.loc 1 1298 0
	jmp	.L65
.L215:
...
.L58:
	...
	ret
.LFE19:
	.size	c_common_decode_option, .-c_common_decode_option
	.section	.rodata
.LC182:
	.string	"-"
.LC183:
...
.LC185:
	...
	.align 4
.LC186:
	.string	"-Wformat-zero-length ignored without -Wformat"
	.align 4
.LC187:
...
.L294:
	...
	jne	.L295
	.loc 1 1370 0
	call	check_deps_environment_vars
.L295:
	.loc 1 1372 0
	call	handle_deferred_opts
	.loc 1 1374 0
	call	sanitize_cpp_opts
	.loc 1 1376 0
...
.LFE20:
	...
	.section	.rodata
.LC190:
	.string	"opening output file %s"
	.text
	.type	preprocess_file, @function
preprocess_file:
.LFB21:
	.loc 1 1416 0
	pushl	%ebp
...
.LCFI31:
	...
	movl	(%eax), %eax
	movl	%eax, out_stream@GOTOFF(%ebx)
	jmp	.L324
.L322:
	.loc 1 1423 0
	movl	out_fname@GOTOFF(%ebx), %eax
	leal	.LC170@GOTOFF(%ebx), %edx
	movl	%edx, 4(%esp)
	movl	%eax, (%esp)
	call	fopen@PLT
	movl	%eax, out_stream@GOTOFF(%ebx)
.L324:
	.loc 1 1425 0
	movl	out_stream@GOTOFF(%ebx), %eax
	testl	%eax, %eax
	jne	.L325
	.loc 1 1426 0
	movl	out_fname@GOTOFF(%ebx), %eax
...
.L325:
	.loc 1 1428 0
	movl	out_stream@GOTOFF(%ebx), %edx
	movl	in_fname@GOTOFF(%ebx), %ecx
	movl	parse_in@GOT(%ebx), %eax
	movl	(%eax), %eax
	movl	%edx, 8(%esp)
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	call	cpp_preprocess_file@PLT
	.loc 1 1429 0
	addl	$20, %esp
	popl	%ebx
	popl	%ebp
	ret
.LFE21:
	.size	preprocess_file, .-preprocess_file
.globl c_common_init
...
.LCFI35:
	...
	movl	%eax, %edx
	movl	cb_register_builtins@GOT(%ebx), %eax
	movl	%eax, 28(%edx)
	.loc 1 1449 0
	movl	flag_preprocess_only@GOT(%ebx), %eax
	movl	(%eax), %eax
...
.LC191:
	.string	"a"
.LC192:
	.string	"opening dependency file %s"
.LC193:
	.string	"closing dependency file %s"
.LC194:
	.string	"when writing output to %s"
	.text
...
.L336:
	.loc 1 1479 0
	movzbl	deps_append@GOTOFF(%ebx), %eax
	testb	%al, %al
	je	.L338
...
.LC196:
	...
	.text
	.type	check_deps_environment_vars, @function
...
.LBE4:
	...
	ret
.LFE24:
	.size	check_deps_environment_vars, .-check_deps_environment_vars
	.section	.rodata
	.type	__FUNCTION__.11260, @object
	.size	__FUNCTION__.11260, 21
__FUNCTION__.11260:
	.string	"handle_deferred_opts"
	.text
	.type	handle_deferred_opts, @function
...
.LBB5:
	...
	movl	%ecx, 4(%esp)
	movl	%eax, (%esp)
	call	cpp_add_dependency_target@PLT
.LBE5:
	.loc 1 1547 0
	addl	$1, -12(%ebp)
	jmp	.L365
...
.LBE6:
	...
	ret
.LFE25:
	.size	handle_deferred_opts, .-handle_deferred_opts
	.section	.rodata
	.align 4
.LC197:
	.string	"to generate dependencies you must specify either -M or -MM"
	.text
	.type	sanitize_cpp_opts, @function
sanitize_cpp_opts:
.LFB26:
	.loc 1 1570 0
	pushl	%ebp
...
.LCFI53:
	...
	addl	$_GLOBAL_OFFSET_TABLE_, %ebx
	.loc 1 1573 0
	movzbl	deps_seen@GOTOFF(%ebx), %eax
	testb	%al, %al
	je	.L372
	movl	cpp_opts@GOTOFF(%ebx), %eax
	movl	76(%eax), %eax
...
.L386:
	...
	ret
.LFE26:
	.size	sanitize_cpp_opts, .-sanitize_cpp_opts
	.type	set_std_c89, @function
set_std_c89:
.LFB27:
	.loc 1 1604 0
	pushl	%ebp
...
.L394:
	...
	call	cpp_set_lang@PLT
	.loc 1 1606 0
	movl	flag_iso@GOT(%ebx), %edx
	movl	12(%ebp), %eax
	movl	%eax, (%edx)
	.loc 1 1607 0
	movl	flag_no_asm@GOT(%ebx), %edx
	movl	12(%ebp), %eax
	movl	%eax, (%edx)
	.loc 1 1608 0
	movl	flag_no_gnu_keywords@GOT(%ebx), %edx
	movl	12(%ebp), %eax
	movl	%eax, (%edx)
	.loc 1 1609 0
	movl	flag_no_nonansi_builtin@GOT(%ebx), %edx
	movl	12(%ebp), %eax
	movl	%eax, (%edx)
	.loc 1 1610 0
	cmpl	$0, 12(%ebp)
	...
	ret
.LFE27:
	.size	set_std_c89, .-set_std_c89
	.type	set_std_c99, @function
set_std_c99:
.LFB28:
	.loc 1 1620 0
	pushl	%ebp
...
.L399:
	...
	ret
.LFE28:
	.size	set_std_c99, .-set_std_c99
	.type	set_std_cxx98, @function
set_std_cxx98:
.LFB29:
	.loc 1 1635 0
	pushl	%ebp
...
.L404:
	...
	ret
.LFE29:
	.size	set_std_cxx98, .-set_std_cxx98
	.type	set_Wimplicit, @function
set_Wimplicit:
.LFB30:
	.loc 1 1647 0
	pushl	%ebp
...
.LCFI67:
	...
	.loc 1 1648 0
	movl	warn_implicit@GOT(%ecx), %edx
	movl	8(%ebp), %eax
	movl	%eax, (%edx)
	.loc 1 1649 0
	movl	warn_implicit_int@GOT(%ecx), %edx
	movl	8(%ebp), %eax
	movl	%eax, (%edx)
	.loc 1 1650 0
	cmpl	$0, 8(%ebp)
	je	.L407
	.loc 1 1652 0
	movl	mesg_implicit_function_declaration@GOT(%ecx), %eax
	movl	(%eax), %eax
	cmpl	$2, %eax
	je	.L412
	.loc 1 1653 0
...
.L412:
	...
	ret
.LFE30:
	.size	set_Wimplicit, .-set_Wimplicit
	.type	handle_OPT_d, @function
handle_OPT_d:
.LFB31:
	.loc 1 1664 0
	pushl	%ebp
...
.L423:
	...
	ret
.LFE31:
	.size	handle_OPT_d, .-handle_OPT_d
	.type	write_langs, @function
write_langs:
.LFB32:
	.loc 1 1693 0
	pushl	%ebp
...
.L435:
	...
	ret
.LFE32:
	.size	write_langs, .-write_langs
	.section	.rodata
.LC198:
	.string	"no-"
	.align 4
.LC199:
	.string	"\"-%c%s%s\" is valid for %s but not for %s"
	.text
	.type	complain_wrong_lang, @function
complain_wrong_lang:
.LFB33:
	.loc 1 1716 0
	pushl	%ebp
...
.L441:
	...
	ret
.LFE33:
	.size	complain_wrong_lang, .-complain_wrong_lang
	.section	.rodata
	.align 4
.LC200:
...
.LC201:
	...
	.align 4
.LC202:
	.ascii	"  -trigraphs                Support ISO C trigraphs\n  -std="
	.ascii	"<std name>           Specify the conformance standard; one o"
	.ascii	"f:\n                            gnu89, gnu99, c89, c99, iso9"
	.ascii	"899"
	.string	":1990,\n                            iso9899:199409, iso9899:1999, c++98\n  -w                        Inhibit warning messages\n  -W[no-]trigraphs          Warn if trigraphs are encountered\n  -W[no-]comment{s}         Warn if one comment starts inside another\n"
	.align 4
.LC203:
	.string	"  -W[no-]traditional        Warn about features not present in traditional C\n  -W[no-]undef              Warn if an undefined macro is used by #if\n  -W[no-]import             Warn about the use of the #import directive\n"
	.align 4
.LC204:
	.string	"  -W[no-]error              Treat all warnings as errors\n  -W[no-]system-headers     Do not suppress warnings from system headers\n  -W[no-]all                Enable most preprocessor warnings\n"
	.align 4
.LC205:
...
.LC208:
	...
	.align 4
.LC209:
	.ascii	"  -f[no-]preprocessed       Treat the input file as already "
	.ascii	"preprocessed\n"
	.string	"  -ftabstop=<number>        Distance between tab stops for column reporting\n  -P                        Do not generate #line directives\n  -remap                    Remap file names when including files\n  --help                    Display this information\n"
	.text
...
.LFE34:
	...
	.comm	out_stream,4,4
	.local	deps_append
	.comm	deps_append,1,1
	.local	deps_seen
	.comm	deps_seen,1,1
	.local	deps_file
	.comm	deps_file,4,4
	.local	deferred_count
	.comm	deferred_count,4,4
	.local	deferred_size
	.comm	deferred_size,4,4
	.local	deferred_opts
	.comm	deferred_opts,4,4
...
.LEFDE38:
	...
	.file 3 "../../../kgccfe/gnu/c-common.h"
	.file 4 "/usr/include/stdio.h"
	.file 5 "/usr/include/libio.h"
	.file 6 "/usr/include/bits/types.h"
	.file 7 "../../../kgccfe/gnu/cpplib.h"
	...
	.file 14 "../../../kgccfe/gnu/toplev.h"
	.file 15 "../../../kgccfe/gnu/flags.h"
	.file 16 "../../../kgccfe/gnu/c-pragma.h"
	.file 17 "../../../kgccfe/gnu/tree-inline.h"
	.file 18 "../../../kgccfe/gnu/diagnostic.h"
	.file 19 "../../../kgccfe/gnu/langhooks.h"
...
.LLST19:
	...
	.sleb128 16
	.uleb128 0x14
	.string	"OPT_Wbad_function_cast"
	.sleb128 17
	.uleb128 0x14
	.string	"OPT_Wcast_qual"
	.sleb128 18
	.uleb128 0x14
	.string	"OPT_Wchar_subscripts"
	.sleb128 19
	.uleb128 0x14
	.string	"OPT_Wcomment"
	.sleb128 20
	.uleb128 0x14
	.string	"OPT_Wcomments"
	.sleb128 21
	.uleb128 0x14
	.string	"OPT_Wconversion"
	.sleb128 22
	.uleb128 0x14
	.string	"OPT_Wctor_dtor_privacy"
	.sleb128 23
	.uleb128 0x14
	.string	"OPT_Wdeclaration_after_statement"
	.sleb128 24
	.uleb128 0x14
	.string	"OPT_Wdeprecated"
	.sleb128 25
	.uleb128 0x14
	.string	"OPT_Wdiv_by_zero"
	.sleb128 26
	.uleb128 0x14
	.string	"OPT_Weffcxx"
	.sleb128 27
	.uleb128 0x14
	.string	"OPT_Wendif_labels"
	.sleb128 28
	.uleb128 0x14
	.string	"OPT_Werror"
	.sleb128 29
	.uleb128 0x14
	.string	"OPT_Werror_implicit_function_decl"
	.sleb128 30
	.uleb128 0x14
	.string	"OPT_Wfloat_equal"
	.sleb128 31
	.uleb128 0x14
	.string	"OPT_Wformat"
	.sleb128 32
	.uleb128 0x14
	.string	"OPT_Wformat_extra_args"
	.sleb128 33
	.uleb128 0x14
	.string	"OPT_Wformat_nonliteral"
	.sleb128 34
	.uleb128 0x14
	.string	"OPT_Wformat_security"
	.sleb128 35
	.uleb128 0x14
	.string	"OPT_Wformat_y2k"
	.sleb128 36
	.uleb128 0x14
	.string	"OPT_Wformat_zero_length"
	.sleb128 37
	.uleb128 0x14
	.string	"OPT_Wformat_eq"
	.sleb128 38
	.uleb128 0x14
	.string	"OPT_Wimplicit"
	.sleb128 39
	.uleb128 0x14
	.string	"OPT_Wimplicit_function_decl"
	.sleb128 40
	.uleb128 0x14
	.string	"OPT_Wimplicit_int"
	.sleb128 41
	.uleb128 0x14
	.string	"OPT_Wimport"
	.sleb128 42
	.uleb128 0x14
	.string	"OPT_Wlong_long"
	.sleb128 43
	.uleb128 0x14
	.string	"OPT_Wmain"
	.sleb128 44
	.uleb128 0x14
	.string	"OPT_Wmissing_braces"
	.sleb128 45
	.uleb128 0x14
	.string	"OPT_Wmissing_declarations"
	.sleb128 46
	.uleb128 0x14
	.string	"OPT_Wmissing_format_attribute"
	.sleb128 47
	.uleb128 0x14
	.string	"OPT_Wmissing_prototypes"
	.sleb128 48
	.uleb128 0x14
	.string	"OPT_Wmultichar"
	.sleb128 49
	.uleb128 0x14
	.string	"OPT_Wnested_externs"
	.sleb128 50
	.uleb128 0x14
	.string	"OPT_Wnon_template_friend"
	.sleb128 51
	.uleb128 0x14
	.string	"OPT_Wnon_virtual_dtor"
	.sleb128 52
	.uleb128 0x14
	.string	"OPT_Wnonnull"
	.sleb128 53
	.uleb128 0x14
	.string	"OPT_Wold_style_cast"
	.sleb128 54
	.uleb128 0x14
	.string	"OPT_Woverloaded_virtual"
	.sleb128 55
	.uleb128 0x14
	.string	"OPT_Wparentheses"
	.sleb128 56
	.uleb128 0x14
	.string	"OPT_Wpmf_conversions"
	.sleb128 57
	.uleb128 0x14
	.string	"OPT_Wpointer_arith"
	.sleb128 58
	.uleb128 0x14
	.string	"OPT_Wprotocol"
	.sleb128 59
	.uleb128 0x14
	.string	"OPT_Wredundant_decls"
	.sleb128 60
	.uleb128 0x14
	.string	"OPT_Wreorder"
	.sleb128 61
	.uleb128 0x14
	.string	"OPT_Wreturn_type"
	.sleb128 62
	.uleb128 0x14
	.string	"OPT_Wselector"
	.sleb128 63
	.uleb128 0x14
	.string	"OPT_Wsequence_point"
	.sleb128 64
	.uleb128 0x14
	.string	"OPT_Wsign_compare"
	.sleb128 65
	.uleb128 0x14
	.string	"OPT_Wsign_promo"
	.sleb128 66
	.uleb128 0x14
	.string	"OPT_Wstrict_prototypes"
	.sleb128 67
	.uleb128 0x14
	.string	"OPT_Wsynth"
	.sleb128 68
	.uleb128 0x14
	.string	"OPT_Wsystem_headers"
	.sleb128 69
	.uleb128 0x14
	.string	"OPT_Wtraditional"
	.sleb128 70
	.uleb128 0x14
	.string	"OPT_Wtrigraphs"
	.sleb128 71
	.uleb128 0x14
	.string	"OPT_Wundeclared_selector"
	.sleb128 72
	.uleb128 0x14
	.string	"OPT_Wundef"
	.sleb128 73
	.uleb128 0x14
	.string	"OPT_Wunknown_pragmas"
	.sleb128 74
	.uleb128 0x14
	.string	"OPT_Wunused_macros"
	.sleb128 75
	.uleb128 0x14
	.string	"OPT_Wwrite_strings"
	.sleb128 76
	.uleb128 0x14
	.string	"OPT_ansi"
	.sleb128 77
	...
	.sleb128 78
	.uleb128 0x14
	.string	"OPT_fabi_version"
	.sleb128 79
	.uleb128 0x14
	.string	"OPT_faccess_control"
	.sleb128 80
	.uleb128 0x14
	.string	"OPT_fall_virtual"
	.sleb128 81
	.uleb128 0x14
	.string	"OPT_falt_external_templates"
	.sleb128 82
	.uleb128 0x14
	.string	"OPT_fasm"
	.sleb128 83
	...
	.sleb128 84
	.uleb128 0x14
	.string	"OPT_fbuiltin_"
	.sleb128 85
	.uleb128 0x14
	.string	"OPT_fcheck_new"
	.sleb128 86
	.uleb128 0x14
	.string	"OPT_fcond_mismatch"
	.sleb128 87
	.uleb128 0x14
	.string	"OPT_fconserve_space"
	.sleb128 88
	.uleb128 0x14
	.string	"OPT_fconst_strings"
	.sleb128 89
	.uleb128 0x14
	.string	"OPT_fconstant_string_class"
	.sleb128 90
	.uleb128 0x14
	.string	"OPT_fdefault_inline"
	.sleb128 91
	.uleb128 0x14
	.string	"OPT_fdollars_in_identifiers"
	.sleb128 92
	.uleb128 0x14
	.string	"OPT_fdump"
	.sleb128 93
	.uleb128 0x14
	.string	"OPT_felide_constructors"
	.sleb128 94
	.uleb128 0x14
	.string	"OPT_fenforce_eh_specs"
	.sleb128 95
	.uleb128 0x14
	.string	"OPT_fenum_int_equiv"
	.sleb128 96
	.uleb128 0x14
	.string	"OPT_fexternal_templates"
	.sleb128 97
	.uleb128 0x14
	.string	"OPT_ffixed_form"
	.sleb128 98
	.uleb128 0x14
	.string	"OPT_ffixed_line_length"
	.sleb128 99
	.uleb128 0x14
	.string	"OPT_ffor_scope"
	.sleb128 100
	.uleb128 0x14
	.string	"OPT_ffreestanding"
	.sleb128 101
	.uleb128 0x14
	.string	"OPT_fgnu_keywords"
	.sleb128 102
	.uleb128 0x14
	.string	"OPT_fgnu_runtime"
	.sleb128 103
	.uleb128 0x14
	.string	"OPT_fguiding_decls"
	.sleb128 104
	.uleb128 0x14
	.string	"OPT_fhandle_exceptions"
	.sleb128 105
	.uleb128 0x14
	.string	"OPT_fhonor_std"
	.sleb128 106
	.uleb128 0x14
	.string	"OPT_fhosted"
	.sleb128 107
	.uleb128 0x14
	.string	"OPT_fhuge_objects"
	.sleb128 108
	.uleb128 0x14
	.string	"OPT_fimplement_inlines"
	.sleb128 109
	.uleb128 0x14
	.string	"OPT_fimplicit_inline_templates"
	.sleb128 110
	.uleb128 0x14
	.string	"OPT_fimplicit_templates"
	.sleb128 111
	.uleb128 0x14
	.string	"OPT_flabels_ok"
	.sleb128 112
	.uleb128 0x14
	.string	"OPT_fms_extensions"
	.sleb128 113
	.uleb128 0x14
	.string	"OPT_fname_mangling"
	.sleb128 114
	.uleb128 0x14
	.string	"OPT_fnew_abi"
	.sleb128 115
	.uleb128 0x14
	.string	"OPT_fnext_runtime"
	.sleb128 116
	.uleb128 0x14
	.string	"OPT_fnonansi_builtins"
	.sleb128 117
	.uleb128 0x14
	.string	"OPT_fnonnull_objects"
	.sleb128 118
	.uleb128 0x14
	.string	"OPT_foperator_names"
	.sleb128 119
	.uleb128 0x14
	.string	"OPT_foptional_diags"
	.sleb128 120
	.uleb128 0x14
	.string	"OPT_fpermissive"
	.sleb128 121
	.uleb128 0x14
	...
	.sleb128 124
	.uleb128 0x14
	.string	"OPT_fshort_double"
	.sleb128 125
	.uleb128 0x14
	.string	"OPT_fshort_enums"
	.sleb128 126
	.uleb128 0x14
	.string	"OPT_fshort_wchar"
	.sleb128 127
	.uleb128 0x14
	.string	"OPT_fshow_column"
	.sleb128 128
	.uleb128 0x14
	.string	"OPT_fsigned_bitfields"
	.sleb128 129
	.uleb128 0x14
	.string	"OPT_fsigned_char"
	.sleb128 130
	.uleb128 0x14
	.string	"OPT_fsquangle"
	.sleb128 131
	.uleb128 0x14
	.string	"OPT_fstats"
	.sleb128 132
	.uleb128 0x14
	.string	"OPT_fstrict_prototype"
	.sleb128 133
	.uleb128 0x14
	.string	"OPT_ftabstop"
	.sleb128 134
	.uleb128 0x14
	.string	"OPT_ftemplate_depth"
	.sleb128 135
	.uleb128 0x14
	.string	"OPT_fthis_is_variable"
	.sleb128 136
	.uleb128 0x14
	.string	"OPT_funsigned_bitfields"
	.sleb128 137
	.uleb128 0x14
	.string	"OPT_funsigned_char"
	.sleb128 138
	.uleb128 0x14
	.string	"OPT_fuse_cxa_atexit"
	.sleb128 139
	.uleb128 0x14
	.string	"OPT_fvtable_gc"
	.sleb128 140
	.uleb128 0x14
	.string	"OPT_fvtable_thunks"
	.sleb128 141
	.uleb128 0x14
	.string	"OPT_fweak"
	.sleb128 142
	...
	.sleb128 151
	.uleb128 0x14
	.string	"OPT_print_objc_runtime_info"
	.sleb128 152
	.uleb128 0x14
	.string	"OPT_remap"
	.sleb128 153
	...
	.uleb128 0x29
	.long	0x5fe6
	.string	"check_deps_environment_vars"
	.byte	0x1
	.value	0x5e2
	.byte	0x1
	.long	.LFB24
