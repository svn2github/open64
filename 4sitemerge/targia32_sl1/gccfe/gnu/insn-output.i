# 1 "../../../kgccfe/gnu/MIPS/insn-output.c"
...
# 5 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 6 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 7 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 8 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 9 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 10 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 11 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 12 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 13 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 14 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
# 1 "../../../kgccfe/gnu/hard-reg-set.h" 1
# 15 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 16 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
# 1 "../../../kgccfe/gnu/MIPS/insn-config.h" 1
# 17 "../../../kgccfe/gnu/MIPS/insn-output.c" 2

# 1 "../../../kgccfe/gnu/conditions.h" 1
# 19 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 20 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 22 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 24 "../../../kgccfe/gnu/MIPS/insn-output.c" 2
...
# 25 "../../../kgccfe/gnu/MIPS/insn-output.c" 2

static const char *output_0 (rtx *, rtx);
...

{
  ...
  else if ((target_flags & 0x00100000) || ! (target_flags & 0x00000010))
    return "break 0";
  else
    return "break";
}
...
static const char *output_7 (rtx *, rtx);
...
{
  if ((((operands[0])->fld[0]).rtuint) == (((operands[1])->fld[0]).rtuint))
    return "addu\t%0,%2";
  return "addu\t%0,%1,%2";
}
}

static const char *output_8 (rtx *, rtx);
...
{
  return ((((operands[0])->fld[0]).rtuint) == (((operands[1])->fld[0]).rtuint)
...
static const char *output_10 (rtx *, rtx);
...
{
  return (((enum rtx_code) (operands[2])->code) == CONST_INT && (((operands[2])->fld[0]).rtwint) < 0)
    ? "dsubu\t%0,%z1,%n2"
    : "daddu\t%0,%z1,%2";
}
}

static const char *output_13 (rtx *, rtx);
...
static const char *output_14 (rtx *, rtx);
...
static const char *output_15 (rtx *, rtx);
...
static const char *output_21 (rtx *, rtx);
...
static const char *output_24 (rtx *, rtx);
...
static const char *output_27 (rtx *, rtx);
...
static const char *output_28 (rtx *, rtx);
...
static const char *output_29 (rtx *, rtx);
...
static const char *output_31 (rtx *, rtx);
...

{
  ...
  if ((target_flags & 0x00080000))
    output_asm_insn ("nop", operands);
  return "";
}
}

static const char *output_33 (rtx *, rtx);
...
static const char *output_34 (rtx *, rtx);
...
static const char *output_36 (rtx *, rtx);
...

{
  ...
  xoperands[1] = gen_rtx_REG (SImode, (64 + 1));

  output_asm_insn ("mult\t%1,%2", operands);
  output_asm_insn (mips_move_1word (xoperands, insn, 0), xoperands);
  return "";
}
}

static const char *output_37 (rtx *, rtx);
...

{
  ...
  if (which_alternative == 2)
    return "#";
  if ((((mips_isa == 32) || (mips_isa == 64) ) && !(target_flags & 0x00100000)) && which_alternative != 0)
    return "#";

  if ((mips_arch == PROCESSOR_R5400))
    return macc[which_alternative];

  if ((mips_arch == PROCESSOR_R5500))
    {
...
static const char *output_38 (rtx *, rtx);
...
static const char *output_42 (rtx *, rtx);
...
{
  if ((((mips_arch == PROCESSOR_R3900)) && !(target_flags & 0x00100000)))
  ...
  else
    {
      ...
      xoperands[0] = operands[0];
      xoperands[1] = gen_rtx_REG (DImode, (64 + 1));
...
static const char *output_43 (rtx *, rtx);
...
{
  if (((enum rtx_code) (operands[3])->code) == SIGN_EXTEND)
    return "mult\t%1,%2";
  return "multu\t%1,%2";
}
}

static const char *output_44 (rtx *, rtx);
...
static const char *output_45 (rtx *, rtx);
...
static const char *output_46 (rtx *, rtx);
...
{
  if (((enum rtx_code) (operands[4])->code) == SIGN_EXTEND)
     {
       if ((mips_arch == PROCESSOR_R5500))
         return "msub\t%1,%2";
       else
...
static const char *output_47 (rtx *, rtx);
...
static const char *output_48 (rtx *, rtx);
...
static const char *output_49 (rtx *, rtx);
...
static const char *output_53 (rtx *, rtx);
...
static const char *output_54 (rtx *, rtx);
...

{
  if ((target_flags & 0x00040000))
  ...
  else if (((mips_arch == PROCESSOR_R5400) || (mips_arch == PROCESSOR_R5500) || (mips_arch == PROCESSOR_SR71000) ))
    {
      if (((enum rtx_code) (operands[3])->code) == SIGN_EXTEND)
        {
          if ((mips_arch == PROCESSOR_R5500))
    ...
    fancy_abort ("../../../kgccfe/gnu/MIPS/insn-output.c", 552, __FUNCTION__);

}
}

static const char *output_71 (rtx *, rtx);
...

{
  ...
  for (link = (((insn)->fld[7]).rtx); link; link = (((link)->fld[1]).rtx))
    ...
    if ((int) REG_DEP_ANTI == (int) ((enum reg_note) ((enum machine_mode) (link)->mode))
        && ((enum rtx_code) ((((link)->fld[0]).rtx))->code) == INSN
        && ((enum rtx_code) (((((((link)->fld[0]).rtx))->fld[5]).rtx))->code) == TRAP_IF
 && which_alternative == 1)
      have_dep_anti = 1;
  if (! have_dep_anti)
    {
      if (((target_flags & 0x02000000) && !(mips_arch == PROCESSOR_SR71000) && !(target_flags & 0x00100000)))
 {
          if (which_alternative == 1)
     return "%(beql\t%0,$0,1f\n\tbreak\t%2\n%~1:%)";
   else
...
static const char *output_72 (rtx *, rtx);
...
static const char *output_85 (rtx *, rtx);
...
static const char *output_86 (rtx *, rtx);
...

{
  ...
  if (((enum rtx_code) (operands[1])->code) == REG)
    regno1 = (((operands[1])->fld[0]).rtuint);
  else
    regno1 = ((((((operands[1])->fld[0]).rtx))->fld[0]).rtuint);

  if ((((operands[0])->fld[0]).rtuint) == regno1)
    return "%(bltzl\t%1,1f\n\tdsubu\t%0,%z2,%0\n%~1:%)";
  else
    return "%(bgez\t%1,1f\n\tmove\t%0,%1\n\tdsubu\t%0,%z2,%0\n%~1:%)";
}
...
static const char *output_89 (rtx *, rtx);
...

{
  ...
  operands[4] = (const_int_rtx[64]);

  if (optimize && find_reg_note (insn, REG_DEAD, operands[1]))
    return "%(move\t%0,%z4\n\tbeq\t%1,%z4,2f\n%~1:\tand\t%2,%1,0x0001\n\taddu\t%0,%0,1\n\tbeq\t%2,%z4,1b\n\tsrl\t%1,%1,1\n%~2:%)";
# 706 "../../../kgccfe/gnu/MIPS/insn-output.c"
  return "%(move\t%0,%z4\n\tmove\t%3,%1\n\tbeq\t%3,%z4,2f\n%~1:\tand\t%2,%3,0x0001\n\taddu\t%0,%0,1\n\tbeq\t%2,%z4,1b\n\tsrl\t%3,%3,1\n%~2:%)";
# 715 "../../../kgccfe/gnu/MIPS/insn-output.c"
}
}

static const char *output_90 (rtx *, rtx);
...

{
  ...
  if (optimize && find_reg_note (insn, REG_DEAD, operands[1]))
    return "%(move\t%0,%z4\n\tbeq\t%1,%z4,2f\n%~1:\tand\t%2,%1,0x0001\n\tdaddu\t%0,%0,1\n\tbeq\t%2,%z4,1b\n\tdsrl\t%1,%1,1\n%~2:%)";
# 741 "../../../kgccfe/gnu/MIPS/insn-output.c"
  return "%(move\t%0,%z4\n\tmove\t%3,%1\n\tbeq\t%3,%z4,2f\n%~1:\tand\t%2,%3,0x0001\n\tdaddu\t%0,%0,1\n\tbeq\t%2,%z4,1b\n\tdsrl\t%3,%3,1\n%~2:%)";
# 750 "../../../kgccfe/gnu/MIPS/insn-output.c"
}
}

static const char *output_91 (rtx *, rtx);
...
static const char *output_92 (rtx *, rtx);
...
static const char *output_93 (rtx *, rtx);
...
static const char *output_96 (rtx *, rtx);
...
static const char *output_97 (rtx *, rtx);
...
static const char *output_100 (rtx *, rtx);
...
static const char *output_101 (rtx *, rtx);
...
static const char *output_105 (rtx *, rtx);
...
static const char *output_106 (rtx *, rtx);
...
static const char *output_109 (rtx *, rtx);
...
static const char *output_114 (rtx *, rtx);
...
static const char *output_116 (rtx *, rtx);
...
static const char *output_117 (rtx *, rtx);
...
static const char *output_118 (rtx *, rtx);
...
static const char *output_119 (rtx *, rtx);
...
{
  int shift_amt = (((operands[2])->fld[0]).rtwint) & 0x3f;

  if (shift_amt < 32)
    {
      operands[2] = gen_rtx_CONST_INT (VOIDmode, (long long) (32 - shift_amt));
      return "dsll\t%0,%1,%2\n\tdsra\t%0,%0,32";
    }
  else
    {
      operands[2] = gen_rtx_CONST_INT (VOIDmode, (long long) (shift_amt));
      return "dsra\t%0,%1,%2";
    }
}
}

static const char *output_120 (rtx *, rtx);
...
static const char *output_121 (rtx *, rtx);
...
static const char *output_125 (rtx *, rtx);
...
output_125 (operands, insn)
     ...
     rtx insn __attribute__ ((__unused__));
{
 return mips_move_1word (operands, insn, 1);
}

static const char *output_126 (rtx *, rtx);
...
static const char *output_127 (rtx *, rtx);
...
static const char *output_128 (rtx *, rtx);
...
static const char *output_129 (rtx *, rtx);
...
static const char *output_130 (rtx *, rtx);
...
static const char *output_131 (rtx *, rtx);
...
static const char *output_132 (rtx *, rtx);
...
static const char *output_133 (rtx *, rtx);
...
static const char *output_134 (rtx *, rtx);
...
static const char *output_135 (rtx *, rtx);
...
static const char *output_136 (rtx *, rtx);
...
static const char *output_137 (rtx *, rtx);
...
static const char *output_138 (rtx *, rtx);
...
static const char *output_139 (rtx *, rtx);
...
static const char *output_140 (rtx *, rtx);
...
static const char *output_141 (rtx *, rtx);
...
static const char *output_153 (rtx *, rtx);
...

{
  ...
  if (((((offset)->fld[0]).rtwint) & 3) == 0
      && (mem_addr == (global_rtl[GR_STACK_POINTER]) || mem_addr == (global_rtl[GR_FRAME_POINTER])))
    ret = "lw\t%0,%1";
  else
    ret = "ulw\t%0,%1";
...
static const char *output_154 (rtx *, rtx);
...
static const char *output_155 (rtx *, rtx);
...
static const char *output_156 (rtx *, rtx);
...
static const char *output_159 (rtx *, rtx);
...
static const char *output_160 (rtx *, rtx);
...
static const char *output_161 (rtx *, rtx);
...
static const char *output_162 (rtx *, rtx);
...
static const char *output_163 (rtx *, rtx);
...
static const char *output_164 (rtx *, rtx);
...
static const char *output_166 (rtx *, rtx);
...
static const char *output_167 (rtx *, rtx);
...
static const char *output_169 (rtx *, rtx);
...
static const char *output_178 (rtx *, rtx);
...
static const char *output_179 (rtx *, rtx);
...
static const char *output_180 (rtx *, rtx);
...
static const char *output_181 (rtx *, rtx);
...
static const char *output_182 (rtx *, rtx);
...
static const char *output_183 (rtx *, rtx);
...
static const char *output_184 (rtx *, rtx);
...
static const char *output_185 (rtx *, rtx);
...
static const char *output_186 (rtx *, rtx);
...
static const char *output_187 (rtx *, rtx);
...
static const char *output_188 (rtx *, rtx);
...
static const char *output_190 (rtx *, rtx);
...
static const char *output_191 (rtx *, rtx);
...
static const char *output_192 (rtx *, rtx);
...
static const char *output_193 (rtx *, rtx);
...
static const char *output_194 (rtx *, rtx);
...
static const char *output_195 (rtx *, rtx);
...
static const char *output_196 (rtx *, rtx);
...
static const char *output_197 (rtx *, rtx);
...

{
  ...
  return "sll\t%3,%2,26\n\tbgez\t%3,1f\n\tsll\t%M0,%L1,%2\n\t%(b\t3f\n\tmove\t%L0,%z4%)\n\n%~1:\n\t%(beq\t%3,%z4,2f\n\tsll\t%M0,%M1,%2%)\n\n\tsubu\t%3,%z4,%2\n\tsrl\t%3,%L1,%3\n\tor\t%M0,%M0,%3\n%~2:\n\tsll\t%L0,%L1,%2\n%~3:";
# 1710 "../../../kgccfe/gnu/MIPS/insn-output.c"
}
}

static const char *output_198 (rtx *, rtx);
...
static const char *output_199 (rtx *, rtx);
...

{
  ...
  operands[4] = (const_int_rtx[64]);
  operands[5] = gen_rtx_CONST_INT (VOIDmode, (long long) ((-amount) & 31));

  return "sll\t%M0,%M1,%2\n\tsrl\t%3,%L1,%5\n\tor\t%M0,%M0,%3\n\tsll\t%L0,%L1,%2";
}
}

static const char *output_200 (rtx *, rtx);
...
{
  if (((enum rtx_code) (operands[2])->code) == CONST_INT)
    operands[2] = gen_rtx_CONST_INT (VOIDmode, (long long) ((((operands[2])->fld[0]).rtwint) & 0x3f));

  return "dsll\t%0,%1,%2";
}
}

static const char *output_201 (rtx *, rtx);
...
static const char *output_202 (rtx *, rtx);
...
static const char *output_203 (rtx *, rtx);
...
static const char *output_204 (rtx *, rtx);
...

{
  ...
  return "sll\t%3,%2,26\n\tbgez\t%3,1f\n\tsra\t%L0,%M1,%2\n\t%(b\t3f\n\tsra\t%M0,%M1,31%)\n\n%~1:\n\t%(beq\t%3,%z4,2f\n\tsrl\t%L0,%L1,%2%)\n\n\tsubu\t%3,%z4,%2\n\tsll\t%3,%M1,%3\n\tor\t%L0,%L0,%3\n%~2:\n\tsra\t%M0,%M1,%2\n%~3:";
# 1846 "../../../kgccfe/gnu/MIPS/insn-output.c"
}
}

static const char *output_205 (rtx *, rtx);
...
static const char *output_206 (rtx *, rtx);
...
static const char *output_207 (rtx *, rtx);
...
static const char *output_208 (rtx *, rtx);
...
static const char *output_209 (rtx *, rtx);
...
static const char *output_210 (rtx *, rtx);
...
static const char *output_212 (rtx *, rtx);
...

{
  ...
  return "sll\t%3,%2,26\n\tbgez\t%3,1f\n\tsrl\t%L0,%M1,%2\n\t%(b\t3f\n\tmove\t%M0,%z4%)\n\n%~1:\n\t%(beq\t%3,%z4,2f\n\tsrl\t%L0,%L1,%2%)\n\n\tsubu\t%3,%z4,%2\n\tsll\t%3,%M1,%3\n\tor\t%L0,%L0,%3\n%~2:\n\tsrl\t%M0,%M1,%2\n%~3:";
# 1977 "../../../kgccfe/gnu/MIPS/insn-output.c"
}
}

static const char *output_213 (rtx *, rtx);
...
static const char *output_214 (rtx *, rtx);
...
static const char *output_215 (rtx *, rtx);
...
static const char *output_216 (rtx *, rtx);
...
static const char *output_217 (rtx *, rtx);
...
{
  if ((mips_arch == PROCESSOR_SR71000) && ((enum rtx_code) (operands[2])->code) != CONST_INT)
    return "rorv\t%0,%1,%2";

  if ((((enum rtx_code) (operands[2])->code) == CONST_INT)
      && ((((operands[2])->fld[0]).rtwint) < 0 || (((operands[2])->fld[0]).rtwint) >= 32))
    fancy_abort ("../../../kgccfe/gnu/MIPS/insn-output.c", 2059, __FUNCTION__);

  return "ror\t%0,%1,%2";
}
}

static const char *output_218 (rtx *, rtx);
...
{
   if ((mips_arch == PROCESSOR_SR71000))
    {
      if (((enum rtx_code) (operands[2])->code) != CONST_INT)
        return "drorv\t%0,%1,%2";

      if ((((operands[2])->fld[0]).rtwint) >= 32 && (((operands[2])->fld[0]).rtwint) <= 63)
        return "dror32\t%0,%1,%2";
    }

  if ((((enum rtx_code) (operands[2])->code) == CONST_INT)
      && ((((operands[2])->fld[0]).rtwint) < 0 || (((operands[2])->fld[0]).rtwint) >= 64))
    fancy_abort ("../../../kgccfe/gnu/MIPS/insn-output.c", 2085, __FUNCTION__);

  return "dror\t%0,%1,%2";
}
}

static const char *output_219 (rtx *, rtx);
...
static const char *output_220 (rtx *, rtx);
...
static const char *output_221 (rtx *, rtx);
...
static const char *output_222 (rtx *, rtx);
...
static const char *output_223 (rtx *, rtx);
...
static const char *output_224 (rtx *, rtx);
...
static const char *output_225 (rtx *, rtx);
...
static const char *output_226 (rtx *, rtx);
...
static const char *output_227 (rtx *, rtx);
...
static const char *output_228 (rtx *, rtx);
...
static const char *output_229 (rtx *, rtx);
...
{
  if (operands[2] != (global_rtl[GR_PC]))
    {
      if (which_alternative == 0)
 return "%*b%C0z\t%1,%2";
      else
...
static const char *output_230 (rtx *, rtx);
...
static const char *output_245 (rtx *, rtx);
...
{
  operands[2] = gen_rtx_CONST_INT (VOIDmode, (long long) ((((operands[2])->fld[0]).rtwint)+1));
  return "slt\t%0,%1,%2";
}
}

static const char *output_246 (rtx *, rtx);
...
static const char *output_247 (rtx *, rtx);
...
static const char *output_248 (rtx *, rtx);
...
static const char *output_257 (rtx *, rtx);
...
static const char *output_258 (rtx *, rtx);
...
static const char *output_259 (rtx *, rtx);
...
static const char *output_260 (rtx *, rtx);
...
static const char *output_261 (rtx *, rtx);
...
static const char *output_262 (rtx *, rtx);
...
static const char *output_263 (rtx *, rtx);
...
static const char *output_264 (rtx *, rtx);
...
static const char *output_265 (rtx *, rtx);
...
static const char *output_266 (rtx *, rtx);
...
static const char *output_267 (rtx *, rtx);
...
static const char *output_268 (rtx *, rtx);
...
static const char *output_269 (rtx *, rtx);
...
static const char *output_270 (rtx *, rtx);
...
static const char *output_271 (rtx *, rtx);
...
static const char *output_272 (rtx *, rtx);
...
static const char *output_273 (rtx *, rtx);
...
static const char *output_274 (rtx *, rtx);
...
static const char *output_275 (rtx *, rtx);
...
static const char *output_276 (rtx *, rtx);
...
static const char *output_277 (rtx *, rtx);
...
static const char *output_278 (rtx *, rtx);
...
static const char *output_279 (rtx *, rtx);
...
{
  if (flag_pic && ! (target_flags & 0x00004000))
    {
...
static const char *output_285 (rtx *, rtx);
...
static const char *output_291 (rtx *, rtx);
...
static const char *output_295 (rtx *, rtx);
...
static const char *output_297 (rtx *, rtx);
...

{
  ...
  if (((enum rtx_code) (target)->code) == CONST_INT)
    return "%[li\t%@,%0\n\t%*jal\t%2,%@%]";
  else if ((((enum rtx_code) (target)->code) == LABEL_REF || ((enum rtx_code) (target)->code) == SYMBOL_REF || ((enum rtx_code) (target)->code) == CONST_INT || ((enum rtx_code) (target)->code) == HIGH || (((enum rtx_code) (target)->code) == CONST && ! (flag_pic && pic_address_needs_scratch (target)) && ((target_flags & 0x00000010) || mips_abi == 0))))
    return "%*jal\t%0";
  else
    return "%*jal\t%2,%0";
}
...
static const char *output_298 (rtx *, rtx);
...

{
  ...
  if (((enum rtx_code) (target)->code) == CONST_INT)
    ...
    {
      if (((enum machine_mode) (target)->mode) == SImode)
 return "la\t%^,%0\n\tjal\t%2,%^";
      else
 return "dla\t%^,%0\n\tjal\t%2,%^";
    }
  else if ((((target)->fld[0]).rtuint) != (0 + 25))
    return "move\t%^,%0\n\tjal\t%2,%^";
  else
    return "jal\t%2,%0";
}
...
static const char *output_302 (rtx *, rtx);
...
{
  if ((((operands[0])->fld[0]).rtuint) != (0 + 25))
    return "move\t%^,%0\n\tjal\t%2,%^";
  else
    return "jal\t%2,%0";
}
...
static const char *output_303 (rtx *, rtx);
...
static const char *output_305 (rtx *, rtx);
...
static const char *output_306 (rtx *, rtx);
...
static const char *output_310 (rtx *, rtx);
...
{
  if ((((operands[1])->fld[0]).rtuint) != (0 + 25))
    return "move\t%^,%1\n\tjal\t%3,%^";
  else
    return "jal\t%3,%1";
}
...
static const char *output_311 (rtx *, rtx);
...
static const char *output_312 (rtx *, rtx);
...
static const char *output_313 (rtx *, rtx);
...
static const char *output_314 (rtx *, rtx);
...
static const char *output_315 (rtx *, rtx);
...
static const char *output_316 (rtx *, rtx);
...
static const char *output_317 (rtx *, rtx);
...
static const char *output_331 (rtx *, rtx);
...
{
  assemble_integer (operands[0], 1, 8, 1);
  return "";
}
}

static const char *output_332 (rtx *, rtx);
...
{
  assemble_integer (operands[0], 2, 8 * 2, 1);
  return "";
}
}

static const char *output_333 (rtx *, rtx);
...
{
  assemble_integer (operands[0], 4, 8 * 4, 1);
  return "";
}
}

static const char *output_334 (rtx *, rtx);
...
{
  assemble_integer (operands[0], 8, 8 * 8, 1);
  return "";
}
}

static const char *output_335 (rtx *, rtx);
...

{
  ...
  if (((enum rtx_code) (operands[0])->code) != CONST_DOUBLE)
    fancy_abort ("../../../kgccfe/gnu/MIPS/insn-output.c", 3104, __FUNCTION__);
  memcpy (&(d), &((((operands[0]))->fld[0]).rtwint), sizeof (struct real_value));
  assemble_real (d, SFmode, get_mode_alignment (SFmode));
  return "";
}
}

static const char *output_336 (rtx *, rtx);
...

{
  ...
  if (((enum rtx_code) (operands[0])->code) != CONST_DOUBLE)
    fancy_abort ("../../../kgccfe/gnu/MIPS/insn-output.c", 3123, __FUNCTION__);
  memcpy (&(d), &((((operands[0]))->fld[0]).rtwint), sizeof (struct real_value));
...
static const char *output_529 (rtx *, rtx);
...
{
  if (operands[3] != (global_rtl[GR_PC]))
    return "%*b%C2z\t%1,%3";
  else
    return "%*b%N2z\t%1,%4";
}
...
static const char *output_530 (rtx *, rtx);
...
static const char *output_531 (rtx *, rtx);
...
static const char *output_532 (rtx *, rtx);
