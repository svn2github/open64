...
# 30 "../../../kgccfe/gnu/cppfiles.c" 2
# 38 "../../../kgccfe/gnu/cppfiles.c"
...
# 39 "../../../kgccfe/gnu/cppfiles.c" 2
# 86 "../../../kgccfe/gnu/cppfiles.c"
struct include_file {
  const char *name;
...
# 277 "../../../kgccfe/gnu/cppfiles.c"
  if (filename[0] == '\0')
    ...
    file->fd = open (file->name, 00 | 0400 | 0, 0666);
     ...
     const cpp_token *header;
{
  ...
  return inc->st.st_mtim.tv_sec > pfile->buffer->inc->st.st_mtim.tv_sec;
}
