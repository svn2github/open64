# 1 "../../libelfutil/xlate_init_elf.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_init_elf.c"
# 47 "../../libelfutil/xlate_init_elf.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 48 "../../libelfutil/xlate_init_elf.c" 2
...
int
_xlate_init_elf(Elf * elf, int open_debug_table,
 xlate_table_con * ret_tab_ptr)
{
 ...
 return -33;
   ...
   if(open_debug_table == 0) {

 wanttype = 0x70000024;
   } else if(open_debug_table == 1) {
