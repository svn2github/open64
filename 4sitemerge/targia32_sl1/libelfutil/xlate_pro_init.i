# 1 "../../libelfutil/xlate_pro_init.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_pro_init.c"
# 60 "../../libelfutil/xlate_pro_init.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 61 "../../libelfutil/xlate_pro_init.c" 2
...
int _xlate_pro_init(xlate_table_pro * ret_table,
    ...
    int is64Bit)
{
   ...
   newtab->tb_std_highwater.hw_lowNewAddr = 0xffffffffffffffffULL;
   newtab->tb_std_highwater.hw_lowOldAddr = 0xffffffffffffffffULL;

   if(compose_with_table ) {
        newtab->tb_debug_highwater.hw_lowNewAddr = 0xffffffffffffffffULL;
        newtab->tb_debug_highwater.hw_lowOldAddr = 0xffffffffffffffffULL;
 newtab->tb_debug_tablekind = tablekind;
 retstatus = _xlate_get_info(compose_with_table,
                  0, 0, 0,
                 0, 0,
                     0, 0,
                         0,
...
int
_xlate_pro_finish(xlate_table_pro table)
{
   Block_s *blk;
   Block_s *blkn;
   int retstatus = 0;
