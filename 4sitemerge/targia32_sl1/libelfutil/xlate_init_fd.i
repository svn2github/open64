# 1 "../../libelfutil/xlate_init_fd.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_init_fd.c"
# 47 "../../libelfutil/xlate_init_fd.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 48 "../../libelfutil/xlate_init_fd.c" 2
...
int
_xlate_init_fd(int fd, int open_debug_table,
