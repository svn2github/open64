# 1 "../../libelfutil/xlate_pro_disk_header.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_pro_disk_header.c"
# 45 "../../libelfutil/xlate_pro_disk_header.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 46 "../../libelfutil/xlate_pro_disk_header.c" 2
...
int _xlate_pro_disk_header(xlate_table_pro table,
...

{
 ...
 return retstatus;
    ...
    for(;;) {
 Elf64_Xword len;
 tretstatus = _xlate_pro_disk_next_block(table,
            0,
   &len);
 if(tretstatus == 0) {
