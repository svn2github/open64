# 1 "../../libelfutil/xlate_update_for_movement.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_update_for_movement.c"
# 72 "../../libelfutil/xlate_update_for_movement.c"
...
# 73 "../../libelfutil/xlate_update_for_movement.c" 2
...
# 75 "../../libelfutil/xlate_update_for_movement.c" 2
# 1 "../../libelfutil/xlateincl.h" 1
# 56 "../../libelfutil/xlateincl.h"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 76 "../../libelfutil/xlate_update_for_movement.c" 2
  ...
  unsigned int movement)
{
 ...
 if( phdr.hd_reg_info_size > 0 ) {
  ...
  for(thisinst = 0; thisinst <num_instrs; ++thisinst) {
   ...
   if(instrs_out[thisinst].sr_op == 0x01) {
     ++instoff;
     if(is64bit) {
