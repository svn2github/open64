# 1 "../../libelfutil/xlate_pro_add_reg_info.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_pro_add_reg_info.c"
# 47 "../../libelfutil/xlate_pro_add_reg_info.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 48 "../../libelfutil/xlate_pro_add_reg_info.c" 2




#pragma weak xlate_pro_add_reg_info = _xlate_pro_add_reg_info
# 61 "../../libelfutil/xlate_pro_add_reg_info.c"
int _xlate_pro_add_reg_info(xlate_table_pro table,
    Dwarf_Small op,
    Dwarf_Unsigned val1,
    Dwarf_Unsigned val2)
{
