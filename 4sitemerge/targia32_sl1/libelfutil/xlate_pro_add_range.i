# 1 "../../libelfutil/xlate_pro_add_range.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_pro_add_range.c"
# 50 "../../libelfutil/xlate_pro_add_range.c"
# 1 "../../libelfutil/xlateincl.h" 1
# 53 "../../libelfutil/xlateincl.h"
# 1 "../include/sgidefs.h" 1
# 43 "../include/sgidefs.h"
#ident "$Revision: 1.1 $"
...
# 56 "../../libelfutil/xlateincl.h" 2
# 1 "../../libelfutil/xlatebase.h" 1
# 60 "../../libelfutil/xlatebase.h"
typedef __uint32_t Uword;
typedef __int32_t Sword;
# 73 "../../libelfutil/xlatebase.h"
typedef __uint64_t Xuword;
typedef __int64_t Xsword;
# 57 "../../libelfutil/xlateincl.h" 2
# 1 "../../libelfutil/syn.h" 1
# 58 "../../libelfutil/xlateincl.h" 2
...
# 59 "../../libelfutil/xlateincl.h" 2
# 1 "../include/libelf/libelf.h" 1
# 29 "../include/libelf/libelf.h"
...
# 30 "../include/libelf/libelf.h" 2




# 1 "../include/libelf/sys_elf.h" 1
# 35 "../include/libelf/libelf.h" 2
...
Dwarf_Unsigned dwf_add_ehframe_info(
    ...
    Dwarf_Unsigned ,
    Dwarf_Error* );
# 61 "../../libelfutil/xlateincl.h" 2
# 1 "../../include/libXlate.h" 1
# 61 "../../include/libXlate.h"
# 1 "../include/libelf/libelf.h" 1
# 62 "../../include/libXlate.h" 2
...
int _xlate_init_fd(int ,
    int ,
    xlate_table_con * );

int _xlate_init_elf(Elf * ,
    int ,
    xlate_table_con * );

int _xlate_named_init_fd(int ,
    const char * ,
    xlate_table_con * );

int _xlate_named_init_elf(Elf * ,
    const char * ,
    xlate_table_con * );

int _xlate_get_info(xlate_table_con ,
    Elf64_Sxword * ,
    Elf64_Addr * ,
    Elf64_Addr * ,
    Elf64_Addr * ,
...
int _xlate_address(xlate_table_con ,
    int ,
    Elf64_Addr ,
    Elf64_Addr * ,
    xlate_block * );

int _xlate_get_reg_rule(xlate_table_con ,
    Elf64_Addr ,
    Elf32_Word ,
    Elf32_Word * ,
    Elf64_Xword * ,
...
int _xlate_get_all_reg_rules(xlate_table_con ,
    Elf64_Addr ,
    Dwarf_Regtable * );
...
int _xlate_expand_reg_info(xlate_table_con ,
    Elf64_Xword * ,
    xlate_reg_instr ** );
# 195 "../../include/libXlate.h"
...
int _xlate_expand_reg_info2(xlate_table_con ,
    Elf64_Xword * ,
    xlate_reg_instr2 ** );

int _xlate_finish(xlate_table_con );
# 233 "../../include/libXlate.h"
...
int _xlate_pro_init(xlate_table_pro * ,
    xlate_tablekind ,
    xlate_table_con ,
    int );

int _xlate_pro_add_info(xlate_table_pro ,
    Elf64_Sxword ,
    Elf64_Addr ,
    Elf64_Addr ,
    Elf32_Word ,
...
int _xlate_pro_add_reg_info(xlate_table_pro ,
    Dwarf_Small ,
    Dwarf_Unsigned ,
    Dwarf_Unsigned );

int _xlate_pro_add_range(xlate_table_pro ,
    Elf64_Addr ,
    Elf64_Xword ,
    Elf64_Addr ,
    Elf64_Xword );
...
int _xlate_pro_disk_header(xlate_table_pro ,
    int ,
    Elf64_Xword * ,
    Elf64_Xword * );

int _xlate_pro_disk_next_block(xlate_table_pro ,
    char ** ,
    Elf64_Xword * );


int _xlate_pro_finish(xlate_table_pro );
# 62 "../../libelfutil/xlateincl.h" 2
# 1 "../../include/cmplrs/xlate.h" 1
# 84 "../../include/cmplrs/xlate.h"
...
# 63 "../../libelfutil/xlateincl.h" 2
# 1 "../../include/cmplrs/leb128.h" 1
# 89 "../../include/cmplrs/leb128.h"
extern int _leb128_unsigned_encode64(u_int64_t , char* );
extern int _leb128_signed_encode64(int64_t , char* );

extern int _leb128_unsigned_encode32(u_int32_t , char* );
extern int _leb128_signed_encode32(int32_t , char* );

extern int _leb128_unsigned_decode64(char* , u_int64_t* );
extern int _leb128_signed_decode64(char* , int64_t* );

extern int _leb128_unsigned_decode32(char* , u_int32_t* );
extern int _leb128_signed_decode32(char* , int32_t* );
# 64 "../../libelfutil/xlateincl.h" 2
...
# 43 "../include/bstring.h" 2
# 65 "../../libelfutil/xlateincl.h" 2
...
# 67 "../../libelfutil/xlateincl.h" 2
# 1 "../../libelfutil/xlateTypes.h" 1
# 87 "../../libelfutil/xlateTypes.h"
struct memo_s {
 char mm_is_valid;
 ...
 char mm_is_new_address;





 Elf64_Xword mm_entryct;


 Uword mm_ublock_index;
...
typedef struct uniform_blk_hdr_s {
  ...
  xlate_block *ub_expanded_entries;
  ...
  Uword ub_v1_entrycount;
# 155 "../../libelfutil/xlateTypes.h"
  Uword ub_block_index;
...
struct xlate_table_con_s {
    ...
    char xc_is64bit;
    char xc_did_elf_begin;
# 236 "../../libelfutil/xlateTypes.h"
    Elf *xc_elf;
    ...
    uniform_block_hdr * xc_ubh_array;
# 262 "../../libelfutil/xlateTypes.h"
    struct internal_con_hdr_s xc_hdr;
# 271 "../../libelfutil/xlateTypes.h"
    struct memo_s xc_memo_new;


    struct memo_s xc_memo_old;




};
# 68 "../../libelfutil/xlateincl.h" 2
# 1 "../../libelfutil/xlate_proTypes.h" 1
# 74 "../../libelfutil/xlate_proTypes.h"
...
# 188 "../../libelfutil/xlate_proTypes.h"
...
# 69 "../../libelfutil/xlateincl.h" 2
# 1 "../../libelfutil/xlatexterns.h" 1
# 73 "../../libelfutil/xlatexterns.h"
void
...
Elf64_Addr _xlate_get_out_from_ranges(Elf64_Addr addr_in,
        ...
        Elf64_Xword range2);
# 70 "../../libelfutil/xlateincl.h" 2
# 1 "../../libelfutil/xlate_pro_externs.h" 1
# 62 "../../libelfutil/xlate_pro_externs.h"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 51 "../../libelfutil/xlate_pro_add_range.c" 2
...
int _xlate_pro_add_range(xlate_table_pro table,
 Elf64_Addr new_address,
 Elf64_Xword new_range,
 Elf64_Addr old_address,
 Elf64_Xword old_range)
...
# 220 "../../libelfutil/xlate_pro_add_range.c"
void
...
# 260 "../../libelfutil/xlate_pro_add_range.c"
int
_xlate_add_tentative_new_range(xlate_table_pro table,
 Elf64_Addr new_address,
 Elf64_Xword new_range,
 ...
 Elf64_Xword old_range)
{
 ...
 if (new_address == highnew){
  ...
  table->tb_save_new_range += new_range;
   ...
   } else if(old_address == (highold - 4)) {

        table->tb_save_new_range += new_range;


        table->tb_save_old_range += (old_range - 4);
   } else {
      retstatus = _xlate_finish_saved_range(table);
      table->tb_save_new_address = new_address;
      table->tb_save_old_address = old_address;
   ...
   if(old_address == highold) {
  table->tb_save_old_range += old_range;
  table->tb_save_new_range += (new_range - 4);
   } else if(old_address == (highold - 4)) {
 ...
 Elf64_Xword old_range)
{
   ...
   Elf64_Xword last_valid_nindex = new_range - 4;
   Elf64_Xword last_valid_oindex = old_range - 4;
  ...
  last_valid_nindex > last_valid_oindex) {
   ...
   tentative_new_range = 4;
      }

      retstatus = _xlate_address(table->tb_con_table,
  1,
