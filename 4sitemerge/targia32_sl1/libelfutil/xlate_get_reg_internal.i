# 1 "../../libelfutil/xlate_get_reg_internal.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_get_reg_internal.c"
# 46 "../../libelfutil/xlate_get_reg_internal.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 47 "../../libelfutil/xlate_get_reg_internal.c" 2
        ...
        xlate_reg_instr2 ** instrs_out)
{
 ...
 if(instrs == 0) {
   return -1;
    ...
    for (i = 0; i < 66; i++) {
        ...
        regtable->rules[i].dw_regnum = 1035;
 ...
 switch (op) {
  ...
  regtable->rules[reg].dw_regnum = 0;
  ...
  reginfo += leb128_length;
                ...
                regtable->rules[0].dw_offset_relevant = 1;
                regtable->rules[0].dw_regnum = reg;
                regtable->rules[0].dw_offset = offset;
  break;
  ...
  reginfo += leb128_length;
                ...
                regtable->rules[reg].dw_regnum = 1034;
  ...
  reginfo += leb128_length;
                ...
                regtable->rules[reg].dw_offset_relevant = 0;
                regtable->rules[reg].dw_regnum = 1035;
                regtable->rules[reg].dw_offset = 0;
  break;
