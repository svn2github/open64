# 1 "../../libelfutil/xlate_named_init_elf.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_named_init_elf.c"
# 49 "../../libelfutil/xlate_named_init_elf.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 50 "../../libelfutil/xlate_named_init_elf.c" 2
...
# 285 "../../libelfutil/xlate_named_init_elf.c"
static int
...
int
_xlate_named_init_elf(Elf * elf, const char *section_name,
 xlate_table_con * ret_tab_ptr)
{
 ...
 if(is64bit) {
   ...
   if(shdr64->sh_type != 0x70000024 &&
  shdr64->sh_type != 0x70000025 &&
  shdr64->sh_type != 0x70000028 ) {
  continue;
   }
  ...
  continue;
   ...
   if(shdr32->sh_type != 0x70000024 &&
  shdr32->sh_type != 0x70000025 &&
  shdr32->sh_type != 0x70000028 ) {
  continue;
   }
   if(!(strcmp(section_name,sec_name) == 0)) {
  continue;
 ...
 return -27;
   ...
   xlatedata = elf_getdata(xlscn,((void *)0));
   if(xlatedata == ((void *)0) || xlatedata->d_size == 0) {
 return -28;
   }
 ...
 return -1;
   ...
   newtab->xc_valid_table = 0xa100f034;
   *ret_tab_ptr = newtab;
   return retstatus;
}

int
_xlate_finish(xlate_table_con tab)
{
   int retstatus = 0;
 ...
 return -2;
   ...
   if(tab->xc_valid_table != 0xa100f034) {
 return -43;
   }
