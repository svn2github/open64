# 1 "../../libelfutil/xlate_address.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_address.c"
# 46 "../../libelfutil/xlate_address.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 47 "../../libelfutil/xlate_address.c" 2
...
int
_xlate_address(xlate_table_con tab,
 int isNewAddress,
        Elf64_Addr addr_in,
 Elf64_Addr *addr_out,
 xlate_block *range)
{
 ...
 range->xe_old_range = 4;
 range->xe_new_range = 4;
      }
      retstatus = 0;
   }
   return retstatus;
