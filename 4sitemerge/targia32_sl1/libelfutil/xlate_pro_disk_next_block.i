# 1 "../../libelfutil/xlate_pro_disk_next_block.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libelfutil/xlate_pro_disk_next_block.c"
# 53 "../../libelfutil/xlate_pro_disk_next_block.c"
...
_xlate_add_tentative_new_range(xlate_table_pro table,
        ...
        Elf64_Xword old_range);
# 70 "../../libelfutil/xlateincl.h" 2
# 54 "../../libelfutil/xlate_pro_disk_next_block.c" 2
    ...
    Elf64_Xword * data_size)
{
 ...
 return -1;
      ...
      hdrp->hd_old_addr_high = table->tb_std_highwater.hw_highOldAddr;
    {
      ...
      retstatus = _xlate_get_info(contab,
...
# 304 "../../libelfutil/xlate_pro_disk_next_block.c"
static int
    ...
    Elf64_Xword * data_size)
{
 ...
 return -1;
    ...
    hdrp->hd_version = 0x5;
    if(table->tb_header_set_to_std_or_debug == 1){
      hdrp->hd_tablekind = table->tb_std_tablekind;
      hdrp->hd_new_addr_low =
  (Elf32_Word)table->tb_std_highwater.hw_lowNewAddr;
      hdrp->hd_new_addr_high =
    ...
    Elf64_Xword * data_size)
{
    ...
    data_ret = (char *)malloc(4096);
    if(data_ret == 0) {
 return -1;
    }
    memcpy(data_ret,curblock->bk_data, bytes_initialized);
    if(bytes_initialized <4096) {
        bzero(data_ret + bytes_initialized,4096 - bytes_initialized);
    }
...
int _xlate_pro_disk_next_block(xlate_table_pro table,
    char** data,
    Elf64_Xword * data_size)
{
    int retstatus = 0;
 ...
 return -51;
   ...
   return -10;
    ...
    } else if(table->tb_header_set_to_std_or_debug == 2){
     if(table->tb_std_header_returned == 0) {
 if(table->tb_is64bit) {
     retstatus = _xlate_do_simple_64bit_header(table,data,data_size);
 } else {
