# 1 "../../libdwarf/libdwarf/dwarf_arange.c"
# 1 "/usa/handong/simplnano/cmplr-open64-merge/targia32_sl1/libdwarf//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libdwarf/libdwarf/dwarf_arange.c"
# 43 "../../libdwarf/libdwarf/dwarf_arange.c"
# 1 "../../libdwarf/libdwarf/config.h" 1
# 44 "../../libdwarf/libdwarf/dwarf_arange.c" 2
...
# 45 "../../libdwarf/libdwarf/dwarf_arange.c" 2
...
# 46 "../../libdwarf/libdwarf/dwarf_arange.c" 2
...
int
  _dwarf_get_aranges_addr_offsets(Dwarf_Debug dbg,
      ...
      Dwarf_Signed * count,
      Dwarf_Error * error);
# 47 "../../libdwarf/libdwarf/dwarf_arange.c" 2
# 59 "../../libdwarf/libdwarf/dwarf_arange.c"
int
    ...
    Dwarf_Signed * returned_count, Dwarf_Error * error)
{
    ...
    Dwarf_Chain curr_chain, prev_chain, head_chain = ((void *)0);
 ...
 { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, 4) ; length = (Dwarf_Unsigned)_ltmp; }; if(length == 0xffffffff) { local_length_size = 8; arange_ptr += 4; local_extension_size = 4; { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, 8) ; length = (Dwarf_Unsigned)_ltmp; }; arange_ptr += 8; } else { if(length == 0 && dbg->de_big_endian_object) { { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, 8) ; length = (Dwarf_Unsigned)_ltmp; }; local_length_size = 8; arange_ptr += 8; local_extension_size = 0; } else { local_extension_size = 0; local_length_size = 4; arange_ptr += local_length_size; } };


 arange_ptr_past_end = arange_ptr + length;


 { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, sizeof(Dwarf_Half)) ; version = (Dwarf_Half)_ltmp; };

 arange_ptr += sizeof(Dwarf_Half);
 length = length - sizeof(Dwarf_Half);
 if (version != 2) {
     _dwarf_error(dbg, error, 48);
     return (1);
 }

 { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, local_length_size) ; info_offset = (Dwarf_Off)_ltmp; };

 arange_ptr += local_length_size;
 length = length - local_length_size;
 if (info_offset >= dbg->de_debug_info_size) {
     _dwarf_error(dbg, error, 134);
     return (1);
 }
 ...
 do {
     { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, address_size) ; range_address = (Dwarf_Addr)_ltmp; };

     arange_ptr += address_size;
     length = length - address_size;

     { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, address_size) ; range_length = (Dwarf_Unsigned)_ltmp; };
  ...
  arange = (Dwarf_Arange)
      _dwarf_get_alloc(dbg, 0x11, 1);
  if (arange == ((void *)0)) {
      _dwarf_error(dbg, error, 62);
      return (1);
  }
  ...
  curr_chain = (Dwarf_Chain)
      _dwarf_get_alloc(dbg, 0x1c + 2, 1);
  if (curr_chain == ((void *)0)) {
      _dwarf_error(dbg, error, 62);
      return (1);
  }

  curr_chain->ch_item = arange;
  if (head_chain == ((void *)0))
 ...
 arange_ptr = arange_ptr_past_end;
    ...
    if (arange_ptr !=
 dbg->de_debug_aranges + dbg->de_debug_aranges_size) {
 _dwarf_error(dbg, error, 137);
 return (1);
    }

    arange_block = (Dwarf_Arange *)
 _dwarf_get_alloc(dbg, 0x0f, arange_count);
    if (arange_block == ((void *)0)) {
 _dwarf_error(dbg, error, 62);
 return (1);
    }
 ...
 *(arange_block + i) = curr_chain->ch_item;
 ...
 dwarf_dealloc(dbg, prev_chain, 0x1c + 2);
    }
...
# 277 "../../libdwarf/libdwarf/dwarf_arange.c"
int
_dwarf_get_aranges_addr_offsets(Dwarf_Debug dbg,
    Dwarf_Addr ** addrs,
    Dwarf_Off ** offsets,
 ...
 *error = ((void *)0);
 ...
 do {
     ...
     { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, dbg->de_pointer_size) ; range_address = (Dwarf_Addr)_ltmp; };

     arange_ptr += dbg->de_pointer_size;
     length = length - dbg->de_pointer_size;

     { BIGGEST_UINT _ltmp = 0; dbg->de_copy_word( (char *)(&_ltmp) , arange_ptr, local_length_size) ; range_length = (Dwarf_Unsigned)_ltmp; };
 ...
 _dwarf_get_alloc(dbg, 0x1c, arange_count);
    if (arange_addrs == ((void *)0)) {
 _dwarf_error(dbg, error, 62);
 return (1);
    }
    arange_offsets = (Dwarf_Off *)
 _dwarf_get_alloc(dbg, 0x1c, arange_count);
    if (arange_offsets == ((void *)0)) {
 _dwarf_error(dbg, error, 62);
 return (1);
    }
...
# 502 "../../libdwarf/libdwarf/dwarf_arange.c"
int
...
# 537 "../../libdwarf/libdwarf/dwarf_arange.c"
int
...
# 573 "../../libdwarf/libdwarf/dwarf_arange.c"
int
...
# 597 "../../libdwarf/libdwarf/dwarf_arange.c"
int
