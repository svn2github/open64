...
.LC54:
	...
	.align 4
.LC55:
	.string	"static unsigned int tag_tree_combination_table [ ][2] = {"
.LC56:
	.string	"/* %-37s*/\n"
.LC57:
	.string	"    { %#.8x, %#.8x},\n"
...
.L5:
	...
	addl	%eax, %eax
	addl	%edx, %eax
	movl	tag_tree_combination_table(,%eax,4), %edx
	movl	-16(%ebp), %ecx
	movl	$1, %eax
	sall	%cl, %eax
	orl	%eax, %edx
	leal	(%ebx,%ebx), %eax
	addl	%esi, %eax
	movl	%edx, tag_tree_combination_table(,%eax,4)
	leal	-28(%ebp), %eax
	movl	%eax, 4(%esp)
	movl	$.LC54, (%esp)
	call	scanf
...
.L8:
	...
	call	printf
	movl	-24(%ebp), %eax
	movl	tag_tree_combination_table+4(,%eax,8), %edx
	movl	-24(%ebp), %eax
	movl	tag_tree_combination_table(,%eax,8), %eax
	movl	%edx, 8(%esp)
	movl	%eax, 4(%esp)
	movl	$.LC57, (%esp)
	call	printf
...
.L7:
	...
	ret
	.size	main, .-main
	.local	tag_tree_combination_table
	.comm	tag_tree_combination_table,432,32
