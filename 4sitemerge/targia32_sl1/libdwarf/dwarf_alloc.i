# 1 "../../libdwarf/libdwarf/dwarf_alloc.c"
# 1 "/usa/handong/simplnano/cmplr-open64-merge/targia32_sl1/libdwarf//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libdwarf/libdwarf/dwarf_alloc.c"
# 42 "../../libdwarf/libdwarf/dwarf_alloc.c"
# 1 "../../libdwarf/libdwarf/config.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_incl.h" 1
# 45 "../../libdwarf/libdwarf/dwarf_incl.h"
# 1 "../../libdwarf/libdwarf/libdwarfdefs.h" 1
# 72 "../../libdwarf/libdwarf/libdwarfdefs.h"
...
# 73 "../../libdwarf/libdwarf/libdwarfdefs.h" 2
# 46 "../../libdwarf/libdwarf/dwarf_incl.h" 2
...
# 47 "../../libdwarf/libdwarf/dwarf_incl.h" 2
...
# 1452 "/usr/include/elf.h" 3 4
typedef struct
{
  Elf32_Word hwp_flags1;
  Elf32_Word hwp_flags2;
} Elf_Options_Hw;
# 1604 "/usr/include/elf.h" 3 4
typedef struct
{
  Elf32_Word l_name;
...
# 1635 "/usr/include/elf.h" 3 4
typedef Elf32_Addr Elf32_Conflict;
# 2631 "/usr/include/elf.h" 3 4

# 50 "../../libdwarf/libdwarf/dwarf_incl.h" 2
...
# 53 "../../libdwarf/libdwarf/dwarf_incl.h" 2
# 1 "../../include/dwarf_stuff.h" 1
# 46 "../../include/dwarf_stuff.h"
# 1 "../../include/dwarf.h" 1
# 47 "../../include/dwarf_stuff.h" 2
# 1 "../../include/libdwarf.h" 1
...
int dwarf_attr_offset(Dwarf_Die ,
    ...
    Dwarf_Off * ,
    Dwarf_Error * );
# 48 "../../include/dwarf_stuff.h" 2
# 66 "../../include/dwarf_stuff.h"
extern Dwarf_Bool generate_fpic_dwarf;
extern Dwarf_Bool generate_m64_dwarf;
# 84 "../../include/dwarf_stuff.h"
Dwarf_P_Attribute dwf_add_AT_unsigned_const_ext(Dwarf_P_Debug ,
    Dwarf_P_Die ,
    Dwarf_Half ,
    Dwarf_Unsigned ,
    Dwarf_Error* ,
...
Dwarf_P_Attribute dwf_add_AT_complex_const(Dwarf_P_Debug ,
    Dwarf_P_Die ,
    Dwarf_Half ,
    Dwarf_Unsigned ,
    Dwarf_Unsigned ,
...
Dwarf_Unsigned dwf_add_frame_cie(Dwarf_P_Debug ,
    char* ,
    Dwarf_Small ,
    Dwarf_Small ,
    Dwarf_Small ,
...
Dwarf_Unsigned dwf_add_ehframe_cie(Dwarf_P_Debug ,
    char* ,
    Dwarf_Small ,
    Dwarf_Small ,
    Dwarf_Small ,
...
Dwarf_Unsigned dwf_add_ehframe_info(
    ...
    Dwarf_Unsigned ,
    Dwarf_Error* );
# 54 "../../libdwarf/libdwarf/dwarf_incl.h" 2

# 1 "../../libdwarf/libdwarf/dwarf_base_types.h" 1
# 82 "../../libdwarf/libdwarf/dwarf_base_types.h"
...
# 56 "../../libdwarf/libdwarf/dwarf_incl.h" 2
# 1 "../../libdwarf/libdwarf/dwarf_alloc.h" 1
# 42 "../../libdwarf/libdwarf/dwarf_alloc.h"
...
# 59 "../../libdwarf/libdwarf/dwarf_alloc.h"
...
# 111 "../../libdwarf/libdwarf/dwarf_alloc.h"
...
# 57 "../../libdwarf/libdwarf/dwarf_incl.h" 2
# 1 "../../libdwarf/libdwarf/dwarf_opaque.h" 1
# 54 "../../libdwarf/libdwarf/dwarf_opaque.h"
# 1 "/usr/lib/gcc/i486-linux-gnu/4.1.2/include/stddef.h" 1 3 4
# 152 "/usr/lib/gcc/i486-linux-gnu/4.1.2/include/stddef.h" 3 4
typedef int ptrdiff_t;
# 326 "/usr/lib/gcc/i486-linux-gnu/4.1.2/include/stddef.h" 3 4
typedef int wchar_t;
# 55 "../../libdwarf/libdwarf/dwarf_opaque.h" 2
...
# 102 "../../libdwarf/libdwarf/dwarf_opaque.h"
...
struct Dwarf_Debug_s {
    ...
    struct Dwarf_Alloc_Hdr_s de_alloc_hdr[31];
# 180 "../../libdwarf/libdwarf/dwarf_opaque.h"
    ...
    Dwarf_Small *de_debug_frame_eh_gnu;
    ...
    Dwarf_Unsigned de_debug_frame_size_eh_gnu;
    ...
    unsigned char de_elf_must_close;
# 241 "../../libdwarf/libdwarf/dwarf_opaque.h"
...
# 275 "../../libdwarf/libdwarf/dwarf_opaque.h"
void *_dwarf_memcpy_swap_bytes(void *s1, const void *s2, size_t len);
# 285 "../../libdwarf/libdwarf/dwarf_opaque.h"
int _dwarf_load_section(Dwarf_Debug,
          Dwarf_Half,
   Dwarf_Small **,
   Dwarf_Error *);
# 58 "../../libdwarf/libdwarf/dwarf_incl.h" 2
# 1 "../../libdwarf/libdwarf/dwarf_error.h" 1
# 42 "../../libdwarf/libdwarf/dwarf_error.h"
...
# 59 "../../libdwarf/libdwarf/dwarf_incl.h" 2
# 1 "../../libdwarf/libdwarf/dwarf_util.h" 1
# 114 "../../libdwarf/libdwarf/dwarf_util.h"
typedef Dwarf_Unsigned BIGGEST_UINT;
# 237 "../../libdwarf/libdwarf/dwarf_util.h"
Dwarf_Unsigned
...
# 60 "../../libdwarf/libdwarf/dwarf_incl.h" 2
# 44 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
...
# 47 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
...
# 48 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
...
# 49 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
...
# 1 "../../libdwarf/libdwarf/dwarf_line.h" 1
# 58 "../../libdwarf/libdwarf/dwarf_line.h"
...
# 129 "../../libdwarf/libdwarf/dwarf_line.h"
struct Dwarf_Line_s {
 ...
 struct li_inner_s {
     ...
     Dwarf_Small li_is_stmt;
     Dwarf_Small li_basic_block;
     Dwarf_Small li_end_sequence;
...
int
  _dwarf_line_address_offsets(Dwarf_Debug dbg,
         ...
         Dwarf_Error * err);
# 57 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_global.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_global.h"
typedef struct Dwarf_Global_Context_s *Dwarf_Global_Context;
# 57 "../../libdwarf/libdwarf/dwarf_global.h"
struct Dwarf_Global_Context_s {
# 66 "../../libdwarf/libdwarf/dwarf_global.h"
...
int _dwarf_internal_get_pubnames_like_data(Dwarf_Debug dbg,
        ...
        int length_err_num,
        int version_err_num);
# 58 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_arange.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_arange.h"
...
int
  _dwarf_get_aranges_addr_offsets(Dwarf_Debug dbg,
      ...
      Dwarf_Signed * count,
      Dwarf_Error * error);
# 59 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_abbrev.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_abbrev.h"
...
# 60 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_die_deliv.h" 1
# 48 "../../libdwarf/libdwarf/dwarf_die_deliv.h"
...
# 61 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_frame.h" 1
# 105 "../../libdwarf/libdwarf/dwarf_frame.h"
struct Dwarf_Reg_Rule_s {
# 121 "../../libdwarf/libdwarf/dwarf_frame.h"
...
struct Dwarf_Frame_s {
    ...
    struct Dwarf_Reg_Rule_s fr_reg[(65 + 1)];
...
# 165 "../../libdwarf/libdwarf/dwarf_frame.h"
struct Dwarf_Cie_s {
...
# 191 "../../libdwarf/libdwarf/dwarf_frame.h"
struct Dwarf_Fde_s {
...
int
  _dwarf_frame_address_offsets(Dwarf_Debug dbg, Dwarf_Addr ** addrlist,
          ...
          Dwarf_Error * err);
# 62 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_loc.h" 1
# 42 "../../libdwarf/libdwarf/dwarf_loc.h"
...
# 63 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_funcs.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_funcs.h"
typedef struct Dwarf_Func_Context_s *Dwarf_Func_Context;
# 64 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_types.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_types.h"
typedef struct Dwarf_Type_Context_s *Dwarf_Type_Context;
# 65 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_vars.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_vars.h"
typedef struct Dwarf_Var_Context_s *Dwarf_Var_Context;
# 66 "../../libdwarf/libdwarf/dwarf_alloc.c" 2
# 1 "../../libdwarf/libdwarf/dwarf_weaks.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_weaks.h"
typedef struct Dwarf_Weak_Context_s *Dwarf_Weak_Context;
# 67 "../../libdwarf/libdwarf/dwarf_alloc.c" 2

static void _dwarf_free_special_error(Dwarf_Ptr space);
# 132 "../../libdwarf/libdwarf/dwarf_alloc.c"
struct ial_s {
    int ia_al_num;
...
static const
struct ial_s index_into_allocated[42] = {
    {0, 1, 1},
    {0, 1, 1,},
    {1, sizeof(Dwarf_Loc), 64}
    ,
    {2, sizeof(Dwarf_Locdesc), 64}
    ,
    {0, 1, 1}
    ,
    {0, 1, 1}
    ,
    {3, sizeof(Dwarf_Block), 64}
    ,
    {0, 1, 1}
    ,
    {4, sizeof(struct Dwarf_Die_s), 128},
    {5, sizeof(struct Dwarf_Line_s), 128},

    {6, sizeof(struct Dwarf_Attribute_s), 128 * 2},

    {0, 1, 1},
    {0, 1, 1},
    {7, sizeof(struct Dwarf_Global_s), 128},


    {8, sizeof(struct Dwarf_Error_s), 64},


    {0, 1, 1},
    {0, 1, 1},
    {9, sizeof(struct Dwarf_Arange_s), 64},


    {10, sizeof(struct Dwarf_Abbrev_s), 128},


    {11, sizeof(Dwarf_Frame_Op), 128}
    ,
    {12, sizeof(struct Dwarf_Cie_s), 64},

    {13, sizeof(struct Dwarf_Fde_s), 64},

    {0, 1, 1},
    {0, 1, 1},
    {14, sizeof(struct Dwarf_Global_s), 128},

    {15, sizeof(struct Dwarf_Global_s), 128},


    {16, sizeof(struct Dwarf_Global_s), 128},

    {17, sizeof(struct Dwarf_Global_s), 64},

    {0, 1, 1},
    {18, sizeof(struct Dwarf_Abbrev_List_s), 128},

    {19, sizeof(struct Dwarf_Chain_s), 128},


    {20, sizeof(struct Dwarf_CU_Context_s), 64},

    {21, sizeof(struct Dwarf_Frame_s), 64},


    {22, sizeof(struct Dwarf_Global_Context_s), 64},

    {23, sizeof(struct Dwarf_File_Entry_s), 64},

    {24, sizeof(struct Dwarf_Line_Context_s), 64},

    {25, sizeof(struct Dwarf_Loc_Chain_s), 64},

    {26, 10 * 2 * sizeof(Dwarf_Abbrev_List),
     64}
    ,
    ...
    {27, sizeof(struct Dwarf_Global_Context_s), 64},

    {28, sizeof(struct Dwarf_Global_Context_s), 64},

    {29, sizeof(struct Dwarf_Global_Context_s), 64},

    {30, sizeof(struct Dwarf_Global_Context_s), 64},

};
# 275 "../../libdwarf/libdwarf/dwarf_alloc.c"
static Dwarf_Ptr
_dwarf_find_memory(Dwarf_Alloc_Hdr alloc_hdr)
{
    ...
    if (alloc_area == ((void *)0) || alloc_area->aa_free_structs_in_chunk == 0)
 for (alloc_area = alloc_hdr->ah_alloc_area_head;
      alloc_area != ((void *)0); alloc_area = alloc_area->aa_next) {
  ...
  break;
    ...
    if (alloc_area != ((void *)0)) {
 alloc_area->aa_free_structs_in_chunk--;

 if (alloc_area->aa_free_list != ((void *)0)) {
  ...
  ((Dwarf_Free_List) ret_mem)->fl_next;
     ...
     *(Dwarf_Alloc_Area *) ret_mem = alloc_area;
     ret_mem += (2 * sizeof(void *));

     alloc_area->aa_blob_start += alloc_hdr->ah_bytes_one_struct;
 } else {
# 338 "../../libdwarf/libdwarf/dwarf_alloc.c"
 }
    }
...

 {
     ...
     rounded_area_hdr_size = (((v) % ((2 * sizeof(void *)))) == 0 ? (v): ((v) + ((2 * sizeof(void *))) - ((v) % ((2 * sizeof(void *)))) ));
 }
 ...
 if (alloc_hdr->ah_alloc_area_head != ((void *)0)) {
 ...
 *(Dwarf_Alloc_Area *) ret_mem = alloc_area;
 ret_mem += (2 * sizeof(void *));
    ...
    memset(ret_mem,0, alloc_hdr->ah_bytes_one_struct - (2 * sizeof(void *)));
    return (ret_mem);
}
# 434 "../../libdwarf/libdwarf/dwarf_alloc.c"
Dwarf_Ptr
...
# 512 "../../libdwarf/libdwarf/dwarf_alloc.c"
     }
 }
    }
...
# 556 "../../libdwarf/libdwarf/dwarf_alloc.c"
void
       ...
       Dwarf_Ptr space, Dwarf_Unsigned alloc_type)
{
 ...
 alloc_area =
     *(Dwarf_Alloc_Area *) ((char *) space - (2 * sizeof(void *)));
 if (alloc_area == 0) {
 ...
 return;
    ...
    alloc_area = *(Dwarf_Alloc_Area *) ((char *) space - (2 * sizeof(void *)));
# 693 "../../libdwarf/libdwarf/dwarf_alloc.c"
    if (alloc_area->aa_alloc_hdr != alloc_hdr) {
# 704 "../../libdwarf/libdwarf/dwarf_alloc.c"
 return;
    }
 ...
 if (alloc_area == alloc_hdr->ah_last_alloc_area) {
     alloc_hdr->ah_last_alloc_area = ((void *)0);
 }
...
# 797 "../../libdwarf/libdwarf/dwarf_alloc.c"
Dwarf_Debug
_dwarf_setup_debug(Dwarf_Debug dbg)
{
 ...
 Dwarf_Word rnded_size = ((((str_size) % ((2 * sizeof(void *)))) == 0 ? (str_size): ((str_size) + ((2 * sizeof(void *))) - ((str_size) % ((2 * sizeof(void *)))) )) + (2 * sizeof(void *)));
...
dwarf_print_memory_stats(Dwarf_Debug dbg)
{
    ...
    char *alloc_type_name[0x1c + 13 + 1] = {
 "",
 "DW_DLA_STRING",
 "DW_DLA_LOC",
 "DW_DLA_LOCDESC",
...
# 914 "../../libdwarf/libdwarf/dwarf_alloc.c"
static void
...
# 934 "../../libdwarf/libdwarf/dwarf_alloc.c"
int
_dwarf_free_all_of_one_debug(Dwarf_Debug dbg)
{
    ...
    if (dbg == ((void *)0))
 return (1);
# 967 "../../libdwarf/libdwarf/dwarf_alloc.c"
    for (i = 1; i < 31; i++) {
 int indx = i;
...
# 991 "../../libdwarf/libdwarf/dwarf_alloc.c"
struct Dwarf_Error_s *
