# 1 "../../libdwarf/libdwarf/dwarf_abbrev.c"
# 1 "/usa/handong/simplnano/cmplr-open64-merge/targia32_sl1/libdwarf//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libdwarf/libdwarf/dwarf_abbrev.c"
# 42 "../../libdwarf/libdwarf/dwarf_abbrev.c"
# 1 "../../libdwarf/libdwarf/config.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_abbrev.c" 2
...
# 44 "../../libdwarf/libdwarf/dwarf_abbrev.c" 2
...
# 45 "../../libdwarf/libdwarf/dwarf_abbrev.c" 2
...
# 46 "../../libdwarf/libdwarf/dwarf_abbrev.c" 2
   ...
   Dwarf_Unsigned * abbr_count, Dwarf_Error * error)
{
 ...
 return (-1);
    ...
    ret_abbrev = (Dwarf_Abbrev) _dwarf_get_alloc(dbg, 0x12, 1);
    if (ret_abbrev == ((void *)0)) {
 _dwarf_error(dbg, error, 62);
 return (1);
    }
    ret_abbrev->ab_dbg = dbg;
    if (returned_abbrev == 0 || abbr_count == 0) {
 _dwarf_error(dbg, error, 110);
 return (1);
    }
 ...
 *length = 1;
 ...
 dbg->de_debug_abbrev + dbg->de_debug_abbrev_size;
    ...
    { Dwarf_Word uleblen; utmp = _dwarf_decode_u_leb128(abbrev_ptr,&uleblen); abbrev_ptr += uleblen; };
 ...
 *abbr_count = 0;
 ...
 { Dwarf_Word uleblen; utmp2 = _dwarf_decode_u_leb128(abbrev_ptr,&uleblen); abbrev_ptr += uleblen; }
         ...
         Dwarf_Off * offset, Dwarf_Error * error)
{
 ...
 { Dwarf_Word uleblen; utmp4 = _dwarf_decode_u_leb128(abbrev_ptr,&uleblen); abbrev_ptr += uleblen; }
 ...
 _dwarf_error(abbrev->ab_dbg, error, 109);
 return (1);
    }
