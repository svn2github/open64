# 1 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/dwarfdump.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/dwarfdump.c"
# 34 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/dwarfdump.c"
# 1 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 1
# 42 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h"
# 1 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/config.h" 1
# 43 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 2
# 64 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h"
...
# 1 "/usr/local/gcc-3.3.5/lib/gcc-lib/i686-pc-linux-gnu/3.3.5/include/stddef.h" 1 3 4
# 213 "/usr/local/gcc-3.3.5/lib/gcc-lib/i686-pc-linux-gnu/3.3.5/include/stddef.h" 3 4
...
# 65 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 2
# 83 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h"
...
# 1 "/usr/local/gcc-3.3.5/lib/gcc-lib/i686-pc-linux-gnu/3.3.5/include/stddef.h" 1 3 4
# 325 "/usr/local/gcc-3.3.5/lib/gcc-lib/i686-pc-linux-gnu/3.3.5/include/stddef.h" 3 4
typedef long int wchar_t;
# 354 "/usr/local/gcc-3.3.5/lib/gcc-lib/i686-pc-linux-gnu/3.3.5/include/stddef.h" 3 4
...
# 1 "/usr/local/gcc-3.3.5/lib/gcc-lib/i686-pc-linux-gnu/3.3.5/include/stdarg.h" 1 3 4
# 43 "/usr/local/gcc-3.3.5/lib/gcc-lib/i686-pc-linux-gnu/3.3.5/include/stdarg.h" 3 4
...
# 84 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 2
...
# 85 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 2
...
# 86 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 2
...
# 1615 "/usr/include/elf.h" 3 4
typedef Elf32_Addr Elf32_Conflict;
# 2556 "/usr/include/elf.h" 3 4

# 88 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 2
# 96 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h"
# 1 "../../libdwarf/libdwarf/dwarf.h" 1
# 97 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 2
# 1 "../../libdwarf/libdwarf/libdwarf.h" 1
# 70 "../../libdwarf/libdwarf/libdwarf.h"
struct Elf;
typedef struct Elf* dwarf_elf_handle;
# 90 "../../libdwarf/libdwarf/libdwarf.h"
...
# 164 "../../libdwarf/libdwarf/libdwarf.h"
enum Dwarf_Rel_Type {
                dwarf_drt_none,
...
# 535 "../../libdwarf/libdwarf/libdwarf.h"
int dwarf_init(int ,
    Dwarf_Unsigned ,
    Dwarf_Handler ,
    Dwarf_Ptr ,
...
# 1144 "../../libdwarf/libdwarf/libdwarf.h"
...
# 1210 "../../libdwarf/libdwarf/libdwarf.h"
...
int dwarf_attr_offset(Dwarf_Die ,
    ...
    Dwarf_Off * ,
    Dwarf_Error * );
# 98 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h" 2

typedef char * string;
typedef int boolean;
# 111 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/globals.h"
typedef struct {
    int checks;
    int errors;
} Dwarf_Check_Result;
...
extern void print_one_die(
        ...
        char **srcfiles,
        Dwarf_Signed cnt);
# 35 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/dwarfdump.c" 2
...
# 39 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/dwarfdump.c" 2
...
# 40 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/dwarfdump.c" 2
...
extern int getopt_long_only (int ___argc, char *const *___argv,
                             ...
                             const struct option *__longopts, int *__longind)
       __attribute__ ((__nothrow__));
# 42 "/home/share/sl1merge/src/sw/cmplr/libdwarf/dwarfdump/dwarfdump.c" 2
...
boolean info_flag = 0;
boolean use_old_dwarf_loclist = 0;




static boolean line_flag = 0;
static boolean abbrev_flag = 0;
static boolean frame_flag = 0;
static boolean exceptions_flag = 0;
static boolean pubnames_flag = 0;
static boolean macinfo_flag = 0;
static boolean loc_flag = 0;
static boolean aranges_flag = 0;
static boolean string_flag = 0;
static boolean reloc_flag = 0;
static boolean static_func_flag = 0;
static boolean static_var_flag = 0;
static boolean type_flag = 0;
static boolean weakname_flag = 0;

int verbose = 0;
boolean dense = 0;
boolean ellipsis = 0;
boolean dst_format = 0;

boolean check_abbrev_code = 0;
boolean check_pubname_attr = 0;
boolean check_reloc_offset = 0;
boolean check_attr_tag = 0;
boolean check_tag_tree = 0;
boolean check_type_offset = 0;

static boolean dwarf_check = 0;

char cu_name[8192];
boolean cu_name_flag = 0;
...
process_one_file(Elf * elf, string file_name, int archive)
{
    ...
    dres = dwarf_elf_init(elf, 0, ((void *)0), ((void *)0), &dbg, &err);
    if (dres == -1) {
    ...
    attrib_buf = (string) malloc(999);
    if (attrib_buf == ((void *)0)) {
    ...
    if (check_pubname_attr)
        { fprintf(stderr, "%-24s%8d%8d\n", "pubname_attr", pubname_attr_result.checks, pubname_attr_result.errors); }
            if (check_attr_tag)
            { fprintf(stderr, "%-24s%8d%8d\n", "attr_tag", attr_tag_result.checks, attr_tag_result.errors); }
                if (check_tag_tree)
                { fprintf(stderr, "%-24s%8d%8d\n", "tag_tree", tag_tree_result.checks, tag_tree_result.errors); }
                    if (check_type_offset)
                    { fprintf(stderr, "%-24s%8d%8d\n", "type_offset", type_offset_result.checks, type_offset_result.errors); }
...
process_args(int argc, char *argv[])
{
    extern int optind;
    int c;
    boolean usage_error = 0;
    int oarg;

    program_name = argv[0];

    while ((c =
            getopt(argc, argv, "ailfghbprmcsvdeok:gu:t:ywz")) != (-1)) {
        switch (c) {
        case 'g':
            use_old_dwarf_loclist = 1;
        case 'i':
            info_flag = 1;
            break;
        case 'l':
        ...
        case 's':
            ...
            break;
        case 'a':
            info_flag = line_flag = frame_flag = abbrev_flag = 1;
            pubnames_flag = aranges_flag = macinfo_flag = 1;
            loc_flag = string_flag = 1;
            reloc_flag = 1;
            static_func_flag = static_var_flag = 1;
            type_flag = weakname_flag = 1;
            break;
        case 'v':
            verbose++;
            break;
        ...
        case 'k':
            ...
            switch (oarg) {
            case 'a':
                check_pubname_attr = 1;
                check_attr_tag = 1;
                check_tag_tree = check_type_offset = 1;
                pubnames_flag = info_flag = 1;
                break;
            case 'e':
                check_pubname_attr = 1;
                pubnames_flag = 1;
...
print_infos(Dwarf_Debug dbg)
{
    ...
    while ((nres =
        ...
        if (cu_name_flag) {
            ...
            sres = dwarf_siblingof(dbg, ((void *)0), &cu_die, &err);
            if (sres != 0) {
            ...
            ares = dwarf_attr(cu_die, 0x03, &attrib, &err);
            if (ares != 0) {
            ...
            dwarf_dealloc(dbg, attrib, 0x0a);
            dwarf_dealloc(dbg, cu_die, 0x08);
        }
        ...
        if (sres == 0) {
            if (info_flag || cu_name_flag) {
                ...
                if (srcf == 0) {
                    ...
                    for (si = 0; si < cnt; ++si) {
                        dwarf_dealloc(dbg, srcfiles[si], 0x01);
                    }
                    dwarf_dealloc(dbg, srcfiles, 0x0f);
                }
            }
            if (line_flag)
            ...
            Dwarf_Error err)
{
    ...
    } else if (dwarf_code == -1) {
        fprintf(stderr, "%s NO ENTRY:  %s: \n", program_name, msg);
    } else if (dwarf_code == 0) {
        fprintf(stderr, "%s:  %s \n", program_name, msg);
    } else {
