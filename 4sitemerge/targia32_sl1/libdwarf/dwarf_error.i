# 1 "../../libdwarf/libdwarf/dwarf_error.c"
# 1 "/usa/handong/simplnano/cmplr-open64-merge/targia32_sl1/libdwarf//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "../../libdwarf/libdwarf/dwarf_error.c"
# 42 "../../libdwarf/libdwarf/dwarf_error.c"
# 1 "../../libdwarf/libdwarf/config.h" 1
# 43 "../../libdwarf/libdwarf/dwarf_error.c" 2
...
# 44 "../../libdwarf/libdwarf/dwarf_error.c" 2
...
# 49 "../../libdwarf/libdwarf/dwarf_error.c" 2
...
# 50 "../../libdwarf/libdwarf/dwarf_error.c" 2
...
# 52 "../../libdwarf/libdwarf/dwarf_error.c" 2
...
# 301 "../../libdwarf/libdwarf/dwarf_error.c"
void
_dwarf_error(Dwarf_Debug dbg, Dwarf_Error * error, Dwarf_Sword errval)
{
 ...
 if (dbg != ((void *)0)) {
     errptr =
  (Dwarf_Error) _dwarf_get_alloc(dbg, 0x0e, 1);
     if (errptr == ((void *)0)) {
  fprintf(stderr,
 ...
 *error = errptr;
 return;
    ...
    if (dbg != ((void *)0) && dbg->de_errhand != ((void *)0)) {
 errptr = (Dwarf_Error) _dwarf_get_alloc(dbg, 0x0e, 1);
 if (errptr == ((void *)0)) {
