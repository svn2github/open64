...
# 1 "/usr/include/wait.h" 2 3 4
# 31 "../../driver/license.c" 2
...
# 33 "../../driver/license.c" 2
# 1 "../../driver/license.h" 1
# 27 "../../driver/license.h"
void obtain_license (char *exedir, int argc, char *argv[]) ;
# 34 "../../driver/license.c" 2
...
void obtain_license (char *exedir, int argc, char *argv[]) {
 ...
 argvec[3] = "";
        ...
        if (((((__extension__ ({ union { __typeof(statloc) __in; int __i; } __u; __u.__in = (statloc); __u.__i; }))) & 0x7f) == 0)) {
            if (((((__extension__ ({ union { __typeof(statloc) __in; int __i; } __u; __u.__in = (statloc); __u.__i; }))) & 0xff00) >> 8) == 6) {
                do_exit (1) ;
            } else if (((((__extension__ ({ union { __typeof(statloc) __in; int __i; } __u; __u.__in = (statloc); __u.__i; }))) & 0xff00) >> 8) == 7) {
                fprintf (stderr, "Compilation terminated\n") ;
                do_exit (1) ;
            } else if (((((__extension__ ({ union { __typeof(statloc) __in; int __i; } __u; __u.__in = (statloc); __u.__i; }))) & 0xff00) >> 8) != 0) {
