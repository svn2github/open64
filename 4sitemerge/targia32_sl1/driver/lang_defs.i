...
# 44 "../../driver/lang_defs.c" 2



# 1 "../../driver/lang_defs.h" 1
# 44 "../../driver/lang_defs.h"
# 1 "../../driver/basic.h" 1
# 44 "../../driver/basic.h"
typedef int boolean;
...
# 49 "../../driver/lang_defs.c" 2
# 1 "../../driver/string_utils.h" 1
# 48 "../../driver/string_utils.h"
...
static lang_info_t language_info[] = {
 ...
 {'A', 0x0fffffff, {""}},
 {'p', 0x00000001, {"cpp"}},
 {'c', 0x00000002, {"cc", "" "cc", "sl" "-" "" "cc","gcc","c89"}},
 {'C', 0x00000004, {"CC", "" "CC", "" "++","g++"}},
 {'f', 0x00000008, {"f77", "" "f77","gf77","fort77"}},
 {'F', 0x00000010, {"f90", "" "f90"}},
 {'a', 0x00000020, {"as", "" "as","gas"}},
 {'l', 0x00000040, {"ld", "" "ld"}},
 {'I', 0x80000000, {"int"}},
};
# 89 "../../driver/lang_defs.c"
typedef struct phase_struct {
 char key;
 mask_t mask;
 char *name;
 char *dir;
 boolean set_ld_library_path;

} phase_info_t;

static phase_info_t phase_info[] = {
   {'N', 0x0000000000000000LL, "", "", 0},
   {'A', 0x0fffffffffffffffLL, "", "", 0},

   {'m', 0x0000000000000008LL, "m4", "/usr/" "" "/bin", 0},
   {'r', 0x0000000000000001LL, "ratfor","/usr/" "" "/bin", 0},

   {'p', 0x0000000000000010LL, "cpp", "/usr/bin", 0},




   {'p', 0x0000000000000020LL, "" "gcc", "/usr/" "" "/altbin", 0},
   {'p', 0x0000000000000040LL, "" "g++", "/usr/" "" "/altbin", 0},




   {'p', 0x0000000000000080LL, "fec", "/usr/bin", 0},

   {'p', 0x0000000000000100LL, "cpp", "/usr/bin", 0},



   {'p', 0x0000000000000200LL, "mfef77","/usr/bin", 0},
   {'p', 0x0000000000000400LL, "ftpp" ,"/usr/bin", 0},

   {'p', 0x0000000000000800LL, "coco" ,"/usr/bin", 0},


   {'p', 0x0000000000000ff0LL, "", "", 0},

   {'K', 0x0000000000001000LL, "pfa", "/usr/bin", 0},
   {'K', 0x0000000000002000LL, "pca", "/usr/bin", 0},
   {'M', 0x0000000000008000LL, "mpc", "/usr/bin", 0},


   {'K', 0x0000000000007000LL, "", "", 0},
# 148 "../../driver/lang_defs.c"
   {'f', 0x0000000000010000LL, "mfef77","/usr/bin", 0},
   {'f', 0x0000000000020000LL, "mfef77","/usr/bin", 0},
   {'f', 0x0000000000040000LL, "mfef95","/usr/bin", 0},
   {'f', 0x0000000000080000LL, "mfef95","/usr/bin", 0},
   {'f', 0x0000000000100000LL, "gfec","/usr/bin", 1 },
   {'f', 0x0000000000200000LL, "gfecc","/usr/bin", 1 },


   {'f', 0x0000000000ff0000LL, "", "", 0},
   {'F', 0x00000000000f0000LL, "", "", 0},
   {'C', 0x0000000000f00000LL, "", "", 0},

   {'X', 0x0000000002000000LL, "ftnlx", "/usr/bin", 0},

   {'i', 0x0000000010000000LL, "inline","/usr/bin", 1},
   {'i', 0x0000000020000000LL, "ipl", "/usr/bin", 1},
   {'i', 0x00000000f0000000LL, "", "", 1},

   {'b', 0x0000000100000000LL, "be", "/usr/bin", 1},


   {'a', 0x0000001000000000LL, "asm", "/usr/bin", 0},


   {'a', 0x0000002000000000LL, "" "as", "/usr/" "" "/bin", 0},
   ...
   {'a', 0x0000003000000000LL, "", "", 0},

   {'d', 0x0000008000000000LL, "dsm_prelink", "/usr/bin",0},
   {'j', 0x0000010000000000LL, "ipa_link", "/usr/" "" "/bin",1},
   {'l', 0x0000020000000000LL, "collect2", "/usr/" "" "/lib",1},


   {'l', 0x0000040000000000LL, "" "ld", "/usr/" "" "/bin", 0},
   {'l', 0x0000080000000000LL, "" "ld", "/usr/" "" "/bin", 0},




   {'l', 0x01000f0000000000LL, "", "", 1},





   {'c', 0x0000100000000000LL, "cord", "/usr/" "" "/bin", 0},
   {'x', 0x0000200000000000LL, "pixie", "/usr/" "" "/bin", 0},
   {'x', 0x0000400000000000LL, "prof", "/usr/" "" "/bin", 0},

   {'R', 0x0001000000000000LL, "ar", "/usr/" "" "/bin", 0},
   {'S', 0x0010000000000000LL, "crt", "/usr/" "" "/lib", 0},
   {'I', 0x0020000000000000LL, "inc", "/usr/include", 0},
   {'L', 0x0040000000000000LL, "lib", "/usr/" "" "/lib", 0},
   {'L', 0x0080000000000000LL, "alib", "/usr/" "" "/lib", 0},

   {'S', 0x0010000000000000LL, "crt", "/usr/libsl2", 0},
...
get_named_language (char *name)
{
 ...
 int j;
 char *p;
# 463 "../../driver/lang_defs.c"
 for (i = L_NONE; i < L_LAST; i++) {
     for (j = 0; j < 5 && language_info[i].name[j] != ((void *)0); j++) {
...
get_source_kind_from_suffix (char *suf)
{
 source_kind_t i;
 int j;
 if (suf == ((void *)0)) return S_o;
 for (i = S_NONE; i < S_LAST; i++) {
  for (j = 0; j < 8 && source_info[i].suffix[j] != ((void *)0); j++) {
...
is_object_source_kind(char *src)
{
 ...
 if (suf == ((void *)0)) return 0;
 for (j = 0; j < 8 && source_info[S_o].suffix[j] != ((void *)0); j++) {
