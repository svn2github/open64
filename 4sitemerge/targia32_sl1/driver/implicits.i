...
{
 if (option_was_implicitly_seen(34)) {
  option_name = get_option_name(34);
  toggle(&msglevel,0);
 }
 if (option_was_implicitly_seen(39)) {
  option_name = get_option_name(39);
  toggle(&msglevel,0);
 }
 if (option_was_implicitly_seen(51)) {
  option_name = get_option_name(51);
  toggle(&skip_as,0);
 }
 if (option_was_implicitly_seen(91)) {
  option_name = get_option_name(91);
  toggle(&shared,2);
 }
 if (option_was_implicitly_seen(98)) {
  option_name = get_option_name(98);
  toggle(&rflag,2);
 }
 if (option_was_implicitly_seen(99)) {
  option_name = get_option_name(99);
  toggle(&rflag,1);
 }
 if (option_was_implicitly_seen(100)) {
  option_name = get_option_name(100);
  toggle(&shared,4);last_phase=P_any_ld;
 }
 if (option_was_implicitly_seen(101)) {
  option_name = get_option_name(101);
  toggle(&qwalign2,1);toggle(&qwalign1,0);
 }
 if (option_was_implicitly_seen(102)) {
  option_name = get_option_name(102);
  toggle(&qwalign1,1);toggle(&qwalign2,0);
 }
 if (option_was_implicitly_seen(142)) {
  option_name = get_option_name(142);
  toggle(&iflag,1);
 }
 if (option_was_implicitly_seen(150)) {
  option_name = get_option_name(150);
  toggle(&skip_as,1);
 }
 if (option_was_implicitly_seen(157)) {
  option_name = get_option_name(157);
  toggle(&abi,ABI_N32);
 }
 if (option_was_implicitly_seen(162)) {
  option_name = get_option_name(162);
  toggle(&sse2,1);toggle(&sse3,1);
 }
 if (option_was_implicitly_seen(163)) {
  option_name = get_option_name(163);
  toggle(&sse2,1);
 }
 if (option_was_implicitly_seen(165)) {
  option_name = get_option_name(165);
  toggle(&ospace,1);
 }
 if (option_was_implicitly_seen(174)) {
  option_name = get_option_name(174);
  toggle(&mpkind,0);
 }
 if (option_was_implicitly_seen(176)) {
  option_name = get_option_name(176);
  toggle(&sse3,0);
 }
 if (option_was_implicitly_seen(177)) {
  option_name = get_option_name(177);
  toggle(&sse2,0);toggle(&sse3,0);
 }
 if (option_was_implicitly_seen(178)) {
  option_name = get_option_name(178);
  toggle(&sse2,0);toggle(&sse3,0);
 }
 if (option_was_implicitly_seen(183)) {
  option_name = get_option_name(183);
  toggle(&m3dnow,0);
 }
 if (option_was_implicitly_seen(185)) {
  option_name = get_option_name(185);
  toggle(&isa,ISA_MIPS4);
 }
 if (option_was_implicitly_seen(201)) {
  option_name = get_option_name(201);
  toggle(&abi,ABI_64);
 }
 if (option_was_implicitly_seen(202)) {
  option_name = get_option_name(202);
  toggle(&m3dnow,1);
 }
 if (option_was_implicitly_seen(204)) {
  option_name = get_option_name(204);
  toggle(&abi,ABI_N32);
 }
 if (option_was_implicitly_seen(215)) {
  option_name = get_option_name(215);
  toggle(&ipa,1);
 }
 if (option_was_implicitly_seen(223)) {
  option_name = get_option_name(223);
  toggle(&iflag,3);
 }
 if (option_was_implicitly_seen(224)) {
  option_name = get_option_name(224);
  toggle(&iflag,2);
 }
 if (option_was_implicitly_seen(225)) {
  option_name = get_option_name(225);
  toggle(&iflag,1);
 }
 if (option_was_implicitly_seen(228)) {
  option_name = get_option_name(228);
  toggle(&use_h264libs,1);toggle(&use_bblibs,0);
 }
 if (option_was_implicitly_seen(235)) {
  option_name = get_option_name(235);
  toggle(&glevel,3);
 }
 if (option_was_implicitly_seen(236)) {
  option_name = get_option_name(236);
  toggle(&glevel,2);
 }
 if (option_was_implicitly_seen(237)) {
  option_name = get_option_name(237);
  toggle(&glevel,3);
 }
 if (option_was_implicitly_seen(238)) {
  option_name = get_option_name(238);
  toggle(&glevel,2);
 }
 if (option_was_implicitly_seen(239)) {
  option_name = get_option_name(239);
  toggle(&glevel,1);
 }
 if (option_was_implicitly_seen(240)) {
  option_name = get_option_name(240);
  toggle(&glevel,0);
 }
 if (option_was_implicitly_seen(241)) {
  option_name = get_option_name(241);
  toggle(&glevel,2);
 }
 if (option_was_implicitly_seen(246)) {
  option_name = get_option_name(246);
  toggle(&glevel,3);
 }
 if (option_was_implicitly_seen(247)) {
  option_name = get_option_name(247);
  toggle(&glevel,2);
 }
 if (option_was_implicitly_seen(248)) {
  option_name = get_option_name(248);
  toggle(&glevel,1);
 }
 if (option_was_implicitly_seen(249)) {
  option_name = get_option_name(249);
  toggle(&glevel,0);
 }
 if (option_was_implicitly_seen(250)) {
  option_name = get_option_name(250);
  toggle(&glevel,2);
 }
 if (option_was_implicitly_seen(266)) {
  option_name = get_option_name(266);
  toggle(&msglevel,2);
 }
 if (option_was_implicitly_seen(268)) {
  option_name = get_option_name(268);
  toggle(&use_ftpp,1);
 }
 if (option_was_implicitly_seen(292)) {
  option_name = get_option_name(292);
  toggle(&fortran_form,2);
 }
 if (option_was_implicitly_seen(299)) {
  option_name = get_option_name(299);
  toggle(&pic,1);
 }
 if (option_was_implicitly_seen(329)) {
  option_name = get_option_name(329);
  toggle(&pic,0);
 }
 if (option_was_implicitly_seen(336)) {
  option_name = get_option_name(336);
  toggle(&fmath_errno,0);
 }
 if (option_was_implicitly_seen(350)) {
  option_name = get_option_name(350);
  toggle(&ffast_math,0);
 }
 if (option_was_implicitly_seen(357)) {
  option_name = get_option_name(357);
  toggle(&fbuiltin,0);
 }
 if (option_was_implicitly_seen(360)) {
  option_name = get_option_name(360);
  toggle(&pic,0);
 }
 if (option_was_implicitly_seen(364)) {
  option_name = get_option_name(364);
  toggle(&fmath_errno,1);
 }
 if (option_was_implicitly_seen(369)) {
  option_name = get_option_name(369);
  toggle(&fortran_form,1);
 }
 if (option_was_implicitly_seen(389)) {
  option_name = get_option_name(389);
  toggle(&ffast_math,1);
 }
 if (option_was_implicitly_seen(407)) {
  option_name = get_option_name(407);
  toggle(&use_coco,1);
 }
 if (option_was_implicitly_seen(414)) {
  option_name = get_option_name(414);
  toggle(&fbuiltin,1);
 }
 if (option_was_implicitly_seen(435)) {
  option_name = get_option_name(435);
  toggle(&pic,1);
 }
 if (option_was_implicitly_seen(485)) {
  option_name = get_option_name(485);
  toggle(&dflag,1);
 }
 if (option_was_implicitly_seen(488)) {
  option_name = get_option_name(488);
  toggle(&use_ftpp,0);first_phase=P_any_cpp;
 }
 if (option_was_implicitly_seen(489)) {
  option_name = get_option_name(489);
  toggle(&cordflag,1);
 }
 if (option_was_implicitly_seen(492)) {
  option_name = get_option_name(492);
  toggle(&compat_gcc,1);
 }
 if (option_was_implicitly_seen(502)) {
  option_name = get_option_name(502);
  toggle(&io_byteswap,1);
 }
 if (option_was_implicitly_seen(504)) {
  option_name = get_option_name(504);
  toggle(&use_bblibs,1);toggle(&use_h264libs,0);
 }
 if (option_was_implicitly_seen(508)) {
  option_name = get_option_name(508);
  toggle(&isstatic,1);
 }
 if (option_was_implicitly_seen(515)) {
  option_name = get_option_name(515);
  toggle(&ansi,2);
 }
 if (option_was_implicitly_seen(696)) {
  option_name = get_option_name(696);
  toggle(&ospace,1);
 }
 if (option_was_implicitly_seen(701)) {
  option_name = get_option_name(701);
  toggle(&olevel,2);
 }
 if (option_was_implicitly_seen(702)) {
  option_name = get_option_name(702);
  toggle(&olevel,1);
 }
 if (option_was_implicitly_seen(703)) {
  option_name = get_option_name(703);
  toggle(&olevel,0);
 }
 if (option_was_implicitly_seen(705)) {
  option_name = get_option_name(705);
  toggle(&olevel,2);
 }
 if (option_was_implicitly_seen(723)) {
  option_name = get_option_name(723);
  toggle(&standard_cplusplus,1);
 }
 if (option_was_implicitly_seen(727)) {
  option_name = get_option_name(727);
  toggle(&ipa,1);
 }
 if (option_was_implicitly_seen(728)) {
  option_name = get_option_name(728);
  toggle(&ipa,1);
 }
}
