...
/* Old target macros that have moved to the target hooks structure.  */
 #pragma GCC poison ASM_OPEN_PAREN ASM_CLOSE_PAREN			\
	...
	WCHAR_UNSIGNED STRIP_NAME_ENCODING \
	ASM_OUTPUT_MI_THUNK
#if 0
UNIQUE_SECTION SELECT_SECTION SELECT_RTX_SECTION	\
	ENCODE_SECTION_INFO ASM_GLOBALIZE_LABEL	\
	ASM_OUTPUT_MI_THUNK
#endif
/* Other obsolete target macros, or macros that used to be in target
 ...
 #pragma GCC poison INT_ASM_OP ASM_OUTPUT_EH_REGION_BEG			   \
	...
	NO_BUILTIN_WCHAR_TYPE NO_BUILTIN_WINT_TYPE \
	BLOCK_PROFILER BLOCK_PROFILER_CODE FUNCTION_BLOCK_PROFILER	   \
	FUNCTION_BLOCK_PROFILER_EXIT MACHINE_STATE_SAVE			   \
	MACHINE_STATE_RESTORE SECTION_ASM_OP		   \
	ASM_OUTPUT_DEFINE_LABEL_DIFFERENCE_SYMBOL
#if 0
NO_BUILTIN_SIZE_TYPE NO_BUILTIN_PTRDIFF_TYPE SCCS_DIRECTIVE 		   
#endif
