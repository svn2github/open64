 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/kgccfe/SCCS/s.wfe_dst.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *wfe_dst_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/kgccfe/SCCS/s.wfe_dst.h $ $Revision: 1.10 $";
#endif /* _KEEP_RCS_ID */
