...
static BOOL intrinsic_op_need_deref (INTRINSIC id) {
...
static void WN_Set_Deref_If_Needed(WN *wn) {
	INTRINSIC intrn=WN_intrinsic(wn);
        if(intrinsic_op_need_deref(intrn)){
...
Mark_LDA_Vbuf_Offset(WN* tree, INTRINSIC iopc ) {
   if( WN_operator(tree) == OPR_LDA) {
    ...
    for(INT i = 0; i < WN_kid_count(tree); i++) {
       Mark_LDA_Vbuf_Offset(WN_kid(tree, i), iopc);
    }
}
...
*/
	    ...
	    case BUILT_IN_SBUF_OFFSET:
	      ...
	      intrinsic_op = TRUE;
	      break;
            case BUILD_IN_MUL_SHIFT_HI:
              iopc = INTRN_MUL_SHIFT_HI;
              intrinsic_op = TRUE;
              break;
             case BUILD_IN_MUL_SHIFT:
              iopc = INTRN_MUL_SHIFT;
              intrinsic_op = TRUE;
              break;
            case BUILD_IN_C3_LEAD:
              iopc = INTRN_C3_LEAD;
              intrinsic_op = TRUE;
               break;
             case BUILD_IN_C3_MAC:
              iopc = INTRN_C3_MAC;
              intrinsic_op = TRUE;
              break;
             case BUILD_IN_C3_MACN:
              iopc = INTRN_C3_MACN;
              intrinsic_op = TRUE;
              break;
            case BUILD_IN_C3_ROUND:
              iopc = INTRN_C3_ROUND;
              intrinsic_op = TRUE;
              break;
            case BUILD_IN_C3_SAADDS:
              iopc = INTRN_C3_SAADDS;
              intrinsic_op = TRUE;
              break;
           case BUILD_IN_C3_SASUBS:
              iopc = INTRN_C3_SASUBS;
              intrinsic_op = TRUE;
              break;
          case BUILD_IN_C3_MULA:
              iopc = INTRN_C3_MULA;
              intrinsic_op = TRUE;
              break;
          case BUILD_IN_C3_INIT_ACC:
	       iopc = INTRN_C3_INIT_ACC;
              //intrinsic_op = TRUE;
		break;
          case BUILD_IN_C3_SAVE_ACC:
              iopc = INTRN_C3_SAVE_ACC;
		//intrinsic_op = TRUE;	  
	       break;	  
          case BUILD_IN_MPY_32_16:
		iopc = INTRN_MPY_32_16;
		intrinsic_op = TRUE;	
		break;	
	   case BUILD_IN_C3_MACD:
	   	iopc = INTRN_C3_MACD;
		intrinsic_op = TRUE;	
		break;
	    case BUILD_IN_C3_MULAD:
	       iopc = INTRN_C3_MULAD;
		intrinsic_op = TRUE;	
		break; 
           case BUILD_IN_C3_SAADDSH:
		iopc = INTRN_C3_SAADDSH;
		intrinsic_op = TRUE;	
		break; 
	    case BUILD_IN_C3_SASUBSH:
		iopc = INTRN_C3_SASUBSH;
		intrinsic_op = TRUE;	
		break; 
           case BUILD_IN_C3_MVFS:
		iopc = INTRN_C3_MVFS;
		intrinsic_op = TRUE;	
		break; 
	    case BUILD_IN_C3_INIT_ADDR:
	       iopc = INTRN_C3_INIT_ADDR;
              break;
          case BUILD_IN_C3_SAVE_ADDR:
              iopc = INTRN_C3_SAVE_ADDR;
		break;
	   case BUILD_IN_C3_MAC_A:
	   	iopc = INTRN_C3_MAC_A;
		intrinsic_op = TRUE;
		break;	
          case BUILD_IN_C3_MACN_A:
	   	iopc = INTRN_C3_MACN_A;
		intrinsic_op = TRUE;
		break;
	   case BUILD_IN_C3_DMAC_A:
	   	iopc = INTRN_C3_DMAC_A;
		intrinsic_op = TRUE;
		break;	
          case BUILD_IN_C3_DMACN_A:
	   	iopc = INTRN_C3_DMACN_A;
		intrinsic_op = TRUE;
		break;
         case BUILD_IN_C3_INIT_DACC:
	       iopc = INTRN_C3_INIT_DACC;
            	break;
          case BUILD_IN_C3_SAVE_DACC:
              iopc = INTRN_C3_SAVE_DACC;
		break;
	  case BUILD_IN_C3_SAADDH_A:
	  	iopc = INTRN_C3_SAADDH_A;
		intrinsic_op = TRUE;
		break;
         case BUILD_IN_C3_SASUBH_A:
	  	iopc = INTRN_C3_SASUBH_A;
		intrinsic_op = TRUE;
		break;
         case BUILD_IN_C3_SAMULSH:
	  	iopc = INTRN_C3_SAMULSH;
		intrinsic_op = TRUE;
		break;
         case BUILD_IN_C3_MULA_A:
              iopc = INTRN_C3_MULA_A;
              intrinsic_op = TRUE;
              break;
         case BUILD_IN_C3_SAMULH_A:
  	      iopc = INTRN_C3_SAMULH_A;
	      intrinsic_op = TRUE;
	      break;
         case BUILD_IN_C3_PTR:
              iopc = INTRN_C3_PTR;
              intrinsic_op =  TRUE;
              break;	
         case BUILD_IN_C3_MAC_AR:
              iopc = INTRN_C3_MAC_AR;
	      intrinsic_op =  TRUE;
              break;
        case BUILD_IN_C3_MACN_AR:
              iopc = INTRN_C3_MACN_AR;
	      intrinsic_op =  TRUE;
              break;
       case BUILD_IN_C3_MULA_AR:
              iopc = INTRN_C3_MULA_AR;
	      intrinsic_op =  TRUE;
              break;			  
       case BUILD_IN_C3_INIT_PTR:
	      iopc = INTRN_C3_INIT_PTR;
	      break;
       case BUILD_IN_C3_TRBACK:
	      iopc = INTRN_C3_TRBACK;
	      break;
       case BUILD_IN_C3_VITERBI:
	      iopc = INTRN_C3_VITERBI;
	      break;
       case BUILD_IN_C3_DMULT:
              iopc = INTRN_C3_DMULT;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_DMULT_A:
              iopc = INTRN_C3_DMULT_A;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_DMULTN:
              iopc = INTRN_C3_DMULTN;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_DMULTN_A:
              iopc = INTRN_C3_DMULTN_A;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_SET_CIRCBUF:
              iopc = INTRN_SET_CIRCBUF;
              break;
       case BUILD_IN_RESET_CIRCBUF:
              iopc = INTRN_SET_CIRCBUF;
              break;
       case BUILD_IN_C3_DADD:
              iopc = INTRN_C3_DADD;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_DSUB:
              iopc = INTRN_C3_DSUB;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_FFT:
              iopc = INTRN_C3_FFT;
              break;
       case BUILD_IN_C3_FFTLD:
              iopc = INTRN_C3_FFTLD;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_FFTST:
              iopc = INTRN_C3_FFTST;
              break;
       case BUILD_IN_DEPOSIT:
              iopc = INTRN_DEPOSIT;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_EXTRACT:
              iopc = INTRN_EXTRACT;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_BITR:
              iopc = INTRN_C3_BITR;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_DMAC:
              iopc = INTRN_C3_DMAC;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_DMACN:
              iopc = INTRN_C3_DMACN;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_LOAD:
              iopc = INTRN_C3_LOAD;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_STORE:
              iopc = INTRN_C3_STORE;
              break;
       case BUILD_IN_C3_REVB:
              iopc = INTRN_C3_REVB;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_DSHL_I:
              iopc = INTRN_C3_DSHL_I;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_DSHR_I:
              iopc = INTRN_C3_DSHR_I;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_MAC_I:
              iopc = INTRN_C3_MAC_I;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_MACN_I:
              iopc = INTRN_C3_MACN_I;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_MULA_I:
              iopc = INTRN_C3_MULA_I;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_SAADD_A:
              iopc = INTRN_C3_SAADD_A;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_SADDHA:
              iopc = INTRN_C3_SADDHA;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_SAADDHA_A:
              iopc = INTRN_C3_SAADDHA_A;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_C3_SASUB_A:
              iopc = INTRN_C3_SASUB_A;
              intrinsic_op = TRUE;
              break;
       case BUILD_IN_COPY_ADDR:
              iopc = INTRN_C3_COPY_ADDR; 
              break;
       case BUILD_IN_SET_ADDR:
	...
	break;
	 ...
	 break;
	   case BUILT_IN_C2_MVGR_G2S:
	   iopc = INTRN_C2_MVGR_G2S;
	 break; 
	   case BUILT_IN_C2_MVGR_S2G:
	   iopc = INTRN_C2_MVGR_S2G;
	 break;
	 ...
	 break;
	   ...
	   case BUILT_IN_C2_VNEG:
        ...
        break;		
          case BUILT_IN_C2_SCOND_BR:
          iopc  = INTRN_OP_C2_SCOND_BR;
          intrinsic_op = TRUE;		
        break;
          case BUILT_IN_C2_SCOND_BR_R:
          iopc  = INTRN_OP_C2_SCOND_BR_R;
          intrinsic_op = TRUE;		
        break;
	   ...
	   iopc = INTRN_C2_MED;
	 break;
          case BUILT_IN_C2_BR_F:		
          iopc = INTRN_C2_BR_F;
        break;		
          case BUILT_IN_C2_BR_T:		
          iopc = INTRN_C2_BR_T;
        break;		
	 ...
	 break;
	   case BUILT_IN_C2_GSUMS:
        ...
        break;		
          ...
          iopc = INTRN_C2_JOINT;
        break;
          case BUILT_IN_C2_THREAD_MAJOR:
	   iopc = INTRN_C2_THREAD_MAJOR;
	   intrinsic_op = TRUE;
	break;
	  case BUILT_IN_C2_THREAD_MINOR:
	  iopc = INTRN_C2_THREAD_MINOR;
	  intrinsic_op = TRUE;
       break;
		 ...
		 i++, list = TREE_CHAIN (list)) {
	      ...
	      arg_mtype  = TY_mtype(arg_ty_idx);
            ...
            if( iopc == INTRN_SBUF_OFFSET || iopc == INTRN_VBUF_OFFSET) {
                Mark_LDA_Vbuf_Offset(arg_wn, iopc);
                Adjust_Vbuf_Array_Ofst(arg_wn);
	     }
#endif 
 ...
 */
      ...
      */
		  ...
		  nth_child = 1;
           ...
           intrn_ofst_wn = WN_Create (OPR_INTRINSIC_OP, MTYPE_I4, MTYPE_V, 1);
