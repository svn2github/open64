...
//  $Source: /scratch/mee/2.4-65/kpro64-pending/be/cg/gra_mon/SCCS/s.gra_color.h $
...
#ifdef _KEEP_RCS_ID
static char *gra_color_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/be/cg/gra_mon/SCCS/s.gra_color.h $ $Revision: 1.2 $";
#endif
#endif
