 ...
 *  $Source: /scratch/mee/2.4-65/kpro64-pending/be/cg/gra_mon/SCCS/s.gra_create.h $
 */
...
#ifdef _KEEP_RCS_ID
static char *create_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/be/cg/gra_mon/SCCS/s.gra_create.h $ $Revision: 1.2 $";
#endif
#endif
