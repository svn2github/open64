...
#ifdef TARG_SL
  else if (Is_Target_Sl1_pcore()  || Is_Target_Sl1_dsp() || Is_Target_Sl2_pcore() || Is_Target_Sl2_mcore()) {
    *mispredict= 7; *fixed= 1; *brtaken= 1; *factor = 1.0;
  }
#endif
  else
...
#ifdef TARG_SL2
  CGTARG_Invert_Table[TOP_c2_br_f] = TOP_c2_br_t;
  CGTARG_Invert_Table[TOP_c2_br_t] = TOP_c2_br_f;
#endif  //TARG_SL2
...
CGTARG_Dependence_Required(OP *pred_op, OP *succ_op)
{
  ...
  switch(OP_code(pred_op))
  {
    ...
    case TOP_c2_thread_major:
    case TOP_c2_thread_minor:
    case TOP_c2_fork_m:
    case TOP_c2_fork_n:
