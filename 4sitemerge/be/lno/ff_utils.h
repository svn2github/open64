...
*** $Author: kevinlo $
*** $Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/ff_utils.h,v $
*** 
*** Description:
*** 
...
#ifdef _KEEP_RCS_ID
static char *ff_utils_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/ff_utils.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
