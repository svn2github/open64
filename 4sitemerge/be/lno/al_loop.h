 ...
 * Module: al_loop.h
 * $Revision: 1.1 $
 * $Date: 2005/07/27 02:13:29 $
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/al_loop.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *al_loop_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/al_loop.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
