...
*** $Author: kevinlo $
*** $Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/lno_scc.h,v $
*** 
*** Revision history:
***
...
#ifdef _KEEP_RCS_ID
static char *lno_scc_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/lno_scc.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
#endif
