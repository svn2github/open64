...
*** Module: ff_pragmas.h
*** $Revision: 1.1 $
*** $Date: 2005/07/27 02:13:27 $
*** $Author: kevinlo $
*** $Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/ff_pragmas.h,v $
*** 
*** Description:
*** 
...
#ifdef _KEEP_RCS_ID
static char *ff_pragmas_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/ff_pragmas.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
