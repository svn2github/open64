 ...
 * $Revision: 1.1 $
 * $Date: 2005/07/27 02:13:23 $
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/array_lower.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *array_lower_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/be/lno/array_lower.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
