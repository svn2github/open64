...
static lang_info_t language_info[] = {
	...
	{'c',	0x00000002,	{"cc", OPEN64_CMPLR_NAME_PREFIX "cc", OPEN64_TARGET_NAME "-" OPEN64_CMPLR_NAME_PREFIX "cc","gcc","c89"}},	/* cc */
	{'C',	0x00000004,	{"CC", OPEN64_CMPLR_NAME_PREFIX "CC", OPEN64_CMPLR_NAME_PREFIX "++","g++"}},	/* c++ */
	{'f',	0x00000008,	{"f77", OPEN64_CMPLR_NAME_PREFIX "f77","gf77","fort77"}}, /* f77 */
	{'F',	0x00000010,	{"f90", OPEN64_CMPLR_NAME_PREFIX "f90"}},		/* f90 */
	{'a',	0x00000020,	{"as", OPEN64_CMPLR_NAME_PREFIX "as","gas"}},		/* as */
	{'l',	0x00000040,	{"ld", OPEN64_CMPLR_NAME_PREFIX "ld"}},		/* ld */
	{'I',	0x80000000,	{"int"}},		/* Internal option */
};

#if defined(linux) && defined(TARG_X8664)
#define NAMEPREFIX	""
#define BINPATH		"/usr/bin"
#define LIBPATH		"/usr/lib"
#define ALTLIBPATH	LIBPATH
#define PHASEPATH	"/usr/lib/" _NAME_PREFIX "cc-lib"
...
static phase_info_t phase_info[] = {
...
#ifdef KEY
#if defined(TARG_SL)
   {'a',  0x0000002000000000LL,	NAMEPREFIX "as", BINPATH, FALSE}, /* gcc */
#else
   ...
   {'j',  0x0000010000000000LL,	"ipa_link", BINPATH,TRUE},	/* ipa_link */
   {'l',  0x0000020000000000LL,	"collect2", GNUPHASEPATH,TRUE},	/* collect */
#if defined(KEY)
#if defined(TARG_SL)
   {'l',  0x0000040000000000LL,	NAMEPREFIX "ld", BINPATH, FALSE}, /* ld */
   {'l',  0x0000080000000000LL,	NAMEPREFIX "ld", BINPATH, FALSE}, /* ldplus */
#else
...
#ifdef TARG_SL2
   {'S',  0x0010000000000000LL,	"crt",	"/usr/libsl2",	FALSE},	/* sl2_startup */
#endif
};
mask_t PHASE_MASK=
