 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/kg++fe/SCCS/s.erauxdesc.h $
 *
 * Revision history:
...
static char *eraux_desc_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/kg++fe/SCCS/s.erauxdesc.h $ $Revision: 1.7 $";
