 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/kg++fe/SCCS/s.c_int_model.h $
 *
 * Revision history:
 *  ??-???-92 - Original Version
 *
...
#ifdef _KEEP_RCS_ID
static char *c_int_model_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/kg++fe/SCCS/s.c_int_model.h $ $Revision: 1.7 $";
#endif /* _KEEP_RCS_ID */
