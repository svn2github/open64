 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/kg++fe/SCCS/s.erfe.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *erfe_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/kg++fe/SCCS/s.erfe.h $ $Revision: 1.7 $";
#endif /* _KEEP_RCS_ID */
