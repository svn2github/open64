...
//  $Author: kevinlo $
//  $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/targ_info/isa/x8664/isa_print.cxx,v $
...
main()
{
  ...
  ISA_PRINT_TYPE cop_v_rop = ISA_Print_Type_Create("cop_vec_rop", "%s");
  Name();
  Instruction_Print_Group( cop_v_rop,
			   TOP_nop_,
			   TOP_iota,
			   TOP_UNDEFINED );

  ISA_PRINT_TYPE cop_alu = ISA_Print_Type_Create("cop_alu", "%s %s %s,%s");
  Name();
  Result(0);
  Operand(1);
  Operand(0);
  Instruction_Print_Group( cop_alu,
			   TOP_iadd,
			   TOP_iadd_c,
			   TOP_isub,
			   TOP_isub_c,
  ...
  ISA_PRINT_TYPE cop_int_madd = ISA_Print_Type_Create("cop_int_madd", "%s %s %s,%s,%s");
  Name();
  Result(0);
  Operand(2);
  Operand(1);
  Operand(0);
  Instruction_Print_Group( cop_int_madd,
			   TOP_imadd,
			   TOP_imaddhi,
			   TOP_inmadd,
			   TOP_inmaddhi,
  ...
  ISA_PRINT_TYPE cop_float_alu = ISA_Print_Type_Create("cop_float_alu", "%s %s %s,%s");
  Name();
  Result(0);
  Operand(1);
  Operand(0);
  Instruction_Print_Group( cop_float_alu,
			   TOP_add_d,
			   TOP_sub_d,
			   TOP_mult_d,
			   TOP_div_d,
  ...
  ISA_PRINT_TYPE cop_float_madd = ISA_Print_Type_Create("cop_float_madd", "%s %s %s,%s,%s");
  Name();
  Result(0);
  Operand(2);
  Operand(1);
  Operand(0);
  Instruction_Print_Group( cop_float_madd,
			   TOP_madd_d,
			   TOP_nmadd_d,
			   TOP_msub_d,
			   TOP_nmsub_d,
  ...
  ISA_PRINT_TYPE cop_v_2op = ISA_Print_Type_Create("cop_vec_2op", "%s %s $s");
  Name();
  Result(0);
  Operand(0);
  Instruction_Print_Group( cop_v_2op,
			   TOP_abs,
			   TOP_abs_f,
			   TOP_abs_d,
			   TOP_sqrt_f,
  ...
  ISA_PRINT_TYPE cop_v_addr = ISA_Print_Type_Create("cop_vec_addr", "%s %s $s");
  Name();
  Result(0);
  Operand(0);
  Instruction_Print_Group( cop_v_addr,
			   TOP_adda,
			   TOP_suba,
			   TOP_UNDEFINED );

  ISA_PRINT_TYPE cop_v_ld = ISA_Print_Type_Create("cop_vec_ld", "%s %s %s,%s,#%s");
  Name();
  Result(0);
  Operand(0);
  Operand(1);
  Operand(2);
  Instruction_Print_Group( cop_v_ld,
			   TOP_ld_d_s,
			   TOP_ld_d,
			   TOP_ld_w_s,
			   TOP_ld_w,
  ...
  ISA_PRINT_TYPE cop_v_st = ISA_Print_Type_Create("cop_vec_st", "%s %s %s,%s,#%s");
  Name();
  Result(0);
  Operand(0);
  Operand(1);
  Operand(2);
  Instruction_Print_Group( cop_v_st,
			   TOP_st_d_s,
			   TOP_st_d,
			   TOP_st_w_s,
			   TOP_st_w,
  ...
  ISA_PRINT_TYPE cop_v_addri = ISA_Print_Type_Create("cop_vec_addri", "%s %s %s,#%s");
  Name();
  Result(0);
  Operand(0);
  Operand(1);
  ...
  ISA_PRINT_TYPE cop_v_movet = ISA_Print_Type_Create("cop_vec_movet", "%s %s $s");
  Name();
  Result(0);
  Operand(0);
  Instruction_Print_Group( cop_v_movet,
			   TOP_moveav,
			   TOP_UNDEFINED );

  ISA_PRINT_TYPE cop_v_movef = ISA_Print_Type_Create("cop_vec_movef", "%s %s $s");
  Name();
  Result(0);
  Operand(0);
  Instruction_Print_Group( cop_v_movef,
			   TOP_moveva,
			   TOP_UNDEFINED );

  ISA_PRINT_TYPE cop_v_1op = ISA_Print_Type_Create("cop_vec_1op", "%s %s");
  Name();
  Operand(0);
  Instruction_Print_Group( cop_v_1op,
			   TOP_setmask,
			   TOP_UNDEFINED );
