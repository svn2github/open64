...
//  $Author: kevinlo $
//  $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/targ_info/isa/x8664/isa_properties.cxx,v $
...
main()
{
  ISA_PROPERTY
    ...
    vector_co_loadstore,   /* vector cop load store */
    vector_co_imul,        /* vector cop mul */
    vector_co_iadd,        /* vector cop add */
    vector_co_immu,        /* vector cop madd type */
    vector_co_imisc,       /* vector cop others */
    vector_co_abs,         /* vector cop absolute */
    vector_co_fabs_sqr,         /* vector cop absolute */
    vector_co_fadd,        /* vector cop float add */
    vector_co_fmul,        /* vector cop float mul */
    vector_co_fmmu,        /* vector cop float madd type */
    vector_co_fmisc,       /* vector cop float others */
    vector_co_move,        /* vector cop move */
    vector_co_addr,        /* vector cop addr type */
    vector_co_mask,        /* vector cop set up */
    vector_co_noop,        /* vector cop nop */
#endif
 ...
 */
...
#ifdef TARG_X8664_SOCC
  /* ===== Instructions for vector coprocessor loadstore  ====== */
  vector_co_loadstore = ISA_Property_Create ("vector_co_loadstore");
  Instruction_Group (vector_co_loadstore,
		     TOP_ld_d_s,
		     TOP_st_d_s,
		     TOP_ld_d,
		     TOP_st_d,
 ...
 /* ===== Instructions for vector coprocessor add  ====== */
  vector_co_iadd = ISA_Property_Create ("vector_co_iadd");
  Instruction_Group (vector_co_iadd,
		     TOP_iadd,
		     TOP_iadd_c,
		     TOP_isub,
		     TOP_isub_c,
  ...
  vector_co_imul = ISA_Property_Create ("vector_co_imul");
  Instruction_Group (vector_co_imul,
		     TOP_imul,
		     TOP_imulhi,
		     TOP_UNDEFINED);

  vector_co_immu = ISA_Property_Create ("vector_co_immu");
  Instruction_Group (vector_co_immu,
		     TOP_imadd,
		     TOP_imaddhi,
		     TOP_inmadd,
		     TOP_inmaddhi,
  ...
  vector_co_imisc = ISA_Property_Create ("vector_co_imisc");
  Instruction_Group (vector_co_imisc,
		     TOP_sll,
		     TOP_srl,
		     TOP_or,
		     TOP_xor,
  ...
  vector_co_abs = ISA_Property_Create ("vector_co_abs");
  Instruction_Group (vector_co_imisc,
		     TOP_abs,     
		     TOP_UNDEFINED);

  vector_co_fabs_sqr = ISA_Property_Create ("vector_co_fabs_sqr");
  Instruction_Group (vector_co_fabs_sqr,
		     TOP_abs_d,
		     TOP_abs_f,
		     TOP_sqrt_d,
		     TOP_rsqrt_d,
  ...
  vector_co_iadd = ISA_Property_Create ("vector_co_fadd");
  Instruction_Group (vector_co_iadd,
		     TOP_add_d,
		     TOP_sub_d,
		     TOP_add_f,
  ...
  vector_co_imul = ISA_Property_Create ("vector_co_fmul");
  Instruction_Group (vector_co_imul,
		     TOP_mult_d,
		     TOP_mult_f,
		     TOP_div_d,
  ...
  vector_co_fmmu = ISA_Property_Create ("vector_co_fmmu");
  Instruction_Group (vector_co_fmmu,
		     TOP_madd_d,
		     TOP_msub_d,
		     TOP_nmadd_d,
		     TOP_nmsub_d,
  ...
  vector_co_fmisc = ISA_Property_Create ("vector_co_fmisc");
  Instruction_Group (vector_co_fmisc,
		     TOP_cvt_d_f,
		     TOP_cvt_f_d,
		     TOP_cmp_eq_d,
		     TOP_cmp_lt_d,
  ...
  vector_co_move = ISA_Property_Create ("vector_co_move");
  Instruction_Group (vector_co_move,
		     TOP_moveva,
		     TOP_moveav,
		     TOP_UNDEFINED);

  vector_co_addr = ISA_Property_Create ("vector_co_addr");
  Instruction_Group (vector_co_addr,
		     TOP_adda,
		     TOP_suba,
		     TOP_addai,
		     TOP_subai,
  ...
  vector_co_mask = ISA_Property_Create ("vector_co_mask");
  Instruction_Group (vector_co_mask,
		     TOP_setmask,
		     TOP_iota,
		     TOP_UNDEFINED);

  vector_co_noop = ISA_Property_Create ("vector_co_noop");
  Instruction_Group (noop,
                     TOP_nop_,
                     TOP_UNDEFINED);
#endif
