...
//  $Author: kevinlo $
//  $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/targ_info/isa/x8664/isa_operands.cxx,v $
...
main()
{
  ...
  const OPERAND_VALUE_TYPE cop_areg =
    ISA_Reg_Opnd_Type_Create("areg", ISA_REGISTER_CLASS_cop_areg,
			     ISA_REGISTER_SUBCLASS_UNDEFINED,
			     64, UNSIGNED, INVALID);
  ...
  Instruction_Group("cop ialu", // cop vector alu
		    TOP_iadd,
		    TOP_iadd_c,
		    TOP_isub,
		    TOP_isub_c,
  ...
  Instruction_Group("cop imadd", // cop vector integer madd
		    TOP_imadd,
		    TOP_imaddhi,
		    TOP_inmadd,
		    TOP_inmaddhi,
  ...
  Instruction_Group("int compare cop vector", 
		    TOP_cmp_eq,
		    TOP_cmp_lt_u,
		    TOP_cmp_lt,
		    TOP_UNDEFINED);
  ...
  Instruction_Group("cop madd", // cop vector float madd
		    TOP_madd_d,
		    TOP_nmadd_d,
		    TOP_msub_d,
		    TOP_nmsub_d,
  ...
  Instruction_Group("cop float alu",
		    TOP_add_d,
		    TOP_sub_d,
		    TOP_mult_d,
		    TOP_div_d,
  ...
  Instruction_Group("cop float compare cop vector", 
		    TOP_cmp_eq_d,
		    TOP_cmp_lt_d,
		    TOP_cmp_lt_f,
		    TOP_cmp_eq_f,
  ...
  Instruction_Group("cop float misc", 
		    TOP_abs_f,
		    TOP_abs_d,
		    TOP_sqrt_f,
		    TOP_rsqrt_f,
  ...
  Instruction_Group("cop conversion", 
		    TOP_cvt_d_f,
		    TOP_cvt_f_d,
		    TOP_UNDEFINED);
  Result(0, cop_vreg);
  ...
  Instruction_Group("cop int misc", 
		    TOP_abs,
		    TOP_UNDEFINED);
  Result(0, cop_vreg);
  Operand(0, cop_vreg);
  ...
  Instruction_Group("cop move ", 
		    TOP_moveva,
		    TOP_UNDEFINED);
  Result(0, cop_vreg);
  Operand(0, cop_areg);

  Instruction_Group("cop move to ", 
		    TOP_moveav,
		    TOP_UNDEFINED);
  Result(0, cop_areg);
  Operand(0, cop_vreg);

  Instruction_Group("cop store ofst", 
		    TOP_st_d_s,
		    TOP_st_d,
		    TOP_st_w_s,
		    TOP_st_w,
  ...
  Instruction_Group("cop load ofst", 
		    TOP_ld_d_s,
		    TOP_ld_d,
		    TOP_ld_w_s,
		    TOP_ld_w,
  ...
  Instruction_Group("cop addr immed", 
		    TOP_addai,
		    TOP_subai,
		    TOP_UNDEFINED);
  Result(0, cop_areg);
  ...
  Instruction_Group("cop mask ", 
		    TOP_setmask,
		    TOP_UNDEFINED);
  Operand(0, cop_vreg);

  Instruction_Group("cop nop ", 
		    TOP_nop_,
		    TOP_iota,
		    TOP_UNDEFINED);
  Operand(0, cop_vreg);
