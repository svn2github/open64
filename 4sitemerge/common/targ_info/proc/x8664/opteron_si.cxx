...
int main (int argc, char *argv[])
{
  ...
  Instruction_Group("cop vec",
		    ...
		    TOP_UNDEFINED);
  Any_Operand_Access_Time(0);
  Any_Result_Available_Time(2);        // this is RANDOM for now
  Resource_Requirement(res_issue, 0);  // this is RANDOM for now
  Resource_Requirement(res_fadd, 0);   // this is RANDOM for now

  Instruction_Group("cop vector nop",
		    TOP_nop_,
		    TOP_setmask,
		    TOP_iota,
		    TOP_UNDEFINED);
