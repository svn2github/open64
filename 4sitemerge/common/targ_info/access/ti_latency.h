 ...
 *  $Author: kevinlo $
 *  $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/targ_info/access/ti_latency.h,v $
 *
 *  Synopsis:
 *
...
#ifdef _KEEP_RCS_ID
static const char ti_latency_rcs_id[] = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/targ_info/access/ti_latency.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
