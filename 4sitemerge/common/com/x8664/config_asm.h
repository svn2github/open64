 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/x8664/config_asm.h,v $
 *
 * Revision history:
 *
 * Description:
...
#ifdef _KEEP_RCS_ID
static char *config_asm_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/x8664/config_asm.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
