 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/x8664/config_targ.cxx,v $
 *
 *
 * Description:
 *
...
Prepare_Target ( void )
{
  ...
  if ( ISA_Name != NULL ) {
    ...
    if ( strcasecmp ( ISA_Name, "x86_64" ) == 0 ) {
  ...
  /* The size of <long double> is 96-bits for -m32, and 128-bits for -m64.
   */
