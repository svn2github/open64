 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/x8664/config_platform.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *config_platform_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/x8664/config_platform.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
