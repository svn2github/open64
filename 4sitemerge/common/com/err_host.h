 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.err_host.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *err_host_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.err_host.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
