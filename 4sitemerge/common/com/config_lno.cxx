 ...
 *
 * $Revision: 1.67 $
 * $Date: 05/12/16 18:49:22-08:00 $
 * $Author: cfang@dunite.internal.keyresearch.com $
 * $Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.config_lno.cxx $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_lno_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.config_lno.cxx $ $Revision: 1.67 $";
#endif /* _KEEP_RCS_ID */
