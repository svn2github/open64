 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/pr1/config_targ.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *config_targ_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/pr1/config_targ.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
...
#define Is_Target_PR() (Target == TARGET_PR)
