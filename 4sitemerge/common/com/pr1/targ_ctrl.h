 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/pr1/targ_ctrl.h,v $
 *
 * Description:
 *
...
#ifdef _KEEP_RCS_ID
static char *targ_ctrl_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/pr1/targ_ctrl.h,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */

static STR_LIST Targ_1 = {"PR1", NULL};
