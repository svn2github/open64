...
#define First_Int_Preg_Return_Offset	6	/* register v0 */
#define Last_Int_Preg_Return_Offset	7	/* register v1 */
#define First_Float_Preg_Return_Offset	32	/* register f0 */
#define Last_Float_Preg_Return_Offset	34	/* register f2 */
#define Stack_Pointer_Preg_Offset	2	/* register sp */
#define Frame_Pointer_Preg_Offset	2	/* register fp */
...
#define MAX_NUMBER_OF_REGISTER_PARAMETERS 6
