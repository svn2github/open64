 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.quadop.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *quadop_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.quadop.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
