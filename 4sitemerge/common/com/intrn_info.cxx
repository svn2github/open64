...
const intrn_info_t intrn_info[INTRINSIC_LAST+1] = {
  ...
  { /* U8READFRAMEPOINTER */
    ...
    { /* PADDSB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PADDSB", NULL, NULL},  
    { /* PADDSW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PADDSW", NULL, NULL},  
    { /* PSUBSB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PSUBSB", NULL, NULL},  
    { /* PSUBSW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PSUBSW", NULL, NULL},  
    { /* PADDUSB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PADDUSB", NULL, NULL},  
    { /* PADDUSW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PADDUSW", NULL, NULL},  
    { /* PSUBUSB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PSUBUSB", NULL, NULL},  
    { /* PSUBUSW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PSUBUSW", NULL, NULL},  
    { /* PMULLW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PMULLW", NULL, NULL},  
    { /* PMULHW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PMULHW", NULL, NULL},  
    { /* PAND */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_U8, "PAND", NULL, NULL},  
    { /* PCMPEQB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PCMPEQB", NULL, NULL},  
    { /* PCMPEQW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PCMPEQW", NULL, NULL},  
    { /* PCMPEQD */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I4, "PCMPEQD", NULL, NULL},  
    { /* PCMPGTB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PCMPGTB", NULL, NULL},  
    { /* PCMPGTW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PCMPGTW", NULL, NULL},  
    { /* PCMPGTD */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I4, "PCMPGTD", NULL, NULL},  
    { /* PUNPCKHBW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PUNPCKHBW", NULL, NULL},  
    { /* PUNPCKHWD */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PUNPCKHWD", NULL, NULL},  
    { /* PUNPCKHDQ */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I4, "PUNPCKHDQ", NULL, NULL},  
    { /* PUNPCKLBW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PUNPCKLBW", NULL, NULL},  
    { /* PUNPCKLWD */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PUNPCKLWD", NULL, NULL},  
    { /* PUNPCKLDQ */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I4, "PUNPCKLDQ", NULL, NULL},  
    { /* PACKSSWB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PACKSSWB", NULL, NULL},  
    { /* PACKSSDW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I4, "PACKSSDW", NULL, NULL},  
    { /* PACKUSWB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PACKUSWB", NULL, NULL},  
    { /* PMULHUW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PMULHUW", NULL, NULL},  
    { /* PAVGB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PAVGB", NULL, NULL},  
    { /* PAVGW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PAVGW", NULL, NULL},  
    { /* PSADBW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PSADBW", NULL, NULL},  
    { /* PMAXUB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PMAXUB", NULL, NULL},  
    { /* PMAXSW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PMAXSW", NULL, NULL},  
    { /* PMINUB */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I1, "PMINUB", NULL, NULL},  
    { /* PMINSW */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PMINSW", NULL, NULL},  
    { /* PEXTRW0 */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
    ...
    { /* PINSRW0 */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PINSRW0", NULL, NULL},  
    { /* PINSRW1 */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PINSRW1", NULL, NULL},  
    { /* PINSRW2 */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PINSRW2", NULL, NULL},  
    { /* PINSRW3 */
        BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_V8I2, "PINSRW3", NULL, NULL},  
#elif defined(TARG_X8664) // TARG_IA64
  { /* PADDSB */
    BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
  ...
  { /* VBUF_OFFSET */
	NOT_BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_I4, "vbuf_offset", "VBUF_OFFSET", NULL},	
  { /* VBUF_OFFSET */
	NOT_BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
	IRETURN_I4, "sbuf_offset", "SBUF_OFFSET", NULL},	
  { /* C2_MVGR_R2G */
	NOT_BYVAL, PURE, NO_SIDEEFFECTS, DOES_RETURN, NOT_ACTUAL, CGINTRINSIC, NOT_SLAVE,
