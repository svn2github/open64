 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/ia64/config_platform.c,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/com/ia64/config_platform.c,v $ $Revision: 1.1 $";
#endif /* _KEEP_RCS_ID */
