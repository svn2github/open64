 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.xstats.h $
 *
 * Description:
 *
...
#ifdef _KEEP_RCS_ID
static char *xstats_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.xstats.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
