 ...
 * $Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.config_flist.h $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_flist_h_rcs_id = "$Source: /scratch/mee/2.4-65/kpro64-pending/common/com/SCCS/s.config_flist.h $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
