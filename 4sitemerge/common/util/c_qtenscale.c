 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/util/c_qtenscale.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/util/c_qtenscale.c,v $ $Revision: 1.1 $";
