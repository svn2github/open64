 ...
 * $Author: kevinlo $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/util/c_a_to_q.c,v $
 *
 * Revision history:
...
static char *rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/util/c_a_to_q.c,v $ $Revision: 1.1 $";
