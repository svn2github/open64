 ...
 *  $Author: kevinlo $
 *  $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/util/c_q_rel.c,v $
 *
 * =======================================================================
 * =======================================================================
 */
...
static char *rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/util/c_q_rel.c,v $ $Revision: 1.1 $";
