...
#pragma ident "@(#) libfi/mathlb/ieee_exponent_i2.c	92.1	07/09/99 11:00:36"
#include <fmath.h>
#include <fortran.h>
#ifdef	__mips
#include <fp_class.h>
...
/* IEEE_EXPONENT(X,Y_I2) returns integer(kind=2) result: */
#ifdef	_CRAYMPP
extern _f_int2 _IEEE_EXPONENT_I2_H(_f_real8 x);
#else	/* _CRAYMPP */
extern _f_int2 _IEEE_EXPONENT_I2_H(_f_real4 x);
#endif	/* _CRAYMPP */
extern _f_int2 _IEEE_EXPONENT_I2_R(_f_real8 x);
extern _f_int2 _IEEE_EXPONENT_I2_D(_f_real16 x);
 ...
 */
#ifdef	_CRAYMPP
static int __ieee_real4_i2(_f_real4 x);
