...
static const char USMID[] = "@(#) libu/util/i3e/ieee_next_after_r_d.c	92.0	10/08/98 14:57:41";
...
extern double _IEEE_NEXT_AFTER_R_D(double x, long double y);
 ...
 *
 */
#pragma _CRI duplicate _IEEE_NEXT_AFTER_R_D as _IEEE_NEXT_AFTER_8_16
double
