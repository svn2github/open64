...
#pragma ident "@(#) libfi/matrix/matmul_jc4.c	92.1	07/09/99 15:18:08"
#include "matmul.h"

/*
 * Name of this entry point
 */
#define NAME _MATMUL_JC4
/*
	...
	DopeVectorType *MATRIX_B)
{
    ...
    _f_real4	*Br, *Bi;	/* pointers to real and imaginary part of B */
