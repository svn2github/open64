...
/* function interface to add command to and free command completion list */
EXTERN int SL_addToCmdCompletionList(const char *);
EXTERN int SL_freeCmdCompletionList();
...
EXTERN const char *Tcl_GetLastCommand(void);
