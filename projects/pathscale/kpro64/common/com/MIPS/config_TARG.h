 ...
 * $Author: marcel $
 * $Source: /proj/osprey/CVS/open64/osprey1.0/common/com/MIPS/config_TARG.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
/*REFERENCED*/
static char *config_TARG_h_rcs_id = "$Source: /proj/osprey/CVS/open64/osprey1.0/common/com/MIPS/config_TARG.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
