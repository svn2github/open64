 ...
 * $Author: marcel $
 * $Source: /proj/osprey/CVS/open64/osprey1.0/common/com/MIPS/config_asm.h,v $
 *
 * Revision history:
 *
 * Description:
...
#ifdef _KEEP_RCS_ID
static char *config_asm_rcs_id = "$Source: /proj/osprey/CVS/open64/osprey1.0/common/com/MIPS/config_asm.h,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
