 ...
 * $Author: marcel $
 * $Source: /proj/osprey/CVS/open64/osprey1.0/common/com/MIPS/config_platform.c,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *rcs_id = "$Source: /proj/osprey/CVS/open64/osprey1.0/common/com/MIPS/config_platform.c,v $ $Revision: 1.1.1.1 $";
#endif /* _KEEP_RCS_ID */
