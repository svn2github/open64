 ...
 * $Author: marcel $
 * $Source: /proj/osprey/CVS/open64/osprey1.0/gccfe/erauxdesc.h,v $
 *
 * Revision history:
...
static char *eraux_desc_rcs_id = "$Source: /proj/osprey/CVS/open64/osprey1.0/gccfe/erauxdesc.h,v $ $Revision: 1.1.1.1 $";
