...
//  Opteron (Barcelona) processor scheduling information
///////////////////////////////////////////////////////////////////
//  
//  Description:
//
//  Generate a scheduling description of an AMD Barcelona processor
...
void Generate_Barcelona (void)
{
  Machine( "barcelona", ISA_SUBSET_x86_64 );
  ...
  Instruction_Group( "barcelona simple alu",
		     TOP_ijmpx,
		     TOP_icallx,
		     TOP_ijmpxx,
		     TOP_icallxx,
  ...
  Instruction_Group( "double-2-float",
		     ...
		     TOP_UNDEFINED );
  Any_Operand_Access_Time(0);
  Any_Result_Available_Time(8); //VectorPath
  Resource_Requirement(res_issue, 0);
  Resource_Requirement(res_fstore, 0);
  ...
  Instruction_Group( "int-2-double",
		     ...
		     TOP_UNDEFINED );
  Any_Operand_Access_Time(0);
  Any_Result_Available_Time(14); //11 opteron
  Resource_Requirement(res_issue, 0);
  Resource_Requirement(res_fstore, 0);
  ...
  Instruction_Group( "int-2-double w/ mem",
		     ...
		     TOP_UNDEFINED );
  Any_Operand_Access_Time(0);
  Any_Result_Available_Time(9); //6 opteron
  Resource_Requirement(res_issue, 0);
  Resource_Requirement(res_fstore, 0);
  Resource_Requirement(res_loadstore, 0);
  ...
  Instruction_Group("float-alu for float vector class VII",
		    ...
		    TOP_UNDEFINED);
  Any_Operand_Access_Time(0);
  Any_Result_Available_Time(21); // 39 for opteron, much faster
  Resource_Requirement(res_issue, 0);
  Resource_Requirement(res_fmul, 0);
  ...
  Instruction_Group("float-alu for float vector class VIII",
		    ...
		    TOP_UNDEFINED);
  Any_Operand_Access_Time(0);
  Any_Result_Available_Time(27); // 51 for opteron
  Resource_Requirement(res_issue, 0);
  Resource_Requirement(res_fmul, 0);
  ...
  Instruction_Group("float-alu for float vector class XVII",
		    ...
		    TOP_UNDEFINED);
  Any_Operand_Access_Time(0);
  Any_Result_Available_Time(2); // ?? with memory operands? --was 4
  Resource_Requirement(res_issue, 0);
  Resource_Requirement(res_fadd, 0);
  Resource_Requirement(res_loadstore, 0);
  ...
  Instruction_Group("float-alu for int mpy vector",
		    ...
		    TOP_UNDEFINED);
  Any_Operand_Access_Time(0);
  Any_Result_Available_Time(3); // 6 for opteron
  Resource_Requirement(res_issue, 0);
  Resource_Requirement(res_fmul, 0);
