...
#endif
extern void
INITV_Init_Label (INITV_IDX inv, LABEL_IDX lab, UINT16 repeat = 1, INT32 flags = INITVLABELFLAGS_UNUSED);
...
inline void
INITV_Set_LABEL (INITV& initv, mUINT16 rp1, LABEL_IDX lab, INT32 flags = INITVLABELFLAGS_UNUSED) {
    initv.next = 0;
