 ...
 * $Author: marcel $
 * $Source: /kpro64/common/com/MIPS/targ_const.cxx,v $
 *
 * Revision history:
...
#undef DEBUG_FOLD
   ...
   *folded = TRUE;
    ...
    */
    ...
    case OPC_I4F10RND:
      if (TCON_R16(c0) >= 0.0) {
        TCON_I4(c0) = (INT32)(TCON_R16(c0) + 0.5);
      } else {
        TCON_I4(c0) = (INT32)(TCON_R16(c0) - 0.5);
      }
      TCON_v1(c0) = 0;
    ...
    case OPC_I8F10RND:
      if (TCON_R16(c0) >= 0.0) {
        TCON_I8(c0) = (INT64)(TCON_R16(c0) + 0.5);
      } else {
        TCON_I8(c0) = (INT64)(TCON_R16(c0) - 0.5);
      }
      TCON_v2(c0) = 0;
    ...
    /* case OPC_I4F10TRUNC:
      c0 = Targ_Conv(MTYPE_I4, c0); */
      printf("HERE%s: %d comment by YZY", __FILE__, __LINE__);
      break;
    ...
    case OPC_U4F4RND:
      ...
      break;
    case OPC_U4F10RND:
      TCON_U4(c0) = (UINT32)(TCON_R16(c0) + 0.5);
      TCON_v1(c0) = 0;
      TCON_v2(c0) = 0;
      TCON_v3(c0) = 0;
      TCON_ty(c0) = MTYPE_U4;
    ...
    case OPC_U8F4RND:
      ...
      break;
    case OPC_U8F10RND:
      TCON_U8(c0) = (UINT64)(TCON_R16(c0) + 0.5);
      TCON_v2(c0) = 0;
      TCON_v3(c0) = 0;
      TCON_ty(c0) = MTYPE_U8;
      break;
...
/*	 ErrMsg( EC_Ill_UModulus );*/
	*folded = FALSE;
	...
	TCON_R8(c1) : TCON_R8(c0);
      break;
    case OPC_F10MIN:
      TCON_R16(c0) = TCON_R16(c0) < TCON_R16(c1) ?
        TCON_R16(c0) : TCON_R16(c1);
      break;
    case OPC_F10MAX:
      TCON_R16(c0) = TCON_R16(c0) < TCON_R16(c1) ?
...
Host_To_Targ_Float_4 ( TYPE_ID ty, float v )
{
  ...
  switch (ty) {
   ...
   case MTYPE_FQ:
     TCON_clear(c);
     c = Targ_Conv (MTYPE_FQ,
		    Host_To_Targ_Float_4 ( MTYPE_F8, v ) );
     TCON_ty(c) = ty;
     return c;
     
   default:
     ErrMsg ( EC_Inv_Mtype, Mtype_Name(ty), "Host_To_Targ_Float_4" );
     TCON_clear(c);
     TCON_ty(c) = MTYPE_F4;
     return c;
  }
...
Targ_fp_class(TCON fvalue)
{
   ...
   case MTYPE_F10:
      return fp_class_e(TCON_R16(fvalue));
