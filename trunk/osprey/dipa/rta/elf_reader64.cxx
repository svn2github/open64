...
ProgHdr64* ProgHdrTable64::getPHdrByIndex(UINT phNum)
{
...
void ProgHdrTable64::_print_one(FILE* stream,ProgHdr64* phdr,UINT phNum)
{
...
SecHdr64* SecHdrTable64::getSHdrByIndex(UINT secNum)
{
...
void SecHdrTable64::_print_one(FILE* stream,SecHdr64* shdr,UINT secNum)
{
