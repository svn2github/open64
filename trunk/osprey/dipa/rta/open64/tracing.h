 ...
 * Module: tracing.h
 * $Revision: 1.2 $
 * $Date: 2005/12/30 03:04:50 $
 * $Author: weitang $
 * $Source: /depot/CVSROOT/javi/src/sw/cmplr/common/util/tracing.h,v $
 *
 * Revision history:
...
#ifdef _KEEP_RCS_ID
static char *tracing_rcs_id = "$Source: /depot/CVSROOT/javi/src/sw/cmplr/common/util/tracing.h,v $ $Revision: 1.2 $";
#endif /* _KEEP_RCS_ID */
...
#define TP_IPISR    64  /* Interprocedural interrupt service routine RA*/
...
extern FILE *Get_Trace_File_Desc ( void );
